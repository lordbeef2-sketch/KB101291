# NI DOCUMENT BUNDLE: labview-nxg-web-module-control-api-ref

<!--NI_BUNDLE_CHUNK bundle=labview-nxg-web-module-control-api-ref start=1 end=15 -->
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=array-control.html language=enus -->
## TOPIC 00001: Array Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `array-control.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/array-control.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=button-controls.html language=enus -->
## TOPIC 00002: Button Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `button-controls.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/button-controls.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
[IMAGE alt='1378' src='GUID-185BF464-BA0C-4A2D-9102-2C8507EE7A1A-a5.png']
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=chart-control.html language=enus -->
## TOPIC 00003: Chart Control

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `chart-control.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/chart-control.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=charts-and-graphs.html language=enus -->
## TOPIC 00004: Charts and Graphs

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `charts-and-graphs.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/charts-and-graphs.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=cluster-controls.html language=enus -->
## TOPIC 00005: Cluster Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `cluster-controls.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/cluster-controls.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=data-grid.html language=enus -->
## TOPIC 00006: Data Grid

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `data-grid.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/data-grid.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=decorations-ctrls.html language=enus -->
## TOPIC 00007: Decorations

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `decorations-ctrls.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/decorations-ctrls.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
- source_description: Decorate the user interface with images and web content. Adding a Hyperlink to the URL Image To add a hyperlink that opens when you click on the URL image, define the hyperlink in the Hyperlink option on the Item tab. In the Target option, set where the hyperlink opens from one of the following loca

Decorations

Decorate the user interface with images and web content.

[IMAGE alt='1378' src='GUID-B1B6A7FF-7582-4F3A-A820-3A9F96C767F1-a5.png']

#### Adding a Hyperlink to the URL
 Image

To add a hyperlink that opens when you click on the URL image, define the
 hyperlink in the Hyperlink option on the Item
 tab. In the Target option, set where the hyperlink opens from one
 of the following locations.

- Same Window / Frame —Opens the hyperlink in the current browsing
 context, such as the tab, window, or frame, that runs the WebVI.
- New Window —Opens the hyperlink in a new window or tab. The
 browser configuration determines whether to open a new window or tab.
- Parent Frame —Opens the hyperlink in the parent of the current
 browsing context. If the current browsing context has no parent, the hyperlink opens in
 the current browsing context.
- Top (Root) Frame —Opens the hyperlink in the root of the current
 browsing context. If the current browsing context has no root, the hyperlink opens in
 the current browsing context.

You can click a hyperlinked URL image only when the WebVI runs in a browser. Select Run»Run in browser to run your WebVI in a browser.

<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=escape-sequences.html language=enus -->
## TOPIC 00008: Escape Sequences

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `escape-sequences.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/escape-sequences.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=graph-control.html language=enus -->
## TOPIC 00009: Graph Control

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `graph-control.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/graph-control.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=intensity-graph-control.html language=enus -->
## TOPIC 00010: Intensity Graph Control

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `intensity-graph-control.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/intensity-graph-control.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=layouts.html language=enus -->
## TOPIC 00011: Layouts

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `layouts.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/layouts.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=numerics.html language=enus -->
## TOPIC 00012: Numeric Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `numerics.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/numerics.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=selector-controls.html language=enus -->
## TOPIC 00013: Selector Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `selector-controls.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/selector-controls.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
[IMAGE alt='1378' src='GUID-A9C00E86-D45F-470D-AE06-6570ACA6D314-a5.png']
...
Unlike the strings listed in rings, enums, and radio button groups, the strings
 listed in a listbox have no numeric representation. Additionally, enums and
 radio button groups require these numeric values to be sequential, unsigned
 integer values, while rings allow for much more freedom in assigning a numeric
 value.
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=text-controls.html language=enus -->
## TOPIC 00014: Text Controls

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `text-controls.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/text-controls.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
...
[IMAGE alt='1378' src='GUID-A29FCFDE-9486-49C3-8940-B084ACD81CFA-a5.png']
...
<!--NI_TOPIC bundle=labview-nxg-web-module-control-api-ref path=tree-control.html language=enus -->
## TOPIC 00015: Tree

- bundle_id: `labview-nxg-web-module-control-api-ref`
- source_path: `tree-control.html`
- source_url: https://docs-be.ni.com/bundle/labview-nxg-web-module-control-api-ref/raw/resource/enus/tree-control.html
- document_id: `labview-nxg-web-module-control-api-ref`
- page_type: `leaf`
- content_type: `reference`
