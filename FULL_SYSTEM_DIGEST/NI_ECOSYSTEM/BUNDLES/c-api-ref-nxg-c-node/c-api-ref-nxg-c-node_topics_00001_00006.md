# NI DOCUMENT BUNDLE: c-api-ref-nxg-c-node

<!--NI_BUNDLE_CHUNK bundle=c-api-ref-nxg-c-node start=1 end=6 -->
<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=analysis-lib.html language=enus -->
## TOPIC 00001: Analysis Library C Function Reference

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `analysis-lib.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/analysis-lib.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
...
<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=ansi-c-lib.html language=enus -->
## TOPIC 00002: ANSI C Library Function Reference

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `ansi-c-lib.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/ansi-c-lib.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=c-node-data-types.html language=enus -->
## TOPIC 00003: C Node Data Types

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `c-node-data-types.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/c-node-data-types.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
- content_type: `concept`
- source_description: You can use any valid C data type in your C code. However, variables that correspond to terminals must be of one of the following data types: signed and unsigned integers, characters (8-bit integers), doubles, Booleans, strings, and 1-dimensional arrays of any of the preceding types. By default, the
...
[IMAGE alt='1378' src='GUID-FC42FB68-F8B3-492D-8279-5EBD0535DF07-a5.png']

Parent topic:

C Node Overview

<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=c-node-lib.html language=enus -->
## TOPIC 00004: C Node Function Reference

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `c-node-lib.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/c-node-lib.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
- content_type: `reference`
...
<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=c-node-overview.html language=enus -->
## TOPIC 00005: C Node Overview

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `c-node-overview.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/c-node-overview.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
- content_type: `concept`
- source_description: Use the C Node to write and execute C code. You can call functions from the following libraries in the C Node: ANSI C Library Analysis Library In addition, the C Node includes functions, macros, and variables that are specific to the C Node. When you begin typing in the C Node, a drop-down list of e
...
The following image shows the components that make up the C Node: 
 [IMAGE alt='1378' src='GUID-80A3B36A-6C77-4A16-8D09-AA4D85F41419-a5.png']
...
<!--NI_TOPIC bundle=c-api-ref-nxg-c-node path=limitations-of-c-lang-in-c-node.html language=enus -->
## TOPIC 00006: Limitations of the C Language in the C Node

- bundle_id: `c-api-ref-nxg-c-node`
- source_path: `limitations-of-c-lang-in-c-node.html`
- source_url: https://docs-be.ni.com/bundle/c-api-ref-nxg-c-node/raw/resource/enus/limitations-of-c-lang-in-c-node.html
- document_id: `c-api-ref-nxg-c-node`
- page_type: `leaf`
- content_type: `concept`
- source_description: The default language standard of the C Node compiler is GNU89. GNU89 is the C89 specification with GNU extensions (some C99 features) supported. However, the C Node does not support the following features: Function definitions and declarations Third-party libraries (#include directive is not support

Limitations of the C Language in the C Node

The default language standard of the C Node compiler is GNU89. GNU89 is the C89 specification with GNU extensions (some C99 features) supported. However, the C Node does not support the following features:
