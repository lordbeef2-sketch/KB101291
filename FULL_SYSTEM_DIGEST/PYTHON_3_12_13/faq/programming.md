# PYTHON_3_12_13::faq/programming.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=faq/programming.txt -->
...
fancy formatting, see the f-strings and Format String Syntax sections,
e.g. ""{:04d}".format(144)" yields "'0144'" and
