# PYTHON_3_12_13::library/multiprocessing.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/multiprocessing.txt -->
...
start a process.  These *start methods* are
   ...
   *fork*
      ...
      Note:
        ...
        The default start method will change away from *fork* in
        Python 3.14. Code that requires *fork* should explicitly
