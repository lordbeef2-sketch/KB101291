# PYTHON_3_12_13::library/zipfile.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/zipfile.txt -->
   ...
   *compression* is the ZIP compression method to use when writing the
   ...
   Note:
     ...
     *metadata_encoding* is an instance-wide setting for the ZipFile.
     ...
     That flag takes precedence over *metadata_encoding*, which is a
