# PYTHON_3_12_13::library/venv.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/venv.txt -->
...
is "Libsite-packages"). If an existing directory is specified, it will
be re-used.
