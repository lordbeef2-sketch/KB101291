# PYTHON_3_12_13::library/email.utils.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/email.utils.txt -->
...
email.utils.parseaddr(address, *, strict=True)
   ...
   *realname* and *email address* parts.  Returns a tuple of that
   ...
   Changed in version 3.12.6: Add *strict* optional parameter and
