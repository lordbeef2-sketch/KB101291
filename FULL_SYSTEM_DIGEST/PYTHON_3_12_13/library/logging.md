# PYTHON_3_12_13::library/logging.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/logging.txt -->
...
class logging.Formatter(fmt=None, datefmt=None, style='%', validate=True, *, defaults=None)
   ...
   Parameters:
      ...
      * **datefmt** (*str*) -- A format string in the given *style*
        for the date/time portion of the logged output. If not
      ...
      * **style** (*str*) -- Can be one of "'%'", "'{'" or "'$'" and
        ...
        applies to *fmt* and *datefmt* (e.g. "'%(message)s'" versus
