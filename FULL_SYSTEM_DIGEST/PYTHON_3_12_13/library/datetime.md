# PYTHON_3_12_13::library/datetime.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/datetime.txt -->
...
Note:
  ...
  is *not* a leap year.  Always add a default leap year to partial
