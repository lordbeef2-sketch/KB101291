# PYTHON_3_12_13::library/unittest.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/unittest.txt -->
...
Changed in version 3.11: "unittest" dropped the *namespace packages*
...
class unittest.TestLoader
   ...
   discover(start_dir, pattern='test*.py', top_level_dir=None)
      ...
      *start_dir* can be a dotted module name as well as a directory.
      ...
      Changed in version 3.12.4: *top_level_dir* is only stored for
