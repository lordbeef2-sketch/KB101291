# JAVA OPENAPI: InstantiationExpression (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/InstantiationExpression.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/InstantiationExpression.html`
- source_sha256: `03f0eca33a46145021c40b389450119212d7c6bf0dd59ff15e9c7d19012b301f`
- captured_utc: `2026-07-14T16:44:49.133856+00:00`
...
## Interface InstantiationExpression
...
`[CollectExpression](CollectExpression.html)`, `[ConstructorExpression](ConstructorExpression.html)`, `[FeatureChainExpression](FeatureChainExpression.html)`, `[IndexExpression](IndexExpression.html)`, `[InvocationExpression](InvocationExpression.html)`, `[OperatorExpression](OperatorExpression.html)`, `[SelectExpression](SelectExpression.html)`, `[TriggerInvocationExpression](../../../sysml/model/sysml/TriggerInvocationExpression.html)`

@OpenApiAllpublic interfaceInstantiationExpressionextends [Expression](Expression.html)
...
The `Expressions` whose `results` are bound to `features` of the `instantiatedType`.
`[Type](Type.html)`
`[getInstantiatedType](#getInstantiatedType())()`
The `Type` that is being instantiated.
`[Type](Type.html)`
`[instantiatedType](#instantiatedType())()`
Return the `Type` to act as the `instantiatedType` for this `InstantiationExpression`.
...
`[checkCondition](Expression.html#checkCondition(com.dassault_systemes.modeler.kerml.model.kerml.Element)), [evaluate](Expression.html#evaluate(com.dassault_systemes.modeler.kerml.model.kerml.Element)), [getFunction](Expression.html#getFunction()), [getResult](Expression.html#getResult()), [isModelLevelEvaluable](Expression.html#isModelLevelEvaluable()), [modelLevelEvaluable](Expression.html#modelLevelEvaluable(java.util.List))`
...
Method Details
getArgument
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Expression](Expression.html)> getArgument()
...
derived="true"
 transient="true"
 oppositeRoleName="instantiation"
getInstantiatedType
@CheckForNull[Type](Type.html) getInstantiatedType()
The `Type` that is being instantiated.
Returns:
the instantiatedType value
Model:
derived="true"
 transient="true"
 oppositeRoleName="instantiationExpression"
...
<h1 class="title" title="Interface InstantiationExpression">Interface InstantiationExpression</h1>
</div>
...
<div class="block">The <code>Expressions</code> whose <code>results</code> are bound to <code>features</code> of the <code>instantiatedType</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInstantiatedType()">getInstantiatedType</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Type</code> that is being instantiated.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#instantiatedType()">instantiatedType</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Return the <code>Type</code> to act as the <code>instantiatedType</code> for this <code>InstantiationExpression</code>.</div>
</div>
</div>
</div>
</div>
...
<code><a href="Expression.html#checkCondition(com.dassault_systemes.modeler.kerml.model.kerml.Element)">checkCondition</a>, <a href="Expression.html#evaluate(com.dassault_systemes.modeler.kerml.model.kerml.Element)">evaluate</a>, <a href="Expression.html#getFunction()">getFunction</a>, <a href="Expression.html#getResult()">getResult</a>, <a href="Expression.html#isModelLevelEvaluable()">isModelLevelEvaluable</a>, <a href="Expression.html#modelLevelEvaluable(java.util.List)">modelLevelEvaluable</a></code></div>
<div class="inherited-list">
...
<h3>getArgument</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</span> <span class="element-name">getArgument</span>()</div>
<div class="block"><p>The <code>Expressions</code> whose <code>results</code> are bound to <code>features</code> of the <code>instantiatedType</code>. The <code>arguments</code> are ordered consistent with the order of the <code>features</code>, though they may not be one-to-one with all the <code>features</code>.</p>
<p><strong>Note.</strong> The derivation of <code>argument</code> is given in the concrete subclasses of <code>InstantiationExpression</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="instantiation"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getInstantiatedType()">
<h3>getInstantiatedType</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getInstantiatedType</span>()</div>
<div class="block"><p>The <code>Type</code> that is being instantiated.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the instantiatedType value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="instantiationExpression"
...
<div class="block"><p>Return the <code>Type</code> to act as the <code>instantiatedType</code> for this <code>InstantiationExpression</code>. By default, this is the <code>memberElement</code> of the first <code>ownedMembership</code> that is not a <code>FeatureMembership</code>, which must be a <code>Type</code>.</p>
