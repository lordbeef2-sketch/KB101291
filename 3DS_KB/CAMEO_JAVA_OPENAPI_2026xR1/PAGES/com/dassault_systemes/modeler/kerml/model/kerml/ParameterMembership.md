# JAVA OPENAPI: ParameterMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/ParameterMembership.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/ParameterMembership.html`
- source_sha256: `97993e172f97dd5b621a2a20894c8e3e853031b2ba69a23e9d6537c45bfef3e7`
- captured_utc: `2026-07-14T16:44:50.218874+00:00`
...
`[ActorMembership](../../../sysml/model/sysml/ActorMembership.html)`, `[ReturnParameterMembership](ReturnParameterMembership.html)`, `[StakeholderMembership](../../../sysml/model/sysml/StakeholderMembership.html)`, `[SubjectMembership](../../../sysml/model/sysml/SubjectMembership.html)`

@OpenApiAllpublic interfaceParameterMembershipextends [FeatureMembership](FeatureMembership.html)
...
`[getOwnedMemberParameter](#getOwnedMemberParameter())()`
...
Return the required value of the `direction` of the `ownedMemberParameter`.
`void`
`[setOwnedMemberParameter](#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` that is identified as a `parameter` by this `ParameterMembership`.
...
============ METHOD DETAIL ========== 
Method Details
getOwnedMemberParameter
@CheckForNull[Feature](Feature.html) getOwnedMemberParameter()
The `Feature` that is identified as a `parameter` by this `ParameterMembership`.
Returns:
the ownedMemberParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningParameterMembership"
 redefines=[`FeatureMembership.getOwnedMemberFeature()`](FeatureMembership.html#getOwnedMemberFeature())
setOwnedMemberParameter
void setOwnedMemberParameter(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` that is identified as a `parameter` by this `ParameterMembership`.
Parameters:
`value` - the ownedMemberParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningParameterMembership"
 redefines=[`FeatureMembership.getOwnedMemberFeature()`](FeatureMembership.html#getOwnedMemberFeature())
parameterDirection
[FeatureDirectionKind](FeatureDirectionKind.html) parameterDirection()
...
<h1 class="title" title="Interface ParameterMembership">Interface ParameterMembership</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedMemberParameter()">getOwnedMemberParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that is identified as a <code>parameter</code> by this <code>ParameterMembership</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#parameterDirection()">parameterDirection</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Return the required value of the <code>direction</code> of the <code>ownedMemberParameter</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setOwnedMemberParameter</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that is identified as a <code>parameter</code> by this <code>ParameterMembership</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getOwnedMemberParameter()">
<h3>getOwnedMemberParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getOwnedMemberParameter</span>()</div>
<div class="block"><p>The <code>Feature</code> that is identified as a <code>parameter</code> by this <code>ParameterMembership</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedMemberParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningParameterMembership"
...
<li>
<section class="detail" id="setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setOwnedMemberParameter</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedMemberParameter</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> that is identified as a <code>parameter</code> by this <code>ParameterMembership</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedMemberParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningParameterMembership"
...
<li>
<section class="detail" id="parameterDirection()">
<h3>parameterDirection</h3>
<div class="member-signature"><span class="return-type"><a href="FeatureDirectionKind.html" title="class in com.dassault_systemes.modeler.kerml.model.kerml">FeatureDirectionKind</a></span> <span class="element-name">parameterDirection</span>()</div>
<div class="block"><p>Return the required value of the <code>direction</code> of the <code>ownedMemberParameter</code>. By default, this is <code>in</code>.</p>
 FeatureDirectionKind::_'in'</div>
</section>
</li>
</ul>
</section>
