# JAVA OPENAPI: CrossSubsetting (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/CrossSubsetting.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/CrossSubsetting.html`
- source_sha256: `9adea4c523dffaf805515d462a16708015692d237417bcbb0672a36357b9e4e5`
- captured_utc: `2026-07-14T16:44:48.690853+00:00`
...
@OpenApiAllpublic interfaceCrossSubsettingextends [Subsetting](Subsetting.html)
...
`[getCrossedFeature](#getCrossedFeature())()`
The chained `Feature` that is cross subset by the `crossingFeature` of this `CrossSubsetting`.
`[Feature](Feature.html)`
`[getCrossingFeature](#getCrossingFeature())()`
The end `Feature` that owns this `CrossSubsetting` relationship and is also its subsettingFeature.
`void`
`[setCrossedFeature](#setCrossedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The chained `Feature` that is cross subset by the `crossingFeature` of this `CrossSubsetting`.
`void`
`[setCrossingFeature](#setCrossingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The end `Feature` that owns this `CrossSubsetting` relationship and is also its subsettingFeature.
...
Method Details
getCrossedFeature
@CheckForNull[Feature](Feature.html) getCrossedFeature()
The chained `Feature` that is cross subset by the `crossingFeature` of this `CrossSubsetting`.
Returns:
the crossedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="crossSupersetting"
 redefines=[`Subsetting.getSubsettedFeature()`](Subsetting.html#getSubsettedFeature())
setCrossedFeature
void setCrossedFeature(@CheckForNull
 [Feature](Feature.html) value)
The chained `Feature` that is cross subset by the `crossingFeature` of this `CrossSubsetting`.
Parameters:
`value` - the crossedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="crossSupersetting"
 redefines=[`Subsetting.getSubsettedFeature()`](Subsetting.html#getSubsettedFeature())
getCrossingFeature
@CheckForNull[Feature](Feature.html) getCrossingFeature()
The end `Feature` that owns this `CrossSubsetting` relationship and is also its subsettingFeature.
Returns:
the crossingFeature value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedCrossSubsetting()`](Feature.html#getOwnedCrossSubsetting())
...
setCrossingFeature
void setCrossingFeature(@CheckForNull
 [Feature](Feature.html) value)
The end `Feature` that owns this `CrossSubsetting` relationship and is also its subsettingFeature.
Parameters:
`value` - the crossingFeature value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedCrossSubsetting()`](Feature.html#getOwnedCrossSubsetting())
...
<h1 class="title" title="Interface CrossSubsetting">Interface CrossSubsetting</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">CrossSubsetting</span><span class="extends-implements">
extends <a href="Subsetting.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Subsetting</a></span></div>
<div class="block"><p><code>CrossSubsetting</code> is a kind of <code>Subsetting</code> for end <code>Features</code>, as identified by <code>crossingFeature</code>, to subset a chained <code>Feature</code>, identified by <code>crossedFeature.</code> It navigates to instances of the end <code>Feature</code>’s type from instances of other end <code>Feature</code> types on the same <code>owningType</code> (at least two end <code>Features</code> are required for any of them to have a <code>CrossSubsetting</code>).</p>
...
<p>A <code>crossFeature</code> must be owned by its <code>featureCrossing</code> (end <code>Feature</code>) when the <code>featureCrossing</code> <code>owningType</code> has more than two end <code>Features</code>. Otherwise, for exactly two end <code>Features</code>, the <code>crossFeatures</code> of each the ends can instead optionally be inherited by the other end from one of its <code>types</code> or a subsetted <code>Feature</code>.</p>
 ...
 crossingFeature.isEnd and
 crossingFeature.owningType&lt;&gt;null and
 crossingFeature.owningType.endFeature -&gt;size() &gt; 1</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getCrossedFeature()">getCrossedFeature</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The chained <code>Feature</code> that is cross subset by the <code>crossingFeature</code> of this <code>CrossSubsetting</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getCrossingFeature()">getCrossingFeature</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The end <code>Feature</code> that owns this <code>CrossSubsetting</code> relationship and is also its subsettingFeature.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setCrossedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setCrossedFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The chained <code>Feature</code> that is cross subset by the <code>crossingFeature</code> of this <code>CrossSubsetting</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setCrossingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setCrossingFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The end <code>Feature</code> that owns this <code>CrossSubsetting</code> relationship and is also its subsettingFeature.</div>
</div>
</div>
...
<li>
<section class="detail" id="getCrossedFeature()">
<h3>getCrossedFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getCrossedFeature</span>()</div>
<div class="block"><p>The chained <code>Feature</code> that is cross subset by the <code>crossingFeature</code> of this <code>CrossSubsetting</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the crossedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="crossSupersetting"
...
<li>
<section class="detail" id="setCrossedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setCrossedFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setCrossedFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The chained <code>Feature</code> that is cross subset by the <code>crossingFeature</code> of this <code>CrossSubsetting</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the crossedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="crossSupersetting"
...
<li>
<section class="detail" id="getCrossingFeature()">
<h3>getCrossingFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getCrossingFeature</span>()</div>
<div class="block"><p>The end <code>Feature</code> that owns this <code>CrossSubsetting</code> relationship and is also its subsettingFeature.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the crossingFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedCrossSubsetting()"><code>Feature.getOwnedCrossSubsetting()</code></a>
...
<li>
<section class="detail" id="setCrossingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setCrossingFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setCrossingFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The end <code>Feature</code> that owns this <code>CrossSubsetting</code> relationship and is also its subsettingFeature.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the crossingFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedCrossSubsetting()"><code>Feature.getOwnedCrossSubsetting()</code></a>
