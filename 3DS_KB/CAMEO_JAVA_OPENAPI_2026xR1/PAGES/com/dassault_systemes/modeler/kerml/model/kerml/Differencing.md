# JAVA OPENAPI: Differencing (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/Differencing.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/Differencing.html`
- source_sha256: `6432b7cf3d13e3166c25c77cd2ebba8750e98f593ea482c1752dac8dc51ef9f5`
- captured_utc: `2026-07-14T16:44:48.795853+00:00`
...
@OpenApiAllpublic interfaceDifferencingextends [Relationship](Relationship.html)
...
`[Type](Type.html)`
`[getTypeDifferenced](#getTypeDifferenced())()`
`Type` with interpretations partly determined by `differencingType`, as described in `Type::differencingType`.
`void`
`[setDifferencingType](#setDifferencingType(com.dassault_systemes.modeler.kerml.model.kerml.Type))([Type](Type.html) value)`
`Type` that partly determines interpretations of `typeDifferenced`, as described in `Type::differencingType`.
`void`
`[setTypeDifferenced](#setTypeDifferenced(com.dassault_systemes.modeler.kerml.model.kerml.Type))([Type](Type.html) value)`
`Type` with interpretations partly determined by `differencingType`, as described in `Type::differencingType`.
...
Method Details
getTypeDifferenced
@CheckForNull[Type](Type.html) getTypeDifferenced()
`Type` with interpretations partly determined by `differencingType`, as described in `Type::differencingType`.
Returns:
the typeDifferenced value
Model:
derived="true"
 transient="true"
 opposite=[`Type.getOwnedDifferencing()`](Type.html#getOwnedDifferencing())
...
setTypeDifferenced
void setTypeDifferenced(@CheckForNull
 [Type](Type.html) value)
`Type` with interpretations partly determined by `differencingType`, as described in `Type::differencingType`.
Parameters:
`value` - the typeDifferenced value
Model:
derived="true"
 transient="true"
 opposite=[`Type.getOwnedDifferencing()`](Type.html#getOwnedDifferencing())
 ...
 redefines=[`Relationship.getSource()`](Relationship.html#getSource())
getDifferencingType
@CheckForNull[Type](Type.html) getDifferencingType()
`Type` that partly determines interpretations of `typeDifferenced`, as described in `Type::differencingType`.
Returns:
...
derived="false"
 transient="false"
 oppositeRoleName="differencedDifferencing"
 redefines=[`Relationship.getTarget()`](Relationship.html#getTarget())
setDifferencingType
void setDifferencingType(@CheckForNull
 [Type](Type.html) value)
`Type` that partly determines interpretations of `typeDifferenced`, as described in `Type::differencingType`.
Parameters:
`value` - the differencingType value
Model:
derived="false"
 transient="false"
 oppositeRoleName="differencedDifferencing"
...
<h1 class="title" title="Interface Differencing">Interface Differencing</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">Differencing</span><span class="extends-implements">
...
<div class="block"><p><code>Differencing</code> is a <code>Relationship</code> that makes its <code>differencingType</code> one of the <code>differencingTypes</code> of its <code>typeDifferenced</code>.</p></div>
</section>
...
<div class="block"><code>Type</code> that partly determines interpretations of <code>typeDifferenced</code>, as described in <code>Type::differencingType</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTypeDifferenced()">getTypeDifferenced</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> with interpretations partly determined by <code>differencingType</code>, as described in <code>Type::differencingType</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDifferencingType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setDifferencingType</a><wbr/>(<a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> that partly determines interpretations of <code>typeDifferenced</code>, as described in <code>Type::differencingType</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTypeDifferenced(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setTypeDifferenced</a><wbr/>(<a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> with interpretations partly determined by <code>differencingType</code>, as described in <code>Type::differencingType</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getTypeDifferenced()">
<h3>getTypeDifferenced</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getTypeDifferenced</span>()</div>
<div class="block"><p><code>Type</code> with interpretations partly determined by <code>differencingType</code>, as described in <code>Type::differencingType</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the typeDifferenced value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Type.html#getOwnedDifferencing()"><code>Type.getOwnedDifferencing()</code></a>
...
<li>
<section class="detail" id="setTypeDifferenced(com.dassault_systemes.modeler.kerml.model.kerml.Type)">
<h3>setTypeDifferenced</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTypeDifferenced</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</span></div>
<div class="block"><p><code>Type</code> with interpretations partly determined by <code>differencingType</code>, as described in <code>Type::differencingType</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the typeDifferenced value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Type.html#getOwnedDifferencing()"><code>Type.getOwnedDifferencing()</code></a>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getDifferencingType</span>()</div>
<div class="block"><p><code>Type</code> that partly determines interpretations of <code>typeDifferenced</code>, as described in <code>Type::differencingType</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setDifferencingType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">
<h3>setDifferencingType</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDifferencingType</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</span></div>
<div class="block"><p><code>Type</code> that partly determines interpretations of <code>typeDifferenced</code>, as described in <code>Type::differencingType</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the differencingType value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="differencedDifferencing"
