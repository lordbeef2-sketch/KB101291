# JAVA OPENAPI: ReturnParameterMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/ReturnParameterMembership.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/ReturnParameterMembership.html`
- source_sha256: `ec4e1f173e678d335ebfbbcc9a2bce9ebc6fe53e87e25df780fa7008bce1cc94`
- captured_utc: `2026-07-14T16:44:50.317877+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](Element.html)`, `org.eclipse.emf.ecore.EObject`, `[FeatureMembership](FeatureMembership.html)`, `[Membership](Membership.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `org.eclipse.emf.common.notify.Notifier`, `[OwningMembership](OwningMembership.html)`, `[ParameterMembership](ParameterMembership.html)`, `[Relationship](Relationship.html)`

@OpenApiAllpublic interfaceReturnParameterMembershipextends [ParameterMembership](ParameterMembership.html)
...
The `ownedMemberParameter` of a `ReturnParameterMembership` must have direction `out`.
...
Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.[ParameterMembership](ParameterMembership.html)
`[getOwnedMemberParameter](ParameterMembership.html#getOwnedMemberParameter()), [setOwnedMemberParameter](ParameterMembership.html#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature))`
...
Specified by:
`[parameterDirection](ParameterMembership.html#parameterDirection())` in interface `[ParameterMembership](ParameterMembership.html)`
...
<h1 class="title" title="Interface ReturnParameterMembership">Interface ReturnParameterMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ReturnParameterMembership</span><span class="extends-implements">
extends <a href="ParameterMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">ParameterMembership</a></span></div>
<div class="block"><p>A <code>ReturnParameterMembership</code> is a <code>ParameterMembership</code> that indicates that the <code>ownedMemberParameter</code> is the <code>result</code> <code>parameter</code> of a <code>Function</code> or <code>Expression</code>. The <code>direction</code> of the <code>ownedMemberParameter</code> must be <code>out</code>.</p>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#parameterDirection()">parameterDirection</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ownedMemberParameter</code> of a <code>ReturnParameterMembership</code> must have direction <code>out</code>.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.kerml.model.kerml.ParameterMembership">Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.<a href="ParameterMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">ParameterMembership</a></h3>
<code><a href="ParameterMembership.html#getOwnedMemberParameter()">getOwnedMemberParameter</a>, <a href="ParameterMembership.html#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setOwnedMemberParameter</a></code></div>
<div class="inherited-list">
...
<div class="block"><p>The <code>ownedMemberParameter</code> of a <code>ReturnParameterMembership</code> must have direction <code>out</code>. (This is a leaf operation that cannot be further redefined.)</p>
 FeatureDirectionKind::out</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="ParameterMembership.html#parameterDirection()">parameterDirection</a></code> in interface <code><a href="ParameterMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">ParameterMembership</a></code></dd>
</dl>
</section>
</li>
</ul>
