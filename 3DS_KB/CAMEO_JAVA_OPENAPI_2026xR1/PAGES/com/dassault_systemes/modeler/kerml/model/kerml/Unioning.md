# JAVA OPENAPI: Unioning (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/Unioning.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/Unioning.html`
- source_sha256: `32a5c7cc7ec741c27c41f895278abe168f316d0c0c05fb5cb0d6487c040f4f71`
- captured_utc: `2026-07-14T16:44:50.866882+00:00`
...
@OpenApiAllpublic interfaceUnioningextends [Relationship](Relationship.html)
...
`void`
`[setTypeUnioned](#setTypeUnioned(com.dassault_systemes.modeler.kerml.model.kerml.Type))([Type](Type.html) value)`
`Type` with interpretations partly determined by `unioningType`, as described in `Type::unioningType`.
`void`
`[setUnioningType](#setUnioningType(com.dassault_systemes.modeler.kerml.model.kerml.Type))([Type](Type.html) value)`
`Type` that partly determines interpretations of `typeUnioned`, as described in `Type::unioningType`.
...
Method Details
getTypeUnioned
@CheckForNull[Type](Type.html) getTypeUnioned()
`Type` with interpretations partly determined by `unioningType`, as described in `Type::unioningType`.
Returns:
the typeUnioned value
Model:
derived="true"
 transient="true"
 opposite=[`Type.getOwnedUnioning()`](Type.html#getOwnedUnioning())
...
setTypeUnioned
void setTypeUnioned(@CheckForNull
 [Type](Type.html) value)
`Type` with interpretations partly determined by `unioningType`, as described in `Type::unioningType`.
Parameters:
`value` - the typeUnioned value
Model:
derived="true"
 transient="true"
 opposite=[`Type.getOwnedUnioning()`](Type.html#getOwnedUnioning())
 ...
 redefines=[`Relationship.getSource()`](Relationship.html#getSource())
getUnioningType
@CheckForNull[Type](Type.html) getUnioningType()
`Type` that partly determines interpretations of `typeUnioned`, as described in `Type::unioningType`.
Returns:
...
derived="false"
 transient="false"
 oppositeRoleName="unionedUnioning"
 redefines=[`Relationship.getTarget()`](Relationship.html#getTarget())
setUnioningType
void setUnioningType(@CheckForNull
 [Type](Type.html) value)
`Type` that partly determines interpretations of `typeUnioned`, as described in `Type::unioningType`.
Parameters:
`value` - the unioningType value
Model:
derived="false"
 transient="false"
 oppositeRoleName="unionedUnioning"
...
<h1 class="title" title="Interface Unioning">Interface Unioning</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">Unioning</span><span class="extends-implements">
...
<div class="block"><p><code>Unioning</code> is a <code>Relationship</code> that makes its <code>unioningType</code> one of the <code>unioningTypes</code> of its <code>typeUnioned</code>.</p></div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTypeUnioned()">getTypeUnioned</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> with interpretations partly determined by <code>unioningType</code>, as described in <code>Type::unioningType</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getUnioningType()">getUnioningType</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> that partly determines interpretations of <code>typeUnioned</code>, as described in <code>Type::unioningType</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTypeUnioned(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setTypeUnioned</a><wbr/>(<a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> with interpretations partly determined by <code>unioningType</code>, as described in <code>Type::unioningType</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setUnioningType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setUnioningType</a><wbr/>(<a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"><code>Type</code> that partly determines interpretations of <code>typeUnioned</code>, as described in <code>Type::unioningType</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getTypeUnioned()">
<h3>getTypeUnioned</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getTypeUnioned</span>()</div>
<div class="block"><p><code>Type</code> with interpretations partly determined by <code>unioningType</code>, as described in <code>Type::unioningType</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the typeUnioned value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Type.html#getOwnedUnioning()"><code>Type.getOwnedUnioning()</code></a>
...
<li>
<section class="detail" id="setTypeUnioned(com.dassault_systemes.modeler.kerml.model.kerml.Type)">
<h3>setTypeUnioned</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTypeUnioned</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</span></div>
<div class="block"><p><code>Type</code> with interpretations partly determined by <code>unioningType</code>, as described in <code>Type::unioningType</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the typeUnioned value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Type.html#getOwnedUnioning()"><code>Type.getOwnedUnioning()</code></a>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getUnioningType</span>()</div>
<div class="block"><p><code>Type</code> that partly determines interpretations of <code>typeUnioned</code>, as described in <code>Type::unioningType</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setUnioningType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">
<h3>setUnioningType</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setUnioningType</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</span></div>
<div class="block"><p><code>Type</code> that partly determines interpretations of <code>typeUnioned</code>, as described in <code>Type::unioningType</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the unioningType value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="unionedUnioning"
