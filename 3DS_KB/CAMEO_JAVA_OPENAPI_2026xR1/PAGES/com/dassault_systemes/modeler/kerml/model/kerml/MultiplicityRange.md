# JAVA OPENAPI: MultiplicityRange (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/MultiplicityRange.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/MultiplicityRange.html`
- source_sha256: `0c45b54408a0e94dfc20ee0e53666918c8e47e86b6cc65fa85bdbf6b9d07d2f7`
- captured_utc: `2026-07-14T16:44:50.061869+00:00`
...
`[getBound](#getBound())()`
The owned `Expressions` of the `MultiplicityRange` whose results provide its bounds.
`[Expression](Expression.html)`
`[getLowerBound](#getLowerBound())()`
The `Expression` whose result provides the lower bound of the `MultiplicityRange`.
`[Expression](Expression.html)`
`[getUpperBound](#getUpperBound())()`
The `Expression` whose result is the upper bound of the `MultiplicityRange`.
`boolean`
`[hasBounds](#hasBounds(int,int))(int lower,
 int upper)`
...
`int`
`[valueOf](#valueOf(com.dassault_systemes.modeler.kerml.model.kerml.Expression))([Expression](Expression.html) bound)`
...
Method Details
getLowerBound
@CheckForNull[Expression](Expression.html) getLowerBound()
...
derived="true"
 transient="true"
 oppositeRoleName="multiplicity"
 subsets=[`getBound()`](#getBound())
getUpperBound
@CheckForNull[Expression](Expression.html) getUpperBound()
The `Expression` whose result is the upper bound of the `MultiplicityRange`.
Returns:
...
derived="true"
 ...
 subsets=[`getBound()`](#getBound())
getBound
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Expression](Expression.html)> getBound()
...
Check whether this `MultiplicityRange` represents the range bounded by the given values `lower` and `upper`, presuming the `lowerBound` and `upperBound` `Expressions` are model-level evaluable.
 ...
 lower = 0 and upper = *))
valueOf
int valueOf([Expression](Expression.html) bound)
Evaluate the given `bound` `Expression` (at model level) and return the result represented as a MOF `UnlimitedNatural` value.
...
<h1 class="title" title="Interface MultiplicityRange">Interface MultiplicityRange</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getBound()">getBound</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>Expressions</code> of the <code>MultiplicityRange</code> whose results provide its bounds.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getLowerBound()">getLowerBound</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expression</code> whose result provides the lower bound of the <code>MultiplicityRange</code>.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expression</code> whose result is the upper bound of the <code>MultiplicityRange</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasBounds(int,int)">hasBounds</a><wbr/>(int lower,
 int upper)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Check whether this <code>MultiplicityRange</code> represents the range bounded by the given values <code>lower</code> and <code>upper</code>, presuming the <code>lowerBound</code> and <code>upperBound</code> <code>Expressions</code> are model-level evaluable.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>int</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#valueOf(com.dassault_systemes.modeler.kerml.model.kerml.Expression)">valueOf</a><wbr/>(<a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a> bound)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Evaluate the given <code>bound</code> <code>Expression</code> (at model level) and return the result represented as a MOF <code>UnlimitedNatural</code> value.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getLowerBound</span>()</div>
<div class="block"><p>The <code>Expression</code> whose result provides the lower bound of the <code>MultiplicityRange</code>. If no <code>lowerBound</code> <code>Expression</code> is given, then the lower bound shall have the same value as the upper bound, unless the upper bound is unbounded (<code>*</code>), in which case the lower bound shall be 0.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the lowerBound value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="multiplicity"
        subsets=<a href="#getBound()"><code>getBound()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<h3>getUpperBound</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getUpperBound</span>()</div>
<div class="block"><p>The <code>Expression</code> whose result is the upper bound of the <code>MultiplicityRange</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the upperBound value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="multiplicity"
...
<li>
<section class="detail" id="getBound()">
<h3>getBound</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</span> <span class="element-name">getBound</span>()</div>
<div class="block"><p>The owned <code>Expressions</code> of the <code>MultiplicityRange</code> whose results provide its bounds. These must be the first <code>ownedMembers</code> of the <code>MultiplicityRange</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the bound value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="multiplicity"
...
<li>
<section class="detail" id="hasBounds(int,int)">
<h3>hasBounds</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasBounds</span><wbr/><span class="parameters">(int lower,
 int upper)</span></div>
<div class="block"><p>Check whether this <code>MultiplicityRange</code> represents the range bounded by the given values <code>lower</code> and <code>upper</code>, presuming the <code>lowerBound</code> and <code>upperBound</code> <code>Expressions</code> are model-level evaluable.</p>
 valueOf(upperBound) = upper and
 let lowerValue: UnlimitedNatural = valueOf(lowerBound) in
 (lowerValue = lower or
  lowerValue = null and 
     (lower = upper or 
      lower = 0 and upper = *))</div>
</section>
</li>
<li>
<section class="detail" id="valueOf(com.dassault_systemes.modeler.kerml.model.kerml.Expression)">
<h3>valueOf</h3>
<div class="member-signature"><span class="return-type">int</span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a> bound)</span></div>
<div class="block"><p>Evaluate the given <code>bound</code> <code>Expression</code> (at model level) and return the result represented as a MOF <code>UnlimitedNatural</code> value.</p>
 if bound = null or not bound.isModelLevelEvaluable then 
     null
 else
     let boundEval: Sequence(Element) = bound.evaluate(owningType) in
