# JAVA OPENAPI: FeatureChaining (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/FeatureChaining.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/FeatureChaining.html`
- source_sha256: `906da76dfa0c864f43f2d16391a03bc6a91447641bb4f098844d8317c8d0b1e6`
- captured_utc: `2026-07-14T16:44:48.806853+00:00`
...
@OpenApiAllpublic interfaceFeatureChainingextends [Relationship](Relationship.html)
...
`[Feature](Feature.html)`
`[getFeatureChained](#getFeatureChained())()`
The `Feature` whose values are partly determined by values of the `chainingFeature`, as described in `Feature::chainingFeature`.
`void`
`[setChainingFeature](#setChainingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` whose values partly determine values of `featureChained`, as described in `Feature::chainingFeature`.
`void`
`[setFeatureChained](#setFeatureChained(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` whose values are partly determined by values of the `chainingFeature`, as described in `Feature::chainingFeature`.
...
Method Details
getChainingFeature
@CheckForNull[Feature](Feature.html) getChainingFeature()
The `Feature` whose values partly determine values of `featureChained`, as described in `Feature::chainingFeature`.
Returns:
...
derived="false"
 transient="false"
 oppositeRoleName="chainedFeatureChaining"
 redefines=[`Relationship.getTarget()`](Relationship.html#getTarget())
setChainingFeature
void setChainingFeature(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` whose values partly determine values of `featureChained`, as described in `Feature::chainingFeature`.
Parameters:
`value` - the chainingFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="chainedFeatureChaining"
 redefines=[`Relationship.getTarget()`](Relationship.html#getTarget())
getFeatureChained
@CheckForNull[Feature](Feature.html) getFeatureChained()
The `Feature` whose values are partly determined by values of the `chainingFeature`, as described in `Feature::chainingFeature`.
Returns:
the featureChained value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedFeatureChaining()`](Feature.html#getOwnedFeatureChaining())
...
setFeatureChained
void setFeatureChained(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` whose values are partly determined by values of the `chainingFeature`, as described in `Feature::chainingFeature`.
Parameters:
`value` - the featureChained value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedFeatureChaining()`](Feature.html#getOwnedFeatureChaining())
...
<h1 class="title" title="Interface FeatureChaining">Interface FeatureChaining</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">FeatureChaining</span><span class="extends-implements">
...
<div class="block"><p><code>FeatureChaining</code> is a <code>Relationship</code> that makes its target <code>Feature</code> one of the <code>chainingFeatures</code> of its owning <code>Feature</code>.</p></div>
</section>
...
<div class="block">The <code>Feature</code> whose values partly determine values of <code>featureChained</code>, as described in <code>Feature::chainingFeature</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getFeatureChained()">getFeatureChained</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> whose values are partly determined by values of the <code>chainingFeature</code>, as described in <code>Feature::chainingFeature</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setChainingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setChainingFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> whose values partly determine values of <code>featureChained</code>, as described in <code>Feature::chainingFeature</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setFeatureChained(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setFeatureChained</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> whose values are partly determined by values of the <code>chainingFeature</code>, as described in <code>Feature::chainingFeature</code>.</div>
</div>
</div>
...
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getChainingFeature</span>()</div>
<div class="block"><p>The <code>Feature</code> whose values partly determine values of <code>featureChained</code>, as described in <code>Feature::chainingFeature</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setChainingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setChainingFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setChainingFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> whose values partly determine values of <code>featureChained</code>, as described in <code>Feature::chainingFeature</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the chainingFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="chainedFeatureChaining"
...
<li>
<section class="detail" id="getFeatureChained()">
<h3>getFeatureChained</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getFeatureChained</span>()</div>
<div class="block"><p>The <code>Feature</code> whose values are partly determined by values of the <code>chainingFeature</code>, as described in <code>Feature::chainingFeature</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the featureChained value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedFeatureChaining()"><code>Feature.getOwnedFeatureChaining()</code></a>
...
<li>
<section class="detail" id="setFeatureChained(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setFeatureChained</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setFeatureChained</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> whose values are partly determined by values of the <code>chainingFeature</code>, as described in <code>Feature::chainingFeature</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the featureChained value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedFeatureChaining()"><code>Feature.getOwnedFeatureChaining()</code></a>
