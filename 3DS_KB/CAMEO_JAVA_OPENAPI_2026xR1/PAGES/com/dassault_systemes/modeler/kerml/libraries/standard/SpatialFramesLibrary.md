# JAVA OPENAPI: SpatialFramesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/SpatialFramesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/SpatialFramesLibrary.html`
- source_sha256: `aea8a5aae802f1e17cbc42b63143433eb86879dd44cb912edccf31a6929a6fdd`
- captured_utc: `2026-07-14T16:44:46.942828+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.SpatialFramesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classSpatialFramesLibrary
...
Constructor
Description
`[SpatialFramesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a SpatialFramesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [SpatialFramesLibrary](SpatialFramesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the SpatialFramesLibrary instance for the project that owns the given element.
`static [SpatialFramesLibrary](SpatialFramesLibrary.html)`
...
Returns the SpatialFramesLibrary instance for the given project.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
SpatialFramesLibrary
public SpatialFramesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a SpatialFramesLibrary for the given project.
Parameters:
...
public static [SpatialFramesLibrary](SpatialFramesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the SpatialFramesLibrary instance for the given project.
Parameters:
...
getInstance
public static [SpatialFramesLibrary](SpatialFramesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the SpatialFramesLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class SpatialFramesLibrary">Class SpatialFramesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.SpatialFramesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">SpatialFramesLibrary</span>
...
<div class="block">Provides typed access to elements from the SpatialFrames standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SpatialFramesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">SpatialFramesLibrary</a></code></div>
...
<div class="block">Returns the SpatialFramesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SpatialFramesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">SpatialFramesLibrary</a></code></div>
...
<div class="block">Returns the SpatialFramesLibrary instance for the given project.</div>
</div>
...
<h3>SpatialFramesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SpatialFramesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a SpatialFramesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SpatialFramesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">SpatialFramesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the SpatialFramesLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SpatialFramesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">SpatialFramesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the SpatialFramesLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
