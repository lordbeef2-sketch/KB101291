# JAVA OPENAPI: NumericalFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/NumericalFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/NumericalFunctionsLibrary.html`
- source_sha256: `616f559b11f64d8fb4b9df3a024505206278bea17e88ed3d26d531affeb53472`
- captured_utc: `2026-07-14T16:44:46.067817+00:00`
...
## Class NumericalFunctionsLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.NumericalFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classNumericalFunctionsLibrary
...
Constructor
Description
`[NumericalFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a NumericalFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [NumericalFunctionsLibrary](NumericalFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the NumericalFunctionsLibrary instance for the project that owns the given element.
`static [NumericalFunctionsLibrary](NumericalFunctionsLibrary.html)`
...
Returns the NumericalFunctionsLibrary instance for the given project.
...
public NumericalFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a NumericalFunctionsLibrary for the given project.
Parameters:
...
public static [NumericalFunctionsLibrary](NumericalFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the NumericalFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [NumericalFunctionsLibrary](NumericalFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the NumericalFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class NumericalFunctionsLibrary">Class NumericalFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.NumericalFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">NumericalFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the NumericalFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="NumericalFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">NumericalFunctionsLibrary</a></code></div>
...
<div class="block">Returns the NumericalFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="NumericalFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">NumericalFunctionsLibrary</a></code></div>
...
<div class="block">Returns the NumericalFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>NumericalFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">NumericalFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a NumericalFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
