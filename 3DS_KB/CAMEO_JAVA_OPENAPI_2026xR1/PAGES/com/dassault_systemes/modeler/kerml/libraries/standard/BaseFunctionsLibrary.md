# JAVA OPENAPI: BaseFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/BaseFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/BaseFunctionsLibrary.html`
- source_sha256: `bd623b9af4180cdc4c5456ded1ef28b7f005350dce0219651cca8a07f39940cc`
- captured_utc: `2026-07-14T16:44:45.228810+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.BaseFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classBaseFunctionsLibrary
...
Description
`static class`
`[BaseFunctionsLibrary.HASHFunction](BaseFunctionsLibrary.HASHFunction.html)`
...
Constructor
Description
`[BaseFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a BaseFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [BaseFunctionsLibrary](BaseFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the BaseFunctionsLibrary instance for the project that owns the given element.
`static [BaseFunctionsLibrary](BaseFunctionsLibrary.html)`
...
Returns the BaseFunctionsLibrary instance for the given project.
...
`[BaseFunctionsLibrary.HASHFunction](BaseFunctionsLibrary.HASHFunction.html)`
`[HASH](#HASH())()`
Returns the wrapper for the HASH library element.
`boolean`
...
public BaseFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a BaseFunctionsLibrary for the given project.
Parameters:
...
public static [BaseFunctionsLibrary](BaseFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the BaseFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [BaseFunctionsLibrary](BaseFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the BaseFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
HASH
public [BaseFunctionsLibrary.HASHFunction](BaseFunctionsLibrary.HASHFunction.html) HASH()
Returns the wrapper for the HASH library element.
Returns:
the wrapper for the HASH element
getTypeWrappers
...
<h1 class="title" title="Class BaseFunctionsLibrary">Class BaseFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.BaseFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">BaseFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the BaseFunctions standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="BaseFunctionsLibrary.HASHFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary.HASHFunction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the HASHFunction library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BaseFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary</a></code></div>
...
<div class="block">Returns the BaseFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BaseFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary</a></code></div>
...
<div class="block">Returns the BaseFunctionsLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="BaseFunctionsLibrary.HASHFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary.HASHFunction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#HASH()">HASH</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the HASH library element.</div>
</div>
...
<h3>BaseFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BaseFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a BaseFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BaseFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the BaseFunctionsLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BaseFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the BaseFunctionsLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>HASH</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="BaseFunctionsLibrary.HASHFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BaseFunctionsLibrary.HASHFunction</a></span> <span class="element-name">HASH</span>()</div>
<div class="block">Returns the wrapper for the HASH library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the HASH element</dd>
</dl>
</section>
</li>
<li>
