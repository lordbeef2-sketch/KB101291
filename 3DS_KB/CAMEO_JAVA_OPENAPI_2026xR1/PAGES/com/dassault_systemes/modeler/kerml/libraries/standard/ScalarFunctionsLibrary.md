# JAVA OPENAPI: ScalarFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ScalarFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ScalarFunctionsLibrary.html`
- source_sha256: `babd1826da112b8f574fa3c62b19106312820b4a65585c703b991f99a4599bf0`
- captured_utc: `2026-07-14T16:44:46.804826+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.ScalarFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classScalarFunctionsLibrary
...
Constructor
Description
`[ScalarFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a ScalarFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ScalarFunctionsLibrary](ScalarFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the ScalarFunctionsLibrary instance for the project that owns the given element.
`static [ScalarFunctionsLibrary](ScalarFunctionsLibrary.html)`
...
Returns the ScalarFunctionsLibrary instance for the given project.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ScalarFunctionsLibrary
public ScalarFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ScalarFunctionsLibrary for the given project.
Parameters:
...
public static [ScalarFunctionsLibrary](ScalarFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ScalarFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [ScalarFunctionsLibrary](ScalarFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ScalarFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class ScalarFunctionsLibrary">Class ScalarFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ScalarFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ScalarFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the ScalarFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ScalarFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ScalarFunctionsLibrary</a></code></div>
...
<div class="block">Returns the ScalarFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ScalarFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ScalarFunctionsLibrary</a></code></div>
...
<div class="block">Returns the ScalarFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>ScalarFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ScalarFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ScalarFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
