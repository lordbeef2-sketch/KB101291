# JAVA OPENAPI: ClocksLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ClocksLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ClocksLibrary.html`
- source_sha256: `e62fa975f71ca085e109a02073aa5e9499ee34513744a4b3a3eb01b65a24010e`
- captured_utc: `2026-07-14T16:44:45.297808+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.ClocksLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classClocksLibrary
...
Description
`static class`
`[ClocksLibrary.ClockStructure](ClocksLibrary.ClockStructure.html)`
...
Constructor
Description
`[ClocksLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a ClocksLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[ClocksLibrary.ClockStructure](ClocksLibrary.ClockStructure.html)`
`[Clock](#Clock())()`
Returns the wrapper for the Clock library element.
`static [ClocksLibrary](ClocksLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the ClocksLibrary instance for the project that owns the given element.
`static [ClocksLibrary](ClocksLibrary.html)`
...
Returns the ClocksLibrary instance for the given project.
...
Constructor Details
ClocksLibrary
public ClocksLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ClocksLibrary for the given project.
Parameters:
...
public static [ClocksLibrary](ClocksLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ClocksLibrary instance for the given project.
Parameters:
...
getInstance
public static [ClocksLibrary](ClocksLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ClocksLibrary instance for the project that owns the given element.
Parameters:
...
Clock
public [ClocksLibrary.ClockStructure](ClocksLibrary.ClockStructure.html) Clock()
Returns the wrapper for the Clock library element.
Returns:
the wrapper for the Clock element
getTypeWrappers
...
<h1 class="title" title="Class ClocksLibrary">Class ClocksLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ClocksLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ClocksLibrary</span>
...
<div class="block">Provides typed access to elements from the Clocks standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ClocksLibrary.ClockStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary.ClockStructure</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the ClockStructure library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ClocksLibrary.ClockStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary.ClockStructure</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Clock()">Clock</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Clock library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ClocksLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary</a></code></div>
...
<div class="block">Returns the ClocksLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ClocksLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary</a></code></div>
...
<div class="block">Returns the ClocksLibrary instance for the given project.</div>
</div>
...
<h3>ClocksLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClocksLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ClocksLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ClocksLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the ClocksLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ClocksLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the ClocksLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>Clock</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ClocksLibrary.ClockStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ClocksLibrary.ClockStructure</a></span> <span class="element-name">Clock</span>()</div>
<div class="block">Returns the wrapper for the Clock library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Clock element</dd>
</dl>
</section>
</li>
<li>
