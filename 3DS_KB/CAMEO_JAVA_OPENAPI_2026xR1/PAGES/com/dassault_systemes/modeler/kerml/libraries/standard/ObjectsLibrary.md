# JAVA OPENAPI: ObjectsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ObjectsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ObjectsLibrary.html`
- source_sha256: `66aca42e7b14c5aa07e9901fe03c0f76fa129a2d87af447325788cbd0bb95845`
- captured_utc: `2026-07-14T16:44:46.224819+00:00`
...
@OpenApiAllpublic classObjectsLibrary
...
Description
`static class`
`[ObjectsLibrary.BinaryLinkObjectAssociationStructure](ObjectsLibrary.BinaryLinkObjectAssociationStructure.html)`
Type wrapper for the BinaryLinkObjectAssociationStructure library element.
`static class`
`[ObjectsLibrary.BinaryLinkObjectsFeature](ObjectsLibrary.BinaryLinkObjectsFeature.html)`
Type wrapper for the BinaryLinkObjectsFeature library element.
`static class`
`[ObjectsLibrary.LinkObjectAssociationStructure](ObjectsLibrary.LinkObjectAssociationStructure.html)`
Type wrapper for the LinkObjectAssociationStructure library element.
`static class`
`[ObjectsLibrary.LinkObjectsFeature](ObjectsLibrary.LinkObjectsFeature.html)`
Type wrapper for the LinkObjectsFeature library element.
`static class`
`[ObjectsLibrary.ObjectsFeature](ObjectsLibrary.ObjectsFeature.html)`
Type wrapper for the ObjectsFeature library element.
`static class`
`[ObjectsLibrary.ObjectStructure](ObjectsLibrary.ObjectStructure.html)`
...
Constructor
Description
`[ObjectsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
...
Constructor Details
ObjectsLibrary
public ObjectsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ObjectsLibrary for the given project.
Parameters:
...
public static [ObjectsLibrary](ObjectsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ObjectsLibrary instance for the given project.
Parameters:
...
getInstance
public static [ObjectsLibrary](ObjectsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ObjectsLibrary instance for the project that owns the given element.
Parameters:
...
Object
public [ObjectsLibrary.ObjectStructure](ObjectsLibrary.ObjectStructure.html) Object()
Returns the wrapper for the Object library element.
Returns:
the wrapper for the Object element
LinkObject
public [ObjectsLibrary.LinkObjectAssociationStructure](ObjectsLibrary.LinkObjectAssociationStructure.html) LinkObject()
Returns the wrapper for the LinkObject library element.
Returns:
the wrapper for the LinkObject element
BinaryLinkObject
public [ObjectsLibrary.BinaryLinkObjectAssociationStructure](ObjectsLibrary.BinaryLinkObjectAssociationStructure.html) BinaryLinkObject()
Returns the wrapper for the BinaryLinkObject library element.
Returns:
the wrapper for the BinaryLinkObject element
objects
public [ObjectsLibrary.ObjectsFeature](ObjectsLibrary.ObjectsFeature.html) objects()
Returns the wrapper for the objects library element.
Returns:
the wrapper for the objects element
linkObjects
public [ObjectsLibrary.LinkObjectsFeature](ObjectsLibrary.LinkObjectsFeature.html) linkObjects()
Returns the wrapper for the linkObjects library element.
Returns:
the wrapper for the linkObjects element
binaryLinkObjects
public [ObjectsLibrary.BinaryLinkObjectsFeature](ObjectsLibrary.BinaryLinkObjectsFeature.html) binaryLinkObjects()
Returns the wrapper for the binaryLinkObjects library element.
Returns:
...
<h1 class="title" title="Class ObjectsLibrary">Class ObjectsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ObjectsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ObjectsLibrary</span>
...
<div class="block">Provides typed access to elements from the Objects standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ObjectsLibrary.BinaryLinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectAssociationStructure</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the BinaryLinkObjectAssociationStructure library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ObjectsLibrary.BinaryLinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectsFeature</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the BinaryLinkObjectsFeature library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="ObjectsLibrary.LinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectAssociationStructure</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the LinkObjectAssociationStructure library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ObjectsLibrary.LinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectsFeature</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the LinkObjectsFeature library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="ObjectsLibrary.ObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectsFeature</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the ObjectsFeature library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ObjectsLibrary.ObjectStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectStructure</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the ObjectStructure library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.BinaryLinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectAssociationStructure</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#BinaryLinkObject()">BinaryLinkObject</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the BinaryLinkObject library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.BinaryLinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectsFeature</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#binaryLinkObjects()">binaryLinkObjects</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the binaryLinkObjects library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ObjectsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary</a></code></div>
...
<div class="block">Returns the ObjectsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ObjectsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary</a></code></div>
...
<div class="block">Returns the ObjectsLibrary instance for the given project.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.LinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectAssociationStructure</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#LinkObject()">LinkObject</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the LinkObject library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.LinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectsFeature</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#linkObjects()">linkObjects</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the linkObjects library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.ObjectStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectStructure</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Object()">Object</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Object library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ObjectsLibrary.ObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectsFeature</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the objects library element.</div>
</div>
...
<h3>ObjectsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ObjectsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ObjectsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>Object</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.ObjectStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectStructure</a></span> <span class="element-name">Object</span>()</div>
<div class="block">Returns the wrapper for the Object library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Object element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="LinkObject()">
<h3>LinkObject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.LinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectAssociationStructure</a></span> <span class="element-name">LinkObject</span>()</div>
<div class="block">Returns the wrapper for the LinkObject library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the LinkObject element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="BinaryLinkObject()">
<h3>BinaryLinkObject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.BinaryLinkObjectAssociationStructure.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectAssociationStructure</a></span> <span class="element-name">BinaryLinkObject</span>()</div>
<div class="block">Returns the wrapper for the BinaryLinkObject library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the BinaryLinkObject element</dd>
</dl>
</section>
</li>
<li>
...
<h3>objects</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.ObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.ObjectsFeature</a></span> <span class="element-name">objects</span>()</div>
<div class="block">Returns the wrapper for the objects library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the objects element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="linkObjects()">
<h3>linkObjects</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.LinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.LinkObjectsFeature</a></span> <span class="element-name">linkObjects</span>()</div>
<div class="block">Returns the wrapper for the linkObjects library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the linkObjects element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="binaryLinkObjects()">
<h3>binaryLinkObjects</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ObjectsLibrary.BinaryLinkObjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObjectsLibrary.BinaryLinkObjectsFeature</a></span> <span class="element-name">binaryLinkObjects</span>()</div>
<div class="block">Returns the wrapper for the binaryLinkObjects library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the binaryLinkObjects element</dd>
</dl>
</section>
</li>
<li>
