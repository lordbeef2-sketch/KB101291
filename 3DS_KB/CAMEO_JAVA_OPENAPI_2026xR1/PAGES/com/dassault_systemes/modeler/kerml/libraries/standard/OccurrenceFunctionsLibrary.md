# JAVA OPENAPI: OccurrenceFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/OccurrenceFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/OccurrenceFunctionsLibrary.html`
- source_sha256: `2ec64a38abba62357c1284a1a07855cfe7be0f11508e0d72d9f147ce22de7b54`
- captured_utc: `2026-07-14T16:44:46.233818+00:00`
...
## Class OccurrenceFunctionsLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.OccurrenceFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classOccurrenceFunctionsLibrary
...
Constructor
Description
`[OccurrenceFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a OccurrenceFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [OccurrenceFunctionsLibrary](OccurrenceFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the OccurrenceFunctionsLibrary instance for the project that owns the given element.
`static [OccurrenceFunctionsLibrary](OccurrenceFunctionsLibrary.html)`
...
Returns the OccurrenceFunctionsLibrary instance for the given project.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
OccurrenceFunctionsLibrary
public OccurrenceFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a OccurrenceFunctionsLibrary for the given project.
Parameters:
...
public static [OccurrenceFunctionsLibrary](OccurrenceFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the OccurrenceFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [OccurrenceFunctionsLibrary](OccurrenceFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the OccurrenceFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class OccurrenceFunctionsLibrary">Class OccurrenceFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.OccurrenceFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">OccurrenceFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the OccurrenceFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="OccurrenceFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrenceFunctionsLibrary</a></code></div>
...
<div class="block">Returns the OccurrenceFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="OccurrenceFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrenceFunctionsLibrary</a></code></div>
...
<div class="block">Returns the OccurrenceFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>OccurrenceFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">OccurrenceFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a OccurrenceFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="OccurrenceFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrenceFunctionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the OccurrenceFunctionsLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="OccurrenceFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrenceFunctionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the OccurrenceFunctionsLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
