# JAVA OPENAPI: OccurrencesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/OccurrencesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/OccurrencesLibrary.html`
- source_sha256: `7451a10ae9717823db5ebe3367037befe5d6a45a449ca0c545ec03669edfc743`
- captured_utc: `2026-07-14T16:44:46.488821+00:00`
...
@OpenApiAllpublic classOccurrencesLibrary
...
Description
`static class`
`[OccurrencesLibrary.HappensBeforeLinksFeature](OccurrencesLibrary.HappensBeforeLinksFeature.html)`
Type wrapper for the HappensBeforeLinksFeature library element.
`static class`
`[OccurrencesLibrary.HappensLinkAssociation](OccurrencesLibrary.HappensLinkAssociation.html)`
Type wrapper for the HappensLinkAssociation library element.
`static class`
`[OccurrencesLibrary.LifeClass](OccurrencesLibrary.LifeClass.html)`
Type wrapper for the LifeClass library element.
`static class`
`[OccurrencesLibrary.OccurrenceClass](OccurrencesLibrary.OccurrenceClass.html)`
Type wrapper for the OccurrenceClass library element.
`static class`
`[OccurrencesLibrary.OccurrencesFeature](OccurrencesLibrary.OccurrencesFeature.html)`
...
Constructor
Description
`[OccurrencesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a OccurrencesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [OccurrencesLibrary](OccurrencesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the OccurrencesLibrary instance for the project that owns the given element.
`static [OccurrencesLibrary](OccurrencesLibrary.html)`
...
Returns the OccurrencesLibrary instance for the given project.
...
`[OccurrencesLibrary.HappensBeforeLinksFeature](OccurrencesLibrary.HappensBeforeLinksFeature.html)`
`[happensBeforeLinks](#happensBeforeLinks())()`
Returns the wrapper for the happensBeforeLinks library element.
`[OccurrencesLibrary.HappensLinkAssociation](OccurrencesLibrary.HappensLinkAssociation.html)`
`[HappensLink](#HappensLink())()`
Returns the wrapper for the HappensLink library element.
`boolean`
`[isSemantic](#isSemantic())()`
Returns whether this library is treated as semantic.
`[OccurrencesLibrary.LifeClass](OccurrencesLibrary.LifeClass.html)`
`[Life](#Life())()`
Returns the wrapper for the Life library element.
`[OccurrencesLibrary.OccurrenceClass](OccurrencesLibrary.OccurrenceClass.html)`
`[Occurrence](#Occurrence())()`
Returns the wrapper for the Occurrence library element.
`[OccurrencesLibrary.OccurrencesFeature](OccurrencesLibrary.OccurrencesFeature.html)`
`[occurrences](#occurrences())()`
Returns the wrapper for the occurrences library element.
...
Constructor Details
OccurrencesLibrary
public OccurrencesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a OccurrencesLibrary for the given project.
Parameters:
...
public static [OccurrencesLibrary](OccurrencesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the OccurrencesLibrary instance for the given project.
Parameters:
...
getInstance
public static [OccurrencesLibrary](OccurrencesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the OccurrencesLibrary instance for the project that owns the given element.
Parameters:
...
Occurrence
public [OccurrencesLibrary.OccurrenceClass](OccurrencesLibrary.OccurrenceClass.html) Occurrence()
Returns the wrapper for the Occurrence library element.
Returns:
the wrapper for the Occurrence element
Life
public [OccurrencesLibrary.LifeClass](OccurrencesLibrary.LifeClass.html) Life()
Returns the wrapper for the Life library element.
Returns:
the wrapper for the Life element
occurrences
public [OccurrencesLibrary.OccurrencesFeature](OccurrencesLibrary.OccurrencesFeature.html) occurrences()
Returns the wrapper for the occurrences library element.
Returns:
the wrapper for the occurrences element
HappensLink
public [OccurrencesLibrary.HappensLinkAssociation](OccurrencesLibrary.HappensLinkAssociation.html) HappensLink()
Returns the wrapper for the HappensLink library element.
Returns:
the wrapper for the HappensLink element
happensBeforeLinks
public [OccurrencesLibrary.HappensBeforeLinksFeature](OccurrencesLibrary.HappensBeforeLinksFeature.html) happensBeforeLinks()
Returns the wrapper for the happensBeforeLinks library element.
Returns:
...
<h1 class="title" title="Class OccurrencesLibrary">Class OccurrencesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.OccurrencesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">OccurrencesLibrary</span>
...
<div class="block">Provides typed access to elements from the Occurrences standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="OccurrencesLibrary.HappensBeforeLinksFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensBeforeLinksFeature</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the HappensBeforeLinksFeature library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="OccurrencesLibrary.HappensLinkAssociation.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensLinkAssociation</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the HappensLinkAssociation library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="OccurrencesLibrary.LifeClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.LifeClass</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the LifeClass library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="OccurrencesLibrary.OccurrenceClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrenceClass</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the OccurrenceClass library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="OccurrencesLibrary.OccurrencesFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrencesFeature</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the OccurrencesFeature library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="OccurrencesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary</a></code></div>
...
<div class="block">Returns the OccurrencesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="OccurrencesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary</a></code></div>
...
<div class="block">Returns the OccurrencesLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="OccurrencesLibrary.HappensBeforeLinksFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensBeforeLinksFeature</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#happensBeforeLinks()">happensBeforeLinks</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the happensBeforeLinks library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="OccurrencesLibrary.HappensLinkAssociation.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensLinkAssociation</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#HappensLink()">HappensLink</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the HappensLink library element.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="OccurrencesLibrary.LifeClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.LifeClass</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Life()">Life</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Life library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="OccurrencesLibrary.OccurrenceClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrenceClass</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Occurrence()">Occurrence</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Occurrence library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="OccurrencesLibrary.OccurrencesFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrencesFeature</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the occurrences library element.</div>
</div>
...
<h3>OccurrencesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">OccurrencesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a OccurrencesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="Occurrence()">
<h3>Occurrence</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="OccurrencesLibrary.OccurrenceClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrenceClass</a></span> <span class="element-name">Occurrence</span>()</div>
<div class="block">Returns the wrapper for the Occurrence library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Occurrence element</dd>
</dl>
</section>
</li>
<li>
...
<h3>Life</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="OccurrencesLibrary.LifeClass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.LifeClass</a></span> <span class="element-name">Life</span>()</div>
<div class="block">Returns the wrapper for the Life library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Life element</dd>
</dl>
</section>
</li>
<li>
...
<h3>occurrences</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="OccurrencesLibrary.OccurrencesFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.OccurrencesFeature</a></span> <span class="element-name">occurrences</span>()</div>
<div class="block">Returns the wrapper for the occurrences library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the occurrences element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="HappensLink()">
<h3>HappensLink</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="OccurrencesLibrary.HappensLinkAssociation.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensLinkAssociation</a></span> <span class="element-name">HappensLink</span>()</div>
<div class="block">Returns the wrapper for the HappensLink library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the HappensLink element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="happensBeforeLinks()">
<h3>happensBeforeLinks</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="OccurrencesLibrary.HappensBeforeLinksFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">OccurrencesLibrary.HappensBeforeLinksFeature</a></span> <span class="element-name">happensBeforeLinks</span>()</div>
<div class="block">Returns the wrapper for the happensBeforeLinks library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the happensBeforeLinks element</dd>
</dl>
</section>
</li>
<li>
