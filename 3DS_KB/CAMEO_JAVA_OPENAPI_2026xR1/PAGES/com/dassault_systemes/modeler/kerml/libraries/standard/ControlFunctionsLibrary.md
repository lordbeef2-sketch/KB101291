# JAVA OPENAPI: ControlFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ControlFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ControlFunctionsLibrary.html`
- source_sha256: `74a064e73f8e8ca768ae55af98891e8440bd907acef27df353708a903021d5f3`
- captured_utc: `2026-07-14T16:44:45.450827+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.ControlFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classControlFunctionsLibrary
...
Description
`static class`
`[ControlFunctionsLibrary.CollectFunction](ControlFunctionsLibrary.CollectFunction.html)`
Type wrapper for the CollectFunction library element.
`static class`
`[ControlFunctionsLibrary.DOTFunction](ControlFunctionsLibrary.DOTFunction.html)`
Type wrapper for the DOTFunction library element.
`static class`
`[ControlFunctionsLibrary.SelectFunction](ControlFunctionsLibrary.SelectFunction.html)`
...
Constructor
Description
`[ControlFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a ControlFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[ControlFunctionsLibrary.CollectFunction](ControlFunctionsLibrary.CollectFunction.html)`
`[collect](#collect())()`
Returns the wrapper for the collect library element.
`[ControlFunctionsLibrary.DOTFunction](ControlFunctionsLibrary.DOTFunction.html)`
`[DOT](#DOT())()`
Returns the wrapper for the DOT library element.
`static [ControlFunctionsLibrary](ControlFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the ControlFunctionsLibrary instance for the project that owns the given element.
`static [ControlFunctionsLibrary](ControlFunctionsLibrary.html)`
...
Returns the ControlFunctionsLibrary instance for the given project.
...
`[ControlFunctionsLibrary.SelectFunction](ControlFunctionsLibrary.SelectFunction.html)`
`[select](#select())()`
Returns the wrapper for the select library element.
...
public ControlFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ControlFunctionsLibrary for the given project.
Parameters:
...
public static [ControlFunctionsLibrary](ControlFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ControlFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [ControlFunctionsLibrary](ControlFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ControlFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
DOT
public [ControlFunctionsLibrary.DOTFunction](ControlFunctionsLibrary.DOTFunction.html) DOT()
Returns the wrapper for the DOT library element.
Returns:
the wrapper for the DOT element
collect
public [ControlFunctionsLibrary.CollectFunction](ControlFunctionsLibrary.CollectFunction.html) collect()
Returns the wrapper for the collect library element.
Returns:
the wrapper for the collect element
select
public [ControlFunctionsLibrary.SelectFunction](ControlFunctionsLibrary.SelectFunction.html) select()
Returns the wrapper for the select library element.
Returns:
the wrapper for the select element
getTypeWrappers
...
<h1 class="title" title="Class ControlFunctionsLibrary">Class ControlFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ControlFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ControlFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the ControlFunctions standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ControlFunctionsLibrary.CollectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.CollectFunction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the CollectFunction library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ControlFunctionsLibrary.DOTFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.DOTFunction</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the DOTFunction library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="ControlFunctionsLibrary.SelectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.SelectFunction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the SelectFunction library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ControlFunctionsLibrary.CollectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.CollectFunction</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#collect()">collect</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the collect library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ControlFunctionsLibrary.DOTFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.DOTFunction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#DOT()">DOT</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the DOT library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ControlFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary</a></code></div>
...
<div class="block">Returns the ControlFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ControlFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary</a></code></div>
...
<div class="block">Returns the ControlFunctionsLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ControlFunctionsLibrary.SelectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.SelectFunction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#select()">select</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the select library element.</div>
</div>
</div>
</div>
</div>
...
<h3>ControlFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ControlFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ControlFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ControlFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the ControlFunctionsLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ControlFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the ControlFunctionsLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>DOT</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ControlFunctionsLibrary.DOTFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.DOTFunction</a></span> <span class="element-name">DOT</span>()</div>
<div class="block">Returns the wrapper for the DOT library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the DOT element</dd>
</dl>
</section>
</li>
<li>
...
<h3>collect</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ControlFunctionsLibrary.CollectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.CollectFunction</a></span> <span class="element-name">collect</span>()</div>
<div class="block">Returns the wrapper for the collect library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the collect element</dd>
</dl>
</section>
</li>
<li>
...
<h3>select</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ControlFunctionsLibrary.SelectFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlFunctionsLibrary.SelectFunction</a></span> <span class="element-name">select</span>()</div>
<div class="block">Returns the wrapper for the select library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the select element</dd>
</dl>
</section>
</li>
<li>
