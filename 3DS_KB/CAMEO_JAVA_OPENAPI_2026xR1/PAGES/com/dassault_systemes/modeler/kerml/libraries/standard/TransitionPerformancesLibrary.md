# JAVA OPENAPI: TransitionPerformancesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/TransitionPerformancesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/TransitionPerformancesLibrary.html`
- source_sha256: `2897b1bed92549648c316905dd04cfb6adc5b24c8e223f8b3aa6bb51dfdad1a6`
- captured_utc: `2026-07-14T16:44:47.150831+00:00`
...
## Class TransitionPerformancesLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.TransitionPerformancesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classTransitionPerformancesLibrary
...
Description
`static class`
`[TransitionPerformancesLibrary.TransitionPerformanceBehavior](TransitionPerformancesLibrary.TransitionPerformanceBehavior.html)`
...
Constructor
Description
`[TransitionPerformancesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a TransitionPerformancesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [TransitionPerformancesLibrary](TransitionPerformancesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the TransitionPerformancesLibrary instance for the project that owns the given element.
`static [TransitionPerformancesLibrary](TransitionPerformancesLibrary.html)`
...
Returns the TransitionPerformancesLibrary instance for the given project.
...
Returns the wrapper for the TransitionPerformance library element.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
TransitionPerformancesLibrary
public TransitionPerformancesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a TransitionPerformancesLibrary for the given project.
Parameters:
...
public static [TransitionPerformancesLibrary](TransitionPerformancesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the TransitionPerformancesLibrary instance for the given project.
Parameters:
...
getInstance
public static [TransitionPerformancesLibrary](TransitionPerformancesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the TransitionPerformancesLibrary instance for the project that owns the given element.
Parameters:
...
public [TransitionPerformancesLibrary.TransitionPerformanceBehavior](TransitionPerformancesLibrary.TransitionPerformanceBehavior.html) TransitionPerformance()
Returns the wrapper for the TransitionPerformance library element.
Returns:
the wrapper for the TransitionPerformance element
getTypeWrappers
...
<h1 class="title" title="Class TransitionPerformancesLibrary">Class TransitionPerformancesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.TransitionPerformancesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TransitionPerformancesLibrary</span>
...
<div class="block">Provides typed access to elements from the TransitionPerformances standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="TransitionPerformancesLibrary.TransitionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary.TransitionPerformanceBehavior</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the TransitionPerformanceBehavior library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TransitionPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary</a></code></div>
...
<div class="block">Returns the TransitionPerformancesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TransitionPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary</a></code></div>
...
<div class="block">Returns the TransitionPerformancesLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TransitionPerformancesLibrary.TransitionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary.TransitionPerformanceBehavior</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TransitionPerformance()">TransitionPerformance</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the TransitionPerformance library element.</div>
</div>
</div>
</div>
</div>
...
<h3>TransitionPerformancesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TransitionPerformancesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a TransitionPerformancesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TransitionPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the TransitionPerformancesLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TransitionPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the TransitionPerformancesLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="TransitionPerformance()">
<h3>TransitionPerformance</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TransitionPerformancesLibrary.TransitionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransitionPerformancesLibrary.TransitionPerformanceBehavior</a></span> <span class="element-name">TransitionPerformance</span>()</div>
<div class="block">Returns the wrapper for the TransitionPerformance library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the TransitionPerformance element</dd>
</dl>
</section>
</li>
<li>
