# JAVA OPENAPI: ConjugatedPortDefinition (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/ConjugatedPortDefinition.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/ConjugatedPortDefinition.html`
- source_sha256: `2452d1c914ac5bac95588193a8223fe576d387d6619a163ee11b02e932e828ba`
- captured_utc: `2026-07-14T16:45:03.419048+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Class](../../../kerml/model/kerml/Class.html)`, `[Classifier](../../../kerml/model/kerml/Classifier.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Definition](Definition.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `[Namespace](../../../kerml/model/kerml/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[OccurrenceDefinition](OccurrenceDefinition.html)`, `[PortDefinition](PortDefinition.html)`, `[Structure](../../../kerml/model/kerml/Structure.html)`, `[Type](../../../kerml/model/kerml/Type.html)`

@OpenApiAllpublic interfaceConjugatedPortDefinitionextends [PortDefinition](PortDefinition.html)
...
`[getOriginalPortDefinition](#getOriginalPortDefinition())()`
...
`[PortConjugation](PortConjugation.html)`
`[getOwnedPortConjugator](#getOwnedPortConjugator())()`
...
Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.[PortDefinition](PortDefinition.html)
`[getConjugatedPortDefinition](PortDefinition.html#getConjugatedPortDefinition())`
...
============ METHOD DETAIL ========== 
Method Details
getOriginalPortDefinition
@CheckForNull[PortDefinition](PortDefinition.html) getOriginalPortDefinition()
The original `PortDefinition` for this `ConjugatedPortDefinition`, which is the `owningNamespace` of the `ConjugatedPortDefinition`.
Returns:
the originalPortDefinition value
Model:
derived="true"
 transient="true"
 opposite=[`PortDefinition.getConjugatedPortDefinition()`](PortDefinition.html#getConjugatedPortDefinition())
getOwnedPortConjugator
@CheckForNull[PortConjugation](PortConjugation.html) getOwnedPortConjugator()
The `PortConjugation` that is the `ownedConjugator` of this `ConjugatedPortDefinition`, linking it to its `originalPortDefinition`.
Returns:
the ownedPortConjugator value
Model:
derived="true"
 transient="true"
 opposite=[`PortConjugation.getConjugatedPortDefinition()`](PortConjugation.html#getConjugatedPortDefinition())
effectiveName
...
Specified by:
`[effectiveName](../../../kerml/model/kerml/Element.html#effectiveName())` in interface `[Element](../../../kerml/model/kerml/Element.html)`
...
<h1 class="title" title="Interface ConjugatedPortDefinition">Interface ConjugatedPortDefinition</h1>
</div>
...
<div class="block">If the <code>name</code> of the <code>originalPortDefinition</code> is non-empty, then return that with the character <code>~</code> prepended.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOriginalPortDefinition()">getOriginalPortDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The original <code>PortDefinition</code> for this <code>ConjugatedPortDefinition</code>, which is the <code>owningNamespace</code> of the <code>ConjugatedPortDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="PortConjugation.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortConjugation</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedPortConjugator()">getOwnedPortConjugator</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>PortConjugation</code> that is the <code>ownedConjugator</code> of this <code>ConjugatedPortDefinition</code>, linking it to its <code>originalPortDefinition</code>.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.sysml.model.sysml.PortDefinition">Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.<a href="PortDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortDefinition</a></h3>
<code><a href="PortDefinition.html#getConjugatedPortDefinition()">getConjugatedPortDefinition</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getOriginalPortDefinition()">
<h3>getOriginalPortDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="PortDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortDefinition</a></span> <span class="element-name">getOriginalPortDefinition</span>()</div>
<div class="block"><p>The original <code>PortDefinition</code> for this <code>ConjugatedPortDefinition</code>, which is the <code>owningNamespace</code> of the <code>ConjugatedPortDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the originalPortDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="PortDefinition.html#getConjugatedPortDefinition()"><code>PortDefinition.getConjugatedPortDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getOwnedPortConjugator()">
<h3>getOwnedPortConjugator</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="PortConjugation.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortConjugation</a></span> <span class="element-name">getOwnedPortConjugator</span>()</div>
<div class="block"><p>The <code>PortConjugation</code> that is the <code>ownedConjugator</code> of this <code>ConjugatedPortDefinition</code>, linking it to its <code>originalPortDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedPortConjugator value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="PortConjugation.html#getConjugatedPortDefinition()"><code>PortConjugation.getConjugatedPortDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>If the <code>name</code> of the <code>originalPortDefinition</code> is non-empty, then return that with the character <code>~</code> prepended.</p>
 let originalName : String = originalPortDefinition.name in
 if originalName = null then null
 else '~' + originalName
 endif</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="../../../kerml/model/kerml/Element.html#effectiveName()">effectiveName</a></code> in interface <code><a href="../../../kerml/model/kerml/Element.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Element</a></code></dd>
</dl>
</section>
</li>
</ul>
