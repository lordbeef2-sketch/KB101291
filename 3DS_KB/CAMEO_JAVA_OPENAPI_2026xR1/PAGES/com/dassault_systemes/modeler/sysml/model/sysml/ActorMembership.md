# JAVA OPENAPI: ActorMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/ActorMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/ActorMembership.html`
- source_sha256: `e76719c6e62ba3698067dbb43f130b686b9c1f632422c1af2a4969db9cb1b596`
- captured_utc: `2026-07-14T16:45:02.908041+00:00`
...
@OpenApiAllpublic interfaceActorMembershipextends [ParameterMembership](../../../kerml/model/kerml/ParameterMembership.html)
...
`[getOwnedActorParameter](#getOwnedActorParameter())()`
The `PartUsage` specifying the actor.
`void`
`[setOwnedActorParameter](#setOwnedActorParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage))([PartUsage](PartUsage.html) value)`
The `PartUsage` specifying the actor.
...
@CheckForNull[PartUsage](PartUsage.html) getOwnedActorParameter()
The `PartUsage` specifying the actor.
Returns:
the ownedActorParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningActorMembership"
setOwnedActorParameter
void setOwnedActorParameter(@CheckForNull
 [PartUsage](PartUsage.html) value)
The `PartUsage` specifying the actor.
Parameters:
`value` - the ownedActorParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningActorMembership"
...
<h1 class="title" title="Interface ActorMembership">Interface ActorMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ActorMembership</span><span class="extends-implements">
...
<div class="block"><p>An <code>ActorMembership</code> is a <code>ParameterMembership</code> that identifies a <code>PartUsage</code> as an <em>actor</em> <code>parameter</code>, which specifies a role played by an external entity in interaction with the <code>owningType</code> of the <code>ActorMembership</code>.</p>
 owningType.oclIsKindOf(RequirementUsage) or
 owningType.oclIsKindOf(RequirementDefinition) or
 owningType.oclIsKindOf(CaseDefinition) or
 owningType.oclIsKindOf(CaseUsage)</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedActorParameter()">getOwnedActorParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>PartUsage</code> specifying the actor.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedActorParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage)">setOwnedActorParameter</a><wbr/>(<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a> value)</code></div>
...
<li>
<section class="detail" id="getOwnedActorParameter()">
<h3>getOwnedActorParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a></span> <span class="element-name">getOwnedActorParameter</span>()</div>
<div class="block"><p>The <code>PartUsage</code> specifying the actor.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedActorParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningActorMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedActorParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage)">
<h3>setOwnedActorParameter</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedActorParameter</span><wbr/><span class="parameters">(@CheckForNull
 <a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a> value)</span></div>
<div class="block"><p>The <code>PartUsage</code> specifying the actor.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedActorParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningActorMembership"</dd>
