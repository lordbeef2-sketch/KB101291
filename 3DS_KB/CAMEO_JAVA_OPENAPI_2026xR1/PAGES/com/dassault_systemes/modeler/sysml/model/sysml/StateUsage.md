# JAVA OPENAPI: StateUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/StateUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/StateUsage.html`
- source_sha256: `cd2a01be801adba2a248ae2a86418c24f03d2bc1c1fee059e55ea784f9802384`
- captured_utc: `2026-07-14T16:45:04.792066+00:00`
...
`[ExhibitStateUsage](ExhibitStateUsage.html)`

@OpenApiAllpublic interfaceStateUsageextends [ActionUsage](ActionUsage.html)

A `StateUsage` is an `ActionUsage` that is nominally the `Usage` of a `StateDefinition`. However, other kinds of kernel `Behaviors` are also allowed as `types`, to permit use of `Behaviorsinvalid input: '<'/code from the Kernel Model Libraries.`
...
`[getDoAction](#getDoAction())()`
The `ActionUsage` of this `StateUsage` to be performed while in the state defined by the `StateDefinition`.
`[ActionUsage](ActionUsage.html)`
`[getEntryAction](#getEntryAction())()`
The `ActionUsage` of this `StateUsage` to be performed on entry to the state defined by the `StateDefinition`.
`[ActionUsage](ActionUsage.html)`
`[getExitAction](#getExitAction())()`
The `ActionUsage` of this `StateUsage` to be performed on exit to the state defined by the `StateDefinition`.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Behavior](../../../kerml/model/kerml/Behavior.html)>`
`[getStateDefinition](#getStateDefinition())()`
The `Behaviors` that are the `types` of this `StateUsage`.
`boolean`
`[isParallel](#isParallel())()`
Whether the `nestedStates` of this `StateUsage` are to all be performed in parallel.
`boolean`
`[isSubstateUsage](#isSubstateUsage(boolean))(boolean isParallel)`
Check if this `StateUsage` is composite and has an `owningType` that is a `StateDefinition` or `StateUsage` with the given value of `isParallel`, but is *not* an `entryAction`, `doAction`, or `exitAction`.
`void`
`[setIsParallel](#setIsParallel(boolean))(boolean value)`
Whether the `nestedStates` of this `StateUsage` are to all be performed in parallel.
...
Method Details
getStateDefinition
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Behavior](../../../kerml/model/kerml/Behavior.html)> getStateDefinition()
...
Returns:
the stateDefinition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="definedState"
 redefines=[`ActionUsage.getActionDefinition()`](ActionUsage.html#getActionDefinition())
getEntryAction
@CheckForNull[ActionUsage](ActionUsage.html) getEntryAction()
...
Returns:
the entryAction value
Model:
derived="true"
 transient="true"
 oppositeRoleName="enteredState"
getDoAction
@CheckForNull[ActionUsage](ActionUsage.html) getDoAction()
...
derived="true"
 transient="true"
 oppositeRoleName="activeState"
getExitAction
@CheckForNull[ActionUsage](ActionUsage.html) getExitAction()
...
<h1 class="title" title="Interface StateUsage">Interface StateUsage</h1>
</div>
...
<dd><code><a href="ExhibitStateUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ExhibitStateUsage</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">StateUsage</span><span class="extends-implements">
...
<div class="block"><p>A <code>StateUsage</code> is an <code>ActionUsage</code> that is nominally the <code>Usage</code> of a <code>StateDefinition</code>. However, other kinds of kernel <code>Behaviors</code> are also allowed as <code>types</code>, to permit use of <code>Behaviors<span class="invalid-tag">invalid input: '&lt;'</span>/code from the Kernel Model Libraries.</code></p>
<p>A <code>StateUsage</code> may be related to up to three of its <code>ownedFeatures</code> by <code>StateSubactionMembership</code> <code>Relationships</code>, all of different <code>kinds</code>, corresponding to the entry, do and exit actions of the <code>StateUsage</code>.</p>
 ...
 (owningType.oclIsKindOf(PartDefinition) or
  owningType.oclIsKindOf(PartUsage)) implies
     specializesFromLibrary('Parts::Part::ownedStates')</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDoAction()">getDoAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed while in the state defined by the <code>StateDefinition</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getEntryAction()">getEntryAction</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed on entry to the state defined by the <code>StateDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExitAction()">getExitAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed on exit to the state defined by the <code>StateDefinition</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getStateDefinition()">getStateDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Behaviors</code> that are the <code>types</code> of this <code>StateUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isParallel()">isParallel</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether the <code>nestedStates</code> of this <code>StateUsage</code> are to all be performed in parallel.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isSubstateUsage(boolean)">isSubstateUsage</a><wbr/>(boolean isParallel)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Check if this <code>StateUsage</code> is composite and has an <code>owningType</code> that is a <code>StateDefinition</code> or <code>StateUsage</code> with the given value of <code>isParallel</code>, but is <em>not</em> an <code>entryAction</code>, <code>doAction</code>, or <code>exitAction</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setIsParallel(boolean)">setIsParallel</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether the <code>nestedStates</code> of this <code>StateUsage</code> are to all be performed in parallel.</div>
</div>
</div>
...
<li>
<section class="detail" id="getStateDefinition()">
<h3>getStateDefinition</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../kerml/model/kerml/Behavior.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Behavior</a>&gt;</span> <span class="element-name">getStateDefinition</span>()</div>
<div class="block"><p>The <code>Behaviors</code> that are the <code>types</code> of this <code>StateUsage</code>. Nominally, these would be <code>StateDefinitions</code>, but kernel <code>Behaviors</code> are also allowed, to permit use of <code>Behaviors</code> from the Kernel Model Libraries.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the stateDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="definedState"
        redefines=<a href="ActionUsage.html#getActionDefinition()"><code>ActionUsage.getActionDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getEntryAction()">
<h3>getEntryAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getEntryAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed on entry to the state defined by the <code>StateDefinition</code>. It is the owned <code>ActionUsage</code> related to the <code>StateUsage</code> by a <code>StateSubactionMembership</code>  with <code>kind = entry</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the entryAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="enteredState"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getDoAction()">
<h3>getDoAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getDoAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed while in the state defined by the <code>StateDefinition</code>. It is the owned <code>ActionUsage</code> related to the <code>StateUsage</code> by a <code>StateSubactionMembership</code>  with <code>kind = do</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the doAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="activeState"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getExitAction()">
<h3>getExitAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getExitAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> of this <code>StateUsage</code> to be performed on exit to the state defined by the <code>StateDefinition</code>. It is the owned <code>ActionUsage</code> related to the <code>StateUsage</code> by a <code>StateSubactionMembership</code>  with <code>kind = exit</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the exitAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="exitedState"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isParallel()">
<h3>isParallel</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isParallel</span>()</div>
<div class="block"><p>Whether the <code>nestedStates</code> of this <code>StateUsage</code> are to all be performed in parallel. If true, none of the <code>nestedActions</code> (which include <code>nestedStates</code>) may have any incoming or outgoing <code>Transitions</code>. If false, only one <code>nestedState</code> may be performed at a time.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the isParallel value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
...
<li>
<section class="detail" id="setIsParallel(boolean)">
<h3>setIsParallel</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setIsParallel</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block"><p>Whether the <code>nestedStates</code> of this <code>StateUsage</code> are to all be performed in parallel. If true, none of the <code>nestedActions</code> (which include <code>nestedStates</code>) may have any incoming or outgoing <code>Transitions</code>. If false, only one <code>nestedState</code> may be performed at a time.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the isParallel value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
...
<li>
<section class="detail" id="isSubstateUsage(boolean)">
<h3>isSubstateUsage</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isSubstateUsage</span><wbr/><span class="parameters">(boolean isParallel)</span></div>
<div class="block"><p>Check if this <code>StateUsage</code> is composite and has an <code>owningType</code> that is a <code>StateDefinition</code> or <code>StateUsage</code> with the given value of <code>isParallel</code>, but is <em>not</em> an <code>entryAction</code>, <code>doAction</code>, or <code>exitAction</code>. If so, then it represents a <code><em>StateAction</em></code> that is a <code><em>substate</em></code> or <code><em>exclusiveState</em></code> (for <code>isParallel = false</code>) of another <code><em>StateAction</em></code>.</p>
 isComposite and owningType &lt;&gt; null and
 (owningType.oclIsKindOf(StateDefinition) and
     owningType.oclAsType(StateDefinition).isParallel = isParallel or
  owningType.oclIsKindOf(StateUsage) and
     owningType.oclAsType(StateUsage).isParallel = isParallel) and
 not owningFeatureMembership.oclIsKindOf(StateSubactionMembership)</div>
</section>
</li>
</ul>
</section>
