# JAVA OPENAPI: ViewDefinition (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/ViewDefinition.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/ViewDefinition.html`
- source_sha256: `4db7e4f17f916845d219bc744b17952a83fab8efccea6be3acbf3f848cbd5b9b`
- captured_utc: `2026-07-14T16:45:05.174072+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Class](../../../kerml/model/kerml/Class.html)`, `[Classifier](../../../kerml/model/kerml/Classifier.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Definition](Definition.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[ItemDefinition](ItemDefinition.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `[Namespace](../../../kerml/model/kerml/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[OccurrenceDefinition](OccurrenceDefinition.html)`, `[PartDefinition](PartDefinition.html)`, `[Structure](../../../kerml/model/kerml/Structure.html)`, `[Type](../../../kerml/model/kerml/Type.html)`

@OpenApiAllpublic interfaceViewDefinitionextends [PartDefinition](PartDefinition.html)
...
Method Details
getView
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ViewUsage](ViewUsage.html)> getView()
The `usages` of this `ViewDefinition` that are `ViewUsages`.
Returns:
the view value
Model:
derived="true"
 transient="true"
 oppositeRoleName="featuringView"
...
derived="true"
 transient="true"
 oppositeRoleName="viewpointSatisfyingViewDefinition"
 subsets=[`Definition.getOwnedRequirement()`](Definition.html#getOwnedRequirement())
getViewRendering
...
derived="true"
 transient="true"
 oppositeRoleName="renderingOwningViewDefinition"
getViewCondition
...
derived="true"
 transient="true"
 oppositeRoleName="owningViewDefinition"
...
<h1 class="title" title="Interface ViewDefinition">Interface ViewDefinition</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ViewDefinition</span><span class="extends-implements">
extends <a href="PartDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartDefinition</a></span></div>
<div class="block"><p>A <code>ViewDefinition</code> is a <code>PartDefinition</code> that specifies how a view artifact is constructed to satisfy a <code>viewpoint</code>. It specifies a <code>viewConditions</code> to define the model content to be presented and a <code>viewRendering</code> to define how the model content is presented.</p>
 view = usage-&gt;selectByKind(ViewUsage)
 satisfiedViewpoint = ownedRequirement-&gt;
     selectByKind(ViewpointUsage)-&gt;
     select(isComposite)
 ...
 featureMembership-&gt;
     selectByKind(ViewRenderingMembership)-&gt;
     size() &lt;= 1
 specializesFromLibrary('Views::View')</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSatisfiedViewpoint()">getSatisfiedViewpoint</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The composite <code>ownedRequirements</code> of this <code>ViewDefinition</code> that are <code>ViewpointUsages</code> for viewpoints satisfied by the <code>ViewDefinition</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ViewUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewUsage</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getView()">getView</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>usages</code> of this <code>ViewDefinition</code> that are <code>ViewUsages</code>.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expressions</code> related to this <code>ViewDefinition</code> by <code>ElementFilterMemberships</code>, which specify conditions on <code>Elements</code> to be rendered in a view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getViewRendering()">getViewRendering</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>RenderingUsage</code> to be used to render views defined by this <code>ViewDefinition</code>, which is the <code>referencedRendering</code> of the <code>ViewRenderingMembership</code> of the <code>ViewDefinition</code>.</div>
</div>
</div>
</div>
</div>
...
<h3>getView</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ViewUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewUsage</a>&gt;</span> <span class="element-name">getView</span>()</div>
<div class="block"><p>The <code>usages</code> of this <code>ViewDefinition</code> that are <code>ViewUsages</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the view value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="featuringView"
...
<div class="block"><p>The composite <code>ownedRequirements</code> of this <code>ViewDefinition</code> that are <code>ViewpointUsages</code> for viewpoints satisfied by the <code>ViewDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="viewpointSatisfyingViewDefinition"
        subsets=<a href="Definition.html#getOwnedRequirement()"><code>Definition.getOwnedRequirement()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>RenderingUsage</code> to be used to render views defined by this <code>ViewDefinition</code>, which is the <code>referencedRendering</code> of the <code>ViewRenderingMembership</code> of the <code>ViewDefinition</code>.<p></p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="renderingOwningViewDefinition"</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>Expressions</code> related to this <code>ViewDefinition</code> by <code>ElementFilterMemberships</code>, which specify conditions on <code>Elements</code> to be rendered in a view.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningViewDefinition"</dd>
</dl>
</section>
</li>
</ul>
