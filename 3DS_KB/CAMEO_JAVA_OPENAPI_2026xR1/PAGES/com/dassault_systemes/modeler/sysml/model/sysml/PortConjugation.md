# JAVA OPENAPI: PortConjugation (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/PortConjugation.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/PortConjugation.html`
- source_sha256: `bb5ab861f85f65b3750b1c46e15dfb03b8cba2236064c588a0416be6c9893782`
- captured_utc: `2026-07-14T16:45:04.363060+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Conjugation](../../../kerml/model/kerml/Conjugation.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `org.eclipse.emf.common.notify.Notifier`, `[Relationship](../../../kerml/model/kerml/Relationship.html)`

@OpenApiAllpublic interfacePortConjugationextends [Conjugation](../../../kerml/model/kerml/Conjugation.html)
...
`void`
`[setOriginalPortDefinition](#setOriginalPortDefinition(com.dassault_systemes.modeler.sysml.model.sysml.PortDefinition))([PortDefinition](PortDefinition.html) value)`
The `PortDefinition` being conjugated.
...
Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.[Conjugation](../../../kerml/model/kerml/Conjugation.html)
`[getConjugatedType](../../../kerml/model/kerml/Conjugation.html#getConjugatedType()), [getOriginalType](../../../kerml/model/kerml/Conjugation.html#getOriginalType()), [getOwningType](../../../kerml/model/kerml/Conjugation.html#getOwningType()), [setConjugatedType](../../../kerml/model/kerml/Conjugation.html#setConjugatedType(com.dassault_systemes.modeler.kerml.model.kerml.Type)), [setOriginalType](../../../kerml/model/kerml/Conjugation.html#setOriginalType(com.dassault_systemes.modeler.kerml.model.kerml.Type))`
...
derived="false"
 transient="false"
 oppositeRoleName="portConjugation"
setOriginalPortDefinition
void setOriginalPortDefinition(@CheckForNull
 [PortDefinition](PortDefinition.html) value)
The `PortDefinition` being conjugated.
Parameters:
`value` - the originalPortDefinition value
Model:
derived="false"
 transient="false"
 oppositeRoleName="portConjugation"
...
derived="true"
 transient="true"
 opposite=[`ConjugatedPortDefinition.getOwnedPortConjugator()`](ConjugatedPortDefinition.html#getOwnedPortConjugator())
...
<h1 class="title" title="Interface PortConjugation">Interface PortConjugation</h1>
</div>
...
<div class="block">The <code>ConjugatedPortDefinition</code> that is conjugate to the <code>originalPortDefinition</code>.</div>
</div>
...
<div class="block">The <code>PortDefinition</code> being conjugated.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOriginalPortDefinition(com.dassault_systemes.modeler.sysml.model.sysml.PortDefinition)">setOriginalPortDefinition</a><wbr/>(<a href="PortDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortDefinition</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>PortDefinition</code> being conjugated.</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.kerml.model.kerml.Conjugation">Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.<a href="../../../kerml/model/kerml/Conjugation.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Conjugation</a></h3>
<code><a href="../../../kerml/model/kerml/Conjugation.html#getConjugatedType()">getConjugatedType</a>, <a href="../../../kerml/model/kerml/Conjugation.html#getOriginalType()">getOriginalType</a>, <a href="../../../kerml/model/kerml/Conjugation.html#getOwningType()">getOwningType</a>, <a href="../../../kerml/model/kerml/Conjugation.html#setConjugatedType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setConjugatedType</a>, <a href="../../../kerml/model/kerml/Conjugation.html#setOriginalType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setOriginalType</a></code></div>
<div class="inherited-list">
...
<div class="block"><p>The <code>PortDefinition</code> being conjugated.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="false"
        transient="false"
        oppositeRoleName="portConjugation"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOriginalPortDefinition(com.dassault_systemes.modeler.sysml.model.sysml.PortDefinition)">
<h3>setOriginalPortDefinition</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOriginalPortDefinition</span><wbr/><span class="parameters">(@CheckForNull
 <a href="PortDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PortDefinition</a> value)</span></div>
<div class="block"><p>The <code>PortDefinition</code> being conjugated.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the originalPortDefinition value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="portConjugation"</dd>
...
<div class="block"><p>The <code>ConjugatedPortDefinition</code> that is conjugate to the <code>originalPortDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        opposite=<a href="ConjugatedPortDefinition.html#getOwnedPortConjugator()"><code>ConjugatedPortDefinition.getOwnedPortConjugator()</code></a></dd>
</dl>
</section>
</li>
</ul>
