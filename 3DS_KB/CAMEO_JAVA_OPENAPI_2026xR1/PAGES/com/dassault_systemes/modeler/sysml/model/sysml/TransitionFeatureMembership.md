# JAVA OPENAPI: TransitionFeatureMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/TransitionFeatureMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/TransitionFeatureMembership.html`
- source_sha256: `b5e46f4a043d43b49df89a2893aba9158e4fe61616bc6e80a0e3741b45e8d33a`
- captured_utc: `2026-07-14T16:45:05.049070+00:00`
...
@OpenApiAllpublic interfaceTransitionFeatureMembershipextends [FeatureMembership](../../../kerml/model/kerml/FeatureMembership.html)
...
Method
Description
`[TransitionFeatureKind](TransitionFeatureKind.html)`
`[getKind](#getKind())()`
Whether this `TransitionFeatureMembership` is for a `trigger`, `guard` or `effect`.
`[Step](../../../kerml/model/kerml/Step.html)`
`[getTransitionFeature](#getTransitionFeature())()`
The `Step` that is the `ownedMemberFeature` of this `TransitionFeatureMembership`.
`void`
`[setKind](#setKind(com.dassault_systemes.modeler.sysml.model.sysml.TransitionFeatureKind))([TransitionFeatureKind](TransitionFeatureKind.html) value)`
Whether this `TransitionFeatureMembership` is for a `trigger`, `guard` or `effect`.
`void`
`[setTransitionFeature](#setTransitionFeature(com.dassault_systemes.modeler.kerml.model.kerml.Step))([Step](../../../kerml/model/kerml/Step.html) value)`
The `Step` that is the `ownedMemberFeature` of this `TransitionFeatureMembership`.
...
Method Details
getKind
@CheckForNull[TransitionFeatureKind](TransitionFeatureKind.html) getKind()
Whether this `TransitionFeatureMembership` is for a `trigger`, `guard` or `effect`.
Returns:
the kind value
Model:
...
void setKind(@CheckForNull
 [TransitionFeatureKind](TransitionFeatureKind.html) value)
Whether this `TransitionFeatureMembership` is for a `trigger`, `guard` or `effect`.
Parameters:
...
derived="false"
 transient="false"
getTransitionFeature
@CheckForNull[Step](../../../kerml/model/kerml/Step.html) getTransitionFeature()
The `Step` that is the `ownedMemberFeature` of this `TransitionFeatureMembership`.
Returns:
the transitionFeature value
Model:
derived="true"
 transient="true"
 oppositeRoleName="transitionFeatureMembership"
setTransitionFeature
void setTransitionFeature(@CheckForNull
 [Step](../../../kerml/model/kerml/Step.html) value)
The `Step` that is the `ownedMemberFeature` of this `TransitionFeatureMembership`.
Parameters:
`value` - the transitionFeature value
Model:
derived="true"
 transient="true"
 oppositeRoleName="transitionFeatureMembership"
...
<h1 class="title" title="Interface TransitionFeatureMembership">Interface TransitionFeatureMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">TransitionFeatureMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>TransitionFeatureMembership</code> is a <code>FeatureMembership</code> for a trigger, guard or effect of a <code>TransitionUsage</code>, whose <code>transitionFeature</code> is a <code>AcceptActionUsage</code>, <em><code>Boolean</code></em>-valued <code>Expression</code> or <code>ActionUsage</code>, depending on its <code>kind</code>. </p>
 ...
 kind = TransitionFeatureKind::guard implies
     ...
     guard.result.multiplicity.hasBounds(1,1)
 kind = TransitionFeatureKind::effect implies
     transitionFeature.oclIsKindOf(ActionUsage)</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="TransitionFeatureKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">TransitionFeatureKind</a></code></div>
...
<div class="block">Whether this <code>TransitionFeatureMembership </code> is for a <code>trigger</code>, <code>guard</code> or <code>effect</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../../kerml/model/kerml/Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTransitionFeature()">getTransitionFeature</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Step</code> that is the <code>ownedMemberFeature</code> of this <code>TransitionFeatureMembership</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setKind(com.dassault_systemes.modeler.sysml.model.sysml.TransitionFeatureKind)">setKind</a><wbr/>(<a href="TransitionFeatureKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">TransitionFeatureKind</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether this <code>TransitionFeatureMembership </code> is for a <code>trigger</code>, <code>guard</code> or <code>effect</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTransitionFeature(com.dassault_systemes.modeler.kerml.model.kerml.Step)">setTransitionFeature</a><wbr/>(<a href="../../../kerml/model/kerml/Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Step</code> that is the <code>ownedMemberFeature</code> of this <code>TransitionFeatureMembership</code>.</div>
</div>
</div>
...
</span><span class="return-type"><a href="TransitionFeatureKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">TransitionFeatureKind</a></span> <span class="element-name">getKind</span>()</div>
<div class="block"><p>Whether this <code>TransitionFeatureMembership </code> is for a <code>trigger</code>, <code>guard</code> or <code>effect</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setKind(com.dassault_systemes.modeler.sysml.model.sysml.TransitionFeatureKind)">
<h3>setKind</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setKind</span><wbr/><span class="parameters">(@CheckForNull
 <a href="TransitionFeatureKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">TransitionFeatureKind</a> value)</span></div>
<div class="block"><p>Whether this <code>TransitionFeatureMembership </code> is for a <code>trigger</code>, <code>guard</code> or <code>effect</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="getTransitionFeature()">
<h3>getTransitionFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a></span> <span class="element-name">getTransitionFeature</span>()</div>
<div class="block"><p>The <code>Step</code> that is the <code>ownedMemberFeature</code> of this <code>TransitionFeatureMembership</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the transitionFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="transitionFeatureMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setTransitionFeature(com.dassault_systemes.modeler.kerml.model.kerml.Step)">
<h3>setTransitionFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTransitionFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../../kerml/model/kerml/Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a> value)</span></div>
<div class="block"><p>The <code>Step</code> that is the <code>ownedMemberFeature</code> of this <code>TransitionFeatureMembership</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the transitionFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="transitionFeatureMembership"</dd>
