# JAVA OPENAPI: StateSubactionMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/StateSubactionMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/StateSubactionMembership.html`
- source_sha256: `07b40f0de6e0bb6795ac73d8e3486f0e80b096577c632a43a90eb45b3f787c27`
- captured_utc: `2026-07-14T16:45:04.756065+00:00`
...
@OpenApiAllpublic interfaceStateSubactionMembershipextends [FeatureMembership](../../../kerml/model/kerml/FeatureMembership.html)

A `StateSubactionMembership` is a `FeatureMembership` for an entry, do or exit `ActionUsageof a StateDefinition or StateUsage.`
...
`[StateSubactionKind](StateSubactionKind.html)`
`[getKind](#getKind())()`
Whether this `StateSubactionMembership` is for an `entry, do or exit ActionUsage.`
`void`
`[setAction](#setAction(com.dassault_systemes.modeler.sysml.model.sysml.ActionUsage))([ActionUsage](ActionUsage.html) value)`
The `ActionUsage` that is the `ownedMemberFeature` of this `StateSubactionMembership`.
`void`
`[setKind](#setKind(com.dassault_systemes.modeler.sysml.model.sysml.StateSubactionKind))([StateSubactionKind](StateSubactionKind.html) value)`
Whether this `StateSubactionMembership` is for an `entry, do or exit ActionUsage.`
...
Method Details
getKind
@CheckForNull[StateSubactionKind](StateSubactionKind.html) getKind()
Whether this `StateSubactionMembership` is for an `entry, do or exit ActionUsage.`
Returns:
the kind value
Model:
...
void setKind(@CheckForNull
 [StateSubactionKind](StateSubactionKind.html) value)
Whether this `StateSubactionMembership` is for an `entry, do or exit ActionUsage.`
Parameters:
...
derived="false"
 transient="false"
getAction
@CheckForNull[ActionUsage](ActionUsage.html) getAction()
The `ActionUsage` that is the `ownedMemberFeature` of this `StateSubactionMembership`.
Returns:
the action value
Model:
derived="true"
 transient="true"
 oppositeRoleName="stateSubactionMembership"
setAction
void setAction(@CheckForNull
 [ActionUsage](ActionUsage.html) value)
The `ActionUsage` that is the `ownedMemberFeature` of this `StateSubactionMembership`.
Parameters:
...
<h1 class="title" title="Interface StateSubactionMembership">Interface StateSubactionMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">StateSubactionMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>StateSubactionMembership</code> is a <code>FeatureMembership</code> for an entry, do or exit <code>ActionUsage<code> of a <code>StateDefinition</code> or <code>StateUsage</code>.</code></code></p>
 owningType.oclIsKindOf(StateDefinition) or
 owningType.oclIsKindOf(StateUsage)</div>
</section>
...
<div class="block">The <code>ActionUsage</code> that is the <code>ownedMemberFeature</code> of this <code>StateSubactionMembership</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="StateSubactionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">StateSubactionKind</a></code></div>
...
<div class="block">Whether this <code>StateSubactionMembership</code> is for an <code>entry<code>, <code>do</code> or <code>exit</code> <code>ActionUsage</code>.</code></code></div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setAction(com.dassault_systemes.modeler.sysml.model.sysml.ActionUsage)">setAction</a><wbr/>(<a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> that is the <code>ownedMemberFeature</code> of this <code>StateSubactionMembership</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setKind(com.dassault_systemes.modeler.sysml.model.sysml.StateSubactionKind)">setKind</a><wbr/>(<a href="StateSubactionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">StateSubactionKind</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether this <code>StateSubactionMembership</code> is for an <code>entry<code>, <code>do</code> or <code>exit</code> <code>ActionUsage</code>.</code></code></div>
</div>
</div>
...
</span><span class="return-type"><a href="StateSubactionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">StateSubactionKind</a></span> <span class="element-name">getKind</span>()</div>
<div class="block"><p>Whether this <code>StateSubactionMembership</code> is for an <code>entry<code>, <code>do</code> or <code>exit</code> <code>ActionUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setKind(com.dassault_systemes.modeler.sysml.model.sysml.StateSubactionKind)">
<h3>setKind</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setKind</span><wbr/><span class="parameters">(@CheckForNull
 <a href="StateSubactionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">StateSubactionKind</a> value)</span></div>
<div class="block"><p>Whether this <code>StateSubactionMembership</code> is for an <code>entry<code>, <code>do</code> or <code>exit</code> <code>ActionUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> that is the <code>ownedMemberFeature</code> of this <code>StateSubactionMembership</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the action value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="stateSubactionMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setAction(com.dassault_systemes.modeler.sysml.model.sysml.ActionUsage)">
<h3>setAction</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setAction</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a> value)</span></div>
<div class="block"><p>The <code>ActionUsage</code> that is the <code>ownedMemberFeature</code> of this <code>StateSubactionMembership</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the action value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="stateSubactionMembership"</dd>
