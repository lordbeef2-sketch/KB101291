# JAVA OPENAPI: SubjectMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/SubjectMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/SubjectMembership.html`
- source_sha256: `ac8ab900202591b96dbac555c88a9ffd5a9e7e1a11b9e33e92428a49296ce31d`
- captured_utc: `2026-07-14T16:45:04.827067+00:00`
...
@OpenApiAllpublic interfaceSubjectMembershipextends [ParameterMembership](../../../kerml/model/kerml/ParameterMembership.html)
...
Description
`[Usage](Usage.html)`
`[getOwnedSubjectParameter](#getOwnedSubjectParameter())()`
The `Usageinvalid input: '<'/codeinvalid input: '<' that is the ownedMemberParameter of this SubjectMembership.`
`void`
`[setOwnedSubjectParameter](#setOwnedSubjectParameter(com.dassault_systemes.modeler.sysml.model.sysml.Usage))([Usage](Usage.html) value)`
The `Usageinvalid input: '<'/codeinvalid input: '<' that is the ownedMemberParameter of this SubjectMembership.`
...
@CheckForNull[Usage](Usage.html) getOwnedSubjectParameter()
The `Usageinvalid input: '<'/codeinvalid input: '<' that is the ownedMemberParameter of this SubjectMembership.`
Returns:
the ownedSubjectParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningSubjectMembership"
setOwnedSubjectParameter
void setOwnedSubjectParameter(@CheckForNull
 [Usage](Usage.html) value)
The `Usageinvalid input: '<'/codeinvalid input: '<' that is the ownedMemberParameter of this SubjectMembership.`
Parameters:
`value` - the ownedSubjectParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningSubjectMembership"
...
<h1 class="title" title="Interface SubjectMembership">Interface SubjectMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">SubjectMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>SubjectMembership</code> is a <code>ParameterMembership</code> that indicates that its <code>ownedSubjectParameter</code> is the subject of its <code>owningType</code>. The <code>owningType</code> of a <code>SubjectMembership</code> must be a <code>RequirementDefinition</code>, <code>RequirementUsage</code>, <code>CaseDefinition</code>, or <code>CaseUsage</code>.</p>
 owningType.oclIsType(RequirementDefinition) or
 owningType.oclIsType(RequiremenCaseRequirementDefinition) or
 owningType.oclIsType(CaseDefinition) or
 owningType.oclIsType(CaseUsage)</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedSubjectParameter()">getOwnedSubjectParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Usage<span class="invalid-tag">invalid input: '&lt;'</span>/code<span class="invalid-tag">invalid input: '&lt;'</span> that is the <code>ownedMemberParameter</code> of this <code>SubjectMembership</code>.</code></div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedSubjectParameter(com.dassault_systemes.modeler.sysml.model.sysml.Usage)">setOwnedSubjectParameter</a><wbr/>(<a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a> value)</code></div>
...
<li>
<section class="detail" id="getOwnedSubjectParameter()">
<h3>getOwnedSubjectParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a></span> <span class="element-name">getOwnedSubjectParameter</span>()</div>
<div class="block"><p>The <code>Usage<span class="invalid-tag">invalid input: '&lt;'</span>/code<span class="invalid-tag">invalid input: '&lt;'</span> that is the <code>ownedMemberParameter</code> of this <code>SubjectMembership</code>.</code></p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedSubjectParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningSubjectMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedSubjectParameter(com.dassault_systemes.modeler.sysml.model.sysml.Usage)">
<h3>setOwnedSubjectParameter</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedSubjectParameter</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a> value)</span></div>
<div class="block"><p>The <code>Usage<span class="invalid-tag">invalid input: '&lt;'</span>/code<span class="invalid-tag">invalid input: '&lt;'</span> that is the <code>ownedMemberParameter</code> of this <code>SubjectMembership</code>.</code></p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedSubjectParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningSubjectMembership"</dd>
