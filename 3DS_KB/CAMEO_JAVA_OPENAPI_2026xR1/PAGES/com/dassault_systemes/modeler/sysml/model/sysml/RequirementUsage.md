# JAVA OPENAPI: RequirementUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/RequirementUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/RequirementUsage.html`
- source_sha256: `dec72d307c4a6f7e44ae221f4cce0b99227a31bec6da5c4f0e69f138dfb7b2d0`
- captured_utc: `2026-07-14T16:45:04.680064+00:00`
...
`[ConcernUsage](ConcernUsage.html)`, `[SatisfyRequirementUsage](SatisfyRequirementUsage.html)`, `[ViewpointUsage](ViewpointUsage.html)`

@OpenApiAllpublic interfaceRequirementUsageextends [ConstraintUsage](ConstraintUsage.html)
...
`[getActorParameter](#getActorParameter())()`
...
`[getAssumedConstraint](#getAssumedConstraint())()`
...
`[getFramedConcern](#getFramedConcern())()`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ConstraintUsage](ConstraintUsage.html)>`
`[getRequiredConstraint](#getRequiredConstraint())()`
...
`[RequirementDefinition](RequirementDefinition.html)`
...
`[getText](#getText())()`
An optional textual statement of the requirement represented by this `RequirementUsage`, derived from the `bodiesof the documentation of the RequirementUsage.`
`void`
`[setReqId](#setReqId(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)`
An optional modeler-specified identifier for this `RequirementUsage` (used, e.g., to link it to an original requirement text in some source document), which is the `declaredShortName` for the `RequirementUsage`.
...
@CheckForNull[RequirementDefinition](RequirementDefinition.html) getRequirementDefinition()
The `RequirementDefinition` that is the single `definition` of this `RequirementUsage`.
Returns:
the requirementDefinition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="definedRequirement"
 redefines=[`ConstraintUsage.getConstraintDefinition()`](ConstraintUsage.html#getConstraintDefinition())
getReqId
@CheckForNull[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getReqId()
An optional modeler-specified identifier for this `RequirementUsage` (used, e.g., to link it to an original requirement text in some source document), which is the `declaredShortName` for the `RequirementUsage`.
Returns:
the reqId value
Model:
...
derived="false"
 transient="false"
getText
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getText()
An optional textual statement of the requirement represented by this `RequirementUsage`, derived from the `bodiesof the documentation of the RequirementUsage.`
Returns:
the text value
Model:
...
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ConstraintUsage](ConstraintUsage.html)> getRequiredConstraint()
The owned `ConstraintUsages` that represent requirements of this `RequirementUsage`, which are the `ownedConstraints` of the `RequirementConstraintMemberships` of the `RequirementUsage` with `kind` = `requirement`.
Returns:
the requiredConstraint value
Model:
derived="true"
 transient="true"
 oppositeRoleName="requiringRequirement"
getAssumedConstraint
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ConstraintUsage](ConstraintUsage.html)> getAssumedConstraint()
The owned `ConstraintUsages` that represent assumptions of this `RequirementUsage`, derived as the `ownedConstraints` of the `RequirementConstraintMemberships` of the `RequirementUsage` with `kind` = `assumption`.
Returns:
the assumedConstraint value
Model:
derived="true"
 transient="true"
 oppositeRoleName="assumingRequirement"
getSubjectParameter
@CheckForNull[Usage](Usage.html) getSubjectParameter()
The `parameter` of this `RequirementUsage` that represents its subject.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="subjectOwningRequirement"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
getFramedConcern
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ConcernUsage](ConcernUsage.html)> getFramedConcern()
The `ConcernUsages` framed by this `RequirementUsage`, which are the `ownedConcerns` of all `FramedConcernMemberships` of the `RequirementUsage`.
Returns:
the framedConcern value
Model:
derived="true"
 transient="true"
 oppositeRoleName="framingRequirement"
 subsets=[`getRequiredConstraint()`](#getRequiredConstraint())
getActorParameter
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PartUsage](PartUsage.html)> getActorParameter()
The `parameters` of this `RequirementUsage` that represent actors involved in the requirement.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="actorOwningRequirement"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
getStakeholderParameter
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PartUsage](PartUsage.html)> getStakeholderParameter()
The `parameters` of this `RequirementUsage` that represent stakeholders for the requirement.
Returns:
the stakeholderParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="stakholderOwningRequirement"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
...
<h1 class="title" title="Interface RequirementUsage">Interface RequirementUsage</h1>
</div>
...
<dd><code><a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a></code>, <code><a href="SatisfyRequirementUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">SatisfyRequirementUsage</a></code>, <code><a href="ViewpointUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewpointUsage</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">RequirementUsage</span><span class="extends-implements">
extends <a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a></span></div>
<div class="block"><p>A <code>RequirementUsage</code> is a <code>Usage</code> of a <code>RequirementDefinition</code>.</p>
 actorParameter = featureMembership-&gt;
     selectByKind(ActorMembership).
     ownedActorParameter
 assumedConstraint = ownedFeatureMembership-&gt;
 ...
 owningFeatureMembership &lt;&gt; null and
 owningFeatureMembership.oclIsKindOf(RequirementVerificationMembership) implies
     specializesFromLibrary('VerificationCases::VerificationCase::obj::requirementVerifications')</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getActorParameter()">getActorParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameters</code> of this <code>RequirementUsage</code> that represent actors involved in the requirement.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getAssumedConstraint()">getAssumedConstraint</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>ConstraintUsages</code> that represent assumptions of this <code>RequirementUsage</code>, derived as the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementUsage</code> with <code>kind</code> = <code>assumption</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getFramedConcern()">getFramedConcern</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ConcernUsages</code> framed by this <code>RequirementUsage</code>, which are the <code>ownedConcerns</code> of all <code>FramedConcernMemberships</code> of the <code>RequirementUsage</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReqId()">getReqId</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional modeler-specified identifier for this <code>RequirementUsage</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRequiredConstraint()">getRequiredConstraint</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>ConstraintUsages</code> that represent requirements of this <code>RequirementUsage</code>, which are the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementUsage</code> with <code>kind</code> = <code>requirement</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="RequirementDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RequirementDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRequirementDefinition()">getRequirementDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>RequirementDefinition</code> that is the single <code>definition</code> of this <code>RequirementUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getStakeholderParameter()">getStakeholderParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameters</code> of this <code>RequirementUsage</code> that represent stakeholders for the requirement.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSubjectParameter()">getSubjectParameter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameter</code> of this <code>RequirementUsage</code> that represents its subject.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional textual statement of the requirement represented by this <code>RequirementUsage</code>, derived from the <code>bodies<code> of the <code>documentation</code> of the <code>RequirementUsage</code>.</code></code></div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setReqId(java.lang.String)">setReqId</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional modeler-specified identifier for this <code>RequirementUsage</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementUsage</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getRequirementDefinition()">
<h3>getRequirementDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="RequirementDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RequirementDefinition</a></span> <span class="element-name">getRequirementDefinition</span>()</div>
<div class="block"><p>The <code>RequirementDefinition</code> that is the single <code>definition</code> of this <code>RequirementUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the requirementDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="definedRequirement"
        redefines=<a href="ConstraintUsage.html#getConstraintDefinition()"><code>ConstraintUsage.getConstraintDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getReqId()">
<h3>getReqId</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getReqId</span>()</div>
<div class="block"><p>An optional modeler-specified identifier for this <code>RequirementUsage</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the reqId value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
...
<li>
<section class="detail" id="setReqId(java.lang.String)">
<h3>setReqId</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setReqId</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the reqId value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
...
<h3>getText</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">getText</span>()</div>
<div class="block"><p>An optional textual statement of the requirement represented by this <code>RequirementUsage</code>, derived from the <code>bodies<code> of the <code>documentation</code> of the <code>RequirementUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="getRequiredConstraint()">
<h3>getRequiredConstraint</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a>&gt;</span> <span class="element-name">getRequiredConstraint</span>()</div>
<div class="block"><p>The owned <code>ConstraintUsages</code> that represent requirements of this <code>RequirementUsage</code>, which are the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementUsage</code> with <code>kind</code> = <code>requirement</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the requiredConstraint value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="requiringRequirement"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getAssumedConstraint()">
<h3>getAssumedConstraint</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a>&gt;</span> <span class="element-name">getAssumedConstraint</span>()</div>
<div class="block"><p>The owned <code>ConstraintUsages</code> that represent assumptions of this <code>RequirementUsage</code>, derived as the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementUsage</code> with <code>kind</code> = <code>assumption</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the assumedConstraint value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="assumingRequirement"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSubjectParameter()">
<h3>getSubjectParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a></span> <span class="element-name">getSubjectParameter</span>()</div>
<div class="block"><p>The <code>parameter</code> of this <code>RequirementUsage</code> that represents its subject.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the subjectParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="subjectOwningRequirement"
        subsets=<a href="Usage.html#getUsage()"><code>Usage.getUsage()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getFramedConcern()">
<h3>getFramedConcern</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a>&gt;</span> <span class="element-name">getFramedConcern</span>()</div>
<div class="block"><p>The <code>ConcernUsages</code> framed by this <code>RequirementUsage</code>, which are the <code>ownedConcerns</code> of all <code>FramedConcernMemberships</code> of the <code>RequirementUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the framedConcern value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="framingRequirement"
        subsets=<a href="#getRequiredConstraint()"><code>getRequiredConstraint()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getActorParameter()">
<h3>getActorParameter</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a>&gt;</span> <span class="element-name">getActorParameter</span>()</div>
<div class="block"><p>The <code>parameters</code> of this <code>RequirementUsage</code> that represent actors involved in the requirement.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the actorParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="actorOwningRequirement"
...
<li>
<section class="detail" id="getStakeholderParameter()">
<h3>getStakeholderParameter</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a>&gt;</span> <span class="element-name">getStakeholderParameter</span>()</div>
<div class="block"><p>The <code>parameters</code> of this <code>RequirementUsage</code> that represent stakeholders for the requirement.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the stakeholderParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="stakholderOwningRequirement"
