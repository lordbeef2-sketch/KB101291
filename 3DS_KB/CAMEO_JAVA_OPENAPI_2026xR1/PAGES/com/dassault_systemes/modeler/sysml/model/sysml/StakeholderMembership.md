# JAVA OPENAPI: StakeholderMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/StakeholderMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/StakeholderMembership.html`
- source_sha256: `d8778c1d4318a51522141b58981841d272207f557a6c651fdb04ab40fce4d369`
- captured_utc: `2026-07-14T16:45:04.817071+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[FeatureMembership](../../../kerml/model/kerml/FeatureMembership.html)`, `[Membership](../../../kerml/model/kerml/Membership.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `org.eclipse.emf.common.notify.Notifier`, `[OwningMembership](../../../kerml/model/kerml/OwningMembership.html)`, `[ParameterMembership](../../../kerml/model/kerml/ParameterMembership.html)`, `[Relationship](../../../kerml/model/kerml/Relationship.html)`

@OpenApiAllpublic interfaceStakeholderMembershipextends [ParameterMembership](../../../kerml/model/kerml/ParameterMembership.html)
...
Method
Description
`[PartUsage](PartUsage.html)`
`[getOwnedStakeholderParameter](#getOwnedStakeholderParameter())()`
The `PartUsage` specifying the stakeholder.
`void`
`[setOwnedStakeholderParameter](#setOwnedStakeholderParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage))([PartUsage](PartUsage.html) value)`
The `PartUsage` specifying the stakeholder.
...
Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.[ParameterMembership](../../../kerml/model/kerml/ParameterMembership.html)
`[getOwnedMemberParameter](../../../kerml/model/kerml/ParameterMembership.html#getOwnedMemberParameter()), [parameterDirection](../../../kerml/model/kerml/ParameterMembership.html#parameterDirection()), [setOwnedMemberParameter](../../../kerml/model/kerml/ParameterMembership.html#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature))`
...
@CheckForNull[PartUsage](PartUsage.html) getOwnedStakeholderParameter()
The `PartUsage` specifying the stakeholder.
Returns:
the ownedStakeholderParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningStakeholderMembership"
setOwnedStakeholderParameter
void setOwnedStakeholderParameter(@CheckForNull
 [PartUsage](PartUsage.html) value)
The `PartUsage` specifying the stakeholder.
Parameters:
`value` - the ownedStakeholderParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningStakeholderMembership"
...
<h1 class="title" title="Interface StakeholderMembership">Interface StakeholderMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">StakeholderMembership</span><span class="extends-implements">
extends <a href="../../../kerml/model/kerml/ParameterMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">ParameterMembership</a></span></div>
<div class="block"><p>A <code>StakeholderMembership</code> is a <code>ParameterMembership</code> that identifies a <code>PartUsage</code> as a <code>stakeholderParameter</code> of a <code>RequirementDefinition</code> or <code>RequirementUsage</code>, which specifies a role played by an entity with concerns framed by the <code>owningType</code>.</p>
 owningType.oclIsKindOf(RequirementUsage) or
 owningType.oclIsKindOf(RequirementDefinition)</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedStakeholderParameter()">getOwnedStakeholderParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>PartUsage</code> specifying the stakeholder.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedStakeholderParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage)">setOwnedStakeholderParameter</a><wbr/>(<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a> value)</code></div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.kerml.model.kerml.ParameterMembership">Methods inherited from interface com.dassault_systemes.modeler.kerml.model.kerml.<a href="../../../kerml/model/kerml/ParameterMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">ParameterMembership</a></h3>
<code><a href="../../../kerml/model/kerml/ParameterMembership.html#getOwnedMemberParameter()">getOwnedMemberParameter</a>, <a href="../../../kerml/model/kerml/ParameterMembership.html#parameterDirection()">parameterDirection</a>, <a href="../../../kerml/model/kerml/ParameterMembership.html#setOwnedMemberParameter(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setOwnedMemberParameter</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getOwnedStakeholderParameter()">
<h3>getOwnedStakeholderParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a></span> <span class="element-name">getOwnedStakeholderParameter</span>()</div>
<div class="block"><p>The <code>PartUsage</code> specifying the stakeholder.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedStakeholderParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningStakeholderMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedStakeholderParameter(com.dassault_systemes.modeler.sysml.model.sysml.PartUsage)">
<h3>setOwnedStakeholderParameter</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedStakeholderParameter</span><wbr/><span class="parameters">(@CheckForNull
 <a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a> value)</span></div>
<div class="block"><p>The <code>PartUsage</code> specifying the stakeholder.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedStakeholderParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningStakeholderMembership"</dd>
