# JAVA OPENAPI: StateDefinition (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/StateDefinition.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/StateDefinition.html`
- source_sha256: `a2cd36e95260fce68557fbc6d4e6b6043119c791f63b50b9c204ceb735ded095`
- captured_utc: `2026-07-14T16:45:04.744066+00:00`
...
The `ActionUsage` of this `StateDefinition` to be performed while in the state defined by the `StateDefinition`.
`[ActionUsage](ActionUsage.html)`
`[getEntryAction](#getEntryAction())()`
The `ActionUsage` of this `StateDefinition` to be performed on entry to the state defined by the `StateDefinition`.
`[ActionUsage](ActionUsage.html)`
`[getExitAction](#getExitAction())()`
The `ActionUsage` of this `StateDefinition` to be performed on exit to the state defined by the `StateDefinition`.
...
Whether the `ownedStates` of this `StateDefinition` are to all be performed in parallel.
`void`
...
Method Details
getState
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[StateUsage](StateUsage.html)> getState()
The `StateUsages`, which are `actions` in the `StateDefinition`, that specify the discrete states in the behavior defined by the `StateDefinition`.
Returns:
the state value
Model:
derived="true"
 transient="true"
 oppositeRoleName="featuringStateDefinition"
 subsets=[`ActionDefinition.getAction()`](ActionDefinition.html#getAction())
getEntryAction
...
derived="true"
 transient="true"
 oppositeRoleName="enteredStateDefinition"
getDoAction
...
derived="true"
 transient="true"
 oppositeRoleName="activeStateDefintion"
getExitAction
...
derived="true"
 transient="true"
 oppositeRoleName="exitedStateDefinition"
isParallel
boolean isParallel()
...
<h1 class="title" title="Interface StateDefinition">Interface StateDefinition</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">StateDefinition</span><span class="extends-implements">
extends <a href="ActionDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionDefinition</a></span></div>
<div class="block"><p>A <code>StateDefinition</code> is the <code>Definition</code> of the Behavior of a system or part of a system in a certain state condition.</p>
...
<div class="block">The <code>ActionUsage</code> of this <code>StateDefinition</code> to be performed while in the state defined by the <code>StateDefinition</code>.</div>
</div>
...
<div class="block">The <code>ActionUsage</code> of this <code>StateDefinition</code> to be performed on entry to the state defined by the <code>StateDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> of this <code>StateDefinition</code> to be performed on exit to the state defined by the <code>StateDefinition</code>.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>StateUsages</code>, which are <code>actions</code> in the <code>StateDefinition</code>, that specify the discrete states in the behavior defined by the <code>StateDefinition</code>.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether the <code>ownedStates</code> of this <code>StateDefinition</code> are to all be performed in parallel.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setIsParallel(boolean)">setIsParallel</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether the <code>ownedStates</code> of this <code>StateDefinition</code> are to all be performed in parallel.</div>
</div>
</div>
...
<h3>getState</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="StateUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">StateUsage</a>&gt;</span> <span class="element-name">getState</span>()</div>
<div class="block"><p>The <code>StateUsages</code>, which are <code>actions</code> in the <code>StateDefinition</code>, that specify the discrete states in the behavior defined by the <code>StateDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="featuringStateDefinition"
        subsets=<a href="ActionDefinition.html#getAction()"><code>ActionDefinition.getAction()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>ActionUsage</code> of this <code>StateDefinition</code> to be performed on entry to the state defined by the <code>StateDefinition</code>. It is the owned <code>ActionUsage</code> related to the <code>StateDefinition</code> by a <code>StateSubactionMembership</code>  with <code>kind = entry</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="enteredStateDefinition"</dd>
</dl>
</section>
</li>
<li>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="activeStateDefintion"</dd>
</dl>
</section>
</li>
<li>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="exitedStateDefinition"</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Whether the <code>ownedStates</code> of this <code>StateDefinition</code> are to all be performed in parallel. If true, none of the <code>ownedActions</code> (which includes <code>ownedStates</code>) may have any incoming or outgoing <code>Transitions</code>. If false, only one <code>ownedState</code> may be performed at a time.</p></div>
<dl class="notes">
<dt>Returns:</dt>
