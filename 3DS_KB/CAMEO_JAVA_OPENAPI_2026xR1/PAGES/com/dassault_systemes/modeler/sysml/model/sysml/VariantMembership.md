# JAVA OPENAPI: VariantMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/VariantMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/VariantMembership.html`
- source_sha256: `b159d4e51f1fbf1d43abf89773db71e428a0ebcd4a339a3868e1d7d149f61798`
- captured_utc: `2026-07-14T16:45:05.196072+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[Membership](../../../kerml/model/kerml/Membership.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `org.eclipse.emf.common.notify.Notifier`, `[OwningMembership](../../../kerml/model/kerml/OwningMembership.html)`, `[Relationship](../../../kerml/model/kerml/Relationship.html)`

@OpenApiAllpublic interfaceVariantMembershipextends [OwningMembership](../../../kerml/model/kerml/OwningMembership.html)
...
Description
`[Usage](Usage.html)`
`[getOwnedVariantUsage](#getOwnedVariantUsage())()`
The `Usage` that represents a variant in the context of the `owningVariationDefinition` or `owningVariationUsage`.
`void`
`[setOwnedVariantUsage](#setOwnedVariantUsage(com.dassault_systemes.modeler.sysml.model.sysml.Usage))([Usage](Usage.html) value)`
The `Usage` that represents a variant in the context of the `owningVariationDefinition` or `owningVariationUsage`.
...
============ METHOD DETAIL ========== 
Method Details
getOwnedVariantUsage
@CheckForNull[Usage](Usage.html) getOwnedVariantUsage()
The `Usage` that represents a variant in the context of the `owningVariationDefinition` or `owningVariationUsage`.
Returns:
the ownedVariantUsage value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningVariantMembership"
setOwnedVariantUsage
void setOwnedVariantUsage(@CheckForNull
 [Usage](Usage.html) value)
The `Usage` that represents a variant in the context of the `owningVariationDefinition` or `owningVariationUsage`.
Parameters:
`value` - the ownedVariantUsage value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningVariantMembership"
...
<h1 class="title" title="Interface VariantMembership">Interface VariantMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">VariantMembership</span><span class="extends-implements">
extends <a href="../../../kerml/model/kerml/OwningMembership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">OwningMembership</a></span></div>
<div class="block"><p>A <code>VariantMembership</code> is a <code>Membership</code> between a variation point <code>Definition</code> or <code>Usage</code> and a <code>Usage</code> that represents a variant in the context of that variation. The <code>membershipOwningNamespace</code> for the <code>VariantMembership</code> must be either a Definition or a <code>Usage</code> with <code>isVariation = true</code>.</p>
 membershipOwningNamespace.oclIsKindOf(Definition) and
     membershipOwningNamespace.oclAsType(Definition).isVariation or
 membershipOwningNamespace.oclIsKindOf(Usage) and
     membershipOwningNamespace.oclAsType(Usage).isVariation</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedVariantUsage()">getOwnedVariantUsage</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Usage</code> that represents a variant in the context of the <code>owningVariationDefinition</code> or <code>owningVariationUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedVariantUsage(com.dassault_systemes.modeler.sysml.model.sysml.Usage)">setOwnedVariantUsage</a><wbr/>(<a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a> value)</code></div>
...
<li>
<section class="detail" id="getOwnedVariantUsage()">
<h3>getOwnedVariantUsage</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a></span> <span class="element-name">getOwnedVariantUsage</span>()</div>
<div class="block"><p>The <code>Usage</code> that represents a variant in the context of the <code>owningVariationDefinition</code> or <code>owningVariationUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ownedVariantUsage value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningVariantMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedVariantUsage(com.dassault_systemes.modeler.sysml.model.sysml.Usage)">
<h3>setOwnedVariantUsage</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedVariantUsage</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a> value)</span></div>
<div class="block"><p>The <code>Usage</code> that represents a variant in the context of the <code>owningVariationDefinition</code> or <code>owningVariationUsage</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedVariantUsage value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningVariantMembership"</dd>
