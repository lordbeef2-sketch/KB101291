# JAVA OPENAPI: CaseUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/CaseUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/CaseUsage.html`
- source_sha256: `d739613c720e930d4ecade5f1a4391a0596c77316c75f1e8d60478dcde438df1`
- captured_utc: `2026-07-14T16:45:03.290046+00:00`
...
`[CaseDefinition](CaseDefinition.html)`
`[getCaseDefinition](#getCaseDefinition())()`
The CaseDefinition that is the type of this CaseUsage.
`[RequirementUsage](RequirementUsage.html)`
`[getObjectiveRequirement](#getObjectiveRequirement())()`
...
Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.[CalculationUsage](CalculationUsage.html)
`[getCalculationDefinition](CalculationUsage.html#getCalculationDefinition()), [modelLevelEvaluable](CalculationUsage.html#modelLevelEvaluable(java.util.List))`
...
@CheckForNull[RequirementUsage](RequirementUsage.html) getObjectiveRequirement()
The `RequirementUsage` representing the objective of this `CaseUsage`.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="objectiveOwningCase"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
getCaseDefinition
@CheckForNull[CaseDefinition](CaseDefinition.html) getCaseDefinition()
The CaseDefinition that is the type of this CaseUsage.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="definedCase"
 redefines=[`CalculationUsage.getCalculationDefinition()`](CalculationUsage.html#getCalculationDefinition())
getSubjectParameter
...
derived="true"
 transient="true"
 oppositeRoleName="subjectOwningCase"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
getActorParameter
...
derived="true"
 transient="true"
 oppositeRoleName="actorOwningCase"
 subsets=[`Usage.getUsage()`](Usage.html#getUsage())
...
<h1 class="title" title="Interface CaseUsage">Interface CaseUsage</h1>
</div>
...
<dd><code><a href="AnalysisCaseUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">AnalysisCaseUsage</a></code>, <code><a href="IncludeUseCaseUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">IncludeUseCaseUsage</a></code>, <code><a href="UseCaseUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">UseCaseUsage</a></code>, <code><a href="VerificationCaseUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">VerificationCaseUsage</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">CaseUsage</span><span class="extends-implements">
extends <a href="CalculationUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">CalculationUsage</a></span></div>
<div class="block"><p>A <code>CaseUsage</code> is a <code>Usage</code> of a <code>CaseDefinition</code>.</p>
 objectiveRequirement = 
     let objectives: OrderedSet(RequirementUsage) = 
         featureMembership-&gt;
             selectByKind(ObjectiveMembership).
 ...
 isComposite and owningType &lt;&gt; null and 
     (owningType.oclIsKindOf(CaseDefinition) or
      owningType.oclIsKindOf(CaseUsage)) implies
     specializesFromLibrary('Cases::Case::subcases')</div>
</section>
...
<div class="block">The <code>parameters</code> of this <code>CaseUsage</code> that represent actors involved in the case.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="CaseDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">CaseDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getCaseDefinition()">getCaseDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The CaseDefinition that is the type of this CaseUsage.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getObjectiveRequirement()">getObjectiveRequirement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>RequirementUsage</code> representing the objective of this <code>CaseUsage</code>.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameter</code> of this <code>CaseUsage</code> that represents its subject.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.sysml.model.sysml.CalculationUsage">Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.<a href="CalculationUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">CalculationUsage</a></h3>
<code><a href="CalculationUsage.html#getCalculationDefinition()">getCalculationDefinition</a>, <a href="CalculationUsage.html#modelLevelEvaluable(java.util.List)">modelLevelEvaluable</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getObjectiveRequirement()">
<h3>getObjectiveRequirement</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="RequirementUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RequirementUsage</a></span> <span class="element-name">getObjectiveRequirement</span>()</div>
<div class="block"><p>The <code>RequirementUsage</code> representing the objective of this <code>CaseUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the objectiveRequirement value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="objectiveOwningCase"
...
<li>
<section class="detail" id="getCaseDefinition()">
<h3>getCaseDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="CaseDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">CaseDefinition</a></span> <span class="element-name">getCaseDefinition</span>()</div>
<div class="block"><p>The CaseDefinition that is the type of this CaseUsage.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the caseDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="definedCase"
        redefines=<a href="CalculationUsage.html#getCalculationDefinition()"><code>CalculationUsage.getCalculationDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>parameter</code> of this <code>CaseUsage</code> that represents its subject.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>The <code>parameters</code> of this <code>CaseUsage</code> that represent actors involved in the case.</p></div>
<dl class="notes">
<dt>Returns:</dt>
