# JAVA OPENAPI: RequirementConstraintMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/RequirementConstraintMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/RequirementConstraintMembership.html`
- source_sha256: `0d331c402ed79546704754667d8cc04e987e528d32c3868cd1bfe60470fe82c4`
- captured_utc: `2026-07-14T16:45:04.605067+00:00`
...
`[FramedConcernMembership](FramedConcernMembership.html)`, `[RequirementVerificationMembership](RequirementVerificationMembership.html)`

@OpenApiAllpublic interfaceRequirementConstraintMembershipextends [FeatureMembership](../../../kerml/model/kerml/FeatureMembership.html)
...
Method
Description
`[RequirementConstraintKind](RequirementConstraintKind.html)`
`[getKind](#getKind())()`
...
`[ConstraintUsage](ConstraintUsage.html)`
`[getReferencedConstraint](#getReferencedConstraint())()`
The `ConstraintUsage` that is referenced through this `RequirementConstraintMembership`.
`void`
`[setKind](#setKind(com.dassault_systemes.modeler.sysml.model.sysml.RequirementConstraintKind))([RequirementConstraintKind](RequirementConstraintKind.html) value)`
Whether the `RequirementConstraintMembership` is for an assumed or required `ConstraintUsage`.
`void`
`[setOwnedConstraint](#setOwnedConstraint(com.dassault_systemes.modeler.sysml.model.sysml.ConstraintUsage))([ConstraintUsage](ConstraintUsage.html) value)`
The `ConstraintUsage` that is the `ownedMemberFeature` of this `RequirementConstraintMembership`.
...
Method Details
getKind
@CheckForNull[RequirementConstraintKind](RequirementConstraintKind.html) getKind()
Whether the `RequirementConstraintMembership` is for an assumed or required `ConstraintUsage`.
Returns:
the kind value
Model:
...
void setKind(@CheckForNull
 [RequirementConstraintKind](RequirementConstraintKind.html) value)
Whether the `RequirementConstraintMembership` is for an assumed or required `ConstraintUsage`.
Parameters:
...
derived="false"
 transient="false"
getOwnedConstraint
@CheckForNull[ConstraintUsage](ConstraintUsage.html) getOwnedConstraint()
The `ConstraintUsage` that is the `ownedMemberFeature` of this `RequirementConstraintMembership`.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="requirementConstraintMembership"
setOwnedConstraint
void setOwnedConstraint(@CheckForNull
 [ConstraintUsage](ConstraintUsage.html) value)
The `ConstraintUsage` that is the `ownedMemberFeature` of this `RequirementConstraintMembership`.
Parameters:
`value` - the ownedConstraint value
Model:
derived="true"
 transient="true"
 oppositeRoleName="requirementConstraintMembership"
getReferencedConstraint
@CheckForNull[ConstraintUsage](ConstraintUsage.html) getReferencedConstraint()
...
Returns:
the referencedConstraint value
Model:
derived="true"
 transient="true"
 oppositeRoleName="referencingConstraintMembership"
...
<h1 class="title" title="Interface RequirementConstraintMembership">Interface RequirementConstraintMembership</h1>
</div>
...
<dd><code><a href="FramedConcernMembership.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">FramedConcernMembership</a></code>, <code><a href="RequirementVerificationMembership.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RequirementVerificationMembership</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">RequirementConstraintMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>RequirementConstraintMembership</code> is a <code>FeatureMembership</code> for an assumed or required <code>ConstraintUsage</code> of a <code>RequirementDefinition</code> or <code>RequirementUsage<code>.</code></code></p>
 referencedConstraint =
     let referencedFeature : Feature = 
         ownedConstraint.referencedFeatureTarget() in
     if referencedFeature = null then ownedConstraint
 ...
 owningType.oclIsKindOf(RequirementDefinition) or
 owningType.oclIsKindOf(RequirementUsage)
 ownedConstraint.isComposite</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="RequirementConstraintKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">RequirementConstraintKind</a></code></div>
...
<div class="block">Whether the <code>RequirementConstraintMembership</code> is for an assumed or required <code>ConstraintUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a></code></div>
...
<div class="block">The <code>ConstraintUsage</code> that is the <code>ownedMemberFeature</code> of this <code>RequirementConstraintMembership</code>.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencedConstraint()">getReferencedConstraint</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"> The <code>ConstraintUsage</code> that is referenced through this <code>RequirementConstraintMembership</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setKind(com.dassault_systemes.modeler.sysml.model.sysml.RequirementConstraintKind)">setKind</a><wbr/>(<a href="RequirementConstraintKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">RequirementConstraintKind</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether the <code>RequirementConstraintMembership</code> is for an assumed or required <code>ConstraintUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedConstraint(com.dassault_systemes.modeler.sysml.model.sysml.ConstraintUsage)">setOwnedConstraint</a><wbr/>(<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ConstraintUsage</code> that is the <code>ownedMemberFeature</code> of this <code>RequirementConstraintMembership</code>.</div>
</div>
</div>
...
</span><span class="return-type"><a href="RequirementConstraintKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">RequirementConstraintKind</a></span> <span class="element-name">getKind</span>()</div>
<div class="block"><p>Whether the <code>RequirementConstraintMembership</code> is for an assumed or required <code>ConstraintUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setKind(com.dassault_systemes.modeler.sysml.model.sysml.RequirementConstraintKind)">
<h3>setKind</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setKind</span><wbr/><span class="parameters">(@CheckForNull
 <a href="RequirementConstraintKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">RequirementConstraintKind</a> value)</span></div>
<div class="block"><p>Whether the <code>RequirementConstraintMembership</code> is for an assumed or required <code>ConstraintUsage</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a></span> <span class="element-name">getOwnedConstraint</span>()</div>
<div class="block"><p>The <code>ConstraintUsage</code> that is the <code>ownedMemberFeature</code> of this <code>RequirementConstraintMembership</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="requirementConstraintMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedConstraint(com.dassault_systemes.modeler.sysml.model.sysml.ConstraintUsage)">
<h3>setOwnedConstraint</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedConstraint</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a> value)</span></div>
<div class="block"><p>The <code>ConstraintUsage</code> that is the <code>ownedMemberFeature</code> of this <code>RequirementConstraintMembership</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedConstraint value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="requirementConstraintMembership"</dd>
...
<li>
<section class="detail" id="getReferencedConstraint()">
<h3>getReferencedConstraint</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a></span> <span class="element-name">getReferencedConstraint</span>()</div>
<div class="block"><p> The <code>ConstraintUsage</code> that is referenced through this <code>RequirementConstraintMembership</code>. It is the <code>referencedFeature</code> of the <code>ownedReferenceSubsetting</code> of the <code>ownedConstraint</code>, if there is one, and, otherwise, the <code>ownedConstraint</code> itself.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencedConstraint value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="referencingConstraintMembership"</dd>
</dl>
</section>
</li>
</ul>
