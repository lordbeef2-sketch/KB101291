# JAVA OPENAPI: ViewRenderingMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/ViewRenderingMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/ViewRenderingMembership.html`
- source_sha256: `4ba636767ae13b951e02e59681319a741c616596f148623b5f5ed970b0ee5d2d`
- captured_utc: `2026-07-14T16:45:05.208072+00:00`
...
@OpenApiAllpublic interfaceViewRenderingMembershipextends [FeatureMembership](../../../kerml/model/kerml/FeatureMembership.html)
...
`[RenderingUsage](RenderingUsage.html)`
`[getReferencedRendering](#getReferencedRendering())()`
The `RenderingUsage` that is referenced through this `ViewRenderingMembership`.
`void`
`[setOwnedRendering](#setOwnedRendering(com.dassault_systemes.modeler.sysml.model.sysml.RenderingUsage))([RenderingUsage](RenderingUsage.html) value)`
The owned `RenderingUsage` that is either itself the `referencedRendering` or subsets the `referencedRendering`.
...
Method Details
getOwnedRendering
@CheckForNull[RenderingUsage](RenderingUsage.html) getOwnedRendering()
The owned `RenderingUsage` that is either itself the `referencedRendering` or subsets the `referencedRendering`.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="viewRenderingMembership"
setOwnedRendering
void setOwnedRendering(@CheckForNull
 [RenderingUsage](RenderingUsage.html) value)
The owned `RenderingUsage` that is either itself the `referencedRendering` or subsets the `referencedRendering`.
Parameters:
`value` - the ownedRendering value
Model:
derived="true"
 transient="true"
 oppositeRoleName="viewRenderingMembership"
getReferencedRendering
@CheckForNull[RenderingUsage](RenderingUsage.html) getReferencedRendering()
...
Returns:
the referencedRendering value
Model:
derived="true"
 transient="true"
 oppositeRoleName="referencingRenderingMembership"
...
<h1 class="title" title="Interface ViewRenderingMembership">Interface ViewRenderingMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ViewRenderingMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>ViewRenderingMembership</code> is a <coed>FeatureMembership that identifies the <code>viewRendering</code> of a <code>ViewDefinition</code> or <code>ViewUsage</code>.</coed></p>
 referencedRendering =
     let referencedFeature : Feature = 
         ownedRendering.referencedFeatureTarget() in
     if referencedFeature = null then ownedRendering
 ...
 owningType.oclIsKindOf(ViewDefinition) or
 owningType.oclIsKindOf(ViewUsage)</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedRendering()">getOwnedRendering</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>RenderingUsage</code> that is either itself the <code>referencedRendering</code> or subsets the <code>referencedRendering</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencedRendering()">getReferencedRendering</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"> The <code>RenderingUsage</code> that is referenced through this <code>ViewRenderingMembership</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedRendering(com.dassault_systemes.modeler.sysml.model.sysml.RenderingUsage)">setOwnedRendering</a><wbr/>(<a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>RenderingUsage</code> that is either itself the <code>referencedRendering</code> or subsets the <code>referencedRendering</code>.</div>
</div>
</div>
...
</span><span class="return-type"><a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a></span> <span class="element-name">getOwnedRendering</span>()</div>
<div class="block"><p>The owned <code>RenderingUsage</code> that is either itself the <code>referencedRendering</code> or subsets the <code>referencedRendering</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="viewRenderingMembership"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnedRendering(com.dassault_systemes.modeler.sysml.model.sysml.RenderingUsage)">
<h3>setOwnedRendering</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedRendering</span><wbr/><span class="parameters">(@CheckForNull
 <a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a> value)</span></div>
<div class="block"><p>The owned <code>RenderingUsage</code> that is either itself the <code>referencedRendering</code> or subsets the <code>referencedRendering</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedRendering value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="viewRenderingMembership"</dd>
...
<li>
<section class="detail" id="getReferencedRendering()">
<h3>getReferencedRendering</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a></span> <span class="element-name">getReferencedRendering</span>()</div>
<div class="block"><p> The <code>RenderingUsage</code> that is referenced through this <code>ViewRenderingMembership</code>. It is the <code>referencedFeature</code> of the <code>ownedReferenceSubsetting</code> for the <code>ownedRendering</code>, if there is one, and, otherwise, the <code>ownedRendering</code> itself.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencedRendering value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="referencingRenderingMembership"</dd>
</dl>
</section>
</li>
</ul>
