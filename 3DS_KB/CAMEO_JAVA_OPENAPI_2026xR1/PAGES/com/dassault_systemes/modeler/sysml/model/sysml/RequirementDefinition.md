# JAVA OPENAPI: RequirementDefinition (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/RequirementDefinition.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/RequirementDefinition.html`
- source_sha256: `39b2a8d4435b968d055e02164ee7c3be3a3cd826e7706077e82c72e290b677fa`
- captured_utc: `2026-07-14T16:45:04.657063+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Behavior](../../../kerml/model/kerml/Behavior.html)`, `[Class](../../../kerml/model/kerml/Class.html)`, `[Classifier](../../../kerml/model/kerml/Classifier.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[ConstraintDefinition](ConstraintDefinition.html)`, `[Definition](Definition.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[Function](../../../kerml/model/kerml/Function.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `[Namespace](../../../kerml/model/kerml/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[OccurrenceDefinition](OccurrenceDefinition.html)`, `[Predicate](../../../kerml/model/kerml/Predicate.html)`, `[Type](../../../kerml/model/kerml/Type.html)`

All Known Subinterfaces:
`[ConcernDefinition](ConcernDefinition.html)`, `[ViewpointDefinition](ViewpointDefinition.html)`

@OpenApiAllpublic interfaceRequirementDefinitionextends [ConstraintDefinition](ConstraintDefinition.html)
...
derived="true"
 transient="true"
 oppositeRoleName="subjectOwningRequirementDefinition"
 subsets=[`Definition.getUsage()`](Definition.html#getUsage())
getActorParameter
...
derived="true"
 transient="true"
 oppositeRoleName="actorOwningRequirementDefinition"
 subsets=[`Definition.getUsage()`](Definition.html#getUsage())
...
derived="true"
 transient="true"
 oppositeRoleName="stakholderOwiningRequirementDefinition"
 subsets=[`Definition.getUsage()`](Definition.html#getUsage())
...
derived="true"
 transient="true"
 oppositeRoleName="assumingRequirementDefinition"
...
derived="true"
 transient="true"
 oppositeRoleName="requiringRequirementDefinition"
getFramedConcern
...
derived="true"
 transient="true"
 oppositeRoleName="framingRequirementDefinition"
...
<h1 class="title" title="Interface RequirementDefinition">Interface RequirementDefinition</h1>
</div>
...
<dd><code><a href="ConcernDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernDefinition</a></code>, <code><a href="ViewpointDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewpointDefinition</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">RequirementDefinition</span><span class="extends-implements">
extends <a href="ConstraintDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintDefinition</a></span></div>
<div class="block"><p>A <code>RequirementDefinition</code> is a <code>ConstraintDefinition</code> that defines a requirement used in the context of a specification as a constraint that a valid solution must satisfy. The specification is relative to a specified subject, possibly in collaboration with one or more external actors.</p>
 text = documentation.body
 assumedConstraint = ownedFeatureMembership-&gt;
     selectByKind(RequirementConstraintMembership)-&gt;
     select(kind = RequirementConstraintKind::assumption).
 ...
 featureMembership-&gt;        
     ...
     size() &lt;= 1
 input-&gt;notEmpty() and input-&gt;first() = subjectParameter
 specializesFromLibrary('Requirements::RequirementCheck')</div>
</section>
...
<div class="block">The <code>parameters</code> of this <code>RequirementDefinition</code> that represent actors involved in the requirement.</div>
</div>
...
<div class="block">The owned <code>ConstraintUsages</code> that represent assumptions of this <code>RequirementDefinition</code>, which are the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementDefinition</code> with <code>kind = assumption</code>.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ConcernUsages</code> framed by this <code>RequirementDefinition</code>, which are the <code>ownedConcerns</code> of all <code>FramedConcernMemberships</code> of the <code>RequirementDefinition</code>.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional modeler-specified identifier for this <code>RequirementDefinition</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ConstraintUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConstraintUsage</a>&gt;</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The owned <code>ConstraintUsages</code> that represent requirements of this <code>RequirementDefinition</code>, derived as the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementDefinition</code> with <code>kind</code> = <code>requirement</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getStakeholderParameter()">getStakeholderParameter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameters</code> of this <code>RequirementDefinition</code> that represent stakeholders for th requirement.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSubjectParameter()">getSubjectParameter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>parameter</code> of this <code>RequirementDefinition</code> that represents its subject.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional textual statement of the requirement represented by this <code>RequirementDefinition</code>, derived from the <code>bodies</code> of the <code>documentation</code> of the <code>RequirementDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setReqId(java.lang.String)">setReqId</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An optional modeler-specified identifier for this <code>RequirementDefinition</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementDefinition</code>.</div>
</div>
</div>
...
<div class="block"><p>An optional modeler-specified identifier for this <code>RequirementDefinition</code> (used, e.g., to link it to an original requirement text in some source document), which is the <code>declaredShortName</code> for the <code>RequirementDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>An optional textual statement of the requirement represented by this <code>RequirementDefinition</code>, derived from the <code>bodies</code> of the <code>documentation</code> of the <code>RequirementDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>The <code>parameter</code> of this <code>RequirementDefinition</code> that represents its subject.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="subjectOwningRequirementDefinition"
        subsets=<a href="Definition.html#getUsage()"><code>Definition.getUsage()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>parameters</code> of this <code>RequirementDefinition</code> that represent actors involved in the requirement.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>The <code>parameters</code> of this <code>RequirementDefinition</code> that represent stakeholders for th requirement.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>The owned <code>ConstraintUsages</code> that represent assumptions of this <code>RequirementDefinition</code>, which are the <code>ownedConstraints</code> of the <code>RequirementConstraintMemberships</code> of the <code>RequirementDefinition</code> with <code>kind = assumption</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="assumingRequirementDefinition"</dd>
</dl>
</section>
</li>
<li>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="requiringRequirementDefinition"</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The <code>ConcernUsages</code> framed by this <code>RequirementDefinition</code>, which are the <code>ownedConcerns</code> of all <code>FramedConcernMemberships</code> of the <code>RequirementDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
