# JAVA OPENAPI: ISQSpaceTimeLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ISQSpaceTimeLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ISQSpaceTimeLibrary.html`
- source_sha256: `91e308d1f8fae1092f1d0f4e5952004ede46003e8aaab39b238a3f9e205cd516`
- captured_utc: `2026-07-14T16:44:53.401914+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.ISQSpaceTimeLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classISQSpaceTimeLibrary
...
Constructor
Description
`[ISQSpaceTimeLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new isqspace time library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ISQSpaceTimeLibrary](ISQSpaceTimeLibrary.html)`
...
Constructor Details
ISQSpaceTimeLibrary
public ISQSpaceTimeLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new isqspace time library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ISQSpaceTimeLibrary](ISQSpaceTimeLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ISQSpaceTimeLibrary](ISQSpaceTimeLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
<h1 class="title" title="Class ISQSpaceTimeLibrary">Class ISQSpaceTimeLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ISQSpaceTimeLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ISQSpaceTimeLibrary</span>
...
<div class="block">Access helper for the isqspace time standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQSpaceTimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQSpaceTimeLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQSpaceTimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQSpaceTimeLibrary</a></code></div>
...
<h3>ISQSpaceTimeLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ISQSpaceTimeLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new isqspace time library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
