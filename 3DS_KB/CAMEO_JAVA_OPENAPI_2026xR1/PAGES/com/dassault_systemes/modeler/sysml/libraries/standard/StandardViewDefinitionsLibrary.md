# JAVA OPENAPI: StandardViewDefinitionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/StandardViewDefinitionsLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/StandardViewDefinitionsLibrary.html`
- source_sha256: `77a93665a5ed0bda84e16d27f169e97d0ac44eb77b45fa7f02d97b3c2c7822eb`
- captured_utc: `2026-07-14T16:44:54.827934+00:00`
...
## Class StandardViewDefinitionsLibrary
...
com.dassault_systemes.modeler.sysml.libraries.standard.StandardViewDefinitionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classStandardViewDefinitionsLibrary
...
Constructor
Description
`[StandardViewDefinitionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new standard view definitions library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [StandardViewDefinitionsLibrary](StandardViewDefinitionsLibrary.html)`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
StandardViewDefinitionsLibrary
public StandardViewDefinitionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new standard view definitions library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [StandardViewDefinitionsLibrary](StandardViewDefinitionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [StandardViewDefinitionsLibrary](StandardViewDefinitionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
<h1 class="title" title="Class StandardViewDefinitionsLibrary">Class StandardViewDefinitionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.StandardViewDefinitionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">StandardViewDefinitionsLibrary</span>
...
<div class="block">Access helper for the standard view definitions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StandardViewDefinitionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StandardViewDefinitionsLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StandardViewDefinitionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StandardViewDefinitionsLibrary</a></code></div>
...
<h3>StandardViewDefinitionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StandardViewDefinitionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new standard view definitions library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StandardViewDefinitionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StandardViewDefinitionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StandardViewDefinitionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StandardViewDefinitionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
