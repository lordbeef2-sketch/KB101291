# JAVA OPENAPI: MetadataLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/MetadataLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/MetadataLibrary.html`
- source_sha256: `5fa7b01e4390d8e41f43fd3405fbd5e68761495a1189fce6e0a9fd33dbd9e764`
- captured_utc: `2026-07-14T16:44:53.867921+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.MetadataLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classMetadataLibrary
...
Description
`static class`
`[MetadataLibrary.MetadataItemMetadataDefinition](MetadataLibrary.MetadataItemMetadataDefinition.html)`
Wrapper for the metadata item metadata definition library element.
`static class`
`[MetadataLibrary.MetadataItemsItemUsage](MetadataLibrary.MetadataItemsItemUsage.html)`
...
Constructor
Description
`[MetadataLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new metadata library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [MetadataLibrary](MetadataLibrary.html)`
...
Constructor Details
MetadataLibrary
public MetadataLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new metadata library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [MetadataLibrary](MetadataLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [MetadataLibrary](MetadataLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
MetadataItem
public [MetadataLibrary.MetadataItemMetadataDefinition](MetadataLibrary.MetadataItemMetadataDefinition.html) MetadataItem()
Returns metadata item.
Returns:
metadata item
metadataItems
public [MetadataLibrary.MetadataItemsItemUsage](MetadataLibrary.MetadataItemsItemUsage.html) metadataItems()
Returns metadata items.
Returns:
metadata items
getTypeWrappers
...
<h1 class="title" title="Class MetadataLibrary">Class MetadataLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.MetadataLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">MetadataLibrary</span>
...
<div class="block">Access helper for the metadata standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="MetadataLibrary.MetadataItemMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the metadata item metadata definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="MetadataLibrary.MetadataItemsItemUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemsItemUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the metadata items item usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MetadataLibrary.MetadataItemMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemMetadataDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#MetadataItem()">MetadataItem</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns metadata item.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MetadataLibrary.MetadataItemsItemUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemsItemUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#metadataItems()">metadataItems</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns metadata items.</div>
</div>
...
<h3>MetadataLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MetadataLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new metadata library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="MetadataItem()">
<h3>MetadataItem</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="MetadataLibrary.MetadataItemMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemMetadataDefinition</a></span> <span class="element-name">MetadataItem</span>()</div>
<div class="block">Returns metadata item.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>metadata item</dd>
...
<li>
<section class="detail" id="metadataItems()">
<h3>metadataItems</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="MetadataLibrary.MetadataItemsItemUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">MetadataLibrary.MetadataItemsItemUsage</a></span> <span class="element-name">metadataItems</span>()</div>
<div class="block">Returns metadata items.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>metadata items</dd>
</dl>
</section>
</li>
<li>
