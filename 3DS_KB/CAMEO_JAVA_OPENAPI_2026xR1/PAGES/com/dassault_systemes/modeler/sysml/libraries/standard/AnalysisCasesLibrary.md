# JAVA OPENAPI: AnalysisCasesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/AnalysisCasesLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/AnalysisCasesLibrary.html`
- source_sha256: `ae6b917b38711b15da9b778e6ba4932d02175071753b9bf4ee3f5ca1dd7116ee`
- captured_utc: `2026-07-14T16:44:52.496903+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.AnalysisCasesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classAnalysisCasesLibrary
...
Description
`static class`
`[AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition](AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition.html)`
Wrapper for the analysis case analysis case definition library element.
`static class`
`[AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage](AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html)`
...
Constructor
Description
`[AnalysisCasesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new analysis cases library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Returns analysis case.
`[AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage](AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html)`
`[analysisCases](#analysisCases())()`
Returns analysis cases.
`static [AnalysisCasesLibrary](AnalysisCasesLibrary.html)`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
AnalysisCasesLibrary
public AnalysisCasesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new analysis cases library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [AnalysisCasesLibrary](AnalysisCasesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [AnalysisCasesLibrary](AnalysisCasesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
AnalysisCase
public [AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition](AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition.html) AnalysisCase()
Returns analysis case.
Returns:
analysis case
analysisCases
public [AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage](AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html) analysisCases()
Returns analysis cases.
Returns:
analysis cases
getTypeWrappers
...
<h1 class="title" title="Class AnalysisCasesLibrary">Class AnalysisCasesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.AnalysisCasesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">AnalysisCasesLibrary</span>
...
<div class="block">Access helper for the analysis cases standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the analysis case analysis case definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the analysis cases analysis case usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#AnalysisCase()">AnalysisCase</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns analysis case.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#analysisCases()">analysisCases</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns analysis cases.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="AnalysisCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="AnalysisCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary</a></code></div>
...
<h3>AnalysisCasesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AnalysisCasesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new analysis cases library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="AnalysisCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<li>
<section class="detail" id="AnalysisCase()">
<h3>AnalysisCase</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCaseAnalysisCaseDefinition</a></span> <span class="element-name">AnalysisCase</span>()</div>
<div class="block">Returns analysis case.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>analysis case</dd>
...
<li>
<section class="detail" id="analysisCases()">
<h3>analysisCases</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">AnalysisCasesLibrary.AnalysisCasesAnalysisCaseUsage</a></span> <span class="element-name">analysisCases</span>()</div>
<div class="block">Returns analysis cases.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>analysis cases</dd>
</dl>
</section>
</li>
<li>
