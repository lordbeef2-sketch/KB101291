# JAVA OPENAPI: ImageMetadataLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ImageMetadataLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ImageMetadataLibrary.html`
- source_sha256: `2f1b5f1a6d7b23cae5fe83f4359ce633b9a474c8eed35efb8c33be064e386ce3`
- captured_utc: `2026-07-14T16:44:53.548920+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.ImageMetadataLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classImageMetadataLibrary
...
Description
`static class`
`[ImageMetadataLibrary.IconMetadataDefinition](ImageMetadataLibrary.IconMetadataDefinition.html)`
Wrapper for the icon metadata definition library element.
`static class`
`[ImageMetadataLibrary.ImageAttributeDefinition](ImageMetadataLibrary.ImageAttributeDefinition.html)`
...
Constructor
Description
`[ImageMetadataLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new image metadata library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ImageMetadataLibrary](ImageMetadataLibrary.html)`
...
public ImageMetadataLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new image metadata library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ImageMetadataLibrary](ImageMetadataLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ImageMetadataLibrary](ImageMetadataLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
Image
public [ImageMetadataLibrary.ImageAttributeDefinition](ImageMetadataLibrary.ImageAttributeDefinition.html) Image()
Returns image.
Returns:
image
Icon
public [ImageMetadataLibrary.IconMetadataDefinition](ImageMetadataLibrary.IconMetadataDefinition.html) Icon()
Returns icon.
Returns:
icon
getTypeWrappers
...
<h1 class="title" title="Class ImageMetadataLibrary">Class ImageMetadataLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ImageMetadataLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ImageMetadataLibrary</span>
...
<div class="block">Access helper for the image metadata standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ImageMetadataLibrary.IconMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.IconMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the icon metadata definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ImageMetadataLibrary.ImageAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.ImageAttributeDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the image attribute definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ImageMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ImageMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ImageMetadataLibrary.IconMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.IconMetadataDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Icon()">Icon</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns icon.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ImageMetadataLibrary.ImageAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.ImageAttributeDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Image()">Image</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns image.</div>
</div>
...
<h3>ImageMetadataLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ImageMetadataLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new image metadata library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>Image</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ImageMetadataLibrary.ImageAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.ImageAttributeDefinition</a></span> <span class="element-name">Image</span>()</div>
<div class="block">Returns image.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>image</dd>
...
<h3>Icon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ImageMetadataLibrary.IconMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ImageMetadataLibrary.IconMetadataDefinition</a></span> <span class="element-name">Icon</span>()</div>
<div class="block">Returns icon.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>icon</dd>
