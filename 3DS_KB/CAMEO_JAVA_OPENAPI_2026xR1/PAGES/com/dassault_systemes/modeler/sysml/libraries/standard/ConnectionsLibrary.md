# JAVA OPENAPI: ConnectionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ConnectionsLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ConnectionsLibrary.html`
- source_sha256: `ea3db40c923ab85c027811ff2d84e5f215143e73b54225db79e32fe2e5ee8458`
- captured_utc: `2026-07-14T16:44:52.800907+00:00`
...
@OpenApiAllpublic classConnectionsLibrary
...
Description
`static class`
`[ConnectionsLibrary.BinaryConnectionConnectionDefinition](ConnectionsLibrary.BinaryConnectionConnectionDefinition.html)`
Wrapper for the binary connection connection definition library element.
`static class`
`[ConnectionsLibrary.BinaryConnectionsConnectionUsage](ConnectionsLibrary.BinaryConnectionsConnectionUsage.html)`
Wrapper for the binary connections connection usage library element.
`static class`
`[ConnectionsLibrary.ConnectionConnectionDefinition](ConnectionsLibrary.ConnectionConnectionDefinition.html)`
Wrapper for the connection connection definition library element.
`static class`
`[ConnectionsLibrary.ConnectionsConnectionUsage](ConnectionsLibrary.ConnectionsConnectionUsage.html)`
...
Constructor
Description
`[ConnectionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new connections library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Returns binary connection.
`[ConnectionsLibrary.BinaryConnectionsConnectionUsage](ConnectionsLibrary.BinaryConnectionsConnectionUsage.html)`
`[binaryConnections](#binaryConnections())()`
Returns binary connections.
`[ConnectionsLibrary.ConnectionConnectionDefinition](ConnectionsLibrary.ConnectionConnectionDefinition.html)`
...
Returns connections.
`static [ConnectionsLibrary](ConnectionsLibrary.html)`
...
Constructor Details
ConnectionsLibrary
public ConnectionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new connections library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ConnectionsLibrary](ConnectionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ConnectionsLibrary](ConnectionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
Connection
public [ConnectionsLibrary.ConnectionConnectionDefinition](ConnectionsLibrary.ConnectionConnectionDefinition.html) Connection()
Returns connection.
Returns:
connection
BinaryConnection
public [ConnectionsLibrary.BinaryConnectionConnectionDefinition](ConnectionsLibrary.BinaryConnectionConnectionDefinition.html) BinaryConnection()
Returns binary connection.
Returns:
binary connection
connections
public [ConnectionsLibrary.ConnectionsConnectionUsage](ConnectionsLibrary.ConnectionsConnectionUsage.html) connections()
Returns connections.
Returns:
connections
binaryConnections
public [ConnectionsLibrary.BinaryConnectionsConnectionUsage](ConnectionsLibrary.BinaryConnectionsConnectionUsage.html) binaryConnections()
Returns binary connections.
Returns:
binary connections
getTypeWrappers
...
<h1 class="title" title="Class ConnectionsLibrary">Class ConnectionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ConnectionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ConnectionsLibrary</span>
...
<div class="block">Access helper for the connections standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ConnectionsLibrary.BinaryConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionConnectionDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the binary connection connection definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ConnectionsLibrary.BinaryConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionsConnectionUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the binary connections connection usage library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="ConnectionsLibrary.ConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionConnectionDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the connection connection definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ConnectionsLibrary.ConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionsConnectionUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the connections connection usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ConnectionsLibrary.BinaryConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionConnectionDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#BinaryConnection()">BinaryConnection</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns binary connection.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ConnectionsLibrary.BinaryConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionsConnectionUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#binaryConnections()">binaryConnections</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns binary connections.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ConnectionsLibrary.ConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionConnectionDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Connection()">Connection</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns connection.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ConnectionsLibrary.ConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionsConnectionUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#connections()">connections</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns connections.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary</a></code></div>
...
<h3>ConnectionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ConnectionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new connections library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>Connection</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ConnectionsLibrary.ConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionConnectionDefinition</a></span> <span class="element-name">Connection</span>()</div>
<div class="block">Returns connection.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>connection</dd>
...
<li>
<section class="detail" id="BinaryConnection()">
<h3>BinaryConnection</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ConnectionsLibrary.BinaryConnectionConnectionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionConnectionDefinition</a></span> <span class="element-name">BinaryConnection</span>()</div>
<div class="block">Returns binary connection.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>binary connection</dd>
</dl>
</section>
</li>
<li>
...
<h3>connections</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ConnectionsLibrary.ConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.ConnectionsConnectionUsage</a></span> <span class="element-name">connections</span>()</div>
<div class="block">Returns connections.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>connections</dd>
...
<li>
<section class="detail" id="binaryConnections()">
<h3>binaryConnections</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ConnectionsLibrary.BinaryConnectionsConnectionUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ConnectionsLibrary.BinaryConnectionsConnectionUsage</a></span> <span class="element-name">binaryConnections</span>()</div>
<div class="block">Returns binary connections.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>binary connections</dd>
</dl>
</section>
</li>
<li>
