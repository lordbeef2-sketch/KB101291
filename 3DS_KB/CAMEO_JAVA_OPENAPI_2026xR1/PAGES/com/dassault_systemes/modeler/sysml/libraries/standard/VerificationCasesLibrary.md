# JAVA OPENAPI: VerificationCasesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/VerificationCasesLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/VerificationCasesLibrary.html`
- source_sha256: `ad978bedb0829966f886b49a0f2030abd3f5f6f8829ad474518994255cd5fa4a`
- captured_utc: `2026-07-14T16:45:02.324033+00:00`
...
## Class VerificationCasesLibrary
...
com.dassault_systemes.modeler.sysml.libraries.standard.VerificationCasesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classVerificationCasesLibrary
...
Description
`static class`
`[VerificationCasesLibrary.VerificationCasesVerificationCaseUsage](VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html)`
Wrapper for the verification cases verification case usage library element.
`static class`
`[VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition](VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition.html)`
...
Constructor
Description
`[VerificationCasesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new verification cases library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [VerificationCasesLibrary](VerificationCasesLibrary.html)`
...
Returns verification case.
`[VerificationCasesLibrary.VerificationCasesVerificationCaseUsage](VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html)`
`[verificationCases](#verificationCases())()`
Returns verification cases.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
VerificationCasesLibrary
public VerificationCasesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new verification cases library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [VerificationCasesLibrary](VerificationCasesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [VerificationCasesLibrary](VerificationCasesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
VerificationCase
public [VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition](VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition.html) VerificationCase()
Returns verification case.
Returns:
verification case
verificationCases
public [VerificationCasesLibrary.VerificationCasesVerificationCaseUsage](VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html) verificationCases()
Returns verification cases.
Returns:
verification cases
getTypeWrappers
...
<h1 class="title" title="Class VerificationCasesLibrary">Class VerificationCasesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.VerificationCasesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">VerificationCasesLibrary</span>
...
<div class="block">Access helper for the verification cases standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCasesVerificationCaseUsage</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the verification cases verification case usage library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the verification case verification case definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="VerificationCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="VerificationCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#VerificationCase()">VerificationCase</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns verification case.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCasesVerificationCaseUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#verificationCases()">verificationCases</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns verification cases.</div>
</div>
</div>
</div>
</div>
...
<h3>VerificationCasesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">VerificationCasesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new verification cases library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="VerificationCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="VerificationCasesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="VerificationCase()">
<h3>VerificationCase</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCaseVerificationCaseDefinition</a></span> <span class="element-name">VerificationCase</span>()</div>
<div class="block">Returns verification case.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>verification case</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="verificationCases()">
<h3>verificationCases</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="VerificationCasesLibrary.VerificationCasesVerificationCaseUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">VerificationCasesLibrary.VerificationCasesVerificationCaseUsage</a></span> <span class="element-name">verificationCases</span>()</div>
<div class="block">Returns verification cases.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>verification cases</dd>
</dl>
</section>
</li>
<li>
