# JAVA OPENAPI: ModelingMetadataLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ModelingMetadataLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ModelingMetadataLibrary.html`
- source_sha256: `a202f63c3426457eefad34c33d9013a85f19ad93e85bf95eb26c93efbdff7a86`
- captured_utc: `2026-07-14T16:44:54.002923+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.ModelingMetadataLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classModelingMetadataLibrary
...
Description
`static class`
`[ModelingMetadataLibrary.RefinementMetadataDefinition](ModelingMetadataLibrary.RefinementMetadataDefinition.html)`
...
Constructor
Description
`[ModelingMetadataLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new modeling metadata library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ModelingMetadataLibrary](ModelingMetadataLibrary.html)`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ModelingMetadataLibrary
public ModelingMetadataLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new modeling metadata library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ModelingMetadataLibrary](ModelingMetadataLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ModelingMetadataLibrary](ModelingMetadataLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
Refinement
public [ModelingMetadataLibrary.RefinementMetadataDefinition](ModelingMetadataLibrary.RefinementMetadataDefinition.html) Refinement()
Returns refinement.
Returns:
refinement
getTypeWrappers
...
<h1 class="title" title="Class ModelingMetadataLibrary">Class ModelingMetadataLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ModelingMetadataLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ModelingMetadataLibrary</span>
...
<div class="block">Access helper for the modeling metadata standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ModelingMetadataLibrary.RefinementMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary.RefinementMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the refinement metadata definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModelingMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModelingMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ModelingMetadataLibrary.RefinementMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary.RefinementMetadataDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Refinement()">Refinement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns refinement.</div>
</div>
</div>
</div>
</div>
...
<h3>ModelingMetadataLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ModelingMetadataLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new modeling metadata library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModelingMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModelingMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="Refinement()">
<h3>Refinement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ModelingMetadataLibrary.RefinementMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ModelingMetadataLibrary.RefinementMetadataDefinition</a></span> <span class="element-name">Refinement</span>()</div>
<div class="block">Returns refinement.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>refinement</dd>
