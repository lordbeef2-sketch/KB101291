# JAVA OPENAPI: FlowsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/FlowsLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/FlowsLibrary.html`
- source_sha256: `5f48982c209290e311522590efa4e3935b734d4aa3b0ea4540ac82bedd6b665b`
- captured_utc: `2026-07-14T16:44:53.196913+00:00`
...
@OpenApiAllpublic classFlowsLibrary
...
Description
`static class`
`[FlowsLibrary.FlowsFlowUsage](FlowsLibrary.FlowsFlowUsage.html)`
Wrapper for the flows flow usage library element.
`static class`
`[FlowsLibrary.MessageActionFlowDefinition](FlowsLibrary.MessageActionFlowDefinition.html)`
Wrapper for the message action flow definition library element.
`static class`
`[FlowsLibrary.MessageFlowDefinition](FlowsLibrary.MessageFlowDefinition.html)`
Wrapper for the message flow definition library element.
`static class`
`[FlowsLibrary.MessagesFlowUsage](FlowsLibrary.MessagesFlowUsage.html)`
Wrapper for the messages flow usage library element.
`static class`
`[FlowsLibrary.SuccessionFlowsFlowUsage](FlowsLibrary.SuccessionFlowsFlowUsage.html)`
...
Constructor
Description
`[FlowsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
...
`[flows](#flows())()`
Returns flows.
`static [FlowsLibrary](FlowsLibrary.html)`
...
`[FlowsLibrary.SuccessionFlowsFlowUsage](FlowsLibrary.SuccessionFlowsFlowUsage.html)`
`[successionFlows](#successionFlows())()`
Returns succession flows.
...
Constructor Details
FlowsLibrary
public FlowsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new flows library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [FlowsLibrary](FlowsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [FlowsLibrary](FlowsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
MessageAction
public [FlowsLibrary.MessageActionFlowDefinition](FlowsLibrary.MessageActionFlowDefinition.html) MessageAction()
Returns message action.
Returns:
message action
Message
public [FlowsLibrary.MessageFlowDefinition](FlowsLibrary.MessageFlowDefinition.html) Message()
Returns message.
Returns:
message
messages
public [FlowsLibrary.MessagesFlowUsage](FlowsLibrary.MessagesFlowUsage.html) messages()
Returns messages.
Returns:
messages
flows
public [FlowsLibrary.FlowsFlowUsage](FlowsLibrary.FlowsFlowUsage.html) flows()
Returns flows.
Returns:
flows
successionFlows
public [FlowsLibrary.SuccessionFlowsFlowUsage](FlowsLibrary.SuccessionFlowsFlowUsage.html) successionFlows()
Returns succession flows.
Returns:
succession flows
getTypeWrappers
...
<h1 class="title" title="Class FlowsLibrary">Class FlowsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.FlowsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">FlowsLibrary</span>
...
<div class="block">Access helper for the flows standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="FlowsLibrary.FlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.FlowsFlowUsage</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the flows flow usage library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="FlowsLibrary.MessageActionFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageActionFlowDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the message action flow definition library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="FlowsLibrary.MessageFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageFlowDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the message flow definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="FlowsLibrary.MessagesFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessagesFlowUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the messages flow usage library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="FlowsLibrary.SuccessionFlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.SuccessionFlowsFlowUsage</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the succession flows flow usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FlowsLibrary.FlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.FlowsFlowUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#flows()">flows</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns flows.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="FlowsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="FlowsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FlowsLibrary.MessageFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageFlowDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Message()">Message</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns message.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FlowsLibrary.MessageActionFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageActionFlowDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#MessageAction()">MessageAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns message action.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FlowsLibrary.MessagesFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessagesFlowUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#messages()">messages</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns messages.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FlowsLibrary.SuccessionFlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.SuccessionFlowsFlowUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#successionFlows()">successionFlows</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns succession flows.</div>
</div>
</div>
</div>
</div>
...
<h3>FlowsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">FlowsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new flows library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="FlowsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="FlowsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="MessageAction()">
<h3>MessageAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FlowsLibrary.MessageActionFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageActionFlowDefinition</a></span> <span class="element-name">MessageAction</span>()</div>
<div class="block">Returns message action.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>message action</dd>
</dl>
</section>
</li>
<li>
...
<h3>Message</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FlowsLibrary.MessageFlowDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessageFlowDefinition</a></span> <span class="element-name">Message</span>()</div>
<div class="block">Returns message.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>message</dd>
...
<h3>messages</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FlowsLibrary.MessagesFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.MessagesFlowUsage</a></span> <span class="element-name">messages</span>()</div>
<div class="block">Returns messages.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>messages</dd>
...
<li>
<section class="detail" id="flows()">
<h3>flows</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FlowsLibrary.FlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.FlowsFlowUsage</a></span> <span class="element-name">flows</span>()</div>
<div class="block">Returns flows.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>flows</dd>
...
<li>
<section class="detail" id="successionFlows()">
<h3>successionFlows</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FlowsLibrary.SuccessionFlowsFlowUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">FlowsLibrary.SuccessionFlowsFlowUsage</a></span> <span class="element-name">successionFlows</span>()</div>
<div class="block">Returns succession flows.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>succession flows</dd>
</dl>
</section>
</li>
<li>
