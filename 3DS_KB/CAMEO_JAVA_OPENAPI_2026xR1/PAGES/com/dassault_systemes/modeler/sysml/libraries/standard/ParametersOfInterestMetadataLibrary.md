# JAVA OPENAPI: ParametersOfInterestMetadataLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ParametersOfInterestMetadataLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ParametersOfInterestMetadataLibrary.html`
- source_sha256: `0dc344060e459a6d7bd1e38133bf9c9152ab7bf0687d87f33649eb7533096859`
- captured_utc: `2026-07-14T16:44:54.022922+00:00`
...
@OpenApiAllpublic classParametersOfInterestMetadataLibrary
...
Description
`static class`
`[ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition](ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition.html)`
...
Constructor
Description
`[ParametersOfInterestMetadataLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
...
Method
Description
`static [ParametersOfInterestMetadataLibrary](ParametersOfInterestMetadataLibrary.html)`
...
Returns measure of effectiveness.
...
public ParametersOfInterestMetadataLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new parameters of interest metadata library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ParametersOfInterestMetadataLibrary](ParametersOfInterestMetadataLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ParametersOfInterestMetadataLibrary](ParametersOfInterestMetadataLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
public [ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition](ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition.html) MeasureOfEffectiveness()
Returns measure of effectiveness.
Returns:
...
<h1 class="title" title="Class ParametersOfInterestMetadataLibrary">Class ParametersOfInterestMetadataLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ParametersOfInterestMetadataLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ParametersOfInterestMetadataLibrary</span>
...
<div class="block">Access helper for the parameters of interest metadata standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the measure of effectiveness metadata definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ParametersOfInterestMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ParametersOfInterestMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#MeasureOfEffectiveness()">MeasureOfEffectiveness</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns measure of effectiveness.</div>
</div>
...
<h3>ParametersOfInterestMetadataLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ParametersOfInterestMetadataLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new parameters of interest metadata library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ParametersOfInterestMetadataLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<li>
<section class="detail" id="MeasureOfEffectiveness()">
<h3>MeasureOfEffectiveness</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ParametersOfInterestMetadataLibrary.MeasureOfEffectivenessMetadataDefinition</a></span> <span class="element-name">MeasureOfEffectiveness</span>()</div>
<div class="block">Returns measure of effectiveness.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>measure of effectiveness</dd>
</dl>
</section>
</li>
<li>
