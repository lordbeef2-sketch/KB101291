# JAVA OPENAPI: ISQElectromagnetismLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ISQElectromagnetismLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ISQElectromagnetismLibrary.html`
- source_sha256: `b5787fb2a2b8b1b99418d42c621859d80dca5e266849bc5309273307c5e7f5ef`
- captured_utc: `2026-07-14T16:44:53.354915+00:00`
...
## Class ISQElectromagnetismLibrary
...
com.dassault_systemes.modeler.sysml.libraries.standard.ISQElectromagnetismLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classISQElectromagnetismLibrary
...
Constructor
Description
`[ISQElectromagnetismLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new isqelectromagnetism library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ISQElectromagnetismLibrary](ISQElectromagnetismLibrary.html)`
...
public ISQElectromagnetismLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new isqelectromagnetism library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ISQElectromagnetismLibrary](ISQElectromagnetismLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ISQElectromagnetismLibrary](ISQElectromagnetismLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
<h1 class="title" title="Class ISQElectromagnetismLibrary">Class ISQElectromagnetismLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ISQElectromagnetismLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ISQElectromagnetismLibrary</span>
...
<div class="block">Access helper for the isqelectromagnetism standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQElectromagnetismLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQElectromagnetismLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQElectromagnetismLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQElectromagnetismLibrary</a></code></div>
...
<h3>ISQElectromagnetismLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ISQElectromagnetismLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new isqelectromagnetism library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
