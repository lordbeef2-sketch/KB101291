# JAVA OPENAPI: DerivationConnectionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/DerivationConnectionsLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/DerivationConnectionsLibrary.html`
- source_sha256: `ffe9a08a73dde9a7d29bffa82bd449051b76bbb3d63fc1b96b3fc9a3e3c939cc`
- captured_utc: `2026-07-14T16:44:52.864907+00:00`
...
## Class DerivationConnectionsLibrary
...
com.dassault_systemes.modeler.sysml.libraries.standard.DerivationConnectionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classDerivationConnectionsLibrary
...
Constructor
Description
`[DerivationConnectionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new derivation connections library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [DerivationConnectionsLibrary](DerivationConnectionsLibrary.html)`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DerivationConnectionsLibrary
public DerivationConnectionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new derivation connections library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [DerivationConnectionsLibrary](DerivationConnectionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [DerivationConnectionsLibrary](DerivationConnectionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
<h1 class="title" title="Class DerivationConnectionsLibrary">Class DerivationConnectionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.DerivationConnectionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DerivationConnectionsLibrary</span>
...
<div class="block">Access helper for the derivation connections standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DerivationConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">DerivationConnectionsLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DerivationConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">DerivationConnectionsLibrary</a></code></div>
...
<h3>DerivationConnectionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DerivationConnectionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new derivation connections library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DerivationConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">DerivationConnectionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DerivationConnectionsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">DerivationConnectionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
