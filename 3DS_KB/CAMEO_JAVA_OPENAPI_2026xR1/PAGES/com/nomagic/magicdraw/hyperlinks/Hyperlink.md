# JAVA OPENAPI: Hyperlink (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/hyperlinks/Hyperlink.html
- source_path: `com/nomagic/magicdraw/hyperlinks/Hyperlink.html`
- source_sha256: `c454d84daccd5764c72e70a68cb9ce3e97ca7370ebb9e3915cd3ed9f8a7ecb10`
- captured_utc: `2026-07-14T16:45:37.143497+00:00`
...
Method
Description
`default [Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html),[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)>`
...
`[getText](#getText())()`
Hyperlink text.
`default [Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<com.nomagic.magicdraw.hyperlinks.HyperlinkTextAttributes,[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)>`
...
Field Details
PROTOCOL_SEPARATOR
static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) PROTOCOL_SEPARATOR
Protocol separator.
See Also:
...
Method Details
getUrl
[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getUrl()
URL of the hyperlink.
Returns:
hyperlink URL.
getText
...
getProtocol
[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getProtocol()
Hyperlink protocol.
Returns:
hyperlink protocol.
getTypeText
[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getTypeText()
Hyperlink type text.
Returns:
type text.
getAttributes
default [Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html),[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)> getAttributes()
Hyperlink additional attributes
Returns:
additional attributes
getTextAttributes
default [Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<com.nomagic.magicdraw.hyperlinks.HyperlinkTextAttributes,[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)> getTextAttributes()
...
<div class="block">Hyperlink describes a reference to any resource (e.g., element, file, or any other resource).</div>
</section>
...
<div class="member-signature"><span class="modifiers">static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">PROTOCOL_SEPARATOR</span></div>
<div class="block">Protocol separator.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>getUrl</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getUrl</span>()</div>
<div class="block">URL of the hyperlink.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>hyperlink URL.</dd>
...
<h3>getProtocol</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getProtocol</span>()</div>
<div class="block">Hyperlink protocol.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>getTypeText</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getTypeText</span>()</div>
<div class="block">Hyperlink type text.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>type text.</dd>
