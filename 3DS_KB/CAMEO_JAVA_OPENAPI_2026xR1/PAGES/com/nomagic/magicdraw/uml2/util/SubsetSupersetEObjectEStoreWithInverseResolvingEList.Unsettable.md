# JAVA OPENAPI: SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html`
- source_sha256: `2e3ba9c4ae5354ed36f5a5f4a498a526052c9721f3c050f3c1b993c6749b08ee`
- captured_utc: `2026-07-14T16:46:10.072933+00:00`
...
## Class SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable<E>
...
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)<E>
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable<E>
...
`[SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html)`

Enclosing class:
`[SubsetSupersetEObjectEStoreWithInverseResolvingEList](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)>`

public static classSubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable<E>
extends [SubsetSupersetEObjectEStoreWithInverseResolvingEList](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html)<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreWithInverseResolvingEList](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)
...
`void`
`[unset](#unset())()`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreWithInverseResolvingEList](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html)
`[resolve](SubsetSupersetEObjectEStoreWithInverseResolvingEList.html#resolve(int,E))`
...
`canContainNull, hasInstanceClass, hasManyInverse, isContainer, isContainment, isEObject, isUnique, isUnsettable, kind, useEquals`
...
Overrides:
`didChange` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">Class SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance"><a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList</a>&lt;E&gt;
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.ManyInverse">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseResolvingEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList</a></h2>
<code><a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<code><a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.html#resolve(int,E)">resolve</a></code></div>
<div class="inherited-list">
...
<code>canContainNull, hasInstanceClass, hasManyInverse, isContainer, isContainment, isEObject, isUnique, isUnsettable, kind, useEquals</code></div>
<div class="inherited-list">
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
