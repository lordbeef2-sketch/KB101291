# JAVA OPENAPI: SubsetSupersetEObjectContainmentWithInverseEList.Resolving (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html`
- source_sha256: `2208c37b1617d26eb1a993e09e2e89fbde8ca21203a1a7c9b74489c77ba95ced`
- captured_utc: `2026-07-14T16:46:09.624930+00:00`
...
## Class SubsetSupersetEObjectContainmentWithInverseEList.Resolving<E>
...
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentWithInverseEList.Resolving<E>
...
public static classSubsetSupersetEObjectContainmentWithInverseEList.Resolving<E>
extends [SubsetSupersetEObjectContainmentWithInverseEList](SubsetSupersetEObjectContainmentWithInverseEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentWithInverseEList.Resolving)
...
`[SubsetSupersetEObjectContainmentWithInverseEList.Resolving](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html)<[E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html)>, [SubsetSupersetEObjectContainmentWithInverseEList.Unsettable](SubsetSupersetEObjectContainmentWithInverseEList.Unsettable.html)<[E](SubsetSupersetEObjectContainmentWithInverseEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
...
Creates and initializes a new `SubsetSupersetEObjectContainmentWithInverseEList$Resolving` instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`protected [E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html)`
`[resolve](#resolve(int,E))(int index,
 [E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html) object)`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset`
...
Overrides:
`hasProxies` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html)>`
resolve
protected [E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html) resolve(int index,
 [E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html) object)
Overrides:
`resolve` in class `org.eclipse.emf.ecore.util.EObjectEList<[E](SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectContainmentWithInverseEList.Resolving">Class SubsetSupersetEObjectContainmentWithInverseEList.Resolving&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentWithInverseEList.Resolving&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectContainmentWithInverseEList.Resolving&lt;E&gt;</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentWithInverseEList.Resolving">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<code><a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentWithInverseEList.Resolving</a>&lt;<a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a>&gt;, <a href="SubsetSupersetEObjectContainmentWithInverseEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentWithInverseEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<div class="block">Creates and initializes a new <code>SubsetSupersetEObjectContainmentWithInverseEList$Resolving</code> instance.</div>
</div>
</div>
</section>
</li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resolve(int,E)">resolve</a><wbr/>(int index,
 <a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a> object)</code></div>
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset</code></div>
<div class="inherited-list">
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasProxies</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a></span> <span class="element-name">resolve</span><wbr/><span class="parameters">(int index,
 <a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a> object)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>resolve</code> in class <code>org.eclipse.emf.ecore.util.EObjectEList&lt;<a href="SubsetSupersetEObjectContainmentWithInverseEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentWithInverseEList.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
