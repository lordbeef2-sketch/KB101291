# JAVA OPENAPI: SubsetSupersetEObjectResolvingEList (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectResolvingEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectResolvingEList.html`
- source_sha256: `c387e4e7a54f93a8e7de3f221d66b8d2216c6b8f243e574499ac723f5c07b768`
- captured_utc: `2026-07-14T16:46:10.124935+00:00`
...
public classSubsetSupersetEObjectResolvingEList<E>
extends [SubsetSupersetEObjectEList](SubsetSupersetEObjectEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectResolvingEList)
...
Constructor
Description
`[SubsetSupersetEObjectResolvingEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`protected [E](SubsetSupersetEObjectResolvingEList.html)`
`[resolve](#resolve(int,E))(int index,
 [E](SubsetSupersetEObjectResolvingEList.html) object)`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset`
...
public SubsetSupersetEObjectResolvingEList([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs)
...
Overrides:
`hasProxies` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectResolvingEList.html)>`
resolve
protected [E](SubsetSupersetEObjectResolvingEList.html) resolve(int index,
 [E](SubsetSupersetEObjectResolvingEList.html) object)
Overrides:
`resolve` in class `org.eclipse.emf.ecore.util.EObjectEList<[E](SubsetSupersetEObjectResolvingEList.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectResolvingEList">Class SubsetSupersetEObjectResolvingEList&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectResolvingEList&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">SubsetSupersetEObjectResolvingEList&lt;E&gt;</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectResolvingEList">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D)">SubsetSupersetEObjectResolvingEList</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates and initializes a new <code>SubsetSupersetEObjectResolvingEList</code> instance.</div>
</div>
</div>
</section>
</li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resolve(int,E)">resolve</a><wbr/>(int index,
 <a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a> object)</code></div>
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset</code></div>
<div class="inherited-list">
...
<h3>SubsetSupersetEObjectResolvingEList</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SubsetSupersetEObjectResolvingEList</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasProxies</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a></span> <span class="element-name">resolve</span><wbr/><span class="parameters">(int index,
 <a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a> object)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>resolve</code> in class <code>org.eclipse.emf.ecore.util.EObjectEList&lt;<a href="SubsetSupersetEObjectResolvingEList.html" title="type parameter in SubsetSupersetEObjectResolvingEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
