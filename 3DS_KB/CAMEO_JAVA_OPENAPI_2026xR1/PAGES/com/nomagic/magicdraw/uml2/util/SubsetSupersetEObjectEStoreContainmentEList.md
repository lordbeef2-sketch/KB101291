# JAVA OPENAPI: SubsetSupersetEObjectEStoreContainmentEList (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentEList.html`
- source_sha256: `7fe2f54135f03194a225c77e708e3361328874743c3bcab757d85d18d08e3a1f`
- captured_utc: `2026-07-14T16:46:09.862930+00:00`
...
`[SubsetSupersetEObjectEStoreContainmentEList.Resolving](SubsetSupersetEObjectEStoreContainmentEList.Resolving.html)`, `[SubsetSupersetEObjectEStoreContainmentEList.Unsettable](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)`, `[SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)`

public classSubsetSupersetEObjectEStoreContainmentEList<E>
extends [SubsetSupersetEObjectEStoreEList](SubsetSupersetEObjectEStoreEList.html)<E>

Since:
1.2
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreContainmentEList.Resolving](SubsetSupersetEObjectEStoreContainmentEList.Resolving.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.Resolving.html)>`
...
Constructor
Description
`[SubsetSupersetEObjectEStoreContainmentEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`[addAll](#addAll(int,java.util.Collection))(int index,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectEStoreContainmentEList.html)> collection)`

`boolean`
`[addAll](#addAll(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectEStoreContainmentEList.html)> collection)`
...
public SubsetSupersetEObjectEStoreContainmentEList([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 @CheckForNull
 int[] supersetFeatureIDs,
...
Overrides:
`hasInverse` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
hasNavigableInverse
protected boolean hasNavigableInverse()
Overrides:
`hasNavigableInverse` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
isContainment
protected boolean isContainment()
Overrides:
`isContainment` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
addAll
public boolean addAll([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectEStoreContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html#addAll(java.util.Collection))` in interface `[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
Overrides:
`[addAll](SubsetSupersetEObjectEStoreEList.html#addAll(java.util.Collection))` in class `[SubsetSupersetEObjectEStoreEList](SubsetSupersetEObjectEStoreEList.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
addAll
public boolean addAll(int index,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectEStoreContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(int,java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
Overrides:
`[addAll](SubsetSupersetEObjectEStoreEList.html#addAll(int,java.util.Collection))` in class `[SubsetSupersetEObjectEStoreEList](SubsetSupersetEObjectEStoreEList.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreContainmentEList">Class SubsetSupersetEObjectEStoreContainmentEList&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectEStoreContainmentEList.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList.Resolving</a></code>, <code><a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList.Unsettable</a></code>, <code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreContainmentEList&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectEStoreEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>Since:</dt>
<dd>1.2</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D)">SubsetSupersetEObjectEStoreContainmentEList</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#addAll(int,java.util.Collection)">addAll</a><wbr/>(int index,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends <a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt; collection)</code></div>
...
<h3>SubsetSupersetEObjectEStoreContainmentEList</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SubsetSupersetEObjectEStoreContainmentEList</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 @CheckForNull
 int[] supersetFeatureIDs,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasInverse</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasNavigableInverse</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>isContainment</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>addAll</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">addAll</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends <a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt; collection)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html#addAll(java.util.Collection)" title="class or interface in java.util">addAll</a></code> in interface <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
<dt>Specified by:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(java.util.Collection)" title="class or interface in java.util">addAll</a></code> in interface <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreEList.html#addAll(java.util.Collection)">addAll</a></code> in class <code><a href="SubsetSupersetEObjectEStoreEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreEList</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreEList.html#addAll(int,java.util.Collection)">addAll</a></code> in class <code><a href="SubsetSupersetEObjectEStoreEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreEList</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
