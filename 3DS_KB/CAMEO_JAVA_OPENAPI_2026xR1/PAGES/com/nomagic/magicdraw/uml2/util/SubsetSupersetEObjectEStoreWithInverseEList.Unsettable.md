# JAVA OPENAPI: SubsetSupersetEObjectEStoreWithInverseEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html`
- source_sha256: `ea774981ad702fdf06f83d986a0e0e9c8b272dc1a148703044e25f19a4561e49`
- captured_utc: `2026-07-14T16:46:09.969934+00:00`
...
`[SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html)`

Enclosing class:
`[SubsetSupersetEObjectEStoreWithInverseEList](SubsetSupersetEObjectEStoreWithInverseEList.html)<[E](SubsetSupersetEObjectEStoreWithInverseEList.html)>`

public static classSubsetSupersetEObjectEStoreWithInverseEList.Unsettable<E>
extends [SubsetSupersetEObjectEStoreWithInverseEList](SubsetSupersetEObjectEStoreWithInverseEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html)<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreWithInverseEList](SubsetSupersetEObjectEStoreWithInverseEList.html)
`[SubsetSupersetEObjectEStoreWithInverseEList.Unsettable](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
Fields
Modifier and Type
...
Overrides:
`didChange` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">Class SubsetSupersetEObjectEStoreWithInverseEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseEList</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreWithInverseEList.Unsettable&lt;E&gt;</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.ManyInverse">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreWithInverseEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectEStoreWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseEList</a></h2>
<code><a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreWithInverseEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
