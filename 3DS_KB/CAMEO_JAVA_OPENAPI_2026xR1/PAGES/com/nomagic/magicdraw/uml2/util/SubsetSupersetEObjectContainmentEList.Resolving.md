# JAVA OPENAPI: SubsetSupersetEObjectContainmentEList.Resolving (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.Resolving.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.Resolving.html`
- source_sha256: `389ac097fc6bda2a276c993d718fe3e01cd93993e10d1e5090d83c159d185b40`
- captured_utc: `2026-07-14T16:46:09.550926+00:00`
...
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Resolving<E>
...
public static classSubsetSupersetEObjectContainmentEList.Resolving<E>
extends [SubsetSupersetEObjectContainmentEList](SubsetSupersetEObjectContainmentEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Resolving)
...
`[SubsetSupersetEObjectContainmentEList.Resolving](SubsetSupersetEObjectContainmentEList.Resolving.html)<[E](SubsetSupersetEObjectContainmentEList.Resolving.html)>, [SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)<[E](SubsetSupersetEObjectContainmentEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
...
`protected [E](SubsetSupersetEObjectContainmentEList.Resolving.html)`
`[resolve](#resolve(int,E))(int index,
 [E](SubsetSupersetEObjectContainmentEList.Resolving.html) object)`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset`
...
Overrides:
`hasProxies` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectContainmentEList.Resolving.html)>`
resolve
protected [E](SubsetSupersetEObjectContainmentEList.Resolving.html) resolve(int index,
 [E](SubsetSupersetEObjectContainmentEList.Resolving.html) object)
Overrides:
`resolve` in class `org.eclipse.emf.ecore.util.EObjectEList<[E](SubsetSupersetEObjectContainmentEList.Resolving.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectContainmentEList.Resolving">Class SubsetSupersetEObjectContainmentEList.Resolving&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Resolving&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectContainmentEList.Resolving&lt;E&gt;</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Resolving">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<code><a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Resolving</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a>&gt;, <a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resolve(int,E)">resolve</a><wbr/>(int index,
 <a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a> object)</code></div>
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, isSet, newData, resolve, resolveProxy, set, toArray, toArray, unset</code></div>
<div class="inherited-list">
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasProxies</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a></span> <span class="element-name">resolve</span><wbr/><span class="parameters">(int index,
 <a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a> object)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>resolve</code> in class <code>org.eclipse.emf.ecore.util.EObjectEList&lt;<a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
