# JAVA OPENAPI: ExportConfiguration (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/cbm/xpdl/export/ExportConfiguration.html
- source_path: `com/nomagic/magicdraw/cbm/xpdl/export/ExportConfiguration.html`
- source_sha256: `836cb51199582c35360d62fbda8382ab95e6e70e3aa8b036d20661506d962b40`
- captured_utc: `2026-07-14T16:45:28.505381+00:00`
...
Constructor
Description
`[ExportConfiguration](#%3Cinit%3E(java.io.File,java.io.OutputStream))([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) exportFile,
...
Constructor Details
ExportConfiguration
public ExportConfiguration([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) exportFile,
 [OutputStream](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/OutputStream.html) outputStream)
Constructs this configuration.
Parameters:
...
Method Details
getExportFile
public [File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) getExportFile()
Gets file to which export is performed.
Returns:
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.io.File,java.io.OutputStream)">ExportConfiguration</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a> exportFile,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/OutputStream.html" title="class or interface in java.io">OutputStream</a> outputStream)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/OutputStream.html" title="class or interface in java.io">OutputStream</a></code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ExportConfiguration</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a> exportFile,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/OutputStream.html" title="class or interface in java.io">OutputStream</a> outputStream)</span></div>
<div class="block">Constructs this configuration.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getExportFile</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a></span> <span class="element-name">getExportFile</span>()</div>
<div class="block">Gets file to which export is performed.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/OutputStream.html" title="class or interface in java.io">OutputStream</a></span> <span class="element-name">getOutputStream</span>()</div>
<div class="block">Gets output stream to which export is performed.</div>
<dl class="notes">
<dt>Returns:</dt>
