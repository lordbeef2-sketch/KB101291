# JAVA OPENAPI: BPMN2Profile.CorrelationSubscriptionStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.CorrelationSubscriptionStereotype.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.CorrelationSubscriptionStereotype.html`
- source_sha256: `f1ff1df0a6b05f8d1ce10898d6d659d27068858891871a814d51813cf3e5316f`
- captured_utc: `2026-07-14T16:45:11.354154+00:00`
...
CORRELATIONKEYREF
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) CORRELATIONKEYREF
The CorrelationKey this CorrelationSubscription refers to.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) CORRELATIONPROPERTYBINDING
The bindings to specific CorrelationProperties and FormalExpressions (extraction rules atop the Process context).
See Also:
...
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getCorrelationPropertyBinding([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setId
