# JAVA OPENAPI: BPMN2Profile.AdHocOrderingEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.AdHocOrderingEnum.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.AdHocOrderingEnum.html`
- source_sha256: `4dd8b9adbb296677abcc7f49ae3433a06461522cb0cee36b56e840e518acdbd3`
- captured_utc: `2026-07-14T16:45:09.657131+00:00`
...
## Enum Class BPMN2Profile.AdHocOrderingEnum

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html)>
com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.AdHocOrderingEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[BPMN2Profile](BPMN2Profile.html)`

public static enumBPMN2Profile.AdHocOrderingEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html)>
...
Method
Description
`static [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.AdHocOrderingEnum))([BPMN2Profile](BPMN2Profile.html) profile,
 [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) anEnum)`
...
PARALLEL
public static final [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) PARALLEL
SEQUENTIAL
public static final [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) SEQUENTIAL
 ============ METHOD DETAIL ========== 
Method Details
values
public static [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [BPMN2Profile.AdHocOrderingEnum](BPMN2Profile.AdHocOrderingEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">BPMN2Profile.AdHocOrderingEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a>&gt;</span></div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#PARALLEL">PARALLEL</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#SEQUENTIAL">SEQUENTIAL</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.AdHocOrderingEnum)">toEnumerationLiteral</a><wbr/>(<a href="BPMN2Profile.html" title="class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile</a> profile,
 <a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a>[]</code></div>
...
<h3>PARALLEL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></span> <span class="element-name">PARALLEL</span></div>
</section>
</li>
<li>
<section class="detail" id="SEQUENTIAL">
<h3>SEQUENTIAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></span> <span class="element-name">SEQUENTIAL</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.AdHocOrderingEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="BPMN2Profile.AdHocOrderingEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.AdHocOrderingEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
