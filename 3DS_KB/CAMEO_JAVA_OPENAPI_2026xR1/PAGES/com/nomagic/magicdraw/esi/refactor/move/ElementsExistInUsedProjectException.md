# JAVA OPENAPI: ElementsExistInUsedProjectException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/esi/refactor/move/ElementsExistInUsedProjectException.html
- source_path: `com/nomagic/magicdraw/esi/refactor/move/ElementsExistInUsedProjectException.html`
- source_sha256: `01ce16751abecbc840f9357e970ca26aa11225ed29f91d59d2dbfe3437552027`
- captured_utc: `2026-07-14T16:45:36.031480+00:00`
...
@OpenApiAllpublic classElementsExistInUsedProjectException
...
See Also:
[Serialized Form](../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.ElementsExistInUsedProjectException)
...
Constructor
Description
`[ElementsExistInUsedProjectException](#%3Cinit%3E(java.util.Set))([Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> elements)`
Creates new instance of [`ElementsExistInUsedProjectException`](ElementsExistInUsedProjectException.html)
 ========== METHOD SUMMARY =========== 
Method Summary
...
public ElementsExistInUsedProjectException([Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> elements)
Creates new instance of [`ElementsExistInUsedProjectException`](ElementsExistInUsedProjectException.html)
Parameters:
...
Method Details
getElements
public [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getElements()
Gets the element that does not exist in the used project anymore
Returns:
the element
...
<h1 class="title" title="Class ElementsExistInUsedProjectException">Class ElementsExistInUsedProjectException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.esi.refactor.move.ElementsExistInUsedProjectException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ElementsExistInUsedProjectException</span>
...
<div class="block">Exception that is thrown when some of the moved elements already exist in the target used project</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.ElementsExistInUsedProjectException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.Set)">ElementsExistInUsedProjectException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html" title="class or interface in java.util">Set</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt; elements)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates new instance of <a href="ElementsExistInUsedProjectException.html" title="class in com.nomagic.magicdraw.esi.refactor.move"><code>ElementsExistInUsedProjectException</code></a></div>
</div>
</div>
</section>
</li>
...
<div class="block">Gets the element that does not exist in the used project anymore</div>
</div>
</div>
</div>
</div>
...
<h3>ElementsExistInUsedProjectException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ElementsExistInUsedProjectException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html" title="class or interface in java.util">Set</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt; elements)</span></div>
<div class="block">Creates new instance of <a href="ElementsExistInUsedProjectException.html" title="class in com.nomagic.magicdraw.esi.refactor.move"><code>ElementsExistInUsedProjectException</code></a></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>elements</code> - the elements that already exist in the target project by Local ID</dd>
</dl>
</section>
</li>
</ul>
