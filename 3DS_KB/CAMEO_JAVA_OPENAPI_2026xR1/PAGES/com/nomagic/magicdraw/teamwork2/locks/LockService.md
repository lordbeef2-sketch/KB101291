# JAVA OPENAPI: LockService (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/teamwork2/locks/LockService.html
- source_path: `com/nomagic/magicdraw/teamwork2/locks/LockService.html`
- source_sha256: `df8979f607e29d6ca9b6448dd4da1585ab243f4f7de331b868bd0d0950ac0690`
- captured_utc: `2026-07-14T16:45:47.933640+00:00`
...
`protected boolean`
`[hasAutomaticUsages](#hasAutomaticUsages(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ModuleUsage](../../core/modules/ModuleUsage.html)> moduleUsages)`
...
`[selectElementsForLock](#selectElementsForLock(java.util.Collection,java.util.function.Predicate))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> collection,
 [Predicate](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Predicate.html)<[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> canBeLocked)`
...
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> selectElementsForLock(@Nonnull
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> collection,
 [Predicate](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Predicate.html)<[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> canBeLocked)
hasAutomaticUsages
protected boolean hasAutomaticUsages([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ModuleUsage](../../core/modules/ModuleUsage.html)> moduleUsages)
