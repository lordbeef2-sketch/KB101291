# JAVA OPENAPI: IdleJobService (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/job/IdleJobService.html
- source_path: `com/nomagic/magicdraw/job/IdleJobService.html`
- source_sha256: `88f1d5d5394a38ed8c5774f216704974036720b531e0d6020869abb6ec52b121`
- captured_utc: `2026-07-14T16:45:37.568502+00:00`
...
Immediately runs the job, without checking if it needs to run
Parameters:
`job` - job that was previously added to the service
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>job</code> - job that was previously added to the service</dd>
</dl>
</section>
</li>
</ul>
