# JAVA OPENAPI: Emf2MofUml2MetaclassMap (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/emfuml2xmi/v2/imp0rt/convert/Emf2MofUml2MetaclassMap.html
- source_path: `com/nomagic/magicdraw/emfuml2xmi/v2/imp0rt/convert/Emf2MofUml2MetaclassMap.html`
- source_sha256: `5a648fcb9c506783a3a5fd6616b13f4ce82a8a3011a64d202153a7b8f2b33caf`
- captured_utc: `2026-07-14T16:45:34.757465+00:00`
...
`[get](#get(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName)`
Returns corresponding MagicDraw UML model metaclass.
`static void`
`[put](#put(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) mdClassName)`
Maps Eclipse UML2 model metaclass to MagicDraw UML model metaclass.
`static void`
`[remove](#remove(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName)`
...
get
@CheckForNull
@OpenApipublic static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) get([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName)
Returns corresponding MagicDraw UML model metaclass.
Parameters:
...
put
@OpenApipublic static void put([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) mdClassName)
Maps Eclipse UML2 model metaclass to MagicDraw UML model metaclass.
Parameters:
...
remove
@OpenApipublic static void remove([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName)
Removes mapping between Eclipse UML2 model metaclass and MagicDraw UML2 model metaclass.
Parameters:
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#put(java.lang.String,java.lang.String)">put</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> eClassName,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mdClassName)</code></div>
...
<div class="member-signature"><span class="annotations">@OpenApi
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mdClassName)</span></div>
<div class="block">Maps Eclipse UML2 model metaclass to MagicDraw UML model metaclass.</div>
<dl class="notes">
<dt>Parameters:</dt>
