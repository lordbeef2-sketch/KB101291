# JAVA OPENAPI: ListProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/ListProperty.html
- source_path: `com/nomagic/magicdraw/properties/ListProperty.html`
- source_sha256: `642e836506333a2765fc9c4d06b453f76a80697ce3c22027c68b2e7dd731c174`
- captured_utc: `2026-07-14T16:45:39.438526+00:00`
...
`[ClassPathEntriesListProperty](ClassPathEntriesListProperty.html)`, `[ElementListProperty](ElementListProperty.html)`

@OpenApiAllpublic classListProperty
...
Constructor
Description
`[ListProperty](#%3Cinit%3E())()`
Creates and initializes a new `ListProperty` object.
`[ListProperty](#%3Cinit%3E(java.lang.String,java.lang.Object%5B%5D))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)[] value)`
Creates and initializes a new `ListProperty` object from
...
`[ListProperty](ListProperty.html)`
`[clone](#clone())()`
Clones the property.
...
public ListProperty()
Creates and initializes a new `ListProperty` object.
 ID of the property will be empty string and value - null.
ListProperty
public ListProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)[] value)
Creates and initializes a new `ListProperty` object from
 specified parameters.
Parameters:
...
`value` - a value.
Throws:
`[IllegalArgumentException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html)` - if specified value is not
 an array. null is legal value.
getClassType
...
See Also:
[`PropertyID.LIST_PROPERTY`](PropertyID.html#LIST_PROPERTY)
accept
...
getValue
public [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)[] getValue()
...
clone
public [ListProperty](ListProperty.html) clone()
...
<h1 class="title" title="Class ListProperty">Class ListProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.ListProperty</div>
</div>
</div>
...
<dd><code><a href="ClassPathEntriesListProperty.html" title="class in com.nomagic.magicdraw.properties">ClassPathEntriesListProperty</a></code>, <code><a href="ElementListProperty.html" title="class in com.nomagic.magicdraw.properties">ElementListProperty</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ListProperty</span>
...
<div class="block"><code>ListProperty</code> represents a property for storing and editing entries of the list.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ListProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates and initializes a new <code>ListProperty</code> object.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Object%5B%5D)">ListProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="block">Creates and initializes a new <code>ListProperty</code> object from
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ListProperty.html" title="class in com.nomagic.magicdraw.properties">ListProperty</a></code></div>
...
<h3>ListProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ListProperty</span>()</div>
<div class="block">Creates and initializes a new <code>ListProperty</code> object.
 ID of the property will be empty string and value - null.</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.lang.Object[])">
<h3>ListProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ListProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang">IllegalArgumentException</a></code> - if specified value is not
 an array. null is legal value.</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>PropertyID.LIST_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#LIST_PROPERTY"><code>PropertyID.LIST_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>getValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a>[]</span> <span class="element-name">getValue</span>()</div>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ListProperty.html" title="class in com.nomagic.magicdraw.properties">ListProperty</a></span> <span class="element-name">clone</span>()</div>
