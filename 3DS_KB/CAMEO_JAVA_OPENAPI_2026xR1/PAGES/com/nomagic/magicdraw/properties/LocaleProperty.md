# JAVA OPENAPI: LocaleProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/LocaleProperty.html
- source_path: `com/nomagic/magicdraw/properties/LocaleProperty.html`
- source_sha256: `4ee0963d901b9b83a27cd4dc43c6fca04d3c936f0d1d796dbbe9d48a0b0a53ed`
- captured_utc: `2026-07-14T16:45:39.871533+00:00`
...
[com.nomagic.magicdraw.properties.ChoiceProperty](ChoiceProperty.html)
...
@OpenApiAllpublic classLocaleProperty
extends [ChoiceProperty](ChoiceProperty.html)

The property for storing and editing some `java.util.Locale`
 value.
...
Constructor
Description
`[LocaleProperty](#%3Cinit%3E())()`
Default constructor.
`[LocaleProperty](#%3Cinit%3E(java.lang.String,int,java.util.List))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 int index,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html) choice)`
The constructor.
`[LocaleProperty](#%3Cinit%3E(java.lang.String,java.lang.Object,java.util.List))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`void`
`[updateLocaleByString](#updateLocaleByString(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) locale)`
Update Locale By String
`void`
`[updateLocaleByValue](#updateLocaleByValue())()`
Updates locale by current value.
Methods inherited from class com.nomagic.magicdraw.properties.[ChoiceProperty](ChoiceProperty.html)
`[getIndex](ChoiceProperty.html#getIndex()), [isAppendValue](ChoiceProperty.html#isAppendValue()), [setAppendValue](ChoiceProperty.html#setAppendValue(boolean)), [setChoice](ChoiceProperty.html#setChoice(java.util.List)), [setIndex](ChoiceProperty.html#setIndex(int)), [setValue](ChoiceProperty.html#setValue(java.lang.Object)), [toString](ChoiceProperty.html#toString())`
...
LocaleProperty
public LocaleProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html) choice)
The constructor.
Parameters:
...
Method Details
getLocale
public [Locale](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html) getLocale()
Return the locale.
Returns:
a locale from property.
setLocale
public void setLocale([Locale](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html) locale)
Sets a new locale for property.
Parameters:
`locale` - a new locale.
updateLocaleByValue
...
Updates locale by current value.
 Also updates available language list for this property from ResourceManager languages.
updateLocaleByString
public void updateLocaleByString([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) locale)
Update Locale By String
Parameters:
...
Overrides:
`[getClassType](ChoiceProperty.html#getClassType())` in class `[ChoiceProperty](ChoiceProperty.html)`
Returns:
PropertyID.LOCALE_PROPERTY
See Also:
[`PropertyID.LOCALE_PROPERTY`](PropertyID.html#LOCALE_PROPERTY)
accept
...
Overrides:
`[accept](ChoiceProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor))` in class `[ChoiceProperty](ChoiceProperty.html)`
Parameters:
`v` - the PropertyVisitor.
Throws:
`[Exception](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Exception.html)`
clone
public [LocaleProperty](LocaleProperty.html) clone()
...
Overrides:
`[clone](ChoiceProperty.html#clone())` in class `[ChoiceProperty](ChoiceProperty.html)`
Returns:
the cloned property.
...
<h1 class="title" title="Class LocaleProperty">Class LocaleProperty</h1>
</div>
...
<div class="inheritance"><a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">com.nomagic.magicdraw.properties.ChoiceProperty</a>
<div class="inheritance">com.nomagic.magicdraw.properties.LocaleProperty</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">LocaleProperty</span>
<span class="extends-implements">extends <a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">ChoiceProperty</a></span></div>
<div class="block">The property for storing and editing some <code>java.util.Locale</code>
 value.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util"><code>Locale</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">LocaleProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,int,java.util.List)">LocaleProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 int index,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a> choice)</code></div>
<div class="col-last odd-row-color">
<div class="block">The constructor.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Object,java.util.List)">LocaleProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="LocaleProperty.html" title="class in com.nomagic.magicdraw.properties">LocaleProperty</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLocale()">getLocale</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Return the locale.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setLocale(java.util.Locale)">setLocale</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a> locale)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets a new locale for property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updateLocaleByString(java.lang.String)">updateLocaleByString</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> locale)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Update Locale By String</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updateLocaleByValue()">updateLocaleByValue</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Updates locale by current value.</div>
</div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.properties.ChoiceProperty">Methods inherited from class com.nomagic.magicdraw.properties.<a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">ChoiceProperty</a></h3>
<code><a href="ChoiceProperty.html#getIndex()">getIndex</a>, <a href="ChoiceProperty.html#isAppendValue()">isAppendValue</a>, <a href="ChoiceProperty.html#setAppendValue(boolean)">setAppendValue</a>, <a href="ChoiceProperty.html#setChoice(java.util.List)">setChoice</a>, <a href="ChoiceProperty.html#setIndex(int)">setIndex</a>, <a href="ChoiceProperty.html#setValue(java.lang.Object)">setValue</a>, <a href="ChoiceProperty.html#toString()">toString</a></code></div>
<div class="inherited-list">
...
<h3>LocaleProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">LocaleProperty</span>()</div>
...
<h3>LocaleProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">LocaleProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a> choice)</span></div>
<div class="block">The constructor.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getLocale</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a></span> <span class="element-name">getLocale</span>()</div>
<div class="block">Return the locale.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>a locale from property.</dd>
</dl>
</section>
</li>
<li>
...
<h3>setLocale</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setLocale</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a> locale)</span></div>
<div class="block">Sets a new locale for property.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>locale</code> - a new locale.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="updateLocaleByValue()">
<h3>updateLocaleByValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">updateLocaleByValue</span>()</div>
<div class="block">Updates locale by current value.
 Also updates available language list for this property from ResourceManager languages.</div>
</section>
</li>
<li>
<section class="detail" id="updateLocaleByString(java.lang.String)">
<h3>updateLocaleByString</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">updateLocaleByString</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> locale)</span></div>
<div class="block">Update Locale By String</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<dt>Overrides:</dt>
<dd><code><a href="ChoiceProperty.html#getClassType()">getClassType</a></code> in class <code><a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">ChoiceProperty</a></code></dd>
<dt>Returns:</dt>
<dd>PropertyID.LOCALE_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#LOCALE_PROPERTY"><code>PropertyID.LOCALE_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<dt>Overrides:</dt>
<dd><code><a href="ChoiceProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor)">accept</a></code> in class <code><a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">ChoiceProperty</a></code></dd>
<dt>Parameters:</dt>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="LocaleProperty.html" title="class in com.nomagic.magicdraw.properties">LocaleProperty</a></span> <span class="element-name">clone</span>()</div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ChoiceProperty.html#clone()">clone</a></code> in class <code><a href="ChoiceProperty.html" title="class in com.nomagic.magicdraw.properties">ChoiceProperty</a></code></dd>
<dt>Returns:</dt>
