# JAVA OPENAPI: BooleanProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/BooleanProperty.html
- source_path: `com/nomagic/magicdraw/properties/BooleanProperty.html`
- source_sha256: `19f59b3500030c81cf86c0c11a0da55c9da84cc57624c87ec1d22bffb02799b9`
- captured_utc: `2026-07-14T16:45:39.195523+00:00`
...
@OpenApiAllpublic classBooleanProperty
...
Constructor
Description
`[BooleanProperty](#%3Cinit%3E())()`
Default constructor.
`[BooleanProperty](#%3Cinit%3E(java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 boolean value)`
The boolean property constructor.
`[BooleanProperty](#%3Cinit%3E(java.lang.String,java.lang.Boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`[BooleanProperty](BooleanProperty.html)`
`[clone](#clone())()`
Clones the property.
`boolean`
...
`[getBooleanObject](#getBooleanObject())()`
...
`[getStringRepresentation](#getStringRepresentation(com.nomagic.magicdraw.properties.Property,java.lang.Boolean))([Property](Property.html) property,
 [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)`
Returns value's string representation.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getStringRepresentation](#getStringRepresentation(java.lang.Boolean))([Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)`
Returns value's string representation.
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
...
`void`
`[setValue](#setValue(boolean))(boolean value)`
...
Default constructor. Value of the property will be false.
 ID will be empty string.
BooleanProperty
public BooleanProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)
The boolean property constructor.
Parameters:
...
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getStringRepresentation(@CheckForNull
 [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)
Returns value's string representation.
Parameters:
...
Returns value's string representation.
Parameters:
`property` - the string representation for this property. A property can have its own 'undefined' state representation.
`value` - The given value.
Returns:
String representation.
accept
...
getBooleanObject
public [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) getBooleanObject()
Returns value as `Boolean` object.
Returns:
...
setValue
public void setValue([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)
...
See Also:
[`PropertyID.BOOLEAN_PROPERTY`](PropertyID.html#BOOLEAN_PROPERTY)
isValueCompatible
...
clone
public [BooleanProperty](BooleanProperty.html) clone()
...
<h1 class="title" title="Class BooleanProperty">Class BooleanProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.BooleanProperty</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">BooleanProperty</span>
...
<div class="block">The property for storing and editing boolean value.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">BooleanProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,boolean)">BooleanProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 boolean value)</code></div>
<div class="col-last odd-row-color">
<div class="block">The boolean property constructor.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Boolean)">BooleanProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="BooleanProperty.html" title="class in com.nomagic.magicdraw.properties">BooleanProperty</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns value as boolean (primitive type).</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getBooleanObject()">getBooleanObject</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns value as <code>Boolean</code> object.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getStringRepresentation(com.nomagic.magicdraw.properties.Property,java.lang.Boolean)">getStringRepresentation</a><wbr/>(<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a> property,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a> value)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getStringRepresentation(java.lang.Boolean)">getStringRepresentation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a> value)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setValue(boolean)">setValue</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value as primitive boolean type.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets boolean value from given Object.</div>
</div>
</div>
</div>
</div>
...
<h3>BooleanProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BooleanProperty</span>()</div>
<div class="block">Default constructor. Value of the property will be false.
 ID will be empty string.</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.lang.Boolean)">
<h3>BooleanProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BooleanProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<dd><code>value</code> - the boolean value of the property.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of the property.</dd>
<dd><code>value</code> - the boolean value of the property.</dd>
</dl>
</section>
</li>
...
<dt>Returns:</dt>
<dd>string "True", "False" or "?" if property does not have value.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getStringRepresentation(java.lang.Boolean)">
...
<li>
<section class="detail" id="getStringRepresentation(com.nomagic.magicdraw.properties.Property,java.lang.Boolean)">
<h3>getStringRepresentation</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getStringRepresentation</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>property</code> - the string representation for this property. A property can have its own 'undefined' state representation.</dd>
<dd><code>value</code> - The given value.</dd>
<dt>Returns:</dt>
<dd>String representation.</dd>
</dl>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>value as primitive boolean. If value object is null, returns false.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getBooleanObject()">
<h3>getBooleanObject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a></span> <span class="element-name">getBooleanObject</span>()</div>
<div class="block">Returns value as <code>Boolean</code> object.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>value as <code>Boolean</code> object.</dd>
</dl>
</section>
</li>
<li>
...
<h3>setValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setValue</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets value as primitive boolean type.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the given new boolean value.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block">Sets boolean value from given Object. ses toString</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dt>Returns:</dt>
<dd>PropertyID.BOOLEAN_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#BOOLEAN_PROPERTY"><code>PropertyID.BOOLEAN_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="BooleanProperty.html" title="class in com.nomagic.magicdraw.properties">BooleanProperty</a></span> <span class="element-name">clone</span>()</div>
