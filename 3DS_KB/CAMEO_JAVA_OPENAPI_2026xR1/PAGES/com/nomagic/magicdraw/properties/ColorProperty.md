# JAVA OPENAPI: ColorProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/ColorProperty.html
- source_path: `com/nomagic/magicdraw/properties/ColorProperty.html`
- source_sha256: `3e08e2033a9dabd693aaed555405c3e31e7fbbbe8c0ac577eda5bbe0648cbde5`
- captured_utc: `2026-07-14T16:45:39.241525+00:00`
...
@OpenApiAllpublic classColorProperty
...
Constructor
Description
`[ColorProperty](#%3Cinit%3E())()`
Default constructor.
`[ColorProperty](#%3Cinit%3E(java.lang.String,java.awt.Color))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`[ColorProperty](ColorProperty.html)`
`[clone](#clone())()`
Clones the property.
...
`[getStringRepresentation](#getStringRepresentation(java.awt.Color))([Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) c)`
...
Field Details
ALLOW_NONE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) ALLOW_NONE
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.properties.ColorProperty.ALLOW_NONE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ColorProperty
...
ColorProperty
public ColorProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) value)
The property constructor.
Parameters:
...
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getStringRepresentation([Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) c)
isValueCompatible
...
getColor
public [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) getColor()
Returns value as color object.
Returns:
value as color.
getClassType
...
See Also:
[`PropertyID.COLOR_PROPERTY`](PropertyID.html#COLOR_PROPERTY)
clone
public [ColorProperty](ColorProperty.html) clone()
...
<h1 class="title" title="Class ColorProperty">Class ColorProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.ColorProperty</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ColorProperty</span>
...
<div class="block">The property for storing and editing some Color value.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#ALLOW_NONE">ALLOW_NONE</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ColorProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.awt.Color)">ColorProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ColorProperty.html" title="class in com.nomagic.magicdraw.properties">ColorProperty</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns value as color object.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getStringRepresentation(java.awt.Color)">getStringRepresentation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> c)</code></div>
...
<li>
<section class="detail" id="ALLOW_NONE">
<h3>ALLOW_NONE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ALLOW_NONE</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.properties.ColorProperty.ALLOW_NONE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ColorProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ColorProperty</span>()</div>
<div class="block">Default constructor. Value of the property will be null.
 ID will be empty string.</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.awt.Color)">
<h3>ColorProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ColorProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<dd><code>value</code> - the color value of the property.</dd>
</dl>
</section>
</li>
</ul>
...
<dt>Returns:</dt>
<dd>value's string representation - "RGB [red, green, blue]". If value null, returns "<none>".</none></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getStringRepresentation(java.awt.Color)">
...
<h3>getColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a></span> <span class="element-name">getColor</span>()</div>
<div class="block">Returns value as color object.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>value as color.</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>PropertyID.COLOR_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#COLOR_PROPERTY"><code>PropertyID.COLOR_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ColorProperty.html" title="class in com.nomagic.magicdraw.properties">ColorProperty</a></span> <span class="element-name">clone</span>()</div>
