# JAVA OPENAPI: SysMLProfile.FlowDirectionKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/sysml/util/SysMLProfile.FlowDirectionKindEnum.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.FlowDirectionKindEnum.html`
- source_sha256: `00b9b6c4721ba3d2118beab51892c4598686b7910f09ccf2adec8b55cca8edc0`
- captured_utc: `2026-07-14T16:45:45.612609+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html)>
com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowDirectionKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[SysMLProfile](SysMLProfile.html)`

public static enumSysMLProfile.FlowDirectionKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html)>
...
Method
Description
`static [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowDirectionKindEnum))([SysMLProfile](SysMLProfile.html) profile,
 [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) anEnum)`
...
IN
public static final [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) IN
Indicates that the flow property is input to the owning block.
OUT
public static final [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) OUT
Indicates that the flow property is an output of the owning block.
INOUT
public static final [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) INOUT
Indicates that the flow property is both an input and an output of the owning block.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [SysMLProfile.FlowDirectionKindEnum](SysMLProfile.FlowDirectionKindEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class SysMLProfile.FlowDirectionKindEnum">Enum Class SysMLProfile.FlowDirectionKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowDirectionKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">SysMLProfile.FlowDirectionKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a>&gt;</span></div>
<div class="block">FlowDirection is an enumeration type that defines literals used for specifying input and output directions. FlowDirection is used by flow properties to indicate if a property is an input or an output with respect to its owner.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#IN">IN</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the flow property is input to the owning block.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#INOUT">INOUT</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates that the flow property is both an input and an output of the owning block.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#OUT">OUT</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the flow property is an output of the owning block.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowDirectionKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile,
 <a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a>[]</code></div>
...
<h3>IN</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">IN</span></div>
<div class="block">Indicates that the flow property is input to the owning block.</div>
</section>
</li>
<li>
...
<h3>OUT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">OUT</span></div>
<div class="block">Indicates that the flow property is an output of the owning block.</div>
</section>
</li>
<li>
...
<h3>INOUT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">INOUT</span></div>
<div class="block">Indicates that the flow property is both an input and an output of the owning block.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowDirectionKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
