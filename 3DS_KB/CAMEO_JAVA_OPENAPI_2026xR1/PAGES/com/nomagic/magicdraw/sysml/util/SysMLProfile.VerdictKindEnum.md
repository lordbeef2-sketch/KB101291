# JAVA OPENAPI: SysMLProfile.VerdictKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/sysml/util/SysMLProfile.VerdictKindEnum.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.VerdictKindEnum.html`
- source_sha256: `6ab7d84fa918b5294908f923186651ce9db66286c801ca378c42cfe6dedf6048`
- captured_utc: `2026-07-14T16:45:46.586622+00:00`
...
## Enum Class SysMLProfile.VerdictKindEnum

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html)>
com.nomagic.magicdraw.sysml.util.SysMLProfile.VerdictKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[SysMLProfile](SysMLProfile.html)`

public static enumSysMLProfile.VerdictKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html)>
...
Method
Description
`static [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.VerdictKindEnum))([SysMLProfile](SysMLProfile.html) profile,
 [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) anEnum)`
...
PASS
public static final [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) PASS
FAIL
public static final [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) FAIL
INCONCLUSIVE
public static final [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) INCONCLUSIVE
ERROR
public static final [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) ERROR
 ============ METHOD DETAIL ========== 
Method Details
values
public static [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [SysMLProfile.VerdictKindEnum](SysMLProfile.VerdictKindEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class SysMLProfile.VerdictKindEnum">Enum Class SysMLProfile.VerdictKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.VerdictKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">SysMLProfile.VerdictKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a>&gt;</span></div>
<div class="block">Type of a return parameter of a TestCase must be VerdictKind, consistent with the UML Testing Profile.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ERROR">ERROR</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#FAIL">FAIL</a></code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#INCONCLUSIVE">INCONCLUSIVE</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#PASS">PASS</a></code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.VerdictKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile,
 <a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a>[]</code></div>
...
<h3>PASS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">PASS</span></div>
</section>
</li>
<li>
<section class="detail" id="FAIL">
<h3>FAIL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">FAIL</span></div>
</section>
</li>
<li>
<section class="detail" id="INCONCLUSIVE">
<h3>INCONCLUSIVE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">INCONCLUSIVE</span></div>
</section>
</li>
<li>
<section class="detail" id="ERROR">
<h3>ERROR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">ERROR</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.SysMLProfile,com.nomagic.magicdraw.sysml.util.SysMLProfile.VerdictKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="SysMLProfile.VerdictKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.VerdictKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
