# JAVA OPENAPI: SysPhSProfile.ModelicaExtensionStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/sysml/util/SysPhSProfile.ModelicaExtensionStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysPhSProfile.ModelicaExtensionStereotype.html`
- source_sha256: `a43642c3d59b06be1e912fd606a7cf1dbfd66c745b2524867401bbb4eb36ae71`
- captured_utc: `2026-07-14T16:45:46.803625+00:00`
...
## Class SysPhSProfile.ModelicaExtensionStereotype
...
com.nomagic.magicdraw.sysml.util.SysPhSProfile.ModelicaExtensionStereotype

Enclosing class:
`[SysPhSProfile](SysPhSProfile.html)`

public static classSysPhSProfile.ModelicaExtensionStereotype
...
Description
`protected`
`[ModelicaExtensionStereotype](#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysPhSProfile))([SysPhSProfile](SysPhSProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysPhSProfile.ModelicaExtensionStereotype.STEREOTYPE_NAME)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ModelicaExtensionStereotype
protected ModelicaExtensionStereotype([SysPhSProfile](SysPhSProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
<h1 class="title" title="Class SysPhSProfile.ModelicaExtensionStereotype">Class SysPhSProfile.ModelicaExtensionStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysPhSProfile.ModelicaExtensionStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SysPhSProfile.ModelicaExtensionStereotype</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysPhSProfile)">ModelicaExtensionStereotype</a><wbr/>(<a href="SysPhSProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysPhSProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysPhSProfile.ModelicaExtensionStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ModelicaExtensionStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ModelicaExtensionStereotype</span><wbr/><span class="parameters">(<a href="SysPhSProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysPhSProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
