# JAVA OPENAPI: DependencyMatrixCellAMConfigurator (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/dependencymatrix/configuration/DependencyMatrixCellAMConfigurator.html
- source_path: `com/nomagic/magicdraw/dependencymatrix/configuration/DependencyMatrixCellAMConfigurator.html`
- source_sha256: `59017a8528b16cf979cca14763877b4ce79fcfb54fa976cbc691bb766e86364d`
- captured_utc: `2026-07-14T16:45:31.818428+00:00`
...
@OpenApiAllpublic interfaceDependencyMatrixCellAMConfiguratorextends [ConfiguratorWithPriority](../../actions/ConfiguratorWithPriority.html)
...
Description
`void`
`[configure](#configure(com.nomagic.actions.ActionsManager,com.nomagic.magicdraw.dependencymatrix.persistence.PersistenceManager,com.nomagic.magicdraw.dependencymatrix.ui.DependencyMatrixSelection))([ActionsManager](../../../actions/ActionsManager.html) manager,
...
Method for configuring context menu actions. During this call, new actions can be added to dependency matrix menu.
 ...
 Using this configurator only one menu type may be configured - cell menu.
Parameters:
...
<h1 class="title" title="Interface DependencyMatrixCellAMConfigurator">Interface DependencyMatrixCellAMConfigurator</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">DependencyMatrixCellAMConfigurator</span><span class="extends-implements">
...
<div class="block">Configurator interface used to customize Dependency matrix cell menu actions.</div>
</section>
...
<li>
<section class="detail" id="configure(com.nomagic.actions.ActionsManager,com.nomagic.magicdraw.dependencymatrix.persistence.PersistenceManager,com.nomagic.magicdraw.dependencymatrix.ui.DependencyMatrixSelection)">
<h3>configure</h3>
...
<div class="block">Method for configuring context menu actions. During this call, new actions can be added to dependency matrix menu.
 ...
 Using this configurator only one menu type may be configured - cell menu.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>manager</code> - manager to be configured.</dd>
<dd><code>settings</code> - dependency matrix settings.</dd>
<dd><code>selection</code> - dependency matrix selection.</dd>
</dl>
</section>
</li>
</ul>
