# JAVA OPENAPI: DependencyEntry (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/dependencymatrix/datamodel/cell/DependencyEntry.html
- source_path: `com/nomagic/magicdraw/dependencymatrix/datamodel/cell/DependencyEntry.html`
- source_sha256: `8d8aec19d77ff9692c3c522acb33f6f3511cf18dbd84e24f8691cb5b7c917db4`
- captured_utc: `2026-07-14T16:45:32.059430+00:00`
...
`[DependencyEntry](#%3Cinit%3E(com.nomagic.magicdraw.dependencymatrix.datamodel.cell.DependencyDirection,java.util.List))([DependencyDirection](DependencyDirection.html) direction,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> cause)`
...
Field Details
cause
protected [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> cause
Element or chain of elements, which are responsible that expression evaluated on `source` gives `target` as a result
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DependencyEntry
...
Direction
getCause
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getCause()
Elements causing this dependency to exist
Returns:
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.dependencymatrix.datamodel.cell.DependencyDirection,java.util.List)">DependencyEntry</a><wbr/>(<a href="DependencyDirection.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.datamodel.cell">DependencyDirection</a> direction,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt; cause)</code></div>
<div class="col-last even-row-color">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DependencyEntry</span><wbr/><span class="parameters">(<a href="DependencyDirection.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.datamodel.cell">DependencyDirection</a> direction,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt; cause)</span></div>
