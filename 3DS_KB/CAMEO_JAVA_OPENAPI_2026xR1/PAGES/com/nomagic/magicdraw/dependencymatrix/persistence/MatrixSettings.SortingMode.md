# JAVA OPENAPI: MatrixSettings.SortingMode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.SortingMode.html
- source_path: `com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.SortingMode.html`
- source_sha256: `bd57adf1875658fbb070f1fe5fd1dd34098103c68cd0ab311f810ab7367475a7`
- captured_utc: `2026-07-14T16:45:32.521435+00:00`
...
## Enum Class MatrixSettings.SortingMode

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.SortingMode](MatrixSettings.SortingMode.html)>
com.nomagic.magicdraw.dependencymatrix.persistence.MatrixSettings.SortingMode

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[MatrixSettings.SortingMode](MatrixSettings.SortingMode.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[MatrixSettings](MatrixSettings.html)`

public static enumMatrixSettings.SortingMode
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.SortingMode](MatrixSettings.SortingMode.html)>
...
Method
Description
`static [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html)`
...
Ascending
public static final [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html) Ascending
Descending
public static final [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html) Descending
Custom
public static final [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html) Custom
 ============ METHOD DETAIL ========== 
Method Details
values
public static [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [MatrixSettings.SortingMode](MatrixSettings.SortingMode.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class MatrixSettings.SortingMode">Enum Class MatrixSettings.SortingMode</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">MatrixSettings.SortingMode</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a>&gt;</span></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a>[]</code></div>
...
<h3>Ascending</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a></span> <span class="element-name">Ascending</span></div>
</section>
</li>
<li>
<section class="detail" id="Descending">
<h3>Descending</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a></span> <span class="element-name">Descending</span></div>
</section>
</li>
<li>
<section class="detail" id="Custom">
<h3>Custom</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a></span> <span class="element-name">Custom</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.SortingMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.SortingMode</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
