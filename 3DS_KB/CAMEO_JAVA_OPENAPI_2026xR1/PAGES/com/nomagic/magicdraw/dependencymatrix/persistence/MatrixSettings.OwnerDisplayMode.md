# JAVA OPENAPI: MatrixSettings.OwnerDisplayMode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.OwnerDisplayMode.html
- source_path: `com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.OwnerDisplayMode.html`
- source_sha256: `7ef1e37dcdcc0e613548370dff0a110d42e95dc17b2ff5615265bb40b4bab2af`
- captured_utc: `2026-07-14T16:45:32.339433+00:00`
...
## Enum Class MatrixSettings.OwnerDisplayMode

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html)>
com.nomagic.magicdraw.dependencymatrix.persistence.MatrixSettings.OwnerDisplayMode

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[MatrixSettings](MatrixSettings.html)`

public static enumMatrixSettings.OwnerDisplayMode
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html)>
...
Method
Description
`static [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html)`
...
TREE
public static final [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) TREE
HIDDEN
public static final [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) HIDDEN
FULL_QUALIFIED_NAME
public static final [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) FULL_QUALIFIED_NAME
COMPACT_TREE
public static final [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) COMPACT_TREE
 ============ METHOD DETAIL ========== 
Method Details
values
public static [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
getEnum
public static [MatrixSettings.OwnerDisplayMode](MatrixSettings.OwnerDisplayMode.html) getEnum([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)
Gets enum according to type value
Parameters:
`type` - type to find
Returns:
...
<h1 class="title" title="Enum Class MatrixSettings.OwnerDisplayMode">Enum Class MatrixSettings.OwnerDisplayMode</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">MatrixSettings.OwnerDisplayMode</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a>&gt;</span></div>
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#FULL_QUALIFIED_NAME">FULL_QUALIFIED_NAME</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></code></div>
...
<div class="block">Gets enum according to type value</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a>[]</code></div>
...
<h3>TREE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">TREE</span></div>
</section>
</li>
<li>
<section class="detail" id="HIDDEN">
<h3>HIDDEN</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">HIDDEN</span></div>
</section>
</li>
<li>
<section class="detail" id="FULL_QUALIFIED_NAME">
<h3>FULL_QUALIFIED_NAME</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">FULL_QUALIFIED_NAME</span></div>
</section>
</li>
<li>
<section class="detail" id="COMPACT_TREE">
<h3>COMPACT_TREE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">COMPACT_TREE</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>Type representation string</dd>
</dl>
</section>
</li>
<li>
...
<h3>getEnum</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.OwnerDisplayMode.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.OwnerDisplayMode</a></span> <span class="element-name">getEnum</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> type)</span></div>
<div class="block">Gets enum according to type value</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>type</code> - type to find</dd>
<dt>Returns:</dt>
<dd>enum of this type</dd>
</dl>
</section>
</li>
</ul>
