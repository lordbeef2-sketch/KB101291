# JAVA OPENAPI: RepresentationTextParams (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/RepresentationTextParams.html
- source_path: `com/nomagic/magicdraw/uml/RepresentationTextParams.html`
- source_sha256: `d598b65ee599fc171b21de70c48c63990904575745811fd6199f38c8e2953820`
- captured_utc: `2026-07-14T16:46:05.505872+00:00`
...
Set to show or hide value prefix
...
setShowValuePrefix
public [RepresentationTextParams](RepresentationTextParams.html) setShowValuePrefix(boolean showValuePrefix)
Set to show or hide value prefix
Parameters:
`showValuePrefix` - false if type data marking should not be added to represented value
isShowValuePrefix
public boolean isShowValuePrefix()
Returns:
true if prefix should be added
setShowTypePrefix
public [RepresentationTextParams](RepresentationTextParams.html) setShowTypePrefix(boolean showTypePrefix)
Set to show or hide prefix
Parameters:
`showTypePrefix` - false if type data marking should not be added
isShowTypePrefix
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="RepresentationTextParams.html" title="class in com.nomagic.magicdraw.uml">RepresentationTextParams</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowValuePrefix(boolean)">setShowValuePrefix</a><wbr/>(boolean showValuePrefix)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Set to show or hide value prefix</div>
</div>
</div>
</div>
</div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="RepresentationTextParams.html" title="class in com.nomagic.magicdraw.uml">RepresentationTextParams</a></span> <span class="element-name">setShowValuePrefix</span><wbr/><span class="parameters">(boolean showValuePrefix)</span></div>
<div class="block">Set to show or hide value prefix</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showValuePrefix</code> - false if type data marking should not be added to represented value</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="RepresentationTextParams.html" title="class in com.nomagic.magicdraw.uml">RepresentationTextParams</a></span> <span class="element-name">setShowTypePrefix</span><wbr/><span class="parameters">(boolean showTypePrefix)</span></div>
<div class="block">Set to show or hide prefix</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showTypePrefix</code> - false if type data marking should not be added</dd>
</dl>
</section>
</li>
<li>
