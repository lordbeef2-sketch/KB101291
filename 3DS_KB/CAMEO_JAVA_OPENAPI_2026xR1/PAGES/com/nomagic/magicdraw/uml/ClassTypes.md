# JAVA OPENAPI: ClassTypes (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/ClassTypes.html
- source_path: `com/nomagic/magicdraw/uml/ClassTypes.html`
- source_sha256: `6964b39d4add52c11e0e6af7d189b61cc9df5740b5bd7255a2ade7e23465c285`
- captured_utc: `2026-07-14T16:46:04.829864+00:00`
...
Field
Description
`static final [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[]`
...
`[expandToConcreteMetaClasses](#expandToConcreteMetaClasses(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> metaClasses)`
...
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<? extends [Classifier](../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)>>`
...
`[getClassType](#getClassType(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) shortName)`

`static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)`
`[getClassType](#getClassType(org.omg.mof.model.Classifier))(org.omg.mof.model.Classifier metatype)`

`static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getClassTypeForShortNames](#getClassTypeForShortNames(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> names)`

`static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getClassTypesForElements](#getClassTypesForElements(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](BaseElement.html)> elements)`
...
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getClassTypesForStereotypeBaseClasses](#getClassTypesForStereotypeBaseClasses(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Stereotype](../../uml2/ext/magicdraw/mdprofiles/Stereotype.html)> stereotypes)`

`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getDirectSubtypes](#getDirectSubtypes(java.lang.Class,boolean))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type,
...
`[getShortName](#getShortName(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)`
...
`[getShortNameForClassTypes](#getShortNameForClassTypes(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> types)`

`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getSubtypes](#getSubtypes(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)`

`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getSubtypes](#getSubtypes(java.lang.Class,boolean))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type,
 boolean includeAbstract)`

`static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getSubtypes](#getSubtypes(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> types)`

`static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[]`
`[getSubtypesArray](#getSubtypesArray(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)`

`static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[]`
`[getSubtypesArray](#getSubtypesArray(java.lang.Class,boolean))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type,
 boolean includeAbstract)`

`static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[]`
`[getSubtypesArray](#getSubtypesArray(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> type)`

`static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[]`
`[getSubtypesArray](#getSubtypesArray(java.util.Collection,boolean))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> type,
 boolean includeAbstract)`

`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)>`
`[getSupertypes](#getSupertypes(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)`

`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)>`
`[getTypeElements](#getTypeElements(java.util.List,com.nomagic.magicdraw.core.Project))([List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)> types,
...
`static boolean`
`[isRelationship](#isRelationship(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)`
Check if given class is relationship
`static void`
`[removeAbstract](#removeAbstract(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> classTypes)`
...
Field Details
RELATIONSHIP_TYPES
public static final [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[] RELATIONSHIP_TYPES
Relationship like classes
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ClassTypes
...
Method Details
getNameSpaces
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getNameSpaces()
Returns a list of all namespaces types.
Returns:
a list of all namespaces types.
getClassifiers
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<? extends [Classifier](../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)>> getClassifiers()
Returns a list of all classifiers types.
Returns:
a list of all classifiers types.
getPackagesNotProfile
public static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getPackagesNotProfile()
Returns a list of all classifiers types.
Returns:
a list of all classifiers types.
getSubtypes
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getSubtypes([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> types)
Parameters:
`types` - base types
Returns:
returns base types and subtypes of given types
getSubtypes
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getSubtypes([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)
Parameters:
`type` - base type
Returns:
...
getSubtypesArray
public static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[] getSubtypesArray([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)
Parameters:
`type` - base type
Returns:
...
return subtypes as array, not as collection
getSubtypesArray
public static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)[] getSubtypesArray([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> type)
Parameters:
`type` - base type
Returns:
return subtypes as array, not as collection
...
return subtypes as array, not as collection
getDirectSubtypes
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getDirectSubtypes([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type,
 boolean includeAbstract)
...
getSupertypes
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getSupertypes([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)
getClassType
public static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) getClassType(org.omg.mof.model.Classifier metatype)
getClassType
@CheckForNullpublic static [Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) getClassType([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) shortName)
Parameters:
`shortName` - class short name
Returns:
return a java class for given UML metaclass by name
getShortName
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getShortName([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)
Parameters:
`type` - java class
Returns:
UML metaclass name
getClassTypesForElements
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getClassTypesForElements([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](BaseElement.html)> elements)
getShortNameForClassTypes
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getShortNameForClassTypes([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> types)
getClassTypeForShortNames
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getClassTypeForShortNames([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> names)
removeAbstract
public static void removeAbstract([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> classTypes)
getClassTypesForStereotypeBaseClasses
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getClassTypesForStereotypeBaseClasses([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Stereotype](../../uml2/ext/magicdraw/mdprofiles/Stereotype.html)> stereotypes)
getClassTypesForStereotypeBaseClasses
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getClassTypesForStereotypeBaseClasses([Stereotype](../../uml2/ext/magicdraw/mdprofiles/Stereotype.html) stereotype)
expandToConcreteMetaClasses
public static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> expandToConcreteMetaClasses([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> metaClasses)
...
public static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> getRelationshipTypes()
Returns:
relationships types
isRelationship
public static boolean isRelationship([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) type)
Check if given class is relationship
Parameters:
`type` - given class
Returns:
...
getAllClassNames
public static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getAllClassNames()
Returns:
...
<div class="col-first even-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>[]</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a></code></div>
