# JAVA OPENAPI: NonSymbolDiagramDescriptor (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/diagrams/NonSymbolDiagramDescriptor.html
- source_path: `com/nomagic/magicdraw/uml/diagrams/NonSymbolDiagramDescriptor.html`
- source_sha256: `696aa7389986f7bcea9acaf2e9a4c1b216c5255181af36de4f5134b2a9e822e4`
- captured_utc: `2026-07-14T16:46:05.746877+00:00`
...
## Class NonSymbolDiagramDescriptor<C extends [Component](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html)>
...
@OpenApiAllpublic abstract classNonSymbolDiagramDescriptor<C extends [Component](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html)>
extends [DiagramDescriptor](../DiagramDescriptor.html)

Descriptor of non symbol diagram - diagram that represents custom [`Component`](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html).
...
Method Details
getSuperType
public final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getSuperType()
UML Class diagram is used as super type.
Specified by:
...
<h1 class="title" title="Class NonSymbolDiagramDescriptor">Class NonSymbolDiagramDescriptor&lt;C extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html" title="class or interface in java.awt">Component</a>&gt;</h1>
</div>
...
</span><span class="modifiers">public abstract class </span><span class="element-name type-name-label">NonSymbolDiagramDescriptor&lt;C extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html" title="class or interface in java.awt">Component</a>&gt;</span>
...
<div class="block">Descriptor of non symbol diagram - diagram that represents custom <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html" title="class or interface in java.awt"><code>Component</code></a>.</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<h3>getSuperType</h3>
<div class="member-signature"><span class="modifiers">public final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getSuperType</span>()</div>
<div class="block">UML Class diagram is used as super type.</div>
<dl class="notes">
<dt>Specified by:</dt>
