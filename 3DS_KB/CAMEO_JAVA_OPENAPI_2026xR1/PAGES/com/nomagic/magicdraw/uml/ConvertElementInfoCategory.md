# JAVA OPENAPI: ConvertElementInfoCategory (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/ConvertElementInfoCategory.html
- source_path: `com/nomagic/magicdraw/uml/ConvertElementInfoCategory.html`
- source_sha256: `318345339a9f7bdb0b441937c6898899f721e769b58ee39646bea27e2aeea2f3`
- captured_utc: `2026-07-14T16:46:04.662862+00:00`
...
Constructor
Description
`[ConvertElementInfoCategory](#%3Cinit%3E(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> notGrouped)`
Constructor
 ========== METHOD SUMMARY =========== 
Method Summary
...
public ConvertElementInfoCategory([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)> notGrouped)
Constructor
Parameters:
