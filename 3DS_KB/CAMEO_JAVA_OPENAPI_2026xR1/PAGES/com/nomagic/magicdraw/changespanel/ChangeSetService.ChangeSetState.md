# JAVA OPENAPI: ChangeSetService.ChangeSetState (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/changespanel/ChangeSetService.ChangeSetState.html
- source_path: `com/nomagic/magicdraw/changespanel/ChangeSetService.ChangeSetState.html`
- source_sha256: `7a9b6edd3b17a93f73cde3e99ff4eb03ef2eff4f956aed599194bfde4aa31c68`
- captured_utc: `2026-07-14T16:45:28.514382+00:00`
...
## Enum Class ChangeSetService.ChangeSetState

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)>
com.nomagic.magicdraw.changespanel.ChangeSetService.ChangeSetState

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing interface:
`[ChangeSetService](ChangeSetService.html)`

public static enumChangeSetService.ChangeSetState
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)>
...
`static [ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)`
...
ACTIVE
public static final [ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html) ACTIVE
SUSPENDED
public static final [ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html) SUSPENDED
 ============ METHOD DETAIL ========== 
Method Details
values
public static [ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
Overrides:
`[toString](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html#toString())` in class `[Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ChangeSetService.ChangeSetState](ChangeSetService.ChangeSetState.html)>`
...
<h1 class="title" title="Enum Class ChangeSetService.ChangeSetState">Enum Class ChangeSetService.ChangeSetState</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.changespanel.ChangeSetService.ChangeSetState</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing interface:</dt>
<dd><code><a href="ChangeSetService.html" title="interface in com.nomagic.magicdraw.changespanel">ChangeSetService</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">ChangeSetService.ChangeSetState</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a>&gt;</span></div>
</section>
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#SUSPENDED">SUSPENDED</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a>[]</code></div>
...
<h3>ACTIVE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a></span> <span class="element-name">ACTIVE</span></div>
</section>
</li>
<li>
<section class="detail" id="SUSPENDED">
<h3>SUSPENDED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a></span> <span class="element-name">SUSPENDED</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ChangeSetService.ChangeSetState.html" title="enum class in com.nomagic.magicdraw.changespanel">ChangeSetService.ChangeSetState</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
