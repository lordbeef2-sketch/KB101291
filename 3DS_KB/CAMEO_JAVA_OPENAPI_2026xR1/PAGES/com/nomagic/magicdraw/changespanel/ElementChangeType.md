# JAVA OPENAPI: ElementChangeType (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/changespanel/ElementChangeType.html
- source_path: `com/nomagic/magicdraw/changespanel/ElementChangeType.html`
- source_sha256: `bb0c9cfc36e8783120e9b207b461a5bff44fd77944486267574eea8abff1929a`
- captured_utc: `2026-07-14T16:45:28.723385+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ElementChangeType](ElementChangeType.html)>
com.nomagic.magicdraw.changespanel.ElementChangeType

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[ElementChangeType](ElementChangeType.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

@OpenApiAllpublic enumElementChangeType
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ElementChangeType](ElementChangeType.html)>
...
`static [ElementChangeType](ElementChangeType.html)`
...
ADDED
public static final [ElementChangeType](ElementChangeType.html) ADDED
Element added.
CHANGED
public static final [ElementChangeType](ElementChangeType.html) CHANGED
Element changed.
REMOVED
public static final [ElementChangeType](ElementChangeType.html) REMOVED
Element removed.
NONE
public static final [ElementChangeType](ElementChangeType.html) NONE
Element unchanged.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [ElementChangeType](ElementChangeType.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [ElementChangeType](ElementChangeType.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
Overrides:
`[toString](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html#toString())` in class `[Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ElementChangeType](ElementChangeType.html)>`
...
<h1 class="title" title="Enum Class ElementChangeType">Enum Class ElementChangeType</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.changespanel.ElementChangeType</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public enum </span><span class="element-name type-name-label">ElementChangeType</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a>&gt;</span></div>
<div class="block">Enum to specify what type of change element has.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ADDED">ADDED</a></code></div>
<div class="col-last even-row-color">
<div class="block">Element added.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#CHANGED">CHANGED</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Element changed.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#NONE">NONE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Element unchanged.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#REMOVED">REMOVED</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Element removed.</div>
</div>
</div>
</section>
</li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a>[]</code></div>
...
<h3>ADDED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></span> <span class="element-name">ADDED</span></div>
<div class="block">Element added.</div>
</section>
</li>
<li>
<section class="detail" id="CHANGED">
<h3>CHANGED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></span> <span class="element-name">CHANGED</span></div>
<div class="block">Element changed.</div>
</section>
</li>
<li>
...
<h3>REMOVED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></span> <span class="element-name">REMOVED</span></div>
<div class="block">Element removed.</div>
</section>
</li>
<li>
...
<h3>NONE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></span> <span class="element-name">NONE</span></div>
<div class="block">Element unchanged.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ElementChangeType.html" title="enum class in com.nomagic.magicdraw.changespanel">ElementChangeType</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
