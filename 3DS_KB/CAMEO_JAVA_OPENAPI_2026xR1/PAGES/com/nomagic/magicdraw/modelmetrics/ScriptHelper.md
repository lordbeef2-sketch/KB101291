# JAVA OPENAPI: ScriptHelper (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/modelmetrics/ScriptHelper.html
- source_path: `com/nomagic/magicdraw/modelmetrics/ScriptHelper.html`
- source_sha256: `6ccc56ba4ffa53bd3d46c08a1ef525aeedf8d6c4a5f21dc2e7b7496cedb4d13b`
- captured_utc: `2026-07-14T16:45:38.176509+00:00`
...
Description
`static double`
`[calcAverageForList](#calcAverageForList(java.util.List))([List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<? extends [Number](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Number.html)> items)`
...
Returns all elements in a package recursively.
`static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)`
`[getElementsRecursively](#getElementsRecursively(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> owningPackages)`
Returns all elements in given packages recursively.
`static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)`
`[getElementsRecursively](#getElementsRecursively(java.util.Collection,com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> owningPackages,
 [Stereotype](../../uml2/ext/magicdraw/mdprofiles/Stereotype.html) stereotype)`
Returns all elements in given packages recursively.
`static boolean`
...
`static boolean`
`[isParentOf](#isParentOf(java.util.Collection,com.nomagic.magicdraw.uml.BaseElement))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](../uml/BaseElement.html)> possibleParents,
 [BaseElement](../uml/BaseElement.html) possibleChild)`
...
public static [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html) getElementsRecursively([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) owningPackage)
Returns all elements in a package recursively.
Parameters:
...
isParentOf
public static boolean isParentOf([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](../uml/BaseElement.html)> possibleParents,
 [BaseElement](../uml/BaseElement.html) possibleChild)
Checks if given object is child of any element in a given list of possible parents.
Parameters:
...
`covered` - nominator
Returns:
percentage value or 0 if denominator invalid input: '<'= 0
calcAverageForList
public static double calcAverageForList(@CheckForNull
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<? extends [Number](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Number.html)> items)
Calculates average for a list of numbers.
Parameters:
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a></code></div>
...
<dt>Returns:</dt>
<dd>percentage value or 0 if denominator <span class="invalid-tag">invalid input: '&lt;'</span>= 0</dd>
</dl>
</section>
</li>
<li>
