# JAVA OPENAPI: BackgroundTaskRunner (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/task/BackgroundTaskRunner.html
- source_path: `com/nomagic/magicdraw/task/BackgroundTaskRunner.html`
- source_sha256: `c87568737fb233abdfa2a5bd14812180f57e67cbda984251f0f0ae6f8cb358f0`
- captured_utc: `2026-07-14T16:45:47.467634+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.magicdraw.task](package-summary.html)
...
@OpenApiAllpublic final classBackgroundTaskRunner
...
Constructor
Description
`[BackgroundTaskRunner](#%3Cinit%3E())()`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Description
`static void`
`[runWithProgressStatus](#runWithProgressStatus(com.nomagic.task.RunnableWithProgress,java.lang.String,boolean))([RunnableWithProgress](../../task/RunnableWithProgress.html) runnable,
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span> <a href="package-summary.html">com.nomagic.magicdraw.task</a></div>
<h1 class="title" title="Class BackgroundTaskRunner">Class BackgroundTaskRunner</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance">com.nomagic.magicdraw.task.BackgroundTaskRunner</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public final class </span><span class="element-name type-name-label">BackgroundTaskRunner</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block">Runs task with progress status in background.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">BackgroundTaskRunner</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#runWithProgressStatus(com.nomagic.task.RunnableWithProgress,java.lang.String,boolean)">runWithProgressStatus</a><wbr/>(<a href="../../task/RunnableWithProgress.html" title="interface in com.nomagic.task">RunnableWithProgress</a> runnable,
 ...
 boolean allowCancel)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Executes runnable with progress status in background.</div>
</div>
</div>
</div>
</div>
...
<h3>BackgroundTaskRunner</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BackgroundTaskRunner</span>()</div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="runWithProgressStatus(com.nomagic.task.RunnableWithProgress,java.lang.String,boolean)">
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">void</span> <span class="element-name">runWithProgressStatus</span><wbr/><span class="parameters">(<a href="../../task/RunnableWithProgress.html" title="interface in com.nomagic.task">RunnableWithProgress</a> runnable,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> description,
 boolean allowCancel)</span></div>
<div class="block">Executes runnable with progress status in background.
...
<dd><code>description</code> - task description.</dd>
