# JAVA OPENAPI: UAF.ViewStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.ViewStereotype.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ViewStereotype.html`
- source_sha256: `560063907245819006a1cd2826a31ee2f82bc84f305a5051d53c84dbe7e57e02`
- captured_utc: `2026-07-14T16:45:59.789798+00:00`
...
public static classUAF.ViewStereotype
...
Description
`protected`
`[ViewStereotype](#%3Cinit%3E(com.nomagic.magicdraw.uaf.UAF))([UAF](UAF.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[setViewpoint](#setViewpoint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) value)`
...
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.STEREOTYPE_NAME)
VIEWPOINT_FROM_UAF
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) VIEWPOINT_FROM_UAF
Relates the View to the Viewpoint that the View conforms to.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.VIEWPOINT_FROM_UAF)
URI
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) URI
Captures Unique identifier for the element.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.URI)
CONFORMSTO
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) CONFORMSTO
Relates a UAFElement to the Standard that the UAFElement is conforming to.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.CONFORMSTO)
STAKEHOLDER
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) STAKEHOLDER
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.STAKEHOLDER)
VIEWPOINT_FROM_SYSML
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) VIEWPOINT_FROM_SYSML
The viewpoint for this View, derived from the supplier of the conform dependency whose client is this View.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.VIEWPOINT_FROM_SYSML)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ViewStereotype
protected ViewStereotype([UAF](UAF.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
getViewpoint
@CheckForNullpublic [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getViewpoint([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setURI
...
<h1 class="title" title="Class UAF.ViewStereotype">Class UAF.ViewStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uaf.UAF.ViewStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">UAF.ViewStereotype</span>
...
<div class="col-first even-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#VIEWPOINT_FROM_SYSML">VIEWPOINT_FROM_SYSML</a></code></div>
<div class="col-last even-row-color">
<div class="block">The viewpoint for this View, derived from the supplier of the   conform   dependency whose client is this View.</div>
</div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#VIEWPOINT_FROM_UAF">VIEWPOINT_FROM_UAF</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Relates the View to the Viewpoint that the View conforms to.</div>
</div>
</div>
</section>
</li>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uaf.UAF)">ViewStereotype</a><wbr/>(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearStakeholder(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearStakeholder</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="VIEWPOINT_FROM_UAF">
<h3>VIEWPOINT_FROM_UAF</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">VIEWPOINT_FROM_UAF</span></div>
<div class="block">Relates the View to the Viewpoint that the View conforms to.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.VIEWPOINT_FROM_UAF">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.URI">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.CONFORMSTO">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.STAKEHOLDER">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="VIEWPOINT_FROM_SYSML">
<h3>VIEWPOINT_FROM_SYSML</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">VIEWPOINT_FROM_SYSML</span></div>
<div class="block">The viewpoint for this View, derived from the supplier of the   conform   dependency whose client is this View.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.uaf.UAF.ViewStereotype.VIEWPOINT_FROM_SYSML">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ViewStereotype</span><wbr/><span class="parameters">(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="setViewpoint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setViewpoint</h3>
