# JAVA OPENAPI: UAF.InformationModelKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.InformationModelKindEnum.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.InformationModelKindEnum.html`
- source_sha256: `eb4bcea65ebb93617de83d3fda3ddd6abf23dfb18b7e31643a19f1fc01389def`
- captured_utc: `2026-07-14T16:45:52.029694+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.InformationModelKindEnum](UAF.InformationModelKindEnum.html)>
com.nomagic.magicdraw.uaf.UAF.InformationModelKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UAF.InformationModelKindEnum](UAF.InformationModelKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UAF](UAF.html)`

public static enumUAF.InformationModelKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.InformationModelKindEnum](UAF.InformationModelKindEnum.html)>
...
valueOf
public static [UAF.InformationModelKindEnum](UAF.InformationModelKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UAF.InformationModelKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.InformationModelKindEnum</a>&gt;
