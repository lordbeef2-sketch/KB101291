# JAVA OPENAPI: UAF.ServiceExchangeKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.ServiceExchangeKindEnum.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ServiceExchangeKindEnum.html`
- source_sha256: `1e9d4b50a0e606a68df6e95faadf846ab16faf826c48e4f620fa82953ef19e68`
- captured_utc: `2026-07-14T16:45:57.249763+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html)>
com.nomagic.magicdraw.uaf.UAF.ServiceExchangeKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UAF](UAF.html)`

public static enumUAF.ServiceExchangeKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html)>
...
Method
Description
`static [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ServiceExchangeKindEnum))([UAF](UAF.html) profile,
 [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) anEnum)`
...
MATERIELEXCHANGE
public static final [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) MATERIELEXCHANGE
Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow of materiel (artifacts) between Functions.
ORGANIZATIONALEXCHANGE
public static final [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) ORGANIZATIONALEXCHANGE
Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where human resources (PostTypes, RoleTypes) flow between OperationalPerformers.
ENERGYEXCHANGE
public static final [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) ENERGYEXCHANGE
Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where energy is flowed from one OperationalPerformer to another.
INFORMATIONEXCHANGE
public static final [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) INFORMATIONEXCHANGE
Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where information is flowed from one OperationalPerformer to another.
CONFIGURATIONEXCHANGE
public static final [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) CONFIGURATIONEXCHANGE
Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where CapabilityConfigurations flow from one OperationalPerformer to another.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [UAF.ServiceExchangeKindEnum](UAF.ServiceExchangeKindEnum.html) toEnum([EnumerationLiteral](../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class UAF.ServiceExchangeKindEnum">Enum Class UAF.ServiceExchangeKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.uaf.UAF.ServiceExchangeKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">UAF.ServiceExchangeKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a>&gt;</span></div>
<div class="block">Enumeration of the possible kinds of ServiceExchange.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#INFORMATIONEXCHANGE">INFORMATIONEXCHANGE</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#MATERIELEXCHANGE">MATERIELEXCHANGE</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ORGANIZATIONALEXCHANGE">ORGANIZATIONALEXCHANGE</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ServiceExchangeKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile,
 <a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a>[]</code></div>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">MATERIELEXCHANGE</span></div>
<div class="block">Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow of materiel (artifacts) between Functions.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">ORGANIZATIONALEXCHANGE</span></div>
<div class="block">Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where human resources (PostTypes, RoleTypes) flow between OperationalPerformers.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">ENERGYEXCHANGE</span></div>
<div class="block">Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where energy is flowed from one OperationalPerformer to another.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">INFORMATIONEXCHANGE</span></div>
<div class="block">Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where information is flowed from one OperationalPerformer to another.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">CONFIGURATIONEXCHANGE</span></div>
<div class="block">Indicates that the OperationalExchange associated with the OperationalExchangeKind is a logical flow where CapabilityConfigurations flow from one OperationalPerformer to another.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ServiceExchangeKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="UAF.ServiceExchangeKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ServiceExchangeKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
