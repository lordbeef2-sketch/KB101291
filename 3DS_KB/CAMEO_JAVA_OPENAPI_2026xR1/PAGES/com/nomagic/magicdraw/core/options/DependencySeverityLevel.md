# JAVA OPENAPI: DependencySeverityLevel (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/options/DependencySeverityLevel.html
- source_path: `com/nomagic/magicdraw/core/options/DependencySeverityLevel.html`
- source_sha256: `f4a7f5f244481e13325db8f71d27194d431866325263d4057c98132e9f89350d`
- captured_utc: `2026-07-14T16:45:30.657410+00:00`
...
## Enum Class DependencySeverityLevel

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[DependencySeverityLevel](DependencySeverityLevel.html)>
com.nomagic.magicdraw.core.options.DependencySeverityLevel

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[DependencySeverityLevel](DependencySeverityLevel.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

@OpenApiAllpublic enumDependencySeverityLevel
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[DependencySeverityLevel](DependencySeverityLevel.html)>
...
Method
Description
`static [DependencySeverityLevel](DependencySeverityLevel.html)`
...
INFO
public static final [DependencySeverityLevel](DependencySeverityLevel.html) INFO
WARNING
public static final [DependencySeverityLevel](DependencySeverityLevel.html) WARNING
ERROR
public static final [DependencySeverityLevel](DependencySeverityLevel.html) ERROR
 ============ METHOD DETAIL ========== 
Method Details
values
public static [DependencySeverityLevel](DependencySeverityLevel.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [DependencySeverityLevel](DependencySeverityLevel.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class DependencySeverityLevel">Enum Class DependencySeverityLevel</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.core.options.DependencySeverityLevel</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public enum </span><span class="element-name type-name-label">DependencySeverityLevel</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a>&gt;</span></div>
<div class="block">Dependency severity levels.</div>
<dl class="notes">
<dt>Version:</dt>
<dd>1.0</dd>
</dl>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a>[]</code></div>
...
<h3>INFO</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a></span> <span class="element-name">INFO</span></div>
</section>
</li>
<li>
<section class="detail" id="WARNING">
<h3>WARNING</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a></span> <span class="element-name">WARNING</span></div>
</section>
</li>
<li>
<section class="detail" id="ERROR">
<h3>ERROR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a></span> <span class="element-name">ERROR</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DependencySeverityLevel.html" title="enum class in com.nomagic.magicdraw.core.options">DependencySeverityLevel</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
