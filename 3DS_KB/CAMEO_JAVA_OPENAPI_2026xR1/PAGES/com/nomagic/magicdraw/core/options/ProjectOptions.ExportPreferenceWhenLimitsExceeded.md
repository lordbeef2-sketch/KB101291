# JAVA OPENAPI: ProjectOptions.ExportPreferenceWhenLimitsExceeded (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/options/ProjectOptions.ExportPreferenceWhenLimitsExceeded.html
- source_path: `com/nomagic/magicdraw/core/options/ProjectOptions.ExportPreferenceWhenLimitsExceeded.html`
- source_sha256: `965a2f30a34f7a7f90d91133bd9a1d1ab11b3206656952f7fda12d2f4f8b01cf`
- captured_utc: `2026-07-14T16:45:31.332418+00:00`
...
## Enum Class ProjectOptions.ExportPreferenceWhenLimitsExceeded

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html)>
com.nomagic.magicdraw.core.options.ProjectOptions.ExportPreferenceWhenLimitsExceeded

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[ProjectOptions](ProjectOptions.html)`

public static enumProjectOptions.ExportPreferenceWhenLimitsExceeded
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html)>
...
`[EXPORT_CROPPED_DIAGRAM](#EXPORT_CROPPED_DIAGRAM)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html)`
...
EXPORT_CROPPED_DIAGRAM
public static final [ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html) EXPORT_CROPPED_DIAGRAM
DO_NOT_EXPORT
public static final [ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html) DO_NOT_EXPORT
 ============ METHOD DETAIL ========== 
Method Details
values
public static [ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [ProjectOptions.ExportPreferenceWhenLimitsExceeded](ProjectOptions.ExportPreferenceWhenLimitsExceeded.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">ProjectOptions.ExportPreferenceWhenLimitsExceeded</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a>&gt;</span></div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#DO_NOT_EXPORT">DO_NOT_EXPORT</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#EXPORT_CROPPED_DIAGRAM">EXPORT_CROPPED_DIAGRAM</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a>[]</code></div>
...
<li>
<section class="detail" id="EXPORT_CROPPED_DIAGRAM">
<h3>EXPORT_CROPPED_DIAGRAM</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a></span> <span class="element-name">EXPORT_CROPPED_DIAGRAM</span></div>
</section>
</li>
<li>
<section class="detail" id="DO_NOT_EXPORT">
<h3>DO_NOT_EXPORT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a></span> <span class="element-name">DO_NOT_EXPORT</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ProjectOptions.ExportPreferenceWhenLimitsExceeded.html" title="enum class in com.nomagic.magicdraw.core.options">ProjectOptions.ExportPreferenceWhenLimitsExceeded</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
