# JAVA OPENAPI: ModuleUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/modules/ModuleUsage.html
- source_path: `com/nomagic/magicdraw/core/modules/ModuleUsage.html`
- source_sha256: `c4bed54b8f5c1efecf5450b0c7b1ae3b405cdcbf0e348a84739c0567d042dce2`
- captured_utc: `2026-07-14T16:45:30.779412+00:00`
...
Method
Description
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)>`
...
`[createUsages](#createUsages(com.nomagic.ci.persistence.IProject,java.util.Collection))(com.nomagic.ci.persistence.IProject owner,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<com.nomagic.ci.persistence.IProject> modules)`
Create usages information of given modules from given owner.
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)>`
`[createUsages](#createUsages(java.util.Collection,boolean))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<com.nomagic.ci.persistence.IAttachedProject> modules,
 boolean allUsages)`
Create usages information for a given modules
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)>`
`[createUsages](#createUsages(java.util.Collection,java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<com.nomagic.ci.persistence.IAttachedProject> modules,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends com.nomagic.ci.persistence.IProject> exceptTheseOwners)`
...
createUsages
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)> createUsages(com.nomagic.ci.persistence.IAttachedProject module,
 boolean allUsages)
Create usages information for a given module
Parameters:
`module` - module
...
usages
createUsages
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)> createUsages(com.nomagic.ci.persistence.IProject owner,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<com.nomagic.ci.persistence.IProject> modules)
Create usages information of given modules from given owner.
Parameters:
`owner` - modules owner
...
usages
createUsages
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ModuleUsage](ModuleUsage.html)> createUsages([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<com.nomagic.ci.persistence.IAttachedProject> modules,
 boolean allUsages)
Create usages information for a given modules
Parameters:
`modules` - module
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ModuleUsage.html" title="class in com.nomagic.magicdraw.core.modules">ModuleUsage</a>&gt;</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#createUsages(com.nomagic.ci.persistence.IProject,java.util.Collection)">createUsages</a><wbr/>(com.nomagic.ci.persistence.IProject owner,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;com.nomagic.ci.persistence.IProject&gt; modules)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#createUsages(java.util.Collection,java.util.Collection)">createUsages</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;com.nomagic.ci.persistence.IAttachedProject&gt; modules,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends com.nomagic.ci.persistence.IProject&gt; exceptTheseOwners)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ModuleUsage.html" title="class in com.nomagic.magicdraw.core.modules">ModuleUsage</a>&gt;</span> <span class="element-name">createUsages</span><wbr/><span class="parameters">(com.nomagic.ci.persistence.IProject owner,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;com.nomagic.ci.persistence.IProject&gt; modules)</span></div>
<div class="block">Create usages information of given modules from given owner.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>createUsages</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ModuleUsage.html" title="class in com.nomagic.magicdraw.core.modules">ModuleUsage</a>&gt;</span> <span class="element-name">createUsages</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;com.nomagic.ci.persistence.IAttachedProject&gt; modules,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends com.nomagic.ci.persistence.IProject&gt; exceptTheseOwners)</span></div>
<div class="block">Create all usages information for a given modules excepts if modules is used by given owners</div>
<dl class="notes">
<dt>Parameters:</dt>
