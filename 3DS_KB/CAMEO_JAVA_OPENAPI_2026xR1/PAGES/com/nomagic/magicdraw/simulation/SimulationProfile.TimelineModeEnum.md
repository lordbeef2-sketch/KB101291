# JAVA OPENAPI: SimulationProfile.TimelineModeEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/SimulationProfile.TimelineModeEnum.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationProfile.TimelineModeEnum.html`
- source_sha256: `0c4f1642cdfd984ff30a606dea1b8e2dd0ca5243f16499455e337deec3486a64`
- captured_utc: `2026-07-14T16:45:41.581556+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SimulationProfile.TimelineModeEnum](SimulationProfile.TimelineModeEnum.html)>
com.nomagic.magicdraw.simulation.SimulationProfile.TimelineModeEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SimulationProfile.TimelineModeEnum](SimulationProfile.TimelineModeEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[SimulationProfile](SimulationProfile.html)`

public static enumSimulationProfile.TimelineModeEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SimulationProfile.TimelineModeEnum](SimulationProfile.TimelineModeEnum.html)>
...
valueOf
public static [SimulationProfile.TimelineModeEnum](SimulationProfile.TimelineModeEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
