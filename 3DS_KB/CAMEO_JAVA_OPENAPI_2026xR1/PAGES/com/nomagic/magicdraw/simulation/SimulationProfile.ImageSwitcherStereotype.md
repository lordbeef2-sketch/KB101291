# JAVA OPENAPI: SimulationProfile.ImageSwitcherStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/SimulationProfile.ImageSwitcherStereotype.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationProfile.ImageSwitcherStereotype.html`
- source_sha256: `e5252ff11674f789b0aefbc95abb3c604f776c4fc2e723d57c586b222b77bd17`
- captured_utc: `2026-07-14T16:45:41.094550+00:00`
...
public static classSimulationProfile.ImageSwitcherStereotype
...
`static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE](#SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE)`
If this value is true when the property typed by what imageSwitcher represents has the value that does not specified as any activeElement of the activeImage of this imageSwitcher, empty image would be shown.
`static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[SOURCE](#SOURCE)`
...
Description
`protected`
`[ImageSwitcherStereotype](#%3Cinit%3E(com.nomagic.magicdraw.simulation.SimulationProfile))([SimulationProfile](SimulationProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearShowEmptyImageForUnspecifiedValue](#clearShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`[Property](../../uml2/ext/magicdraw/classes/mdkernel/Property.html)`
`[getShowEmptyImageForUnspecifiedValueProperty](#getShowEmptyImageForUnspecifiedValueProperty())()`
...
`[isShowEmptyImageForUnspecifiedValue](#isShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`void`
`[setShowEmptyImageForUnspecifiedValue](#setShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.STEREOTYPE_NAME)
SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE
...
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE)
SOURCE
...
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.SOURCE)
NESTEDPROPERTYPATHS
...
Specify nested property paths
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.NESTEDPROPERTYPATHS)
REPRESENTS
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) REPRESENTS
Specify the classifier represented by the configuration.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.REPRESENTS)
VALUE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) VALUE
Structural feature which value should be represented for the configuration.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.VALUE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ImageSwitcherStereotype
protected ImageSwitcherStereotype([SimulationProfile](SimulationProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getShowEmptyImageForUnspecifiedValueProperty()
getSourceProperty
...
public void setShowEmptyImageForUnspecifiedValue([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)
clearShowEmptyImageForUnspecifiedValue
public void clearShowEmptyImageForUnspecifiedValue([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
isShowEmptyImageForUnspecifiedValue
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowEmptyImageForUnspecifiedValue([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setSource
...
<h1 class="title" title="Class SimulationProfile.ImageSwitcherStereotype">Class SimulationProfile.ImageSwitcherStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SimulationProfile.ImageSwitcherStereotype</span>
...
<div class="col-first even-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE">SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE</a></code></div>
<div class="col-last even-row-color">
<div class="block">If this value is true when the property typed by what imageSwitcher represents has the value that does not specified as any activeElement of the activeImage of this imageSwitcher, empty image would be shown.</div>
</div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.simulation.SimulationProfile)">ImageSwitcherStereotype</a><wbr/>(<a href="SimulationProfile.html" title="class in com.nomagic.magicdraw.simulation">SimulationProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearShowEmptyImageForUnspecifiedValue</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getShowEmptyImageForUnspecifiedValueProperty()">getShowEmptyImageForUnspecifiedValueProperty</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">isShowEmptyImageForUnspecifiedValue</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean)">setShowEmptyImageForUnspecifiedValue</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE">
<h3>SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE</span></div>
<div class="block">If this value is true when the property typed by what imageSwitcher represents has the value that does not specified as any activeElement of the activeImage of this imageSwitcher, empty image would be shown. Otherwise, the image will not change.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.SHOWEMPTYIMAGEFORUNSPECIFIEDVALUE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.SOURCE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.NESTEDPROPERTYPATHS">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.REPRESENTS">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicdraw.simulation.SimulationProfile.ImageSwitcherStereotype.VALUE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ImageSwitcherStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ImageSwitcherStereotype</span><wbr/><span class="parameters">(<a href="SimulationProfile.html" title="class in com.nomagic.magicdraw.simulation">SimulationProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getShowEmptyImageForUnspecifiedValueProperty()">
<h3>getShowEmptyImageForUnspecifiedValueProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getShowEmptyImageForUnspecifiedValueProperty</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="setShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean)">
<h3>setShowEmptyImageForUnspecifiedValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowEmptyImageForUnspecifiedValue</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearShowEmptyImageForUnspecifiedValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearShowEmptyImageForUnspecifiedValue</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="isShowEmptyImageForUnspecifiedValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>isShowEmptyImageForUnspecifiedValue</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a></span> <span class="element-name">isShowEmptyImageForUnspecifiedValue</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
