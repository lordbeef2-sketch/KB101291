# JAVA OPENAPI: ProjectVersion (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/magicreport/tools/ProjectVersion.html
- source_path: `com/nomagic/magicdraw/magicreport/tools/ProjectVersion.html`
- source_sha256: `2ff2ff0a24cb5fa172b0aec4b71915609851ecb87fa928cc919086b74bf689c7`
- captured_utc: `2026-07-14T16:45:37.706504+00:00`
...
`[ProjectVersion](#%3Cinit%3E(com.nomagic.magicdraw.core.project.ProjectDescriptor,java.lang.Object,java.lang.String,java.util.Date,long,java.lang.String))([ProjectDescriptor](../../core/project/ProjectDescriptor.html) projectDescriptor,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) version,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) comment,
 [Date](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html) date,
 long number,
...
`[Date](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html)`
`[getDate](#getDate())()`
...
`void`
`[setComment](#setComment(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) comment)`
Sets comment text.
`void`
`[setDate](#setDate(java.util.Date))([Date](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html) date)`
Sets version date.
`void`
...
`void`
`[setVersion](#setVersion(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) version)`
Sets version object
...
Field Details
DESCENDING
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) DESCENDING
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.magicreport.tools.ProjectVersion.DESCENDING)
ASCENDING
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) ASCENDING
See Also:
...
Method Details
getComment
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getComment()
Returns:
comment for this version.
setComment
public void setComment([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) comment)
Sets comment text.
Parameters:
`com` - the comment text.
getDate
public [Date](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html) getDate()
Returns the date of the version.
Returns:
the date.
setDate
public void setDate([Date](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html) date)
Sets version date.
Parameters:
`date` -
getNumber
...
getAuthor
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getAuthor()
Returns the user who created the version.
Returns:
the user who created the version.
setUser
...
`user` -
getDateAsString
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getDateAsString()
Returns date represented by string.
getVersionAsString
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getVersionAsString()
Returns string representation about version number.
Returns:
string which represents version number.
getNumberAsString
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getNumberAsString()
Deprecated.
Returns string representation about version number.
...
string which represents version number.
getVersion
public [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) getVersion()
Returns version object of project
setVersion
public void setVersion([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) version)
Sets version object
Parameters:
`user` -
getTags
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getTags()
Returns all tags.
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.core.project.ProjectDescriptor,java.lang.Object,java.lang.String,java.util.Date,long,java.lang.String)">ProjectVersion</a><wbr/>(<a href="../../core/project/ProjectDescriptor.html" title="interface in com.nomagic.magicdraw.core.project">ProjectDescriptor</a> projectDescriptor,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> version,
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html" title="class or interface in java.util">Date</a> date,
 long number,
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html" title="class or interface in java.util">Date</a></code></div>
...
<h3>DESCENDING</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">DESCENDING</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<h3>ASCENDING</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ASCENDING</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<h3>getComment</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getComment</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>getDate</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Date.html" title="class or interface in java.util">Date</a></span> <span class="element-name">getDate</span>()</div>
<div class="block">Returns the date of the version.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the date.</dd>
...
<h3>getAuthor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getAuthor</span>()</div>
<div class="block">Returns the user who created the version.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the user who created the version.</dd>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getDateAsString</span>()</div>
<div class="block">Returns date represented by string.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getVersionAsString</span>()</div>
<div class="block">Returns string representation about version number.</div>
<dl class="notes">
<dt>Returns:</dt>
...
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getNumberAsString</span>()</div>
...
<h3>getVersion</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span> <span class="element-name">getVersion</span>()</div>
<div class="block">Returns version object of project</div>
</section>
</li>
<li>
