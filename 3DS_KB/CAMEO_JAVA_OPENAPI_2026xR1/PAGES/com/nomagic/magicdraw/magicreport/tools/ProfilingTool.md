# JAVA OPENAPI: ProfilingTool (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/magicreport/tools/ProfilingTool.html
- source_path: `com/nomagic/magicdraw/magicreport/tools/ProfilingTool.html`
- source_sha256: `a09ab5928e56b7bf2939fc8e598b48567dbea159d6bc37aee1b4df038ca989b9`
- captured_utc: `2026-07-14T16:45:37.611503+00:00`
...
`[getDeclaringElementName](#getDeclaringElementName(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName,
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)>`
`[getElementProperties](#getElementProperties(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName)`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)>`
`[getGeneralizationName](#getGeneralizationName(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName)`
Return generalization model of modelName.
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getHumanPropertyName](#getHumanPropertyName(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)`
...
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getPropertyTypeName](#getPropertyTypeName(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)`
Retrieve type of property.
...
public [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getGeneralizationName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName)
Return generalization model of modelName.
Parameters:
...
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getDeclaringElementName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)
Retrieve the name of meta-model which property name is declared.
Parameters:
`modelName` - meta-model name
...
name of meta-model
getPropertyTypeName
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getPropertyTypeName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)
Retrieve type of property.
Parameters:
`modelName` - meta-model name
...
getPropertyTypeName
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getPropertyTypeName([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)
Retrieve type of property.
Parameters:
...
public [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getElementProperties([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) modelName)
Retrieve Collection of element properties name from meta-model name.
Parameters:
`modelName` - meta-model name
Returns:
...
getElementProperties
public [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getElementProperties([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
Return Collection of element properties name.
Parameters:
`element` - target element
Returns:
collection of element properties
getElementProperty
public [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) getElementProperty([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)
Retrieve property value of specified element and property name.
Parameters:
`element` - target element
...
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getHumanPropertyName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName)
Return text representing property name.
Parameters:
`propertyName` - property name
Returns:
