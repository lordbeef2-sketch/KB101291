# JAVA OPENAPI: ExportTool3 (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/magicreport/tools/ExportTool3.html
- source_path: `com/nomagic/magicdraw/magicreport/tools/ExportTool3.html`
- source_sha256: `5452c8f0c59d6b1c5b451b32820d9a8d6543d21e8a82ade86d6431ecb504ddf7`
- captured_utc: `2026-07-14T16:45:37.970510+00:00`
...
`[ExportTool3](#%3Cinit%3E(com.nomagic.magicreport.engine.ITemplateEngine,java.util.Observer))([ITemplateEngine](../../../magicreport/engine/ITemplateEngine.html) engine,
...
`[ExportTool3](#%3Cinit%3E(java.util.Observer))([Observer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Observer.html) observer)`
Create an export tool with observer.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[createTagName](#createTagName(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) tagName)`
...
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[exportIcon](#exportIcon(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)`
...
`boolean`
`[isDisplayTreeElementId](#isDisplayTreeElementId())()`

`boolean`
`[isDisplayTreeElementNumber](#isDisplayTreeElementNumber())()`

`boolean`
`[isShowAppearsInPage](#isShowAppearsInPage())()`

`boolean`
`[isShowAppliedStereotype](#isShowAppliedStereotype())()`
...
Create an export tool.
ExportTool3
public ExportTool3([Observer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Observer.html) observer)
Create an export tool with observer.
Parameters:
`observer` - Observer
ExportTool3
public ExportTool3([ITemplateEngine](../../../magicreport/engine/ITemplateEngine.html) engine,
 [Observer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Observer.html) observer)
Create an export tool with observer.
Parameters:
`engine` - engine
...
exportIcon
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) exportIcon([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)
Throws:
...
protected void createAndExportElement(org.codehaus.stax2.XMLStreamWriter2 document,
 ...
 com.nomagic.magicdraw.ui.ElementFilter filter)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html),
[XMLStreamException](https://docs.oracle.com/en/java/javase/21/docs/api/java.xml/javax/xml/stream/XMLStreamException.html)
Throws:
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)`
`[XMLStreamException](https://docs.oracle.com/en/java/javase/21/docs/api/java.xml/javax/xml/stream/XMLStreamException.html)`
...
protected [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getElementTypeForTagName([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
createTagName
protected [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) createTagName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) tagName)
exportAll
...
isShowAppearsInPage
public boolean isShowAppearsInPage()
isDisplayTreeElementId
public boolean isDisplayTreeElementId()
isDisplayTreeElementNumber
public boolean isDisplayTreeElementNumber()
isShowAppliedStereotype
public boolean isShowAppliedStereotype()
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicreport.engine.ITemplateEngine,java.util.Observer)">ExportTool3</a><wbr/>(<a href="../../../magicreport/engine/ITemplateEngine.html" title="interface in com.nomagic.magicreport.engine">ITemplateEngine</a> engine,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#consume(com.nomagic.magicreport.engine.ConcurrentTool.ConsumeObject)">consume</a><wbr/>(<a href="../../../magicreport/engine/ConcurrentTool.ConsumeObject.html" title="class in com.nomagic.magicreport.engine">ConcurrentTool.ConsumeObject</a> consumeObject)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isDisplayTreeElementId()">isDisplayTreeElementId</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isDisplayTreeElementNumber()">isDisplayTreeElementNumber</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowAppearsInPage()">isShowAppearsInPage</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowAppliedStereotype()">isShowAppliedStereotype</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<h3>ExportTool3</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ExportTool3</span><wbr/><span class="parameters">(<a href="../../../magicreport/engine/ITemplateEngine.html" title="interface in com.nomagic.magicreport.engine">ITemplateEngine</a> engine,
...
<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.xml/javax/xml/stream/XMLStreamException.html" title="class or interface in javax.xml.stream">XMLStreamException</a></span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code></dd>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.xml/javax/xml/stream/XMLStreamException.html" title="class or interface in javax.xml.stream">XMLStreamException</a></code></dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isShowAppearsInPage()">
<h3>isShowAppearsInPage</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowAppearsInPage</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isDisplayTreeElementId()">
<h3>isDisplayTreeElementId</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isDisplayTreeElementId</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isDisplayTreeElementNumber()">
<h3>isDisplayTreeElementNumber</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isDisplayTreeElementNumber</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowAppliedStereotype()">
<h3>isShowAppliedStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowAppliedStereotype</span>()</div>
</section>
</li>
</ul>
</section>
