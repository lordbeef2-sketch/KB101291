# JAVA OPENAPI: MDFoundationAdapterFactory (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/foundation/util/MDFoundationAdapterFactory.html
- source_path: `com/nomagic/magicdraw/foundation/util/MDFoundationAdapterFactory.html`
- source_sha256: `7878a1ff1503fa2a36a758b5bf524146606836446c25908e258cbf392f8c7b55`
- captured_utc: `2026-07-14T16:45:36.915497+00:00`
...
## Class MDFoundationAdapterFactory

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
org.eclipse.emf.common.notify.impl.AdapterFactoryImpl
com.nomagic.magicdraw.foundation.util.MDFoundationAdapterFactory

All Implemented Interfaces:
`org.eclipse.emf.common.notify.AdapterFactory`

public classMDFoundationAdapterFactory
...
`protected [MDFoundationSwitch](MDFoundationSwitch.html)<org.eclipse.emf.common.notify.Adapter>`
...
Constructor
Description
`[MDFoundationAdapterFactory](#%3Cinit%3E())()`
...
`org.eclipse.emf.common.notify.Adapter`
`[createMDExtensionAdapter](#createMDExtensionAdapter())()`
Creates a new adapter for an object of class '[`*MD Extension*`](../MDExtension.html)'.
`org.eclipse.emf.common.notify.Adapter`
`[createMDObjectAdapter](#createMDObjectAdapter())()`
Creates a new adapter for an object of class '[`*MD Object*`](../MDObject.html)'.
`org.eclipse.emf.common.notify.Adapter`
`[createStringToStringMapEntryAdapter](#createStringToStringMapEntryAdapter())()`
Creates a new adapter for an object of class '[`*String To String Map Entry*`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.Entry.html)'.
`boolean`
`[isFactoryForType](#isFactoryForType(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) object)`
...
Generated:
modelSwitch
protected [MDFoundationSwitch](MDFoundationSwitch.html)<org.eclipse.emf.common.notify.Adapter> modelSwitch
The switch that delegates to the `createXXX` methods.
 begin-user-doc 
 end-user-doc
Generated:
...
public MDFoundationAdapterFactory()
Creates an instance of the adapter factory.
 begin-user-doc 
 end-user-doc
Generated:
...
Method Details
isFactoryForType
public boolean isFactoryForType([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) object)
Returns whether this factory is applicable for the type of the object.
 begin-user-doc 
...
Generated:
createMDExtensionAdapter
public org.eclipse.emf.common.notify.Adapter createMDExtensionAdapter()
Creates a new adapter for an object of class '[`*MD Extension*`](../MDExtension.html)'.
 begin-user-doc 
 This default implementation returns null so that we can easily ignore cases;
 it's useful to ignore a case when inheritance will catch all the cases anyway.
...
public org.eclipse.emf.common.notify.Adapter createStringToStringMapEntryAdapter()
Creates a new adapter for an object of class '[`*String To String Map Entry*`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.Entry.html)'.
 begin-user-doc 
 This default implementation returns null so that we can easily ignore cases;
 it's useful to ignore a case when inheritance will catch all the cases anyway.
...
<h1 class="title" title="Class MDFoundationAdapterFactory">Class MDFoundationAdapterFactory</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance">org.eclipse.emf.common.notify.impl.AdapterFactoryImpl
<div class="inheritance">com.nomagic.magicdraw.foundation.util.MDFoundationAdapterFactory</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">MDFoundationAdapterFactory</span>
...
<div class="col-first odd-row-color"><code>protected <a href="MDFoundationSwitch.html" title="class in com.nomagic.magicdraw.foundation.util">MDFoundationSwitch</a><wbr/>&lt;org.eclipse.emf.common.notify.Adapter&gt;</code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">MDFoundationAdapterFactory</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>org.eclipse.emf.common.notify.Adapter</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createMDExtensionAdapter()">createMDExtensionAdapter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates a new adapter for an object of class '<a href="../MDExtension.html" title="interface in com.nomagic.magicdraw.foundation"><code><em>MD Extension</em></code></a>'.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>org.eclipse.emf.common.notify.Adapter</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createMDObjectAdapter()">createMDObjectAdapter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates a new adapter for an object of class '<a href="../MDObject.html" title="interface in com.nomagic.magicdraw.foundation"><code><em>MD Object</em></code></a>'.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>org.eclipse.emf.common.notify.Adapter</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createStringToStringMapEntryAdapter()">createStringToStringMapEntryAdapter</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates a new adapter for an object of class '<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.Entry.html" title="class or interface in java.util"><code><em>String To String Map Entry</em></code></a>'.</div>
</div>
...
<h3>modelSwitch</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="MDFoundationSwitch.html" title="class in com.nomagic.magicdraw.foundation.util">MDFoundationSwitch</a>&lt;org.eclipse.emf.common.notify.Adapter&gt;</span> <span class="element-name">modelSwitch</span></div>
...
<h3>MDFoundationAdapterFactory</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MDFoundationAdapterFactory</span>()</div>
...
<div class="block">Creates a new adapter for an object of class '<a href="../MDObject.html" title="interface in com.nomagic.magicdraw.foundation"><code><em>MD Object</em></code></a>'.
 <!-- begin-user-doc -->
 This default implementation returns null so that we can easily ignore cases;
 it's useful to ignore a case when inheritance will catch all the cases anyway.
 <!-- end-user-doc --></div>
...
<li>
<section class="detail" id="createMDExtensionAdapter()">
<h3>createMDExtensionAdapter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">org.eclipse.emf.common.notify.Adapter</span> <span class="element-name">createMDExtensionAdapter</span>()</div>
<div class="block">Creates a new adapter for an object of class '<a href="../MDExtension.html" title="interface in com.nomagic.magicdraw.foundation"><code><em>MD Extension</em></code></a>'.
 <!-- begin-user-doc -->
 This default implementation returns null so that we can easily ignore cases;
 it's useful to ignore a case when inheritance will catch all the cases anyway.
 <!-- end-user-doc --></div>
...
<li>
<section class="detail" id="createStringToStringMapEntryAdapter()">
<h3>createStringToStringMapEntryAdapter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">org.eclipse.emf.common.notify.Adapter</span> <span class="element-name">createStringToStringMapEntryAdapter</span>()</div>
<div class="block">Creates a new adapter for an object of class '<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.Entry.html" title="class or interface in java.util"><code><em>String To String Map Entry</em></code></a>'.
 <!-- begin-user-doc -->
 This default implementation returns null so that we can easily ignore cases;
 it's useful to ignore a case when inheritance will catch all the cases anyway.
 <!-- end-user-doc --></div>
