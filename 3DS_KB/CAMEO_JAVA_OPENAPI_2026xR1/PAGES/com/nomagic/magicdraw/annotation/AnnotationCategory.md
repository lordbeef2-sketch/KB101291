# JAVA OPENAPI: AnnotationCategory (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/annotation/AnnotationCategory.html
- source_path: `com/nomagic/magicdraw/annotation/AnnotationCategory.html`
- source_sha256: `349b2d5fe556a4d4deda6d2f45bcdab0995cf5b761b6d5a6cfa3287bf1230bec`
- captured_utc: `2026-07-14T16:45:08.029109+00:00`
...
@OpenApiAllpublic classAnnotationCategory
...
Field
Description
`static final [AnnotationCategory](AnnotationCategory.html)`
`[ANY](#ANY)`
 ======== CONSTRUCTOR SUMMARY ======== 
Constructor Summary
Constructors
Constructor
Description
`[AnnotationCategory](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Field Details
ANY
public static final [AnnotationCategory](AnnotationCategory.html) ANY
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
AnnotationCategory
public AnnotationCategory([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
 ============ METHOD DETAIL ========== 
Method Details
getName
...
<h1 class="title" title="Class AnnotationCategory">Class AnnotationCategory</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance">com.nomagic.magicdraw.annotation.AnnotationCategory</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public class </span><span class="element-name type-name-label">AnnotationCategory</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block">Semantic types of Annotation objects</div>
</section>
...
<div class="col-first even-row-color"><code>static final <a href="AnnotationCategory.html" title="class in com.nomagic.magicdraw.annotation">AnnotationCategory</a></code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#ANY">ANY</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">AnnotationCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<h3>ANY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="AnnotationCategory.html" title="class in com.nomagic.magicdraw.annotation">AnnotationCategory</a></span> <span class="element-name">ANY</span></div>
</section>
</li>
</ul>
</section>
...
<h3>AnnotationCategory</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AnnotationCategory</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
</section>
</li>
</ul>
</section>
