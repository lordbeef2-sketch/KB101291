# JAVA OPENAPI: DialogResource.ResourceID (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/resources/DialogResource.ResourceID.html
- source_path: `com/nomagic/magicdraw/resources/DialogResource.ResourceID.html`
- source_sha256: `0da12510215730d046c6f31778908af931addfe97f4cff0ce1ef4449e4cb9f52`
- captured_utc: `2026-07-14T16:45:40.156537+00:00`
...
## Enum Class DialogResource.ResourceID

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[DialogResource.ResourceID](DialogResource.ResourceID.html)>
com.nomagic.magicdraw.resources.DialogResource.ResourceID

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[DialogResource.ResourceID](DialogResource.ResourceID.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[DialogResource](DialogResource.html)`

public static enumDialogResource.ResourceID
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[DialogResource.ResourceID](DialogResource.ResourceID.html)>
...
Method
Description
`static [DialogResource.ResourceID](DialogResource.ResourceID.html)`
...
PLATFORM
public static final [DialogResource.ResourceID](DialogResource.ResourceID.html) PLATFORM
TWC
public static final [DialogResource.ResourceID](DialogResource.ResourceID.html) TWC
 ============ METHOD DETAIL ========== 
Method Details
values
public static [DialogResource.ResourceID](DialogResource.ResourceID.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [DialogResource.ResourceID](DialogResource.ResourceID.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class DialogResource.ResourceID">Enum Class DialogResource.ResourceID</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.resources.DialogResource.ResourceID</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="DialogResource.html" title="class in com.nomagic.magicdraw.resources">DialogResource</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">DialogResource.ResourceID</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a>&gt;</span></div>
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#TWC">TWC</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a>[]</code></div>
...
<h3>PLATFORM</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a></span> <span class="element-name">PLATFORM</span></div>
</section>
</li>
<li>
<section class="detail" id="TWC">
<h3>TWC</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a></span> <span class="element-name">TWC</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="DialogResource.ResourceID.html" title="enum class in com.nomagic.magicdraw.resources">DialogResource.ResourceID</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
