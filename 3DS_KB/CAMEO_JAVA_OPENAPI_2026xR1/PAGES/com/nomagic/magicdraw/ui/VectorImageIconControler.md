# JAVA OPENAPI: VectorImageIconControler (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/VectorImageIconControler.html
- source_path: `com/nomagic/magicdraw/ui/VectorImageIconControler.html`
- source_sha256: `5bbb05c38b8b7603d5e40fc1f7898446f4d83c5b16171c57c614cdf66c4b741b`
- captured_utc: `2026-07-14T16:45:59.801798+00:00`
...
@OpenApiAll
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public classVectorImageIconControler
...
Constructor
Description
`[VectorImageIconControler](#%3Cinit%3E(java.lang.Class,java.lang.String,int,int))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) loader,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) iconPath,
 int iconSize,
 int type)`
Deprecated.
...
@OpenApipublic VectorImageIconControler([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html) loader,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) iconPath,
 int iconSize,
 int type)
Deprecated.
...
Method Details
createIcon
public [Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) createIcon()
Deprecated.
...
Loaded image file
getIconPath
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getIconPath()
Deprecated.
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,java.lang.String,int,int)">VectorImageIconControler</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a> loader,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> iconPath,
 int iconSize,
 int type)</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
</span><span class="modifiers">public</span> <span class="element-name">VectorImageIconControler</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a> loader,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> iconPath,
 int iconSize,
 int type)</span></div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
...
<h3>createIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a></span> <span class="element-name">createIcon</span>()</div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IconControlerInterface.html#createIcon()">IconControlerInterface</a></code></span></div>
<div class="block">Creates icon by given class file and path</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<h3>getIconPath</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getIconPath</span>()</div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IconControlerInterface.html#getIconPath()">IconControlerInterface</a></code></span></div>
<div class="block">Returns full icon name.</div>
<dl class="notes">
<dt>Specified by:</dt>
