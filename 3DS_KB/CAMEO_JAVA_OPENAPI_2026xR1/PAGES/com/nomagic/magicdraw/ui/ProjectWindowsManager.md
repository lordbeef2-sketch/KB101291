# JAVA OPENAPI: ProjectWindowsManager (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/ProjectWindowsManager.html
- source_path: `com/nomagic/magicdraw/ui/ProjectWindowsManager.html`
- source_sha256: `db0e744a96e77083f3f8d5dac146e62adfe858244a1dadf73fdd0d39701d40ee`
- captured_utc: `2026-07-14T16:46:00.613809+00:00`
...
`default void`
`[activateWindow](#activateWindow(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)`
Deprecated.
...
`default void`
`[hideWindow](#hideWindow(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)`
Deprecated.
...
`default void`
`[removeWindow](#removeWindow(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)`
Deprecated.
use [`hideWindow(Project, String)`](#hideWindow(com.nomagic.magicdraw.core.Project,java.lang.String))
`void`
...
Method Details
addWindow
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void addWindow([ProjectWindow](ProjectWindow.html) projectWindow)
Deprecated.
use [`addWindow(Project, ProjectWindow)`](#addWindow(com.nomagic.magicdraw.core.Project,com.nomagic.magicdraw.ui.ProjectWindow))
addWindow
...
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void addWindowWithoutOpen([ProjectWindow](ProjectWindow.html) projectWindow)
Deprecated.
use [`addWindowWithoutOpen(Project, ProjectWindow)`](#addWindowWithoutOpen(com.nomagic.magicdraw.core.Project,com.nomagic.magicdraw.ui.ProjectWindow))
addWindowWithoutOpen
...
updateWindow
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void updateWindow([ProjectWindow](ProjectWindow.html) projectWindow)
Deprecated.
use [`updateWindow(Project, ProjectWindow)`](#updateWindow(com.nomagic.magicdraw.core.Project,com.nomagic.magicdraw.ui.ProjectWindow))
updateWindow
...
hideWindow
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void hideWindow([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)
Deprecated.
use [`hideWindow(Project, String)`](#hideWindow(com.nomagic.magicdraw.core.Project,java.lang.String))
hideWindow
...
removeWindow
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void removeWindow([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)
Deprecated.
use [`hideWindow(Project, String)`](#hideWindow(com.nomagic.magicdraw.core.Project,java.lang.String))
removeWindow
...
activateWindow
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)default void activateWindow([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)
Deprecated.
use [`activateWindow(Project, String)`](#activateWindow(com.nomagic.magicdraw.core.Project,java.lang.String))
activateWindow
...
getBounds
@CheckForNull[Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) getBounds(@CheckForNull
 [Project](../core/Project.html) project,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)
Returns bounds of window with given id.
Parameters:
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setBounds(com.nomagic.magicdraw.core.Project,java.lang.String,java.awt.Rectangle)">setBounds</a><wbr/>(<a href="../core/Project.html" title="class in com.nomagic.magicdraw.core">Project</a> project,
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> bounds)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a></span> <span class="element-name">getBounds</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../core/Project.html" title="class in com.nomagic.magicdraw.core">Project</a> project,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</span></div>
<div class="block">Returns bounds of window with given id.</div>
<dl class="notes">
