# JAVA OPENAPI: SelectionProvider.SelectionChangedEvent (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/SelectionProvider.SelectionChangedEvent.html
- source_path: `com/nomagic/magicdraw/ui/SelectionProvider.SelectionChangedEvent.html`
- source_sha256: `9103a01318c6486bcf7672c420f4ff5ea636dd50138fae91db2c853f8eb3670b`
- captured_utc: `2026-07-14T16:45:59.649796+00:00`
...
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](../uml/BaseElement.html)> getOldSelectedValues()
Deprecated.
use [`getOldSelection()`](#getOldSelection())
...
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [BaseElement](../uml/BaseElement.html)> getNewSelectedValues()
Deprecated.
use [`getNewSelection()`](#getNewSelection())
