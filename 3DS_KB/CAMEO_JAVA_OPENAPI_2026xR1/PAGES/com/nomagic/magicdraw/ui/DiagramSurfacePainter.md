# JAVA OPENAPI: DiagramSurfacePainter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/DiagramSurfacePainter.html
- source_path: `com/nomagic/magicdraw/ui/DiagramSurfacePainter.html`
- source_sha256: `3f57790ea5124a356de067f795848804bb87055802adab23cd7a3bd7e6f7bee4`
- captured_utc: `2026-07-14T16:45:58.835786+00:00`
...
This painter can do some additional painting on diagram canvas.
 This class also provides an API for registering painters for all diagrams.
...
Description
`abstract void`
`[paint](#paint(java.awt.Graphics,com.nomagic.magicdraw.uml.symbols.DiagramPresentationElement))([Graphics](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics.html) g,
...
Method Details
paint
public abstract void paint([Graphics](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics.html) g,
 [DiagramPresentationElement](../uml/symbols/DiagramPresentationElement.html) diagram)
Do some painting on given canvas with given diagram
Parameters:
`g` - the graphics.
...
<div class="block">This painter can do some additional painting on diagram canvas.
 This class also provides an API for registering painters for all diagrams.</div>
</section>
