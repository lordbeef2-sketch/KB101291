# JAVA OPENAPI: MagicDrawProfile.DeprecatedStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.DeprecatedStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.DeprecatedStereotype.html`
- source_sha256: `358a5cae88dee457b6aae511fa625e90f2aa8a9e11e90b94c9497d59d9e5a4ee`
- captured_utc: `2026-07-14T16:46:17.719035+00:00`
...
com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype

Enclosing class:
`[MagicDrawProfile](MagicDrawProfile.html)`

public static classMagicDrawProfile.DeprecatedStereotype
...
Description
`protected`
`[DeprecatedStereotype](#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile))([MagicDrawProfile](MagicDrawProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearDeprecatedReason](#clearDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getDeprecatedReason](#getDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](ext/magicdraw/classes/mdkernel/Property.html)`
`[getDeprecatedReasonProperty](#getDeprecatedReasonProperty())()`
...
`void`
`[setDeprecatedReason](#setDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype.STEREOTYPE_NAME)
DEPRECATEDREASON
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) DEPRECATEDREASON
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype.DEPRECATEDREASON)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DeprecatedStereotype
protected DeprecatedStereotype([MagicDrawProfile](MagicDrawProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getDeprecatedReasonProperty()
setDeprecatedReason
public void setDeprecatedReason([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)
clearDeprecatedReason
public void clearDeprecatedReason([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
getDeprecatedReason
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getDeprecatedReason([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class MagicDrawProfile.DeprecatedStereotype">Class MagicDrawProfile.DeprecatedStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">MagicDrawProfile.DeprecatedStereotype</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#DEPRECATEDREASON">DEPRECATEDREASON</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile)">DeprecatedStereotype</a><wbr/>(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearDeprecatedReason</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getDeprecatedReason</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDeprecatedReasonProperty()">getDeprecatedReasonProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">setDeprecatedReason</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="DEPRECATEDREASON">
<h3>DEPRECATEDREASON</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">DEPRECATEDREASON</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DeprecatedStereotype.DEPRECATEDREASON">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>DeprecatedStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">DeprecatedStereotype</span><wbr/><span class="parameters">(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getDeprecatedReasonProperty()">
<h3>getDeprecatedReasonProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getDeprecatedReasonProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">
<h3>setDeprecatedReason</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setDeprecatedReason</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearDeprecatedReason</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearDeprecatedReason</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getDeprecatedReason(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getDeprecatedReason</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getDeprecatedReason</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
