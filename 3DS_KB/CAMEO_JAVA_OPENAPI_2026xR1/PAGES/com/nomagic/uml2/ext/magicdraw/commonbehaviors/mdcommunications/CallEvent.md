# JAVA OPENAPI: CallEvent (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/CallEvent.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/CallEvent.html`
- source_sha256: `bbcec4c7ebc50075b6397fa88fd9a56a9c4c0bd8d1478ec37bb492e8970f2535`
- captured_utc: `2026-07-14T16:46:30.818211+00:00`
...
See Also:
[`UMLPackage.getCallEvent()`](../../metadata/UMLPackage.html#getCallEvent())
Model:
...
Returns the value of the '***Operation***' reference.
 ...
 '[`*call Event Of Operation*`](../../classes/mdkernel/Operation.html#get_callEventOfOperation())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 Designates the Operation whose invocation raised the CallEvent.
 end-model-doc
Returns:
...
[`UMLPackage.getCallEvent_Operation()`](../../metadata/UMLPackage.html#getCallEvent_Operation())
[`Operation.get_callEventOfOperation()`](../../classes/mdkernel/Operation.html#get_callEventOfOperation())
Model:
opposite="_callEventOfOperation" required="true" ordered="false"
Generated:
setOperation
...
<h1 class="title" title="Interface CallEvent">Interface CallEvent</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">CallEvent</span><span class="extends-implements">
extends <a href="MessageEvent.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdcommunications">MessageEvent</a></span></div>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getCallEvent()"><code>UMLPackage.getCallEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOperation(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Operation)">setOperation</a><wbr/>(<a href="../../classes/mdkernel/Operation.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Operation</a> value)</code></div>
...
<div class="block">Returns the value of the '<em><b>Operation</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Operation.html#get_callEventOfOperation()"><code><em>call Event Of Operation</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Designates the Operation whose invocation raised the CallEvent.
...
<li><a href="../../metadata/UMLPackage.html#getCallEvent_Operation()"><code>UMLPackage.getCallEvent_Operation()</code></a></li>
<li><a href="../../classes/mdkernel/Operation.html#get_callEventOfOperation()"><code>Operation.get_callEventOfOperation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_callEventOfOperation" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
