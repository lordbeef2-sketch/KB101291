# JAVA OPENAPI: PackageableElement (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/PackageableElement.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/PackageableElement.html`
- source_sha256: `8b696b2879a905d8cf5c5196518c8501dffa327336d8b52acf94e5ce3cbf40cd`
- captured_utc: `2026-07-14T16:46:29.689195+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Manifestation](../../deployments/mdartifacts/Manifestation.html)>`
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ElementImport](ElementImport.html)> get_elementImportOfImportedElement()
Returns the value of the '***element Import Of Imported Element***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Manifestation](../../deployments/mdartifacts/Manifestation.html)> get_manifestationOfUtilizedElement()
Returns the value of the '***manifestation Of Utilized Element***' reference list.
