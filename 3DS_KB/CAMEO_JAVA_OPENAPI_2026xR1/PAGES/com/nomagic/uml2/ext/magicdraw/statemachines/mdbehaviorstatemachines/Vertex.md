# JAVA OPENAPI: Vertex (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/Vertex.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/Vertex.html`
- source_sha256: `4e400beff8650f12a0812c0897a4eb24d552e8930e2e7a3fa4f23f97729384e7`
- captured_utc: `2026-07-14T16:46:34.303255+00:00`
...
`[ConnectionPointReference](ConnectionPointReference.html)`, `[FinalState](FinalState.html)`, `[Pseudostate](Pseudostate.html)`, `[State](State.html)`

public interfaceVertexextends [RedefinableElement](../../classes/mdkernel/RedefinableElement.html)
...
See Also:
[`UMLPackage.getVertex()`](../../metadata/UMLPackage.html#getVertex())
Model:
abstract="true"
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Vertex](Vertex.html)>`
`[get_vertexOfRedefinedVertex](#get_vertexOfRedefinedVertex())()`
Returns the value of the '***Vertex***' reference list.
`[Region](Region.html)`
`[getContainer](#getContainer())()`
Returns the value of the '***Container***' container reference.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Transition](Transition.html)>`
...
`[Vertex](Vertex.html)`
`[getRedefinedVertex](#getRedefinedVertex())()`
...
Sets the value of the '[`*Container*`](#getContainer())' container reference.
`void`
`[setRedefinedVertex](#setRedefinedVertex(com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Vertex))([Vertex](Vertex.html) value)`
Sets the value of the '[`*Redefined Vertex*`](#getRedefinedVertex())' reference.
...
Method Details
getRedefinedVertex
@CheckForNull[Vertex](Vertex.html) getRedefinedVertex()
Returns the value of the '***Redefined Vertex***' reference.
 It is bidirectional and its opposite is
 '[`get_vertexOfRedefinedVertex()`](#get_vertexOfRedefinedVertex()) *vertex Of Redefined Vertex*}'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setRedefinedVertex(Vertex)`](#setRedefinedVertex(com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Vertex))
[`UMLPackage.getVertex_RedefinedVertex()`](../../metadata/UMLPackage.html#getVertex_RedefinedVertex())
[`get_vertexOfRedefinedVertex()`](#get_vertexOfRedefinedVertex())
Model:
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Vertex](Vertex.html)> get_vertexOfRedefinedVertex()
Returns the value of the '***Vertex***' reference list.
 It is bidirectional and its opposite is
 '[`*Redefined Vertex*`](#getRedefinedVertex())'.
 begin-user-doc 
If the meaning of the '*state Of Redefined Vertex*' reference isn't clear,
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)> getRedefinitionContext()
Returns the value of the '***Redefinition Context***' reference list.
...
See Also:
[`UMLPackage.getVertex_RedefinitionContext()`](../../metadata/UMLPackage.html#getVertex_RedefinitionContext())
Model:
opposite="_vertexOfRedefinitionContext" transient="true" changeable="false" volatile="true" derived="true" ordered="false"
Generated:
getOutgoing
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Transition](Transition.html)> getOutgoing()
Returns the value of the '***Outgoing***' reference list.
 The list contents are of type [`Transition`](Transition.html).
 It is bidirectional and its opposite is '[`*Source*`](Transition.html#getSource())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getVertex_Outgoing()`](../../metadata/UMLPackage.html#getVertex_Outgoing())
[`Transition.getSource()`](Transition.html#getSource())
Model:
opposite="source" ordered="false"
Generated:
getIncoming
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Transition](Transition.html)> getIncoming()
Returns the value of the '***Incoming***' reference list.
 The list contents are of type [`Transition`](Transition.html).
 It is bidirectional and its opposite is '[`*Target*`](Transition.html#getTarget())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getVertex_Incoming()`](../../metadata/UMLPackage.html#getVertex_Incoming())
[`Transition.getTarget()`](Transition.html#getTarget())
Model:
...
Returns the value of the '***Container***' container reference.
 It is bidirectional and its opposite is '[`*Subvertex*`](Region.html#getSubvertex())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getVertex_Container()`](../../metadata/UMLPackage.html#getVertex_Container())
[`Region.getSubvertex()`](Region.html#getSubvertex())
Model:
...
<h1 class="title" title="Interface Vertex">Interface Vertex</h1>
</div>
...
<dd><code><a href="ConnectionPointReference.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">ConnectionPointReference</a></code>, <code><a href="FinalState.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">FinalState</a></code>, <code><a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Pseudostate</a></code>, <code><a href="State.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">State</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Vertex</span><span class="extends-implements">
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getVertex()"><code>UMLPackage.getVertex()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
 annotation="MOF package='statemachines.mdbehaviorstatemachines'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="Vertex.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Vertex</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_vertexOfRedefinedVertex()">get_vertexOfRedefinedVertex</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Vertex</b></em>' reference list.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRedefinedVertex()">getRedefinedVertex</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Redefined Vertex</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRedefinitionContext()">getRedefinitionContext</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasOutgoing()">hasOutgoing</a>()</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getContainer()"><code><em>Container</em></code></a>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setRedefinedVertex(com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Vertex)">setRedefinedVertex</a><wbr/>(<a href="Vertex.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Vertex</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getRedefinedVertex()"><code><em>Redefined Vertex</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getRedefinedVertex()">
<h3>getRedefinedVertex</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Vertex.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Vertex</a></span> <span class="element-name">getRedefinedVertex</span>()</div>
<div class="block">Returns the value of the '<em><b>Redefined Vertex</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="#get_vertexOfRedefinedVertex()"><code>get_vertexOfRedefinedVertex()</code></a> <em>vertex Of Redefined Vertex</em>}'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Vertex of which this Vertex is a redefinition.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Redefined Vertex</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setRedefinedVertex(com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Vertex)"><code>setRedefinedVertex(Vertex)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getVertex_RedefinedVertex()"><code>UMLPackage.getVertex_RedefinedVertex()</code></a></li>
<li><a href="#get_vertexOfRedefinedVertex()"><code>get_vertexOfRedefinedVertex()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="vertex" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setRedefinedVertex(com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Vertex)">
<h3>setRedefinedVertex</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setRedefinedVertex</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getRedefinedVertex()"><code><em>Redefined Vertex</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Redefined Vertex</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getRedefinedVertex()"><code>getRedefinedVertex()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="get_vertexOfRedefinedVertex()">
<h3>get_vertexOfRedefinedVertex</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Vertex.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Vertex</a>&gt;</span> <span class="element-name">get_vertexOfRedefinedVertex</span>()</div>
<div class="block">Returns the value of the '<em><b>Vertex</b></em>' reference list.
 It is bidirectional and its opposite is
 '<a href="#getRedefinedVertex()"><code><em>Redefined Vertex</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>state Of Redefined Vertex</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>vertex Of Redefined Vertex</em>' reference list.</dd>
<dt>Model:</dt>
<dd>opposite="redefinedVertex" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getVertex_RedefinitionContext()"><code>UMLPackage.getVertex_RedefinitionContext()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_vertexOfRedefinitionContext" transient="true" changeable="false" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getOutgoing</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Transition.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Transition</a>&gt;</span> <span class="element-name">getOutgoing</span>()</div>
<div class="block">Returns the value of the '<em><b>Outgoing</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="Transition.html#getSource()"><code><em>Source</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the Transitions departing from this Vertex.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getVertex_Outgoing()"><code>UMLPackage.getVertex_Outgoing()</code></a></li>
<li><a href="Transition.html#getSource()"><code>Transition.getSource()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<h3>getIncoming</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Transition.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Transition</a>&gt;</span> <span class="element-name">getIncoming</span>()</div>
<div class="block">Returns the value of the '<em><b>Incoming</b></em>' reference list.
 The list contents are of type <a href="Transition.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>Transition</code></a>.
 It is bidirectional and its opposite is '<a href="Transition.html#getTarget()"><code><em>Target</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the Transitions entering this Vertex.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getVertex_Incoming()"><code>UMLPackage.getVertex_Incoming()</code></a></li>
<li><a href="Transition.html#getTarget()"><code>Transition.getTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Container</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Region.html#getSubvertex()"><code><em>Subvertex</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Region that contains this Vertex.
...
<li><a href="../../metadata/UMLPackage.html#getVertex_Container()"><code>UMLPackage.getVertex_Container()</code></a></li>
<li><a href="Region.html#getSubvertex()"><code>Region.getSubvertex()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="subvertex" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Sets the value of the '<a href="#getContainer()"><code><em>Container</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
