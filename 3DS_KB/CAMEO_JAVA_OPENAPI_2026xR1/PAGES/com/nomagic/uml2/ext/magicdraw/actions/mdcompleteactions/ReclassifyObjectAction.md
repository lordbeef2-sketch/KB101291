# JAVA OPENAPI: ReclassifyObjectAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReclassifyObjectAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReclassifyObjectAction.html`
- source_sha256: `a7f247b92d5a890e84ff53747736dde1af6d82d7c9a83784ecf35d4feef9079d`
- captured_utc: `2026-07-14T16:46:24.058121+00:00`
...
public interfaceReclassifyObjectActionextends [Action](../mdbasicactions/Action.html)
...
[`*New Classifier*`](#getNewClassifier())
[`*Old Classifier*`](#getOldClassifier())
[`*Object*`](#getObject())

See Also:
[`UMLPackage.getReclassifyObjectAction()`](../../metadata/UMLPackage.html#getReclassifyObjectAction())
Model:
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)>`
`[getOldClassifier](#getOldClassifier())()`
Returns the value of the '***Old Classifier***' reference list.
`boolean`
`[hasNewClassifier](#hasNewClassifier())()`

`boolean`
`[hasOldClassifier](#hasOldClassifier())()`
...
Generated:
getOldClassifier
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)> getOldClassifier()
Returns the value of the '***Old Classifier***' reference list.
 The list contents are of type [`Classifier`](../../classes/mdkernel/Classifier.html).
 It is bidirectional and its opposite is '[`*reclassify Object Action Of Old Classifier*`](../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfOldClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getReclassifyObjectAction_OldClassifier()`](../../metadata/UMLPackage.html#getReclassifyObjectAction_OldClassifier())
[`Classifier.get_reclassifyObjectActionOfOldClassifier()`](../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfOldClassifier())
Model:
opposite="_reclassifyObjectActionOfOldClassifier" ordered="false"
Generated:
getNewClassifier
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)> getNewClassifier()
Returns the value of the '***New Classifier***' reference list.
 The list contents are of type [`Classifier`](../../classes/mdkernel/Classifier.html).
 It is bidirectional and its opposite is '[`*reclassify Object Action Of New Classifier*`](../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfNewClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getReclassifyObjectAction_NewClassifier()`](../../metadata/UMLPackage.html#getReclassifyObjectAction_NewClassifier())
[`Classifier.get_reclassifyObjectActionOfNewClassifier()`](../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfNewClassifier())
Model:
...
Returns the value of the '***Object***' containment reference.
 ...
 '[`*reclassify Object Action Of Object*`](../mdbasicactions/InputPin.html#get_reclassifyObjectActionOfObject())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReclassifyObjectAction_Object()`](../../metadata/UMLPackage.html#getReclassifyObjectAction_Object())
[`InputPin.get_reclassifyObjectActionOfObject()`](../mdbasicactions/InputPin.html#get_reclassifyObjectActionOfObject())
Model:
...
<h1 class="title" title="Interface ReclassifyObjectAction">Interface ReclassifyObjectAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReclassifyObjectAction</span><span class="extends-implements">
...
<li><a href="#getNewClassifier()"><code><em>New Classifier</em></code></a></li>
<li><a href="#getOldClassifier()"><code><em>Old Classifier</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getReclassifyObjectAction()"><code>UMLPackage.getReclassifyObjectAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getNewClassifier()">getNewClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>New Classifier</b></em>' reference list.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOldClassifier()">getOldClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Old Classifier</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasNewClassifier()">hasNewClassifier</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasOldClassifier()">hasOldClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isReplaceAll()">isReplaceAll</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getReclassifyObjectAction_ReplaceAll()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="getOldClassifier()">
<h3>getOldClassifier</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt;</span> <span class="element-name">getOldClassifier</span>()</div>
<div class="block">Returns the value of the '<em><b>Old Classifier</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfOldClassifier()"><code><em>reclassify Object Action Of Old Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A set of Classifiers to be removed from the Classifiers of the given object.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Old Classifier</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getReclassifyObjectAction_OldClassifier()"><code>UMLPackage.getReclassifyObjectAction_OldClassifier()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfOldClassifier()"><code>Classifier.get_reclassifyObjectActionOfOldClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reclassifyObjectActionOfOldClassifier" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getNewClassifier()">
<h3>getNewClassifier</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt;</span> <span class="element-name">getNewClassifier</span>()</div>
<div class="block">Returns the value of the '<em><b>New Classifier</b></em>' reference list.
 The list contents are of type <a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel"><code>Classifier</code></a>.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfNewClassifier()"><code><em>reclassify Object Action Of New Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A set of Classifiers to be added to the Classifiers of the given object.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>New Classifier</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getReclassifyObjectAction_NewClassifier()"><code>UMLPackage.getReclassifyObjectAction_NewClassifier()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_reclassifyObjectActionOfNewClassifier()"><code>Classifier.get_reclassifyObjectActionOfNewClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reclassifyObjectActionOfNewClassifier" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_reclassifyObjectActionOfObject()"><code><em>reclassify Object Action Of Object</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that holds the object to be reclassified.
...
<li><a href="../../metadata/UMLPackage.html#getReclassifyObjectAction_Object()"><code>UMLPackage.getReclassifyObjectAction_Object()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_reclassifyObjectActionOfObject()"><code>InputPin.get_reclassifyObjectActionOfObject()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reclassifyObjectActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasOldClassifier()">
<h3>hasOldClassifier</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasOldClassifier</span>()
...
<li>
<section class="detail" id="hasNewClassifier()">
<h3>hasNewClassifier</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasNewClassifier</span>()
                  throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
