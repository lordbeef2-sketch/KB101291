# JAVA OPENAPI: SendObjectAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/SendObjectAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/SendObjectAction.html`
- source_sha256: `d4a489383464a4a00f5eb15fb73765fc39e3817291b21ba1e9b36080b8e24332`
- captured_utc: `2026-07-14T16:46:25.227135+00:00`
...
See Also:
[`UMLPackage.getSendObjectAction()`](../../metadata/UMLPackage.html#getSendObjectAction())
Model:
...
`void`
`[setRequest](#setRequest(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*Request*`](#getRequest())' containment reference.
`void`
`[setTarget](#setTarget(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.[InvocationAction](../mdbasicactions/InvocationAction.html)
`[getArgument](../mdbasicactions/InvocationAction.html#getArgument()), [getOnPort](../mdbasicactions/InvocationAction.html#getOnPort()), [hasArgument](../mdbasicactions/InvocationAction.html#hasArgument()), [setOnPort](../mdbasicactions/InvocationAction.html#setOnPort(com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port))`
...
Method Details
getTarget
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getTarget()
Returns the value of the '***Target***' containment reference.
 It is bidirectional and its opposite is
 '[`*send Object Action Of Target*`](../mdbasicactions/InputPin.html#get_sendObjectActionOfTarget())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getSendObjectAction_Target()`](../../metadata/UMLPackage.html#getSendObjectAction_Target())
[`InputPin.get_sendObjectActionOfTarget()`](../mdbasicactions/InputPin.html#get_sendObjectActionOfTarget())
Model:
opposite="_sendObjectActionOfTarget" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setTarget
...
Generated:
getRequest
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getRequest()
Returns the value of the '***Request***' containment reference.
 It is bidirectional and its opposite is
 '[`*send Object Action Of Request*`](../mdbasicactions/InputPin.html#get_sendObjectActionOfRequest())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setRequest(InputPin)`](#setRequest(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getSendObjectAction_Request()`](../../metadata/UMLPackage.html#getSendObjectAction_Request())
[`InputPin.get_sendObjectActionOfRequest()`](../mdbasicactions/InputPin.html#get_sendObjectActionOfRequest())
Model:
opposite="_sendObjectActionOfRequest" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setRequest
void setRequest(@CheckForNull
 [InputPin](../mdbasicactions/InputPin.html) value)
Sets the value of the '[`*Request*`](#getRequest())' containment reference.
 begin-user-doc 
 end-user-doc
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getRequest()"><code><em>Request</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getSendObjectAction()"><code>UMLPackage.getSendObjectAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRequest()">getRequest</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Request</b></em>' containment reference.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setRequest(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setRequest</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getRequest()"><code><em>Request</em></code></a>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTarget(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setTarget</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InvocationAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.<a href="../mdbasicactions/InvocationAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InvocationAction</a></h3>
<code><a href="../mdbasicactions/InvocationAction.html#getArgument()">getArgument</a>, <a href="../mdbasicactions/InvocationAction.html#getOnPort()">getOnPort</a>, <a href="../mdbasicactions/InvocationAction.html#hasArgument()">hasArgument</a>, <a href="../mdbasicactions/InvocationAction.html#setOnPort(com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port)">setOnPort</a></code></div>
<div class="inherited-list">
...
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getTarget</span>()</div>
<div class="block">Returns the value of the '<em><b>Target</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_sendObjectActionOfTarget()"><code><em>send Object Action Of Target</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The target object to which the object is sent.
...
<li><a href="../../metadata/UMLPackage.html#getSendObjectAction_Target()"><code>UMLPackage.getSendObjectAction_Target()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_sendObjectActionOfTarget()"><code>InputPin.get_sendObjectActionOfTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_sendObjectActionOfTarget" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getRequest</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getRequest</span>()</div>
<div class="block">Returns the value of the '<em><b>Request</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_sendObjectActionOfRequest()"><code><em>send Object Action Of Request</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The request object, which is transmitted to the target object. The object may be copied in transmission, so identity might not be preserved.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Request</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setRequest(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setRequest(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getSendObjectAction_Request()"><code>UMLPackage.getSendObjectAction_Request()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_sendObjectActionOfRequest()"><code>InputPin.get_sendObjectActionOfRequest()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_sendObjectActionOfRequest" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setRequest(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setRequest</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setRequest</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getRequest()"><code><em>Request</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Request</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getRequest()"><code>getRequest()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
