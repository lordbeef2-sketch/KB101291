# JAVA OPENAPI: Activity (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdfundamentalactivities/Activity.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdfundamentalactivities/Activity.html`
- source_sha256: `ed55d192abd3e05e346d3a6b2405828e88bf6b77c5e43543bf829880ef975014`
- captured_utc: `2026-07-14T16:46:26.973159+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[StructuredActivityNode](../mdstructuredactivities/StructuredActivityNode.html)>`
`[getStructuredNode](#getStructuredNode())()`
Returns the value of the '***Structured Node***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Variable](../mdstructuredactivities/Variable.html)>`
...
Generated:
getGroup
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ActivityGroup](ActivityGroup.html)> getGroup()
Returns the value of the '***Group***' containment reference list.
...
Generated:
getPartition
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ActivityPartition](../mdintermediateactivities/ActivityPartition.html)> getPartition()
Returns the value of the '***Partition***' reference list.
...
Generated:
getVariable
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Variable](../mdstructuredactivities/Variable.html)> getVariable()
Returns the value of the '***Variable***' containment reference list.
...
Generated:
getStructuredNode
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[StructuredActivityNode](../mdstructuredactivities/StructuredActivityNode.html)> getStructuredNode()
Returns the value of the '***Structured Node***' reference list.
...
Generated:
getNode
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ActivityNode](ActivityNode.html)> getNode()
Returns the value of the '***Node***' containment reference list.
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../mdstructuredactivities/StructuredActivityNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">StructuredActivityNode</a>&gt;</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../mdstructuredactivities/Variable.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">Variable</a>&gt;</code></div>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getActivity_ReadOnly()</code></pre>
</details>
</li>
</ul>
</dd>
...
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getActivity_SingleExecution()</code></pre>
</details>
</li>
</ul>
</dd>
