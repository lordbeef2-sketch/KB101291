# JAVA OPENAPI: ElementValue (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/ElementValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/ElementValue.html`
- source_sha256: `3fad09da983162452dc9cc5edb4ea01c0168b16978e0117ad70f613eb7cd471a`
- captured_utc: `2026-07-14T16:46:28.827183+00:00`
...
public interfaceElementValueextends [ValueSpecification](ValueSpecification.html)
...
See Also:
[`UMLPackage.getElementValue()`](../../metadata/UMLPackage.html#getElementValue())
Model:
...
`void`
`[setElement](#setElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](Element.html) value)`
Sets the value of the '[`*Element*`](#getElement())' reference.
...
Method Details
getElement
@CheckForNull[Element](Element.html) getElement()
Returns the value of the '***Element***' reference.
 It is bidirectional and its opposite is
 '[`*element Value Of Element*`](Element.html#get_elementValueOfElement())'.
 begin-user-doc 
...
See Also:
[`setElement(Element)`](#setElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))
[`UMLPackage.getElementValue_Element()`](../../metadata/UMLPackage.html#getElementValue_Element())
[`Element.get_elementValueOfElement()`](Element.html#get_elementValueOfElement())
Model:
opposite="_elementValueOfElement" required="true" ordered="false"
Generated:
setElement
void setElement(@CheckForNull
...
<h1 class="title" title="Interface ElementValue">Interface ElementValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ElementValue</span><span class="extends-implements">
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getElementValue()"><code>UMLPackage.getElementValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Element</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setElement</a><wbr/>(<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getElement()"><code><em>Element</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Element</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="Element.html#get_elementValueOfElement()"><code><em>element Value Of Element</em></code></a>'.
 <!-- begin-user-doc -->
<p>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Element</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)"><code>setElement(Element)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getElementValue_Element()"><code>UMLPackage.getElementValue_Element()</code></a></li>
<li><a href="Element.html#get_elementValueOfElement()"><code>Element.get_elementValueOfElement()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_elementValueOfElement" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>setElement</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setElement</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getElement()"><code><em>Element</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Element</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
