# JAVA OPENAPI: ConnectionPointReference (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/ConnectionPointReference.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/ConnectionPointReference.html`
- source_sha256: `d2115920e87df11644d85b76356562dd11964f558d9a23012aff47342a2da523`
- captured_utc: `2026-07-14T16:46:33.655247+00:00`
...
public interfaceConnectionPointReferenceextends [Vertex](Vertex.html)

begin-user-doc 
 A representation of the model object '***Connection Point Reference***'.
 end-user-doc 
begin-model-doc 
 A ConnectionPointReference represents a usage (as part of a submachine State) of an entry/exit point Pseudostate defined in the StateMachine referenced by the
 submachine State.
 end-model-doc 
...
See Also:
[`UMLPackage.getConnectionPointReference()`](../../metadata/UMLPackage.html#getConnectionPointReference())
Model:
...
Sets the value of the '[`*State*`](#getState())' container
 reference.
...
Method Details
getEntry
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)> getEntry()
Returns the value of the '***Entry***' reference list.
 The list contents are of type [`Pseudostate`](Pseudostate.html).
 It is bidirectional and its opposite is '
invalid reference
`.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfEntry *connection Point Reference Of Entry*`
'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getConnectionPointReference_Entry()`](../../metadata/UMLPackage.html#getConnectionPointReference_Entry())
[`Pseudostate.get_connectionPointReferenceOfEntry()`](Pseudostate.html#get_connectionPointReferenceOfEntry())
Model:
opposite="_connectionPointReferenceOfEntry" ordered="false"
Generated:
getExit
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)> getExit()
Returns the value of the '***Exit***' reference list.
 The list contents are of type [`Pseudostate`](Pseudostate.html).
 It is bidirectional and its opposite is '
invalid reference
`.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfExit *connection Point Reference Of Exit*`
'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getConnectionPointReference_Exit()`](../../metadata/UMLPackage.html#getConnectionPointReference_Exit())
[`Pseudostate.get_connectionPointReferenceOfExit()`](Pseudostate.html#get_connectionPointReferenceOfExit())
Model:
...
Returns the value of the '***State***' container reference.
 It is bidirectional and its opposite is '[`*Connection*`](State.html#getConnection())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getConnectionPointReference_State()`](../../metadata/UMLPackage.html#getConnectionPointReference_State())
[`State.getConnection()`](State.html#getConnection())
Model:
...
<h1 class="title" title="Interface ConnectionPointReference">Interface ConnectionPointReference</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ConnectionPointReference</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getConnectionPointReference()"><code>UMLPackage.getConnectionPointReference()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getEntry()">getEntry</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Entry</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Pseudostate</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExit()">getExit</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Exit</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="State.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">State</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasEntry()">hasEntry</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasExit()">hasExit</a>()</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getState()"><code><em>State</em></code></a>' container
 reference.</div>
</div>
</div>
</div>
...
<h3>getEntry</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Pseudostate</a>&gt;</span> <span class="element-name">getEntry</span>()</div>
<div class="block">Returns the value of the '<em><b>Entry</b></em>' reference list.
...
<pre><code>.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfEntry <em>connection Point Reference Of Entry</em></code></pre>
</details>
'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Entry</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getConnectionPointReference_Entry()"><code>UMLPackage.getConnectionPointReference_Entry()</code></a></li>
<li><a href="Pseudostate.html#get_connectionPointReferenceOfEntry()"><code>Pseudostate.get_connectionPointReferenceOfEntry()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_connectionPointReferenceOfEntry" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getExit</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">Pseudostate</a>&gt;</span> <span class="element-name">getExit</span>()</div>
<div class="block">Returns the value of the '<em><b>Exit</b></em>' reference list.
 The list contents are of type <a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>Pseudostate</code></a>.
 It is bidirectional and its opposite is '
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfExit <em>connection Point Reference Of Exit</em></code></pre>
</details>
'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Exit</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getConnectionPointReference_Exit()"><code>UMLPackage.getConnectionPointReference_Exit()</code></a></li>
<li><a href="Pseudostate.html#get_connectionPointReferenceOfExit()"><code>Pseudostate.get_connectionPointReferenceOfExit()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_connectionPointReferenceOfExit" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>State</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="State.html#getConnection()"><code><em>Connection</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The State in which the ConnectionPointReference is defined.
...
<li><a href="../../metadata/UMLPackage.html#getConnectionPointReference_State()"><code>UMLPackage.getConnectionPointReference_State()</code></a></li>
<li><a href="State.html#getConnection()"><code>State.getConnection()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="connection" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasEntry()">
<h3>hasEntry</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasEntry</span>()
...
<li>
<section class="detail" id="hasExit()">
<h3>hasExit</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasExit</span>()
         throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
