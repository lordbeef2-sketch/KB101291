# JAVA OPENAPI: QualifierValue (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/QualifierValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/QualifierValue.html`
- source_sha256: `cbe7985855c49f557718a380f549ac31a82a3fa914bdac8596709e376d34c909`
- captured_utc: `2026-07-14T16:46:23.721115+00:00`
...
public interfaceQualifierValueextends [Element](../../classes/mdkernel/Element.html)
...
[`*Value*`](#getValue())
[`*link End Data Of Qualifier*`](#get_linkEndDataOfQualifier())

See Also:
[`UMLPackage.getQualifierValue()`](../../metadata/UMLPackage.html#getQualifierValue())
Model:
...
`[get_linkEndDataOfQualifier](#get_linkEndDataOfQualifier())()`
...
`void`
`[set_linkEndDataOfQualifier](#set_linkEndDataOfQualifier(com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkEndData))([LinkEndData](../mdintermediateactions/LinkEndData.html) value)`
Sets the value of the
 '[`*link End Data Of Qualifier*`](#get_linkEndDataOfQualifier())' container
 reference.
`void`
`[setQualifier](#setQualifier(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))([Property](../../classes/mdkernel/Property.html) value)`
Sets the value of the '[`*Qualifier*`](#getQualifier())' reference.
`void`
...
Method Details
getQualifier
@CheckForNull[Property](../../classes/mdkernel/Property.html) getQualifier()
Returns the value of the '***Qualifier***' reference.
 It is bidirectional and its opposite is
 '[`*qualifier Value Of Qualifier*`](../../classes/mdkernel/Property.html#get_qualifierValueOfQualifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setQualifier(Property)`](#setQualifier(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))
[`UMLPackage.getQualifierValue_Qualifier()`](../../metadata/UMLPackage.html#getQualifierValue_Qualifier())
[`Property.get_qualifierValueOfQualifier()`](../../classes/mdkernel/Property.html#get_qualifierValueOfQualifier())
Model:
opposite="_qualifierValueOfQualifier" required="true" ordered="false"
Generated:
setQualifier
void setQualifier(@CheckForNull
...
Returns the value of the '***Value***' reference.
 It is bidirectional and its opposite is
 '[`*qualifier Value Of Value*`](../mdbasicactions/InputPin.html#get_qualifierValueOfValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getQualifierValue_Value()`](../../metadata/UMLPackage.html#getQualifierValue_Value())
[`InputPin.get_qualifierValueOfValue()`](../mdbasicactions/InputPin.html#get_qualifierValueOfValue())
Model:
...
@CheckForNull[LinkEndData](../mdintermediateactions/LinkEndData.html) get_linkEndDataOfQualifier()
Returns the value of the '***link End Data Of Qualifier***' container reference.
 It is bidirectional and its opposite is '[`*Qualifier*`](../mdintermediateactions/LinkEndData.html#getQualifier())'.
 begin-user-doc 
If the meaning of the '*link End Data Of Qualifier*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*link End Data Of Qualifier*' container reference.
See Also:
[`set_linkEndDataOfQualifier(LinkEndData)`](#set_linkEndDataOfQualifier(com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkEndData))
[`UMLPackage.getQualifierValue__linkEndDataOfQualifier()`](../../metadata/UMLPackage.html#getQualifierValue__linkEndDataOfQualifier())
[`LinkEndData.getQualifier()`](../mdintermediateactions/LinkEndData.html#getQualifier())
Model:
opposite="qualifier" required="true" transient="false" ordered="false"
Generated:
set_linkEndDataOfQualifier
void set_linkEndDataOfQualifier(@CheckForNull
...
Parameters:
`value` - the new value of the '*link End Data Of Qualifier*' container reference.
See Also:
[`get_linkEndDataOfQualifier()`](#get_linkEndDataOfQualifier())
Generated:
...
<h1 class="title" title="Interface QualifierValue">Interface QualifierValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">QualifierValue</span><span class="extends-implements">
...
<li><a href="#get_linkEndDataOfQualifier()"><code><em>link End Data Of Qualifier</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getQualifierValue()"><code>UMLPackage.getQualifierValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdintermediateactions/LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkEndData</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_linkEndDataOfQualifier()">get_linkEndDataOfQualifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>link End Data Of Qualifier</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getQualifier()">getQualifier</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Qualifier</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_linkEndDataOfQualifier(com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkEndData)">set_linkEndDataOfQualifier</a><wbr/>(<a href="../mdintermediateactions/LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkEndData</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#get_linkEndDataOfQualifier()"><code><em>link End Data Of Qualifier</em></code></a>' container
 reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setQualifier(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)">setQualifier</a><wbr/>(<a href="../../classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getQualifier()"><code><em>Qualifier</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
...
</span><span class="return-type"><a href="../../classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getQualifier</span>()</div>
<div class="block">Returns the value of the '<em><b>Qualifier</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Property.html#get_qualifierValueOfQualifier()"><code><em>qualifier Value Of Qualifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The qualifier Property for which the value is to be specified.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Qualifier</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setQualifier(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)"><code>setQualifier(Property)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getQualifierValue_Qualifier()"><code>UMLPackage.getQualifierValue_Qualifier()</code></a></li>
<li><a href="../../classes/mdkernel/Property.html#get_qualifierValueOfQualifier()"><code>Property.get_qualifierValueOfQualifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_qualifierValueOfQualifier" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setQualifier(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)">
<h3>setQualifier</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setQualifier</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getQualifier()"><code><em>Qualifier</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Qualifier</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_qualifierValueOfValue()"><code><em>qualifier Value Of Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin from which the specified value for the qualifier is taken.
...
<li><a href="../../metadata/UMLPackage.html#getQualifierValue_Value()"><code>UMLPackage.getQualifierValue_Value()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_qualifierValueOfValue()"><code>InputPin.get_qualifierValueOfValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_qualifierValueOfValue" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="get_linkEndDataOfQualifier()">
<h3>get_linkEndDataOfQualifier</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdintermediateactions/LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkEndData</a></span> <span class="element-name">get_linkEndDataOfQualifier</span>()</div>
<div class="block">Returns the value of the '<em><b>link End Data Of Qualifier</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="../mdintermediateactions/LinkEndData.html#getQualifier()"><code><em>Qualifier</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>link End Data Of Qualifier</em>' container reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>link End Data Of Qualifier</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#set_linkEndDataOfQualifier(com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkEndData)"><code>set_linkEndDataOfQualifier(LinkEndData)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getQualifierValue__linkEndDataOfQualifier()"><code>UMLPackage.getQualifierValue__linkEndDataOfQualifier()</code></a></li>
<li><a href="../mdintermediateactions/LinkEndData.html#getQualifier()"><code>LinkEndData.getQualifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="qualifier" required="true" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_linkEndDataOfQualifier(com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkEndData)">
<h3>set_linkEndDataOfQualifier</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_linkEndDataOfQualifier</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>link End Data Of Qualifier</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#get_linkEndDataOfQualifier()"><code>get_linkEndDataOfQualifier()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
