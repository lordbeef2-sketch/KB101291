# JAVA OPENAPI: DeployedArtifact (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/DeployedArtifact.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/DeployedArtifact.html`
- source_sha256: `ccfacbbba9452fe83d5d29aaf58499ee1ab48572d057ffccce8f08c3d33a91c8`
- captured_utc: `2026-07-14T16:46:32.161228+00:00`
...
`[Artifact](../mdartifacts/Artifact.html)`, `[DeploymentSpecification](../mdcomponentdeployments/DeploymentSpecification.html)`, `[EnumerationLiteral](../../classes/mdkernel/EnumerationLiteral.html)`, `[InstanceSpecification](../../classes/mdkernel/InstanceSpecification.html)`

public interfaceDeployedArtifactextends [NamedElement](../../classes/mdkernel/NamedElement.html)
...
The following features are supported:
 [`*deployment Of Deployed Artifact*`](#get_deploymentOfDeployedArtifact())

See Also:
[`UMLPackage.getDeployedArtifact()`](../../metadata/UMLPackage.html#getDeployedArtifact())
Model:
abstract="true"
...
`[get_deploymentOfDeployedArtifact](#get_deploymentOfDeployedArtifact())()`
Returns the value of the '***deployment Of Deployed Artifact***' reference list.
`boolean`
`[has_deploymentOfDeployedArtifact](#has_deploymentOfDeployedArtifact())()`
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Deployment](Deployment.html)> get_deploymentOfDeployedArtifact()
Returns the value of the '***deployment Of Deployed Artifact***' reference list.
 The list contents are of type [`Deployment`](Deployment.html).
 It is bidirectional and its opposite is '[`*Deployed Artifact*`](Deployment.html#getDeployedArtifact())'.
 begin-user-doc 
If the meaning of the '*deployment Of Deployed Artifact*' reference list isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*deployment Of Deployed Artifact*' reference list.
See Also:
[`UMLPackage.getDeployedArtifact__deploymentOfDeployedArtifact()`](../../metadata/UMLPackage.html#getDeployedArtifact__deploymentOfDeployedArtifact())
[`Deployment.getDeployedArtifact()`](Deployment.html#getDeployedArtifact())
Model:
opposite="deployedArtifact" ordered="false"
Generated:
has_deploymentOfDeployedArtifact
boolean has_deploymentOfDeployedArtifact()
...
<h1 class="title" title="Interface DeployedArtifact">Interface DeployedArtifact</h1>
</div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#get_deploymentOfDeployedArtifact()"><code><em>deployment Of Deployed Artifact</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getDeployedArtifact()"><code>UMLPackage.getDeployedArtifact()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_deploymentOfDeployedArtifact()">get_deploymentOfDeployedArtifact</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>deployment Of Deployed Artifact</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_deploymentOfDeployedArtifact()">has_deploymentOfDeployedArtifact</a>()</code></div>
...
<li>
<section class="detail" id="get_deploymentOfDeployedArtifact()">
<h3>get_deploymentOfDeployedArtifact</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a>&gt;</span> <span class="element-name">get_deploymentOfDeployedArtifact</span>()</div>
<div class="block">Returns the value of the '<em><b>deployment Of Deployed Artifact</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="Deployment.html#getDeployedArtifact()"><code><em>Deployed Artifact</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>deployment Of Deployed Artifact</em>' reference list isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>deployment Of Deployed Artifact</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDeployedArtifact__deploymentOfDeployedArtifact()"><code>UMLPackage.getDeployedArtifact__deploymentOfDeployedArtifact()</code></a></li>
<li><a href="Deployment.html#getDeployedArtifact()"><code>Deployment.getDeployedArtifact()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="deployedArtifact" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="has_deploymentOfDeployedArtifact()">
<h3>has_deploymentOfDeployedArtifact</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_deploymentOfDeployedArtifact</span>()
