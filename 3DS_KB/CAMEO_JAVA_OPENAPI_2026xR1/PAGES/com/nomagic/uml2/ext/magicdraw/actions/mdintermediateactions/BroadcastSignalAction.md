# JAVA OPENAPI: BroadcastSignalAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/BroadcastSignalAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/BroadcastSignalAction.html`
- source_sha256: `43b8bf5e6e995705d2f048be6b167883ef42d8855496815ba402fdc1e6055518`
- captured_utc: `2026-07-14T16:46:24.431127+00:00`
...
public interfaceBroadcastSignalActionextends [InvocationAction](../mdbasicactions/InvocationAction.html)

begin-user-doc 
 A representation of the model object '***Broadcast Signal Action***'.
 end-user-doc 
begin-model-doc 
 A BroadcastSignalAction is an InvocationAction that transmits a Signal instance to all the potential target objects in the system. Values from the argument
 InputPins are used to provide values for the attributes of the Signal. The requestor continues execution immediately after the Signal instances are sent out and
...
See Also:
[`UMLPackage.getBroadcastSignalAction()`](../../metadata/UMLPackage.html#getBroadcastSignalAction())
Model:
...
Returns the value of the '***Signal***' reference.
 It is bidirectional and its opposite is '[`*broadcast Signal Action Of Signal*`](../../commonbehaviors/mdcommunications/Signal.html#get_broadcastSignalActionOfSignal())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getBroadcastSignalAction_Signal()`](../../metadata/UMLPackage.html#getBroadcastSignalAction_Signal())
[`Signal.get_broadcastSignalActionOfSignal()`](../../commonbehaviors/mdcommunications/Signal.html#get_broadcastSignalActionOfSignal())
Model:
opposite="_broadcastSignalActionOfSignal" required="true" ordered="false"
Generated:
setSignal
...
<h1 class="title" title="Interface BroadcastSignalAction">Interface BroadcastSignalAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">BroadcastSignalAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getBroadcastSignalAction()"><code>UMLPackage.getBroadcastSignalAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Signal</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../commonbehaviors/mdcommunications/Signal.html#get_broadcastSignalActionOfSignal()"><code><em>broadcast Signal Action Of Signal</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Signal whose instances are to be sent.
...
<li><a href="../../metadata/UMLPackage.html#getBroadcastSignalAction_Signal()"><code>UMLPackage.getBroadcastSignalAction_Signal()</code></a></li>
<li><a href="../../commonbehaviors/mdcommunications/Signal.html#get_broadcastSignalActionOfSignal()"><code>Signal.get_broadcastSignalActionOfSignal()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_broadcastSignalActionOfSignal" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
