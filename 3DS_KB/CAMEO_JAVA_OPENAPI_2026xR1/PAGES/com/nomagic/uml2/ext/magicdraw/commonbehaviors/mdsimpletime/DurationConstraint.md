# JAVA OPENAPI: DurationConstraint (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationConstraint.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationConstraint.html`
- source_sha256: `9364df1bbc1a9068ef7976ef645f27b0d3934fc6dec8983a1e392e3f8888332d`
- captured_utc: `2026-07-14T16:46:31.283216+00:00`
...
See Also:
[`UMLPackage.getDurationConstraint()`](../../metadata/UMLPackage.html#getDurationConstraint())
Model:
...
Method
Description
`[DurationInterval](DurationInterval.html)`
...
`void`
`[setSpecification](#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationInterval))([DurationInterval](DurationInterval.html) value)`
Sets the value of the '[`*Specification*`](#getSpecification())'
...
Returns the value of the '***First Event***' attribute list.
 ...
 begin-model-doc 
 The value of firstEvent[i] is related to constrainedElement[i] (where i is 1 or 2). If firstEvent[i] is true, then the corresponding observation event is the
 first time instant the execution enters constrainedElement[i]. If firstEvent[i] is false, then the corresponding observation event is the last time instant the
 execution is within constrainedElement[i].
 end-model-doc
Returns:
the value of the '*First Event*' attribute list.
See Also:
[`UMLPackage.getDurationConstraint_FirstEvent()`](../../metadata/UMLPackage.html#getDurationConstraint_FirstEvent())
Model:
dataType="com.nomagic.uml2.ext.magicdraw.Boolean" upper="2" ordered="true"
Generated:
getSpecification
@CheckForNull[DurationInterval](DurationInterval.html) getSpecification()
Returns the value of the '***Specification***' containment reference.
 It is bidirectional and its opposite is '[`.DurationInterval#get_durationConstraintOfSpecification *duration Constraint Of Specification*`](package-summary.html)'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setSpecification(DurationInterval)`](#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationInterval))
[`UMLPackage.getDurationConstraint_Specification()`](../../metadata/UMLPackage.html#getDurationConstraint_Specification())
[`DurationInterval.get_durationConstraintOfSpecification()`](DurationInterval.html#get_durationConstraintOfSpecification())
Model:
opposite="_durationConstraintOfSpecification" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setSpecification
void setSpecification(@CheckForNull
 [DurationInterval](DurationInterval.html) value)
Sets the value of the '[`*Specification*`](#getSpecification())'
 containment reference.
 begin-user-doc 
 end-user-doc
...
<h1 class="title" title="Interface DurationConstraint">Interface DurationConstraint</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DurationConstraint</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getDurationConstraint()"><code>UMLPackage.getDurationConstraint()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasFirstEvent()">hasFirstEvent</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isFirstEvent()">isFirstEvent</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>First Event</b></em>' attribute list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationInterval)">setSpecification</a><wbr/>(<a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getSpecification()"><code><em>Specification</em></code></a>'
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDurationConstraint_FirstEvent()"><code>UMLPackage.getDurationConstraint_FirstEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
</span><span class="return-type"><a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a></span> <span class="element-name">getSpecification</span>()</div>
<div class="block">Returns the value of the '<em><b>Specification</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="package-summary.html"><code>.DurationInterval#get_durationConstraintOfSpecification <em>duration Constraint Of Specification</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The DurationInterval constraining the duration.
...
<dd>
<ul class="tag-list-long">
<li><a href="#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationInterval)"><code>setSpecification(DurationInterval)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDurationConstraint_Specification()"><code>UMLPackage.getDurationConstraint_Specification()</code></a></li>
<li><a href="DurationInterval.html#get_durationConstraintOfSpecification()"><code>DurationInterval.get_durationConstraintOfSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationConstraintOfSpecification" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationInterval)">
...
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSpecification</span><wbr/><span class="parameters">(@CheckForNull
 <a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getSpecification()"><code><em>Specification</em></code></a>'
 containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
