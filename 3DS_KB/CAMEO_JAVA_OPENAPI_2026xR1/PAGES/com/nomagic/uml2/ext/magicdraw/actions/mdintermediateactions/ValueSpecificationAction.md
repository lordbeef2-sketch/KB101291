# JAVA OPENAPI: ValueSpecificationAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ValueSpecificationAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ValueSpecificationAction.html`
- source_sha256: `bc5f85a25659e69234f352336b800ac6ef5d8053f7deb1946307fca7ad1c24e0`
- captured_utc: `2026-07-14T16:46:25.790146+00:00`
...
public interfaceValueSpecificationActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getValueSpecificationAction()`](../../metadata/UMLPackage.html#getValueSpecificationAction())
Model:
...
Sets the value of the '[`*Result*`](#getResult())' containment
 reference.
`void`
`[setValue](#setValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
...
Method Details
getValue
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getValue()
Returns the value of the '***Value***' containment reference.
 It is bidirectional and its opposite is '[`*value
 Specification Action Of Value*`](../../classes/mdkernel/ValueSpecification.html#get_valueSpecificationActionOfValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setValue(ValueSpecification)`](#setValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getValueSpecificationAction_Value()`](../../metadata/UMLPackage.html#getValueSpecificationAction_Value())
[`ValueSpecification.get_valueSpecificationActionOfValue()`](../../classes/mdkernel/ValueSpecification.html#get_valueSpecificationActionOfValue())
Model:
opposite="_valueSpecificationActionOfValue" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setValue
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is '[`*value
 Specification Action Of Result*`](../mdbasicactions/OutputPin.html#get_valueSpecificationActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getValueSpecificationAction_Result()`](../../metadata/UMLPackage.html#getValueSpecificationAction_Result())
[`OutputPin.get_valueSpecificationActionOfResult()`](../mdbasicactions/OutputPin.html#get_valueSpecificationActionOfResult())
Model:
opposite="_valueSpecificationActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
<h1 class="title" title="Interface ValueSpecificationAction">Interface ValueSpecificationAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ValueSpecificationAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getValueSpecificationAction()"><code>UMLPackage.getValueSpecificationAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getValue</span>()</div>
<div class="block">Returns the value of the '<em><b>Value</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/ValueSpecification.html#get_valueSpecificationActionOfValue()"><code><em>value
 Specification Action Of Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The ValueSpecification to be evaluated.
...
<dd>
<ul class="tag-list-long">
<li><a href="#setValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setValue(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getValueSpecificationAction_Value()"><code>UMLPackage.getValueSpecificationAction_Value()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_valueSpecificationActionOfValue()"><code>ValueSpecification.get_valueSpecificationActionOfValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_valueSpecificationActionOfValue" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setValue(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setValue</h3>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/OutputPin.html#get_valueSpecificationActionOfResult()"><code><em>value
 Specification Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the result value is placed.
...
<li><a href="../../metadata/UMLPackage.html#getValueSpecificationAction_Result()"><code>UMLPackage.getValueSpecificationAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_valueSpecificationActionOfResult()"><code>OutputPin.get_valueSpecificationActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_valueSpecificationActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
