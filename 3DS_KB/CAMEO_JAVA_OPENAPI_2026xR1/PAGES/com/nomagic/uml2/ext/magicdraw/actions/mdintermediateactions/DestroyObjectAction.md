# JAVA OPENAPI: DestroyObjectAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/DestroyObjectAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/DestroyObjectAction.html`
- source_sha256: `8c8031bdb356e68dc3a6dbd99a90c8847251be65ab7911d0c1419eb19f03c754`
- captured_utc: `2026-07-14T16:46:24.658129+00:00`
...
public interfaceDestroyObjectActionextends [Action](../mdbasicactions/Action.html)
...
The following features are supported:
 [`*Destroy Links*`](#isDestroyLinks())
[`*Destroy Owned Objects*`](#isDestroyOwnedObjects())
[`*Target*`](#getTarget())

See Also:
[`UMLPackage.getDestroyObjectAction()`](../../metadata/UMLPackage.html#getDestroyObjectAction())
Model:
...
`void`
`[setDestroyLinks](#setDestroyLinks(boolean))(boolean value)`
Sets the value of the '[`*Destroy Links*`](#isDestroyLinks())' attribute.
`void`
`[setDestroyOwnedObjects](#setDestroyOwnedObjects(boolean))(boolean value)`
Sets the value of the
 '[`*Destroy Owned Objects*`](#isDestroyOwnedObjects())' attribute.
`void`
...
See Also:
[`setDestroyLinks(boolean)`](#setDestroyLinks(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getDestroyObjectAction_DestroyLinks()`
Model:
...
See Also:
[`setDestroyOwnedObjects(boolean)`](#setDestroyOwnedObjects(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getDestroyObjectAction_DestroyOwnedObjects()`
Model:
default="false" dataType="com.nomagic.uml2.ext.magicdraw.Boolean" required="true" ordered="false"
Generated:
...
Returns the value of the '***Target***' containment reference.
 ...
 '[`*destroy Object Action Of Target*`](../mdbasicactions/InputPin.html#get_destroyObjectActionOfTarget())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getDestroyObjectAction_Target()`](../../metadata/UMLPackage.html#getDestroyObjectAction_Target())
[`InputPin.get_destroyObjectActionOfTarget()`](../mdbasicactions/InputPin.html#get_destroyObjectActionOfTarget())
Model:
...
<h1 class="title" title="Interface DestroyObjectAction">Interface DestroyObjectAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DestroyObjectAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isDestroyLinks()"><code><em>Destroy Links</em></code></a></li>
<li><a href="#isDestroyOwnedObjects()"><code><em>Destroy Owned Objects</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getDestroyObjectAction()"><code>UMLPackage.getDestroyObjectAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isDestroyLinks()">isDestroyLinks</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Destroy Links</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isDestroyOwnedObjects()">isDestroyOwnedObjects</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Destroy Owned Objects</b></em>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDestroyLinks(boolean)">setDestroyLinks</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isDestroyLinks()"><code><em>Destroy Links</em></code></a>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDestroyOwnedObjects(boolean)">setDestroyOwnedObjects</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#isDestroyOwnedObjects()"><code><em>Destroy Owned Objects</em></code></a>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
...
<li>
<section class="detail" id="isDestroyLinks()">
<h3>isDestroyLinks</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isDestroyLinks</span>()</div>
<div class="block">Returns the value of the '<em><b>Destroy Links</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Destroy Links</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDestroyLinks(boolean)"><code>setDestroyLinks(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getDestroyObjectAction_DestroyLinks()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setDestroyLinks(boolean)">
<h3>setDestroyLinks</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDestroyLinks</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isDestroyLinks()"><code><em>Destroy Links</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Destroy Links</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isDestroyLinks()"><code>isDestroyLinks()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="isDestroyOwnedObjects()">
<h3>isDestroyOwnedObjects</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isDestroyOwnedObjects</span>()</div>
<div class="block">Returns the value of the '<em><b>Destroy Owned Objects</b></em>' attribute.
 The default value is <code>"false"</code>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Destroy Owned Objects</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDestroyOwnedObjects(boolean)"><code>setDestroyOwnedObjects(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getDestroyObjectAction_DestroyOwnedObjects()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setDestroyOwnedObjects(boolean)">
<h3>setDestroyOwnedObjects</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDestroyOwnedObjects</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the
 '<a href="#isDestroyOwnedObjects()"><code><em>Destroy Owned Objects</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Destroy Owned Objects</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isDestroyOwnedObjects()"><code>isDestroyOwnedObjects()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Target</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_destroyObjectActionOfTarget()"><code><em>destroy Object Action Of Target</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin providing the object to be destroyed.
...
<li><a href="../../metadata/UMLPackage.html#getDestroyObjectAction_Target()"><code>UMLPackage.getDestroyObjectAction_Target()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_destroyObjectActionOfTarget()"><code>InputPin.get_destroyObjectActionOfTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_destroyObjectActionOfTarget" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
