# JAVA OPENAPI: ReduceAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReduceAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReduceAction.html`
- source_sha256: `13dc908169534481b6a37f1052269901c8dc1bc5dd85ee7352c638b32d2f328f`
- captured_utc: `2026-07-14T16:46:24.193122+00:00`
...
public interfaceReduceActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getReduceAction()`](../../metadata/UMLPackage.html#getReduceAction())
Model:
...
`void`
`[setCollection](#setCollection(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*Collection*`](#getCollection())' containment reference.
`void`
`[setOrdered](#setOrdered(boolean))(boolean value)`
Sets the value of the '[`*Ordered*`](#isOrdered())' attribute.
`void`
`[setReducer](#setReducer(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))([Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) value)`
Sets the value of the '[`*Reducer*`](#getReducer())' reference.
`void`
...
Method Details
getReducer
@CheckForNull[Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) getReducer()
Returns the value of the '***Reducer***' reference.
 It is bidirectional and its opposite is
 '[`*reduce Action Of Reducer*`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_reduceActionOfReducer())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setReducer(Behavior)`](#setReducer(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))
[`UMLPackage.getReduceAction_Reducer()`](../../metadata/UMLPackage.html#getReduceAction_Reducer())
[`Behavior.get_reduceActionOfReducer()`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_reduceActionOfReducer())
Model:
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is
 '[`*reduce Action Of Result*`](../mdbasicactions/OutputPin.html#get_reduceActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReduceAction_Result()`](../../metadata/UMLPackage.html#getReduceAction_Result())
[`OutputPin.get_reduceActionOfResult()`](../mdbasicactions/OutputPin.html#get_reduceActionOfResult())
Model:
...
Generated:
getCollection
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getCollection()
Returns the value of the '***Collection***' containment reference.
 It is bidirectional and its opposite is
 '[`*reduce Action Of Collection*`](../mdbasicactions/InputPin.html#get_reduceActionOfCollection())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setCollection(InputPin)`](#setCollection(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getReduceAction_Collection()`](../../metadata/UMLPackage.html#getReduceAction_Collection())
[`InputPin.get_reduceActionOfCollection()`](../mdbasicactions/InputPin.html#get_reduceActionOfCollection())
Model:
...
<h1 class="title" title="Interface ReduceAction">Interface ReduceAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReduceAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getCollection()"><code><em>Collection</em></code></a></li>
<li><a href="#isOrdered()"><code><em>Ordered</em></code></a></li>
<li><a href="#getReducer()"><code><em>Reducer</em></code></a></li>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getReduceAction()"><code>UMLPackage.getReduceAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getCollection()">getCollection</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Collection</b></em>' containment reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReducer()">getReducer</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Reducer</b></em>' reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setCollection(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setCollection</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getCollection()"><code><em>Collection</em></code></a>' containment reference.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setReducer(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setReducer</a><wbr/>(<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getReducer()"><code><em>Reducer</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
...
<li>
<section class="detail" id="getReducer()">
<h3>getReducer</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></span> <span class="element-name">getReducer</span>()</div>
<div class="block">Returns the value of the '<em><b>Reducer</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_reduceActionOfReducer()"><code><em>reduce Action Of Reducer</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A Behavior that is repreatedly applied to two elements of the input collection to produce a value that is of the same type as elements of the collection.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Reducer</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setReducer(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)"><code>setReducer(Behavior)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getReduceAction_Reducer()"><code>UMLPackage.getReduceAction_Reducer()</code></a></li>
<li><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_reduceActionOfReducer()"><code>Behavior.get_reduceActionOfReducer()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reduceActionOfReducer" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setReducer(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">
<h3>setReducer</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setReducer</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getReducer()"><code><em>Reducer</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Reducer</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getReducer()"><code>getReducer()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_reduceActionOfResult()"><code><em>reduce Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The output pin on which the result value is placed.
...
<li><a href="../../metadata/UMLPackage.html#getReduceAction_Result()"><code>UMLPackage.getReduceAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_reduceActionOfResult()"><code>OutputPin.get_reduceActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reduceActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getCollection</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getCollection</span>()</div>
<div class="block">Returns the value of the '<em><b>Collection</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_reduceActionOfCollection()"><code><em>reduce Action Of Collection</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that provides the collection to be reduced.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Collection</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setCollection(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setCollection(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getReduceAction_Collection()"><code>UMLPackage.getReduceAction_Collection()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_reduceActionOfCollection()"><code>InputPin.get_reduceActionOfCollection()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_reduceActionOfCollection" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setCollection(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setCollection</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setCollection</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getCollection()"><code><em>Collection</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Collection</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getCollection()"><code>getCollection()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getReduceAction_Ordered()</code></pre>
</details>
</li>
</ul>
</dd>
