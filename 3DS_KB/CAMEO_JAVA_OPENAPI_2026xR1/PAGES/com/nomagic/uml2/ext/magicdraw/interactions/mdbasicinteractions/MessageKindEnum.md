# JAVA OPENAPI: MessageKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/MessageKindEnum.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/MessageKindEnum.html`
- source_sha256: `7931d6d78d7b27246aaa1bde32581ee4f6e806af677a7f1d73d7ca17c23dae12`
- captured_utc: `2026-07-14T16:46:32.763236+00:00`
...
`[MessageKind](MessageKind.html)`, `[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `javax.jmi.reflect.RefEnum`, `org.eclipse.emf.common.util.Enumerator`
...
get
public static [MessageKindEnum](MessageKindEnum.html) get([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) literal)
Returns the '***Message Kind***' literal with the specified literal value.
 begin-user-doc 
 end-user-doc
Generated:
getByName
public static [MessageKindEnum](MessageKindEnum.html) getByName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the '***Message Kind***' literal with the specified name.
 begin-user-doc 
 end-user-doc
Generated:
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getMessageKindEnum()</code></pre>
</details>
</li>
