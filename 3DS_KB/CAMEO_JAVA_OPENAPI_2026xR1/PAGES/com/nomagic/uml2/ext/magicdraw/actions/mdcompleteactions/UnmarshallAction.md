# JAVA OPENAPI: UnmarshallAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/UnmarshallAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/UnmarshallAction.html`
- source_sha256: `506d2344fc15e2d879eb591d9a4db76190ccb09bc5ab02c6e5e5d54ee8775036`
- captured_utc: `2026-07-14T16:46:24.313123+00:00`
...
public interfaceUnmarshallActionextends [Action](../mdbasicactions/Action.html)
...
The following features are supported:
 [`*Object*`](#getObject())
[`*Unmarshall Type*`](#getUnmarshallType())
[`*Result*`](#getResult())

See Also:
[`UMLPackage.getUnmarshallAction()`](../../metadata/UMLPackage.html#getUnmarshallAction())
Model:
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../mdbasicactions/OutputPin.html)>`
`[getResult](#getResult())()`
Returns the value of the '***Result***' containment reference list.
`[Classifier](../../classes/mdkernel/Classifier.html)`
`[getUnmarshallType](#getUnmarshallType())()`
...
Sets the value of the '[`*Object*`](#getObject())' containment reference.
`void`
`[setUnmarshallType](#setUnmarshallType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier))([Classifier](../../classes/mdkernel/Classifier.html) value)`
Sets the value of the '[`*Unmarshall Type*`](#getUnmarshallType())' reference.
...
Method Details
getResult
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../mdbasicactions/OutputPin.html)> getResult()
Returns the value of the '***Result***' containment reference list.
 The list contents are of type [`OutputPin`](../mdbasicactions/OutputPin.html).
 It is bidirectional and its opposite is
 '[`*unmarshall Action Of Result*`](../mdbasicactions/OutputPin.html#get_unmarshallActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getUnmarshallAction_Result()`](../../metadata/UMLPackage.html#getUnmarshallAction_Result())
[`OutputPin.get_unmarshallActionOfResult()`](../mdbasicactions/OutputPin.html#get_unmarshallActionOfResult())
Model:
opposite="_unmarshallActionOfResult" containment="true" resolveProxies="true" required="true"
Generated:
getUnmarshallType
@CheckForNull[Classifier](../../classes/mdkernel/Classifier.html) getUnmarshallType()
Returns the value of the '***Unmarshall Type***' reference.
 It is bidirectional and its opposite is
 '[`*unmarshall Action Of Unmarshall Type*`](../../classes/mdkernel/Classifier.html#get_unmarshallActionOfUnmarshallType())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Returns:
the value of the '*Unmarshall Type*' reference.
See Also:
[`setUnmarshallType(Classifier)`](#setUnmarshallType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier))
[`UMLPackage.getUnmarshallAction_UnmarshallType()`](../../metadata/UMLPackage.html#getUnmarshallAction_UnmarshallType())
[`Classifier.get_unmarshallActionOfUnmarshallType()`](../../classes/mdkernel/Classifier.html#get_unmarshallActionOfUnmarshallType())
Model:
opposite="_unmarshallActionOfUnmarshallType" required="true" ordered="false"
Generated:
setUnmarshallType
void setUnmarshallType(@CheckForNull
 [Classifier](../../classes/mdkernel/Classifier.html) value)
Sets the value of the '[`*Unmarshall Type*`](#getUnmarshallType())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*Unmarshall Type*' reference.
See Also:
[`getUnmarshallType()`](#getUnmarshallType())
Generated:
getObject
...
Returns the value of the '***Object***' containment reference.
 It is bidirectional and its opposite is
 '[`*unmarshall Action Of Object*`](../mdbasicactions/InputPin.html#get_unmarshallActionOfObject())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getUnmarshallAction_Object()`](../../metadata/UMLPackage.html#getUnmarshallAction_Object())
[`InputPin.get_unmarshallActionOfObject()`](../mdbasicactions/InputPin.html#get_unmarshallActionOfObject())
Model:
opposite="_unmarshallActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setObject
...
<h1 class="title" title="Interface UnmarshallAction">Interface UnmarshallAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">UnmarshallAction</span><span class="extends-implements">
...
<li><a href="#getUnmarshallType()"><code><em>Unmarshall Type</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getUnmarshallAction()"><code>UMLPackage.getUnmarshallAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getObject()">getObject</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a>&gt;</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getUnmarshallType()">getUnmarshallType</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Unmarshall Type</b></em>' reference.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setObject(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setObject</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getObject()"><code><em>Object</em></code></a>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setUnmarshallType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier)">setUnmarshallType</a><wbr/>(<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getUnmarshallType()"><code><em>Unmarshall Type</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<h3>getResult</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a>&gt;</span> <span class="element-name">getResult</span>()</div>
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference list.
 The list contents are of type <a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions"><code>OutputPin</code></a>.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_unmarshallActionOfResult()"><code><em>unmarshall Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPins on which are placed the values of the StructuralFeatures of the input object.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getUnmarshallAction_Result()"><code>UMLPackage.getUnmarshallAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_unmarshallActionOfResult()"><code>OutputPin.get_unmarshallActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_unmarshallActionOfResult" containment="true" resolveProxies="true" required="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getUnmarshallType()">
<h3>getUnmarshallType</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a></span> <span class="element-name">getUnmarshallType</span>()</div>
<div class="block">Returns the value of the '<em><b>Unmarshall Type</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Classifier.html#get_unmarshallActionOfUnmarshallType()"><code><em>unmarshall Action Of Unmarshall Type</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The type of the object to be unmarshalled.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Unmarshall Type</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setUnmarshallType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier)"><code>setUnmarshallType(Classifier)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getUnmarshallAction_UnmarshallType()"><code>UMLPackage.getUnmarshallAction_UnmarshallType()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_unmarshallActionOfUnmarshallType()"><code>Classifier.get_unmarshallActionOfUnmarshallType()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_unmarshallActionOfUnmarshallType" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setUnmarshallType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier)">
<h3>setUnmarshallType</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setUnmarshallType</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getUnmarshallType()"><code><em>Unmarshall Type</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Unmarshall Type</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getUnmarshallType()"><code>getUnmarshallType()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_unmarshallActionOfObject()"><code><em>unmarshall Action Of Object</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that gives the object to be unmarshalled.
...
<li><a href="../../metadata/UMLPackage.html#getUnmarshallAction_Object()"><code>UMLPackage.getUnmarshallAction_Object()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_unmarshallActionOfObject()"><code>InputPin.get_unmarshallActionOfObject()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_unmarshallActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Sets the value of the '<a href="#getObject()"><code><em>Object</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
