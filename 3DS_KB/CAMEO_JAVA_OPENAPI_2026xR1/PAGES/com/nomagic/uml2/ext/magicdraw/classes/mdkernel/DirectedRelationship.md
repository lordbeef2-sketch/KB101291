# JAVA OPENAPI: DirectedRelationship (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/DirectedRelationship.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/DirectedRelationship.html`
- source_sha256: `22153d1f8faea1f3900909f5434f90bc0d2060a4f10b60d90b34e2088b472ee6`
- captured_utc: `2026-07-14T16:46:28.536180+00:00`
...
See Also:
[`UMLPackage.getDirectedRelationship()`](../../metadata/UMLPackage.html#getDirectedRelationship())
Model:
abstract="true"
...
Method Details
getSource
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Element](Element.html)> getSource()
Returns the value of the '***Source***' reference list.
 The list contents are of type [`Element`](Element.html).
 It is bidirectional and its opposite is
 '[`*directed Relationship Of Source*`](Element.html#get_directedRelationshipOfSource())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDirectedRelationship_Source()`](../../metadata/UMLPackage.html#getDirectedRelationship_Source())
[`Element.get_directedRelationshipOfSource()`](Element.html#get_directedRelationshipOfSource())
Model:
opposite="_directedRelationshipOfSource" required="true" transient="true" volatile="true" derived="true" ordered="false"
Generated:
getTarget
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Element](Element.html)> getTarget()
Returns the value of the '***Target***' reference list.
 The list contents are of type [`Element`](Element.html).
 It is bidirectional and its opposite is
 '[`*directed Relationship Of Target*`](Element.html#get_directedRelationshipOfTarget())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDirectedRelationship_Target()`](../../metadata/UMLPackage.html#getDirectedRelationship_Target())
[`Element.get_directedRelationshipOfTarget()`](Element.html#get_directedRelationshipOfTarget())
Model:
opposite="_directedRelationshipOfTarget" required="true" transient="true" volatile="true" derived="true" ordered="false"
Generated:
hasSource
boolean hasSource()
...
<h1 class="title" title="Interface DirectedRelationship">Interface DirectedRelationship</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DirectedRelationship</span><span class="extends-implements">
extends <a href="Relationship.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Relationship</a></span></div>
...
<li><a href="../../metadata/UMLPackage.html#getDirectedRelationship()"><code>UMLPackage.getDirectedRelationship()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="block">Returns the value of the '<em><b>Source</b></em>' reference list.</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Target</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasSource()">hasSource</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasTarget()">hasTarget</a>()</code></div>
...
<h3>getSource</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt;</span> <span class="element-name">getSource</span>()</div>
<div class="block">Returns the value of the '<em><b>Source</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Element.html#get_directedRelationshipOfSource()"><code><em>directed Relationship Of Source</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the source Element(s) of the DirectedRelationship.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Source</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDirectedRelationship_Source()"><code>UMLPackage.getDirectedRelationship_Source()</code></a></li>
<li><a href="Element.html#get_directedRelationshipOfSource()"><code>Element.get_directedRelationshipOfSource()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_directedRelationshipOfSource" required="true" transient="true" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getTarget</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt;</span> <span class="element-name">getTarget</span>()</div>
<div class="block">Returns the value of the '<em><b>Target</b></em>' reference list.
 The list contents are of type <a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel"><code>Element</code></a>.
 It is bidirectional and its opposite is
 '<a href="Element.html#get_directedRelationshipOfTarget()"><code><em>directed Relationship Of Target</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the target Element(s) of the DirectedRelationship.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Target</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDirectedRelationship_Target()"><code>UMLPackage.getDirectedRelationship_Target()</code></a></li>
<li><a href="Element.html#get_directedRelationshipOfTarget()"><code>Element.get_directedRelationshipOfTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_directedRelationshipOfTarget" required="true" transient="true" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>hasSource</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasSource</span>()
...
<li>
<section class="detail" id="hasTarget()">
<h3>hasTarget</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasTarget</span>()
           throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
