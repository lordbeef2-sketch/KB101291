# JAVA OPENAPI: WriteVariableAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/WriteVariableAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/WriteVariableAction.html`
- source_sha256: `8c0b495f2ed5defb7b19be76b2e451fb92ed4c92b6f4e97d923ea81bf81c42fe`
- captured_utc: `2026-07-14T16:46:25.857145+00:00`
...
See Also:
[`UMLPackage.getWriteVariableAction()`](../../metadata/UMLPackage.html#getWriteVariableAction())
Model:
abstract="true"
...
Sets the value of the '[`*Value*`](#getValue())' containment reference.
...
Returns the value of the '***Value***' containment reference.
 ...
 '[`*write Variable Action Of Value*`](../mdbasicactions/InputPin.html#get_writeVariableActionOfValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getWriteVariableAction_Value()`](../../metadata/UMLPackage.html#getWriteVariableAction_Value())
[`InputPin.get_writeVariableActionOfValue()`](../mdbasicactions/InputPin.html#get_writeVariableActionOfValue())
Model:
opposite="_writeVariableActionOfValue" containment="true" resolveProxies="true" ordered="false"
Generated:
setValue
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">WriteVariableAction</span><span class="extends-implements">
extends <a href="VariableAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions">VariableAction</a></span></div>
...
<li><a href="../../metadata/UMLPackage.html#getWriteVariableAction()"><code>UMLPackage.getWriteVariableAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="block">Sets the value of the '<a href="#getValue()"><code><em>Value</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_writeVariableActionOfValue()"><code><em>write Variable Action Of Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that gives the value to be added or removed from the Variable.
...
<li><a href="../../metadata/UMLPackage.html#getWriteVariableAction_Value()"><code>UMLPackage.getWriteVariableAction_Value()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_writeVariableActionOfValue()"><code>InputPin.get_writeVariableActionOfValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_writeVariableActionOfValue" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Sets the value of the '<a href="#getValue()"><code><em>Value</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
