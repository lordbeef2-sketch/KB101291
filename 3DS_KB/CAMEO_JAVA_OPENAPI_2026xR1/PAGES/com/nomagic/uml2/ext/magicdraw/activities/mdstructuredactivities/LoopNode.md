# JAVA OPENAPI: LoopNode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdstructuredactivities/LoopNode.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdstructuredactivities/LoopNode.html`
- source_sha256: `28d696323ffd07e63412194adb773c169c7928ae2b7c08816985a6ba1350fd0e`
- captured_utc: `2026-07-14T16:46:27.238162+00:00`
...
[`*Decider*`](#getDecider())
[`*Tested First*`](#isTestedFirst())
[`*Loop Variable Input*`](#getLoopVariableInput())
[`*Result*`](#getResult())
[`*Setup Part*`](#getSetupPart())
[`*Test*`](#getTest())
[`*Loop Variable*`](#getLoopVariable())

See Also:
[`UMLPackage.getLoopNode()`](../../metadata/UMLPackage.html#getLoopNode())
Model:
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../../actions/mdbasicactions/OutputPin.html)>`
`[getBodyOutput](#getBodyOutput())()`
Returns the value of the '***Body Output***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutableNode](ExecutableNode.html)>`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../../actions/mdbasicactions/OutputPin.html)>`
`[getLoopVariable](#getLoopVariable())()`
Returns the value of the '***Loop Variable***' containment reference list.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[InputPin](../../actions/mdbasicactions/InputPin.html)>`
`[getLoopVariableInput](#getLoopVariableInput())()`
...
`boolean`
`[hasLoopVariable](#hasLoopVariable())()`

`boolean`
`[hasLoopVariableInput](#hasLoopVariableInput())()`

`boolean`
`[hasResult](#hasResult())()`

`boolean`
`[hasSetupPart](#hasSetupPart())()`
...
`void`
`[setTestedFirst](#setTestedFirst(boolean))(boolean value)`
Sets the value of the '[`*Tested First*`](#isTestedFirst())' attribute.
...
Method Details
getBodyPart
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutableNode](ExecutableNode.html)> getBodyPart()
Returns the value of the '***Body Part***' reference list.
 The list contents are of type [`ExecutableNode`](ExecutableNode.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Body Part*`](ExecutableNode.html#get_loopNodeOfBodyPart())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_BodyPart()`](../../metadata/UMLPackage.html#getLoopNode_BodyPart())
[`ExecutableNode.get_loopNodeOfBodyPart()`](ExecutableNode.html#get_loopNodeOfBodyPart())
Model:
...
Returns the value of the '***Decider***' reference.
 It is bidirectional and its opposite is
 '[`*loop Node Of Decider*`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfDecider())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getLoopNode_Decider()`](../../metadata/UMLPackage.html#getLoopNode_Decider())
[`OutputPin.get_loopNodeOfDecider()`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfDecider())
Model:
...
See Also:
[`setTestedFirst(boolean)`](#setTestedFirst(boolean))
invalid reference
...
Generated:
getResult
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../../actions/mdbasicactions/OutputPin.html)> getResult()
Returns the value of the '***Result***' containment reference list.
 The list contents are of type [`OutputPin`](../../actions/mdbasicactions/OutputPin.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Result*`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_Result()`](../../metadata/UMLPackage.html#getLoopNode_Result())
[`OutputPin.get_loopNodeOfResult()`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfResult())
Model:
opposite="_loopNodeOfResult" containment="true" resolveProxies="true"
Generated:
getLoopVariable
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../../actions/mdbasicactions/OutputPin.html)> getLoopVariable()
Returns the value of the '***Loop Variable***' containment reference list.
 The list contents are of type [`OutputPin`](../../actions/mdbasicactions/OutputPin.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Loop Variable*`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfLoopVariable())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_LoopVariable()`](../../metadata/UMLPackage.html#getLoopNode_LoopVariable())
[`OutputPin.get_loopNodeOfLoopVariable()`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfLoopVariable())
Model:
opposite="_loopNodeOfLoopVariable" containment="true" resolveProxies="true"
Generated:
getBodyOutput
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](../../actions/mdbasicactions/OutputPin.html)> getBodyOutput()
Returns the value of the '***Body Output***' reference list.
 The list contents are of type [`OutputPin`](../../actions/mdbasicactions/OutputPin.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Body Output*`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfBodyOutput())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_BodyOutput()`](../../metadata/UMLPackage.html#getLoopNode_BodyOutput())
[`OutputPin.get_loopNodeOfBodyOutput()`](../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfBodyOutput())
Model:
opposite="_loopNodeOfBodyOutput"
Generated:
getTest
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutableNode](ExecutableNode.html)> getTest()
Returns the value of the '***Test***' reference list.
 The list contents are of type [`ExecutableNode`](ExecutableNode.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Test*`](ExecutableNode.html#get_loopNodeOfTest())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_Test()`](../../metadata/UMLPackage.html#getLoopNode_Test())
[`ExecutableNode.get_loopNodeOfTest()`](ExecutableNode.html#get_loopNodeOfTest())
Model:
opposite="_loopNodeOfTest" required="true" ordered="false"
Generated:
getLoopVariableInput
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[InputPin](../../actions/mdbasicactions/InputPin.html)> getLoopVariableInput()
Returns the value of the '***Loop Variable Input***' containment reference list.
 The list contents are of type [`InputPin`](../../actions/mdbasicactions/InputPin.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Loop Variable Input*`](../../actions/mdbasicactions/InputPin.html#get_loopNodeOfLoopVariableInput())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_LoopVariableInput()`](../../metadata/UMLPackage.html#getLoopNode_LoopVariableInput())
[`InputPin.get_loopNodeOfLoopVariableInput()`](../../actions/mdbasicactions/InputPin.html#get_loopNodeOfLoopVariableInput())
Model:
opposite="_loopNodeOfLoopVariableInput" containment="true" resolveProxies="true"
Generated:
getSetupPart
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutableNode](ExecutableNode.html)> getSetupPart()
Returns the value of the '***Setup Part***' reference list.
 The list contents are of type [`ExecutableNode`](ExecutableNode.html).
 It is bidirectional and its opposite is
 '[`*loop Node Of Setup Part*`](ExecutableNode.html#get_loopNodeOfSetupPart())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLoopNode_SetupPart()`](../../metadata/UMLPackage.html#getLoopNode_SetupPart())
[`ExecutableNode.get_loopNodeOfSetupPart()`](ExecutableNode.html#get_loopNodeOfSetupPart())
Model:
...
<h1 class="title" title="Interface LoopNode">Interface LoopNode</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">LoopNode</span><span class="extends-implements">
...
<li><a href="#getBodyPart()"><code><em>Body Part</em></code></a></li>
<li><a href="#getDecider()"><code><em>Decider</em></code></a></li>
<li><a href="#isTestedFirst()"><code><em>Tested First</em></code></a></li>
<li><a href="#getLoopVariableInput()"><code><em>Loop Variable Input</em></code></a></li>
<li><a href="#getResult()"><code><em>Result</em></code></a></li>
<li><a href="#getSetupPart()"><code><em>Setup Part</em></code></a></li>
<li><a href="#getTest()"><code><em>Test</em></code></a></li>
<li><a href="#getLoopVariable()"><code><em>Loop Variable</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getLoopNode()"><code>UMLPackage.getLoopNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getBodyPart()">getBodyPart</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Body Part</b></em>' reference list.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDecider()">getDecider</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Decider</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getLoopVariable()">getLoopVariable</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Loop Variable</b></em>' containment reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../actions/mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getLoopVariableInput()">getLoopVariableInput</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Loop Variable Input</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a>&gt;</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSetupPart()">getSetupPart</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Setup Part</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTest()">getTest</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasBodyPart()">hasBodyPart</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasLoopVariable()">hasLoopVariable</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasLoopVariableInput()">hasLoopVariableInput</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasResult()">hasResult</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasSetupPart()">hasSetupPart</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasTest()">hasTest</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isTestedFirst()">isTestedFirst</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Tested First</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDecider(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)">setDecider</a><wbr/>(<a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getDecider()"><code><em>Decider</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTestedFirst(boolean)">setTestedFirst</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isTestedFirst()"><code><em>Tested First</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getBodyPart()">
<h3>getBodyPart</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a>&gt;</span> <span class="element-name">getBodyPart</span>()</div>
<div class="block">Returns the value of the '<em><b>Body Part</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="ExecutableNode.html#get_loopNodeOfBodyPart()"><code><em>loop Node Of Body Part</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of ExecutableNodes that perform the repetitive computations of the loop. The bodyPart is executed as long as the test section produces a true value.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Body Part</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_BodyPart()"><code>UMLPackage.getLoopNode_BodyPart()</code></a></li>
<li><a href="ExecutableNode.html#get_loopNodeOfBodyPart()"><code>ExecutableNode.get_loopNodeOfBodyPart()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfBodyPart" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Decider</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfDecider()"><code><em>loop Node Of Decider</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An OutputPin on an Action in the test section whose Boolean value determines whether to continue executing the loop bodyPart.
...
<li><a href="../../metadata/UMLPackage.html#getLoopNode_Decider()"><code>UMLPackage.getLoopNode_Decider()</code></a></li>
<li><a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfDecider()"><code>OutputPin.get_loopNodeOfDecider()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfDecider" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="isTestedFirst()">
<h3>isTestedFirst</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isTestedFirst</span>()</div>
<div class="block">Returns the value of the '<em><b>Tested First</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Tested First</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setTestedFirst(boolean)"><code>setTestedFirst(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getLoopNode_TestedFirst()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setTestedFirst(boolean)">
<h3>setTestedFirst</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTestedFirst</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isTestedFirst()"><code><em>Tested First</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Tested First</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isTestedFirst()"><code>isTestedFirst()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfResult()"><code><em>loop Node Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A list of OutputPins that receive the loopVariable values after the last iteration of the loop and constitute the output of the LoopNode.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_Result()"><code>UMLPackage.getLoopNode_Result()</code></a></li>
<li><a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfResult()"><code>OutputPin.get_loopNodeOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfResult" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getLoopVariable()">
<h3>getLoopVariable</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a>&gt;</span> <span class="element-name">getLoopVariable</span>()</div>
<div class="block">Returns the value of the '<em><b>Loop Variable</b></em>' containment reference list.
 The list contents are of type <a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions"><code>OutputPin</code></a>.
 It is bidirectional and its opposite is
 '<a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfLoopVariable()"><code><em>loop Node Of Loop Variable</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A list of OutputPins that hold the values of the loop variables during an execution of the loop. When the test fails, the values are moved to the result
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Loop Variable</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_LoopVariable()"><code>UMLPackage.getLoopNode_LoopVariable()</code></a></li>
<li><a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfLoopVariable()"><code>OutputPin.get_loopNodeOfLoopVariable()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfLoopVariable" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Body Output</b></em>' reference list.
 The list contents are of type <a href="../../actions/mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions"><code>OutputPin</code></a>.
 It is bidirectional and its opposite is
 '<a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfBodyOutput()"><code><em>loop Node Of Body Output</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPins on Actions within the bodyPart, the values of which are moved to the loopVariable OutputPins after the completion of each execution of the
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_BodyOutput()"><code>UMLPackage.getLoopNode_BodyOutput()</code></a></li>
<li><a href="../../actions/mdbasicactions/OutputPin.html#get_loopNodeOfBodyOutput()"><code>OutputPin.get_loopNodeOfBodyOutput()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfBodyOutput"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Test</b></em>' reference list.
 The list contents are of type <a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities"><code>ExecutableNode</code></a>.
 It is bidirectional and its opposite is
 '<a href="ExecutableNode.html#get_loopNodeOfTest()"><code><em>loop Node Of Test</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of ExecutableNodes executed in order to provide the test result for the loop.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_Test()"><code>UMLPackage.getLoopNode_Test()</code></a></li>
<li><a href="ExecutableNode.html#get_loopNodeOfTest()"><code>ExecutableNode.get_loopNodeOfTest()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfTest" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getLoopVariableInput()">
<h3>getLoopVariableInput</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../actions/mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a>&gt;</span> <span class="element-name">getLoopVariableInput</span>()</div>
<div class="block">Returns the value of the '<em><b>Loop Variable Input</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../../actions/mdbasicactions/InputPin.html#get_loopNodeOfLoopVariableInput()"><code><em>loop Node Of Loop Variable Input</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A list of InputPins whose values are moved into the loopVariable Pins before the first iteration of the loop.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Loop Variable Input</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_LoopVariableInput()"><code>UMLPackage.getLoopNode_LoopVariableInput()</code></a></li>
<li><a href="../../actions/mdbasicactions/InputPin.html#get_loopNodeOfLoopVariableInput()"><code>InputPin.get_loopNodeOfLoopVariableInput()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfLoopVariableInput" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSetupPart()">
<h3>getSetupPart</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a>&gt;</span> <span class="element-name">getSetupPart</span>()</div>
<div class="block">Returns the value of the '<em><b>Setup Part</b></em>' reference list.
 The list contents are of type <a href="ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities"><code>ExecutableNode</code></a>.
 It is bidirectional and its opposite is
 '<a href="ExecutableNode.html#get_loopNodeOfSetupPart()"><code><em>loop Node Of Setup Part</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of ExecutableNodes executed before the first iteration of the loop, in order to initialize values or perform other setup computations.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Setup Part</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLoopNode_SetupPart()"><code>UMLPackage.getLoopNode_SetupPart()</code></a></li>
<li><a href="ExecutableNode.html#get_loopNodeOfSetupPart()"><code>ExecutableNode.get_loopNodeOfSetupPart()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_loopNodeOfSetupPart" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasBodyPart()">
<h3>hasBodyPart</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasBodyPart</span>()
...
<li>
<section class="detail" id="hasLoopVariable()">
<h3>hasLoopVariable</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasLoopVariable</span>()
                 throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="hasLoopVariableInput()">
<h3>hasLoopVariableInput</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasLoopVariableInput</span>()
                      throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="hasSetupPart()">
<h3>hasSetupPart</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasSetupPart</span>()
              throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
