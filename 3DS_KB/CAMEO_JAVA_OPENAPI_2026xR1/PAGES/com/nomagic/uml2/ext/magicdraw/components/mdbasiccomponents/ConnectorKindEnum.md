# JAVA OPENAPI: ConnectorKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/ConnectorKindEnum.html
- source_path: `com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/ConnectorKindEnum.html`
- source_sha256: `85cc72a07c4b03368c9ab9f3cee4cc5ca23ea253b988779b1ca3d3b60f969b08`
- captured_utc: `2026-07-14T16:46:31.586221+00:00`
...
`[ConnectorKind](ConnectorKind.html)`, `[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `javax.jmi.reflect.RefEnum`, `org.eclipse.emf.common.util.Enumerator`
...
get
public static [ConnectorKindEnum](ConnectorKindEnum.html) get([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) literal)
Returns the '***Connector Kind***' literal with the specified literal value.
 begin-user-doc 
 end-user-doc
Generated:
getByName
public static [ConnectorKindEnum](ConnectorKindEnum.html) getByName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the '***Connector Kind***' literal with the specified name.
 begin-user-doc 
 end-user-doc
Generated:
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getConnectorKindEnum()</code></pre>
</details>
</li>
