# JAVA OPENAPI: StateMachine (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/StateMachine.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/StateMachine.html`
- source_sha256: `8e7babdeaf57e87bde1148548b996a9ddb74b58791c4c4863e5a2a8ea321670e`
- captured_utc: `2026-07-14T16:46:34.279256+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[State](State.html)>`
...
Generated:
getSubmachineState
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[State](State.html)> getSubmachineState()
Returns the value of the '***Submachine State***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)> getExtendedStateMachine()
Returns the value of the '***Extended State Machine***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)> get_stateMachineOfExtendedStateMachine()
Returns the value of the '***state Machine Of Extended State Machine***' reference list.
 The list contents are of type [`StateMachine`](StateMachine.html).
 It is bidirectional and its opposite is
 '[`*Extended State Machine*`](#getExtendedStateMachine())'.
