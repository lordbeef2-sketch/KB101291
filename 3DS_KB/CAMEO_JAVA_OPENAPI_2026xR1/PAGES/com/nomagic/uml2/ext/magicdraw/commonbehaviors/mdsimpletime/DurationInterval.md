# JAVA OPENAPI: DurationInterval (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationInterval.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationInterval.html`
- source_sha256: `a6dfc787b7a1c4239299e7aed40f3d2780042928e455d6cefd75b88486dbb0d1`
- captured_utc: `2026-07-14T16:46:31.240217+00:00`
...
The following features are supported:
 [`*duration Constraint Of Specification*`](#get_durationConstraintOfSpecification())

See Also:
[`UMLPackage.getDurationInterval()`](../../metadata/UMLPackage.html#getDurationInterval())
Model:
...
Method
Description
`[DurationConstraint](DurationConstraint.html)`
`[get_durationConstraintOfSpecification](#get_durationConstraintOfSpecification())()`
...
`void`
`[set_durationConstraintOfSpecification](#set_durationConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationConstraint))([DurationConstraint](DurationConstraint.html) value)`
Sets the value of the '[`*duration
 Constraint Of Specification*`](#get_durationConstraintOfSpecification())' container reference.
`void`
`[setMax](#setMax(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))([Duration](Duration.html) value)`
Sets the value of the '[`*Max*`](#getMax())' reference.
`void`
`[setMin](#setMin(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))([Duration](Duration.html) value)`
...
============ METHOD DETAIL ========== 
Method Details
get_durationConstraintOfSpecification
@CheckForNull[DurationConstraint](DurationConstraint.html) get_durationConstraintOfSpecification()
Returns the value of the '***duration Constraint Of Specification***' container reference.
 It is bidirectional and its opposite is
 '[`*Specification*`](DurationConstraint.html#getSpecification())'.
 begin-user-doc 
If the meaning of the '*duration Constraint Of Specification*' reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*duration Constraint Of Specification*' container reference.
See Also:
[`set_durationConstraintOfSpecification(DurationConstraint)`](#set_durationConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationConstraint))
[`UMLPackage.getDurationInterval__durationConstraintOfSpecification()`](../../metadata/UMLPackage.html#getDurationInterval__durationConstraintOfSpecification())
[`DurationConstraint.getSpecification()`](DurationConstraint.html#getSpecification())
Model:
opposite="specification" volatile="true" ordered="false"
Generated:
set_durationConstraintOfSpecification
void set_durationConstraintOfSpecification(@CheckForNull
 [DurationConstraint](DurationConstraint.html) value)
Sets the value of the '[`*duration
 Constraint Of Specification*`](#get_durationConstraintOfSpecification())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*duration Constraint Of Specification*' container reference.
See Also:
[`get_durationConstraintOfSpecification()`](#get_durationConstraintOfSpecification())
Generated:
getMin
@CheckForNull[Duration](Duration.html) getMin()
Returns the value of the '***Min***' reference.
 It is bidirectional and its opposite is
 '[`*duration Interval Of Min*`](Duration.html#get_durationIntervalOfMin())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMin(Duration)`](#setMin(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))
[`UMLPackage.getDurationInterval_Min()`](../../metadata/UMLPackage.html#getDurationInterval_Min())
[`Duration.get_durationIntervalOfMin()`](Duration.html#get_durationIntervalOfMin())
Model:
opposite="_durationIntervalOfMin" required="true" ordered="false"
Generated:
setMin
...
Generated:
getMax
@CheckForNull[Duration](Duration.html) getMax()
Returns the value of the '***Max***' reference.
 It is bidirectional and its opposite is
 '[`*duration Interval Of Max*`](Duration.html#get_durationIntervalOfMax())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMax(Duration)`](#setMax(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))
[`UMLPackage.getDurationInterval_Max()`](../../metadata/UMLPackage.html#getDurationInterval_Max())
[`Duration.get_durationIntervalOfMax()`](Duration.html#get_durationIntervalOfMax())
Model:
opposite="_durationIntervalOfMax" required="true" ordered="false"
Generated:
setMax
...
<h1 class="title" title="Interface DurationInterval">Interface DurationInterval</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DurationInterval</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#get_durationConstraintOfSpecification()"><code><em>duration Constraint Of Specification</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getDurationInterval()"><code>UMLPackage.getDurationInterval()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_durationConstraintOfSpecification()">get_durationConstraintOfSpecification</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>duration Constraint Of Specification</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_durationConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationConstraint)">set_durationConstraintOfSpecification</a><wbr/>(<a href="DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_durationConstraintOfSpecification()"><code><em>duration
 Constraint Of Specification</em></code></a>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMax(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">setMax</a><wbr/>(<a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getMax()"><code><em>Max</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMin(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">setMin</a><wbr/>(<a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<li>
<section class="detail" id="get_durationConstraintOfSpecification()">
<h3>get_durationConstraintOfSpecification</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a></span> <span class="element-name">get_durationConstraintOfSpecification</span>()</div>
<div class="block">Returns the value of the '<em><b>duration Constraint Of Specification</b></em>' container reference.
 It is bidirectional and its opposite is
 '<a href="DurationConstraint.html#getSpecification()"><code><em>Specification</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>duration Constraint Of Specification</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>duration Constraint Of Specification</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#set_durationConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationConstraint)"><code>set_durationConstraintOfSpecification(DurationConstraint)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDurationInterval__durationConstraintOfSpecification()"><code>UMLPackage.getDurationInterval__durationConstraintOfSpecification()</code></a></li>
<li><a href="DurationConstraint.html#getSpecification()"><code>DurationConstraint.getSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="set_durationConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.DurationConstraint)">
<h3>set_durationConstraintOfSpecification</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_durationConstraintOfSpecification</span><wbr/><span class="parameters">(@CheckForNull
 <a href="DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#get_durationConstraintOfSpecification()"><code><em>duration
 Constraint Of Specification</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>duration Constraint Of Specification</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#get_durationConstraintOfSpecification()"><code>get_durationConstraintOfSpecification()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<h3>getMin</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a></span> <span class="element-name">getMin</span>()</div>
<div class="block">Returns the value of the '<em><b>Min</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="Duration.html#get_durationIntervalOfMin()"><code><em>duration Interval Of Min</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Refers to the Duration denoting the minimum value of the range.
...
<dd>
<ul class="tag-list-long">
<li><a href="#setMin(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)"><code>setMin(Duration)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDurationInterval_Min()"><code>UMLPackage.getDurationInterval_Min()</code></a></li>
<li><a href="Duration.html#get_durationIntervalOfMin()"><code>Duration.get_durationIntervalOfMin()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationIntervalOfMin" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMin(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">
<h3>setMin</h3>
...
<h3>getMax</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a></span> <span class="element-name">getMax</span>()</div>
<div class="block">Returns the value of the '<em><b>Max</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="Duration.html#get_durationIntervalOfMax()"><code><em>duration Interval Of Max</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Refers to the Duration denoting the maximum value of the range.
...
<dd>
<ul class="tag-list-long">
<li><a href="#setMax(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)"><code>setMax(Duration)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDurationInterval_Max()"><code>UMLPackage.getDurationInterval_Max()</code></a></li>
<li><a href="Duration.html#get_durationIntervalOfMax()"><code>Duration.get_durationIntervalOfMax()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationIntervalOfMax" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMax(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">
<h3>setMax</h3>
