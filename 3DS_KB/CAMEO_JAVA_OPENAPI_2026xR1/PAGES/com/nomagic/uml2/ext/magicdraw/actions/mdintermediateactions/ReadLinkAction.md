# JAVA OPENAPI: ReadLinkAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ReadLinkAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ReadLinkAction.html`
- source_sha256: `78204b7f605407999f5e0487c0782ecbc59c0e30390ea5615cb7734df6f71a88`
- captured_utc: `2026-07-14T16:46:25.125135+00:00`
...
See Also:
[`UMLPackage.getReadLinkAction()`](../../metadata/UMLPackage.html#getReadLinkAction())
Model:
...
`[getEndData](LinkAction.html#getEndData()), [getInputValue](LinkAction.html#getInputValue()), [hasEndData](LinkAction.html#hasEndData()), [hasInputValue](LinkAction.html#hasInputValue())`
...
Returns the value of the '***Result***' containment reference.
 ...
 '[`*read Link Action Of Result*`](../mdbasicactions/OutputPin.html#get_readLinkActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadLinkAction_Result()`](../../metadata/UMLPackage.html#getReadLinkAction_Result())
[`OutputPin.get_readLinkActionOfResult()`](../mdbasicactions/OutputPin.html#get_readLinkActionOfResult())
Model:
...
<h1 class="title" title="Interface ReadLinkAction">Interface ReadLinkAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReadLinkAction</span><span class="extends-implements">
extends <a href="LinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkAction</a></span></div>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getReadLinkAction()"><code>UMLPackage.getReadLinkAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<code><a href="LinkAction.html#getEndData()">getEndData</a>, <a href="LinkAction.html#getInputValue()">getInputValue</a>, <a href="LinkAction.html#hasEndData()">hasEndData</a>, <a href="LinkAction.html#hasInputValue()">hasInputValue</a></code></div>
<div class="inherited-list">
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_readLinkActionOfResult()"><code><em>read Link Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the objects retrieved from the "open" end of those links whose values on other ends are given by the endData.
...
<li><a href="../../metadata/UMLPackage.html#getReadLinkAction_Result()"><code>UMLPackage.getReadLinkAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_readLinkActionOfResult()"><code>OutputPin.get_readLinkActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readLinkActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
