# JAVA OPENAPI: CallAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallAction.html`
- source_sha256: `5b7c26ea4dc444e9df0459863868391d5eb19d1249e8b5e3d9758f274c91d636`
- captured_utc: `2026-07-14T16:46:23.412114+00:00`
...
`[CallBehaviorAction](CallBehaviorAction.html)`, `[CallOperationAction](CallOperationAction.html)`, `[StartObjectBehaviorAction](../mdcompleteactions/StartObjectBehaviorAction.html)`

public interfaceCallActionextends [InvocationAction](InvocationAction.html)
...
See Also:
[`UMLPackage.getCallAction()`](../../metadata/UMLPackage.html#getCallAction())
Model:
abstract="true"
...
`void`
`[setSynchronous](#setSynchronous(boolean))(boolean value)`
Sets the value of the '[`*Synchronous*`](#isSynchronous())' attribute.
...
Returns the value of the '***Synchronous***' attribute.
 ...
 begin-model-doc 
 If true, the call is synchronous and the caller waits for completion of the invoked Behavior. If false, the call is asynchronous and the caller proceeds
 immediately and cannot receive return values.
 end-model-doc
Returns:
the value of the '*Synchronous*' attribute.
See Also:
[`setSynchronous(boolean)`](#setSynchronous(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getCallAction_Synchronous()`
Model:
...
Generated:
getResult
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[OutputPin](OutputPin.html)> getResult()
Returns the value of the '***Result***' containment reference list.
 The list contents are of type [`OutputPin`](OutputPin.html).
 It is bidirectional and its opposite is
 '[`*call Action Of Result*`](OutputPin.html#get_callActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getCallAction_Result()`](../../metadata/UMLPackage.html#getCallAction_Result())
[`OutputPin.get_callActionOfResult()`](OutputPin.html#get_callActionOfResult())
Model:
...
<h1 class="title" title="Interface CallAction">Interface CallAction</h1>
</div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isSynchronous()"><code><em>Synchronous</em></code></a></li>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getCallAction()"><code>UMLPackage.getCallAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isSynchronous()">isSynchronous</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Synchronous</b></em>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setSynchronous(boolean)">setSynchronous</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isSynchronous()"><code><em>Synchronous</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="isSynchronous()">
<h3>isSynchronous</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isSynchronous</span>()</div>
<div class="block">Returns the value of the '<em><b>Synchronous</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Synchronous</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setSynchronous(boolean)"><code>setSynchronous(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getCallAction_Synchronous()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setSynchronous(boolean)">
<h3>setSynchronous</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSynchronous</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isSynchronous()"><code><em>Synchronous</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Synchronous</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isSynchronous()"><code>isSynchronous()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="OutputPin.html#get_callActionOfResult()"><code><em>call Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPins on which the reply values from the invocation are placed (if the call is synchronous).
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getCallAction_Result()"><code>UMLPackage.getCallAction_Result()</code></a></li>
<li><a href="OutputPin.html#get_callActionOfResult()"><code>OutputPin.get_callActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_callActionOfResult" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
