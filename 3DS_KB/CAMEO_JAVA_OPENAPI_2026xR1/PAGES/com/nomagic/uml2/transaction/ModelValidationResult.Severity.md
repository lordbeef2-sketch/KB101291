# JAVA OPENAPI: ModelValidationResult.Severity (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/transaction/ModelValidationResult.Severity.html
- source_path: `com/nomagic/uml2/transaction/ModelValidationResult.Severity.html`
- source_sha256: `916c28669587ee9988a21dce6ad6af69ecb121511e9fb2341ac3077d0fc5cb42`
- captured_utc: `2026-07-14T16:46:34.679262+00:00`
...
## Enum Class ModelValidationResult.Severity

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ModelValidationResult.Severity](ModelValidationResult.Severity.html)>
com.nomagic.uml2.transaction.ModelValidationResult.Severity

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[ModelValidationResult.Severity](ModelValidationResult.Severity.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[ModelValidationResult](ModelValidationResult.html)`

public static enumModelValidationResult.Severity
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ModelValidationResult.Severity](ModelValidationResult.Severity.html)>
...
Method
Description
`static [ModelValidationResult.Severity](ModelValidationResult.Severity.html)`
...
ERROR
public static final [ModelValidationResult.Severity](ModelValidationResult.Severity.html) ERROR
WARNING
public static final [ModelValidationResult.Severity](ModelValidationResult.Severity.html) WARNING
 ============ METHOD DETAIL ========== 
Method Details
values
public static [ModelValidationResult.Severity](ModelValidationResult.Severity.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [ModelValidationResult.Severity](ModelValidationResult.Severity.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class ModelValidationResult.Severity">Enum Class ModelValidationResult.Severity</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a>&gt;
<div class="inheritance">com.nomagic.uml2.transaction.ModelValidationResult.Severity</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="ModelValidationResult.html" title="class in com.nomagic.uml2.transaction">ModelValidationResult</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">ModelValidationResult.Severity</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a>&gt;</span></div>
</section>
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#WARNING">WARNING</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a>[]</code></div>
...
<h3>ERROR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a></span> <span class="element-name">ERROR</span></div>
</section>
</li>
<li>
<section class="detail" id="WARNING">
<h3>WARNING</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a></span> <span class="element-name">WARNING</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModelValidationResult.Severity.html" title="enum class in com.nomagic.uml2.transaction">ModelValidationResult.Severity</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
