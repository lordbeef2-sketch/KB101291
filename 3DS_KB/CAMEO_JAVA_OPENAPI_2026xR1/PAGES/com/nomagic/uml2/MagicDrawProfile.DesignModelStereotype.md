# JAVA OPENAPI: MagicDrawProfile.DesignModelStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.DesignModelStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.DesignModelStereotype.html`
- source_sha256: `feea4bdd53d4024ec1ea2f9411d26ff3acd5019a0b8210b58f67a0e251581f4a`
- captured_utc: `2026-07-14T16:46:17.880039+00:00`
...
## Class MagicDrawProfile.DesignModelStereotype
...
com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype

Enclosing class:
`[MagicDrawProfile](MagicDrawProfile.html)`

public static classMagicDrawProfile.DesignModelStereotype
...
Description
`protected`
`[DesignModelStereotype](#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile))([MagicDrawProfile](MagicDrawProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearDesignModelID](#clearDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html)`
`[getDesignModelID](#getDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](ext/magicdraw/classes/mdkernel/Property.html)`
`[getDesignModelIDProperty](#getDesignModelIDProperty())()`
...
`void`
`[setDesignModelID](#setDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Integer))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype.STEREOTYPE_NAME)
DESIGNMODELID
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) DESIGNMODELID
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype.DESIGNMODELID)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DesignModelStereotype
protected DesignModelStereotype([MagicDrawProfile](MagicDrawProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
Returns:
stereotype
getDesignModelIDProperty
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getDesignModelIDProperty()
setDesignModelID
public void setDesignModelID([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) value)
clearDesignModelID
public void clearDesignModelID([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
getDesignModelID
@CheckForNullpublic [Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) getDesignModelID([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class MagicDrawProfile.DesignModelStereotype">Class MagicDrawProfile.DesignModelStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">MagicDrawProfile.DesignModelStereotype</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#DESIGNMODELID">DESIGNMODELID</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile)">DesignModelStereotype</a><wbr/>(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearDesignModelID</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getDesignModelID</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDesignModelIDProperty()">getDesignModelIDProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Integer)">setDesignModelID</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="DESIGNMODELID">
<h3>DESIGNMODELID</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">DESIGNMODELID</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.DesignModelStereotype.DESIGNMODELID">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>DesignModelStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">DesignModelStereotype</span><wbr/><span class="parameters">(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getDesignModelIDProperty()">
<h3>getDesignModelIDProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getDesignModelIDProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Integer)">
<h3>setDesignModelID</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setDesignModelID</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearDesignModelID</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearDesignModelID</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getDesignModelID(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getDesignModelID</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang">Integer</a></span> <span class="element-name">getDesignModelID</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
