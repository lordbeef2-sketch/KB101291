# JAVA OPENAPI: MagicDrawProfile.NumberingSchemeStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.NumberingSchemeStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.NumberingSchemeStereotype.html`
- source_sha256: `05df8bd48fcb50c99d4b164494a07cdb2c5d8bfea16fe87484d24c1ffaeeab20`
- captured_utc: `2026-07-14T16:46:19.167054+00:00`
...
## Class MagicDrawProfile.NumberingSchemeStereotype
...
com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype

Enclosing class:
`[MagicDrawProfile](MagicDrawProfile.html)`

public static classMagicDrawProfile.NumberingSchemeStereotype
...
Description
`protected`
`[NumberingSchemeStereotype](#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile))([MagicDrawProfile](MagicDrawProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearNumberingStyle](#clearNumberingStyle(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[MagicDrawProfile.NumberingStyleEnum](MagicDrawProfile.NumberingStyleEnum.html)`
`[getNumberingStyle](#getNumberingStyle(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`void`
`[setNumberingStyle](#setNumberingStyle(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.NumberingStyleEnum))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [MagicDrawProfile.NumberingStyleEnum](MagicDrawProfile.NumberingStyleEnum.html) value)`
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype.STEREOTYPE_NAME)
NUMBERINGSTYLE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) NUMBERINGSTYLE
Select a multi-lever style to number elements in more than one numbering level. Specify at least one number part for each numbering level.
 Select a consecutive style to number elements in one numbering level. Specify only one number part.
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype.NUMBERINGSTYLE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
NumberingSchemeStereotype
protected NumberingSchemeStereotype([MagicDrawProfile](MagicDrawProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getNumberingStyleProperty()
setNumberingStyle
public void setNumberingStyle([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [MagicDrawProfile.NumberingStyleEnum](MagicDrawProfile.NumberingStyleEnum.html) value)
clearNumberingStyle
public void clearNumberingStyle([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
getNumberingStyle
@CheckForNullpublic [MagicDrawProfile.NumberingStyleEnum](MagicDrawProfile.NumberingStyleEnum.html) getNumberingStyle([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class MagicDrawProfile.NumberingSchemeStereotype">Class MagicDrawProfile.NumberingSchemeStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">MagicDrawProfile.NumberingSchemeStereotype</span>
...
<div class="block">Select a multi-lever style to number elements in more than one numbering level.</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile)">NumberingSchemeStereotype</a><wbr/>(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MagicDrawProfile.NumberingStyleEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.NumberingStyleEnum</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setNumberingStyle(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.NumberingStyleEnum)">setNumberingStyle</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 <a href="MagicDrawProfile.NumberingStyleEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.NumberingStyleEnum</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="block">Select a multi-lever style to number elements in more than one numbering level. Specify at least one number part for each numbering level.
 Select a consecutive style to number elements in one numbering level. Specify only one number part.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.NumberingSchemeStereotype.NUMBERINGSTYLE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>NumberingSchemeStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">NumberingSchemeStereotype</span><wbr/><span class="parameters">(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getNumberingStyleProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setNumberingStyle(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.NumberingStyleEnum)">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setNumberingStyle</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
 <a href="MagicDrawProfile.NumberingStyleEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.NumberingStyleEnum</a> value)</span></div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearNumberingStyle</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="MagicDrawProfile.NumberingStyleEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.NumberingStyleEnum</a></span> <span class="element-name">getNumberingStyle</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
