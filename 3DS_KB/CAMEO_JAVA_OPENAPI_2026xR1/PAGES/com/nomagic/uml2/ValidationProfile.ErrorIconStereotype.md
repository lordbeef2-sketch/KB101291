# JAVA OPENAPI: ValidationProfile.ErrorIconStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ValidationProfile.ErrorIconStereotype.html
- source_path: `com/nomagic/uml2/ValidationProfile.ErrorIconStereotype.html`
- source_sha256: `4d831c20b8be4e491daf7034fd97122f9e52c0a14941b62ab9d7b82118566a8f`
- captured_utc: `2026-07-14T16:46:20.957078+00:00`
...
## Class ValidationProfile.ErrorIconStereotype
...
com.nomagic.uml2.ValidationProfile.ErrorIconStereotype

Enclosing class:
`[ValidationProfile](ValidationProfile.html)`

public static classValidationProfile.ErrorIconStereotype
...
Description
`protected`
`[ErrorIconStereotype](#%3Cinit%3E(com.nomagic.uml2.ValidationProfile))([ValidationProfile](ValidationProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Description
`void`
`[clearHighlightColor](#clearHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getHighlightColor](#getHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](ext/magicdraw/classes/mdkernel/Property.html)`
`[getHighlightColorProperty](#getHighlightColorProperty())()`
...
`void`
`[setHighlightColor](#setHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.ValidationProfile.ErrorIconStereotype.STEREOTYPE_NAME)
HIGHLIGHTCOLOR
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) HIGHLIGHTCOLOR
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.ValidationProfile.ErrorIconStereotype.HIGHLIGHTCOLOR)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ErrorIconStereotype
protected ErrorIconStereotype([ValidationProfile](ValidationProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getHighlightColorProperty()
setHighlightColor
public void setHighlightColor([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)
clearHighlightColor
public void clearHighlightColor([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
getHighlightColor
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getHighlightColor([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
is
...
<h1 class="title" title="Class ValidationProfile.ErrorIconStereotype">Class ValidationProfile.ErrorIconStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.ValidationProfile.ErrorIconStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">ValidationProfile.ErrorIconStereotype</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#HIGHLIGHTCOLOR">HIGHLIGHTCOLOR</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.ValidationProfile)">ErrorIconStereotype</a><wbr/>(<a href="ValidationProfile.html" title="class in com.nomagic.uml2">ValidationProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearHighlightColor</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getHighlightColor</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getHighlightColorProperty()">getHighlightColorProperty</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">setHighlightColor</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.ValidationProfile.ErrorIconStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="HIGHLIGHTCOLOR">
<h3>HIGHLIGHTCOLOR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">HIGHLIGHTCOLOR</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.ValidationProfile.ErrorIconStereotype.HIGHLIGHTCOLOR">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ErrorIconStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ErrorIconStereotype</span><wbr/><span class="parameters">(<a href="ValidationProfile.html" title="class in com.nomagic.uml2">ValidationProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getHighlightColorProperty()">
<h3>getHighlightColorProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getHighlightColorProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">
<h3>setHighlightColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setHighlightColor</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearHighlightColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearHighlightColor</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getHighlightColor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getHighlightColor</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getHighlightColor</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
