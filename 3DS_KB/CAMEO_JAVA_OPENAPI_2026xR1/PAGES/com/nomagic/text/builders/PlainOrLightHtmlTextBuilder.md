# JAVA OPENAPI: PlainOrLightHtmlTextBuilder (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/text/builders/PlainOrLightHtmlTextBuilder.html
- source_path: `com/nomagic/text/builders/PlainOrLightHtmlTextBuilder.html`
- source_sha256: `79f8ec0d00ea5551fbf651fb191e14491f6f2eabdcadbd6b2aed466487f525cd`
- captured_utc: `2026-07-14T16:46:16.592021+00:00`
...
@OpenApiAllpublic classPlainOrLightHtmlTextBuilder<T extends PlainOrLightHtmlTextBuilder>
...
Constructor
Description
`[PlainOrLightHtmlTextBuilder](#%3Cinit%3E())()`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Overrides:
`[toAppendableText](AbstractTextBuilder.html#toAppendableText(java.lang.String))` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](PlainOrLightHtmlTextBuilder.html) extends [PlainOrLightHtmlTextBuilder](PlainOrLightHtmlTextBuilder.html)>`
toString
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) toString()
Specified by:
`[toString](TextBuilder.html#toString())` in interface `[TextBuilder](TextBuilder.html)<[T](PlainOrLightHtmlTextBuilder.html) extends [PlainOrLightHtmlTextBuilder](PlainOrLightHtmlTextBuilder.html)>`
Overrides:
`[toString](AbstractTextBuilder.html#toString())` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](PlainOrLightHtmlTextBuilder.html) extends [PlainOrLightHtmlTextBuilder](PlainOrLightHtmlTextBuilder.html)>`
Returns:
result string
toPlainText
...
<h1 class="title" title="Class PlainOrLightHtmlTextBuilder">Class PlainOrLightHtmlTextBuilder&lt;T extends PlainOrLightHtmlTextBuilder&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.text.builders.PlainOrLightHtmlTextBuilder&lt;T&gt;</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PlainOrLightHtmlTextBuilder&lt;T extends PlainOrLightHtmlTextBuilder&gt;</span>
...
<div class="block">Builder used for plain or light html text building. Colored fragments are not supported.
 Output text format depends on input text format - if at least one light html fragment added, result will be light html, otherwise result will be plain text.
 Note - full html and rich text fragments will be converted to a light html.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PlainOrLightHtmlTextBuilder</a>()</code></div>
...
<h3>PlainOrLightHtmlTextBuilder</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PlainOrLightHtmlTextBuilder</span>()</div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="AbstractTextBuilder.html#toAppendableText(java.lang.String)">toAppendableText</a></code> in class <code><a href="AbstractTextBuilder.html" title="class in com.nomagic.text.builders">AbstractTextBuilder</a>&lt;<a href="PlainOrLightHtmlTextBuilder.html" title="type parameter in PlainOrLightHtmlTextBuilder">T</a> extends <a href="PlainOrLightHtmlTextBuilder.html" title="class in com.nomagic.text.builders">PlainOrLightHtmlTextBuilder</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="TextBuilder.html#toString()">toString</a></code> in interface <code><a href="TextBuilder.html" title="interface in com.nomagic.text.builders">TextBuilder</a>&lt;<a href="PlainOrLightHtmlTextBuilder.html" title="type parameter in PlainOrLightHtmlTextBuilder">T</a> extends <a href="PlainOrLightHtmlTextBuilder.html" title="class in com.nomagic.text.builders">PlainOrLightHtmlTextBuilder</a>&gt;</code></dd>
<dt>Overrides:</dt>
