# JAVA OPENAPI: UPDMProfile.LocationTypeKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/updm/utils/UPDMProfile.LocationTypeKindEnum.html
- source_path: `com/nomagic/updm/utils/UPDMProfile.LocationTypeKindEnum.html`
- source_sha256: `04c71976e1e168cd641be14cbb650f65708e37bedcd44d0aca67159bd518bdc6`
- captured_utc: `2026-07-14T16:46:42.747371+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UPDMProfile.LocationTypeKindEnum](UPDMProfile.LocationTypeKindEnum.html)>
com.nomagic.updm.utils.UPDMProfile.LocationTypeKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UPDMProfile.LocationTypeKindEnum](UPDMProfile.LocationTypeKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UPDMProfile](UPDMProfile.html)`

public static enumUPDMProfile.LocationTypeKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UPDMProfile.LocationTypeKindEnum](UPDMProfile.LocationTypeKindEnum.html)>
...
valueOf
public static [UPDMProfile.LocationTypeKindEnum](UPDMProfile.LocationTypeKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
