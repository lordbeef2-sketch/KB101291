# JAVA OPENAPI: UPDMProfile.InformationKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/updm/utils/UPDMProfile.InformationKindEnum.html
- source_path: `com/nomagic/updm/utils/UPDMProfile.InformationKindEnum.html`
- source_sha256: `b47a056864db03471e8041b24fe9b219e717543e5e3180a661b13f1e9635b807`
- captured_utc: `2026-07-14T16:46:42.236362+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html)>
com.nomagic.updm.utils.UPDMProfile.InformationKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UPDMProfile](UPDMProfile.html)`

public static enumUPDMProfile.InformationKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html)>
...
Method
Description
`static [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.updm.utils.UPDMProfile,com.nomagic.updm.utils.UPDMProfile.InformationKindEnum))([UPDMProfile](UPDMProfile.html) profile,
 [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) anEnum)`
...
INFORMATION
public static final [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) INFORMATION
Information is the state of a something of interest that is materialized -- in any medium or form -- and communicated or received.
DOMAININFORMATION
public static final [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) DOMAININFORMATION
Types of information within the scope or domain of the architecture.
POSITIONREFERENCEFRAME
public static final [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) POSITIONREFERENCEFRAME
An arbitrary set of axes with reference to which the position or motion of something is described or physical laws are formulated.
PEDIGREEINFORMATION
public static final [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) PEDIGREEINFORMATION
Information describing pedigree.
DATA
public static final [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) DATA
...
Method Details
values
public static [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [UPDMProfile.InformationKindEnum](UPDMProfile.InformationKindEnum.html) toEnum([EnumerationLiteral](../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class UPDMProfile.InformationKindEnum">Enum Class UPDMProfile.InformationKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a>&gt;
<div class="inheritance">com.nomagic.updm.utils.UPDMProfile.InformationKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">UPDMProfile.InformationKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a>&gt;</span></div>
<div class="block">Enumeration of kinds of information, derived from MODAF and DoDAF, used to support the InformationKind tag of the Information stereotype.</div>
</section>
...
<div class="block">Representation of information in a formalized manner suitable for communication, interpretation, or processing by humans or by automatic means.</div>
</div>
...
<div class="block">Types of information within the scope or domain of the architecture.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#INFORMATION">INFORMATION</a></code></div>
<div class="col-last even-row-color">
<div class="block">Information is the state of a something of interest that is materialized -- in any medium or form -- and communicated or received.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#PEDIGREEINFORMATION">PEDIGREEINFORMATION</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Information describing pedigree.</div>
</div>
...
<div class="col-last even-row-color">
<div class="block">An arbitrary set of axes with reference to which the position or motion of something is described or physical laws are formulated.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.updm.utils.UPDMProfile,com.nomagic.updm.utils.UPDMProfile.InformationKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="UPDMProfile.html" title="class in com.nomagic.updm.utils">UPDMProfile</a> profile,
 <a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a>[]</code></div>
...
<h3>INFORMATION</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">INFORMATION</span></div>
<div class="block">Information is the state of a something of interest that is materialized -- in any medium or form -- and communicated or received.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">DOMAININFORMATION</span></div>
<div class="block">Types of information within the scope or domain of the architecture.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">POSITIONREFERENCEFRAME</span></div>
<div class="block">An arbitrary set of axes with reference to which the position or motion of something is described or physical laws are formulated.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">PEDIGREEINFORMATION</span></div>
<div class="block">Information describing pedigree.</div>
</section>
</li>
<li>
...
<h3>DATA</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">DATA</span></div>
<div class="block">Representation of information in a formalized manner suitable for communication, interpretation, or processing by humans or by automatic means. Examples could be whole models, packages, entities, attributes, classes, domain values, enumeration values, records, tables, rows, columns, and fields.</div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.updm.utils.UPDMProfile,com.nomagic.updm.utils.UPDMProfile.InformationKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="UPDMProfile.InformationKindEnum.html" title="enum class in com.nomagic.updm.utils">UPDMProfile.InformationKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
