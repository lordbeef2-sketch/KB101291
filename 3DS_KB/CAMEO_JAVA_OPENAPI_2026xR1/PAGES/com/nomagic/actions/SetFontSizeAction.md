# JAVA OPENAPI: SetFontSizeAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/actions/SetFontSizeAction.html
- source_path: `com/nomagic/actions/SetFontSizeAction.html`
- source_sha256: `7f47bf318b59f11c89473c23de07408a7eb04d32578ee1372b54e7fa20c0c3ae`
- captured_utc: `2026-07-14T16:45:06.806093+00:00`
...
[com.nomagic.actions.SelectItemAction](SelectItemAction.html)
...
@OpenApiAllpublic final classSetFontSizeAction
extends [SelectItemAction](SelectItemAction.html)
implements com.nomagic.actions.ShortcutsNotCustomizable

Action for choosing font size.

See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.actions.SetFontSizeAction)
...
Fields inherited from class com.nomagic.actions.[SelectItemAction](SelectItemAction.html)
`[ADDITIONAL_PROPERTY_MAX_WIDTH](SelectItemAction.html#ADDITIONAL_PROPERTY_MAX_WIDTH)`
...
`void`
`[setFontSize](#setFontSize(java.lang.Integer))([Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) newFontSize)`
Sets new font size value.
`void`
`[setValue](#setValue(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) val)`
Sets new font size value.
Methods inherited from class com.nomagic.actions.[SelectItemAction](SelectItemAction.html)
`[accept](SelectItemAction.html#accept(com.nomagic.actions.ActionsVisitor)), [clone](SelectItemAction.html#clone()), [createAction](SelectItemAction.html#createAction(java.lang.Object,java.lang.String)), [getItems](SelectItemAction.html#getItems()), [getValue](SelectItemAction.html#getValue()), [getValueName](SelectItemAction.html#getValueName()), [isChangeable](SelectItemAction.html#isChangeable()), [isDisplayAsComboBox](SelectItemAction.html#isDisplayAsComboBox()), [isShowActionName](SelectItemAction.html#isShowActionName()), [propertyChange](SelectItemAction.html#propertyChange(java.beans.PropertyChangeEvent)), [setChangeable](SelectItemAction.html#setChangeable(boolean)), [setDisplayAsComboBox](SelectItemAction.html#setDisplayAsComboBox(boolean)), [setItems](SelectItemAction.html#setItems(java.util.List)), [setList](SelectItemAction.html#setList(java.util.List)), [setShowActionName](SelectItemAction.html#setShowActionName(boolean)), [updateState](SelectItemAction.html#updateState())`
...
Field Details
FONT_SIZE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) FONT_SIZE
The value of font size property key.
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.actions.SetFontSizeAction.FONT_SIZE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
SetFontSizeAction
...
Method Details
getFontSize
public [Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) getFontSize()
Returns selected font size value.
Returns:
selected font size.
setFontSize
public void setFontSize([Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) newFontSize)
Sets new font size value.
Parameters:
`newFontSize` - new font size.
setValue
public void setValue([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) val)
Sets new font size value.
Overrides:
`[setValue](SelectItemAction.html#setValue(java.lang.Object))` in class `[SelectItemAction](SelectItemAction.html)`
Parameters:
`val` - new font size. Can be passed as Integer or String(convertible
...
<h1 class="title" title="Class SetFontSizeAction">Class SetFontSizeAction</h1>
</div>
...
<div class="inheritance"><a href="SelectItemAction.html" title="class in com.nomagic.actions">com.nomagic.actions.SelectItemAction</a>
<div class="inheritance">com.nomagic.actions.SetFontSizeAction</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public final class </span><span class="element-name type-name-label">SetFontSizeAction</span>
<span class="extends-implements">extends <a href="SelectItemAction.html" title="class in com.nomagic.actions">SelectItemAction</a>
implements com.nomagic.actions.ShortcutsNotCustomizable</span></div>
<div class="block">Action for choosing font size.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.actions.SetFontSizeAction">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#FONT_SIZE">FONT_SIZE</a></code></div>
<div class="col-last even-row-color">
<div class="block">The value of font size property key.</div>
</div>
</div>
<div class="inherited-list">
<h3 id="fields-inherited-from-class-com.nomagic.actions.SelectItemAction">Fields inherited from class com.nomagic.actions.<a href="SelectItemAction.html" title="class in com.nomagic.actions">SelectItemAction</a></h3>
<code><a href="SelectItemAction.html#ADDITIONAL_PROPERTY_MAX_WIDTH">ADDITIONAL_PROPERTY_MAX_WIDTH</a></code></div>
<div class="inherited-list">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">SetFontSizeAction</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates action and fills it predefined font size selection list.</div>
</div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getFontSize()">getFontSize</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns selected font size value.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setFontSize(java.lang.Integer)">setFontSize</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang">Integer</a> newFontSize)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new font size value.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setValue(java.lang.Object)">setValue</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> val)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new font size value.</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.actions.SelectItemAction">Methods inherited from class com.nomagic.actions.<a href="SelectItemAction.html" title="class in com.nomagic.actions">SelectItemAction</a></h3>
<code><a href="SelectItemAction.html#accept(com.nomagic.actions.ActionsVisitor)">accept</a>, <a href="SelectItemAction.html#clone()">clone</a>, <a href="SelectItemAction.html#createAction(java.lang.Object,java.lang.String)">createAction</a>, <a href="SelectItemAction.html#getItems()">getItems</a>, <a href="SelectItemAction.html#getValue()">getValue</a>, <a href="SelectItemAction.html#getValueName()">getValueName</a>, <a href="SelectItemAction.html#isChangeable()">isChangeable</a>, <a href="SelectItemAction.html#isDisplayAsComboBox()">isDisplayAsComboBox</a>, <a href="SelectItemAction.html#isShowActionName()">isShowActionName</a>, <a href="SelectItemAction.html#propertyChange(java.beans.PropertyChangeEvent)">propertyChange</a>, <a href="SelectItemAction.html#setChangeable(boolean)">setChangeable</a>, <a href="SelectItemAction.html#setDisplayAsComboBox(boolean)">setDisplayAsComboBox</a>, <a href="SelectItemAction.html#setItems(java.util.List)">setItems</a>, <a href="SelectItemAction.html#setList(java.util.List)">setList</a>, <a href="SelectItemAction.html#setShowActionName(boolean)">setShowActionName</a>, <a href="SelectItemAction.html#updateState()">updateState</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="FONT_SIZE">
<h3>FONT_SIZE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">FONT_SIZE</span></div>
<div class="block">The value of font size property key.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.actions.SetFontSizeAction.FONT_SIZE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>SetFontSizeAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SetFontSizeAction</span>()</div>
<div class="block">Creates action and fills it predefined font size selection list.</div>
</section>
</li>
</ul>
...
<h3>getFontSize</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang">Integer</a></span> <span class="element-name">getFontSize</span>()</div>
<div class="block">Returns selected font size value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>selected font size.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setFontSize(java.lang.Integer)">
<h3>setFontSize</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setFontSize</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang">Integer</a> newFontSize)</span></div>
<div class="block">Sets new font size value.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>newFontSize</code> - new font size.</dd>
</dl>
</section>
</li>
<li>
...
<h3>setValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setValue</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> val)</span></div>
<div class="block">Sets new font size value.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="SelectItemAction.html#setValue(java.lang.Object)">setValue</a></code> in class <code><a href="SelectItemAction.html" title="class in com.nomagic.actions">SelectItemAction</a></code></dd>
<dt>Parameters:</dt>
<dd><code>val</code> - new font size. Can be passed as Integer or String(convertible
            to int). If value is not correct, old font size will be left.</dd>
</dl>
</section>
</li>
</ul>
