# JAVA OPENAPI: BaseNMStateAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/actions/BaseNMStateAction.html
- source_path: `com/nomagic/actions/BaseNMStateAction.html`
- source_sha256: `af83596c774937dcc6cf637f60b83b5310d7396eb01dad3c2ada45c2a98bd4db`
- captured_utc: `2026-07-14T16:45:06.212084+00:00`
...
`[NMStateAction](NMStateAction.html)`, `[NMTriStateAction](NMTriStateAction.html)`

@OpenApiAllpublic abstract classBaseNMStateAction
extends [NMAction](NMAction.html)

See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.actions.BaseNMStateAction)
...
Constructor
Description
`[BaseNMStateAction](#%3Cinit%3E(java.lang.String,java.lang.String,int))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`[BaseNMStateAction](#%3Cinit%3E(java.lang.String,java.lang.String,int,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 int mnemonic,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) group)`
Constructs the action with given id, name, mnemonic key.
`[BaseNMStateAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
...
`[BaseNMStateAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 [KeyStroke](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/KeyStroke.html) stroke,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) group)`
Creates action with given id, name, key stroke.
...
Field Details
GROUPED
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) GROUPED
Flag indicates that in group of NMStateActions only one action can have
 "state" true (its radio buttons actions).
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.actions.BaseNMStateAction.GROUPED)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
BaseNMStateAction
...
<h1 class="title" title="Class BaseNMStateAction">Class BaseNMStateAction</h1>
</div>
...
<div class="inheritance">com.nomagic.actions.BaseNMStateAction</div>
</div>
</div>
</div>
...
<dd><code><a href="NMStateAction.html" title="class in com.nomagic.actions">NMStateAction</a></code>, <code><a href="NMTriStateAction.html" title="class in com.nomagic.actions">NMTriStateAction</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public abstract class </span><span class="element-name type-name-label">BaseNMStateAction</span>
<span class="extends-implements">extends <a href="NMAction.html" title="class in com.nomagic.actions">NMAction</a></span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.actions.BaseNMStateAction">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#GROUPED">GROUPED</a></code></div>
<div class="col-last even-row-color">
<div class="block">Flag indicates that in group of NMStateActions only one action can have
 "state" true (its radio buttons actions).</div>
</div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,int)">BaseNMStateAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,int,java.lang.String)">BaseNMStateAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 int mnemonic,
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke)">BaseNMStateAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String)">BaseNMStateAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isGrouped()">isGrouped</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Return grouped property value.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setGrouped(boolean)">setGrouped</a><wbr/>(boolean grouped)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new grouped property value.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="GROUPED">
<h3>GROUPED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">GROUPED</span></div>
<div class="block">Flag indicates that in group of NMStateActions only one action can have
 "state" true (its radio buttons actions).</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.actions.BaseNMStateAction.GROUPED">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>BaseNMStateAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BaseNMStateAction</span><wbr/><span class="parameters">(@CheckForNull
...
<ul class="member-list">
<li>
<section class="detail" id="isGrouped()">
<h3>isGrouped</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isGrouped</span>()</div>
<div class="block">Return grouped property value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if this action is grouped state action.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setGrouped(boolean)">
<h3>setGrouped</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setGrouped</span><wbr/><span class="parameters">(boolean grouped)</span></div>
<div class="block">Sets new grouped property value.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>grouped</code> - new value of grouped flag.</dd>
</dl>
</section>
</li>
</ul>
