# JAVA OPENAPI: SetFontFaceAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/actions/SetFontFaceAction.html
- source_path: `com/nomagic/actions/SetFontFaceAction.html`
- source_sha256: `af987d41bf89e63aed6919a8840dc5a771717e965a40f0d54acd6273ae4b472e`
- captured_utc: `2026-07-14T16:45:07.424101+00:00`
...
@OpenApiAllpublic classSetFontFaceAction
...
See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.actions.SetFontFaceAction)
...
Field Details
FONT_FACE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) FONT_FACE
The value of font face property key.
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.actions.SetFontFaceAction.FONT_FACE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
SetFontFaceAction
...
Method Details
getFontFace
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getFontFace()
Returns selected font face value.
Returns:
selected font face name.
setFontFace
public void setFontFace([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) newFontFace)
Sets new font face value.
Parameters:
`newFontFace` - value.
...
<h1 class="title" title="Class SetFontFaceAction">Class SetFontFaceAction</h1>
</div>
...
<div class="inheritance">com.nomagic.actions.SetFontFaceAction</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">SetFontFaceAction</span>
...
<div class="block">Action for choosing font face.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.actions.SetFontFaceAction">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#FONT_FACE">FONT_FACE</a></code></div>
<div class="col-last even-row-color">
<div class="block">The value of font face property key.</div>
</div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">SetFontFaceAction</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates action and fills it with all system fonts.</div>
</div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getFontFace()">getFontFace</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns selected font face value.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setFontFace(java.lang.String)">setFontFace</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> newFontFace)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new font face value.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="FONT_FACE">
<h3>FONT_FACE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">FONT_FACE</span></div>
<div class="block">The value of font face property key.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.actions.SetFontFaceAction.FONT_FACE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>SetFontFaceAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SetFontFaceAction</span>()</div>
<div class="block">Creates action and fills it with all system fonts.</div>
</section>
</li>
</ul>
...
<ul class="member-list">
<li>
<section class="detail" id="getFontFace()">
<h3>getFontFace</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getFontFace</span>()</div>
<div class="block">Returns selected font face value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>selected font face name.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setFontFace(java.lang.String)">
<h3>setFontFace</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setFontFace</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> newFontFace)</span></div>
<div class="block">Sets new font face value.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>newFontFace</code> - value.</dd>
</dl>
</section>
</li>
</ul>
