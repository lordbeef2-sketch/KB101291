# JAVA OPENAPI: PriorityProvider (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/utils/PriorityProvider.html
- source_path: `com/nomagic/utils/PriorityProvider.html`
- source_sha256: `22adf3dca37e397ef1bb2bcd8e9ec461ac6f5edf0ad57a634a7c905df80d5a11`
- captured_utc: `2026-07-14T16:46:49.844463+00:00`
...
@OpenApiAll
[@FunctionalInterface](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/FunctionalInterface.html)public interfacePriorityProvider
...
`static void`
`[sort](#sort(java.util.List))([List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<? extends [PriorityProvider](PriorityProvider.html)> providers)`
...
sort
static void sort([List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<? extends [PriorityProvider](PriorityProvider.html)> providers)
Sorts given list of providers by priority
Parameters:
`providers` - providers
...
<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/FunctionalInterface.html" title="class or interface in java.lang">@FunctionalInterface</a>
