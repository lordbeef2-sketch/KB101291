# JAVA OPENAPI: LaTeXFormatter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/LaTeXFormatter.html
- source_path: `com/nomagic/magicreport/format/LaTeXFormatter.html`
- source_sha256: `d281bdfb57ec96c9e80ff0de5336c8c64addcb7d58273cfbd21abcf1932fe1af`
- captured_utc: `2026-07-14T16:46:13.834984+00:00`
...
@OpenApiAllpublic classLaTeXFormatter
...
Constructor
Description
`[LaTeXFormatter](#%3Cinit%3E(java.util.Properties))([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)`
...
Constructor Details
LaTeXFormatter
public LaTeXFormatter([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)
Create a HTML formatter with specific properties.
Parameters:
...
<h1 class="title" title="Class LaTeXFormatter">Class LaTeXFormatter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.LaTeXFormatter</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">LaTeXFormatter</span>
...
<div class="block">This class provides implementation for LaTeX format output. Extend from DefaultFormatter, this class provide
...
<div class="block">Filter the specified string for characters that are sensitive to LaTeX interpreters, returning the string
...
<h3>LaTeXFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">LaTeXFormatter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</span></div>
<div class="block">Create a HTML formatter with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
