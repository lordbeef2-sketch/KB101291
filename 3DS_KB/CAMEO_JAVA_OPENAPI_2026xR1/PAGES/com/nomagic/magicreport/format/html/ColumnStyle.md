# JAVA OPENAPI: ColumnStyle (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/html/ColumnStyle.html
- source_path: `com/nomagic/magicreport/format/html/ColumnStyle.html`
- source_sha256: `b1a3b0088ceae903abb7b7a02f0de0416693ad35350b21e1f63cda9df6657c1c`
- captured_utc: `2026-07-14T16:46:14.066989+00:00`
...
com.nomagic.magicreport.format.html.ColumnStyle
...
@OpenApiAllpublic classColumnStyle
...
Jun 4, 2009
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicreport.format.html.ColumnStyle)
...
Constructor
Description
`[ColumnStyle](#%3Cinit%3E())()`
Creates a new style, with a null name and parent.
`[ColumnStyle](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)`
Creates a new style.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Creates a new style, with a null name and parent.
ColumnStyle
public ColumnStyle([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Creates a new style.
Parameters:
...
<h1 class="title" title="Class ColumnStyle">Class ColumnStyle</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.html.ColumnStyle</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ColumnStyle</span>
...
<div class="block">A collection of attributes, represent table styles.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Jun 4, 2009</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicreport.format.html.ColumnStyle">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ColumnStyle</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a new style, with a null name and parent.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">ColumnStyle</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
...
<h3>ColumnStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ColumnStyle</span>()</div>
<div class="block">Creates a new style, with a null name and parent.</div>
</section>
</li>
<li>
...
<h3>ColumnStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ColumnStyle</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
<div class="block">Creates a new style.</div>
<dl class="notes">
<dt>Parameters:</dt>
