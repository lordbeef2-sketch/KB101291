# JAVA OPENAPI: DocBookCreator (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/html/DocBookCreator.html
- source_path: `com/nomagic/magicreport/format/html/DocBookCreator.html`
- source_sha256: `8356b21f91e60e7f9d83b10a9f240be32cb33e491b6f23de2919e3842fcf491f`
- captured_utc: `2026-07-14T16:46:14.099988+00:00`
...
@OpenApiAllpublic classDocBookCreator
...
Description copied from interface: `[IDocumentCreator](../IDocumentCreator.html#setPaperWidth(float))`
set width of paper.
Specified by:
...
Description copied from interface: `[IDocumentCreator](../IDocumentCreator.html#setPaperHeight(float))`
set height of paper.
Specified by:
...
Description copied from interface: `[IDocumentCreator](../IDocumentCreator.html#setProperties(java.util.Properties))`
Set properties.
Specified by:
...
public void startTag([HTML.Tag](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/text/html/HTML.Tag.html) tag,
 [AttributeSet](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/text/AttributeSet.html) attributes)
Description copied from interface: `[IHTMLHandler](IHTMLHandler.html#startTag(javax.swing.text.html.HTML.Tag,javax.swing.text.AttributeSet))`
Receive notification of the start of a tag.
Specified by:
...
Description copied from interface: `[IHTMLHandler](IHTMLHandler.html#endTag(javax.swing.text.html.HTML.Tag))`
Receive notification of the end of a tag.
Specified by:
...
Description copied from interface: `[IHTMLHandler](IHTMLHandler.html#characters(char%5B%5D))`
Receive notification of character data inside a tag.
Specified by:
...
Description copied from interface: `[IHTMLHandler](IHTMLHandler.html#endDocument())`
Receive notification of end document.
Specified by:
...
<h1 class="title" title="Class DocBookCreator">Class DocBookCreator</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.html.DocBookCreator</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DocBookCreator</span>
...
<div class="block">The class use for create DocBook content.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Jan 30, 2013</dd>
<dt>Version:</dt>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">DocBookCreator</a>()</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Convert the HTML content from reader into DocBook document.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#endTag(javax.swing.text.html.HTML.Tag)">endTag</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/text/html/HTML.Tag.html" title="class or interface in javax.swing.text.html">HTML.Tag</a> tag)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Receive notification of the end of a tag.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#putAttributeToStack(javax.swing.text.AttributeSet)">putAttributeToStack</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/text/AttributeSet.html" title="class or interface in javax.swing.text">AttributeSet</a> attributes)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">put start tag attributes in to htmlTagStack.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setDocumentPage(com.nomagic.magicreport.DocumentPage)">setDocumentPage</a><wbr/>(com.nomagic.magicreport.DocumentPage page)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">set document page property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setPaperHeight(float)">setPaperHeight</a><wbr/>(float height)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">set height of paper.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setPaperWidth(float)">setPaperWidth</a><wbr/>(float width)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<h3>DocBookCreator</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DocBookCreator</span>()</div>
</section>
</li>
</ul>
</section>
...
<dd><code>writer</code> - the writer containing DocBook document.</dd>
<dt>Throws:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../IDocumentCreator.html#setPaperWidth(float)">IDocumentCreator</a></code></span></div>
<div class="block">set width of paper.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../IDocumentCreator.html#setPaperHeight(float)">IDocumentCreator</a></code></span></div>
<div class="block">set height of paper.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../IDocumentCreator.html#setProperties(java.util.Properties)">IDocumentCreator</a></code></span></div>
<div class="block">Set properties.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IHTMLHandler.html#startTag(javax.swing.text.html.HTML.Tag,javax.swing.text.AttributeSet)">IHTMLHandler</a></code></span></div>
<div class="block">Receive notification of the start of a tag.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IHTMLHandler.html#endTag(javax.swing.text.html.HTML.Tag)">IHTMLHandler</a></code></span></div>
<div class="block">Receive notification of the end of a tag.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IHTMLHandler.html#characters(char%5B%5D)">IHTMLHandler</a></code></span></div>
<div class="block">Receive notification of character data inside a tag.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="IHTMLHandler.html#endDocument()">IHTMLHandler</a></code></span></div>
<div class="block">Receive notification of end document.</div>
<dl class="notes">
<dt>Specified by:</dt>
