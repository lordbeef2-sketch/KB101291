# JAVA OPENAPI: RowStyle (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/html/RowStyle.html
- source_path: `com/nomagic/magicreport/format/html/RowStyle.html`
- source_sha256: `87460b40b79c934bc5addcac1e434ab8a7ea097e99216a572624924832fd6dd2`
- captured_utc: `2026-07-14T16:46:14.244989+00:00`
...
com.nomagic.magicreport.format.html.RowStyle
...
@OpenApiAllpublic classRowStyle
...
Jun 1, 2009
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicreport.format.html.RowStyle)
...
`[RowStyle](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)`
Creates a new style.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Creates a new style, with a null name and parent.
RowStyle
public RowStyle([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Creates a new style.
Parameters:
...
<h1 class="title" title="Class RowStyle">Class RowStyle</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.html.RowStyle</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">RowStyle</span>
...
<div class="block">A collection of attributes, represent column styles.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Jun 1, 2009</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicreport.format.html.RowStyle">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">RowStyle</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a new style, with a null name and parent.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">RowStyle</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
...
<h3>RowStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RowStyle</span>()</div>
<div class="block">Creates a new style, with a null name and parent.</div>
</section>
</li>
<li>
...
<h3>RowStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RowStyle</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
<div class="block">Creates a new style.</div>
<dl class="notes">
<dt>Parameters:</dt>
