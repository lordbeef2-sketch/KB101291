# JAVA OPENAPI: ParagraphStyle (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/html/ParagraphStyle.html
- source_path: `com/nomagic/magicreport/format/html/ParagraphStyle.html`
- source_sha256: `f9159d5ae2acbfb0cd242633c5abd4725644abf131231edd81230f97de97300a`
- captured_utc: `2026-07-14T16:46:14.210990+00:00`
...
@OpenApiAllpublic classParagraphStyle
...
Jun 3, 2009
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicreport.format.html.ParagraphStyle)
...
Constructor
Description
`[ParagraphStyle](#%3Cinit%3E())()`
Creates a new style, with a null name and parent.
`[ParagraphStyle](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)`
Creates a new style.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Creates a new style, with a null name and parent.
ParagraphStyle
public ParagraphStyle([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Creates a new style.
Parameters:
...
<h1 class="title" title="Class ParagraphStyle">Class ParagraphStyle</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.html.ParagraphStyle</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ParagraphStyle</span>
...
<div class="block">A collection of attributes, represent paragraph styles.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Jun 3, 2009</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicreport.format.html.ParagraphStyle">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ParagraphStyle</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a new style, with a null name and parent.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">ParagraphStyle</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ParagraphStyle</span>()</div>
<div class="block">Creates a new style, with a null name and parent.</div>
</section>
</li>
<li>
...
<h3>ParagraphStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ParagraphStyle</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
<div class="block">Creates a new style.</div>
<dl class="notes">
<dt>Parameters:</dt>
