# JAVA OPENAPI: TextStyle (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/html/TextStyle.html
- source_path: `com/nomagic/magicreport/format/html/TextStyle.html`
- source_sha256: `01ce6bbd93030076ba1bb3ba66ee3b869e77e4f0b005148dcc7f992612319ba2`
- captured_utc: `2026-07-14T16:46:14.387992+00:00`
...
@OpenApiAllpublic classTextStyle
...
Dec 24, 2009
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicreport.format.html.TextStyle)
...
`[TextStyle](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)`
Creates a new style.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Creates a new style, with a null name and parent.
TextStyle
public TextStyle([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Creates a new style.
Parameters:
...
<h1 class="title" title="Class TextStyle">Class TextStyle</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.html.TextStyle</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TextStyle</span>
...
<div class="block">A collection of attributes, represent text styles.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Dec 24, 2009</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicreport.format.html.TextStyle">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">TextStyle</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
...
<h3>TextStyle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TextStyle</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
<div class="block">Creates a new style.</div>
<dl class="notes">
<dt>Parameters:</dt>
