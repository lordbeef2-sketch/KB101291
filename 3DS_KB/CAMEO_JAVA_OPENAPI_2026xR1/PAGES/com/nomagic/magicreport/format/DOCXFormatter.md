# JAVA OPENAPI: DOCXFormatter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/DOCXFormatter.html
- source_path: `com/nomagic/magicreport/format/DOCXFormatter.html`
- source_sha256: `f21e788d83649df83dabd7aed2710b7d364b5810777a49acf6e36504ad61abe3`
- captured_utc: `2026-07-14T16:46:13.792984+00:00`
...
@OpenApiAllpublic classDOCXFormatter
...
Description
`static class`
`[DOCXFormatter.ChartFileProcess](DOCXFormatter.ChartFileProcess.html)`
 =========== FIELD SUMMARY =========== 
Field Summary
...
Constructor
Description
`[DOCXFormatter](#%3Cinit%3E(com.nomagic.magicreport.engine.ITemplateEngine))([ITemplateEngine](../engine/ITemplateEngine.html) templateEngine)`
Create a Docx formatter with specific properties.
`[DOCXFormatter](#%3Cinit%3E(java.util.Properties))([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)`
Create a Docx formatter with specific properties.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Create a DOCX bookmark string from given [`Bookmark`](../Bookmark.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createChart](#createChart(com.nomagic.magicreport.Chart))([Chart](../Chart.html) chart)`
Create a DOCX chart string from given [`Chart`](../Chart.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createGridRowSpan](#createGridRowSpan(com.nomagic.magicreport.GridRowSpan))([GridRowSpan](../GridRowSpan.html) span)`
Create a DOCX gridrowspan (merge columns vertically) string from given [`GridRowSpan`](../GridRowSpan.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createGridSpan](#createGridSpan(com.nomagic.magicreport.GridSpan))([GridSpan](../GridSpan.html) span)`
Create a DOCX gridspan (merge columns horizontally) string from given [`GridSpan`](../GridSpan.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
...
Create a DOCX link string from given [`Link`](../Link.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createRef](#createRef(com.nomagic.magicreport.TextReference))([TextReference](../TextReference.html) bookmark)`
Create a DOCX bookmark string for REF from given [`TextReference`](../TextReference.html) object.
...
`protected double`
`[getPropertyPageHeight](#getPropertyPageHeight())()`

`protected double`
`[getPropertyPageWidth](#getPropertyPageWidth())()`

`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[handleRef](#handleRef(com.nomagic.magicreport.TextReference))([TextReference](../TextReference.html) bookmark)`
Handle TextReference for REF in DOCX
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[openRef](#openRef(com.nomagic.magicreport.TextReference))([TextReference](../TextReference.html) bookmark)`
Create a DOCX ref string from given [`TextReference`](../TextReference.html) object.
...
Constructor Details
DOCXFormatter
public DOCXFormatter([ITemplateEngine](../engine/ITemplateEngine.html) templateEngine)
Create a Docx formatter with specific properties.
Parameters:
`templateEngine` - template engine
DOCXFormatter
public DOCXFormatter([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)
Create a Docx formatter with specific properties.
Parameters:
...
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)` - when IO error occurs
handleRef
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) handleRef([TextReference](../TextReference.html) bookmark)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)
Handle TextReference for REF in DOCX
Parameters:
`bookmark` - an [`TextReference`](../TextReference.html) object
Returns:
...
openRef
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) openRef([TextReference](../TextReference.html) bookmark)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)
Create a DOCX ref string from given [`TextReference`](../TextReference.html) object.
Parameters:
`bookmark` - an [`TextReference`](../TextReference.html) object
...
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)` - when IO error occurs
createRef
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createRef([TextReference](../TextReference.html) bookmark)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)
Create a DOCX bookmark string for REF from given [`TextReference`](../TextReference.html) object.
Parameters:
`bookmark` - an [`TextReference`](../TextReference.html) object
...
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)` - when IO error occurs
createGridSpan
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createGridSpan([GridSpan](../GridSpan.html) span)
Create a DOCX gridspan (merge columns horizontally) string from given [`GridSpan`](../GridSpan.html) object.
Parameters:
...
createChart
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createChart([Chart](../Chart.html) chart)
Create a DOCX chart string from given [`Chart`](../Chart.html) object.
Parameters:
`span` - an [`Chart`](../Chart.html) object
Returns:
...
<h1 class="title" title="Class DOCXFormatter">Class DOCXFormatter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.DOCXFormatter</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DOCXFormatter</span>
...
<div class="block">The Velocity engine support for Docx.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Nov 16, 2009</dd>
</dl>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="DOCXFormatter.ChartFileProcess.html" title="class in com.nomagic.magicreport.format">DOCXFormatter.ChartFileProcess</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicreport.engine.ITemplateEngine)">DOCXFormatter</a><wbr/>(<a href="../engine/ITemplateEngine.html" title="interface in com.nomagic.magicreport.engine">ITemplateEngine</a> templateEngine)</code></div>
<div class="col-last even-row-color">
<div class="block">Create a Docx formatter with specific properties.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.Properties)">DOCXFormatter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#adjustImage(com.nomagic.magicreport.Image,float,float,int)">adjustImage</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 float w,
 float h,
 int flag)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns [imageWidth, imageHeight, imageRotate, effectL, effectT, effectR, effectB ] the image will be
 rotated if necessary 914,400 EMU per inch 12,700 EMU in a point360,000 EMU per cm.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createBookmark(com.nomagic.magicreport.Bookmark)">createBookmark</a><wbr/>(<a href="../Bookmark.html" title="class in com.nomagic.magicreport">Bookmark</a> bookmark)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX bookmark string from given <a href="../Bookmark.html" title="class in com.nomagic.magicreport"><code>Bookmark</code></a> object.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createChart(com.nomagic.magicreport.Chart)">createChart</a><wbr/>(<a href="../Chart.html" title="class in com.nomagic.magicreport">Chart</a> chart)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX chart string from given <a href="../Chart.html" title="class in com.nomagic.magicreport"><code>Chart</code></a> object.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX gridrowspan (merge columns vertically) string from given <a href="../GridRowSpan.html" title="class in com.nomagic.magicreport"><code>GridRowSpan</code></a> object.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX gridspan (merge columns horizontally) string from given <a href="../GridSpan.html" title="class in com.nomagic.magicreport"><code>GridSpan</code></a> object.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX link string from given <a href="../Link.html" title="class in com.nomagic.magicreport"><code>Link</code></a> object.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createRef(com.nomagic.magicreport.TextReference)">createRef</a><wbr/>(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX bookmark string for REF from given <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPaperHeight()">getPaperHeight</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPaperWidth()">getPaperWidth</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected double</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPropertyPageHeight()">getPropertyPageHeight</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected double</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPropertyPageWidth()">getPropertyPageWidth</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#handleRef(com.nomagic.magicreport.TextReference)">handleRef</a><wbr/>(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Handle TextReference for REF in DOCX</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#openRef(com.nomagic.magicreport.TextReference)">openRef</a><wbr/>(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a DOCX ref string from given <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object.</div>
</div>
</div>
</div>
</div>
...
<h3>DOCXFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DOCXFormatter</span><wbr/><span class="parameters">(<a href="../engine/ITemplateEngine.html" title="interface in com.nomagic.magicreport.engine">ITemplateEngine</a> templateEngine)</span></div>
<div class="block">Create a Docx formatter with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>DOCXFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DOCXFormatter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</span></div>
<div class="block">Create a Docx formatter with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<dt>Returns:</dt>
<dd>The String in DOCX bookmark format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
...
<dt>Returns:</dt>
<dd>The String in DOCX link format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
...
<li>
<section class="detail" id="handleRef(com.nomagic.magicreport.TextReference)">
<h3>handleRef</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">handleRef</span><wbr/><span class="parameters">(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</span>
                                  throws <span class="exceptions"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></span></div>
<div class="block">Handle TextReference for REF in DOCX</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>bookmark</code> - an <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object</dd>
<dt>Returns:</dt>
<dd>The String in DOCX of bookmark or REF format.</dd>
<dt>Throws:</dt>
...
<li>
<section class="detail" id="openRef(com.nomagic.magicreport.TextReference)">
<h3>openRef</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">openRef</span><wbr/><span class="parameters">(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</span>
                                throws <span class="exceptions"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></span></div>
<div class="block">Create a DOCX ref string from given <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="createRef(com.nomagic.magicreport.TextReference)">
<h3>createRef</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createRef</span><wbr/><span class="parameters">(<a href="../TextReference.html" title="class in com.nomagic.magicreport">TextReference</a> bookmark)</span>
                                  throws <span class="exceptions"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></span></div>
<div class="block">Create a DOCX bookmark string for REF from given <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>bookmark</code> - an <a href="../TextReference.html" title="class in com.nomagic.magicreport"><code>TextReference</code></a> object</dd>
<dt>Returns:</dt>
<dd>The String in DOCX bookmark for REF format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createGridSpan</span><wbr/><span class="parameters">(<a href="../GridSpan.html" title="class in com.nomagic.magicreport">GridSpan</a> span)</span></div>
<div class="block">Create a DOCX gridspan (merge columns horizontally) string from given <a href="../GridSpan.html" title="class in com.nomagic.magicreport"><code>GridSpan</code></a> object.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>span</code> - an <a href="../GridSpan.html" title="class in com.nomagic.magicreport"><code>GridSpan</code></a> object</dd>
<dt>Returns:</dt>
<dd>The String in DOCX for gridspan format.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createChart(com.nomagic.magicreport.Chart)">
<h3>createChart</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createChart</span><wbr/><span class="parameters">(<a href="../Chart.html" title="class in com.nomagic.magicreport">Chart</a> chart)</span></div>
<div class="block">Create a DOCX chart string from given <a href="../Chart.html" title="class in com.nomagic.magicreport"><code>Chart</code></a> object.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>span</code> - an <a href="../Chart.html" title="class in com.nomagic.magicreport"><code>Chart</code></a> object</dd>
<dt>Returns:</dt>
<dd>The String in DOCX for chart format.</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>The String in DOCX for gridrowspan format.</dd>
</dl>
</section>
</li>
<li>
...
<h3>getPaperWidth</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">double</span> <span class="element-name">getPaperWidth</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getPropertyPageWidth()">
<h3>getPropertyPageWidth</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">double</span> <span class="element-name">getPropertyPageWidth</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getPaperHeight()">
<h3>getPaperHeight</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">double</span> <span class="element-name">getPaperHeight</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getPropertyPageHeight()">
<h3>getPropertyPageHeight</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">double</span> <span class="element-name">getPropertyPageHeight</span>()</div>
</section>
</li>
</ul>
</section>
