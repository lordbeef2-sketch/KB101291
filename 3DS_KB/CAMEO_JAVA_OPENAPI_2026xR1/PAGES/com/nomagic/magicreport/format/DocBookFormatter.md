# JAVA OPENAPI: DocBookFormatter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/DocBookFormatter.html
- source_path: `com/nomagic/magicreport/format/DocBookFormatter.html`
- source_sha256: `5a79e88350952efadc02ea85316083f7fc1b8d7469e27c79512627ffcf8b3335`
- captured_utc: `2026-07-14T16:46:13.825985+00:00`
...
@OpenApiAllpublic classDocBookFormatter
...
Constructor
Description
`[DocBookFormatter](#%3Cinit%3E(java.util.Properties))([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)`
...
Create a DocBook bookmark string from given [`Bookmark`](../Bookmark.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImage](#createImage(com.nomagic.magicreport.Image))([Image](../Image.html) image)`
Create a DocBook image string from given [`Image`](../Image.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
...
Constructor Details
DocBookFormatter
public DocBookFormatter([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)
Create a HTML formatter with specific properties.
Parameters:
...
<h1 class="title" title="Class DocBookFormatter">Class DocBookFormatter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.DocBookFormatter</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DocBookFormatter</span>
...
<div class="block">This class provides implementation for DocBook format output. Extend from DefaultFormatter, this class provide
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.Properties)">DocBookFormatter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</code></div>
...
<div class="block">Create a DocBook bookmark string from given <a href="../Bookmark.html" title="class in com.nomagic.magicreport"><code>Bookmark</code></a> object.</div>
</div>
...
<div class="block">Create a DocBook image string from given <a href="../Image.html" title="class in com.nomagic.magicreport"><code>Image</code></a> object.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
...
<h3>DocBookFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DocBookFormatter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</span></div>
<div class="block">Create a HTML formatter with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<dt>Returns:</dt>
<dd>The String in DocBook image format.</dd>
<dt>Throws:</dt>
...
<dt>Returns:</dt>
<dd>The String in DocBook bookmark format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
