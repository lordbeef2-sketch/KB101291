# JAVA OPENAPI: OOXMLTemplate (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/OOXMLTemplate.html
- source_path: `com/nomagic/magicreport/OOXMLTemplate.html`
- source_sha256: `7a4e88e687e7176742ebf353314ae567f59ed455a57d2e90ef9ee5a53a2f7421`
- captured_utc: `2026-07-14T16:46:11.445954+00:00`
...
@OpenApiAllpublic classOOXMLTemplate
...
See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.magicreport.OOXMLTemplate)
...
Constructor
Description
`[OOXMLTemplate](#%3Cinit%3E())()`
Create OOXML template.
`[OOXMLTemplate](#%3Cinit%3E(java.io.File))([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) input)`
Create OOXML template.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[finalizeOutputLater](#finalizeOutputLater())()`
...
Constructor Details
OOXMLTemplate
public OOXMLTemplate()
Create OOXML template.
OOXMLTemplate
public OOXMLTemplate([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) input)
Create OOXML template.
Parameters:
`input` - template file.
 ============ METHOD DETAIL ========== 
...
Finalize the output before terminate this object. This method do nothing because we still need to hold a
 reference of OOXML file for later processing.
Overrides:
`[finalizeOutput](Template.html#finalizeOutput())` in class `[Template](Template.html)`
finalizeOutputLater
public void finalizeOutputLater()
Manually call this method for real finalize.
...
<h1 class="title" title="Class OOXMLTemplate">Class OOXMLTemplate</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.OOXMLTemplate</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">OOXMLTemplate</span>
<span class="extends-implements">extends <a href="Template.html" title="class in com.nomagic.magicreport">Template</a></span></div>
<div class="block">OOXMLTemplate use for handling the OOXML document.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Oct 19, 2009 1:48:19 PM</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.magicreport.OOXMLTemplate">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">OOXMLTemplate</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Create OOXML template.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.io.File)">OOXMLTemplate</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a> input)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#finalizeOutputLater()">finalizeOutputLater</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Manually call this method for real finalize.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getTemplateFile()">getTemplateFile</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<h3>OOXMLTemplate</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">OOXMLTemplate</span>()</div>
<div class="block">Create OOXML template.</div>
</section>
</li>
<li>
...
<h3>OOXMLTemplate</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">OOXMLTemplate</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html" title="class or interface in java.io">File</a> input)</span></div>
<div class="block">Create OOXML template.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="block">Finalize the output before terminate this object. This method do nothing because we still need to hold a
 reference of OOXML file for later processing.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<li>
<section class="detail" id="finalizeOutputLater()">
<h3>finalizeOutputLater</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">finalizeOutputLater</span>()</div>
<div class="block">Manually call this method for real finalize.</div>
</section>
</li>
</ul>
