# JAVA OPENAPI: XLSXSizeLimitExceededException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/XLSXSizeLimitExceededException.html
- source_path: `com/nomagic/magicreport/XLSXSizeLimitExceededException.html`
- source_sha256: `5fb1a3e0c8292578f7e89fa758195d713d92476e7d3550b71cb45ae4e2dfdb1d`
- captured_utc: `2026-07-14T16:46:11.670957+00:00`
...
## Class XLSXSizeLimitExceededException
...
com.nomagic.magicreport.XLSXSizeLimitExceededException

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`

@OpenApiAllpublic classXLSXSizeLimitExceededException
extends [ReportSizeLimitExceededException](ReportSizeLimitExceededException.html)

See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.magicreport.XLSXSizeLimitExceededException)
...
Constructor
Description
`[XLSXSizeLimitExceededException](#%3Cinit%3E())()`

`[XLSXSizeLimitExceededException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`

`[XLSXSizeLimitExceededException](#%3Cinit%3E(java.lang.String,java.lang.Throwable))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)`

`[XLSXSizeLimitExceededException](#%3Cinit%3E(java.lang.String,java.lang.Throwable,boolean,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause,
 boolean enableSuppression,
 boolean writableStackTrace)`

`[XLSXSizeLimitExceededException](#%3Cinit%3E(java.lang.Throwable))([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
XLSXSizeLimitExceededException
public XLSXSizeLimitExceededException()
XLSXSizeLimitExceededException
public XLSXSizeLimitExceededException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause,
 boolean enableSuppression,
 boolean writableStackTrace)
XLSXSizeLimitExceededException
...
public XLSXSizeLimitExceededException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
XLSXSizeLimitExceededException
public XLSXSizeLimitExceededException([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)
...
<h1 class="title" title="Class XLSXSizeLimitExceededException">Class XLSXSizeLimitExceededException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.XLSXSizeLimitExceededException</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">XLSXSizeLimitExceededException</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.magicreport.XLSXSizeLimitExceededException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">XLSXSizeLimitExceededException</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">XLSXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Throwable)">XLSXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
...
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Throwable)">XLSXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html" title="class or interface in java.lang">Throwable</a> cause)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<h3>XLSXSizeLimitExceededException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">XLSXSizeLimitExceededException</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.lang.Throwable,boolean,boolean)">
<h3>XLSXSizeLimitExceededException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">XLSXSizeLimitExceededException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html" title="class or interface in java.lang">Throwable</a> cause,
 boolean enableSuppression,
