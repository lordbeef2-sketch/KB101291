# JAVA OPENAPI: DOCXEngine.StyleUpdateProcess (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/velocity/DOCXEngine.StyleUpdateProcess.html
- source_path: `com/nomagic/magicreport/engine/velocity/DOCXEngine.StyleUpdateProcess.html`
- source_sha256: `ee6d3e62fed1c9336116b2b1ef866e671c5d2f059214f133270bd2010d80bd09`
- captured_utc: `2026-07-14T16:46:13.046974+00:00`
...
public static classDOCXEngine.StyleUpdateProcess
...
Constructor
Description
`[StyleUpdateProcess](#%3Cinit%3E(com.nomagic.magicreport.engine.ooxml.child.docx.DocumentInfo,com.nomagic.magicreport.engine.velocity.DOCXEngine))([DocumentInfo](../ooxml/child/docx/DocumentInfo.html) documentInfo,
 [DOCXEngine](DOCXEngine.html) engine)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[getParentStyleIds](#getParentStyleIds())()`
Get list of style id
`[Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html),[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)>`
`[getParentStyleNameMap](#getParentStyleNameMap())()`
...
Constructor Details
StyleUpdateProcess
public StyleUpdateProcess([DocumentInfo](../ooxml/child/docx/DocumentInfo.html) documentInfo,
 [DOCXEngine](DOCXEngine.html) engine)
 ============ METHOD DETAIL ========== 
Method Details
startElement
...
content of style
getParentStyleIds
public [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getParentStyleIds()
Get list of style id
Returns:
list of style id
getParentStyleNameMap
public [Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html),[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getParentStyleNameMap()
Get style map {name, id} of style
Returns:
...
<h1 class="title" title="Class DOCXEngine.StyleUpdateProcess">Class DOCXEngine.StyleUpdateProcess</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.engine.velocity.DOCXEngine.StyleUpdateProcess</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">DOCXEngine.StyleUpdateProcess</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicreport.engine.ooxml.child.docx.DocumentInfo,com.nomagic.magicreport.engine.velocity.DOCXEngine)">StyleUpdateProcess</a><wbr/>(<a href="../ooxml/child/docx/DocumentInfo.html" title="class in com.nomagic.magicreport.engine.ooxml.child.docx">DocumentInfo</a> documentInfo,
 <a href="DOCXEngine.html" title="class in com.nomagic.magicreport.engine.velocity">DOCXEngine</a> engine)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getChildStyleIdMap()">getChildStyleIdMap</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Get style map {new id, old id} for child template</div>
</div>
...
<div class="block">Get content of style</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getParentStyleIds()">getParentStyleIds</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Get list of style id</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html" title="class or interface in java.util">Map</a><wbr/>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>,<wbr/><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getParentStyleNameMap()">getParentStyleNameMap</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Get style map {name, id} of style</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicreport.engine.ooxml.child.docx.DocumentInfo,com.nomagic.magicreport.engine.velocity.DOCXEngine)">
<h3>StyleUpdateProcess</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StyleUpdateProcess</span><wbr/><span class="parameters">(<a href="../ooxml/child/docx/DocumentInfo.html" title="class in com.nomagic.magicreport.engine.ooxml.child.docx">DocumentInfo</a> documentInfo,
 <a href="DOCXEngine.html" title="class in com.nomagic.magicreport.engine.velocity">DOCXEngine</a> engine)</span></div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>content of style</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getParentStyleIds()">
<h3>getParentStyleIds</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html" title="class or interface in java.util">Set</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">getParentStyleIds</span>()</div>
<div class="block">Get list of style id</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>list of style id</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getParentStyleNameMap()">
<h3>getParentStyleNameMap</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html" title="class or interface in java.util">Map</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>,<wbr/><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">getParentStyleNameMap</span>()</div>
<div class="block">Get style map {name, id} of style</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>style name map of all templates</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>style id map for child template</dd>
</dl>
</section>
</li>
</ul>
