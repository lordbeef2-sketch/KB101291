# JAVA OPENAPI: PPTXParseErrorException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/ooxml/PPTXParseErrorException.html
- source_path: `com/nomagic/magicreport/engine/ooxml/PPTXParseErrorException.html`
- source_sha256: `99b1044d0a29ad5054c0f072318dab828918f6d9d36bd9500ea6b083c34eac61`
- captured_utc: `2026-07-14T16:46:12.270965+00:00`
...
@OpenApiAllpublic classPPTXParseErrorException
...
Jan 7, 2010
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicreport.engine.ooxml.PPTXParseErrorException)
...
Constructor
Description
`[PPTXParseErrorException](#%3Cinit%3E(com.nomagic.magicreport.ParseErrorException))([ParseErrorException](../../ParseErrorException.html) message)`
Constructs a new exception with the specified detail message.
`[PPTXParseErrorException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`
Constructs a new exception with the specified detail message.
`[PPTXParseErrorException](#%3Cinit%3E(java.lang.String,com.nomagic.magicreport.Template,int,int,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
...
`void`
`[setOtherFile](#setOtherFile(boolean))(boolean otherFile)`
...
public PPTXParseErrorException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
Constructs a new exception with the specified detail message.
Parameters:
`message` - the detail message. The detail message is saved for later retrieval by the
 [`getMessage()`](#getMessage()) method.
PPTXParseErrorException
public PPTXParseErrorException([ParseErrorException](../../ParseErrorException.html) message)
Constructs a new exception with the specified detail message.
Parameters:
`message` - the detail message. The detail message is saved for later retrieval by the
 [`getMessage()`](#getMessage()) method.
...
<h1 class="title" title="Class PPTXParseErrorException">Class PPTXParseErrorException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.engine.ooxml.PPTXParseErrorException</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PPTXParseErrorException</span>
...
<div class="block">Application-level exception thrown when a template has a syntax or other error which prevents it from being
 parsed. The exception message will be return in PPTX meaning.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Jan 7, 2010</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicreport.engine.ooxml.PPTXParseErrorException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicreport.ParseErrorException)">PPTXParseErrorException</a><wbr/>(<a href="../../ParseErrorException.html" title="class in com.nomagic.magicreport">ParseErrorException</a> message)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs a new exception with the specified detail message.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">PPTXParseErrorException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
<div class="col-last odd-row-color">
<div class="block">Constructs a new exception with the specified detail message.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,com.nomagic.magicreport.Template,int,int,java.lang.String)">PPTXParseErrorException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setOtherFile(boolean)">setOtherFile</a><wbr/>(boolean otherFile)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Set true if file is not on current slide.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<h3>PPTXParseErrorException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PPTXParseErrorException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</span></div>
<div class="block">Constructs a new exception with the specified detail message.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>PPTXParseErrorException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PPTXParseErrorException</span><wbr/><span class="parameters">(<a href="../../ParseErrorException.html" title="class in com.nomagic.magicreport">ParseErrorException</a> message)</span></div>
<div class="block">Constructs a new exception with the specified detail message.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>message</code> - the detail message. The detail message is saved for later retrieval by the
...
<li>
<section class="detail" id="setOtherFile(boolean)">
<h3>setOtherFile</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setOtherFile</span><wbr/><span class="parameters">(boolean otherFile)</span></div>
<div class="block">Set true if file is not on current slide.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>otherFile</code> - otherFile</dd>
</dl>
</section>
</li>
</ul>
