# JAVA OPENAPI: DependencyMatrixTool (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/reportwizard/tools/DependencyMatrixTool.html
- source_path: `com/nomagic/reportwizard/tools/DependencyMatrixTool.html`
- source_sha256: `060944e3962a158aea1bc7332308f9962b644be3a3dcbcac60d4afee0572fe9b`
- captured_utc: `2026-07-14T16:46:14.835998+00:00`
...
com.nomagic.reportwizard.tools.DependencyMatrixTool
...
@OpenApiAllpublic classDependencyMatrixTool
...
Feb 1, 2012
See Also:
[Serialized Form](../../../../serialized-form.html#com.nomagic.reportwizard.tools.DependencyMatrixTool)
...
Constructor
Description
`[DependencyMatrixTool](#%3Cinit%3E())()`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`[Matrix](dependencymatrix/Matrix.html)`
`[getMatrix](#getMatrix(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram))([Diagram](../../uml2/ext/magicdraw/classes/mdkernel/Diagram.html) diagram)`
Gets dependency matrix instance form diagram element.
`[Matrix](dependencymatrix/Matrix.html)`
`[getMatrix](#getMatrix(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) diagramName)`
...
Method Details
getMatrix
@CheckForNullpublic [Matrix](dependencymatrix/Matrix.html) getMatrix([Diagram](../../uml2/ext/magicdraw/classes/mdkernel/Diagram.html) diagram)
Gets dependency matrix instance form diagram element.
Parameters:
`diagram` - diagram object.
Returns:
dependency matrix instance.
getMatrix
@CheckForNullpublic [Matrix](dependencymatrix/Matrix.html) getMatrix([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) diagramName)
Get dependency matrix instance from diagram name.
Parameters:
...
<h1 class="title" title="Class DependencyMatrixTool">Class DependencyMatrixTool</h1>
</div>
...
<div class="inheritance">com.nomagic.reportwizard.tools.DependencyMatrixTool</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DependencyMatrixTool</span>
...
<div class="block">A custom tool for accessing Dependency Matrix data to get row elements, column elements and relation between
 row and column elements.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Feb 1, 2012</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../serialized-form.html#com.nomagic.reportwizard.tools.DependencyMatrixTool">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">DependencyMatrixTool</a>()</code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="dependencymatrix/Matrix.html" title="class in com.nomagic.reportwizard.tools.dependencymatrix">Matrix</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getMatrix(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram)">getMatrix</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Diagram.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Diagram</a> diagram)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets dependency matrix instance form diagram element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="dependencymatrix/Matrix.html" title="class in com.nomagic.reportwizard.tools.dependencymatrix">Matrix</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getMatrix(java.lang.String)">getMatrix</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> diagramName)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Get dependency matrix instance from diagram name.</div>
</div>
</div>
</div>
</div>
...
<h3>DependencyMatrixTool</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DependencyMatrixTool</span>()</div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="getMatrix(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram)">
<h3>getMatrix</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="dependencymatrix/Matrix.html" title="class in com.nomagic.reportwizard.tools.dependencymatrix">Matrix</a></span> <span class="element-name">getMatrix</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Diagram.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Diagram</a> diagram)</span></div>
<div class="block">Gets dependency matrix instance form diagram element.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>diagram</code> - diagram object.</dd>
<dt>Returns:</dt>
<dd>dependency matrix instance.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getMatrix(java.lang.String)">
<h3>getMatrix</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="dependencymatrix/Matrix.html" title="class in com.nomagic.reportwizard.tools.dependencymatrix">Matrix</a></span> <span class="element-name">getMatrix</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> diagramName)</span></div>
<div class="block">Get dependency matrix instance from diagram name.</div>
<dl class="notes">
<dt>Parameters:</dt>
