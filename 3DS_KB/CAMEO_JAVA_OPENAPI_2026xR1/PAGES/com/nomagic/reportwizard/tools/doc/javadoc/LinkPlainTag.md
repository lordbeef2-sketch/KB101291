# JAVA OPENAPI: LinkPlainTag (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/reportwizard/tools/doc/javadoc/LinkPlainTag.html
- source_path: `com/nomagic/reportwizard/tools/doc/javadoc/LinkPlainTag.html`
- source_sha256: `730ae9d49589beb909e38a96b195ac5e9f0d0984306bde240fd801d465d70121`
- captured_utc: `2026-07-14T16:46:15.525008+00:00`
...
[com.nomagic.reportwizard.tools.doc.javadoc.LinkTag](LinkTag.html)
com.nomagic.reportwizard.tools.doc.javadoc.LinkPlainTag

All Implemented Interfaces:
`[Tag](../Tag.html)`

@OpenApiAllpublic classLinkPlainTag
extends [LinkTag](LinkTag.html)
...
Constructor
Description
`[LinkPlainTag](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)`
Create a linkplain tag.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Methods inherited from class com.nomagic.reportwizard.tools.doc.javadoc.[LinkTag](LinkTag.html)
`[getLabel](LinkTag.html#getLabel()), [getLink](LinkTag.html#getLink()), [getReference](LinkTag.html#getReference())`
...
Constructor Details
LinkPlainTag
public LinkPlainTag([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)
Create a linkplain tag.
Parameters:
...
Overrides:
`[getText](LinkTag.html#getText())` in class `[LinkTag](LinkTag.html)`
Returns:
...
<h1 class="title" title="Class LinkPlainTag">Class LinkPlainTag</h1>
</div>
...
<div class="inheritance"><a href="LinkTag.html" title="class in com.nomagic.reportwizard.tools.doc.javadoc">com.nomagic.reportwizard.tools.doc.javadoc.LinkTag</a>
<div class="inheritance">com.nomagic.reportwizard.tools.doc.javadoc.LinkPlainTag</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">LinkPlainTag</span>
<span class="extends-implements">extends <a href="LinkTag.html" title="class in com.nomagic.reportwizard.tools.doc.javadoc">LinkTag</a></span></div>
<div class="block">Represents a @linkplain documentation tag.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Sep 3, 2008</dd>
</dl>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">LinkPlainTag</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
...
<div class="block">Create a linkplain tag.</div>
</div>
</div>
</section>
</li>
...
<h3 id="methods-inherited-from-class-com.nomagic.reportwizard.tools.doc.javadoc.LinkTag">Methods inherited from class com.nomagic.reportwizard.tools.doc.javadoc.<a href="LinkTag.html" title="class in com.nomagic.reportwizard.tools.doc.javadoc">LinkTag</a></h3>
<code><a href="LinkTag.html#getLabel()">getLabel</a>, <a href="LinkTag.html#getLink()">getLink</a>, <a href="LinkTag.html#getReference()">getReference</a></code></div>
<div class="inherited-list">
...
<h3>LinkPlainTag</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">LinkPlainTag</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
...
<dt>Overrides:</dt>
<dd><code><a href="LinkTag.html#getText()">getText</a></code> in class <code><a href="LinkTag.html" title="class in com.nomagic.reportwizard.tools.doc.javadoc">LinkTag</a></code></dd>
<dt>Returns:</dt>
