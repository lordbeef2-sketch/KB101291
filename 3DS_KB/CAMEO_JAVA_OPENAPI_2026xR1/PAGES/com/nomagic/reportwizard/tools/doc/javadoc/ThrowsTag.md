# JAVA OPENAPI: ThrowsTag (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/reportwizard/tools/doc/javadoc/ThrowsTag.html
- source_path: `com/nomagic/reportwizard/tools/doc/javadoc/ThrowsTag.html`
- source_sha256: `ff545b4431b0edb150f797bff125b78e1ca1ed8de31b02f060a770fc2f5dfae3`
- captured_utc: `2026-07-14T16:46:15.660008+00:00`
...
com.nomagic.reportwizard.tools.doc.javadoc.ThrowsTag

All Implemented Interfaces:
`[Tag](../Tag.html)`

@OpenApiAllpublic classThrowsTag
...
Constructor
Description
`[ThrowsTag](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
...
`[getName](#getName())()`
Return the name of the parameter associated with this tag.
`[ITool.HTMLString](../../../../magicreport/engine/ITool.HTMLString.html)`
`[getText](#getText())()`
...
Constructor Details
ThrowsTag
public ThrowsTag([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)
Create a throws tag.
Parameters:
...
<h1 class="title" title="Class ThrowsTag">Class ThrowsTag</h1>
</div>
...
<div class="inheritance">com.nomagic.reportwizard.tools.doc.javadoc.ThrowsTag</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ThrowsTag</span>
...
<div class="block">Represents a @throws or @exception documentation tag.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Sep 3, 2008</dd>
</dl>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">ThrowsTag</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
...
<div class="block">Create a throws tag.</div>
</div>
</div>
</section>
</li>
...
<div class="block">Return the parameter comment.</div>
</div>
...
<div class="block">Return the name of the parameter associated with this tag.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../magicreport/engine/ITool.HTMLString.html" title="class in com.nomagic.magicreport.engine">ITool.HTMLString</a></code></div>
...
<h3>ThrowsTag</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ThrowsTag</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
