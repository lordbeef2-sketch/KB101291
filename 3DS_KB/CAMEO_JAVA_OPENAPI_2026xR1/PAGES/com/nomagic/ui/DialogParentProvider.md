# JAVA OPENAPI: DialogParentProvider (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/ui/DialogParentProvider.html
- source_path: `com/nomagic/ui/DialogParentProvider.html`
- source_sha256: `f1f73fc30edff4b206969a7ffd9ade5c6b7b1818684bce75377907501b7e62e3`
- captured_utc: `2026-07-14T16:46:16.979026+00:00`
...
Method Details
getDialogParent
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)[Frame](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Frame.html) getDialogParent()
Deprecated.
...
parent
getDialogOwner
[Window](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Window.html) getDialogOwner()
Returns owner window(dialog or frame) for dialogs
Returns:
owner window
getDialogOwner
[Window](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Window.html) getDialogOwner([Component](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Component.html) invoker)
Returns parent window(dialog or frame) for a dialog which will be invoked by given component
Parameters:
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Window.html" title="class or interface in java.awt">Window</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Window.html" title="class or interface in java.awt">Window</a></code></div>
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Frame.html" title="class or interface in java.awt">Frame</a></span> <span class="element-name">getDialogParent</span>()</div>
...
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Window.html" title="class or interface in java.awt">Window</a></span> <span class="element-name">getDialogOwner</span>()</div>
<div class="block">Returns owner window(dialog or frame) for dialogs</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>owner window</dd>
