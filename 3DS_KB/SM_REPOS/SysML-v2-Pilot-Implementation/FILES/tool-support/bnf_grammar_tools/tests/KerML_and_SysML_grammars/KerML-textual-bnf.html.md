# OFFICIAL REPOSITORY FILE: SysML-v2-Pilot-Implementation/tool-support/bnf_grammar_tools/tests/KerML_and_SysML_grammars/KerML-textual-bnf.html

- repository: `SysML-v2-Pilot-Implementation`
- source_path: `tool-support/bnf_grammar_tools/tests/KerML_and_SysML_grammars/KerML-textual-bnf.html`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Pilot-Implementation/blob/fa709f28dfd49dfdb7ee83e4e19da2f57e0eb3aa/tool-support/bnf_grammar_tools/tests/KerML_and_SysML_grammars/KerML-textual-bnf.html
- source_bytes: 83597
- source_sha256: `e93cd07222f0b837d3ad406160e93e912af882114c7e9994fc4c25df7b4643e3`
- decoded_as: `utf-8`
...
<pre>COMMENT_LINE_TEXT =
    <a href="#LINE_TEXT_">LINE_TEXT</a> excluding the sequence '*/'
</pre>
...
<pre>UNRESTRICTED_NAME =
    single_quote ( <a href="#NAME_CHARACTER_">NAME_CHARACTER</a> | <a href="#ESCAPE_SEQUENCE_">ESCAPE_SEQUENCE</a> )* single_quote
</pre>
<p>// (See Note 1)</p>
...
<pre>Comment =
    ( 'comment' <a href="#Identification">Identification</a>
      ( 'about' ownedRelationsip += <a href="#Annotation">Annotation</a>
...
<a id="SpecificType"></a>
<pre>SpecificType : <a href="#Specialization">Specialization</a> :
...
<pre>BasicFeaturePrefix : <a href="#Feature">Feature</a> :
...
<pre>TypeFeaturingPart : Feature =
    'featured' 'by' ownedRelatioship += <a href="#OwnedTypeFeaturing">OwnedTypeFeaturing</a>
...
<pre>PositionalArgumentList : Feature =
    e.ownedRelationship += <a href="#ArgumentMember">ArgumentMember</a>
    ( ',' e.ownedRelationship += <a href="#ArgumentMember">ArgumentMember</a> )*
</pre>
...
<pre>Flow =
    ...
    ItemFlowDeclaration <a href="#TypeBody">TypeBody</a>
</pre>
...
<pre>PrefixMetadataFeature : <a href="#MetadataFeature">MetadataFeature</a> :
    ownedRelationship += <a href="#OwnedFeatureTyping">OwnedFeatureTyping</a>
</pre>
