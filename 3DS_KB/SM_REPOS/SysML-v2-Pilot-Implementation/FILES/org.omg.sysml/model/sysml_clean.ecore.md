# OFFICIAL REPOSITORY FILE: SysML-v2-Pilot-Implementation/org.omg.sysml/model/sysml_clean.ecore

- repository: `SysML-v2-Pilot-Implementation`
- source_path: `org.omg.sysml/model/sysml_clean.ecore`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Pilot-Implementation/blob/fa709f28dfd49dfdb7ee83e4e19da2f57e0eb3aa/org.omg.sysml/model/sysml_clean.ecore
- source_bytes: 604540
- source_sha256: `75594b4ef7fd8d0302b7984cc9511797b748c7699231d08eb92d8fe4c69d7227`
- decoded_as: `utf-8`
...
<ecore:EPackage xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Type" eSuperTypes="#//Namespace">
    ...
    <eOperations name="specializesFromLibrary" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="isCompatibleWith" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      ...
      <eParameters name="otherType" ordered="false" lowerBound="1" eType="#//Type"/>
    </eOperations>
    <eOperations name="multiplicities" upperBound="-1" eType="#//Multiplicity">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return the owned or inherited &lt;code>Multiplicities&lt;/code> for this &lt;code>Type&lt;./code>.&lt;/p>&#xA;if multiplicity &lt;> null then OrderedSet{multiplicity}&#xA;else &#xA;    ownedSpecialization.general->closure(t |&#xA;        if t.multiplicity &lt;> null then OrderedSet{}&#xA;        else ownedSpecialization.general&#xA;    )->select(multiplicity &lt;> null).multiplicity->asOrderedSet()&#xA;endif"/>
      </eAnnotations>
    </eOperations>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Namespace" eSuperTypes="#//Element">
    ...
    <eOperations name="namesOf" ordered="false" upperBound="-1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="resolve" ordered="false" eType="#//Membership">
      ...
      <eParameters name="qualifiedName" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String"/>
    </eOperations>
    ...
    <eOperations name="qualificationOf" ordered="false" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="unqualifiedNameOf" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Element" abstract="true">
    ...
    <eOperations name="escapedName" ordered="false" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="effectiveShortName" ordered="false" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="effectiveName" ordered="false" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="AnnotatingElement" eSuperTypes="#//Element">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="ownedAnnotatingRelationship"
        upperBound="-1" eType="#//Annotation" volatile="true" transient="true" derived="true"
        eOpposite="#//Annotation/owningAnnotatingElement">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="annotation" upperBound="-1"
        eType="#//Annotation" volatile="true" transient="true" derived="true" eOpposite="#//Annotation/annotatingElement">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Annotations&lt;/code> that relate this &lt;code>AnnotatingElement&lt;/code> to its &lt;code>annotatedElements&lt;/code>. This includes the &lt;code>owningAnnotatingRelationship&lt;/code> (if any) followed by all the &lt;code>ownedAnnotatingRelationshps&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningAnnotatingRelationship"
        ordered="false" eType="#//Annotation" volatile="true" transient="true" derived="true"
        eOpposite="#//Annotation/ownedAnnotatingElement">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>owningRelationship&lt;/code> of this &lt;code>AnnotatingRelationship&lt;/code>, if it is an &lt;code>Annotation&lt;/code>&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Element/owningRelationship #//AnnotatingElement/annotation"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="Annotation" eSuperTypes="#//Relationship">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="annotatingElement" ordered="false"
        lowerBound="1" eType="#//AnnotatingElement" volatile="true" transient="true"
        derived="true" eOpposite="#//AnnotatingElement/annotation">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value=" &lt;p>The &lt;code>AnnotatingElement&lt;/code> that annotates the &lt;code>annotatedElement&lt;/code> of this &lt;code>Annotation&lt;/code>. This is always either the &lt;code>ownedAnnotatingElement&lt;/code> or the &lt;code>owningAnnotatingElement&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
      <eAnnotations source="redefines" references="#//Relationship/source"/>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningAnnotatedElement"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>annotatedElement&lt;/code> of this &lt;code>Annotation&lt;/code>, when it is also the &lt;code>owningRelatedElement&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Annotation/annotatedElement #//Relationship/owningRelatedElement"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="ownedAnnotatingElement"
        ordered="false" eType="#//AnnotatingElement" volatile="true" transient="true"
        derived="true" eOpposite="#//AnnotatingElement/owningAnnotatingRelationship">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>annotatingElement&lt;/code> of this &lt;code>Annotation&lt;/code>, when it is an &lt;code>ownedRelatedElement&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Annotation/annotatingElement #//Relationship/ownedRelatedElement"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningAnnotatingElement"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>annotatingElement&lt;/code> of this &lt;code>Annotation&lt;/code>, when it is the &lt;code>owningRelatedElement&lt;/code>.&lt;/p>"/>
      </eAnnotations>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Specialization" eSuperTypes="#//Relationship">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningType" ordered="false"
      ...
      <eAnnotations source="subsets" references="#//Relationship/owningRelatedElement #//Specialization/specific"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="FeatureMembership" eSuperTypes="#//OwningMembership">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningType" ordered="false"
      ...
      <eAnnotations source="redefines" references="#//Membership/membershipOwningNamespace"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="Feature" eSuperTypes="#//Type">
    ...
    <eOperations name="redefinesFromLibrary" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      ...
      <eParameters name="libraryFeatureName" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//String"/>
    </eOperations>
    <eOperations name="subsetsChain" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="asCartesianProduct" unique="false" upperBound="-1" eType="#//Type">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>If &lt;code>isCartesianProduct&lt;/code> is true, then return the list of &lt;code>Types&lt;/code> whose Cartesian product can be represented by this &lt;code>Feature&lt;/code>. (If &lt;code>isCartesianProduct&lt;/code> is not true, the operation will still return a valid value, it will just not represent anything useful.)&lt;/p>&#xA;featuringType->select(t | t.owner &lt;> self)->&#xA;    union(featuringType->select(t | t.owner = self)->&#xA;        selectByKind(Feature).asCartesianProduct())->&#xA;    union(type)"/>
      </eAnnotations>
    </eOperations>
    <eOperations name="isCartesianProduct" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Check whether this &lt;code>Feature&lt;/code> can be used to represent a Cartesian product of &lt;code>Types&lt;/code>.&lt;/p>&#xA;type->size() = 1 and&#xA;featuringType.size() = 1 and&#xA;(featuringType.first().owner = self implies&#xA;    featuringType.first().oclIsKindOf(Feature) and&#xA;    featuringType.first().oclAsType(Feature).isCartesianProduct())"/>
      </eAnnotations>
    </eOperations>
    <eOperations name="isOwnedCrossFeature" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return whether this &lt;code>Feature&lt;/code> is an owned cross &lt;code>Feature&lt;/code> of an end &lt;code>Feature&lt;/code>.&lt;/p>&#xA;owningNamespace &lt;> null and &#xA;owningNamespace.oclIsKindOf(Feature) and &#xA;owningNamespace.oclAsType(Feature).ownedCrossFeature() = self"/>
      </eAnnotations>
    </eOperations>
    <eOperations name="ownedCrossFeature" ordered="false" eType="#//Feature">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>If this &lt;code>Feature&lt;/code> is an end &lt;code>Feature&lt;/code> of its &lt;code>owningType&lt;/code>, then return the first &lt;code>ownedMember&lt;/code> of the &lt;code>Feature&lt;/code> that is a &lt;code>Feature&lt;/code>, but not a &lt;code>Multiplicity&lt;/code> or a &lt;code>MetadataFeature&lt;/code>, and whose &lt;code>owningMembership&lt;/code> is &lt;em>not&lt;/em> a &lt;code>FeatureMembership&lt;/code>. If this exists, it is the &lt;code>crossFeature&lt;/code> of the end &lt;code>Feature&lt;/code>.&lt;/p>&#xA;if not isEnd or owningType = null then null&#xA;else&#xA;    let ownedMemberFeatures: Sequence(Feature) =&#xA;        ownedMember->selectByKind(Feature)->&#xA;            reject(oclIsKindOf(Multiplicity) or &#xA;                   oclIsKindOf(MetadataFeature) or&#xA;                   oclIsKindOf(FeatureValue))->&#xA;            reject(owningMembership.oclIsKindOf(FeatureMembership)) in&#xA;    if ownedMemberFeatures.isEmpty() then null&#xA;    else ownedMemberFeatures->first()&#xA;    endif"/>
      </eAnnotations>
    </eOperations>
    <eOperations name="allRedefinedFeatures" ordered="false" upperBound="-1" eType="#//Feature">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return this &lt;code>Feature&lt;/code> and all the &lt;code>Features&lt;/code> that are directly or indirectly &lt;code>Redefined&lt;/code> by this &lt;code>Feature&lt;/code>.&lt;/p>&#xA;ownedRedefinition.redefinedFeature->&#xA;    closure(ownedRedefinition.redefinedFeature)->&#xA;    asOrderedSet()->prepend(self)&#xA;"/>
      </eAnnotations>
    </eOperations>
    <eOperations name="isFeaturedWithin" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return if the &lt;code>featuringTypes&lt;/code> of this &lt;code>Feature&lt;/code> are compatible with the given &lt;code>type&lt;/code>. If &lt;code>type&lt;/code> is null, then check if this &lt;code>Feature&lt;/code> is explicitly or implicitly featured by &lt;em>&lt;code>Base::Anything&lt;/code>&lt;/em>. If this &lt;code>Feature&lt;/code> has &lt;code>isVariable = true&lt;/code>, then also consider it to be featured within its &lt;code>owningType&lt;/code>. If this &lt;code>Feature&lt;/code> is a feature chain whose first &lt;code>chainingFeature&lt;/code> has &lt;code>isVariable = true&lt;/code>, then also consider it to be featured within the &lt;code>owningType&lt;/code> of its first &lt;code>chainingFeature&lt;/code>.&lt;/p>&#xA;if type = null then&#xA;    featuringType->forAll(f | f = resolveGlobal('Base::Anything').memberElement)&#xA;else&#xA;    featuringType->forAll(f | type.isCompatibleWith(f)) or&#xA;    isVariable and type.specializes(owningType) or&#xA;    chainingFeature->notEmpty() and chainingFeature->first().isVariable and&#xA;        type.specializes(chainingFeature->first().owningType)&#xA;endif"/>
      </eAnnotations>
      <eParameters name="type" ordered="false" eType="#//Type"/>
    </eOperations>
    <eOperations name="canAccess" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>A &lt;code>Feature&lt;/code> can access another &lt;code>feature&lt;/code> if the other &lt;code>feature&lt;/code> is featured within one of the direct or indirect &lt;code>featuringTypes&lt;/code> of this &lt;code>Feature&lt;/code>.&lt;/p>&#xA;let anythingType: Element =&#xA;    subsettingFeature.resolveGlobal('Base::Anything').memberElement in&#xA;let allFeaturingTypes : Sequence(Type) =&#xA;    featuringTypes->closure(t |&#xA;        if not t.oclIsKindOf(Feature) then Sequence{}&#xA;        else&#xA;            let featuringTypes : OrderedSet(Type) = t.oclAsType(Feature).featuringType in&#xA;            if featuringTypes->isEmpty() then Sequence{anythingType}&#xA;            else featuringTypes&#xA;            endif &#xA;        endif) in&#xA;allFeaturingTypes->exists(t | feature.isFeaturedWithin(t))"/>
      </eAnnotations>
      <eParameters name="feature" ordered="false" lowerBound="1" eType="#//Feature"/>
    </eOperations>
    <eOperations name="isFeaturingType" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return whether the given &lt;code>type&lt;/code> must be a &lt;code>featuringType&lt;/code> of this &lt;code>Feature&lt;/code>. If this &lt;code>Feature&lt;/code> has &lt;code>isVariable = false&lt;/code>, then return true if the &lt;code>type&lt;/code> is the &lt;code>owningType&lt;/code> of the &lt;code>Feature&lt;/code>. If &lt;code>isVariable = true&lt;/code>, then return true if the &lt;code>type&lt;/code> is a &lt;code>Feature&lt;/code> representing the &lt;em>&lt;code>snapshots&lt;/code>&lt;/em> of the &lt;code>owningType&lt;/code> of this &lt;code>Feature&lt;/code>.&lt;/p>&#xA;owningType &lt;> null and&#xA;if not isVariable then type = owningType&#xA;else if owningType = resolveGlobal('Occurrences::Occurrence').memberElement then&#xA;    type = resolveGlobal('Occurrences::Occurrence::snapshots').memberElement &#xA;else &#xA;    type.oclIsKindOf(Feature) and&#xA;    let feature : Feature = type.oclAsType(Feature) in&#xA;    feature.featuringType->includes(owningType) and&#xA;    feature.redefinesFromLibrary('Occurrences::Occurrence::snapshots')&#xA;endif&#xA;"/>
      </eAnnotations>
      <eParameters name="type" ordered="false" lowerBound="1" eType="#//Type"/>
    </eOperations>
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningType" ordered="false"
    ...
    <eStructuralFeatures xsi:type="ecore:EAttribute" name="isVariable" ordered="false"
        lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean"
        defaultValueLiteral="false">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Whether the value of this &lt;code>Feature&lt;/code> might vary over time. That is, whether the &lt;code>Feature&lt;/code> may have a different value for each &lt;em>&lt;code>snapshot&lt;/code>&lt;/em> of an &lt;code>owningType&lt;/code> that is an &lt;em>&lt;code>Occurrence&lt;/code>&lt;/em>.&lt;/p>"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EAttribute" name="isConstant" ordered="false"
        ...
        defaultValueLiteral="false">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>If &lt;code>isVariable&lt;/code> is true, then whether the value of this &lt;code>Feature&lt;/code> nevertheless does not change over all &lt;code>&lt;em>snapshots&lt;/em>&lt;/code> of its &lt;code>owningType&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="crossFeature" ordered="false"
        eType="#//Feature" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="featureCrossing"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The second &lt;code>chainingFeature&lt;/code> of the &lt;code>crossedFeature&lt;/code> of the &lt;code>ownedCrossSubsetting&lt;/code> of this &lt;code>Feature&lt;/code>, if it has one. Semantically, the values of the &lt;code>crossFeature&lt;/code> of an end &lt;code>Feature&lt;/code> must include all values of the end &lt;code>Feature&lt;/code> obtained when navigating from values of the other end &lt;code>Features&lt;/code> of the same &lt;code>owningType&lt;/code>.&#xA;&lt;/p>"/>
      </eAnnotations>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="ownedCrossSubsetting" ordered="false"
        eType="#//CrossSubsetting" volatile="true" transient="true" derived="true"
        eOpposite="#//CrossSubsetting/crossingFeature">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The one &lt;code>ownedSubsetting&lt;/code> of this &lt;code>Feature&lt;/code>, if any, that is a &lt;code>CrossSubsetting}, for which the &lt;code>Feature&lt;/code> is the &lt;code>crossingFeature&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Feature/ownedSubsetting"/>
    </eStructuralFeatures>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="TypeFeaturing" eSuperTypes="#//Relationship">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningFeatureOfType" ordered="false"
      ...
      <eAnnotations source="subsets" references="#//Relationship/owningRelatedElement #//TypeFeaturing/featureOfType"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="FeatureInverting" eSuperTypes="#//Relationship">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningFeature" ordered="false"
      ...
      <eAnnotations source="subsets" references="#//FeatureInverting/featureInverted #//Relationship/owningRelatedElement"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="ReferenceSubsetting" eSuperTypes="#//Subsetting">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="referencingFeature" ordered="false"
      ...
      <eAnnotations source="redefines" references="#//Subsetting/owningFeature #//Subsetting/subsettingFeature"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Disjoining" eSuperTypes="#//Relationship">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="owningType" ordered="false"
      ...
      <eAnnotations source="subsets" references="#//Relationship/owningRelatedElement #//Disjoining/typeDisjoined"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="MetadataFeature" eSuperTypes="#//Feature #//AnnotatingElement">
    ...
    <eOperations name="isSemantic" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="isSyntactic" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Expression" eSuperTypes="#//Step">
    ...
    <eOperations name="modelLevelEvaluable" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eOperations name="checkCondition" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="result" ordered="false"
      ...
      <eAnnotations source="subsets" references="#//Type/output #//Step/parameter"/>
    </eStructuralFeatures>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Function" eSuperTypes="#//Behavior">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="result" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The object or value that is the result of evaluating the Function.&lt;/p>&#xA;&lt;p>The &lt;code>result&lt;/code> &lt;code>parameter&lt;/code> of the &lt;code>Function&lt;/code>, which is owned by the &lt;code>Function&lt;/code> via a &lt;code>ReturnParameterMembership&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Type/output #//Behavior/parameter"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EAttribute" name="isModelLevelEvaluable"
        ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean"
        volatile="true" transient="true" derived="true">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="InvocationExpression" eSuperTypes="#//InstantiationExpression">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="InstantiationExpression" abstract="true"
    ...
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>An &lt;code>InstantiationExpression&lt;/code> is an &lt;code>Expression&lt;/code> that instantiates its &lt;code>instantiatedType&lt;/code>, binding some or all of the &lt;code>features&lt;/code> of that &lt;code>Type&lt;/code> to the &lt;code>results&lt;/code> of its &lt;code>arguments&lt;/code>.&lt;/p>&#xA;&#xA;&lt;p>&lt;code>InstantiationExpression&lt;/code> is abstract, with concrete subclasses &lt;code>InvocationExpression&lt;/code> and &lt;code>ConstructorExpression&lt;/code>.&lt;/p>&#xA;result.owningType = self&#xA;instantiatedType = instantiatedType()&#xA;instantiatedType() &lt;> null"/>
    </eAnnotations>
    <eOperations name="instantiatedType" ordered="false" eType="#//Type">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return the &lt;code>Type&lt;/code> to act as the &lt;code>instantiatedType&lt;/code> for this &lt;code>InstantiationExpression&lt;/code>. By default, this is the &lt;code>memberElement&lt;/code> of the first &lt;code>ownedMembership&lt;/code> that is not a &lt;code>FeatureMembership&lt;/code>, which must be a &lt;code>Type&lt;/code>.&lt;/p>&#xA;&#xA;&lt;p>&lt;b>Note.&lt;/b> This operation is overridden in the subclass &lt;code>OperatorExpression&lt;/code>.&lt;/p>&#xA;let members : Sequence(Element) = ownedMembership->&#xA;    reject(oclIsKindOf(FeatureMembership)).memberElement in&#xA;if members->isEmpty() or not members->first().oclIsKindOf(Type) then null&#xA;else typeMembers->first().oclAsType(Type)&#xA;endif"/>
      </eAnnotations>
    </eOperations>
    <eStructuralFeatures xsi:type="ecore:EReference" name="argument" upperBound="-1"
        eType="#//Expression" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="instantiation"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Expressions&lt;/code> whose &lt;code>results&lt;/code> are bound to &lt;code>features&lt;/code> of the &lt;code>instantiatedType&lt;/code>. The &lt;code>arguments&lt;/code> are ordered consistent with the order of the &lt;code>features&lt;/code>, though they may not be one-to-one with all the &lt;code>features&lt;/code>.&lt;/p>&#xA;&#xA;&lt;p>&lt;strong>Note.&lt;/strong> The derivation of &lt;code>argument&lt;/code> is given in the concrete subclasses of &lt;code>InstantiationExpression&lt;/code>.&lt;/p>"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="instantiatedType" ordered="false"
        lowerBound="1" eType="#//Type" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="instantiationExpression"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Type&lt;/code> that is being instantiated.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Namespace/member"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="IndexExpression" eSuperTypes="#//OperatorExpression">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>An &lt;code>IndexExpression&lt;/code> is an &lt;code>OperatorExpression&lt;/code> whose operator is &lt;code>&quot;#&quot;&lt;/code>, which resolves to the &lt;code>Function&lt;/code> &lt;em>&lt;code>BasicFunctions::'#'&lt;/code>&lt;/em> from the Kernel Functions Library.&lt;/p>&#xA;arguments->notEmpty() and &#xA;not arguments->first().result.specializesFromLibrary('Collections::Array') implies&#xA;    result.specializes(arguments->first().result)&#xA;operator = '#'"/>
    </eAnnotations>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="MultiplicityRange" eSuperTypes="#//Multiplicity">
    ...
    <eOperations name="hasBounds" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      ...
      <eParameters name="lower" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Integer"/>
      <eParameters name="upper" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//UnlimitedNatural"/>
    </eOperations>
    <eOperations name="valueOf" ordered="false" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//UnlimitedNatural">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="bound" lowerBound="1" upperBound="2"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The owned &lt;code>Expressions&lt;/code> of the &lt;code>MultiplicityRange&lt;/code> whose results provide its bounds. These must be the first &lt;code>ownedMembers&lt;/code> of the &lt;code>MultiplicityRange&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Namespace/ownedMember"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="FlowEnd" eSuperTypes="#//Feature">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>A &lt;code>FlowEnd&lt;/code> is a &lt;code>Feature&lt;/code> that is one of the &lt;code>connectorEnds&lt;/code> giving the &lt;code>&lt;em>source&lt;/em>&lt;/code> or &lt;code>&lt;em>target&lt;/em>&lt;/code> of a &lt;code>Flow&lt;/code>. For &lt;code>Flows&lt;/code> typed by &lt;code>&lt;em>FlowTransfer&lt;/em>&lt;/code> or its specializations, &lt;code>FlowEnds&lt;/code> must have exactly one &lt;code>ownedFeature&lt;/code>, which redefines &lt;code>&lt;em>Transfer::source::sourceOutput&lt;/em>&lt;/code> or &lt;code>&lt;em>Transfer::target::targetInput&lt;/em>&lt;/code> and redefines the corresponding feature of the &lt;code>relatedElement&lt;/code> for its end.&lt;/p>&#xA;isEnd&#xA;ownedFeature->size() = 1&#xA;owningType &lt;> null and owningType.oclIsKindOf(Flow)"/>
    </eAnnotations>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="Flow" eSuperTypes="#//Connector #//Step">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>An &lt;code>Flow&lt;/code> is a &lt;code>Step&lt;/code> that represents the transfer of values from one &lt;code>Feature&lt;/code> to another. &lt;code>Flows&lt;/code> can take non-zero time to complete.&lt;/p>&#xA;&#xA;specializesFromLibrary('Transfers::transfers')&#xA;payloadType =&#xA;    if payloadFeature = null then Sequence{}&#xA;    else payloadFeature.type&#xA;    endif&#xA;sourceOutputFeature =&#xA;    if connectorEnd->isEmpty() or &#xA;        connectorEnd.ownedFeature->isEmpty()&#xA;    then null&#xA;    else connectorEnd.ownedFeature->first()&#xA;    endif&#xA;targetInputFeature =&#xA;    if connectorEnd->size() &lt; 2 or &#xA;        connectorEnd->at(2).ownedFeature->isEmpty()&#xA;    then null&#xA;    else connectorEnd->at(2).ownedFeature->first()&#xA;    endif&#xA;flowEnd = connectorEnd->selectByKind(FlowEnd)&#xA;payloadFeature =&#xA;    let payloadFeatures : Sequence(PayloadFeature) =&#xA;        ownedFeature->selectByKind(PayloadFeature) in&#xA;    if payloadFeatures->isEmpty() then null&#xA;    else payloadFeatures->first()&#xA;    endif&#xA;ownedFeature->selectByKind(PayloadFeature)->size() &lt;= 1&#xA;ownedEndFeatures->notEmpty() implies&#xA;    specializesFromLibrary('Transfers::flowTransfers')"/>
    </eAnnotations>
    <eStructuralFeatures xsi:type="ecore:EReference" name="payloadType" unique="false"
        upperBound="-1" eType="#//Classifier" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowForPayloadType"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The type of values transferred, which is the &lt;code>type&lt;/code> of the &lt;code>payloadFeature&lt;/code> of the &lt;code>Flow&lt;/code>.&lt;/p>&#xA;&#xA;"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="targetInputFeature" unique="false"
        eType="#//Feature" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowToInput"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Feature&lt;/code> that receives the values carried by the &lt;code>Flow&lt;/code>. It must be a &lt;code>feature&lt;/code> of the &lt;code>target&lt;/code> of the &lt;code>Flow&lt;/code>.&lt;/p>"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="sourceOutputFeature" unique="false"
        eType="#//Feature" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowFromOutput"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Feature&lt;/code> that provides the items carried by the &lt;code>Flow&lt;/code>. It must be a &lt;code>feature&lt;/code> of the &lt;code>source&lt;/code> of the &lt;code>Flow&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="flowEnd" upperBound="2"
        eType="#//FlowEnd" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="featuringFlow"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>connectorEnds&lt;/code> of this &lt;code>Flow&lt;/code> that are &lt;code>FlowEnds&lt;/code>.&lt;/p>&#xA;"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Connector/connectorEnd"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="payloadFeature" ordered="false"
        eType="#//PayloadFeature" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowWithPayloadFeature"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>ownedFeature&lt;/code> of the &lt;code>Flow&lt;/code> that is a &lt;code>PayloadFeature&lt;/code> (if any).&lt;/p>&#xA;"/>
      </eAnnotations>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="interaction" upperBound="-1"
      ...
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="typedFlow"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Interactions&lt;/code> that type this &lt;code>Flow&lt;/code>. &lt;code>Interactions&lt;/code> are both &lt;code>Associations&lt;/code> and &lt;code>Behaviors&lt;/code>, which can type &lt;code>Connectors&lt;/code> and &lt;code>Steps&lt;/code>, respectively.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="redefines" references="#//Connector/association #//Step/behavior"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="PayloadFeature" eSuperTypes="#//Feature">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>A &lt;code>PayloadFeature&lt;/code> is the &lt;code>ownedFeature&lt;/code> of a &lt;code>Flow&lt;/code> that identifies the things carried by the kinds of transfers that are instances of the &lt;code>Flow&lt;/code>.&lt;/p>&#xA;redefinesFromLibrary('Transfers::Transfer::payload')"/>
    </eAnnotations>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Package" eSuperTypes="#//Namespace">
    ...
    <eOperations name="includeAsMember" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="ControlNode" abstract="true" eSuperTypes="#//ActionUsage">
    ...
    <eOperations name="multiplicityHasBounds" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="ActionUsage" eSuperTypes="#//OccurrenceUsage #//Step">
    ...
    <eOperations name="inputParameter" ordered="false" eType="#//Feature">
      ...
      <eParameters name="i" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Integer"/>
    </eOperations>
    ...
    <eOperations name="isSubactionUsage" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Usage" eSuperTypes="#//Feature">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="directedUsage" upperBound="-1"
      ...
      <eAnnotations source="subsets" references="#//Type/directedFeature #//Usage/usage"/>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="nestedConnection" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>ConnectorAsUsages&lt;/code> that are &lt;code>nestedUsages&lt;/code> of this &lt;code>Usage&lt;/code>. Note that this list includes &lt;code>BindingConnectorAsUsages&lt;/code>, &lt;code>SuccessionAsUsages&lt;/code>, and &lt;code>FlowUsages&lt;/code> because these are &lt;code>ConnectorAsUsages&lt;/code> even though they are not &lt;code>ConnectionUsages&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Usage/nestedUsage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="nestedFlow" ordered="false"
        upperBound="-1" eType="#//FlowUsage" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowOwningUsage"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The code>FlowUsages&lt;/code> that are &lt;code>nestedUsages&lt;/code> of this &lt;code>Usage&lt;/code>.&lt;/p>"/>
      </eAnnotations>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="nestedMetadata" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>MetadataUsages&lt;/code> that are &lt;code>ownedMembers&lt;/code> of this of this &lt;code>Usage&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Usage/nestedItem"/>
    </eStructuralFeatures>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="Definition" eSuperTypes="#//Classifier">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="directedUsage" upperBound="-1"
      ...
      <eAnnotations source="subsets" references="#//Type/directedFeature #//Definition/usage"/>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="ownedFlow" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>FlowUsages&lt;/code> that are &lt;code>ownedUsages&lt;/code> of this &lt;code>Definition&lt;/code>.&lt;/p>"/>
      </eAnnotations>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="ownedMetadata" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>MetadataUsages&lt;/code> that are &lt;code>ownedMembers&lt;/code> of this &lt;code>Definition&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Definition/ownedItem"/>
    </eStructuralFeatures>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="PortDefinition" eSuperTypes="#//OccurrenceDefinition #//Structure">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="conjugatedPortDefinition"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>ConjugatedPortDefinition&lt;/code> that is conjugate to this &lt;code>PortDefinition&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Namespace/ownedMember"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="FlowUsage" eSuperTypes="#//ConnectorAsUsage #//ActionUsage #//Flow">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>A &lt;code>FlowUsage&lt;/code> is an &lt;code>ActionUsage&lt;/code> that is also a &lt;code>ConnectorAsUsage&lt;/code> and a KerML &lt;code>Flow&lt;/code>.&lt;/p>&#xA;specializesFromLibrary('Flows::messages')&#xA;ownedEndFeatures->notEmpty() implies&#xA;    specializesFromLibrary('Flows::flows')"/>
    </eAnnotations>
    <eStructuralFeatures xsi:type="ecore:EReference" name="flowDefinition" upperBound="-1"
        eType="#//Interaction" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="definedFlow"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Interactions&lt;/code> that are the &lt;code>types&lt;/code> of this &lt;code>FlowUsage&lt;/code>. Nominally, these are &lt;code>FlowDefinitions&lt;/code>, but other kinds of Kernel &lt;code>Interactions&lt;/code> are also allowed, to permit use of Interactions from the Kernel Model Libraries.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="redefines" references="#//ActionUsage/actionDefinition #//Flow/interaction"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="StateUsage" eSuperTypes="#//ActionUsage">
    ...
    <eOperations name="isSubstateUsage" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Check if this &lt;code>StateUsage&lt;/code> is composite and has an &lt;code>owningType&lt;/code> that is a &lt;code>StateDefinition&lt;/code> or &lt;code>StateUsage&lt;/code> with the given value of &lt;code>isParallel&lt;/code>, but is &lt;em>not&lt;/em> an &lt;code>entryAction&lt;/code>, &lt;code>doAction&lt;/code>, or &lt;code>exitAction&lt;/code>. If so, then it represents a &lt;code>&lt;em>StateAction&lt;/em>&lt;/code> that is a &lt;code>&lt;em>substate&lt;/em>&lt;/code> or &lt;code>&lt;em>exclusiveState&lt;/em>&lt;/code> (for &lt;code>isParallel = false&lt;/code>) of another &lt;code>&lt;em>StateAction&lt;/em>&lt;/code>.&lt;/p>&#xA;isComposite and owningType &lt;> null and&#xA;(owningType.oclIsKindOf(StateDefinition) and&#xA;    owningType.oclAsType(StateDefinition).isParallel = isParallel or&#xA; owningType.oclIsKindOf(StateUsage) and&#xA;    owningType.oclAsType(StateUsage).isParallel = isParallel) and&#xA;not owningFeatureMembership.oclIsKindOf(StateSubactionMembership)"/>
      </eAnnotations>
      <eParameters name="isParallel" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean"/>
    </eOperations>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="TransitionUsage" eSuperTypes="#//ActionUsage">
    ...
    <eOperations name="sourceFeature" ordered="false" eType="#//Feature">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>Return the &lt;code>Feature&lt;/code> to be used as the &lt;code>source&lt;/code> of the &lt;code>succession&lt;/code> of this &lt;code>TransitionUsage&lt;/code>, which is the first &lt;code>member&lt;/code> of the &lt;code>TransitionUsage&lt;/code> that is a &lt;code>Feature&lt;/code>, that is owned by the &lt;code>TransitionUsage&lt;/code> via a &lt;code>Membership&lt;/code> that is &lt;em>not&lt;/em> a &lt;code>FeatureMembership&lt;/code>, and whose &lt;code>featureTarget&lt;/code> is an &lt;code>ActionUsage&lt;/code>.&lt;/p>&#xA;let features : Sequence(Feature) = ownedMembership->&#xA;    reject(oclIsKindOf(FeatureMembership)).memberElement->&#xA;    selectByKind(Feature)->&#xA;    select(featureTarget.oclIsKindOf(ActionUsage)) in&#xA;if features->isEmpty() then null&#xA;else features->first()&#xA;endif"/>
      </eAnnotations>
    </eOperations>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="AcceptActionUsage" eSuperTypes="#//ActionUsage">
    ...
    <eOperations name="isTriggerAction" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
  ...
  <eClassifiers xsi:type="ecore:EClass" name="RequirementUsage" eSuperTypes="#//ConstraintUsage">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="subjectParameter" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameter&lt;/code> of this &lt;code>RequirementUsage&lt;/code> that represents its subject.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Step/parameter #//Usage/usage"/>
    </eStructuralFeatures>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="actorParameter" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>RequirementUsage&lt;/code> that represent actors involved in the requirement.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Step/parameter #//Usage/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="stakeholderParameter" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>RequirementUsage&lt;/code> that represent stakeholders for the requirement.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Step/parameter #//Usage/usage"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="RequirementDefinition" eSuperTypes="#//ConstraintDefinition">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="subjectParameter" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameter&lt;/code> of this &lt;code>RequirementDefinition&lt;/code> that represents its subject.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Behavior/parameter #//Definition/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="actorParameter" upperBound="-1"
        eType="#//PartUsage" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>RequirementDefinition&lt;/code> that represent actors involved in the requirement.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Behavior/parameter #//Definition/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="stakeholderParameter" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>RequirementDefinition&lt;/code> that represent stakeholders for the requirement.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Behavior/parameter #//Definition/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="assumedConstraint" upperBound="-1"
  ...
  <eClassifiers xsi:type="ecore:EClass" name="CaseUsage" eSuperTypes="#//CalculationUsage">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="objectiveRequirement" eType="#//RequirementUsage"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>RequirementUsage&lt;/code> representing the objective of this &lt;code>CaseUsage&lt;/code>.&lt;/p> &#xA;"/>
      </eAnnotations>
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="subjectParameter" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameter&lt;/code> of this &lt;code>CaseUsage&lt;/code> that represents its subject.&lt;/p>&#xA;"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Step/parameter #//Usage/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="actorParameter" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>CaseUsage&lt;/code> that represent actors involved in the case.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Step/parameter #//Usage/usage"/>
    </eStructuralFeatures>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="CaseDefinition" eSuperTypes="#//CalculationDefinition">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="objectiveRequirement" eType="#//RequirementUsage"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>RequirementUsage&lt;/code> representing the objective of this &lt;code>CaseDefinition&lt;/code>.&lt;/p> &#xA;"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Definition/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="subjectParameter" ordered="false"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameter&lt;/code> of this &lt;code>CaseDefinition&lt;/code> that represents its subject.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Behavior/parameter #//Definition/usage"/>
    </eStructuralFeatures>
    <eStructuralFeatures xsi:type="ecore:EReference" name="actorParameter" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>parameters&lt;/code> of this &lt;code>CaseDefinition&lt;/code> that represent actors involved in the case.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Behavior/parameter #//Definition/usage"/>
    </eStructuralFeatures>
  </eClassifiers>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="ViewUsage" eSuperTypes="#//PartUsage">
    ...
    <eOperations name="includeAsExposed" ordered="false" lowerBound="1" eType="ecore:EDataType ../../org.eclipse.uml2.types/model/Types.ecore#//Boolean">
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
    ...
    <eStructuralFeatures xsi:type="ecore:EReference" name="exposedElement" upperBound="-1"
      ...
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Elements&lt;/code> that are exposed by this &lt;code>ViewUsage&lt;/code>, which are those &lt;code>memberElements&lt;/code> of the imported &lt;code>Memberships&lt;/code> from all the &lt;code>Expose&lt;/code> &lt;code>Relationships&lt;/code> that meet all the owned and inherited &lt;code>viewConditions&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="subsets" references="#//Namespace/member"/>
    </eStructuralFeatures>
  ...
  <eClassifiers xsi:type="ecore:EClass" name="SuccessionFlowUsage" eSuperTypes="#//FlowUsage #//SuccessionFlow">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>A &lt;code>SuccessionFlowUsage&lt;/code> is a &lt;code>FlowUsage&lt;/code> that is also a KerML &lt;code>SuccessionFlow&lt;/code>.&lt;/p>&#xA;specializesFromLibrary('Flows::successionFlows')"/>
    </eAnnotations>
  </eClassifiers>
  <eClassifiers xsi:type="ecore:EClass" name="FlowDefinition" eSuperTypes="#//ActionDefinition #//Interaction">
    <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
      <details key="documentation" value="&lt;p>A &lt;code>FlowDefinition&lt;/code> is an &lt;code>ActionDefinition&lt;/code> that is also an &lt;code>Interaction&lt;/code> (which is both a KerML &lt;code>Behavior&lt;/code> and &lt;code>Association&lt;/code>), representing flows between &lt;code>Usages&lt;/code>.&lt;/p>&#xA;specializesFromLibrary('Flows::MessageAction')&#xA;flowEnd->size() = 2 implies&#xA;    specializesFromLibrary('Flows::Message')&#xA;flowEnd->size() &lt;= 2"/>
    </eAnnotations>
    <eStructuralFeatures xsi:type="ecore:EReference" name="flowEnd" ordered="false"
        upperBound="-1" eType="#//Usage" volatile="true" transient="true" derived="true">
      <eAnnotations source="http://schema.omg.org/spec/MOF/2.0/emof.xml#Property.oppositeRoleName">
        <details key="body" value="flowDefinitionWithEnd"/>
      </eAnnotations>
      <eAnnotations source="http://www.eclipse.org/emf/2002/GenModel">
        <details key="documentation" value="&lt;p>The &lt;code>Usages&lt;/code> that define the things related by the &lt;code>FlowDefinition&lt;/code>.&lt;/p>"/>
      </eAnnotations>
      <eAnnotations source="redefines" references="#//Association/associationEnd"/>
    </eStructuralFeatures>
  </eClassifiers>
