# OFFICIAL REPOSITORY FILE: SysML-v2-Release/sysml/src/validation/01-Parts Tree/1d-Parts Tree with Reference.sysml

- repository: `SysML-v2-Release`
- source_path: `sysml/src/validation/01-Parts Tree/1d-Parts Tree with Reference.sysml`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Release/blob/288d129c0d532065d45434bbb48a920898b719af/sysml/src/validation/01-Parts Tree/1d-Parts Tree with Reference.sysml
- source_bytes: 1394
