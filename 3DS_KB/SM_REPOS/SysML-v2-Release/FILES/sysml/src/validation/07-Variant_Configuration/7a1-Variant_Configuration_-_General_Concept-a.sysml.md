# OFFICIAL REPOSITORY FILE: SysML-v2-Release/sysml/src/validation/07-Variant Configuration/7a1-Variant Configuration - General Concept-a.sysml

- repository: `SysML-v2-Release`
- source_path: `sysml/src/validation/07-Variant Configuration/7a1-Variant Configuration - General Concept-a.sysml`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Release/blob/288d129c0d532065d45434bbb48a920898b719af/sysml/src/validation/07-Variant Configuration/7a1-Variant Configuration - General Concept-a.sysml
- source_bytes: 1609
