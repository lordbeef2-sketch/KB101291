# OFFICIAL REPOSITORY FILE: SysML-v2-API-Services/public/oslc/KerML-vocab.ttl

- repository: `SysML-v2-API-Services`
- source_path: `public/oslc/KerML-vocab.ttl`
- source_url: https://github.com/Systems-Modeling/SysML-v2-API-Services/blob/0af711b14bbcea7b240bb0a3a65817ae68302092/public/oslc/KerML-vocab.ttl
- source_bytes: 92078
- source_sha256: `dc3ca902220ca6f9c7cf63f966be9884fe2c4505becae7b560d69399d38a5cd6`
- decoded_as: `utf-8`
...
oslc_kerml:AnnotatingElement a rdfs:Class ;
...
oslc_kerml:Annotation a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Relationship .

oslc_kerml:Association a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Classifier,
        oslc_kerml:Relationship .

oslc_kerml:AssociationStructure a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Association,
        oslc_kerml:Structure .

oslc_kerml:Behavior a rdfs:Class ;
    rdfs:label "Behavior" ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Class .

oslc_kerml:BindingConnector a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Connector .

oslc_kerml:BooleanExpression a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Expression .

oslc_kerml:Class a rdfs:Class ;
    rdfs:label "Class" ;
...
oslc_kerml:CollectExpression a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:OperatorExpression .

oslc_kerml:Comment a rdfs:Class ;
    rdfs:label "Comment" ;
    rdfs:comment "A Comment is an AnnotatingElement whose body in some way describes its annotatedElements." ;
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:AnnotatingElement .

oslc_kerml:Conjugation a rdfs:Class ;
...
oslc_kerml:ConstructorExpression a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:InstantiationExpression .

oslc_kerml:CrossSubsetting a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Subsetting .

oslc_kerml:DataType a rdfs:Class ;
    rdfs:label "DataType" ;
...
oslc_kerml:Dependency a rdfs:Class ;
...
oslc_kerml:Differencing a rdfs:Class ;
...
oslc_kerml:Disjoining a rdfs:Class ;
...
oslc_kerml:ElementFilterMembership a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:OwningMembership .

oslc_kerml:EndFeatureMembership a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:FeatureMembership .

oslc_kerml:Expression a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Step .
...
oslc_kerml:FeatureChainExpression a rdfs:Class ;
...
oslc_kerml:FeatureChaining a rdfs:Class ;
...
oslc_kerml:FeatureInverting a rdfs:Class ;
...
oslc_kerml:FeatureMembership a rdfs:Class ;
...
oslc_kerml:FeatureReferenceExpression a rdfs:Class ;
...
oslc_kerml:FeatureTyping a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Specialization .

oslc_kerml:FeatureValue a rdfs:Class ;
...
oslc_kerml:FlowEnd a rdfs:Class ;
    rdfs:label "FlowEnd" ;
...
oslc_kerml:Function a rdfs:Class ;
    rdfs:label "Function" ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Behavior .

oslc_kerml:Import a rdfs:Class ;
    rdfs:label "Import" ;
...
oslc_kerml:IndexExpression a rdfs:Class ;
...
oslc_kerml:InstantiationExpression a rdfs:Class ;
...
oslc_kerml:Interaction a rdfs:Class ;
...
oslc_kerml:Intersecting a rdfs:Class ;
...
oslc_kerml:Invariant a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:BooleanExpression .

oslc_kerml:InvocationExpression a rdfs:Class ;
...
oslc_kerml:LibraryPackage a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Package .

oslc_kerml:LiteralBoolean a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:LiteralExpression .

oslc_kerml:LiteralExpression a rdfs:Class ;
...
oslc_kerml:LiteralInfinity a rdfs:Class ;
...
oslc_kerml:LiteralInteger a rdfs:Class ;
...
oslc_kerml:LiteralRational a rdfs:Class ;
...
oslc_kerml:LiteralString a rdfs:Class ;
...
oslc_kerml:Membership a rdfs:Class ;
...
oslc_kerml:MembershipImport a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Import .

oslc_kerml:Metaclass a rdfs:Class ;
    rdfs:label "Metaclass" ;
    rdfs:comment "A Metaclass is a Structure used to type MetadataFeatures." ;
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Structure .

oslc_kerml:MetadataAccessExpression a rdfs:Class ;
...
oslc_kerml:MetadataFeature a rdfs:Class ;
...
oslc_kerml:Multiplicity a rdfs:Class ;
...
oslc_kerml:MultiplicityRange a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Multiplicity .

oslc_kerml:Namespace a rdfs:Class ;
...
oslc_kerml:NamespaceImport a rdfs:Class ;
...
oslc_kerml:OperatorExpression a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:InvocationExpression .

oslc_kerml:OwningMembership a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Membership .

oslc_kerml:Package a rdfs:Class ;
    rdfs:label "Package" ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Namespace .

oslc_kerml:ParameterMembership a rdfs:Class ;
...
oslc_kerml:PayloadFeature a rdfs:Class ;
...
oslc_kerml:Predicate a rdfs:Class ;
    rdfs:label "Predicate" ;
    rdfs:comment "A Predicate is a Function whose result parameter has type Boolean and multiplicity 1..1." ;
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Function .

oslc_kerml:Redefinition a rdfs:Class ;
...
oslc_kerml:ReferenceSubsetting a rdfs:Class ;
...
oslc_kerml:ResultExpressionMembership a rdfs:Class ;
...
oslc_kerml:ReturnParameterMembership a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:ParameterMembership .

oslc_kerml:SelectExpression a rdfs:Class ;
...
oslc_kerml:Specialization a rdfs:Class ;
...
oslc_kerml:Structure a rdfs:Class ;
...
oslc_kerml:Subclassification a rdfs:Class ;
...
oslc_kerml:Subsetting a rdfs:Class ;
...
oslc_kerml:Succession a rdfs:Class ;
...
oslc_kerml:SuccessionFlow a rdfs:Class ;
    ...
    rdfs:isDefinedBy oslc_kerml: ;
    rdfs:subClassOf oslc_kerml:Flow,
        oslc_kerml:Succession .

oslc_kerml:TextualRepresentation a rdfs:Class ;
...
oslc_kerml:TypeFeaturing a rdfs:Class ;
...
oslc_kerml:Unioning a rdfs:Class ;
    rdfs:label "Unioning" ;
...
oslc_kerml:annotatedElement a rdf:Property ;
...
oslc_kerml:annotatingElement a rdf:Property ;
    rdfs:label "annotatingElement" ;
...
oslc_kerml:annotation a rdf:Property ;
    rdfs:label "annotation" ;
...
oslc_kerml:argument a rdf:Property ;
    rdfs:label "argument" ;
...
oslc_kerml:association a rdf:Property ;
    rdfs:label "association" ;
    rdfs:comment "Connector: The Associations that type the Connector." ;
    rdfs:isDefinedBy oslc_kerml: .

oslc_kerml:associationEnd a rdf:Property ;
...
oslc_kerml:behavior a rdf:Property ;
    rdfs:label "behavior" ;
    rdfs:comment "Step: The Behaviors that type this Step." ;
    rdfs:isDefinedBy oslc_kerml: .

oslc_kerml:body a rdf:Property ;
    rdfs:label "body" ;
...
oslc_kerml:bound a rdf:Property ;
    rdfs:label "bound" ;
...
oslc_kerml:chainingFeature a rdf:Property ;
...
oslc_kerml:conjugatedType a rdf:Property ;
...
oslc_kerml:connectorEnd a rdf:Property ;
...
oslc_kerml:crossFeature a rdf:Property ;
...
oslc_kerml:crossedFeature a rdf:Property ;
...
oslc_kerml:crossingFeature a rdf:Property ;
...
oslc_kerml:declaredName a rdf:Property ;
    rdfs:label "declaredName" ;
    rdfs:comment "Element: The declared name of this Element." ;
    rdfs:isDefinedBy oslc_kerml: .

oslc_kerml:declaredShortName a rdf:Property ;
...
oslc_kerml:defaultFeaturingType a rdf:Property ;
...
oslc_kerml:differencingType a rdf:Property ;
...
oslc_kerml:featureOfType a rdf:Property ;
...
oslc_kerml:featureTarget a rdf:Property ;
...
oslc_kerml:filterCondition a rdf:Property ;
...
oslc_kerml:importedElement a rdf:Property ;
...
oslc_kerml:importedMembership a rdf:Property ;
...
oslc_kerml:importedNamespace a rdf:Property ;
...
oslc_kerml:inheritedFeature a rdf:Property ;
...
oslc_kerml:inheritedMembership a rdf:Property ;
...
oslc_kerml:intersectingType a rdf:Property ;
...
oslc_kerml:isComposite a rdf:Property ;
...
oslc_kerml:isDefault a rdf:Property ;
...
oslc_kerml:isDerived a rdf:Property ;
...
oslc_kerml:isEnd a rdf:Property ;
    rdfs:label "isEnd" ;
...
oslc_kerml:isImplied a rdf:Property ;
...
oslc_kerml:isImpliedIncluded a rdf:Property ;
...
oslc_kerml:isLibraryElement a rdf:Property ;
...
oslc_kerml:isModelLevelEvaluable a rdf:Property ;
...
oslc_kerml:isSufficient a rdf:Property ;
...
oslc_kerml:lowerBound a rdf:Property ;
...
oslc_kerml:member a rdf:Property ;
    rdfs:label "member" ;
...
oslc_kerml:memberElement a rdf:Property ;
...
oslc_kerml:membership a rdf:Property ;
    rdfs:label "membership" ;
...
oslc_kerml:membershipOwningNamespace a rdf:Property ;
...
oslc_kerml:name a rdf:Property ;
    rdfs:label "name" ;
...
oslc_kerml:operator a rdf:Property ;
    rdfs:label "operator" ;
...
oslc_kerml:originalType a rdf:Property ;
...
oslc_kerml:ownedAnnotatingRelationship a rdf:Property ;
...
oslc_kerml:ownedAnnotation a rdf:Property ;
...
oslc_kerml:ownedDifferencing a rdf:Property ;
...
oslc_kerml:ownedDisjoining a rdf:Property ;
...
oslc_kerml:ownedElement a rdf:Property ;
...
oslc_kerml:ownedFeatureInverting a rdf:Property ;
...
oslc_kerml:ownedFeatureMembership a rdf:Property ;
...
oslc_kerml:ownedImport a rdf:Property ;
...
oslc_kerml:ownedIntersecting a rdf:Property ;
...
oslc_kerml:ownedMember a rdf:Property ;
...
oslc_kerml:ownedMemberElement a rdf:Property ;
...
oslc_kerml:ownedRedefinition a rdf:Property ;
...
oslc_kerml:ownedReferenceSubsetting a rdf:Property ;
...
oslc_kerml:ownedRelatedElement a rdf:Property ;
...
oslc_kerml:ownedSpecialization a rdf:Property ;
...
oslc_kerml:ownedSubclassification a rdf:Property ;
...
oslc_kerml:ownedSubsetting a rdf:Property ;
...
oslc_kerml:ownedTypeFeaturing a rdf:Property ;
...
oslc_kerml:ownedTyping a rdf:Property ;
...
oslc_kerml:ownedUnioning a rdf:Property ;
...
oslc_kerml:owner a rdf:Property ;
    rdfs:label "owner" ;
...
oslc_kerml:owningAnnotatedElement a rdf:Property ;
...
oslc_kerml:owningAnnotatingElement a rdf:Property ;
...
oslc_kerml:owningAnnotatingRelationship a rdf:Property ;
...
oslc_kerml:owningClassifier a rdf:Property ;
...
oslc_kerml:owningFeature a rdf:Property ;
...
oslc_kerml:owningFeatureMembership a rdf:Property ;
...
oslc_kerml:owningFeatureOfType a rdf:Property ;
...
oslc_kerml:owningRelatedElement a rdf:Property ;
...
oslc_kerml:owningRelationship a rdf:Property ;
...
oslc_kerml:owningType a rdf:Property ;
...
oslc_kerml:parameter a rdf:Property ;
...
oslc_kerml:predicate a rdf:Property ;
    rdfs:label "predicate" ;
...
oslc_kerml:protected a oslc_kerml:VisibilityKind ;
...
oslc_kerml:qualifiedName a rdf:Property ;
...
oslc_kerml:redefinedFeature a rdf:Property ;
...
oslc_kerml:redefiningFeature a rdf:Property ;
...
oslc_kerml:referencingFeature a rdf:Property ;
...
oslc_kerml:referent a rdf:Property ;
    rdfs:label "referent" ;
...
oslc_kerml:relatedElement a rdf:Property ;
...
oslc_kerml:relatedFeature a rdf:Property ;
...
oslc_kerml:relatedType a rdf:Property ;
...
oslc_kerml:representedElement a rdf:Property ;
...
oslc_kerml:sourceOutputFeature a rdf:Property ;
...
oslc_kerml:sourceType a rdf:Property ;
...
oslc_kerml:subsettingFeature a rdf:Property ;
...
oslc_kerml:targetInputFeature a rdf:Property ;
...
oslc_kerml:targetType a rdf:Property ;
...
oslc_kerml:textualRepresentation a rdf:Property ;
    rdfs:label "textualRepresentation" ;
    rdfs:comment "Element: The TextualRepresentations that annotate this Element." ;
    rdfs:isDefinedBy oslc_kerml: .

oslc_kerml:type a rdf:Property ;
    rdfs:label "type" ;
...
oslc_kerml:typeDifferenced a rdf:Property ;
...
oslc_kerml:typeUnioned a rdf:Property ;
...
oslc_kerml:upperBound a rdf:Property ;
...
oslc_kerml:value a rdf:Property ;
    rdfs:label "value" ;
...
oslc_kerml:visibility a rdf:Property ;
...
oslc_kerml: a owl:Ontology ;
    rdfs:label "OSLC KerML Vocabulary" ;
    dcterms:description "All vocabulary URIs defined in the OSLC KerML namespace."^^rdf:XMLLiteral ;
    ...
    dcterms:title "OSLC KerML Vocabulary" ;
    vann:preferredNamespacePrefix "oslc_kerml" .
