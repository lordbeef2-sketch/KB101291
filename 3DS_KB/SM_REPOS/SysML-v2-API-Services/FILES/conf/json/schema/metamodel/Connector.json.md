# OFFICIAL REPOSITORY FILE: SysML-v2-API-Services/conf/json/schema/metamodel/Connector.json

- repository: `SysML-v2-API-Services`
- source_path: `conf/json/schema/metamodel/Connector.json`
- source_url: https://github.com/Systems-Modeling/SysML-v2-API-Services/blob/0af711b14bbcea7b240bb0a3a65817ae68302092/conf/json/schema/metamodel/Connector.json
- source_bytes: 448297
- source_sha256: `d1cc3abc451a16378b0a89f96f10071d92764c8bf55bb97c0a49c203317cc33e`
- decoded_as: `utf-8`
...
````json
{
  ...
  "anyOf": [
    ...
    {
      "$ref": "https://www.omg.org/spec/SysML/20250201/Flow"
    },
    {
      "$ref": "https://www.omg.org/spec/SysML/20250201/Succession"
    },
    {
      "$ref": "https://www.omg.org/spec/SysML/20250201/BindingConnector"
    },
    {
      "$ref": "https://www.omg.org/spec/SysML/20250201/ConnectorAsUsage"
    }
  ],
  "$defs": {
    "Identified": {
    ...
    "Flow": {
      ...
      "anyOf": [
        ...
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/SuccessionFlow"
        },
        {
    ...
    "SuccessionFlow": {
      "$id": "https://www.omg.org/spec/SysML/20250201/SuccessionFlow",
      "title": "SuccessionFlow",
      "anyOf": [
        {
          "type": "object",
          "properties": {
    ...
    "Succession": {
      "$id": "https://www.omg.org/spec/SysML/20250201/Succession",
      "title": "Succession",
      "anyOf": [
        {
          "type": "object",
        ...
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/SuccessionAsUsage"
        }
      ]
    },
    "SuccessionAsUsage": {
      "$id": "https://www.omg.org/spec/SysML/20250201/SuccessionAsUsage",
    ...
    "BindingConnector": {
      ...
      "anyOf": [
        ...
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/BindingConnectorAsUsage"
        }
      ]
    },
    ...
    "ConnectorAsUsage": {
      ...
      "anyOf": [
        ...
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/ConnectionUsage"
        },
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/SuccessionAsUsage"
        },
    ...
    "ConnectionUsage": {
      ...
      "anyOf": [
        ...
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/InterfaceUsage"
        },
        {
          "$ref": "https://www.omg.org/spec/SysML/20250201/AllocationUsage"
        }
      ]
    },
    "InterfaceUsage": {
      "$id": "https://www.omg.org/spec/SysML/20250201/InterfaceUsage",
