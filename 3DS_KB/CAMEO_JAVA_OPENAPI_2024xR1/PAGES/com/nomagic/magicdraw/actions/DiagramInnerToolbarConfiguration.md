# JAVA OPENAPI: DiagramInnerToolbarConfiguration (2024x API)

- source_url: https://jdocs.nomagic.com/2024xRefresh1/com/nomagic/magicdraw/actions/DiagramInnerToolbarConfiguration.html
- source_path: `com/nomagic/magicdraw/actions/DiagramInnerToolbarConfiguration.html`
- source_sha256: `269f69605852f1e392919259558fa8d0e6508447ecb85fec77b8480e94712a9b`
- captured_utc: `2026-07-14T16:51:01.583941+00:00`
...
Constructor
Description
`[DiagramInnerToolbarConfiguration](#%3Cinit%3E(java.lang.String,javax.swing.Icon,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
...
`[DiagramInnerToolbarConfiguration](#%3Cinit%3E(java.lang.String,javax.swing.Icon,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 boolean expandedByDefault)`

`[DiagramInnerToolbarConfiguration](#%3Cinit%3E(javax.swing.Icon,java.lang.String))([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name)`

`[DiagramInnerToolbarConfiguration](#%3Cinit%3E(javax.swing.Icon,java.lang.String,boolean))([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 boolean expandedByDefault)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
public DiagramInnerToolbarConfiguration(@CheckForNull
 ...
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name)
DiagramInnerToolbarConfiguration
public DiagramInnerToolbarConfiguration([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name)
DiagramInnerToolbarConfiguration
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(javax.swing.Icon,java.lang.String)">DiagramInnerToolbarConfiguration</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a> icon,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(javax.swing.Icon,java.lang.String,boolean)">DiagramInnerToolbarConfiguration</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a> icon,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 boolean expandedByDefault)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setExpandByDefault(boolean)">setExpandByDefault</a><wbr/>(boolean expandByDefault)</code></div>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../../actions/ActionsCategory.html#clone()">ActionsCategory</a></code></span></div>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../../actions/ActionsCategory.html#shallowClone()">ActionsCategory</a></code></span></div>
<div class="block">Clones the category. During clone does not fire any property change events.
 Does deep clone.</div>
<dl class="notes">
<dt>Overrides:</dt>
