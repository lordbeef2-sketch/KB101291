# JAVA OPENAPI: ReqIFException (2024x API)

- source_url: https://jdocs.nomagic.com/2024xRefresh1/com/nomagic/requirements/reqif/ReqIFException.html
- source_path: `com/nomagic/requirements/reqif/ReqIFException.html`
- source_sha256: `2f244de2068f820351638a318d7a51b94fc059971306b65d77692ae700c19593`
- captured_utc: `2026-07-14T16:52:21.307003+00:00`
...
Constructor
Description
`[ReqIFException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)`

`[ReqIFException](#%3Cinit%3E(java.lang.String,java.lang.Throwable))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message,
...
Constructor Details
ReqIFException
public ReqIFException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)
ReqIFException
public ReqIFException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html) cause)
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">ReqIFException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
...
<h3>ReqIFException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ReqIFException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
