# JAVA OPENAPI: AbstractPropertyOptionsGroup (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/core/options/AbstractPropertyOptionsGroup.html
- source_path: `com/nomagic/magicdraw/core/options/AbstractPropertyOptionsGroup.html`
- source_sha256: `21f12e9fcd753687f39d3600b74520be29c22b76b69690d8a0139086565e04f0`
- captured_utc: `2026-07-14T16:55:12.635977+00:00`
...
`protected void`
`[afterLoadAdditionalAction](#afterLoadAdditionalAction(boolean))(boolean pluginsLoaded)`

`void`
`[beforeLoad](#beforeLoad(boolean))(boolean pluginsLoaded)`

`protected [AbstractPropertyOptionsGroup](AbstractPropertyOptionsGroup.html)`
`[clone](#clone())()`

`final [PropertyManager](../../properties/PropertyManager.html)`
`[createDefault](#createDefault())()`
Creates default values for properties.
`[PropertyManager](../../properties/PropertyManager.html)`
`[createOptions](#createOptions())()`
Creates a property manager for the group.
...
`protected void`
`[fixProperty](#fixProperty(java.lang.String,java.lang.Runnable))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) propertyID,
...
Method Details
createDefault
public final [PropertyManager](../../properties/PropertyManager.html) createDefault()
Creates default values for properties.
Returns:
property manager with properties having default values.
createOptions
public [PropertyManager](../../properties/PropertyManager.html) createOptions()
Creates a property manager for the group.
Returns:
...
Creates options panel for editing the properties.
Specified by:
`[createOptionsPanel](OptionsGroup.html#createOptionsPanel())` in class `[OptionsGroup](OptionsGroup.html)`
Returns:
...
Overrides:
`[getOptionsToSave](OptionsGroup.html#getOptionsToSave())` in class `[OptionsGroup](OptionsGroup.html)`
loadOptions
public void loadOptions([Style](../../properties/Style.html) style,
 boolean pluginsLoaded)
Overrides:
`[loadOptions](OptionsGroup.html#loadOptions(com.nomagic.magicdraw.properties.Style,boolean))` in class `[OptionsGroup](OptionsGroup.html)`
afterLoad
protected void afterLoad(com.nomagic.magicdraw.lic.MDVersion version,
 boolean pluginsLoaded)
Overrides:
`[afterLoad](OptionsGroup.html#afterLoad(com.nomagic.magicdraw.lic.MDVersion,boolean))` in class `[OptionsGroup](OptionsGroup.html)`
...
Overrides:
`[beforeLoad](OptionsGroup.html#beforeLoad(boolean))` in class `[OptionsGroup](OptionsGroup.html)`
setOptions
...
`invisible` - visibility flag value.
clone
protected [AbstractPropertyOptionsGroup](AbstractPropertyOptionsGroup.html) clone()
Overrides:
`[clone](OptionsGroup.html#clone())` in class `[OptionsGroup](OptionsGroup.html)`
getCopy
public [AbstractPropertyOptionsGroup](AbstractPropertyOptionsGroup.html) getCopy()
fixProperty
protected void fixProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) propertyID,
 [Runnable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Runnable.html) runnable)
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#afterLoadAdditionalAction(boolean)">afterLoadAdditionalAction</a><wbr/>(boolean pluginsLoaded)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#beforeLoad(boolean)">beforeLoad</a><wbr/>(boolean pluginsLoaded)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="AbstractPropertyOptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">AbstractPropertyOptionsGroup</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createDefault()">createDefault</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates default values for properties.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createOptions()">createOptions</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates a property manager for the group.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#fixProperty(java.lang.String,java.lang.Runnable)">fixProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> propertyID,
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="AbstractPropertyOptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">AbstractPropertyOptionsGroup</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#hasVisibleOptions()">hasVisibleOptions</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#loadOptions(com.nomagic.magicdraw.properties.Style,boolean)">loadOptions</a><wbr/>(<a href="../../properties/Style.html" title="class in com.nomagic.magicdraw.properties">Style</a> style,
 boolean pluginsLoaded)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<ul class="member-list">
<li>
<section class="detail" id="createDefault()">
<h3>createDefault</h3>
<div class="member-signature"><span class="modifiers">public final</span> <span class="return-type"><a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a></span> <span class="element-name">createDefault</span>()</div>
<div class="block">Creates default values for properties.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>property manager with properties having default values.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createOptions()">
<h3>createOptions</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a></span> <span class="element-name">createOptions</span>()</div>
<div class="block">Creates a property manager for the group.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>created property manager.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="OptionsGroup.html#createOptionsPanel()">createOptionsPanel</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="hasVisibleOptions()">
<h3>hasVisibleOptions</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">boolean</span> <span class="element-name">hasVisibleOptions</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="OptionsGroup.html#getOptionsToSave()">getOptionsToSave</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="OptionsGroup.html#loadOptions(com.nomagic.magicdraw.properties.Style,boolean)">loadOptions</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="OptionsGroup.html#afterLoad(com.nomagic.magicdraw.lic.MDVersion,boolean)">afterLoad</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="afterLoadAdditionalAction(boolean)">
<h3>afterLoadAdditionalAction</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">afterLoadAdditionalAction</span><wbr/><span class="parameters">(boolean pluginsLoaded)</span></div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="OptionsGroup.html#beforeLoad(boolean)">beforeLoad</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
</dl>
</section>
</li>
<li>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="AbstractPropertyOptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">AbstractPropertyOptionsGroup</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="OptionsGroup.html#clone()">clone</a></code> in class <code><a href="OptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">OptionsGroup</a></code></dd>
</dl>
</section>
</li>
<li>
...
<h3>getCopy</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="AbstractPropertyOptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">AbstractPropertyOptionsGroup</a></span> <span class="element-name">getCopy</span>()</div>
</section>
</li>
<li>
<section class="detail" id="fixProperty(java.lang.String,java.lang.Runnable)">
<h3>fixProperty</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">fixProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> propertyID,
