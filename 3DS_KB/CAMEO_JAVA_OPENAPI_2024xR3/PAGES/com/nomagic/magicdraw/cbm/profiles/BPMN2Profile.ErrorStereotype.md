# JAVA OPENAPI: BPMN2Profile.ErrorStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.ErrorStereotype.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.ErrorStereotype.html`
- source_sha256: `0b09b8c2c0468a985a12a5db410b6b0cba46f68d0e73405cf8b87bfa65107ce0`
- captured_utc: `2026-07-14T16:55:06.481909+00:00`
...
public static classBPMN2Profile.ErrorStereotype
...
Description
`protected`
`[ErrorStereotype](#%3Cinit%3E(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile))([BPMN2Profile](BPMN2Profile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearErrorCode](#clearErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`[getErrorCode](#getErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)`
`[getErrorCodeProperty](#getErrorCodeProperty())()`
...
`void`
`[setErrorCode](#setErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.STEREOTYPE_NAME)
ERRORCODE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ERRORCODE
For an End Event:
 If the Result is an Error, then the errorCode MUST be supplied (if the processType attribute of the Process is set to executable) This throws the error.
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.ERRORCODE)
STRUCTUREREF
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) STRUCTUREREF
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.STRUCTUREREF)
ID
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ID
This attribute is used to uniquely identify BPMN elements.
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.ID)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ErrorStereotype
protected ErrorStereotype([BPMN2Profile](BPMN2Profile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getErrorCodeProperty()
...
setErrorCode
public void setErrorCode([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)
clearErrorCode
public void clearErrorCode([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
getErrorCode
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getErrorCode([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setStructureRef
...
<h1 class="title" title="Class BPMN2Profile.ErrorStereotype">Class BPMN2Profile.ErrorStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">BPMN2Profile.ErrorStereotype</span>
...
<div class="block">For an End Event:
                 If the Result is an Error, then the errorCode MUST be supplied (if the processType attribute of the Process is set to executable) This    throws    the error.</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile)">ErrorStereotype</a><wbr/>(<a href="BPMN2Profile.html" title="class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearErrorCode</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getErrorCode</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getErrorCodeProperty()">getErrorCodeProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">setErrorCode</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ERRORCODE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ERRORCODE</span></div>
<div class="block">For an End Event:
                 If the Result is an Error, then the errorCode MUST be supplied (if the processType attribute of the Process is set to executable) This    throws    the error.
                 ...
                 For an Intermediate Event attached to the boundary of an Activity:
                 If the Trigger is an Error, then the errorCode MAY be entered. This Event    catches    the error. If there is no errorCode, then any error SHALL trigger the Event. If there is an errorCode, then only an error that matches the errorCode SHALL trigger the Event.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.ERRORCODE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.STRUCTUREREF">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.ErrorStereotype.ID">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ErrorStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ErrorStereotype</span><wbr/><span class="parameters">(<a href="BPMN2Profile.html" title="class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getErrorCodeProperty()">
<h3>getErrorCodeProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getErrorCodeProperty</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="setErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String)">
<h3>setErrorCode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setErrorCode</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearErrorCode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearErrorCode</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getErrorCode(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getErrorCode</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getErrorCode</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
