# JAVA OPENAPI: PasswordProtectException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/teamwork2/esi/protect/PasswordProtectException.html
- source_path: `com/nomagic/magicdraw/teamwork2/esi/protect/PasswordProtectException.html`
- source_sha256: `d0a916098c4fcfb2aea4d42eb4f9c46d545f7c05fd4a733cf86276ed5ed4ee7f`
- captured_utc: `2026-07-14T16:55:38.825270+00:00`
...
## Class PasswordProtectException
...
@OpenApiAllpublic classPasswordProtectException
...
1.0
See Also:
[Serialized Form](../../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.esi.protect.PasswordProtectException)
...
Constructor
Description
`[PasswordProtectException](#%3Cinit%3E())()`
Creates and initializes a new `PasswordProtectException`.
`[PasswordProtectException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)`
Creates and initializes a new `PasswordProtectException` from specified parameter.
`[PasswordProtectException](#%3Cinit%3E(java.lang.String,java.lang.Throwable))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html) cause)`
Creates and initializes a new `PasswordProtectException` from specified parameters.
`[PasswordProtectException](#%3Cinit%3E(java.lang.Throwable))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html) cause)`
Creates and initializes a new `PasswordProtectException` from specified parameter.
 ========== METHOD SUMMARY =========== 
Method Summary
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
PasswordProtectException
public PasswordProtectException()
Creates and initializes a new `PasswordProtectException`.
PasswordProtectException
public PasswordProtectException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)
Creates and initializes a new `PasswordProtectException` from specified parameter.
Parameters:
`message` - error message.
PasswordProtectException
public PasswordProtectException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html) cause)
Creates and initializes a new `PasswordProtectException` from specified parameter.
Parameters:
...
<h1 class="title" title="Class PasswordProtectException">Class PasswordProtectException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.teamwork2.esi.protect.PasswordProtectException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PasswordProtectException</span>
...
<div class="block">Identifies password protect failures.</div>
<dl class="notes">
<dt>Version:</dt>
<dd>1.0</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.esi.protect.PasswordProtectException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PasswordProtectException</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates and initializes a new <code>PasswordProtectException</code>.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">PasswordProtectException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates and initializes a new <code>PasswordProtectException</code> from specified parameter.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Throwable)">PasswordProtectException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
...
<div class="col-last even-row-color">
<div class="block">Creates and initializes a new <code>PasswordProtectException</code> from specified parameters.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Throwable)">PasswordProtectException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html" title="class or interface in java.lang">Throwable</a> cause)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates and initializes a new <code>PasswordProtectException</code> from specified parameter.</div>
</div>
</div>
...
<h3>PasswordProtectException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PasswordProtectException</span>()</div>
<div class="block">Creates and initializes a new <code>PasswordProtectException</code>.</div>
</section>
</li>
<li>
...
<h3>PasswordProtectException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PasswordProtectException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</span></div>
<div class="block">Creates and initializes a new <code>PasswordProtectException</code> from specified parameter.</div>
<dl class="notes">
<dt>Parameters:</dt>
