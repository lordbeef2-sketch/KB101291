# JAVA OPENAPI: MagicDrawTestRunner (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/tests/MagicDrawTestRunner.html
- source_path: `com/nomagic/magicdraw/tests/MagicDrawTestRunner.html`
- source_sha256: `4889ebd9d52c280e497fbec921276946efb03b113ca0f12f51026fd5f3cd27a7`
- captured_utc: `2026-07-14T16:55:39.066274+00:00`
...
@OpenApiAllpublic classMagicDrawTestRunner
...
Constructor
Description
`[MagicDrawTestRunner](#%3Cinit%3E(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> aClass)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`protected [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<org.junit.rules.TestRule>`
`[getTestRules](#getTestRules(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) target)`
...
Constructor Details
MagicDrawTestRunner
public MagicDrawTestRunner([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> aClass)
...
Method Details
getTestRules
protected [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<org.junit.rules.TestRule> getTestRules([Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) target)
Overrides:
...
<h1 class="title" title="Class MagicDrawTestRunner">Class MagicDrawTestRunner</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.tests.MagicDrawTestRunner</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">MagicDrawTestRunner</span>
<span class="extends-implements">extends org.junit.runners.BlockJUnit4ClassRunner</span></div>
<div class="block">Test runner which starts application and checks for memory leaks after each test finish.
 To use this class annotate test class with such text:<br/>
<code>@RunWith(MagicDrawTestRunner.class)</code></div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class)">MagicDrawTestRunner</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; aClass)</code></div>
...
<code>childrenInvoker, classBlock, classRules, createTestClass, filter, getDescription, getName, getRunnerAnnotations, getTestClass, order, run, runLeaf, setScheduler, sort, validatePublicVoidNoArgMethods, withAfterClasses, withBeforeClasses, withInterruptIsolation</code></div>
<div class="inherited-list">
...
<h3>MagicDrawTestRunner</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MagicDrawTestRunner</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; aClass)</span>
