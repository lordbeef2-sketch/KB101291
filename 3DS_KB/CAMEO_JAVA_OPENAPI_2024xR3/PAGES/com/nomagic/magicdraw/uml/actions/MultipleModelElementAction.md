# JAVA OPENAPI: MultipleModelElementAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/actions/MultipleModelElementAction.html
- source_path: `com/nomagic/magicdraw/uml/actions/MultipleModelElementAction.html`
- source_sha256: `edef073aea1bc446772422db0129fb08535c0c2311e8022a38c2777761842adb`
- captured_utc: `2026-07-14T16:55:55.607461+00:00`
...
Constructor
Description
`[MultipleModelElementAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionID,
...
Constructor
`[MultipleModelElementAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionID,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionName,
 [KeyStroke](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/KeyStroke.html) stroke,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) group,
 boolean useSchema)`
...
Returns data from selected node.
`[ModelElementsProvider](../ModelElementsProvider.html)`
`[getElementsProvider](#getElementsProvider())()`
Gets the provider.
`void`
`[setElementsProvider](#setElementsProvider(com.nomagic.magicdraw.uml.ModelElementsProvider))([ModelElementsProvider](../ModelElementsProvider.html) provider)`
...
`[getProvider](SingleModelElementAction.html#getProvider()), [setProvider](SingleModelElementAction.html#setProvider(com.nomagic.magicdraw.uml.ModelElementProvider))`
...
Method Details
getElements
protected [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getElements()
Returns data from selected node.
 If there are no selected nodes, or more than one selected node returns null.
Returns:
element
createCollection
public static <T> [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<T> createCollection(@CheckForNull
 T element)
Utility method to create an empty collection in case given element is null or a singleton collection in other case.
Parameters:
`element` - element
...
collection
setElementsProvider
public void setElementsProvider([ModelElementsProvider](../ModelElementsProvider.html) provider)
Set provider for action
Specified by:
`[setElementsProvider](IMultipleModelElementAction.html#setElementsProvider(com.nomagic.magicdraw.uml.ModelElementsProvider))` in interface `[IMultipleModelElementAction](IMultipleModelElementAction.html)`
Parameters:
`provider` - the provider to set
getElementsProvider
public [ModelElementsProvider](../ModelElementsProvider.html) getElementsProvider()
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../ModelElementsProvider.html" title="interface in com.nomagic.magicdraw.uml">ModelElementsProvider</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setElementsProvider(com.nomagic.magicdraw.uml.ModelElementsProvider)">setElementsProvider</a><wbr/>(<a href="../ModelElementsProvider.html" title="interface in com.nomagic.magicdraw.uml">ModelElementsProvider</a> provider)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<code><a href="SingleModelElementAction.html#getProvider()">getProvider</a>, <a href="SingleModelElementAction.html#setProvider(com.nomagic.magicdraw.uml.ModelElementProvider)">setProvider</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="setElementsProvider(com.nomagic.magicdraw.uml.ModelElementsProvider)">
<h3>setElementsProvider</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setElementsProvider</span><wbr/><span class="parameters">(<a href="../ModelElementsProvider.html" title="interface in com.nomagic.magicdraw.uml">ModelElementsProvider</a> provider)</span></div>
<div class="block">Set provider for action</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="IMultipleModelElementAction.html#setElementsProvider(com.nomagic.magicdraw.uml.ModelElementsProvider)">setElementsProvider</a></code> in interface <code><a href="IMultipleModelElementAction.html" title="interface in com.nomagic.magicdraw.uml.actions">IMultipleModelElementAction</a></code></dd>
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../ModelElementsProvider.html" title="interface in com.nomagic.magicdraw.uml">ModelElementsProvider</a></span> <span class="element-name">getElementsProvider</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code><a href="IMultipleModelElementAction.html#getElementsProvider()">IMultipleModelElementAction</a></code></span></div>
<div class="block">Gets the provider.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="SingleModelElementAction.html#getElement()">SingleModelElementAction</a></code></span></div>
<div class="block">Returns data from selected node.
 If there are no selected nodes, or more than one selected node returns null.</div>
<dl class="notes">
<dt>Overrides:</dt>
