# JAVA OPENAPI: Finder.ByHyperlinkFinder (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/Finder.ByHyperlinkFinder.html
- source_path: `com/nomagic/magicdraw/uml/Finder.ByHyperlinkFinder.html`
- source_sha256: `d93c040daa66b580b05836525a4786a0f6a3cb630cf4cdd7ffb703eaa2722a79`
- captured_utc: `2026-07-14T16:55:54.591449+00:00`
...
`[find](#find(com.nomagic.magicdraw.core.Project,java.lang.String))([Project](../core/Project.html) project,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) elementHyperlink)`
Find element in the given project by element hyperlink.
`boolean`
`[isElementHyperlink](#isElementHyperlink(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string)`
...
element.
isElementHyperlink
public boolean isElementHyperlink([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string)
Check if given string is element hyperlink.
Parameters:
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#find(com.nomagic.magicdraw.core.Project,java.lang.String)">find</a><wbr/>(<a href="../core/Project.html" title="class in com.nomagic.magicdraw.core">Project</a> project,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> elementHyperlink)</code></div>
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> elementHyperlink)</span></div>
<div class="block">Find element in the given project by element hyperlink.</div>
<dl class="notes">
<dt>Parameters:</dt>
