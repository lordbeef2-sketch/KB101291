# JAVA OPENAPI: ContainmentLinkView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/ContainmentLinkView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/ContainmentLinkView.html`
- source_sha256: `9da00b8bce840b87d243961be6cb71559667b11cae2cfafa8f7521ddf530185f`
- captured_utc: `2026-07-14T16:56:00.304513+00:00`
...
`[BaseElement](../../BaseElement.html)`, `[MDElement](../../MDElement.html)`, `[ModelElementProvider](../../ModelElementProvider.html)`, `com.nomagic.magicdraw.uml.symbols.LineJumpDrawer`, `com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector`, `com.nomagic.magicdraw.uml.symbols.SuspendShapeAutoResizeModeProvider`, `[NameOwner](../../../utils/NameOwner.html)`, `[PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[EventListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/EventListener.html)`

@OpenApipublic classContainmentLinkView
...
Constructor
Description
`[ContainmentLinkView](#%3Cinit%3E())()`

`[ContainmentLinkView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[asPathElement](#asPathElement())()`

`com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape`
`[createTreeShape](#createTreeShape())()`

`void`
`[dispose](#dispose())()`
Disconnect this link from shapes.
`[Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html)`
`[drawAnchor](#drawAnchor(java.awt.Graphics2D,int,int,int,int,int,boolean,java.awt.Color))([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 int ix1,
 int iy1,
 int ix2,
 int iy2,
 int size,
 boolean fill,
 [Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) fillColor)`
...
`[getInternalStroke](#getInternalStroke(boolean,int))(boolean line,
 int width)`

`com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape`
`[getTreeShape](#getTreeShape())()`
...
`void`
`[retrieveDataFromTreeView](#retrieveDataFromTreeView(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape))(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)`

`void`
`[setChildElement](#setChildElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement))([NamedElement](../../../../uml2/ext/magicdraw/classes/mdkernel/NamedElement.html) newChild)`
Change child element of this containment link.
`void`
`[setClient](#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) obj)`
Sets client for this link.
`void`
`[setSimple](#setSimple(boolean))(boolean simple)`
...
Method Details
asPathElement
public [PathElement](PathElement.html) asPathElement()
Specified by:
...
Description copied from class: `[PathElement](PathElement.html#getActualClientDrawPoint())`
Returns actual client side draw point.
Overrides:
`[getActualClientDrawPoint](PathElement.html#getActualClientDrawPoint())` in class `[PathElement](PathElement.html)`
Returns:
...
Description copied from class: `[PathElement](PathElement.html#getActualSupplierDrawPoint())`
Returns actual supplier side draw point.
Overrides:
`[getActualSupplierDrawPoint](PathElement.html#getActualSupplierDrawPoint())` in class `[PathElement](PathElement.html)`
Returns:
actual supplier draw point.
drawAnchor
public [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) drawAnchor([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 int ix1,
 int iy1,
 int ix2,
 int iy2,
...
Overrides:
`[accept](PathElement.html#accept(com.nomagic.magicdraw.uml.Visitor))` in class `[PathElement](PathElement.html)`
Parameters:
`visitor` - - the Visitor
Throws:
...
Description copied from class: `[PathElement](PathElement.html#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement))`
Sets supplier end for link.
...
Overrides:
`[setSupplier](PathElement.html#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement))` in class `[PathElement](PathElement.html)`
Parameters:
`shape` - new supplier.
setClient
public void setClient([PresentationElement](../PresentationElement.html) obj)
Description copied from class: `[PathElement](PathElement.html#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement))`
Sets client for this link.
 Changes parent object to the parent of client.
 Client's parent will always contain incoming links.
Overrides:
`[setClient](PathElement.html#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement))` in class `[PathElement](PathElement.html)`
Parameters:
`obj` - shape to check
setChildElement
public void setChildElement(@CheckForNull
 [NamedElement](../../../../uml2/ext/magicdraw/classes/mdkernel/NamedElement.html) newChild)
...
Overrides:
`[preDisposeOnUpdate](PathElement.html#preDisposeOnUpdate())` in class `[PathElement](PathElement.html)`
Returns:
true if symbol must be disposed
isRectilinear
public boolean isRectilinear()
Overrides:
`[isRectilinear](PathElement.html#isRectilinear())` in class `[PathElement](PathElement.html)`
Returns:
...
`tree` - new tree of this link.
getTreeShape
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape getTreeShape()
Specified by:
`getTreeShape` in interface `com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector`
dispose
public void dispose()
Description copied from class: `[PathElement](PathElement.html#dispose())`
Disconnect this link from shapes.
Specified by:
`[dispose](../../BaseElement.html#dispose())` in interface `[BaseElement](../../BaseElement.html)`
Overrides:
`[dispose](PathElement.html#dispose())` in class `[PathElement](PathElement.html)`
...
public [BasicStroke](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/BasicStroke.html) internalGetPresentationElementStroke(boolean line,
 int width)
Description copied from class: `[PathElement](PathElement.html#internalGetPresentationElementStroke(boolean,int))`
This method must be overridden, if you need to use DASHED_STROKE or another one.
Overrides:
`[internalGetPresentationElementStroke](PathElement.html#internalGetPresentationElementStroke(boolean,int))` in class `[PathElement](PathElement.html)`
Parameters:
...
getInternalStroke
public [BasicStroke](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/BasicStroke.html) getInternalStroke(boolean line,
 int width)
Specified by:
...
<h1 class="title" title="Class ContainmentLinkView">Class ContainmentLinkView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.ContainmentLinkView</div>
</div>
</div>
</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ContainmentLinkView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ContainmentLinkView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="block">accept method for Visitor</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#asPathElement()">asPathElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createTreeShape()">createTreeShape</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#drawAnchor(java.awt.Graphics2D,int,int,int,int,int,boolean,java.awt.Color)">drawAnchor</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 int ix1,
 int iy1,
 int ix2,
 int iy2,
 int size,
 boolean fill,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> fillColor)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getInternalStroke(boolean,int)">getInternalStroke</a><wbr/>(boolean line,
 int width)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getTreeShape()">getTreeShape</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/BasicStroke.html" title="class or interface in java.awt">BasicStroke</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#internalGetPresentationElementStroke(boolean,int)">internalGetPresentationElementStroke</a><wbr/>(boolean line,
 int width)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isSimple()">isSimple</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#retrieveDataFromTreeView(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">retrieveDataFromTreeView</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setChildElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">setChildElement</a><wbr/>(<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a> newChild)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Change child element of this containment link.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement)">setClient</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets client for this link.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setSimple(boolean)">setSimple</a><wbr/>(boolean simple)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement)">setSupplier</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> shape)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets supplier end for link.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setTreeShape(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">setTreeShape</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new tree view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetSimple(boolean)">sSetSimple</a><wbr/>(boolean simple)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetTreeShape(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">sSetTreeShape</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets new tree view.</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector">Methods inherited from interface com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</h3>
<code>getClassType, getID, prepareForLineDrawing, updateTreeShapeByTreeShapeConnector</code></div>
</section>
</li>
</ul>
</section>
...
<h3>ContainmentLinkView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ContainmentLinkView</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>ContainmentLinkView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ContainmentLinkView</span>()</div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="asPathElement()">
<h3>asPathElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></span> <span class="element-name">asPathElement</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>asPathElement</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createTreeShape()">
<h3>createTreeShape</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape</span> <span class="element-name">createTreeShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>createTreeShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#getActualClientDrawPoint()">PathElement</a></code></span></div>
<div class="block">Returns actual client side draw point.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#getActualClientDrawPoint()">getActualClientDrawPoint</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#getActualSupplierDrawPoint()">PathElement</a></code></span></div>
<div class="block">Returns actual supplier side draw point.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#getActualSupplierDrawPoint()">getActualSupplierDrawPoint</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="drawAnchor(java.awt.Graphics2D,int,int,int,int,int,boolean,java.awt.Color)">
<h3>drawAnchor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></span> <span class="element-name">drawAnchor</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 int ix1,
 int iy1,
 int ix2,
 int iy2,
 int size,
 boolean fill,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> fillColor)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>drawAnchor</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#accept(com.nomagic.magicdraw.uml.Visitor)">accept</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PathElement</a></code></span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement)">setSupplier</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
...
<h3>setClient</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setClient</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PathElement</a></code></span></div>
<div class="block">Sets client for this link.
 Changes parent object to the parent of client.
 Client's parent will always contain incoming links.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#setClient(com.nomagic.magicdraw.uml.symbols.PresentationElement)">setClient</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
<dd><code>obj</code> - shape to check</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setChildElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">
<h3>setChildElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setChildElement</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../../../uml2/ext/magicdraw/classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a> newChild)</span></div>
<div class="block">Change child element of this containment link. Registers listener to a new child (removes listener from the old one)</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>newChild</code> - child</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#preDisposeOnUpdate()">preDisposeOnUpdate</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#isRectilinear()">isRectilinear</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setSimple(boolean)">
<h3>setSimple</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setSimple</span><wbr/><span class="parameters">(boolean simple)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>setSimple</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetSimple(boolean)">
<h3>sSetSimple</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetSimple</span><wbr/><span class="parameters">(boolean simple)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>sSetSimple</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>isSimple</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setTreeShape(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">
<h3>setTreeShape</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setTreeShape</span><wbr/><span class="parameters">(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</span></div>
<div class="block">Sets new tree view.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>setTreeShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
<dt>Parameters:</dt>
<dd><code>tree</code> - new tree of this link.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetTreeShape(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">
<h3>sSetTreeShape</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetTreeShape</span><wbr/><span class="parameters">(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</span></div>
<div class="block">Sets new tree view.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>sSetTreeShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
<dt>Parameters:</dt>
<dd><code>tree</code> - new tree of this link.</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getTreeShape()">
<h3>getTreeShape</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape</span> <span class="element-name">getTreeShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getTreeShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#dispose()">PathElement</a></code></span></div>
<div class="block">Disconnect this link from shapes.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#dispose()">dispose</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="retrieveDataFromTreeView(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">
<h3>retrieveDataFromTreeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">retrieveDataFromTreeView</span><wbr/><span class="parameters">(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>retrieveDataFromTreeView</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/BasicStroke.html" title="class or interface in java.awt">BasicStroke</a></span> <span class="element-name">internalGetPresentationElementStroke</span><wbr/><span class="parameters">(boolean line,
 int width)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#internalGetPresentationElementStroke(boolean,int)">PathElement</a></code></span></div>
<div class="block">This method must be overridden, if you need to use DASHED_STROKE or another one.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#internalGetPresentationElementStroke(boolean,int)">internalGetPresentationElementStroke</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="getInternalStroke(boolean,int)">
<h3>getInternalStroke</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/BasicStroke.html" title="class or interface in java.awt">BasicStroke</a></span> <span class="element-name">getInternalStroke</span><wbr/><span class="parameters">(boolean line,
 int width)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getInternalStroke</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
</ul>
