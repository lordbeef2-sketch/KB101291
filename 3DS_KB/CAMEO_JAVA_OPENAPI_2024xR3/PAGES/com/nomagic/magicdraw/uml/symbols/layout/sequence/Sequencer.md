# JAVA OPENAPI: Sequencer (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/layout/sequence/Sequencer.html
- source_path: `com/nomagic/magicdraw/uml/symbols/layout/sequence/Sequencer.html`
- source_sha256: `9f8a541a4fab66ad7e140295059a342e54603c9534f40557ed44ed15ee669cc9`
- captured_utc: `2026-07-14T16:55:58.920497+00:00`
...
All Superinterfaces:
`[Comparator](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Comparator.html)<[ShapeElement](../../shapes/ShapeElement.html)>`

All Known Implementing Classes:
`[NameSequencer](NameSequencer.html)`, `[NumberingSequencer](NumberingSequencer.html)`, `[UnspecifiedSequencer](UnspecifiedSequencer.html)`

@OpenApiAllpublic interfaceSequencerextends [Comparator](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Comparator.html)<[ShapeElement](../../shapes/ShapeElement.html)>
...
sequencer name
compare
int compare([ShapeElement](../../shapes/ShapeElement.html) o1,
 [ShapeElement](../../shapes/ShapeElement.html) o2)
Specified by:
...
<h1 class="title" title="Interface Sequencer">Interface Sequencer</h1>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Superinterfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Comparator.html" title="class or interface in java.util">Comparator</a>&lt;<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a>&gt;</code></dd>
</dl>
<dl class="notes">
<dt>All Known Implementing Classes:</dt>
<dd><code><a href="NameSequencer.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.sequence">NameSequencer</a></code>, <code><a href="NumberingSequencer.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.sequence">NumberingSequencer</a></code>, <code><a href="UnspecifiedSequencer.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.sequence">UnspecifiedSequencer</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">Sequencer</span><span class="extends-implements">
extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Comparator.html" title="class or interface in java.util">Comparator</a>&lt;<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a>&gt;</span></div>
<div class="block">Sequencer used to determine the node sequence within a layer.
 Mostly used in hierarchic layouters</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#compare(com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement)">compare</a><wbr/>(<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> o1,
...
<h3>compare</h3>
<div class="member-signature"><span class="return-type">int</span> <span class="element-name">compare</span><wbr/><span class="parameters">(<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> o1,
