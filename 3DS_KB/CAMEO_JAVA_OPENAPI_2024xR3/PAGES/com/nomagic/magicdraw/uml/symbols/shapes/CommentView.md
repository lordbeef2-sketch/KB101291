# JAVA OPENAPI: CommentView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/CommentView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/CommentView.html`
- source_sha256: `5229c41d10ae7ad0f4b74758683280e793c1bd8ab8084badbd60b8b607be5ab5`
- captured_utc: `2026-07-14T16:56:02.577536+00:00`
...
Constructor
Description
`[CommentView](#%3Cinit%3E())()`

`[CommentView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`com.nomagic.magicdraw.uml.symbols.shapes.TextObject`
...
`void`
`[setOwnerDisplayMode](#setOwnerDisplayMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`
Sets the owner display mode and updates the view.
`void`
`[sSetHTMLText](#sSetHTMLText(boolean))(boolean isHtml)`

`void`
`[sSetOwnerDisplayMode](#sSetOwnerDisplayMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`
...
public CommentView()
CommentView
public CommentView(@CheckForNull
...
getOwnerDisplayMode
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getOwnerDisplayMode()
...
public void sSetOwnerDisplayMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
Description copied from interface: `com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner`
Sets the owner display mode without updating shape view.
Specified by:
...
`mode` - the new mode
setOwnerDisplayMode
public void setOwnerDisplayMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
Description copied from interface: `com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner`
Sets the owner display mode and updates the view.
Specified by:
...
getElement
public [Comment](../../../../uml2/ext/magicdraw/classes/mdkernel/Comment.html) getElement()
...
<h1 class="title" title="Class CommentView">Class CommentView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.CommentView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CommentView</span>
<span class="extends-implements">extends com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView
implements com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable, com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</span></div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">CommentView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">CommentView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.TextObject</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCommentBody()">getCommentBody</a>()</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Comment.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Comment</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getOwnerDisplayMode()">getOwnerDisplayMode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets the owner display mode string.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getUserText()">getUserText</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isHorizontalCenterlineProvider()">isHorizontalCenterlineProvider</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isHTMLText()">isHTMLText</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setOwnerDisplayMode(java.lang.String)">setOwnerDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets the owner display mode and updates the view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetHTMLText(boolean)">sSetHTMLText</a><wbr/>(boolean isHtml)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetOwnerDisplayMode(java.lang.String)">sSetOwnerDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets the owner display mode without updating shape view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updateName()">updateName</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<h3>CommentView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CommentView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>CommentView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CommentView</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="getCommentBody()">
<h3>getCommentBody</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.TextObject</span> <span class="element-name">getCommentBody</span>()</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getOwnerDisplayMode</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></span></div>
<div class="block">Gets the owner display mode string.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getOwnerDisplayMode</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></dd>
<dt>Returns:</dt>
<dd>on of the <code>QNAME_DISPLAY_MODES</code> list elements.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetOwnerDisplayMode(java.lang.String)">
<h3>sSetOwnerDisplayMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetOwnerDisplayMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></span></div>
<div class="block">Sets the owner display mode without updating shape view.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>sSetOwnerDisplayMode</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></dd>
<dt>Parameters:</dt>
<dd><code>mode</code> - the new mode</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwnerDisplayMode(java.lang.String)">
<h3>setOwnerDisplayMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setOwnerDisplayMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></span></div>
<div class="block">Sets the owner display mode and updates the view.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>setOwnerDisplayMode</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.OwnerNameLabelOwner</code></dd>
<dt>Parameters:</dt>
<dd><code>mode</code> - the new mode</dd>
</dl>
</section>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>updateName</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Comment.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Comment</a></span> <span class="element-name">getElement</span>()</div>
