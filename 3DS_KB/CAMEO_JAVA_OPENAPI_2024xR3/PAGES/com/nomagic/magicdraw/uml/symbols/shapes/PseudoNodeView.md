# JAVA OPENAPI: PseudoNodeView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/PseudoNodeView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/PseudoNodeView.html`
- source_sha256: `3f830ed896d0b9c6ccd53f02c39fc013efe302217dfd6d59351922ded139802a`
- captured_utc: `2026-07-14T16:56:04.645560+00:00`
...
com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView
...
@OpenApipublic classPseudoNodeView
...
`static final int`
`[TYPE_FLOW_FINAL](#TYPE_FLOW_FINAL)`
...
Constructor
Description
`[PseudoNodeView](#%3Cinit%3E())()`

`[PseudoNodeView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`boolean`
`[isActivityFinalNode](#isActivityFinalNode())()`
...
Types for global access
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_INITIAL)
TYPE_FINAL
public static final int TYPE_FINAL
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_FINAL)
TYPE_FLOW_FINAL
public static final int TYPE_FLOW_FINAL
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_FLOW_FINAL)
GAP
public static final int GAP
Distance from outer to inner circle
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.GAP)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
PseudoNodeView
public PseudoNodeView()
PseudoNodeView
public PseudoNodeView(@CheckForNull
...
<h1 class="title" title="Class PseudoNodeView">Class PseudoNodeView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PseudoNodeView</span>
...
<div class="col-first even-row-color"><code>static final int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#TYPE_FLOW_FINAL">TYPE_FLOW_FINAL</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#TYPE_INITIAL">TYPE_INITIAL</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PseudoNodeView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PseudoNodeView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isActivityFinalNode()">isActivityFinalNode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this symbol represents activity final node.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isFlowFinalNode()">isFlowFinalNode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this symbol represents flow final node.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isInitialNode()">isInitialNode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this symbol represents initial node.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#minimumSizeIgnoringOrientation(java.awt.Dimension)">minimumSizeIgnoringOrientation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Dimension.html" title="class or interface in java.awt">Dimension</a> min)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets data type according to type of this view.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_INITIAL">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_FINAL">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="TYPE_FLOW_FINAL">
<h3>TYPE_FLOW_FINAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">TYPE_FLOW_FINAL</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.TYPE_FLOW_FINAL">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PseudoNodeView.GAP">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>PseudoNodeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PseudoNodeView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>PseudoNodeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PseudoNodeView</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="isInitialNode()">
<h3>isInitialNode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isInitialNode</span>()</div>
<div class="block">Indicates if this symbol represents initial node.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if this symbol represents initial node, false otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isFlowFinalNode()">
<h3>isFlowFinalNode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isFlowFinalNode</span>()</div>
<div class="block">Indicates if this symbol represents flow final node.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if this symbol represents flow final node, false otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isActivityFinalNode()">
<h3>isActivityFinalNode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isActivityFinalNode</span>()</div>
<div class="block">Indicates if this symbol represents activity final node.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if this symbol represents activity final node, false otherwise.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>internalGetHeaderInsets</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.AbstractHeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
