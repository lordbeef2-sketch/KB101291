# JAVA OPENAPI: DisplayRelatedSymbolsInfo (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/DisplayRelatedSymbolsInfo.html
- source_path: `com/nomagic/magicdraw/uml/symbols/DisplayRelatedSymbolsInfo.html`
- source_sha256: `a856bd4cca570510ed50bd2376671e1c8b29953e90d4afb7d59c65cee0a7ff98`
- captured_utc: `2026-07-14T16:55:56.193469+00:00`
...
Constructor
Description
`[DisplayRelatedSymbolsInfo](#%3Cinit%3E(java.util.Set))([Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)> linkTypes)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)>`
...
`void`
`[setLinkTypes](#setLinkTypes(java.util.Set))([Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)> linkTypes)`
...
public DisplayRelatedSymbolsInfo([Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)> linkTypes)
 ============ METHOD DETAIL ========== 
Method Details
isCreateClients
...
getLinkTypes
public [Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)> getLinkTypes()
Gets link types for display related elements functionality.
Returns:
link types.
setLinkTypes
public void setLinkTypes([Set](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html)<[LinkType](LinkType.html)> linkTypes)
Sets link types for display related elements functionality.
Parameters:
