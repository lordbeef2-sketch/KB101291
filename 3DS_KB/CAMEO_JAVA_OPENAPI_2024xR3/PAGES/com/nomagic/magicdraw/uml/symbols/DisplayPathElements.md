# JAVA OPENAPI: DisplayPathElements (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/DisplayPathElements.html
- source_path: `com/nomagic/magicdraw/uml/symbols/DisplayPathElements.html`
- source_sha256: `292ac89b68852b65cdade9e98ceafb4eb4cb8fc1a73cad47fdca57e9ff34b8c4`
- captured_utc: `2026-07-14T16:55:55.877463+00:00`
...
`[displayPathElements](#displayPathElements(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PresentationElement](PresentationElement.html)> symbols)`
Display paths from the given symbols.
`static [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PresentationElement](PresentationElement.html)>`
`[displayPathElements](#displayPathElements(java.util.Collection,com.nomagic.magicdraw.uml.symbols.DisplayPathElements.DisplayPathOptions))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PresentationElement](PresentationElement.html)> symbols,
...
<pre>
 ...
 List<b>&lt;</b>PresentationElement&gt; viewList = ...; //List of symbols for which you need to invoke the displaying paths action.
