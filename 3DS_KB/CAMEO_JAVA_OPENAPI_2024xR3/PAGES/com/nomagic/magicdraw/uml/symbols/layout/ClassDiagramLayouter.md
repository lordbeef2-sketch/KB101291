# JAVA OPENAPI: ClassDiagramLayouter (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/layout/ClassDiagramLayouter.html
- source_path: `com/nomagic/magicdraw/uml/symbols/layout/ClassDiagramLayouter.html`
- source_sha256: `dbc545cc00ea1689b1aec84dd0ecc7da52182e8aad9ec811ebf02de9519fd8fb`
- captured_utc: `2026-07-14T16:55:58.089489+00:00`
...
`[OrderedHierarchicDiagramLayouter](orderedhier/OrderedHierarchicDiagramLayouter.html)`

@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public classClassDiagramLayouter
extends [CompositeStructureDiagramLayouter](composite/CompositeStructureDiagramLayouter.html)
...
Constructor
Description
`[ClassDiagramLayouter](#%3Cinit%3E())()`
Deprecated.
Construct ClassDiagramLayouter.
`[ClassDiagramLayouter](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)`
...
@OpenApipublic ClassDiagramLayouter()
Deprecated.
Construct ClassDiagramLayouter.
ClassDiagramLayouter
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)([since](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html#since())="2024x Refresh3",
 [forRemoval](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html#forRemoval())=true)public ClassDiagramLayouter([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)
Deprecated, for removal: This API element is subject to removal in a future version.
 ============ METHOD DETAIL ========== 
Method Details
layout
...
Layouts a diagram
Overrides:
`[layout](composite/CompositeStructureDiagramLayouter.html#layout(com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup,com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.nomagic.magicdraw.uml.symbols.layout.BaseGraph))` in class `[CompositeStructureDiagramLayouter](composite/CompositeStructureDiagramLayouter.html)`
Parameters:
...
<h1 class="title" title="Class ClassDiagramLayouter">Class ClassDiagramLayouter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.layout.ClassDiagramLayouter</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="orderedhier/OrderedHierarchicDiagramLayouter.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.orderedhier">OrderedHierarchicDiagramLayouter</a></code></dd>
</dl>
<hr/>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ClassDiagramLayouter</span>
<span class="extends-implements">extends <a href="composite/CompositeStructureDiagramLayouter.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.composite">CompositeStructureDiagramLayouter</a></span></div>
...
<div class="block">A layouter by default used for class diagrams and class based diagrams.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ClassDiagramLayouter</a>()</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block">Construct ClassDiagramLayouter.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">ClassDiagramLayouter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</code></div>
...
<h3>ClassDiagramLayouter</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">ClassDiagramLayouter</span>()</div>
...
</span><span class="modifiers">public</span> <span class="element-name">ClassDiagramLayouter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="composite/CompositeStructureDiagramLayouter.html#layout(com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup,com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.nomagic.magicdraw.uml.symbols.layout.BaseGraph)">layout</a></code> in class <code><a href="composite/CompositeStructureDiagramLayouter.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.composite">CompositeStructureDiagramLayouter</a></code></dd>
<dt>Parameters:</dt>
