# JAVA OPENAPI: ConstraintLinkView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/ConstraintLinkView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/ConstraintLinkView.html`
- source_sha256: `d6e9ccee62bbf81d7806baa8fa61b00f97452a7eee19b3b2e48529396c97a4c7`
- captured_utc: `2026-07-14T16:55:59.238500+00:00`
...
@OpenApipublic classConstraintLinkView
...
Constructor
Description
`[ConstraintLinkView](#%3Cinit%3E())()`

`[ConstraintLinkView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
ConstraintLinkView
public ConstraintLinkView(@CheckForNull
...
Overrides:
`[canChangeSupplier](PathElement.html#canChangeSupplier())` in class `[PathElement](PathElement.html)`
Returns:
true, if view can change supplier.
canChangeClient
public boolean canChangeClient()
Overrides:
`[canChangeClient](PathElement.html#canChangeClient())` in class `[PathElement](PathElement.html)`
Returns:
...
Overrides:
`[hasSharedModelElement](PathElement.html#hasSharedModelElement())` in class `[PathElement](PathElement.html)`
Returns:
...
public boolean beforeDelete(com.dassault_systemes.modeler.foundation.editing.CompositeCommand deleteCommand,
 [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html) removeTogether)
Description copied from class: `[PresentationElement](../PresentationElement.html#beforeDelete(com.dassault_systemes.modeler.foundation.editing.CompositeCommand,java.util.Collection))`
Method is called before deleting symbol with user "DELETE" action
Overrides:
`[beforeDelete](../PresentationElement.html#beforeDelete(com.dassault_systemes.modeler.foundation.editing.CompositeCommand,java.util.Collection))` in class `[PresentationElement](../PresentationElement.html)`
`removeTogether` - other symbols participating in delete operation
Returns:
true, if symbol can be deleted
getElement
public [Constraint](../../../../uml2/ext/magicdraw/classes/mdkernel/Constraint.html) getElement()
...
<h1 class="title" title="Class ConstraintLinkView">Class ConstraintLinkView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.ConstraintLinkView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ConstraintLinkView</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ConstraintLinkView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ConstraintLinkView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#canChangeClient()">canChangeClient</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowArrow()">isShowArrow</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowArrow(boolean)">setShowArrow</a><wbr/>(boolean showArrow)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowArrow(boolean)">sSetShowArrow</a><wbr/>(boolean showArrow)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<h3>ConstraintLinkView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ConstraintLinkView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ConstraintLinkView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ConstraintLinkView</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="isShowArrow()">
<h3>isShowArrow</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowArrow</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowArrow(boolean)">
<h3>sSetShowArrow</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowArrow</span><wbr/><span class="parameters">(boolean showArrow)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowArrow(boolean)">
<h3>setShowArrow</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowArrow</span><wbr/><span class="parameters">(boolean showArrow)</span></div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>internalApplyProperties</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
<dt>Parameters:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#canChangeSupplier()">canChangeSupplier</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#canChangeClient()">canChangeClient</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#hasSharedModelElement()">hasSharedModelElement</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>createSmartListenerConfig</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#beforeDelete(com.dassault_systemes.modeler.foundation.editing.CompositeCommand,java.util.Collection)">PresentationElement</a></code></span></div>
<div class="block">Method is called before deleting symbol with user "DELETE" action</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../PresentationElement.html#beforeDelete(com.dassault_systemes.modeler.foundation.editing.CompositeCommand,java.util.Collection)">beforeDelete</a></code> in class <code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></dd>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Constraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Constraint</a></span> <span class="element-name">getElement</span>()</div>
