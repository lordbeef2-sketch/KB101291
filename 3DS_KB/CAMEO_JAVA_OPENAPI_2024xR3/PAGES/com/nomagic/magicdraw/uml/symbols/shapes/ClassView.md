# JAVA OPENAPI: ClassView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/ClassView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/ClassView.html`
- source_sha256: `155d9e6d78b7658781250b178b2b595d08b795ad5d3aea9f4ac5613679bb87ac`
- captured_utc: `2026-07-14T16:56:02.291535+00:00`
...
`[ComponentView](ComponentView.html)`, `[NodeView](NodeView.html)`

@OpenApipublic classClassView
...
Description
`static final int`
`[ACTIVE_BORDER_DISTANCE](#ACTIVE_BORDER_DISTANCE)`
...
`[ClassView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`

`[ClassView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,boolean))([PresentationElement](../PresentationElement.html) parent,
 boolean canShowStructure)`

`[ClassView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView))([PresentationElement](../PresentationElement.html) parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header)`

`[ClassView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView,boolean))([PresentationElement](../PresentationElement.html) parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header,
 boolean canShowStructure)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`boolean`
`[checkElementOwnerOnChange](#checkElementOwnerOnChange(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) view)`

`[ClassView](ClassView.html)`
`[clone](#clone())()`
...
`com.nomagic.magicdraw.uml.symbols.shapes.BehaviorsCompartmentHelper`
`[getBehaviorsCompartmentHelper](#getBehaviorsCompartmentHelper())()`
...
`static int`
`[getHeaderInsetReduce](#getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds,com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView))(int edge,
 com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds bounds,
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView headerShape)`

`com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView`
`[getHeaderView](#getHeaderView())()`

`com.nomagic.magicdraw.uml.symbols.shapes.PortsCompartmentHelper`
`[getPortsCompartmentHelper](#getPortsCompartmentHelper())()`
...
`void`
`[removeUseCaseSubject](#removeUseCaseSubject(com.nomagic.magicdraw.uml.symbols.shapes.UseCaseView))([UseCaseView](UseCaseView.html) useCaseView)`
If given parent is ClassView the information about subject is removed from given UseCase.
`boolean`
...
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ClassView.ACTIVE_BORDER_DISTANCE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ClassView
public ClassView()
...
Overrides:
`[isShowElementTypeAsLabel](../PresentationElement.html#isShowElementTypeAsLabel())` in class `[PresentationElement](../PresentationElement.html)`
...
clone
public [ClassView](ClassView.html) clone()
Specified by:
`[clone](../../BaseElement.html#clone())` in interface `[BaseElement](../../BaseElement.html)`
Overrides:
`[clone](ClassifierView.html#clone())` in class `[ClassifierView](ClassifierView.html)`
...
Description copied from class: `[ClassifierView](ClassifierView.html#sSetShowFullType(boolean))`
Sets show full type for members
Overrides:
`[sSetShowFullType](ClassifierView.html#sSetShowFullType(boolean))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
`show` - show full type
sSetUseAdvancedColoring
public void sSetUseAdvancedColoring(boolean use)
Description copied from class: `[ClassifierView](ClassifierView.html#sSetUseAdvancedColoring(boolean))`
Sets use advanced coloring
Overrides:
`[sSetUseAdvancedColoring](ClassifierView.html#sSetUseAdvancedColoring(boolean))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
...
Description copied from class: `[ClassifierView](ClassifierView.html#sSetMembersDisplayMode(java.lang.String))`
Sets members display mode. Does not update classifier symbol.
Overrides:
`[sSetMembersDisplayMode](ClassifierView.html#sSetMembersDisplayMode(java.lang.String))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
`membersDisplayMode` - display mode
See Also:
[`ClassifierView.setMembersDisplayMode(String)`](ClassifierView.html#setMembersDisplayMode(java.lang.String))
[`ClassifierView.ALL`](ClassifierView.html#ALL)
[`ClassifierView.NOT_PRIVATE`](ClassifierView.html#NOT_PRIVATE)
[`ClassifierView.ONLY_PUBLIC`](ClassifierView.html#ONLY_PUBLIC)
setDummyResizeMode
public boolean setDummyResizeMode(boolean b)
In dummy resize mode symbol may not resize according it children or move children on bounds changed and etc.
 This is more as hack for resize problems during load or diagram layout
Overrides:
...
public boolean checkElementOwnerOnChange([PresentationElement](../PresentationElement.html) view)
Overrides:
...
Object view has no children.
Overrides:
`[canAddInstance](ClassifierView.html#canAddInstance(com.nomagic.magicdraw.uml.symbols.PresentationElement))` in class `[ClassifierView](ClassifierView.html)`
addPresentationElement
...
If a specified object not inserted in this container then adds a new object view to the container.
Overrides:
`[addPresentationElement](ClassifierView.html#addPresentationElement(com.nomagic.magicdraw.uml.symbols.PresentationElement,int,boolean))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
`element` - new PresentationElement object
`index` - index to add at
`resize` - resize parent
removeUseCaseSubject
public void removeUseCaseSubject([UseCaseView](UseCaseView.html) useCaseView)
...
public static int getHeaderInsetReduce(int edge,
 ...
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView headerShape)
getElement
public [Class](../../../../uml2/ext/magicdraw/classes/mdkernel/Class.html) getElement()
...
<h1 class="title" title="Class ClassView">Class ClassView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.ClassView</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="ComponentView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ComponentView</a></code>, <code><a href="NodeView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">NodeView</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ClassView</span>
...
<div class="block">Class model element symbol representation.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#ACTIVE_BORDER_DISTANCE">ACTIVE_BORDER_DISTANCE</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ClassView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ClassView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,boolean)">ClassView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 boolean canShowStructure)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView)">ClassView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView,boolean)">ClassView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header,
 boolean canShowStructure)</code></div>
<div class="col-last even-row-color"> </div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#checkElementOwnerOnChange(com.nomagic.magicdraw.uml.symbols.PresentationElement)">checkElementOwnerOnChange</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.BehaviorsCompartmentHelper</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getBehaviorsCompartmentHelper()">getBehaviorsCompartmentHelper</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets behaviors compartment helper.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds)">getHeaderInsetReduce</a><wbr/>(int edge,
 com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds bounds)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static int</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds,com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView)">getHeaderInsetReduce</a><wbr/>(int edge,
 com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds bounds,
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView headerShape)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.PortsCompartmentHelper</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPortsCompartmentHelper()">getPortsCompartmentHelper</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#removeUseCaseSubject(com.nomagic.magicdraw.uml.symbols.shapes.UseCaseView)">removeUseCaseSubject</a><wbr/>(<a href="UseCaseView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">UseCaseView</a> useCaseView)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">If given parent is ClassView the information about subject is removed from given UseCase.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">In dummy resize mode symbol may not resize according it children or move children on bounds changed and etc.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetMembersDisplayMode(java.lang.String)">sSetMembersDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> membersDisplayMode)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets members display mode.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowFullType(boolean)">sSetShowFullType</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<li>
<section class="detail" id="ACTIVE_BORDER_DISTANCE">
<h3>ACTIVE_BORDER_DISTANCE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">ACTIVE_BORDER_DISTANCE</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ClassView.ACTIVE_BORDER_DISTANCE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClassView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClassView</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClassView</span><wbr/><span class="parameters">(@CheckForNull
 ...
 boolean canShowStructure)</span></div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView)">
<h3>ClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClassView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header)</span></div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView,boolean)">
<h3>ClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ClassView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView header,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../PresentationElement.html#isShowElementTypeAsLabel()">isShowElementTypeAsLabel</a></code> in class <code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getPortsCompartmentHelper()">
<h3>getPortsCompartmentHelper</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.PortsCompartmentHelper</span> <span class="element-name">getPortsCompartmentHelper</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getBehaviorsCompartmentHelper()">
<h3>getBehaviorsCompartmentHelper</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.BehaviorsCompartmentHelper</span> <span class="element-name">getBehaviorsCompartmentHelper</span>()</div>
<div class="block">Gets behaviors compartment helper.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>behaviors compartment helper.</dd>
</dl>
</section>
</li>
<li>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#clone()">clone</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="ClassifierView.html#sSetShowFullType(boolean)">ClassifierView</a></code></span></div>
<div class="block">Sets show full type for members</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#sSetShowFullType(boolean)">sSetShowFullType</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="ClassifierView.html#sSetUseAdvancedColoring(boolean)">ClassifierView</a></code></span></div>
<div class="block">Sets use advanced coloring</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#sSetUseAdvancedColoring(boolean)">sSetUseAdvancedColoring</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="ClassifierView.html#sSetMembersDisplayMode(java.lang.String)">ClassifierView</a></code></span></div>
<div class="block">Sets members display mode. Does not update classifier symbol.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#sSetMembersDisplayMode(java.lang.String)">sSetMembersDisplayMode</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
<dd><code>membersDisplayMode</code> - display mode</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="ClassifierView.html#setMembersDisplayMode(java.lang.String)"><code>ClassifierView.setMembersDisplayMode(String)</code></a></li>
<li><a href="ClassifierView.html#ALL"><code>ClassifierView.ALL</code></a></li>
<li><a href="ClassifierView.html#NOT_PRIVATE"><code>ClassifierView.NOT_PRIVATE</code></a></li>
<li><a href="ClassifierView.html#ONLY_PUBLIC"><code>ClassifierView.ONLY_PUBLIC</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="block">In dummy resize mode symbol may not resize according it children or move children on bounds changed and etc.
 This is more as hack for resize problems during load or diagram layout</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dt>Returns:</dt>
<dd>true if dummy mode was applied</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">checkElementOwnerOnChange</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#canAddInstance(com.nomagic.magicdraw.uml.symbols.PresentationElement)">canAddInstance</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#addPresentationElement(com.nomagic.magicdraw.uml.symbols.PresentationElement,int,boolean)">addPresentationElement</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="removeUseCaseSubject(com.nomagic.magicdraw.uml.symbols.shapes.UseCaseView)">
<h3>removeUseCaseSubject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">removeUseCaseSubject</span><wbr/><span class="parameters">(<a href="UseCaseView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">UseCaseView</a> useCaseView)</span></div>
<div class="block">If given parent is ClassView the information about subject is removed from given UseCase. If not, does nothing.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>useCaseView</code> - use case</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds,com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView)">
<h3>getHeaderInsetReduce</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">int</span> <span class="element-name">getHeaderInsetReduce</span><wbr/><span class="parameters">(int edge,
 com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds bounds,
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView headerShape)</span></div>
</section>
</li>
<li>
<section class="detail" id="getElement()">
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Class.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Class</a></span> <span class="element-name">getElement</span>()</div>
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.ClassHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
