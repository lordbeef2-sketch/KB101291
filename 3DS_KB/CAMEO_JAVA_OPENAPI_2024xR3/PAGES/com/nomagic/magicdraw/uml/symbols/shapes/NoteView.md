# JAVA OPENAPI: NoteView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/NoteView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/NoteView.html`
- source_sha256: `286330663c259b9a87b3f92f6c161361546017fd3dbca33ddd9c474c67ec098f`
- captured_utc: `2026-07-14T16:56:04.187558+00:00`
...
`[COMMENT_DISPLAY_MODES](#COMMENT_DISPLAY_MODES)`
...
`[NoteView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`boolean`
`[addConnectedPathElement](#addConnectedPathElement(com.nomagic.magicdraw.uml.symbols.paths.PathElement))([PathElement](../paths/PathElement.html) link)`
Adds a new path element, and recalculates its position.
`[NoteView](NoteView.html)`
`[clone](#clone())()`
...
`void`
`[createCompartmentElements](#createCompartmentElements())()`
Create compartments elements.
`protected void`
...
`[NoteAnchorView](../paths/NoteAnchorView.html)`
`[getActiveNoteAnchorView](#getActiveNoteAnchorView())()`
Returns "active" note anchor view.
`[PresentationElement](../PresentationElement.html)`
`[getAnchoredDiagramFrame](#getAnchoredDiagramFrame())()`

`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<com.dassault_systemes.modeler.foundation.compartments.CompartmentCollection>`
...
`com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView`
...
`com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView`
`[getNoteHeaderView](#getNoteHeaderView())()`
Deprecated.
...
`[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getRelatedElement](#getRelatedElement(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) presentationElement)`
Returns element to which note is connected with first (active) note anchor.
`[PresentationElement](../PresentationElement.html)`
`[getRelatedPresentationElement](#getRelatedPresentationElement())()`
...
`boolean`
`[isRepresentDiagramContext](#isRepresentDiagramContext())()`

`boolean`
`[isShowDocumentationStereotypes](#isShowDocumentationStereotypes())()`

`boolean`
`[isShowLineBetweenCompartments](#isShowLineBetweenCompartments())()`
...
`void`
`[setCommentDisplayMode](#setCommentDisplayMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`

`void`
`[setHTMLText](#setHTMLText(boolean))(boolean isHtml)`

`void`
`[setRepresentDiagramContext](#setRepresentDiagramContext(boolean))(boolean enable)`

`void`
`[setShowConstraints](#setShowConstraints(boolean))(boolean show)`

`void`
`[setShowDocumentationStereotypes](#setShowDocumentationStereotypes(boolean))(boolean show)`

`void`
`[setShowLineBetweenCompartments](#setShowLineBetweenCompartments(boolean))(boolean show)`
...
`void`
`[setSmartPropertyChangeListenerElement](#setSmartPropertyChangeListenerElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`
Sets smart property change listener element.
`void`
`[sSetCommentDisplayMode](#sSetCommentDisplayMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`
...
`void`
`[sSetHTMLText](#sSetHTMLText(boolean))(boolean isHtml)`

`void`
`[sSetRepresentDiagramContext](#sSetRepresentDiagramContext(boolean))(boolean enable)`

`void`
`[sSetShowConstraints](#sSetShowConstraints(boolean))(boolean show)`

`void`
`[sSetShowDocumentationStereotypes](#sSetShowDocumentationStereotypes(boolean))(boolean show)`

`void`
`[sSetShowLineBetweenCompartments](#sSetShowLineBetweenCompartments(boolean))(boolean show)`
...
Methods inherited from interface com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable
`canDisplayHTMLText`
...
Field Details
SHOW_TEXT
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SHOW_TEXT
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.SHOW_TEXT)
SHOW_DOCUMENTATION
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SHOW_DOCUMENTATION
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.SHOW_DOCUMENTATION)
NONE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) NONE
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.NONE)
COMMENT_DISPLAY_MODES
public static final [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> COMMENT_DISPLAY_MODES
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
NoteView
public NoteView()
NoteView
public NoteView(@CheckForNull
 [PresentationElement](../PresentationElement.html) parent)
 ============ METHOD DETAIL ========== 
Method Details
clone
public [NoteView](NoteView.html) clone()
Specified by:
...
public boolean addConnectedPathElement([PathElement](../paths/PathElement.html) link)
...
getUserText
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getUserText()
Returns the pure text. If html text is presented, this method returns not tml text,
 but user visible text.
Returns:
...
@CheckForNullpublic [PresentationElement](../PresentationElement.html) getRelatedPresentationElement()
getRelatedElement
@CheckForNullpublic [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getRelatedElement()
Returns element to which note is connected with first (active) note anchor.
Returns:
related element
See Also:
[`getActiveNoteAnchorView()`](#getActiveNoteAnchorView())
getRelatedElement
@CheckForNullpublic [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getRelatedElement(@CheckForNull
...
@CheckForNullpublic [NoteAnchorView](../paths/NoteAnchorView.html) getActiveNoteAnchorView()
Returns "active" note anchor view. Note displays info of element connected with active anchor.
 Active anchor is first connected path.
Returns:
active anchor
getAnchoredDiagramFrame
@CheckForNullpublic [PresentationElement](../PresentationElement.html) getAnchoredDiagramFrame()
setShowTaggedValues
...
getCollections
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<com.dassault_systemes.modeler.foundation.compartments.CompartmentCollection> getCollections()
Specified by:
...
Sets smart property change listener element. This is a way to reset mSmartPropertyChangeListenerElement which lets
 to create new smart listener. The problem is when adding custom compartment for NoteView: there is no way to write
 smart listener configurator to update view because standard listener is added for related element and view is not updated.
Parameters:
`element` - element to set.
sSetCommentDisplayMode
public void sSetCommentDisplayMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
setCommentDisplayMode
public void setCommentDisplayMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
getCommentDisplayMode
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getCommentDisplayMode()
...
getNoteHeaderView
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView getNoteHeaderView()
Deprecated.
use [`getHeaderView()`](#getHeaderView())
...
<h1 class="title" title="Class NoteView">Class NoteView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.NoteView</div>
</div>
</div>
</div>
</div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#COMMENT_DISPLAY_MODES">COMMENT_DISPLAY_MODES</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#NONE">NONE</a></code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-first even-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#SHOW_DOCUMENTATION">SHOW_DOCUMENTATION</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#SHOW_TEXT">SHOW_TEXT</a></code></div>
<div class="col-last odd-row-color"> </div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">NoteView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">NoteView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createCompartmentElements()">createCompartmentElements</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create compartments elements.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../paths/NoteAnchorView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">NoteAnchorView</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getActiveNoteAnchorView()">getActiveNoteAnchorView</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns "active" note anchor view.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getAnchoredDiagramFrame()">getAnchoredDiagramFrame</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;com.dassault_systemes.modeler.foundation.compartments.CompartmentCollection&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCollections()">getCollections</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCommentDisplayMode()">getCommentDisplayMode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code>com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#getNoteHeaderView()">getNoteHeaderView</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getRelatedElement()">getRelatedElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns element to which note is connected with first (active) note anchor.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getRelatedElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">getRelatedElement</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> presentationElement)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns element to which note is connected with first (active) note anchor.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getRelatedPresentationElement()">getRelatedPresentationElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.AbstractHeaderShapeView.StereotypeDisplayData</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getStereotypesToDisplay()">getStereotypesToDisplay</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getUserText()">getUserText</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the pure text.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isHTMLText()">isHTMLText</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isRepresentDiagramContext()">isRepresentDiagramContext</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowDocumentationStereotypes()">isShowDocumentationStereotypes</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowLineBetweenCompartments()">isShowLineBetweenCompartments</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowTaggedValuesStereotypes()">isShowTaggedValuesStereotypes</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setCommentDisplayMode(java.lang.String)">setCommentDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setHTMLText(boolean)">setHTMLText</a><wbr/>(boolean isHtml)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setRepresentDiagramContext(boolean)">setRepresentDiagramContext</a><wbr/>(boolean enable)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowConstraints(boolean)">setShowConstraints</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowDocumentationStereotypes(boolean)">setShowDocumentationStereotypes</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowLineBetweenCompartments(boolean)">setShowLineBetweenCompartments</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowQualifiedNameInTaggedValues(boolean)">setShowQualifiedNameInTaggedValues</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setSmartPropertyChangeListenerElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setSmartPropertyChangeListenerElement</a><wbr/>(<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets smart property change listener element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetCommentDisplayMode(java.lang.String)">sSetCommentDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetConstraintTextMode(java.lang.String)">sSetConstraintTextMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Change the value of CONSTRAINT_TEXT_MODE property.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetHTMLText(boolean)">sSetHTMLText</a><wbr/>(boolean isHtml)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetRepresentDiagramContext(boolean)">sSetRepresentDiagramContext</a><wbr/>(boolean enable)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowConstraints(boolean)">sSetShowConstraints</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowDocumentationStereotypes(boolean)">sSetShowDocumentationStereotypes</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowLineBetweenCompartments(boolean)">sSetShowLineBetweenCompartments</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowTaggedValuesStereotypes(boolean)">sSetShowTaggedValuesStereotypes</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable">Methods inherited from interface com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable</h3>
<code>canDisplayHTMLText</code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="SHOW_TEXT">
<h3>SHOW_TEXT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SHOW_TEXT</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.SHOW_TEXT">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="SHOW_DOCUMENTATION">
<h3>SHOW_DOCUMENTATION</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SHOW_DOCUMENTATION</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.SHOW_DOCUMENTATION">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>NONE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">NONE</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.NoteView.NONE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="COMMENT_DISPLAY_MODES">
<h3>COMMENT_DISPLAY_MODES</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">COMMENT_DISPLAY_MODES</span></div>
</section>
</li>
</ul>
</section>
...
<h3>NoteView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">NoteView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>NoteView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">NoteView</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="NoteView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">NoteView</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">addConnectedPathElement</span><wbr/><span class="parameters">(<a href="../paths/PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a> link)</span></div>
...
<dt>Parameters:</dt>
<dd><code>link</code> - element to be added.</dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setHTMLText(boolean)">
<h3>setHTMLText</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setHTMLText</span><wbr/><span class="parameters">(boolean isHtml)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>setHTMLText</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetHTMLText(boolean)">
<h3>sSetHTMLText</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetHTMLText</span><wbr/><span class="parameters">(boolean isHtml)</span></div>
</section>
</li>
<li>
<section class="detail" id="isHTMLText()">
<h3>isHTMLText</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isHTMLText</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>isHTMLText</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.PlainTextOrHTMLChangeable</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getUserText()">
<h3>getUserText</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getUserText</span>()</div>
<div class="block">Returns the pure text. If html text is presented, this method returns not tml text,
 but user visible text.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the user visible text.</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getRelatedPresentationElement()">
<h3>getRelatedPresentationElement</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">getRelatedPresentationElement</span>()</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getRelatedElement</span>()</div>
<div class="block">Returns element to which note is connected with first (active) note anchor.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>related element</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getActiveNoteAnchorView()"><code>getActiveNoteAnchorView()</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getRelatedElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>getRelatedElement</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getRelatedElement</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="getActiveNoteAnchorView()">
<h3>getActiveNoteAnchorView</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../paths/NoteAnchorView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">NoteAnchorView</a></span> <span class="element-name">getActiveNoteAnchorView</span>()</div>
<div class="block">Returns "active" note anchor view. Note displays info of element connected with active anchor.
 Active anchor is first connected path.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>active anchor</dd>
</dl>
...
<li>
<section class="detail" id="getAnchoredDiagramFrame()">
<h3>getAnchoredDiagramFrame</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">getAnchoredDiagramFrame</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>setShowTaggedValues</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>sSetShowTaggedValues</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>setShowConstraints</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>sSetShowConstraints</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isShowLineBetweenCompartments()">
<h3>isShowLineBetweenCompartments</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowLineBetweenCompartments</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowLineBetweenCompartments(boolean)">
<h3>sSetShowLineBetweenCompartments</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowLineBetweenCompartments</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="setShowLineBetweenCompartments(boolean)">
<h3>setShowLineBetweenCompartments</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowLineBetweenCompartments</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isShowDocumentationStereotypes()">
<h3>isShowDocumentationStereotypes</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowDocumentationStereotypes</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowDocumentationStereotypes(boolean)">
<h3>sSetShowDocumentationStereotypes</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowDocumentationStereotypes</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowDocumentationStereotypes(boolean)">
<h3>setShowDocumentationStereotypes</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowDocumentationStereotypes</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="createCompartmentElements()">
<h3>createCompartmentElements</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">createCompartmentElements</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code>com.nomagic.magicdraw.uml.CompartmentSupport</code></span></div>
<div class="block">Create compartments elements. After that compartment should be ready to hide or show some elements.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>createCompartmentElements</code> in interface <code>com.nomagic.magicdraw.uml.CompartmentSupport</code></dd>
<dt>Overrides:</dt>
<dd><code>createCompartmentElements</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.BaseHeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getCollections()">
<h3>getCollections</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;com.dassault_systemes.modeler.foundation.compartments.CompartmentCollection&gt;</span> <span class="element-name">getCollections</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getCollections</code> in interface <code>com.nomagic.magicdraw.uml.CompartmentSupport</code></dd>
<dt>Overrides:</dt>
<dd><code>getCollections</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.BaseHeaderShapeView</code></dd>
<dt>Returns:</dt>
<dd>compartment information</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setSmartPropertyChangeListenerElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setSmartPropertyChangeListenerElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setSmartPropertyChangeListenerElement</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets smart property change listener element. This is a way to reset mSmartPropertyChangeListenerElement which lets
 to create new smart listener. The problem is when adding custom compartment for NoteView: there is no way to write
 smart listener configurator to update view because standard listener is added for related element and view is not updated.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>element</code> - element to set.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetCommentDisplayMode(java.lang.String)">
<h3>sSetCommentDisplayMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetCommentDisplayMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
</section>
</li>
<li>
<section class="detail" id="setCommentDisplayMode(java.lang.String)">
<h3>setCommentDisplayMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setCommentDisplayMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
</section>
</li>
<li>
<section class="detail" id="getCommentDisplayMode()">
<h3>getCommentDisplayMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getCommentDisplayMode</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setRepresentDiagramContext(boolean)">
<h3>setRepresentDiagramContext</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setRepresentDiagramContext</span><wbr/><span class="parameters">(boolean enable)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetRepresentDiagramContext(boolean)">
<h3>sSetRepresentDiagramContext</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetRepresentDiagramContext</span><wbr/><span class="parameters">(boolean enable)</span></div>
</section>
</li>
<li>
<section class="detail" id="isRepresentDiagramContext()">
<h3>isRepresentDiagramContext</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isRepresentDiagramContext</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>sSetConstraintTextMode</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
<dt>Parameters:</dt>
<dd><code>mode</code> - text mode.</dd>
</dl>
</section>
</li>
<li>
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<li>
<section class="detail" id="getNoteHeaderView()">
<h3>getNoteHeaderView</h3>
<div class="member-signature"><span class="annotations"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html" title="class or interface in java.lang">@Deprecated</a>
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.NoteHeaderView</span> <span class="element-name">getNoteHeaderView</span>()</div>
