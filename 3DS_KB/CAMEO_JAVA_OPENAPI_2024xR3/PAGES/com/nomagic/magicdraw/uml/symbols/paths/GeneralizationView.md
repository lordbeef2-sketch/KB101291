# JAVA OPENAPI: GeneralizationView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/GeneralizationView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/GeneralizationView.html`
- source_sha256: `8e7e0dbb21539d0343d945acdcdccb9afcb23b0ee3f550dddf63b406941bd7e5`
- captured_utc: `2026-07-14T16:56:00.414514+00:00`
...
`[BaseElement](../../BaseElement.html)`, `com.nomagic.magicdraw.uml.CompartmentSupport`, `[MDElement](../../MDElement.html)`, `[ModelElementProvider](../../ModelElementProvider.html)`, `com.nomagic.magicdraw.uml.symbols.LabelOwner`, `com.nomagic.magicdraw.uml.symbols.LineJumpDrawer`, `com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector`, `com.nomagic.magicdraw.uml.symbols.PropertyBasedPresentationElement`, `[StereotypesDisplayModeOwner](../shapes/StereotypesDisplayModeOwner.html)`, `com.nomagic.magicdraw.uml.symbols.SuspendShapeAutoResizeModeProvider`, `[NameOwner](../../../utils/NameOwner.html)`, `[PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[EventListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/EventListener.html)`

@OpenApipublic classGeneralizationView
...
Constructor
Description
`[GeneralizationView](#%3Cinit%3E())()`

`[GeneralizationView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[Generalization](../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html)`
`[getElement](#getElement())()`
Returns model element of this presentation element.
`[Generalization](../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html)`
`[getGeneralization](#getGeneralization())()`

`[GeneralizationSetView](../shapes/GeneralizationSetView.html)`
`[getGeneralizationSetLabelBox](#getGeneralizationSetLabelBox())()`

`com.nomagic.magicdraw.uml.symbols.shapes.GeneralizationSetLabelWrapper`
`[getGeneralizationSetLabelWrapper](#getGeneralizationSetLabelWrapper())()`
...
`boolean`
`[isShowGeneralizationSet](#isShowGeneralizationSet())()`
...
`void`
`[setShowGeneralizationSet](#setShowGeneralizationSet(boolean))(boolean show)`
...
`void`
`[sSetShowGeneralizationSet](#sSetShowGeneralizationSet(boolean))(boolean show)`
...
`void`
`[updateTreeShapeByTreeShapeConnector](#updateTreeShapeByTreeShapeConnector(com.nomagic.magicdraw.uml.symbols.paths.PathElement,com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape))([PathElement](PathElement.html) otherPath,
 com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape treeShape)`
...
`getClassType, getID, prepareForLineDrawing`
...
GeneralizationView
public GeneralizationView(@CheckForNull
...
public void updateTreeShapeByTreeShapeConnector([PathElement](PathElement.html) otherPath,
 com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape treeShape)
Specified by:
...
Overrides:
`[setParent](PathConnector.html#setParent(com.nomagic.magicdraw.uml.symbols.PresentationElement))` in class `[PathConnector](PathConnector.html)`
Parameters:
`parent` - parent view
...
getElement
public [Generalization](../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html) getElement()
...
getGeneralization
@CheckForNullpublic [Generalization](../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html) getGeneralization()
getTreeShape
...
public com.nomagic.utils.Pair<com.dassault_systemes.modeler.foundation.model.ModelElement,[Consumer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Consumer.html)<com.dassault_systemes.modeler.foundation.model.ModelElement>> useOtherExistingElement()
Description copied from class: `[PathElement](PathElement.html#useOtherExistingElement())`
Finds and returns other model element which is semantically equivalent to this path model element.
...
Overrides:
`[useOtherExistingElement](PathElement.html#useOtherExistingElement())` in class `[PathElement](PathElement.html)`
Returns:
element
canHavePaths
...
@CheckForNullpublic [GeneralizationSetView](../shapes/GeneralizationSetView.html) getGeneralizationSetLabelBox()
...
<h1 class="title" title="Class GeneralizationView">Class GeneralizationView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.GeneralizationView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">GeneralizationView</span>
<span class="extends-implements">extends com.nomagic.magicdraw.uml.symbols.paths.LinkWithStereotype
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">GeneralizationView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">GeneralizationView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createTreeShape()">createTreeShape</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Generalization</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Generalization</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getGeneralization()">getGeneralization</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../shapes/GeneralizationSetView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">GeneralizationSetView</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getGeneralizationSetLabelBox()">getGeneralizationSetLabelBox</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.GeneralizationSetLabelWrapper</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getGeneralizationSetLabelWrapper()">getGeneralizationSetLabelWrapper</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowGeneralizationSet()">isShowGeneralizationSet</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#retrieveDataFromTreeView(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">retrieveDataFromTreeView</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowGeneralizationSet(boolean)">setShowGeneralizationSet</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setSimple(boolean)">setSimple</a><wbr/>(boolean simple)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowGeneralizationSet(boolean)">sSetShowGeneralizationSet</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetSimple(boolean)">sSetSimple</a><wbr/>(boolean simple)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetTreeShape(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">sSetTreeShape</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape tree)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updateTreeShapeByTreeShapeConnector(com.nomagic.magicdraw.uml.symbols.paths.PathElement,com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">updateTreeShapeByTreeShapeConnector</a><wbr/>(<a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a> otherPath,
 com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape treeShape)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<code>getClassType, getID, prepareForLineDrawing</code></div>
</section>
</li>
</ul>
</section>
...
<h3>GeneralizationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">GeneralizationView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>GeneralizationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">GeneralizationView</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="updateTreeShapeByTreeShapeConnector(com.nomagic.magicdraw.uml.symbols.paths.PathElement,com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape)">
<h3>updateTreeShapeByTreeShapeConnector</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">updateTreeShapeByTreeShapeConnector</span><wbr/><span class="parameters">(<a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a> otherPath,
 com.nomagic.magicdraw.uml.symbols.shapes.BaseTreeShape treeShape)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>updateTreeShapeByTreeShapeConnector</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.TreeShapeConnector</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>createLabels</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithStereotype</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathConnector.html#setParent(com.nomagic.magicdraw.uml.symbols.PresentationElement)">setParent</a></code> in class <code><a href="PathConnector.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathConnector</a></code></dd>
<dt>Parameters:</dt>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Generalization</a></span> <span class="element-name">getElement</span>()</div>
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Generalization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Generalization</a></span> <span class="element-name">getGeneralization</span>()</div>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code>accept</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithStereotype</code></dd>
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.utils.Pair&lt;com.dassault_systemes.modeler.foundation.model.ModelElement,<wbr/><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Consumer.html" title="class or interface in java.util.function">Consumer</a>&lt;com.dassault_systemes.modeler.foundation.model.ModelElement&gt;&gt;</span> <span class="element-name">useOtherExistingElement</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#useOtherExistingElement()">PathElement</a></code></span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#useOtherExistingElement()">useOtherExistingElement</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
<dd>element</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getGeneralizationSetLabelBox()">
<h3>getGeneralizationSetLabelBox</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../shapes/GeneralizationSetView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">GeneralizationSetView</a></span> <span class="element-name">getGeneralizationSetLabelBox</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getGeneralizationSetLabelWrapper()">
<h3>getGeneralizationSetLabelWrapper</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.GeneralizationSetLabelWrapper</span> <span class="element-name">getGeneralizationSetLabelWrapper</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>createSmartListenerConfig</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithStereotype</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isShowGeneralizationSet()">
<h3>isShowGeneralizationSet</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowGeneralizationSet</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowGeneralizationSet(boolean)">
<h3>sSetShowGeneralizationSet</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowGeneralizationSet</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowGeneralizationSet(boolean)">
<h3>setShowGeneralizationSet</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowGeneralizationSet</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
</ul>
</section>
