# JAVA OPENAPI: ExtendablePropertyManager (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/ExtendablePropertyManager.html
- source_path: `com/nomagic/magicdraw/properties/ExtendablePropertyManager.html`
- source_sha256: `affff32507b6c8bcd347905ab9740fd34ca3862e2f85ce1cdd93f916c917c665`
- captured_utc: `2026-07-14T16:55:27.858149+00:00`
...
`[ExtendablePropertyManager](#%3Cinit%3E(java.lang.String,java.util.List))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)`
Construct ExtendablePropertyManager with given arguments.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Set Removable flag.
`void`
`[setSymbolType](#setSymbolType(java.lang.Class))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html) symbolType)`
Set symbol type.
`void`
`[setSymbolType](#setSymbolType(java.lang.Class%5B%5D))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)[] symbolType)`
Set symbol type.
...
ExtendablePropertyManager
public ExtendablePropertyManager([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)
Construct ExtendablePropertyManager with given arguments.
Parameters:
...
setSymbolType
public void setSymbolType([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html) symbolType)
...
getSymbolType
public [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)[] getSymbolType()
Get Symbol type.
Returns:
symbol type.
isRemovable
...
<h3>ExtendablePropertyManager</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ExtendablePropertyManager</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a>&gt; properties)</span></div>
<div class="block">Construct ExtendablePropertyManager with given arguments.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PropertyManager.html#getClassType()">PropertyManager</a></code></span></div>
<div class="block">Returns property class type.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<h3>getSymbolType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>[]</span> <span class="element-name">getSymbolType</span>()</div>
<div class="block">Get Symbol type.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>symbol type.</dd>
