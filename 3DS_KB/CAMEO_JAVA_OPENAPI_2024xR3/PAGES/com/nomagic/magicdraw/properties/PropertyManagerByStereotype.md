# JAVA OPENAPI: PropertyManagerByStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/PropertyManagerByStereotype.html
- source_path: `com/nomagic/magicdraw/properties/PropertyManagerByStereotype.html`
- source_sha256: `1f2e039ef008bf44d876d72345a43b4fdd6192553a54de520bdab9b8e78372b6`
- captured_utc: `2026-07-14T16:55:33.183211+00:00`
...
@OpenApiAllpublic classPropertyManagerByStereotype
...
Constructor
Description
`[PropertyManagerByStereotype](#%3Cinit%3E())()`

`[PropertyManagerByStereotype](#%3Cinit%3E(com.nomagic.magicdraw.properties.PropertyManager,java.lang.String,java.util.List))([PropertyManager](PropertyManager.html) parentPropertyManager,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)`

`[PropertyManagerByStereotype](#%3Cinit%3E(java.lang.String,java.util.List))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[PropertyManagerByStereotype](PropertyManagerByStereotype.html)`
`[clone](#clone())()`
Clones the manager.
`protected void`
`[customize](#customize())()`
...
`[getAssignedStereotypeID](#getAssignedStereotypeID())()`
...
`void`
`[setStereoType](#setStereoType(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)`
...
PropertyManagerByStereotype
public PropertyManagerByStereotype([PropertyManager](PropertyManager.html) parentPropertyManager,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)
PropertyManagerByStereotype
public PropertyManagerByStereotype([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)
 ============ METHOD DETAIL ========== 
Method Details
accept
...
getStereotype
@CheckForNullpublic [Stereotype](../../uml2/ext/magicdraw/mdprofiles/Stereotype.html) getStereotype()
getAssignedStereotypeID
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getAssignedStereotypeID()
Gets represented stereotype identifier.
 For internal usage only.
Returns:
identifier of the stereotype that
 was set using [`setStereoType(String)`](#setStereoType(java.lang.String)) method.
setStereoType
public void setStereoType([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)
customize
...
Description copied from class: `[PropertyManager](PropertyManager.html#getName())`
Returns name of the property manager.
Overrides:
`[getName](PropertyManager.html#getName())` in class `[PropertyManager](PropertyManager.html)`
Returns:
...
Check if given property manager is the same as current. Managers are the same if names are equal, parent managers are equal and stereotypes are equal
Overrides:
...
true if the same
clone
public [PropertyManagerByStereotype](PropertyManagerByStereotype.html) clone()
Description copied from class: `[PropertyManager](PropertyManager.html#clone())`
Clones the manager. Does deep clone - all properties will be cloned too.
Overrides:
`[clone](PropertyManager.html#clone())` in class `[PropertyManager](PropertyManager.html)`
Returns:
the cloned manager.
...
<h1 class="title" title="Class PropertyManagerByStereotype">Class PropertyManagerByStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.PropertyManagerByStereotype</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PropertyManagerByStereotype</span>
...
<div class="block">Property manager which is specified by stereotype.</div>
</section>
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.properties.PropertyManager,java.lang.String,java.util.List)">PropertyManagerByStereotype</a><wbr/>(<a href="PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a> parentPropertyManager,
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a>&gt; properties)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.util.List)">PropertyManagerByStereotype</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a>&gt; properties)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="PropertyManagerByStereotype.html" title="class in com.nomagic.magicdraw.properties">PropertyManagerByStereotype</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#customize()">customize</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getAssignedStereotypeID()">getAssignedStereotypeID</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets represented stereotype identifier.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setStereoType(java.lang.String)">setStereoType</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</code></div>
...
<h3>PropertyManagerByStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PropertyManagerByStereotype</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.properties.PropertyManager,java.lang.String,java.util.List)">
<h3>PropertyManagerByStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PropertyManagerByStereotype</span><wbr/><span class="parameters">(<a href="PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a> parentPropertyManager,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a>&gt; properties)</span></div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.util.List)">
<h3>PropertyManagerByStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PropertyManagerByStereotype</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Property.html" title="class in com.nomagic.magicdraw.properties">Property</a>&gt; properties)</span></div>
</section>
</li>
</ul>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PropertyManager.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor)">PropertyManager</a></code></span></div>
<div class="block">Accepts the given visitor.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<li>
<section class="detail" id="getAssignedStereotypeID()">
<h3>getAssignedStereotypeID</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getAssignedStereotypeID</span>()</div>
<div class="block">Gets represented stereotype identifier.
 For internal usage only.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>identifier of the  stereotype that
 was set using <a href="#setStereoType(java.lang.String)"><code>setStereoType(String)</code></a> method.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setStereoType(java.lang.String)">
<h3>setStereoType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setStereoType</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</span></div>
</section>
</li>
<li>
<section class="detail" id="customize()">
<h3>customize</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">customize</span>()</div>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PropertyManager.html#makeCopy()">PropertyManager</a></code></span></div>
<div class="block">Make copy of property.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PropertyManager.html#getName()">PropertyManager</a></code></span></div>
<div class="block">Returns name of the property manager.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PropertyManager.html#getName()">getName</a></code> in class <code><a href="PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a></code></dd>
<dt>Returns:</dt>
<dd>stereotype name if such available. If such not available returns name passed to constructor.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block">Check if given property manager is the same as current. Managers are the same if names are equal, parent managers are equal and stereotypes are equal</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="PropertyManagerByStereotype.html" title="class in com.nomagic.magicdraw.properties">PropertyManagerByStereotype</a></span> <span class="element-name">clone</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PropertyManager.html#clone()">PropertyManager</a></code></span></div>
<div class="block">Clones the manager. Does deep clone - all properties will be cloned too.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PropertyManager.html#clone()">clone</a></code> in class <code><a href="PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a></code></dd>
<dt>Returns:</dt>
