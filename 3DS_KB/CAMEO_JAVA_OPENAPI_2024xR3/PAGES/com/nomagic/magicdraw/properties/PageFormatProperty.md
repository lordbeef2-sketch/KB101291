# JAVA OPENAPI: PageFormatProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/PageFormatProperty.html
- source_path: `com/nomagic/magicdraw/properties/PageFormatProperty.html`
- source_sha256: `febc66111c0a6971d2bcd9a338c77ff6c9719e52d04fb83f0180cca342d6d6e3`
- captured_utc: `2026-07-14T16:55:28.453155+00:00`
...
See Also:
[`PageFormat`](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html)
...
Default constructor.
`[PageFormatProperty](#%3Cinit%3E(java.lang.String,java.awt.print.PageFormat))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [PageFormat](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html) value)`
...
PageFormatProperty
public PageFormatProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [PageFormat](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html) value)
The property constructor.
Parameters:
...
getPageFormat
public [PageFormat](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html) getPageFormat()
Returns value as `PageFormat`.
Returns:
value as `PageFormat`.
getClassType
...
<dd>
<ul class="see-list">
<li><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print"><code>PageFormat</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.awt.print.PageFormat)">PageFormatProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a> value)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a></code></div>
...
<h3>PageFormatProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PageFormatProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a> value)</span></div>
<div class="block">The property constructor.</div>
<dl class="notes">
<dt>Parameters:</dt>
