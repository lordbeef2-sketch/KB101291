# JAVA OPENAPI: LocaleProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/LocaleProperty.html
- source_path: `com/nomagic/magicdraw/properties/LocaleProperty.html`
- source_sha256: `0073541d8a43906a0b6343515a15f5c5e95a2395faa46ddb2e668bf11ad458f8`
- captured_utc: `2026-07-14T16:55:28.200152+00:00`
...
Default constructor.
`[LocaleProperty](#%3Cinit%3E(java.lang.String,int,java.util.List))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 int index,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html) choice)`
The constructor.
`[LocaleProperty](#%3Cinit%3E(java.lang.String,java.lang.Object,java.util.List))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
...
`void`
`[updateLocaleByString](#updateLocaleByString(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) locale)`
...
LocaleProperty
public LocaleProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) value,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html) choice)
The constructor.
Parameters:
...
Method Details
getLocale
public [Locale](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Locale.html) getLocale()
Return the locale.
Returns:
a locale from property.
setLocale
public void setLocale([Locale](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Locale.html) locale)
Sets a new locale for property.
Parameters:
`locale` - a new locale.
updateLocaleByValue
...
public void updateLocaleByString([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) locale)
Update Locale By String
Parameters:
...
<dd>
<ul class="see-list">
<li><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util"><code>Locale</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a></code></div>
...
<h3>LocaleProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">LocaleProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value,
...
<h3>getLocale</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Locale.html" title="class or interface in java.util">Locale</a></span> <span class="element-name">getLocale</span>()</div>
<div class="block">Return the locale.</div>
<dl class="notes">
<dt>Returns:</dt>
