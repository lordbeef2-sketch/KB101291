# JAVA OPENAPI: ModuleUsageDifference (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/diff/ModuleUsageDifference.html
- source_path: `com/nomagic/magicdraw/diff/ModuleUsageDifference.html`
- source_sha256: `62f62c8fd942e125c0db4f441d35bb0645b99103f5dc0913f9d137f664862508`
- captured_utc: `2026-07-14T16:55:16.855025+00:00`
...
`[getModule](#getModule())()`
Get module info.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ModuleUsageDifference.Mount](ModuleUsageDifference.Mount.html)>`
`[getMounts](#getMounts())()`
...
modification kind.
getMounts
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ModuleUsageDifference.Mount](ModuleUsageDifference.Mount.html)> getMounts()
