# JAVA OPENAPI: SymbolDifference (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/diff/symbols/SymbolDifference.html
- source_path: `com/nomagic/magicdraw/diff/symbols/SymbolDifference.html`
- source_sha256: `5665ca1de9ed1bbe2dedb81fd02343bbe4f50c2064ca9022ff23c14e992e89d5`
- captured_utc: `2026-07-14T16:55:17.128031+00:00`
...
Method Details
getSymbolID
[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getSymbolID()
Changed symbol id.
Returns:
symbol id.
getDiagramID
...
Diagram which owns this symbol id.
getProjectID
@CheckForNull[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getProjectID()
Project part, to which symbol belongs, project id
Returns:
Project part, to which symbol belongs, project id
...
<h3>getSymbolID</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getSymbolID</span>()</div>
<div class="block">Changed symbol id.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>symbol id.</dd>
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getProjectID</span>()</div>
<div class="block">Project part, to which symbol belongs, project id</div>
<dl class="notes">
<dt>Returns:</dt>
