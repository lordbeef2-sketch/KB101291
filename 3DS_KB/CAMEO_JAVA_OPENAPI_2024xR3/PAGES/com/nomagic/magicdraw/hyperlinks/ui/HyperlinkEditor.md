# JAVA OPENAPI: HyperlinkEditor (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/hyperlinks/ui/HyperlinkEditor.html
- source_path: `com/nomagic/magicdraw/hyperlinks/ui/HyperlinkEditor.html`
- source_sha256: `4d84623d07738a871d98e0a238479a9ffd2dd03d99fd6c18adb70d5869bebf93`
- captured_utc: `2026-07-14T16:55:23.003094+00:00`
...
`[getHyperlink](#getHyperlink(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) text)`
...
Method Details
getTitle
[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getTitle()
Get editor title.
Returns:
title string.
getComponent
...
component.
getHyperlink
@CheckForNull[Hyperlink](../Hyperlink.html) getHyperlink([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) text)
Get edited hyperlink.
Parameters:
`text` - hyperlink text.
Returns:
...
`link` - hyperlink.
setFavorites
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)void setFavorites([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Hyperlink](../Hyperlink.html)> favorites)
Deprecated.
