# JAVA OPENAPI: EsiUtils.OfflineProjectDescriptor (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/esi/EsiUtils.OfflineProjectDescriptor.html
- source_path: `com/nomagic/magicdraw/esi/EsiUtils.OfflineProjectDescriptor.html`
- source_sha256: `fd61c9027c228cad1f73d41f9e1964a83b6e34708bc8558216bcd8f00af63ce8`
- captured_utc: `2026-07-14T16:55:20.448066+00:00`
...
Method Details
getClusterID
public [UUID](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/UUID.html) getClusterID()
Returns cluster ID of the project.
Returns:
cluster ID.
getUser
...
<h3>getClusterID</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/UUID.html" title="class or interface in java.util">UUID</a></span> <span class="element-name">getClusterID</span>()</div>
<div class="block">Returns cluster ID of the project.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>cluster ID.</dd>
...
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code><a href="../core/project/ProjectDescriptor.html#getURI()">ProjectDescriptor</a></code></span></div>
...
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code><a href="../core/project/ProjectDescriptor.html#getRepresentationString()">ProjectDescriptor</a></code></span></div>
<div class="block">Constructs human representation of project.</div>
<dl class="notes">
<dt>Specified by:</dt>
