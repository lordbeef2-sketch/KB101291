# JAVA OPENAPI: UsedProjectHasIncompatibleProfilesException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/esi/refactor/move/UsedProjectHasIncompatibleProfilesException.html
- source_path: `com/nomagic/magicdraw/esi/refactor/move/UsedProjectHasIncompatibleProfilesException.html`
- source_sha256: `5cd00c0ccb6bb68ede97843ff475ff43442455069e68515129189fae88d63937`
- captured_utc: `2026-07-14T16:55:20.815070+00:00`
...
@OpenApiAllpublic classUsedProjectHasIncompatibleProfilesException
extends [Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)

A special exception that is thrown if the target project has not up-to-date Standard/System
 profiles and thus cannot be changed (the move operation cannot continue)

See Also:
[Serialized Form](../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.UsedProjectHasIncompatibleProfilesException)
...
Constructor
Description
`[UsedProjectHasIncompatibleProfilesException](#%3Cinit%3E(com.nomagic.ci.persistence.IAttachedProject,boolean))(com.nomagic.ci.persistence.IAttachedProject targetProject,
 boolean projectProfileDowngradeNeeded)`
Creates new instance of [`UsedProjectHasIncompatibleProfilesException`](UsedProjectHasIncompatibleProfilesException.html)
 ========== METHOD SUMMARY =========== 
Method Summary
...
`boolean`
`[isProjectProfileDowngradeNeeded](#isProjectProfileDowngradeNeeded())()`
...
`projectProfileDowngradeNeeded` - `true` if project has profiles that are newer
...
<h1 class="title" title="Class UsedProjectHasIncompatibleProfilesException">Class UsedProjectHasIncompatibleProfilesException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.esi.refactor.move.UsedProjectHasIncompatibleProfilesException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">UsedProjectHasIncompatibleProfilesException</span>
...
<div class="block">A special exception that is thrown if the target project has not up-to-date Standard/System
 profiles and thus cannot be changed (the move operation cannot continue)</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.UsedProjectHasIncompatibleProfilesException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.ci.persistence.IAttachedProject,boolean)">UsedProjectHasIncompatibleProfilesException</a><wbr/>(com.nomagic.ci.persistence.IAttachedProject targetProject,
 boolean projectProfileDowngradeNeeded)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates new instance of <a href="UsedProjectHasIncompatibleProfilesException.html" title="class in com.nomagic.magicdraw.esi.refactor.move"><code>UsedProjectHasIncompatibleProfilesException</code></a></div>
</div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getTargetProject()">getTargetProject</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets the target project</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isProjectProfileDowngradeNeeded()">isProjectProfileDowngradeNeeded</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Determines project has profiles that are newer that these of the installation</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.ci.persistence.IAttachedProject,boolean)">
<h3>UsedProjectHasIncompatibleProfilesException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">UsedProjectHasIncompatibleProfilesException</span><wbr/><span class="parameters">(com.nomagic.ci.persistence.IAttachedProject targetProject,
 boolean projectProfileDowngradeNeeded)</span></div>
<div class="block">Creates new instance of <a href="UsedProjectHasIncompatibleProfilesException.html" title="class in com.nomagic.magicdraw.esi.refactor.move"><code>UsedProjectHasIncompatibleProfilesException</code></a></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>targetProject</code> - the project</dd>
<dd><code>projectProfileDowngradeNeeded</code> - <code>true</code> if project has profiles that are newer
                                      that these of the installation, <code>false</code> if all project's profiles in
                                      older only</dd>
</dl>
</section>
</li>
...
<ul class="member-list">
<li>
<section class="detail" id="getTargetProject()">
<h3>getTargetProject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.ci.persistence.IAttachedProject</span> <span class="element-name">getTargetProject</span>()</div>
<div class="block">Gets the target project</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the target</dd>
...
<li>
<section class="detail" id="isProjectProfileDowngradeNeeded()">
<h3>isProjectProfileDowngradeNeeded</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isProjectProfileDowngradeNeeded</span>()</div>
<div class="block">Determines project has profiles that are newer that these of the installation</div>
<dl class="notes">
<dt>Returns:</dt>
<dd><code>true</code> if project profiles would require downgrade, <code>false</code>
 otherwise</dd>
</dl>
</section>
</li>
