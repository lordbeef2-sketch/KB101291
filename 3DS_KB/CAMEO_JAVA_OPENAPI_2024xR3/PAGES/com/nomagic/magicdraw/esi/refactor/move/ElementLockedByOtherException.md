# JAVA OPENAPI: ElementLockedByOtherException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/esi/refactor/move/ElementLockedByOtherException.html
- source_path: `com/nomagic/magicdraw/esi/refactor/move/ElementLockedByOtherException.html`
- source_sha256: `9a2b545d5946ffce6eb5d16a9f79322016fa46b6a0606d3bd6a6d2037c448381`
- captured_utc: `2026-07-14T16:55:20.694068+00:00`
...
@OpenApiAllpublic classElementLockedByOtherException
...
See Also:
[Serialized Form](../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.ElementLockedByOtherException)
...
Constructor
Description
`[ElementLockedByOtherException](#%3Cinit%3E(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.String))([Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) user)`
Creates new instance of [`ElementLockedByOtherException`](ElementLockedByOtherException.html)
 ========== METHOD SUMMARY =========== 
Method Summary
...
public ElementLockedByOtherException([Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) user)
Creates new instance of [`ElementLockedByOtherException`](ElementLockedByOtherException.html)
Parameters:
...
<h1 class="title" title="Class ElementLockedByOtherException">Class ElementLockedByOtherException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.esi.refactor.move.ElementLockedByOtherException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ElementLockedByOtherException</span>
...
<div class="block">Indicates that an element is locked by other user</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../serialized-form.html#com.nomagic.magicdraw.esi.refactor.move.ElementLockedByOtherException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="block">Creates new instance of <a href="ElementLockedByOtherException.html" title="class in com.nomagic.magicdraw.esi.refactor.move"><code>ElementLockedByOtherException</code></a></div>
</div>
</div>
</section>
</li>
...
<div class="block">Gets the element that is locked by other user</div>
</div>
...
<div class="block">Gets the user who has locked the element</div>
</div>
</div>
</div>
</div>
...
<h3>ElementLockedByOtherException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ElementLockedByOtherException</span><wbr/><span class="parameters">(<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>element</code> - the element that is locked by other user</dd>
<dd><code>user</code> - the user who has locked the element</dd>
</dl>
</section>
</li>
</ul>
