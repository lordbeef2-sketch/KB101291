# JAVA OPENAPI: SimulationProfile.NestedUIConfigStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/simulation/SimulationProfile.NestedUIConfigStereotype.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationProfile.NestedUIConfigStereotype.html`
- source_sha256: `917255bdf6eac705c3da9a551c5d1ddd50fffef50a181b3bc5fc129201d5de5a`
- captured_utc: `2026-07-14T16:55:35.415234+00:00`
...
CONFIG
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) CONFIG
Specify which existing UI configuration will be used and displayed as the UI of the system part, which is represented by the property specified in the feature tag.
See Also:
...
<h3>CONFIG</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">CONFIG</span></div>
<div class="block">Specify which existing UI configuration will be used and displayed as the UI of the system part, which is represented by the property specified in the feature tag.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
