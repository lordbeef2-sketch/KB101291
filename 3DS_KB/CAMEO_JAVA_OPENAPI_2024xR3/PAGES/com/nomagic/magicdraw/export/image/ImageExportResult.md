# JAVA OPENAPI: ImageExportResult (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/export/image/ImageExportResult.html
- source_path: `com/nomagic/magicdraw/export/image/ImageExportResult.html`
- source_sha256: `c3710950a05b66344b2f447144f4c1fb88b8265ed85f0632e5c33ce6e916fc7a`
- captured_utc: `2026-07-14T16:55:21.082073+00:00`
...
`[ImageExportResult](#%3Cinit%3E(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult))(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult result)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`final void`
`[setValuesFromInternalResult](#setValuesFromInternalResult(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult))(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult result)`
...
exportedAreaRect
protected [Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) exportedAreaRect
Start point in the diagram and dimension exported diagram area
exportedCanvasAreaRect
protected [Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) exportedCanvasAreaRect
Start point in the diagram canvas and dimension exported diagram canvas area.
...
protected [Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) imageWithoutBannersRect
Rectangle within exported image containing exported are
imageRect
protected [Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) imageRect
Rectangle of exported image.
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ImageExportResult
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color"><code>protected <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a></code></div>
...
<div class="col-first odd-row-color"><code>protected <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a></code></div>
...
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult)">ImageExportResult</a><wbr/>(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult result)</code></div>
...
<h3>imageRect</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a></span> <span class="element-name">imageRect</span></div>
<div class="block">Rectangle of exported image.</div>
</section>
</li>
</ul>
...
<li>
<section class="detail" id="&lt;init&gt;(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult)">
<h3>ImageExportResult</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ImageExportResult</span><wbr/><span class="parameters">(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult result)</span></div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="setValuesFromInternalResult(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult)">
<h3>setValuesFromInternalResult</h3>
<div class="member-signature"><span class="modifiers">public final</span> <span class="return-type">void</span> <span class="element-name">setValuesFromInternalResult</span><wbr/><span class="parameters">(com.dassault_systemes.modeler.magic.diagram.image.InternalImageExportResult result)</span></div>
</section>
</li>
<li>
