# JAVA OPENAPI: DrawShapeDiagramAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/ui/actions/DrawShapeDiagramAction.html
- source_path: `com/nomagic/magicdraw/ui/actions/DrawShapeDiagramAction.html`
- source_sha256: `468cc27ad6eaff3760591d7b157089204389a7f44a5db5b7aa0a103ef87eff82`
- captured_utc: `2026-07-14T16:55:51.169409+00:00`
...
[com.nomagic.magicdraw.ui.diagrams.BaseCustomizableDiagramAction](../diagrams/BaseCustomizableDiagramAction.html)
...
@OpenApipublic abstract classDrawShapeDiagramAction
extends [BaseCustomizableDiagramAction](../diagrams/BaseCustomizableDiagramAction.html)

The abstract diagram action to draw shape from diagram toolbar.

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.ui.actions.DrawShapeDiagramAction)

=========== FIELD SUMMARY =========== 
Field Summary
Fields inherited from class com.nomagic.magicdraw.ui.diagrams.[BaseCustomizableDiagramAction](../diagrams/BaseCustomizableDiagramAction.html)
`[customAdditionalDrawAction](../diagrams/BaseCustomizableDiagramAction.html#customAdditionalDrawAction)`
...
Constructor
Description
`[DrawShapeDiagramAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionID,
...
Method
Description
`final [PresentationElement](../../uml/symbols/PresentationElement.html)`
`[create](#create())()`
Creates presentation element.
`com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction`
`[createAdditionalDrawAction](#createAdditionalDrawAction(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../../uml/symbols/PresentationElement.html) view)`

`protected abstract [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[createElement](#createElement())()`
Creates model element
`protected [PresentationElement](../../uml/symbols/PresentationElement.html)`
`[createPresentationElement](#createPresentationElement())()`
Creates presentation element.
`protected com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State`
`[createState](#createState())()`

`protected [Dimension](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Dimension.html)`
`[getDefaultSize](#getDefaultSize())()`

`protected [DiagramPresentationElement](../../uml/symbols/DiagramPresentationElement.html)`
`[getDiagram](#getDiagram())()`
Returns diagram this action.
Methods inherited from class com.nomagic.magicdraw.ui.diagrams.[BaseCustomizableDiagramAction](../diagrams/BaseCustomizableDiagramAction.html)
`[clone](../diagrams/BaseCustomizableDiagramAction.html#clone()), [getCustomAdditionalDrawAction](../diagrams/BaseCustomizableDiagramAction.html#getCustomAdditionalDrawAction()), [getDefaultAdditionalDrawAction](../diagrams/BaseCustomizableDiagramAction.html#getDefaultAdditionalDrawAction()), [getDefaultIcon](../diagrams/BaseCustomizableDiagramAction.html#getDefaultIcon()), [getIcons](../diagrams/BaseCustomizableDiagramAction.html#getIcons()), [getLargeIcon](../diagrams/BaseCustomizableDiagramAction.html#getLargeIcon()), [getSmallIcon](../diagrams/BaseCustomizableDiagramAction.html#getSmallIcon()), [getStyle](../diagrams/BaseCustomizableDiagramAction.html#getStyle()), [setCustomAdditionalDrawAction](../diagrams/BaseCustomizableDiagramAction.html#setCustomAdditionalDrawAction(com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction)), [setDescription](../diagrams/BaseCustomizableDiagramAction.html#setDescription(java.lang.String)), [setIcons](../diagrams/BaseCustomizableDiagramAction.html#setIcons(com.nomagic.magicdraw.ui.diagrams.IconCollection)), [setStyle](../diagrams/BaseCustomizableDiagramAction.html#setStyle(com.nomagic.magicdraw.properties.PropertyManager)), [setStyle](../diagrams/BaseCustomizableDiagramAction.html#setStyle(com.nomagic.magicdraw.ui.diagrams.PropertyManagerProxy))`
...
@OpenApipublic DrawShapeDiagramAction([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionID,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionName,
 @CheckForNull
 [KeyStroke](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/KeyStroke.html) key)
Constructs new action with given id and name.
...
Method Details
createState
@NotApiprotected com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State createState()
Overrides:
`[createState](../diagrams/BaseCustomizableDiagramAction.html#createState())` in class `[BaseCustomizableDiagramAction](../diagrams/BaseCustomizableDiagramAction.html)`
createElement
@OpenApiprotected abstract [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) createElement()
Creates model element
Returns:
created model element
getDefaultSize
@CheckForNullprotected [Dimension](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Dimension.html) getDefaultSize()
create
@CheckForNullpublic final [PresentationElement](../../uml/symbols/PresentationElement.html) create()
Creates presentation element.
Returns:
created presentation element
createPresentationElement
@OpenApi
@CheckForNullprotected [PresentationElement](../../uml/symbols/PresentationElement.html) createPresentationElement()
Creates presentation element.
Returns:
created presentation element
createAdditionalDrawAction
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction createAdditionalDrawAction([PresentationElement](../../uml/symbols/PresentationElement.html) view)
getDiagram
@CheckForNullprotected [DiagramPresentationElement](../../uml/symbols/DiagramPresentationElement.html) getDiagram()
Description copied from class: `[DefaultAbstractDiagramStateAction](../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html#getDiagram())`
Returns diagram this action.
...
Overrides:
`[getDiagram](../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html#getDiagram())` in class `[DefaultAbstractDiagramStateAction](../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html)`
Returns:
diagram.
...
<h1 class="title" title="Class DrawShapeDiagramAction">Class DrawShapeDiagramAction</h1>
</div>
...
<div class="inheritance"><a href="../diagrams/BaseCustomizableDiagramAction.html" title="class in com.nomagic.magicdraw.ui.diagrams">com.nomagic.magicdraw.ui.diagrams.BaseCustomizableDiagramAction</a>
<div class="inheritance">com.nomagic.magicdraw.ui.actions.DrawShapeDiagramAction</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public abstract class </span><span class="element-name type-name-label">DrawShapeDiagramAction</span>
<span class="extends-implements">extends <a href="../diagrams/BaseCustomizableDiagramAction.html" title="class in com.nomagic.magicdraw.ui.diagrams">BaseCustomizableDiagramAction</a></span></div>
<div class="block">The abstract diagram action to draw shape from diagram toolbar.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.ui.actions.DrawShapeDiagramAction">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3 id="fields-inherited-from-class-com.nomagic.magicdraw.ui.diagrams.BaseCustomizableDiagramAction">Fields inherited from class com.nomagic.magicdraw.ui.diagrams.<a href="../diagrams/BaseCustomizableDiagramAction.html" title="class in com.nomagic.magicdraw.ui.diagrams">BaseCustomizableDiagramAction</a></h3>
<code><a href="../diagrams/BaseCustomizableDiagramAction.html#customAdditionalDrawAction">customAdditionalDrawAction</a></code></div>
<div class="inherited-list">
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke)">DrawShapeDiagramAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> actionID,
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/KeyStroke.html" title="class or interface in javax.swing">KeyStroke</a> key)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs new action with given id and name.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>final <a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></div>
...
<div class="block">Creates presentation element.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createAdditionalDrawAction(com.nomagic.magicdraw.uml.symbols.PresentationElement)">createAdditionalDrawAction</a><wbr/>(<a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>protected abstract <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#createElement()">createElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Creates model element</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createPresentationElement()">createPresentationElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates presentation element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createState()">createState</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Dimension.html" title="class or interface in java.awt">Dimension</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultSize()">getDefaultSize</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../../uml/symbols/DiagramPresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">DiagramPresentationElement</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns diagram this action.</div>
</div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.ui.diagrams.BaseCustomizableDiagramAction">Methods inherited from class com.nomagic.magicdraw.ui.diagrams.<a href="../diagrams/BaseCustomizableDiagramAction.html" title="class in com.nomagic.magicdraw.ui.diagrams">BaseCustomizableDiagramAction</a></h3>
<code><a href="../diagrams/BaseCustomizableDiagramAction.html#clone()">clone</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getCustomAdditionalDrawAction()">getCustomAdditionalDrawAction</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getDefaultAdditionalDrawAction()">getDefaultAdditionalDrawAction</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getDefaultIcon()">getDefaultIcon</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getIcons()">getIcons</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getLargeIcon()">getLargeIcon</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getSmallIcon()">getSmallIcon</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#getStyle()">getStyle</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#setCustomAdditionalDrawAction(com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction)">setCustomAdditionalDrawAction</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#setDescription(java.lang.String)">setDescription</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#setIcons(com.nomagic.magicdraw.ui.diagrams.IconCollection)">setIcons</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#setStyle(com.nomagic.magicdraw.properties.PropertyManager)">setStyle</a>, <a href="../diagrams/BaseCustomizableDiagramAction.html#setStyle(com.nomagic.magicdraw.ui.diagrams.PropertyManagerProxy)">setStyle</a></code></div>
<div class="inherited-list">
...
<h3>DrawShapeDiagramAction</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">DrawShapeDiagramAction</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> actionID,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> actionName,
 @CheckForNull
...
<dd><code>actionName</code> - name of the action.</dd>
<dd><code>key</code> - the command key for action.</dd>
</dl>
</section>
</li>
</ul>
...
</span><span class="modifiers">protected</span> <span class="return-type">com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State</span> <span class="element-name">createState</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../diagrams/BaseCustomizableDiagramAction.html#createState()">createState</a></code> in class <code><a href="../diagrams/BaseCustomizableDiagramAction.html" title="class in com.nomagic.magicdraw.ui.diagrams">BaseCustomizableDiagramAction</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createElement()">
<h3>createElement</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">protected abstract</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">createElement</span>()</div>
<div class="block">Creates model element</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>created model element</dd>
</dl>
</section>
</li>
<li>
...
</span><span class="modifiers">protected</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Dimension.html" title="class or interface in java.awt">Dimension</a></span> <span class="element-name">getDefaultSize</span>()</div>
</section>
</li>
<li>
...
<h3>create</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public final</span> <span class="return-type"><a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">create</span>()</div>
<div class="block">Creates presentation element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>created presentation element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createPresentationElement()">
<h3>createPresentationElement</h3>
<div class="member-signature"><span class="annotations">@OpenApi
@CheckForNull
</span><span class="modifiers">protected</span> <span class="return-type"><a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">createPresentationElement</span>()</div>
<div class="block">Creates presentation element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>created presentation element</dd>
...
<li>
<section class="detail" id="createAdditionalDrawAction(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>createAdditionalDrawAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction</span> <span class="element-name">createAdditionalDrawAction</span><wbr/><span class="parameters">(<a href="../../uml/symbols/PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view)</span></div>
</section>
</li>
<li>
...
<h3>getDiagram</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">protected</span> <span class="return-type"><a href="../../uml/symbols/DiagramPresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">DiagramPresentationElement</a></span> <span class="element-name">getDiagram</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html#getDiagram()">DefaultAbstractDiagramStateAction</a></code></span></div>
<div class="block">Returns diagram this action.
 MagicDraw framework guarantee that diagram will set if this method is called from updateState() or
 actionPerformed(ActionEvent) methods.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html#getDiagram()">getDiagram</a></code> in class <code><a href="../../../../dassault_systemes/modeler/magic/ui/diagrams/actions/DefaultAbstractDiagramStateAction.html" title="class in com.dassault_systemes.modeler.magic.ui.diagrams.actions">DefaultAbstractDiagramStateAction</a></code></dd>
<dt>Returns:</dt>
<dd>diagram.</dd>
</dl>
</section>
