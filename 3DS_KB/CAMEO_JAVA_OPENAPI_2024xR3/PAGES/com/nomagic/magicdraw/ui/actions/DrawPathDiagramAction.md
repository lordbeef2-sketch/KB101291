# JAVA OPENAPI: DrawPathDiagramAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/ui/actions/DrawPathDiagramAction.html
- source_path: `com/nomagic/magicdraw/ui/actions/DrawPathDiagramAction.html`
- source_sha256: `7fd919182e1ec2343021267fa766ca6b8dd411060716b9dd8d53d211f36b9369`
- captured_utc: `2026-07-14T16:55:51.286412+00:00`
...
@OpenApipublic abstract classDrawPathDiagramAction
extends com.nomagic.magicdraw.ui.actions.BaseDiagramAction

The abstract diagram action to draw path from diagram toolbar.

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.ui.actions.DrawPathDiagramAction)
...
Constructor
Description
`[DrawPathDiagramAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) actionID,
...
`[createAdditionalDrawAction](#createAdditionalDrawAction())()`

`protected com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements`
`[createCreatableClientElements](#createCreatableClientElements())()`

`protected com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements`
`[createCreatableSupplierElements](#createCreatableSupplierElements())()`

`protected abstract [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[createElement](#createElement())()`
Creates model link.
`protected [PathElement](../../uml/symbols/paths/PathElement.html)`
...
@OpenApipublic DrawPathDiagramAction(@CheckForNull
...
Method Details
createState
@CheckForNullprotected com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State createState()
Overrides:
...
created model link
createPathElement
protected [PathElement](../../uml/symbols/paths/PathElement.html) createPathElement()
Creates path element.
Returns:
...
@CheckForNullprotected com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction createAdditionalDrawAction()
...
<h1 class="title" title="Class DrawPathDiagramAction">Class DrawPathDiagramAction</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.ui.actions.DrawPathDiagramAction</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public abstract class </span><span class="element-name type-name-label">DrawPathDiagramAction</span>
<span class="extends-implements">extends com.nomagic.magicdraw.ui.actions.BaseDiagramAction</span></div>
<div class="block">The abstract diagram action to draw path from diagram toolbar.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.ui.actions.DrawPathDiagramAction">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke)">DrawPathDiagramAction</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> actionID,
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createAdditionalDrawAction()">createAdditionalDrawAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createCreatableClientElements()">createCreatableClientElements</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createCreatableSupplierElements()">createCreatableSupplierElements</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>protected abstract <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#createElement()">createElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Creates model link.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../../uml/symbols/paths/PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createPathElement()">createPathElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Creates path element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.dassault_systemes.modeler.magic.ui.diagrams.editor.states.State</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createState()">createState</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<code>clone, getDiagramActionsExecuter, getElementCreatorInfo, isAllowedToCreateSymbol</code></div>
<div class="inherited-list">
...
<h3>DrawPathDiagramAction</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">DrawPathDiagramAction</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>createState</code> in class <code>com.nomagic.magicdraw.ui.actions.BaseDiagramAction</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createCreatableClientElements()">
<h3>createCreatableClientElements</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements</span> <span class="element-name">createCreatableClientElements</span>()</div>
</section>
</li>
<li>
<section class="detail" id="createCreatableSupplierElements()">
<h3>createCreatableSupplierElements</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.manipulators.CreatableShapeElements</span> <span class="element-name">createCreatableSupplierElements</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>created model link</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createPathElement()">
<h3>createPathElement</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../../uml/symbols/paths/PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></span> <span class="element-name">createPathElement</span>()</div>
<div class="block">Creates path element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>created path element</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="createAdditionalDrawAction()">
<h3>createAdditionalDrawAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.manipulators.drawactions.AdditionalDrawAction</span> <span class="element-name">createAdditionalDrawAction</span>()</div>
</section>
</li>
</ul>
</section>
