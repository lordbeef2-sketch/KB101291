# JAVA OPENAPI: SelectElementInfo (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/ui/dialogs/SelectElementInfo.html
- source_path: `com/nomagic/magicdraw/ui/dialogs/SelectElementInfo.html`
- source_sha256: `396ca0372849a7bcaa2006f0e7a767faa1803850553e8329b41e34f590e7383f`
- captured_utc: `2026-07-14T16:55:51.686417+00:00`
...
Show NONE node
`boolean`
`[showNotLoadedData](#showNotLoadedData)`
...
not used anymore.
`boolean`
`[useTypeSpecificDialogTitle](#useTypeSpecificDialogTitle)`
 ======== CONSTRUCTOR SUMMARY ======== 
Constructor Summary
Constructors
Constructor
Description
`[SelectElementInfo](#%3Cinit%3E(boolean,boolean))(boolean showNone,
 boolean showDiagrams)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,boolean))(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,boolean,int))(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 int suggestionList)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) root)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int))(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) root,
 int suggestionList)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int,boolean))(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) root,
 int suggestionList,
 boolean showNotLoadedData)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,int))(boolean showNone,
 boolean showDiagrams,
 int suggestionList)`

`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))(boolean showNone,
 boolean showDiagrams,
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) root)`
...
`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,boolean))(boolean showNone,
 ...
 boolean sortable)`
Constructor.
`[SelectElementInfo](#%3Cinit%3E(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int))(boolean showNone,
 boolean showDiagrams,
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) root,
 int suggestionList)`
 ========== METHOD SUMMARY =========== 
...
Method
Description
`static [SelectElementInfo](SelectElementInfo.html)`
`[create](#create(com.nomagic.magicdraw.properties.Property))([Property](../../properties/Property.html) property)`
...
Method Details
create
public static [SelectElementInfo](SelectElementInfo.html) create([Property](../../properties/Property.html) property)
An utility method to create an instance for given property.
Parameters:
...
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#showNotLoadedData">showNotLoadedData</a></code></div>
<div class="col-last even-row-color">
<div class="block">Show not loaded data in UI</div>
</div>
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#showRelationships">showRelationships</a></code></div>
<div class="col-last odd-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">not used anymore.</div>
</div>
...
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#sortable">sortable</a></code></div>
<div class="col-last even-row-color">
<div class="block">Should result of selection in UI be "sortable"</div>
</div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#SUGGESTION_LIST_ALWAYS">SUGGESTION_LIST_ALWAYS</a></code></div>
<div class="col-last odd-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">not used anymore</div>
</div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#SUGGESTION_LIST_NEVER">SUGGESTION_LIST_NEVER</a></code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">not used anymore</div>
</div>
...
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#SUGGESTION_LIST_ON_DEMAND">SUGGESTION_LIST_ON_DEMAND</a></code></div>
<div class="col-last odd-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">not used anymore</div>
</div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#suggestionList">suggestionList</a></code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">not used anymore.</div>
</div>
...
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#useTypeSpecificDialogTitle">useTypeSpecificDialogTitle</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,boolean)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,boolean,int)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 int suggestionList)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
...
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 ...
 int suggestionList)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int,boolean)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> root,
 int suggestionList,
 boolean showNotLoadedData)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,int)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 int suggestionList)</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> root)</code></div>
<div class="col-last odd-row-color"> </div>
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int)">SelectElementInfo</a><wbr/>(boolean showNone,
 boolean showDiagrams,
 <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> root,
 int suggestionList)</code></div>
<div class="col-last odd-row-color"> </div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SelectElementInfo.html" title="class in com.nomagic.magicdraw.ui.dialogs">SelectElementInfo</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#create(com.nomagic.magicdraw.properties.Property)">create</a><wbr/>(<a href="../../properties/Property.html" title="class in com.nomagic.magicdraw.properties">Property</a> property)</code></div>
...
<li>
<section class="detail" id="showNotLoadedData">
<h3>showNotLoadedData</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">showNotLoadedData</span></div>
<div class="block">Show not loaded data in UI</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="useTypeSpecificDialogTitle">
<h3>useTypeSpecificDialogTitle</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">useTypeSpecificDialogTitle</span></div>
</section>
</li>
</ul>
</section>
...
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams)</span></div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships)</span></div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,int)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 int suggestionList)</span></div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
...
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,boolean,int)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
...
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 @CheckForNull
...
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 @CheckForNull
...
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
...
<li>
<section class="detail" id="&lt;init&gt;(boolean,boolean,boolean,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,int,boolean)">
<h3>SelectElementInfo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SelectElementInfo</span><wbr/><span class="parameters">(boolean showNone,
 boolean showDiagrams,
 boolean showRelationships,
 ...
 <a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> root,
 int suggestionList,
 boolean showNotLoadedData)</span></div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="create(com.nomagic.magicdraw.properties.Property)">
<h3>create</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SelectElementInfo.html" title="class in com.nomagic.magicdraw.ui.dialogs">SelectElementInfo</a></span> <span class="element-name">create</span><wbr/><span class="parameters">(<a href="../../properties/Property.html" title="class in com.nomagic.magicdraw.properties">Property</a> property)</span></div>
<div class="block">An utility method to create an instance for given property.</div>
<dl class="notes">
<dt>Parameters:</dt>
