# JAVA OPENAPI: SysMLProfile.AdjunctPropertyStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/sysml/util/SysMLProfile.AdjunctPropertyStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.AdjunctPropertyStereotype.html`
- source_sha256: `01cce7d8bcfbdbbd5ec6cf05f8c0de9c1dbeacc0abb498093892eb13866e5aa2`
- captured_utc: `2026-07-14T16:55:35.906237+00:00`
...
public static classSysMLProfile.AdjunctPropertyStereotype
...
Description
`protected`
`[AdjunctPropertyStereotype](#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile))([SysMLProfile](SysMLProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearPrincipal](#clearPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getPrincipal](#getPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)`
`[getPrincipalProperty](#getPrincipalProperty())()`
...
`void`
`[setPrincipal](#setPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.AdjunctPropertyStereotype.STEREOTYPE_NAME)
PRINCIPAL
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) PRINCIPAL
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.AdjunctPropertyStereotype.PRINCIPAL)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
AdjunctPropertyStereotype
protected AdjunctPropertyStereotype([SysMLProfile](SysMLProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getPrincipalProperty()
setPrincipal
public void setPrincipal([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) value)
clearPrincipal
public void clearPrincipal([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
getPrincipal
@CheckForNullpublic [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getPrincipal([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class SysMLProfile.AdjunctPropertyStereotype">Class SysMLProfile.AdjunctPropertyStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.AdjunctPropertyStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SysMLProfile.AdjunctPropertyStereotype</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#PRINCIPAL">PRINCIPAL</a></code></div>
<div class="col-last even-row-color">
<div class="block">Gives the element that determines the values of the property.</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile)">AdjunctPropertyStereotype</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearPrincipal</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getPrincipal</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPrincipalProperty()">getPrincipalProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setPrincipal</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.AdjunctPropertyStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>PRINCIPAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">PRINCIPAL</span></div>
<div class="block">Gives the element that determines the values of the property.  Must be a connector, call action, object node, variable, or parameter.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.AdjunctPropertyStereotype.PRINCIPAL">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>AdjunctPropertyStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">AdjunctPropertyStereotype</span><wbr/><span class="parameters">(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getPrincipalProperty()">
<h3>getPrincipalProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getPrincipalProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setPrincipal</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setPrincipal</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearPrincipal</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearPrincipal</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getPrincipal(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getPrincipal</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getPrincipal</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
