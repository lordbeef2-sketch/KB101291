# JAVA OPENAPI: SysMLProfile.FlowPropertyStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/sysml/util/SysMLProfile.FlowPropertyStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.FlowPropertyStereotype.html`
- source_sha256: `436ae73e5447612cdb385199bb1a58b21e50d33c2555c0cb6eef519f92e89f04`
...
com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype

Enclosing class:
[SysMLProfile](SysMLProfile.html)

public static classSysMLProfile.FlowPropertyStereotype
...
Description
`protected`
`[FlowPropertyStereotype](#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile))([SysMLProfile](SysMLProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype.STEREOTYPE_NAME)
DIRECTION
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) DIRECTION
Specifies if the property value is received from an external block (direction= in ), transmitted to an external Block (direction= out ) or both (direction= inout ).
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype.DIRECTION)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
FlowPropertyStereotype
protected FlowPropertyStereotype([SysMLProfile](SysMLProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
<h1 class="title" title="Class SysMLProfile.FlowPropertyStereotype">Class SysMLProfile.FlowPropertyStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SysMLProfile.FlowPropertyStereotype</span>
...
<div class="block">Specifies if the property value is received from an external block (direction=   in   ), transmitted to an external Block (direction=   out   ) or both (direction=   inout   ).</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile)">FlowPropertyStereotype</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="SysMLProfile.FlowDirectionKindEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">SysMLProfile.FlowDirectionKindEnum</a></code></div>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.FlowPropertyStereotype.DIRECTION">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>FlowPropertyStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">FlowPropertyStereotype</span><wbr/><span class="parameters">(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
