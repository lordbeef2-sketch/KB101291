# JAVA OPENAPI: SubsetSupersetEObjectContainmentEList (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.html`
- source_sha256: `84fe1b21e1b5db5be6ebef4db30f7381e09399829b320dcaae37899a5d3bc973`
- captured_utc: `2026-07-14T16:56:06.890587+00:00`
...
Constructor
Description
`[SubsetSupersetEObjectContainmentEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`[addAll](#addAll(int,java.util.Collection))(int index,
 [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)`

`boolean`
`[addAll](#addAll(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)`
...
public SubsetSupersetEObjectContainmentEList([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs)
...
addAll
public boolean addAll([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html#addAll(java.util.Collection))` in interface `[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html#addAll(java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Overrides:
...
public boolean addAll(int index,
 [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html#addAll(int,java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Overrides:
