# JAVA OPENAPI: SubsetSupersetEObjectEStoreContainmentWithInverseEList (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentWithInverseEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentWithInverseEList.html`
- source_sha256: `c6cab6f17f916a629aca9334caa5fe598d5b6809e443e40e5a5b135f4a32ad8e`
- captured_utc: `2026-07-14T16:56:07.234589+00:00`
...
## Class SubsetSupersetEObjectEStoreContainmentWithInverseEList<E>
...
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList<E>
...
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Resolving](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Resolving.html)`, `[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)`

public classSubsetSupersetEObjectEStoreContainmentWithInverseEList<E>
extends [SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)<E>

Since:
1.2
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Resolving](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Resolving.html)<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Resolving.html)>`
...
Constructor
Description
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D,int))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
public SubsetSupersetEObjectEStoreContainmentWithInverseEList([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 @CheckForNull
 int[] supersetFeatureIDs,
...
Overrides:
`[hasNavigableInverse](SubsetSupersetEObjectEStoreContainmentEList.html#hasNavigableInverse())` in class `[SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)>`
getInverseFeatureID
public int getInverseFeatureID()
Overrides:
`getInverseFeatureID` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)>`
getInverseFeatureClass
public [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> getInverseFeatureClass()
Overrides:
`getInverseFeatureClass` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreContainmentWithInverseEList">Class SubsetSupersetEObjectEStoreContainmentWithInverseEList&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreContainmentWithInverseEList&lt;E&gt;</span>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D,int)">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs,
...
<h3>SubsetSupersetEObjectEStoreContainmentWithInverseEList</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SubsetSupersetEObjectEStoreContainmentWithInverseEList</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 @CheckForNull
 int[] supersetFeatureIDs,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>getInverseFeatureID</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt;</span> <span class="element-name">getInverseFeatureClass</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>getInverseFeatureClass</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
