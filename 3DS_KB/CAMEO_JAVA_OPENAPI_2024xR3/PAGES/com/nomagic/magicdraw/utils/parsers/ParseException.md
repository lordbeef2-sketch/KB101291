# JAVA OPENAPI: ParseException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/utils/parsers/ParseException.html
- source_path: `com/nomagic/magicdraw/utils/parsers/ParseException.html`
- source_sha256: `bdb87095884ed9404b2142cf711da8a74cbb94038a48c2d4ed0e3f8cc689857a`
- captured_utc: `2026-07-14T16:56:08.353603+00:00`
...
`[ParseException](#%3Cinit%3E(com.nomagic.magicdraw.utils.parsers.Token,int%5B%5D%5B%5D,java.lang.String%5B%5D))([Token](Token.html) currentTokenVal,
 ...
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)[] tokenImageVal)`
This constructor is used by the method "generateParseException"
 in the generated parser.
`[ParseException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)`
...
The following constructors are for use by you for whatever
 ...
 these constructors.
ParseException
public ParseException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) message)
Constructor with message.
 ============ METHOD DETAIL ========== 
Method Details
getCurrentToken
...
getTokenImage
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)[] getTokenImage()
getEol
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getEol()
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.utils.parsers.Token,int%5B%5D%5B%5D,java.lang.String%5B%5D)">ParseException</a><wbr/>(<a href="Token.html" title="class in com.nomagic.magicdraw.utils.parsers">Token</a> currentTokenVal,
 int[][] expectedTokenSequencesVal,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>[] tokenImageVal)</code></div>
<div class="col-last odd-row-color">
<div class="block">This constructor is used by the method "generateParseException"
 in the generated parser.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">ParseException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
<div class="col-last even-row-color">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ParseException</span><wbr/><span class="parameters">(<a href="Token.html" title="class in com.nomagic.magicdraw.utils.parsers">Token</a> currentTokenVal,
 int[][] expectedTokenSequencesVal,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>[] tokenImageVal)</span></div>
<div class="block">This constructor is used by the method "generateParseException"
 in the generated parser.  Calling this constructor generates
 a new object of this type with the fields "currentToken",
...
<h3>getTokenImage</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>[]</span> <span class="element-name">getTokenImage</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getEol()">
<h3>getEol</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getEol</span>()</div>
</section>
</li>
</ul>
</section>
