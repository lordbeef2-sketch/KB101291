# JAVA OPENAPI: SetFontSizeAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/actions/SetFontSizeAction.html
- source_path: `com/nomagic/actions/SetFontSizeAction.html`
- source_sha256: `69794188d7eedb80d36a3fb4a3778f8f991aef5303968ce5208af1c50b52b982`
- captured_utc: `2026-07-14T16:55:01.624854+00:00`
...
`void`
`[setFontSize](#setFontSize(java.lang.Integer))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html) newFontSize)`
Sets new font size value.
`void`
`[setValue](#setValue(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) val)`
Sets new font size value.
...
Field Details
FONT_SIZE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) FONT_SIZE
The value of font size property key.
See Also:
...
Method Details
getFontSize
public [Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html) getFontSize()
Returns selected font size value.
Returns:
selected font size.
setFontSize
public void setFontSize([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html) newFontSize)
Sets new font size value.
Parameters:
`newFontSize` - new font size.
setValue
public void setValue([Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) val)
Sets new font size value.
Overrides:
...
<h3>FONT_SIZE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">FONT_SIZE</span></div>
<div class="block">The value of font size property key.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>getFontSize</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang">Integer</a></span> <span class="element-name">getFontSize</span>()</div>
<div class="block">Returns selected font size value.</div>
<dl class="notes">
<dt>Returns:</dt>
