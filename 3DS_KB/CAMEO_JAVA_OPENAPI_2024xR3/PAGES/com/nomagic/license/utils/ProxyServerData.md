# JAVA OPENAPI: ProxyServerData (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/license/utils/ProxyServerData.html
- source_path: `com/nomagic/license/utils/ProxyServerData.html`
- source_sha256: `3f6b649ecc76c64d2ead781310659357e6bf887595a2a15c4c16a92f612a666b`
- captured_utc: `2026-07-14T16:55:02.458864+00:00`
...
Constructor
Description
`[ProxyServerData](#%3Cinit%3E(java.lang.String,int,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address,
 int port,
 boolean useProxyServer)`

`[ProxyServerData](#%3Cinit%3E(java.lang.String,int,java.lang.String,boolean,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address,
 int port,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) user,
 boolean authenticate,
 boolean useProxyServer)`

`[ProxyServerData](#%3Cinit%3E(java.lang.String,int,java.lang.String,char%5B%5D,boolean,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address,
 int port,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) user,
 char[] password,
 boolean authenticate,
...
`void`
`[setAddress](#setAddress(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address)`
...
Constructor Details
ProxyServerData
public ProxyServerData([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address,
 int port,
 boolean useProxyServer)
ProxyServerData
public ProxyServerData([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address,
...
Method Details
getAddress
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getAddress()
getPort
public int getPort()
getUser
...
setAddress
public void setAddress([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) address)
setPort
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ProxyServerData</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> address,
 int port,
...
<h3>getAddress</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getAddress</span>()</div>
</section>
</li>
<li>
