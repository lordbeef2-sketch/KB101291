# JAVA OPENAPI: RetinaImageIcon (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/ui/RetinaImageIcon.html
- source_path: `com/nomagic/ui/RetinaImageIcon.html`
- source_sha256: `6fc13d99574eacf6a09415df0844ba849c2b55815ee0d72559abe4567be23ae7`
- captured_utc: `2026-07-14T16:56:10.050622+00:00`
...
`[RetinaImageIcon](#%3Cinit%3E(com.nomagic.ui.ResizableIcon,int,int))([ResizableIcon](ResizableIcon.html) icon,
 ...
 int height)`
Constructor.
`[RetinaImageIcon](#%3Cinit%3E(java.awt.Image))([Image](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html) image)`
Constructor.
`[RetinaImageIcon](#%3Cinit%3E(java.awt.Image,int,int))([Image](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html) image,
 int width,
 int height)`
Constructor.
 ========== METHOD SUMMARY =========== 
...
`icon` - given icon
RetinaImageIcon
public RetinaImageIcon([Image](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html) image,
 int width,
 int height)
Constructor. Scales down given icon to the given width and height.
Parameters:
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.awt.Image)">RetinaImageIcon</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html" title="class or interface in java.awt">Image</a> image)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.awt.Image,int,int)">RetinaImageIcon</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html" title="class or interface in java.awt">Image</a> image,
 int width,
 int height)</code></div>
<div class="col-last odd-row-color">
<div class="block">Constructor.</div>
...
<h3>RetinaImageIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RetinaImageIcon</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html" title="class or interface in java.awt">Image</a> image,
 int width,
 int height)</span></div>
<div class="block">Constructor. Scales down given icon to the given width and height.</div>
<dl class="notes">
...
<h3>RetinaImageIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RetinaImageIcon</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Image.html" title="class or interface in java.awt">Image</a> image)</span></div>
