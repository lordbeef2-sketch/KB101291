# JAVA OPENAPI: DeploymentTarget (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/DeploymentTarget.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/DeploymentTarget.html`
- source_sha256: `4976fcd5398eb833c03f81b2eeabf61a89da4ffbd10d19c8331d6c1023a9e288`
- captured_utc: `2026-07-14T16:56:24.462784+00:00`
...
`[Device](Device.html)`, `[EnumerationLiteral](../../classes/mdkernel/EnumerationLiteral.html)`, `[ExecutionEnvironment](ExecutionEnvironment.html)`, `[ExtensionEnd](../../mdprofiles/ExtensionEnd.html)`, `[InstanceSpecification](../../classes/mdkernel/InstanceSpecification.html)`, `[Node](Node.html)`, `[Port](../../compositestructures/mdports/Port.html)`, `[Property](../../classes/mdkernel/Property.html)`

public interfaceDeploymentTargetextends [NamedElement](../../classes/mdkernel/NamedElement.html)
...
The following features are supported:
 [`*Deployed Element*`](#getDeployedElement())
[`*Deployment*`](#getDeployment())

See Also:
[`UMLPackage.getDeploymentTarget()`](../../metadata/UMLPackage.html#getDeploymentTarget())
Model:
abstract="true"
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PackageableElement](../../classes/mdkernel/PackageableElement.html)>`
`[getDeployedElement](#getDeployedElement())()`
Returns the value of the '***Deployed Element***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Deployment](Deployment.html)>`
`[getDeployment](#getDeployment())()`
Returns the value of the '***Deployment***' containment reference list.
`boolean`
`[hasDeployedElement](#hasDeployedElement())()`
...
Method Details
getDeployment
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Deployment](Deployment.html)> getDeployment()
Returns the value of the '***Deployment***' containment reference list.
 The list contents are of type [`Deployment`](Deployment.html).
 It is bidirectional and its opposite is '[`*Location*`](Deployment.html#getLocation())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDeploymentTarget_Deployment()`](../../metadata/UMLPackage.html#getDeploymentTarget_Deployment())
[`Deployment.getLocation()`](Deployment.html#getLocation())
Model:
opposite="location" containment="true" resolveProxies="true" ordered="false"
Generated:
getDeployedElement
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PackageableElement](../../classes/mdkernel/PackageableElement.html)> getDeployedElement()
Returns the value of the '***Deployed Element***' reference list.
...
See Also:
[`UMLPackage.getDeploymentTarget_DeployedElement()`](../../metadata/UMLPackage.html#getDeploymentTarget_DeployedElement())
...
<h1 class="title" title="Interface DeploymentTarget">Interface DeploymentTarget</h1>
</div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getDeployedElement()"><code><em>Deployed Element</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getDeploymentTarget()"><code>UMLPackage.getDeploymentTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
 annotation="MOF package='deployments.mdnodes'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDeployedElement()">getDeployedElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Deployed Element</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDeployment()">getDeployment</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Deployment</b></em>' containment reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasDeployedElement()">hasDeployedElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasDeployment()">hasDeployment</a>()</code></div>
...
<h3>getDeployment</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a>&gt;</span> <span class="element-name">getDeployment</span>()</div>
<div class="block">Returns the value of the '<em><b>Deployment</b></em>' containment reference list.
 The list contents are of type <a href="Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes"><code>Deployment</code></a>.
 It is bidirectional and its opposite is '<a href="Deployment.html#getLocation()"><code><em>Location</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of Deployments for a DeploymentTarget.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Deployment</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getDeploymentTarget_Deployment()"><code>UMLPackage.getDeploymentTarget_Deployment()</code></a></li>
<li><a href="Deployment.html#getLocation()"><code>Deployment.getLocation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="location" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getDeployedElement()">
<h3>getDeployedElement</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../classes/mdkernel/PackageableElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">PackageableElement</a>&gt;</span> <span class="element-name">getDeployedElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Deployed Element</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<code><em>deployment Target Of Deployed Element</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of elements that are manifested in an Artifact that is involved in Deployment to a DeploymentTarget.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Deployed Element</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getDeploymentTarget_DeployedElement()"><code>UMLPackage.getDeploymentTarget_DeployedElement()</code></a></li>
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement#get_deploymentTargetOfDeployedElement</code></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_deploymentTargetOfDeployedElement" transient="true" changeable="false" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasDeployment()">
<h3>hasDeployment</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasDeployment</span>()
...
<li>
<section class="detail" id="hasDeployedElement()">
<h3>hasDeployedElement</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasDeployedElement</span>()
                    throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
