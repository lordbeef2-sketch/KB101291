# JAVA OPENAPI: BehavioredClassifier (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/BehavioredClassifier.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/BehavioredClassifier.html`
- source_sha256: `b3799986d4e9ebcf6162dffc5bca384886f9c9dd70451b2bc23106de8e9a3b6c`
- captured_utc: `2026-07-14T16:56:23.120768+00:00`
...
`[Activity](../../activities/mdfundamentalactivities/Activity.html)`, `[Actor](../../mdusecases/Actor.html)`, `[AssociationClass](../../classes/mdassociationclasses/AssociationClass.html)`, `[Behavior](Behavior.html)`, `[Class](../../classes/mdkernel/Class.html)`, `[Collaboration](../../compositestructures/mdcollaborations/Collaboration.html)`, `[Component](../../components/mdbasiccomponents/Component.html)`, `[Device](../../deployments/mdnodes/Device.html)`, `[ExecutionEnvironment](../../deployments/mdnodes/ExecutionEnvironment.html)`, `[FunctionBehavior](FunctionBehavior.html)`, `[Interaction](../../interactions/mdbasicinteractions/Interaction.html)`, `[Node](../../deployments/mdnodes/Node.html)`, `[OpaqueBehavior](OpaqueBehavior.html)`, `[ProtocolStateMachine](../../statemachines/mdprotocolstatemachines/ProtocolStateMachine.html)`, `[StateMachine](../../statemachines/mdbehaviorstatemachines/StateMachine.html)`, `[Stereotype](../../mdprofiles/Stereotype.html)`, `[UseCase](../../mdusecases/UseCase.html)`

public interfaceBehavioredClassifierextends [Classifier](../../classes/mdkernel/Classifier.html)
...
The following features are supported:
 [`*Classifier Behavior*`](#getClassifierBehavior())
[`*Interface Realization*`](#getInterfaceRealization())
[`*Owned Behavior*`](#getOwnedBehavior())

See Also:
[`UMLPackage.getBehavioredClassifier()`](../../metadata/UMLPackage.html#getBehavioredClassifier())
Model:
abstract="true"
...
`[getClassifierBehavior](#getClassifierBehavior())()`
Returns the value of the '***Classifier Behavior***' reference.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InterfaceRealization](../../classes/mdinterfaces/InterfaceRealization.html)>`
`[getInterfaceRealization](#getInterfaceRealization())()`
Returns the value of the '***Interface Realization***' containment reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Behavior](Behavior.html)>`
`[getOwnedBehavior](#getOwnedBehavior())()`
Returns the value of the '***Owned Behavior***' containment reference list.
`boolean`
`[hasInterfaceRealization](#hasInterfaceRealization())()`

`boolean`
`[hasOwnedBehavior](#hasOwnedBehavior())()`

`void`
`[setClassifierBehavior](#setClassifierBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))([Behavior](Behavior.html) value)`
Sets the value of the
 '[`*Classifier Behavior*`](#getClassifierBehavior())' reference.
...
Method Details
getOwnedBehavior
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Behavior](Behavior.html)> getOwnedBehavior()
Returns the value of the '***Owned Behavior***' containment reference list.
 The list contents are of type [`Behavior`](Behavior.html).
 It is bidirectional and its opposite is '[`*behaviored Classifier Of Owned Behavior*`](Behavior.html#get_behavioredClassifierOfOwnedBehavior())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getBehavioredClassifier_OwnedBehavior()`](../../metadata/UMLPackage.html#getBehavioredClassifier_OwnedBehavior())
[`Behavior.get_behavioredClassifierOfOwnedBehavior()`](Behavior.html#get_behavioredClassifierOfOwnedBehavior())
Model:
opposite="_behavioredClassifierOfOwnedBehavior" containment="true" resolveProxies="true" ordered="false"
Generated:
getClassifierBehavior
@CheckForNull[Behavior](Behavior.html) getClassifierBehavior()
Returns the value of the '***Classifier Behavior***' reference.
 It is bidirectional and its opposite is '[`.Behavior#get_behavioredClassifierOfClassifierBehavior *behaviored Classifier Of Classifier Behavior*`](package-summary.html)'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setClassifierBehavior(Behavior)`](#setClassifierBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))
[`UMLPackage.getBehavioredClassifier_ClassifierBehavior()`](../../metadata/UMLPackage.html#getBehavioredClassifier_ClassifierBehavior())
[`Behavior.get_behavioredClassifierOfClassifierBehavior()`](Behavior.html#get_behavioredClassifierOfClassifierBehavior())
Model:
opposite="_behavioredClassifierOfClassifierBehavior" ordered="false"
Generated:
setClassifierBehavior
void setClassifierBehavior(@CheckForNull
 [Behavior](Behavior.html) value)
Sets the value of the
 '[`*Classifier Behavior*`](#getClassifierBehavior())' reference.
 begin-user-doc 
 end-user-doc
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InterfaceRealization](../../classes/mdinterfaces/InterfaceRealization.html)> getInterfaceRealization()
Returns the value of the '***Interface Realization***' containment reference list.
 The list contents are of type [`InterfaceRealization`](../../classes/mdinterfaces/InterfaceRealization.html).
 It is bidirectional and its opposite is
 '[`*Implementing Classifier*`](../../classes/mdinterfaces/InterfaceRealization.html#getImplementingClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The set of InterfaceRealizations owned by the BehavioredClassifier. Interface realizations reference the Interfaces of which the BehavioredClassifier is an
 implementation.
 end-model-doc
Returns:
the value of the '*Interface Realization*' containment reference list.
See Also:
[`UMLPackage.getBehavioredClassifier_InterfaceRealization()`](../../metadata/UMLPackage.html#getBehavioredClassifier_InterfaceRealization())
[`InterfaceRealization.getImplementingClassifier()`](../../classes/mdinterfaces/InterfaceRealization.html#getImplementingClassifier())
Model:
opposite="implementingClassifier" containment="true" resolveProxies="true" ordered="false"
Generated:
hasOwnedBehavior
boolean hasOwnedBehavior()
 throws javax.jmi.reflect.JmiException
Throws:
`javax.jmi.reflect.JmiException`
Generated:
hasInterfaceRealization
boolean hasInterfaceRealization()
 throws javax.jmi.reflect.JmiException
Throws:
`javax.jmi.reflect.JmiException`
Generated:
...
<h1 class="title" title="Interface BehavioredClassifier">Interface BehavioredClassifier</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">BehavioredClassifier</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getClassifierBehavior()"><code><em>Classifier Behavior</em></code></a></li>
<li><a href="#getInterfaceRealization()"><code><em>Interface Realization</em></code></a></li>
<li><a href="#getOwnedBehavior()"><code><em>Owned Behavior</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getBehavioredClassifier()"><code>UMLPackage.getBehavioredClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getClassifierBehavior()">getClassifierBehavior</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Classifier Behavior</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInterfaceRealization()">getInterfaceRealization</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Interface Realization</b></em>' containment reference list.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedBehavior()">getOwnedBehavior</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Owned Behavior</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasInterfaceRealization()">hasInterfaceRealization</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasOwnedBehavior()">hasOwnedBehavior</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setClassifierBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setClassifierBehavior</a><wbr/>(<a href="Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#getClassifierBehavior()"><code><em>Classifier Behavior</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getOwnedBehavior()">
<h3>getOwnedBehavior</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a>&gt;</span> <span class="element-name">getOwnedBehavior</span>()</div>
<div class="block">Returns the value of the '<em><b>Owned Behavior</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is '<a href="Behavior.html#get_behavioredClassifierOfOwnedBehavior()"><code><em>behaviored Classifier Of Owned Behavior</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Behaviors owned by a BehavioredClassifier.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Owned Behavior</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getBehavioredClassifier_OwnedBehavior()"><code>UMLPackage.getBehavioredClassifier_OwnedBehavior()</code></a></li>
<li><a href="Behavior.html#get_behavioredClassifierOfOwnedBehavior()"><code>Behavior.get_behavioredClassifierOfOwnedBehavior()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_behavioredClassifierOfOwnedBehavior" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getClassifierBehavior()">
<h3>getClassifierBehavior</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></span> <span class="element-name">getClassifierBehavior</span>()</div>
<div class="block">Returns the value of the '<em><b>Classifier Behavior</b></em>' reference.
 It is bidirectional and its opposite is '<a href="package-summary.html"><code>.Behavior#get_behavioredClassifierOfClassifierBehavior <em>behaviored Classifier Of Classifier Behavior</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A Behavior that specifies the behavior of the BehavioredClassifier itself.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Classifier Behavior</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setClassifierBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)"><code>setClassifierBehavior(Behavior)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getBehavioredClassifier_ClassifierBehavior()"><code>UMLPackage.getBehavioredClassifier_ClassifierBehavior()</code></a></li>
<li><a href="Behavior.html#get_behavioredClassifierOfClassifierBehavior()"><code>Behavior.get_behavioredClassifierOfClassifierBehavior()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_behavioredClassifierOfClassifierBehavior" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setClassifierBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">
<h3>setClassifierBehavior</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setClassifierBehavior</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</span></div>
<div class="block">Sets the value of the
 '<a href="#getClassifierBehavior()"><code><em>Classifier Behavior</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Classifier Behavior</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getClassifierBehavior()"><code>getClassifierBehavior()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getInterfaceRealization()">
<h3>getInterfaceRealization</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../classes/mdinterfaces/InterfaceRealization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces">InterfaceRealization</a>&gt;</span> <span class="element-name">getInterfaceRealization</span>()</div>
<div class="block">Returns the value of the '<em><b>Interface Realization</b></em>' containment reference list.
 The list contents are of type <a href="../../classes/mdinterfaces/InterfaceRealization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces"><code>InterfaceRealization</code></a>.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdinterfaces/InterfaceRealization.html#getImplementingClassifier()"><code><em>Implementing Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The set of InterfaceRealizations owned by the BehavioredClassifier. Interface realizations reference the Interfaces of which the BehavioredClassifier is an
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Interface Realization</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getBehavioredClassifier_InterfaceRealization()"><code>UMLPackage.getBehavioredClassifier_InterfaceRealization()</code></a></li>
<li><a href="../../classes/mdinterfaces/InterfaceRealization.html#getImplementingClassifier()"><code>InterfaceRealization.getImplementingClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="implementingClassifier" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasOwnedBehavior()">
<h3>hasOwnedBehavior</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasOwnedBehavior</span>()
...
<li>
<section class="detail" id="hasInterfaceRealization()">
<h3>hasInterfaceRealization</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasInterfaceRealization</span>()
                         throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
