# JAVA OPENAPI: Vertex (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/Vertex.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/Vertex.html`
- source_sha256: `f468b8458c0a3541bf922b1d0784d322f9609d27d19ad76a444f50fd8fd41a1a`
- captured_utc: `2026-07-14T16:56:26.313805+00:00`
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Vertex](Vertex.html)> get_vertexOfRedefinedVertex()
Returns the value of the '***Vertex***' reference list.
 It is bidirectional and its opposite is
...
Generated:
getOutgoing
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Transition](Transition.html)> getOutgoing()
Returns the value of the '***Outgoing***' reference list.
...
Generated:
getIncoming
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Transition](Transition.html)> getIncoming()
Returns the value of the '***Incoming***' reference list.
 The list contents are of type [`Transition`](Transition.html).
