# JAVA OPENAPI: Stereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/mdprofiles/Stereotype.html
- source_path: `com/nomagic/uml2/ext/magicdraw/mdprofiles/Stereotype.html`
- source_sha256: `cb270dac6a7a712626920cb4e6d686c0e36a810b63b4c49801fec5c6f8a7a44f`
- captured_utc: `2026-07-14T16:56:25.698797+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExtensionEnd](ExtensionEnd.html)>`
`[get_extensionEndOfType](#get_extensionEndOfType())()`
Returns the value of the '***extension End Of Type***' reference list.
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](../classes/mdkernel/Element.html)>`
`[get_stereotypedElement](#get_stereotypedElement())()`
Returns the value of the '***Stereotyped Element***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Image](Image.html)>`
`[getIcon](#getIcon())()`
...
Method Details
getIcon
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Image](Image.html)> getIcon()
Returns the value of the '***Icon***' containment reference list.
...
Returns the value of the '***Profile***' reference.
 It is bidirectional and its opposite is '`*stereotype Of Profile*`'.
 begin-user-doc 
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExtensionEnd](ExtensionEnd.html)> get_extensionEndOfType()
Returns the value of the '***extension End Of Type***' reference list.
...
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](../classes/mdkernel/Element.html)> get_stereotypedElement()
Returns the value of the '***Stereotyped Element***' reference list.
...
<div class="block">Returns the value of the '<em><b>Profile</b></em>' reference.
 It is bidirectional and its opposite is '<code><em>stereotype Of Profile</em></code>'.
 <!-- begin-user-doc -->
<p>
...
<li><code>com.nomagic.uml2.ext.magicdraw.mdprofiles.Profile#get_stereotypeOfProfile</code></li>
</ul>
</dd>
<dt>Model:</dt>
...
<dd>
<ul class="see-list-long">
<li><code>UMLPackage#getStereotype__stereotypedElement()</code></li>
