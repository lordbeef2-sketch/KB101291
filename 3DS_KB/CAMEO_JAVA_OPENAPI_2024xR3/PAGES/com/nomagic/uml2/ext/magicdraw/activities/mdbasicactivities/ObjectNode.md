# JAVA OPENAPI: ObjectNode (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/activities/mdbasicactivities/ObjectNode.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdbasicactivities/ObjectNode.html`
- source_sha256: `ca2faae8d2471ba32a8258a8483ada83741732a96379e2f227142c74d2443e87`
- captured_utc: `2026-07-14T16:56:19.599728+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[State](../../statemachines/mdbehaviorstatemachines/State.html)>`
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExceptionHandler](../mdextrastructuredactivities/ExceptionHandler.html)> get_exceptionHandlerOfExceptionInput()
Returns the value of the '***exception Handler Of Exception Input***' reference list.
...
Generated:
getInState
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[State](../../statemachines/mdbehaviorstatemachines/State.html)> getInState()
Returns the value of the '***In State***' reference list.
...
<li><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getObjectNode_ControlType()</code></li>
</ul>
</dd>
<dt>Model:</dt>
