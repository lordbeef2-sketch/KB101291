# JAVA OPENAPI: StringTaggedValue (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/StringTaggedValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/StringTaggedValue.html`
- source_sha256: `e852281c95be12db4c34d43e73f09c49a0660a5a525c92d0478dfef3d9ad707e`
- captured_utc: `2026-07-14T16:56:22.794763+00:00`
...
public interfaceStringTaggedValueextends [TaggedValue](TaggedValue.html)

begin-user-doc 
 A representation of the model object '***String Tagged Value***'.
 end-user-doc 
begin-model-doc 
 A StringTaggedValue designates that an entity modeled by an Element has a string tagged value or values.
 end-model-doc 
...
Method Details
getValue
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> getValue()
Returns the value of the '***Value***' attribute list.
 The list contents are of type [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html).
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The values held by the StringTaggedValue.
 end-model-doc
Specified by:
...
Model:
unique="false" dataType="uml.String"
Generated:
...
<h1 class="title" title="Interface StringTaggedValue">Interface StringTaggedValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">StringTaggedValue</span><span class="extends-implements">
...
<div class="block"><!-- begin-user-doc -->
 A representation of the model object '<em><b>String Tagged Value</b></em>'.
 <!-- end-user-doc -->
<p>
<!-- begin-model-doc -->
 A StringTaggedValue designates that an entity modeled by an Element has a string tagged value or values.
...
<dt>Model:</dt>
<dd>unique="false" dataType="uml.String"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
