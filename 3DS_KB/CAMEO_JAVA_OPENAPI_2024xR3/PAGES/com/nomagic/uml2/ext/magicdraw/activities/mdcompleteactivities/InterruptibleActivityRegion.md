# JAVA OPENAPI: InterruptibleActivityRegion (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/activities/mdcompleteactivities/InterruptibleActivityRegion.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdcompleteactivities/InterruptibleActivityRegion.html`
- source_sha256: `83f923439810fd387e6610defd5bd53c8f8d982759e2a90ef21ed19b53238d4f`
- captured_utc: `2026-07-14T16:56:19.406727+00:00`
...
public interfaceInterruptibleActivityRegionextends [ActivityGroup](../mdfundamentalactivities/ActivityGroup.html)
...
The following features are supported:
 [`*Node*`](#getNode())
[`*Interrupting Edge*`](#getInterruptingEdge())

See Also:
[`UMLPackage.getInterruptibleActivityRegion()`](../../metadata/UMLPackage.html#getInterruptibleActivityRegion())
Model:
...
`[getInterruptingEdge](#getInterruptingEdge())()`
...
`boolean`
`[hasInterruptingEdge](#hasInterruptingEdge())()`
...
Returns the value of the '***Node***' reference list.
 ...
 '[`*In Interruptible Region*`](../mdfundamentalactivities/ActivityNode.html#getInInterruptibleRegion())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getInterruptibleActivityRegion_Node()`](../../metadata/UMLPackage.html#getInterruptibleActivityRegion_Node())
[`ActivityNode.getInInterruptibleRegion()`](../mdfundamentalactivities/ActivityNode.html#getInInterruptibleRegion())
Model:
opposite="inInterruptibleRegion" ordered="false"
Generated:
getInterruptingEdge
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityEdge](../mdbasicactivities/ActivityEdge.html)> getInterruptingEdge()
Returns the value of the '***Interrupting Edge***' reference list.
 The list contents are of type [`ActivityEdge`](../mdbasicactivities/ActivityEdge.html).
 It is bidirectional and its opposite is '[`*Interrupts*`](../mdbasicactivities/ActivityEdge.html#getInterrupts())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getInterruptibleActivityRegion_InterruptingEdge()`](../../metadata/UMLPackage.html#getInterruptibleActivityRegion_InterruptingEdge())
[`ActivityEdge.getInterrupts()`](../mdbasicactivities/ActivityEdge.html#getInterrupts())
Model:
...
<h1 class="title" title="Interface InterruptibleActivityRegion">Interface InterruptibleActivityRegion</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">InterruptibleActivityRegion</span><span class="extends-implements">
...
<li><a href="#getInterruptingEdge()"><code><em>Interrupting Edge</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getInterruptibleActivityRegion()"><code>UMLPackage.getInterruptibleActivityRegion()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInterruptingEdge()">getInterruptingEdge</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Interrupting Edge</b></em>' reference list.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getNode()">getNode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Node</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasInterruptingEdge()">hasInterruptingEdge</a>()</code></div>
...
<div class="block">Returns the value of the '<em><b>Node</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../mdfundamentalactivities/ActivityNode.html#getInInterruptibleRegion()"><code><em>In Interruptible Region</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 ActivityNodes immediately contained in the InterruptibleActivityRegion.
...
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getInterruptibleActivityRegion_Node()"><code>UMLPackage.getInterruptibleActivityRegion_Node()</code></a></li>
<li><a href="../mdfundamentalactivities/ActivityNode.html#getInInterruptibleRegion()"><code>ActivityNode.getInInterruptibleRegion()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="inInterruptibleRegion" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getInterruptingEdge()">
<h3>getInterruptingEdge</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../mdbasicactivities/ActivityEdge.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ActivityEdge</a>&gt;</span> <span class="element-name">getInterruptingEdge</span>()</div>
<div class="block">Returns the value of the '<em><b>Interrupting Edge</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="../mdbasicactivities/ActivityEdge.html#getInterrupts()"><code><em>Interrupts</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The ActivityEdges leaving the InterruptibleActivityRegion on which a traversing token will result in the termination of other tokens flowing in the
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Interrupting Edge</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getInterruptibleActivityRegion_InterruptingEdge()"><code>UMLPackage.getInterruptibleActivityRegion_InterruptingEdge()</code></a></li>
<li><a href="../mdbasicactivities/ActivityEdge.html#getInterrupts()"><code>ActivityEdge.getInterrupts()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="interrupts" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasInterruptingEdge()">
<h3>hasInterruptingEdge</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasInterruptingEdge</span>()
                     throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
