# JAVA OPENAPI: ProtocolStateMachine (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/statemachines/mdprotocolstatemachines/ProtocolStateMachine.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdprotocolstatemachines/ProtocolStateMachine.html`
- source_sha256: `cd9967873a7405ed832929aca89f18a0ea83168da32a7b33c3e95e4fa5594733`
- captured_utc: `2026-07-14T16:56:26.289803+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Port](../../compositestructures/mdports/Port.html)>`
`[get_portOfProtocol](#get_portOfProtocol())()`
Returns the value of the '***port Of Protocol***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ProtocolConformance](ProtocolConformance.html)>`
...
Method Details
getConformance
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ProtocolConformance](ProtocolConformance.html)> getConformance()
Returns the value of the '***Conformance***' containment reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ProtocolConformance](ProtocolConformance.html)> get_protocolConformanceOfGeneralMachine()
Returns the value of the '***protocol Conformance Of General Machine***' reference list.
 The list contents are of type [`ProtocolConformance`](ProtocolConformance.html).
 It is bidirectional and its opposite is
...
Generated:
get_portOfProtocol
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Port](../../compositestructures/mdports/Port.html)> get_portOfProtocol()
Returns the value of the '***port Of Protocol***' reference list.
