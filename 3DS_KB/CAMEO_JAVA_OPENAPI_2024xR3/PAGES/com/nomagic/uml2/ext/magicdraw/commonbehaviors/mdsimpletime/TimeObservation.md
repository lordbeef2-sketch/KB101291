# JAVA OPENAPI: TimeObservation (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/TimeObservation.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/TimeObservation.html`
- source_sha256: `ce983b7d9c6bd4b6b2876d69d36e7a43f9d97bf33d825ad6bc0dea9a5e14f83b`
- captured_utc: `2026-07-14T16:56:23.864776+00:00`
...
public interfaceTimeObservationextends [Observation](Observation.html)

begin-user-doc 
 A representation of the model object '***Time Observation***'.
 end-user-doc 
begin-model-doc 
 A TimeObservation is a reference to a time instant during an execution. It points out the NamedElement in the model to observe and whether the observation is when
 this NamedElement is entered or when it is exited.
 end-model-doc 
...
See Also:
[`UMLPackage.getTimeObservation()`](../../metadata/UMLPackage.html#getTimeObservation())
Model:
...
`void`
`[setEvent](#setEvent(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement))([NamedElement](../../classes/mdkernel/NamedElement.html) value)`
...
[`UMLPackage.getTimeObservation_FirstEvent()`](../../metadata/UMLPackage.html#getTimeObservation_FirstEvent())
Model:
...
Generated:
getEvent
@CheckForNull[NamedElement](../../classes/mdkernel/NamedElement.html) getEvent()
Returns the value of the '***Event***' reference.
 It is bidirectional and its opposite is
 '[`*time Observation Of Event*`](../../classes/mdkernel/NamedElement.html#get_timeObservationOfEvent())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setEvent(NamedElement)`](#setEvent(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement))
[`UMLPackage.getTimeObservation_Event()`](../../metadata/UMLPackage.html#getTimeObservation_Event())
[`NamedElement.get_timeObservationOfEvent()`](../../classes/mdkernel/NamedElement.html#get_timeObservationOfEvent())
Model:
...
<h1 class="title" title="Interface TimeObservation">Interface TimeObservation</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">TimeObservation</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getTimeObservation()"><code>UMLPackage.getTimeObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setEvent(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">setEvent</a><wbr/>(<a href="../../classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getEvent()"><code><em>Event</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setFirstEvent(boolean)">setFirstEvent</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<li><a href="../../metadata/UMLPackage.html#getTimeObservation_FirstEvent()"><code>UMLPackage.getTimeObservation_FirstEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
</span><span class="return-type"><a href="../../classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a></span> <span class="element-name">getEvent</span>()</div>
<div class="block">Returns the value of the '<em><b>Event</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/NamedElement.html#get_timeObservationOfEvent()"><code><em>time Observation Of Event</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The TimeObservation is determined by the entering or exiting of the event Element during execution.
...
<dd>
<ul class="see-list-long">
<li><a href="#setEvent(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)"><code>setEvent(NamedElement)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTimeObservation_Event()"><code>UMLPackage.getTimeObservation_Event()</code></a></li>
<li><a href="../../classes/mdkernel/NamedElement.html#get_timeObservationOfEvent()"><code>NamedElement.get_timeObservationOfEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_timeObservationOfEvent" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setEvent(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">
<h3>setEvent</h3>
