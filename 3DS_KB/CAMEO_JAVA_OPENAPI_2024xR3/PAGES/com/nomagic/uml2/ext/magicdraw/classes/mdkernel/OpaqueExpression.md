# JAVA OPENAPI: OpaqueExpression (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/OpaqueExpression.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/OpaqueExpression.html`
- source_sha256: `3027b86458a97389119af5f75a8f9a3e0ef223e2598bf06677c46645f8b40be7`
- captured_utc: `2026-07-14T16:56:22.320759+00:00`
...
public interfaceOpaqueExpressionextends [ValueSpecification](ValueSpecification.html)

begin-user-doc 
 A representation of the model object '***Opaque Expression***'.
 end-user-doc 
begin-model-doc 
 An OpaqueExpression is a ValueSpecification that specifies the computation of a collection of values either in terms of a UML Behavior or based on a textual
...
[`*Result*`](#getResult())
[`*abstraction Of Mapping*`](#get_abstractionOfMapping())

See Also:
[`UMLPackage.getOpaqueExpression()`](../../metadata/UMLPackage.html#getOpaqueExpression())
Model:
...
`[get_abstractionOfMapping](#get_abstractionOfMapping())()`
...
`void`
`[set_abstractionOfMapping](#set_abstractionOfMapping(com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction))([Abstraction](../mddependencies/Abstraction.html) value)`
Sets the value of the '[`*abstraction Of Mapping*`](#get_abstractionOfMapping())'
 container reference.
`void`
`[setBehavior](#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))([Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) value)`
Sets the value of the '[`*Behavior*`](#getBehavior())' reference.
...
Method Details
getBody
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> getBody()
Returns the value of the '***Body***' attribute list.
...
See Also:
[`UMLPackage.getOpaqueExpression_Body()`](../../metadata/UMLPackage.html#getOpaqueExpression_Body())
Model:
unique="false" dataType="com.nomagic.uml2.ext.magicdraw.String"
Generated:
getLanguage
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> getLanguage()
Returns the value of the '***Language***' attribute list.
 The list contents are of type [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html).
 begin-user-doc 
 end-user-doc 
...
See Also:
[`UMLPackage.getOpaqueExpression_Language()`](../../metadata/UMLPackage.html#getOpaqueExpression_Language())
Model:
dataType="com.nomagic.uml2.ext.magicdraw.String"
Generated:
getResult
@CheckForNull[Parameter](Parameter.html) getResult()
Returns the value of the '***Result***' reference.
...
See Also:
[`UMLPackage.getOpaqueExpression_Result()`](../../metadata/UMLPackage.html#getOpaqueExpression_Result())
...
@CheckForNull[Abstraction](../mddependencies/Abstraction.html) get_abstractionOfMapping()
Returns the value of the '***abstraction Of Mapping***' container reference.
 It is bidirectional and its opposite is '[`*Mapping*`](../mddependencies/Abstraction.html#getMapping())'.
 begin-user-doc 
If the meaning of the '*abstraction Of Mapping*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*abstraction Of Mapping*' container reference.
See Also:
[`set_abstractionOfMapping(Abstraction)`](#set_abstractionOfMapping(com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction))
[`UMLPackage.getOpaqueExpression__abstractionOfMapping()`](../../metadata/UMLPackage.html#getOpaqueExpression__abstractionOfMapping())
[`Abstraction.getMapping()`](../mddependencies/Abstraction.html#getMapping())
Model:
opposite="mapping" transient="false" ordered="false"
Generated:
set_abstractionOfMapping
void set_abstractionOfMapping(@CheckForNull
 [Abstraction](../mddependencies/Abstraction.html) value)
Sets the value of the '[`*abstraction Of Mapping*`](#get_abstractionOfMapping())'
 container reference.
 begin-user-doc 
 end-user-doc
...
Generated:
getBehavior
@CheckForNull[Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) getBehavior()
Returns the value of the '***Behavior***' reference.
 It is bidirectional and its opposite is
 '[`*opaque Expression Of Behavior*`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_opaqueExpressionOfBehavior())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getOpaqueExpression_Behavior()`](../../metadata/UMLPackage.html#getOpaqueExpression_Behavior())
[`Behavior.get_opaqueExpressionOfBehavior()`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_opaqueExpressionOfBehavior())
Model:
...
<h1 class="title" title="Interface OpaqueExpression">Interface OpaqueExpression</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">OpaqueExpression</span><span class="extends-implements">
extends <a href="ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span></div>
...
<li><a href="#get_abstractionOfMapping()"><code><em>abstraction Of Mapping</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression()"><code>UMLPackage.getOpaqueExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mddependencies/Abstraction.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Abstraction</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_abstractionOfMapping()">get_abstractionOfMapping</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>abstraction Of Mapping</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getBehavior()">getBehavior</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Behavior</b></em>' reference.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getResult()">getResult</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Result</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_abstractionOfMapping(com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction)">set_abstractionOfMapping</a><wbr/>(<a href="../mddependencies/Abstraction.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Abstraction</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_abstractionOfMapping()"><code><em>abstraction Of Mapping</em></code></a>'
 container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setBehavior</a><wbr/>(<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getBehavior()"><code><em>Behavior</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression_Body()"><code>UMLPackage.getOpaqueExpression_Body()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression_Language()"><code>UMLPackage.getOpaqueExpression_Language()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
</span><span class="return-type"><a href="Parameter.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Parameter</a></span> <span class="element-name">getResult</span>()</div>
<div class="block">Returns the value of the '<em><b>Result</b></em>' reference.
 It is bidirectional and its opposite is
 '<code><em>opaque Expression Of Result</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 If an OpaqueExpression is specified using a UML Behavior, then this refers to the single required return Parameter of that Behavior. When the Behavior completes
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Result</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression_Result()"><code>UMLPackage.getOpaqueExpression_Result()</code></a></li>
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter#get_opaqueExpressionOfResult</code></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_opaqueExpressionOfResult" transient="true" changeable="false" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_abstractionOfMapping()">
<h3>get_abstractionOfMapping</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mddependencies/Abstraction.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Abstraction</a></span> <span class="element-name">get_abstractionOfMapping</span>()</div>
<div class="block">Returns the value of the '<em><b>abstraction Of Mapping</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="../mddependencies/Abstraction.html#getMapping()"><code><em>Mapping</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>abstraction Of Mapping</em>' container reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>abstraction Of Mapping</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#set_abstractionOfMapping(com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction)"><code>set_abstractionOfMapping(Abstraction)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression__abstractionOfMapping()"><code>UMLPackage.getOpaqueExpression__abstractionOfMapping()</code></a></li>
<li><a href="../mddependencies/Abstraction.html#getMapping()"><code>Abstraction.getMapping()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="mapping" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_abstractionOfMapping(com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction)">
<h3>set_abstractionOfMapping</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_abstractionOfMapping</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mddependencies/Abstraction.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Abstraction</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#get_abstractionOfMapping()"><code><em>abstraction Of Mapping</em></code></a>'
 container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>abstraction Of Mapping</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#get_abstractionOfMapping()"><code>get_abstractionOfMapping()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<h3>getBehavior</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></span> <span class="element-name">getBehavior</span>()</div>
<div class="block">Returns the value of the '<em><b>Behavior</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_opaqueExpressionOfBehavior()"><code><em>opaque Expression Of Behavior</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the behavior of the OpaqueExpression as a UML Behavior.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Behavior</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
...
<li><a href="../../metadata/UMLPackage.html#getOpaqueExpression_Behavior()"><code>UMLPackage.getOpaqueExpression_Behavior()</code></a></li>
<li><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_opaqueExpressionOfBehavior()"><code>Behavior.get_opaqueExpressionOfBehavior()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_opaqueExpressionOfBehavior" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Sets the value of the '<a href="#getBehavior()"><code><em>Behavior</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Behavior</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
