# JAVA OPENAPI: IntervalConstraint (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/IntervalConstraint.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/IntervalConstraint.html`
- source_sha256: `d743ef8636bd80c30917af91afb3d1899af9d34f279d6b1c324b3b313ae3edcc`
- captured_utc: `2026-07-14T16:56:23.905778+00:00`
...
`[DurationConstraint](DurationConstraint.html)`, `[TimeConstraint](TimeConstraint.html)`

public interfaceIntervalConstraintextends [Constraint](../../classes/mdkernel/Constraint.html)
...
See Also:
[`UMLPackage.getIntervalConstraint()`](../../metadata/UMLPackage.html#getIntervalConstraint())
Model:
...
`void`
`[setSpecification](#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Interval))([Interval](Interval.html) value)`
...
Method Details
getSpecification
@CheckForNull[Interval](Interval.html) getSpecification()
Returns the value of the '***Specification***' containment reference.
 It is bidirectional and its opposite is '[`*interval Constraint Of Specification*`](Interval.html#get_intervalConstraintOfSpecification())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setSpecification(Interval)`](#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Interval))
[`UMLPackage.getIntervalConstraint_Specification()`](../../metadata/UMLPackage.html#getIntervalConstraint_Specification())
[`Interval.get_intervalConstraintOfSpecification()`](Interval.html#get_intervalConstraintOfSpecification())
Model:
opposite="_intervalConstraintOfSpecification" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setSpecification
void setSpecification(@CheckForNull
 [Interval](Interval.html) value)
Sets the value of the '[`*Specification*`](#getSpecification())'
 containment reference.
 begin-user-doc 
 end-user-doc
...
<h1 class="title" title="Interface IntervalConstraint">Interface IntervalConstraint</h1>
</div>
...
<dd><code><a href="DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a></code>, <code><a href="TimeConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeConstraint</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">IntervalConstraint</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getIntervalConstraint()"><code>UMLPackage.getIntervalConstraint()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Interval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Interval</a></code></div>
...
</span><span class="return-type"><a href="Interval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Interval</a></span> <span class="element-name">getSpecification</span>()</div>
<div class="block">Returns the value of the '<em><b>Specification</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="Interval.html#get_intervalConstraintOfSpecification()"><code><em>interval Constraint Of Specification</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Interval that specifies the condition of the IntervalConstraint.
...
<dd>
<ul class="see-list-long">
<li><a href="#setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Interval)"><code>setSpecification(Interval)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getIntervalConstraint_Specification()"><code>UMLPackage.getIntervalConstraint_Specification()</code></a></li>
<li><a href="Interval.html#get_intervalConstraintOfSpecification()"><code>Interval.get_intervalConstraintOfSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_intervalConstraintOfSpecification" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Interval)">
...
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSpecification</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Interval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Interval</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getSpecification()"><code><em>Specification</em></code></a>'
 containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
