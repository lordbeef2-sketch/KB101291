# JAVA OPENAPI: Class (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Class.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Class.html`
- source_sha256: `1a116d577c63e9df136316a3fa2b1546554bbcad618f910cc2f9c2ff011ffd41`
- captured_utc: `2026-07-14T16:56:21.387750+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Extension](../../mdprofiles/Extension.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Class](Class.html)>`
...
Method Details
getExtension
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Extension](../../mdprofiles/Extension.html)> getExtension()
Returns the value of the '***Extension***' reference list.
...
Generated:
getNestedClassifier
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](Classifier.html)> getNestedClassifier()
Returns the value of the '***Nested Classifier***' containment reference list.
...
Generated:
getSuperClass
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Class](Class.html)> getSuperClass()
Returns the value of the '***Super Class***' reference list.
...
<li><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getClass_Active()</code></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Super Class</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<code><em>class Of Super Class</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The superclasses of a Class, derived from its Generalizations.
...
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class#get_classOfSuperClass</code></li>
</ul>
</dd>
<dt>Model:</dt>
