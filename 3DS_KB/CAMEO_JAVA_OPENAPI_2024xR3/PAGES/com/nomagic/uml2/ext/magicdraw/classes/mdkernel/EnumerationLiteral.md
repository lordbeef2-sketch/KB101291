# JAVA OPENAPI: EnumerationLiteral (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html`
- source_sha256: `c9b69a478d00b39df8035f24c596150e3d5bef66b1f93106615b11d632712093`
- captured_utc: `2026-07-14T16:56:21.735751+00:00`
...
See Also:
[`UMLPackage.getEnumerationLiteral()`](../../metadata/UMLPackage.html#getEnumerationLiteral())
Model:
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](Classifier.html)>`
...
`void`
`[setEnumeration](#setEnumeration(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration))([Enumeration](Enumeration.html) value)`
Sets the value of the '[`*Enumeration*`](#getEnumeration())' container reference.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.[InstanceSpecification](InstanceSpecification.html)
`[get_instanceValueOfInstance](InstanceSpecification.html#get_instanceValueOfInstance()), [getSlot](InstanceSpecification.html#getSlot()), [getSpecification](InstanceSpecification.html#getSpecification()), [has_instanceValueOfInstance](InstanceSpecification.html#has_instanceValueOfInstance()), [hasClassifier](InstanceSpecification.html#hasClassifier()), [hasSlot](InstanceSpecification.html#hasSlot()), [setSpecification](InstanceSpecification.html#setSpecification(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))`
...
Method Details
getEnumeration
@CheckForNull[Enumeration](Enumeration.html) getEnumeration()
Returns the value of the '***Enumeration***' container reference.
 It is bidirectional and its opposite is '[`*Owned Literal*`](Enumeration.html#getOwnedLiteral())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setEnumeration(Enumeration)`](#setEnumeration(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration))
[`UMLPackage.getEnumerationLiteral_Enumeration()`](../../metadata/UMLPackage.html#getEnumerationLiteral_Enumeration())
[`Enumeration.getOwnedLiteral()`](Enumeration.html#getOwnedLiteral())
Model:
opposite="ownedLiteral" required="true" transient="false" ordered="false"
Generated:
setEnumeration
void setEnumeration(@CheckForNull
 [Enumeration](Enumeration.html) value)
Sets the value of the '[`*Enumeration*`](#getEnumeration())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
Generated:
getClassifier
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](Classifier.html)> getClassifier()
Returns the value of the '***Classifier***' reference list.
 The list contents are of type [`Enumeration`](Enumeration.html).
...
Specified by:
`[getClassifier](InstanceSpecification.html#getClassifier())` in interface `[InstanceSpecification](InstanceSpecification.html)`
Returns:
the value of the '*Classifier*' reference list.
See Also:
[`UMLPackage.getEnumerationLiteral_Classifier()`](../../metadata/UMLPackage.html#getEnumerationLiteral_Classifier())
...
<h1 class="title" title="Interface EnumerationLiteral">Interface EnumerationLiteral</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">EnumerationLiteral</span><span class="extends-implements">
extends <a href="InstanceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">InstanceSpecification</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getEnumeration()"><code><em>Enumeration</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getEnumerationLiteral()"><code>UMLPackage.getEnumerationLiteral()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getEnumeration()">getEnumeration</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Enumeration</b></em>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setEnumeration(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration)">setEnumeration</a><wbr/>(<a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getEnumeration()"><code><em>Enumeration</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.<a href="InstanceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">InstanceSpecification</a></h3>
<code><a href="InstanceSpecification.html#get_instanceValueOfInstance()">get_instanceValueOfInstance</a>, <a href="InstanceSpecification.html#getSlot()">getSlot</a>, <a href="InstanceSpecification.html#getSpecification()">getSpecification</a>, <a href="InstanceSpecification.html#has_instanceValueOfInstance()">has_instanceValueOfInstance</a>, <a href="InstanceSpecification.html#hasClassifier()">hasClassifier</a>, <a href="InstanceSpecification.html#hasSlot()">hasSlot</a>, <a href="InstanceSpecification.html#setSpecification(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setSpecification</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getEnumeration()">
<h3>getEnumeration</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a></span> <span class="element-name">getEnumeration</span>()</div>
<div class="block">Returns the value of the '<em><b>Enumeration</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Enumeration.html#getOwnedLiteral()"><code><em>Owned Literal</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Enumeration that this EnumerationLiteral is a member of.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Enumeration</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setEnumeration(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration)"><code>setEnumeration(Enumeration)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getEnumerationLiteral_Enumeration()"><code>UMLPackage.getEnumerationLiteral_Enumeration()</code></a></li>
<li><a href="Enumeration.html#getOwnedLiteral()"><code>Enumeration.getOwnedLiteral()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="ownedLiteral" required="true" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setEnumeration(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration)">
<h3>setEnumeration</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setEnumeration</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getEnumeration()"><code><em>Enumeration</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Enumeration</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getEnumeration()"><code>getEnumeration()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Classifier</b></em>' reference list.
 The list contents are of type <a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel"><code>Enumeration</code></a>.
 It is bidirectional and its opposite is
 '<code><em>enumeration Literal Of Classifier</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The classifier of this EnumerationLiteral derived to be equal to its Enumeration.
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="InstanceSpecification.html#getClassifier()">getClassifier</a></code> in interface <code><a href="InstanceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">InstanceSpecification</a></code></dd>
<dt>Returns:</dt>
<dd>the value of the '<em>Classifier</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getEnumerationLiteral_Classifier()"><code>UMLPackage.getEnumerationLiteral_Classifier()</code></a></li>
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration#get_enumerationLiteralOfClassifier</code></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_enumerationLiteralOfClassifier" transient="true" changeable="false" volatile="true" derived="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
