# JAVA OPENAPI: ModelValidator (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/transaction/ModelValidator.html
- source_path: `com/nomagic/uml2/transaction/ModelValidator.html`
- source_sha256: `aaaa91ab827f55d7f2021bea5cc4caeed855a6fc2d677941e6f71ba747fedf67`
- captured_utc: `2026-07-14T16:56:26.575806+00:00`
...
`[validateChanges](#validateChanges(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Element](../ext/magicdraw/classes/mdkernel/Element.html)> changedElements)`

============ METHOD DETAIL ========== 
Method Details
validateChanges
@CheckForNull[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ModelValidationResult](ModelValidationResult.html)> validateChanges([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Element](../ext/magicdraw/classes/mdkernel/Element.html)> changedElements)
Parameters:
