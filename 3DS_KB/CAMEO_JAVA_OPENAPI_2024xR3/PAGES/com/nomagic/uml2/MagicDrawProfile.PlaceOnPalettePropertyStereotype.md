# JAVA OPENAPI: MagicDrawProfile.PlaceOnPalettePropertyStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/MagicDrawProfile.PlaceOnPalettePropertyStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.PlaceOnPalettePropertyStereotype.html`
- source_sha256: `5e6849304857c64256b9c193a52168ec9be6afb977baaabfd05e5e567aea3142`
- captured_utc: `2026-07-14T16:56:12.494655+00:00`
...
PLACE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) PLACE
Specifies the diagram type, whose palette includes the DSL element s button, and the position of the button on the palette.
See Also:
...
getPlace
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getPlace([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h3>PLACE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">PLACE</span></div>
<div class="block">Specifies the diagram type, whose palette includes the DSL element   s button, and the position of the button on the palette.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
