# JAVA OPENAPI: MagicDrawProfile.ImportMapStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/MagicDrawProfile.ImportMapStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.ImportMapStereotype.html`
- source_sha256: `6eebfe695fcae6a87f18351cfeb6b0c574c9bf39da0e10ab04c47e7679080b04`
- captured_utc: `2026-07-14T16:56:11.755640+00:00`
...
ELEMENTTYPE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ELEMENTTYPE
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.ImportMapStereotype.ELEMENTTYPE)
IMPORTINSTANCE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) IMPORTINSTANCE
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.ImportMapStereotype.IMPORTINSTANCE)
INSTANCECLASSIFIER
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) INSTANCECLASSIFIER
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.ImportMapStereotype.INSTANCECLASSIFIER)
PROPERTIESTOMAP
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) PROPERTIESTOMAP
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SEARCHFORELEMENTSINTARGETSCOPEONLY
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SEARCHFORREFERENCESINTARGETSCOPEONLY
See Also:
...
TARGETSCOPE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) TARGETSCOPE
See Also:
...
isImportInstance
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isImportInstance([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
public void removePropertiesToMap([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)
getPropertiesToMap
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> getPropertiesToMap([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isSearchForElementsInTargetScopeOnly([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isSearchForReferencesInTargetScopeOnly([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setStereotypes
...
public void removeStereotypes([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [Element](ext/magicdraw/classes/mdkernel/Element.html) value)
getStereotypes
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](ext/magicdraw/classes/mdkernel/Element.html)> getStereotypes([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setTargetScope
...
<h3>ELEMENTTYPE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ELEMENTTYPE</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
...
<h3>TARGETSCOPE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">TARGETSCOPE</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
