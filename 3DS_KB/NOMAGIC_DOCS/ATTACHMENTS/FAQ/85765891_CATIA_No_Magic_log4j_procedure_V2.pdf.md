# NOMAGIC ATTACHMENT: CATIA_No_Magic_log4j_procedure_V2.pdf

- attachment_id: `85765891`
- space_key: `FAQ`
...
- reported_bytes: 797439
- download_url: https://docs.nomagic.com/download/attachments/85764682/CATIA_No_Magic_log4j_procedure_V2.pdf?version=1&modificationDate=1639987876523&api=v2
- payload_kind: `pdf-extracted`
- downloaded_sha256: `52c5014034f06a10d5558ed023ff28a7415754526c53e8b1b5e580cf5aa82810`
...
In your installation base, please search for the following file: *log4j-core*.jar
    ...
     If you find a match, the log4j2 library is installed and could be exploited. Please execute these steps:
          Download log4j v2.16.0 from apache website (link)
          Search now for all the additional jar files (see complete list at the bottom) and replace any match by
              the 2.16.0 version. Make sure the original filename is unchanged.
...
````json
{
  ...
  "type": "attachment",
  "status": "current",
  "title": "CATIA_No_Magic_log4j_procedure_V2.pdf",
  "version": {
    "by": {
      "type": "known",
      "username": "developer",
    ...
    "when": "2021-12-20T09:11:16.523+01:00",
    "message": "",
    "number": 1,
    "minorEdit": true,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/85765891/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/85765891"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/85764682/CATIA_No_Magic_log4j_procedure_V2.pdf?version=1&modificationDate=1639987876523&api=v2",
    "webui": "/spaces/FAQ/pages/85764682/CATIA+Magic+and+No+Magic+products+affected+by+Log4j+vulnerability+-+CVE-2021-44228+CVE-2021-45046+CVE-2021-44832?preview=%2F85764682%2F85765891%2FCATIA_No_Magic_log4j_procedure_V2.pdf",
    "self": "https://docs.nomagic.com/rest/api/content/85765891"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/85765891/child",
    "restrictions": "/rest/api/content/85765891/restriction/byOperation",
    "history": "/rest/api/content/85765891/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/85765891/descendant",
    "space": "/rest/api/space/FAQ",
    "relevantViewRestrictions": "/rest/api/content/85765891/restriction/relevantViewRestrictions"
  }
}
````
