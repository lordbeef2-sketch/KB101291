...
- download_url: https://docs.nomagic.com/download/attachments/178163955/twc-services-charts.zip?version=1&modificationDate=1720457935923&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `4c4c5cf02e9db08706bff9d8d22cf0e6305c1134b17bc68b6406f8fc406df1ad`
...
Properties names changed:

Zookeeper property was split into two:

zookeeper.connect.string -> zookeeper.server.ip
                         |
                         -> zookeeper.server.port

Flexnet proprties changed names:

flexnet.server.name -> license.server.name
flexnet.server.port -> license.server.port

Pods will mount configuration files from configMaps.
...
````json
{
  ...
  "version": {
    ...
    "when": "2024-07-08T18:58:55.923+02:00",
    "message": "",
    "number": 1,
    "minorEdit": true,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/178163964/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/178163964"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/178163955/twc-services-charts.zip?version=1&modificationDate=1720457935923&api=v2",
    "webui": "/spaces/MCS2024xR1/pages/178163955/Deployment+example+for+Teamwork+Cloud+with+services+on+Kubernetes?preview=%2F178163955%2F178163964%2Ftwc-services-charts.zip",
    "self": "https://docs.nomagic.com/rest/api/content/178163964"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/178163964/child",
    "restrictions": "/rest/api/content/178163964/restriction/byOperation",
    "history": "/rest/api/content/178163964/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/178163964/descendant",
    "space": "/rest/api/space/MCS2024xR1",
    "relevantViewRestrictions": "/rest/api/content/178163964/restriction/relevantViewRestrictions"
  }
}
````
