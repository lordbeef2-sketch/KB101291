# NOMAGIC ATTACHMENT: webapp-charts.zip

- attachment_id: `304002731`
- space_key: `MCS`
- parent_page_id: `304002727`
- parent_page_title: (2026x Refresh1) Deployment example on Kubernetes
- media_type: `application/zip`
- reported_bytes: 90258
- download_url: https://docs.nomagic.com/download/attachments/304002727/webapp-charts.zip?version=1&modificationDate=1777452488660&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `16e0e875a1154b7f1e4609c4216005ff04c992aeece903c9365be9a90763874d`

## ARCHIVE CONTENTS

### ENTRY: webapp-charts/.helmignore
...
### ENTRY: webapp-charts/Chart.yaml
...
apiVersion: v2
name: webapp
description: A Helm chart to deploy WebAppPlatform

type: application

version: 0.1.0

appVersion: "2022xRefresh2"
...
### ENTRY: webapp-charts/charts/adminconsole/Chart.lock
...
dependencies:
- name: main-template
  repository: file://../main-template
  version: 0.1.0
digest: sha256:4cdc93a770ba032a721ca4da89f9046cc6aa0f068555ca9b82dfd71daf796e29
generated: "2023-02-28T09:25:11.451329425+02:00"

````

### ENTRY: webapp-charts/charts/adminconsole/Chart.yaml
...
### ENTRY: webapp-charts/charts/adminconsole/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/adminconsole/templates/service.yaml
...
### ENTRY: webapp-charts/charts/adminconsole/values.yaml
...
env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.admin.username={{ .Values.global.twcAdminUsername }} -Dtwc.admin.password={{ .Values.global.twcAdminPassword }} -Dtwc.rest.port={{ .Values.global.twcRestPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.protocol={{ .Values.global.authenticationServerProtocol }} -Dauthentication.client.secret={{ .Values.global.authenticationClientSecret }} -Dmessaging.server.ip=artemis-service -Dmessaging.server.port={{ .Values.global.messagingServerPort }} -Dmessaging.server.security.enabled={{ .Values.global.messagingServerSecurityEnabled }} -Dmessaging.user.name={{ .Values.global.messagingUserName }} -Dmessaging.user.password={{ .Values.global.messagingUserPassword }} -Dmessage.server.persistence.enabled=true -Dignore.wap.twc.compatibility={{ .Values.global.ignoreWapTwcCompatibility }}"
...
### ENTRY: webapp-charts/charts/artemis/.helmignore
...
### ENTRY: webapp-charts/charts/artemis/Chart.yaml
...
### ENTRY: webapp-charts/charts/artemis/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/artemis/templates/service.yaml
...
### ENTRY: webapp-charts/charts/artemis/values.yaml
...
### ENTRY: webapp-charts/charts/authentication/.helmignore
...
### ENTRY: webapp-charts/charts/authentication/Chart.yaml
...
### ENTRY: webapp-charts/charts/authentication/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/authentication/templates/service.yaml
...
### ENTRY: webapp-charts/charts/authentication/values.yaml
...
env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.client.port={{ .Values.global.twcClientPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.redirect.uri=https://{{ .Values.global.authenticationServerIp }}/webapp -Dauthentication.redirect.uri.whitelist=https,https:// -Dcassandra.contactPoints={{ .Values.global.cassandraContactPoints }} -Dignore.wap.twc.compatibility=true"
...
### ENTRY: webapp-charts/charts/collaborator/.helmignore
...
### ENTRY: webapp-charts/charts/collaborator/Chart.yaml
...
### ENTRY: webapp-charts/charts/collaborator/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/collaborator/templates/service.yaml
...
### ENTRY: webapp-charts/charts/collaborator/values.yaml
...
env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.admin.username={{ .Values.global.twcAdminUsername }} -Dtwc.admin.password={{ .Values.global.twcAdminPassword }} -Dtwc.rest.port={{ .Values.global.twcRestPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.protocol={{ .Values.global.authenticationServerProtocol }} -Dauthentication.client.secret={{ .Values.global.authenticationClientSecret }} -Dflexnet.server.name={{ .Values.global.flexnetServerName }} -Dflexnet.server.port={{ .Values.global.flexnetServerPort }} -Dmessaging.server.ip=artemis-service -Dmessaging.server.port={{ .Values.global.messagingServerPort }} -Dmessaging.server.security.enabled={{ .Values.global.messagingServerSecurityEnabled }} -Dmessaging.user.name={{ .Values.global.messagingUserName }} -Dmessaging.user.password={{ .Values.global.messagingUserPassword }} -Dmessage.server.persistence.enabled=true -Dignore.wap.twc.compatibility={{ .Values.global.ignoreWapTwcCompatibility }}"
...
### ENTRY: webapp-charts/charts/docexporter/.helmignore
...
### ENTRY: webapp-charts/charts/docexporter/Chart.yaml
...
### ENTRY: webapp-charts/charts/docexporter/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/docexporter/templates/service.yaml
...
### ENTRY: webapp-charts/charts/docexporter/values.yaml
...
env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.admin.username={{ .Values.global.twcAdminUsername }} -Dtwc.admin.password={{ .Values.global.twcAdminPassword }} -Dtwc.rest.port={{ .Values.global.twcRestPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.protocol={{ .Values.global.authenticationServerProtocol }} -Dauthentication.client.secret={{ .Values.global.authenticationClientSecret }} -Dflexnet.server.name={{ .Values.global.flexnetServerName }} -Dflexnet.server.port={{ .Values.global.flexnetServerPort }} -Dmessaging.server.security.enabled={{ .Values.global.messagingServerSecurityEnabled }} -Dmessaging.server.ip=artemis-service -Dmessaging.server.port={{ .Values.global.messagingServerPort }} -Dmessaging.user.name={{ .Values.global.messagingUserName }} -Dmessaging.user.password={{ .Values.global.messagingUserPassword }} -Dmessage.server.persistence.enabled=true -Dmessaging.consumer.window.size=0 -Dignore.wap.twc.compatibility=true -Ddocument.exporter.file.storing.time={{ .Values.global.docexporterFileStoring }}"
...
### ENTRY: webapp-charts/charts/oslc/.helmignore
...
### ENTRY: webapp-charts/charts/oslc/Chart.yaml
...
### ENTRY: webapp-charts/charts/oslc/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/oslc/templates/service.yaml
...
### ENTRY: webapp-charts/charts/oslc/values.yaml
...
### ENTRY: webapp-charts/charts/reports/.helmignore
...
### ENTRY: webapp-charts/charts/reports/Chart.yaml
...
### ENTRY: webapp-charts/charts/reports/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/reports/templates/service.yaml
...
### ENTRY: webapp-charts/charts/reports/values.yaml
...
### ENTRY: webapp-charts/charts/resources/.helmignore
...
### ENTRY: webapp-charts/charts/resources/Chart.yaml
...
### ENTRY: webapp-charts/charts/resources/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/resources/templates/service.yaml
...
### ENTRY: webapp-charts/charts/resources/values.yaml
...
### ENTRY: webapp-charts/charts/rum/.helmignore
...
### ENTRY: webapp-charts/charts/rum/Chart.yaml
...
### ENTRY: webapp-charts/charts/rum/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/rum/templates/service.yaml
...
### ENTRY: webapp-charts/charts/rum/values.yaml
...
### ENTRY: webapp-charts/charts/simulation/.helmignore
...
### ENTRY: webapp-charts/charts/simulation/Chart.yaml
...
### ENTRY: webapp-charts/charts/simulation/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/simulation/templates/job.yaml
...
### ENTRY: webapp-charts/charts/simulation/templates/service.yaml
...
### ENTRY: webapp-charts/charts/simulation/values.yaml
...
pollingInterval: 1
env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.admin.username={{ .Values.global.twcAdminUsername }} -Dtwc.admin.password={{ .Values.global.twcAdminPassword }} -Dtwc.rest.port={{ .Values.global.twcRestPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.protocol={{ .Values.global.authenticationServerProtocol }} -Dauthentication.client.secret={{ .Values.global.authenticationClientSecret }} -Dmessaging.server.ip=webapp-artemis -Dmessaging.server.port={{ .Values.global.messagingServerPort }} -Dmessaging.server.security.enabled={{ .Values.global.messagingServerSecurityEnabled }} -Dmessaging.user.name={{ .Values.global.activeMqUserName }} -Dmessaging.user.password={{ .Values.global.activeMqPassword }} -Dflexnet.server.name={{ .Values.global.flexnetServerName }} -Dflexnet.server.port={{ .Values.global.flexnetServerPort }} -Dmessage.server.persistence.enabled=true -Dsim.license.checkout=true"
...
### ENTRY: webapp-charts/charts/webapp/.helmignore
...
### ENTRY: webapp-charts/charts/webapp/Chart.yaml
...
### ENTRY: webapp-charts/charts/webapp/templates/deployment.yaml
...
### ENTRY: webapp-charts/charts/webapp/templates/service.yaml
...
### ENTRY: webapp-charts/charts/webapp/values.yaml
...
ident: wap
fullnameOverride: webapp-webapp

env:
  value: "-Dtwc.ip={{ .Values.global.twcIp }} -Dtwc.admin.username={{ .Values.global.twcAdminUsername }} -Dtwc.admin.password={{ .Values.global.twcAdminPassword }} -Dtwc.rest.port={{ .Values.global.twcRestPort }} -Dtwc.client.port={{ .Values.global.twcClientPort }} -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }} -Dservice.uri={{ .Values.global.serviceUri }} -Dauthentication.server.ip={{ .Values.global.authenticationServerIp }} -Dauthentication.server.port={{ .Values.global.authenticationServerPort }} -Dauthentication.server.protocol={{ .Values.global.authenticationServerProtocol }} -Dauthentication.redirect.uri=https://{{ .Values.global.authenticationServerIp }}/webapp -Dauthentication.client.secret={{ .Values.global.authenticationClientSecret }} -Dignore.wap.twc.compatibility={{ .Values.global.ignoreWapTwcCompatibility }}"
...
### ENTRY: webapp-charts/crd/keda/keda-2.6.0.yaml
    ...
    spec:
      ...
      - args:
        ...
        - name: KEDA_HTTP_DEFAULT_TIMEOUT
          value: ""
        image: ghcr.io/kedacore/keda-metrics-apiserver:2.6.0
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        - name: KEDA_HTTP_DEFAULT_TIMEOUT
          value: ""
        image: ghcr.io/kedacore/keda:2.6.0
        imagePullPolicy: Always
        livenessProbe:
          httpGet:
            path: /healthz
...
### ENTRY: webapp-charts/crd/metalLB/l2advertisement.yaml
...
### ENTRY: webapp-charts/crd/metalLB/metallb_ipaddresspool.yaml
...
### ENTRY: webapp-charts/templates/ingress-resource.yaml
    ...
    http:      
      paths:  
        ...
        - path: /admin
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.adminconsole.appLabel | replace "-" "" }}
              port:
        ...
        - path: /authentication
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.authentication.appLabel }}
              port:
        ...
        - path: /collaborator
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.collaborator.appLabel }}
              port:
        ...
        - path: /document-exporter
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.docexporter.appLabel }}
              port: 
        ...
        - path: /oslc
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.oslc.appLabel }}
              port:
        ...
        - path: /reports
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.reports.appLabel }}
              port:
        ...
        - path: /resources
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.resources.appLabel }}
              port:
        ...
        - path: /resource-usage-map
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.rum.appLabel }}
              port:
        ...
        - path: /simulation
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.simulation.appLabel }}
              port:
        ...
        - path: /webapp
          ...
          backend:
            service:
              name: {{ include "main-template.fullname" . }}-{{ .Values.webapp.appLabel }}
              port:
...
### ENTRY: webapp-charts/templates/NOTES.txt
...
````text
Thank you for installing Web Application Platform.
...
### ENTRY: webapp-charts/templates/required.yaml
...
{{- $_ := required "**** .Values.global.authenticationServerIp is a required value ****" .Values.global.authenticationServerIp }}
{{- $_ := required "**** .Values.global.authenticationServerProtocol is a required value ****" .Values.global.authenticationServerProtocol }}
{{- $_ := required "**** .Values.global.flexnetServerName is a required value ****" .Values.global.flexnetServerName }}
{{- $_ := required "**** .Values.global.cassandraContactPoints is a required value ****" .Values.global.cassandraContactPoints }}
````

### ENTRY: webapp-charts/templates/_deployment.tpl
...
### ENTRY: webapp-charts/templates/_helpers.tpl
...
### ENTRY: webapp-charts/templates/_job.tpl
...
spec:
            ...
            env:
              - name: WEBAPP_PROPERTIES
                value: "-Dsim.shutdown.on.empty.run.queue=true
                          ...
                          -Dzookeeper.connect.string={{ .Values.global.zookeeperConnectString }}
                          ...
                          -Dflexnet.server.name={{ .Values.global.flexnetServerName }}
                          -Dflexnet.server.port={{ .Values.global.flexnetServerPort }}
                          -Dmessaging.server.ip=webapp-artemis
  ...
  triggers:
    - type: artemis-queue
      metadata:
        managementEndpoint: "webapp-artemis:8161"
...
### ENTRY: webapp-charts/templates/_service.tpl
...
### ENTRY: webapp-charts/values.yaml
...
global:
  ...
  repoURL: change.example.com:5000/
  ...
  # MANDATORY !
  # twcIp: twc.example.com
  twcIp: change.example.com
  ...
  # MANDATORY !
  # serviceUri: https://admin.example.com/
  serviceUri: https://change.example.com/
  ...
  authenticationServerIp: change.example.com

  # Specify the Authentication server port (depends on your ingress configuration).
  ...
  # Specify the ZooKeeper service name.
  zookeeperConnectString: webapp-zookeeper

  # Specify the FlexNet licence server IP address (licensing server).
  # MANDATORY !
  # flexnetServerName: example.com
  flexnetServerName: change.example.com

  # Specify the FlexNet license server port.
  flexnetServerPort: 1101

  # messagingServerPort is Apache ActiveMQ Artemis service port
  ...
  # Specify username for ActiveMQ Artemis service
  # MANDATORY !
  activeMqUserName: artemis

  # Specify password for ActiveMQ Artemis service
  # MANDATORY !
  ...
  # cassandraContactPoints is the Cassandra DB IP/hostname for Authserver. Overrides settings in
  # authserver.properties
  # MANDATORY !
  # cassandraContactPoints: example.com
  cassandraContactPoints: change.example.com
...
ingress:
  # Specifies whether a ingress-nginx service should be deployed (Mandatory)
  enabled: true
  service:
    port: 8080
  className: "nginx"
  # Specifies annotations
  # nginx.ingress.kubernetes.io/backend-protocol: https (can be set to http or https depends on your setup)
  # nginx.ingress.kubernetes.io/proxy-body-size: 100m (Max file size)
  # nginx.ingress.kubernetes.io/session-cookie-name: "COOKIE" (Mandatory)
  # nginx.ingress.kubernetes.io/affinity-canary-behavior: "sticky" (Mandatory)
  # nginx.ingress.kubernetes.io/affinity-mode: "persistent" (Mandatory)
  # nginx.ingress.kubernetes.io/affinity: "cookie" (Mandatory)
  # nginx.ingress.kubernetes.io/proxy-connect-timeout: "600" (Mandatory)
  # nginx.ingress.kubernetes.io/proxy-read-timeout: "600" (Mandatory)
  # nginx.ingress.kubernetes.io/proxy-send-timeout: "600" (Mandatory)
  # nginx.ingress.kubernetes.io/send-timeout: "600" (Mandatory)
  annotations: {nginx.ingress.kubernetes.io/backend-protocol: https, nginx.ingress.kubernetes.io/proxy-body-size: 100m, nginx.ingress.kubernetes.io/session-cookie-name: "COOKIE", nginx.ingress.kubernetes.io/affinity-canary-behavior: "sticky", nginx.ingress.kubernetes.io/affinity-mode: "persistent", nginx.ingress.kubernetes.io/affinity: "cookie", nginx.ingress.kubernetes.io/proxy-connect-timeout: "600", nginx.ingress.kubernetes.io/proxy-read-timeout: "600", nginx.ingress.kubernetes.io/proxy-send-timeout: "600", nginx.ingress.kubernetes.io/send-timeout: "600"}
  hosts:
  # Specify ip address or domain name which is bind to exposed ip LoadBalancer address.
  # MANDATORY !
  # - host: example.com
  - host: change.example.com
    paths:
  tls:
...
````json
{
  ...
  "version": {
    ...
    "when": "2026-04-29T10:48:08.660+02:00",
    "message": "",
    "number": 1,
    "minorEdit": false,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/304002731/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/304002731"
    }
  },
  "position": -1,
  "container": {
    ...
    "type": "page",
    "status": "current",
    "title": "(2026x Refresh1) Deployment example on Kubernetes",
    "position": 1,
    "extensions": {
      "position": 1
    },
    "_links": {
      "webui": "/spaces/MCS/pages/304002727/2026x+Refresh1+Deployment+example+on+Kubernetes",
      "edit": "/pages/resumedraft.action?draftId=304002727",
      "tinyui": "/x/p7YeEg",
      "self": "https://docs.nomagic.com/rest/api/content/304002727"
    },
    "_expandable": {
      "container": "/rest/api/space/MCS",
      "metadata": "",
      "operations": "",
      "children": "/rest/api/content/304002727/child",
      "restrictions": "/rest/api/content/304002727/restriction/byOperation",
      "history": "/rest/api/content/304002727/history",
      "ancestors": "",
      "body": "",
      "version": "",
      "descendants": "/rest/api/content/304002727/descendant",
      "space": "/rest/api/space/MCS",
      "relevantViewRestrictions": "/rest/api/content/304002727/restriction/relevantViewRestrictions"
    }
  },
  "metadata": {
  ...
  "_links": {
    "download": "/download/attachments/304002727/webapp-charts.zip?version=1&modificationDate=1777452488660&api=v2",
    "webui": "/spaces/MCS/pages/304002727/2026x+Refresh1+Deployment+example+on+Kubernetes?preview=%2F304002727%2F304002731%2Fwebapp-charts.zip",
    "self": "https://docs.nomagic.com/rest/api/content/304002731"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/304002731/child",
    "restrictions": "/rest/api/content/304002731/restriction/byOperation",
    "history": "/rest/api/content/304002731/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/304002731/descendant",
    "space": "/rest/api/space/MCS",
    "relevantViewRestrictions": "/rest/api/content/304002731/restriction/relevantViewRestrictions"
  }
}
````
