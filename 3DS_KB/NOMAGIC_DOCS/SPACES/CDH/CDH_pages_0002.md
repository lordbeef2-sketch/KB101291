# NOMAGIC DOCUMENTATION SPACE: Cameo DataHub

<!--NOMAGIC_SPACE key=CDH chunk=2 -->

<!--NOMAGIC_PAGE id=254419597 space=CDH version=2 -->
## PAGE 00236: (2026x) IBM Rational DOORS Next Generation

- page_id: `254419597`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419597/2026x+IBM+Rational+DOORS+Next+Generation
- version_number: 2
- version_date: `2025-09-11T18:56:25.083+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Customizing DataHub options
- labels: []
...
````html
<p>To import a schema map</p><hr /><ol><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The <strong>Schema Map Manager</strong> dialog opens.</li><li>Click <strong>Import</strong> and choose the schema map file. The template will be updated with the new mapping.</li></ol><p><br /><ac:image ac:align="center"><ri:attachment ri:filename="maptemplate05.png" /></ac:image></p><h6 style="text-align: center;">The updated template with the new mapping and without defined attributes.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Attribute-defined Template.png" /></ac:image></p><h6 style="text-align: center;">The updated template with the new attribute-defined mapping.</h6>
````

<!--NOMAGIC_PAGE id=254419807 space=CDH version=2 -->
## PAGE 00238: (2026x) Inactive Data Source filter

- page_id: `254419807`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419807/2026x+Inactive+Data+Source+filter
- version_number: 2
- version_date: `2025-11-20T12:32:40.037+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) Add-on features
- labels: []
...
````html
<p>The<strong> Inactive Data Source Filter</strong> button <ac:image><ri:attachment ri:filename="dh-inactive-ds-filter.png" /></ac:image>is available on the <strong>DataHub Explorer</strong> toolbar. You can use this filter to filter out all inactive Data Sources from the <strong>DataHub Explorer</strong> tree.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer toolbar - Filtering inactive sources button" ac:alt="DataHub Explorer toolbar - Filtering inactive sources button"><ri:attachment ri:filename="dh-toggle-connected-data-sources.png" /></ac:image></p><h6 style="text-align: center;"> Inactive Data Source Filter button on the DataHub Explorer toolbar.</h6>
````

<!--NOMAGIC_PAGE id=254419200 space=CDH version=2 -->
## PAGE 00239: (2026x) Individual and Group Type Mapping

- page_id: `254419200`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419200/2026x+Individual+and+Group+Type+Mapping
- version_number: 2
- version_date: `2025-11-20T12:41:44.662+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Requirement Mapping > (2026x) Schema mapping modes
- labels: []
...
If you have mapped a schema with the **Define Target Type from the Attribute Value** option, DataHub saves this mode automatically and uses it as the default mapping mode. You can still change the default mapping mode through the **Copy data** dialog.

DataHub also provides a default Schema Map template for mapping data. In the **[CONFLUENCE_PAGE title='(2026x) Schema Map Manager' space='']**dialog, you can find the default Schema Map template under the IBM® Rational® DOORS® driver side.

When you select a Schema Map template for mapping, DataHub uses the selected template again next time you copy the same Data Type, if the copied data match the default Schema Map template. For example, if you copy a node from a DOORS Data Source to MagicDraw®, DataHub automatically selects a SysML Requirement node as the target type the next time you copy data to the MagicDraw® driver. You can also change the default Schema Map template in the **Schema Map Manager** dialog.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can copy data from the MagicDraw Containment tree to <strong>DataHub Explorer</strong> or vice versa, or within <strong>DataHub Explorer</strong> by dragging the source item to the target item. Therefore, you need to have a Data Type and a Schema Map. If default Data Type or auto Schema Map is not found in the system, Cameo DataHub asks you to do the mapping.</p><p>DataHub provides two types of schema mapping modes: <strong>Individual Type Mapping</strong> and <strong>Group Type Mapping</strong> as the default mapping mode, and the selected operation from DataHub Explorer is displayed as the name of the dialog, e.g., <strong>Copy Data</strong> dialog. You can also change the default setting through the <strong>Cameo DataHub Options</strong> dialog, including changing the default mapping mode.<br /><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Copy Data with Sync Dialog with Mapping Dropdown List (Group Mapping).png" /></ac:image></p><h6 style="text-align: center;">The Mapping Mode drop-down list in the Copy Data with Sync dialog.</h6><p>If you have mapped a schema with the  <strong>Define Target Type from the Attribute Value</strong> option, DataHub saves this mode automatically and uses it as the default mapping mode. You can still change the default mapping mode through the <strong>Copy data</strong> dialog.</p><p>DataHub also provides a default Schema Map template for mapping data. In the <strong><ac:link><ri:page ri:content-title="(2026x) Schema Map Manager" /></ac:link> </strong>dialog, you can find the default Schema Map template under the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> driver side.</p><p>When you select a Schema Map template for mapping, DataHub uses the selected template again next time you copy the same Data Type, if the copied data match the default Schema Map template. For example, if you copy a node from a DOORS Data Source to MagicDraw<sup>®</sup>, DataHub automatically selects a SysML Requirement node as the target type the next time you copy data to the MagicDraw<sup>®</sup> driver. You can also change the default Schema Map template in the <strong>Schema Map Manager</strong> dialog.</p>
````

<!--NOMAGIC_PAGE id=254420080 space=CDH version=1 -->
## PAGE 00240: (2026x) Individual type mapping

- page_id: `254420080`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254420080/2026x+Individual+type+mapping
- version_number: 1
- version_date: `2025-09-11T18:51:48.297+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) Schema map and mapping options
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b2c5fa33-f2d3-4e7a-a890-9f65d33db446"><ac:rich-text-body><p>For individual type mapping, you must start by mapping the parent node first, following the sequence. Please make sure to map the parent before moving on to the children nodes.</p></ac:rich-text-body></ac:structured-macro><p>The individual type mapping feature in DataHub arranges all nodes into a tree structure. You can select a node from the source node and map it to a type in the target node. The auto-mapping function of DataHub allows you to map similar node types automatically and change the target type that has been mapped.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Node Mapping Individual - One Way.png"><ri:page ri:content-title="(2026x) Individual type mapping" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Individual type mapping mode in the Copy Data with Sync dialog.</h6>
````

<!--NOMAGIC_PAGE id=254419595 space=CDH version=3 -->
## PAGE 00241: (2026x) Installation, licensing, and system requirements

- page_id: `254419595`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419595/2026x+Installation+licensing+and+system+requirements
- version_number: 3
- version_date: `2025-11-20T12:28:30.519+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation
- labels: []
...
````html
<p class="with-breadcrumbs">For information regarding installation, licensing, and system requirements, visit the <a href="https://docs.nomagic.com/IL/?contextKey=installation-licensing-and-system-requirements&amp;version=2026x">Installation, licensing, and system requirements</a> page.</p>
````

<!--NOMAGIC_PAGE id=258048870 space=CDH version=1 -->
## PAGE 00242: (2026x) JAMA Connect

- page_id: `258048870`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/258048870/2026x+JAMA+Connect
- version_number: 1
- version_date: `2025-09-25T12:30:03.215+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Customizing DataHub options
- labels: []

### NORMALIZED CONTENT

This section explains the JAMA Connect preference in the Cameo DataHub Options dialog.

To configure the****JAMA Connect setting

1. Open the Cameo DataHub Options dialog. [ATTACHMENT filename='JAMA Connect Environment options.png']
2. Go to the JAMA Connect option group and update the option.

The following table explains the JAMA Connect****options in the Cameo DataHub Options dialog.
...
````html
<p>This section explains the JAMA Connect preference in the Cameo DataHub Options dialog.</p><p><br /></p><p><span style="color:var(--ds-text,#172b4d);"> To configure the</span><strong style="text-align: left;"><span> </span></strong><span style="color:var(--ds-text,#172b4d);">JAMA Connect setting</span></p><hr /><ol><li data-uuid="d64611ef-21ff-4a13-95d6-a8e8b36bc48e">Open the <a href="https://docs.nomagic.com/display/CDH/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="JAMA Connect Environment options.png" /></ac:image><br /><br /></li><li data-uuid="50cb65b6-9fb9-4659-89b5-dffff9d782e0">Go to the <strong>JAMA Connect</strong> option<span> </span><span style="color:var(--ds-text,#333333);">group and<span> </span></span><span style="color:var(--ds-text,#333333);">update the option.<br /></span></li></ol><p>The following table explains the JAMA Connect<strong> </strong>options in the Cameo DataHub Options dialog.</p><table class="relative-table" style="width: 87.8548%;"><colgroup class=""><col class="" style="width: 30.4639%;" /><col class="" style="width: 69.5294%;" /></colgroup><tbody class=""><tr class=""><th>Option</th><th>Function</th></tr><tr class=""><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=254419479 space=CDH version=3 -->
## PAGE 00243: (2026x) Linking model elements to OSLC resources

- page_id: `254419479`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419479/2026x+Linking+model+elements+to+OSLC+resources
- version_number: 3
- version_date: `2025-11-20T12:40:33.244+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with OSLC features
- labels: []
...
1. Do one of the following:
  - In the Model Browser, select an element, open its **Specification** window and go to Documentation / Hyperlinks property group. Click Add .
...
````html
<p>You can link your model elements to the OSLC resources through the hyperlinks.</p><p>There are two ways you can link a model element to an OSLC resource:</p><ul><li data-uuid="aea01be5-e883-4d7b-b49c-68f54ecf0a39">Selecting an existing resource</li><li data-uuid="1493ef35-6504-4a98-a58c-c02c16d61a4a">Creating a new resource</li></ul><h3>Selecting an existing OSLC resource</h3><p><br /></p><p>To link an element to an OSLC resource</p><hr /><ol><li data-uuid="0219d769-40b3-45da-8b14-06c7f132f728">Do one of the following:<ul><li>In the Model Browser, select an element, open its<strong> </strong><a href="https://docs.nomagic.com/MT/?contextKey=specification-window&amp;version=2026x&amp;variant=default"><strong>Specification</strong> window</a> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the <strong>Hyperlinks / Go To</strong> button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="2bf9c922-e3ec-4012-8915-88fc387ba3e7">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="a2ba9b15-c7ca-4076-80c8-9b7f591b1539">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="04c61a07-d305-4483-a4d1-5874498fc528">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="d3647a4b-838d-4b9f-babd-8bbb05b23066">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Choose Existing</strong> option.</li><li data-uuid="575ee7db-a72b-42b9-be58-e623aa6dd480">Select an artifact and click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="select.png" /></ac:image><br /><br /></li><li data-uuid="cabfdc6c-ccce-4aaf-8225-28b558a7cc00">Click <strong>Close</strong>.</li><li data-uuid="aa29195b-8c91-4eca-a9ac-26efd46401e5">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><h3>Creating a new OSLC resource</h3><p><br /></p><p>To create a new OSLC resource</p><hr /><ol><li data-uuid="6e501e95-592f-4b6f-b459-8adf8b7eb362">Do one of the following:<ul><li>In the Model Browser, select an element, open its <a href="https://docs.nomagic.com/MT/?contextKey=specification-window&amp;version=2026x&amp;variant=default"><strong>Specification</strong> window</a> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the Hyperlinks / Go To button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="4d6808ad-c841-4016-9cee-a23ac90554a4">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="53280231-04e6-4491-96eb-54ed1d7a4a3a">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="9a220739-a378-46b8-922d-57a19a027f6c">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="5898d5e4-27ea-422a-84a2-dcab21d0a6d8">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Create New</strong> option.</li><li data-uuid="3690e63b-6e7b-4bb4-9fa4-df7d42aa41bd">Fill out the data for the new element.<br /><br /><ac:image><ri:attachment ri:filename="create.png" /></ac:image><br /><br /></li><li data-uuid="5054c035-6e6e-4666-86d6-78b00aca65bc">Click <strong>OK</strong>.</li><li data-uuid="d735c06f-dc76-4633-b6f7-98e0f2fc9498">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><p>The created element is now linked to your selected model element.</p>
````

<!--NOMAGIC_PAGE id=254419238 space=CDH version=2 -->
## PAGE 00244: (2026x) Mapping source and target types to copy data to and from a modelling tool

- page_id: `254419238`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419238/2026x+Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool
- version_number: 2
- version_date: `2025-11-20T12:34:03.671+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Basic features of DataHub
- labels: []
...
The export dialog, e.g., **Copy Data with Sync**(depending on the operation you have selected from the [CONFLUENCE_PAGE title='(2026x) DataHub Operation drop-down list' space='']), opens to allow you to map the source and target attribute. 
...
````html
<p>The <strong>Schema Map Manager</strong> dialog allows you to see all attributes of both sources and targets. It automates data matching and mapping so that you can integrate data on both sides and make them identical.</p><p>To open the <strong>Schema Map Manager</strong> dialog in MagicDraw<sup>®</sup></p><hr /><ol><li>From the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The Cameo DataHub <strong>Schema Map Manager</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image><br /><br /></li><li>Expand the nodes to see the types that have already been mapped.<br /><br /></li></ol><p>You can also select a schema map template in the<strong> Schema Map Manager</strong> dialog by expanding each Data Source. DataHub also allows you to view schema maps used by particular relations. You can right-click an item in the table and select <strong>View Schema Map</strong> to open the<strong> View Schema Map</strong> dialog from that schema map.<br /><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="View Schema Map dialog.png" /></ac:image></p><h6 style="text-align: center;">The View Schema Map dialog showing schema maps used by particular relations.</h6>
````

<!--NOMAGIC_PAGE id=254419150 space=CDH version=2 -->
## PAGE 00246: (2026x) Module artifacts of DOORS Next Generation

- page_id: `254419150`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419150/2026x+Module+artifacts+of+DOORS+Next+Generation
- version_number: 2
- version_date: `2025-11-20T12:39:29.291+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with Data Sources > (2026x) Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p><span style="color:var(--ds-text,#333333);">Normally, artifacts of DOORS Next Generation do not have hierarchy, and the module artifact is the customized view of artifacts that can create structure of added or created artifacts. Since the module is also an artifact, DataHub will show the module as a single node. However, with new support of the DOORS Next Generation module, you can now open the module artifact to see a list of artifacts inside as a separate tab.</span></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="50aa9403-eb49-42c9-ae9b-011bb3d449f5"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>Since artifacts in the module and their hierarchy do not reflect the original ones, DataHub will treat artifacts in the module separately apart from the original artifacts out of the module.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To open the module in a new tab</p><hr /><ul><li><p>Right-click the module artifact and select <strong style="letter-spacing: 0.0px;">Open module in new window</strong>. The module will be open in another tab.</p><p><ac:image><ri:attachment ri:filename="Open_module_new_window.png" /></ac:image></p><h6><span style="color:var(--ds-text,#707070);">Using the Open module in new window command to open a DOORS Next Generation module artifact in a new tab.</span></h6><p><ac:image><ri:attachment ri:filename="Module Open3.png" /></ac:image></p><h6><span style="color:var(--ds-text,#707070);"><span style="color:var(--ds-text,#707070);">The selected Evaluation Suggestions DOORS Next Generation module artifact is open in a new tab.</span><br /></span></h6></li></ul><p>When you work with the module next time, you can open the module through <strong>Alias Manager</strong> or by clicking <strong>Open module in new window</strong>. In the module tab, you can perform all the same DataHub operations as in DataHub Explorer.</p>
````

<!--NOMAGIC_PAGE id=254419377 space=CDH version=2 -->
## PAGE 00247: (2026x) Node synchronization

- page_id: `254419377`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419377/2026x+Node+synchronization
- version_number: 2
- version_date: `2025-11-20T12:46:33.240+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization > (2026x) Synchronizing Requirements
- labels: []
...
2. From the MagicDraw main menu, click Tools > DataHub > DataHub Explorer . The [CONFLUENCE_PAGE title='(2026x) DataHub Explorer tab' space=''] opens.
...
- [CONFLUENCE_PAGE title='(2026x) DataHub Explorer tab' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="7a8ac0d3-c2f2-4866-b7fe-24526b16f4ad"><ac:parameter ac:name="id">1144117790</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="3c5e4bd6-ebf1-4c85-9e67-fa0935801509"><ac:parameter ac:name="id">1144117792</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="bd8d0056-353f-48ae-a6ac-70b35fcb0306"><ac:parameter ac:name="id">1144117791</ac:parameter><ac:rich-text-body><p><span style="color: rgb(51,51,51);">To open <strong>DataHub Explorer</strong></span></p><hr /><ol><li>Create a new MagicDraw<sup>®</sup> project or open an existing project.</li><li>From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <ac:link><ri:page ri:content-title="(2026x) DataHub Explorer tab" /></ac:link> opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="worddavff8df49b8dd564525b509af5bc3f682e.png"><ri:page ri:content-title="(2026x) Opening DataHub Explorer" /></ri:attachment></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="59442eae-22b5-4d89-902c-278cc7ff4145"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>Nodes under particular drivers in <strong>DataHub Explorer</strong> also represent nodes in the applications belonging to the drivers.</li><li>If a driver is correctly started, the name of the driver will appear in the <strong>DataHub Explorer</strong> tree. The driver will then connect to data in each of its respective application.</li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="8aaffeac-73fe-4df9-96fe-bbea241fe42c"><ac:parameter ac:name="id">1144117789</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:content-title="(2026x) DataHub Explorer tab" /><ac:plain-text-link-body><![CDATA[DataHub Explorer tab]]></ac:plain-text-link-body></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=254419559 space=CDH version=2 -->
## PAGE 00250: (2026x) Opening selected Requirements in DataHub Explorer or other applications

- page_id: `254419559`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419559/2026x+Opening+selected+Requirements+in+DataHub+Explorer+or+other+applications
- version_number: 2
- version_date: `2025-11-20T12:41:14.265+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Creating links between elements
- labels: []
...
<!--NOMAGIC_PAGE id=254419972 space=CDH version=2 -->
## PAGE 00251: (2026x) Operation drop-down list

- page_id: `254419972`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419972/2026x+Operation+drop-down+list
- version_number: 2
- version_date: `2025-11-20T12:30:35.839+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) DataHub Explorer tab
- labels: []
...
- [CONFLUENCE_PAGE title='(2026x) Create Sync operation' space='']
- [CONFLUENCE_PAGE title='(2026x) Create DHTrace operation with OSLC links' space='']
- [CONFLUENCE_PAGE title='(2026x) Compatible data sources' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The <strong>Operation </strong>list in the <strong>Cameo DataHub Explorer </strong>panel provides several options for you to work with your data.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="CDH_Panel.png" /></ac:image></p><h6 style="text-align: center;">Operation drop-down list</h6><p>The table below briefly explains the functions of the DataHub operations.</p><p><br /></p><table class="fixed-table"><colgroup class=""><col class="" style="width: 257.0px;" /><col class="" style="width: 996.0px;" /></colgroup><tbody class=""><tr class=""><th>Operation</th><th>Function</th></tr><tr class=""><td><strong>Copy Data</strong></td><td>Only copies the data with child nodes.</td></tr><tr class=""><td><strong>Copy Data with Sync</strong></td><td><div class="content-wrapper"><p>Copies data and creates synchronization (DHLinks) between the source and target nodes. Nodes in the modeling tool are updated or deleted whenever their corresponding nodes in associated tools are updated or deleted. The newly created nodes can be transferred to other associated tools as well.</p></div></td></tr><tr class=""><td><strong>Copy Data with DHTrace</strong></td><td>Copies data and creates DHTrace links between the source and target nodes. DHLinks are used to trace the changes.</td></tr><tr class=""><td><strong>Create Sync</strong></td><td>Recreates synchronization (DHLinks) if you lose or delete the DHLinks without replicating the data.</td></tr><tr class=""><td><strong>Create DHTrace (with OSLC links)</strong></td><td>Creates DHLinks between the source and target nodes without copying any data.<br />Creates an OSLC link from an IBM® Rational® DOORS® Next Generation Data Source to a MagicDraw® element.</td></tr></tbody></table><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="72de58ac-4522-4ab4-8c99-427b6a92c097"><ac:rich-text-body><ul><li data-uuid="d2ed7830-5fcd-450d-b6f3-037d3ee039b0">The parent-and-child relationships are transferred from the source to the target items.</li><li data-uuid="ffd4917b-acd2-40fd-ad2b-ea169310c956">The dependency relationships from MagicDraw® are also transferred if both the source and target nodes are selected.</li><li data-uuid="a498d105-d271-4998-841d-2925e11481c5">By default, <strong>Copy Data with Sync</strong> is selected in the operations list.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="01bb940d-603d-49b4-8b86-a0d25678551b"><ac:link><ri:page ri:content-title="(2026x) Copy Data operation" /></ac:link></li><li data-uuid="bc03da7b-6a08-4340-97fb-d67b5348eb12"><ac:link><ri:page ri:content-title="(2026x) Copy Data with Sync operation" /></ac:link></li><li data-uuid="2738d4d6-e29b-434d-936a-31817a45bca6"><ac:link><ri:page ri:content-title="(2026x) Copy Data with DHTrace operation" /></ac:link></li><li data-uuid="411f999a-4eab-49bb-8b57-3337ad2c140d"><ac:link><ri:page ri:content-title="(2026x) Create Sync operation" /></ac:link></li><li data-uuid="1b0d4ab0-a13b-4cb7-ba9e-2bbce6d98acf"><ac:link><ri:page ri:content-title="(2026x) Create DHTrace operation with OSLC links" /></ac:link></li><li data-uuid="17ca6580-f1bc-430b-8187-50ef74461927"><ac:link><ri:page ri:content-title="(2026x) Compatible data sources" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254419438 space=CDH version=3 -->
## PAGE 00253: (2026x) OSLC Preview

- page_id: `254419438`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419438/2026x+OSLC+Preview
- version_number: 3
- version_date: `2025-11-20T12:40:34.261+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with OSLC features
- labels: []
...
The **OSLC Preview** tab in the [Quick properties panel](https://docs.nomagic.com/MT/?contextKey=understanding-the-user-interface&version=2026x&variant=default) allows you to view the details of the OSLC resource. The OSLC resource can be selected from **DataHub Explorer**, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser**.**
...
````html
<p>Using <strong>DataHub Explorer</strong>, you can connect to the Data Sources, such as IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS Next Generation, or other OSLC Providers. <strong>DataHub Explorer</strong> lists the content of the open Data Source.</p><p>The <strong>OSLC Preview</strong> tab in the <a href="https://docs.nomagic.com/MT/?contextKey=understanding-the-user-interface&amp;version=2026x&amp;variant=default">Quick properties panel</a> allows you to view the details of the OSLC resource. The OSLC resource can be selected from <strong>DataHub Explorer</strong>, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser<strong>.</strong></p><p><br /></p><p>To open the <strong>OSLC Preview</strong> tab</p><hr /><ul><li>From the main menu, select <strong>Window</strong> &gt; <strong>OSLC Preview</strong>.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="OSLC Preview.png" /></ac:image></p><p><br /></p><p>You can use OSLC preview to display the information of the selected node or the linked node in the following ways:</p><ul><li>When you add an OSLC Data Source into <strong>DataHub Explorer</strong>, e.g., DOORS Next Generation, the <strong>OSLC Preview</strong> tab can display the information of the selected node.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="preview.png" /></ac:image></p><h6 style="text-align: center;">The details of the selected OSLC resource in Cameo DataHub Explorer are displayed in the OSLC Preview tab.</h6><ul><li>When you import data from an OSLC Data Source into the MagicDraw Containment tree, the <strong>OSLC Preview</strong> tab can display the information of the related/linked node.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Preview on Containment Tree.png" /></ac:image></p><h6 style="text-align: center;">The details of the selected OSLC resource in the MagicDraw Containment tree are displayed in the OSLC Preview tab.</h6><ul><li>With an existing element in the model, you can also manually create an OSLC link to the other node from the connected OSLC Data Source so that the <strong>OSLC Preview</strong> tab can display the information of the linked node.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Preview on URLs.png" /></ac:image></p><h6 style="text-align: center;">The detail of the resources that the OSLC link to are displayed in the OSLC Preview tab.</h6><p><br /></p><p>When the Data Source in <strong>DataHub Explorer</strong> is closed, the preview of the selected element details is not available. The <strong>OSLC Preview</strong> tab offers you a link to reconnect to the Data Source.</p><p><br /></p><p>To reconnect to a Data Source</p><hr /><ol><li>In the <strong>OSLC Preview</strong> tab, click the <strong>Connect to Data Source</strong> link.</li><li>In the login dialog, enter the <strong>User ID</strong> and <strong>Password</strong>.</li><li>Click <strong>Connect</strong>.</li></ol><p><ac:image ac:align="center"><ri:attachment ri:filename="connect.png" /></ac:image></p><h6 style="text-align: center;">An example of the closed Data Source.</h6>
````

<!--NOMAGIC_PAGE id=254419682 space=CDH version=2 -->
## PAGE 00254: (2026x) OSLC Provider

- page_id: `254419682`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419682/2026x+OSLC+Provider
- version_number: 2
- version_date: `2025-09-11T18:56:25.332+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Customizing DataHub options
- labels: []
...
````html
<p>This section explains the Generic OSLC Service Provider preference in the Cameo DataHub Options dialog.</p><p><br /></p><p>To specify the number of maximum concurrent connections for the OSLC Provider</p><hr /><ol><li>Open the <a href="https://docs.nomagic.com/display/CDH/(2026x) Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH_OSLC.png"><ri:page ri:content-title="(2026x) OSLC Provider" /></ri:attachment></ac:image><br /><br /></li><li>Go to the <strong>Generic OSLC Service Provider</strong> option<span> </span><span style="color: rgb(62,63,64);">group and<span> </span></span><span style="color: rgb(62,63,64);">update the option.<br /></span></li></ol><p style="">The following table explains the Generic OSLC Service Provider<strong> </strong>options in the Cameo DataHub Options dialog.</p><table class="relative-table" style="width: 87.8548%;"><colgroup><col style="width: 30.4639%;" /><col style="width: 69.5294%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=254419505 space=CDH version=2 -->
## PAGE 00255: (2026x) OSLC support

- page_id: `254419505`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419505/2026x+OSLC+support
- version_number: 2
- version_date: `2025-11-20T12:32:11.111+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=254419435 space=CDH version=2 -->
## PAGE 00256: (2026x) OSLC tutorial

- page_id: `254419435`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419435/2026x+OSLC+tutorial
- version_number: 2
- version_date: `2025-11-20T12:40:26.682+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with OSLC features
- labels: []
...
````html
<p>Cameo DataHub has the ability to use OSLC data from any OSLC-compliant Provider. It is now possible to establish hyperlinks between model elements and elements provided by an OSLC Provider, as well as having OSLC previews of remote elements from within a modeling tool environment.</p><p>The steps for establishing links between model elements and OSLC resources are shown below:</p><p style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:width="400"><ri:attachment ri:filename="OSLC Workflow Process.png" /></ac:image></span></p><h6 style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size">Steps<span style="color:var(--ds-text,#707070);"> to establish links between model elements and OSLC resources.</span><br /></span></h6><p style="text-align: left;"><span style="color:var(--ds-text,#333333);">In the following pages, you will find step-by-step descriptions for linking model elements with OSLC resources.</span></p>
````

<!--NOMAGIC_PAGE id=254419765 space=CDH version=2 -->
## PAGE 00257: (2026x) Property value conversion

- page_id: `254419765`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419765/2026x+Property+value+conversion
- version_number: 2
- version_date: `2025-11-20T12:38:04.823+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Operations in DataHub Explorer
- labels: []
...
````html
<p>To remove a Data Source</p><hr /><ol><li>Right-click the Data Source to remove and select <strong><ac:image><ri:attachment ri:filename="remove-ds.png" /></ac:image></strong>.</li><li>You are prompted to confirm the removal action. Click <strong>OK</strong>.</li></ol><p>This option removes the Data Source from the <strong>DataHub Explorer</strong> tree. It also removes all related DHLinks and Schema Map information from DataHub.</p>
````

<!--NOMAGIC_PAGE id=254419564 space=CDH version=2 -->
## PAGE 00259: (2026x) Removing DHLinks

- page_id: `254419564`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419564/2026x+Removing+DHLinks
- version_number: 2
- version_date: `2025-11-20T12:41:15.405+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Creating links between elements
- labels: []
...
````html
<p>DataHub provides two options to remove the DHLink of a node as follows</p><ul><li>Remove only a DHLink or DHTrace of the selected node.</li><li>Remove all DHLinks or DHTraces recursively in the node hierarchy.</li></ul><p><br />To remove a DHLink or DHTrace (recursively), do one of the following</p><hr /><ul><li>Right-click an item in <strong>DataHub Explorer</strong> and select <strong>Remove DHLinks</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Remove DHLinks.png" /></ac:image><br /><br /></p><ul><li>Right-click a DHLink in the <strong>DH Links</strong> panel and select <strong>Remove DHLink</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="Removing DHLink in the Cameo DataHub DHLink Panel" ac:alt="Removing DHLink in the Cameo DataHub DHLink Panel"><ri:attachment ri:filename="dh-links-tab-sync-tasks.png" /></ac:image><br /><br /></p><ul><li>Right-click a Traced or Suspect link in the <strong>DH Links </strong>panel and click <strong>Remove DHTrace</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="Remove DHTrace option from DHLinks Panel" ac:alt="Remove DHTrace option from DHLinks Panel"><ri:attachment ri:filename="remove-dh-trace.png" /></ac:image><br /><br /></p><ul><li>Right-click a node in the MagicDraw Containment tree and select <strong>DataHub Actions</strong> &gt; <strong>Remove DHLinks</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Right-click to Remove DHLink.png" /></ac:image></p>
````

<!--NOMAGIC_PAGE id=254419052 space=CDH version=2 -->
## PAGE 00260: (2026x) Requirement Mapping

- page_id: `254419052`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419052/2026x+Requirement+Mapping
- version_number: 2
- version_date: `2025-11-20T12:42:14.190+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You can do simple schema mappings or define<span class="current"> target types from attribute value mapping</span>s between sources and targets in Cameo DataHub by using Schema Map Manager. This section also describes exporting, importing, and deleting schema mappings by using the <strong>Schema Map Manager</strong> dialog.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="a3d1720d-ba69-440a-acdb-61ac8accc19c" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254418933 space=CDH version=2 -->
## PAGE 00261: (2026x) Saving the DHLink summary as reports

- page_id: `254418933`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418933/2026x+Saving+the+DHLink+summary+as+reports
- version_number: 2
- version_date: `2025-11-20T12:42:31.029+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with the DHLink summary and generating reports
- labels: []
...
1. In the Filter Options pane on the left-hand side of the [CONFLUENCE_PAGE title='(2026x) DHLink Summary' space=''] dialog, choose type of relations you want to see in the DHLink summary.
...
````html
<p>After you view a DHLink summary, you can click <ac:image><ri:attachment ri:filename="save-btn-2.png" /></ac:image> to save the summary view. The report is saved in the HTML format so that you can open it in a web browser, e.g., Chrome or Firefox.</p><p><br /></p><p>To save a DHLink summary as a report</p><hr /><ol><li>In the<strong> Filter Options</strong> pane on the left-hand side of the <strong><ac:link><ri:page ri:content-title="(2026x) DHLink Summary" /></ac:link></strong> dialog, choose type of relations you want to see in the DHLink summary.</li><li>Do one of the following to save the report</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>Click<strong> <ac:image><ri:attachment ri:filename="view-btn.png" /></ac:image></strong> to view the DHLink summary and click <ac:image><ri:attachment ri:filename="save-btn-2.png" /></ac:image> to save the DHLink summary as a report.</li><li>Click<strong> <ac:image><ri:attachment ri:filename="generate-btn.png" /></ac:image></strong> to save the DHLink summary as a report without viewing the items in the DHLink summary.</li></ul></li></ul><p><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="e10c92a1-e958-4bae-a124-7b7341b2fb1c"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><p>If you want to save a large amount of data in the report more quickly, click <strong><ac:image><ri:attachment ri:filename="generate-btn.png" /></ac:image></strong>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=254419513 space=CDH version=2 -->
## PAGE 00262: (2026x) Schema map and mapping options

- page_id: `254419513`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419513/2026x+Schema+map+and+mapping+options
- version_number: 2
- version_date: `2025-11-20T12:32:01.057+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub provides the two mapping modes to simplify the way you map source and target nodes as follows</p><ul><li data-uuid="ff8fa1d3-747d-4d38-bb02-ddffad6ab7ba">Group type mapping mode</li><li data-uuid="effe0a64-e3ee-4293-b1ac-8f827d756a7a">Individual type mapping mode</li></ul><p>These schema mapping methods are accessible through the <strong>Copy Data</strong> dialog, <strong>Copy Data with Sync</strong> dialog, and <strong>Copy Data with DHTrace</strong> dialog. Additional options, e.g., excluding unmapped nodes, are also available.</p><p>There is also a <strong><ac:link><ri:page ri:content-title="(2026x) Define target type from attribute value mapping" /><ac:plain-text-link-body><![CDATA[Define target type from attribute value]]></ac:plain-text-link-body></ac:link></strong> mapping mode only available in group type mapping mode. Once you use the <strong>Define Target Type from Attribute Value </strong>mapping mode, DataHub saves it as the default mode and activates it the next time you copy the same type of data. In this case, the <strong>Copy Data </strong>dialog, <strong>Copy Data with Sync</strong> dialog, or <strong>Copy Data with DHTrace</strong> dialog does not open.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3e2827ac-45e6-4160-9dc5-21696946df96" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254420003 space=CDH version=1 -->
## PAGE 00263: (2026x) Schema Map Manager

- page_id: `254420003`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254420003/2026x+Schema+Map+Manager
- version_number: 1
- version_date: `2025-09-11T18:51:43.253+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) Schema map and mapping options
- labels: []

### NORMALIZED CONTENT

You can use **[CONFLUENCE_PAGE title='(2026x) Mapping with Schema Map Manager' space='']** to edit attribute mapping. When the DHLinks between nodes and attributes have been created, **Schema Map Manager** saves the mapped nodes and attributes. You can edit the attribute mapping for a specific schema mapping. You can also export the mappings in XML format and share them with other users.
...
````html
<p>You can use <strong><ac:link><ri:page ri:content-title="(2026x) Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Schema Map Manager]]></ac:plain-text-link-body></ac:link></strong> to edit attribute mapping. When the DHLinks between nodes and attributes have been created, <strong>Schema Map Manager</strong> saves the mapped nodes and attributes. You can edit the attribute mapping for a specific schema mapping. You can also export the mappings in XML format and share them with other users.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:content-title="(2026x) Schema Map Manager" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Schema Map Manager</h6>
````

<!--NOMAGIC_PAGE id=254420007 space=CDH version=1 -->
## PAGE 00264: (2026x) Schema map templates

- page_id: `254420007`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254420007/2026x+Schema+map+templates
- version_number: 1
- version_date: `2025-09-11T18:51:43.570+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) Schema map and mapping options
- labels: []
...
<!--NOMAGIC_PAGE id=254419116 space=CDH version=2 -->
## PAGE 00265: (2026x) Schema mapping modes

- page_id: `254419116`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419116/2026x+Schema+mapping+modes
- version_number: 2
- version_date: `2025-11-20T12:41:56.732+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Requirement Mapping
- labels: []
...
````html
<p>You can map nodes by doing either of the following:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="783163a3-e3bd-4f68-aa6d-5ee809553f03" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=254420050 space=CDH version=2 -->
## PAGE 00266: (2026x) Searching for a text string

- page_id: `254420050`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254420050/2026x+Searching+for+a+text+string
- version_number: 2
- version_date: `2025-11-20T12:36:10.533+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To search for text</p><hr /><ol><li><span style="color:var(--ds-text,#333333);">Type the text you want to search into the search box </span> <ac:image><ri:attachment ri:filename="text-search-box.png" /></ac:image>.<br /><br /><ac:image ac:title="Text Search from DataHub Explorer" ac:alt="Text Search from DataHub Explorer"><ri:attachment ri:filename="dh-explorer-toolbar.png" /></ac:image><br /><br /></li><li><span style="color:var(--ds-text,#333333);">The search results are shown in the<span> </span></span><strong style="text-align: left;">DataHub Explorer</strong><span style="color:var(--ds-text,#333333);"><span> </span>tree with highlighted texts in accordance with the used search word.</span><br /><br /><ac:image ac:title="Results of text search - the search item will be highlighted" ac:alt="Results of text search - the search item will be highlighted"><ri:attachment ri:filename="results-of-text-search.png" /></ac:image><br /><br /></li><li><span style="color:var(--ds-text,#333333);">To navigate to the</span><span style="color:var(--ds-text,#333333);"> </span><strong style="text-align: left;">Next Result<span> </span></strong><span style="color:var(--ds-text,#333333);">or</span><span style="color:var(--ds-text,#333333);"> </span><strong style="text-align: left;">Previous Result<span> </span></strong><span style="color:var(--ds-text,#333333);">in the highlighted texts, use the navigation buttons next to the search box.<br /></span><br /><ac:image><ri:attachment ri:filename="Navigation Button.png" /></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=254419118 space=CDH version=2 -->
## PAGE 00267: (2026x) Simple schema mapping

- page_id: `254419118`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419118/2026x+Simple+schema+mapping
- version_number: 2
- version_date: `2025-11-20T12:41:54.413+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Requirement Mapping > (2026x) Schema mapping modes
- labels: []
...
1. Open the [CONFLUENCE_PAGE title='(2026x) Mapping with Schema Map Manager' space=''] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog. [ATTACHMENT filename='Schema_Map_Manager.png']
...
1. Open the [CONFLUENCE_PAGE title='(2026x) Mapping with Schema Map Manager' space=''] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog.
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
````html
<p>You can do simple schema mapping and update existing schema maps in the Schema Map Manager dialog between data in the source schema and the target schema. You can also define a target type from the attribute value mappings by selecting the <strong>Define Target Type from Attribute Value</strong> option.</p><p>If your previous mapping mode is  Define Target Type from Attribute Value mapping, it is set as the default mapping automatically. You can also change the default mapping back to a simple mapping so that you can use the simple mapping to copy data when the <strong>Define Target Type from Attribute Value</strong> mapping mode is not selected.</p><p><br /></p><p>To specify a default mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:content-title="(2026x) Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. <br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image><br /><br /></li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a target type in the Target Type section that you want to specify as the default one.</li><li>Click <strong>Set as Default</strong>. The selected target type is now the default mapping, and the button changes to <strong>Remove Default</strong>.<br /><br /></li></ol><p>To remove a default mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:content-title="(2026x) Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. <br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image><br /><br /></li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a default target type in the Target Type section that you want to remove.</li><li>Click <strong>Remove Default</strong>. The selected target type is no longer the default mapping, and the button changes to <strong>Set as Default</strong>.<br /><br /></li></ol><p>To edit a schema mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:content-title="(2026x) Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. </li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a target type in the Target Type section that you want to edit.  The Select Attribute to Sync list shows the list of default attributes mapping.</li><li>Click <strong>Edit </strong>to enable editing mode.</li><li>Change the attributes mapping, and then click <strong>Save</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Edited_Attribute.png" /></ac:image><br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57302633-e7ba-426e-8ec0-0711ebe96967"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If the edited schema mapping affects any elements in the current project, the Edit Schema Map Confirmation dialog opens. Click <strong>Yes</strong> to confirm that you want to edit the schema, <strong>No</strong> to cancel the editing, or <strong>Details</strong> to see the details of all affected nodes.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Edit Schema Map Confirmation Dialog" ac:alt="Edit Schema Map Confirmation Dialog"><ri:attachment ri:filename="dh-edit-schema-map.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The Edit Schema Map Confirmation dialog.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="f0408f31-efd0-4097-a2f7-dfc810c5a46d"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>After DataHub<span> saves an edited schema map, it will be effective when you perform data synchronization next time.</span></p></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=254419911 space=CDH version=2 -->
## PAGE 00268: (2026x) Splitting part of a synchronized model as a used project

- page_id: `254419911`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419911/2026x+Splitting+part+of+a+synchronized+model+as+a+used+project
- version_number: 2
- version_date: `2025-11-20T12:45:19.008+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization
- labels: []
...
````html
<p>DataHub helps you to Synchronize the data between the modeler and the data source. Synchronization can be done one way or two ways. You can also check the changes made on either the modeler side or the data source side.</p><p>To learn more about synchronization, refer to:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="2d4c6ffd-f6e1-474c-8268-98b3b2c1d262" /></p>
````

<!--NOMAGIC_PAGE id=254419856 space=CDH version=2 -->
## PAGE 00270: (2026x) Synchronize buttons and commands

- page_id: `254419856`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419856/2026x+Synchronize+buttons+and+commands
- version_number: 2
- version_date: `2025-11-20T12:46:13.620+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization
- labels: []
...
````html
<p>DataHub has <strong>Synchronize</strong> buttons and commands in different locations to perform different functions as follows</p><p><br /></p><ul><li><p>On top of the MagicDraw Containment tree</p><p>When you click this <strong>Synchronize <ac:image><ri:attachment ri:filename="sync-btn.png" /></ac:image></strong> button, all nodes from MagicDraw are synchronized. A single node without children nodes can be synchronized, while a node containing children nodes can be synchronized recursively.<br /><br /></p><p><ac:image ac:align="center" ac:title="Synchronize button on MagicDraw containment Tree" ac:alt="Synchronize button on MagicDraw containment Tree"><ri:attachment ri:filename="md-sync-btn.png" /></ac:image></p><h6 style="text-align: center;">The Synchronize button on top of the MagicDraw Containment tree.</h6></li><li><p>On top of DataHub Explorer.</p><p>When you click this <strong>Synchronize <ac:image><ri:attachment ri:filename="sync-btn.png" /></ac:image></strong> button, all nodes in the Data Source of the selected node in DataHub Explorer are synchronized.<br /><br /></p><h6 style="text-align: center;"><ac:image ac:align="center" ac:title="Sync button on DataHub Explorer toolbar" ac:alt="Sync button on DataHub Explorer toolbar"><ri:attachment ri:filename="dh-exp-sync-btn.png" /></ac:image>The Synchronize button on top of DataHub Explorer.</h6></li><li><p>From the MagicDraw main menu</p><p>Clicking <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Synchronize updates to Data Source</strong> <span>performs the same function as clicking the <strong>Synchronize</strong> <ac:image><ri:attachment ri:filename="sync-btn.png" /></ac:image> button on top of the MagicDraw Containment Tree. </span><span><span>All nodes from MagicDraw are synchronized. A single node without children nodes can be synchronized, while a node containing children nodes can be synchronized recursively.</span><br /><br /></span></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Synchronize updates to data source.png" /></ac:image></p><h6 style="text-align: center;">The Synchronize updates to the Data Source command from the MagicDraw main menu.</h6></li><li><p>From the MagicDraw shortcut menu</p><p>When you right-click a node and select <strong>DataHub Actions </strong>&gt;<strong> Synchronize </strong>&gt;<strong> Synchronize Node</strong> or <strong>Synchronize Node Recursively</strong>, the selected node is synchronized or recursively synchronized. You can also <strong>Update Pending DHLinks</strong>, <strong>Update Pending DHLinks Recursively</strong>, <strong>Clear Suspect DHTraces</strong>, <strong>Clear Suspect DHTraces Recursively</strong>, <strong>Remove DHLinks, Remove DHLinks recursively</strong>, <strong>Remove DHTrace,</strong> and <strong>Remove DHTrace recursively</strong>.<br /><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Node Sync_Main Menu_Tools.png" /></ac:image></p><h6 style="text-align: center;">The Synchronize command from the MagicDraw shortcut menu.<br /><ac:image><ri:attachment ri:filename="Update DHLink_MD.png" /></ac:image></h6><h6 style="text-align: center;">The Update DHLinks command from the MagicDraw shortcut menu.<br /><ac:image><ri:attachment ri:filename="Remove DHLink_MD.png" /></ac:image></h6><h6 style="text-align: center;">The Remove DHLinks command from the MagicDraw shortcut menu.<br /><br /></h6></li><li><p>From the DataHub shortcut menu</p><p>The Datahub shortcut menu is for <strong>Synchronize</strong> <strong>Node</strong> or <strong>Synchronize Node Recursively</strong> that the selected node is synchronized or recursively synchronized, <strong>Update DHLinks</strong>, and <strong>Remove DHLinks</strong>. You can also <strong>Update Pending DHLinks</strong>,<strong> Update Pending DHLinks Recursively</strong>, <strong>Clear Suspect DHTraces</strong>, <strong>Clear Suspect DHTraces Recursively</strong>, <strong>Remove DHLinks, Remove DHLinks recursively</strong>, <strong>Remove DHTrace,</strong> and <strong>Remove DHTrace recursively</strong>.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Node Sync_Shortcut Menu_Explorer panel.png" /></ac:image></p><h6 style="text-align: center;">The Synchronize command from the DataHub shortcut menu.<br /><ac:image><ri:attachment ri:filename="Update DHLink_DH.png" /></ac:image></h6><h6 style="text-align: center;">The Update DHLinks command from the DataHub shortcut menu.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Remove DHLink_DH.png" /></ac:image></p></li></ul><h6 style="text-align: center;">The Remove DHLinks command from the DataHub shortcut menu.</h6>
````

<!--NOMAGIC_PAGE id=254419833 space=CDH version=2 -->
## PAGE 00271: (2026x) Synchronizing changes in data hierarchy

- page_id: `254419833`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419833/2026x+Synchronizing+changes+in+data+hierarchy
- version_number: 2
- version_date: `2025-11-20T12:45:38.920+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization
- labels: []
...
````html
<p>You can also synchronize updates on a schema map when you perform the data synchronization. If you change a schema map, synchronization applies the changes in the schema map to the affected nodes.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema Map Changes Synchronize.png" /></ac:image></p><h6 style="text-align: center;">The Schema Map Manager for synchronizing schema mapping.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="c5b2c6d2-eaef-4588-89d2-a718b527e510"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>After you update the schema map, the <strong>Edit Schema Map Confirmation</strong> dialog opens to notify that you must synchronize the data again to synchronize the changes to the affected nodes.</p><h6 style="text-align: center;"><ac:image ac:align="center" ac:title="Confirmation to Synchronize when a Schema Map is Changed" ac:alt="Confirmation to Synchronize when a Schema Map is Changed"><ri:attachment ri:filename="confirm-schema-edit.png" /></ac:image>The Edit Schema Map Confirmation dialog.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=254419337 space=CDH version=2 -->
## PAGE 00273: (2026x) Synchronizing DOORS External Links

- page_id: `254419337`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419337/2026x+Synchronizing+DOORS+External+Links
- version_number: 2
- version_date: `2025-11-20T12:46:18.166+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization > (2026x) Synchronizing Requirements
- labels: []
...
````html
<p>After Requirements are synchronized from DOORS, they can have Relationships, e.g., <strong>Satisfy</strong> or <strong>Derive</strong>, with other elements in the model. In this version, DataHub can synchronize these Relationships back to DOORS and create External Links that help display and navigate to those relationships with related model elements.<br /><br /></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="DataHub Synchronizes Relationships back to DOORS with External Links.png" /></ac:image></p><h6 style="text-align: center;">DataHub synchronizes Relationships back to DOORS and creates External Links to display and navigate to those relationships.</h6><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="External Link2.png" /></ac:image></p><h6 style="text-align: center;">The External Link in DOORS displaying the Relationship and navigating to the related model element.</h6><p><br /></p><p>To synchronize a related element in the model with Requirements in DOORS as an External Link</p><hr /><ol><li><p class="auto-cursor-target">Right-click the module or parent node of Requirements and select <strong>Create/Update External Links to the Satisfying elements</strong>. The External Link will be created in the Requirements that contain Relationships in DOORS.<br /><br /><ac:image><ri:attachment ri:filename="Create External Link.PNG" /></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="17e2ff65-e4a7-4132-907a-1d60c2449eeb"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If you have selected the root node of the Sync Scope, the <strong>Create/Update External Links to the Satisfying elements</strong> operation will recursively detect the changes. Otherwise, only the selected node will be checked.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li>The <strong>Updating External Links</strong> dialog opens to show the synchronizing actions of the selected module or parent node of Requirements. Click <strong>Synchronize</strong> to proceed with the actions.<br /><br /><ac:image><ri:attachment ri:filename="Updating External Links Dialog.png" /></ac:image><br /><br /></li><li><p class="auto-cursor-target">The <strong>Create/Update External Links Summary</strong> dialog opens to show the summary of External Links that have been created or updated. Click <strong>Close</strong> to complete the External Link synchronization.<br /><br /></p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="Create or Update External Links Summary Dialog.png" /></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a3b8b291-3600-4c53-8fe9-630159ccdae9"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>External Links will be created with or deleted from Requirements in DOORS according to the Relationships in the model.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=254420009 space=CDH version=2 -->
## PAGE 00274: (2026x) Synchronizing nodes

- page_id: `254420009`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254420009/2026x+Synchronizing+nodes
- version_number: 2
- version_date: `2025-11-20T12:45:34.829+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization
- labels: []
...
- [CONFLUENCE_PAGE title='(2026x) Tracking changes on Conflict Dashboard' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>To synchronize any nodes in the <strong>Conflict Dashboard</strong> dialog</p><hr /><ol><li data-uuid="5396b4b4-db5f-45dd-841b-686cef63e649"><p class="auto-cursor-target">Select any check boxes of Data Sources on either of the sides. The selected side will be the master Data Source, and the other side will pick up the changes from the selected side.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57776fbc-c1d7-4a13-9494-dcc9a7c64609"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>A single node can be only synchronized from either the source to the target or the target to the source. However, multiple nodes can have different synchronization directions, e.g., one node can be synchronized from the source to the target, and another node can be synchronized from the target to the source.</p></ac:rich-text-body></ac:structured-macro></li><li data-uuid="6d90965d-8532-4e1f-b5fe-736469e3aed4">Click <strong>Synchronize</strong>.</li></ol></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="f218c6c7-a036-4437-ae79-9a3a7f9861a7"><ac:link><ri:page ri:content-title="(2026x) Tracking changes on Conflict Dashboard" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254419203 space=CDH version=2 -->
## PAGE 00275: (2026x) Synchronizing Requirements

- page_id: `254419203`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419203/2026x+Synchronizing+Requirements
- version_number: 2
- version_date: `2025-11-20T12:46:59.562+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=254419821 space=CDH version=2 -->
## PAGE 00277: (2026x) Text search in DataHub Explorer and Alias Manager

- page_id: `254419821`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419821/2026x+Text+search+in+DataHub+Explorer+and+Alias+Manager
- version_number: 2
- version_date: `2025-11-20T12:32:35.278+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) Getting started > (2026x) Understanding DataHub user interface > (2026x) Add-on features
- labels: []
...
````html
<p>The text search capability in DataHub Explorer allows you to search for data and items in DataHub.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer Text Search box" ac:alt="DataHub Explorer Text Search box"><ri:attachment ri:filename="dh-text-search.png" /></ac:image></p><h6 style="text-align: center;">Text search capability in DataHub Explorer.</h6>
````

<!--NOMAGIC_PAGE id=254419321 space=CDH version=2 -->
## PAGE 00278: (2026x) Tracking changes on Conflict Dashboard

- page_id: `254419321`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419321/2026x+Tracking+changes+on+Conflict+Dashboard
- version_number: 2
- version_date: `2025-11-20T12:46:32.121+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Synchronization > (2026x) Synchronizing Requirements
- labels: []
...
Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to [Server Certificates](https://docs.nomagic.com/MT/?contextKey=server-certificates&version=2026x&variant=default). The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to the [3DEXPERIENCE platform troubleshooting](https://docs.nomagic.com/CM/?contextKey=3dexperience-platform-troubleshooting&version=2026x).

##### Enabling the SysMLv2 support for 2026x Version

To enable support of SysMLv2

1. In <modeling tool installation directory>\bin folder, open the <modeling tool name>.properties file.
2. In the JAVA_ARGS line, add the - Ddh.sysmlv2.enabled=true JAVA argument .
3. Restart the modeling tool.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<h3>Server Certificate tool</h3><p>Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to <a href="https://docs.nomagic.com/MT/?contextKey=server-certificates&amp;version=2026x&amp;variant=default">Server Certificates</a>. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to the <a href="https://docs.nomagic.com/CM/?contextKey=3dexperience-platform-troubleshooting&amp;version=2026x">3DEXPERIENCE platform troubleshooting</a>.</p><h3>Enabling the SysMLv2 support for 2026x Version</h3><p>To enable support of SysMLv2</p><hr /><ol><li data-uuid="aadcb85d-e037-4615-89e8-a974a72f7be3">In<span> </span><em>&lt;modeling tool installation directory&gt;\bin </em>folder, open the<span> </span><em>&lt;modeling tool name&gt;.properties</em><span> </span>file.</li><li data-uuid="96cf15a8-6478-447d-ab06-2f1be0959578">In the JAVA_ARGS line, add the -<em>Ddh.sysmlv2.enabled=true </em>JAVA argument<em>.</em></li><li data-uuid="b363d0f5-3ff5-4b0f-b359-337d298e2df4">Restart the modeling tool.</li></ol>
````

<!--NOMAGIC_PAGE id=254419721 space=CDH version=2 -->
## PAGE 00280: (2026x) UI components of Schema Map Manager

- page_id: `254419721`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419721/2026x+UI+components+of+Schema+Map+Manager
- version_number: 2
- version_date: `2025-11-20T12:42:02.513+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=254418901 space=CDH version=1 -->
## PAGE 00283: (2026x) User Guide

- page_id: `254418901`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418901/2026x+User+Guide
- version_number: 1
- version_date: `2025-09-11T18:50:38.899+02:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation
...
````html
<p>Welcome to Cameo DataHub user guide!</p><p>See the following chapters to learn more about the product and its features or use the search box to find the information you need:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f38be95b-5be2-482b-a314-cdfd9ad70325" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=254418973 space=CDH version=3 -->
## PAGE 00284: (2026x) Using DataHub in Teamwork Cloud environment

- page_id: `254418973`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418973/2026x+Using+DataHub+in+Teamwork+Cloud+environment
- version_number: 3
- version_date: `2025-11-06T08:21:53.572+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []
...
````html
<p>DataHub supports local and remote connections. A local project is a project that is stored on your machine. When you connect to Teamwork Cloud, other users can remotely see the project you are working on through Teamwork Cloud. Multiple users can collaborate and work on the same project, and the DHLink map will be stored along with the project on Teamwork Cloud. This allows all users to see other users’ changes in their work.</p><p>In addition to local and remote connections, DataHub also provides functionality that allows several users to access the same project, including DataHub relations. This functionality is available for projects that are stored on Teamwork Cloud.</p><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="765a341a-c277-494e-9502-2a2dc68e643a" /></p>
````

<!--NOMAGIC_PAGE id=254419285 space=CDH version=2 -->
## PAGE 00285: (2026x) Working with custom IP Classification attributes

- page_id: `254419285`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419285/2026x+Working+with+custom+IP+Classification+attributes
- version_number: 2
- version_date: `2025-11-20T12:44:44.063+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Additional DataHub features
- labels: []
...
````html
<p><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02"><span style="color:var(--ds-text,#333333);">If you use</span> </ac:inline-comment-marker><a href="https://dsua.dsone.3ds.com/R2023x/English/?show=Lbc3DDashUserMap/lbc3ddash-c-ov.htm"><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02">IP Classification Editor</ac:inline-comment-marker></a><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02"> <span style="color:var(--ds-text,#333333);">on the 3DEXPERIENCE platform to manage libraries and classes, you can view and work with these custom IP classification attributes in the modeling tool as well. Cameo DataHub allows you to choose whether the attributes are displayed or hidden and use them for mapping and synchronization.</span></ac:inline-comment-marker></p><p>To view custom added attributes through IP classification</p><hr /><ul><li>Right-click on the <strong>ENVOIA REQS</strong> data source and select <strong>Show IP classification attribute<br /><br /></strong></li></ul><p><ac:image ac:align="left"><ri:attachment ri:filename="Custom IP Classfication command.png" /></ac:image><br /><br /><br /><br /><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p>After you click on the <strong>Show IP Classification attribute</strong> command, the data source will be reloaded and the list of custom added attributes will be visible in the properties tab.</p><p><br /></p><p>To view the properties tab</p><hr /><ul><li>Right click on the data source and select <strong>Properties<br /></strong><br /><ac:image><ri:attachment ri:filename="IP Classification Properties.png" /></ac:image></li><li>A new tab will display the properties of the selected data source.<br /><br /><ac:image><ri:attachment ri:filename="IP_Classification Comparison.png" /></ac:image></li></ul><p>To hide the custom added attributes through IP classification</p><hr /><ul><li>Right-click on the <strong>ENVOIA REQS</strong> data source and select <strong>Hide IP classification attribute<br /><br /><ac:image><ri:attachment ri:filename="IP Classification Hide Command.png" /></ac:image><br /></strong></li></ul><hr />
````

<!--NOMAGIC_PAGE id=254419068 space=CDH version=2 -->
## PAGE 00286: (2026x) Working with Data Sources

- page_id: `254419068`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419068/2026x+Working+with+Data+Sources
- version_number: 2
- version_date: `2025-11-20T12:39:59.370+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Before connecting a Data Source to a driver, you need to have the<strong> DataHub Explorer</strong> tab open in MagicDraw<sup>®</sup>.</p><p>To open <strong>DataHub Explorer</strong></p><hr /><ol><li data-uuid="ddcd1a12-c01f-49ae-8c89-90c101e6c2fd">Start MagicDraw<sup>®</sup> and create a new project or open an existing one.</li><li data-uuid="47905e5c-1456-41fb-8ac2-b2df54b3ead7">From the MagicDraw<sup>®</sup> main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="4a3bfa82-0bb1-4b85-9474-03162e9e93dc" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254419221 space=CDH version=2 -->
## PAGE 00287: (2026x) Working with OSLC features

- page_id: `254419221`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419221/2026x+Working+with+OSLC+features
- version_number: 2
- version_date: `2025-11-20T12:40:49.502+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []
...
- [CONFLUENCE_PAGE title='(2026x) Working with Data Sources' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The modeling tool can link and share data using Open Services for Lifecycle Collaboration (OSLC) integration that allows the following</p><ul><li data-uuid="c82405c2-8188-4ce7-bbfc-4dfddcc718d2">The modeling environment to work smoothly in the IBM Jazz ecosystem.</li><li data-uuid="7c00f15c-b999-4ec0-9917-bfa3103055ac">Linking different project lifecycle artifacts in different tools without additional plugins needed.</li><li data-uuid="e53ced28-fc0d-4151-b409-7d521dff91c8">Seeing information details of linked artifacts without switching between different tools. </li></ul><p>The following chapters describe how the modeling tool works with OSLC:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f1b328bc-fea4-4637-8557-0d096f85deb0" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="10187e80-f8a3-495e-8b5f-7b244f3f2488"><ac:link><ri:page ri:content-title="(2026x) Working with Data Sources" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254419371 space=CDH version=8 -->
## PAGE 00288: (2026x) Working with revisions for ENOVIA Requirements

- page_id: `254419371`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254419371/2026x+Working+with+revisions+for+ENOVIA+Requirements
- version_number: 8
- version_date: `2025-11-20T12:39:08.550+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide > (2026x) Working with Data Sources > (2026x) Adding Data Sources for ENOVIA Requirements
- labels: []

### NORMALIZED CONTENT

When ENOVIA Requirements are synchronized with the modeling tool through the Cameo DataHub Plugin, revisions may change over time as the requirements evolve. To ensure traceability and accuracy, it is important to understand how revisions are handled within the Cameo DataHub Plugin. Revisions can be updated automatically or manually, depending on whether you are working within or outside the parent node.

##### Working with the revision within the parent node

A Requirement Specification revised inside a Specification Folder in ENOVIA Requirements is automatically synchronized in the modeling tool. The DHLinks update seamlessly to the revised version without a manual DHLink transfer.

To update the revision while working within the parent node

1. Add an ENOVIARequirementsData Source (to learn more, refer to the [CONFLUENCE_PAGE title='(2026x) Adding Data Sources for ENOVIA Requirements' space=''] page).
2. Do one of the following:
  - Click **Synchronization**in the Cameo DataHub Explorer Panel.
  - Right-click the node and select the **Check for Change** command from the contextual menu.
3. Collapse the data source, right-click it, and select **Reload**.

The revised Requirement Specification is automatically updated in the modeling tool and the Cameo DataHub Explorer Panel.

##### Working with the revision outside the parent node

A Requirement Specification revised **outside of any Specification Folder** results in two separate objects (old revision and new revision) being displayed in the Cameo DataHub Explorer Panel. You must manually transfer DHLinks to the new revision.

To update the revision while working outside the parent node

1. Add an ENOVIARequirementsData Source (to learn more, refer to the [CONFLUENCE_PAGE title='(2026x) Adding Data Sources for ENOVIA Requirements' space=''] page).
2. Right-click the data source and select **Reload**.
3. Right-click the new revision and select the**Transfer DHLink from other revision**command from the contextual menu. 
 
[IMAGE alt='' src='']
4. In the Transfer DHLink from other revision dialog, select the required revision. [ATTACHMENT filename='Transfer DHLink from other revision_Dialog.png']
5. In the Transfer Link Confirmation dialog, click OK . [ATTACHMENT filename='Transfer Link Confirmation dialog.png']
6. Run Synchronization to update the modeling tool based on the revised specification.

If the parent node is out of scope and if the DHLink transfer is not possible, the following error message is displayed. 
...
````html
<p>When ENOVIA Requirements are synchronized with the modeling tool through the Cameo DataHub <span style="color:var(--ds-text,#172b4d);">Plugin</span>, revisions may change over time as the requirements evolve. To ensure traceability and accuracy, it is important to understand how revisions are handled within the Cameo DataHub <span style="color:var(--ds-text,#172b4d);">Plugin</span>. Revisions can be updated automatically or manually, depending on whether you are working within or outside the parent node.</p><h3>Working with the revision within the parent node</h3><p><span>A Requirement Specification revised inside a Specification Folder in ENOVIA Requirements is automatically synchronized in the modeling tool. The DHLinks update seamlessly to the revised version without a manual DHLink transfer.</span></p><p>To update the revision while working within the parent node</p><hr /><ol><li data-uuid="0919a4f0-82a6-485c-8587-a57d76ba0d49"><span><span style="color:var(--ds-text,#172b4d);">Add an ENOVIA </span><span style="color:var(--ds-text,#172b4d);">Requirements </span><span style="color:var(--ds-text,#172b4d);">Data Source (to learn more, refer to the </span></span><ac:link><ri:page ri:content-title="(2026x) Adding Data Sources for ENOVIA Requirements" /><ac:plain-text-link-body><![CDATA[Adding ENOVIA Requirements Data Source]]></ac:plain-text-link-body></ac:link> page).</li><li data-uuid="4965ae24-e88e-42f0-a342-e74fef5ec1ad"><p>Do one of the following:</p><ul><li><p>Click <strong>Synchronization </strong>in the Cameo DataHub Explorer Panel.</p></li><li><p>Right-click the node and select the <strong>Check for Change</strong> command from the contextual menu.</p></li></ul></li><li data-uuid="2a18d9f7-4fec-4d0a-b86e-2f1ef3dc5bfc"><p>Collapse the data source, right-click it, and select <strong>Reload</strong>.</p></li></ol><p>The revised Requirement Specification is automatically updated in the modeling tool and the Cameo DataHub Explorer Panel.</p><h3>Working with the revision outside the parent node</h3><p> A Requirement Specification revised <strong>outside of any Specification Folder</strong> results in two separate objects (old revision and new revision) being displayed in the Cameo DataHub Explorer Panel. You must manually transfer DHLinks to the new revision.</p><p>To update the revision while working outside the parent node</p><hr /><ol><li data-uuid="d3bf1c3d-d0f9-4bc0-ab53-687b8c79a029"><span><span style="color:var(--ds-text,#172b4d);">Add an ENOVIA </span><span style="color:var(--ds-text,#172b4d);">Requirements </span><span style="color:var(--ds-text,#172b4d);">Data Source (to learn more, refer to the </span></span><ac:link><ri:page ri:content-title="(2026x) Adding Data Sources for ENOVIA Requirements" /><ac:plain-text-link-body><![CDATA[Adding ENOVIA Requirements Data Source]]></ac:plain-text-link-body></ac:link> page).</li><li data-uuid="549004cf-c513-4b98-b0d3-3cef6c42fac1"><span>Right-click the data source and select <strong>Reload</strong>.</span></li><li data-uuid="fdca74c6-9f19-41dd-8e53-5b5129eaea73"><p><span>Right-click the new revision and s</span><span>elect the </span><strong>Transfer DHLink from other revision </strong>command from the contextual menu.<br /><br /><ac:image><ri:attachment ri:filename="Transfer DHLink from other revision.png" /></ac:image><br /><br /></p></li><li data-uuid="c8ce73e0-a371-4f94-b95a-21596a0d0562">In the Transfer DHLink from other revision dialog, select the required revision.<br /><br /><ac:image><ri:attachment ri:filename="Transfer DHLink from other revision_Dialog.png" /></ac:image><br /><br /></li><li data-uuid="8e65b84f-7fa0-4f45-9f7c-d459a98133c9">In the Transfer Link Confirmation dialog, click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Transfer Link Confirmation dialog.png" /></ac:image><br /><br /></li><li data-uuid="05a56176-e540-450e-a306-da4a2f9b17c4"><span>Run </span><strong>Synchronization</strong><span> to update the modeling tool based on the revised specification.</span></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="f864c77e-fc4e-4ed5-9622-8737b7592b3c"><ac:rich-text-body><p>If the parent node is out of scope and if the DHLink transfer is not possible, the following error message is displayed.<br /><br /><ac:image><ri:attachment ri:filename="Error message.png" /></ac:image></p></ac:rich-text-body></ac:structured-macro><p><br /></p>
````

<!--NOMAGIC_PAGE id=254418903 space=CDH version=2 -->
## PAGE 00289: (2026x) Working with the DataHub Explorer tree

- page_id: `254418903`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418903/2026x+Working+with+the+DataHub+Explorer+tree
- version_number: 2
- version_date: `2025-11-20T12:35:58.498+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><span style="color:var(--ds-text,#333333);">While using DataHub to work with Requirements from a project in DOORS or CSV, you must first create a Data Source. Data sources can be created for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation, or CSV files.</span></p><p>When you add the Data Source into MagicDraw<sup>®</sup>, it appears in the DataHub Explorer tree as a Data Source node.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="cb13ea5e-1aba-4c96-bc28-bd49899fea25" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=254418916 space=CDH version=2 -->
## PAGE 00290: (2026x) Working with the DHLink summary and generating reports

- page_id: `254418916`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418916/2026x+Working+with+the+DHLink+summary+and+generating+reports
- version_number: 2
- version_date: `2025-11-20T12:42:55.631+01:00`
- ancestors: Versions of Cameo DataHub Documentation > (2026x) Cameo DataHub Documentation > (2026x) User Guide
- labels: []

### NORMALIZED CONTENT

You can review DHLinks and make filtering options in terms of selected driver, direction of synchronization, sources and targets, types, status, and DHTrace, to display all interconnected relations through the [CONFLUENCE_PAGE title='(2026x) DHLink Summary' space='']**DHLink summary** dialog. With the shortcut menu in the DHLink Summary dialog, you can remove DHLinks, change synchronization directions, or select nodes from DataHub Explorer/Alias Explorer or in their original applications. You can also save the DHLink summary as an HTML report and open it in browsers.
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You can review DHLinks and make filtering options in terms of selected driver, direction of synchronization, sources and targets, types, status, and DHTrace, to display all interconnected relations through the <ac:link><ri:page ri:content-title="(2026x) DHLink Summary" /><ac:link-body><strong>DHLink summary</strong> dialog</ac:link-body></ac:link>. With the shortcut menu in the DHLink Summary dialog, you can remove DHLinks, change synchronization directions, or select nodes from DataHub Explorer/Alias Explorer or in their original applications. You can also save the DHLink summary as an HTML report and open it in browsers.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="c7a7334e-fde4-4787-bbf4-d8e83c541949" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568052 space=CDH version=2 -->
## PAGE 00291: Add-on features

- page_id: `249568052`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568052/Add-on+features
- version_number: 2
- version_date: `2025-11-20T11:27:17.521+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The current release of DataHub features enhanced capabilities and emphasizes more usability. The <strong>Conflict Dashboard</strong> keeps track of the changes of on both sides of the source and target nodes, which allows you to consider data synchronization. The text search function enables convenient searching for data or items in DataHub Explorer and Alias Manager. Available filtering inactive Data Sources makes it easier for you to focus on working active Data Sources, and the data copy progress bar shows the remaining percentage to complete the data copying operation.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="20ab95eb-2f4b-4881-a8e8-1fdfaf81fe58" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568296 space=CDH version=2 -->
## PAGE 00292: Adding a new node to a Data Source

- page_id: `249568296`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568296/Adding+a+new+node+to+a+Data+Source
- version_number: 2
- version_date: `2025-11-20T11:31:40.766+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
1. Open the template file located in <install_root>\ plugins\com.nomagic.datahub.magicdraw\data\templates\relation.html . with any text editors.
...
4. Open the [DHLink Summary](https://docs.nomagic.com/display/CDH/DHLink+summary) dialog in MagicDraw to [CONFLUENCE_PAGE title='Working with DHLink Summary reports' space='']
...
````html
<p>To add a Data Source for an OSLC Provider</p><hr /><ol><li>Click <span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="dh-add-ds-btn.png" /></ac:image> </span>on the <strong>DataHub Explorer</strong> toolbar. The <strong>Add Data Source</strong> dialog opens.</li><li>From the <strong>Driver</strong> drop-down list, select <strong>OSLC Provider</strong>.<br /><br /><ac:image><ri:attachment ri:filename="add_provider.png" /></ac:image><br /><br /></li><li>Enter the <strong>Root Services URI</strong>, <strong>Consumer key</strong>, and <strong>Consumer secret</strong> (provided by your administrator).</li><li>Click <strong>Create</strong>.</li></ol><p> The new OSLC Provider is added to the <strong>DataHub Explorer</strong> tree.</p><p><br /></p>
````

<!--NOMAGIC_PAGE id=249568469 space=CDH version=2 -->
## PAGE 00295: Adding Data Sources for CSV

- page_id: `249568469`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568469/Adding+Data+Sources+for+CSV
- version_number: 2
- version_date: `2025-11-20T11:34:54.170+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources
- labels: []
...
All specification folders and requirement specifications on the server are displayed in the CDH Explorer panel. To view only the elements you own, update the environment options. For more information, click [CONFLUENCE_PAGE title='ENOVIA Requirements' space=''].
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Adding ENOVIA Requirements Data Source</h3><p>To add an ENOVIA <span>Requirements </span>Data Source</p><hr /><ol><li data-uuid="f40d3d36-292f-4444-ba59-148ade386e93"><a href="https://docs.nomagic.com/MT/?contextKey=authentication-with-3dexperience-platform&amp;version=latest&amp;variant=default">Log in to the 3DEXPERIENCE platform.</a></li><li data-uuid="5bc4076b-e5b4-46ac-82ca-f32a455cade7"><p class="auto-cursor-target">In the main menu, select 3DEXPERIENCE &gt; ENOVIA Requirements.<br /><br /><ac:image><ri:attachment ri:filename="ENOVIA Requirements option.png" /></ac:image></p></li></ol><p>All specification folders and requirement specifications on the server are displayed in the CDH Explorer panel. To view only the elements you own, update the environment options. For more information, click <ac:link><ri:page ri:content-title="ENOVIA Requirements" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p><p><br /><ac:image><ri:attachment ri:filename="Requirements.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="e87f42b0-5317-433a-bdfc-103559d10139"><a href="https://docs.nomagic.com/display/CDH/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool">Mapping source and target types to copy data to and from a modelling tool</a></li><li data-uuid="637e9155-2abc-48f4-9aa9-91cae6314570"><a href="https://docs.nomagic.com/MT/?contextKey=authentication-with-3dexperience-platform&amp;version=latest&amp;variant=default">Authentication with 3DEXPERIENCE platform</a></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568479 space=CDH version=2 -->
## PAGE 00297: Adding Data Sources for IBM Rational DOORS

- page_id: `249568479`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568479/Adding+Data+Sources+for+IBM+Rational+DOORS
- version_number: 2
- version_date: `2025-11-20T11:34:57.962+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources
- labels: []
...
3. Click **Create**. InformationOAuth consumer key authentication when adding Data Sources for IBM Rational DOORS Next Generation is similar to the process of [CONFLUENCE_PAGE title='Adding Data Sources for an OSLC Provider' space=''].

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>There are two types of authentication when adding Data Sources for IBM Rational DOORS Next Generation as follows</p><ul><li>Login authentication through the embedded browser<br />To support the secured environment with different authentications including single sign-on, the embedded browser can be used to allow you to log on directly to the DNG login page so that DataHub is able to make connections to a variety of secured servers.<br /><br /></li><li>OAuth consumer key authentication</li></ul><p>Before selecting one of the two authentication types, you must open the <strong>Add Data Source</strong> dialog first and select the <strong>IBM Rational DOORS Next Generation</strong> driver.</p><p><br /></p><p>To open the <strong>Add Data Source</strong> dialog and select <strong>IBM Rational DOORS Next Generation</strong> as the driver</p><hr /><ol><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Add Data Source</strong> <ac:image><ri:attachment ri:filename="dh-add-ds-btn.png" /></ac:image>button. The <strong>Add Data Source</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="1570 Add Data Source Button.png" /></ac:image><br /><br /></li><li>From the <strong>Driver</strong> drop-down list, select <strong>IBM Rational DOORS Next Generation</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Add Data Source Dialog - DOORS NG.png" /></ac:image></li></ol><p style="margin-left: 30.0px;text-align: left;"><br /></p><p>To add an IBM Rational DOORS Next Generation Data Source using the <strong>Login</strong> authentication type through the embedded browser</p><hr /><ol><li>From the <strong>Authentication type</strong> options, select <strong>Login</strong>.</li><li><p class="auto-cursor-target">Specify <strong>Service Provider URL</strong> and <strong>Authentication URL</strong>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="5358c9ee-d13d-43d2-b8dd-0a5b362e13b2"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If server addresses are copied and pasted into the <strong>Service Provider URL</strong> and <strong>Authentication URL</strong> boxes, the addresses are automatically formatted as the format examples shown below the boxes.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br />The Server information to be specified is explained in the table below</p><table class="relative-table wrapped"><colgroup> <col /> <col /> <col /> </colgroup><tbody><tr><td><p><strong>Server information</strong></p></td><td><p><strong>Function</strong></p></td><td><p><strong>Format</strong></p></td></tr><tr><td><p>Service Provider URL</p></td><td><p>Specifies a web application address to access DOORS.</p></td><td><p><em>https://&lt;server&gt;:&lt;port&gt;/rm/rootservices</em></p></td></tr><tr><td><p>Authentication URL (optional)</p></td><td><p>Specifies an authentication address to log on DOORS.</p><p>An authentication URL is required for distributed authentication service.</p></td><td><p><em>https://&lt;server&gt;:&lt;port&gt;/jts/j_security_check</em></p></td></tr></tbody></table><p class="auto-cursor-target"><br /><br /></p></li><li>Click <strong>Login with browser</strong>. The embedded browser opens the DNG Login page.<br /><br /><ac:image ac:width="600"><ri:attachment ri:filename="Embedded Browser - DOORS NG.png" /></ac:image><br /><br /></li><li>After logging on successfully, close the embedded browser. The newly created DOORS Next Generation Data Source appears in the <strong>DataHub Explorer</strong> tab.</li></ol><p class="auto-cursor-target" style="margin-left: 30.0px;"><br /></p><p style="margin-left: 30.0px;"><br /></p><p>To add an IBM Rational DOORS Next Generation Data Source using the <strong>OAuth consumer key</strong> authentication type</p><hr /><ol><li>From the <strong>Authentication type</strong> options, select <strong>OAuth consumer key</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Add DOORS NG Data Source (OAuth).png" /></ac:image><br /><br /></li><li><p class="auto-cursor-target">Specify <strong>Root Services URI</strong>, <strong>Consumer key</strong>, and <strong>Consumer secret</strong>.<br /><br />The <strong>Server</strong> and <strong>OAuth</strong> information to be specified is explained in the table below</p><table class="relative-table wrapped" style="width: 69.4762%;"><colgroup> <col style="width: 36.7111%;" /> <col style="width: 63.3391%;" /> </colgroup><tbody><tr><td><p><strong>Server and OAuth information</strong></p></td><td><p><strong>Function</strong></p></td></tr><tr><td><p>Root Services URI</p></td><td><p>Specifies a Root Services URI.</p></td></tr><tr><td><p>Consumer key</p></td><td>Specifies a key provided by the administrator.</td></tr><tr><td colspan="1">Consumer secret</td><td colspan="1">Specifies a secret provided by the administrator.</td></tr></tbody></table><p class="auto-cursor-target"><span style="color:var(--ds-text-inverse,#ffffff);">a</span></p></li><li><p class="auto-cursor-target">Click <strong>Create</strong>.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="2879099a-ae3a-4d5f-bb52-7a166e0051b6"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>OAuth consumer key authentication when adding Data Sources for IBM Rational DOORS Next Generation is similar to the process of <ac:link><ri:page ri:content-title="Adding Data Sources for an OSLC Provider" /><ac:plain-text-link-body><![CDATA[adding Data Sources for an OSLC Provider]]></ac:plain-text-link-body></ac:link>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=249568621 space=CDH version=5 -->
## PAGE 00299: Adding Data Sources for JAMA Connect

- page_id: `249568621`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568621/Adding+Data+Sources+for+JAMA+Connect
- version_number: 5
- version_date: `2025-12-04T06:27:51.592+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources
- labels: []

### NORMALIZED CONTENT

With the Jama Connect 9.29 Cloud release (9.28.x for Self-Hosted and Customer-Validated Cloud), Jama Software is introducing **API Reporting**. This new view enables Organization Admins to monitor REST API usage, including active users, their OAuth Client IDs, and volumes. To support this enhancement, REST API access will be limited to users with**Named Creator**licenses. For any questions about licensing requirements, contact your Customer Success Manager.

The modeling tool supports JAMA Connect version 9.x and later.

##### Adding Data Sources for JAMA Connect

To add a Jama Connect data source

1. In theCameoDataHub Explorertoolbar, click **Add Data Source. 
...
[IMAGE alt='' src='']
4. From the JAMA Single Project Selection dialog, select the project and click **Connect**. 
...
The following video shows theJama Connect to modeling tool Integration:

800400

##### Adding Data Source for JAMA Connect using the OAuth 2.0 authentication type

To add a data source for JAMA Connect using the OAuth 2.0 authentication type

1. In theCameoDataHub Explorertoolbar, click **Add Data Source. 
 
[IMAGE alt='' src='']**
2. In the Add Data Source dialog, select OAuth 2.0 authentication type. [IMAGE alt='' src='']
3. Specifythe Server and Login Information in the Add Data Source dialog. **Server and Login Information****Function**URLSpecifies the JAMA Connect URL.Client IDSpecifies a key provided by the Client.Client SecretSpecifies a secret provided by the Client. To learn more about generating Client ID and Client Secret, refer to [Generating an OAuth Bearer Token for Making API Calls](https://support.jamasoftware.com/hc/en-us/articles/20466885006861-API-Authentication-Generating-an-OAuth-Bearer-Token-for-Making-API-Calls).
4. Click Create .

**Related pages:**

- [CONFLUENCE_PAGE title='Diagram Synchronization' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b908ab67-a3d0-49fb-972e-6fc5d2c602d9"><ac:rich-text-body><p>With the Jama Connect 9.29 Cloud release (9.28.x for Self-Hosted and Customer-Validated Cloud), Jama Software is introducing <strong>API Reporting</strong>. This new view enables Organization Admins to monitor REST API usage, including active users, their OAuth Client IDs, and volumes. <span>To support this enhancement, REST API access will be limited to users with </span><strong>Named Creator </strong><span>licenses. For any questions about licensing requirements, contact your Customer Success Manager.</span></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="7032d140-2193-4e1d-a0eb-2043193f50ae"><ac:rich-text-body><p>The modeling tool supports JAMA Connect version 9.x and later.</p></ac:rich-text-body></ac:structured-macro><h3><span style="font-size: 16.0px;letter-spacing: -0.006em;">Adding Data Sources for JAMA Connect</span></h3><p><span style="color:var(--ds-text,#333333);">To add a Jama Connect d</span><span style="color:var(--ds-text,#333333);">ata source</span></p><hr /><ol><li><span style="color:var(--ds-text,#333333);">In the<span> Cameo </span>DataHub Explorer<span> </span>toolbar, click <strong style="text-align: left;">Add Data Source.<br /><br /><ac:image><ri:attachment ri:filename="Add data source.png" /></ac:image><br /></strong></span></li><li><span style="color:var(--ds-text,#333333);">In the Add Data Source dialog, select<span> <strong>Jama Connect </strong></span>from the<span> </span><strong>Driver </strong>drop-down list<span><strong>.</strong></span><br /><br /><ac:image><ri:attachment ri:filename="Select JAMA Connect.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">Enter the server URL and login information and click<strong> Create.</strong><br /><br /><ac:image><ri:attachment ri:filename="Add data source_Dialog.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">From the JAMA Single Project Selection dialog, select the project and click <strong>Connect</strong>.<br /><br /><ac:image><ri:attachment ri:filename="JAMA Single Project Selection.png" /></ac:image><br /><br /></span></li></ol><p><span style="color:var(--ds-text,#333333);">The data source is added in the Cameo DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="CDH Explorer Panel.png" /></ac:image><br /></span></p><p><span style="color:var(--ds-text,#333333);">The following video shows the </span><span style="letter-spacing: 0.0px;">Jama Connect to modeling tool Integration:</span></p><p style="text-align: center;"><span style="color:var(--ds-text,#333333);"><span style="color:var(--ds-text,#333333);"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="00e0d004-f0c3-41cd-90a0-eef364f6c3d4"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=HT1OIG7bAGY" /></ac:parameter><ac:parameter ac:name="height">400</ac:parameter></ac:structured-macro></span></span></p><h3>Adding Data Source for JAMA Connect using the OAuth 2.0 authentication type</h3><p>To a<span style="letter-spacing: 0.0px;">dd a data source for JAMA Connect using the OAuth 2.0 authentication type</span></p><hr /><ol><li><span style="color:var(--ds-text,#333333);">In the<span> Cameo </span>DataHub Explorer<span> </span>toolbar, click <strong style="text-align: left;">Add Data Source.<br /><br /><ac:image><ri:attachment ri:filename="Add data source.png" /></ac:image><br /><br /></strong></span></li><li><span style="color:var(--ds-text,#172b4d);">In the Add Data Source dialog, </span><span style="color:var(--ds-text,#172b4d);">select<span> </span></span><strong style="text-align: left;">OAuth 2.0 </strong>authentication type.<span style="color:var(--ds-text,#172b4d);"><br /><br /><ac:image><ri:attachment ri:filename="oAuth Authentication type.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#172b4d);">Specify<span> the Server and Login Information</span></span><strong style="text-align: left;"> </strong>in the Add Data Source dialog.<br /><br /><table class="wrapped"><colgroup><col /><col /></colgroup><tbody><tr><th scope="col"><strong>Server and Login Information</strong></th><th scope="col"><strong>Function</strong></th></tr><tr><td>URL </td><td>Specifies the JAMA Connect URL.</td></tr><tr><td>Client ID</td><td>Specifies a key provided by the Client.</td></tr><tr><td>Client Secret</td><td>Specifies a secret provided by the Client.</td></tr></tbody></table><br /><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ec34dc3b-5ba6-497a-b394-5e066645a462"><ac:rich-text-body><p>To learn more about generating Client ID and Client Secret, refer to <a href="https://support.jamasoftware.com/hc/en-us/articles/20466885006861-API-Authentication-Generating-an-OAuth-Bearer-Token-for-Making-API-Calls">Generating an OAuth Bearer Token for Making API Calls</a>.</p></ac:rich-text-body></ac:structured-macro></li><li>Click <strong>Create</strong>.</li></ol></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages:</strong></p><ul><li><ac:link><ri:page ri:content-title="Diagram Synchronization" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568598 space=CDH version=3 -->
## PAGE 00300: Adding Data Sources for OSLC Provider

- page_id: `249568598`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568598/Adding+Data+Sources+for+OSLC+Provider
- version_number: 3
- version_date: `2025-11-20T11:35:31.246+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources
- labels: []

### NORMALIZED CONTENT

See the [Adding Data Sources for an OSLC Provider](https://docs.nomagic.com/display/CDH/Adding+Data+Sources+for+an+OSLC+Provider) in the [Working with OSLC features](https://docs.nomagic.com/display/CDH/Working+with+OSLC+features) section.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>See the <a href="https://docs.nomagic.com/display/CDH/Adding+Data+Sources+for+an+OSLC+Provider">Adding Data Sources for an OSLC Provider</a> in the <a href="https://docs.nomagic.com/display/CDH/Working+with+OSLC+features">Working with OSLC features</a> section.</p>
````

<!--NOMAGIC_PAGE id=249569041 space=CDH version=2 -->
## PAGE 00301: Additional DataHub features

- page_id: `249569041`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569041/Additional+DataHub+features
- version_number: 2
- version_date: `2025-11-20T11:42:34.397+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>In this section, you will learn more about Alias Manager to deal with aliases in DataHub, DHLink panel for identification of changes in each data node, Schema Map Manager and its user interface components to edit or deactivate the mappings, and the database clean-up operation for unused reference removal in projects from modeling tools.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3278b749-703c-4697-975d-46d6632673e6" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568019 space=CDH version=2 -->
## PAGE 00302: Alias Manager

- page_id: `249568019`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568019/Alias+Manager
- version_number: 2
- version_date: `2025-11-20T11:26:29.504+01:00`
...
````html
<p>DataHub <strong>Alias Manager</strong> contains a list of all available aliases. It stores these aliases for later use, and you can either access or remove them.</p><p><br /></p><p>To open Alias Manager</p><hr /><ul><li>From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Alias Manager</strong>. The <strong>Alias Manager</strong> dialog opens.</li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Alias Manager" ac:alt="DataHub Alias Manager"><ri:attachment ri:filename="alias-manager.png" /></ac:image></p>
````

<!--NOMAGIC_PAGE id=249568087 space=CDH version=2 -->
## PAGE 00303: Basic features of DataHub

- page_id: `249568087`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568087/Basic+features+of+DataHub
- version_number: 2
- version_date: `2025-11-20T11:28:15.799+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You will be guided through DataHub basic copying operations from the <strong>Operation</strong> drop-down list in Cameo DataHub Explorer including creating OSLC links and DHTraces. There is also more explanation about creating OSLC queries and copying their results, optionally as SysML requirements.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="6f2d6385-48e0-4de2-8a92-4805fe86c206" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568685 space=CDH version=4 -->
## PAGE 00304: Business Use Case flow with DNG

- page_id: `249568685`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568685/Business+Use+Case+flow+with+DNG
- version_number: 4
- version_date: `2025-11-20T11:36:27.160+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features > OSLC tutorial
- labels: []
...
OSLC root services document URI can be found using the following pattern - http(s)://TWC_IP:PORT/oslc/rootservices. For more information, see [OSLC API](https://docs.nomagic.com/DEVG/?contextKey=oslc-api&version=latest).

You must also [publish the project as an OSLC resource in Cameo Collaborator for Teamwork Cloud](https://docs.nomagic.com/MCS/?contextKey=publishing-from-graphical-user-interface&version=latest&variant=Teamwork%20Cloud%20and%20Services).

After establishing server and project-level relationships, open your modeling tool (MagicDraw, Cameo Systems Modeler, or Cameo Enterprise Architecture), and perform the following steps:

1. Add requirements (import or sync) from DNG through DataHub as described at [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space=''].
2. Copy requirements from DataHub to your model as described at [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='']. The adding of requirements has been enhanced during OSLC consumer implementation in version 19.0. Users are able to see the DNG requirement’s OSLC Previews in the [OSLC Preview](https://docs.nomagic.com/display/CDH/OSLC+Preview) tab of a modeling tool.
...
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2024xR3']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2024xR2']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2024x']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2022xR2']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2022xR1']
- [CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2022x']
...
````html
<p>To close an open Data Source</p><hr /><ul><li>Right-click a Data Source in the <strong>DataHub Explorer</strong> tree and choose <strong><ac:image><ri:attachment ri:filename="close-ds.png" /></ac:image></strong>.</li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="227ab3ef-e0d9-4259-9d5e-ca03f5e98b8c"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>Closing a Data Source doesn’t remove it from the <strong>DataHub Explorer</strong> tree. This action is only for deactivation.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To open or activate an inactive Data Source</p><hr /><ul><li>Right-click an inactive Data Source and choose <strong><ac:image><ri:attachment ri:filename="connect.png" /></ac:image></strong>. The Data Source shows as connected.</li></ul>
````

<!--NOMAGIC_PAGE id=249568580 space=CDH version=2 -->
## PAGE 00309: Collection nodes in DOORS Next Generation

- page_id: `249568580`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568580/Collection+nodes+in+DOORS+Next+Generation
- version_number: 2
- version_date: `2025-11-20T11:35:22.002+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>You can work with an artifact in a Collection via a new Collection tab that displays items of the Collection artifact by using the <strong>Open collection in new window</strong> command.</p><p><br /></p><p>To open a Collection artifact in a new tab</p><hr /><ul><li>Right-click a Collection element in DataHub Explorer and select <strong>Open collection in new window</strong>.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Open collection.png" /></ac:image></p><h6 style="text-align: center;">The Open collection in new window command.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="An Open DOORS Next Generation Collection Artifact Tab in DataHub Explorer.png" /></ac:image></p><h6 style="text-align: center;">An open DOORS Next Generation Collection artifact tab in DataHub Explorer.</h6><p>The new Collection artifact tab that shows items of the Collection artifact will open in DataHub Explorer.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="61a4d8b4-c545-434f-b429-4312515ad7c4"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>DataHub records the open Collection artifact tab as a new Alias tree, thus allowing you to directly open the DOORS Next Generation Collection artifact tab by clicking <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Alias Manager</strong> and selecting the Collection from the list at the next time you connect the DOORS Next Generation Data Source.</li><li>All associated DHLinks created will be available only within the Collection artifact tab.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568549 space=CDH version=2 -->
## PAGE 00310: Comment elements under Requirements of DOORS Next Generation Data Source

- page_id: `249568549`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568549/Comment+elements+under+Requirements+of+DOORS+Next+Generation+Data+Source
- version_number: 2
- version_date: `2025-11-20T11:35:09.689+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
<!--NOMAGIC_PAGE id=249568586 space=CDH version=2 -->
## PAGE 00312: Configuration Management

- page_id: `249568586`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568586/Configuration+Management
- version_number: 2
- version_date: `2025-11-20T11:35:29.236+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>Configuration Management can be enabled once the project initiates, after which it cannot be disabled later in DOORS Next Generation. When Configuration Management is not enabled for a project, only the content of default project component is available in the Cameo DataHub Explorer Panel. When configuration management is enabled, you can have more than one component in the project. Each component could have multiple streams and baselines and can be used on Global Configurations. All those objects once created and configured are available to work with in the Cameo DataHub Explorer Panel.</p><h3><span style="color:var(--ds-text,#333333);">Working with Global Configuration</span></h3><p><span style="color:var(--ds-text,#333333);">The DOORS Next Generation connector now supports global configuration. When configuration management is enabled in DOORS Next Generation, you can add all RM domain-related objects identified on the selected global configuration to the Cameo DataHub Explorer panel as separate data sources.</span></p><p><span style="color:var(--ds-text,#333333);">To create Global Configuration as a data source</span></p><hr /><ol><li data-uuid="cb979884-b912-4b66-bf81-b1b0f6f91a29">Right click on the DOORS Next Generation data source and select <strong>Create GC Configuration as Data Source<br /><br /></strong><strong><ac:image><ri:attachment ri:filename="GC_Command.png" /></ac:image><br /><br /></strong></li><li data-uuid="7c9fe463-1079-4ab7-88a5-1ae4e9c4e01b">The <strong>Create GC Configuration as Data Source </strong>dialog box appears. From the <strong>Select GC project</strong> list select the GC project. Select the GC component from the <strong>Select GC component</strong> list.  Then select the stream/baseline you want to work on from the <strong>Select GC stream/baseline</strong> list. The list of available streams/baselines in the GC configuration are displayed below. Click <strong>Create </strong>to create<strong> </strong>GC Configuration as Data Source.<br /><br /><ac:image><ri:attachment ri:filename="GC_DialogBox.png" /></ac:image><br /><br /></li><li data-uuid="cf344e6a-122c-40cd-99f4-8382bd0531a8">After the GC configuration is created as a data source, it will be visible in the same Cameo Datahub Explorer panel. Once you click on any stream/baseline, the GC configuration data source will open in a new tab.<br /><br /><ac:image><ri:attachment ri:filename="GC_Datasource.png" /></ac:image><br /><br /></li></ol><h3>Configuration Management effect on CDH Explorer Panel</h3><p><br /></p><p>Enabling or disabling Configuration Management in DOORS Next Generation affects Cameo Datahub Explorer Panel in the following ways:</p><ul><li data-uuid="e7074427-e56f-4588-a885-2bf9bee54134">When Configuration management is not enabled, the content of the default component is displayed under the project parent node.</li><li data-uuid="2bde999e-fe56-47b8-8899-5a1be7963ac5">When Configuration Management is enabled, only the <span style="color:var(--ds-text,#333333);">project's </span>components are displayed under the project parent node.<br /><br /><ac:image ac:align="center"><ri:attachment ri:filename="CDH_finalResult.png" /></ac:image><h6 style="text-align: center;">Configuration Management effect on CDH Explorer Panel</h6></li></ul>
````

<!--NOMAGIC_PAGE id=249568684 space=CDH version=3 -->
## PAGE 00313: Configuring software for OSLC integration

- page_id: `249568684`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568684/Configuring+software+for+OSLC+integration
- version_number: 3
- version_date: `2025-11-20T11:36:26.666+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features > OSLC tutorial
- labels: []
...
You must use the same version of a modeling tool and Cameo DataHub, and the same version of Teamwork Cloud and Cameo Collaborator for Teamwork Cloud. For more information, see the [product compatibility page](https://docs.nomagic.com/PC/?contextKey=product-compatibility&version=latest).

**Related pages**

- Installing modeling tools
- Installing plugins
- Installing and configuring Teamwork Cloud

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Software requirements</h3><p>To link and share data using Open Services for Lifecycle Collaboration (OSLC) integration, ensure that the following software requirements are met:</p><ul><li data-uuid="6d7ef349-2ee5-4538-a2da-4c841707af16">The following software is installed on your machine:<ol><li>Modeling tool with the Requirements plugin (e.g., MagicDraw + Requirements plugin, Cameo Systems Modeler, Cameo Enterprise Architecture)</li><li>Cameo DataHub</li></ol></li></ul><ul><li class="auto-cursor-target" data-uuid="acca9bd6-c767-4668-ab56-669a10a95d60">You have access to the following software on a server:<br /><ol><li>Teamwork Cloud</li><li>Cameo Collaborator for Teamwork Cloud</li><li>Doors Next Generation v6.0.3+ (DNG)<br /><br /></li></ol></li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="4d23ba4a-401c-4b82-8cc0-3dd47bf95b75"><ac:parameter ac:name="title">Software versions</ac:parameter><ac:rich-text-body><p>You must use the same version of a modeling tool and Cameo DataHub, and the same version of Teamwork Cloud and Cameo Collaborator for Teamwork Cloud. For more information, see the <a href="https://docs.nomagic.com/PC/?contextKey=product-compatibility&amp;version=latest">product compatibility page</a>.</p></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="ff5d3250-49b2-450b-8e0d-35561e22d6f9"><a href="https://docs.nomagic.com/IL/?contextKey=installing-modeling-tools&amp;version=latest">Installing modeling tools</a></li><li data-uuid="94fa9e80-3ece-485c-b402-d467bf40a049"><a href="https://docs.nomagic.com/IL/?contextKey=installing-plugins&amp;version=latest">Installing plugins</a></li><li data-uuid="23750f8e-1115-4062-bbf3-369d974caffe"><a href="https://docs.nomagic.com/MCS/?contextKey=installation&amp;version=latest&amp;variant=Teamwork%20Cloud%20and%20Services">Installing and configuring Teamwork Cloud</a></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568228 space=CDH version=3 -->
## PAGE 00314: Confirmation

- page_id: `249568228`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568228/Confirmation
- version_number: 3
- version_date: `2025-11-20T11:31:08.559+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Customizing DataHub options
- labels: []
...
<!--NOMAGIC_PAGE id=249568565 space=CDH version=2 -->
## PAGE 00319: Copying DHLinks across Stream or Baseline Data Sources

- page_id: `249568565`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568565/Copying+DHLinks+across+Stream+or+Baseline+Data+Sources
- version_number: 2
- version_date: `2025-11-20T11:35:21.159+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>When you have synchronization with any existing Stream or Baseline, you can continue it with a new stream or baseline. DataHub enables you to copy DHLinks from one Stream or Baseline Data Source to another.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_Selection.png" /></ac:image></p><h6 style="text-align: center;">Selecting an existing DHLink in an Initial Stream or Baseline.</h6><p>To copy an existing DHLink to another Stream or Baseline Data Source</p><hr /><ol><li style="text-align: left;">Right-click an element in the target Stream or Baseline that DHLink(s) will be copied to and select <strong>Copy DHLink from other data sources</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy_DHLinks from other data source.png" /></ac:image><br /><br /></li><li style="text-align: left;">The <strong style="letter-spacing: 0.0px;">Copy DHLink from other data sources</strong><span style="letter-spacing: 0.0px;"> dialog box opens. From the </span><strong style="letter-spacing: 0.0px;">Select root element of the DHLink</strong><span style="letter-spacing: 0.0px;"> list, select a Stream or baseline to copy DHLink(s) from. Click </span><strong style="letter-spacing: 0.0px;">OK</strong><span style="letter-spacing: 0.0px;">.</span><br /><br /><ac:image><ri:attachment ri:filename="Dailog_box.png" /></ac:image></li></ol><p><br /><span style="letter-spacing: 0.0px;">After links are copied from one data source to the other, both data sources will not contain synchronized links. Data sources </span><span style="letter-spacing: 0.0px;">those links are copied from will be displayed with an <em><strong>x</strong></em> icon on the components, <span>indicating that it is not in </span>synchronization<span> with the model</span>. The other data source the links are copied to will be displayed with an <em><strong>s</strong></em> icon on the components, indicating that it is in </span>synchronization<span style="letter-spacing: 0.0px;"> with the model.</span></p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_copy.png" /></ac:image></p><h6 style="text-align: center;">The duplicated DHLink copied from the Initial Stream</h6><p>It is possible to have both sources in synchronization by selecting the <strong>Include Link Recursively</strong> command.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Inlcude DHLinks.png" /></ac:image></p><h6 style="text-align: center;">Inlcude DHLinks Recursively command</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_copy_both_sync.png" /></ac:image></p><h6 style="text-align: center;">Both data sources in synchronization</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="cbe65665-f9b5-4667-be69-52cba4a780f5"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The selected element in the target Stream must be the root element of DHLink(s) in the other Stream Data Source to perform the copying DHLink operation across Stream Data Sources.</li><li>When the Check for change command is initiated, you need to select which target stream to check the model against.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568671 space=CDH version=3 -->
## PAGE 00320: Copying OSLC query results to a modeling tool as SysML Requirements

- page_id: `249568671`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568671/Copying+OSLC+query+results+to+a+modeling+tool+as+SysML+Requirements
- version_number: 3
- version_date: `2025-11-20T11:36:25.004+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []

### NORMALIZED CONTENT

To copy OSLC query results to a modeling tool as SysML Requirements, you must set up [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space=''] and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.

To copy OSLC query results to a modeling tool as SysML Requirements

1. Complete the steps of [CONFLUENCE_PAGE title='Creating OSLC queries' space=''] .
...
````html
<p>To copy OSLC query results to a modeling tool as SysML Requirements, you must set up <ac:link><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS Next Generation" /><ac:plain-text-link-body><![CDATA[an IBM® Rational® DOORS® Next Generation Data Source]]></ac:plain-text-link-body></ac:link> and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.</p><p>To copy OSLC query results to a modeling tool as SysML Requirements</p><hr /><ol><li>Complete the steps of <ac:link><ri:page ri:content-title="Creating OSLC queries" /><ac:plain-text-link-body><![CDATA[creating OSLC queries]]></ac:plain-text-link-body></ac:link>.</li><li>From the OSLC query results, drag the matching query tree to the Containment tree of the modeling tool.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="export-from-oslc-qe.png" /></ac:image><br /><br /></p><p style="margin-left: 30.0px;">2. The <strong>Copy Data</strong> dialog opens. From the target type list in the <strong>MagicDraw Side</strong> group, choose <strong>Extended Requirement</strong>. Click <strong>OK</strong>.<br /><br /></p><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Copy Data for OSLC Query User Guide.png" /></ac:image></p><p><br /></p><p>The result of the copy is shown in the MagicDraw Containment tree.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="export-doors-ng-node-2.png" /></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The result of the copied OSLC query in the MagicDraw Containment tree.</h6><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="c9cbee8c-4d2b-4f4b-8733-bc9cbfe86342"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p style="margin-left: 30.0px;"><strong>OSLC Query Editor</strong><span> supports the </span><strong>Copy Data</strong>,<strong> Copy Data with DHTrace</strong>, and<strong> Create DHTrace</strong><strong> </strong>operations<span>.</span></p><p style="margin-left: 30.0px;"><span> </span></p><p><ac:image ac:align="center"><ri:attachment ri:filename="OSLC Query Editor.png" /></ac:image></p><h6 style="text-align: center;">The Copy Data, Copy Data with DHTrace, and Create DHTrace operations are supported in the OSLC Query Editor dialog.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568434 space=CDH version=3 -->
## PAGE 00321: Copying Requirements into a modeling tool

- page_id: `249568434`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568434/Copying+Requirements+into+a+modeling+tool
- version_number: 3
- version_date: `2025-11-20T11:33:49.510+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub allows you to copy Requirements from DOORS into UML diagrams, from DOORS Data Source to the Containment area as Use Case diagrams, from DOORS or DOORS Next Generation to a modeling tool with DHLinks, and copy Requirements using OSLC links.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="96c19c2f-7366-41b0-ad7b-00ce7fa929ff" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568435 space=CDH version=2 -->
## PAGE 00322: Copying Requirements to a modeling tool as the SysML Requirement diagram

- page_id: `249568435`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568435/Copying+Requirements+to+a+modeling+tool+as+the+SysML+Requirement+diagram
- version_number: 2
- version_date: `2025-11-20T11:33:42.167+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
1. [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS' space=''] or [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space=''] in DataHub Explorer.
...
````html
<p>This section deals with copying a Use Case diagram from a DOORS Data Source into your modeling tool's Containment area.</p><p>To copy a Use Case from a DOORS Data Source to a modeling tool as the Use Case diagram</p><hr /><ol><li><a href="https://docs.nomagic.com/display/CDH/Adding+Data+Sources+for+IBM+Rational+DOORS">Add a DOORS Data Source </a>or <a href="https://docs.nomagic.com/display/CDH/Adding+Data+Sources+for+IBM+Rational+DOORS+Next+Generation">DOORS Next Generation Data Source </a>in DataHub Explorer.</li><li><p style="text-align: left;">Drag the selected node from DOORS Data Source to your modeling tool's Containment tree.<br /><br /><ac:image ac:title="Drag and drop to copy requirements from DOORS data source to MagicDraw" ac:alt="Drag and drop to copy requirements from DOORS data source to MagicDraw"><ri:attachment ri:filename="importing-reqs-from-doors-ds.png" /></ac:image><br /><br /></p></li><li><p style="text-align: left;">Map the Formal Module to a Use Case diagram type and the object to a Use Case type. Click <strong>OK</strong>.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Copy Data with Object.png" /></ac:image></p></li></ol><h6 style="text-align: center;margin-left: 30.0px;">The Copy Data dialog in Group Type Mapping mode when copying Use Case elements from DOORS to the modeling tool's Containment area.</h6><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Result of copying Use Case Diagram to MagicDraw" ac:alt="Result of copying Use Case Diagram to MagicDraw"><ri:attachment ri:filename="result-of-import-use-case.png" /></ac:image></p><h6 style="text-align: center;">The Use Case diagram after copying Requirements from DOORS to a modeling tool.</h6>
````

<!--NOMAGIC_PAGE id=249568451 space=CDH version=2 -->
## PAGE 00324: Copying Requirements to a modeling tool with DHLinks

- page_id: `249568451`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568451/Copying+Requirements+to+a+modeling+tool+with+DHLinks
- version_number: 2
- version_date: `2025-11-20T11:33:44.049+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
````html
<p>To copy Requirements from DOORS or DOORS Next Generation Data Source to a modeling tool</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Copy Data with Sync</strong>.</li><li>Drag a data node in a DOORS or DOORS Next Generation Data Source from DataHub Explorer to the modeling tool's Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="Copy Requirement with DHLinks.png" /></ac:image><br /><br /></li><li>The <strong>Copy Data with Sync</strong> dialog appears. From the <strong>Mapping Mode</strong> drop-down list, choose <strong>Individual Type Mapping</strong> or <strong>Group Type Mapping</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy Data with Sync Dialog with Mapping Dropdown List (Group Mapping).png" /></ac:image><br /><br /></li><li>After you finish all attribute mappings, click <strong>OK</strong>. The copying result is shown in the modeling tool's Containment tree.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="Result of copying SysML requirement with DHLink" ac:alt="Result of copying SysML requirement with DHLink"><ri:attachment ri:filename="result-of-import-req-as-dh-link.png" /></ac:image></p>
````

<!--NOMAGIC_PAGE id=249568461 space=CDH version=2 -->
## PAGE 00325: Copying Requirements to a modeling tool with OSLC links

- page_id: `249568461`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568461/Copying+Requirements+to+a+modeling+tool+with+OSLC+links
- version_number: 2
- version_date: `2025-11-20T11:33:45.306+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
This version of DataHub now supports OSLC queries and links that you can [CONFLUENCE_PAGE title='Create DHTrace operation with OSLC links' space=''].
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ad0ec783-712d-491a-8709-a013333b8cc6"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p>This version of DataHub now supports OSLC queries and links that you can <ac:link><ri:page ri:content-title="Create DHTrace operation with OSLC links" /><ac:plain-text-link-body><![CDATA[create OSLC links through the Create DHTrace operation]]></ac:plain-text-link-body></ac:link>.</p><p><br /></p><p>To copy Requirements using OSLC links</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create_DHTrace.png" /></ac:image><br /><br /></li><li>From an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source, drag a node into the modeling tool's Containment area. A shortcut menu appears, prompting you to select the type of link. Select one from the shortcut menu.<br /><br /><ac:image><ri:attachment ri:filename="Create OSLC Link by Create DHTrace.png" /></ac:image><br /><br /></li></ol><p><ac:image ac:align="center"><ri:attachment ri:filename="result-of-create-oslc-link.png" /></ac:image></p><h6 style="text-align: center;">The newly created OSLC hyperlink from copying the Requirement in the modeling tool's Containment tree.</h6>
````

<!--NOMAGIC_PAGE id=249568406 space=CDH version=2 -->
## PAGE 00326: Create DHTrace operation with OSLC links

- page_id: `249568406`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568406/Create+DHTrace+operation+with+OSLC+links
- version_number: 2
- version_date: `2025-11-20T11:33:10.632+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="eb70b979-0fa0-474c-8101-94279fb2a98e"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In addition to creating DHTrace, the <strong>Create DHTrace</strong> operation enables you to create OSLC links instead of using the <strong>Create OSLC link</strong> operation in earlier versions of Cameo DataHub 19.0.</p></ac:rich-text-body></ac:structured-macro><h3>Create DHTrace operation</h3><p>This DataHub operation does not copy data. It only creates a DHTrace link from a source to a target. When the source has any changes, the DHTrace link becomes <strong>Suspect</strong>.</p><p><br /></p><p>To create DHTrace</p><hr /><ol><li data-uuid="e6ed9678-f7b4-4269-bfe0-3d5961a9e228">From the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create_DHTrace.png" /></ac:image><br /><br /></li><li data-uuid="b2159a15-ab25-4481-9ffe-7b85ce37801a">Drag any nodes from <strong>DataHub Explorer</strong> to the MagicDraw Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="MD Tree for CreateDHTrace.png" /></ac:image><br /><br />The <strong>Create DHTrace Summary</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Create DHTrace Summary Dialog.png" /></ac:image><br /><br /></li><li data-uuid="9f5ab8de-ab72-4451-9520-15335b6d63ea">When you modify the source nodes, right-click one of them and select <strong>Check Changes</strong> &gt; <strong>Check DHTrace Changes</strong> or <strong>Check DHTrace Changes recursively</strong>. The <strong>DHTrace Summary</strong> dialog appears showing the <strong>Suspect</strong> status of the DHTrace links.<br /><br /><ac:image><ri:attachment ri:filename="DHTrace Summary.png" /></ac:image><br /><br /></li><li data-uuid="b928903f-c94a-4d35-84d5-69307d7d1abd">Select the checkboxes of the data nodes you want to clear the <strong>Suspect</strong> status in the <strong>DHTrace Summary</strong> dialog and click <strong>OK</strong>.</li></ol><h3>Creating OSLC links through the Create DHTrace operation</h3><p><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ad0ec783-712d-491a-8709-a013333b8cc6"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p>OSLC links can be created when you open an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source in DataHub.</p><p><br /></p><p>To create an OSLC link</p><hr /><ol><li data-uuid="3a02fe4f-307f-478f-8a98-40337791b57e">From the <strong>Operation</strong> drop-down list in <strong>DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.</li><li data-uuid="160f2d41-007a-4379-a597-603f4f0f0427"><p class="_mce_tagged_br" style="text-align: left;">From an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source, drag a node into the MagicDraw<sup>®</sup> Containment area.</p></li><li data-uuid="a3826cbc-439d-4b87-afbb-5ce397f3a84a"><p class="_mce_tagged_br" style="text-align: left;">A shortcut menu prompts you to choose the type of link. Select one from the shortcut menu. The link of the selected type will be created.<br /><br /></p><ac:image ac:align="left" ac:title="Figure OSLC Link types" ac:alt="Figure OSLC Link types"><ri:attachment ri:filename="worddav5a3754b972c5e28584dc28a2a6a5178a.png" /></ac:image></li></ol><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="worddav940b362d2a8553e7320fdc5b60af115c.png" /></ac:image></p><h6 style="text-align: center;">The newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree.</h6><p style="margin-left: 30.0px;text-align: center;"><ac:image ac:title="Properties of OSLC Link " ac:alt="Properties of OSLC Link "><ri:attachment ri:filename="worddavae7ad7197fdcea58505c68e4c441a7fb.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink's Properties.</h6><p style="margin-left: 30.0px;text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Hyperlink.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink is in the DH Links panel.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="1b6320c7-2300-457f-8b43-0c71989cb598"><ac:link><ri:page ri:content-title="Creating OSLC links" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568397 space=CDH version=2 -->
## PAGE 00327: Create Sync operation

- page_id: `249568397`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568397/Create+Sync+operation
- version_number: 2
- version_date: `2025-11-20T11:32:52.915+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer
- labels: []
...
3. The Create Sync Wizard will appear. Perform the Type/Attribute mapping as you would while using the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space=''] . [ATTACHMENT filename='CreateSync_Wizard.png']
...
````html
<p style="text-align: left;">The Create Sync operation is an addition to the list of Cameo DataHub operations. The Create Sync operation will recreate synchronization (DHLinks) if you lose or delete the DHLinks. Before, in order to recreate synchronization (DHLinks), if you lost or deleted the DHLinks you were required to copy the data from the Cameo DataHub to the modeling tool(Cameo) using the Copy Data with Sync operation. This new operation allows you to recreate synchronization(DHLinks) without replicating the data.<br /><br /></p><h6 style="text-align: center;"><ac:image><ri:attachment ri:filename="Same Data.png" /></ac:image><br /><br />The same data source exists in the Cameo DataHub Explorer panel and the Modelling tool without DHLinks</h6><p>To create sync between existing data</p><hr /><ol><li><span style="color:var(--ds-text,#333333);">From the<span> </span></span><strong>Operation</strong><span style="color:var(--ds-text,#333333);"> list in<span> the </span></span><strong>Cameo DataHub Explorer </strong>panel<span style="color:var(--ds-text,#333333);">, select<span> </span></span><strong>Create Sync</strong><span style="color:var(--ds-text,#333333);">.<br /><br /><ac:image><ri:attachment ri:filename="Create_Sync.png" /></ac:image><br /><br /></span></li><li>Drag the parent data set from the Cameo DataHub Explorer panel and drop it over the identical data set in the Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="Create Sync_Drag and Drop.png" /></ac:image><br /><br /></li><li>The Create Sync Wizard will appear. Perform the Type/Attribute mapping as you would while using the <ac:link><ri:page ri:content-title="Copy Data with Sync operation" /></ac:link>. <br /><br /><ac:image><ri:attachment ri:filename="CreateSync_Wizard.png" /></ac:image><br /><br /></li><li>Select the mapped type, then choose the <strong>Key attribute </strong>between them. The key attribute will be used to match the values. <br /><br /><ac:image ac:border="true"><ri:attachment ri:filename="CreateSync_Wizard_2.png" /></ac:image><br /><br /></li><li><p class="auto-cursor-target">Once matching results are displayed, do one or several of the following:</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="84e8ec61-84a7-462f-bb96-86b3924bc0e6"><ac:rich-text-body><p>The matching result displays the matched attributes in green(Sync relation created) and unmatched attributes in red(Sync relation not created).</p></ac:rich-text-body></ac:structured-macro><ul><li>If there are key attributes that do not match (highlighted in red) and you want them to be included, select the checkbox for the particular value and click <strong>Add Sync</strong>.</li><li>If there are key attributes that match and you do not want them to be included, select the checkbox for the particular value and click <strong>Remove Sync.</strong></li><li>If there are key attributes that do not match (highlighted in red)and you want them to be excluded, select the checkbox for the particular value and click <strong>Exclude</strong>.</li><li>Select <strong>Ignore</strong> <strong>all no sync source entities</strong> checkbox, if you want all nodes that did not match to be ignored. The synchronization will discover them later.</li><li>Select <strong>Exclude all no sync source entities </strong>checkbox, if you want all the nodes that did not match to be marked as Excluded. The synchronization will no longer include them in the operation.<br /><br /><ac:image><ri:attachment ri:filename="CreateSync_Wizard_3.png" /></ac:image><br /><br /></li></ul></li><li><p class="auto-cursor-target">Click <strong>Finish</strong>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="343eb2e6-cf3f-4c62-a8dd-4e2382a57e94"><ac:rich-text-body><p>Until every node is marked as synced or excluded, you cannot click <strong>Finish.</strong></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="CreateSync_Wizard_4.png" /></ac:image></p><p class="auto-cursor-target">Once the procedure is finished, the newly created synchronization will be visible as shown in the image below, denoted with the <strong>S </strong>icon.<br /><br /><ac:image><ri:attachment ri:filename="Sync_Done.png" /></ac:image></p></li></ol>
````

<!--NOMAGIC_PAGE id=249568554 space=CDH version=2 -->
## PAGE 00328: Creating a Stream and Baseline as a Data Source

- page_id: `249568554`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568554/Creating+a+Stream+and+Baseline+as+a+Data+Source
- version_number: 2
- version_date: `2025-11-20T11:35:20.690+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>A Component is a container in a project that you can use to organize artifacts. When connected with a DOORS Next Generation Data Source, DataHub lists Components under each project.  The main Data Source tree still displays artifacts from default Components. You can also open additional Components as another Data Source. Additionally, you can perform all DataHub operations, such as the main Data Source, from the Component Data Source.</p><p><span class="confluence-embedded-file-wrapper image-center-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Components Supported in Cameo DataHub.png" /></ac:image></span></p><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="Components in DOORS NG.png" /></ac:image></span></p><h6 style="text-align: center;">Components in DOORS Next Generation.</h6><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="Components in DOORS Next Generation.png" /></ac:image></span></p><h6 style="text-align: center;">Components in DOORS Next Generation in Cameo DataHub Explorer.</h6><p>You can now work with a Stream and Baseline by creating a new Data Source from components; thus, DOORS Next Generation projects can be connected to a specific Stream and Baseline.</p><p><br /></p><p>To create a Stream as a Data Source</p><hr /><ul><li>Right-click a Component element in DataHub Explorer and select <strong>Create Stream as Data Source</strong>.<br /><br /></li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Create Component or Stream as Data Source Command.png" /></ac:image></p><h6 style="text-align: center;">The Create Component/Stream as Data Source command.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="eb78f629-4d38-4d98-8a1d-deb7a74288e4"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>An Initial Stream is used when creating a Data Source for a Component without an additional Stream.</li><li>If the Component with Stream(s) other than the Initial Stream is selected, the <strong>Select stream</strong> list in the <strong>Create Stream as Data Source</strong> dialog box will appear.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Select_component or stream.png" /></ac:image></p><h6 style="text-align: center;">The Select stream list in the Create Stream as Data Source dialog.</h6></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Created Component Stream Data Source.png" /></ac:image></p><h6 style="text-align: center;">The created Stream Data Source.</h6><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target">To create a Baseline as a Data Source</p><hr /><ul><li>Right-click a Component element in DataHub Explorer and select <strong>Create Baseline as Data Source</strong>.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_creation.png" /></ac:image></p><h6 style="text-align: center;">The Create Baseline as Data Source command.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a2390e6c-6994-4b2b-8206-16616f4c6f4d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>An Initial Baseline is used when creating a Data Source for a Component without an additional Stream.</li><li>If the Component with Baseline(s) other than the Initial Stream is selected, the <strong>Select baseline </strong>list in the <strong>Create Baseline as Data Source</strong> dialog box will appear.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_selection.png" /></ac:image></p><h6 style="text-align: center;">The Select baseline list in the Create Baseline as Data Source dialog box.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target" style="text-align: center;"><br /></p><p class="auto-cursor-target" style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_created.png" /></ac:image></p><h6 style="text-align: center;">The created Baseline Data Source.</h6><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="0e94662f-8e68-4617-9160-846140545311"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>Components on the CDH Explorer panel and DNG side are only visible and available to use when the Configuration Management for selected projects is enabled.</li><li>The Stream and Baseline Data Source name is represented in the format of<em> &lt;Project Area name&gt;</em> | <em>&lt;Component name&gt;</em> | <em>&lt;Stream/Baseline name&gt;</em>.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568307 space=CDH version=2 -->
## PAGE 00329: Creating Alias

- page_id: `249568307`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568307/Creating+Alias
- version_number: 2
- version_date: `2025-11-20T11:31:58.607+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
- [CONFLUENCE_PAGE title='DataHub Alias Manager' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>To create <strong>Alias Explorer</strong></p><hr /><ul><li data-uuid="f79e191b-ca83-461a-8ae2-b2fe431cb0f1">Right-click a node that you want to create the selected scope and click <strong>Create Alias</strong>. The <strong>Alias Explorer</strong> tab opens, showing only the nodes in the scope that you have selected.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Create_Alias.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="5c46c153-b114-4de6-8714-46022676505d"><strong><ac:link><ri:page ri:content-title="DataHub Alias Manager" /></ac:link></strong></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568697 space=CDH version=3 -->
## PAGE 00330: Creating DHTrace links

- page_id: `249568697`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568697/Creating+DHTrace+links
- version_number: 3
- version_date: `2025-11-20T11:36:58.907+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Creating links between elements
- labels: []
...
````html
<p>DataHub links can create relationships between elements. The relationship determines how the elements react when one of the elements changes. You can use the MagicDraw shortcut menu to navigate to DHLinks.</p><p><br /></p><p>To navigate to DHLinks from the MagicDraw shortcut menu</p><hr /><ul><li>Right-click a node in the MagicDraw Containment tree. Select <strong>Go To</strong> &gt;<strong> DHLinks</strong>.</li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="MagicDraw Containment Tree context menu to navigate to DHLinks" ac:alt="MagicDraw Containment Tree context menu to navigate to DHLinks"><ri:attachment ri:filename="dh-go-to-dh-links.png" /></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=249568652 space=CDH version=2 -->
## PAGE 00333: Creating OSLC links

- page_id: `249568652`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568652/Creating+OSLC+links
- version_number: 2
- version_date: `2025-11-20T11:36:22.671+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []
...
You can create OSLC links and queries from an [CONFLUENCE_PAGE title='Adding IBM Rational DOORS Next Generation Data Sources' space='']IBM® Rational® DOORS® Next Generation Data Source in DataHub by using the **Create DHTrace** operation from the **Operation** drop-down list in **Cameo DataHub Explorer**.
...
When you copy the Doors Next Generation (DNG) datasource's requirements from the DataHub Explorer to the MagicDraw containment tree, the URI link is created automatically for those requirements with the type “self”. This "self" type link is needed for [CONFLUENCE_PAGE title='OSLC Preview' space=''], navigation, or other purposes.
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a56a9bc2-1c75-4b2d-8fde-0b7f76c04bea"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p class="confluence-link">You can create OSLC links and queries from an <ac:link><ri:page ri:content-title="Adding IBM Rational DOORS Next Generation Data Sources" /><ac:link-body>IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</ac:link-body></ac:link> in DataHub by using the <strong>Create DHTrace</strong> operation from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>.</p><p><br /></p><p>To create an OSLC Link</p><hr /><ol><li class="confluence-link">Open an <span class="confluence-link">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</span>.</li><li>From the <strong>Operation</strong> drop-down list in <strong>DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="CDH_Panel_Create_DHTrace.png" /></ac:image><br /><br /></li><li>From the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation data source, drag a node into the MagicDraw<sup>®</sup> Containment area.</li><li>There is a popup menu after dragging the node to the MagicDraw Containment area. Choose one type of link from the list that you want to create.<br /><br /><ac:image ac:title="Figure OSLC Link types" ac:alt="Figure OSLC Link types"><ri:attachment ri:filename="dh-link-types.png" /></ac:image><br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d127d1d5-cbff-4b8c-a7e7-c48f3fdfa28d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>When you copy the Doors Next Generation (DNG) datasource's requirements from the DataHub Explorer to the MagicDraw containment tree, the URI link is created automatically for those requirements with the type “self”. This &quot;self&quot; type link is needed for <ac:link><ri:page ri:content-title="OSLC Preview" /><ac:plain-text-link-body><![CDATA[previewing]]></ac:plain-text-link-body></ac:link>, navigation, or other purposes.</p></ac:rich-text-body></ac:structured-macro><p><span style="line-height: 1.4285715;"> </span></p><p><span style="line-height: 1.4285715;">The figures below show the newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree, OSLC hyperlinks' properties, and an OSLC hyperlink in the</span> <strong>DH Links</strong> panel respectively.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="OSLC hyperlinks in MagicDraw containment area" ac:alt="OSLC hyperlinks in MagicDraw containment area"><ri:attachment ri:filename="oslc-hyperlinks.png" /></ac:image></p><h6 style="text-align: center;"> The newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree.</h6><p style="text-align: center;margin-left: 30.0px;"><ac:image ac:title="Properties of OSLC Link " ac:alt="Properties of OSLC Link "><ri:attachment ri:filename="worddavae7ad7197fdcea58505c68e4c441a7fb.png" /></ac:image></p><h6 style="text-align: center;">The OSLC hyperlink's properties.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="OSLC Hyperlink.png" /></ac:image></p><h6 style="text-align: center;">An OSLC hyperlink in the DH Links panel.</h6>
````

<!--NOMAGIC_PAGE id=249568661 space=CDH version=2 -->
## PAGE 00334: Creating OSLC queries

- page_id: `249568661`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568661/Creating+OSLC+queries
- version_number: 2
- version_date: `2025-11-20T11:36:23.522+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []
...
````html
<p>There are two types of OSLC queries you can construct to query the DOORS<sup>®</sup> Next Generation artifacts repository - simple or basic query and advanced query based on SQL or SPARQL<em>. </em>You can find the details of OSLC queries and more examples of queries and their syntax on the <a class="external-link" style="line-height: 1.4285715;" href="http://open-services.net/" rel="nofollow">OSLC Specification website</a>.</p><p><br /></p><p>To create and run a simple or basic OSLC query</p><hr /><ol><li>Do one of the following</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Create OSLC Query</strong> from MagicDraw®.</li><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Create OSLC Query</strong> <ac:image><ri:attachment ri:filename="oslc-query-icon.png" /></ac:image> button.</li></ul></li></ul><p style="margin-left: 30.0px;">The <strong>OSLC Query Editor</strong> dialog opens.</p><p style="margin-left: 30.0px;"><ac:image ac:title="OSLC Query editor window" ac:alt="OSLC Query editor window"><ri:attachment ri:filename="oslc-query-editor-a.png" /></ac:image></p><p style="margin-left: 30.0px;">2. Fill out the information that you want to create the query to search for.</p><p style="margin-left: 30.0px;">3. Click <strong><ac:image><ri:attachment ri:filename="run-btn.png" /></ac:image></strong>. The results of the query, if any, appears below the <em>Type text to search</em> box.</p><p style="margin-left: 30.0px;"><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="d156c760-b22b-45db-a9e8-5fd0c8057a3f"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li>You can filter the search results of the query by using the <em>Type text to search</em> box.</li><li>You can click <ac:image><ri:attachment ri:filename="oslc-btn1.png" /></ac:image> to save the results in <strong>Alias Manager</strong>.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To create and run an advanced query</p><hr /><ol><li>Do one of the following</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Create OSLC Query</strong> from MagicDraw®.</li><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Create OSLC Query</strong> <ac:image><ri:attachment ri:filename="oslc-query-icon.png" /></ac:image> button.</li></ul></li></ul><p style="margin-left: 30.0px;">The <strong>OSLC Query Editor</strong> dialog opens.</p><p style="margin-left: 30.0px;"><ac:image ac:title="The OSLC advanced Query Editor tab" ac:alt="The OSLC advanced Query Editor tab"><ri:attachment ri:filename="datahub-oslc-query-editor.png" /></ac:image></p><p style="margin-left: 30.0px;">2. Click the <strong><ac:image><ri:attachment ri:filename="query-editor.png" /></ac:image></strong> tab. In the <strong>Query String</strong> box, type your query using the simple or basic query language, e.g., <em><span class="nolink">https://10.1.1.70:9443/rm/views?oslc.query=true</span></em> or using the SPARQL query language, e.g., <em><span class="external-link">https://host:port/bugs?oslc.select=dcterms:created,dcterms:creator{foaf:familyName}&amp;oslc.where=cm:severity=&quot;high<em><span class="external-link">&quot;</span></em></span></em>.</p><p style="margin-left: 30.0px;">3. Click <strong><ac:image><ri:attachment ri:filename="run-btn.png" /></ac:image></strong>. The results of the query, if any, appears below the <em>Type text to search</em> box.</p><p style="margin-left: 30.0px;"><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="af0338e8-0d8f-4cb1-b445-df64678c4cf5"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li>You can filter the search results of the query by using the <em>Type text to search</em> box.</li><li>You can click <ac:image><ri:attachment ri:filename="oslc-btn1.png" /></ac:image> to save the results in <strong>Alias Manager</strong>.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568115 space=CDH version=2 -->
## PAGE 00335: Creating OSLC Query operation

- page_id: `249568115`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568115/Creating+OSLC+Query+operation
- version_number: 2
- version_date: `2025-11-20T11:29:28.943+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>In OSLC, each artifact in the lifecycle, e.g., Requirements, Change Requests, or Test Cases, is identified by a URI. Each artifact in the lifecycle is an HTTP resource. Standard HTTP methods (GET, PUT, POST, DELETE) are used to interact with each artifact. When you look up a URI, OSLC queries provide useful information using the standards (RDF*, SPARQL). Each OSLC resource has an RDF representation. RDF/XML is mandatory and other representations such as JSON or HTML are common. OSLC lifecycle artifacts are linked by relationships, e.g., elaborates or elaborated, defined by URIs.</p><p>You can construct two types of OSLC queries to query an artifacts repository - simple or basic query and advanced query based on SQL or SPARQL. You can also find more information about OSLC queries on <a class="external-link" href="http://open-services.net/+" rel="nofollow">the OSLC Specification website</a>.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="1bba1d5a-ca10-4987-8b5e-181d8bc72b6d"><strong><ac:link><ri:page ri:content-title="Creating OSLC queries" /></ac:link></strong></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568216 space=CDH version=2 -->
## PAGE 00336: Customizing DataHub options

- page_id: `249568216`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568216/Customizing+DataHub+options
- version_number: 2
- version_date: `2025-11-20T11:31:07.658+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="79c5d464-e846-47f5-9784-96f13e36978d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>This customization applies for the entire DOORS Data Source. You cannot customize the node’s label for only some modules.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To customize the node’s label</p><hr /><ol><li>Right-click a DOORS Data Source and select <strong>Customize Module/Object label</strong>.<br /><br /><ac:image><ri:attachment ri:filename="6.png" /></ac:image><br /><br /></li><li><p class="auto-cursor-target">The <strong>Customize label</strong> dialog opens. Enter the name of property that you want to display for the module and object by placing the property name inside quotation marks. You can append more properties or add some text, e.g., <em>“Object Identifier”::”Object Heading</em>”. Click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="customlabel02.png" /></ac:image></p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="customlabel03.png" /></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="14daf86b-d10f-46f0-b683-8de8bbfeab9d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>When you edit the node’s label, you must reload the tree in <strong>DataHub Explorer</strong>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=249568525 space=CDH version=2 -->
## PAGE 00338: Customizing module and object labels in DataHub Explorer

- page_id: `249568525`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568525/Customizing+module+and+object+labels+in+DataHub+Explorer
- version_number: 2
- version_date: `2025-11-20T11:35:04.983+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS
- labels: []
...
<!--NOMAGIC_PAGE id=249568063 space=CDH version=2 -->
## PAGE 00340: Data copying progress bar

- page_id: `249568063`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568063/Data+copying+progress+bar
- version_number: 2
- version_date: `2025-11-20T11:27:26.430+01:00`
...
````html
<p>When copying data, DataHub shows the progress through its progress bar.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Copy progress bar" ac:alt="DataHub Copy progress bar"><ri:attachment ri:filename="data-copy-progress-bar.png" /></ac:image></p><h6 style="text-align: center;"> The progress bar when DataHub copies data.</h6>
````

<!--NOMAGIC_PAGE id=249568880 space=CDH version=2 -->
## PAGE 00341: Data Source synchronization

- page_id: `249568880`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568880/Data+Source+synchronization
- version_number: 2
- version_date: `2025-11-20T11:40:57.378+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Data Sources on Teamwork Cloud are projects accessible to all users who have credentials to the network. Therefore, <strong>Teamwork Cloud Data Sources</strong> are actually projects stored in Teamwork Cloud. A <strong>Teamwork Cloud project</strong> may be accessible to more than one client.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3f62e555-d0c2-4821-a858-1e379affc3c7" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568124 space=CDH version=2 -->
## PAGE 00343: Data Synchronization

- page_id: `249568124`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568124/Data+Synchronization
- version_number: 2
- version_date: `2025-11-20T11:29:36.761+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>An alias can be created from any nodes or Data Source. DataHub <ac:link><ri:page ri:content-title="Alias Manager" /><ac:link-body><strong>Alias Manager</strong></ac:link-body></ac:link> stores all available aliases, and they can be either accessed or removed from there.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><p><strong><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="dc640d2e-5976-4968-95e1-db163f3bbc3e"><ac:parameter ac:name="excerptType">simple</ac:parameter></ac:structured-macro></strong></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568311 space=CDH version=2 -->
## PAGE 00345: DataHub Alias Manager

- page_id: `249568311`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568311/DataHub+Alias+Manager
- version_number: 2
- version_date: `2025-11-20T11:32:00.627+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>After installing Cameo DataHub, you can begin to add Data Sources. Data Sources can be added for the following requirements management systems</p><ul><li data-uuid="97e311bd-3f02-407c-83f0-6d375ded8d64">IBM DOORS</li><li data-uuid="b8ad20ec-4a70-4f89-af16-4f7b40259d4c">IBM DOORS Next Generation</li><li data-uuid="b48803b6-3a6e-4cd1-91ee-a91791f1590a">CSV Files</li></ul><p>Once you have the Data Sources in DataHub open, you can start using more advanced DataHub features, e.g., copying data and DHLink relations between Data Sources. The synchronization features of DataHub are also illustrated in this chapter.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="d3d3c6cd-463e-4172-89e0-623c37fcd0a3" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249567956 space=CDH version=2 -->
## PAGE 00347: DataHub Explorer buttons and icons

- page_id: `249567956`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567956/DataHub+Explorer+buttons+and+icons
- version_number: 2
- version_date: `2025-11-20T11:24:26.182+01:00`
...
````html
<p><span style="color:var(--ds-text,#333333);">The following table lists the icons in the <strong>DataHub Explorer</strong> tab.<br /> </span></p><table class="relative-table" style="width: 99.9434%;"><colgroup><col style="width: 4.86219%;" /><col style="width: 17.9848%;" /><col style="width: 77.2406%;" /></colgroup><tbody><tr><th>Icon</th><th>Name</th><th>Description</th></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="datahub.gif" /></ac:image></td><td><ac:inline-comment-marker ac:ref="e01ff494-dd00-4c24-8631-ba510086a80f">Cameo DataHub</ac:inline-comment-marker></td><td>The DataHub root.</td></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="magicdraw_driver.gif" /></ac:image></td><td>MagicDraw® Driver</td><td>The MagicDraw<sup>®</sup> driver to connect to a MagicDraw<sup>®</sup> project.</td></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="driver.png" /></ac:image></td><td>Drivers</td><td><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">The drivers to connect to the other tools </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">(</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">CSV</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation).</ac:inline-comment-marker></td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-toggle-btn.png" /></ac:image></td><td colspan="1">Toggle showing only <br />connected Data Sources</td><td colspan="1">Hides all disconnected Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="toggle-data-sources-icon.png" /></ac:image></td><td colspan="1">Toggle showing all Data Sources</td><td colspan="1">Displays all Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-add-ds-btn.png" /></ac:image></td><td colspan="1">Add Data Source button</td><td colspan="1">Opens the <strong>Add Data Source</strong> dialog.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-btn-4.png" /></ac:image></td><td colspan="1">Synchronize button</td><td colspan="1">Starts the synchronization process.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-disconnected-ds-btn.png" /></ac:image></td><td colspan="1">Disconnected Data Source</td><td colspan="1"><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">The Data Source (of MagicDraw<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, or a CSV file) disconnected from </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">its source.</ac:inline-comment-marker></td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="folder.gif" /></ac:image></td><td colspan="1">Folder, Package</td><td colspan="1">A folder or a Package.</td></tr><tr><td rowspan="2"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="link.png" /></ac:image></td><td colspan="1">DOORS Link</td><td colspan="1">A link in the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> application.</td></tr><tr><td colspan="1">MagicDraw<sup>®</sup> relationship</td><td colspan="1">A link in the MagicDraw<sup>®</sup> application.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="ex.gif" /></ac:image></td><td colspan="1">Item</td><td colspan="1">Any items, e.g., an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> object, MagicDraw<sup>®</sup> element, or CSV item.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-oslc-query-icon.png" /></ac:image></td><td colspan="1">Create OSLC Query <br />button</td><td colspan="1">Opens the <strong>OSLC Query Editor</strong> dialog, allowing you to perform basic and advanced queries to an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source. This becomes enabled when you add an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source.</td></tr><tr><td colspan="1"><ac:image ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-trash-icon.png" /></ac:image></td><td colspan="1">DataHub explorer Trash <br />Icon</td><td colspan="1">Deletes an item when the item is dragged onto the icon. A confirmation dialog appears before deleting the item.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=249567946 space=CDH version=2 -->
## PAGE 00348: DataHub Explorer tab

- page_id: `249567946`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567946/DataHub+Explorer+tab
- version_number: 2
- version_date: `2025-11-20T11:23:45.873+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The <strong>DataHub Explorer</strong> tab has toolbar options for the following actions</p><ul><li data-uuid="9d1c5f89-3d39-49b1-a33e-2af23b5004ef">Add a new Data Source</li><li data-uuid="418523ee-bdd3-4dac-9dda-9d6d5327163f">Close a Data Source</li><li data-uuid="47a67390-968e-4c30-8ac5-842f4d1e34c0">Open a Data Source</li><li data-uuid="6355ceb4-6147-4828-8832-9b56370818c7">Filter inactive Data Source</li><li data-uuid="ec90cc3f-ea72-4223-aec0-71fb4fe17197">Create OSLC query</li><li data-uuid="4a279499-0bda-4bba-9b10-566d8b66e5b9">Work with data in the tree</li><li data-uuid="7c2fadf6-8146-43c7-9cb3-a6280d1ddf14">Search for items</li></ul><p>You can use <strong>DataHub Explorer toolbar</strong> buttons and shortcut menu items to connect, add, or remove Data Sources. You can also use it to view drivers, Data Sources, and items of the connected Data Sources in the DataHub tree. You can also apply a filter to display only the connected Data Sources in DataHub Explorer.</p><p><br />To open DataHub Explorer</p><hr /><ol><li data-uuid="1b3de78b-b351-474d-a18e-178798be93ce">Start MagicDraw® and open an existing project or start a new one.</li><li data-uuid="4c41e733-03b3-4288-9deb-32dbd1b78d6c">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /><br /><ac:image ac:title="The DataHub Explorer Tab" ac:alt="The DataHub Explorer Tab"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></li></ol><p><br /></p><p>The <strong>DataHub Explorer</strong> tab contains the following</p><ul><li style="list-style-type: none;background-image: none;" data-uuid="363ba74b-4422-4711-96e9-512a6fc875bd"><ul><li><strong>Operation</strong> drop-down list</li><li>Tree of Data Sources</li><li>Explorer buttons and icons</li><li>Text search box</li></ul></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="7340f42d-dbd3-4040-97d4-dab2d6e6ebbe" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249567934 space=CDH version=1 -->
## PAGE 00349: DataHub menu

- page_id: `249567934`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567934/DataHub+menu
- version_number: 1
- version_date: `2019-10-31T13:26:06.467+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="c81d1ebf-2177-462e-8a25-a47bf805ff29"><ac:parameter ac:name="id">138587489</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="30f73030-dbb5-4fb9-a9e6-b1f1c174ac79"><ac:parameter ac:name="id">138587491</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="a6c935de-8c93-4e2c-88b9-e2ebf45f1aa5"><ac:parameter ac:name="id">138587490</ac:parameter><ac:rich-text-body><p>To access the DataHub menu, you need to start MagicDraw<sup>®</sup> and open a new or existing project.</p><p><br />To open the DataHub menu in MagicDraw<sup>®</sup></p><hr /><ul><li><p>From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong>. The DataHub menu items open.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="1.png" /></ac:image></p></li></ul><h6 style="text-align: center;">DataHub menu items.</h6><p>The table below explains the functions of the DataHub menu items.</p><table class="relative-table" style="width: 96.6548%;"><colgroup><col style="width: 23.9175%;" /><col style="width: 76.0779%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><th><p>Name</p></th><th><p> Function</p></th></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td>Synchronize updates to Data Source</td><td>Synchronizes the node if there are any pending changes. Otherwise, does nothing.</td></tr><tr style="margin-left: 30.0px;"><td>DataHub Explorer</td><td>Opens the <strong>DataHub Explorer</strong> tab.</td></tr><tr style="margin-left: 30.0px;"><td>DHLink Panel</td><td><p>Opens the <strong>DHLink Panel</strong></p></td></tr><tr style="margin-left: 30.0px;"><td colspan="1">DHLink Summary</td><td colspan="1">Opens the <strong>DHLink Summary</strong> dialog</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Schema Map Manager</td><td colspan="1">Opens the <strong>Schema Map Manager</strong> dialog</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Alias Manager</td><td colspan="1">Opens the <strong>Alias Manager</strong> dialog</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Remove non-use DHLink</td><td colspan="1">Opens the <strong>Remove DHLinks Confirmation</strong> dialog to remove DHLinks that are not in the project.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Migrate DataHub</td><td colspan="1">Opens the <strong>Cameo DataHub Migration</strong> dialog. Data from older versions of DataHub are migrated to the latest version of DataHub.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Driver Deployment</td><td colspan="1">Opens the <strong>Driver Deployment</strong> dialog</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Create OSLC Query</td><td colspan="1">Opens the <strong>OSLC Query Editor</strong> dialog</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Actions</td><td colspan="1">Opens the <strong>Actions</strong> menu</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">3rd Party Libraries Info</td><td colspan="1">Opens the <strong>3rd Party Libraries Info</strong> dialog.</td></tr></tbody></table><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="72999da0-7dd9-46aa-9056-69f38eeeb619"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p><span><span>Some of the DataHub menu items may be disabled if those items are not applicable in the current context. For example, the </span><strong>Create OSLC query</strong><span> menu item is enabled only when you have an</span><strong> IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation</strong><span> Data Source open.</span></span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target" style="text-align: center;"><ac:image><ri:attachment ri:filename="DataHub Action Menu.png" /></ac:image></p><h6 style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"> DataHub Actions menu items.</span></h6><p><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size">The table below explains the functions of the DataHub Actions menu items.<br /></span></p><table class="relative-table" style="width: 93.5437%;"><colgroup><col style="width: 19.962%;" /><col style="width: 80.0333%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><th><p>Name</p></th><th><p>Function</p></th></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td><strong>Add Data Source</strong></td><td>Opens the <strong>Add Data Source</strong> dialog.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Connect</strong></td><td>Connects to the selected Data Source.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Close Data Source</strong></td><td>Closes a Data Source.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Save</strong></td><td colspan="1">Saves changes to a Data Source.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Remove Data Source</strong></td><td colspan="1">Removes a Data Source from the DataHub Explorer instances.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>New Node</strong></td><td colspan="1">Adds a new node under the selected node or Data Source.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Delete Node</strong></td><td colspan="1">Removes the selected node.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Reload</strong></td><td colspan="1">Reloads all properties and items on the selected item and sub-items.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Select in Application</strong></td><td colspan="1">Selects the selected node in its original application.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Go to the Other Related Link</strong></td><td colspan="1">Goes to a related linked item (within DataHub Explorer).</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Check Changes</strong></td><td colspan="1"><p>Reviews all nodes that have been changed or edited without synchronizing them. The <strong>Check Changes</strong> menu has four sub-menus</p><ul><li><strong>Check DHLink Changes</strong>: <br />Views the changes in DHLinks only in the selected node.</li><li><strong>Check DHLink Changes Recursively</strong>: <br />Views the changes in DHLinks in both the selected node and its children.</li><li><p><strong>Check DHTrace Changes</strong>: <br />Determines trace changes in the selected node.</p></li><li><p><strong>Check DHTrace Changes Recursively</strong>: <br />Determines changes in trace links in the selected node and its children.</p></li></ul></td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Synchronize</strong></td><td colspan="1"><p>Sends data updates from the selected Data Source to all of the related items in other tools. This option performs data synchronization for<strong> DHLinks</strong> only, but <strong>DHTraces</strong> are not synchronized. The <strong>Synchronize</strong> menu contains two sub-menus</p><ul><li><strong>Synchronize Node</strong>: <br />Synchronizes data only in the selected node.</li><li><strong>Synchronize Node Recursively</strong>: <br />Synchronizes data under the selected node and all its child nodes.</li></ul></td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Update DHLinks</strong></td><td colspan="1">Updates pending updates and pending delete <strong>DHLinks</strong>. This menu item has four sub-menu items<ul><li><strong>Update Pending DHLinks</strong>:<br />Updates pending DHLinks in a single node.</li><li><strong>Update Pending DHLinks Recursively</strong>:<br />Updates pending DHLinks across a node and its children.</li><li><strong>Clear Suspect DHTraces</strong>:<br />Clears suspect DHLinks in a single node.</li><li><strong>Clear Suspect DHTraces Recursively</strong>:<br />Clears suspect DHLinks across a node and its children.</li></ul></td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Remove DHLinks</strong></td><td colspan="1">Removes all the <strong>DHLink</strong> information from the selected node. This menu item has four sub-menu items<ul><li><strong>Remove DHLinks</strong>: <br />Removes all DHLinks from a single node.</li><li><strong>Remove DHLinks Recursively</strong>: <br />Removes all DHLinks from a node as well as all its children.</li><li><strong>Remove DHTrace</strong>: <br />Removes all DHTrace links from a node.</li><li><strong>Remove DHTrace Recursively</strong>: <br />Removes all DHTrace links from a node and all its children.</li></ul></td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Create Alias</strong></td><td colspan="1">Creates an alias for the selected node and adds it to Alias Manager.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Properties</strong></td><td colspan="1">Opens the <strong>Cameo DataHub Properties</strong> tab and <strong>DH Links</strong> panel for the selected node.</td></tr></tbody></table><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="e6e816c4-f592-4d79-a05f-4e4874943ad0"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><p>Removing a Data Source deletes all of its mappings and DHLinks.</p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="db3a16f2-76ec-4536-9ce0-97e4b6afecd7"><ac:parameter ac:name="id">138587487</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f6d92cfb-4eb0-4ad2-b182-63e5357d7bb9" /></p><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=249568088 space=CDH version=2 -->
## PAGE 00350: DataHub Operation drop-down list

- page_id: `249568088`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568088/DataHub+Operation+drop-down+list
- version_number: 2
- version_date: `2025-11-20T11:28:26.506+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b3fae4ab-4342-4d4e-abf5-0656390a1ebd"><ac:parameter ac:name="page">Operations in DataHub Explorer</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name="retain-block-width">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:content-title="Operations in DataHub Explorer" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=249567972 space=CDH version=2 -->
## PAGE 00351: DataHub Properties tab

- page_id: `249567972`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567972/DataHub+Properties+tab
- version_number: 2
- version_date: `2025-11-20T11:24:27.504+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<p>The <strong style="line-height: 1.4285715;">DataHub Properties</strong> tab shows the properties (names and values) and associations of a selected node in DataHub Explorer that you can edit and save their value. You can also open, update, or delete the following items in the <strong style="line-height: 1.4285715;">DataHub Properties </strong>tab. </p><ul><li>MagicDraw<sup>®</sup> elements</li><li>DOORS objects and modules</li><li>CSV items</li><li>IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Artifacts</li></ul><p><br /></p><p>To open the <strong>DataHub Properties</strong> tab in MagicDraw®, do one of the following</p><hr /><ul><li>Right-click a node in DataHub Explorer and click <strong>Properties</strong>.</li><li>Double-click a node in DataHub Explorer.<br /><br />The <strong>DataHub Properties</strong> tab opens in MagicDraw<sup>®</sup>, and the properties of the selected item are displayed.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="dh-properties-tab.png" /></ac:image><br /><span style="color:var(--ds-background-accent-gray-bolder,#626f86);"> </span></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d31614a8-1844-44ae-b9a2-5da7206f8cb8"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The <strong>DH Links </strong>panel opens when the <strong>DataHub Properties</strong> tab is open.</li><li>Read-only and multi-valued properties cannot be edited. However, you can edit multi-valued properties through the Specifications window.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>The table below explains the function of each icon in the <strong>DataHub Properties</strong> tab in MagicDraw<sup>®</sup>.</p><table class="relative-table wrapped" style="margin-left: 30.0px;width: 96.4116%;"><colgroup><col style="width: 4.71616%;" /><col style="width: 16.6754%;" /><col style="width: 78.6376%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Icon</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Name</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Function</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - categorized view.png" /></ac:image></div></td><td style="margin-left: 30.0px;"><strong>Categorized View</strong></td><td style="margin-left: 30.0px;">Shows all property names by category.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="29"><ri:attachment ri:filename="Properties - alphabetical view.png" /></ac:image></div></td><td style="margin-left: 30.0px;"><strong>Alphabetical View</strong></td><td style="margin-left: 30.0px;">Shows all property names in an alphabetical order.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - show description.png" /></ac:image></div></td><td style="margin-left: 30.0px;"><strong>Show Description</strong></td><td style="margin-left: 30.0px;">Shows description of each property.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><div class="content-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - expand.png" /></ac:image></div></td><td style="margin-left: 30.0px;" colspan="1"><strong>Expand</strong></td><td style="margin-left: 30.0px;" colspan="1"><p>Shows all property names and values.</p></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><div class="content-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - collapse.png" /></ac:image></div></td><td style="margin-left: 30.0px;" colspan="1"><strong>Collapse</strong></td><td style="margin-left: 30.0px;" colspan="1">Hides all property names and values.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - save.png" /></ac:image></div></td><td style="margin-left: 30.0px;" colspan="1"><strong>Save</strong></td><td style="margin-left: 30.0px;" colspan="1">Saves changes made to a property name or value. The button is enabled when the value of the property changes.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249567954 space=CDH version=2 -->
## PAGE 00352: DataHub tree

- page_id: `249567954`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567954/DataHub+tree
- version_number: 2
- version_date: `2025-11-20T11:24:21.964+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > DataHub Explorer tab
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub tree is composed of nodes, each of which represents either a node or a connected Data Source. Data in the DataHub tree are arranged hierarchically in a tree structure. It represents all the data that DataHub contains at that time.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DataHub Tree.png" /></ac:image></p><h6 style="text-align: center;">The DataHub tree.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="740635e2-439a-45f2-8056-f14e7dd6a6c5"><ac:link><ri:page ri:content-title="Data Source synchronization" /></ac:link></li><li data-uuid="9b0187e7-506c-4d11-b512-33165cb018e6"><ac:link><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /><ac:plain-text-link-body><![CDATA[Displaying MagicDraw Data Sources]]></ac:plain-text-link-body></ac:link></li><li data-uuid="4091e67c-75a6-44ea-90b0-b3e1758c3d00"><ac:link><ri:page ri:content-title="Removing a Data Source" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568766 space=CDH version=6 -->
## PAGE 00353: Define Target Type from Attribute Value dialog and mapping

- page_id: `249568766`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568766/Define+Target+Type+from+Attribute+Value+dialog+and+mapping
- version_number: 6
- version_date: `2025-11-20T11:37:23.418+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping > Schema mapping modes
- labels: []
...
````html
<p><span style="color:var(--ds-text,#333333);">The </span><strong>Define Target Type from Attribute Value</strong><span style="color:var(--ds-text,#333333);"> mapping mode is the capability of specifying or defining type of nodes to map in the target by using a node’s attribute value in the source as the condition. This mode is available in the </span><strong style="font-size: 14.0px;line-height: 1.42857;color:var(--ds-text,#333333);">Copy Data</strong><span style="color:var(--ds-text,#333333);"> dialog, <strong>Copy Data with Sync</strong><span style="color:var(--ds-text,#333333);"> dialog</span>, and <strong>Copy Data</strong><span style="color:var(--ds-text,#333333);"><strong> with DHTrace</strong> dialog</span> for the <strong>Group Type Mapping</strong> option. The </span><strong>Define Target Type from Attribute Value</strong><span style="color:var(--ds-text,#333333);"> mapping mode makes it possible to select the attribute’s values of a node and map them to multiple target types.</span></p><p><span style="color:var(--ds-text,#333333);"> </span></p><h6 style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Define Target Type for Group Mapping.png" /></ac:image>The Define Target Type from Attribute Value option in the Copy Data with Sync Dialog.</h6>
````

<!--NOMAGIC_PAGE id=249568976 space=CDH version=3 -->
## PAGE 00355: Defining a target type from an attribute value

- page_id: `249568976`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568976/Defining+a+target+type+from+an+attribute+value
- version_number: 3
- version_date: `2025-11-20T11:41:41.861+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The functionality of synchronization has been additionally simplified with the use of the <strong>Define Target Type from Attribute Value</strong> option. The synchronization does not limit only to a simple type-to type-mapping and attribute-to-attribute mapping but also a target node type can be defined dynamically according to a specified attribute value.</p><p><br /></p><p>To copy data and define a target node type from an attribute value</p><hr /><ol><li data-uuid="1079240e-88d7-4357-b0bc-6f75d167dd4c">From the Operation drop-down list in DataHub Explorer, select one of the DataHub operations to copy data. The Copy Data with Sync dialog (depending on the operation you have selected) opens.</li><li data-uuid="0ba1c58b-085d-4290-8798-44d03ccdd5e4">From the <strong>Mapping Mode</strong> option, select <strong>Group Type Mapping</strong>.<br /><br /><ac:image ac:title="Copy Data with Sync in Group Type Mapping " ac:alt="Copy Data with Sync in Group Type Mapping "><ri:attachment ri:filename="set-as-default-target-type.png" /></ac:image><br /><br /></li><li data-uuid="f6a13782-39d4-4547-99cf-7534cf1afd22">Select a source node type to start mapping.</li><li data-uuid="533a55d5-de73-46c4-86c6-e96810a91c90">Select the <strong>Define Target Type from Attribute Value</strong> check box.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping.png" /></ac:image><br /><br /></li><li data-uuid="b00a297a-af14-4e54-8cba-43fc155db6c2">From the <strong>Attribute</strong> drop-down list, choose an attribute to define a target node type.</li><li data-uuid="bb0d8346-46f8-4030-87cf-286e647540e8"><p class="auto-cursor-target">Specify the attribute value to do the mapping.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="307eb3bc-f78b-4130-9353-ece0cc9e69b0"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>If the attribute is <strong>Enumeration</strong>, you can select a value from the <strong>Value</strong> drop-down list for each attribute.<br /><br /><ac:image><ri:attachment ri:filename="Selecting Value from Name Attribute.png" /></ac:image><br /><br /></li><li>If the attribute is a simple data type, you can type any expected value in the <strong>Value</strong> box.</li></ul></ac:rich-text-body></ac:structured-macro></li><li data-uuid="36007039-7a37-4713-93b1-f818c2a1e142">From the target type box on the right-hand side of the source type box, choose a target node type for that value.</li><li data-uuid="84e1b71f-04cc-44c1-b66c-437aa8f96b0a">Continue mapping the attributes.</li><li data-uuid="63d1a37a-f77d-4a20-b8b5-10db2a60a595">If you have more values for mapping, click <ac:image><ri:attachment ri:filename="add-btn2.png" /></ac:image> to enter more values for mapping.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping End - Edited.png" /></ac:image><br /><br /></li><li data-uuid="3d2b7998-5b15-435a-80b1-a258f8dadee5">Repeat Steps 5 to 9 to map each attribute value.</li><li data-uuid="b3139179-7ce7-4320-8ae0-f6efd32b866f">When you finish mapping each attribute value, click <strong>OK</strong> to start copying.<br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="661cd26c-c59e-4110-b077-6b60922bbe9b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="a894afec-25fa-42c7-ad67-cec807c01bd3">The functionality to map between<strong> </strong>Attribute value and Target type is available only in Group Type Mapping.</li><li data-uuid="6fab327d-390b-4d4f-a157-c04b01742fcf">At least 2 values must be identified for mapping.</li><li data-uuid="f16be67e-eeaa-4d16-aea9-1cf27b227afb">You can edit or deactivate the mapping in the <a href="https://docs.nomagic.com/display/CDH/Mapping+with+Schema+Map+Manager">Schema Map Manager</a> dialog.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="d52b1a0b-0188-496e-a0dc-732e01377382"><a href="https://docs.nomagic.com/display/CDH/Mapping+with+Schema+Map+Manager">Mapping with Schema Map Manager</a></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568791 space=CDH version=2 -->
## PAGE 00356: Deleting a schema map

- page_id: `249568791`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568791/Deleting+a+schema+map
- version_number: 2
- version_date: `2025-11-20T11:37:35.099+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []

### NORMALIZED CONTENT

If a schema map is referenced by a DHLink, it cannot be deleted. You can delete only schema maps that are not referenced by any DHLinks. Deleting aDefine Target Type from the Attribute Value mapped schema deletes all defined target types. If you want to delete only some values of the schema, you can delete them in the[CONFLUENCE_PAGE title='Define Target Type from Attribute Value dialog and mapping' space=''] dialog.

To delete an existing schema map

1. Open the Cameo DataHub [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space=''] dialog.
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
````html
<p><span style="color:var(--ds-text,#333333);">If a schema map is referenced by a DHLink, it cannot be deleted. You can delete only schema maps that are not referenced by any DHLinks. Deleting a </span><span style="color:var(--ds-text,#333333);"> Define Target Type from the Attribute Value mapped schema deletes all defined target types. If you want to delete only some values of the schema, you can delete them in the </span><span><ac:link><ri:page ri:content-title="Define Target Type from Attribute Value dialog and mapping" /><ac:plain-text-link-body><![CDATA[Define Target Type from Attribute Value]]></ac:plain-text-link-body></ac:link> dialog.<br /></span></p><p><span style="color:var(--ds-text,#333333);"> </span></p><p>To delete an existing schema map</p><hr /><ol><li>Open the Cameo DataHub <ac:link><ri:page ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Schema Map Manager]]></ac:plain-text-link-body></ac:link> dialog. </li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Click <strong>Delete</strong>. A confirmation dialog box to confirm the deletion opens. Click <strong>Yes</strong>.</li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Schema_Map_Manager_Delete.png" /></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="bc7e74f4-3315-4de8-91fe-e9a9dde36a79"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If you delete a schema map that is currently in use, an error message opens, showing that one or more relations are using the deleted schema map. Therefore, you must delete the relations first, and then delete the schema map.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568285 space=CDH version=2 -->
## PAGE 00357: Deleting Requirements

- page_id: `249568285`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568285/Deleting+Requirements
- version_number: 2
- version_date: `2025-11-20T11:31:38.381+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To delete a Requirement from the <strong>DataHub Explorer</strong> tree, do one of the following</p><hr /><ul><li>Right-click the node you want to delete and select <strong><ac:image><ri:attachment ri:filename="delete-node.png" /></ac:image></strong>.</li><li>Drag the node onto the <strong>DataHub Explorer</strong><ac:image><ri:attachment ri:filename="dh-trash-icon.png" /></ac:image><strong>Trash</strong> icon.</li></ul><p>A confirmation dialog asking you to confirm the deletion opens. Click <strong>OK</strong>.</p>
````

<!--NOMAGIC_PAGE id=249567980 space=CDH version=2 -->
## PAGE 00358: DH Links panel

- page_id: `249567980`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567980/DH+Links+panel
- version_number: 2
- version_date: `2025-11-20T11:24:28.705+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
- From the MagicDraw main menu, click Tools > DataHub > DHLink Panel . The DH Links panel opens. [ATTACHMENT filename='DH Link Panel.png']
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><span style="color:var(--ds-text,#333333);">Information about links between elements is arranged in a tabular form in the </span><strong>DH Links</strong><span style="color:var(--ds-text,#333333);"> panel. This tab shows the detail of all the links you have added to items from the </span>DataHub<strong> Operation </strong>drop-down list<span style="color:var(--ds-text,#333333);">.</span></p><p><strong>DHLink</strong> maintains synchronization between source and target elements, either bidirectional or unidirectional.</p><p><br /></p><p>To open the <strong>DH Links </strong>panel in MagicDraw<sup>®</sup></p><hr /><ul><li>From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt;<strong> DHLink Panel</strong>. The <strong>DH Links </strong>panel opens.<br /><br /><ac:image><ri:attachment ri:filename="DH Link Panel.png" /></ac:image></li></ul><p><br /></p><p>The <strong>DH Links</strong> panel contains icons and a table. Each node in the table has a <ac:link><ri:page ri:content-title="DH Links panel shortcut menu and Sync Status icons" /><ac:plain-text-link-body><![CDATA[shortcut menu]]></ac:plain-text-link-body></ac:link> called the Actions menu that helps you manage the node and its relations.</p><p>The following table provides the description of each column in the table in the <strong>DH Links</strong> panel.</p><table class="relative-table wrapped"><colgroup><col style="width: 34.4722%;" /><col style="width: 65.5587%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><th><p>Value</p></th><th><p>Description</p></th></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td>Data Source and its driver name (MagicDraw)</td><td>The name of the Data Source in MagicDraw.</td></tr><tr style="margin-left: 30.0px;"><td>Direction</td><td>The direction of DHLink synchronization.</td></tr><tr style="margin-left: 30.0px;"><td>Data Source and its driver name (other drivers)</td><td>The name and the driver of the Data Source.</td></tr><tr style="margin-left: 30.0px;"><td colspan="1">Status</td><td colspan="1">The status of the node (<strong>Modified</strong>, <strong>Moved</strong>, <strong>Deleted</strong> or <strong>Synchronized</strong>).</td></tr><tr style="margin-left: 30.0px;"><td colspan="1"><strong>Property</strong> button</td><td colspan="1"><div class="content-wrapper"><p>Contains the <strong>Property</strong> <ac:image><ri:attachment ri:filename="property-btn.png" /></ac:image>button that opens up the node’s properties panel.</p></div></td></tr></tbody></table><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="042fa1a5-124e-4cb0-800a-e4c526fc2a25"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><p>You can click the <strong>Property <ac:image><ri:attachment ri:filename="property-btn.png" /></ac:image></strong> button to see more details of the target node.</p></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="6da1ab14-1fe8-4f6a-ae37-71b23d2dd0b8" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249567994 space=CDH version=3 -->
## PAGE 00359: DH Links panel shortcut menu and Sync Status icons

- page_id: `249567994`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567994/DH+Links+panel+shortcut+menu+and+Sync+Status+icons
- version_number: 3
- version_date: `2025-11-20T11:24:29.934+01:00`
...
| Command | Function |
| --- | --- |
| Select node in Containment tree | Selects the element in the MagicDraw Containment tree. |
| Select Modeling Tool node in Cameo DataHub Panel | Selects the MagicDraw node in DataHub/Alias Explorer. |
| Select node in external application | Selects the node in the original application, e.g., the node originally from DOORS will be opened in the DOORS client application. |
| Select Data Source node in Cameo DataHub Panel | Selects the node from other Data Sources, e.g., DOORS, in DataHub/Alias Explorer. |
...
````html
<p>You can right-click an item in the table in the <strong>DH Links</strong> panel to open a shortcut menu. This shortcut menu allows you to execute specific operations on a node in the panel.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DH Link Panel.png" /></ac:image></p><h6 style="text-align: center;">The Shortcut menu in the table in the DH Links panel.</h6><p>The table below explains the functions of the <strong>DH Links </strong>panel shortcut menu.</p><table class="relative-table" style="width: 99.9444%;"><colgroup><col style="width: 32.9073%;" /><col style="width: 67.1242%;" /></colgroup><tbody><tr><th>Command</th><th>Function</th></tr><tr><td colspan="1">Select node in Containment tree</td><td colspan="1">Selects the element in the MagicDraw Containment tree.</td></tr><tr><td colspan="1">Select Modeling Tool node in Cameo DataHub Panel</td><td colspan="1">Selects the MagicDraw node in <strong>DataHub/Alias Explorer</strong>.</td></tr><tr><td colspan="1">Select node in external application</td><td colspan="1">Selects the node in the original application, e.g., the node originally from DOORS will be opened in the DOORS client application.</td></tr><tr><td colspan="1">Select Data Source node in Cameo DataHub Panel</td><td colspan="1">Selects the node from other Data Sources, e.g., DOORS, in <strong>DataHub/Alias Explorer</strong>.</td></tr><tr><td colspan="1">Change Direction (only for root nodes)</td><td colspan="1">Changes the current direction of synchronization: <strong>Two-way Sync</strong>, <strong>Sync from MagicDraw</strong>, and <strong>Sync to MagicDraw</strong>.</td></tr><tr><td>View Schema Map</td><td><div class="content-wrapper"><p>Opens the <strong><a href="https://docs.nomagic.com/display/CDH/Mapping+with+Schema+Map+Manager">View Schema Map </a></strong>dialog.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="View Schema Map dialog.png" /></ac:image></p><h6 style="text-align: center;">The View Schema Map dialog.</h6></div></td></tr><tr><td>Exclude Node (not for root nodes)</td><td>Skips the synchronization of the selected node and its child nodes.</td></tr><tr><td>Include Node</td><td>Includes the selected node and its child nodes for the synchronization.</td></tr><tr><td colspan="1">Update Pending DHLink (for Pending Update items)</td><td colspan="1">Synchronizes the node by updating the pending DHLink.</td></tr><tr><td colspan="1">Discard Update (for Pending Delete items)</td><td colspan="1">Synchronizes the node by discarding the DHLink.</td></tr><tr><td>Remove DHLink</td><td>Removes the selected DHLink.</td></tr></tbody></table><p><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="8b1f4548-42a5-42da-ad07-92b0e1ea7b5a"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>DataHub cannot recreate a node if its parent does not exist.</li><li>You can perform the <strong>Change Direction</strong> and <strong>Remove DHLink</strong> command(sync relation) on a root node only.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>You can click the <strong>Sync Status</strong> icons to filter the status of synchronization of the nodes. The <strong>DH Links </strong>panel displays only the DHLinks with the Sync status you have selected from the specified <strong>Sync Status</strong> icons.</p><p><br /></p><p style="margin-left: 30.0px;text-align: center;"><ac:image><ri:attachment ri:filename="2.png" /></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The Sync Status icons on the DH Links panel.</h6><p>All the <strong>Sync Status</strong> icons are listed in the following table</p><table class="relative-table"><colgroup><col /><col /><col /><col /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Button</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Color sync</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Status</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Meaning</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:width="20"><ri:attachment ri:filename="s_active_t_none.png" /></ac:image></span></td><td>Green</td><td>Synchronized</td><td>Displays only the DHLink of the <strong>Synchronized</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:width="20"><ri:attachment ri:filename="s_orphan_t_none.png" /></ac:image></span></td><td>Blue</td><td>Orphan</td><td>Displays only the DHLink of the <strong>Orphan</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: center;"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:width="20"><ri:attachment ri:filename="s_delete_t_none.png" /></ac:image></span></td><td>Red</td><td>Pending Delete</td><td>Displays only the DHLink of the <strong>Pending Delete</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: center;" colspan="1"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:width="20"><ri:attachment ri:filename="s_update_t_none.png" /></ac:image></span></td><td colspan="1">Yellow</td><td colspan="1">Pending Update</td><td colspan="1">Displays only the DHLink of the <strong>Pending Update</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: center;" colspan="1"><span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="exclude_icon.png" /></ac:image></span></td><td colspan="1">Grey</td><td colspan="1">Excluded</td><td colspan="1">Displays only the DHLink of the <strong>Excluded</strong> status.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568803 space=CDH version=2 -->
## PAGE 00360: DHLink Summary

- page_id: `249568803`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568803/DHLink+Summary
- version_number: 2
- version_date: `2025-11-20T11:37:59.280+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DHLink summary and generating reports
- labels: []
...
````html
<p>To open the shortcut menu in the <strong><ac:link><ri:page ri:content-title="DHLink Summary" /></ac:link></strong> dialog</p><hr /><ul><li><p>In the <strong>DHLink Summary</strong> dialog, right-click a value in the element. The shortcut menu opens.<br /><br /></p><h6 style="text-align: center;"><ac:image><ri:attachment ri:filename="DHLink Summary  (Root Element).png" /></ac:image><br />The shortcut menu of the root data node in the DHLink Summary dialog.</h6><p><ac:image><ri:attachment ri:filename="DHLink Summary  (Except Root Element).png" /></ac:image></p><h6 style="text-align: center;">The shortcut menu of a data node in the DHLink Summary dialog.</h6></li></ul><p>To open the shortcut menu in the <strong>DH Links </strong>panel</p><hr /><ul><li>In the <strong>DH Links </strong>panel, right-click a Data Source in the element. The shortcut menu opens.</li></ul><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DH Link Panel.png" /></ac:image></p><h6 style="text-align: center;">The shortcut menu of the synchronized DHLink in the DH Links panel.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DH Trace.png" /></ac:image></p><h6 style="text-align: center;">The shortcut menu of DHTrace in the DH Links panel.</h6><p><br /></p><p>The table below summarizes the shortcut menu items in the <strong>DHLink Summary </strong>dialog and <strong>DH Links</strong> panel.</p><table class="relative-table wrapped" style="margin-left: 30.0px;width: 96.8238%;"><colgroup><col style="width: 35.2022%;" /><col style="width: 64.7925%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><th><div class="tablesorter-header-inner">Menu</div></th><th><div class="tablesorter-header-inner">Function</div></th></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td><strong>Change Direction</strong> (only for the root element)<strong> </strong></td><td><div class="content-wrapper"><p>Changes the direction of synchronization: <strong>Sync from MagicDraw</strong> and <strong>Sync to MagicDraw</strong>.</p></div></td></tr><tr style="margin-left: 30.0px;"><td><strong>Remove DHLink </strong></td><td><p>Removes the selected DHLink from both of the associated nodes.</p></td></tr><tr style="margin-left: 30.0px;"><td><strong>Remove DHTrace</strong></td><td>Removes the selected DHTrace from both of the associated nodes.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Clear Suspect DHTrace</strong></td><td>Clears the Suspect status from both of the associated nodes.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: left;vertical-align: top;"><strong>Select node in Containment tree</strong></td><td>Selects the element in the MagicDraw Containment tree.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: left;vertical-align: top;"><strong>Select Modeling Tool node in Cameo DataHub Panel</strong></td><td>Selects the MagicDraw node in <strong>DataHub/Alias Explorer</strong>.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: left;vertical-align: top;"><strong>Select node in external application</strong></td><td>Selects the node in the original application, e.g., the node originally from DOORS will be opened in the DOORS client application.</td></tr><tr style="margin-left: 30.0px;"><td style="text-align: left;vertical-align: top;"><strong>Select Data Source node in Cameo DataHub Panel</strong></td><td>Selects the node from other Data Sources, e.g., DOORS, in <strong>DataHub/Alias Explorer</strong>.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Discard Update </strong>(only for the <strong>Pending Update</strong> status)<strong><br /></strong></td><td>Synchronizes the node by discarding the DHLink.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Exclude Node </strong>(not for the root element)<strong> </strong></td><td>Excludes the node from being included for synchronization.</td></tr><tr style="margin-left: 30.0px;"><td><strong>Include Node</strong></td><td>Includes the selected node and its child nodes for the synchronization.</td></tr><tr style="margin-left: 30.0px;"><td><p><strong>Update Pending DHLink</strong> (only for the <strong>Pending Update</strong> status)<strong><br /></strong></p></td><td>Synchronizes the node by updating the pending DHLink.</td></tr><tr style="margin-left: 30.0px;"><td><strong>View Schema Map</strong></td><td>Opens the <strong><ac:link><ri:page ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Schema Map Manager]]></ac:plain-text-link-body></ac:link></strong> dialog.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249569037 space=CDH version=2 -->
## PAGE 00362: Diagram Synchronization

- page_id: `249569037`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569037/Diagram+Synchronization
- version_number: 2
- version_date: `2025-11-20T11:42:06.424+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
You can synchronize a single diagram or an entire package of diagrams from the modeling tool into the JAMA Connect project. All types of diagrams available in the modeling tool are supported. The synchronized diagram is converted to an image and is embedded in the description property of the corresponding JAMA Connect project item. When you synchronize, the image on the JAMA Connect side is updated if the related diagram is modified in the modeling tool.

To synchronize the diagram

1. Drag and drop a diagram or a diagram package onto the project, component, or set node. [ATTACHMENT filename='Drag and Drop.png']
2. In the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space=''] dialog, map the **Diagram**on the modeling tool side to the **Text**on the JAMA Connect side. 
 
[IMAGE alt='' src='']
3. In Select Attribute to Sync section, map the **Documentation**attribute against the **Description**and the **Name**attribute against the **Name**. 
 
[IMAGE alt='' src='']
4. Click **OK**.

The following video shows theSysML Diagrams Synchronization from JAMA Connect to the modeling tool:

800400

**Related pages:**

- [CONFLUENCE_PAGE title='Adding Data Sources for JAMA Connect' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Diagram Synchronization</h3><p>You can synchronize a single diagram or an entire package of diagrams from the modeling tool into the JAMA Connect project.  All types of diagrams available in the modeling tool are supported. The synchronized diagram is converted to an image and is embedded in the description property of the corresponding JAMA Connect project item. When you synchronize, the image on the JAMA Connect side is updated if the related diagram is modified in the modeling tool.</p><p><br /></p><p><span style="color:var(--ds-text,#333333);">To synchronize the diagram</span></p><hr /><ol><li>Drag and drop a diagram or a diagram package onto the project, component, or set node.<br /><br /><ac:image><ri:attachment ri:filename="Drag and Drop.png" /></ac:image><br /><br /></li><li><span style="color:var(--ds-text,#333333);">In the <ac:link><ri:page ri:content-title="Copy Data with Sync operation" /><ac:plain-text-link-body><![CDATA[Copy Data with Sync]]></ac:plain-text-link-body></ac:link> dialog, map the <strong>Diagram </strong>on the modeling tool side to the <strong>Text </strong>on the JAMA Connect side.<br /><br /><ac:image><ri:attachment ri:filename="Diagram to the Text mapping.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">In Select Attribute to Sync section, map the <strong>Documentation </strong>attribute against the <strong>Description </strong>and the <strong>Name </strong>attribute against the <strong>Name</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Select Attribute to Sync section.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">Click <strong>OK</strong>.</span></li></ol><p><span style="color:var(--ds-text,#333333);">The following video shows the </span><span>SysML Diagrams Synchronization from JAMA Connect to the modeling tool:</span></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="1ab36aa0-2087-4dcf-a5a3-47b3e110d432"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=d_oXKu9730I" /></ac:parameter><ac:parameter ac:name="height">400</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages:</strong></p><ul><li><ac:link><ri:page ri:content-title="Adding Data Sources for JAMA Connect" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568814 space=CDH version=2 -->
## PAGE 00363: Directions of DHLinks

- page_id: `249568814`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568814/Directions+of+DHLinks
- version_number: 2
- version_date: `2025-11-20T11:37:59.946+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DHLink summary and generating reports
- labels: ['unrestored-unknown-attachment']

### NORMALIZED CONTENT

Besides showing types of DHLinks and the source and type elements that have DHLinks, the **[CONFLUENCE_PAGE title='DHLink Summary' space='']** dialog displays the direction of the **DHLink** with an arrow. The arrow describes the direction of synchronization graphically, either unidirectional or bidirectional.
...
````html
<p>Besides showing types of DHLinks and the source and type elements that have DHLinks, the <strong><ac:link><ri:page ri:content-title="DHLink Summary" /></ac:link></strong> dialog displays the direction of the <strong>DHLink</strong> with an arrow. The arrow describes the direction of synchronization graphically, either unidirectional or bidirectional.</p><p><br /></p><table class="relative-table wrapped" style="margin-left: 30.0px;width: 97.3794%;"><colgroup><col style="width: 6.01758%;" /><col style="width: 16.4233%;" /><col style="width: 16.4909%;" /><col style="width: 61.0908%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Symbol</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Type</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Sync status</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Description</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><span class="confluence-embedded-file-wrapper"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-151732.png"><ri:page ri:content-title="Working with DataHub and modeling tools" /></ri:attachment></ac:image></span></span></div></td><td style="margin-left: 30.0px;"><strong>Two-way sync</strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;">Data synchronization can be performed on both sides, which are source or target with the <strong>Synchronized</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><span class="confluence-embedded-file-wrapper"> </span><ac:image><ri:attachment ri:filename="capture-20120810-150304.png"><ri:page ri:content-title="Working with DataHub and modeling tools" /></ri:attachment></ac:image></div></td><td style="margin-left: 30.0px;"><strong>One-way Sync from MagicDraw </strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;"><span>Selecting this synchronization mode allows the Data Source from the node with a DHLink in the other driver picks up changes from the MagicDraw Data Source.</span></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><div class="content-wrapper"><span class="confluence-embedded-file-wrapper"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-150426.png"><ri:page ri:content-title="Working with DataHub and modeling tools" /></ri:attachment></ac:image></span></span></div></td><td style="margin-left: 30.0px;"><strong>One-way Sync to MagicDraw</strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;"><span>Selecting this synchronization mode allows the MagicDraw Data Source to pick up changes from the node <span>with a DHLink in the other driver</span>.</span></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><div class="content-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-150304.png"><ri:page ri:content-title="Working with DataHub and modeling tools" /></ri:attachment></ac:image></div></td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Pending Update/ Pending Delete</strong></td><td style="margin-left: 30.0px;" colspan="1">The relation status is <strong>PendingUpdate</strong>, <strong>PendingDelete, </strong>or<strong> Orphan</strong>, and the data are updated from the source to the target.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><div class="content-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-150426.png"><ri:page ri:content-title="Working with DataHub and modeling tools" /></ri:attachment></ac:image></div></td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Pending Update/ Pending Delete</strong> </td><td style="margin-left: 30.0px;" colspan="1"><p>The relation status is <strong style="line-height: 1.42857;">PendingUpdate,</strong> <strong style="line-height: 1.42857;">PendingDelete<strong>, </strong><span>or</span></strong> <strong>Orphan</strong>, and the data will be updated from the target to the source.</p></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1">- - - - -</td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Excluded</strong></td><td style="margin-left: 30.0px;" colspan="1">This symbol is used for a <strong>DHLink</strong> relation that has been excluded and has a virtual relation.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568912 space=CDH version=2 -->
## PAGE 00364: Directions of synchronization

- page_id: `249568912`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568912/Directions+of+synchronization
- version_number: 2
- version_date: `2025-11-20T11:41:17.628+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The synchronization direction allows you to choose the direction from which the changes are sent. There are three directions of data synchronization in the dialog of the selected DataHub Explorer operation as follows</p><ul><li data-uuid="96357ed3-30a8-43dd-b906-ebe0dfd164ad"><ac:image><ri:attachment ri:filename="two-way-sync.png" /></ac:image><br />Synchronizations are in both directions.</li><li data-uuid="5e446cde-c0ed-4893-94d9-63e9056b91cf"><strong><ac:image><ri:attachment ri:filename="one-way-sync-to-md.png" /></ac:image></strong><br />The third-party Data Source is always synchronized to the MagicDraw Data Source.</li><li data-uuid="1e325749-9d71-4699-9a51-455575ff1fbd"><ac:image><ri:attachment ri:filename="one-way-sync-from-md.png" /></ac:image><br />The MagicDraw Data Source is always synchronized to the third-party Data Source.</li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="a0695d9c-4b71-40b9-b993-cb5e3b8093d8"><ac:link><ri:page ri:content-title="Operations in DataHub Explorer" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568069 space=CDH version=2 -->
## PAGE 00365: Displaying MagicDraw Data Sources in DataHub Explorer

- page_id: `249568069`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568069/Displaying+MagicDraw+Data+Sources+in+DataHub+Explorer
- version_number: 2
- version_date: `2025-11-20T11:28:03.052+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > DataHub basic operations
- labels: []

### NORMALIZED CONTENT

By default, MagicDraw® Data Sources are not shown in the [CONFLUENCE_PAGE title='DataHub Explorer tab' space='']. However, you can display MagicDraw® Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.
...
````html
<p>By default, MagicDraw<sup>®</sup> Data Sources are not shown in the <ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link>. However, you can display MagicDraw<sup>®</sup> Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.</p><p><br /></p><p>To display a MagicDraw<sup>®</sup> Data Source in the DataHub Explorer tree</p><hr /><ol><li>From the MagicDraw main menu, click <strong>Options</strong> &gt; <strong>Environment</strong>. The Environment Options dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_General.png" /></ac:image><br /><br /></li><li>On the left-hand side of the dialog, select <strong>Cameo DataHub</strong> in the list.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH.png" /></ac:image><br /><br /></li><li>In the<strong> General</strong> group of options, clear the Filter a Magic Systems of Systems Architect data source from the DataHub Explorer checkbox.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_Clear_Checkbox.png" /></ac:image><br /><br /></li><li>Click <strong>OK</strong>. A MagicDraw<sup>®</sup> Data Source now appears in the DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="MD_Data_Source.png" /></ac:image></li></ol><p><br /></p>
````

<!--NOMAGIC_PAGE id=249568496 space=CDH version=2 -->
## PAGE 00366: DOORS Baseline Data Sources

- page_id: `249568496`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568496/DOORS+Baseline+Data+Sources
- version_number: 2
- version_date: `2025-11-20T11:35:00.921+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS
- labels: []
...
````html
<p>You can access DOORS Baseline by adding a new Baseline Data Source.</p><p>To create the Baseline Data Source</p><hr /><ol><li>Right-click any folder, project, or module you want to create the Baseline Data Source and select <strong>Create data source from Baseline</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create data source fom baseline.PNG" /></ac:image><br /><br /></li><li>The <strong>Create data source from Baseline</strong> dialog opens and lists all Baseline versions grouped by the Baseline set. Do one of the following:<br /><br /><ul><li><p>To create a Data Source with only the selected module, select a particular module version.</p></li><li><p>To create a Data Source with all modules in the Baseline set, select a Baseline set version.</p></li></ul><br /><ac:image><ri:attachment ri:filename="Dialog Box.PNG" /></ac:image><br /><br /></li><li>Select the Baseline that you want and click <strong>OK</strong>.  You will get a new Data Source that contains the modules with the specific version you have selected.<br /><br /><ac:image><ri:attachment ri:filename="Data Source with module and specific versions.PNG" /></ac:image></li></ol><p>It is possible that your data in DataHub (DHLink to MagicDraw) work with original DOORS Data Sources or other Data Sources with different Baseline versions. If you also want the newly created Baseline Data Sources to synchronize with those data, you can use the copying function to copy the DHLinks from other DOORS Data Sources to the new Baseline Data Sources.</p><p>To copy the DHLink to a Baseline Data Source</p><hr /><ol><li>Right-click any module in the Baseline Data Source and select <strong>Copy DHLink from other data sources</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy DHlinks from other data sources.PNG" /></ac:image><br /><br /></li><li>The <strong>Copy DHLink from other data source</strong> dialog opens. From the drop-down list, choose the Data Source you want to copy the DHLink from.<br /><br /><ac:image><ri:attachment ri:filename="Copi DHLinks Dialog box.PNG" /></ac:image><br /><br /></li><li>Click <strong>OK</strong>. The DHLink will be copied to the new Baseline Data Source.<br /><br /><ac:image><ri:attachment ri:filename="DHLinks_Copied.PNG" /></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=249568046 space=CDH version=2 -->
## PAGE 00367: Driver deployment

- page_id: `249568046`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568046/Driver+deployment
- version_number: 2
- version_date: `2025-11-20T11:27:04.831+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
1. Open the Cameo DataHub Options dialog. [ATTACHMENT filename='ENOVIA_Environment Options.png']
...
| --- | --- |
| Maximum concurrent connection | Takes a numerical value for the maximum number of concurrent connections. |
| Show All Elements | If true, displays all ENOVIA Requirement items available to you across all collaboration spaces on the server. If false, displays ENOVIA Requirement items only from the collaboration space you are currently connected to, based on your selected credentials. The default value is true. |
| Show Ownership | If true, displays the collaboration space name and organization for each object in the TRM data source. If false, displays only the object title for each object in the TRM data source (for example, the Specification title). The default value is false. |
| Show Revisions | If true, displays the revision name for each object in the ENOVIA Requirement data source tree, except for links. If false, hides the revision name for each object in the ENOVIA Requirement data source tree. The default value is true. |
| Show Transfer Link Confirmation Dialog | If true, displays the Transfer Link Confirmation Dialog while you are transferring DHLinks from one revision to another. If false, hides the Transfer Link Confirmation Dialog. The default value is true. |
...
| Use DataHub JxBrowser | RedObsolete |
| Use JxBrowser GPU | JxBrowser renders content using a GPU (Graphical Processing Unit) and displays it directly. |
| Use JxBrowser sandbox | If True, JxBrowser supports Chromium Sandbox on Windows. |

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>This section explains the ENOVIA Requirements setting in the Cameo DataHub Options dialog.</p><p><br /></p><p> To configure the<strong> </strong>ENOVIA Requirements setting</p><hr /><ol><li>Open the <a href="https://docs.nomagic.com/display/CDH/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="ENOVIA_Environment Options.png" /></ac:image><br /><br /></li><li>Go to the <strong>ENOVIA Requirements </strong>group and update the required options.</li><li>Click <strong>OK</strong>.</li></ol><p><br /></p><p>The following table explains the<strong> </strong>ENOVIA Requirements options in the Cameo DataHub Options dialog.</p><table class="relative-table wrapped" style="width: 68.0746%;"><colgroup><col style="width: 20.4032%;" /><col style="width: 79.5968%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr><tr><td><span style="color:var(--ds-text,#172b4d);">Show All Elements</span></td><td><p>If <em>true</em>, displays all ENOVIA Requirement items available to you across all collaboration spaces on the server. If <em>false</em>, displays ENOVIA Requirement items only from the collaboration space you are currently connected to, based on your selected credentials. <span style="color:var(--ds-text,#172b4d);">The default value is<span> </span></span><em style="text-align: left;">true.</em></p></td></tr><tr><td><span style="color:var(--ds-text,#172b4d);">Show Ownership</span></td><td><p>If <em>true</em>, displays the collaboration space name and organization for each object in the TRM data source. If <em>false</em>, displays only the object title for each object in the TRM data source (for example, the Specification title). <span style="color:var(--ds-text,#172b4d);">The default value is<span> </span></span><em style="text-align: left;">false.</em></p></td></tr><tr><td><span style="color:var(--ds-text,#172b4d);">Show Revisions</span></td><td><p>If <em>true</em>, displays the revision name for each object in the ENOVIA Requirement data source tree, except for links. If <em>false</em>, hides the revision name for each object in the ENOVIA Requirement data source tree. <span style="color:var(--ds-text,#172b4d);">The default value is <em>true.</em></span></p></td></tr><tr><td><span style="color:var(--ds-text,#172b4d);">Show Transfer Link Confirmation Dialog</span></td><td><p>If <em>true, </em>displays the <span style="color:var(--ds-text,#172b4d);">Transfer Link Confirmation Dialog while you are transferring DHLinks from one revision to another. If false, hides the Transfer Link Confirmation Dialog. <span style="color:var(--ds-text,#172b4d);">The default value is<span> </span></span><em style="text-align: left;">true.</em></span></p></td></tr><tr><td>Use JxBrowser incognito mode</td><td>Enables the Incognito mode for the default profile. Incognito mode stores user data, such as browsing history, cookies, and site data in the memory.</td></tr><tr><td>Use DataHub JxBrowser</td><td><div class="content-wrapper"><p><ac:structured-macro ac:name="status" ac:schema-version="1" ac:macro-id="3d2e677c-1721-4ee1-ac48-39ce832d6b2e"><ac:parameter ac:name="colour">Red</ac:parameter><ac:parameter ac:name="title">Obsolete</ac:parameter></ac:structured-macro></p></div></td></tr><tr><td>Use JxBrowser GPU</td><td>JxBrowser renders content using a GPU (Graphical Processing Unit) and displays it directly.</td></tr><tr><td>Use JxBrowser sandbox</td><td>If True, JxBrowser supports Chromium Sandbox on Windows.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568997 space=CDH version=3 -->
## PAGE 00369: Excluding some nodes when copying data

- page_id: `249568997`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568997/Excluding+some+nodes+when+copying+data
- version_number: 3
- version_date: `2025-11-20T11:41:44.540+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<p>The <strong>Copy Data with Sync</strong> operation has been enhanced. It no longer requires you to map the whole set of data before copying data. With the <strong>Copy Data with Sync</strong> operation, DataHub can exclude data types that you do not map when you select <ac:image ac:thumbnail="true" ac:height="18"><ri:attachment ri:filename="Non-mapping.png" /></ac:image> as the target type and select the <strong>Exclude all unmapped nodes from DHLinks</strong> check box, and these nodes will not be copied. Alternatively, DataHub allows you to create the schema mapping for the selected nodes as <strong>Exclude</strong> by selecting the <ac:image ac:thumbnail="true" ac:height="17"><ri:attachment ri:filename="Excluded.png" /></ac:image> target type. You can also include the portion of data that has been excluded later.</p><p><br /></p><p>To exclude a portion of data while copying with DHLink</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Copy Data with Sync</strong>. The <strong>Copy Data with Sync</strong> dialog opens.</li><li><a href="https://docs.nomagic.com/display/CDH/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modeling+tool">Map the data types that you need to copy</a>.</li><li>Exclude nodes from being copied by doing one of the following<br /><br /><ul><li class="auto-cursor-target">Selecting the <ac:image ac:thumbnail="true" ac:height="18"><ri:attachment ri:filename="Non-mapping.png" /></ac:image> target type and the <strong>Exclude all unmapped nodes from DHLinks</strong> check box.</li><li class="auto-cursor-target">Selecting the <ac:image ac:thumbnail="true" ac:height="17"><ri:attachment ri:filename="Excluded.png" /></ac:image>target type.</li></ul><br /><ac:image><ri:attachment ri:filename="Exclude in Copy Data with Sync Dialog (highlighted).png" /></ac:image><br /><br /></li><li>Click <strong>OK </strong>to start copying the data. The copied data are indicated with the <ac:image><ri:attachment ri:filename="s-node.png" /></ac:image> symbols, and the data which is not copied are indicated with the <ac:image><ri:attachment ri:filename="x-clude.png" /></ac:image> symbols.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Exclude in DH Explorer Tree (Highlighted).png" /></ac:image><br /><br /><br /></p><p>To include previously excluded data into a scope set</p><hr /><ol><li>Double-click a node marked with a <ac:image><ri:attachment ri:filename="x-clude.png" /></ac:image> symbol. The <strong>DH Links </strong>panel appears.</li><li>Right-click the relation table and select <strong>Include Node</strong>.</li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="worddavf35042654464548804c64111c9aebecf.png" /></ac:image><br /><br /></p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="19aadcfd-b40c-4815-aa50-24d490721a9f"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>When you synchronize data next time, DataHub will recognize it as a newly added node to the target side.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568780 space=CDH version=2 -->
## PAGE 00370: Exporting a schema map

- page_id: `249568780`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568780/Exporting+a+schema+map
- version_number: 2
- version_date: `2025-11-20T11:37:28.531+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []
...
````html
<p>To export a schema map as a new template</p><hr /><ol><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The Schema Map Manager dialog opens. There are some properties with pre-mappings.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image><br /><br /></li><li>Click <strong>Export</strong>. The Export Schema Map Wizard appears.<br /><br /><ac:image><ri:attachment ri:filename="Export Schema Map Wizard.png" /></ac:image><br /><br /></li><li>Select the source and target driver of the map and click <strong>Next</strong>.</li><li>Do one of the following:<br /><br /><ul><li>If any maps are not attribute-defined, select the box(es) in front of the maps and click the selected map to choose the type object, e.g., DOORS, to change it to a generic type. Click <strong>Next</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Non-attribute Map.png" /></ac:image><br /><br /></li><li>If any maps are attribute-defined, select all the box(es) in front of the maps that contain defined attributes and click the selected map to choose the type object, e.g., DOORS, to change it to a generic type. Click <strong>Next</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Attribute-defined Map.png" /></ac:image><br /><br /></li></ul></li><li>Name the schema and the exported file. Click <strong>Finish</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Naming Schema.png" /></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=249568038 space=CDH version=2 -->
## PAGE 00371: Exporting schema maps as new templates

- page_id: `249568038`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568038/Exporting+schema+maps+as+new+templates
- version_number: 2
- version_date: `2025-11-20T11:27:03.643+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []
...
````html
<p>To filter out an inactive Data Source</p><hr /><ul><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Filter inactive data sources</strong> <ac:image><ri:attachment ri:filename="dh-inactive-ds-filter.png" /></ac:image>button.</li></ul>
````

<!--NOMAGIC_PAGE id=249568238 space=CDH version=3 -->
## PAGE 00373: General

- page_id: `249568238`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568238/General
- version_number: 3
- version_date: `2025-11-20T11:31:09.397+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Customizing DataHub options
- labels: []
...
2. In the file, find the JAVA_ARGS line and add the **-Ddatahub.mdp.image.converttoBase64=true** argument as one of its values. [ATTACHMENT filename='adding_java_argument.png']
...
To configure the IBM Rational DOORS Next Generation settings
...
````html
<p>This section explains the IBM Rational DOORS Next Generation preference in the Cameo DataHub Options dialog.</p><p><br /></p><p> <span style="color:var(--ds-text,#172b4d);">To configure the</span> IBM Rational DOORS Next Generation <span style="color:var(--ds-text,#172b4d);">settings</span></p><hr /><ol><li>Open the <a href="https://docs.nomagic.com/display/CDH/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH_DOORS_NG.png" /></ac:image><br /><br /></li><li>Go to the <strong>IBM Rational DOORS Next Generation</strong> option <span style="color:var(--ds-text,#333333);">group and<span> </span></span><span style="color:var(--ds-text,#333333);">update the required options.<br /></span></li></ol><p>The following table explains the IBM Rational DOORS Next Generation options in the Cameo DataHub Options dialog.</p><table class="relative-table wrapped" style="width: 87.8548%;"><colgroup><col style="width: 30.4639%;" /><col style="width: 69.5294%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr><tr><td colspan="1">Show all GC data source</td><td colspan="1">If True, all Global Configuration data sources are visible on the Cameo DdataHub Explorer panel, including removed and inactive data sources.</td></tr><tr><td colspan="1">Use DataHub JxBrowser</td><td colspan="1"><div class="content-wrapper"><p><ac:structured-macro ac:name="status" ac:schema-version="1" ac:macro-id="a97943d2-3b2e-47e8-bf35-7e376966bb72"><ac:parameter ac:name="colour">Red</ac:parameter><ac:parameter ac:name="title">Obsolete</ac:parameter></ac:structured-macro></p></div></td></tr><tr><td colspan="1">Use JxBrowser incognito mode</td><td colspan="1">Enables Incognito mode for the default profile. Incognito mode stores user data, such as browsing history, cookies, and site data in the memory.</td></tr><tr><td colspan="1">Use JxBrowser GPU</td><td colspan="1">JxBrowser renders content using GPU (Graphical Processing Unit) and displays it directly.</td></tr><tr><td>Use JxBrowser sandbox</td><td>If True, JxBrowser supports Chromium Sandbox on Windows.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568788 space=CDH version=2 -->
## PAGE 00382: Importing a schema map

- page_id: `249568788`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568788/Importing+a+schema+map
- version_number: 2
- version_date: `2025-11-20T11:37:32.338+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=249568060 space=CDH version=2 -->
## PAGE 00383: Inactive Data Source filter

- page_id: `249568060`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568060/Inactive+Data+Source+filter
- version_number: 2
- version_date: `2025-11-20T11:27:23.301+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Add-on features
- labels: []
...
<!--NOMAGIC_PAGE id=249568778 space=CDH version=2 -->
## PAGE 00384: Individual and Group Type Mapping

- page_id: `249568778`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568778/Individual+and+Group+Type+Mapping
- version_number: 2
- version_date: `2025-11-20T11:37:27.728+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping > Schema mapping modes
- labels: []
...
DataHub also provides a default Schema Map template for mapping data. In the **[CONFLUENCE_PAGE title='Schema Map Manager' space='']**dialog, you can find the default Schema Map template under the IBM® Rational® DOORS® driver side.
...
<!--NOMAGIC_PAGE id=249568025 space=CDH version=2 -->
## PAGE 00385: Individual type mapping

- page_id: `249568025`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568025/Individual+type+mapping
- version_number: 2
- version_date: `2025-11-20T11:26:50.023+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []
...
<!--NOMAGIC_PAGE id=249567931 space=CDH version=2 -->
## PAGE 00386: Installation, licensing, and system requirements

- page_id: `249567931`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567931/Installation+licensing+and+system+requirements
- version_number: 2
- version_date: `2025-09-11T18:10:44.052+02:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
````html
<p class="with-breadcrumbs">For information regarding installation, licensing, and system requirements, visit the <a href="https://docs.nomagic.com/IL/?contextKey=installation-licensing-and-system-requirements&amp;version=latest">Installation, licensing, and system requirements</a> page.</p>
````

<!--NOMAGIC_PAGE id=256443766 space=CDH version=13 -->
## PAGE 00387: JAMA Connect

- page_id: `256443766`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/256443766/JAMA+Connect
- version_number: 13
- version_date: `2026-02-03T10:16:30.473+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Customizing DataHub options
- labels: []
...
1. Open the Cameo DataHub Options dialog. [ATTACHMENT filename='Environment Options_JAMA Connect.png']
2. Go to the JAMA Connect option group and update the option.
...
| --- | --- |
| Maximum concurrent connection | Takes a numerical value for the maximum number of concurrent connections. |
| API Version | Enables you to choose the appropriate JAMA Connect API version to ensure compatibility with your setup. The default value is v2. Select v1 for JAMA Connect Cloud versions earlier than 9.29 and 9.28 when JAMA Connect is self-hosted. |

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>This section explains the JAMA Connect preference in the Cameo DataHub Options dialog.</p><p><br /></p><p><span style="color:var(--ds-text,#172b4d);"> To configure the</span><strong style="text-align: left;"><span> </span></strong><span style="color:var(--ds-text,#172b4d);">JAMA Connect setting</span></p><hr /><ol><li data-uuid="d64611ef-21ff-4a13-95d6-a8e8b36bc48e">Open the <a href="https://docs.nomagic.com/display/CDH/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="Environment Options_JAMA Connect.png" /></ac:image><br /><br /></li><li data-uuid="50cb65b6-9fb9-4659-89b5-dffff9d782e0">Go to the <strong>JAMA Connect</strong> option<span> </span><span style="color:var(--ds-text,#333333);">group and<span> </span></span><span style="color:var(--ds-text,#333333);">update the option.<br /></span></li></ol><p>The following table explains the JAMA Connect<strong> </strong>options in the Cameo DataHub Options dialog.</p><table class="wrapped relative-table" style="width: 72.274%;"><colgroup><col style="width: 17.1443%;" /><col style="width: 82.8557%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr><tr><td>API Version</td><td><p>Enables you to choose the appropriate JAMA Connect API version to ensure compatibility with your setup. The default value is <strong>v2</strong>. Select <strong>v1 </strong>for JAMA Connect Cloud versions earlier than 9.29 <span style="color:var(--ds-text,#172b4d);">and 9.28 when JAMA Connect is self-hosted.</span></p></td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568648 space=CDH version=5 -->
## PAGE 00388: Linking model elements to OSLC resources

- page_id: `249568648`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568648/Linking+model+elements+to+OSLC+resources
- version_number: 5
- version_date: `2025-11-20T11:36:21.757+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []
...
````html
<p>You can link your model elements to the OSLC resources through the hyperlinks.</p><p>There are two ways you can link a model element to an OSLC resource:</p><ul><li data-uuid="aea01be5-e883-4d7b-b49c-68f54ecf0a39">Selecting an existing resource</li><li data-uuid="1493ef35-6504-4a98-a58c-c02c16d61a4a">Creating a new resource</li></ul><h3>Selecting an existing OSLC resource</h3><p><br /></p><p>To link an element to an OSLC resource</p><hr /><ol><li data-uuid="0219d769-40b3-45da-8b14-06c7f132f728">Do one of the following:<ul><li>In the Model Browser, select an element, open its<strong> </strong><a href="https://docs.nomagic.com/MT/?contextKey=specification-window&amp;version=latest&amp;variant=default"><strong>Specification</strong> window</a> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the <strong>Hyperlinks / Go To</strong> button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="2bf9c922-e3ec-4012-8915-88fc387ba3e7">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="a2ba9b15-c7ca-4076-80c8-9b7f591b1539">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="04c61a07-d305-4483-a4d1-5874498fc528">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="d3647a4b-838d-4b9f-babd-8bbb05b23066">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Choose Existing</strong> option.</li><li data-uuid="575ee7db-a72b-42b9-be58-e623aa6dd480">Select an artifact and click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="select.png" /></ac:image><br /><br /></li><li data-uuid="cabfdc6c-ccce-4aaf-8225-28b558a7cc00">Click <strong>Close</strong>.</li><li data-uuid="aa29195b-8c91-4eca-a9ac-26efd46401e5">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><h3>Creating a new OSLC resource</h3><p><br /></p><p>To create a new OSLC resource</p><hr /><ol><li data-uuid="6e501e95-592f-4b6f-b459-8adf8b7eb362">Do one of the following:<ul><li>In the Model Browser, select an element, open its <a href="https://docs.nomagic.com/MT/?contextKey=specification-window&amp;version=latest&amp;variant=default"><strong>Specification</strong> window</a> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the Hyperlinks / Go To button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="4d6808ad-c841-4016-9cee-a23ac90554a4">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="53280231-04e6-4491-96eb-54ed1d7a4a3a">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="9a220739-a378-46b8-922d-57a19a027f6c">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="5898d5e4-27ea-422a-84a2-dcab21d0a6d8">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Create New</strong> option.</li><li data-uuid="3690e63b-6e7b-4bb4-9fa4-df7d42aa41bd">Fill out the data for the new element.<br /><br /><ac:image><ri:attachment ri:filename="create.png" /></ac:image><br /><br /></li><li data-uuid="5054c035-6e6e-4666-86d6-78b00aca65bc">Click <strong>OK</strong>.</li><li data-uuid="d735c06f-dc76-4633-b6f7-98e0f2fc9498">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><p>The created element is now linked to your selected model element.</p>
````

<!--NOMAGIC_PAGE id=249568091 space=CDH version=2 -->
## PAGE 00389: Mapping source and target types to copy data to and from a modelling tool

- page_id: `249568091`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568091/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool
- version_number: 2
- version_date: `2025-11-20T11:29:08.717+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Data can be copied into the MagicDraw<sup>®</sup> Containment area from other Data Sources. Data can also be moved from MagicDraw<sup>®</sup> into other Data Sources like DOORS and CSV repositories. You can use the Copy Data, Copy Data with Sync, and Copy Data with DHTrace operations to copy data. While moving the data, the <strong>Copy Data</strong>, <strong>Copy Data with Sync,</strong> or <strong>Copy Data with DHTrace</strong> dialog prompts you to map the source and target types as well as their attribute types. After you map the source and target types, you can copy the data.</p><p>To copy data into MagicDraw<sup>®</sup> or to copy data to other Data Sources</p><hr /><ol><li data-uuid="eccb65a7-2f32-44d2-9c0e-5d4a963d370e">Drag the data node to another Data Source, e.g., DOORS.<br /><p class="auto-cursor-target"><br /><ac:image><ri:attachment ri:filename="Tutorial - Dragging DOORS Data Source.png" /></ac:image><br /><br />The export dialog, e.g., <strong>Copy Data with Sync </strong>(depending on the operation you have selected from the <ac:link><ri:page ri:content-title="DataHub Operation drop-down list" /></ac:link>), opens to allow you to map the source and target attribute.<br /><br /><ac:image><ri:attachment ri:filename="Export Dialog (Group Type Mapping, Copy Data with Sync).png" /></ac:image><br /><br />The detail of each option in the export dialog is explained in the table below.</p><table class="relative-table" style="width: 97.5529%;"><colgroup class=""> <col class="" style="width: 20.1533%;" /> <col class="" style="width: 79.88%;" /> </colgroup><tbody class=""><tr class=""><th><div class="content-wrapper"><p>Option</p></div></th><th>Function</th></tr><tr class=""><td><strong>Mapping mode</strong></td><td><div class="content-wrapper"><p>You can either do <strong>Individual Type mapping</strong> or <strong>Group Type mapping</strong>. <strong>Individual type mapping</strong> allows you to map the individual nodes themselves, and <strong>Group Type mapping</strong> allows you to map the node type as a whole.</p></div></td></tr><tr class=""><td><div class="content-wrapper"><p><strong>Set as default target type</strong></p></div></td><td><div class="content-wrapper"><p>The source nodes are mapped to the selected stereotype element type as default. The export dialog will not open when you copy the same type of data next time.</p></div></td></tr><tr class=""><td><div class="content-wrapper"><p><strong>Define Target Type from Attribute Value</strong></p></div></td><td>This mapping option is only available for group type mapping mode. In this mapping mode, you can specify node values and their target types.</td></tr><tr class=""><td><div class="content-wrapper"><p><strong>Exclude all no-mapped nodes from DHLinks</strong></p></div></td><td>Unmapped nodes will not be copied, and the source nodes will be marked as excluded with an 'X' symbol. Unmapped nodes are marked with red circles beside them and the mapped ones have green circles.</td></tr><tr class=""><td><strong>Sync Direction</strong></td><td><div class="content-wrapper"><p><strong>Two-way sync</strong>, <strong>One-way Sync from MagicDraw,</strong> and <strong>One-way Sync to MagicDraw</strong>. Two-way sync changes the nodes on both ends, while one-way sync only synchronizes changes from the source node to the target node.</p></div></td></tr></tbody></table><p><span style="color:var(--ds-text-inverse,#ffffff);">a</span></p></li><li data-uuid="7f54817a-1beb-4d80-87bf-24bdc4c342f9">Choose a mapping type, either individual or group. Map the source types to target types and map source attributes to target attributes. When the nodes have all been mapped, the red circles beside them change to green. You can select <strong>Exclude all no-mapped nodes from DHLinks </strong>the checkbox to exclude nodes that have not been mapped from being copied.</li><li data-uuid="de4f753d-7b7e-4679-9305-70e281e604b7">Click <strong>OK</strong>. The nodes are copied to the MagicDraw<sup>®</sup> Containment area.</li></ol></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="7d7b27b6-1a99-48a7-a9c3-d2819eab9656"><ac:link><ri:page ri:content-title="DataHub Operation drop-down list" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568736 space=CDH version=2 -->
## PAGE 00390: Mapping with Schema Map Manager

- page_id: `249568736`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568736/Mapping+with+Schema+Map+Manager
- version_number: 2
- version_date: `2025-11-20T11:37:20.054+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=249568545 space=CDH version=2 -->
## PAGE 00391: Module artifacts of DOORS Next Generation

- page_id: `249568545`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568545/Module+artifacts+of+DOORS+Next+Generation
- version_number: 2
- version_date: `2025-11-20T11:35:09.216+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
<!--NOMAGIC_PAGE id=249568885 space=CDH version=2 -->
## PAGE 00392: Node synchronization

- page_id: `249568885`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568885/Node+synchronization
- version_number: 2
- version_date: `2025-11-20T11:40:58.318+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=249568923 space=CDH version=3 -->
## PAGE 00393: One-way synchronization

- page_id: `249568923`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568923/One-way+synchronization
- version_number: 3
- version_date: `2025-11-20T11:41:20.981+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=249568066 space=CDH version=2 -->
## PAGE 00394: Opening DataHub Explorer

- page_id: `249568066`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568066/Opening+DataHub+Explorer
- version_number: 2
- version_date: `2025-11-20T11:27:43.180+01:00`
- ancestors: Cameo DataHub Documentation > Getting started
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><span style="color:var(--ds-text,#333333);">To open <strong>DataHub Explorer</strong></span></p><hr /><ol><li data-uuid="54a53d88-5200-47c0-9cb4-a6c93ec7aacd">Create a new MagicDraw<sup>®</sup> project or open an existing project.</li><li data-uuid="9476fa4d-beb9-4d32-8ccd-bb235263aacd">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link> opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="worddavff8df49b8dd564525b509af5bc3f682e.png" /></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="59442eae-22b5-4d89-902c-278cc7ff4145"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="59bb3de3-037a-4462-8cd5-0fa655d34ed3">Nodes under particular drivers in <strong>DataHub Explorer</strong> also represent nodes in the applications belonging to the drivers.</li><li data-uuid="c5f1491a-37ff-412d-bc74-092a027599f9">If a driver is correctly started, the name of the driver will appear in the <strong>DataHub Explorer</strong> tree. The driver will then connect to data in each of its respective application.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="5ddf4a1a-ff7d-48be-b6e4-109e3bf5d631"><ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568717 space=CDH version=2 -->
## PAGE 00395: Opening selected Requirements in DataHub Explorer or other applications

- page_id: `249568717`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568717/Opening+selected+Requirements+in+DataHub+Explorer+or+other+applications
- version_number: 2
- version_date: `2025-11-20T11:37:01.797+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Creating links between elements
- labels: []
...
<!--NOMAGIC_PAGE id=249567948 space=CDH version=2 -->
## PAGE 00396: Operation drop-down list

- page_id: `249567948`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567948/Operation+drop-down+list
- version_number: 2
- version_date: `2025-11-20T11:24:05.691+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > DataHub Explorer tab
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The DataHub <strong>Operation</strong> drop-down list has multiple operations as described below.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="CDH_Panel.png" /></ac:image></p><h6 style="text-align: center;">The DataHub Operation drop-down list.</h6><h3>Copy Data</h3><p>This operation only copies data. It does not allow synchronization.</p><h3>Copy Data with Sync</h3><p>This operation mode allows copying data with synchronization. You can perform synchronization between source and target nodes, either unidirectional or bidirectional, in this mode.</p><h3>Copy Data with DHTrace</h3><p>This operation mode copies data and also includes a trace link between the source and target elements. When a node containing a trace link changes, that trace link is marked <strong>Suspect</strong>.</p><p>Trace links or DHTrace links can exist between text-based Requirements and models or elements that define them, like use cases, system artifacts, documents, and other Requirement objects.</p><p>When the nodes being traced are modified, deleted, or moved, you can right-click a node in either the MagicDraw Containment tree or DataHub Explorer and select <strong>Check DHTrace Changes Recursively</strong>. Choosing this option opens up the<strong> DHTrace Summary</strong> dialog which lists all the <strong>Suspect</strong> links in the system. You can choose to clear the <strong>Suspect</strong> trace through the <strong>DHTrace Summary</strong> dialog or you can leave them. In this case, the Requirement is validated.</p><h3>Create Sync</h3><p>This operation recreates synchronization (DHLinks) in case you lose or delete the DHLinks. The synchronization (DHLinks) is recreated without replicating the data.</p><h3>Create DHTrace (with OSLC links)</h3><p>This operation mode creates a <strong>DHTrace</strong> link between the source and target items. A trace link can exist between two requirement objects or between requirements and their model elements such as a use-case. As in the previous operation mode, whenever the source or target nodes are moved, modified, or deleted, will result in the trace link becoming <strong>Suspect</strong>.</p><p>You can then right-click the node in the MagicDraw containment tree or DataHub Explorer and choose <strong>Check DHTrace Changes Recursively</strong>. The <strong>DHTrace Summary</strong> dialog will open allowing you to clear the trace links which have acquired a suspect status, thus validating the state of the requirement and the linked UML element.</p><h3>Creating OSLC links (through the Create DHTrace operation)</h3><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d57a198f-0480-4b8a-ab5a-b1ccb1ada965"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead of the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>.</p></ac:rich-text-body></ac:structured-macro><p>OSLC links can be created when you open an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source in DataHub. You can create OSLC links from IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation artifacts repository by using the <strong>Create DHTrace</strong> operation from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>.</p><p>Typically, an OSLC link is a relation between two lifecycle artifacts. Relationships are modeled with two types of properties: link property and backlink property. The following relations have properties listed in the table below</p><table style="margin-left: 30.0px;"><colgroup class=""><col class="" /><col class="" /><col class="" /></colgroup><thead class="" style="margin-left: 30.0px;"><tr class="" style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Relation</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Link property</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Backlink property</span></strong></td></tr></thead><tbody class="" style="margin-left: 30.0px;"><tr class="" style="margin-left: 30.0px;"><td>implementation</td><td><br /></td><td>oslc.implementedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td>constrain</td><td>oslc.constrains</td><td>oslc.constrainedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td>elaborate</td><td>oslc.elaborates</td><td>oslc.elaboratedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">satisfy</td><td colspan="1">oslc.satisfies</td><td colspan="1">oslc.satisfiedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">affect</td><td colspan="1"><br /></td><td colspan="1">oslc.affectedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">specify</td><td colspan="1">oslc.specifies</td><td colspan="1">oslc.specifiedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">track</td><td colspan="1"><br /></td><td colspan="1">oslc.trackedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">decompose</td><td colspan="1">oslc.decomposes</td><td colspan="1">oslc.decomposedBy</td></tr><tr class="" style="margin-left: 30.0px;"><td colspan="1">validate</td><td colspan="1"><br /></td><td colspan="1">oslc.validatedBy</td></tr></tbody></table></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="36b86597-90cb-471c-9ca2-bd076b1fbe16"><ac:link><ri:page ri:content-title="Copy Data operation" /></ac:link></li><li data-uuid="98f1d6c1-3d2c-4818-ba0f-0beca9ffbdfe"><ac:link><ri:page ri:content-title="Copy Data with Sync operation" /></ac:link></li><li data-uuid="b89dc5b8-829e-4c9b-99a8-2db981097d9a"><ac:link><ri:page ri:content-title="Copy Data with DHTrace operation" /></ac:link></li><li data-uuid="3a9e7f0f-2779-47a2-a663-0dad064322df"><ac:link><ri:page ri:content-title="Create Sync operation" /></ac:link></li><li data-uuid="3b0e08f5-440c-4af3-a400-883a05f3d20c"><ac:link><ri:page ri:content-title="Create DHTrace operation with OSLC links" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568316 space=CDH version=2 -->
## PAGE 00397: Operations in DataHub Explorer

- page_id: `249568316`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568316/Operations+in+DataHub+Explorer
- version_number: 2
- version_date: `2025-11-20T11:32:49.035+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The <strong>Operation </strong>list in the <strong>Cameo DataHub Explorer </strong>panel provides several options for you to work with your data.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="CDH_Panel.png" /></ac:image></p><h6 style="text-align: center;">Operation drop-down list</h6><p>The table below briefly explains the functions of the DataHub operations.</p><p><br /></p><table class="fixed-table"><colgroup class=""><col class="" style="width: 257.0px;" /><col class="" style="width: 996.0px;" /></colgroup><tbody class=""><tr class=""><th>Operation</th><th>Function</th></tr><tr class=""><td><strong>Copy Data</strong></td><td>Only copies the data with child nodes.</td></tr><tr class=""><td><strong>Copy Data with Sync</strong></td><td><div class="content-wrapper"><p>Copies data and creates synchronization (DHLinks) between the source and target nodes. Nodes in the modeling tool are updated or deleted whenever their corresponding nodes in associated tools are updated or deleted. The newly created nodes can be transferred to other associated tools as well.</p></div></td></tr><tr class=""><td><strong>Copy Data with DHTrace</strong></td><td>Copies data and creates DHTrace links between the source and target nodes. DHLinks are used to trace the changes.</td></tr><tr class=""><td><strong>Create Sync</strong></td><td>Recreates synchronization (DHLinks) if you lose or delete the DHLinks without replicating the data.</td></tr><tr class=""><td><strong>Create DHTrace (with OSLC links)</strong></td><td>Creates DHLinks between the source and target nodes without copying any data.<br />Creates an OSLC link from an IBM® Rational® DOORS® Next Generation Data Source to a MagicDraw® element.</td></tr></tbody></table><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="72de58ac-4522-4ab4-8c99-427b6a92c097"><ac:rich-text-body><ul><li data-uuid="f5c6ac10-5117-4ca6-94a5-93b7dce7fe1a">The parent-and-child relationships are transferred from the source to the target items.</li><li data-uuid="c930b770-d025-4e09-a8fd-970f3e03739c">The dependency relationships from MagicDraw® are also transferred if both the source and target nodes are selected.</li><li data-uuid="9b91ae1e-0d67-4fcc-8bda-bfd3cf7b7c4e">By default, <strong>Copy Data with Sync</strong> is selected in the operations list.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="43f12c52-6526-42d2-ab99-f824fafd3327"><ac:link><ri:page ri:content-title="Copy Data operation" /></ac:link></li><li data-uuid="20ff1dd4-7c3b-4ec9-8cc1-96b822185e54"><ac:link><ri:page ri:content-title="Copy Data with Sync operation" /></ac:link></li><li data-uuid="51e3b856-f761-48be-a042-453c3de82115"><ac:link><ri:page ri:content-title="Copy Data with DHTrace operation" /></ac:link></li><li data-uuid="f4744d90-64e0-40ea-ba96-64849f6eb321"><ac:link><ri:page ri:content-title="Create Sync operation" /></ac:link></li><li data-uuid="06f4243a-040d-4160-9002-4746340c3ae5"><ac:link><ri:page ri:content-title="Create DHTrace operation with OSLC links" /></ac:link></li><li data-uuid="7f91135f-f1e0-47d2-9f35-ef091e99b680"><ac:link><ri:page ri:content-title="Compatible data sources" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568641 space=CDH version=3 -->
## PAGE 00398: OSLC Preview

- page_id: `249568641`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568641/OSLC+Preview
- version_number: 3
- version_date: `2025-11-20T11:36:20.962+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []
...
The **OSLC Preview** tab in the [Quick properties panel](https://docs.nomagic.com/MT/?contextKey=understanding-the-user-interface&version=latest&variant=default) allows you to view the details of the OSLC resource. The OSLC resource can be selected from **DataHub Explorer**, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser**.**
...
````html
<p>Using <strong>DataHub Explorer</strong>, you can connect to the Data Sources, such as IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS Next Generation, or other OSLC Providers. <strong>DataHub Explorer</strong> lists the content of the open Data Source.</p><p>The <strong>OSLC Preview</strong> tab in the <a href="https://docs.nomagic.com/MT/?contextKey=understanding-the-user-interface&amp;version=latest&amp;variant=default">Quick properties panel</a> allows you to view the details of the OSLC resource. The OSLC resource can be selected from <strong>DataHub Explorer</strong>, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser<strong>.</strong></p><p><br /></p><p>To open the <strong>OSLC Preview</strong> tab</p><hr /><ul><li>From the main menu, select <strong>Window</strong> &gt; <strong>OSLC Preview</strong>.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="OSLC Preview.png" /></ac:image></p><p><br /></p><p>You can use OSLC preview to display the information of the selected node or the linked node in the following ways:</p><ul><li>When you add an OSLC Data Source into <strong>DataHub Explorer</strong>, e.g., DOORS Next Generation, the <strong>OSLC Preview</strong> tab can display the information of the selected node.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="preview.png" /></ac:image></p><h6 style="text-align: center;">The details of the selected OSLC resource in Cameo DataHub Explorer are displayed in the OSLC Preview tab.</h6><ul><li>When you import data from an OSLC Data Source into the MagicDraw Containment tree, the <strong>OSLC Preview</strong> tab can display the information of the related/linked node.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Preview on Containment Tree.png" /></ac:image></p><h6 style="text-align: center;">The details of the selected OSLC resource in the MagicDraw Containment tree are displayed in the OSLC Preview tab.</h6><ul><li>With an existing element in the model, you can also manually create an OSLC link to the other node from the connected OSLC Data Source so that the <strong>OSLC Preview</strong> tab can display the information of the linked node.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Preview on URLs.png" /></ac:image></p><h6 style="text-align: center;">The detail of the resources that the OSLC link to are displayed in the OSLC Preview tab.</h6><p><br /></p><p>When the Data Source in <strong>DataHub Explorer</strong> is closed, the preview of the selected element details is not available. The <strong>OSLC Preview</strong> tab offers you a link to reconnect to the Data Source.</p><p><br /></p><p>To reconnect to a Data Source</p><hr /><ol><li>In the <strong>OSLC Preview</strong> tab, click the <strong>Connect to Data Source</strong> link.</li><li>In the login dialog, enter the <strong>User ID</strong> and <strong>Password</strong>.</li><li>Click <strong>Connect</strong>.</li></ol><p><ac:image ac:align="center"><ri:attachment ri:filename="connect.png" /></ac:image></p><h6 style="text-align: center;">An example of the closed Data Source.</h6>
````

<!--NOMAGIC_PAGE id=249568264 space=CDH version=4 -->
## PAGE 00399: OSLC Provider

- page_id: `249568264`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568264/OSLC+Provider
- version_number: 4
- version_date: `2025-11-20T11:31:13.964+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Customizing DataHub options
- labels: []
...
````html
<p>This section explains the Generic OSLC Service Provider preference in the Cameo DataHub Options dialog.</p><p><br /></p><p>To specify the number of maximum concurrent connections for the OSLC Provider</p><hr /><ol><li>Open the <a href="https://docs.nomagic.com/display/CDH/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH_OSLC.png" /></ac:image><br /><br /></li><li>Go to the <strong>Generic OSLC Service Provider</strong> option<span> </span><span style="color:var(--ds-text,#333333);">group and<span> </span></span><span style="color:var(--ds-text,#333333);">update the option.<br /></span></li></ol><p>The following table explains the Generic OSLC Service Provider<strong> </strong>options in the Cameo DataHub Options dialog.</p><table class="relative-table wrapped" style="width: 87.8548%;"><colgroup><col style="width: 30.4639%;" /><col style="width: 69.5294%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568051 space=CDH version=2 -->
## PAGE 00400: OSLC support

- page_id: `249568051`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568051/OSLC+support
- version_number: 2
- version_date: `2025-11-20T11:27:05.994+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=249568682 space=CDH version=2 -->
## PAGE 00401: OSLC tutorial

- page_id: `249568682`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568682/OSLC+tutorial
- version_number: 2
- version_date: `2025-11-20T11:36:25.873+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with OSLC features
- labels: []
...
<!--NOMAGIC_PAGE id=249568423 space=CDH version=2 -->
## PAGE 00402: Property value conversion

- page_id: `249568423`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568423/Property+value+conversion
- version_number: 2
- version_date: `2025-11-20T11:33:23.012+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Operations in DataHub Explorer
- labels: []
...
````html
<p>In addition to property-to-property mapping, you can apply a conversion rule to convert an original property value to another value when importing or synchronizing the data. You can set the conversion rule by clicking the <strong>Edit rule</strong> button at the end of each property mapping in the <strong>Cameo DataHub Schema Map Manager</strong> dialog or DataHub operation dialogs.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image></p><h6 style="text-align: center;">The Edit rule button in the Cameo DataHub Schema Map Manager dialog to set the conversion rules.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager _Edit_rule.png" /></ac:image></p><h6 style="text-align: center;">The Edit rule button in the Copy Data with Sync dialog to set the conversion rules.</h6><p>Converting Rule Editor has two converting rule schemes as follows</p><ul><li data-uuid="220eac96-f81b-48b1-bede-b9b6899a229e"><p><span class="confluence-link">Converting rules from an Enumeration to another Enumeration.</span></p></li><li data-uuid="97c84f9c-1a03-4bde-9d99-b47719aa2982"><span class="confluence-link">Converting rules between source attribute values and target values as String.</span></li></ul><h2><span class="confluence-link">Converting rules from an Enumeration to another Enumeration</span></h2><p>The <strong>Converting Rule Editor</strong> dialog converts all the mapped Enumeration values on the left table and converts the Enumeration values from the left table back to the right table and vice versa. In the first table, the first column will list the Enumeration values of the source property, and the second column automatically shows the values that match the values of the Elements to synchronize. In the right table, the Enumeration values will be in relation to the selected mapping values in the left table.</p><p><br /></p><h6 style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Enum Conversion.png" /></ac:image>Selecting Enumeration values for conversion in the Converting Rule Editor dialog.</h6><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="13ba9aa7-0de9-4ca9-83ef-7a3683263f30"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><p>If there is no matching value, you must manually correct all the mapping attribute values shown in red.</p></ac:rich-text-body></ac:structured-macro><h2><span class="confluence-link">Converting rules between source attribute values and target values as String</span></h2><p>In the <strong>Converting Rule Editor</strong> dialog, the left table allows specifying the values of source attributes in String to be converted to target values according to the selected conversion rules.  The table on the right allows the user to select the rules to convert the values of target attributes to source values.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Source Attribute Conversion Editor.png" /></ac:image></p><h6 style="text-align: center;">Selecting the rules to convert the values of source attributes to target values in the Converting Rule Editor dialog.</h6><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="26b62cc7-9019-48ef-9d08-8f37e1c1866c"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li data-uuid="3cd84f97-c1be-4994-b92f-17c6869704c5">To add another conversion rule, click <ac:image><ri:attachment ri:filename="Add Button.png" /></ac:image>.</li><li data-uuid="75f0500d-b853-4183-b604-15611c6ba707">When setting all the conversion rules, you can use <ac:image><ri:attachment ri:filename="Button.png" /></ac:image> for left-to-right reflection or <ac:image><ri:attachment ri:filename="Button2.png" /></ac:image> for right-to-left reflection of the conversion rules for round-trip synchronization.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Using Button as Reflecting Sync.png" /></ac:image></p><h6 style="text-align: center;">Using the &gt;&gt; button for left-to-right reflection of the conversion rules for round-trip synchronization.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="d6338f48-5835-4acf-8735-0cc7f37eefd4"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><p>In case of conversion conflicts, you need to manually correct all the mapping attribute values shown in red.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="4acdf0b5-4a93-46b7-820b-57091725cd49"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>You must specify a conversion rule for the <strong>&lt;ANY VALUE&gt;</strong> source attribute to ensure that the selected conversion rule applies to other unspecified values of source attributes.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>The<strong> Converting Rule Editor</strong> dialog has the following conversion rules</p><ul><li data-uuid="ac0aa640-ebf7-4772-8fa3-dfcd680e48dd"><strong>&lt;CONVERT TO&gt;</strong></li></ul><p style="margin-left: 30.0px;">Synchronize the converted value if the source value matches the value in the <strong>From</strong> column.</p><ul><li data-uuid="71da0675-75b8-45d6-9353-726b21b13ffc"><strong>&lt;DEFAULT&gt;</strong></li></ul><p style="margin-left: 30.0px;">Synchronize the original value if the source value matches the value in the <strong>From</strong> column.</p><ul><li data-uuid="fee5ebfd-abdc-47d8-aa6e-727cf847bdfe"><strong>&lt;IGNORED&gt;</strong></li></ul><p style="margin-left: 30.0px;">Do not perform any synchronization if the source value matches the value in the <strong>From</strong> column.</p>
````

<!--NOMAGIC_PAGE id=249568283 space=CDH version=2 -->
## PAGE 00403: Removing a Data Source

- page_id: `249568283`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568283/Removing+a+Data+Source
- version_number: 2
- version_date: `2025-11-20T11:31:37.212+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
<!--NOMAGIC_PAGE id=249568704 space=CDH version=2 -->
## PAGE 00404: Removing DHLinks

- page_id: `249568704`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568704/Removing+DHLinks
- version_number: 2
- version_date: `2025-11-20T11:36:59.647+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Creating links between elements
- labels: []
...
<!--NOMAGIC_PAGE id=249568721 space=CDH version=2 -->
## PAGE 00405: Requirement Mapping

- page_id: `249568721`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568721/Requirement+Mapping
- version_number: 2
- version_date: `2025-11-20T11:37:17.566+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=249568836 space=CDH version=2 -->
## PAGE 00406: Saving the DHLink summary as reports

- page_id: `249568836`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568836/Saving+the+DHLink+summary+as+reports
- version_number: 2
- version_date: `2025-11-20T11:38:01.417+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DHLink summary and generating reports
- labels: []
...
1. In the Filter Options pane on the left-hand side of the [CONFLUENCE_PAGE title='DHLink Summary' space=''] dialog, choose type of relations you want to see in the DHLink summary.
2. Do one of the following to save the report
...
<!--NOMAGIC_PAGE id=249568023 space=CDH version=2 -->
## PAGE 00407: Schema map and mapping options

- page_id: `249568023`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568023/Schema+map+and+mapping+options
- version_number: 2
- version_date: `2025-11-20T11:26:47.621+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub provides the two mapping modes to simplify the way you map source and target nodes as follows</p><ul><li data-uuid="5c1d3e55-3055-4c20-b141-f1afbce74a82">Group type mapping mode</li><li data-uuid="58cc873a-51a9-4cfc-9f0a-836648af10bd">Individual type mapping mode</li></ul><p>These schema mapping methods are accessible through the <strong>Copy Data</strong> dialog, <strong>Copy Data with Sync</strong> dialog, and <strong>Copy Data with DHTrace</strong> dialog. Additional options, e.g., excluding unmapped nodes, are also available.</p><p>There is also a <strong><ac:link><ri:page ri:content-title="Define target type from attribute value mapping" /><ac:plain-text-link-body><![CDATA[Define target type from attribute value]]></ac:plain-text-link-body></ac:link></strong> mapping mode only available in group type mapping mode. Once you use the <strong>Define Target Type from Attribute Value </strong>mapping mode, DataHub saves it as the default mode and activates it the next time you copy the same type of data. In this case, the <strong>Copy Data </strong>dialog, <strong>Copy Data with Sync</strong> dialog, or <strong>Copy Data with DHTrace</strong> dialog does not open.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3e2827ac-45e6-4160-9dc5-21696946df96" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568034 space=CDH version=2 -->
## PAGE 00408: Schema Map Manager

- page_id: `249568034`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568034/Schema+Map+Manager
- version_number: 2
- version_date: `2025-11-20T11:26:57.625+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []

### NORMALIZED CONTENT

You can use **[CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='']** to edit attribute mapping. When the DHLinks between nodes and attributes have been created, **Schema Map Manager** saves the mapped nodes and attributes. You can edit the attribute mapping for a specific schema mapping. You can also export the mappings in XML format and share them with other users.
...
````html
<p>You can use <strong><ac:link><ri:page ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Schema Map Manager]]></ac:plain-text-link-body></ac:link></strong> to edit attribute mapping. When the DHLinks between nodes and attributes have been created, <strong>Schema Map Manager</strong> saves the mapped nodes and attributes. You can edit the attribute mapping for a specific schema mapping. You can also export the mappings in XML format and share them with other users.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image></p><h6 style="text-align: center;">Schema Map Manager</h6>
````

<!--NOMAGIC_PAGE id=249568037 space=CDH version=2 -->
## PAGE 00409: Schema map templates

- page_id: `249568037`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568037/Schema+map+templates
- version_number: 2
- version_date: `2025-11-20T11:27:02.229+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []
...
<!--NOMAGIC_PAGE id=249568745 space=CDH version=2 -->
## PAGE 00410: Schema mapping modes

- page_id: `249568745`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568745/Schema+mapping+modes
- version_number: 2
- version_date: `2025-11-20T11:37:21.023+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=249568288 space=CDH version=2 -->
## PAGE 00411: Searching for a text string

- page_id: `249568288`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568288/Searching+for+a+text+string
- version_number: 2
- version_date: `2025-11-20T11:31:39.857+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with the DataHub Explorer tree
- labels: []
...
<!--NOMAGIC_PAGE id=249568746 space=CDH version=2 -->
## PAGE 00412: Simple schema mapping

- page_id: `249568746`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568746/Simple+schema+mapping
- version_number: 2
- version_date: `2025-11-20T11:37:22.378+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping > Schema mapping modes
- labels: []
...
<!--NOMAGIC_PAGE id=249569030 space=CDH version=2 -->
## PAGE 00413: Splitting part of a synchronized model as a used project

- page_id: `249569030`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569030/Splitting+part+of+a+synchronized+model+as+a+used+project
- version_number: 2
- version_date: `2025-11-20T11:42:04.476+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=249568866 space=CDH version=2 -->
## PAGE 00414: Synchronization

- page_id: `249568866`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568866/Synchronization
- version_number: 2
- version_date: `2025-11-20T11:39:13.379+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=249568945 space=CDH version=2 -->
## PAGE 00415: Synchronize buttons and commands

- page_id: `249568945`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568945/Synchronize+buttons+and+commands
- version_number: 2
- version_date: `2025-11-20T11:41:25.939+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=249568993 space=CDH version=2 -->
## PAGE 00416: Synchronizing changes in data hierarchy

- page_id: `249568993`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568993/Synchronizing+changes+in+data+hierarchy
- version_number: 2
- version_date: `2025-11-20T11:41:43.231+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=249569025 space=CDH version=2 -->
## PAGE 00417: Synchronizing changes in schema mapping

- page_id: `249569025`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569025/Synchronizing+changes+in+schema+mapping
- version_number: 2
- version_date: `2025-11-20T11:42:03.394+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=249568916 space=CDH version=2 -->
## PAGE 00418: Synchronizing DOORS External Links

- page_id: `249568916`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568916/Synchronizing+DOORS+External+Links
- version_number: 2
- version_date: `2025-11-20T11:41:19.788+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=249569019 space=CDH version=2 -->
## PAGE 00419: Synchronizing nodes

- page_id: `249569019`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569019/Synchronizing+nodes
- version_number: 2
- version_date: `2025-11-20T11:42:01.575+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>To synchronize any nodes in the <strong>Conflict Dashboard</strong> dialog</p><hr /><ol><li data-uuid="a7b24723-ef9b-4f8b-94b8-39890cb41e99"><p class="auto-cursor-target">Select any check boxes of Data Sources on either of the sides. The selected side will be the master Data Source, and the other side will pick up the changes from the selected side.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57776fbc-c1d7-4a13-9494-dcc9a7c64609"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>A single node can be only synchronized from either the source to the target or the target to the source. However, multiple nodes can have different synchronization directions, e.g., one node can be synchronized from the source to the target, and another node can be synchronized from the target to the source.</p></ac:rich-text-body></ac:structured-macro></li><li data-uuid="1a1220c3-2192-45ba-b1f6-70bfc04222a5">Click <strong>Synchronize</strong>.</li></ol></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="8bf6412d-cfdd-44f5-9bf5-2d2b810bb537"><ac:link><ri:page ri:content-title="Tracking changes on Conflict Dashboard" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568868 space=CDH version=2 -->
## PAGE 00420: Synchronizing Requirements

- page_id: `249568868`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568868/Synchronizing+Requirements
- version_number: 2
- version_date: `2025-11-20T11:40:55.165+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Data synchronization is the process of sending all changes in the attribute values including a list of deleted items from a source to target data. Either the source or target must be a MagicDraw<sup>®</sup> node.</p><p>Data synchronization allows you to maintain the consistency of data across nodes in different Data sources and applications. During synchronization, all types of changes in a Data Source or application are stored in the DHLink map along with the project in its repository.</p><p>In addition to the <strong>Synchronize</strong> command on the DataHub Actions menu, DataHub provides the synchronization option through the DataHub main menu and the <strong>Synchronize</strong> buttons in the Containment tree and DataHub Explorer.</p><p>Data synchronization can be categorized into two functional types: Data Source synchronization and node synchronization.</p><p>Data Source synchronization is to synchronize all items in the entire Data Source that have DHLinks in a current project in an application.</p><p>Node Synchronization allows you to synchronize a specific node using either of the following mode:</p><ul><li data-uuid="9c1dd22c-daa7-4188-a6e0-dfe63f98a21a"><strong>Synchronize Node</strong></li><li data-uuid="d91e2e48-b206-4898-97bd-55aba47b4e41"><strong>Synchronize Node Recursively</strong>.</li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ed7b4e06-e498-487a-ab82-4d6182168021"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>DataHub ignores all excluded nodes in the Sync relations during data synchronization.</p></ac:rich-text-body></ac:structured-macro><p>You can perform synchronization on the selected node by clicking the <strong>Synchronize</strong> button on the <strong>DataHub Explorer</strong> toolbar.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Synchronizing a Data Source using the Synchronize button in DataHub explorer" ac:alt="Synchronizing a Data Source using the Synchronize button in DataHub explorer"><ri:attachment ri:filename="data-sync-btn-on-explorer-tab.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The Synchronize button on the DataHub Explorer toolbar.</h6><p>Alternatively, you can perform synchronization from the MagicDraw<sup>®</sup> main menu by clicking <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Synchronize updates to Data Source</strong>.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="DataHub Menu.png" /></ac:image></p><h6 class="auto-cursor-target" style="text-align: center;">Performing synchronization from the MagicDraw main menu.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="6f812287-2809-421a-95d5-dc4662487c7e" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568856 space=CDH version=3 -->
## PAGE 00421: Teamwork Cloud projects

- page_id: `249568856`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568856/Teamwork+Cloud+projects
- version_number: 3
- version_date: `2025-11-06T08:16:49.084+01:00`
...
<!--NOMAGIC_PAGE id=249568058 space=CDH version=2 -->
## PAGE 00422: Text search in DataHub Explorer and Alias Manager

- page_id: `249568058`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568058/Text+search+in+DataHub+Explorer+and+Alias+Manager
- version_number: 2
- version_date: `2025-11-20T11:27:19.496+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Add-on features
- labels: []
...
<!--NOMAGIC_PAGE id=249568897 space=CDH version=2 -->
## PAGE 00423: Tracking changes on Conflict Dashboard

- page_id: `249568897`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568897/Tracking+changes+on+Conflict+Dashboard
- version_number: 2
- version_date: `2025-11-20T11:41:02.848+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=249569062 space=CDH version=5 -->
## PAGE 00424: Troubleshooting

- page_id: `249569062`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569062/Troubleshooting
- version_number: 5
- version_date: `2026-01-09T10:46:32.251+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to [Server Certificates](https://docs.nomagic.com/MT/?contextKey=server-certificates&version=latest&variant=default). The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to the [3DEXPERIENCE platform troubleshooting](https://docs.nomagic.com/CM/?contextKey=3dexperience-platform-troubleshooting&version=latest).
...
````html
<h3>Server Certificate tool</h3><p>Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to <a href="https://docs.nomagic.com/MT/?contextKey=server-certificates&amp;version=latest&amp;variant=default">Server Certificates</a>. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to the <a href="https://docs.nomagic.com/CM/?contextKey=3dexperience-platform-troubleshooting&amp;version=latest">3DEXPERIENCE platform troubleshooting</a>.</p><h3>Enabling the SysMLv2 support for 2026x Version</h3><p>To enable support of SysMLv2</p><hr /><ol><li data-uuid="c7b0ee01-7ae5-4583-8c5b-d06bc23df981">In<span> </span><em>&lt;modeling tool installation directory&gt;\bin </em>folder, open the<span> </span><em>&lt;modeling tool name&gt;.properties</em><span> </span>file.</li><li data-uuid="881b0cd8-bfe9-4852-b82b-5092082e148f">In the JAVA_ARGS line, add the -<em>Ddh.sysmlv2.enabled=true </em>JAVA argument<em>.</em></li><li data-uuid="7b87d8ce-324e-4dea-b1d8-d481d6af04ee">Restart the modeling tool.</li></ol><p><br /></p>
````

<!--NOMAGIC_PAGE id=249568734 space=CDH version=2 -->
## PAGE 00425: UI components of Schema Map Manager

- page_id: `249568734`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568734/UI+components+of+Schema+Map+Manager
- version_number: 2
- version_date: `2025-11-20T11:37:19.212+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Requirement Mapping
- labels: []
...
````html
<h6 style="text-align: center;"><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png" /></ac:image></h6><h6 style="text-align: center;">The Schema Map Manager dialog.</h6><p>The following UI components in Schema Map Manager are explained in the following table</p><table class="relative-table wrapped" style="width: 99.9427%;"><colgroup><col style="width: 17.0335%;" /><col style="width: 83.0299%;" /></colgroup><tbody><tr><th>UI component</th><th>Function</th></tr><tr><td>Source Type</td><td><p>All the source types from all Data Sources currently in the system.</p></td></tr><tr><td colspan="1">Target Type</td><td colspan="1">All the target types from all Data Sources currently in the system.</td></tr><tr><td>Set as Default</td><td><div class="content-wrapper"><p>Sets the current schema configuration as the default one. After clicking, the button changes to <strong>Remove Default</strong>. Clicking<strong> Remove Default </strong>removes the schema configuration from the selected source and target types.</p></div></td></tr><tr><td>Activate (or Deactivate)</td><td><div class="content-wrapper"><p>Activates or deactivates the selected <ac:link><ri:page ri:content-title="Define Target Type from Attribute Value dialog and mapping" /><ac:plain-text-link-body><![CDATA[Define Target Type from Attribute Value ]]></ac:plain-text-link-body></ac:link>schema.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a71153dd-7a10-4dc2-9a29-931e6a2aaa8b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p><strong>Activate</strong> and <strong>Deactivate</strong> UI components apply to only the <strong>Define Target Type from Attribute Value</strong><strong> </strong>mapping option.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></div></td></tr><tr><td>Delete</td><td>Deletes the current schema configuration.</td></tr><tr><td colspan="1">Migrate</td><td colspan="1">Migrates the required scheme map to the present schema map.</td></tr><tr><td>Edit</td><td>Edits a schema map.</td></tr><tr><td>Save</td><td>Saves the editing of a schema map.</td></tr><tr><td>Cancel</td><td>Cancels the editing of a schema map.</td></tr><tr><td colspan="1">Import</td><td colspan="1">Browses a schema map file to import.</td></tr><tr><td colspan="1">Export</td><td colspan="1"><div class="content-wrapper"><p>Opens the <ac:link><ri:page ri:content-title="Exporting a schema map" /><ac:plain-text-link-body><![CDATA[Export Schema Map Wizard]]></ac:plain-text-link-body></ac:link> dialog to guide you through exporting the current schema to a file on your file system.</p></div></td></tr><tr><td colspan="1">Close</td><td colspan="1">Closes the Schema Map Manager dialog.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249567933 space=CDH version=1 -->
## PAGE 00426: Understanding DataHub user interface

- page_id: `249567933`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249567933/Understanding+DataHub+user+interface
- version_number: 1
- version_date: `2022-05-06T08:21:36.927+02:00`
- ancestors: Cameo DataHub Documentation > Getting started
- labels: []
...
Before using DataHub to connect with IBM® Rational® DOORS®, you must first [CONFLUENCE_PAGE title='Driver deployment' space=''].
...
<!--NOMAGIC_PAGE id=249568857 space=CDH version=4 -->
## PAGE 00427: Updating Teamwork Cloud projects

- page_id: `249568857`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568857/Updating+Teamwork+Cloud+projects
- version_number: 4
- version_date: `2025-12-03T10:33:37.001+01:00`
...
````html
<p>A DataHub Data Source in a Teamwork Cloud project, which is opened through Teamwork Cloud, is accessible to multiple clients. The Data Source shows the project currently open on each client’s machine.</p><p>You can add a Teamwork Cloud Data Source to DataHub Explorer. You can work on the Data Source and save the changes. Other users can also do the same things you do to the same project. Therefore, the project in the Teamwork Cloud Data Source may contain different sets of data as a result of multiple updates.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="c14e625e-22db-4657-9882-ddea545845b5"><ac:rich-text-body><p>As DataHub doesn’t support Collaborative editing, it is critical to check out the project from the server before applying any updates. Only one user can work on the project at the same time. The other user can only start working on the project after the previous user fully commits their changes to the server.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="68303b85-ec48-480a-b277-c0ae8d9c00e5"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p><span>For more details about setting Teamwork Cloud in MagicDraw<sup>®</sup>, see the MagicDraw<sup>®</sup> User Guide.</span></p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To log in to Teamwork Cloud</p><hr /><ol><li>On the MagicDraw® main menu, click <strong>Collaborate</strong> &gt;<strong> Login</strong>. The <strong>Login</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Login_Window.png" /></ac:image><br /><br /></li><li>Enter all the server connection parameters.</li><li>Click <strong>OK</strong>.<br /><br /></li></ol><p>The table below explains each connection parameter.</p><table class="relative-table wrapped" style="margin-left: 30.0px;width: 59.2408%;"><colgroup><col style="width: 31.8519%;" /><col style="width: 68.1743%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Parameter Name</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Function</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><strong>User name</strong></td><td style="margin-left: 30.0px;">Specifies a user name to connect to Teamwork Cloud.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><strong>Password </strong></td><td style="margin-left: 30.0px;">Specifies a password to connect to Teamwork Cloud.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><strong>Server name</strong></td><td style="margin-left: 30.0px;">Specifies a Teamwork Cloud server name or IP Address.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><strong>Auto Login to Server</strong></td><td style="margin-left: 30.0px;" colspan="1">Logs on to Teamwork Cloud automatically when MagicDraw<sup>®</sup> starts.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><strong>Use Secured Connection (SSL)</strong></td><td style="margin-left: 30.0px;" colspan="1">Turns on SSL encryption for data transfer.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><strong>OK</strong></td><td style="margin-left: 30.0px;" colspan="1">Confirms the connection parameters and logs in to Teamwork Cloud.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><strong>Cancel </strong></td><td style="margin-left: 30.0px;" colspan="1">Cancels the login process.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><strong>Help</strong></td><td style="margin-left: 30.0px;" colspan="1">Opens the <strong>Help</strong> dialog.</td></tr></tbody></table><p><br /></p><p>To open a Teamwork Cloud project</p><hr /><ol><li>On the MagicDraw® main menu, click <strong>Collaborate</strong> &gt; <strong>Open Server Project</strong>. The <strong>Open Server Project</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Open_Project_Window.png" /></ac:image><br /><br /></li><li>Select a particular project and click <strong>Open</strong>. MagicDraw<sup>®</sup> opens the selected project.</li></ol><p style="margin-left: 30.0px;"><br /></p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="f27058fc-d45d-47ff-b6e0-9a64c6ce2eee"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><ul><li>All users must connect to Teamwork Cloud using the same host address (IP address or machine name).</li><li>DataHub handles the items in Data Sources in compliance with Teamwork Cloud rules.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=249568125 space=CDH version=2 -->
## PAGE 00428: User Guide

- page_id: `249568125`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568125/User+Guide
- version_number: 2
- version_date: `2025-11-20T11:31:06.642+01:00`
- ancestors: Cameo DataHub Documentation
- labels: ['featured', 'documentation-space-sample']
...
<!--NOMAGIC_PAGE id=249568850 space=CDH version=4 -->
## PAGE 00429: Using DataHub in Teamwork Cloud environment

- page_id: `249568850`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568850/Using+DataHub+in+Teamwork+Cloud+environment
- version_number: 4
- version_date: `2025-11-06T08:21:54.755+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=254418894 space=CDH version=1 -->
## PAGE 00430: Versions of Cameo DataHub Documentation

- page_id: `254418894`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/254418894/Versions+of+Cameo+DataHub+Documentation
- version_number: 1
- version_date: `2025-09-11T18:50:36.982+02:00`
- ancestors: 
- labels: []

### NORMALIZED CONTENT

31811406bae2149248d5b21e808cab83
...
````html
<ac:structured-macro ac:name="scroll-document-location" ac:schema-version="1" ac:macro-id="5884a601-5867-4b5b-8317-27e204263c76"><ac:parameter ac:name="permaId">31811406bae2149248d5b21e808cab83</ac:parameter><ac:parameter ac:name="documentTitle">Cameo DataHub Documentation</ac:parameter><ac:parameter ac:name="key">documentVersions</ac:parameter></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=249569054 space=CDH version=2 -->
## PAGE 00431: Working with custom IP Classification attributes

- page_id: `249569054`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249569054/Working+with+custom+IP+Classification+attributes
- version_number: 2
- version_date: `2025-11-20T11:42:36.420+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Additional DataHub features
- labels: []
...
<!--NOMAGIC_PAGE id=249568467 space=CDH version=2 -->
## PAGE 00432: Working with Data Sources

- page_id: `249568467`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568467/Working+with+Data+Sources
- version_number: 2
- version_date: `2025-11-20T11:34:50.462+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Before connecting a Data Source to a driver, you need to have the<strong> DataHub Explorer</strong> tab open in MagicDraw<sup>®</sup>.</p><p>To open <strong>DataHub Explorer</strong></p><hr /><ol><li data-uuid="ee0e2485-df61-4dd7-829c-ce5e92e2bd2e">Start MagicDraw<sup>®</sup> and create a new project or open an existing one.</li><li data-uuid="8c816234-0027-40ca-8214-90d82c6da75b">From the MagicDraw<sup>®</sup> main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="4a3bfa82-0bb1-4b85-9474-03162e9e93dc" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=249568635 space=CDH version=3 -->
## PAGE 00433: Working with OSLC features

- page_id: `249568635`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568635/Working+with+OSLC+features
- version_number: 3
- version_date: `2025-11-20T11:36:18.848+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The modeling tool can link and share data using Open Services for Lifecycle Collaboration (OSLC) integration that allows the following</p><ul><li data-uuid="6e882524-d6b8-4651-8a05-28fbd5804c48">The modeling environment to work smoothly in the IBM Jazz ecosystem.</li><li data-uuid="49196ca9-213a-4683-864d-87b4c6982f08">Linking different project lifecycle artifacts in different tools without additional plugins needed.</li><li data-uuid="3934c449-713b-4261-b462-6f1e02c22407">Seeing information details of linked artifacts without switching between different tools. </li></ul><p>The following chapters describe how the modeling tool works with OSLC:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f1b328bc-fea4-4637-8557-0d096f85deb0" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="f5bdfd60-1095-47ef-b88c-8fe5f212bcf6"><ac:link><ri:page ri:content-title="Working with Data Sources" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=253046173 space=CDH version=22 -->
## PAGE 00434: Working with revisions for ENOVIA Requirements

- page_id: `253046173`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/253046173/Working+with+revisions+for+ENOVIA+Requirements
- version_number: 22
- version_date: `2025-11-20T11:35:33.320+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with Data Sources > Adding Data Sources for ENOVIA Requirements
- labels: []
...
1. Add an ENOVIARequirementsData Source (to learn more, refer to the [CONFLUENCE_PAGE title='Adding Data Sources for ENOVIA Requirements' space=''] page).
2. Do one of the following:
  - Click **Synchronization**in the Cameo DataHub Explorer Panel.
  - Right-click the node and select the **Check for Change** command from the contextual menu.
3. Collapse the data source, right-click it, and select **Reload**.
...
````html
<p>When ENOVIA Requirements are synchronized with the modeling tool through the Cameo DataHub <span style="color:var(--ds-text,#172b4d);">Plugin</span>, revisions may change over time as the requirements evolve. To ensure traceability and accuracy, it is important to understand how revisions are handled within the Cameo DataHub <span style="color:var(--ds-text,#172b4d);">Plugin</span>. Revisions can be updated automatically or manually, depending on whether you are working within or outside the parent node.</p><h3>Working with the revision within the parent node</h3><p><span>A Requirement Specification revised inside a Specification Folder in ENOVIA Requirements is automatically synchronized in the modeling tool. The DHLinks update seamlessly to the revised version without a manual DHLink transfer.</span></p><p>To update the revision while working within the parent node</p><hr /><ol><li data-uuid="11feadcf-bdda-450d-9250-41bb827848db"><span><span style="color:var(--ds-text,#172b4d);">Add an ENOVIA </span><span style="color:var(--ds-text,#172b4d);">Requirements </span><span style="color:var(--ds-text,#172b4d);">Data Source (to learn more, refer to the </span></span><ac:link><ri:page ri:content-title="Adding Data Sources for ENOVIA Requirements" /><ac:plain-text-link-body><![CDATA[Adding ENOVIA Requirements Data Source]]></ac:plain-text-link-body></ac:link> page).</li><li data-uuid="2b70dfdf-931d-409f-b79d-7c2a7b2e3e50"><p>Do one of the following:</p><ul><li><p>Click <strong>Synchronization </strong>in the Cameo DataHub Explorer Panel.</p></li><li><p>Right-click the node and select the <strong>Check for Change</strong> command from the contextual menu.</p></li></ul></li><li data-uuid="140c4b55-5253-4ef5-a09a-78f6ee1c0798"><p>Collapse the data source, right-click it, and select <strong>Reload</strong>.</p></li></ol><p>The revised Requirement Specification is automatically updated in the modeling tool and the Cameo DataHub Explorer Panel.</p><h3>Working with the revision outside the parent node</h3><p> A Requirement Specification revised <strong>outside of any Specification Folder</strong> results in two separate objects (old revision and new revision) being displayed in the Cameo DataHub Explorer Panel. You must manually transfer DHLinks to the new revision.</p><p>To update the revision while working outside the parent node</p><hr /><ol><li data-uuid="1c5ff517-0761-46b6-a33a-230b75daf0fd"><span><span style="color:var(--ds-text,#172b4d);">Add an ENOVIA </span><span style="color:var(--ds-text,#172b4d);">Requirements </span><span style="color:var(--ds-text,#172b4d);">Data Source (to learn more, refer to the </span></span><ac:link><ri:page ri:content-title="Adding Data Sources for ENOVIA Requirements" /><ac:plain-text-link-body><![CDATA[Adding ENOVIA Requirements Data Source]]></ac:plain-text-link-body></ac:link> page).</li><li data-uuid="75a058c6-8c07-4287-ae6e-87ea9047a281"><span>Right-click the data source and select <strong>Reload</strong>.</span></li><li data-uuid="085afee4-55f8-4b60-95e1-d505b1a28de6"><p><span>Right-click the new revision and s</span><span>elect the </span><strong>Transfer DHLink from other revision </strong>command from the contextual menu.<br /><br /><ac:image><ri:attachment ri:filename="Transfer DHLink from other revision.png" /></ac:image><br /><br /></p></li><li data-uuid="09ebda28-849c-4632-856e-bf9fe6cc88b9">In the Transfer DHLink from other revision dialog, select the required revision.<br /><br /><ac:image><ri:attachment ri:filename="Transfer DHLink from other revision_Dialog.png" /></ac:image><br /><br /></li><li data-uuid="04abd424-bd21-432b-a4db-a3ec3c95afbb">In the Transfer Link Confirmation dialog, click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Transfer Link Confirmation dialog.png" /></ac:image><br /><br /></li><li data-uuid="04410449-9540-4d3a-b424-7f31aaec622a"><span>Run </span><strong>Synchronization</strong><span> to update the modeling tool based on the revised specification.</span></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="f864c77e-fc4e-4ed5-9622-8737b7592b3c"><ac:rich-text-body><p>If the parent node is out of scope and if the DHLink transfer is not possible, the following error message is displayed.<br /><br /><ac:image><ri:attachment ri:filename="Error message.png" /></ac:image></p></ac:rich-text-body></ac:structured-macro><p><br /></p>
````

<!--NOMAGIC_PAGE id=249568270 space=CDH version=3 -->
## PAGE 00435: Working with the DataHub Explorer tree

- page_id: `249568270`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568270/Working+with+the+DataHub+Explorer+tree
- version_number: 3
- version_date: `2025-11-20T11:31:31.723+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=249568799 space=CDH version=2 -->
## PAGE 00436: Working with the DHLink summary and generating reports

- page_id: `249568799`
- space_key: `CDH`
- source_url: https://docs.nomagic.com/spaces/CDH/pages/249568799/Working+with+the+DHLink+summary+and+generating+reports
- version_number: 2
- version_date: `2025-11-20T11:37:57.656+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You can review DHLinks and make filtering options in terms of selected driver, direction of synchronization, sources and targets, types, status, and DHTrace, to display all interconnected relations through the <ac:link><ri:page ri:content-title="DHLink Summary" /><ac:link-body><strong>DHLink summary</strong> dialog</ac:link-body></ac:link>. With the shortcut menu in the DHLink Summary dialog, you can remove DHLinks, change synchronization directions, or select nodes from DataHub Explorer/Alias Explorer or in their original applications. You can also save the DHLink summary as an HTML report and open it in browsers.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="c7a7334e-fde4-4787-bbf4-d8e83c541949" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````
