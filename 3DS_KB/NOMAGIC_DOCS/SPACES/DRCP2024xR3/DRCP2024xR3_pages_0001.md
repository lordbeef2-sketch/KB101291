# NOMAGIC DOCUMENTATION SPACE: DDS Real-Time Communication Plugin 2024x Refresh3

<!--NOMAGIC_SPACE key=DRCP2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227178865 space=DRCP2024xR3 version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `227178865`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178865/Applying+DDS+Sterotypes
- version_number: 1
...
First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='DRCP2024xR3']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='DRCP2024xR3']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024xR3']>]]>
...
````html
<p>The Domain can be created by using the <span style="color: rgb(62,63,64);">DDS Domain Table. As shown in the following table, the Smart Home DDS Domain is created with specified its id, topics, participants and participant instances. <a href="https://docs.nomagic.com/display/DRCP2024xR3/Defining+Domains+and+Domain+Participants#DefiningDomainsandDomainParticipants-CreatingDomainandDomainParticipantsbyusingtheDDSDomainTable">How to create DDS Domain Table&gt;&gt;</a></span></p><p><span style="color: rgb(62,63,64);"><ac:image ac:align="center"><ri:attachment ri:filename="domain_table.png"><ri:page ri:content-title="Creating the domain" ri:space-key="DRCP2024xR3" /></ri:attachment></ac:image></span></p><h6 style="text-align: center;"><span style="color: rgb(62,63,64);">The example of DDS Domain Table.</span></h6><p class="auto-cursor-target"><span><span><span style="color: rgb(62,63,64);">The Participant Instances derived column displays all the instances that will be in the the DDS XML. </span>Now we are ready to export the model if we desire, but first we need to assign quality of service requirements on the DDS elements.</span><br /></span></p><p class="auto-cursor-target"><span><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=227178813 space=DRCP2024xR3 version=1 -->
## PAGE 00004: DDS Real-Time Communication Plugin

- page_id: `227178813`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178813/DDS+Real-Time+Communication+Plugin
- version_number: 1
- version_date: `2024-10-07T15:38:44.221+02:00`
- ancestors: 
...
<!--NOMAGIC_PAGE id=227178835 space=DRCP2024xR3 version=1 -->
## PAGE 00005: Defining Domain Participant communication

- page_id: `227178835`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178835/Defining+Domain+Participant+communication
- version_number: 1
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2024xR3'] , right-click a Package wherein you want to create Domain Participants or Domain.
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2024xR3'] , right-click a predefined Domain Package.
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024xR3'] 
[IMAGE alt='' src='']
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2024xR3'] , right-click a Block which will be the owner of the instances.
2. From the shortcut menu, select Create Diagram and from the opened dialog, select SysML Internal Block Diagram.
3. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] select a property (e.g. Part Property) and click on the diagram pane.
...
1. Double-click the Part Property to open it's [CONFLUENCE_PAGE title='Specification window' space='MD2024xR3'] .
...
1. In the [CONFLUENCE_PAGE title='Model Browser' space='MD2024xR3'] , select the owner for the new diagram.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] , select a type you need and click on DDS Module element.
2. Type its name.
3. Click the Create Member [CONFLUENCE_PAGE title='Smart manipulators' space='MD2024xR3'] to create a Members for the type.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] , select a Topic and click on the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] .
2. Type its name.
3. Click the Create Element [CONFLUENCE_PAGE title='Smart manipulators' space='MD2024xR3'] to create a Topic Type Property or Reception for the Topic.
...
<!--NOMAGIC_PAGE id=227178875 space=DRCP2024xR3 version=1 -->
## PAGE 00009: Domain Participant without Instance

- page_id: `227178875`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178875/Domain+Participant+without+Instance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178876 space=DRCP2024xR3 version=1 -->
## PAGE 00010: Duplicate Domain ID

- page_id: `227178876`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178876/Duplicate+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178877 space=DRCP2024xR3 version=1 -->
## PAGE 00011: Endpoint not Referenced

- page_id: `227178877`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178877/Endpoint+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178857 space=DRCP2024xR3 version=1 -->
## PAGE 00012: Environment setup

- page_id: `227178857`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178857/Environment+setup
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178863 space=DRCP2024xR3 version=1 -->
## PAGE 00013: Example Model

- page_id: `227178863`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178863/Example+Model
- version_number: 1
...
````html
<p class="FirstParagraph">HomeControler.mdzip contains a model that describes a system that consists of an air conditioner unit, a dehumidifiers, shutters and a light sensor. The air conditioner and the dehumidifier both contain a controller and a sensor component. The system is supervised by the Home Controller whose main responsibility is to monitor data received from the components and to control them.</p><p class="FirstParagraph"><ac:image ac:align="center"><ri:attachment ri:filename="ibd_homeControlerSystem.png"><ri:page ri:content-title="Example Model" ri:space-key="DRCP2024xR3" /></ri:attachment></ac:image></p><h6 class="FirstParagraph" style="text-align: center;">The SysmL Internal Block Diagram of Home Controller environment.</h6>
````

<!--NOMAGIC_PAGE id=227178872 space=DRCP2024xR3 version=2 -->
## PAGE 00014: Exporting DDS Control Example to XML

- page_id: `227178872`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178872/Exporting+DDS+Control+Example+to+XML
- version_number: 2
- version_date: `2025-05-06T14:50:29.203+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []

### NORMALIZED CONTENT

You can export the DDS examples to XML. For this, follow the procedures provided in the page [Exporting DDS XML](https://docs.nomagic.com/display/DRCP2024xR3/Exporting+DDS+XML).

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can export the DDS examples to XML. For this, follow the procedures provided in the page <a class="current" style="letter-spacing: 0.0px;" href="https://docs.nomagic.com/display/DRCP2024xR3/Exporting+DDS+XML">Exporting DDS XML</a>.</p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227178843 space=DRCP2024xR3 version=2 -->
## PAGE 00015: Exporting DDS XML

- page_id: `227178843`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178843/Exporting+DDS+XML
- version_number: 2
- version_date: `2025-05-06T14:50:28.734+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] , select Tools > DDS > Generate DDS XML .
...
<!--NOMAGIC_PAGE id=227178862 space=DRCP2024xR3 version=1 -->
## PAGE 00018: Home Control Example

- page_id: `227178862`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178862/Home+Control+Example
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178878 space=DRCP2024xR3 version=1 -->
## PAGE 00019: Illegal Inheritance

- page_id: `227178878`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178878/Illegal+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178819 space=DRCP2024xR3 version=1 -->
## PAGE 00020: Importing DDS Profile and DDS Style in Other Projects

- page_id: `227178819`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178819/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] , select Tools > DDS > Import DDS XML.
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='DRCP2024xR3'] to import them.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] , select Tools > DDS > Import QoS Profile .
...
<!--NOMAGIC_PAGE id=227178856 space=DRCP2024xR3 version=1 -->
## PAGE 00024: Install for simulation

- page_id: `227178856`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178856/Install+for+simulation
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178814 space=DRCP2024xR3 version=2 -->
## PAGE 00025: Installation

- page_id: `227178814`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178814/Installation
- version_number: 2
- version_date: `2025-05-06T14:50:28.363+02:00`
- ancestors: DDS Real-Time Communication Plugin
...
1. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='MD2024xR3'] .
2. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='SYSMLP2024xR3'] .
3. Start MagicDraw.
...
<!--NOMAGIC_PAGE id=227178881 space=DRCP2024xR3 version=1 -->
## PAGE 00027: Invalid Member Multiplicity

- page_id: `227178881`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178881/Invalid+Member+Multiplicity
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178882 space=DRCP2024xR3 version=1 -->
## PAGE 00028: Invalid Member Type

- page_id: `227178882`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178882/Invalid+Member+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178883 space=DRCP2024xR3 version=1 -->
## PAGE 00029: Invalid Port Type

- page_id: `227178883`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178883/Invalid+Port+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178884 space=DRCP2024xR3 version=1 -->
## PAGE 00030: Invalid Repository

- page_id: `227178884`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178884/Invalid+Repository
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178885 space=DRCP2024xR3 version=1 -->
## PAGE 00031: Invalid Topic Type Property Direction

- page_id: `227178885`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178885/Invalid+Topic+Type+Property+Direction
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178886 space=DRCP2024xR3 version=1 -->
## PAGE 00032: Missing Domain Attribute

- page_id: `227178886`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178886/Missing+Domain+Attribute
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178887 space=DRCP2024xR3 version=1 -->
## PAGE 00033: Missing Domain ID

- page_id: `227178887`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178887/Missing+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178888 space=DRCP2024xR3 version=1 -->
## PAGE 00034: Missing Element Name

- page_id: `227178888`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178888/Missing+Element+Name
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178889 space=DRCP2024xR3 version=1 -->
## PAGE 00035: Multiple Struct Inheritance

- page_id: `227178889`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178889/Multiple+Struct+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178890 space=DRCP2024xR3 version=1 -->
## PAGE 00036: Multitype Topic

- page_id: `227178890`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178890/Multitype+Topic
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178891 space=DRCP2024xR3 version=1 -->
## PAGE 00037: Non-Nmeric Domain ID

- page_id: `227178891`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178891/Non-Nmeric+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178892 space=DRCP2024xR3 version=1 -->
## PAGE 00038: Participant Type not Referenced

- page_id: `227178892`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178892/Participant+Type+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178870 space=DRCP2024xR3 version=1 -->
## PAGE 00039: Qos Assignments

- page_id: `227178870`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178870/Qos+Assignments
- version_number: 1
...
The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='DRCP2024xR3']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:content-title="QoS profile assignments" ri:space-key="DRCP2024xR3" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:content-title="Qos Assignments" ri:space-key="DRCP2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=227178837 space=DRCP2024xR3 version=2 -->
## PAGE 00040: QoS profile assignments

- page_id: `227178837`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178837/QoS+profile+assignments
- version_number: 2
- version_date: `2025-05-06T14:50:28.646+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
...
<!--NOMAGIC_PAGE id=227178855 space=DRCP2024xR3 version=1 -->
## PAGE 00042: Simulation with Simulink

- page_id: `227178855`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178855/Simulation+with+Simulink
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178893 space=DRCP2024xR3 version=1 -->
## PAGE 00043: Struct Member Visibility

- page_id: `227178893`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178893/Struct+Member+Visibility
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178894 space=DRCP2024xR3 version=1 -->
## PAGE 00044: Topic Missing from Domain

- page_id: `227178894`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178894/Topic+Missing+from+Domain
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178861 space=DRCP2024xR3 version=1 -->
## PAGE 00045: Type mapping

- page_id: `227178861`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178861/Type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178895 space=DRCP2024xR3 version=1 -->
## PAGE 00046: Unspecified String Bounds

- page_id: `227178895`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178895/Unspecified+String+Bounds
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178896 space=DRCP2024xR3 version=1 -->
## PAGE 00047: Unspecified String Bounds of Map Key

- page_id: `227178896`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178896/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178897 space=DRCP2024xR3 version=1 -->
## PAGE 00048: Unsupported Discriminator Type

- page_id: `227178897`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178897/Unsupported+Discriminator+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178853 space=DRCP2024xR3 version=2 -->
## PAGE 00049: Validation

- page_id: `227178853`
- space_key: `DRCP2024xR3`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR3/pages/227178853/Validation
- version_number: 2
- version_date: `2025-05-06T14:50:28.945+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
- labels: []
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='DRCP2024xR3'].
...
The severity is either error or warning. Warning means that the state is not necessarily incorrect, but probably is. The implementation, qualified name, and abbreviation are given because those are the identifiers modeling tool provides for a validation rule, so this document is searchable by either. [CONFLUENCE_PAGE title='Validation' space='MD2024xR3']>]]>
