# NOMAGIC DOCUMENTATION SPACE: DDS Real-Time Communication Plugin 2024x

<!--NOMAGIC_SPACE key=DRCP2024x chunk=1 -->

<!--NOMAGIC_PAGE id=137987981 space=DRCP2024x version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `137987981`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987981/Applying+DDS+Sterotypes
- version_number: 1
...
First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='DRCP2024x']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='DRCP2024x']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024x']>]]>
...
<!--NOMAGIC_PAGE id=137987951 space=DRCP2024x version=1 -->
## PAGE 00005: Defining Domain Participant communication

- page_id: `137987951`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987951/Defining+Domain+Participant+communication
- version_number: 1
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024x'] 
[IMAGE alt='' src='']
...
<!--NOMAGIC_PAGE id=137987991 space=DRCP2024x version=1 -->
## PAGE 00009: Domain Participant without Instance

- page_id: `137987991`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987991/Domain+Participant+without+Instance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987992 space=DRCP2024x version=1 -->
## PAGE 00010: Duplicate Domain ID

- page_id: `137987992`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987992/Duplicate+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987993 space=DRCP2024x version=1 -->
## PAGE 00011: Endpoint not Referenced

- page_id: `137987993`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987993/Endpoint+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987973 space=DRCP2024x version=1 -->
## PAGE 00012: Environment setup

- page_id: `137987973`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987973/Environment+setup
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987979 space=DRCP2024x version=1 -->
## PAGE 00013: Example Model

- page_id: `137987979`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987979/Example+Model
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987988 space=DRCP2024x version=1 -->
## PAGE 00014: Exporting DDS Control Example to XML

- page_id: `137987988`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987988/Exporting+DDS+Control+Example+to+XML
- version_number: 1
- version_date: `2023-09-22T12:23:34.426+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []

### NORMALIZED CONTENT

You can export the DDS examples to XML. For this, follow the procedures provided in the page [Exporting DDS XML](https://docs.nomagic.com/display/DRCP2024x/Exporting+DDS+XML).

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can export the DDS examples to XML. For this, follow the procedures provided in the page <a class="current" style="letter-spacing: 0.0px;" href="https://docs.nomagic.com/display/DRCP2024x/Exporting+DDS+XML">Exporting DDS XML</a>.</p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=137987959 space=DRCP2024x version=1 -->
## PAGE 00015: Exporting DDS XML

- page_id: `137987959`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987959/Exporting+DDS+XML
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987978 space=DRCP2024x version=1 -->
## PAGE 00018: Home Control Example

- page_id: `137987978`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987978/Home+Control+Example
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987994 space=DRCP2024x version=1 -->
## PAGE 00019: Illegal Inheritance

- page_id: `137987994`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987994/Illegal+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987935 space=DRCP2024x version=1 -->
## PAGE 00020: Importing DDS Profile and DDS Style in Other Projects

- page_id: `137987935`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987935/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='DRCP2024x'] to import them.
...
<!--NOMAGIC_PAGE id=137987972 space=DRCP2024x version=1 -->
## PAGE 00024: Install for simulation

- page_id: `137987972`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987972/Install+for+simulation
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987930 space=DRCP2024x version=1 -->
## PAGE 00025: Installation

- page_id: `137987930`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987930/Installation
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987996 space=DRCP2024x version=1 -->
## PAGE 00026: Instance not Participant

- page_id: `137987996`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987996/Instance+not+Participant
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987929 space=DRCP2024x version=1 -->
## PAGE 00027: Introduction

- page_id: `137987929`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987929/Introduction
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987997 space=DRCP2024x version=1 -->
## PAGE 00028: Invalid Member Multiplicity

- page_id: `137987997`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987997/Invalid+Member+Multiplicity
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987998 space=DRCP2024x version=1 -->
## PAGE 00029: Invalid Member Type

- page_id: `137987998`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987998/Invalid+Member+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987999 space=DRCP2024x version=1 -->
## PAGE 00030: Invalid Port Type

- page_id: `137987999`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987999/Invalid+Port+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988000 space=DRCP2024x version=1 -->
## PAGE 00031: Invalid Repository

- page_id: `137988000`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988000/Invalid+Repository
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988001 space=DRCP2024x version=1 -->
## PAGE 00032: Invalid Topic Type Property Direction

- page_id: `137988001`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988001/Invalid+Topic+Type+Property+Direction
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988002 space=DRCP2024x version=1 -->
## PAGE 00033: Missing Domain Attribute

- page_id: `137988002`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988002/Missing+Domain+Attribute
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988003 space=DRCP2024x version=1 -->
## PAGE 00034: Missing Domain ID

- page_id: `137988003`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988003/Missing+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988004 space=DRCP2024x version=1 -->
## PAGE 00035: Missing Element Name

- page_id: `137988004`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988004/Missing+Element+Name
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988005 space=DRCP2024x version=1 -->
## PAGE 00036: Multiple Struct Inheritance

- page_id: `137988005`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988005/Multiple+Struct+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988006 space=DRCP2024x version=1 -->
## PAGE 00037: Multitype Topic

- page_id: `137988006`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988006/Multitype+Topic
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988007 space=DRCP2024x version=1 -->
## PAGE 00038: Non-Nmeric Domain ID

- page_id: `137988007`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988007/Non-Nmeric+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988008 space=DRCP2024x version=1 -->
## PAGE 00039: Participant Type not Referenced

- page_id: `137988008`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988008/Participant+Type+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987986 space=DRCP2024x version=1 -->
## PAGE 00040: Qos Assignments

- page_id: `137987986`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987986/Qos+Assignments
- version_number: 1
...
The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='DRCP2024x']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="Qos Assignments" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=137987953 space=DRCP2024x version=1 -->
## PAGE 00041: QoS profile assignments

- page_id: `137987953`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987953/QoS+profile+assignments
- version_number: 1
...
````html
<p class="FirstParagraph">There are three elements that QoS Profiles can be assigned to in the model:</p><ul><li class="FirstParagraph">Endpoints typed by Topic.</li><li class="FirstParagraph">DomainParticipants.</li><li class="FirstParagraph">Topics.</li></ul><p><br /></p><p>To create an empty Endpoint QoS Assignment Table</p><hr /><ol><li>In the <a href="https://docs.nomagic.com/display/MD2022xR2/Containment+tab">Containment tree</a>, right-click a predefined <em>Endpoint QoS </em>Package.</li><li>From the shortcut menu, select <strong>Create Diagram </strong>and from the opened dialog, select Endpoint QoS Assignment Table.</li><li>The unnamed table is created. Type its name and press enter.</li></ol><p><br /></p><p>To fill in the Endpoint QoS Assignment Table</p><hr /><ol><li>From the table toolbar, click the <strong>Add New</strong> button. The new row appears and Endpoint QoS Assignment element is created in the model.</li><li><p class="auto-cursor-target">In the table, specify the following:<br /> - Double-click the <strong>Name</strong> cell and type Endpoint QoS Assignment name.<br /> - Double-click the <strong>QoS Profile</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Elements</strong> dialog choose QoS Profile.<br /> - Double-click the <strong>Endpoint</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Port </strong>dialog choose already created ports or use the <strong>Creation Mode</strong> to create new port.<br /> - Double-click the <strong>Domain Participant Instance</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Property </strong>dialog choose already created Part Properties or use the <strong>Creation Mode</strong> to create new Part Property.</p></li></ol><p class="FirstParagraph"><span><br /></span></p><p class="FirstParagraph"><span>Assigning QoS on subscribers/publishers is not possible since they are derived from the model and not explicitly marked.</span></p><ul><li>To assign QoS Profiles on Topics create a Topic QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="topic_qos_assignemnt_table_example.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Domain Participants create a Participant QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="participant_qos_assignment.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Endpoints create a Endpoint QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="endpoint_Qos_assignment_table.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li></ul>
````

<!--NOMAGIC_PAGE id=137987976 space=DRCP2024x version=1 -->
## PAGE 00042: Setting up the Simulink model

- page_id: `137987976`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987976/Setting+up+the+Simulink+model
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987971 space=DRCP2024x version=1 -->
## PAGE 00043: Simulation with Simulink

- page_id: `137987971`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987971/Simulation+with+Simulink
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988009 space=DRCP2024x version=1 -->
## PAGE 00044: Struct Member Visibility

- page_id: `137988009`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988009/Struct+Member+Visibility
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988010 space=DRCP2024x version=1 -->
## PAGE 00045: Topic Missing from Domain

- page_id: `137988010`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988010/Topic+Missing+from+Domain
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987977 space=DRCP2024x version=1 -->
## PAGE 00046: Type mapping

- page_id: `137987977`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987977/Type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988011 space=DRCP2024x version=1 -->
## PAGE 00047: Unspecified String Bounds

- page_id: `137988011`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988011/Unspecified+String+Bounds
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988012 space=DRCP2024x version=1 -->
## PAGE 00048: Unspecified String Bounds of Map Key

- page_id: `137988012`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988012/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
...
<!--NOMAGIC_PAGE id=137988013 space=DRCP2024x version=1 -->
## PAGE 00049: Unsupported Discriminator Type

- page_id: `137988013`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137988013/Unsupported+Discriminator+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137987969 space=DRCP2024x version=1 -->
## PAGE 00050: Validation

- page_id: `137987969`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987969/Validation
- version_number: 1
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='DRCP2024x'].
...
````html
<p class="FirstParagraph"><span lang="EN">The validity of the DDS model is continuously checked by active validation rules contained in the DDS Validation Suite. For example, if you accidentally add multiple attributes to a Topic, an error is displayed. You can fix some of these DDS modeling problems by right-clicking on them and selecting the appropriate solver.</span></p><p class="FirstParagraph"><span lang="EN"><ac:image><ri:attachment ri:filename="image2020-11-12_15-7-35.png"><ri:page ri:space-key="DRCP2024x" ri:content-title="Validation" /></ri:attachment></ac:image></span></p><p class="FirstParagraph"><br /></p><p class="FirstParagraph"><span lang="EN"><span><span>There is a separate validation suite for Simulink named DDS Simulink Validation Suite. It contains validation rules for data types that are not supported by Simulink. It can be activated independently from the rest of the rules.</span></span></span></p><p>The detailed descriptions of the validation rules are available in <ac:link><ri:page ri:space-key="DRCP2024x" ri:content-title="Validation Suite" /></ac:link>.</p><p><br /></p><p><ac:link><ri:page ri:space-key="MD2022xR2" ri:content-title="Validation" /><ac:plain-text-link-body><![CDATA[Learn more about Validation >>]]></ac:plain-text-link-body></ac:link></p><p>.</p><p class="FirstParagraph"><span lang="EN"><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=137987989 space=DRCP2024x version=1 -->
## PAGE 00051: Validation Suite

- page_id: `137987989`
- space_key: `DRCP2024x`
- source_url: https://docs.nomagic.com/spaces/DRCP2024x/pages/137987989/Validation+Suite
- version_number: 1
