# NOMAGIC DOCUMENTATION SPACE: Cameo Requirements Modeler Plugin 2024x Refresh3

<!--NOMAGIC_SPACE key=CRMP2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227170720 space=CRMP2024xR3 version=2 -->
## PAGE 00001: 2024x Refresh2 Version News

- page_id: `227170720`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170720/2024x+Refresh2+Version+News
- version_number: 2
- version_date: `2026-02-09T16:13:17.677+01:00`
...
````html
<h5 style="line-height: 1.66667;letter-spacing: normal;text-align: center;">Cameo Requirements Modeler Plugin</h5><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: November 8, 2024</span></p><p style="margin-top: 0.0px;">The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p>
````

<!--NOMAGIC_PAGE id=227170721 space=CRMP2024xR3 version=5 -->
## PAGE 00002: 2024x Refresh3 Version News

- page_id: `227170721`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170721/2024x+Refresh3+Version+News
- version_number: 5
- version_date: `2026-02-09T16:13:10.929+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="text-align: center;">Cameo Requirements Modeler Plugin</h1><p style="text-align: center;"><span style="color:var(--ds-chart-gray-bold,#8590a2);">Released on: July 11, 2025</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p>The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170715 space=CRMP2024xR3 version=1 -->
## PAGE 00003: _buttons

- page_id: `227170715`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170715/_buttons
- version_number: 1
- version_date: `2025-05-05T13:18:47.435+02:00`
- ancestors: 
- labels: []
...
<!--NOMAGIC_PAGE id=227170717 space=CRMP2024xR3 version=1 -->
## PAGE 00004: _sample models

- page_id: `227170717`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170717/_sample+models
- version_number: 1
- version_date: `2025-05-05T13:18:47.493+02:00`
- ancestors: 
- labels: []
...
<!--NOMAGIC_PAGE id=227170834 space=CRMP2024xR3 version=2 -->
## PAGE 00005: Analyzing dependencies in dependency matrix

- page_id: `227170834`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170834/Analyzing+dependencies+in+dependency+matrix
- version_number: 2
- version_date: `2026-02-09T16:27:52.370+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You can create, analyze, and modify requirement relations in the matrix, which provides a compact visual view for analysis. Using a dependency matrix, you can also edit relations between a selected requirement and model element (i.e., add or remove a desired relation).</p><p>The Dependency Matrix enables:</p><ul><li>The visualization of more than one element relations from different diagrams.</li><li>The capability to create domain-specific matrices and their templates. </li><li>Ready-to-use matrix templates: traceability of elements and behavior diagrams, traceability of requirements, traceability of requirements and elements refining, satisfying, verifying them, and others.</li><li>Faster creation of traceability links between elements (for example, between requirements and the architecture or requirements and test cases). This improvement saves a huge amount of time in comparison to linking elements in diagrams.</li></ul><p>To create a dependency matrix</p><hr /><ol><li><span style="color:var(--ds-text,#333333);">From a requirements specification package shortcut menu in the Containment tree, select <strong>Create</strong><strong> Diagram</strong> and then select one of the following:<br /></span><ul><li><strong>Derive</strong><strong> Requirement</strong><strong> Matrix</strong> to create a Dependency Matrix to analyze, create, and modify derivation relations between a derived requirement and a source requirement.</li><li><strong>Refine </strong><strong>Requirement </strong><strong>Matrix</strong> to create a Dependency Matrix to analyze, create, and modify refined relations between a requirement and a model element or a set of elements refining the requirement.</li><li><strong>Satisfy Requirement Matrix</strong> to create a Dependency Matrix to analyze, create, and modify satisfaction relations between requirements and model elements fulfilling the requirements.</li><li><span style="color:var(--ds-text,#333333);"><strong>Verify Requirement Matrix</strong> to create a Dependency Matrix to analyze, create, or modify verification relations between requirements and named elements that can determine whether the systems fulfill the requirements.</span></li></ul></li><li><span style="color:var(--ds-text,#333333);">Type a diagram name.</span></li><li><p class="auto-cursor-target"><span style="color:var(--ds-text,#333333);">Select criteria and a scope to be represented in the matrix.<br /></span></p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="11eae72e-474b-44bb-a0cd-f3e032497cc0"><ac:rich-text-body><p><span style="color:var(--ds-text,#333333);">You can specify requirements to be represented as rows and class elements to be represented as columns.</span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><span class="auto-cursor-target" style="color:var(--ds-text,#333333);"> </span></p></li><li><span style="color:var(--ds-text,#333333);">Click the <strong>Refresh</strong> button.<br />The following figure shows how particular requirements satisfy particular model class elements.</span></li></ol><p><span style="color:var(--ds-text,#333333);"><ac:image ac:align="center"><ri:attachment ri:filename="dependency_matrix_example.png" /></ac:image></span></p><h6 style="text-align: center;"><span style="color:var(--ds-text,#333333);">Example of a dependency matrix.</span></h6><p style="text-align: left;"><br class="atl-forced-newline" /><span style="color:var(--ds-text,#333333);">  You can also remove redundant or create missing dependencies using a dependency matrix. For detailed instructions on how to use dependency matrixes, see<ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Dependency Matrix" /><ac:plain-text-link-body><![CDATA[ Dependency Matrix]]></ac:plain-text-link-body></ac:link>.</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p class="auto-cursor-target"><strong>Related pages</strong></p><ul><li><span style="color:var(--ds-text,#333333);"><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Dependency Matrix" /></ac:link></span></li><li><ac:link><ri:page ri:content-title="Requirement matrices" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170836 space=CRMP2024xR3 version=2 -->
## PAGE 00006: Analyzing dependencies in relation map

- page_id: `227170836`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170836/Analyzing+dependencies+in+relation+map
- version_number: 2
- version_date: `2026-02-09T16:27:59.806+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
````html
<p>A relation map allows visual analysis among multiple levels of abstraction, such as how requirements are satisfied by other model elements. The relation map enables you to show existing relationships, visualize multilevel relationships, observe traceability from requirements to implementation, or any other analysis you need.</p><p>The relation map is useful for:</p><ul><li>Making fast analysis and overview of a model.</li><li>Observing traceability from requirements to implementation all the way through different levels of abstraction (such as analysis, design, etc.).</li><li>Discovering the requirements structure.</li></ul><p><br /></p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="cf772b43-daa8-457f-a7be-4f2eec2a0a7e"><ac:rich-text-body><p>You are not allowed to edit relations in the relation map diagram.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p><span style="color:var(--ds-text,#333333);">To create a relation map</span></p><hr /><ol><li><span style="color:var(--ds-text,#333333);">From a package or requirement shortcut menu in the Containment tree, select <strong>Create Diagram</strong> and then select one of the following:<br /></span><ul><li><strong>Requirement Containment Map</strong>.</li><li class="auto-cursor-target"><strong>Requirement Derivation Map</strong>.</li></ul></li><li><span style="color:var(--ds-text,#333333);">Type a diagram name.</span></li><li><span style="color:var(--ds-text,#333333);">Specify a relation criterion, element type, and scope.</span></li><li><span style="color:var(--ds-text,#333333);">Click the <strong>Refresh</strong> button.<br />The following figure shows how particular requirements satisfy particular model class elements.</span></li></ol><p><span style="color:var(--ds-text,#333333);"><ac:image ac:align="center"><ri:attachment ri:filename="relation_map_example.png" /></ac:image><br /></span></p><h6 style="text-align: center;"><span style="color:var(--ds-text,#333333);">Example of relation map</span></h6><p>For detailed instructions on how to use relation maps, see <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Relation Map" /></ac:link>.</p>
````

<!--NOMAGIC_PAGE id=227170821 space=CRMP2024xR3 version=2 -->
## PAGE 00007: Analyzing Requirements

- page_id: `227170821`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170821/Analyzing+Requirements
- version_number: 2
- version_date: `2026-02-09T16:27:32.490+01:00`
...
<!--NOMAGIC_PAGE id=227170877 space=CRMP2024xR3 version=2 -->
## PAGE 00008: Applying  «invariant» and «validationRule» stereotype

- page_id: `227170877`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170877/Applying+%C2%ABinvariant%C2%BB+and+%C2%ABvalidationRule%C2%BB+stereotype
- version_number: 2
- version_date: `2026-02-09T16:37:20.996+01:00`
...
true[CONFLUENCE_PAGE title='Applying validationRule stereotype' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="941a62d7-70b6-4c50-9bbe-08a99149b879"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Applying validationRule stereotype" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170788 space=CRMP2024xR3 version=3 -->
## PAGE 00009: Applying automated post-processing scripts after ReqIF file import

- page_id: `227170788`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170788/Applying+automated+post-processing+scripts+after+ReqIF+file+import
- version_number: 3
- version_date: `2026-02-09T16:24:10.962+01:00`
...
<!--NOMAGIC_PAGE id=227170798 space=CRMP2024xR3 version=3 -->
## PAGE 00010: Applying automated pre-processing scripts before ReqIF file export

- page_id: `227170798`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170798/Applying+automated+pre-processing+scripts+before+ReqIF+file+export
- version_number: 3
- version_date: `2026-02-09T16:24:59.761+01:00`
...
<!--NOMAGIC_PAGE id=227170964 space=CRMP2024xR3 version=2 -->
## PAGE 00011: Assigning shortcut keys

- page_id: `227170964`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170964/Assigning+shortcut+keys
- version_number: 2
- version_date: `2026-02-09T16:47:43.199+01:00`
...
<!--NOMAGIC_PAGE id=227170929 space=CRMP2024xR3 version=2 -->
## PAGE 00012: Basic requirement concepts

- page_id: `227170929`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170929/Basic+requirement+concepts
- version_number: 2
- version_date: `2026-02-09T16:40:54.923+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>This section contains all basic concepts that are used while using the Cameo Requirements Modeler Plugin.</p><p>Basic requirement concepts:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="df699e6c-b430-4a13-9509-914512a0ec87" /></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170938 space=CRMP2024xR3 version=2 -->
## PAGE 00013: Business Requirement

- page_id: `227170938`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170938/Business+Requirement
- version_number: 2
- version_date: `2026-02-09T16:41:49.047+01:00`
...
````html
<p><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="d27a0102-fe68-4aef-8fd8-0be60ee8fd3d"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Business Requirement is a requirement that specifies characteristics of the business process that must be satisfied by the system.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170719 space=CRMP2024xR3 version=2 -->
## PAGE 00014: Cameo Requirements Modeler Plugin Documentation

- page_id: `227170719`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170719/Cameo+Requirements+Modeler+Plugin+Documentation
- version_number: 2
- version_date: `2025-05-05T13:31:46.725+02:00`
- ancestors: 
- labels: []
...
<!--NOMAGIC_PAGE id=227170833 space=CRMP2024xR3 version=2 -->
## PAGE 00015: Change impact analysis

- page_id: `227170833`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170833/Change+impact+analysis
- version_number: 2
- version_date: `2026-02-09T16:27:45.588+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=227170965 space=CRMP2024xR3 version=2 -->
## PAGE 00017: Configuration files

- page_id: `227170965`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170965/Configuration+files
- version_number: 2
- version_date: `2026-02-09T16:47:50.061+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Customizations
- labels: []
...
<!--NOMAGIC_PAGE id=227170730 space=CRMP2024xR3 version=2 -->
## PAGE 00018: Containment tab

- page_id: `227170730`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170730/Containment+tab
- version_number: 2
- version_date: `2026-02-09T16:15:42.133+01:00`
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b9986127-2c40-4ea1-915b-8352bec344a5"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Containment tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170817 space=CRMP2024xR3 version=2 -->
## PAGE 00019: Converting requirements

- page_id: `227170817`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170817/Converting+requirements
- version_number: 2
- version_date: `2026-02-09T16:27:09.037+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Converting Elements' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b74507d6-0974-4081-a43f-e451340dcafc"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Converting Elements" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170948 space=CRMP2024xR3 version=2 -->
## PAGE 00020: Copy

- page_id: `227170948`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170948/Copy
- version_number: 2
- version_date: `2026-02-09T16:45:15.052+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p>A Copy relationship is a dependency between a supplier requirement (master) and a client requirement (slave), specifying that the client requirement text is a read-only copy of the supplier requirement text. In other words, by creating a Copy dependency between two Requirements, you copy the text property from the supplier to the client.</p><p><ac:image><ri:attachment ri:filename="copy_relationship.png" /></ac:image></p><p><br /></p><p>To create a Copy dependency between two requirements on the diagram</p><hr /><ol><li data-uuid="f670f4b4-1056-4bd8-ace4-fc01c1438d26">On the diagram, select a client Requirement symbol (slave), a symbol you want to be a copy of the supplier Requirement (master). The smart manipulator appears.<br /><ac:image><ri:attachment ri:filename="copy_smart_manipulator.png" /></ac:image></li><li data-uuid="94e91eee-962d-441a-9e99-b39179d86e8f">Select the Copy command as depicted in the preceding figure and connect the client Requirement to the supplier Requirement.</li><li data-uuid="c91afee5-0fcb-4006-8765-c172177bd471">The Copy path goes yellow because of violation of the rule <strong>Invalid Slave Requirement text</strong> meaning the text of the slave Requirement must be the same as of the master Requirement. Click the Copy path and, in the smart manipulator, select the Validation command.<br /><ac:image><ri:attachment ri:filename="copy_validation.png" /></ac:image></li><li data-uuid="b4a90d51-301b-4459-9de1-91399f3cd6c5"><p class="auto-cursor-target">The list of suggested solvers appears. Select <strong>Copy text of the supplier requirement to the client requirement </strong>to create and sustain this dependency in your model correctly.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="b28d5edd-ff53-418a-ab58-d7a392836b78"><ac:parameter ac:name="title">Ignoring solver</ac:parameter><ac:rich-text-body><p>You may select other solvers but note:</p><ul><li><strong>Remove Copy dependency</strong> - removes the dependency from the diagram and the entire model.</li><li><strong>Ignore</strong> - ignores the violation and the dependency is created and sustained in the model with the violation.</li></ul></ac:rich-text-body></ac:structured-macro></li></ol><p><br /></p><p />
````

<!--NOMAGIC_PAGE id=227170832 space=CRMP2024xR3 version=2 -->
## PAGE 00021: Coverage analysis

- page_id: `227170832`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170832/Coverage+analysis
- version_number: 2
- version_date: `2026-02-09T16:27:39.157+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
````html
<p>The Coverage analysis provides coverage information at immediate higher or lower levels by analyzing traceability properties values. Coverage analysis visualizes and verifies that requirements are covered with design, implementation, test cases, or other subjects.</p><p>Test cases not only plan how to verify each requirement, but also identify a relation between the requirement and test case and show the coverage to ensure that each requirement will be appropriately tested.</p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170872 space=CRMP2024xR3 version=3 -->
## PAGE 00022: Creating new validation rules

- page_id: `227170872`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170872/Creating+new+validation+rules
- version_number: 3
- version_date: `2026-02-09T16:36:26.557+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Custom validation
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Creating new validation rules' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="607fd600-ac44-4ccd-a2d0-cd0159f28e4e"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Creating new validation rules" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170967 space=CRMP2024xR3 version=2 -->
## PAGE 00023: Creating path variables

- page_id: `227170967`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170967/Creating+path+variables
- version_number: 2
- version_date: `2026-02-09T16:48:03.643+01:00`
...
<!--NOMAGIC_PAGE id=227170803 space=CRMP2024xR3 version=2 -->
## PAGE 00024: Creating Requirement Diagram for sub-requirements

- page_id: `227170803`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170803/Creating+Requirement+Diagram+for+sub-requirements
- version_number: 2
- version_date: `2026-02-09T16:25:44.119+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170754 space=CRMP2024xR3 version=2 -->
## PAGE 00025: Creating requirements

- page_id: `227170754`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170754/Creating+requirements
- version_number: 2
- version_date: `2026-02-09T16:22:43.900+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
2. In the New Project dialog, specify the following:
  ...
  - On the right side of the dialog, click the [ATTACHMENT filename='3dot_button.png'] button and select the location to store the created project. [ATTACHMENT filename='requirements_projects_templates.png']
...
````html
<p>You can create requirements using the the Requirements Project template. It contains predefined packages, elements, and diagrams to start creating your own requirements in the model.</p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="16ac13b5-48ab-4cc4-b773-d1c8fd43d925"><ac:rich-text-body><p>The Requirements Project template is only available in MagicDraw with Cameo Requirement Modeler Plugin installed.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p class="atl-forced-newline">To create a Requirement Project</p><hr /><ol><li class="atl-forced-newline" data-uuid="543bc67f-7eb0-4482-a9af-9755b7f9f953">Open the <strong>New Project</strong> dialog. Do one of the following:<br /><ul><li style="list-style-type: none;background-image: none;"><ul><li class="atl-forced-newline">From the <strong>File</strong> menu, select <strong>New Project</strong>.</li><li class="atl-forced-newline">On the main toolbar, click the <strong>New Project</strong> button.</li><li class="atl-forced-newline">Press Ctrl + Shift + N.</li></ul></li></ul></li><li class="atl-forced-newline" data-uuid="0604dd24-093e-4c97-add1-27f143b22493">In the <strong>New Project</strong> dialog, specify the following:<br /><ul><li class="auto-cursor-target">On the left side of the dialog, under the <strong>General-Purpose Modeling</strong> domain, select the <strong>Requirements Project</strong>.</li><li class="auto-cursor-target">On the right side of the dialog, type the file name in the <strong>Name</strong> box.</li><li class="auto-cursor-target">On the right side of the dialog, click the <ac:image ac:thumbnail="true" ac:height="22"><ri:attachment ri:filename="3dot_button.png" /></ac:image> button and select the location to store the created project.<br /><ac:image><ri:attachment ri:filename="requirements_projects_templates.png" /></ac:image></li></ul></li><li class="atl-forced-newline" data-uuid="36253819-3b48-4fe7-8814-3ac8ce549e6e">Click <strong>OK</strong>.<br />The new Requirement project is created with predefined structure as shown in the image below.<br /><ac:image><ri:attachment ri:filename="requirements_project_structure.png" /></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=227170870 space=CRMP2024xR3 version=2 -->
## PAGE 00027: Creating validation suites

- page_id: `227170870`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170870/Creating+validation+suites
- version_number: 2
- version_date: `2026-02-09T16:35:29.619+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Custom validation
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Creating validation suites' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="4548ab2e-69df-473e-9086-d8e7c9a8bda7"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Creating validation suites" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170869 space=CRMP2024xR3 version=2 -->
## PAGE 00028: Custom validation

- page_id: `227170869`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170869/Custom+validation
- version_number: 2
- version_date: `2026-02-09T16:35:23.360+01:00`
...
<!--NOMAGIC_PAGE id=227170962 space=CRMP2024xR3 version=2 -->
## PAGE 00029: Customizations

- page_id: `227170962`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170962/Customizations
- version_number: 2
- version_date: `2026-02-09T16:47:13.858+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170966 space=CRMP2024xR3 version=2 -->
## PAGE 00030: Customizing environment options

- page_id: `227170966`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170966/Customizing+environment+options
- version_number: 2
- version_date: `2026-02-09T16:47:56.478+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Customizations
- labels: []
...
<!--NOMAGIC_PAGE id=227170814 space=CRMP2024xR3 version=2 -->
## PAGE 00031: Customizing requirement properties

- page_id: `227170814`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170814/Customizing+requirement+properties
- version_number: 2
- version_date: `2026-02-09T16:27:02.256+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170880 space=CRMP2024xR3 version=2 -->
## PAGE 00032: Customizing severity levels

- page_id: `227170880`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170880/Customizing+severity+levels
- version_number: 2
- version_date: `2026-02-09T16:37:43.538+01:00`
...
true[CONFLUENCE_PAGE title='Customizing severity levels' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="c472f826-023e-4cea-9782-7de375a19cdc"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Customizing severity levels" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170887 space=CRMP2024xR3 version=2 -->
## PAGE 00033: Defining Constraint condition

- page_id: `227170887`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170887/Defining+Constraint+condition
- version_number: 2
- version_date: `2026-02-09T16:37:50.036+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Custom validation > Creating new validation rules
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Defining Constraint condition' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="94b4d96d-f5d8-4a3e-8d6d-618dd256ba3f"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Defining Constraint condition" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170947 space=CRMP2024xR3 version=2 -->
## PAGE 00034: Derive

- page_id: `227170947`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170947/Derive
- version_number: 2
- version_date: `2026-02-09T16:43:58.305+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170939 space=CRMP2024xR3 version=2 -->
## PAGE 00035: Design Constraint

- page_id: `227170939`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170939/Design+Constraint
- version_number: 2
- version_date: `2026-02-09T16:42:05.020+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="07bbde82-ce7f-4ddb-b31d-c442984f8a27"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Design Constraint is a requirement that specifies a constraint on the implementation of a system or on a part of it.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170930 space=CRMP2024xR3 version=2 -->
## PAGE 00036: Diagram descriptions

- page_id: `227170930`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170930/Diagram+descriptions
- version_number: 2
- version_date: `2026-02-09T16:41:01.733+01:00`
...
<!--NOMAGIC_PAGE id=227170737 space=CRMP2024xR3 version=2 -->
## PAGE 00037: Diagrams tab

- page_id: `227170737`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170737/Diagrams+tab
- version_number: 2
- version_date: `2026-02-09T16:18:01.817+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="058605a1-caf2-425a-b8f6-663041ed9043"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Diagrams tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170968 space=CRMP2024xR3 version=2 -->
## PAGE 00038: Disabling inbound network activity

- page_id: `227170968`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170968/Disabling+inbound+network+activity
- version_number: 2
- version_date: `2026-02-09T16:48:10.896+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Customizations
- labels: []
...
<!--NOMAGIC_PAGE id=227170742 space=CRMP2024xR3 version=2 -->
## PAGE 00039: Documentation tab

- page_id: `227170742`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170742/Documentation+tab
- version_number: 2
- version_date: `2026-02-09T16:20:08.962+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
<!--NOMAGIC_PAGE id=227170937 space=CRMP2024xR3 version=2 -->
## PAGE 00040: Element descriptions

- page_id: `227170937`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170937/Element+descriptions
- version_number: 2
- version_date: `2026-02-09T16:41:28.932+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts
- labels: []
...
<!--NOMAGIC_PAGE id=227170917 space=CRMP2024xR3 version=2 -->
## PAGE 00041: Exchanging requirements with ReqIf

- page_id: `227170917`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170917/Exchanging+requirements+with+ReqIf
- version_number: 2
- version_date: `2026-02-09T16:39:59.306+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Requirements are gathered and managed in dedicated requirements tools. When it comes to requirements refinement and integration with business, software, and system architecture, different requirements interchange formats are used. It can be comma separated value, MS Excel, Word, or XML. These are nonstandard ways, which bring drawbacks. It is clear that need for dedicated common format exists. This is why the German automotive industry started the open, non-proprietary format for requirements exchange development.</p><p>Starting with the upcoming v18.0, all MagicDraw-based Cameo Suite products will support ReqIF import as part of the new Cameo Requirements Modeler plugin.</p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="455cfe49-c146-495c-95dc-f3db76e3fbdf" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h3 style="color:var(--ds-text,#172b4d);">What is ReqIF?</h3><p>ReqIF is the XML-based international standard for requirement data exchange, standardized by the Object Management Group (OMG). It has solid recognition in the industry and adoption by many requirements management tool vendors. It is used to exchange requirement information between different tools and toolchains.</p><p><ac:image><ri:attachment ri:filename="Requirements_Interchange_Format_ReqIF_Importer.jpg" /></ac:image>“For requirement analysis, ReqIF is the same as Unified Modeling Language (UML) for modeling – it is the most popular and dedicated requirements interchange format.”</p><h3 style="color:var(--ds-text,#172b4d);">ReqIF Support in MagicDraw</h3><p>ReqIF Importer imports and updates (previously imported) requirements in models with the following capabilities:</p><ul><li>Import process includes the ability for custom mapping with the option to import all data and dynamically create properties.</li><li>Update process includes changing management support with requirements status identification. After import, new, changed, updated or obsolete requirements are identified with the ability to check the impact of changes.</li></ul><p><ac:image><ri:attachment ri:filename="main-diagram-good.png" /></ac:image></p><p>Once imported, requirements become first-class citizens in the modeling world. That means they can be:</p><ul><li><strong>Integrated</strong> with other models: business, software, and systems architecture, test cases, and toolchains: PLM tools (e.g. Teamcenter), CAD tools (e.g. Catia), and others. This enables requirements-driven design and communication of changes with all stakeholders.</li><li><strong>Reviewed</strong> with visualization in diagrams, tables, matrices, and structure maps.</li><li><strong>Analyzed</strong> with built-in and custom validation suites, coverage metrics, traceability.</li><li><strong>Collaborated</strong> with a global modeling project’s repository, supporting collaboration inside a project, change and configuration management, multisite support.</li><li><strong>Simulated</strong> with OMG standard-based model execution, debugging, animation, and user interface prototyping supporting framework.</li><li><strong>Published</strong> with MS Office and Open Office docs, Web-based reports, with the ability to have custom reports incorporating required data.</li></ul><h3 style="color:var(--ds-text,#172b4d);">ReqIF Importer Features</h3><ol><li><strong>Import</strong> data that originated in a wide variety of tools*<br /><ac:image><ri:attachment ri:filename="021714_2253_Requirement3.png" /></ac:image><br />* Import tested with: IBM Rational DOORS 9.4, 9.5, Next Generation, Polarion, PTC Integrity, Siemens TC, and other ReqIF 1.0 compatible data sources.</li><li><strong>Update</strong> existing data. It is possible to create relations to any other model element, e.g. test cases, or architectural components, to realize total traceability as required by the processes. On update, all custom relations are left untouched.</li><li><strong>Change status</strong> identification (updated, new, unchanged, or obsolete)<br /><ac:image><ri:attachment ri:filename="status5.png" /></ac:image></li><li><strong>Requirements structure</strong> and structure changes support<br /><ac:image><ri:attachment ri:filename="Structure1.png" /></ac:image></li><li><strong>Physical requirements remove</strong> action<br /><ac:image><ri:attachment ri:filename="remove-action2.png" /></ac:image></li><li><strong>Status and summary </strong>notification message<br /><ac:image><ri:attachment ri:filename="021714_2244_Requirement7.png" /></ac:image></li><li><strong>Custom mapping<br /><ac:image><ri:attachment ri:filename="mapping2.png" /></ac:image></strong></li><li><strong>Dynamic properties discovery</strong>, no need to determine what data is in ReqIF file, all the properties can be imported</li><li><strong>Omit the data</strong> you don’t need to import</li><li><strong>Rich text</strong> support<br /><ac:image><ri:attachment ri:filename="rich.png" /></ac:image></li></ol><h3 style="color:var(--ds-text,#172b4d);">More About ReqIF</h3><h4 style="line-height: 1.42857;color:var(--ds-text,#172b4d);">ReqIF Recognition</h4><p>The group working on the initial release of ReqIF consists of the ProSTEP iViP Association, Atego Systems GmbH, Audi AG, BMW AG, Continental AG, Daimler AG, HOOD GmbH, IBM, MKS GmbH, PROSTEP AG, Robert Bosch GmbH, and Volkswagen AG.</p><h4 style="line-height: 1.42857;color:var(--ds-text,#172b4d);">ReqIF Sources</h4><ul><li>Rational DOORS, DOORS Next generation, IBM Rational Requirements composer (<a href="http://www-01.ibm.com/software/rational/" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">http://www-01.ibm.com/software/rational/</a>)</li><li>Polarion (<a href="http://www.polarion.com/2014/reqif-solution.php" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">http://www.polarion.com/2014/reqif-solution.php</a>)</li><li>PTC Integrity (<a href="http://www.mks.com/platform/our-product" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">http://www.mks.com/platform/our-product</a>)</li><li>Siemens Teamcenter (<a href="http://m.plm.automation.siemens.com/en_us/Images/Siemens-PLM-Teamcenter-Requirements-Integrator-for-RIF-ReqIF-fs_tcm1224-213684.pdf" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">http://m.plm.automation.siemens.com/en_us/Images/Siemens-PLM-Teamcenter-Requirements-Integrator-for-RIF-ReqIF-fs_tcm1224-213684.pdf</a>)</li><li>LieberLieber for EA (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="http://www.lieberlieber.com/en/model-engineering/reqif/">http://www.lieberlieber.com/en/model-engineering/reqif/</a>)</li><li>Agosense (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="http://www.agosense.com/english/products/platform-und-adapter/agosensesymphony">http://www.agosense.com/english/products/platform-und-adapter/agosensesymphony</a>)</li><li>ReqIF Server (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="http://enso-managers.de/">http://enso-managers.de/</a>)</li><li>MS Excel to ReqIF exporter (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="http://www.pyrrho.com/en/ReqIF/ReqIF-Intro.htm">http://www.pyrrho.com/en/ReqIF/ReqIF-Intro.htm</a>)</li><li>GitHub EnterpriseArchitect_ReqIF_AddIn (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://github.com/redsteve/EnterpriseArchitect_ReqIF_AddIn">https://github.com/redsteve/EnterpriseArchitect_ReqIF_AddIn</a>)</li><li><p>Requisis Rex (<a href="https://requisis.com/de/produkte/rex-doors-reqif-rif-export.html" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">https://requisis.com/de/produkte/rex-doors-reqif-rif-export.html</a>)</p></li><li><p>VISURE (<a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="http://www.visuresolutions.com/">http://www.visuresolutions.com/</a>)</p></li><li><p>Formalmind (<a href="http://www.formalmind.com/" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">www.formalmind.com/</a>)</p></li></ul><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><br /></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170800 space=CRMP2024xR3 version=2 -->
## PAGE 00042: Exporting ReqIF files from the command-line interface

- page_id: `227170800`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170800/Exporting+ReqIF+files+from+the+command-line+interface
- version_number: 2
- version_date: `2026-02-09T16:25:06.207+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Exporting requirements
- labels: []
...
# Specify the flavor of the ReqIF file. Supported flavors are: "MagicDraw", "IBM Rational DOORS", "Polarion", "Teamcenter" and "Reqtify".
# NOTE: This argument is optional.
#]]></ac:plain-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="a747b836-052e-4bff-a358-e5edaed77878"><ac:rich-text-body><p>When creating a properties file on Windows OS, use only / or \\ as a path separator, otherwise the command will fail.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li>Open the Command Prompt window.</li><li>Go to the <em><span style="color:var(--ds-text,#000000);">&lt;model editor installa</span><span style="color:var(--ds-text,#000000);">tion </span><span style="color:var(--ds-text,#000000);">directory&gt;/plugins/com.nomagic.requirements</span></em><span style="color:var(--ds-text,#000000);"> directory containing the <em>reqifexport.exe</em> file.</span></li><li><p>At the command prompt, type the following command and specify the value of the <strong>properties_file</strong> argument.</p><pre>reqifexport properties_file=&lt;path to properties file&gt;</pre><p>Where <strong>properties_file</strong> is the path to the properties file to be used.<br /><br /></p></li><li><span style="color:var(--ds-text,#000000);"><span><span style="color:var(--ds-text,#333333);">Press <strong>Enter</strong>.</span></span></span></li></ol><p>The ReqIF file with the desired data is now exported to the specified directory.</p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170792 space=CRMP2024xR3 version=2 -->
## PAGE 00043: Exporting requirements

- page_id: `227170792`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170792/Exporting+requirements
- version_number: 2
- version_date: `2026-02-09T16:24:46.521+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: ['unrestored-unknown-attachment']
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="ae6d89ac-5ed9-4155-b690-090226ad8d5e"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>An Extended Requirement is a standard Requirement subtype, which adds some properties to a requirement element. These properties such as a source, risk, and verify method are important for the requirement management. Specific projects should add their own properties. All these properties are now available in the standard Requirement Specification window and Requirements Table. If any of these property values is specified, a requirement is automatically converted to ExtendedRequirement.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170907 space=CRMP2024xR3 version=2 -->
## PAGE 00045: Extracting Constraint from Requirement

- page_id: `227170907`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170907/Extracting+Constraint+from+Requirement
- version_number: 2
- version_date: `2026-02-09T16:39:16.419+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="24c0a823-706f-42a0-ada5-cbafe982b108"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Functional Requirement is a requirement that specifies a behavior that a system or a part of a system must perform.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170927 space=CRMP2024xR3 version=2 -->
## PAGE 00047: Generating requirement reports

- page_id: `227170927`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170927/Generating+requirement+reports
- version_number: 2
- version_date: `2026-02-09T16:40:20.634+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
To start working with the Cameo Requirement Modeler Plugin, [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space=''] in the MagicDraw tool.
...
<!--NOMAGIC_PAGE id=227170786 space=CRMP2024xR3 version=2 -->
## PAGE 00051: Importing ReqIF files

- page_id: `227170786`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170786/Importing+ReqIF+files
- version_number: 2
- version_date: `2026-02-09T16:23:08.160+01:00`
...
# To get the hyperlink of an element, open a project, right-click the element in the Containment tree and select "Copy Element Hyperlink".
# NOTE: This argument is optional.
#]]></ac:plain-text-body></ac:structured-macro><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="a747b836-052e-4bff-a358-e5edaed77878"><ac:rich-text-body><p><span>When creating a properties file on Windows OS, use only / or \\ as a path separator, otherwise the command will fail.</span></p></ac:rich-text-body></ac:structured-macro></li><li>Open the Command Prompt window.</li><li>Go to the <em><span style="color:var(--ds-text,#000000);">&lt;model editor installa</span><span style="color:var(--ds-text,#000000);">tion </span><span style="color:var(--ds-text,#000000);">directory&gt;/plugins/com.nomagic.requirements</span></em><span style="color:var(--ds-text,#000000);"> directory containing the <em>reqifimport.exe</em> file.</span></li><li><p>At the command prompt, type the following command and specify the value of the <strong>properties_file</strong> argument.</p><pre>reqifimport properties_file=&lt;path to properties file&gt;</pre><p>Where <strong>properties_file</strong> is the path to the properties file to be used.<br /><br /></p></li><li><span style="color:var(--ds-text,#000000);"><span style="color:var(--ds-text,#000000);"><span style="line-height: 1.42857;color:var(--ds-text,#333333);">Press <strong>Enter</strong>.</span></span></span></li></ol><p><span style="color:var(--ds-text,#000000);"><span style="color:var(--ds-text,#000000);"><span style="line-height: 1.42857;color:var(--ds-text,#333333);">Now after opening the project you have imported the ReqIF file into, the imported data is already present in the Containment tree of the project.<br /></span></span></span></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170778 space=CRMP2024xR3 version=2 -->
## PAGE 00053: Importing requirements

- page_id: `227170778`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170778/Importing+requirements
- version_number: 2
- version_date: `2026-02-09T16:23:00.409+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
- [CONFLUENCE_PAGE title='Importing ReqIF files' space='']
...
- [CONFLUENCE_PAGE title='Interchanging of requirements using Cameo DataHub' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="10f724db-e174-4e5f-9954-64ed3e6e9115"><ac:rich-text-body><p>It is recommended that you import requirements into a separate project which can be used in other models as a used project. <ac:link><ri:page ri:space-key="MD2024x" ri:content-title="Managing used projects" /><ac:plain-text-link-body><![CDATA[How to manage used projects >>]]></ac:plain-text-link-body></ac:link></p></ac:rich-text-body></ac:structured-macro><p><br class="atl-forced-newline" />You can import requirements in one of the following ways:</p><ul><li class="confluence-link" data-uuid="4099ae7f-aee9-4488-aaab-0deb6c202ee4"><ac:link><ri:page ri:content-title="Importing ReqIF files" /><ac:plain-text-link-body><![CDATA[By importing ReqIF files.]]></ac:plain-text-link-body></ac:link></li><li data-uuid="4c586da8-6ad8-414c-ae1e-535966ef0fd3"><ac:link><ri:page ri:space-key="MD2024x" ri:content-title="Sync with Excel or CSV files" /><ac:plain-text-link-body><![CDATA[By syncing Excel or CSV files with Requirement table.]]></ac:plain-text-link-body></ac:link></li><li data-uuid="d48b0656-c93e-4599-86ca-c9d9cb3755e4"><ac:link><ri:page ri:space-key="MD2024x" ri:content-title="Importing data from Excel or CSV files" /><ac:plain-text-link-body><![CDATA[By importing data from Excel or CSV file.]]></ac:plain-text-link-body></ac:link></li><li data-uuid="7e98b6a2-3858-4a9e-9cc8-8dcae405d2b7"><a href="https://docs.nomagic.com/display/MD2024x/Basic+tasks+in+tables#Basictasksintables-Copyingandpastingdata">By pasting into Requirement table.</a></li><li data-uuid="973dde71-ffe5-4516-bb9a-b87f1e8d30d3"><ac:link><ri:page ri:space-key="MD2024x" ri:content-title="Creating elements from other resources" /><ac:plain-text-link-body><![CDATA[By pasting into Requirements diagram, or Containment tree.]]></ac:plain-text-link-body></ac:link></li><li data-uuid="0993eec2-ded3-4585-9bc1-0ef11275e697"><ac:link><ri:page ri:content-title="Interchanging of requirements using Cameo DataHub" /><ac:plain-text-link-body><![CDATA[Using Cameo DataHub.]]></ac:plain-text-link-body></ac:link></li></ul>
````

<!--NOMAGIC_PAGE id=227170736 space=CRMP2024xR3 version=2 -->
## PAGE 00054: Inheritance tab

- page_id: `227170736`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170736/Inheritance+tab
- version_number: 2
- version_date: `2026-02-09T16:17:48.184+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="074b0a5c-00ca-4e05-a1ae-3ed5e0b9b982"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Inheritance tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170722 space=CRMP2024xR3 version=2 -->
## PAGE 00055: Installation, licensing, and system requirements

- page_id: `227170722`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170722/Installation+licensing+and+system+requirements
- version_number: 2
- version_date: `2026-02-09T16:13:37.839+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation
- labels: []
...
````html
<p>For information regarding installation, licensing, and system requirements, visit the <ac:link><ri:page ri:space-key="IL2024xR1" ri:content-title="Installation, licensing, and system requirements" /></ac:link> page.</p>
````

<!--NOMAGIC_PAGE id=227170790 space=CRMP2024xR3 version=3 -->
## PAGE 00056: Interchanging of requirements using Cameo DataHub

- page_id: `227170790`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170790/Interchanging+of+requirements+using+Cameo+DataHub
- version_number: 3
- version_date: `2026-02-09T16:24:37.782+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Importing requirements
- labels: []
...
<!--NOMAGIC_PAGE id=227170860 space=CRMP2024xR3 version=2 -->
## PAGE 00059: Invalid generalization of Requirement

- page_id: `227170860`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170860/Invalid+generalization+of+Requirement
- version_number: 2
- version_date: `2026-02-09T16:33:21.749+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170861 space=CRMP2024xR3 version=2 -->
## PAGE 00060: Invalid owned attribute of Requirement

- page_id: `227170861`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170861/Invalid+owned+attribute+of+Requirement
- version_number: 2
- version_date: `2026-02-09T16:33:28.674+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170862 space=CRMP2024xR3 version=2 -->
## PAGE 00061: Invalid owned operation of Requirement

- page_id: `227170862`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170862/Invalid+owned+operation+of+Requirement
- version_number: 2
- version_date: `2026-02-09T16:33:34.765+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170854 space=CRMP2024xR3 version=2 -->
## PAGE 00062: Invalid return parameter type

- page_id: `227170854`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170854/Invalid+return+parameter+type
- version_number: 2
- version_date: `2026-02-09T16:32:22.323+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170855 space=CRMP2024xR3 version=2 -->
## PAGE 00063: Invalid Slave Requirement text

- page_id: `227170855`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170855/Invalid+Slave+Requirement+text
- version_number: 2
- version_date: `2026-02-09T16:32:31.880+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170859 space=CRMP2024xR3 version=2 -->
## PAGE 00064: Invalid source or target of DeriveReqt

- page_id: `227170859`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170859/Invalid+source+or+target+of+DeriveReqt
- version_number: 2
- version_date: `2026-02-09T16:33:15.483+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170856 space=CRMP2024xR3 version=2 -->
## PAGE 00065: Invalid stereotype(s) of client/supplier of Copy

- page_id: `227170856`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170856/Invalid+stereotype+s+of+client+supplier+of+Copy
- version_number: 2
- version_date: `2026-02-09T16:32:38.419+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170740 space=CRMP2024xR3 version=2 -->
## PAGE 00066: Lock View tab

- page_id: `227170740`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170740/Lock+View+tab
- version_number: 2
- version_date: `2026-02-09T16:18:46.267+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Lock View tab' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="078f2ecd-e45a-40cc-b3fc-8282ba145879"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Lock View tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p><p><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170726 space=CRMP2024xR3 version=2 -->
## PAGE 00067: Main menu

- page_id: `227170726`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170726/Main+menu
- version_number: 2
- version_date: `2026-02-09T16:14:16.084+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface
- labels: []
...
<!--NOMAGIC_PAGE id=227170896 space=CRMP2024xR3 version=2 -->
## PAGE 00068: Metrics

- page_id: `227170896`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170896/Metrics
- version_number: 2
- version_date: `2026-02-09T16:38:58.614+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=227170863 space=CRMP2024xR3 version=2 -->
## PAGE 00070: Missing requirement stereotype

- page_id: `227170863`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170863/Missing+requirement+stereotype
- version_number: 2
- version_date: `2026-02-09T16:33:41.279+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170728 space=CRMP2024xR3 version=3 -->
## PAGE 00071: Model Browser

- page_id: `227170728`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170728/Model+Browser
- version_number: 3
- version_date: `2026-02-09T16:15:11.368+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface
- labels: []

### NORMALIZED CONTENT

etrue[CONFLUENCE_PAGE title='Model Browser' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>e<ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="afc760cf-73e7-46e1-838f-4eb723e4091e"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Model Browser" /></ac:link></ac:parameter></ac:structured-macro></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170738 space=CRMP2024xR3 version=2 -->
## PAGE 00072: Model Extensions tab

- page_id: `227170738`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170738/Model+Extensions+tab
- version_number: 2
- version_date: `2026-02-09T16:18:15.549+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="061ee20c-c215-40a1-9413-f863c264443c"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Model Extensions tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170804 space=CRMP2024xR3 version=2 -->
## PAGE 00073: Modifying requirement text

- page_id: `227170804`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170804/Modifying+requirement+text
- version_number: 2
- version_date: `2026-02-09T16:26:32.558+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170802 space=CRMP2024xR3 version=2 -->
## PAGE 00075: Nesting requirements in the Requirements Table

- page_id: `227170802`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170802/Nesting+requirements+in+the+Requirements+Table
- version_number: 2
- version_date: `2026-02-09T16:25:37.502+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170943 space=CRMP2024xR3 version=2 -->
## PAGE 00078: Performance Requirement

- page_id: `227170943`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170943/Performance+Requirement
- version_number: 2
- version_date: `2026-02-09T16:43:08.104+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="ff6c1156-434c-474d-9abb-307cc60746eb"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Performance Requirement refers to a requirement that quantitatively measures the extent to which a system or a system part satisfy a required capability or condition.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170944 space=CRMP2024xR3 version=2 -->
## PAGE 00079: Physical Requirement

- page_id: `227170944`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170944/Physical+Requirement
- version_number: 2
- version_date: `2026-02-09T16:43:21.164+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="6e09f9bb-fc15-40cf-ada2-76cbf5e41dda"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Physical Requirement specifies the physical characteristics and/or physical constraints of a system or a system part.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170743 space=CRMP2024xR3 version=2 -->
## PAGE 00080: Properties tab

- page_id: `227170743`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170743/Properties+tab
- version_number: 2
- version_date: `2026-02-09T16:20:15.260+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
<!--NOMAGIC_PAGE id=227170858 space=CRMP2024xR3 version=2 -->
## PAGE 00081: Recursive loop of Copy dependencies

- page_id: `227170858`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170858/Recursive+loop+of+Copy+dependencies
- version_number: 2
- version_date: `2026-02-09T16:33:08.166+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170955 space=CRMP2024xR3 version=3 -->
## PAGE 00082: Refine

- page_id: `227170955`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170955/Refine
- version_number: 3
- version_date: `2026-02-09T16:46:19.675+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="49bb7774-95dd-456c-9472-c42aaf7e3998"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A 'Refine' relationship is a dependency that describes how a model element or a set of elements refine a requirement. For example, a use case or activity diagram may be used to refine a text-based functional requirement. Alternatively, it may be used to show how a text-based requirement refines a model element. In this case, some elaborated text could be used to refine a less fine- grained model element.</p><p><ac:image><ri:attachment ri:filename="refine_relationship.png" /></ac:image></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170801 space=CRMP2024xR3 version=2 -->
## PAGE 00083: Relating requirements

- page_id: `227170801`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170801/Relating+requirements
- version_number: 2
- version_date: `2026-02-09T16:25:28.305+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
````html
<p>You can create relationships directly on the Requirement Diagram pane or in the Requirement Matrices such as Derive, Refine, Satisfy, or Verify.</p><h3>Relating Requirements in the Requirement Diagram</h3><p><br /></p><p>To relate requirements on the Requirement Diagram pane</p><hr /><ol><li data-uuid="1009f531-74da-4169-93ba-9160be01e427">Open an existing or create a new Requirement Diagram. <a href="https://docs.nomagic.com/display/MD2024xR1/Creating+diagrams">How to create a new diagram &gt;</a></li><li data-uuid="355e8cf0-db68-4d45-9447-420cbd5e0e6d">Represent requirements on the Requirement diagram.</li><li data-uuid="9529ec34-5898-49f4-bb59-0a31196d86cf">Select a relation type either from the diagram pane or the smart manipulator of the selected requirement shape on the diagram pane.</li><li data-uuid="794bc3d6-399a-489d-b8ea-fbe9aa3997ed">Draw the selected relation from one requirement element to other.</li></ol><h3><br class="atl-forced-newline" />Relating Requirements in the Requirement Matrices</h3><p><br class="atl-forced-newline" />To create a relation in the Requirement Matrices</p><hr /><ol><li data-uuid="4c6f6208-93e3-40ea-a9e5-ef3637990352">Create a corresponding matrix or open an existing one. </li><li data-uuid="a26eacbf-5d73-472b-96b6-46fde3a46452">In the intersection cell do one of the following:<br /><ul><li>Double click the intersection cell. The appropriate relation is created.</li><li>Right-click the intersection cell and, on the shortcut menu, and click the relation name.</li></ul><p class="auto-cursor-target">The relation is created.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="e2e1d3d6-1d3c-4ffb-9cd9-556591a0ce7f"><ac:rich-text-body><p>You can create more than one relation in the same cell.</p></ac:rich-text-body></ac:structured-macro></li></ol>
````

<!--NOMAGIC_PAGE id=227170818 space=CRMP2024xR3 version=2 -->
## PAGE 00084: Replacing requirements

- page_id: `227170818`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170818/Replacing+requirements
- version_number: 2
- version_date: `2026-02-09T16:27:15.670+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Replacing elements' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="ab85b392-1d6e-4ddb-b6c1-d6bdbf4aeb70"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Replacing elements" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170960 space=CRMP2024xR3 version=2 -->
## PAGE 00085: ReqIF

- page_id: `227170960`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170960/ReqIF
- version_number: 2
- version_date: `2026-02-09T16:46:55.771+01:00`
...
````html
<p>The Requirement Interchange Format (ReqIF) standard is an XML based international standard adopted by Object Management Group (OMG) as a formal specification for exchanging requirements between software tools from different vendors.</p>
````

<!--NOMAGIC_PAGE id=227170945 space=CRMP2024xR3 version=2 -->
## PAGE 00086: Requirement

- page_id: `227170945`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170945/Requirement
- version_number: 2
- version_date: `2026-02-09T16:43:33.377+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170936 space=CRMP2024xR3 version=2 -->
## PAGE 00088: Requirement matrices

- page_id: `227170936`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170936/Requirement+matrices
- version_number: 2
- version_date: `2026-02-09T16:41:22.256+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Diagram descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170961 space=CRMP2024xR3 version=2 -->
## PAGE 00089: Requirement Specification

- page_id: `227170961`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170961/Requirement+Specification
- version_number: 2
- version_date: `2026-02-09T16:47:04.879+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Other descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170934 space=CRMP2024xR3 version=2 -->
## PAGE 00090: Requirement Table

- page_id: `227170934`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170934/Requirement+Table
- version_number: 2
- version_date: `2026-02-09T16:41:15.538+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Diagram descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170819 space=CRMP2024xR3 version=2 -->
## PAGE 00091: Requirements numbering

- page_id: `227170819`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170819/Requirements+numbering
- version_number: 2
- version_date: `2026-02-09T16:27:23.481+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170851 space=CRMP2024xR3 version=2 -->
## PAGE 00093: Requirements validation suites

- page_id: `227170851`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170851/Requirements+validation+suites
- version_number: 2
- version_date: `2026-02-09T16:32:00.590+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="346f5d41-164f-48cd-8058-e58edd92b928"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Search Results tab" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170970 space=CRMP2024xR3 version=2 -->
## PAGE 00096: Setting project options

- page_id: `227170970`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170970/Setting+project+options
- version_number: 2
- version_date: `2026-02-09T16:48:23.838+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Customizations
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Setting project options' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="dac7cdd6-2e1a-49a8-8113-6b6a5c2ec64d"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Setting project options" /></ac:link></ac:parameter></ac:structured-macro></p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170875 space=CRMP2024xR3 version=2 -->
## PAGE 00097: Specifying Constraint Element property

- page_id: `227170875`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170875/Specifying+Constraint+Element+property
- version_number: 2
- version_date: `2026-02-09T16:37:14.286+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Custom validation > Creating new validation rules
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Specifying Constraint Element property' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="71e105d6-a712-44f8-8868-83a9a7cd2d0b"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Specifying Constraint Element property" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170963 space=CRMP2024xR3 version=2 -->
## PAGE 00098: Specifying project properties

- page_id: `227170963`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170963/Specifying+project+properties
- version_number: 2
- version_date: `2026-02-09T16:47:21.225+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Customizations
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Project Properties dialog' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b94f1495-33f7-45bc-b74a-108ae31f98cb"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Project Properties dialog" /></ac:link></ac:parameter></ac:structured-macro></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170878 space=CRMP2024xR3 version=2 -->
## PAGE 00099: Specifying the validation rule properties

- page_id: `227170878`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170878/Specifying+the+validation+rule+properties
- version_number: 2
- version_date: `2026-02-09T16:37:36.131+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Custom validation > Creating new validation rules
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Specifying the validation rule properties' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="bee0d524-bb0a-4bd5-b9d5-d752c35928ac"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Specifying the validation rule properties" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170865 space=CRMP2024xR3 version=2 -->
## PAGE 00100: Starting the validation

- page_id: `227170865`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170865/Starting+the+validation
- version_number: 2
- version_date: `2026-02-09T16:34:07.557+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Starting the validation' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="83bc0c49-6868-4e49-9e63-41d549187fbd"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Starting the validation" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170731 space=CRMP2024xR3 version=4 -->
## PAGE 00101: Structure tab

- page_id: `227170731`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170731/Structure+tab
- version_number: 4
- version_date: `2026-02-09T16:17:32.451+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
true[CONFLUENCE_PAGE title='Structure tab' space='SYSMLP2024xR1']
...
| --- | --- | --- |
|  | Collapse All | Collapses all of the currently expanded elements in the Containment tree. |
|  | Collapse Selected Recursively | Collapses only selected node and all subnodes in that node. |
|  | Open in New Tree | Opens the contents of the selected element in a new tab of the Model Browser. The selected element becomes the root node of the new tree.You can choose to open elements in:New Containment TreeNew Structure TreeNew Inheritance Tree |
|  | Favorites | Opens the Favorites menu for choosing to do one of the following:Add a selected element to favoritesOpen the dialog for managing favorites Navigate to a desired favorite in the Containment tree |
|  | Quick Find | Opens the Quick Find dialog. |
|  | Options | Click to open the Options menu and then select:Filter - opens the Select Element Type dialog wherein you can select element types to be visible in the Containment tree. Learn more on the page.Show Auxiliary Resources - shows or hides modules and profiles that are used in your project.Show Applied Stereotypes - shows or hides the applied stereotypes next to the element name in the Containment tree.Nest Satisfied Requirements - shows requirements nested within elements that satisfy them.Show Inherited Structure - shows properties that are inherited from the generalization classifier.Show Full Types - shows or hides the full types of typed elements (for example, operations, attributes, relationships, and other) in the Containment tree.Show Code Engineering Sets - shows or hides the code engineering sets. |

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ea713a0f-a995-4989-9861-e2be6290f2f6"><ac:rich-text-body><p>This tab will appear in the Window menu only if the SysML plugin is installed. </p></ac:rich-text-body></ac:structured-macro><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="ca5e7a35-9b8d-4985-842f-e3917cb40d97"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="SYSMLP2024xR1" ri:content-title="Structure tab" /></ac:link></ac:parameter></ac:structured-macro></p><h3 style="color:var(--ds-text,#172b4d);">Structure tab toolbar</h3><p><br class="atl-forced-newline" />The Structure tab toolbar contains the following buttons:</p><table class="wrapped"><colgroup><col /><col /><col /></colgroup><tbody><tr><td style=""><p><strong>Button</strong></p></td><td style=""><p><strong>Tooltip text</strong></p></td><td style=""><p><strong>Description</strong></p></td></tr><tr><td style="" colspan="1"><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Collapse_all.png" /></ac:image></p></div></td><td style="" colspan="1">Collapse All</td><td style="" colspan="1"><div class="content-wrapper"><p>C<span>ollapses all of the currently expanded elements in the Containment tree.</span></p></div></td></tr><tr><td style="" colspan="1"><div class="content-wrapper"><p><ac:image ac:thumbnail="true" ac:height="21"><ri:attachment ri:filename="Collapse_selected_recursively.png" /></ac:image></p></div></td><td style="" colspan="1">Collapse Selected Recursively</td><td style="" colspan="1"><div class="content-wrapper"><p>Collapses only selected node and all subnodes in that node.</p></div></td></tr><tr><td style=""><div class="content-wrapper"><p><ac:image ac:height="18" ac:width="19"><ri:attachment ri:filename="open_new_tab_button.png" /></ac:image></p></div></td><td style=""><p>Open in New Tree</p></td><td style=""><div class="content-wrapper"><p>Opens the contents of the selected element in a new tab of the Model Browser. T<span>he selected element becomes the root node of the new tree.</span></p><p>You can choose to open elements in:</p><ul><li data-uuid="b161307d-d468-4931-bc5d-86112842a977">New Containment Tree</li><li data-uuid="dede4024-2bdb-4920-bde0-9c2023c606a3">New Structure Tree</li><li data-uuid="9fce4f93-16a4-4a13-9df0-ebda2583d325">New Inheritance Tree</li></ul><p><ac:image><ri:attachment ri:filename="structure_tab.png" /></ac:image></p></div></td></tr><tr><td style=""><div class="content-wrapper"><p><ac:image ac:height="17" ac:width="18"><ri:attachment ri:filename="favorite_button.png" /></ac:image></p></div></td><td style=""><p>Favorites</p></td><td style=""><div class="content-wrapper"><p>Opens the Favorites menu for choosing to do one of the following:</p><ul><li data-uuid="6c112407-d8df-436f-8584-e8f79aac6440">Add a selected element to favorites</li><li data-uuid="c44f965e-4fc4-46ed-a56f-fb348f479db6">Open the dialog for managing favorites<span style="color:var(--ds-chart-gray-bold,#8590A2);"> </span></li><li data-uuid="e7025d94-541e-4518-b739-be38defefaaf">Navigate to a desired favorite in the Containment tree</li></ul></div></td></tr><tr><td style=""><div class="content-wrapper"><p><ac:image ac:height="19" ac:width="19"><ri:attachment ri:filename="quick_find_button.png" /></ac:image></p></div></td><td style=""><p>Quick Find</p></td><td style=""><p>Opens the <strong>Quick Find</strong> dialog.</p></td></tr><tr><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="options_button.png" /></ac:image></p></div></td><td style=""><p>Options</p></td><td style=""><p>Click to open the Options menu and then select:</p><ul><li data-uuid="73e7b8be-aa86-4723-98a5-ba6758a7a489"><strong>Filter</strong> - opens the <strong>Select Element Type</strong> dialog wherein you can select element types to be visible in the Containment tree. Learn more on the <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Filtering" /></ac:link> page.</li><li data-uuid="9e5c2558-13e0-42d6-9613-290d0a9492e1"><strong>Show</strong> <strong>Auxiliary</strong> <strong>Resources</strong> - shows or hides modules and profiles that are used in your project.</li><li data-uuid="053d0529-998f-4ae9-a02a-24387b351fcd"><strong>Show</strong> <strong>Applied Stereotypes</strong> - shows or hides the applied stereotypes next to the element name in the Containment tree.</li><li data-uuid="c487bc4c-5319-49a8-87c8-f08e4de4b2e8"><strong>Nest Satisfied Requirements</strong> - shows requirements nested within elements that satisfy them.</li><li data-uuid="ffdc13df-be30-4fa7-aaba-8b186a8a0823"><strong>Show Inherited Structure</strong> - shows properties that are inherited from the generalization classifier.</li><li data-uuid="0d77d971-805e-4516-820d-57903ed08676"><strong>Show Full Types</strong> - shows or hides the full types of typed elements (for example, operations, attributes, relationships, and other) in the Containment tree.</li><li data-uuid="f88a218a-f308-45d4-b291-87f12604eed6"><strong>Show Code Engineering Sets</strong> - shows or hides the code engineering sets.</li></ul></td></tr></tbody></table><p><br /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170864 space=CRMP2024xR3 version=2 -->
## PAGE 00102: Suspect Unlinked Requirement

- page_id: `227170864`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170864/Suspect+Unlinked+Requirement
- version_number: 2
- version_date: `2026-02-09T16:34:00.862+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation > Requirements validation rules
- labels: []
...
<!--NOMAGIC_PAGE id=227170753 space=CRMP2024xR3 version=2 -->
## PAGE 00103: Switching between multiple projects

- page_id: `227170753`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170753/Switching+between+multiple+projects
- version_number: 2
- version_date: `2026-02-09T16:22:06.372+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Working with multiple projects' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="13d05c40-d38a-49e2-b69e-9eafdbed54c0"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Working with multiple projects" /></ac:link></ac:parameter></ac:structured-macro></p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170952 space=CRMP2024xR3 version=2 -->
## PAGE 00104: Test Case

- page_id: `227170952`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170952/Test+Case
- version_number: 2
- version_date: `2026-02-09T16:45:29.457+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="a924f1fc-9ac3-4a58-af31-569e61be0a93"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A Test Case (Activity / StateMachine / Interaction) is a method for verifying a requirement.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170727 space=CRMP2024xR3 version=3 -->
## PAGE 00105: Toolbars

- page_id: `227170727`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170727/Toolbars
- version_number: 3
- version_date: `2026-02-09T16:14:48.345+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="ca1ef367-9922-470c-8c6e-981d09c0d662"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Toolbars" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170953 space=CRMP2024xR3 version=2 -->
## PAGE 00106: Trace

- page_id: `227170953`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170953/Trace
- version_number: 2
- version_date: `2026-02-09T16:45:41.422+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="749bb55f-4391-48f8-a3c2-9794c1416959"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A 'Trace' relationship is a dependency between a requirement and an arbitrary model element traced by this requirement.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170838 space=CRMP2024xR3 version=2 -->
## PAGE 00107: Tracing requirements

- page_id: `227170838`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170838/Tracing+requirements
- version_number: 2
- version_date: `2026-02-09T16:28:07.322+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
<!--NOMAGIC_PAGE id=227170725 space=CRMP2024xR3 version=2 -->
## PAGE 00108: Understanding the user interface

- page_id: `227170725`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170725/Understanding+the+user+interface
- version_number: 2
- version_date: `2026-02-09T16:14:07.898+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started
- labels: []
...
````html
<p><br /></p><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b7513ec6-84ba-4b6e-99e4-9be942ae98e7"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Understanding the user interface" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170946 space=CRMP2024xR3 version=2 -->
## PAGE 00109: Usability Requirement

- page_id: `227170946`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170946/Usability+Requirement
- version_number: 2
- version_date: `2026-02-09T16:43:45.424+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
<!--NOMAGIC_PAGE id=227170723 space=CRMP2024xR3 version=2 -->
## PAGE 00110: User Guide

- page_id: `227170723`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170723/User+Guide
- version_number: 2
- version_date: `2026-02-09T16:13:45.004+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation
- labels: []
...
<!--NOMAGIC_PAGE id=227170899 space=CRMP2024xR3 version=2 -->
## PAGE 00111: Using Requirement patterns glossary

- page_id: `227170899`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170899/Using+Requirement+patterns+glossary
- version_number: 2
- version_date: `2026-02-09T16:39:09.672+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227170729 space=CRMP2024xR3 version=2 -->
## PAGE 00112: Using the Model Browser

- page_id: `227170729`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170729/Using+the+Model+Browser
- version_number: 2
- version_date: `2026-02-09T16:15:27.558+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="c0a3467d-5c92-4278-862a-7441cd4b1602"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Using the Model Browser" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170843 space=CRMP2024xR3 version=3 -->
## PAGE 00113: Validation

- page_id: `227170843`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170843/Validation
- version_number: 3
- version_date: `2026-02-09T16:29:38.426+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements
- labels: []
...
- [CONFLUENCE_PAGE title='Validation results marker bar' space='']>]]>
- [CONFLUENCE_PAGE title='Validation Results panel' space='']>]]>
...
You can analyze invalid elements and solve problems by selecting appropriate commands from the invalid element or symbol shortcut menu or in the [CONFLUENCE_PAGE title='Validation Results panel' space=''].
...
true[CONFLUENCE_PAGE title='Validation dialog' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="caa2ccee-e80b-4dce-a000-f043f853cbf1"><ac:parameter ac:name="maxLevel">4</ac:parameter><ac:parameter ac:name="minLevel">3</ac:parameter></ac:structured-macro></p><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="8e224012-9c5d-4e0b-b826-39b97f9643b2"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Validation dialog" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170866 space=CRMP2024xR3 version=2 -->
## PAGE 00115: Validation results marker bar

- page_id: `227170866`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170866/Validation+results+marker+bar
- version_number: 2
- version_date: `2026-02-09T16:34:14.728+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Validation results marker bar' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="77020805-7ebe-4e25-9d66-b5220f778fda"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Validation results marker bar" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170867 space=CRMP2024xR3 version=3 -->
## PAGE 00116: Validation Results panel

- page_id: `227170867`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170867/Validation+Results+panel
- version_number: 3
- version_date: `2026-02-09T16:35:15.102+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Analyzing Requirements > Validation
- labels: []
...
true[CONFLUENCE_PAGE title='Validation Results panel' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="caa2ccee-e80b-4dce-a000-f043f853cbf1"><ac:parameter ac:name="maxLevel">4</ac:parameter><ac:parameter ac:name="minLevel">3</ac:parameter></ac:structured-macro></p><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="29ac21e6-fdc2-4941-91cd-5d8b61da6ced"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Validation Results panel" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170871 space=CRMP2024xR3 version=2 -->
## PAGE 00117: Validation Suites dialog

- page_id: `227170871`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170871/Validation+Suites+dialog
- version_number: 2
- version_date: `2026-02-09T16:35:45.537+01:00`
...
true[CONFLUENCE_PAGE title='Validation Suites dialog' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="caa2ccee-e80b-4dce-a000-f043f853cbf1"><ac:parameter ac:name="maxLevel">4</ac:parameter><ac:parameter ac:name="minLevel">3</ac:parameter></ac:structured-macro></p><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="40b60c61-3461-48a9-bda5-36bc65919198"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Validation Suites dialog" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=227170954 space=CRMP2024xR3 version=2 -->
## PAGE 00118: Verify

- page_id: `227170954`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170954/Verify
- version_number: 2
- version_date: `2026-02-09T16:46:03.459+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Basic requirement concepts > Element descriptions
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="d12c185f-ebd4-4870-837e-e0b3d96fa1e2"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>A 'Verify' relationship is a dependency between a requirement and a test case or a model element that can determine whether the system fulfills the requirement. As with other dependencies, the arrow direction points from the (client) test case to the (supplier) requirement.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227170744 space=CRMP2024xR3 version=2 -->
## PAGE 00119: Working with model elements in the Model Browser

- page_id: `227170744`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170744/Working+with+model+elements+in+the+Model+Browser
- version_number: 2
- version_date: `2026-02-09T16:20:21.789+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
...
<!--NOMAGIC_PAGE id=227170741 space=CRMP2024xR3 version=3 -->
## PAGE 00120: Zoom tab

- page_id: `227170741`
- space_key: `CRMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CRMP2024xR3/pages/227170741/Zoom+tab
- version_number: 3
- version_date: `2026-02-09T16:20:02.145+01:00`
- ancestors: Cameo Requirements Modeler Plugin Documentation > User Guide > Getting started > Understanding the user interface > Model Browser
- labels: []
