# NOMAGIC DOCUMENTATION SPACE: Cameo Business Modeler Plugin 2024x Refresh3

<!--NOMAGIC_SPACE key=CBMP2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227169957 space=CBMP2024xR3 version=2 -->
## PAGE 00001: 2024x Refresh2 Version News

- page_id: `227169957`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169957/2024x+Refresh2+Version+News
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169958 space=CBMP2024xR3 version=5 -->
## PAGE 00002: 2024x Refresh3 Version News

- page_id: `227169958`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169958/2024x+Refresh3+Version+News
- version_number: 5
- version_date: `2026-02-09T13:46:43.234+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="text-align: center;">Cameo Business Modeler Plugin</h1><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: July 11</span><span style="color:var(--ds-text,#707070);">, 2025</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p>The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227169989 space=CBMP2024xR3 version=3 -->
## PAGE 00003: Activities

- page_id: `227169989`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169989/Activities
- version_number: 3
...
````html
<p>An Activity is a work that is performed within a business process. An Activity can be atomic or non-atomic (compound). There are three types of Activities that are part of a Process:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f66051d6-e804-413f-8aea-802e12fc6c57" /></p><p>If the Activity property Is For Compensation is set to true, the Activity will be used for compensation, which means that this Activity will be activated only when a Compensation Event is detected and initiated under the Compensation Event visibility scope. The Compensation indicator (marker) is displayed for all activities that are used for the compensation.</p><ul><li>Compensation Task with Compensation indicator<br /><ac:image><ri:attachment ri:filename="task_compensation.png" /></ac:image></li><li>Compensation SubProcess with Compensation indicator<br /><ac:image><ri:attachment ri:filename="subprocess_compensation.png" /></ac:image></li></ul><p>Activities can be repeated sequentially, essentially behaving like a loop. The presence of loop characteristics signifies that an Activity has the looping behavior. There are two types of looping characteristics defined in BPMN:</p><ul><li>Standard Loop. A Standard Loop indicator (marker) displayed in an Activity shape shows that the looping behavior based on a boolean condition is defined for this Activity. Additional looping characteristics can be defined, and the Activity will loop as long as the boolean condition is true. The condition is evaluated for every loop iteration and can be evaluated at the beginning or end of the iteration. In addition, a numeric cap can be optionally specified, but the number of iterations cannot exceed this cap.<ul><li>Task with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="task_standard_loop.png" /></ac:image></li><li>SubProcess with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="subprocess_standard_loop.png" /></ac:image></li></ul></li><li><p>MultiInstance Loop. A MultiInstance Loop indicator shows that a desired number of Activity instances can be created. The instances can be executed in parallel or sequentially. Either expression is used to specify the desired number of instances or a data driven setup that can be used.</p><ul><li><p>Task with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="task_multi_par.png" /></ac:image></p></li><li><p>SubProcess with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par.png" /></ac:image></p></li><li><p>Task with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="task_multi_par_seq.png" /></ac:image></p></li><li>SubProcess with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par_seq.png" /></ac:image></li></ul></li></ul><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="78303b38-7a07-479f-9c99-d0b24fc412d5"><ac:rich-text-body><p>The Compensation, Multi-instance Loop, and Standard Loop indicators can be added to all types of Activities.</p></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=227170019 space=CBMP2024xR3 version=3 -->
## PAGE 00004: AdHoc SubProcess

- page_id: `227170019`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170019/AdHoc+SubProcess
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>An Anchor is used to associate a Text Annotation, Note, or Comment with the other diagram elements.</p><p><strong>Example</strong></p><p><strong><ac:image><ri:attachment ri:filename="anchor.png" /></ac:image></strong></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227169974 space=CBMP2024xR3 version=3 -->
## PAGE 00006: Artifacts

- page_id: `227169974`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169974/Artifacts
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170279 space=CBMP2024xR3 version=2 -->
## PAGE 00007: Assessment

- page_id: `227170279`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170279/Assessment
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>The following table provides the relationships that exist between element types and their meaning.</p><table class="relative-table wrapped" style="width: 2059.95px;"><colgroup><col style="width: 210.594px;" /><col style="width: 1303.06px;" /><col style="width: 545.297px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td style="">Identifies</td><td style=""><p>This link connects <ac:link><ri:page ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:content-title="Potential Reward" /></ac:link> or <ac:link><ri:page ri:content-title="Risk" /></ac:link>. Meaning that the Assessment points out some possible Potential Reward or Risk that is/are significant to that Assessment. Each possible consequence serves as an appraisal of the worth, value, or quality of some aspect of the Assessment in specific terms, types, or dimensions.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="identifies.png" /></ac:image></p></div></td></tr><tr><td style=""><p>Provides<br />Impetus</p></td><td style=""><p>This link connects <ac:link><ri:page ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment is the driving force for the Business Policy or Business Rule.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="provides_impetus.png" /></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Achievements</p></td><td style=""><p>This link connects <ac:link><ri:page ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:content-title="Vision" /></ac:link>, <ac:link><ri:page ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:content-title="Objective" /></ac:link>. Meaning that the Assessment has an impact on the End outcomes.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_achievements.png" /></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Employment</p></td><td style=""><p>This link connects <ac:link><ri:page ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:content-title="Mission" /></ac:link>, <ac:link><ri:page ri:content-title="Strategy" /></ac:link>, <ac:link><ri:page ri:content-title="Tactic" /></ac:link>, <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment has an impact on the use of Means.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_employment.png" /></ac:image></p></div></td></tr><tr><td style=""><p>Judgement<br />For</p></td><td style=""><p>This link connects <ac:link><ri:page ri:content-title="Assessment" /></ac:link> to a Influencer (<ac:link><ri:page ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:content-title="Internal Influencer" /></ac:link>). Meaning that the Assessment is the Influencer’s judgment that influences the organization’s ability to carry out its Means or achieve its Ends.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="judgement_for.png" /></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Assessment+Concepts">Assessment Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170278 space=CBMP2024xR3 version=2 -->
## PAGE 00009: Assessment Concepts

- page_id: `227170278`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170278/Assessment+Concepts
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169979 space=CBMP2024xR3 version=3 -->
## PAGE 00010: Association

- page_id: `227169979`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169979/Association
- version_number: 3
...
````html
<p>A Boundary Event is an Intermediate event which can be placed on the boundary of any of the following activities:</p><ul><li>SubProcess, Task, or Call Activity</li><li>SubChoreography, Choreography Task, or Call Choreography</li></ul><p>Boundary Event indicates that while attached-to Activity is running, event is listening for the trigger signal.</p><p>Boundary Event types:</p><ul><li>Interrupting Boundary Event aborts Activity and Process is continued of exceptional flow. This event is drawn with a solid border.</li><li>Non-Interrupting Boundary Event splits process to parallel flows. This event is drawn with a dashed border.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="boundary_error.png" /></ac:image></p><h6 style="text-align: center;">Error Boundary Event attached to SubProcess.</h6><p>Types of Boundary Events are as follows:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="dd5528d2-89f7-4470-8751-3f740afa86c7" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170335 space=CBMP2024xR3 version=2 -->
## PAGE 00012: BPMN Activities Description Table

- page_id: `227170335`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170335/BPMN+Activities+Description+Table
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170199 space=CBMP2024xR3 version=2 -->
## PAGE 00015: BPMN Choreography Diagram

- page_id: `227170199`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170199/BPMN+Choreography+Diagram
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Collaboration represents the interactions between two or more business entities. A Collaboration diagram depicts a global point of view. It shows the interactions between participants in general.</p><p>A Collaboration contains two or more pools, representing the participants in the collaboration. Messages exchanged between the participants are shown by message flows that connect two pools together (or objects within the pools).</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_I.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Collaboration diagram with two Black Box Pools.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="collaboration_II.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Collaboration diagram with two Pools showing process.</h6><p>A Collaboration diagram can also show distinct conversations between collaborating participants in a domain. Communications are defined by the conversations, participants, and conversation links between them.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_III.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">BPMN Collaboration diagram with Conversations.</h6><p>The elements of a BPMN Process diagram can be displayed on the BPMN Collaboration diagram.</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170340 space=CBMP2024xR3 version=2 -->
## PAGE 00017: BPMN Data Usage Matrices

- page_id: `227170340`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170340/BPMN+Data+Usage+Matrices
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170337 space=CBMP2024xR3 version=2 -->
## PAGE 00018: BPMN Matrices

- page_id: `227170337`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170337/BPMN+Matrices
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169987 space=CBMP2024xR3 version=3 -->
## PAGE 00019: BPMN Process

- page_id: `227169987`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169987/BPMN+Process
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A BPMN Process element defines a process performed in an organization. This element is a container for the BPMN Process diagram and its elements. Process diagram describes how a process is performed.</p><p><strong>Notation</strong><br /><ac:image ac:thumbnail="true" ac:width="200"><ri:attachment ri:filename="bpmn_process.png" /></ac:image></p>
````

<!--NOMAGIC_PAGE id=227169985 space=CBMP2024xR3 version=3 -->
## PAGE 00020: BPMN Process Diagram

- page_id: `227169985`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169985/BPMN+Process+Diagram
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A BPMN Process Diagram describes a sequence or flow of activities in an organization that shows how the business works. The diagram shows activities, events, and data that trigger or feed business activities. A BPMN Process Diagram is similar to the UML Activity diagram with a much richer set of default message types and business process styles of notations.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="process_diagram.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">BPMN Process diagram</h6><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170329 space=CBMP2024xR3 version=2 -->
## PAGE 00021: BPMN Processes Description Table

- page_id: `227170329`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170329/BPMN+Processes+Description+Table
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170342 space=CBMP2024xR3 version=2 -->
## PAGE 00022: BPMN Processes Structure Map

- page_id: `227170342`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170342/BPMN+Processes+Structure+Map
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170383 space=CBMP2024xR3 version=2 -->
## PAGE 00026: BPMN2 Completeness Validation Rules

- page_id: `227170383`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170383/BPMN2+Completeness+Validation+Rules
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170381 space=CBMP2024xR3 version=1 -->
## PAGE 00027: BPMN2 Correctness (Active) Validation Rules

- page_id: `227170381`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170381/BPMN2+Correctness+Active+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=227170382 space=CBMP2024xR3 version=2 -->
## PAGE 00028: BPMN2 Correctness Validation Rules

- page_id: `227170382`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170382/BPMN2+Correctness+Validation+Rules
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170384 space=CBMP2024xR3 version=2 -->
## PAGE 00029: BPMN2 Export Completeness Validation Rules

- page_id: `227170384`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170384/BPMN2+Export+Completeness+Validation+Rules
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170232 space=CBMP2024xR3 version=2 -->
## PAGE 00030: BPMN2 XML support

- page_id: `227170232`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170232/BPMN2+XML+support
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170187 space=CBMP2024xR3 version=2 -->
## PAGE 00031: BPMNMessage

- page_id: `227170187`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170187/BPMNMessage
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170291 space=CBMP2024xR3 version=2 -->
## PAGE 00033: Business Data Diagram

- page_id: `227170291`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170291/Business+Data+Diagram
- version_number: 2
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Description</strong></p><p>The Business Motivation Model designed to develop, communicate, and manage business plans. The model identifies and defines the elements of business plans, the motivating factors to establish the business plans, and how all these factors and elements are interconnected.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="business_motivation_diagram.png" /></ac:image></p><h6 style="text-align: center;">Business Motivation Diagram.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related elements</strong></p><ul class="childpages-macro"><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Ends+Concepts">Ends Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Means+Concepts">Means Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Influencer+Concepts">Influencer Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Assessment+Concepts">Assessment Concepts</a></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227169964 space=CBMP2024xR3 version=3 -->
## PAGE 00035: Business Motivation Model standard

- page_id: `227169964`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169964/Business+Motivation+Model+standard
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170253 space=CBMP2024xR3 version=2 -->
## PAGE 00036: Business Policy

- page_id: `227170253`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170253/Business+Policy
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169970 space=CBMP2024xR3 version=3 -->
## PAGE 00038: Business Process Model and Notation Concepts

- page_id: `227169970`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169970/Business+Process+Model+and+Notation+Concepts
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170255 space=CBMP2024xR3 version=2 -->
## PAGE 00039: Business Rule

- page_id: `227170255`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170255/Business+Rule
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Business Rule is a Directive, intended to govern, guide, or influence business behavior, in support of Business Policy that has been formulated in response to an Opportunity, Threat, Strength, or Weakness. It is a single Directive that does not require additional interpretation to undertake Strategies or Tactics. Often, a Business Rule is derived from Business Policy. Business Rules guide Business Processes.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="business_rule.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Means+Concepts">Means Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Mean+Concept+Relationships">Mean Concept Relationships</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170011 space=CBMP2024xR3 version=3 -->
## PAGE 00040: Business Rule Task

- page_id: `227170011`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170011/Business+Rule+Task
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Business Rule Task provides a mechanism for a process to provide inputs to a business rules engine and to get the output of calculations that the business rules engine might provide.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="business_rule_task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170029 space=CBMP2024xR3 version=3 -->
## PAGE 00041: Call Activity

- page_id: `227170029`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170029/Call+Activity
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170216 space=CBMP2024xR3 version=2 -->
## PAGE 00042: Call Choreography

- page_id: `227170216`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170216/Call+Choreography
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170107 space=CBMP2024xR3 version=2 -->
## PAGE 00045: Cancel Boundary Event

- page_id: `227170107`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170107/Cancel+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Cancel End Event is used within a Transaction SubProcess. It indicates that the transaction will be canceled and a Cancel Boundary Event attached to the SubProcess boundary will be triggered. It also indicates that a Transaction Protocol Cancel message have to be sent to all entities involved in the transaction.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event_cancel.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li>End Events</li></ul><p><strong>Related diagrams</strong></p><ul><li>BPMN Process Diagram</li><li>BPMN Collaboration Diagram</li></ul><p><strong>Related procedure</strong></p><ul><li>Creating and Using an Event</li></ul>
````

<!--NOMAGIC_PAGE id=227170201 space=CBMP2024xR3 version=2 -->
## PAGE 00047: Choreography

- page_id: `227170201`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170201/Choreography
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170202 space=CBMP2024xR3 version=2 -->
## PAGE 00048: Choreography Activities

- page_id: `227170202`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170202/Choreography+Activities
- version_number: 2
...
````html
<p>A Choreography Activity is an abstract element. It represents a point on a choreography flow where an interaction occurs between two or more participants.</p><p>There are three types of Choreography activities defined in business process modeling:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="b3e4d655-dd0d-49cc-8824-972698b39055" /></p><p>The shape of a Choreography Task, SubChoreography, or Call Choreography consists of two or more participant compartments and one name compartment. One of the participants can be selected as an initiating participant. The color of the initiating participant compartment is the same as the color of the name compartment. The other participants compartments are gray.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="choreography_task.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Compartments on Choreography Activity shape.</h6><p>The looping properties of a Choreography Activity can be specified. They can be repeated sequentially, essentially behaving like a loop. The presence of loop characteristics signifies that the Choreography Activity has looping behavior. There are two types of Looping characteristics defined in BPMN:</p><p><strong>Standard Loop</strong></p><p>A Standard Loop marker displayed on a name compartment of a Choreography Activity shape shows that the looping behavior based on a boolean condition is defined for this Activity. Additional looping characteristics can also be defined: the Activity will loop as long as the boolean condition is true. The condition is evaluated for every loop iteration and can be evaluated at the beginning or end of the iteration. In addition, a numeric cap can be optionally specified, but the number of iterations cannot exceed this cap.</p><ul><li>Choreography Activity with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_task_with_standard_loop.png" /></ac:image></li><li>SubChoreography with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_subprocess_with_standard_loop.png" /></ac:image></li></ul><p><strong>Multi-instance Loop</strong></p><p>A Multi-instance Loop marker shows that a desired number of Choreography Activity instances can be created. The instances can be executed either in parallel or sequentially and each will be identified using a different marker.</p><ul><li>Choreography Task with Parallel MultiInstance Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_task_parallel.png" /></ac:image></li><li>SubChoreography with Parallel MultiInstance Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_subprocess_parallel.png" /></ac:image></li><li>Choreography Task with sequential MultiInstance Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_task_parallel_is_sequential.png" /></ac:image></li><li>SubChoreography with sequential MultiInstance Loop marker<br /><ac:image><ri:attachment ri:filename="choreography_subprocess_parallel_is_sequential.png" /></ac:image></li></ul><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="11aafcb5-2c6a-42d7-b66b-404ecfd578f0"><ac:rich-text-body><p>Multi-instance Loop and Standard Loop markers can be added to all types of Choreography activities.</p></ac:rich-text-body></ac:structured-macro><p>There are circumstances when a Choreography Activity references a multi-instance participant (the minimum multiplicity property value for a participant is 2 or greater). A multi-instance participant represents a situation where there is more than one possible related participant involved in a Choreography. If this is the case, a MultiInstance marker will be displayed in the participant compartment of a Choreography Activity shape.</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagram</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+Choreography+Activity" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using Choreography Activity</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170210 space=CBMP2024xR3 version=2 -->
## PAGE 00049: Choreography Task

- page_id: `227170210`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170210/Choreography+Task
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169971 space=CBMP2024xR3 version=3 -->
## PAGE 00052: Common BPMN Elements

- page_id: `227169971`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169971/Common+BPMN+Elements
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170170 space=CBMP2024xR3 version=3 -->
## PAGE 00053: Compensation

- page_id: `227170170`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170170/Compensation
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170134 space=CBMP2024xR3 version=2 -->
## PAGE 00055: Compensation End Event

- page_id: `227170134`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170134/Compensation+End+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Compensation Start Event triggers an in-line Compensation Event SubProcess only. The event is triggered when the compensation occurs.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="start_event_compensation.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170088 space=CBMP2024xR3 version=2 -->
## PAGE 00057: Compensation Throwing Intermediate Event

- page_id: `227170088`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170088/Compensation+Throwing+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Conditional Boundary Event is triggered when a specified condition becomes true. When the event is triggered, it will change a normal flow of a Process into an exception flow.</p><p>This event displays either of the following on a diagram:</p><ul><li>A Conditional Catching Intermediate Event name if the name is specified.</li><li>A Conditional property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional.png" /></ac:image></li><li>Non-interrupting Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional_false.png" /></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170070 space=CBMP2024xR3 version=2 -->
## PAGE 00061: Conditional Catching Intermediate Event

- page_id: `227170070`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170070/Conditional+Catching+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Consecutive with Owner Number numbering schema provides non-multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is displayed before the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_I.png" /></ac:image></p><h6 style="text-align: center;">Consecutive Numbering style with element owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170228 space=CBMP2024xR3 version=2 -->
## PAGE 00064: Consecutive without Owner Number

- page_id: `227170228`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170228/Consecutive+without+Owner+Number
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Consecutive without Owner Number numbering schema provides non-multilevel element numbering. An Element Owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_II.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Consecutive numbering style without owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170189 space=CBMP2024xR3 version=2 -->
## PAGE 00065: Conversation

- page_id: `227170189`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170189/Conversation
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170351 space=CBMP2024xR3 version=2 -->
## PAGE 00068: Creating and Using a BPMNEvent

- page_id: `227170351`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170351/Creating+and+Using+a+BPMNEvent
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170363 space=CBMP2024xR3 version=2 -->
## PAGE 00071: Creating and Using Conversation Nodes

- page_id: `227170363`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170363/Creating+and+Using+Conversation+Nodes
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170356 space=CBMP2024xR3 version=3 -->
## PAGE 00072: Creating and Using Data Items

- page_id: `227170356`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170356/Creating+and+Using+Data+Items
- version_number: 3
...
- [CONFLUENCE_PAGE title='Data Object' space='']
- [CONFLUENCE_PAGE title='Data Store' space='']
- [CONFLUENCE_PAGE title='Data Input and Data Output' space='']
...
<!--NOMAGIC_PAGE id=227170364 space=CBMP2024xR3 version=2 -->
## PAGE 00074: Creating and Using Participant

- page_id: `227170364`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170364/Creating+and+Using+Participant
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170361 space=CBMP2024xR3 version=2 -->
## PAGE 00075: Creating and Using Pool and Lanes

- page_id: `227170361`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170361/Creating+and+Using+Pool+and+Lanes
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170349 space=CBMP2024xR3 version=2 -->
## PAGE 00076: Creating and Using SubProcesses

- page_id: `227170349`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170349/Creating+and+Using+SubProcesses
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170348 space=CBMP2024xR3 version=2 -->
## PAGE 00077: Creating and Using Tasks

- page_id: `227170348`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170348/Creating+and+Using+Tasks
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169967 space=CBMP2024xR3 version=3 -->
## PAGE 00078: Creating BPMN Projects

- page_id: `227169967`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169967/Creating+BPMN+Projects
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170368 space=CBMP2024xR3 version=2 -->
## PAGE 00080: Creating SubChoreography

- page_id: `227170368`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170368/Creating+SubChoreography
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170168 space=CBMP2024xR3 version=3 -->
## PAGE 00081: Data Association

- page_id: `227170168`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170168/Data+Association
- version_number: 3
...
````html
<p><br /></p><p style="margin-top: 0.0px;"><strong>Description</strong></p><p>A Data Association is used to model how data are pushed into or pulled from item-aware elements. Tokens do not flow along a Data Association. Therefore, they have no direct effect on the flow of a process.</p><p>Alternatively, Data Objects can be directly associated with a Sequence Flow to represent the same input or output Data Associations. This is a visual shortcut that is stored in a model as two Data Associations</p><ul><li>from Activity to Data Object</li><li>from Data Object to Activity</li></ul><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="data_association_ flow_data_object.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Data Association showing flow of Data Object.</h6><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Object">Data Object</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Store">Data Store</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Input+and+Data+Output">Data Input and Data Output</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+Data+Items">Creating and Using Data Items</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170165 space=CBMP2024xR3 version=2 -->
## PAGE 00082: Data Input and Data Output

- page_id: `227170165`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170165/Data+Input+and+Data+Output
- version_number: 2
...
````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p><strong>Description</strong></p><p>The Definitions element is a root model in a business modeling project. This element is the outermost containing object for all BPMN elements. It defines the visibility scope and the namespace for all of the BPMN elements in a model.</p><p><strong>Example</strong></p><p><strong><ac:image ac:align="center"><ri:attachment ri:filename="definition.png" /></ac:image></strong></p><h6 style="text-align: center;">Definitions element in Containment tree</h6><p><strong> </strong></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227170318 space=CBMP2024xR3 version=2 -->
## PAGE 00086: Dependency

- page_id: `227170318`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170318/Dependency
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Dependency indicates a semantic relationship between two model elements (or two sets of model elements). Dependency indicates a situation in which a change to a supplier (target) element may require a change to a client (source) element in the dependency.</p><p>A Dependency is shown as a dashed arrow between model elements. The model element at the start point of the arrow (the client element) depends on the model element at the arrowhead (the supplier element). The arrow can be labeled with an optional individual name.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="dependency.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170230 space=CBMP2024xR3 version=2 -->
## PAGE 00087: Element Types Numbering Sequence

- page_id: `227170230`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170230/Element+Types+Numbering+Sequence
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170243 space=CBMP2024xR3 version=2 -->
## PAGE 00088: End Concept Relationships

- page_id: `227170243`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170243/End+Concept+Relationships
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170236 space=CBMP2024xR3 version=2 -->
## PAGE 00090: Ends Concepts

- page_id: `227170236`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170236/Ends+Concepts
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169984 space=CBMP2024xR3 version=3 -->
## PAGE 00091: Error

- page_id: `227169984`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169984/Error
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170105 space=CBMP2024xR3 version=2 -->
## PAGE 00092: Error Boundary Event

- page_id: `227170105`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170105/Error+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>An Error Start Event triggers an in-line Event SubProcess only.</p><p>This event displays either of the following on the diagram:</p><ul><li>An Error Start Event name if the name is specified.</li><li>An Error Ref property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="start_event_error.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170102 space=CBMP2024xR3 version=2 -->
## PAGE 00095: Escalation Boundary Event

- page_id: `227170102`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170102/Escalation+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>An Escalation Boundary Event is used to catch an escalation.</p><p>This event displays either of the following on a diagram:</p><ul><li>An Escalation Boundary Event name if the name is specified.</li><li>An Escalation Code property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Escalation Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_escalation_true.png" /></ac:image></li><li>Escalation Boundary Event (Cancel Activity - False)<br /><ac:image><ri:attachment ri:filename="boundary_event_escalation_false.png" /></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170130 space=CBMP2024xR3 version=2 -->
## PAGE 00096: Escalation End Event

- page_id: `227170130`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170130/Escalation+End+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>An Escalation Throwing Intermediate Event raises an Escalation.</p><p>This event displays one of the following on the diagram:</p><ul><li>An Escalation Throwing Intermediate Event name if the name is specified.</li><li>An Escalation Code property value if then name is unspecified.</li></ul><p><strong>Notation</strong><br /><ac:image><ri:attachment ri:filename="intermediate_throwing_event_escalation.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170153 space=CBMP2024xR3 version=3 -->
## PAGE 00099: Event Based Gateway

- page_id: `227170153`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170153/Event+Based+Gateway
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170375 space=CBMP2024xR3 version=2 -->
## PAGE 00103: Exporting Models to XPDL

- page_id: `227170375`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170375/Exporting+Models+to+XPDL
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170270 space=CBMP2024xR3 version=2 -->
## PAGE 00104: External Influencer

- page_id: `227170270`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170270/External+Influencer
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170142 space=CBMP2024xR3 version=2 -->
## PAGE 00105: Gateways

- page_id: `227170142`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170142/Gateways
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170298 space=CBMP2024xR3 version=2 -->
## PAGE 00106: Generalization

- page_id: `227170298`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170298/Generalization
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Generalization link shows that one class provides grouping criteria for sets of other classes. Generic class may define sets of properties, that are applicable to all the specific classes. The Generalization link can be among classes.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="generalization.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Data+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Data Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227169961 space=CBMP2024xR3 version=3 -->
## PAGE 00107: Getting Started

- page_id: `227169961`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169961/Getting+Started
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170239 space=CBMP2024xR3 version=2 -->
## PAGE 00108: Goal

- page_id: `227170239`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170239/Goal
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>Governs shows that a Business Policy governs BPMN Process.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="governs_process.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227169982 space=CBMP2024xR3 version=3 -->
## PAGE 00110: Group

- page_id: `227169982`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169982/Group
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170324 space=CBMP2024xR3 version=2 -->
## PAGE 00111: Guides

- page_id: `227170324`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170324/Guides
- version_number: 2
...
````html
<p>The following table provides the relationship that exists between element types and the meaning.</p><table class="wrapped"><colgroup><col /><col /><col /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td>Is Source Of </td><td><p>This link connects <ac:link><ri:page ri:content-title="Influencing Organization" /></ac:link> to an Influencer (<ac:link><ri:page ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:content-title="Internal Influencer" /></ac:link>).<br />Meaning that the Influencing Organization is the source of Influencer. An Influencer may have multiple sources, or<br />none.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="is_source_of.png" /></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Influencer+Concepts">Influencer Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170269 space=CBMP2024xR3 version=2 -->
## PAGE 00114: Influencer Concepts

- page_id: `227170269`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170269/Influencer+Concepts
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170274 space=CBMP2024xR3 version=2 -->
## PAGE 00115: Influencing Organization

- page_id: `227170274`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170274/Influencing+Organization
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>An Influencing Organization is an organization that is external to the enterprise modeled in a given enterprise BMM, and that influences that enterprise.</p><p>An Influencing Organization is the source of Influencer. The Influencer may have multiple sources, or none.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="influencing_organization.png" /></ac:image></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Influencer+Concepts" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Influencer Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Influence+Concepts+Relationship">Influence Concepts Relationship</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170309 space=CBMP2024xR3 version=2 -->
## PAGE 00116: Information system

- page_id: `227170309`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170309/Information+system
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169959 space=CBMP2024xR3 version=3 -->
## PAGE 00117: Installation, licensing, and system requirements

- page_id: `227169959`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169959/Installation+licensing+and+system+requirements
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170063 space=CBMP2024xR3 version=2 -->
## PAGE 00118: Intermediate Catch Event

- page_id: `227170063`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170063/Intermediate+Catch+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170081 space=CBMP2024xR3 version=2 -->
## PAGE 00119: Intermediate Throwing Event

- page_id: `227170081`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170081/Intermediate+Throwing+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170272 space=CBMP2024xR3 version=2 -->
## PAGE 00120: Internal Influencer

- page_id: `227170272`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170272/Internal+Influencer
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170159 space=CBMP2024xR3 version=2 -->
## PAGE 00122: Items and Data

- page_id: `227170159`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170159/Items+and+Data
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170072 space=CBMP2024xR3 version=2 -->
## PAGE 00123: Link Catching Intermediate Event

- page_id: `227170072`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170072/Link+Catching+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Link Throwing Intermediate Event is used to throw a link to a Link Catching Intermediate Event.</p><p>This event displays either of the following:</p><ul><li>A Link Throwing Intermediate Event name if the name is specified.</li><li>A Target Link Event property value if the name is unspecified.</li></ul><p><strong>Notation</strong><br /><ac:image><ri:attachment ri:filename="intermediate_throwing_event_link.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170009 space=CBMP2024xR3 version=3 -->
## PAGE 00125: Manual Task

- page_id: `227170009`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170009/Manual+Task
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Manual Task is a task that is expected to be performed without the aid of any business process execution engine or application, for example, installing a telephone at a customer location.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="manual_task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170257 space=CBMP2024xR3 version=3 -->
## PAGE 00126: Mean Concept Relationships

- page_id: `227170257`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170257/Mean+Concept+Relationships
- version_number: 3
...
````html
<p style="margin-top: 10.0px;">The following table provides the relationships that exist between element types and their meaning.</p><table class="wrapped relative-table" style="width: 1931.61px;"><colgroup><col style="width: 334.094px;" /><col style="width: 1057.38px;" /><col style="width: 539.141px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td><strong>Makes Operative </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Mission" /><ac:plain-text-link-body><![CDATA[ Mission ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:content-title="Vision" /></ac:link>. Meaning that the Mission lists every continuing<br />Activity to ensure the Vision.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="makes_operative.png" /></ac:image></p></div></td></tr><tr><td><strong>Component Of </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[ Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:content-title="Mission" /></ac:link>. Meaning that the Strategy is the method or<br />course of action that will be employed to achieve the Mission.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="component_of.png" /></ac:image></p></div></td></tr><tr><td><strong>Implements </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:content-title="Strategy" /></ac:link>. Meaning that the Tactic realizes Strategies.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="implements.png" /></ac:image></p></div></td></tr><tr><td><strong>Enables </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:content-title="Tactic" /></ac:link>. Meaning that a Strategy/<br />Tactic makes another Strategy/Tactic doable. That is to say the latter Strategy/Tactic<br />provides an opportunity for the former Strategy/Tactic to be carried out. Use this link<br />to associate Strategy to another Strategy or Tactic to another Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="enables.png" /></ac:image></p></div></td></tr><tr><td><strong>Effects Enforcement Level </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:content-title="Business Rule" /></ac:link>. Meaning that the Tactics influences the</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="effects_enforcement_level.png" /></ac:image></p></div></td></tr><tr><td><strong>Formulated Based On </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:content-title="Business Rule" /></ac:link>. Meaning<br />that the Strategy or Tactic is planned according to what result the Business Policy or<br />Business Rule desires.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="formulated based on.png" /></ac:image></p></div></td></tr><tr><td><strong>Channel Efforts Towards </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:content-title="Tactic" /></ac:link> to an <ac:link><ri:page ri:content-title="Objective" /></ac:link>. Meaning that the Strategy is<br />coordinated as activities aimed towards Goals as Tactic towards Objective. For example, the<br />Tactic “Free delivery” channels efforts towards the Objective “5% increase in sales within 3<br />months.”</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="channel_effort_towards.png" /></ac:image></p></div></td></tr><tr><td><strong>Governs </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:content-title="Tactic" /></ac:link>. Meaning that the Business Policy or BusinessRule determines the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="governs.png" /></ac:image></p></div></td></tr><tr><td><strong>Basis For </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> to a <ac:link><ri:page ri:content-title="Business Rule" /></ac:link>. Meaning that the Business Policy is the key to achieve Business Rule.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="basis_for.png" /></ac:image></p></div></td></tr><tr><td><strong>Supports Achievement Of </strong></td><td><p>This link connects <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:content-title="Goal" /></ac:link> or <ac:link><ri:page ri:content-title="Objective" /></ac:link>. Meaning that the Business Policy provides an<br />idea or reason to develop the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="supports_achievement_of.png" /></ac:image></p></div></td></tr><tr><td colspan="1"><strong>Acts As Regulation </strong></td><td colspan="1"><p>This link connects a <ac:link><ri:page ri:content-title="Business Policy" /></ac:link> or a <ac:link><ri:page ri:content-title="Business Rule" /></ac:link> to External Influencer.</p></td><td colspan="1"><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="acts_as_regulation.png" /></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Means+Concepts">Means Concepts</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170246 space=CBMP2024xR3 version=2 -->
## PAGE 00127: Means Concepts

- page_id: `227170246`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170246/Means+Concepts
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170096 space=CBMP2024xR3 version=2 -->
## PAGE 00128: Message Boundary Event

- page_id: `227170096`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170096/Message+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Message Boundary Event is triggered by an arrived message. Once triggered, it changes a normal flow into an exception flow or parallel.</p><p>A Message Boundary Event displays any of the following on the diagram:</p><ul><li>A Message Boundary Event name if the name is specified.</li><li>A Message Ref property value if the name is unspecified.</li><li>An Operation Ref property if the name and Message Ref are not specified.</li></ul><p><strong>Notation</strong></p><ul><li>Message Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_message.png" /></ac:image> </li><li>Message Boundary Event (Cancel Activity - False)<br /><ac:image><ri:attachment ri:filename="boundary_event_message_cancelactivity.png" /></ac:image></li></ul><p><br /></p><p><br /></p><p />
````

<!--NOMAGIC_PAGE id=227170066 space=CBMP2024xR3 version=2 -->
## PAGE 00129: Message Catching Intermediate Event

- page_id: `227170066`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170066/Message+Catching+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Message Flow is used to show the flow of messages between two participants who are prepared to send and receive them.</p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="a22639dc-1888-49e6-b405-3b6ece737c90"><ac:rich-text-body><ul><li>A Message Flow must connect separate Pools. It can be connected to the pool boundary or an element inside the pool.</li><li>A Message Flow cannot connect two elements in the same Pool.</li></ul></ac:rich-text-body></ac:structured-macro><p>Messages that are sent by a Message Flow can be displayed on a diagram in two ways:</p><ul><li>overlapping the Message Flow</li><li>associated with the Message Flow</li></ul><p>However, they can also be hidden.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_I.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Message Flows between two pools.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="message_flow_overlapping.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Messages overlapping Message Flows.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="collaboration_II.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Message Flows between Pools Inner elements.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Pool+and+Lane">Pool and Lane</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170038 space=CBMP2024xR3 version=3 -->
## PAGE 00132: Message Start Event

- page_id: `227170038`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170038/Message+Start+Event
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170378 space=CBMP2024xR3 version=2 -->
## PAGE 00134: Migrating from BPMN 1.1

- page_id: `227170378`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170378/Migrating+from+BPMN+1.1
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170379 space=CBMP2024xR3 version=2 -->
## PAGE 00135: Migrating to UML Profile for BPMN2 v1.0

- page_id: `227170379`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170379/Migrating+to+UML+Profile+for+BPMN2+v1.0
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170377 space=CBMP2024xR3 version=2 -->
## PAGE 00136: Migration

- page_id: `227170377`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170377/Migration
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170247 space=CBMP2024xR3 version=2 -->
## PAGE 00137: Mission

- page_id: `227170247`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170247/Mission
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170371 space=CBMP2024xR3 version=2 -->
## PAGE 00139: Modifying BPMN Table

- page_id: `227170371`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170371/Modifying+BPMN+Table
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170222 space=CBMP2024xR3 version=2 -->
## PAGE 00140: Multilevel with Owner Number

- page_id: `227170222`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170222/Multilevel+with+Owner+Number
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multilevel with Owner Number numbering schema provides multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is displayed before the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_multilevel.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Multilevel Numbering style with element owner number.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="c26a9a48-25c2-49b1-b7f4-2eb2f75b5282"><ac:rich-text-body><p>A Multilevel with Owner Number numbering schema is the default schema for all BPMN diagram elements.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170224 space=CBMP2024xR3 version=2 -->
## PAGE 00141: Multilevel without Owner Number

- page_id: `227170224`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170224/Multilevel+without+Owner+Number
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multilevel without Owner Number numbering schema provides multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center" ac:height="250"><ri:attachment ri:filename="element_numbering_multilevel_II.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Multilevel Numbering style without element owner number.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="47f86cd7-cfac-410d-a52b-3266d8d1fbfe"><ac:rich-text-body><p>When a Multilevel without element number numbering schema is used, the numbers in a project are not unique. Elements with the same number can exist in multiple diagrams.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170117 space=CBMP2024xR3 version=2 -->
## PAGE 00142: Multiple Boundary Event

- page_id: `227170117`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170117/Multiple+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multiple Boundary Event indicates that there are multiple triggers assigned to the Event. Only one of the specified triggers is required. The Event that occurred changes a normal flow into an exception flow.</p><p><strong>Notation</strong></p><ul><li>Multiple Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_multiple.png" /></ac:image></li><li>Multiple Boundary Event (Cancel Activity - False)<br /><ac:image><ri:attachment ri:filename="boundary_event_multiple_false.png" /></ac:image></li></ul><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170077 space=CBMP2024xR3 version=2 -->
## PAGE 00143: Multiple Catching Intermediate Event

- page_id: `227170077`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170077/Multiple+Catching+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multiple Catching Intermediate Event signifies that multiple types of events can be caught. Only one of the defined event triggers is required.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_catch_event_multiple.png" /></ac:image></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Catch+Event">Intermediate Catch Event</a></li></ul><p class="ancestor-link parent-link"><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170140 space=CBMP2024xR3 version=2 -->
## PAGE 00144: Multiple End Event

- page_id: `227170140`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170140/Multiple+End+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multiple End Event shows that there are multiple consequences of ending a process and all of them occur, for example, multiple messages might be sent.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event_multiple.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170057 space=CBMP2024xR3 version=3 -->
## PAGE 00145: Multiple Start Event

- page_id: `227170057`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170057/Multiple+Start+Event
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Multiple Start Event indicates that there are multiple ways to trigger a process. However, only one is required.</p><p><strong>Notation</strong></p><ul><li>Interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_interr.png" /></ac:image></li><li>Non-interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_noninterr.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170092 space=CBMP2024xR3 version=2 -->
## PAGE 00146: Multiple Throwing Intermediate Event

- page_id: `227170092`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170092/Multiple+Throwing+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Multiple Throwing Intermediate Event signifies that multiple types of events are thrown. All of the defined triggers will be thrown by this event.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_throwing_event_multiple.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170357 space=CBMP2024xR3 version=2 -->
## PAGE 00147: Navigation Between BPMN Diagrams

- page_id: `227170357`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170357/Navigation+Between+BPMN+Diagrams
- version_number: 2
...
````html
<p>You can navigate to</p><ul><li>higher level BPMN diagrams</li><li>related Process diagrams</li></ul><p>To navigate to a higher level BPMN diagrams</p><hr style="" /><ul><li>At the bottom left corner of the diagram pane, on the toolbar, click the <ac:image><ri:attachment ri:filename="up_button.png" /></ac:image> button and select higher level BPMN diagram.</li></ul><p><br /></p><p>To navigate to a related Process diagrams</p><hr style="" /><ul><li>At the bottom left corner of the diagram pane, on the toolbar, click the <ac:image ac:thumbnail="true" ac:height="44"><ri:attachment ri:filename="related.png" /></ac:image>button and select related process diagram.</li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+a+Diagram">Creating a Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+Tasks" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using Tasks</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+SubProcesses" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using SubProcesses</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Using+Activities">Using Activities</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+Data+Items" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using Data Items</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170124 space=CBMP2024xR3 version=2 -->
## PAGE 00148: None End Event

- page_id: `227170124`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170124/None+End+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined result.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170064 space=CBMP2024xR3 version=2 -->
## PAGE 00149: None Intermediate Event

- page_id: `227170064`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170064/None+Intermediate+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined trigger that invokes the start of a process.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="start_event.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170219 space=CBMP2024xR3 version=2 -->
## PAGE 00151: Numbering Elements

- page_id: `227170219`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170219/Numbering+Elements
- version_number: 2
...
````html
<p>Cameo Business Modeler offers an automatic numbering feature to number specific types of BPMN elements.</p><p>Each element number is saved in an ID property of element specification.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering.png" /></ac:image></p><h6 style="text-align: center;">BPMN Process Diagram showing element numbers.</h6><p>Numbering elements are described in the following sections:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="870a1867-d60b-4393-be38-eafdef2c714a" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170221 space=CBMP2024xR3 version=2 -->
## PAGE 00152: Numbering Schemas

- page_id: `227170221`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170221/Numbering+Schemas
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170241 space=CBMP2024xR3 version=2 -->
## PAGE 00153: Objective

- page_id: `227170241`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170241/Objective
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>An Objective is a statement of an attainable, time-targeted, and measurable target that the enterprise seeks to meet in order to achieve its Goals.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="objective.png" /></ac:image></p><p><br /></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Ends+Concepts" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Ends Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Concept+Relationships" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170300 space=CBMP2024xR3 version=2 -->
## PAGE 00154: Organization Structure Diagram

- page_id: `227170300`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170300/Organization+Structure+Diagram
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>Package groups together processes and other model elements. You can organize all types of model elements into packages. The Packages themselves can be nested within other Packages.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="package.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170150 space=CBMP2024xR3 version=3 -->
## PAGE 00157: Parallel Gateway

- page_id: `227170150`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170150/Parallel+Gateway
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Parallel Gateway is used to synchronize (combine) and create parallel flows.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="gateway_parallel.png" /></ac:image></p><p><strong>Example</strong></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Parallel_gateway.png" /></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Parallel Gateway.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Gateways">Gateways</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170120 space=CBMP2024xR3 version=2 -->
## PAGE 00158: Parallel Multiple Boundary Event

- page_id: `227170120`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170120/Parallel+Multiple+Boundary+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Parallel Multiple Boundary Event indicates that there are multiple triggers assigned to the event and all of them are required to trigger it.</p><p><strong>Notation</strong></p><ul><li>Parallel Multiple Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_parallel_multiple.png" /></ac:image></li><li>Parallel Multiple Boundary Event (Cancel Activity - False)<br /><ac:image><ri:attachment ri:filename="boundary_event_parallel_multiple_false.png" /></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170079 space=CBMP2024xR3 version=2 -->
## PAGE 00159: Parallel Multiple Catching Intermediate Event

- page_id: `227170079`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170079/Parallel+Multiple+Catching+Intermediate+Event
- version_number: 2
...
````html
<p><br /></p><p style="margin-top: 0.0px;"><strong>Description</strong></p><p>A Parallel Multiple Catching Intermediate Event signifies that multiple types of events are caught. All of the defined event triggers are required to trigger this event.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_catch_event_parallel_multiple.png" /></ac:image></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Catch+Event">Intermediate Catch Event</a></li></ul><p class="ancestor-link parent-link"><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170060 space=CBMP2024xR3 version=3 -->
## PAGE 00160: Parallel Multiple Start Event

- page_id: `227170060`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170060/Parallel+Multiple+Start+Event
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Parallel Multiple Start Event indicates that there are multiple triggers required before a process can be initiated.</p><p><strong>Notation</strong></p><ul><li>Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_interr.png" /></ac:image></li><li>Non-Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_noninterr.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170198 space=CBMP2024xR3 version=2 -->
## PAGE 00161: Participant

- page_id: `227170198`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170198/Participant
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170307 space=CBMP2024xR3 version=2 -->
## PAGE 00162: Person

- page_id: `227170307`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170307/Person
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Potential Reward is a category of Potential Impact that indicates the probability of gain. Some Potential Rewards are expressible as formulas, for example:</p><ul><li>Probability of gain (for example, 30% probability)</li><li>Potential gain (for example, $40,000 gain)</li></ul><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="potential_reward.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Assessment+Concepts">Assessment Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Assessment+Concept+Relationships" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Assessment Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170313 space=CBMP2024xR3 version=2 -->
## PAGE 00165: Process Definition Diagram

- page_id: `227170313`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170313/Process+Definition+Diagram
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170320 space=CBMP2024xR3 version=2 -->
## PAGE 00166: Realizes

- page_id: `227170320`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170320/Realizes
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>Realizes shows that a BPMN Process can realizes a Strategy or Tactic.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="realizes.png" /></ac:image></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170005 space=CBMP2024xR3 version=3 -->
## PAGE 00167: Receive Task

- page_id: `227170005`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170005/Receive+Task
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170281 space=CBMP2024xR3 version=2 -->
## PAGE 00169: Risk

- page_id: `227170281`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170281/Risk
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170003 space=CBMP2024xR3 version=3 -->
## PAGE 00172: Send Task

- page_id: `227170003`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170003/Send+Task
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Send Task is a simple task that is designed to send a message to an external participant. Once the message has been sent, the task is completed.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="send_task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170031 space=CBMP2024xR3 version=4 -->
## PAGE 00173: Sequence Flow

- page_id: `227170031`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170031/Sequence+Flow
- version_number: 4
...
````html
<p><strong>Description</strong></p><p>A Service Task is a task that uses some sort of service, which could be a Web service or an automated application.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="service_task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170114 space=CBMP2024xR3 version=2 -->
## PAGE 00175: Signal Boundary Event

- page_id: `227170114`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170114/Signal+Boundary+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170136 space=CBMP2024xR3 version=2 -->
## PAGE 00177: Signal End Event

- page_id: `227170136`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170136/Signal+End+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170054 space=CBMP2024xR3 version=3 -->
## PAGE 00178: Signal Start Event

- page_id: `227170054`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170054/Signal+Start+Event
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Signal Start Event means that a signal, which has been broadcast from another process, has arrived and triggered the start of a process.</p><p>A Signal Start Event displays either of the following on a diagram:</p><ul><li>A Signal Start Event name if the name is specified.</li><li>A Signal Ref property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_interr.png" /></ac:image></li><li>Non-Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_noninterr.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170086 space=CBMP2024xR3 version=2 -->
## PAGE 00179: Signal Throwing Intermediate Event

- page_id: `227170086`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170086/Signal+Throwing+Intermediate+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170035 space=CBMP2024xR3 version=3 -->
## PAGE 00180: Start Events

- page_id: `227170035`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170035/Start+Events
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170249 space=CBMP2024xR3 version=2 -->
## PAGE 00181: Strategy

- page_id: `227170249`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170249/Strategy
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A SubProcess is used to create a context for an exception handling that applies to a group of activities.</p><p>A collapsed SubProcess can be used as a mechanism to show a compact and less clutter group of parallel activities.</p><p><strong>Notation</strong></p><ul><li>Expanded SubProcess<br /><ac:image><ri:attachment ri:filename="expanded_subprocess.png" /></ac:image></li><li>Collapsed SubProcess<br /><ac:image><ri:attachment ri:filename="suppressed_subproces.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170015 space=CBMP2024xR3 version=3 -->
## PAGE 00185: SubProcesses

- page_id: `227170015`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170015/SubProcesses
- version_number: 3
...
<!--NOMAGIC_PAGE id=227169965 space=CBMP2024xR3 version=4 -->
## PAGE 00186: Supportive diagrams

- page_id: `227169965`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169965/Supportive+diagrams
- version_number: 4
...
<!--NOMAGIC_PAGE id=227170233 space=CBMP2024xR3 version=2 -->
## PAGE 00187: Supportive Diagrams Concepts

- page_id: `227170233`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170233/Supportive+Diagrams+Concepts
- version_number: 2
...
<!--NOMAGIC_PAGE id=227169966 space=CBMP2024xR3 version=3 -->
## PAGE 00188: Switching to Business Modeling Perspectives

- page_id: `227169966`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169966/Switching+to+Business+Modeling+Perspectives
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170251 space=CBMP2024xR3 version=2 -->
## PAGE 00189: Tactic

- page_id: `227170251`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170251/Tactic
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Task that has no specified behavior defined.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227169998 space=CBMP2024xR3 version=3 -->
## PAGE 00191: Tasks

- page_id: `227169998`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169998/Tasks
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170138 space=CBMP2024xR3 version=2 -->
## PAGE 00192: Terminate End Event

- page_id: `227170138`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170138/Terminate+End+Event
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Terminate End Event indicates that all activities in a process have to be immediately ended, including all the instances of multi-instance activities. The process will be ended without any compensation or event handling.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event_terminate.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=227169977 space=CBMP2024xR3 version=3 -->
## PAGE 00193: Text Annotation

- page_id: `227169977`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169977/Text+Annotation
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Text Annotation allows a modeler to provide additional information about elements for the reader of a BPMN diagram.</p><p><strong>Example</strong></p><p><strong><br /></strong><ac:image><ri:attachment ri:filename="text_annotation.png" /></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227170099 space=CBMP2024xR3 version=2 -->
## PAGE 00194: Timer Boundary Event

- page_id: `227170099`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170099/Timer+Boundary+Event
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170041 space=CBMP2024xR3 version=3 -->
## PAGE 00196: Timer Start Event

- page_id: `227170041`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170041/Timer+Start+Event
- version_number: 3
...
````html
<p>Description</p><p>A Timer Start Event allows a particular time and date or cycle setting, for example, on Mondays at 9 A.M., to trigger the start of a process.</p><p>A Timer Start Event displays any of the following on a diagram:</p><ul><li>A Timer Start Event name if the name is specified.</li><li>A Time Cycle property name if the name is unspecified.</li><li>A Time Date property if the name and Time Cycle are unspecified.</li></ul><p>Notation</p><ul><li>Interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_interr.png" /></ac:image></li><li>Non-interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_noninterr.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170026 space=CBMP2024xR3 version=3 -->
## PAGE 00197: Transaction

- page_id: `227170026`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170026/Transaction
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A Transaction is a specialized type of SubProcess whose special behavior is controlled through a transaction protocol (such as WS-Transaction).</p><p><strong>Notation</strong></p><ul><li>Expanded<br /><ac:image><ri:attachment ri:filename="transaction.png" /></ac:image></li><li>Collapsed<br /><ac:image><ri:attachment ri:filename="transaction_suppressed.png" /></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=227170316 space=CBMP2024xR3 version=2 -->
## PAGE 00198: Usage

- page_id: `227170316`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170316/Usage
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A Usage is a BPMNRelationship in which one element requires another element (or set of elements) for its full implementation or operation.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="use.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227169960 space=CBMP2024xR3 version=3 -->
## PAGE 00199: User Guide

- page_id: `227169960`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227169960/User+Guide
- version_number: 3
...
<!--NOMAGIC_PAGE id=227170007 space=CBMP2024xR3 version=3 -->
## PAGE 00200: User Task

- page_id: `227170007`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170007/User+Task
- version_number: 3
...
````html
<p><strong>Description</strong></p><p>A User Task is a typical workflow task where a human performer performs the task with the assistance of software and is scheduled through a task list manager of some sort.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="user_task.png" /></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=227170350 space=CBMP2024xR3 version=2 -->
## PAGE 00201: Using Activities

- page_id: `227170350`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170350/Using+Activities
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170365 space=CBMP2024xR3 version=2 -->
## PAGE 00202: Using BPMN Choreography Diagram

- page_id: `227170365`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170365/Using+BPMN+Choreography+Diagram
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170360 space=CBMP2024xR3 version=2 -->
## PAGE 00203: Using BPMN Collaboration Diagram

- page_id: `227170360`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170360/Using+BPMN+Collaboration+Diagram
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170374 space=CBMP2024xR3 version=2 -->
## PAGE 00204: Using BPMN Element Numbers

- page_id: `227170374`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170374/Using+BPMN+Element+Numbers
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170347 space=CBMP2024xR3 version=2 -->
## PAGE 00205: Using BPMN Process Diagram

- page_id: `227170347`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170347/Using+BPMN+Process+Diagram
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170370 space=CBMP2024xR3 version=2 -->
## PAGE 00206: Using BPMN Tables and Matrices

- page_id: `227170370`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170370/Using+BPMN+Tables+and+Matrices
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170344 space=CBMP2024xR3 version=2 -->
## PAGE 00207: Using Cameo Business Modeler Plugin

- page_id: `227170344`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170344/Using+Cameo+Business+Modeler+Plugin
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170366 space=CBMP2024xR3 version=2 -->
## PAGE 00208: Using Choreography Activity

- page_id: `227170366`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170366/Using+Choreography+Activity
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170346 space=CBMP2024xR3 version=2 -->
## PAGE 00209: Using Common BPMN Elements

- page_id: `227170346`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170346/Using+Common+BPMN+Elements
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170373 space=CBMP2024xR3 version=2 -->
## PAGE 00210: Using Organization Structure Diagram

- page_id: `227170373`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170373/Using+Organization+Structure+Diagram
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170380 space=CBMP2024xR3 version=2 -->
## PAGE 00211: Validation Rules

- page_id: `227170380`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170380/Validation+Rules
- version_number: 2
...
<!--NOMAGIC_PAGE id=227170237 space=CBMP2024xR3 version=2 -->
## PAGE 00212: Vision

- page_id: `227170237`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170237/Vision
- version_number: 2
...
````html
<p><strong>Description</strong></p><p>A vision is a state where an organization wants to achieve in the future. It is common that a vision is made up of many aspects rather than concentrated on a specific factor of the business problem. It is the final, possibly unattainable, state the organization would like to accomplish. It does not describe how the organization will achieve the state. A Vision is often compound, rather than focused toward one particular aspect of the business problem. It is supported or made operative by Missions and amplified by Goals.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="vision.png" /></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Ends+Concepts" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Ends Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Concept+Relationships" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=227170231 space=CBMP2024xR3 version=2 -->
## PAGE 00213: XPDL Support

- page_id: `227170231`
- space_key: `CBMP2024xR3`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR3/pages/227170231/XPDL+Support
- version_number: 2
