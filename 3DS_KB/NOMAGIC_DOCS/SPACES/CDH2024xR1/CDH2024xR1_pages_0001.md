# NOMAGIC DOCUMENTATION SPACE: Cameo DataHub 2024x Refresh1

<!--NOMAGIC_SPACE key=CDH2024xR1 chunk=1 -->

<!--NOMAGIC_PAGE id=170465214 space=CDH2024xR1 version=4 -->
## PAGE 00001: 2024x Refresh1 Version News

- page_id: `170465214`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465214/2024x+Refresh1+Version+News
- version_number: 4
- version_date: `2024-06-05T11:15:17.731+02:00`
...
<!--NOMAGIC_PAGE id=170465587 space=CDH2024xR1 version=1 -->
## PAGE 00004: Adding a new node to a Data Source

- page_id: `170465587`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465587/Adding+a+new+node+to+a+Data+Source
- version_number: 1
...
4. Open the [DHLink Summary](https://docs.nomagic.com/display/CDH2024xR1/DHLink+summary) dialog in MagicDraw to [CONFLUENCE_PAGE title='Working with DHLink Summary reports' space='CDH2024xR1']
...
````html
<p>DataHub uses report template code from its report template to create the layout and detail of a <strong>DHLink Summary</strong> report. You can find the report template file in <em style="text-align: left;">&lt;install_root&gt;\</em><em>plugins\com.nomagic.datahub.magicdraw\data\templates\relation.html</em>. You can edit the report template file with any text editors to add more information to the report template. In this scenario, you want to add another attribute to the report template.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="The Inside of a Report Template" ac:alt="The Inside of a Report Template"><ri:attachment ri:filename="datahub-folder-relation-template.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding another attribute into the report template" /></ri:attachment></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The report template code inside the report template file and the construction of the report layout and data script.</h6><p>To add another attribute to the report template and generate a DHLink Summary report</p><hr /><ol><li>Open the template file located in <em style="text-align: left;">&lt;install_root&gt;\</em><em>plugins\com.nomagic.datahub.magicdraw\data\templates\relation.html</em>. with any text editors.</li><li><p class="auto-cursor-target">Type the following code in the highlighted area of the report template code fragment to add more attributes to the report template file. For example, if you want to add the <strong>Created Thru</strong> attributes into the report template file to include them in the DHLink Summary report, you must replace <em>&lt;Attribute name&gt;</em> with <strong>Created Thru</strong>.<br /><br /></p><ac:structured-macro ac:name="code" ac:schema-version="1" ac:macro-id="0d0a735e-5a93-4102-8d64-7f424a1bf17b"><ac:parameter ac:name="language">text</ac:parameter><ac:parameter ac:name="title">The code for adding another attribute in the report template file</ac:parameter><ac:plain-text-body><![CDATA[<br/>$DataHubReportEngine.decorateHTMLTag($row.sourceElement.entity.getAttributeValue("<Attribute name>"))]]></ac:plain-text-body></ac:structured-macro><h6 style="text-align: center;"><ac:image ac:align="left"><ri:attachment ri:filename="Report Template File.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding another attribute into the report template" /></ri:attachment></ac:image><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="8c810da1-595f-4a5c-b948-268d17398be8"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>The name of the attribute you want to add in the report template file must be the same as the one that appears in the <strong>Cameo DataHub Properties</strong> tab.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Attribute Name in Property Tab.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding another attribute into the report template" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The attribute name, e.g., Created Thru, in the DataHub Properties tab must match the &lt;Attribute name&gt; in the report template code.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li><p><span class="confluence-link">Save the template file.</span></p></li><li><p>Open the <a href="https://docs.nomagic.com/display/CDH2024xR1/DHLink+summary">DHLink Summary</a> dialog in MagicDraw to <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Working with DHLink Summary reports" /><ac:plain-text-link-body><![CDATA[generate the DHLink Summary report.]]></ac:plain-text-link-body></ac:link></p></li></ol><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Summary Report (Before).png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding another attribute into the report template" /></ri:attachment></ac:image></p><h6 style="text-align: center;">A DHLink Summary report generated from the report template before adding another attribute.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Summary Report (After).png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding another attribute into the report template" /></ri:attachment></ac:image></p><h6 style="text-align: center;">A DHLink Summary report generated from the report template after adding another attribute.</h6>
````

<!--NOMAGIC_PAGE id=170465912 space=CDH2024xR1 version=1 -->
## PAGE 00006: Adding Data Sources for an OSLC Provider

- page_id: `170465912`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465912/Adding+Data+Sources+for+an+OSLC+Provider
- version_number: 1
...
1. [CONFLUENCE_PAGE title='Authentication with 3DEXPERIENCE platform' space='MD2024xR1']
...
- [CONFLUENCE_PAGE title='Authentication with 3DEXPERIENCE platform' space='MD2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="dba16862-8192-428e-8e62-d1e14ce27151"><ac:parameter ac:name="id">65844939</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="20273322-8830-436e-bd3d-b0ea1b576161"><ac:parameter ac:name="id">65844950</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="68b930b1-5bad-4ba2-84e2-2caa9195c601"><ac:parameter ac:name="id">65844940</ac:parameter><ac:rich-text-body><p>The ENOVIA Requirements connector, based on the Cameo DataHub framework, provides the data copy and synchronization functionality between your model and the requirement management application on the 3DEXPERIENCE platform. SAML is also supported for passing authorization credentials to the platform. Furthermore, Cameo DataHub enhances the ENOVIA requirements connection by applying a login with an embedded browser in place of a simple login form. As this is the new authentication technique, this login method allows you to connect to both requirement data sources deployed on Premises and Cloud.</p><p><br /></p><p>To add an ENOVIA <span>Requirements </span>Data Source</p><hr /><ol><li><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Authentication with 3DEXPERIENCE platform" /><ac:plain-text-link-body><![CDATA[Log in to the 3DEXPERIENCE platform.]]></ac:plain-text-link-body></ac:link></li><li><p class="auto-cursor-target">In the main menu, select 3DEXPERIENCE &gt; ENOVIA Requirements.<br /><br /><ac:image><ri:attachment ri:filename="ENOVIA Requirements option.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ri:attachment></ac:image><br /><br /></p></li><li>In the specification selection dialog, from the list of all specifications available select one specification and click <strong>Connect</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Specification Selection dialog.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ri:attachment></ac:image><br /><br /><span style="color: rgb(62,63,64);">The one specification added is available in the new tab in the Cameo DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="Specification Added.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ri:attachment></ac:image><br /></span></li></ol><p><span style="color: rgb(62,63,64);">To add more specifications one at a time</span></p><hr /><ul><li><span style="color: rgb(62,63,64);">Select the<span> </span></span><strong style="text-align: left;">Add single requirement specification</strong><span style="color: rgb(62,63,64);"><span> </span>option<span> </span></span><span style="color: rgb(62,63,64);">from the ENOVIA data source shortcut menu.<br /><br /><ac:image><ri:attachment ri:filename="ENOVIArequirements_AddMoreSpecs.jpg"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ri:attachment></ac:image><br /></span></li></ul><p><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d1fa161a-57e1-4836-8f3a-598f14e15e5a"><ac:rich-text-body><p><span style="color: rgb(62,63,64);">The Specification Folder name is not displayed in the Cameo DataHub Explorer panel; only the name of the Requirement Specification name is displayed. The Specification Folder name is displayed in the specification selection dialog.<br /><br /></span><span style="color: rgb(62,63,64);"><ac:image><ri:attachment ri:filename="Specification Folder name.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ri:attachment></ac:image><br /></span></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="07dd2a62-40b1-4841-b921-ac87995bed74"><ac:parameter ac:name="id">65844938</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><a href="https://docs.nomagic.com/display/CDH2024xR1/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool">Mapping source and target types to copy data to and from a modelling tool</a></li><li><ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Authentication with 3DEXPERIENCE platform" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465772 space=CDH2024xR1 version=1 -->
## PAGE 00009: Adding Data Sources for IBM Rational DOORS

- page_id: `170465772`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465772/Adding+Data+Sources+for+IBM+Rational+DOORS
- version_number: 1
- version_date: `2024-03-12T11:27:58.044+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b908ab67-a3d0-49fb-972e-6fc5d2c602d9"><ac:rich-text-body><p>With the Jama Connect 9.29 Cloud release (9.28.x for Self-Hosted and Customer-Validated Cloud), Jama Software is introducing <strong>API Reporting</strong>. This new view enables Organization Admins to monitor REST API usage, including active users, their OAuth Client IDs, and volumes. <span style="letter-spacing: 0.0px;">To support this enhancement, REST API access will be limited to users with </span><strong style="letter-spacing: 0.0px;">Named Creator </strong><span style="letter-spacing: 0.0px;">licenses. For any questions about licensing requirements, contact your Customer Success Manager.</span></p></ac:rich-text-body></ac:structured-macro><h3>Adding Data Sources for JAMA Connect</h3><p><span style="color:var(--ds-text,#333333);">To add a Jama Connect d</span><span style="color:var(--ds-text,#333333);">ata source</span></p><hr /><ol><li><span style="color:var(--ds-text,#333333);">In the<span> Cameo </span>DataHub Explorer<span> </span>toolbar, click <strong style="text-align: left;">Add Data Source.<br /><br /><ac:image><ri:attachment ri:filename="Add data source.png" /></ac:image><br /></strong></span></li><li><span style="color:var(--ds-text,#333333);">In the Add Data Source dialog, select<span> <strong>Jama Connect </strong></span>from the<span> </span><strong>Driver </strong>drop-down list<span><strong>.</strong></span><br /><br /><ac:image><ri:attachment ri:filename="Select JAMA Connect.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">Enter the server URL and login information and click<strong> Create.</strong><br /><br /><ac:image><ri:attachment ri:filename="Add data source_Dialog.png" /></ac:image><br /><br /></span></li><li><span style="color:var(--ds-text,#333333);">From the JAMA Single Project Selection dialog, select the project and click <strong>Connect</strong>.<br /><br /><ac:image><ri:attachment ri:filename="JAMA Single Project Selection.png" /></ac:image><br /><br /></span></li></ol><p><span style="color:var(--ds-text,#333333);">The data source is added in the Cameo DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="CDH Explorer Panel.png" /></ac:image><br /></span></p><p><span style="color:var(--ds-text,#333333);">The following video shows the </span><span>Jama Connect to modeling tool Integration:</span></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="0b830d90-35e2-42f0-8b99-55cb8928e6ff"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=HT1OIG7bAGY&amp;t=2s" /></ac:parameter><ac:parameter ac:name="height">400</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages:</strong></p><ul><li><ac:link><ri:page ri:content-title="Diagram Synchronization" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=170465883 space=CDH2024xR1 version=2 -->
## PAGE 00012: Adding Data Sources for OSLC Provider

- page_id: `170465883`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465883/Adding+Data+Sources+for+OSLC+Provider
- version_number: 2
- version_date: `2024-05-08T13:50:49.088+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources
- labels: []

### NORMALIZED CONTENT

See the [Adding Data Sources for an OSLC Provider](https://docs.nomagic.com/display/CDH2024xR1/Adding+Data+Sources+for+an+OSLC+Provider) in the [Working with OSLC features](https://docs.nomagic.com/display/CDH2024xR1/Working+with+OSLC+features) section.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>See the <a href="https://docs.nomagic.com/display/CDH2024xR1/Adding+Data+Sources+for+an+OSLC+Provider">Adding Data Sources for an OSLC Provider</a> in the <a href="https://docs.nomagic.com/display/CDH2024xR1/Working+with+OSLC+features">Working with OSLC features</a> section.</p>
````

<!--NOMAGIC_PAGE id=170466360 space=CDH2024xR1 version=1 -->
## PAGE 00013: Additional DataHub features

- page_id: `170466360`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466360/Additional+DataHub+features
- version_number: 1
- version_date: `2022-01-21T11:34:10.510+01:00`
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="c8e60424-3f08-4b50-8545-d985914b323f"><ac:parameter ac:name="id">1250365201</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="a06e9a9a-012e-4fac-81e1-8dd2b89b4fa7"><ac:parameter ac:name="id">1250365204</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="bc5a4adf-2c89-4611-a2f6-dfb2846dfde5"><ac:parameter ac:name="id">1250365202</ac:parameter><ac:rich-text-body><p>In this section, you will learn more about Alias Manager to deal with aliases in DataHub, DHLink panel for identification of changes in each data node, Schema Map Manager and its user interface components to edit or deactivate the mappings, and the database clean-up operation for unused reference removal in projects from modeling tools.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="675f3d1b-3f91-40d8-a312-773d441eebf8"><ac:parameter ac:name="id">1250365200</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3278b749-703c-4697-975d-46d6632673e6" /></p><p><br /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465310 space=CDH2024xR1 version=1 -->
## PAGE 00014: Alias Manager

- page_id: `170465310`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465310/Alias+Manager
- version_number: 1
...
````html
<p>DataHub <strong>Alias Manager</strong> contains a list of all available aliases. It stores these aliases for later use, and you can either access or remove them.</p><p><br /></p><p>To open Alias Manager</p><hr /><ul><li>From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Alias Manager</strong>. The <strong>Alias Manager</strong> dialog opens.</li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Alias Manager" ac:alt="DataHub Alias Manager"><ri:attachment ri:filename="alias-manager.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Alias Manager" /></ri:attachment></ac:image></p>
````

<!--NOMAGIC_PAGE id=170465379 space=CDH2024xR1 version=3 -->
## PAGE 00015: Basic features of DataHub

- page_id: `170465379`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465379/Basic+features+of+DataHub
- version_number: 3
- version_date: `2026-02-10T14:02:37.607+01:00`
...
<!--NOMAGIC_PAGE id=170465961 space=CDH2024xR1 version=2 -->
## PAGE 00016: Business Use Case flow with DNG

- page_id: `170465961`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465961/Business+Use+Case+flow+with+DNG
- version_number: 2
- version_date: `2024-05-08T13:50:49.680+02:00`
...
OSLC root services document URI can be found using the following pattern - http(s)://TWC_IP:PORT/oslc/rootservices. For more information, see [OSLC API](https://docs.nomagic.com/display/TWCloud2024xR1/OSLC+API).

You must also [publish the project as an OSLC resource in Cameo Collaborator for Teamwork Cloud](https://docs.nomagic.com/display/CC4TWC2024xR1/Publishing+an+OSLC+resource).

After establishing server and project-level relationships, open your modeling tool ([MagicDraw](https://docs.nomagic.com/display/MD2024xR1), [Cameo Systems Modeler](https://docs.nomagic.com/display/CSM2024xR1), or [Cameo Enterprise Architecture](https://docs.nomagic.com/display/CEA2024xR1)), and perform the following steps:

1. Add requirements (import or sync) from DNG through DataHub as described at [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space='CDH2024xR1'].
2. Copy requirements from DataHub to your model as described at [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR1']. The adding of requirements has been enhanced during OSLC consumer implementation in version 19.0. Users are able to see the DNG requirement’s OSLC Previews in the [OSLC Preview](https://docs.nomagic.com/display/CDH2024xR1/OSLC+Preview) tab of a modeling tool.
...
<!--NOMAGIC_PAGE id=170465878 space=CDH2024xR1 version=1 -->
## PAGE 00024: Configuration Management

- page_id: `170465878`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465878/Configuration+Management
- version_number: 1
...
- [CONFLUENCE_PAGE title='Installing Teamwork Cloud on Windows' space='TWCloud2024xR1']
- [CONFLUENCE_PAGE title='Cameo Collaborator for Teamwork Cloud Documentation' space='CC4TWC2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="7f1a2983-c755-4a89-ac80-9176c6922cfe"><ac:parameter ac:name="id">1248351166</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="e2ad1631-91cb-4a2d-afb3-a1987e62b772"><ac:parameter ac:name="id">1248351186</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="b1efd3fe-a297-4d4f-9729-c47bb3b00046"><ac:parameter ac:name="id">1248351176</ac:parameter><ac:rich-text-body><h3>Software requirements</h3><p>To link and share data using Open Services for Lifecycle Collaboration (OSLC) integration, ensure that the following software requirements are met:</p><ul><li>The following software is installed on your machine:<ol><li>Modeling tool with the Requirements plugin (e.g., MagicDraw + Requirements plugin, Cameo Systems Modeler, Cameo Enterprise Architecture)</li><li>Cameo DataHub</li></ol></li></ul><ul><li class="auto-cursor-target">You have access to the following software on a server:<br /><ol><li>Teamwork Cloud</li><li>Cameo Collaborator for Teamwork Cloud</li><li>Doors Next Generation v6.0.3+ (DNG)<br /><br /></li></ol></li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="4d23ba4a-401c-4b82-8cc0-3dd47bf95b75"><ac:parameter ac:name="title">Software versions</ac:parameter><ac:rich-text-body><p>You must use the same version of a modeling tool and Cameo DataHub, and the same version of Teamwork Cloud and Cameo Collaborator for Teamwork Cloud. For more information, see the <a href="https://www.nomagic.com/support/compatibility">product compatibility page</a>.</p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="3d1d5053-4153-4112-a349-50d3b840634a"><ac:parameter ac:name="id">1248351165</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><ul><li><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Installing modeling tools" /></ac:link></li><li><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Installing plugins in earlier versions" /><ac:plain-text-link-body><![CDATA[Installing plugins]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="TWCloud2024xR1" ri:content-title="Installing Teamwork Cloud on Windows" /><ac:plain-text-link-body><![CDATA[Installing and configuring Teamwork Cloud]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="CC4TWC2024xR1" ri:content-title="Cameo Collaborator for Teamwork Cloud Documentation" /><ac:plain-text-link-body><![CDATA[Installing Cameo Collaborator for Teamwork Cloud]]></ac:plain-text-link-body></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465520 space=CDH2024xR1 version=2 -->
## PAGE 00026: Confirmation

- page_id: `170465520`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465520/Confirmation
- version_number: 2
- version_date: `2024-05-08T13:50:48.323+02:00`
...
<!--NOMAGIC_PAGE id=170465857 space=CDH2024xR1 version=1 -->
## PAGE 00031: Copying DHLinks across Stream or Baseline Data Sources

- page_id: `170465857`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465857/Copying+DHLinks+across+Stream+or+Baseline+Data+Sources
- version_number: 1
...
To copy OSLC query results to a modeling tool as SysML Requirements, you must set up [CONFLUENCE_PAGE title='Adding IBM Rational DOORS Next Generation Data Sources' space='CDH2024xR1']an IBM® Rational® DOORS® Next Generation Data Source and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.

To copy OSLC query results to a modeling tool as SysML Requirements

1. Complete the steps of [CONFLUENCE_PAGE title='Creating OSLC queries' space='CDH2024xR1'] .
...
````html
<p>To copy OSLC query results to a modeling tool as SysML Requirements, you must set up <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Adding IBM Rational DOORS Next Generation Data Sources" /><ac:link-body>an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</ac:link-body></ac:link> and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.</p><p>To copy OSLC query results to a modeling tool as SysML Requirements</p><hr /><ol><li>Complete the steps of <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating OSLC queries" /><ac:plain-text-link-body><![CDATA[creating OSLC queries]]></ac:plain-text-link-body></ac:link>.</li><li>From the OSLC query results, drag the matching query tree to the Containment tree of the modeling tool.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="export-from-oslc-qe.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" /></ri:attachment></ac:image><br /><br /></p><p style="margin-left: 30.0px;">2. The <strong>Copy Data</strong> dialog opens. From the target type list in the <strong>MagicDraw Side</strong> group, choose <strong>Extended Requirement</strong>. Click <strong>OK</strong>.<br /><br /></p><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Copy Data for OSLC Query User Guide.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" /></ri:attachment></ac:image></p><p><br /></p><p>The result of the copy is shown in the MagicDraw Containment tree.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="export-doors-ng-node-2.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" /></ri:attachment></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The result of the copied OSLC query in the MagicDraw Containment tree.</h6><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="c9cbee8c-4d2b-4f4b-8733-bc9cbfe86342"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p style="margin-left: 30.0px;"><strong>OSLC Query Editor</strong><span> supports the </span><strong>Copy Data</strong>,<strong> Copy Data with DHTrace</strong>, and<strong> Create DHTrace</strong><strong> </strong>operations<span>.</span></p><p style="margin-left: 30.0px;"><span><br /></span></p><p><ac:image ac:align="center"><ri:attachment ri:filename="OSLC Query Editor.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Copy Data, Copy Data with DHTrace, and Create DHTrace operations are supported in the OSLC Query Editor dialog.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=170465726 space=CDH2024xR1 version=1 -->
## PAGE 00033: Copying Requirements into a modeling tool

- page_id: `170465726`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465726/Copying+Requirements+into+a+modeling+tool
- version_number: 1
- version_date: `2018-08-06T09:33:51.460+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="3bace6fd-1495-4d7b-873e-9ecceef89065"><ac:parameter ac:name="id">994309026</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="0bf18c7b-0ac9-4741-8c1b-fd39110197fc"><ac:parameter ac:name="id">994309028</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="7b571820-a153-4830-b87c-16359c9ff60b"><ac:parameter ac:name="id">994309027</ac:parameter><ac:rich-text-body><p>DataHub allows you to copy Requirements from DOORS into UML diagrams, from DOORS Data Source to the Containment area as Use Case diagrams, from DOORS or DOORS Next Generation to a modeling tool with DHLinks, and copy Requirements using OSLC links.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="09b1a4c3-8cab-4824-a0ee-622abd022657"><ac:parameter ac:name="id">994309025</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="96c19c2f-7366-41b0-ad7b-00ce7fa929ff" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465727 space=CDH2024xR1 version=1 -->
## PAGE 00034: Copying Requirements to a modeling tool as the SysML Requirement diagram

- page_id: `170465727`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465727/Copying+Requirements+to+a+modeling+tool+as+the+SysML+Requirement+diagram
- version_number: 1
...
1. [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS' space='CDH2024xR1'] or [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space='CDH2024xR1'] in DataHub Explorer.
...
````html
<p>This section deals with copying a Use Case diagram from a DOORS Data Source into your modeling tool's Containment area.</p><p>To copy a Use Case from a DOORS Data Source to a modeling tool as the Use Case diagram</p><hr /><ol><li><a href="https://docs.nomagic.com/display/CDH2024xR1/Adding+Data+Sources+for+IBM+Rational+DOORS">Add a DOORS Data Source </a>or <a href="https://docs.nomagic.com/display/CDH2024xR1/Adding+Data+Sources+for+IBM+Rational+DOORS+Next+Generation">DOORS Next Generation Data Source </a>in DataHub Explorer.</li><li><p style="text-align: left;">Drag the selected node from DOORS Data Source to your modeling tool's Containment tree.<br /><br /><ac:image ac:title="Drag and drop to copy requirements from DOORS data source to MagicDraw" ac:alt="Drag and drop to copy requirements from DOORS data source to MagicDraw"><ri:attachment ri:filename="importing-reqs-from-doors-ds.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" /></ri:attachment></ac:image><br /><br /></p></li><li><p style="text-align: left;">Map the Formal Module to a Use Case diagram type and the object to a Use Case type. Click <strong>OK</strong>.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Copy Data with Object.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" /></ri:attachment></ac:image></p></li></ol><h6 style="text-align: center;margin-left: 30.0px;">The Copy Data dialog in Group Type Mapping mode when copying Use Case elements from DOORS to the modeling tool's Containment area.</h6><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Result of copying Use Case Diagram to MagicDraw" ac:alt="Result of copying Use Case Diagram to MagicDraw"><ri:attachment ri:filename="result-of-import-use-case.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Use Case diagram after copying Requirements from DOORS to a modeling tool.</h6>
````

<!--NOMAGIC_PAGE id=170465744 space=CDH2024xR1 version=1 -->
## PAGE 00036: Copying Requirements to a modeling tool with DHLinks

- page_id: `170465744`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465744/Copying+Requirements+to+a+modeling+tool+with+DHLinks
- version_number: 1
...
This version of DataHub now supports OSLC queries and links that you can [CONFLUENCE_PAGE title='Create DHTrace operation with OSLC links' space='CDH2024xR1'].
...
- [CONFLUENCE_PAGE title='Creating OSLC links' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="3b096e85-c825-46e5-b653-873f9261ccfa"><ac:parameter ac:name="id">642762005</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="60128dcb-bd19-458b-89b2-ab85b0de3d0c"><ac:parameter ac:name="id">642762008</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="374dc0da-b57c-4a40-8072-fadeff9f8eb6"><ac:parameter ac:name="id">642762004</ac:parameter><ac:rich-text-body><p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="459f7df5-8ae8-4715-8dcc-a54c507b13da"><ac:parameter ac:name="maxLevel">3</ac:parameter><ac:parameter ac:name="minLevel">3</ac:parameter></ac:structured-macro></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="b7c02f55-0656-41ee-a192-8e9994f5c0c2"><ac:parameter ac:name="id">642762007</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="eb70b979-0fa0-474c-8101-94279fb2a98e"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In addition to creating DHTrace, the <strong>Create DHTrace</strong> operation enables you to create OSLC links instead of using the <strong>Create OSLC link</strong> operation in earlier versions of Cameo DataHub 19.0.</p></ac:rich-text-body></ac:structured-macro><h3>Create DHTrace operation</h3><p>This DataHub operation does not copy data. It only creates a DHTrace link from a source to a target. When the source has any changes, the DHTrace link becomes <strong>Suspect</strong>.</p><p><br /></p><p>To create DHTrace</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create_DHTrace.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image><br /><br /></li><li>Drag any nodes from <strong>DataHub Explorer</strong> to the MagicDraw Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="MD Tree for CreateDHTrace.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image><br /><br />The <strong>Create DHTrace Summary</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Create DHTrace Summary Dialog.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image><br /><br /></li><li>When you modify the source nodes, right-click one of them and select <strong>Check Changes</strong> &gt; <strong>Check DHTrace Changes</strong> or <strong>Check DHTrace Changes recursively</strong>. The <strong>DHTrace Summary</strong> dialog appears showing the <strong>Suspect</strong> status of the DHTrace links.<br /><br /><ac:image><ri:attachment ri:filename="DHTrace Summary.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image><br /><br /></li><li>Select the checkboxes of the data nodes you want to clear the <strong>Suspect</strong> status in the <strong>DHTrace Summary</strong> dialog and click <strong>OK</strong>.</li></ol><h3>Creating OSLC links through the Create DHTrace operation</h3><p><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ad0ec783-712d-491a-8709-a013333b8cc6"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p>OSLC links can be created when you open an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source in DataHub.</p><p><br /></p><p>To create an OSLC link</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in <strong>DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.</li><li><p class="_mce_tagged_br" style="text-align: left;">From an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source, drag a node into the MagicDraw<sup>®</sup> Containment area.</p></li><li><p class="_mce_tagged_br" style="text-align: left;">A shortcut menu prompts you to choose the type of link. Select one from the shortcut menu. The link of the selected type will be created.<br /><br /></p><ac:image ac:align="left" ac:title="Figure OSLC Link types" ac:alt="Figure OSLC Link types"><ri:attachment ri:filename="worddav5a3754b972c5e28584dc28a2a6a5178a.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image></li></ol><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="worddav940b362d2a8553e7320fdc5b60af115c.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree.</h6><p style="text-align: center;margin-left: 30.0px;"><ac:image ac:title="Properties of OSLC Link " ac:alt="Properties of OSLC Link "><ri:attachment ri:filename="worddavae7ad7197fdcea58505c68e4c441a7fb.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink's Properties.</h6><p style="margin-left: 30.0px;text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Hyperlink.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ri:attachment></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink is in the DH Links panel.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="142f3b68-2be4-4de6-be92-afe53703ff02"><ac:parameter ac:name="id">642793773</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating OSLC links" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465689 space=CDH2024xR1 version=1 -->
## PAGE 00039: Create Sync operation

- page_id: `170465689`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465689/Create+Sync+operation
- version_number: 1
...
3. The Create Sync Wizard will appear. Perform the Type/Attribute mapping as you would while using the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR1'] . [ATTACHMENT filename='CreateSync_Wizard.png']
...
- [CONFLUENCE_PAGE title='Copy Data with Sync' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="e6564bca-7b9f-4b8d-8162-6049f7d9a017"><ac:parameter ac:name="id">543550767</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="d32c6669-6ba8-4e15-8f90-0f7bde0c0ddc"><ac:parameter ac:name="id">543550769</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="9911f450-ffd4-4546-b5de-aba33d59b6d0"><ac:parameter ac:name="id">543550768</ac:parameter><ac:rich-text-body><p>There are two types of links supported by DataHub: DHLinks and DHTrace links. You can choose to copy data with DHLinks, with DHTrace links, or without any links.</p><p><br /></p><p>To create a DHTrace link</p><hr /><ol><li>From the <strong>Operations</strong> drop-down list, select the <strong>Create DHTrace</strong> option.</li><li>Drag a node, e.g., a DOORS or CSV Data Source, to the MagicDraw Containment tree.</li><li>The <strong>Create DHTrace Summary</strong> dialog box opens to confirm the DHTrace link has been created.</li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DHTrace Summary dialog - shows when you create a DHTrace" ac:alt="DHTrace Summary dialog - shows when you create a DHTrace"><ri:attachment ri:filename="create-dhtrace-summary-a.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating DHTrace links" /></ri:attachment></ac:image></p><p style="margin-left: 30.0px;"><br /></p><p>The DHTrace links appear on the <strong>DH Links</strong> panel.</p><p><br /></p><p><ac:image ac:align="center" ac:title="The newly created DHTrace in the DHLinks panel" ac:alt="The newly created DHTrace in the DHLinks panel"><ri:attachment ri:filename="dhlink-panel-view.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating DHTrace links" /></ri:attachment></ac:image></p><h6 style="text-align: center;">DHTrace links on the DH Links panel.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d954e575-4b9d-42bb-9b47-756251a88256"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>Nodes that contain DHTrace links are indicated with small half-green squares. In the following figure, the DHTrace links are created between CSV Data Source nodes and MagicDraw elements. The links are indicated with small half-green squares in <strong>Cameo DataHub Explorer</strong> and the MagicDraw Containment tree.<br /><br /><ac:image ac:align="center"><ri:attachment ri:filename="create-dh-trace-c.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating DHTrace links" /></ri:attachment></ac:image><ac:image ac:align="center"><ri:attachment ri:filename="create-dh-trace-d.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating DHTrace links" /></ri:attachment></ac:image></p><h6 style="text-align: center;">CSV Data Source nodes with DHTrace links to MagicDraw elements are indicated with small half-green squares in Cameo DataHub Explorer and the MagicDraw Containment tree.</h6></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="56e5c35b-2e97-4d8b-b88f-52799f486630"><ac:parameter ac:name="id">543550766</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copy Data with Sync" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465783 space=CDH2024xR1 version=1 -->
## PAGE 00043: Creating DOORS module view Data Sources

- page_id: `170465783`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465783/Creating+DOORS+module+view+Data+Sources
- version_number: 1
...
````html
<p>DataHub links can create relationships between elements. The relationship determines how the elements react when one of the elements changes. You can use the MagicDraw shortcut menu to navigate to DHLinks.</p><p><br /></p><p>To navigate to DHLinks from the MagicDraw shortcut menu</p><hr /><ul><li>Right-click a node in the MagicDraw Containment tree. Select <strong>Go To</strong> &gt;<strong> DHLinks</strong>.</li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="MagicDraw Containment Tree context menu to navigate to DHLinks" ac:alt="MagicDraw Containment Tree context menu to navigate to DHLinks"><ri:attachment ri:filename="dh-go-to-dh-links.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Creating links between elements" /></ri:attachment></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=170465927 space=CDH2024xR1 version=1 -->
## PAGE 00045: Creating OSLC links

- page_id: `170465927`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465927/Creating+OSLC+links
- version_number: 1
...
You can create OSLC links and queries from an [CONFLUENCE_PAGE title='Adding IBM Rational DOORS Next Generation Data Sources' space='CDH2024xR1']IBM® Rational® DOORS® Next Generation Data Source in DataHub by using the **Create DHTrace** operation from the **Operation** drop-down list in **Cameo DataHub Explorer**.
...
When you copy the Doors Next Generation (DNG) datasource's requirements from the DataHub Explorer to the MagicDraw containment tree, the URI link is created automatically for those requirements with the type “self”. This "self" type link is needed for [CONFLUENCE_PAGE title='OSLC Preview' space='CDH2024xR1'], navigation, or other purposes.
...
<!--NOMAGIC_PAGE id=170465354 space=CDH2024xR1 version=1 -->
## PAGE 00052: Data copying progress bar

- page_id: `170465354`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465354/Data+copying+progress+bar
- version_number: 1
...
````html
<p>When copying data, DataHub shows the progress through its progress bar.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Copy progress bar" ac:alt="DataHub Copy progress bar"><ri:attachment ri:filename="data-copy-progress-bar.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Data copying progress bar" /></ri:attachment></ac:image></p><h6 style="text-align: center;"> The progress bar when DataHub copies data.</h6>
````

<!--NOMAGIC_PAGE id=170466154 space=CDH2024xR1 version=1 -->
## PAGE 00053: Data Source synchronization

- page_id: `170466154`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466154/Data+Source+synchronization
- version_number: 1
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="85f3a1a8-69c6-44a1-ba5d-e4c56258851f"><ac:parameter ac:name="id">625018634</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="4f6e4015-f570-4dcb-bf64-c0cb48652c26"><ac:parameter ac:name="id">625018636</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="f9d0028b-e8db-4810-b500-d05229f6278e"><ac:parameter ac:name="id">625018635</ac:parameter><ac:rich-text-body><p>Data Sources on Teamwork Cloud are projects accessible to all users who have credentials to the network. Therefore, <strong>Teamwork Cloud Data Sources</strong> are actually projects stored in Teamwork Cloud. A <strong>Teamwork Cloud project</strong> may be accessible to more than one client.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="c6f6ea18-25d0-4b78-b398-a25d28e3d472"><ac:parameter ac:name="id">625018633</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="3f62e555-d0c2-4821-a858-1e379affc3c7" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465416 space=CDH2024xR1 version=1 -->
## PAGE 00055: Data Synchronization

- page_id: `170465416`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465416/Data+Synchronization
- version_number: 1
- version_date: `2023-06-01T09:43:24.356+02:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
Synchronization is primarily used for keeping track of changes. Data synchronization allows you to track different types of changes and maintain the consistency of data across nodes in different data sources and applications.Data synchronization can be categorized into two functional types namely, Data Source synchronization and Node synchronization.For more information, refer to [CONFLUENCE_PAGE title='Synchronization' space='CDH2024xR1'].

To synchronize the data sources

1. Open the [CONFLUENCE_PAGE title='DataHub Explorer tab' space='CDH2024xR1'] .
2. From the [CONFLUENCE_PAGE title='Operation drop-down list' space='CDH2024xR1'], select [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR1']. You can also synchronize the data by using [CONFLUENCE_PAGE title='Create Sync operation' space='CDH2024xR1'].

You can track the changes and updates done after the synchronization with the help of the[CONFLUENCE_PAGE title='Tracking changes on Conflict Dashboard' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="4907b106-480d-40cc-8d4e-30304526a8ce"><ac:parameter ac:name="id">1747646948</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="c8efcac5-d998-418f-8cbc-449eb523263b"><ac:parameter ac:name="id">1747646968</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="abbe3c0c-f3e5-4656-9ad6-732922eabae9"><ac:parameter ac:name="id">1747646958</ac:parameter><ac:rich-text-body><p><span style="color: rgb(62,63,64);">Synchronization is primarily used for keeping track of changes. Data synchronization allows you to track different types of changes and maintain the consistency of data across nodes in different data sources and applications.<span> Data synchronization can be categorized into two functional types namely, Data Source synchronization and Node synchronization. </span></span><span style="color: rgb(62,63,64);"><span>For more information, refer to <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Synchronization" /></ac:link>.</span></span></p><p>To synchronize the data sources</p><hr /><ol><li class="auto-cursor-target">Open the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer tab" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Explorer Panel]]></ac:plain-text-link-body></ac:link>.</li><li class="auto-cursor-target"><p class="auto-cursor-target">From the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Operation drop-down list" /></ac:link>, select <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copy Data with Sync operation" /></ac:link>. You can also synchronize the data by using <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create Sync operation" /><ac:plain-text-link-body><![CDATA[Create Sync Operation]]></ac:plain-text-link-body></ac:link>.</p></li></ol><p><span>You can track the changes and updates done after the synchronization with the help of the </span><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Tracking changes on Conflict Dashboard" /><ac:plain-text-link-body><![CDATA[Conflict Dashboard.]]></ac:plain-text-link-body></ac:link></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465307 space=CDH2024xR1 version=3 -->
## PAGE 00056: DataHub alias

- page_id: `170465307`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465307/DataHub+alias
- version_number: 3
- version_date: `2026-02-11T07:25:44.323+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=170465602 space=CDH2024xR1 version=1 -->
## PAGE 00057: DataHub Alias Manager

- page_id: `170465602`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465602/DataHub+Alias+Manager
- version_number: 1
...
````html
<p><span style="color: rgb(51,51,51);">The following table lists the icons in the <strong>DataHub Explorer</strong> tab.<br /> </span></p><table class="relative-table" style="width: 99.9434%;"><colgroup><col style="width: 4.86219%;" /><col style="width: 17.9848%;" /><col style="width: 77.2406%;" /></colgroup><tbody><tr><th>Icon</th><th>Name</th><th>Description</th></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="datahub.gif"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td><ac:inline-comment-marker ac:ref="e01ff494-dd00-4c24-8631-ba510086a80f">Cameo DataHub</ac:inline-comment-marker></td><td>The DataHub root.</td></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="magicdraw_driver.gif"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td>MagicDraw® Driver</td><td>The MagicDraw<sup>®</sup> driver to connect to a MagicDraw<sup>®</sup> project.</td></tr><tr><td><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="driver.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td>Drivers</td><td><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">The drivers to connect to the other tools </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">(</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">CSV</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation).</ac:inline-comment-marker></td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-toggle-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Toggle showing only <br />connected Data Sources</td><td colspan="1">Hides all disconnected Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="toggle-data-sources-icon.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Toggle showing all Data Sources</td><td colspan="1">Displays all Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-add-ds-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Add Data Source button</td><td colspan="1">Opens the <strong>Add Data Source</strong> dialog.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-btn-4.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Synchronize button</td><td colspan="1">Starts the synchronization process.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-disconnected-ds-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Disconnected Data Source</td><td colspan="1"><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">The Data Source (of MagicDraw<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, or a CSV file) disconnected from </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">its source.</ac:inline-comment-marker></td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="folder.gif"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Folder, Package</td><td colspan="1">A folder or a Package.</td></tr><tr><td rowspan="2"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="link.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">DOORS Link</td><td colspan="1">A link in the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> application.</td></tr><tr><td colspan="1">MagicDraw<sup>®</sup> relationship</td><td colspan="1">A link in the MagicDraw<sup>®</sup> application.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="ex.gif"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Item</td><td colspan="1">Any items, e.g., an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> object, MagicDraw<sup>®</sup> element, or CSV item.</td></tr><tr><td colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-oslc-query-icon.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">Create OSLC Query <br />button</td><td colspan="1">Opens the <strong>OSLC Query Editor</strong> dialog, allowing you to perform basic and advanced queries to an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source. This becomes enabled when you add an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source.</td></tr><tr><td colspan="1"><ac:image ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-trash-icon.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer buttons and icons" /></ri:attachment></ac:image></td><td colspan="1">DataHub explorer Trash <br />Icon</td><td colspan="1">Deletes an item when the item is dragged onto the icon. A confirmation dialog appears before deleting the item.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=170465237 space=CDH2024xR1 version=2 -->
## PAGE 00060: DataHub Explorer tab

- page_id: `170465237`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465237/DataHub+Explorer+tab
- version_number: 2
- version_date: `2026-02-10T13:57:46.460+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<p>The <strong>DataHub Explorer</strong> tab has toolbar options for the following actions</p><ul><li data-uuid="ad2f7934-9b27-4b13-868e-e7c013358e28">Add a new Data Source</li><li data-uuid="e3bad469-19e4-4c73-95c6-96671061887f">Close a Data Source</li><li data-uuid="10e0ca40-31e4-4955-a800-1ca62f0a1019">Open a Data Source</li><li data-uuid="c6dcbb96-a5d7-474d-ad89-3ec42de2c7d6">Filter inactive Data Source</li><li data-uuid="d08e781a-bdc0-4f8e-b650-dab590db96ba">Create OSLC query</li><li data-uuid="9a80d116-a105-446b-b830-695c0ca62fdd">Work with data in the tree</li><li data-uuid="63d6abad-f35d-4492-a5ed-b3315bfc3043">Search for items</li></ul><p>You can use <strong>DataHub Explorer toolbar</strong> buttons and shortcut menu items to connect, add, or remove Data Sources. You can also use it to view drivers, Data Sources, and items of the connected Data Sources in the DataHub tree. You can also apply a filter to display only the connected Data Sources in DataHub Explorer.</p><p><br />To open DataHub Explorer</p><hr /><ol><li data-uuid="cf249680-e5f9-4261-b400-074ce1b21b1f">Start MagicDraw® and open an existing project or start a new one.</li><li data-uuid="05a5a7b0-df67-400c-9ef7-460810375f2b">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /><br /><ac:image ac:title="The DataHub Explorer Tab" ac:alt="The DataHub Explorer Tab"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></li></ol><p><br /></p><p>The <strong>DataHub Explorer</strong> tab contains the following</p><ul><li style="list-style-type: none;" data-uuid="23ea5db2-386b-4a56-810c-35943874a9d1"><ul><li><strong>Operation</strong> drop-down list</li><li>Tree of Data Sources</li><li>Explorer buttons and icons</li><li>Text search box</li></ul></li></ul><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="7340f42d-dbd3-4040-97d4-dab2d6e6ebbe" /></p>
````

<!--NOMAGIC_PAGE id=170465225 space=CDH2024xR1 version=3 -->
## PAGE 00061: DataHub menu

- page_id: `170465225`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465225/DataHub+menu
- version_number: 3
- version_date: `2026-02-10T13:42:38.196+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=170465263 space=CDH2024xR1 version=1 -->
## PAGE 00063: DataHub Properties tab

- page_id: `170465263`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465263/DataHub+Properties+tab
- version_number: 1
...
````html
<p>The <strong style="line-height: 1.4285715;">DataHub Properties</strong> tab shows the properties (names and values) and associations of a selected node in DataHub Explorer that you can edit and save their value. You can also open, update, or delete the following items in the <strong style="line-height: 1.4285715;">DataHub Properties </strong>tab. </p><ul><li>MagicDraw<sup>®</sup> elements</li><li>DOORS objects and modules</li><li>CSV items</li><li>IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Artifacts</li></ul><p><br /></p><p>To open the <strong>DataHub Properties</strong> tab in MagicDraw®, do one of the following</p><hr /><ul><li>Right-click a node in DataHub Explorer and click <strong>Properties</strong>.</li><li>Double-click a node in DataHub Explorer.<br /><br />The <strong>DataHub Properties</strong> tab opens in MagicDraw<sup>®</sup>, and the properties of the selected item are displayed.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="dh-properties-tab.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image><br /><span style="color: rgb(74,103,133);"> </span></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d31614a8-1844-44ae-b9a2-5da7206f8cb8"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The <strong>DH Links </strong>panel opens when the <strong>DataHub Properties</strong> tab is open.</li><li>Read-only and multi-valued properties cannot be edited. However, you can edit multi-valued properties through the Specifications window.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>The table below explains the function of each icon in the <strong>DataHub Properties</strong> tab in MagicDraw<sup>®</sup>.</p><table class="relative-table" style="margin-left: 30.0px;width: 96.4116%;"><colgroup><col style="width: 4.71616%;" /><col style="width: 16.6754%;" /><col style="width: 78.6376%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Icon</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Name</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Function</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - categorized view.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;"><strong>Categorized View</strong></td><td style="margin-left: 30.0px;">Shows all property names by category.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center" ac:thumbnail="true" ac:width="29"><ri:attachment ri:filename="Properties - alphabetical view.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;"><strong>Alphabetical View</strong></td><td style="margin-left: 30.0px;">Shows all property names in an alphabetical order.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - show description.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;"><strong>Show Description</strong></td><td style="margin-left: 30.0px;">Shows description of each property.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - expand.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Expand</strong></td><td style="margin-left: 30.0px;" colspan="1"><p>Shows all property names and values.</p></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - collapse.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Collapse</strong></td><td style="margin-left: 30.0px;" colspan="1">Hides all property names and values.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - save.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Properties tab" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Save</strong></td><td style="margin-left: 30.0px;" colspan="1">Saves changes made to a property name or value. The button is enabled when the value of the property changes.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=170465245 space=CDH2024xR1 version=2 -->
## PAGE 00064: DataHub tree

- page_id: `170465245`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465245/DataHub+tree
- version_number: 2
- version_date: `2026-02-10T13:58:56.804+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > DataHub Explorer tab
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub tree is composed of nodes, each of which represents either a node or a connected Data Source. Data in the DataHub tree are arranged hierarchically in a tree structure. It represents all the data that DataHub contains at that time.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DataHub Tree.png" /></ac:image></p><h6 style="text-align: center;">The DataHub tree.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="6344c1ba-0a12-4b5d-8b08-8addba6eb2ac"><ac:link><ri:page ri:content-title="Data Source synchronization" /></ac:link></li><li data-uuid="83e66157-2a44-4882-af50-2993039de39d"><ac:link><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /><ac:plain-text-link-body><![CDATA[Displaying MagicDraw Data Sources]]></ac:plain-text-link-body></ac:link></li><li data-uuid="d69213bc-aec9-40d2-8cf6-6eddf2563b92"><ac:link><ri:page ri:content-title="Removing a Data Source" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=170466041 space=CDH2024xR1 version=5 -->
## PAGE 00065: Define Target Type from Attribute Value dialog and mapping

- page_id: `170466041`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466041/Define+Target+Type+from+Attribute+Value+dialog+and+mapping
- version_number: 5
- version_date: `2025-10-08T12:23:55.173+02:00`
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="ee5418bd-f080-4370-9f11-0eb71da57ba8"><ac:parameter ac:name="id">1247079753</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="71c6c9a6-333e-4c19-b648-d8ded3559fd9"><ac:parameter ac:name="id">1247079756</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="16e51486-5632-4902-966d-3d79151d4c38"><ac:parameter ac:name="id">1247079755</ac:parameter><ac:rich-text-body><p>The functionality of synchronization has been additionally simplified with the use of the <strong>Define Target Type from Attribute Value</strong> option. The synchronization does not limit only to a simple type-to type-mapping and attribute-to-attribute mapping but also a target node type can be defined dynamically according to a specified attribute value.</p><p><br /></p><p>To copy data and define a target node type from an attribute value</p><hr /><ol><li>From the Operation drop-down list in DataHub Explorer, select one of the DataHub operations to copy data. The Copy Data with Sync dialog (depending on the operation you have selected) opens.</li><li>From the <strong>Mapping Mode</strong> option, select <strong>Group Type Mapping</strong>.<br /><br /><ac:image ac:title="Copy Data with Sync in Group Type Mapping " ac:alt="Copy Data with Sync in Group Type Mapping "><ri:attachment ri:filename="set-as-default-target-type.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Defining a target type from an attribute value" /></ri:attachment></ac:image><br /><br /></li><li>Select a source node type to start mapping.</li><li>Select the <strong>Define Target Type from Attribute Value</strong> check box.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Defining a target type from an attribute value" /></ri:attachment></ac:image><br /><br /></li><li>From the <strong>Attribute</strong> drop-down list, choose an attribute to define a target node type.</li><li><p class="auto-cursor-target">Specify the attribute value to do the mapping.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="307eb3bc-f78b-4130-9353-ece0cc9e69b0"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>If the attribute is <strong>Enumeration</strong>, you can select a value from the <strong>Value</strong> drop-down list for each attribute.<br /><br /><ac:image><ri:attachment ri:filename="Selecting Value from Name Attribute.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Defining a target type from an attribute value" /></ri:attachment></ac:image><br /><br /></li><li>If the attribute is a simple data type, you can type any expected value in the <strong>Value</strong> box.</li></ul></ac:rich-text-body></ac:structured-macro></li><li>From the target type box on the right-hand side of the source type box, choose a target node type for that value.</li><li>Continue mapping the attributes.</li><li>If you have more values for mapping, click <ac:image><ri:attachment ri:filename="add-btn2.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Defining a target type from an attribute value" /></ri:attachment></ac:image> to enter more values for mapping.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping End - Edited.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Defining a target type from an attribute value" /></ri:attachment></ac:image><br /><br /></li><li>Repeat Steps 5 to 9 to map each attribute value.</li><li>When you finish mapping each attribute value, click <strong>OK</strong> to start copying.<br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="661cd26c-c59e-4110-b077-6b60922bbe9b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The functionality to map between<strong> </strong>Attribute value and Target type is available only in Group Type Mapping.</li><li>At least 2 values must be identified for mapping.</li><li>You can edit or deactivate the mapping in the <a href="https://docs.nomagic.com/display/CDH2024xR1/Mapping+with+Schema+Map+Manager">Schema Map Manager</a> dialog.</li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="076626e8-b23e-4fbf-92ab-a0119e7f00b4"><ac:parameter ac:name="id">1247079751</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><a href="https://docs.nomagic.com/display/CDH2024xR1/Mapping+with+Schema+Map+Manager">Mapping with Schema Map Manager</a></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465578 space=CDH2024xR1 version=1 -->
## PAGE 00068: Deleting Requirements

- page_id: `170465578`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465578/Deleting+Requirements
- version_number: 1
...
````html
<p>To delete a Requirement from the <strong>DataHub Explorer</strong> tree, do one of the following</p><hr /><ul><li>Right-click the node you want to delete and select <strong><ac:image><ri:attachment ri:filename="delete-node.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Deleting Requirements" /></ri:attachment></ac:image></strong>.</li><li>Drag the node onto the <strong>DataHub Explorer</strong><ac:image><ri:attachment ri:filename="dh-trash-icon.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Deleting Requirements" /></ri:attachment></ac:image><strong>Trash</strong> icon.</li></ul><p>A confirmation dialog asking you to confirm the deletion opens. Click <strong>OK</strong>.</p>
````

<!--NOMAGIC_PAGE id=170466067 space=CDH2024xR1 version=1 -->
## PAGE 00069: Deleting schema maps

- page_id: `170466067`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466067/Deleting+schema+maps
- version_number: 1
- version_date: `2023-07-27T12:31:05.968+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []

### NORMALIZED CONTENT

If a schema map is referenced by a DHLink, it cannot be deleted. You can delete only schema maps that are not referenced by any DHLinks. Deleting aDefine Target Type from Attribute Value mapped schema deletes all defined target types. If you want to delete only some values of the schema, you can delete them in the[CONFLUENCE_PAGE title='Define Target Type from Attribute Value dialog and mapping' space='CDH2024xR1'] dialog.

To delete an existing schema map

1. Open the Cameo DataHub [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR1'] dialog.
...
2. In the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDHTWRT'] dialog, map the **Diagram**on the modeling tool side to the **Text**on the JAMA Connect side. 
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Diagram Synchronization</h3><p>You can synchronize a single diagram or an entire package of diagrams from the modeling tool into the JAMA Connect project.  All types of diagrams available in the modeling tool are supported. The synchronized diagram is converted to an image and is embedded in the description property of the corresponding JAMA Connect project item. When you synchronize, the image on the JAMA Connect side is updated if the related diagram is modified in the modeling tool.</p><p><br /></p><p><span style="color: rgb(62,63,64);">To synchronize the diagram</span></p><hr /><ol><li>Drag and drop a diagram or a diagram package onto the project, component, or set node.<br /><br /><ac:image><ri:attachment ri:filename="Drag and Drop.png" /></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">In the <ac:link><ri:page ri:space-key="CDHTWRT" ri:content-title="Copy Data with Sync operation" /><ac:plain-text-link-body><![CDATA[Copy Data with Sync]]></ac:plain-text-link-body></ac:link> dialog, map the <strong>Diagram </strong>on the modeling tool side to the <strong>Text </strong>on the JAMA Connect side.<br /><br /><ac:image><ri:attachment ri:filename="Diagram to the Text mapping.png" /></ac:image><br /><br /></span></li><li><span style="color: rgb(62,63,64);">In Select Attribute to Sync section, map the <strong>Documentation </strong>attribute against the <strong>Description </strong>and the <strong>Name </strong>attribute against the <strong>Name</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Select Attribute to Sync section.png" /></ac:image><br /><br /></span></li><li><span style="color: rgb(62,63,64);">Click <strong>OK</strong>.</span></li></ol><p><span style="color: rgb(62,63,64);">The following video shows the </span><span>SysML Diagrams Synchronization from JAMA Connect to the modeling tool:</span></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="4bdaa099-83c5-4b21-b51e-871f7e1e8bd9"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=d_oXKu9730I&amp;t=3s" /></ac:parameter><ac:parameter ac:name="height">400</ac:parameter></ac:structured-macro> </p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages:</strong></p><ul><li><ac:link><ri:page ri:content-title="Adding Data Sources for JAMA Connect" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=170466090 space=CDH2024xR1 version=1 -->
## PAGE 00075: Directions of DHLinks

- page_id: `170466090`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466090/Directions+of+DHLinks
- version_number: 1
...
- [CONFLUENCE_PAGE title='Operations in DataHub Explorer' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="8fa9cdac-55d9-4335-9f6e-935d3af922a8"><ac:parameter ac:name="id">1143893834</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="64c1b45e-1a3d-4e14-8bfb-9b4596cd95d9"><ac:parameter ac:name="id">1143893837</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="f0d74388-020f-4937-acdc-0116b3fb1e74"><ac:parameter ac:name="id">1143893835</ac:parameter><ac:rich-text-body><p>The synchronization direction allows you to choose the direction from which the changes are sent. There are three directions of data synchronization in the dialog of the selected DataHub Explorer operation as follows</p><ul><li><ac:image><ri:attachment ri:filename="two-way-sync.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Directions of synchronization" /></ri:attachment></ac:image><br />Synchronizations are in both directions.</li><li><strong><ac:image><ri:attachment ri:filename="one-way-sync-to-md.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Directions of synchronization" /></ri:attachment></ac:image></strong><br />The third-party Data Source is always synchronized to the MagicDraw Data Source.</li><li><ac:image><ri:attachment ri:filename="one-way-sync-from-md.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Directions of synchronization" /></ri:attachment></ac:image><br />The MagicDraw Data Source is always synchronized to the third-party Data Source.</li></ul></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="43d4294e-b7ea-4a64-b49a-97c2cfa87c98"><ac:parameter ac:name="id">1143893833</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Operations in DataHub Explorer" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465361 space=CDH2024xR1 version=1 -->
## PAGE 00077: Displaying MagicDraw Data Sources in DataHub Explorer

- page_id: `170465361`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465361/Displaying+MagicDraw+Data+Sources+in+DataHub+Explorer
- version_number: 1
...
By default, MagicDraw® Data Sources are not shown in the [CONFLUENCE_PAGE title='DataHub Explorer tab' space='CDH2024xR1']. However, you can display MagicDraw® Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.
...
````html
<p>By default, MagicDraw<sup>®</sup> Data Sources are not shown in the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Explorer tab" /></ac:link>. However, you can display MagicDraw<sup>®</sup> Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.</p><p><br /></p><p>To display a MagicDraw<sup>®</sup> Data Source in the DataHub Explorer tree</p><hr /><ol><li>From the MagicDraw main menu, click <strong>Options</strong> &gt; <strong>Environment</strong>. The Environment Options dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_General.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /></ri:attachment></ac:image><br /><br /></li><li>On the left-hand side of the dialog, select <strong>Cameo DataHub</strong> in the list.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /></ri:attachment></ac:image><br /><br /></li><li>In the<strong> General</strong> group of options, clear the Filter a Magic Systems of Systems Architect data source from the DataHub Explorer checkbox.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_Clear_Checkbox.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>OK</strong>. A MagicDraw<sup>®</sup> Data Source now appears in the DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="MD_Data_Source.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /></ri:attachment></ac:image></li></ol><p><br /></p>
````

<!--NOMAGIC_PAGE id=170465790 space=CDH2024xR1 version=1 -->
## PAGE 00078: DOORS Baseline Data Sources

- page_id: `170465790`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465790/DOORS+Baseline+Data+Sources
- version_number: 1
...
````html
<p>When you have copied some data with types and attributes mappings, DataHub stores the mappings between the types and attributes. If you set them as the default mappings, DataHub maps the source node with the target node automatically the next time you copy data or create DHLinks. You can edit those mappings later in the <strong><a href="https://docs.nomagic.com/display/CDH2024xR1/Mapping+with+Schema+Map+Manager">Schema Map Manager</a></strong> dialog.</p><p>With the <strong>Export Schema Map</strong> <strong>Wizard</strong>, you can export an existing schema map to an XML file by selecting a particular schema map from a Data Source in the selected driver.</p><p><br /></p><p>To export a schema map</p><hr /><ol><li>Open the <strong>Cameo DataHub <a href="https://docs.nomagic.com/display/CDH2024xR1/Mapping+with+Schema+Map+Manager">Schema Map Manager</a></strong> dialog and click <strong><ac:image><ri:attachment ri:filename="export-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image></strong>. The <strong>Export Schema Map Wizard</strong> dialog opens. In the <strong>Source Driver</strong> and <strong>Target Driver</strong> sections, select the source and target Data Source that you want to export its mapping. Click <strong><ac:image><ri:attachment ri:filename="next-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image></strong>.<br /><br /><ac:image ac:title="Export Schema Map Wizard Dialog" ac:alt="Export Schema Map Wizard Dialog"><ri:attachment ri:filename="export-schema-map-a.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image><br /><br /></li><li>Select the data types that you want to export their mappings and click <strong><ac:image><ri:attachment ri:filename="next-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image></strong>.<br /><br /><ac:image ac:title="Select the Existing Schema Map to be Exported" ac:alt="Select the Existing Schema Map to be Exported"><ri:attachment ri:filename="export-schema-map-b.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image><br /><br /></li><li>Type the name and description of the schema map.<br /><br /><ac:image ac:title="Exporting a Schema Map to local file in xml format" ac:alt="Exporting a Schema Map to local file in xml format"><ri:attachment ri:filename="export-schema-map-c.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image><br /><br /></li><li>Click <ac:image><ri:attachment ri:filename="btn3.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image> to select a location to save the file.</li><li>Click <ac:image><ri:attachment ri:filename="finish-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Exporting schema maps" /></ri:attachment></ac:image>to export the schema map.</li></ol>
````

<!--NOMAGIC_PAGE id=170465329 space=CDH2024xR1 version=1 -->
## PAGE 00084: Exporting schema maps as new templates

- page_id: `170465329`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465329/Exporting+schema+maps+as+new+templates
- version_number: 1
...
Alias is a name that is assigned to a node in the DataHub Explorer tree or MagicDraw® Containment area tree. This node can then be accessed or removed via the [CONFLUENCE_PAGE title='Alias Manager' space='CDH2024xR1']**Alias Manager** dialog.
...
[CONFLUENCE_PAGE title='Glossary' space='CDH2024xR1'] refers to an item whose specific format enables it to be synchronized with and traced to and from another data.

A [CONFLUENCE_PAGE title='Glossary' space='CDH2024xR1'] is an item whose specific format can link one data to another and also enables it to be synchronized with other links.
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="d2264867-1183-48ee-a4c4-0b5be3c3029f"><ac:parameter ac:name="id">794541289</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="43e429d1-514c-4040-be25-704fbac00628"><ac:parameter ac:name="width">100.00002%</ac:parameter><ac:parameter ac:name="id">794541291</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="105221ff-05b9-4a74-90d4-adda5ebbdf5a"><ac:parameter ac:name="id">794541290</ac:parameter><ac:rich-text-body><p>DataHub synchronization capability is a core feature of the DataHub. Synchronization is primarily used for keeping track of changes. This synchronization feature allows you to track different types of node changes, to update or remove DHLinks from the <strong>Synchronize</strong> button on either side of the MagicDraw Containment area or DataHub Explorer, to synchronize Data Sources with other collaboration tools, and to choose to synchronize single, grouped, or entire Data Source.</p><p><span style="color: rgb(62,63,64);">The following videos show the data synchronization and the data links in action:</span></p><p><br /></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="8a6f2cc2-f7a8-4d80-9956-4cd8a6fea605"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=O3LijuCItEM" /></ac:parameter><ac:parameter ac:name="height">450</ac:parameter></ac:structured-macro></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="3122e301-6e43-4c8d-8ba8-738e3a23db4c"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=gKiXaQK7Wf8" /></ac:parameter><ac:parameter ac:name="height">450</ac:parameter></ac:structured-macro></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="7026c00e-3f18-4377-8003-f6f1485604f8"><ac:parameter ac:name="id">794541288</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="25bb0086-a93b-4a5c-8c33-65a6c954e6fb" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466361 space=CDH2024xR1 version=1 -->
## PAGE 00092: HTML images, RTF, and OLE support

- page_id: `170466361`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466361/HTML+images+RTF+and+OLE+support
- version_number: 1
...
1. Open the Cameo DataHub [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR1'][CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog and click [IMAGE alt='' src=''] .
2. Select a schema file to import and click [IMAGE alt='' src=''] .

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can import a schema map that is in the XML format to DataHub.</p><p><br /></p><p>To import a saved schema map</p><hr /><ol><li>Open the <strong>Cameo DataHub <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Schema Map Manage]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[r]]></ac:plain-text-link-body></ac:link></strong> dialog and click <strong><ac:image><ri:attachment ri:filename="import-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Importing schema maps" /></ri:attachment></ac:image></strong>.</li><li>Select a schema file to import and click <strong><ac:image><ri:attachment ri:filename="open-btn.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Importing schema maps" /></ri:attachment></ac:image></strong>.</li></ol>
````

<!--NOMAGIC_PAGE id=170465351 space=CDH2024xR1 version=1 -->
## PAGE 00096: Inactive Data Source filter

- page_id: `170465351`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465351/Inactive+Data+Source+filter
- version_number: 1
...
````html
<p>The<strong> Inactive Data Source Filter</strong> button <ac:image><ri:attachment ri:filename="dh-inactive-ds-filter.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Inactive Data Source filter" /></ri:attachment></ac:image>is available on the <strong>DataHub Explorer</strong> toolbar. You can use this filter to filter out all inactive Data Sources from the <strong>DataHub Explorer</strong> tree.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer toolbar - Filtering inactive sources button" ac:alt="DataHub Explorer toolbar - Filtering inactive sources button"><ri:attachment ri:filename="dh-toggle-connected-data-sources.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Inactive Data Source filter" /></ri:attachment></ac:image></p><h6 style="text-align: center;"> Inactive Data Source Filter button on the DataHub Explorer toolbar.</h6>
````

<!--NOMAGIC_PAGE id=170465316 space=CDH2024xR1 version=1 -->
## PAGE 00097: Individual type mapping

- page_id: `170465316`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465316/Individual+type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465221 space=CDH2024xR1 version=1 -->
## PAGE 00099: Introduction to Cameo DataHub

- page_id: `170465221`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465221/Introduction+to+Cameo+DataHub
- version_number: 1
...
Cameo DataHub Documentationtrue[CONFLUENCE_PAGE title='Cameo DataHub Documentation' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="885f5512-3e04-41a2-925a-7d2fb0d0f728"><ac:parameter ac:name="page">Cameo DataHub Documentation</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Cameo DataHub Documentation" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=170465923 space=CDH2024xR1 version=2 -->
## PAGE 00100: Linking model elements to OSLC resources

- page_id: `170465923`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465923/Linking+model+elements+to+OSLC+resources
- version_number: 2
- version_date: `2024-05-08T13:50:49.452+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
1. Do one of the following:
  - In the Model Browser, select an element, open its [CONFLUENCE_PAGE title='Specification window' space='MD2024xR1']**Specification** window and go to Documentation / Hyperlinks property group. Click Add .
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="ddd27724-ea74-49cb-b2e6-3190009b0ad7"><ac:parameter ac:name="id">1018174666</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="613ed0cf-2569-4a61-93f7-558f0d260249"><ac:parameter ac:name="id">1018174669</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="16ed2007-a6a4-4e64-a33b-fd6f6e624f94"><ac:parameter ac:name="id">1018174665</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="19211d61-0926-4f2c-976a-b4df1491a258" /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="b5f6bbf8-5d67-4c6b-8616-93c556f40e04"><ac:parameter ac:name="id">1018174667</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>You can link your model elements to the OSLC resources through the hyperlinks.</p><p>There are two ways you can link a model element to an OSLC resource:</p><ul><li>Selecting an existing resource</li><li>Creating a new resource</li></ul><h3>Selecting an existing OSLC resource</h3><p><br /></p><p>To link an element to an OSLC resource</p><hr /><ol><li>Do one of the following:<ul><li>In the Model Browser, select an element, open its <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Specification window" /><ac:link-body><strong>Specification</strong> window</ac:link-body></ac:link> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the <strong>Hyperlinks / Go To</strong> button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li>In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li>From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li>Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /> <ac:image><ri:attachment ri:filename="add_link.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Linking model elements to OSLC resources" /></ri:attachment></ac:image><br /><br /></li><li>In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Choose Existing</strong> option.</li><li>Select an artifact and click <strong>OK</strong>.<br /><br /> <ac:image><ri:attachment ri:filename="select.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Linking model elements to OSLC resources" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>Close</strong>.</li><li>Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><h3>Creating a new OSLC resource</h3><p><br /></p><p>To create a new OSLC resource</p><hr /><ol><li>Do one of the following:<ul><li>In the Model Browser, select an element, open its <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Specification window" /><ac:link-body><strong>Specification</strong> window</ac:link-body></ac:link> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the Hyperlinks / Go To button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li>In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li>From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li>Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /> <ac:image><ri:attachment ri:filename="add_link.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Linking model elements to OSLC resources" /></ri:attachment></ac:image><br /><br /></li><li>In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Create New</strong> option.</li><li>Fill out the data for the new element.<br /><br /> <ac:image><ri:attachment ri:filename="create.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Linking model elements to OSLC resources" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>OK</strong>.</li><li>Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><p>The created element is now linked to your selected model element.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=170466312 space=CDH2024xR1 version=1 -->
## PAGE 00101: Mapping modes

- page_id: `170466312`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466312/Mapping+modes
- version_number: 1
- version_date: `2018-02-06T11:14:17.034+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Schema Mapping
- labels: []
...
DataHub also provides a default Schema Map template for mapping data. In the **[CONFLUENCE_PAGE title='Schema Map Manager' space='CDH2024xR1']**dialog, you can find the default Schema Map template under the IBM® Rational® DOORS® driver side.
...
The export dialog, e.g., **Copy Data with Sync**(depending on the operation you have selected from the [CONFLUENCE_PAGE title='DataHub Operation drop-down list' space='CDH2024xR1']), opens to allow you to map the source and target attribute. 
...
- [CONFLUENCE_PAGE title='DataHub Operation drop-down list' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="8c059589-2760-4835-8fe7-c601dcaab34a"><ac:parameter ac:name="id">34921945</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="98cbd532-f089-4339-beff-33a8b4443340"><ac:parameter ac:name="id">34921947</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="57608788-e9fa-4721-9221-3f7538389e18"><ac:parameter ac:name="id">34921946</ac:parameter><ac:rich-text-body><p>Data can be copied into the MagicDraw<sup>®</sup> Containment area from other Data Sources. Data can also be moved from MagicDraw<sup>®</sup> into other Data Sources like DOORS and CSV repositories. You can use the Copy Data, Copy Data with Sync, and Copy Data with DHTrace operations to copy data. While moving the data, the <strong>Copy Data</strong>, <strong>Copy Data with Sync,</strong> or <strong>Copy Data with DHTrace</strong> dialog prompts you to map the source and target types as well as their attribute types. After you map the source and target types, you can copy the data.</p><p>To copy data into MagicDraw<sup>®</sup> or to copy data to other Data Sources</p><hr /><ol><li>Drag the data node to another Data Source, e.g., DOORS.<br /><p class="auto-cursor-target"><br /><ac:image><ri:attachment ri:filename="Tutorial - Dragging DOORS Data Source.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping source and target types to copy data to and from a modelling tool" /></ri:attachment></ac:image><br /><br />The export dialog, e.g., <strong>Copy Data with Sync </strong>(depending on the operation you have selected from the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Operation drop-down list" /></ac:link>), opens to allow you to map the source and target attribute.<br /><br /><ac:image><ri:attachment ri:filename="Export Dialog (Group Type Mapping, Copy Data with Sync).png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping source and target types to copy data to and from a modelling tool" /></ri:attachment></ac:image><br /><br />The detail of each option in the export dialog is explained in the table below.</p><table class="wrapped relative-table" style="width: 97.5529%;"><colgroup> <col style="width: 20.1533%;" /> <col style="width: 79.88%;" /> </colgroup><tbody><tr><th><div class="content-wrapper"><p>Option</p></div></th><th>Function</th></tr><tr><td><strong>Mapping mode</strong></td><td><div class="content-wrapper"><p>You can either do <strong>Individual Type mapping</strong> or <strong>Group Type mapping</strong>. <strong>Individual type mapping</strong> allows you to map the individual nodes themselves, and <strong>Group Type mapping</strong> allows you to map the node type as a whole.</p></div></td></tr><tr><td><div class="content-wrapper"><p><strong>Set as default target type</strong></p></div></td><td><div class="content-wrapper"><p>The source nodes are mapped to the selected stereotype element type as default. The export dialog will not open when you copy the same type of data next time.</p></div></td></tr><tr><td><div class="content-wrapper"><p><strong>Define Target Type from Attribute Value</strong></p></div></td><td>This mapping option is only available for group type mapping mode. In this mapping mode, you can specify node values and their target types.</td></tr><tr><td><div class="content-wrapper"><p><strong>Exclude all no-mapped nodes from DHLinks</strong></p></div></td><td>Unmapped nodes will not be copied, and the source nodes will be marked as excluded with an 'X' symbol. Unmapped nodes are marked with red circles beside them and the mapped ones have green circles.</td></tr><tr><td><strong>Sync Direction</strong></td><td><div class="content-wrapper"><p><strong>Two-way sync</strong>, <strong>One-way Sync from MagicDraw,</strong> and <strong>One-way Sync to MagicDraw</strong>. Two-way sync changes the nodes on both ends, while one-way sync only synchronizes changes from the source node to the target node.</p></div></td></tr></tbody></table><p><span style="color: white;">a</span></p></li><li>Choose a mapping type, either individual or group. Map the source types to target types and map source attributes to target attributes. When the nodes have all been mapped, the red circles beside them change to green. You can select <strong>Exclude all no-mapped nodes from DHLinks </strong>the checkbox to exclude nodes that have not been mapped from being copied.</li><li>Click <strong>OK</strong>. The nodes are copied to the MagicDraw<sup>®</sup> Containment area.</li></ol></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="402f2cdd-1907-4101-b13f-ee2b839b75c3"><ac:parameter ac:name="id">34921944</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="DataHub Operation drop-down list" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466011 space=CDH2024xR1 version=1 -->
## PAGE 00103: Mapping with Schema Map Manager

- page_id: `170466011`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466011/Mapping+with+Schema+Map+Manager
- version_number: 1
...
````html
<p><span style="color:var(--ds-text,#333333);">To open <strong>DataHub Explorer</strong></span></p><hr /><ol><li data-uuid="ba8ed9d3-19f5-42d5-9911-2961c86d8bb6">Create a new MagicDraw<sup>®</sup> project or open an existing project.</li><li data-uuid="d20eeca2-edb7-4e1e-ac73-c94b28d0693b">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link> opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="worddavff8df49b8dd564525b509af5bc3f682e.png" /></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="59442eae-22b5-4d89-902c-278cc7ff4145"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="28876440-d2fe-4ed8-9726-30a5f2ce5df2">Nodes under particular drivers in <strong>DataHub Explorer</strong> also represent nodes in the applications belonging to the drivers.</li><li data-uuid="e323efe5-9e3a-4313-9e0a-27d2d7514623">If a driver is correctly started, the name of the driver will appear in the <strong>DataHub Explorer</strong> tree. The driver will then connect to data in each of its respective application.</li></ul></ac:rich-text-body></ac:structured-macro><p><strong>Related page</strong></p><ul><li data-uuid="c06ff6f3-0fb2-4fb5-9b6d-7a8819b3bc2c"><ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link></li></ul>
````

<!--NOMAGIC_PAGE id=170465994 space=CDH2024xR1 version=1 -->
## PAGE 00108: Opening selected Requirements in DataHub Explorer or other applications

- page_id: `170465994`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465994/Opening+selected+Requirements+in+DataHub+Explorer+or+other+applications
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465239 space=CDH2024xR1 version=4 -->
## PAGE 00109: Operation drop-down list

- page_id: `170465239`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465239/Operation+drop-down+list
- version_number: 4
- version_date: `2026-02-11T07:16:07.888+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > DataHub Explorer tab
- labels: []
...
- [CONFLUENCE_PAGE title='Copy Data operation' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Copy Data with DHTrace operation' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Create Sync operation' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Create DHTrace operation with OSLC links' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Compatible data sources' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="3765e38a-6fdf-415d-ba00-70a3435ff1af"><ac:parameter ac:name="id">1355884508</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="e1cb0dc6-6799-49c2-9d8e-6264128bf979"><ac:parameter ac:name="id">1355884519</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="071a45e3-1c04-4c34-b90f-923c2fd46e1b"><ac:parameter ac:name="id">1355884518</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="excerpt" ac:schema-version="1" ac:macro-id="9ec653cf-c3fb-4f95-9514-95000866bda8"><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>The <strong>Operation </strong>list in the <strong>Cameo DataHub Explorer </strong>panel provides several options for you to work with your data.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="CDH_Panel.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Operations in DataHub Explorer" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Operation drop-down list</h6><p>The table below briefly explains the functions of the DataHub operations.</p><p><br /></p><table class="fixed-table wrapped"><colgroup><col style="width: 257.0px;" /><col style="width: 996.0px;" /></colgroup><tbody><tr><th>Operation</th><th>Function</th></tr><tr><td><strong>Copy Data</strong></td><td>Only copies the data with child nodes.</td></tr><tr><td><strong>Copy Data with Sync</strong></td><td><div class="content-wrapper"><p>Copies data and creates synchronization (DHLinks) between the source and target nodes. Nodes in the modeling tool are updated or deleted whenever their corresponding nodes in associated tools are updated or deleted. The newly created nodes can be transferred to other associated tools as well.</p></div></td></tr><tr><td><strong>Copy Data with DHTrace</strong></td><td>Copies data and creates DHTrace links between the source and target nodes. DHLinks are used to trace the changes.</td></tr><tr><td><strong>Create Sync</strong></td><td>Recreates synchronization (DHLinks) if you lose or delete the DHLinks without replicating the data.</td></tr><tr><td><strong>Create DHTrace (with OSLC links)</strong></td><td>Creates DHLinks between the source and target nodes without copying any data.<br />Creates an OSLC link from an IBM® Rational® DOORS® Next Generation Data Source to a MagicDraw® element.</td></tr></tbody></table><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="72de58ac-4522-4ab4-8c99-427b6a92c097"><ac:rich-text-body><ul><li>The parent-and-child relationships are transferred from the source to the target items.</li><li>The dependency relationships from MagicDraw® are also transferred if both the source and target nodes are selected.</li><li>By default, <strong>Copy Data with Sync</strong> is selected in the operations list.</li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="727b2658-a720-4422-8664-8d6294abe6b5"><ac:parameter ac:name="id">1355884507</ac:parameter><ac:rich-text-body><p><strong>Related Pages</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copy Data operation" /></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copy Data with Sync operation" /></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Copy Data with DHTrace operation" /></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create Sync operation" /></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Create DHTrace operation with OSLC links" /></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Compatible data sources" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465916 space=CDH2024xR1 version=2 -->
## PAGE 00111: OSLC Preview

- page_id: `170465916`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465916/OSLC+Preview
- version_number: 2
- version_date: `2024-05-08T13:50:49.345+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
The **OSLC Preview** tab in the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR1'] allows you to view the details of the OSLC resource. The OSLC resource can be selected from **DataHub Explorer**, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser**.**
...
<!--NOMAGIC_PAGE id=170465958 space=CDH2024xR1 version=1 -->
## PAGE 00114: OSLC tutorial

- page_id: `170465958`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465958/OSLC+tutorial
- version_number: 1
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="4bb93e4f-7878-414c-bb03-4ef35abab50d"><ac:parameter ac:name="id">222209597</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="f9092721-41de-4839-b4d8-155a43795d58"><ac:parameter ac:name="id">222209599</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="5fe9d1a3-820a-4974-9925-98ebbde5bd95"><ac:parameter ac:name="id">222209596</ac:parameter><ac:rich-text-body><p><strong>On this page</strong></p><p><ac:structured-macro ac:name="toc" ac:schema-version="1" ac:macro-id="641e2090-13c5-4e31-ab5b-9daee7b2a75a"><ac:parameter ac:name="maxLevel">2</ac:parameter><ac:parameter ac:name="minLevel">2</ac:parameter></ac:structured-macro></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="db9f18af-d1ee-4821-ae2b-b79af46a6034"><ac:parameter ac:name="id">222209598</ac:parameter><ac:rich-text-body><p>In addition to property-to-property mapping, you can apply a conversion rule to convert an original property value to another value when importing or synchronizing the data. You can set the conversion rule by clicking the <strong>Edit rule</strong> button at the end of each property mapping in the <strong>Cameo DataHub Schema Map Manager</strong> dialog or DataHub operation dialogs.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Edit rule button in the Cameo DataHub Schema Map Manager dialog to set the conversion rules.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema_Map_Manager _Edit_rule.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Edit rule button in the Copy Data with Sync dialog to set the conversion rules.</h6><p>Converting Rule Editor has two converting rule schemes as follows</p><ul><li><p><span class="confluence-link">Converting rules from an Enumeration to another Enumeration.</span></p></li><li><span class="confluence-link">Converting rules between source attribute values and target values as String.</span></li></ul><h2><span class="confluence-link">Converting rules from an Enumeration to another Enumeration</span></h2><p>The <strong>Converting Rule Editor</strong> dialog converts all the mapped Enumeration values on the left table and converts the Enumeration values from the left table back to the right table and vice versa. In the first table, the first column will list the Enumeration values of the source property, and the second column automatically shows the values that match the values of the Elements to synchronize. In the right table, the Enumeration values will be in relation to the selected mapping values in the left table.</p><p><br /></p><h6 style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Enum Conversion.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image>Selecting Enumeration values for conversion in the Converting Rule Editor dialog.</h6><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="13ba9aa7-0de9-4ca9-83ef-7a3683263f30"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><p>If there is no matching value, you must manually correct all the mapping attribute values shown in red.</p></ac:rich-text-body></ac:structured-macro><h2><span class="confluence-link">Converting rules between source attribute values and target values as String</span></h2><p>In the <strong>Converting Rule Editor</strong> dialog, the left table allows specifying the values of source attributes in String to be converted to target values according to the selected conversion rules.  The table on the right allows the user to select the rules to convert the values of target attributes to source values.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Source Attribute Conversion Editor.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Selecting the rules to convert the values of source attributes to target values in the Converting Rule Editor dialog.</h6><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="26b62cc7-9019-48ef-9d08-8f37e1c1866c"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li>To add another conversion rule, click <ac:image><ri:attachment ri:filename="Add Button.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image>.</li><li>When setting all the conversion rules, you can use <ac:image><ri:attachment ri:filename="Button.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image> for left-to-right reflection or <ac:image><ri:attachment ri:filename="Button2.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image> for right-to-left reflection of the conversion rules for round-trip synchronization.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Using Button as Reflecting Sync.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Property value conversion" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Using the &gt;&gt; button for left-to-right reflection of the conversion rules for round-trip synchronization.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="d6338f48-5835-4acf-8735-0cc7f37eefd4"><ac:parameter ac:name="title">Important</ac:parameter><ac:rich-text-body><p>In case of conversion conflicts, you need to manually correct all the mapping attribute values shown in red.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="4acdf0b5-4a93-46b7-820b-57091725cd49"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>You must specify a conversion rule for the <strong>&lt;ANY VALUE&gt;</strong> source attribute to ensure that the selected conversion rule applies to other unspecified values of source attributes.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>The<strong> Converting Rule Editor</strong> dialog has the following conversion rules</p><ul><li><strong>&lt;CONVERT TO&gt;</strong></li></ul><p style="margin-left: 30.0px;">Synchronize the converted value if the source value matches the value in the <strong>From</strong> column.</p><ul><li><strong>&lt;DEFAULT&gt;</strong></li></ul><p style="margin-left: 30.0px;">Synchronize the original value if the source value matches the value in the <strong>From</strong> column.</p><ul><li><strong>&lt;IGNORED&gt;</strong></li></ul><p style="margin-left: 30.0px;">Do not perform any synchronization if the source value matches the value in the <strong>From</strong> column.</p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465576 space=CDH2024xR1 version=1 -->
## PAGE 00116: Removing a Data Source

- page_id: `170465576`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465576/Removing+a+Data+Source
- version_number: 1
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="32b60762-ccb6-4ce0-bdb6-1edf83c30363"><ac:parameter ac:name="id">1324133724</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="9e0de664-fcad-4b72-9c04-35a2461f5209"><ac:parameter ac:name="id">1324133726</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="512be508-b000-4b8f-b3ca-e5b61bbc9071"><ac:parameter ac:name="id">1324133725</ac:parameter><ac:rich-text-body><p>You can do simple schema mappings or define<span class="current"> target types from attribute value mapping</span>s between sources and targets in Cameo DataHub by using Schema Map Manager. This section also describes exporting, importing, and deleting schema mappings by using the <strong>Schema Map Manager</strong> dialog.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="e99b2dca-e3c7-48eb-9899-a1a05a81927e"><ac:parameter ac:name="id">1324133723</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="a3d1720d-ba69-440a-acdb-61ac8accc19c" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466110 space=CDH2024xR1 version=1 -->
## PAGE 00119: Saving the DHLink summary as reports

- page_id: `170466110`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466110/Saving+the+DHLink+summary+as+reports
- version_number: 1
...
1. In the Filter Options pane on the left-hand side of the [CONFLUENCE_PAGE title='DHLink Summary' space='CDH2024xR1'] dialog, choose type of relations you want to see in the DHLink summary.
...
````html
<p>DataHub provides the two mapping modes to simplify the way you map source and target nodes as follows</p><ul><li data-uuid="b54d418c-7eb1-4b88-aae2-7f08aacd3512">Group type mapping mode</li><li data-uuid="c9a12790-b6bb-4f89-9032-31dd68a02ea5">Individual type mapping mode</li></ul><p>These schema mapping methods are accessible through the <strong>Copy Data</strong> dialog, <strong>Copy Data with Sync</strong> dialog, and <strong>Copy Data with DHTrace</strong> dialog. Additional options, e.g., excluding unmapped nodes, are also available.</p><p>There is also a <strong><ac:link><ri:page ri:content-title="Define target type from attribute value mapping" /><ac:plain-text-link-body><![CDATA[Define target type from attribute value]]></ac:plain-text-link-body></ac:link></strong> mapping mode only available in group type mapping mode. Once you use the <strong>Define Target Type from Attribute Value </strong>mapping mode, DataHub saves it as the default mode and activates it the next time you copy the same type of data. In this case, the <strong>Copy Data </strong>dialog, <strong>Copy Data with Sync</strong> dialog, or <strong>Copy Data with DHTrace</strong> dialog does not open.</p><p><strong>Related pages</strong></p><p><strong><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="b750261b-c3ea-47e4-acf9-8563774bb6c2" /></strong></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=170465325 space=CDH2024xR1 version=1 -->
## PAGE 00121: Schema Map Manager

- page_id: `170465325`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465325/Schema+Map+Manager
- version_number: 1
- version_date: `2023-07-11T10:22:21.974+02:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []

### NORMALIZED CONTENT

You can **[CONFLUENCE_PAGE title='Working with Schema Map Manager' space='CDH2024xR1']** to edit attribute mapping. When the DHLinks between nodes and attributes have been created, **Schema Map Manager** saves the mapped nodes and attributes. You can edit the attribute mapping for a specific schema mapping. You can also export the mappings in XML format and share them with other users.
...
<!--NOMAGIC_PAGE id=170466311 space=CDH2024xR1 version=1 -->
## PAGE 00123: Schema Mapping

- page_id: `170466311`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466311/Schema+Mapping
- version_number: 1
- version_date: `2022-01-20T12:23:09.028+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="18cc8363-0d4f-4ddd-82d2-2bb65ff3970c"><ac:parameter ac:name="id">903652360</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="197dcf15-9887-4dc2-b3cc-e55a3559e1e7"><ac:parameter ac:name="id">903652363</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="3a55e963-b3ad-4c90-a47e-7b9651fce897"><ac:parameter ac:name="id">903652361</ac:parameter><ac:rich-text-body><p>DataHub is capable of synchronizing data in either one-way or two-way direction that you can apply to other relations, showing updates or changes through checking DHLinks and DHTrace prior to synchronizing data, excluding some nodes when copying data, providing synchronized changes in data hierarchy and in schema mapping, arranging nodes into the group type mapping to complete mapping faster, and dynamically defining target types from attributes' values before copying data.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="211ab19e-3d00-4f84-9c1d-812b98effd97"><ac:parameter ac:name="id">903652359</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="c659dc4a-8977-4c0e-82d0-4e26c8d62f20" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466020 space=CDH2024xR1 version=1 -->
## PAGE 00124: Schema mapping modes

- page_id: `170466020`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466020/Schema+mapping+modes
- version_number: 1
- version_date: `2017-12-21T05:33:22.841+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []
...
- [CONFLUENCE_PAGE title='Simple schema mapping' space='CDH2024xR1']
- [CONFLUENCE_PAGE title='Define Target Type from Attribute Value dialog and mapping' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can map nodes by doing either of the following</p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Simple schema mapping" /><ac:plain-text-link-body><![CDATA[Using simple Schema Mapping]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Define Target Type from Attribute Value dialog and mapping" /></ac:link></li></ul>
````

<!--NOMAGIC_PAGE id=170465581 space=CDH2024xR1 version=1 -->
## PAGE 00125: Searching for a text string

- page_id: `170465581`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465581/Searching+for+a+text+string
- version_number: 1
...
````html
<p>To search for text</p><hr /><ol><li><span style="color: rgb(62,63,64);">Type the text you want to search into the search box </span> <ac:image><ri:attachment ri:filename="text-search-box.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Searching for a text string" /></ri:attachment></ac:image>.<br /><br /><ac:image ac:title="Text Search from DataHub Explorer" ac:alt="Text Search from DataHub Explorer"><ri:attachment ri:filename="dh-explorer-toolbar.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Searching for a text string" /></ri:attachment></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">The search results are shown in the<span> </span></span><strong style="text-align: left;">DataHub Explorer</strong><span style="color: rgb(62,63,64);"><span> </span>tree with highlighted texts in accordance with the used search word.</span><br /><br /><ac:image ac:title="Results of text search - the search item will be highlighted" ac:alt="Results of text search - the search item will be highlighted"><ri:attachment ri:filename="results-of-text-search.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Searching for a text string" /></ri:attachment></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">To navigate to the</span><span style="color: rgb(62,63,64);"> </span><strong style="text-align: left;">Next Result<span> </span></strong><span style="color: rgb(62,63,64);">or</span><span style="color: rgb(62,63,64);"> </span><strong style="text-align: left;">Previous Result<span> </span></strong><span style="color: rgb(62,63,64);">in the highlighted texts, use the navigation buttons next to the search box.<br /></span><br /><ac:image><ri:attachment ri:filename="Navigation Button.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Searching for a text string" /></ri:attachment></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=170466021 space=CDH2024xR1 version=1 -->
## PAGE 00126: Simple schema mapping

- page_id: `170466021`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466021/Simple+schema+mapping
- version_number: 1
- version_date: `2023-07-27T12:32:54.242+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping > Schema mapping modes
- labels: []
...
1. Open the [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR1'] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog. [ATTACHMENT filename='Schema_Map_Manager.png']
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
1. Open the [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR1'] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog.
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
- [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="00e81a17-9b22-4683-b23f-18213df105cf"><ac:parameter ac:name="id">20157265</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="9b797fbd-29a2-44d1-8c74-475b66454c41"><ac:parameter ac:name="id">20157267</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="86043172-a53c-4f9c-8439-984292c079db"><ac:parameter ac:name="id">20157266</ac:parameter><ac:rich-text-body><p>You can do simple schema mapping and update existing schema maps in the Schema Map Manager dialog between data in the source schema and the target schema. You can also define a target type from the attribute value mappings by selecting the <strong>Define Target Type from Attribute Value</strong> option.</p><p>If your previous mapping mode is  Define Target Type from Attribute Value mapping, it is set as the default mapping automatically. You can also change the default mapping back to a simple mapping so that you can use the simple mapping to copy data when the <strong>Define Target Type from Attribute Value</strong> mapping mode is not selected.</p><p><br /></p><p>To specify a default mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. <br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Simple schema mapping" /></ri:attachment></ac:image><br /><br /></li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a target type in the Target Type section that you want to specify as the default one.</li><li>Click <strong>Set as Default</strong>. The selected target type is now the default mapping, and the button changes to <strong>Remove Default</strong>.<br /><br /></li></ol><p>To remove a default mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. <br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Simple schema mapping" /></ri:attachment></ac:image><br /><br /></li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a default target type in the Target Type section that you want to remove.</li><li>Click <strong>Remove Default</strong>. The selected target type is no longer the default mapping, and the button changes to <strong>Set as Default</strong>.<br /><br /></li></ol><p>To edit a schema mapping</p><hr /><ol><li>Open the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[Cameo DataHub Schema Map Manager]]></ac:plain-text-link-body></ac:link><ac:link><ri:page ri:space-key="CDH190" ri:content-title="Mapping with Schema Map Manager" /><ac:plain-text-link-body><![CDATA[ ]]></ac:plain-text-link-body></ac:link>dialog. </li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Select a target type in the Target Type section that you want to edit.  The Select Attribute to Sync list shows the list of default attributes mapping.</li><li>Click <strong>Edit </strong>to enable editing mode.</li><li>Change the attributes mapping, and then click <strong>Save</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Edited_Attribute.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Simple schema mapping" /></ri:attachment></ac:image><br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57302633-e7ba-426e-8ec0-0711ebe96967"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If the edited schema mapping affects any elements in the current project, the Edit Schema Map Confirmation dialog opens. Click <strong>Yes</strong> to confirm that you want to edit the schema, <strong>No</strong> to cancel the editing, or <strong>Details</strong> to see the details of all affected nodes.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Edit Schema Map Confirmation Dialog" ac:alt="Edit Schema Map Confirmation Dialog"><ri:attachment ri:filename="dh-edit-schema-map.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Simple schema mapping" /></ri:attachment></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The Edit Schema Map Confirmation dialog.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="f0408f31-efd0-4097-a2f7-dfc810c5a46d"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>After DataHub<span> saves an edited schema map, it will be effective when you perform data synchronization next time.</span></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="faa25272-3e5f-4ea2-a441-8cb8d708b033"><ac:parameter ac:name="id">20157264</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Mapping with Schema Map Manager" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466304 space=CDH2024xR1 version=1 -->
## PAGE 00127: Splitting part of a synchronized model as a used project

- page_id: `170466304`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466304/Splitting+part+of+a+synchronized+model+as+a+used+project
- version_number: 1
...
<!--NOMAGIC_PAGE id=170466219 space=CDH2024xR1 version=1 -->
## PAGE 00129: Synchronize buttons and commands

- page_id: `170466219`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466219/Synchronize+buttons+and+commands
- version_number: 1
...
- [CONFLUENCE_PAGE title='Tracking changes on Conflict Dashboard' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="8a9b729a-d201-40f0-9b37-db26f206ce52"><ac:parameter ac:name="id">1753613513</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="bef77671-68c3-4301-903a-4b0c13bb5f0b"><ac:parameter ac:name="id">1753613533</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="92f85682-c3ff-42e1-a814-f4ea7564ffad"><ac:parameter ac:name="id">1753613523</ac:parameter><ac:rich-text-body><p>To synchronize any nodes in the <strong>Conflict Dashboard</strong> dialog</p><hr /><ol><li><p class="auto-cursor-target">Select any check boxes of Data Sources on either of the sides. The selected side will be the master Data Source, and the other side will pick up the changes from the selected side.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57776fbc-c1d7-4a13-9494-dcc9a7c64609"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>A single node can be only synchronized from either the source to the target or the target to the source. However, multiple nodes can have different synchronization directions, e.g., one node can be synchronized from the source to the target, and another node can be synchronized from the target to the source.</p></ac:rich-text-body></ac:structured-macro></li><li>Click <strong style="line-height: 1.4285715;">Synchronize</strong>.</li></ol></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="0f7f9ab8-9157-4bfc-9422-fe96cfe6715e"><ac:parameter ac:name="id">1753613502</ac:parameter><ac:rich-text-body><p><strong>Related Pages</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Tracking changes on Conflict Dashboard" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466142 space=CDH2024xR1 version=1 -->
## PAGE 00134: Synchronizing Requirements

- page_id: `170466142`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466142/Synchronizing+Requirements
- version_number: 1
- version_date: `2018-02-06T11:47:12.355+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="627f24be-1932-4907-9633-8e8a35fda1f7"><ac:parameter ac:name="id">1167836701</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="7bdd0991-e509-4680-804a-1bb3f28e475d"><ac:parameter ac:name="id">1167836704</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="e57d4381-d50a-44a8-aca6-e42218aa95ef"><ac:parameter ac:name="id">1167836702</ac:parameter><ac:rich-text-body><p>Data synchronization is the process of sending all changes in the attribute values including a list of deleted items from a source to target data. Either the source or target must be a MagicDraw<sup>®</sup> node.</p><p>Data synchronization allows you to maintain the consistency of data across nodes in different Data sources and applications. During synchronization, all types of changes in a Data Source or application are stored in the DHLink map along with the project in its repository.</p><p>In addition to the <strong>Synchronize</strong> command on the DataHub Actions menu, DataHub provides the synchronization option through the DataHub main menu and the <strong>Synchronize</strong> buttons in the Containment tree and DataHub Explorer.</p><p>Data synchronization can be categorized into two functional types: Data Source synchronization and node synchronization.</p><p>Data Source synchronization is to synchronize all items in the entire Data Source that have DHLinks in a current project in an application.</p><p>Node Synchronization allows you to synchronize a specific node using either of the following mode:</p><ul><li><strong>Synchronize Node</strong></li><li><strong>Synchronize Node Recursively</strong>.</li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ed7b4e06-e498-487a-ab82-4d6182168021"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>DataHub ignores all excluded nodes in the Sync relations during data synchronization.</p></ac:rich-text-body></ac:structured-macro><p>You can perform synchronization on the selected node by clicking the <strong>Synchronize</strong> button on the <strong>DataHub Explorer</strong> toolbar.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Synchronizing a Data Source using the Synchronize button in DataHub explorer" ac:alt="Synchronizing a Data Source using the Synchronize button in DataHub explorer"><ri:attachment ri:filename="data-sync-btn-on-explorer-tab.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Synchronizing Requirements" /></ri:attachment></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The Synchronize button on the DataHub Explorer toolbar.</h6><p>Alternatively, you can perform synchronization from the MagicDraw<sup>®</sup> main menu by clicking <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Synchronize updates to Data Source</strong>.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="DataHub Menu.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Synchronizing Requirements" /></ri:attachment></ac:image></p><h6 class="auto-cursor-target" style="text-align: center;">Performing synchronization from the MagicDraw main menu.</h6></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="30f0b97e-fdea-4a9a-a6b1-379c930f4c34"><ac:parameter ac:name="id">1167836700</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="6f812287-2809-421a-95d5-dc4662487c7e" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466130 space=CDH2024xR1 version=3 -->
## PAGE 00135: Teamwork Cloud projects

- page_id: `170466130`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466130/Teamwork+Cloud+projects
- version_number: 3
- version_date: `2025-11-06T09:56:58.806+01:00`
...
<!--NOMAGIC_PAGE id=170465349 space=CDH2024xR1 version=1 -->
## PAGE 00136: Text search in DataHub Explorer and Alias Manager

- page_id: `170465349`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465349/Text+search+in+DataHub+Explorer+and+Alias+Manager
- version_number: 1
...
````html
<p>The text search capability in DataHub Explorer allows you to search for data and items in DataHub.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer Text Search box" ac:alt="DataHub Explorer Text Search box"><ri:attachment ri:filename="dh-text-search.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Text search in DataHub Explorer and Alias Manager" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Text search capability in DataHub Explorer.</h6>
````

<!--NOMAGIC_PAGE id=170466171 space=CDH2024xR1 version=1 -->
## PAGE 00137: Tracking changes on Conflict Dashboard

- page_id: `170466171`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466171/Tracking+changes+on+Conflict+Dashboard
- version_number: 1
...
Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to [CONFLUENCE_PAGE title='Server Certificates' space='MD2024xR1']. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to [CONFLUENCE_PAGE title='3DEXPERIENCE troubleshooting' space='MD2024xR1'].

### EXACT CONFLUENCE STORAGE SOURCE

````html
<h3>Server Certificate tool</h3><p>Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Server Certificates" /></ac:link>. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to  <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="3DEXPERIENCE troubleshooting" /></ac:link>.</p>
````

<!--NOMAGIC_PAGE id=170466323 space=CDH2024xR1 version=1 -->
## PAGE 00139: UI components of Schema Map Manager

- page_id: `170466323`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466323/UI+components+of+Schema+Map+Manager
- version_number: 1
- version_date: `2023-08-22T07:22:26.488+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Schema Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=170465417 space=CDH2024xR1 version=1 -->
## PAGE 00142: User Guide

- page_id: `170465417`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465417/User+Guide
- version_number: 1
...
<!--NOMAGIC_PAGE id=170466124 space=CDH2024xR1 version=3 -->
## PAGE 00143: Using DataHub in Teamwork Cloud environment

- page_id: `170466124`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466124/Using+DataHub+in+Teamwork+Cloud+environment
- version_number: 3
- version_date: `2025-11-06T10:09:41.684+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
````html
<p>DataHub supports local and remote connections. A local project is a project that is stored on your machine. When you connect to Teamwork Cloud, other users can remotely see the project you are working on through Teamwork Cloud. Multiple users can collaborate and work on the same project, and the DHLink map will be stored along with the project on Teamwork Cloud. This allows all users to see other users’ changes in their work.</p><p style="text-align: left;">In addition to local and remote connections, DataHub also provides functionality that allows several users to access the same project, including DataHub relations. This functionality is available for projects that are stored on Teamwork Cloud.</p><p><strong>Related page</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="b09348f8-e4f9-4759-bd16-cab4f9e9d8ff" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=170466374 space=CDH2024xR1 version=1 -->
## PAGE 00144: Working with custom IP Classification attributes

- page_id: `170466374`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466374/Working+with+custom+IP+Classification+attributes
- version_number: 1
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="644a4802-0f76-492f-a6cd-98b481bac151"><ac:parameter ac:name="id">123044587</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="d92b6e81-8c85-44d9-913f-1da30e42a4cd"><ac:parameter ac:name="id">123044598</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="2ad63f2f-7ae9-4a5c-a6a4-137318c2bd35"><ac:parameter ac:name="id">123044597</ac:parameter><ac:rich-text-body><p>Before connecting a Data Source to a driver, you need to have the<strong> DataHub Explorer</strong> tab open in MagicDraw<sup>®</sup>.</p><p>To open <strong>DataHub Explorer</strong></p><hr /><ol><li>Start MagicDraw<sup>®</sup> and create a new project or open an existing one.</li><li>From the MagicDraw<sup>®</sup> main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="dh-explorer.png"><ri:page ri:space-key="CDH2024xR1" ri:content-title="Working with Data Sources" /></ri:attachment></ac:image></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="1f777467-4227-4f11-b788-874c171532ae"><ac:parameter ac:name="id">123044586</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="4a3bfa82-0bb1-4b85-9474-03162e9e93dc" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465418 space=CDH2024xR1 version=2 -->
## PAGE 00146: Working with DataHub and modeling tools

- page_id: `170465418`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465418/Working+with+DataHub+and+modeling+tools
- version_number: 2
- version_date: `2024-05-08T13:50:48.233+02:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
To use Cameo DataHub, make sure you have [deployed it in your application](https://docs.nomagic.com/display/CDH2024xR1/Driver+deployment). The DataHub plugin works with both local and [CONFLUENCE_PAGE title='Using Teamwork Cloud' space='MD2024xR1'].
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="2b0ff4e9-52f1-4d8f-947b-b8280955fda2"><ac:parameter ac:name="id">1017353020</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="8295fe50-6b8d-440e-8864-173fbbe3ff9a"><ac:parameter ac:name="id">1017353023</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="33f15a39-0c5d-4936-8d00-b62ceb3b0a16"><ac:parameter ac:name="id">1017353022</ac:parameter><ac:rich-text-body><p>DataHub is a fully functional plugin for MagicDraw<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation, and CSV files. It allows you to work with the Requirement management tools mentioned above and provides three following main functions</p><ul><li>Copy</li><li>Link</li><li>Synchronize</li></ul><p>You can copy Requirement objects, and link them to one another as well as system models, for example, Use Cases and Diagram elements. You can create OSLC links and synchronize the repositories. This chapter also explains OSLC support and how to use it with Cameo DataHub.</p><p>To use Cameo DataHub, make sure you have <a href="https://docs.nomagic.com/display/CDH2024xR1/Driver+deployment">deployed it in your application</a>. The DataHub plugin works with both local and <ac:link><ri:page ri:space-key="MD2024xR1" ri:content-title="Using Teamwork Cloud" /><ac:plain-text-link-body><![CDATA[Teamwork Cloud projects]]></ac:plain-text-link-body></ac:link>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b195c968-f56f-4ea2-844a-9d41925ec19b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>To load a MagicDraw<sup>®</sup> Teamwork Cloud project as a Data Source in DataHub, you must first log on to MagicDraw<sup>®</sup> Teamwork Cloud.</li><li>Only the <strong>Locked For Edit</strong> Teamwork Cloud project elements can perform DataHub functions, e.g., copying and creating OSLC links and queries or synchronizing data.</li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="f522d25e-21f3-4f45-b0f7-164a3f12138e"><ac:parameter ac:name="id">1017353019</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="061fb9c2-d35d-44fe-9eba-f215aff9675d" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170465910 space=CDH2024xR1 version=1 -->
## PAGE 00147: Working with OSLC features

- page_id: `170465910`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465910/Working+with+OSLC+features
- version_number: 1
- version_date: `2024-01-31T07:05:08.618+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
- [CONFLUENCE_PAGE title='Working with Data Sources' space='CDH2024xR1']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="c5a4361c-e5a7-4bf7-ab5b-0834cab8d435"><ac:parameter ac:name="id">1333392449</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="d66659bd-7737-4989-9ca7-c21fb3409048"><ac:parameter ac:name="id">1333392451</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="2a3766cb-8077-45ca-a5d6-268c8e1165e6"><ac:parameter ac:name="id">1333392450</ac:parameter><ac:rich-text-body><p>The modeling tool can link and share data using Open Services for Lifecycle Collaboration (OSLC) integration that allows the following</p><ul><li>The modeling environment to work smoothly in the IBM Jazz ecosystem.</li><li>Linking different project lifecycle artifacts in different tools without additional plugins needed.</li><li>Seeing information details of linked artifacts without switching between different tools. </li></ul><p>The following chapters describe how the modeling tool works with OSLC:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f1b328bc-fea4-4637-8557-0d096f85deb0" /></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="1f948ad5-aa44-4ea3-905c-cdd086da9766"><ac:parameter ac:name="id">1333392448</ac:parameter><ac:rich-text-body><p><strong>Related page</strong></p><ul><li><ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="Working with Data Sources" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466317 space=CDH2024xR1 version=1 -->
## PAGE 00148: Working with Schema Map Manager

- page_id: `170466317`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466317/Working+with+Schema+Map+Manager
- version_number: 1
- version_date: `2023-07-28T06:39:19.004+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Schema Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=170465562 space=CDH2024xR1 version=1 -->
## PAGE 00149: Working with the DataHub Explorer tree

- page_id: `170465562`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170465562/Working+with+the+DataHub+Explorer+tree
- version_number: 1
- version_date: `2022-05-06T08:38:24.772+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="becdbafb-5289-473a-91bd-d2a055be18d1"><ac:parameter ac:name="id">1253185318</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="f15e9110-512f-4920-a8d5-c7dcac10daf6"><ac:parameter ac:name="id">1253185320</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="cbcb60a1-5376-4692-a3a9-69ce9db9bee4"><ac:parameter ac:name="id">1253185319</ac:parameter><ac:rich-text-body><p><span style="color: rgb(51,51,51);">While using DataHub to work with Requirements from a project in DOORS or CSV, you must first create a Data Source. Data sources can be created for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation, or CSV files.</span></p><p>When you add the Data Source into MagicDraw<sup>®</sup>, it appears in the DataHub Explorer tree as a Data Source node.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="1ac3bb49-ff78-4368-a2dc-c735c5877166"><ac:parameter ac:name="id">1253185316</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="cb13ea5e-1aba-4c96-bc28-bd49899fea25" /></p><p><strong><br /></strong></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=170466075 space=CDH2024xR1 version=1 -->
## PAGE 00150: Working with the DHLink summary and generating reports

- page_id: `170466075`
- space_key: `CDH2024xR1`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR1/pages/170466075/Working+with+the+DHLink+summary+and+generating+reports
- version_number: 1
- version_date: `2017-12-26T06:59:27.578+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="fb700396-ca66-4287-aa10-45ff16e1728e"><ac:parameter ac:name="id">368648720</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="45f11238-28d6-435f-8890-573a8bcfaca8"><ac:parameter ac:name="id">368648722</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="91640057-bbc3-476b-a59c-ba50411e00da"><ac:parameter ac:name="id">368648721</ac:parameter><ac:rich-text-body><p>You can review DHLinks and make filtering options in terms of selected driver, direction of synchronization, sources and targets, types, status, and DHTrace, to display all interconnected relations through the <ac:link><ri:page ri:space-key="CDH2024xR1" ri:content-title="DHLink Summary" /><ac:link-body><strong>DHLink summary</strong> dialog</ac:link-body></ac:link>. With the shortcut menu in the DHLink Summary dialog, you can remove DHLinks, change synchronization directions, or select nodes from DataHub Explorer/Alias Explorer or in their original applications. You can also save the DHLink summary as an HTML report and open it in browsers.</p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="2dc9f70a-7d6a-42cd-b209-5c17a7eb9860"><ac:parameter ac:name="id">368648719</ac:parameter><ac:rich-text-body><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="c7a7334e-fde4-4787-bbf4-d8e83c541949" /></p></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````
