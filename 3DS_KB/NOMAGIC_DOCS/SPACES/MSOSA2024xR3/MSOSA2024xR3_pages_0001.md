# NOMAGIC DOCUMENTATION SPACE: Magic Systems of Systems Architect 2024x Refresh3

<!--NOMAGIC_SPACE key=MSOSA2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227162862 space=MSOSA2024xR3 version=1 -->
## PAGE 00001: 2022x News for Developers

- page_id: `227162862`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162862/2022x+News+for+Developers
- version_number: 1
...
<!--NOMAGIC_PAGE id=227162863 space=MSOSA2024xR3 version=1 -->
## PAGE 00002: 2022x Version News

- page_id: `227162863`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162863/2022x+Version+News
- version_number: 1
...
**[CONFLUENCE_PAGE title='2022x Version News' space='MSOSA2024xR3']**
...
<!--NOMAGIC_PAGE id=227162891 space=MSOSA2024xR3 version=1 -->
## PAGE 00004: 2024x Refresh2 Version News

- page_id: `227162891`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162891/2024x+Refresh2+Version+News
- version_number: 1
- version_date: `2025-05-02T10:00:41.192+02:00`
- ancestors: Magic Systems of Systems Architect Documentation
- labels: []
...
2024x Refresh2 Hot Fix 1 is now available for CATIA Magic and No Magic portfolios. It includes a number of improvements and bug fixes, and vulnerability fixes in our modeling tools, plugins, and server products . [CONFLUENCE_PAGE title='2024x Refresh2 Hot Fix 1 Version News' space='CATIA']>]]>
...
[CONFLUENCE_PAGE title='SIMULIA Process Composer Integration' space='MSI2024xR2']>]]>
...
The**2024x Refresh3**release comes with Gantt Chart improvements such as the ability to control sub-resource visibility and depth in the Capability Provisions panel, and to manage their In Service / Out of Service dates directly. To ensure date alignment in Gantt charts, a new validation rule was implemented.You can also now reuse existing Actual Project Milestones in different Gantt charts.Additionally, the release includes enhanced UAF element numbering, which allows to use of multi-level and hierarchical numbering of UAF elements.

Moreover, the release introduces key enhancements to collaborative modeling on both Teamwork Cloud and the**3D**EXPERIENCE platform. Teamwork Cloud now supports partial project usages as a technology preview, enabling more flexible reuse of specific project parts, along with improved SSO support across command-line tools. On the**3D**EXPERIENCE platform, standard profile migration has been simplified, and project opening performance with local cache has been significantly improved. Both Teamwork Cloud and the**3D**EXPERIENCE platform will benefit from a new option to detect changes in derived properties during project merging or comparison.
...
- A new project option allows you to set the depth of displayed sub-resources in the Strategic Phasing/CV-3/StV-3/NCV-3/Cr Gantt Chart Capability Provisions panel. This lets you control how many sub-resource levels are displayed in the Capability Provisionarea.[Learn more >>>](https://docs.nomagic.com/display/UAF12P2024xR3/Setting+project+options) 
[IMAGE alt='' src='']
- A new toolbar button in the Gantt Chart allows you to toggle the visibility of sub-resources in the Capability Provisions panel. [Learn more >>>](https://docs.nomagic.com/display/UAF12P2024xR3/Working+with+Strategic+Phasing+diagram) 
[IMAGE alt='' src='']
- When you enable sub-resource visibility in the Strategic Phasing Gantt chart, you can now add, edit, or remove In Service / Out of Service dates for sub-resources directly in the Capability Provision area.[Learn more >>>](https://docs.nomagic.com/display/UAF12P2024xR3/Working+with+Strategic+Phasing+diagram) 
[IMAGE alt='' src='']
- Now you can select an existing InService/ Out of Service Actual Project Milestones in the following Gantt charts:
  - Strategic Phasing
  - Resources Evolution
  - Personnel Evolution
  - Services Roadmap

### UAF Element Numbering

In this version, the UAF element numbering was enhanced. The multi-levelnumbering is now available for UAF elements. Now, you can apply:

- hierarchical numbering to UAF elements (such as Driver, Operational Information),
- hierarchical numbering with dynamic prefixes for the UAF requirements (such as Enterprise Goal, Enterprise Objective) based on SysML elements.

[IMAGE alt='' src='']

[Learn more >>>](https://docs.nomagic.com/display/UAF12P2024xR3/UAF+element+numbering)

### Other Enhancements

- A new Correctness validation rule was implemented to check whether the Capability Provision's actual start/end aligns with the Capability Provision's consolidated start/end dates. Learn more >>>

### miModeling and Infrastructure

- You can now disable all automatic and manual usage analytics, prevent internal error submissions, and remove related environment properties by modifying the system properties. [Learn more >>>](https://docs.nomagic.com/display/MD2024xR3/Sharing+Usage+Analytics+information)
- This release introduces the ability to install custom browser extensions in JxBrowser.

### Collaboration

#### Teamwork Cloud

##### Partial Project Usages (Technology Preview)

We’re excited to introduce a significant enhancement to project usages, now available as a**technology preview**. Previously, you could only use an entire project (full usage), but with this release, you can define a usage scope and use only a specific part of a project. Additionally, you can seamlessly switch between full and partial usage at any time and adjust the usage scope as needed.

[IMAGE alt='' src='']

###### Selecting the scope of a partial project usage.

##### Improvements to Single Sign-On Authentication

For improved security, the Used Projects Auto Update Wizard now only accepts access tokens generated by your user when using single sign-on (SSO) authentication. Additionally, SSO is now supported in other command-line tools, like Report Wizard and Cameo Collaborator.

#### **3D**EXPERIENCE Platform

##### Easier Standard Profile Migration

The standard profile migration has been simplified allowing you to migrate all standard profiles in one go. Now, you can use the project migrationdialogto select the profiles from both the server and your modeling tool installation. During migration:

- Standard profiles stored in the 3D EXPERIENCE platform are migrated.
- Standard profiles existing in the modeling tool installation but not yet added to the the server can be selected and added to the 3D EXPERIENCE platform.
- Any dependent profiles are also migrated or added.

##### Performance Improvements

In version 2024x Refresh3, project opening performance has been significantly improved when a local cache is already present on your machine, as demonstrated in the chart below.

[IMAGE alt='' src='']

###### Comparison of project load times with local cache.

##### Other Improvements

- The following predefined templates have been introduced for publishing Cameo Collaborator documents:
  - UAF Template for Cameo Collaborator
  - UPDM Template for Cameo Collaborator
  - BPMN Template for Cameo Collaborator
- You can now specify the project branch, revision, and iteration when logged in via the command line interface.

#### General Collaboration Improvements

- The new Detect Changes in Derived Properties environment option allows you to specify which derived properties to compare when detecting changes during project merge or compare.
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:structured-macro ac:name="anchor" ac:schema-version="1" ac:macro-id="7dc7bee2-3797-466f-982b-5a1e0d78e7c5"><ac:parameter ac:name="">top</ac:parameter></ac:structured-macro></p><h5 style="text-align: center;">Magic Systems of Systems Architect</h5><p style="text-align: center;"><span style="color:var(--ds-chart-gray-bold,#8590a2);">Released on: July 11, 2025</span></p><p><br /></p><p><span style="color:var(--ds-text,#172b4d);">The</span><strong style="text-align: left;"><span> </span>2024x Refresh3</strong><span style="color:var(--ds-text,#172b4d);"><span> </span>release comes with Gantt Chart improvements such as the ability to control sub-resource visibility and depth in the Capability Provisions panel, and to manage their In Service / Out of Service dates directly. To ensure date alignment in Gantt charts, a new validation rule was implemented.<span> </span></span>You can also now reuse existing Actual Project Milestones in different Gantt charts.<span style="color:var(--ds-text,#172b4d);"><span> </span></span>Additionally, the release includes enhanced UAF element numbering, which allows to use of multi-level and hierarchical numbering of UAF elements. </p><p><span style="color:var(--ds-text,#172b4d);">Moreover, the release introduces key enhancements to collaborative modeling on both Teamwork Cloud and the </span><strong style="text-align: left;">3D</strong><span style="color:var(--ds-text,#172b4d);">EXPERIENCE platform. Teamwork Cloud now supports partial project usages as a technology preview, enabling more flexible reuse of specific project parts, along with improved SSO support across command-line tools. On the<span> </span></span><strong style="text-align: left;">3D</strong><span style="color:var(--ds-text,#172b4d);">EXPERIENCE platform, standard profile migration has been simplified, and project opening performance with local cache has been significantly improved. Both Teamwork Cloud and the<span> </span></span><strong style="text-align: left;">3D</strong><span style="color:var(--ds-text,#172b4d);">EXPERIENCE platform will benefit from a new option to detect changes in derived properties during project merging or comparison.</span></p><p>To download the latest version of the modeling tool, see <ac:link><ri:page ri:space-key="IL2024xR2" ri:content-title="Downloading installation files" /></ac:link>. For further information, check the product documentation.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p><hr /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="three_equal"><ac:layout-cell><p><strong style="letter-spacing: 0.0px;"><ac:link ac:anchor="UAF Features" /></strong></p><ul><li><ac:link ac:anchor="Gantt Chart Improvements" /></li><li><ac:link ac:anchor="UAF Element Numbering" /></li><li><ac:link ac:anchor="Other Enhancements" /></li></ul></ac:layout-cell><ac:layout-cell><p><strong style="letter-spacing: 0.0px;"><ac:link ac:anchor="mi"><ac:plain-text-link-body><![CDATA[Modeling and Infrastructure]]></ac:plain-text-link-body></ac:link></strong></p></ac:layout-cell><ac:layout-cell><p><strong style="letter-spacing: 0.0px;"><ac:link ac:anchor="Collaboration" /></strong></p><ul><li><ac:link ac:anchor="Teamwork Cloud" /><ul><li><ac:link ac:anchor="Partial Project Usages (Technology Preview)" /></li><li><ac:link ac:anchor="Improvements to Single Sign-On Authentication" /></li></ul></li><li><ac:link ac:anchor="3DEXPERIENCE Platform" /><ul><li><ac:link ac:anchor="Easier Standard Profile Migration" /></li></ul></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p><hr /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1>UAF Features</h1></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><span style="font-size: 24.0px;letter-spacing: -0.01em;">Gantt Chart Improvements</span></p><ul><li data-uuid="34676d30-6bdc-4be4-9c7f-56bdc315e7f9"><span style="color:var(--ds-text,#172b4d);">A new project option allows you to set the depth of displayed sub-resources in the Strategic Phasing/CV-3/StV-3/NCV-3/Cr Gantt Chart Capability Provisions panel. This lets you control how many sub-resource levels are displayed in the Capability Provision<span> </span>area.<span> </span><a href="https://docs.nomagic.com/display/UAF12P2024xR3/Setting+project+options">Learn more &gt;&gt;&gt;</a><br /><span class="confluence-embedded-file-wrapper image-center-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="sub_resource_depth.png" /></ac:image></span><br /></span></li><li data-uuid="71a42216-97bc-4f36-a3a6-ed0dd8de0091"><span style="color:var(--ds-text,#172b4d);">A new toolbar button in the Gantt Chart allows you to toggle the visibility of sub-resources in the Capability Provisions panel.<span> </span> <a href="https://docs.nomagic.com/display/UAF12P2024xR3/Working+with+Strategic+Phasing+diagram">Learn more &gt;&gt;&gt;</a> <br /><span class="confluence-embedded-file-wrapper image-center-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Show_hide_sub_resources_in_the_capability_provision_area.png" /></ac:image></span><br /></span></li><li data-uuid="7e9ac2a9-47ca-485c-a695-811433c08220"><span style="color:var(--ds-text,#172b4d);">When you enable sub-resource visibility in the Strategic Phasing Gantt chart, you can now add, edit, or remove In Service / Out of Service dates for sub-resources directly in the Capability Provision area.<span> </span><a href="https://docs.nomagic.com/display/UAF12P2024xR3/Working+with+Strategic+Phasing+diagram">Learn more &gt;&gt;&gt;</a><br /><span class="confluence-embedded-file-wrapper image-center-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="add_edit_remove_in_out_service_dates.png" /></ac:image></span><br /></span></li><li data-uuid="bdbac909-fa38-4061-91a9-c0ce0d0199c4"><span style="color:var(--ds-text,#172b4d);">Now you can select an existing In<span> </span>Service<span> </span>/ Out of Service Actual Project Milestones in the following Gantt charts:</span><ul><li><span style="color:var(--ds-text,#172b4d);">Strategic Phasing<br /></span></li><li><span style="color:var(--ds-text,#172b4d);">Resources Evolution<br /></span></li><li><span style="color:var(--ds-text,#172b4d);">Personnel Evolution<br /></span></li><li><span style="color:var(--ds-text,#172b4d);">Services Roadmap</span></li></ul></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="text-align: left;">UAF Element Numbering</h1><p style="text-align: left;"><span style="font-size: 14.0px;letter-spacing: 0.0px;">In this version, the UAF element numbering was enhanced. The multi-level</span><span style="font-size: 14.0px;letter-spacing: 0.0px;"> </span><span style="color:var(--ds-text,#172b4d);">numbering is now available for UAF elements. Now, you can apply:</span></p><ul><li style="text-align: left;" data-uuid="95a2c8a2-b0d8-4c45-9f0a-e2e36b5222c6"><span style="font-size: 14.0px;letter-spacing: 0.0px;color:var(--ds-text,#172b4d);">hierarchical numbering to UAF elements (such as Driver, Operational Information),</span></li><li style="text-align: left;" data-uuid="0a35c196-917b-4126-8844-b5acd0edfee4"><span style="font-size: 14.0px;letter-spacing: 0.0px;color:var(--ds-text,#172b4d);">hierarchical numbering with dynamic prefixes for the</span><span style="font-size: 14.0px;letter-spacing: 0.0px;color:var(--ds-text,#172b4d);"> </span><span style="font-size: 14.0px;letter-spacing: 0.0px;color:var(--ds-text,#172b4d);"> UAF requirements (such as Enterprise Goal, Enterprise Objective) based on SysML elements.</span></li></ul><p style="text-align: center;"><span style="color:var(--ds-text,#172b4d);"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="hierarchical_element_numbering.png" /></ac:image></span></span></p><p><span style="color:var(--ds-text,#172b4d);"><a href="https://docs.nomagic.com/display/UAF12P2024xR3/UAF+element+numbering">Learn more &gt;&gt;&gt;</a></span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1>Other Enhancements</h1><ul><li data-uuid="6b8ac900-e033-4b70-9c9f-72ff914aa47c">A new Correctness validation rule was implemented to check<span> </span>whether<span> </span>the Capability Provision's actual start/end aligns with the Capability Provision's<span> </span>consolidated start/end dates.<span> </span><a href="https://docs.nomagic.com/display/UAF12P2024xR3/COR2362">Learn more &gt;&gt;&gt;</a></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p style="text-align: right;"><ac:link ac:anchor="top"><ac:plain-text-link-body><![CDATA[Back to top]]></ac:plain-text-link-body></ac:link></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1><ac:structured-macro ac:name="anchor" ac:schema-version="1" ac:macro-id="86c1e37a-6f77-4e5e-aa46-ea5b738c8c41"><ac:parameter ac:name="">mi</ac:parameter></ac:structured-macro>Modeling and Infrastructure</h1><ul style="text-align: left;"><li data-uuid="574882fe-baeb-427d-a5e4-2ce35d9fdb95"><span style="color:var(--ds-text,#172b4d);">You can now disable all automatic and manual usage analytics, prevent internal error submissions, and remove related environment properties by modifying the system properties. <a href="https://docs.nomagic.com/display/MD2024xR3/Sharing+Usage+Analytics+information">Learn more &gt;&gt;&gt;</a></span></li><li data-uuid="7657062d-270d-46bf-8549-7fa06b831fcb"><span style="color:var(--ds-text,#172b4d);">This release introduces the ability to install custom browser extensions in JxBrowser.</span></li></ul><p style="text-align: right;"><ac:link ac:anchor="top"><ac:plain-text-link-body><![CDATA[Back to top]]></ac:plain-text-link-body></ac:link></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="text-align: left;"><span>Collaboration</span></h1></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h2 style="text-align: left;"><span>Teamwork Cloud</span></h2><h3 style="text-align: left;">Partial Project Usages (Technology Preview)</h3><p style="text-align: left;">We’re excited to introduce a significant enhancement to project usages, now available as a<span> </span><strong>technology preview</strong>. Previously, you could only use an entire project (full usage), but with this release, you can define a usage scope and use only a specific part of a project. Additionally, you can seamlessly switch between full and partial usage at any time and adjust the usage scope as needed.<br /><br /></p><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="partial_project_usages.png" /></ac:image></span></p><h6 style="text-align: center;">Selecting the scope of a partial project usage.</h6><h3 style="text-align: left;">Improvements to Single Sign-On Authentication</h3><p style="text-align: left;">For improved security, the Used Projects Auto Update Wizard now only accepts access tokens generated by your user when using single sign-on (SSO) authentication. Additionally, SSO is now supported in other command-line tools, like Report Wizard and Cameo Collaborator.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p style="text-align: right;"><ac:link ac:anchor="top"><ac:plain-text-link-body><![CDATA[Back to top]]></ac:plain-text-link-body></ac:link></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h2 style="text-align: left;"><strong>3D</strong><span>EXPERIENCE Platform</span></h2><h3 style="text-align: left;">Easier Standard Profile Migration</h3><p style="text-align: left;">The standard profile migration has been simplified allowing you to migrate all standard profiles in one go. Now, you can use the project migration<span> </span><span>dialog </span>to select the profiles from both the server and your modeling tool installation. During migration:</p><ul style="text-align: left;"><li data-uuid="91ffc6ca-c1a0-4873-bfc5-b465d74983de">Standard profiles stored in the<span> </span><strong>3D</strong>EXPERIENCE platform are migrated.</li><li data-uuid="c2db8492-f8d7-4a06-b3ab-6315c1f07673">Standard profiles existing in the modeling tool installation but not yet added to the the server can be selected and added to the<span> </span><strong>3D</strong>EXPERIENCE platform.</li><li data-uuid="e743a6d1-3b39-430b-996c-b2815c852730">Any dependent profiles are also migrated or added.</li></ul><h3 style="text-align: left;">Performance Improvements</h3><p style="text-align: left;">I<span>n version 2024x Refresh3, project opening performance has been significantly improved when a local cache is already present on your machine, as demonstrated in the chart below.<br /><br /></span></p><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="project_opening_performance.png" /></ac:image></span></p><h6 style="text-align: center;">Comparison of project load times with local cache.</h6><h3 style="text-align: left;">Other Improvements</h3><ul style="text-align: left;"><li data-uuid="5f7fb816-e07d-43a5-96e4-8efa2fda36f2">The following predefined templates have been introduced for publishing Cameo Collaborator documents:<ul><li>UAF Template for Cameo Collaborator</li><li>UPDM Template for Cameo Collaborator</li><li>BPMN Template for Cameo Collaborator</li></ul></li><li data-uuid="b357ee12-9c99-4142-97a4-9e5b35d02ac8">You can now specify the project branch, revision, and iteration when logged in via the command line interface.</li></ul><h2 style="text-align: left;">General Collaboration Improvements</h2><ul style="text-align: left;"><li data-uuid="23d14d42-44c6-4163-afed-55a8a654c7bd">The new<span> </span><strong>Detect Changes in Derived Properties<span> </span></strong>environment option allows you to specify which derived properties to compare when detecting changes during project merge or compare.</li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p><hr /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="2024x Refresh2 Version News" /><ac:plain-text-link-body><![CDATA[Version news of servers and plugins >>]]></ac:plain-text-link-body></ac:link></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227162979 space=MSOSA2024xR3 version=1 -->
## PAGE 00006: 2024x Version News

- page_id: `227162979`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162979/2024x+Version+News
- version_number: 1
...
<!--NOMAGIC_PAGE id=227162890 space=MSOSA2024xR3 version=3 -->
## PAGE 00007: Magic Systems of Systems Architect Documentation

- page_id: `227162890`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162890/Magic+Systems+of+Systems+Architect+Documentation
- version_number: 3
- version_date: `2025-05-07T09:14:23.800+02:00`
- ancestors: 
- labels: []
...
**[CONFLUENCE_PAGE title='MagicDraw Documentation' space='MD2024xR3']**
...
**[CONFLUENCE_PAGE title='UAF 1.2 Plugin Documentation' space='UAF12P2024xR3']**
...
**[CONFLUENCE_PAGE title='UPDM 2 Plugin Documentation' space='UPDM2P2024xR3']**
...
**[CONFLUENCE_PAGE title='Cameo Requirements Modeler Plugin Documentation' space='CRMP2024xR3']**

Guides you through the import, export, and management of SysML requirements.

Type a search phrase...

**[CONFLUENCE_PAGE title='Magic Concept Modeler Documentation' space='MCM2024xR3']**
...
**[CONFLUENCE_PAGE title='Installation, Licensing, and System Requirements Documentation' space='IL2024xR3']**

Provides the instructions about how to install modeling tool and plugins, add or remove licenses, perform activation.

**[CONFLUENCE_PAGE title='Magic Model Analyst Documentation' space='MSI2024xR3']**
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>This is the home page of Magic Systems of Systems Architect documentation.</p><p>Magic Systems of Systems Architect is based on the award-winning MagicDraw modeling platform. The solution retains all the best diagramming, collaboration, persistence, and documentation capabilities while offering more customized capabilities tailored to <strong>enterprise architecture</strong> needs.</p><p>The documentation of Magic Systems of Systems Architect is a package that includes the documentation of these capabilities:</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p> <strong style="letter-spacing: 0.0px;"><span class="confluence-link"><ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="MagicDraw Documentation" /><ac:plain-text-link-body><![CDATA[General Capabilities]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Introduces the main features of modeling tool: working with projects, UML 2 modeling and diagramming, collaboration capabilities, and many more core features.</p><p><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="a351fb91-3e83-400d-9356-f7f8a6819239"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="MD2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><span class="confluence-link"><ac:link><ri:page ri:space-key="UAF12P2024xR3" ri:content-title="UAF 1.2 Plugin Documentation" /><ac:plain-text-link-body><![CDATA[UAF 1.2 modeling]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Provides descriptions of UAF diagrams and elements, plus introduces UAF specific features as well as gives guidelines for building enterprises.</p><p><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="9c6a326e-f3ca-469d-b33c-d6fe3e1ba607"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="UAF12P2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><span class="confluence-link"><ac:link><ri:page ri:space-key="UPDM2P2024xR3" ri:content-title="UPDM 2 Plugin Documentation" /><ac:plain-text-link-body><![CDATA[UPDM 2 modeling]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Provides descriptions of UPDM 2 diagrams and elements, plus introduces UPDM 2 specific features as well as gives guidelines for building enterprises.</p><p><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="31857b8b-0a30-4268-adb0-493efa83708b"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="UPDM2P2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><span class="confluence-link"><ac:link><ri:page ri:space-key="SYSMLP2024xR3" ri:content-title="SysML Plugin Documentation" /><ac:plain-text-link-body><![CDATA[SysML modeling]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Provides descriptions of SysML diagrams and elements, plus introduces SysML specific features as well as gives guidelines for building systems.</p><p><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="42f152ec-25e5-4af2-b474-bfe7825d0ccc"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="SYSMLP2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><span class="confluence-link"><ac:link><ri:page ri:space-key="CRMP2024xR3" ri:content-title="Cameo Requirements Modeler Plugin Documentation" /><ac:plain-text-link-body><![CDATA[Requirements modeling]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Guides you through the import, export, and management of SysML requirements.</p><p><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="36b76ba2-3c11-4211-9356-acf7977a1b00"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="CRMP2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><ac:link><ri:page ri:space-key="MCM2024xR3" ri:content-title="Magic Concept Modeler Documentation" /><ac:plain-text-link-body><![CDATA[Concept modeling]]></ac:plain-text-link-body></ac:link></strong></p><p><span style="color: rgb(62,63,64);">Provides instructions about how to model real-world concepts, import/export a model from/to an OWL ontology, and generate glossaries in plain English for clearer and more informative source of knowledge for any domain. </span></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="eb189a65-8aef-4d87-9f02-c1eca531dd8a"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="MCM2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><br /></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><h3>Additional information</h3></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><ac:link><ri:page ri:space-key="IL2024xR3" ri:content-title="Installation, Licensing, and System Requirements Documentation" /><ac:plain-text-link-body><![CDATA[Installation and licensing]]></ac:plain-text-link-body></ac:link></strong></p><p>Provides the instructions about how to install modeling tool and plugins, add or remove licenses, perform activation. </p><p><br /></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p><strong><span class="confluence-link"><ac:link><ri:page ri:space-key="MSI2024xR3" ri:content-title="Magic Model Analyst Documentation" /><ac:plain-text-link-body><![CDATA[Simulation]]></ac:plain-text-link-body></ac:link></span></strong></p><p>Provides instructions on how to test the system reactions to user interaction or predefined testing data and execution scenarios.</p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="70296f46-eacf-4253-86f4-6ac81d4e31b8"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="MSI2024xR3" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227162999 space=MSOSA2024xR3 version=1 -->
## PAGE 00008: Support

- page_id: `227162999`
- space_key: `MSOSA2024xR3`
- source_url: https://docs.nomagic.com/spaces/MSOSA2024xR3/pages/227162999/Support
- version_number: 1
...
In case you will decide to change the plugin later, see chapter [CONFLUENCE_PAGE title='Changing between UAF and UPDM 2 plugins' space='UAF12P2024xR3'] for information about how to do that.
