# NOMAGIC DOCUMENTATION SPACE: Alf Plugin 2024x Refresh3

<!--NOMAGIC_SPACE key=ALFP2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=239797264 space=ALFP2024xR3 version=1 -->
## PAGE 00001: 2024x Refresh3 Version News

- page_id: `239797264`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/239797264/2024x+Refresh3+Version+News
- version_number: 1
- version_date: `2025-07-10T11:01:47.671+02:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h5 style="text-align: center;">Alf Plugin</h5><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: July 11, 2025</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p>The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <a href="https://docs.nomagic.com/display/NMDOC/Product+compatibility" style="text-decoration: none;">here</a>.</p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179143 space=ALFP2024xR3 version=1 -->
## PAGE 00002: Accessing context features without using "this"

- page_id: `227179143`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179143/Accessing+context+features+without+using+this
- version_number: 1
- version_date: `2023-07-26T13:43:56.080+02:00`
...
<!--NOMAGIC_PAGE id=227179138 space=ALFP2024xR3 version=1 -->
## PAGE 00004: Accessing data in Activity Edge guards

- page_id: `227179138`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179138/Accessing+data+in+Activity+Edge+guards
- version_number: 1
...
Unless the attribute *Tcontrol* is used elsewhere, its only purpose in the Activity shown in the previous example is to pass the current temperature value from the operation call to the guards. In this case, a simpler way to provide this value to the guards is to make it the decision input value for the Decision Node. In the revised Activity shown below, the result of the operation call is now provided on an Output Pin of the first Action called *Tcurrent* (via the shortcut for [CONFLUENCE_PAGE title='Using Alf expressions in Opaque Actions' space='ALFP2024xR3']). This Output Pin is then connected to the Decision Node by an Object Flow, so the value on the Output Pin becomes the decision input value for the Decision Node. This value can then be accessed in the guard expressions using the name of the Output Pin.
...
<!--NOMAGIC_PAGE id=227179066 space=ALFP2024xR3 version=1 -->
## PAGE 00007: Address Book

- page_id: `227179066`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179066/Address+Book
- version_number: 1
...
To see the Alf code for an Operation of a Class, open the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window (select **Windows > Alf**) and select the Operation in the *Address Book* Class diagram. The Alf code for the Operation will then appear in the window.

[CONFLUENCE_PAGE title='Running a model with Alf' space='ALFP2024xR3']Executing the *TestAddressBook* Activity (using CST) exercises the functionality of the Address Book model. This activity should be run with the **Animation speed** slider set to its maximum (rightwards) position.

#### PANEL: Related Pages

Related Pages

[CONFLUENCE_PAGE title='Using Alf for Operation methods' space='ALFP2024xR3']

[CONFLUENCE_PAGE title='Running a model with Alf' space='ALFP2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>The Address Book sample includes a simple Class model in which the behaviors of Class Operations have been written in Alf. The model includes a Class diagram showing an <em>Address Book</em> Class that contains zero or more instances of an <em>Entry</em> Class.</p><p>To see the Alf code for an Operation of a Class, open the <ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[Alf editor]]></ac:plain-text-link-body></ac:link> window (select <strong>Windows &gt; Alf</strong>) and select the Operation in the <em>Address Book</em> Class diagram. The Alf code for the Operation will then appear in the window.</p><p><ac:link><ri:page ri:content-title="Running a model with Alf" ri:space-key="ALFP2024xR3" /><ac:link-body>Executing the <em>TestAddressBook</em> Activity (using CST)</ac:link-body></ac:link> exercises the functionality of the Address Book model. This activity should be run with the <strong>Animation speed</strong> slider set to its maximum (rightwards) position.</p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="1fb8a50c-3828-4dc8-b915-871e0191e946"><ac:parameter ac:name="title">Related Pages</ac:parameter><ac:rich-text-body><p><ac:link><ri:page ri:content-title="Using Alf for Operation methods" ri:space-key="ALFP2024xR3" /></ac:link></p><p><ac:link><ri:page ri:content-title="Running a model with Alf" ri:space-key="ALFP2024xR3" /></ac:link></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179170 space=ALFP2024xR3 version=1 -->
## PAGE 00008: Alf as scripting language

- page_id: `227179170`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179170/Alf+as+scripting+language
- version_number: 1
...
In the script editor window, the language must be set to "Alf Script". The scripting window has an automatic syntax and constraint check, the same as [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'][CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'].
...
<!--NOMAGIC_PAGE id=227179068 space=ALFP2024xR3 version=1 -->
## PAGE 00010: Alf project template

- page_id: `227179068`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179068/Alf+project+template
- version_number: 1
- version_date: `2023-07-26T13:43:53.071+02:00`
...
This tutorial describes how to create an Alf project containing a very simple "Hello World" activity that can be executed using Cameo Simulation Toolkit. (This Activity is similar to, but even simpler than, the one in the [CONFLUENCE_PAGE title='Hello' space='ALFP2024xR3'] sample model.)
...
````html
<p>This tutorial describes how to create an Alf project containing a very simple &quot;Hello World&quot; activity that can be executed using Cameo Simulation Toolkit. (This Activity is similar to, but even simpler than, the one in the <ac:link><ri:page ri:content-title="Hello" ri:space-key="ALFP2024xR3" /></ac:link> sample model.)</p><p>It consists of three steps:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="a6515c54-68bc-4dfb-819f-b794fa4b444d" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227179182 space=ALFP2024xR3 version=1 -->
## PAGE 00012: Alf Tutorial 2: Address Book

- page_id: `227179182`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179182/Alf+Tutorial+2+Address+Book
- version_number: 1
...
This tutorial describes how to create an Alf project containing a simple *Address Book* model, along with a test**Activity that can be executed using Cameo Simulation Toolkit. (This model is similar to, but even simpler than, the one in the [CONFLUENCE_PAGE title='Address Book' space='ALFP2024xR3'] sample model.)
...
<!--NOMAGIC_PAGE id=227179162 space=ALFP2024xR3 version=1 -->
## PAGE 00014: Building and cleaning

- page_id: `227179162`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179162/Building+and+cleaning
- version_number: 1
- version_date: `2023-07-26T13:43:57.001+02:00`
- ancestors: Alf Plugin Documentation > User Guide > Compiling Alf
- labels: []

### NORMALIZED CONTENT

As discussed in [CONFLUENCE_PAGE title='Dependency Management' space='ALFP2024xR3'], when you make changes within a model, the Alf compiler normally automatically processes any Alf code that might be affected by these changes. However, in some cases the Alf compiler may not have enough information to realize that a change in the model will correct an error in previously erroneous Alf code. Or, you may have turned off the [CONFLUENCE_PAGE title='Environment options' space='ALFP2024xR3']**Build Automatically** environment option, in which case the Alf compiler will mark elements needing recompilation without automatically recompiling them.
...
- **Build Project**[CONFLUENCE_PAGE title='Building and cleaning' space='ALFP2024xR3'] – A normal build triggers the recompilation of the Alf bodies of all model elements marked as having Alf compilation errors or otherwise needing to be recompiled.
- [CONFLUENCE_PAGE title='Building and cleaning' space='ALFP2024xR3'] – A clean build triggers the recompilation of all Alf code in your project, whether it is marked as needing recompilation or not.

##### build-projectBuild Project

To initiate a normal build of your project, select **Tools > Alf > Build Project**. If there are any elements in your project that are marked with either an Alf compilation error annotation or an Alf recompilation-needed warning annotation (see [CONFLUENCE_PAGE title='Dependency Management' space='ALFP2024xR3']), then the Alf bodies for these elements will be recompiled. Any previously erroneous Alf code that compiles successfully has its error annotation removed, while any code with new compilation errors has a new error annotation added. All recompilation-needed warning annotations are removed.
...
The figure below shows the error annotations caused by deleting the Association in the [CONFLUENCE_PAGE title='Address Book' space='ALFP2024xR3'] example and then recreating it as a new Association, so the error annotations remain (see also the discussion of this example in [CONFLUENCE_PAGE title='Dependency Management' space='ALFP2024xR3']). Selecting **Tools > Alf > Build Project** initiates an Alf build of the project, resulting in the successful recompilation of the indicated operations and the removal of the error annotations.
...
Compilation of template bindings in your Alf code result in the generation of instantiated Classes in the [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3']*$$Template Bindings* Package in your project. Over time, Classes in this Package may accumulate that are no longer necessary for your project. A clean rebuild first cleans out this Package, so, at the end of the build, it contains only the instantiations truly needed for the Alf code actually in your project. If your Alf code no longer has any template bindings, then the Package is removed entirely from your model.
...
<!--NOMAGIC_PAGE id=227179147 space=ALFP2024xR3 version=1 -->
## PAGE 00016: Checking the State of an object

- page_id: `227179147`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179147/Checking+the+State+of+an+object
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179151 space=ALFP2024xR3 version=1 -->
## PAGE 00017: Compiling Alf

- page_id: `227179151`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179151/Compiling+Alf
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179189 space=ALFP2024xR3 version=1 -->
## PAGE 00018: Creating AddressBook operations

- page_id: `227179189`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179189/Creating+AddressBook+operations
- version_number: 1
...
3. Click on the new put Operation, and, in the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window, press Create .
...
A project in which Alf is to be used should be created from the [CONFLUENCE_PAGE title='Alf project template' space='ALFP2024xR3'], to ensure that all necessary library models are included.
...
Next: [CONFLUENCE_PAGE title='Creating the Hello World activity' space='ALFP2024xR3']

#### PANEL: Related pages

Related pages

- [CONFLUENCE_PAGE title='Alf project template' space='ALFP2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>A project in which Alf is to be used should be created from the <ac:link><ri:page ri:content-title="Alf project template" ri:space-key="ALFP2024xR3" /></ac:link>, to ensure that all necessary library models are included.</p><p><br /></p><p>To create a new Alf project.</p><hr /><ol><li><p class="auto-cursor-target">Select<strong> File</strong> &gt; <strong>New Project</strong> on the main menu. The <strong>New Project</strong> dialog will open (see the following figure).</p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="AlfProjectTemplate-NewProject.png"><ri:page ri:content-title="Alf project template" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></p></li><li>On the bottom left, select <strong>Project from Template</strong> from the <strong>Other</strong> group (you may need to scroll down).</li><li>On the bottom right, under <strong>Select template</strong>, open the <strong>Alf</strong> folder and select <strong>Alf</strong>.</li><li>Enter the project name <em>Hello World </em>and a project location.</li><li>Click <strong>OK</strong>.</li></ol><p><br /></p><p>Next: <ac:link><ri:page ri:content-title="Creating the Hello World activity" ri:space-key="ALFP2024xR3" /></ac:link></p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="ab616d93-ccff-4934-9fd4-84182722ffde"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="Alf project template" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179187 space=ALFP2024xR3 version=1 -->
## PAGE 00020: Creating an Entry constructor

- page_id: `227179187`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179187/Creating+an+Entry+constructor
- version_number: 1
...
6. In the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'], type the statements shown in the following figure. [ATTACHMENT filename='Address_Book-Creating_Entry_Constructor.png']
...
Next: [CONFLUENCE_PAGE title='Creating AddressBook operations' space='ALFP2024xR3']
...
1. Create a new Alf project as described in [CONFLUENCE_PAGE title='Alf project template' space='ALFP2024xR3'] , using the name Address Book for the project.
...
Next: [CONFLUENCE_PAGE title='Creating Entry attributes' space='ALFP2024xR3']
...
2. In the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window, type *WriteLine("Hello World!");*``
...
Next: [CONFLUENCE_PAGE title='Running the Hello World activity' space='ALFP2024xR3']

#### PANEL: Related pages

Related pages

- [CONFLUENCE_PAGE title='Working with Alf' space='ALFP2024xR3']
  - [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3']
  - [CONFLUENCE_PAGE title='Using Alf to define Activities' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='Compiling Alf' space='ALFP2024xR3']
  - [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>To define a new activity using Alf, first the Activity needs to be created in the model, and then Alf code needs to be written for it and compiled.</p><p><br /></p><p>To create the <em>Hello World</em> Activity</p><hr /><ol><li>Right click on the root <em>Model</em> and select <strong>Create Element</strong> &gt; <strong>Activity</strong>.</li><li><p>Enter the name <em>Hello World</em>.</p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="Hello_World-Creating_Activity.png"><ri:page ri:content-title="Creating the Hello World activity" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></p></li></ol><p><br /></p><p>To create an Alf body for <em>Hello World</em></p><hr /><ol><li><p class="auto-cursor-target">Select the new Activity in the Model Browser and open the Alf editor window (select <strong>Windows &gt; Alf</strong>), if it isn't already open.</p></li><li><p class="auto-cursor-target">In the <ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[Alf editor]]></ac:plain-text-link-body></ac:link> window, type <em>WriteLine(&quot;Hello World!&quot;);</em><code> <br /></code></p></li><li>If there are any errors in your code, fix them.</li><li><p class="auto-cursor-target">When the code is entered correctly, click the <strong>Save</strong> button. The Alf code will be compiled into Activity Nodes and Edges within the selected Activity.<br /><br /><ac:image><ri:attachment ri:filename="Hello_World-Creating_Alf_Body.png"><ri:page ri:content-title="Creating the Hello World activity" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></p></li></ol><p><br /></p><p>Next: <ac:link><ri:page ri:content-title="Running the Hello World activity" ri:space-key="ALFP2024xR3" /></ac:link></p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="ba3cafe6-d881-42db-b28d-c9cc4b02bda0"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="Working with Alf" ri:space-key="ALFP2024xR3" /></ac:link><ul><li><ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /></ac:link></li><li class="confluence-link"><ac:link><ri:page ri:content-title="Using Alf to define Activities" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></li><li><ac:link><ri:page ri:content-title="Compiling Alf" ri:space-key="ALFP2024xR3" /></ac:link><ul><li><ac:link><ri:page ri:content-title="The Alf compiler" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></li></ul></ac:rich-text-body></ac:structured-macro><br /><p> </p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179202 space=ALFP2024xR3 version=1 -->
## PAGE 00024: Creating the StopWatch state machine

- page_id: `227179202`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179202/Creating+the+StopWatch+state+machine
- version_number: 1
...
First, use the [CONFLUENCE_PAGE title='Alf project template' space='ALFP2024xR3'] to create a new project called *StopWatch.*Next, define a stopwatch Class and its attributes using a Class diagram.
...
Next: [CONFLUENCE_PAGE title='Creating the StopWatch state machine' space='ALFP2024xR3']
...
Next: [CONFLUENCE_PAGE title='Running the Stopwatch model' space='ALFP2024xR3']
...
- [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='Using Alf for State Behaviors' space='ALFP2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>Next, add entry Behaviors to the <em>ready</em> and <em>running</em> States of the <em>StopWatch</em> State Machine.</p><p><br /></p><p>To add an entry Behavior to the <em>ready</em> State</p><hr /><ol><li>Click on the <em>ready</em> state and, in the Alf editor window, press <strong>Create</strong>.</li><li>Type the Alf code shown in the figure below.<br /><br /><ac:image ac:width="420"><ri:attachment ri:filename="Stopwatch-Creating_State_Entry_Body_ready.png"><ri:page ri:content-title="Defining the Ready and Running behaviors using Alf" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>When the code is correct, press <strong>Save</strong>. The Alf code should now appear in the entry Behavior for the <em>ready</em> State, as shown in the figure below.<br /><br /><ac:image ac:width="420"><ri:attachment ri:filename="Stopwatch-State_Entry_ready.png"><ri:page ri:content-title="Defining the Ready and Running behaviors using Alf" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></li></ol><p><span class="confluence-embedded-file-wrapper"><span><br /></span></span></p><p><span class="confluence-embedded-file-wrapper"><span>To add an entry Behavior to the <em>running</em> State</span></span></p><hr /><ol><li>Click on the running state and, in the Alf editor window, press <strong>Create</strong>.</li><li>Type the Alf code shown in the figure below.<br /><br /><ac:image ac:width="420"><ri:attachment ri:filename="Stopwatch-Creating_State_Entry_Body_running.png"><ri:page ri:content-title="Defining the Ready and Running behaviors using Alf" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></li><li><p class="auto-cursor-target">When the code is correct, press <strong>Save</strong>. The Alf code should now appear in the entry Behavior for the <em>running</em> State, as shown in the figure below.<span class="confluence-embedded-file-wrapper"><br /></span></p><p class="auto-cursor-target"><span class="confluence-embedded-file-wrapper"><span class="confluence-embedded-file-wrapper"><span><ac:image ac:width="420"><ri:attachment ri:filename="Stopwatch-State_Entry_running.png"><ri:page ri:content-title="Defining the Ready and Running behaviors using Alf" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></span></span></span></p></li></ol><p><span class="confluence-embedded-file-wrapper"><span><br /></span></span></p><p><span class="confluence-embedded-file-wrapper"><span>At this point the <em>StopWatch</em> has been completely modeled. You can now execute the <em>StopWatch</em> Class using Cameo Simulation Toolkit.</span></span></p><p><span class="confluence-embedded-file-wrapper"><span>Next: <ac:link><ri:page ri:content-title="Running the Stopwatch model" ri:space-key="ALFP2024xR3" /></ac:link><br /></span></span></p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="907c2efc-4efd-4508-9f8b-8242a5ec3f02"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Using Alf for State Behaviors" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179219 space=ALFP2024xR3 version=1 -->
## PAGE 00027: Defining the Stopwatch operations using Alf

- page_id: `227179219`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179219/Defining+the+Stopwatch+operations+using+Alf
- version_number: 1
...
3. While resetTime operation is selected, open the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window (select Windows > Alf ), if it isn't already open, and press Create .
...
3. Click on the *increaseTime* operation and, in the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window, press **Create**.
...
Next: [CONFLUENCE_PAGE title='Defining the Ready and Running behaviors using Alf' space='ALFP2024xR3']
...
- Build On Project Open – The default for this option is false, in which case, when a project with Alf code is opened, the Alf compiler parses all the code in the project in order to [CONFLUENCE_PAGE title='Dependency Management' space='ALFP2024xR3'] of the code on other model elements. Set this option to true to automatically perform a [CONFLUENCE_PAGE title='Building and cleaning' space='ALFP2024xR3'] on a project when it is open, which not only parses all the Alf code, but also recompiles it.
- Build Automatically – The default for this option is true, in which case the Alf compiler will automatically recompile Alf code whenever it may be necessary due to changes in model elements on which the code depends. Set this option to false to prevent automatic recompilation, in which case the Alf compiler will instead just mark elements having Alf code needing recompilation with [CONFLUENCE_PAGE title='Dependency Management' space='ALFP2024xR3'] .
...
````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p><em>Environment options</em> are options that you can set for your MagicDraw installation that apply across all the projects you create or open. The Alf plugin has two such options.</p><ul><li><strong>Build On Project Open</strong> – The default for this option is <em>false,</em> in which case, when a project with Alf code is opened, the Alf compiler parses all the code in the project in order to <ac:link><ri:page ri:content-title="Dependency Management" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[establish dependencies]]></ac:plain-text-link-body></ac:link> of the code on other model elements. Set this option to <em>true</em> to automatically perform a <ac:link ac:anchor="clean-project"><ri:page ri:content-title="Building and cleaning" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[clean build]]></ac:plain-text-link-body></ac:link> on a project when it is open, which not only parses all the Alf code, but also recompiles it.</li><li><strong>Build Automatically</strong> – The default for this option is <em>true,</em> in which case the Alf compiler will automatically recompile Alf code whenever it may be necessary due to changes in model elements on which the code depends. Set this option to <em>false</em> to prevent automatic recompilation, in which case the Alf compiler will instead just mark elements having Alf code needing recompilation with <ac:link ac:anchor="recompile"><ri:page ri:content-title="Dependency Management" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[warning annotations]]></ac:plain-text-link-body></ac:link>.</li></ul><p><br /></p><p>To access the Alf environment options</p><hr /><ol><li>Select <strong>Options &gt; Environment</strong> from the main menu</li><li>On the left-hand side, select the entry for <strong>Alf</strong>.</li><li>The Alf environment options appear on the right-hand side.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options-Alf_Options.png"><ri:page ri:content-title="Environment options" ri:space-key="ALFP2024xR3" /></ri:attachment></ac:image></li></ol></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="50b20bf8-eb4f-43c0-85de-cdf2f2ed8ebc"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="The Alf compiler" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Dependency Management" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Building and cleaning" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179057 space=ALFP2024xR3 version=1 -->
## PAGE 00030: Getting Started

- page_id: `227179057`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179057/Getting+Started
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179065 space=ALFP2024xR3 version=1 -->
## PAGE 00031: Hello

- page_id: `227179065`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179065/Hello
- version_number: 1
...
Both these activities were compiled from Alf. To see the original Alf code, open the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window (select **Window > Alf**) and select either activity. The Alf code will appear in the window.

When [CONFLUENCE_PAGE title='Running a model with Alf' space='ALFP2024xR3'], the *Hello World* should write "Hello World!" in the console pane of the simulation window.
...
- [CONFLUENCE_PAGE title='Checking the State of an object' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='Checking a visited State' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='Accessing current simulation time' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='Accessing the simulation time unit' space='ALFP2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>Cameo Simulation Toolkit provides an Action Language Helper (ALH) API for accessing executing models. Many of the capabilities in this API are natively available as part of the Alf language (such as reading and writing structural feature values, sending signals, etc.). However, the API also provides some additional functionality that is not covered by the Alf language itself, but can still be used from Alf code. The Alf <em>Helper Functions</em> provide access to this functionality, including checking if an object currently is or previously was in a given state and accessing the current simulation time and simulation time unit.</p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="281b1859-6448-4a1e-9f31-059a9aa33d9a"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="Checking the State of an object" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Checking a visited State" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Accessing current simulation time" ri:space-key="ALFP2024xR3" /></ac:link></li><li><ac:link><ri:page ri:content-title="Accessing the simulation time unit" ri:space-key="ALFP2024xR3" /></ac:link></li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179168 space=ALFP2024xR3 version=1 -->
## PAGE 00033: Importing Alf

- page_id: `227179168`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179168/Importing+Alf
- version_number: 1
- version_date: `2023-07-26T13:43:57.376+02:00`
- ancestors: Alf Plugin Documentation > User Guide
- labels: []
...
If you have projects open, and you want to import Alf into a new project, but don't want to close the currently open projects, then first use **File > New Project** to create a [CONFLUENCE_PAGE title='Alf project template' space='ALFP2024xR3'], and import the Alf file into that, as above.
...
The Alf Plugin of the current version requires that [Cameo Simulation Toolkit](https://docs.nomagic.com/display/CST2024xR3/Installation+and+licensing) of the current version is already installed.
...
<!--NOMAGIC_PAGE id=227179058 space=ALFP2024xR3 version=2 -->
## PAGE 00035: Introduction

- page_id: `227179058`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179058/Introduction
- version_number: 2
- version_date: `2025-05-06T15:24:13.146+02:00`
- ancestors: Alf Plugin Documentation > User Guide > Getting Started
- labels: []
...
[CONFLUENCE_PAGE title='Using Alf for classifier behaviors' space='ALFP2024xR3']
...
3. Click on Test , and open the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window (select Windows > Alf ), if it isn't already open [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3']
...
When you delete the code for a template binding with an Alf body, the instantiated class generated from that Alf code is *not* automatically deleted from the *$$Template Bindings* package, since that class might also be referenced elsewhere in your model. Thus, if you use templates in your Alf code, it is possible, over time, for the *$$Template Bindings* package to accumulate contents that are no longer useful. If necessary, this can be cleaned up by doing a *[CONFLUENCE_PAGE title='Building and cleaning' space='ALFP2024xR3']* of your project.
...
<!--NOMAGIC_PAGE id=227179056 space=ALFP2024xR3 version=1 -->
## PAGE 00046: User Guide

- page_id: `227179056`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179056/User+Guide
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179130 space=ALFP2024xR3 version=1 -->
## PAGE 00047: Using Alf expressions in Opaque Actions

- page_id: `227179130`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179130/Using+Alf+expressions+in+Opaque+Actions
- version_number: 1
- version_date: `2023-07-26T13:43:55.606+02:00`
...
You can use the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf Expression for the guard for an Activity Edge (Object Flow or Control Flow) in an Activity or to edit an existing guard Expression.
...
- [CONFLUENCE_PAGE title='Accessing data in Activity Edge guards' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3']
- [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3']
...
In UML, the behavior of an Operation of a Class can be defined using a Behavior element called the *method* of the Operation. You can use the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf body for a new Operation method or to edit the existing Alf body of a method.
...
- Select the Operation in the Model Browser or on a Class diagram and open the Alf editor window (select **Windows > Alf**), if it isn't already open. The existing Alf code will appear in the window. The Alf code for an Operation is actually stored as the Alf body of the method Behavior of the Operation (which is an Activity or Opaque Behavior, as created above). It is therefore possible to directly the edit the code on the method Behavior (as described in [CONFLUENCE_PAGE title='Using Alf to define Behaviors' space='ALFP2024xR3']), but it is usually easier to act directly on the Operation. [IMAGE alt='' src='']
...
You can use the[CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf body for a new default value for a Property (e.g., the attribute of a Class) or to edit the existing Alf body of a Property. The Alf expression for a default value is stored as the the body of an Opaque Expression with the language *Alf.* Compiling this Alf code results in the creation of an executable Activity that returns the value of the Alf expression. This Activity is linked to the Opaque Expression as its the **Behavior** property. (See also the discussion on [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3'])
...
4. Enter the Alf code for the Behavior and press **Save** to compile and save it. The Alf code for a State Behavior can access attribute values of the context Classifier of the State Machine containing its State (using Alf *this* expressions). It can also [CONFLUENCE_PAGE title='Accessing Event data' space='ALFP2024xR3'] in the Event occurrence that triggered its execution (e.g., the attribute data of a received Signal).
...
You can use the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf body for the effect Behavior of a Transition in a State Machine or to edit the existing Alf body of an effect Behavior.
...
4. Enter the Alf code for the Behavior and press **Save** to compile and save it. The Alf code for an effect Behavior can access attribute values of the context Classifier of the State Machine containing its Transition (using Alf *this* expressions). It can also [CONFLUENCE_PAGE title='Accessing Event data' space='ALFP2024xR3'] in the Event occurrence that triggered its execution (e.g., the attribute data of a received Signal).
...
[IMAGE alt='' src=''] Even while you are editing an existing effect Behavior, the **Create** button stays active if the Transition does not have a guard. Press **Create** in order to [CONFLUENCE_PAGE title='Using Alf for Transition guard Expressions' space='ALFP2024xR3'] on the Transaction.
...
You can use the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf Expression for the guard of a Transition in a State Machine or to edit an existing guard Expression.
...
[CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] may be used to create an Alf body for a new Opaque Behavior or to edit the existing Alf body of an Opaque Behavior. The Alf code for an Opaque Behavior is stored as the body of the Opaque Behavior with the language *Alf.* Compiling this Alf code results in the creation of an executable Activity reflecting the behavior defined by the Alf code. This Activity is attached to the Opaque Behavior as a tagged value of the special *CompiledRepresentation* stereotype. (See also the discussion on [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3'].)
...
You can use the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] to create an Alf body for a new Activity or to edit the existing Alf body of an Activity. Compiling the Alf body of an Activity results in the generation of Activity Nodes and Activity Edges within the Activity. Executing the Activity then has the behavior specified by the original Alf code. The Alf code itself is stored in a Comment owned by the Activity, which has the *TextualRepresentation* stereotype applied. Normally, you should not modify any of the contents of an Activity with an Alf body, other than by editing its Alf code using the Alf editor. (See also the discussion on [CONFLUENCE_PAGE title='The Alf compiler' space='ALFP2024xR3'].)
...
Two kinds of UML Behaviors may directly have Alf bodies: Activities and Opaque Behaviors. You can edit the Alf body of either kind of Behavior using the [CONFLUENCE_PAGE title='The Alf editor' space='ALFP2024xR3'] window. You can also edit the body of an Opaque Behavior directly through its Specification.
...
````html
<ac:layout><ac:layout-section ac:type="two_right_sidebar"><ac:layout-cell><p>Two kinds of UML Behaviors may directly have Alf bodies: Activities and Opaque Behaviors. You can edit the Alf body of either kind of Behavior using the <ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /><ac:plain-text-link-body><![CDATA[Alf editor]]></ac:plain-text-link-body></ac:link> window. You can also edit the body of an Opaque Behavior directly through its Specification.</p></ac:layout-cell><ac:layout-cell><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="84c985ab-3b45-44f7-9694-49aa4e05bd62"><ac:parameter ac:name="title">Related pages</ac:parameter><ac:rich-text-body><ul><li><ac:link><ri:page ri:content-title="The Alf editor" ri:space-key="ALFP2024xR3" /></ac:link></li></ul><p style="margin-left: 30.0px;"><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="5222eb93-7cd5-4535-a41e-dc3e7b04f20d" /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227179070 space=ALFP2024xR3 version=1 -->
## PAGE 00062: Working with Alf

- page_id: `227179070`
- space_key: `ALFP2024xR3`
- source_url: https://docs.nomagic.com/spaces/ALFP2024xR3/pages/227179070/Working+with+Alf
- version_number: 1
