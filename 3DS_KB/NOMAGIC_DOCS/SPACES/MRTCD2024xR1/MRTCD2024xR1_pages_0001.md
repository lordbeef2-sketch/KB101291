# NOMAGIC DOCUMENTATION SPACE: Magic Real-Time Communication Designer 2024x Refresh1

<!--NOMAGIC_SPACE key=MRTCD2024xR1 chunk=1 -->

<!--NOMAGIC_PAGE id=170465011 space=MRTCD2024xR1 version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `170465011`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465011/Applying+DDS+Sterotypes
- version_number: 1
...
First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='MRTCD2024xR1']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='MRTCD2024xR1']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024xR1']>]]>
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024xR1'] 
[IMAGE alt='' src='']
...
<!--NOMAGIC_PAGE id=170465021 space=MRTCD2024xR1 version=1 -->
## PAGE 00008: Domain Participant without Instance

- page_id: `170465021`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465021/Domain+Participant+without+Instance
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465022 space=MRTCD2024xR1 version=1 -->
## PAGE 00009: Duplicate Domain ID

- page_id: `170465022`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465022/Duplicate+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465023 space=MRTCD2024xR1 version=1 -->
## PAGE 00010: Endpoint not Referenced

- page_id: `170465023`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465023/Endpoint+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465003 space=MRTCD2024xR1 version=1 -->
## PAGE 00011: Environment setup

- page_id: `170465003`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465003/Environment+setup
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465009 space=MRTCD2024xR1 version=1 -->
## PAGE 00012: Example Model

- page_id: `170465009`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465009/Example+Model
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465018 space=MRTCD2024xR1 version=1 -->
## PAGE 00013: Exporting DDS Control Example to XML

- page_id: `170465018`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465018/Exporting+DDS+Control+Example+to+XML
- version_number: 1
...
<!--NOMAGIC_PAGE id=170464989 space=MRTCD2024xR1 version=1 -->
## PAGE 00014: Exporting DDS XML

- page_id: `170464989`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464989/Exporting+DDS+XML
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465008 space=MRTCD2024xR1 version=1 -->
## PAGE 00017: Home Control Example

- page_id: `170465008`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465008/Home+Control+Example
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465024 space=MRTCD2024xR1 version=1 -->
## PAGE 00018: Illegal Inheritance

- page_id: `170465024`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465024/Illegal+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=170464965 space=MRTCD2024xR1 version=1 -->
## PAGE 00019: Importing DDS Profile and DDS Style in Other Projects

- page_id: `170464965`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464965/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='MRTCD2024xR1'] to import them.
...
<!--NOMAGIC_PAGE id=170465002 space=MRTCD2024xR1 version=1 -->
## PAGE 00023: Install for simulation

- page_id: `170465002`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465002/Install+for+simulation
- version_number: 1
...
<!--NOMAGIC_PAGE id=170464960 space=MRTCD2024xR1 version=2 -->
## PAGE 00024: Installation

- page_id: `170464960`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464960/Installation
- version_number: 2
- version_date: `2024-05-09T14:26:20.754+02:00`
- ancestors: Magic Real-Time Communication Designer
...
1. Install [CONFLUENCE_PAGE title='Installation, Licensing, and System Requirements Documentation' space='IL2024xR1'] .
2. Install [CONFLUENCE_PAGE title='Installation, Licensing, and System Requirements Documentation' space='IL2024xR1'] .
3. Start MagicDraw.
...
<!--NOMAGIC_PAGE id=170465027 space=MRTCD2024xR1 version=1 -->
## PAGE 00026: Invalid Member Multiplicity

- page_id: `170465027`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465027/Invalid+Member+Multiplicity
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465028 space=MRTCD2024xR1 version=1 -->
## PAGE 00027: Invalid Member Type

- page_id: `170465028`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465028/Invalid+Member+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465029 space=MRTCD2024xR1 version=1 -->
## PAGE 00028: Invalid Port Type

- page_id: `170465029`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465029/Invalid+Port+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465030 space=MRTCD2024xR1 version=1 -->
## PAGE 00029: Invalid Repository

- page_id: `170465030`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465030/Invalid+Repository
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465031 space=MRTCD2024xR1 version=1 -->
## PAGE 00030: Invalid Topic Type Property Direction

- page_id: `170465031`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465031/Invalid+Topic+Type+Property+Direction
- version_number: 1
...
<!--NOMAGIC_PAGE id=170464958 space=MRTCD2024xR1 version=3 -->
## PAGE 00031: Magic Real-Time Communication Designer

- page_id: `170464958`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464958/Magic+Real-Time+Communication+Designer
- version_number: 3
- version_date: `2025-05-06T15:03:45.449+02:00`
- ancestors: 
...
<!--NOMAGIC_PAGE id=170465032 space=MRTCD2024xR1 version=1 -->
## PAGE 00032: Missing Domain Attribute

- page_id: `170465032`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465032/Missing+Domain+Attribute
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465033 space=MRTCD2024xR1 version=1 -->
## PAGE 00033: Missing Domain ID

- page_id: `170465033`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465033/Missing+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465034 space=MRTCD2024xR1 version=1 -->
## PAGE 00034: Missing Element Name

- page_id: `170465034`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465034/Missing+Element+Name
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465035 space=MRTCD2024xR1 version=1 -->
## PAGE 00035: Multiple Struct Inheritance

- page_id: `170465035`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465035/Multiple+Struct+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465036 space=MRTCD2024xR1 version=1 -->
## PAGE 00036: Multitype Topic

- page_id: `170465036`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465036/Multitype+Topic
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465037 space=MRTCD2024xR1 version=1 -->
## PAGE 00037: Non-Nmeric Domain ID

- page_id: `170465037`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465037/Non-Nmeric+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465038 space=MRTCD2024xR1 version=1 -->
## PAGE 00038: Participant Type not Referenced

- page_id: `170465038`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465038/Participant+Type+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465016 space=MRTCD2024xR1 version=1 -->
## PAGE 00039: Qos Assignments

- page_id: `170465016`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465016/Qos+Assignments
- version_number: 1
...
The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='MRTCD2024xR1']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="Qos Assignments" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=170464983 space=MRTCD2024xR1 version=1 -->
## PAGE 00040: QoS profile assignments

- page_id: `170464983`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464983/QoS+profile+assignments
- version_number: 1
...
````html
<p class="FirstParagraph">There are three elements that QoS Profiles can be assigned to in the model:</p><ul><li class="FirstParagraph">Endpoints typed by Topic.</li><li class="FirstParagraph">DomainParticipants.</li><li class="FirstParagraph">Topics.</li></ul><p><br /></p><p>To create an empty Endpoint QoS Assignment Table</p><hr /><ol><li>In the <a href="https://docs.nomagic.com/display/MD2021xR2/Containment+tab">Containment tree</a>, right-click a predefined <em>Endpoint QoS </em>Package.</li><li>From the shortcut menu, select <strong>Create Diagram </strong>and from the opened dialog, select Endpoint QoS Assignment Table.</li><li>The unnamed table is created. Type its name and press enter.</li></ol><p><br /></p><p>To fill in the Endpoint QoS Assignment Table</p><hr /><ol><li>From the table toolbar, click the <strong>Add New</strong> button. The new row appears and Endpoint QoS Assignment element is created in the model.</li><li><p class="auto-cursor-target">In the table, specify the following:<br /> - Double-click the <strong>Name</strong> cell and type Endpoint QoS Assignment name.<br /> - Double-click the <strong>QoS Profile</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Elements</strong> dialog choose QoS Profile.<br /> - Double-click the <strong>Endpoint</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Port </strong>dialog choose already created ports or use the <strong>Creation Mode</strong> to create new port.<br /> - Double-click the <strong>Domain Participant Instance</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Property </strong>dialog choose already created Part Properties or use the <strong>Creation Mode</strong> to create new Part Property.</p></li></ol><p class="FirstParagraph"><span><br /></span></p><p class="FirstParagraph"><span>Assigning QoS on subscribers/publishers is not possible since they are derived from the model and not explicitly marked.</span></p><ul><li>To assign QoS Profiles on Topics create a Topic QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="topic_qos_assignemnt_table_example.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Domain Participants create a Participant QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="participant_qos_assignment.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Endpoints create a Endpoint QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="endpoint_Qos_assignment_table.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li></ul>
````

<!--NOMAGIC_PAGE id=170465006 space=MRTCD2024xR1 version=1 -->
## PAGE 00041: Setting up the Simulink model

- page_id: `170465006`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465006/Setting+up+the+Simulink+model
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465001 space=MRTCD2024xR1 version=1 -->
## PAGE 00042: Simulation with Simulink

- page_id: `170465001`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465001/Simulation+with+Simulink
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465039 space=MRTCD2024xR1 version=1 -->
## PAGE 00043: Struct Member Visibility

- page_id: `170465039`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465039/Struct+Member+Visibility
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465040 space=MRTCD2024xR1 version=1 -->
## PAGE 00044: Topic Missing from Domain

- page_id: `170465040`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465040/Topic+Missing+from+Domain
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465007 space=MRTCD2024xR1 version=1 -->
## PAGE 00045: Type mapping

- page_id: `170465007`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465007/Type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465041 space=MRTCD2024xR1 version=1 -->
## PAGE 00046: Unspecified String Bounds

- page_id: `170465041`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465041/Unspecified+String+Bounds
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465042 space=MRTCD2024xR1 version=1 -->
## PAGE 00047: Unspecified String Bounds of Map Key

- page_id: `170465042`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465042/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
...
<!--NOMAGIC_PAGE id=170465043 space=MRTCD2024xR1 version=1 -->
## PAGE 00048: Unsupported Discriminator Type

- page_id: `170465043`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465043/Unsupported+Discriminator+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=170464999 space=MRTCD2024xR1 version=1 -->
## PAGE 00049: Validation

- page_id: `170464999`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170464999/Validation
- version_number: 1
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='MRTCD2024xR1'].
...
````html
<p class="FirstParagraph"><span lang="EN">The validity of the DDS model is continuously checked by active validation rules contained in the DDS Validation Suite. For example, if you accidentally add multiple attributes to a Topic, an error is displayed. You can fix some of these DDS modeling problems by right-clicking on them and selecting the appropriate solver.</span></p><p class="FirstParagraph"><span lang="EN"><ac:image><ri:attachment ri:filename="image2020-11-12_15-7-35.png"><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="Validation" /></ri:attachment></ac:image></span></p><p class="FirstParagraph"><br /></p><p class="FirstParagraph"><span lang="EN"><span><span>There is a separate validation suite for Simulink named DDS Simulink Validation Suite. It contains validation rules for data types that are not supported by Simulink. It can be activated independently from the rest of the rules.</span></span></span></p><p>The detailed descriptions of the validation rules are available in <ac:link><ri:page ri:space-key="MRTCD2024xR1" ri:content-title="Validation Suite" /></ac:link>.</p><p><br /></p><p><ac:link><ri:page ri:space-key="MD2021xR2" ri:content-title="Validation" /><ac:plain-text-link-body><![CDATA[Learn more about Validation >>]]></ac:plain-text-link-body></ac:link></p><p>.</p><p class="FirstParagraph"><span lang="EN"><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=170465019 space=MRTCD2024xR1 version=1 -->
## PAGE 00050: Validation Suite

- page_id: `170465019`
- space_key: `MRTCD2024xR1`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR1/pages/170465019/Validation+Suite
- version_number: 1
