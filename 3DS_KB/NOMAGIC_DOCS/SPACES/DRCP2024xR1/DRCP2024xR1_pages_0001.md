# NOMAGIC DOCUMENTATION SPACE: DDS Real-Time Communication Plugin 2024x Refresh1

<!--NOMAGIC_SPACE key=DRCP2024xR1 chunk=1 -->

<!--NOMAGIC_PAGE id=170464916 space=DRCP2024xR1 version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `170464916`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464916/Applying+DDS+Sterotypes
- version_number: 1
- version_date: `2023-09-22T12:23:34.242+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []

### NORMALIZED CONTENT

First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='DRCP2024xR1']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='DRCP2024xR1']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024xR1']>]]>
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2022xR2'] , right-click a Package wherein you want to create Domain Participants or Domain.
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2022xR2'] , right-click a predefined Domain Package.
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='DRCP2024xR1'] 
[IMAGE alt='' src='']
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2022xR2'] , right-click a Block which will be the owner of the instances.
2. From the shortcut menu, select Create Diagram and from the opened dialog, select SysML Internal Block Diagram.
3. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] select a property (e.g. Part Property) and click on the diagram pane.
...
1. Double-click the Part Property to open it's [CONFLUENCE_PAGE title='Specification window' space='MD2022xR2'] .
...
1. In the [CONFLUENCE_PAGE title='Model Browser' space='MD2022xR2'] , select the owner for the new diagram.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] , select a type you need and click on DDS Module element.
2. Type its name.
3. Click the Create Member [CONFLUENCE_PAGE title='Smart manipulators' space='MD2022xR2'] to create a Members for the type.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] , select a Topic and click on the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] .
2. Type its name.
3. Click the Create Element [CONFLUENCE_PAGE title='Smart manipulators' space='MD2022xR2'] to create a Topic Type Property or Reception for the Topic.
...
<!--NOMAGIC_PAGE id=170464926 space=DRCP2024xR1 version=1 -->
## PAGE 00009: Domain Participant without Instance

- page_id: `170464926`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464926/Domain+Participant+without+Instance
- version_number: 1
- version_date: `2023-09-22T12:23:34.554+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464927 space=DRCP2024xR1 version=1 -->
## PAGE 00010: Duplicate Domain ID

- page_id: `170464927`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464927/Duplicate+Domain+ID
- version_number: 1
- version_date: `2023-09-22T12:23:34.605+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464928 space=DRCP2024xR1 version=1 -->
## PAGE 00011: Endpoint not Referenced

- page_id: `170464928`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464928/Endpoint+not+Referenced
- version_number: 1
- version_date: `2023-09-22T12:23:34.663+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464908 space=DRCP2024xR1 version=1 -->
## PAGE 00012: Environment setup

- page_id: `170464908`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464908/Environment+setup
- version_number: 1
- version_date: `2023-09-22T12:23:33.955+02:00`
- ancestors: DDS Real-Time Communication Plugin > Simulation with Simulink
- labels: []
...
<!--NOMAGIC_PAGE id=170464914 space=DRCP2024xR1 version=1 -->
## PAGE 00013: Example Model

- page_id: `170464914`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464914/Example+Model
- version_number: 1
- version_date: `2023-09-22T12:23:34.147+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []
...
<!--NOMAGIC_PAGE id=170464923 space=DRCP2024xR1 version=2 -->
## PAGE 00014: Exporting DDS Control Example to XML

- page_id: `170464923`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464923/Exporting+DDS+Control+Example+to+XML
- version_number: 2
- version_date: `2024-05-08T13:33:21.048+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []

### NORMALIZED CONTENT

You can export the DDS examples to XML. For this, follow the procedures provided in the page [Exporting DDS XML](https://docs.nomagic.com/display/DRCP2024xR1/Exporting+DDS+XML).

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can export the DDS examples to XML. For this, follow the procedures provided in the page <a class="current" style="letter-spacing: 0.0px;" href="https://docs.nomagic.com/display/DRCP2024xR1/Exporting+DDS+XML">Exporting DDS XML</a>.</p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=170464894 space=DRCP2024xR1 version=1 -->
## PAGE 00015: Exporting DDS XML

- page_id: `170464894`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464894/Exporting+DDS+XML
- version_number: 1
- version_date: `2023-09-22T12:23:33.620+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] , select Tools > DDS > Generate DDS XML .
...
<!--NOMAGIC_PAGE id=170464913 space=DRCP2024xR1 version=1 -->
## PAGE 00018: Home Control Example

- page_id: `170464913`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464913/Home+Control+Example
- version_number: 1
- version_date: `2023-09-22T12:23:34.113+02:00`
- ancestors: DDS Real-Time Communication Plugin
- labels: []
...
<!--NOMAGIC_PAGE id=170464929 space=DRCP2024xR1 version=1 -->
## PAGE 00019: Illegal Inheritance

- page_id: `170464929`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464929/Illegal+Inheritance
- version_number: 1
- version_date: `2023-09-22T12:23:34.719+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464870 space=DRCP2024xR1 version=1 -->
## PAGE 00020: Importing DDS Profile and DDS Style in Other Projects

- page_id: `170464870`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464870/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
- version_date: `2023-09-22T12:23:33.269+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] , select Tools > DDS > Import DDS XML.
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='DRCP2024xR1'] to import them.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2022xR2'] , select Tools > DDS > Import QoS Profile .
...
<!--NOMAGIC_PAGE id=170464907 space=DRCP2024xR1 version=1 -->
## PAGE 00024: Install for simulation

- page_id: `170464907`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464907/Install+for+simulation
- version_number: 1
- version_date: `2023-09-22T12:23:33.912+02:00`
- ancestors: DDS Real-Time Communication Plugin > Simulation with Simulink
- labels: []
...
<!--NOMAGIC_PAGE id=170464865 space=DRCP2024xR1 version=1 -->
## PAGE 00025: Installation

- page_id: `170464865`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464865/Installation
- version_number: 1
- version_date: `2023-09-22T12:23:33.125+02:00`
- ancestors: DDS Real-Time Communication Plugin
...
1. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='MD2022xR2'] .
2. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='SYSMLP2022xR2'] .
3. Start MagicDraw.
...
<!--NOMAGIC_PAGE id=170464863 space=DRCP2024xR1 version=1 -->
## PAGE 00027: Introduction

- page_id: `170464863`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464863/Introduction
- version_number: 1
- version_date: `2023-09-22T12:23:33.093+02:00`
- ancestors: 
- labels: []
...
````html
<p class="FirstParagraph">The Connext DDS for MagicDraw plugin is an environment for editing <a href="https://www.rti.com/products/connext-dds-professional">Connext DDS</a> models in a visual way.</p><h3><strong>Background</strong></h3><p class="FirstParagraph">The OMG Data-Distribution Service for Real-Time Systems (DDS) is the first open international middleware standard directly addressing publish-subscribe communications for real-time and embedded systems.</p><p>RTI Connext DDS Professional, based on a connectivity databus, offers a robust framework for developing and integrating mission critical systems. It is fully compliant with the OMG DDS for Real-Time Systems standard.</p><h3>Advantages</h3><p class="FirstParagraph">With the Connext DDS for MagicDraw plugin, you can model the DDS-related aspects of your system using UML, extended by a DDS-specific profile. This offers the following advantages:</p><ul><li>The overall system (from requirements to functional applications) will have a unified representation, providing a common view of the system and a single source of truth.</li><li>You can use an already familiar modeling language.</li><li>The DDS entities and their relationships are displayed visually in a graphical notation.</li></ul>
````

<!--NOMAGIC_PAGE id=170464932 space=DRCP2024xR1 version=1 -->
## PAGE 00028: Invalid Member Multiplicity

- page_id: `170464932`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464932/Invalid+Member+Multiplicity
- version_number: 1
- version_date: `2023-09-22T12:23:34.869+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464933 space=DRCP2024xR1 version=1 -->
## PAGE 00029: Invalid Member Type

- page_id: `170464933`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464933/Invalid+Member+Type
- version_number: 1
- version_date: `2023-09-22T12:23:34.938+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464934 space=DRCP2024xR1 version=1 -->
## PAGE 00030: Invalid Port Type

- page_id: `170464934`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464934/Invalid+Port+Type
- version_number: 1
- version_date: `2023-09-22T12:23:34.996+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464935 space=DRCP2024xR1 version=1 -->
## PAGE 00031: Invalid Repository

- page_id: `170464935`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464935/Invalid+Repository
- version_number: 1
- version_date: `2023-09-22T12:23:35.048+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464936 space=DRCP2024xR1 version=1 -->
## PAGE 00032: Invalid Topic Type Property Direction

- page_id: `170464936`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464936/Invalid+Topic+Type+Property+Direction
- version_number: 1
- version_date: `2023-09-22T12:23:35.092+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464937 space=DRCP2024xR1 version=1 -->
## PAGE 00033: Missing Domain Attribute

- page_id: `170464937`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464937/Missing+Domain+Attribute
- version_number: 1
- version_date: `2023-09-22T12:23:35.136+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464938 space=DRCP2024xR1 version=1 -->
## PAGE 00034: Missing Domain ID

- page_id: `170464938`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464938/Missing+Domain+ID
- version_number: 1
- version_date: `2023-09-22T12:23:35.187+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464939 space=DRCP2024xR1 version=1 -->
## PAGE 00035: Missing Element Name

- page_id: `170464939`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464939/Missing+Element+Name
- version_number: 1
- version_date: `2023-09-22T12:23:35.243+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464940 space=DRCP2024xR1 version=1 -->
## PAGE 00036: Multiple Struct Inheritance

- page_id: `170464940`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464940/Multiple+Struct+Inheritance
- version_number: 1
- version_date: `2023-09-22T12:23:35.299+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464941 space=DRCP2024xR1 version=1 -->
## PAGE 00037: Multitype Topic

- page_id: `170464941`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464941/Multitype+Topic
- version_number: 1
- version_date: `2023-09-22T12:23:35.346+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464942 space=DRCP2024xR1 version=1 -->
## PAGE 00038: Non-Nmeric Domain ID

- page_id: `170464942`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464942/Non-Nmeric+Domain+ID
- version_number: 1
- version_date: `2023-09-22T12:23:35.398+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464943 space=DRCP2024xR1 version=1 -->
## PAGE 00039: Participant Type not Referenced

- page_id: `170464943`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464943/Participant+Type+not+Referenced
- version_number: 1
- version_date: `2023-09-22T12:23:35.454+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464921 space=DRCP2024xR1 version=1 -->
## PAGE 00040: Qos Assignments

- page_id: `170464921`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464921/Qos+Assignments
- version_number: 1
- version_date: `2023-09-22T12:23:34.362+02:00`
- ancestors: DDS Real-Time Communication Plugin > Home Control Example
- labels: []

### NORMALIZED CONTENT

The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='DRCP2024xR1']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="Qos Assignments" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=170464888 space=DRCP2024xR1 version=1 -->
## PAGE 00041: QoS profile assignments

- page_id: `170464888`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464888/QoS+profile+assignments
- version_number: 1
- version_date: `2023-09-22T12:23:33.543+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
...
````html
<p class="FirstParagraph">There are three elements that QoS Profiles can be assigned to in the model:</p><ul><li class="FirstParagraph">Endpoints typed by Topic.</li><li class="FirstParagraph">DomainParticipants.</li><li class="FirstParagraph">Topics.</li></ul><p><br /></p><p>To create an empty Endpoint QoS Assignment Table</p><hr /><ol><li>In the <a href="https://docs.nomagic.com/display/MD2022xR2/Containment+tab">Containment tree</a>, right-click a predefined <em>Endpoint QoS </em>Package.</li><li>From the shortcut menu, select <strong>Create Diagram </strong>and from the opened dialog, select Endpoint QoS Assignment Table.</li><li>The unnamed table is created. Type its name and press enter.</li></ol><p><br /></p><p>To fill in the Endpoint QoS Assignment Table</p><hr /><ol><li>From the table toolbar, click the <strong>Add New</strong> button. The new row appears and Endpoint QoS Assignment element is created in the model.</li><li><p class="auto-cursor-target">In the table, specify the following:<br /> - Double-click the <strong>Name</strong> cell and type Endpoint QoS Assignment name.<br /> - Double-click the <strong>QoS Profile</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Elements</strong> dialog choose QoS Profile.<br /> - Double-click the <strong>Endpoint</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Port </strong>dialog choose already created ports or use the <strong>Creation Mode</strong> to create new port.<br /> - Double-click the <strong>Domain Participant Instance</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Property </strong>dialog choose already created Part Properties or use the <strong>Creation Mode</strong> to create new Part Property.</p></li></ol><p class="FirstParagraph"><span><br /></span></p><p class="FirstParagraph"><span>Assigning QoS on subscribers/publishers is not possible since they are derived from the model and not explicitly marked.</span></p><ul><li>To assign QoS Profiles on Topics create a Topic QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="topic_qos_assignemnt_table_example.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Domain Participants create a Participant QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="participant_qos_assignment.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Endpoints create a Endpoint QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="endpoint_Qos_assignment_table.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li></ul>
````

<!--NOMAGIC_PAGE id=170464911 space=DRCP2024xR1 version=1 -->
## PAGE 00042: Setting up the Simulink model

- page_id: `170464911`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464911/Setting+up+the+Simulink+model
- version_number: 1
- version_date: `2023-09-22T12:23:34.038+02:00`
- ancestors: DDS Real-Time Communication Plugin > Simulation with Simulink
- labels: []
...
<!--NOMAGIC_PAGE id=170464906 space=DRCP2024xR1 version=1 -->
## PAGE 00043: Simulation with Simulink

- page_id: `170464906`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464906/Simulation+with+Simulink
- version_number: 1
- version_date: `2023-09-22T12:23:33.879+02:00`
- ancestors: DDS Real-Time Communication Plugin
- labels: []
...
<!--NOMAGIC_PAGE id=170464944 space=DRCP2024xR1 version=1 -->
## PAGE 00044: Struct Member Visibility

- page_id: `170464944`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464944/Struct+Member+Visibility
- version_number: 1
- version_date: `2023-09-22T12:23:35.509+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464945 space=DRCP2024xR1 version=1 -->
## PAGE 00045: Topic Missing from Domain

- page_id: `170464945`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464945/Topic+Missing+from+Domain
- version_number: 1
- version_date: `2023-09-22T12:23:35.568+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464912 space=DRCP2024xR1 version=1 -->
## PAGE 00046: Type mapping

- page_id: `170464912`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464912/Type+mapping
- version_number: 1
- version_date: `2023-09-22T12:23:34.074+02:00`
- ancestors: DDS Real-Time Communication Plugin > Simulation with Simulink
- labels: []
...
<!--NOMAGIC_PAGE id=170464946 space=DRCP2024xR1 version=1 -->
## PAGE 00047: Unspecified String Bounds

- page_id: `170464946`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464946/Unspecified+String+Bounds
- version_number: 1
- version_date: `2023-09-22T12:23:35.654+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464947 space=DRCP2024xR1 version=1 -->
## PAGE 00048: Unspecified String Bounds of Map Key

- page_id: `170464947`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464947/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
- version_date: `2023-09-22T12:23:35.741+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464948 space=DRCP2024xR1 version=1 -->
## PAGE 00049: Unsupported Discriminator Type

- page_id: `170464948`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464948/Unsupported+Discriminator+Type
- version_number: 1
- version_date: `2023-09-22T12:23:35.795+02:00`
- ancestors: DDS Real-Time Communication Plugin > Validation Suite
- labels: []
...
<!--NOMAGIC_PAGE id=170464904 space=DRCP2024xR1 version=1 -->
## PAGE 00050: Validation

- page_id: `170464904`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464904/Validation
- version_number: 1
- version_date: `2023-09-22T12:23:33.822+02:00`
- ancestors: DDS Real-Time Communication Plugin > Getting started
- labels: []
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='DRCP2024xR1'].

[CONFLUENCE_PAGE title='Validation' space='MD2022xR2']>]]>
...
````html
<p class="FirstParagraph"><span lang="EN">The validity of the DDS model is continuously checked by active validation rules contained in the DDS Validation Suite. For example, if you accidentally add multiple attributes to a Topic, an error is displayed. You can fix some of these DDS modeling problems by right-clicking on them and selecting the appropriate solver.</span></p><p class="FirstParagraph"><span lang="EN"><ac:image><ri:attachment ri:filename="image2020-11-12_15-7-35.png"><ri:page ri:space-key="DRCP2024xR1" ri:content-title="Validation" /></ri:attachment></ac:image></span></p><p class="FirstParagraph"><br /></p><p class="FirstParagraph"><span lang="EN"><span><span>There is a separate validation suite for Simulink named DDS Simulink Validation Suite. It contains validation rules for data types that are not supported by Simulink. It can be activated independently from the rest of the rules.</span></span></span></p><p>The detailed descriptions of the validation rules are available in <ac:link><ri:page ri:space-key="DRCP2024xR1" ri:content-title="Validation Suite" /></ac:link>.</p><p><br /></p><p><ac:link><ri:page ri:space-key="MD2022xR2" ri:content-title="Validation" /><ac:plain-text-link-body><![CDATA[Learn more about Validation >>]]></ac:plain-text-link-body></ac:link></p><p>.</p><p class="FirstParagraph"><span lang="EN"><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=170464924 space=DRCP2024xR1 version=1 -->
## PAGE 00051: Validation Suite

- page_id: `170464924`
- space_key: `DRCP2024xR1`
- source_url: https://docs.nomagic.com/spaces/DRCP2024xR1/pages/170464924/Validation+Suite
- version_number: 1
- version_date: `2023-09-22T12:23:34.465+02:00`
- ancestors: DDS Real-Time Communication Plugin
- labels: []
...
The severity is either error or warning. Warning means that the state is not necessarily incorrect, but probably is. The implementation, qualified name, and abbreviation are given because those are the identifiers modeling tool provides for a validation rule, so this document is searchable by either. [CONFLUENCE_PAGE title='Validation' space='MD2022xR2']>]]>
