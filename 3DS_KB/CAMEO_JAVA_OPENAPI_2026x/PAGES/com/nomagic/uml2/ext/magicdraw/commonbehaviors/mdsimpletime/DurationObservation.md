# JAVA OPENAPI: DurationObservation (2026x API)

- source_url: https://jdocs.nomagic.com/2026x/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationObservation.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationObservation.html`
- source_sha256: `f815cbb78f5f3903e4efa8f9bacdaf08d8505f8e4ed1fe06b5623daf2164cf0b`
- captured_utc: `2026-07-14T16:58:55.542490+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `com.dassault_systemes.modeler.foundation.model.ModelElement`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[Observation](Observation.html)`, `[PackageableElement](../../classes/mdkernel/PackageableElement.html)`, `[ParameterableElement](../../auxiliaryconstructs/mdtemplates/ParameterableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`

public interfaceDurationObservationextends [Observation](Observation.html)

begin-user-doc 
 A representation of the model object '***Duration Observation***'.
 end-user-doc 
begin-model-doc 
 A DurationObservation is a reference to a duration during an execution. It points out the NamedElement(s) in the model to observe and whether the observations are
...
See Also:
[`UMLPackage.getDurationObservation()`](../../metadata/UMLPackage.html#getDurationObservation())
Model:
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)>`
`[getEvent](#getEvent())()`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html)>`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.[Observation](Observation.html)
`[get_durationOfObservation](Observation.html#get_durationOfObservation()), [get_timeExpressionOfObservation](Observation.html#get_timeExpressionOfObservation()), [getBehavior](Observation.html#getBehavior()), [set_durationOfObservation](Observation.html#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)), [set_timeExpressionOfObservation](Observation.html#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)), [setBehavior](Observation.html#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))`
...
Method Details
isFirstEvent
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html)> isFirstEvent()
Returns the value of the '***First Event***' attribute list.
 The list contents are of type [`Boolean`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html).
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The value of firstEvent[i] is related to event[i] (where i is 1 or 2). If firstEvent[i] is true, then the corresponding observation event is the first time
 instant the execution enters event[i]. If firstEvent[i] is false, then the corresponding observation event is the time instant the execution exits event[i].
 end-model-doc
Returns:
the value of the '*First Event*' attribute list.
See Also:
[`UMLPackage.getDurationObservation_FirstEvent()`](../../metadata/UMLPackage.html#getDurationObservation_FirstEvent())
Model:
dataType="com.nomagic.uml2.ext.magicdraw.Boolean" upper="2" ordered="true"
Generated:
getEvent
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)> getEvent()
Returns the value of the '***Event***' reference list.
 The list contents are of type [`NamedElement`](../../classes/mdkernel/NamedElement.html).
 It is bidirectional and its opposite is
 '[`*duration Observation Of Event*`](../../classes/mdkernel/NamedElement.html#get_durationObservationOfEvent())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The DurationObservation is determined as the duration between the entering or exiting of a single event Element during execution, or the entering/exiting of one
 event Element and the entering/exiting of a second.
 end-model-doc
Returns:
the value of the '*Event*' reference list.
See Also:
[`UMLPackage.getDurationObservation_Event()`](../../metadata/UMLPackage.html#getDurationObservation_Event())
[`NamedElement.get_durationObservationOfEvent()`](../../classes/mdkernel/NamedElement.html#get_durationObservationOfEvent())
Model:
...
<h1 class="title" title="Interface DurationObservation">Interface DurationObservation</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DurationObservation</span><span class="extends-implements">
extends <a href="Observation.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Observation</a></span></div>
...
<li><a href="../../metadata/UMLPackage.html#getDurationObservation()"><code>UMLPackage.getDurationObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Event</b></em>' reference list.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasFirstEvent()">hasFirstEvent</a>()</code></div>
...
<div class="block">Returns the value of the '<em><b>First Event</b></em>' attribute list.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Observation">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.<a href="Observation.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Observation</a></h3>
<code><a href="Observation.html#get_durationOfObservation()">get_durationOfObservation</a>, <a href="Observation.html#get_timeExpressionOfObservation()">get_timeExpressionOfObservation</a>, <a href="Observation.html#getBehavior()">getBehavior</a>, <a href="Observation.html#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">set_durationOfObservation</a>, <a href="Observation.html#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)">set_timeExpressionOfObservation</a>, <a href="Observation.html#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setBehavior</a></code></div>
<div class="inherited-list">
...
<div class="block">Returns the value of the '<em><b>First Event</b></em>' attribute list.
 The list contents are of type <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang"><code>Boolean</code></a>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The value of firstEvent[i] is related to event[i] (where i is 1 or 2). If firstEvent[i] is true, then the corresponding observation event is the first time
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>First Event</em>' attribute list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDurationObservation_FirstEvent()"><code>UMLPackage.getDurationObservation_FirstEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>dataType="com.nomagic.uml2.ext.magicdraw.Boolean" upper="2" ordered="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getEvent</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a>&gt;</span> <span class="element-name">getEvent</span>()</div>
<div class="block">Returns the value of the '<em><b>Event</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/NamedElement.html#get_durationObservationOfEvent()"><code><em>duration Observation Of Event</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The DurationObservation is determined as the duration between the entering or exiting of a single event Element during execution, or the entering/exiting of one
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Event</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDurationObservation_Event()"><code>UMLPackage.getDurationObservation_Event()</code></a></li>
<li><a href="../../classes/mdkernel/NamedElement.html#get_durationObservationOfEvent()"><code>NamedElement.get_durationObservationOfEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationObservationOfEvent" required="true" upper="2"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasFirstEvent()">
<h3>hasFirstEvent</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasFirstEvent</span>()
               throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
