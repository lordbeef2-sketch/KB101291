# JAVA OPENAPI: StateInvariant (2026x API)

- source_url: https://jdocs.nomagic.com/2026x/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/StateInvariant.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/StateInvariant.html`
- source_sha256: `ea1798fe04abf69a64a5d0d05224bd92a5e0d04bcdf265ceb66556ec3014c6e9`
- captured_utc: `2026-07-14T16:58:57.058503+00:00`
...
public interfaceStateInvariantextends [InteractionFragment](InteractionFragment.html)

begin-user-doc 
 A representation of the model object '***State Invariant***'.
 end-user-doc 
begin-model-doc 
 A StateInvariant is a runtime constraint on the participants of the Interaction. It may be used to specify a variety of different kinds of Constraints, such as
 values of Attributes or Variables, internal or external States, and so on. A StateInvariant is an InteractionFragment and it is placed on a Lifeline.
 end-model-doc 
The following features are supported:
 [`*Invariant*`](#getInvariant())

See Also:
[`UMLPackage.getStateInvariant()`](../../metadata/UMLPackage.html#getStateInvariant())
Model:
...
`void`
`[setInvariant](#setInvariant(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Constraint))([Constraint](../../classes/mdkernel/Constraint.html) value)`
Sets the value of the '[`*Invariant*`](#getInvariant())' containment
 reference.
...
Method Details
getInvariant
@CheckForNull[Constraint](../../classes/mdkernel/Constraint.html) getInvariant()
Returns the value of the '***Invariant***' containment reference.
 It is bidirectional and its opposite is
 '[`*state Invariant Of Invariant*`](../../classes/mdkernel/Constraint.html#get_stateInvariantOfInvariant())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setInvariant(Constraint)`](#setInvariant(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Constraint))
[`UMLPackage.getStateInvariant_Invariant()`](../../metadata/UMLPackage.html#getStateInvariant_Invariant())
[`Constraint.get_stateInvariantOfInvariant()`](../../classes/mdkernel/Constraint.html#get_stateInvariantOfInvariant())
Model:
opposite="_stateInvariantOfInvariant" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setInvariant
void setInvariant(@CheckForNull
...
Generated:
getCovered
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Lifeline](Lifeline.html)> getCovered()
Returns the value of the '***Covered***' reference list.
 The list contents are of type [`Lifeline`](Lifeline.html).
 It is bidirectional and its opposite is
 '[`*state Invariant Of Covered*`](Lifeline.html#get_stateInvariantOfCovered())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getStateInvariant_Covered()`](../../metadata/UMLPackage.html#getStateInvariant_Covered())
[`Lifeline.get_stateInvariantOfCovered()`](Lifeline.html#get_stateInvariantOfCovered())
Model:
...
<h1 class="title" title="Interface StateInvariant">Interface StateInvariant</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">StateInvariant</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getInvariant()"><code><em>Invariant</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getStateInvariant()"><code>UMLPackage.getStateInvariant()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInvariant()">getInvariant</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Invariant</b></em>' containment reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setInvariant(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Constraint)">setInvariant</a><wbr/>(<a href="../../classes/mdkernel/Constraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Constraint</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getInvariant()"><code><em>Invariant</em></code></a>' containment
 reference.</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../../classes/mdkernel/Constraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Constraint</a></span> <span class="element-name">getInvariant</span>()</div>
<div class="block">Returns the value of the '<em><b>Invariant</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Constraint.html#get_stateInvariantOfInvariant()"><code><em>state Invariant Of Invariant</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A Constraint that should hold at runtime for this StateInvariant.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Invariant</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setInvariant(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Constraint)"><code>setInvariant(Constraint)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getStateInvariant_Invariant()"><code>UMLPackage.getStateInvariant_Invariant()</code></a></li>
<li><a href="../../classes/mdkernel/Constraint.html#get_stateInvariantOfInvariant()"><code>Constraint.get_stateInvariantOfInvariant()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_stateInvariantOfInvariant" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setInvariant(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Constraint)">
<h3>setInvariant</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setInvariant</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Invariant</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getInvariant()"><code>getInvariant()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Covered</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Lifeline.html#get_stateInvariantOfCovered()"><code><em>state Invariant Of Covered</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the Lifeline on which the StateInvariant appears.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getStateInvariant_Covered()"><code>UMLPackage.getStateInvariant_Covered()</code></a></li>
<li><a href="Lifeline.html#get_stateInvariantOfCovered()"><code>Lifeline.get_stateInvariantOfCovered()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_stateInvariantOfCovered" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
