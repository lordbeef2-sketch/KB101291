# JAVA OPENAPI: Expression (2026x API)

- source_url: https://jdocs.nomagic.com/2026x/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Expression.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Expression.html`
- source_sha256: `eedb59552bb2dc1a8586e1fc6296df574ed6ca4b00cd2d3f67b82128ef4091dd`
- captured_utc: `2026-07-14T16:58:52.884457+00:00`
...
public interfaceExpressionextends [ValueSpecification](ValueSpecification.html)

begin-user-doc 
 A representation of the model object '***Expression***'.
 end-user-doc 
begin-model-doc 
 An Expression represents a node in an expression tree, which may be non-terminal or terminal. It defines a symbol, and has a possibly empty sequence of operands
 that are ValueSpecifications. It denotes a (possibly empty) set of values when evaluated in a context.
 end-model-doc 
...
See Also:
[`UMLPackage.getExpression()`](../../metadata/UMLPackage.html#getExpression())
Model:
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ValueSpecification](ValueSpecification.html)>`
...
`void`
`[setSymbol](#setSymbol(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the '[`*Symbol*`](#getSymbol())' attribute.
...
Method Details
getSymbol
@CheckForNull[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getSymbol()
Returns the value of the '***Symbol***' attribute.
...
See Also:
[`setSymbol(String)`](#setSymbol(java.lang.String))
[`UMLPackage.getExpression_Symbol()`](../../metadata/UMLPackage.html#getExpression_Symbol())
Model:
...
Generated:
getOperand
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ValueSpecification](ValueSpecification.html)> getOperand()
Returns the value of the '***Operand***' containment reference list.
 The list contents are of type [`ValueSpecification`](ValueSpecification.html).
 It is bidirectional and its opposite is '[`*Expression*`](ValueSpecification.html#getExpression())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getExpression_Operand()`](../../metadata/UMLPackage.html#getExpression_Operand())
[`ValueSpecification.getExpression()`](ValueSpecification.html#getExpression())
Model:
...
<dd><code><a href="../../auxiliaryconstructs/mdtemplates/StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Expression</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getSymbol()"><code><em>Symbol</em></code></a></li>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getExpression()"><code>UMLPackage.getExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSymbol()">getSymbol</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Symbol</b></em>' attribute.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setSymbol(java.lang.String)">setSymbol</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getSymbol()"><code><em>Symbol</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getSymbol</span>()</div>
<div class="block">Returns the value of the '<em><b>Symbol</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Symbol</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setSymbol(java.lang.String)"><code>setSymbol(String)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getExpression_Symbol()"><code>UMLPackage.getExpression_Symbol()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="setSymbol(java.lang.String)">
<h3>setSymbol</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSymbol</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getSymbol()"><code><em>Symbol</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Symbol</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getSymbol()"><code>getSymbol()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<h3>getOperand</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a>&gt;</span> <span class="element-name">getOperand</span>()</div>
<div class="block">Returns the value of the '<em><b>Operand</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is '<a href="ValueSpecification.html#getExpression()"><code><em>Expression</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies a sequence of operand ValueSpecifications.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getExpression_Operand()"><code>UMLPackage.getExpression_Operand()</code></a></li>
<li><a href="ValueSpecification.html#getExpression()"><code>ValueSpecification.getExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="expression" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
