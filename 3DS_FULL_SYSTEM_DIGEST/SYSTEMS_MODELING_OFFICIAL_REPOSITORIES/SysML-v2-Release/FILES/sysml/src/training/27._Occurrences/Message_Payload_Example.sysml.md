# OFFICIAL REPOSITORY FILE: SysML-v2-Release/sysml/src/training/27. Occurrences/Message Payload Example.sysml

- repository: `SysML-v2-Release`
- source_path: `sysml/src/training/27. Occurrences/Message Payload Example.sysml`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Release/blob/288d129c0d532065d45434bbb48a920898b719af/sysml/src/training/27. Occurrences/Message Payload Example.sysml
- source_bytes: 1176
