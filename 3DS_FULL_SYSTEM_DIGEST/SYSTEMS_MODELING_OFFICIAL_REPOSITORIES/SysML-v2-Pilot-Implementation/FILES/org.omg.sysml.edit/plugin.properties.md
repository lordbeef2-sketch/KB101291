# OFFICIAL REPOSITORY FILE: SysML-v2-Pilot-Implementation/org.omg.sysml.edit/plugin.properties

- repository: `SysML-v2-Pilot-Implementation`
- source_path: `org.omg.sysml.edit/plugin.properties`
- source_url: https://github.com/Systems-Modeling/SysML-v2-Pilot-Implementation/blob/fa709f28dfd49dfdb7ee83e4e19da2f57e0eb3aa/org.omg.sysml.edit/plugin.properties
- source_bytes: 35663
- source_sha256: `e5c9bf7984418267333aaaf721ec580a56b5fcf824cb4fe21d7e3dc2bbcdae0e`
- decoded_as: `utf-8`
...
_UI_TerminateActionUsage_type = Terminate Action Usage
_UI_TerminateWithResultActionUsage_type = Terminate With Result Action Usage
_UI_TerminateActionUsage_terminatedOccurrenceArgument_feature = Terminated Occurrence Argument
_UI_TerminateWithResultActionUsage_returnedResultArgument_feature = Returned Result Argument
_UI_FlowConnectionDefinition_flowConnectionEnd_feature = Flow Connection End
_UI_CrossSubsetting_type = Cross Subsetting
_UI_Feature_crossFeature_feature = Cross Feature
_UI_Feature_ownedCrossSubsetting_feature = Owned Cross Subsetting
_UI_CrossSubsetting_crossedFeature_feature = Crossed Feature
_UI_CrossSubsetting_crossingFeature_feature = Crossing Feature
_UI_IndexExpression_type = Index Expression
_UI_AnnotatingElement_owningAnnotatingRelationship_feature = Owning Annotating Relationship
_UI_Annotation_ownedAnnotatingElement_feature = Owned Annotating Element
_UI_SuccessionFlow_type = Succession Flow
_UI_Flow_type = Flow
_UI_FlowEnd_type = Flow End
_UI_PayloadFeature_type = Payload Feature
_UI_InstantiationExpression_type = Instantiation Expression
_UI_ConstructorExpression_type = Constructor Expression
_UI_FlowUsage_type = Flow Usage
_UI_FlowDefinition_type = Flow Definition
_UI_SuccessionFlowUsage_type = Succession Flow Usage
_UI_Feature_isVariable_feature = Is Variable
_UI_Feature_isConstant_feature = Is Constant
_UI_Connector_defaultFeaturingType_feature = Default Featuring Type
_UI_Flow_payloadType_feature = Payload Type
_UI_Flow_targetInputFeature_feature = Target Input Feature
_UI_Flow_sourceOutputFeature_feature = Source Output Feature
_UI_Flow_flowEnd_feature = Flow End
_UI_Flow_payloadFeature_feature = Payload Feature
_UI_Flow_interaction_feature = Interaction
_UI_InstantiationExpression_argument_feature = Argument
_UI_InstantiationExpression_instantiatedType_feature = Instantiated Type
_UI_Usage_mayTimeVary_feature = May Time Vary
_UI_FlowUsage_flowDefinition_feature = Flow Definition
_UI_FlowDefinition_flowEnd_feature = Flow End
