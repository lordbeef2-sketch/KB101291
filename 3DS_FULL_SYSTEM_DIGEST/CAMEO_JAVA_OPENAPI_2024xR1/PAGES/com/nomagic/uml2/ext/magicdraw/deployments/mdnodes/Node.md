...
- source_url: https://jdocs.nomagic.com/2024xRefresh1/com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/Node.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/Node.html`
- source_sha256: `39a732250bb469a89dfc8fe2573b7bf990b836549cfcdd4880ea2e7c1e066b16`
- captured_utc: `2026-07-14T16:53:00.455498+00:00`
...
Description
`[Node](Node.html)`
`[get_nodeOfNestedNode](#get_nodeOfNestedNode())()`
Returns the value of the '***node Of Nested Node***' container reference.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Node](Node.html)>`
`[getNestedNode](#getNestedNode())()`
Returns the value of the '***Nested Node***' containment reference list.
`boolean`
`[hasNestedNode](#hasNestedNode())()`

`void`
`[set_nodeOfNestedNode](#set_nodeOfNestedNode(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Node))([Node](Node.html) value)`
Sets the value of the '[`*node Of Nested Node*`](#get_nodeOfNestedNode())' container reference.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.[DeploymentTarget](DeploymentTarget.html)
`[getDeployedElement](DeploymentTarget.html#getDeployedElement()), [getDeployment](DeploymentTarget.html#getDeployment()), [hasDeployedElement](DeploymentTarget.html#hasDeployedElement()), [hasDeployment](DeploymentTarget.html#hasDeployment())`
...
Method Details
getNestedNode
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Node](Node.html)> getNestedNode()
Returns the value of the '***Nested Node***' containment reference list.
 The list contents are of type [`Node`](Node.html).
 It is bidirectional and its opposite is '[`*node Of Nested Node*`](#get_nodeOfNestedNode())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getNode_NestedNode()`](../../metadata/UMLPackage.html#getNode_NestedNode())
[`get_nodeOfNestedNode()`](#get_nodeOfNestedNode())
Model:
opposite="_nodeOfNestedNode" containment="true" resolveProxies="true" ordered="false"
Generated:
get_nodeOfNestedNode
@CheckForNull[Node](Node.html) get_nodeOfNestedNode()
Returns the value of the '***node Of Nested Node***' container reference.
 It is bidirectional and its opposite is '[`*Nested Node*`](#getNestedNode())'.
 begin-user-doc 
If the meaning of the '*node Of Nested Node*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*node Of Nested Node*' container reference.
See Also:
[`set_nodeOfNestedNode(Node)`](#set_nodeOfNestedNode(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Node))
[`UMLPackage.getNode__nodeOfNestedNode()`](../../metadata/UMLPackage.html#getNode__nodeOfNestedNode())
[`getNestedNode()`](#getNestedNode())
Model:
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getNestedNode()"><code><em>Nested Node</em></code></a></li>
<li><a href="#get_nodeOfNestedNode()"><code><em>node Of Nested Node</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getNode()"><code>UMLPackage.getNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_nodeOfNestedNode()">get_nodeOfNestedNode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>node Of Nested Node</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getNestedNode()">getNestedNode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Nested Node</b></em>' containment reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasNestedNode()">hasNestedNode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_nodeOfNestedNode(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Node)">set_nodeOfNestedNode</a><wbr/>(<a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_nodeOfNestedNode()"><code><em>node Of Nested Node</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.<a href="DeploymentTarget.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeploymentTarget</a></h3>
<code><a href="DeploymentTarget.html#getDeployedElement()">getDeployedElement</a>, <a href="DeploymentTarget.html#getDeployment()">getDeployment</a>, <a href="DeploymentTarget.html#hasDeployedElement()">hasDeployedElement</a>, <a href="DeploymentTarget.html#hasDeployment()">hasDeployment</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getNestedNode()">
<h3>getNestedNode</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a>&gt;</span> <span class="element-name">getNestedNode</span>()</div>
<div class="block">Returns the value of the '<em><b>Nested Node</b></em>' containment reference list.
 The list contents are of type <a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes"><code>Node</code></a>.
 It is bidirectional and its opposite is '<a href="#get_nodeOfNestedNode()"><code><em>node Of Nested Node</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Nodes that are defined (nested) within the Node.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Nested Node</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getNode_NestedNode()"><code>UMLPackage.getNode_NestedNode()</code></a></li>
<li><a href="#get_nodeOfNestedNode()"><code>get_nodeOfNestedNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_nodeOfNestedNode" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_nodeOfNestedNode()">
<h3>get_nodeOfNestedNode</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a></span> <span class="element-name">get_nodeOfNestedNode</span>()</div>
<div class="block">Returns the value of the '<em><b>node Of Nested Node</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="#getNestedNode()"><code><em>Nested Node</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>node Of Nested Node</em>' container reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>node Of Nested Node</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#set_nodeOfNestedNode(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Node)"><code>set_nodeOfNestedNode(Node)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getNode__nodeOfNestedNode()"><code>UMLPackage.getNode__nodeOfNestedNode()</code></a></li>
<li><a href="#getNestedNode()"><code>getNestedNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="nestedNode" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_nodeOfNestedNode(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Node)">
<h3>set_nodeOfNestedNode</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_nodeOfNestedNode</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Node.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Node</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#get_nodeOfNestedNode()"><code><em>node Of Nested Node</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>node Of Nested Node</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#get_nodeOfNestedNode()"><code>get_nodeOfNestedNode()</code></a></li>
...
<li>
<section class="detail" id="hasNestedNode()">
<h3>hasNestedNode</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasNestedNode</span>()
