...
- source_url: https://jdocs.nomagic.com/2024x/com/nomagic/magicdraw/core/modules/ModulesService.UsedViaReadOnlyAutomaticUsageException.html
- source_path: `com/nomagic/magicdraw/core/modules/ModulesService.UsedViaReadOnlyAutomaticUsageException.html`
- source_sha256: `2a486a36039e268b2c2f47294efdf9e49192df0d2b5ba9e8ce35157273a0d6f6`
- captured_utc: `2026-07-14T16:51:13.655102+00:00`
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.ci.persistence.spi.decomposition.AttachmentSet</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getOffendingUsages()">getOffendingUsages</a>()</code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">UsedViaReadOnlyAutomaticUsageException</span><wbr/><span class="parameters">(com.nomagic.ci.persistence.spi.decomposition.AttachmentSet offendingUsages)</span></div>
<div class="block">Creates new instance of
 <a href="ModulesService.UsedViaReadOnlyAutomaticUsageException.html" title="class in com.nomagic.magicdraw.core.modules"><code>ModulesService.UsedViaReadOnlyAutomaticUsageException</code></a></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.ci.persistence.spi.decomposition.AttachmentSet</span> <span class="element-name">getOffendingUsages</span>()</div>
<div class="block">Gets the set of offending read-only automatic usages</div>
<dl class="notes">
<dt>Returns:</dt>
