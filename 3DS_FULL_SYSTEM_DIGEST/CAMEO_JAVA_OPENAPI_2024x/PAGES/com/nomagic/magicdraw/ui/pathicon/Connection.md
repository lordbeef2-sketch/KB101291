...
- source_url: https://jdocs.nomagic.com/2024x/com/nomagic/magicdraw/ui/pathicon/Connection.html
- source_path: `com/nomagic/magicdraw/ui/pathicon/Connection.html`
- source_sha256: `f9583468cb89ce7cc58acf7d1c320c8754ea50884deec567cedfcdf254af069d`
- captured_utc: `2026-07-14T16:52:06.808808+00:00`
...
`fixOverlapping` - if true then correcting of the link end shape covering client or supplier
...
<div class="col-first even-row-color"><code>static final int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#GENERALIZATION">GENERALIZATION</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#GENERALIZATION2">GENERALIZATION2</a></code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-first even-row-color"><code>static final int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#HALF_CIRCLE">HALF_CIRCLE</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
...
<dd><code>y2</code> - to point</dd>
<dd><code>preferredSize</code> - preferred size of path end shape</dd>
<dd><code>shapeBounds</code> - client shape bounds</dd>
<dt>Returns:</dt>
<dd>Point where path line should begin</dd>
<dt>See Also:</dt>
<dd>
...
<dd><code>fixOverlapping</code> - if true then correcting of the link end shape covering client or supplier
                       shape should be used.</dd>
<dt>Returns:</dt>
