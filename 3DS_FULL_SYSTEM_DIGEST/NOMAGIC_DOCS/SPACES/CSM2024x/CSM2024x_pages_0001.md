# NOMAGIC DOCUMENTATION SPACE: Cameo Systems Modeler 2024x

<!--NOMAGIC_SPACE key=CSM2024x chunk=1 -->

<!--NOMAGIC_PAGE id=142934671 space=CSM2024x version=1 -->
## PAGE 00001: 2024x News for Developers

- page_id: `142934671`
- space_key: `CSM2024x`
- source_url: https://docs.nomagic.com/spaces/CSM2024x/pages/142934671/2024x+News+for+Developers
- version_number: 1
...
<!--NOMAGIC_PAGE id=136726579 space=CSM2024x version=43 -->
## PAGE 00002: 2024x Version News

- page_id: `136726579`
- space_key: `CSM2024x`
- source_url: https://docs.nomagic.com/spaces/CSM2024x/pages/136726579/2024x+Version+News
- version_number: 43
- version_date: `2024-11-29T13:50:58.872+01:00`
- ancestors: Cameo Systems Modeler Documentation
- labels: []
...
[CONFLUENCE_PAGE title='Cameo Simulation Toolkit Documentation' space='CST2024x']**Cameo Simulation Toolkit Documentation**
...
````html
<ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="d516dbf5-4ea4-4e56-a38a-2c61f18af7be"><ac:parameter ac:name="id">564776767</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="44f03ae1-e5ba-44d1-ae13-9dbd20224243"><ac:parameter ac:name="id">564776769</ac:parameter><ac:rich-text-body><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="10ad0c56-c8dd-4c03-8a25-a45cd3fd3f90"><ac:parameter ac:name="id">564776766</ac:parameter><ac:rich-text-body><p class="auto-cursor-target"><strong>Docs of other versions</strong></p><ul><li><ac:link><ac:plain-text-link-body><![CDATA[Cameo Systems Modeler 2022x Refresh1]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="CSM2022x" ri:content-title="Cameo Systems Modeler Documentation" /><ac:plain-text-link-body><![CDATA[Cameo Systems Modeler 2022x]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="CSM2021xR2" ri:content-title="Cameo Systems Modeler Documentation" /><ac:plain-text-link-body><![CDATA[Cameo Systems Modeler 2021x Refresh2]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:space ri:space-key="CSM2021xR1" /></ac:link></li><li><ac:link><ri:page ri:space-key="CSM2021x" ri:content-title="Cameo Systems Modeler Documentation" /><ac:plain-text-link-body><![CDATA[Cameo Systems Modeler 2021x]]></ac:plain-text-link-body></ac:link></li><li><ac:link><ri:page ri:space-key="CSM190SP4" ri:content-title="Cameo Systems Modeler Documentation" /><ac:plain-text-link-body><![CDATA[Cameo Systems Modeler 19.0 LTR SP4]]></ac:plain-text-link-body></ac:link></li></ul><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="ab96daf3-0ef5-4f79-a1d0-c988e00412a5"><ac:parameter ac:name="id">564776768</ac:parameter><ac:rich-text-body><ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>This is the home page of Cameo Systems Modeler documentation.</p><p>Cameo Systems Modeler is based on the award-winning MagicDraw modeling platform. The solution retains all the best diagramming, collaboration, persistence, and documentation capabilities while offering more customized capabilities tailored to <strong>systems engineering</strong> needs.</p><p>The documentation of Cameo Systems Modeler is a package that includes the documentation of these products and plugins:</p><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p style="margin-left: 30.0px;"><span class="confluence-link"><strong><ac:link><ri:page ri:space-key="MD2024x" ri:content-title="MagicDraw Documentation" /></ac:link></strong><br /></span></p><p style="margin-left: 30.0px;">Introduces the main features of modeling tool: working with projects, UML 2 modeling and diagramming, collaboration capabilities, and many more core features.</p><p style="margin-left: 30.0px;"><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="8e733953-c9e3-4afa-a2ce-0dcb8dbb0801"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="MD2024x" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p style="margin-left: 30.0px;"><span class="confluence-link"><span class="confluence-link"><strong><ac:link><ri:page ri:space-key="SYSMLP2024x" ri:content-title="SysML Plugin Documentation" /></ac:link></strong><br /></span></span></p><p style="margin-left: 30.0px;">Provides descriptions of SysML diagrams and elements, plus introduces SysML specific features as well as gives guidelines for building systems.</p><p style="margin-left: 30.0px;"><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="f60afd5d-e09d-490c-bf28-aeeeebe8f315"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="SYSMLP2024x" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p style="margin-left: 30.0px;"><span class="confluence-link"><span class="confluence-link"><strong><ac:link><ri:page ri:space-key="CRMP2024x" ri:content-title="Cameo Requirements Modeler Plugin Documentation" /></ac:link></strong><br /></span></span></p><p style="margin-left: 30.0px;">Guides you through the import, export, and management of SysML requirements.</p><p style="margin-left: 30.0px;"><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="73274897-cdc6-40b0-b354-1d8bd74cdfc2"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="CRMP2024x" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p style="margin-left: 30.0px;"><span class="confluence-link"><ac:link><ri:page ri:space-key="CST2024x" ri:content-title="Cameo Simulation Toolkit Documentation" /><ac:link-body><strong>Cameo Simulation Toolkit Documentation</strong></ac:link-body></ac:link><br /></span></p><p style="margin-left: 30.0px;">Provides instructions on how to test the system reactions to user interaction or predefined testing data and execution scenarios.</p><p style="margin-left: 30.0px;"><br /></p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="57d1ed99-9134-422c-908f-bf3717e73f6c"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="CST2024x" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_left_sidebar"><ac:layout-cell><p style="margin-left: 30.0px;"><strong><ac:link><ri:page ri:space-key="IL2024x" ri:content-title="Installation, licensing, and system requirements" /><ac:plain-text-link-body><![CDATA[Installation and licensing]]></ac:plain-text-link-body></ac:link></strong></p><p style="margin-left: 30.0px;">Provides the instructions about how to install modeling tool and plugins, add or remove licenses, perform activation. </p></ac:layout-cell><ac:layout-cell><p><ac:structured-macro ac:name="livesearch" ac:schema-version="1" ac:macro-id="04751d59-4ade-4425-bae2-5a2272a7db3e"><ac:parameter ac:name="spaceKey"><ri:space ri:space-key="NMDOC" /></ac:parameter><ac:parameter ac:name="placeholder">Type a search phrase...</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section></ac:layout></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=136723596 space=CSM2024x version=4 -->
## PAGE 00004: Cameo Systems Modeler Home Page

- page_id: `136723596`
- space_key: `CSM2024x`
- source_url: https://docs.nomagic.com/spaces/CSM2024x/pages/136723596/Cameo+Systems+Modeler+Home+Page
- version_number: 4
- version_date: `2024-01-26T15:16:27.077+01:00`
- ancestors: Cameo Systems Modeler Documentation
- labels: []

### NORMALIZED CONTENT

[CONFLUENCE_PAGE title='Cameo Systems Modeler Documentation' space='']Cameo Systems Modeler Documentationtrue

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="include" ac:schema-version="1" ac:macro-id="d8e68408-f09f-4089-9a63-3f2078360730"><ac:parameter ac:name=""><ac:link><ri:page ri:content-title="Cameo Systems Modeler Documentation" /></ac:link></ac:parameter><ac:parameter ac:name="page">Cameo Systems Modeler Documentation</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=136723737 space=CSM2024x version=3 -->
## PAGE 00005: Legal Notices

- page_id: `136723737`
- space_key: `CSM2024x`
- source_url: https://docs.nomagic.com/spaces/CSM2024x/pages/136723737/Legal+Notices
- version_number: 3
- version_date: `2024-04-19T13:34:59.314+02:00`
- ancestors: Cameo Systems Modeler Documentation
- labels: []

### NORMALIZED CONTENT

MD2024x:Legal Noticestrue[CONFLUENCE_PAGE title='Legal Notices' space='MD2024x']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="a7e8f59a-86dd-4987-b275-386638ece502"><ac:parameter ac:name="page">MD2024x:Legal Notices</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024x" ri:content-title="Legal Notices" /></ac:link></ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=136723736 space=CSM2024x version=3 -->
## PAGE 00006: Support

- page_id: `136723736`
- space_key: `CSM2024x`
- source_url: https://docs.nomagic.com/spaces/CSM2024x/pages/136723736/Support
- version_number: 3
- version_date: `2024-10-04T14:24:43.843+02:00`
- ancestors: Cameo Systems Modeler Documentation
- labels: []
...
````html
<p><ac:structured-macro ac:name="include" ac:schema-version="1" ac:macro-id="428aac84-630c-49c1-a505-e45d4392f1df"><ac:parameter ac:name="page">NMDOC:Support</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Support" /></ac:link></ac:parameter></ac:structured-macro></p>
````
