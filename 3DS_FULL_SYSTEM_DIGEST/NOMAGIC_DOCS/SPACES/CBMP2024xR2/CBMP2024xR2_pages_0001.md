# NOMAGIC DOCUMENTATION SPACE: Cameo Business Modeler Plugin 2024x Refresh2

<!--NOMAGIC_SPACE key=CBMP2024xR2 chunk=1 -->

<!--NOMAGIC_PAGE id=290030615 space=CBMP2024xR2 version=1 -->
## PAGE 00001: 2024x Refresh2 Version News

- page_id: `290030615`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030615/2024x+Refresh2+Version+News
- version_number: 1
- version_date: `2026-02-09T13:46:51.389+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="line-height: 1.66667;letter-spacing: normal;text-align: center;">Cameo Business Modeler Plugin</h1><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: November 8</span><span style="color:var(--ds-text,#707070);">, 2024</span></p><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p>The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=290030646 space=CBMP2024xR2 version=1 -->
## PAGE 00002: Activities

- page_id: `290030646`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030646/Activities
- version_number: 1
...
````html
<p>An Activity is a work that is performed within a business process. An Activity can be atomic or non-atomic (compound). There are three types of Activities that are part of a Process:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f66051d6-e804-413f-8aea-802e12fc6c57" /></p><p>If the Activity property Is For Compensation is set to true, the Activity will be used for compensation, which means that this Activity will be activated only when a Compensation Event is detected and initiated under the Compensation Event visibility scope. The Compensation indicator (marker) is displayed for all activities that are used for the compensation.</p><ul><li>Compensation Task with Compensation indicator<br /><ac:image><ri:attachment ri:filename="task_compensation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></li><li>Compensation SubProcess with Compensation indicator<br /><ac:image><ri:attachment ri:filename="subprocess_compensation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul><p>Activities can be repeated sequentially, essentially behaving like a loop. The presence of loop characteristics signifies that an Activity has the looping behavior. There are two types of looping characteristics defined in BPMN:</p><ul><li>Standard Loop. A Standard Loop indicator (marker) displayed in an Activity shape shows that the looping behavior based on a boolean condition is defined for this Activity. Additional looping characteristics can be defined, and the Activity will loop as long as the boolean condition is true. The condition is evaluated for every loop iteration and can be evaluated at the beginning or end of the iteration. In addition, a numeric cap can be optionally specified, but the number of iterations cannot exceed this cap.<ul><li>Task with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="task_standard_loop.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></li><li>SubProcess with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="subprocess_standard_loop.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul></li><li><p>MultiInstance Loop. A MultiInstance Loop indicator shows that a desired number of Activity instances can be created. The instances can be executed in parallel or sequentially. Either expression is used to specify the desired number of instances or a data driven setup that can be used.</p><ul><li><p>Task with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="task_multi_par.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li><p>SubProcess with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li><p>Task with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="task_multi_par_seq.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li>SubProcess with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par_seq.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul></li></ul><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="78303b38-7a07-479f-9c99-d0b24fc412d5"><ac:rich-text-body><p>The Compensation, Multi-instance Loop, and Standard Loop indicators can be added to all types of Activities.</p></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=290030676 space=CBMP2024xR2 version=1 -->
## PAGE 00003: AdHoc SubProcess

- page_id: `290030676`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030676/AdHoc+SubProcess
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>An AdHoc SubProcess is a specialized type of SubProcess, which is a group of activities that have no required sequence relationships. A set of activities can be defined for the process, but the sequence and number of performances for the activities are determined by the performers of the activities.</p><p><strong>Notation</strong></p><ul><li>Expanded<br /><ac:image><ri:attachment ri:filename="expanded_adhoc.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="AdHoc SubProcess" /></ri:attachment></ac:image></li><li>Collapsed<br /><ac:image><ri:attachment ri:filename="suppressed_adhoc.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="AdHoc SubProcess" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030632 space=CBMP2024xR2 version=1 -->
## PAGE 00004: Anchor

- page_id: `290030632`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030632/Anchor
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030936 space=CBMP2024xR2 version=2 -->
## PAGE 00006: Assessment

- page_id: `290030936`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030936/Assessment
- version_number: 2
- version_date: `2026-02-23T14:20:24.744+01:00`
...
````html
<p><strong>Description</strong></p><p>An Assessment is a judgment of some Influencer that affects the ability of organization to employ its Means or achieve its Ends. In other words, an Assessment expresses a logical connection or fact type between Influencers and the Ends and/or Means of the business plans. In this way, an Assessment indicates which Influencers are relevant to which Ends and/or Means.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="assesment.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Assessment+Concepts">Assessment Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Assessment+Concept+Relationships" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Assessment Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030942 space=CBMP2024xR2 version=2 -->
## PAGE 00007: Assessment Concept Relationships

- page_id: `290030942`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030942/Assessment+Concept+Relationships
- version_number: 2
- version_date: `2026-02-23T14:20:25.385+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Assessment Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>The following table provides the relationships that exist between element types and their meaning.</p><table class="relative-table wrapped" style="width: 2059.95px;"><colgroup><col style="width: 210.594px;" /><col style="width: 1303.06px;" /><col style="width: 545.297px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td style="">Identifies</td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Potential Reward" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Risk" /></ac:link>. Meaning that the Assessment points out some possible Potential Reward or Risk that is/are significant to that Assessment. Each possible consequence serves as an appraisal of the worth, value, or quality of some aspect of the Assessment in specific terms, types, or dimensions.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="identifies.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Provides<br />Impetus</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment is the driving force for the Business Policy or Business Rule.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="provides_impetus.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Achievements</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Vision" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Objective" /></ac:link>. Meaning that the Assessment has an impact on the End outcomes.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_achievements.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Employment</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mission" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment has an impact on the use of Means.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_employment.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Judgement<br />For</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment" /></ac:link> to a Influencer (<ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Internal Influencer" /></ac:link>). Meaning that the Assessment is the Influencer’s judgment that influences the organization’s ability to carry out its Means or achieve its Ends.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="judgement_for.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Assessment+Concepts">Assessment Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030935 space=CBMP2024xR2 version=1 -->
## PAGE 00008: Assessment Concepts

- page_id: `290030935`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030935/Assessment+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030636 space=CBMP2024xR2 version=1 -->
## PAGE 00009: Association

- page_id: `290030636`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030636/Association
- version_number: 1
...
````html
<p>A Boundary Event is an Intermediate event which can be placed on the boundary of any of the following activities:</p><ul><li>SubProcess, Task, or Call Activity</li><li>SubChoreography, Choreography Task, or Call Choreography</li></ul><p>Boundary Event indicates that while attached-to Activity is running, event is listening for the trigger signal.</p><p>Boundary Event types:</p><ul><li>Interrupting Boundary Event aborts Activity and Process is continued of exceptional flow. This event is drawn with a solid border.</li><li>Non-Interrupting Boundary Event splits process to parallel flows. This event is drawn with a dashed border.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="boundary_error.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Boundary Events" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Error Boundary Event attached to SubProcess.</h6><p>Types of Boundary Events are as follows:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="dd5528d2-89f7-4470-8751-3f740afa86c7" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=290030992 space=CBMP2024xR2 version=2 -->
## PAGE 00011: BPMN Activities Description Table

- page_id: `290030992`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030992/BPMN+Activities+Description+Table
- version_number: 2
- version_date: `2026-02-23T14:20:29.322+01:00`
...
````html
<p><strong>Description</strong></p><p>A BPMN Activities Description table is designed to display or edit selected process activities descriptions in a table form. A BPMN Activities Description table is created for a BPMN Process.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="activities_description_table.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Activities Description Table" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Activities Description table.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Tables">BPMN Tables</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+a+Diagram">Creating a Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030953 space=CBMP2024xR2 version=2 -->
## PAGE 00012: BPMN Association

- page_id: `290030953`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030953/BPMN+Association
- version_number: 2
- version_date: `2026-02-23T14:20:25.915+01:00`
...
````html
<p><strong>Description</strong></p><p>A BPMN Association link shows that particular classes are related to each other. BPMN Association links may have names defined – names help to read diagrams. You can also specify multiplicity at the end of a BPMN Association.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="association_example.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Association" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Association between two Classes with Multiplicity at the End.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Data+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Data Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030990 space=CBMP2024xR2 version=2 -->
## PAGE 00013: BPMN Business Data Description Table

- page_id: `290030990`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030990/BPMN+Business+Data+Description+Table
- version_number: 2
- version_date: `2026-02-23T14:20:29.140+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > BPMN Tables
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Choreography formalizes the way business participants coordinate their interactions. A Choreography is a type of process, but its purpose and behavior are different from a standard BPMN process.</p><p>A standard process defines the flow of activities of a specific partner entity or organization. In contrast, a Choreography formalizes the way business participants coordinate their interactions. The focus is not on the work performed within these participants, but rather on the information (messages) exchanged between them.</p><p>A Choreography is a definition of expected behavior, basically a procedural business contract between interacting participants. It shows the messages exchanged and their logical relations. This allows business partners to plan their business processes for inter-operation without introducing conflicts.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="choreography_diagram.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Choreography Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Choreography diagram.</h6><p>A BPMN Choreography diagram is based on the UML Activity diagram and includes restrictions and extensions as defined by BPMN.</p><p>Types of Choreography elements are as follows:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="4d335140-5180-4a64-b441-3516fbfd43f8" /></p><p><br /></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Choreography</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Error" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Error</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Intermediate+Catch+Event">Intermediate Catch Event</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Boundary+Events">Boundary Events</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Gateways">Gateways</a></li></ul><p><strong>Related diagram</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+BPMN+Choreography+Diagram">Using BPMN Choreography Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030830 space=CBMP2024xR2 version=2 -->
## PAGE 00015: BPMN Collaboration Diagram

- page_id: `290030830`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030830/BPMN+Collaboration+Diagram
- version_number: 2
- version_date: `2026-02-23T14:20:18.736+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Collaboration represents the interactions between two or more business entities. A Collaboration diagram depicts a global point of view. It shows the interactions between participants in general.</p><p>A Collaboration contains two or more pools, representing the participants in the collaboration. Messages exchanged between the participants are shown by message flows that connect two pools together (or objects within the pools).</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_I.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Collaboration Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Collaboration diagram with two Black Box Pools.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="collaboration_II.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Collaboration Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Collaboration diagram with two Pools showing process.</h6><p>A Collaboration diagram can also show distinct conversations between collaborating participants in a domain. Communications are defined by the conversations, participants, and conversation links between them.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_III.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Collaboration Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">BPMN Collaboration diagram with Conversations.</h6><p>The elements of a BPMN Process diagram can be displayed on the BPMN Collaboration diagram.</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030997 space=CBMP2024xR2 version=2 -->
## PAGE 00016: BPMN Data Usage Matrices

- page_id: `290030997`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030997/BPMN+Data+Usage+Matrices
- version_number: 2
- version_date: `2026-02-23T14:20:29.875+01:00`
...
````html
<p><strong>Description</strong></p><p>A BPMN Data Usage Matrix shows what data classes are used in BPMN Processes and SubProcess. Data Objects represents classes in a BPMN diagram.</p><p>A BPMN Data Usage Matrix presents information about all BPMN Processes and SubProcesses in rows and Classes in columns. Each row in the matrix shows if a class is used in a BPMN Process or SubProcess diagram as a Data Object.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="data_usage_matrix.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Data Usage Matrices" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Data Usage Matrix.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/SubProcesses">SubProcesses</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Matrices" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Matrices</a></li></ul><p><strong>Related diagram</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+a+Diagram">Creating a Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/MD2024xR2/Dependency+Matrix">Dependency Matrix</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030994 space=CBMP2024xR2 version=2 -->
## PAGE 00017: BPMN Matrices

- page_id: `290030994`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030994/BPMN+Matrices
- version_number: 2
- version_date: `2026-02-23T14:20:29.528+01:00`
...
<!--NOMAGIC_PAGE id=290030644 space=CBMP2024xR2 version=1 -->
## PAGE 00018: BPMN Process

- page_id: `290030644`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030644/BPMN+Process
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A BPMN Process Diagram describes a sequence or flow of activities in an organization that shows how the business works. The diagram shows activities, events, and data that trigger or feed business activities. A BPMN Process Diagram is similar to the UML Activity diagram with a much richer set of default message types and business process styles of notations.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="process_diagram.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Process Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">BPMN Process diagram</h6><p><br /></p>
````

<!--NOMAGIC_PAGE id=290030986 space=CBMP2024xR2 version=2 -->
## PAGE 00020: BPMN Processes Description Table

- page_id: `290030986`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030986/BPMN+Processes+Description+Table
- version_number: 2
- version_date: `2026-02-23T14:20:28.774+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > BPMN Tables
- labels: []
...
````html
<p><strong>Description</strong></p><p>A BPMN Processes Structure Map diagram allows you to represent the structure of processes in a project. The<br />processes are grouped into packages on the diagram. And each process may itself contains other processes,<br />which in turn may contain other processes. The diagram makes the processes easier to understand and helps you<br />analyze how they are organized.</p><p>A BPMN Processes Structure Map diagram shows packages, processes, subprocesses, and tasks from a<br />selected scope.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="process_structure_map.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Processes Structure Map" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Processes Structure Map.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Package">Package</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li></ul><p><strong>Related diagram</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related external resource</strong></p><ul><li><a href="https://docs.nomagic.com/display/MD2024xR2/Relation+Map" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Relation Map</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030988 space=CBMP2024xR2 version=2 -->
## PAGE 00022: BPMN Resources Description Table

- page_id: `290030988`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030988/BPMN+Resources+Description+Table
- version_number: 2
- version_date: `2026-02-23T14:20:28.952+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > BPMN Tables
- labels: []
...
````html
<p><strong>Description</strong></p><p>A BPMN Resources Usage Matrix is designed to review and edit an allocation of Resource Roles for BPMN Activities. The Resource Roles used in an Activity show a Resources property in a BPMN Activity specification dialog.</p><p>A BPMN Resources Usage Matrix presents information about BPMN Activities in rows and Resource Roles in columns. Each arrow in the matrix shows if a Resource Role is used by an Activity.<br />You can define Resource Roles usage for all BPMN Activities by assigning or removing the Resource Roles to or from the Activities.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="resource_usage_matrix.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMN Resources Usage Matrices" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">BPMN Resource Usage Matrix.</h6><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Information+system">Information system</a></li><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Matrices" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Matrices</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+a+Diagram">Creating a Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/MD2024xR2/Dependency+Matrix">Dependency Matrix</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030985 space=CBMP2024xR2 version=2 -->
## PAGE 00024: BPMN Tables

- page_id: `290030985`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030985/BPMN+Tables
- version_number: 2
- version_date: `2026-02-23T14:20:28.613+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts
- labels: []
...
<!--NOMAGIC_PAGE id=290031038 space=CBMP2024xR2 version=1 -->
## PAGE 00026: BPMN2 Correctness (Active) Validation Rules

- page_id: `290031038`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031038/BPMN2+Correctness+Active+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031039 space=CBMP2024xR2 version=1 -->
## PAGE 00027: BPMN2 Correctness Validation Rules

- page_id: `290031039`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031039/BPMN2+Correctness+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031041 space=CBMP2024xR2 version=1 -->
## PAGE 00028: BPMN2 Export Completeness Validation Rules

- page_id: `290031041`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031041/BPMN2+Export+Completeness+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030889 space=CBMP2024xR2 version=2 -->
## PAGE 00029: BPMN2 XML support

- page_id: `290030889`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030889/BPMN2+XML+support
- version_number: 2
- version_date: `2026-02-23T14:20:22.210+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts
- labels: []
...
````html
<p>Cameo Business Modeler supports exporting BPMN2 models as BPMN2 Diagram Interchange files. The BPMN2 Diagram Interchange is a format for interchanging BPMN2 diagrams between tools. Its reduced ambiguity allows the users to exchange BPMN models between tools more conveniently. You can export a BPMN2 diagram as a BPMN2 Diagram Interchange file (BPMN2 XMI).</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Exporting+Models+to+BPMN2" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Exporting Models to BPMN2</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030844 space=CBMP2024xR2 version=2 -->
## PAGE 00030: BPMNMessage

- page_id: `290030844`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030844/BPMNMessage
- version_number: 2
- version_date: `2026-02-23T14:20:19.475+01:00`
...
````html
<p><strong style="letter-spacing: 0.0px;">Description</strong></p><p>A BPMNMessage represents the content of communications between two participants. It is passed by a message flow and is sent or received by a message event.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="message.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="BPMNMessage" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Message+Flow">Message Flow</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Task" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Choreography Task</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Message+Flow">Creating and Using Message Flow</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Choreography+Task" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using Choreography Task</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030972 space=CBMP2024xR2 version=1 -->
## PAGE 00031: BPMNRelationships

- page_id: `290030972`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030972/BPMNRelationships
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030948 space=CBMP2024xR2 version=2 -->
## PAGE 00032: Business Data Diagram

- page_id: `290030948`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030948/Business+Data+Diagram
- version_number: 2
- version_date: `2026-02-23T14:20:25.599+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts
- labels: []
...
<!--NOMAGIC_PAGE id=290030910 space=CBMP2024xR2 version=2 -->
## PAGE 00035: Business Policy

- page_id: `290030910`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030910/Business+Policy
- version_number: 2
- version_date: `2026-02-23T14:20:23.495+01:00`
...
````html
<p><strong>Description</strong></p><p>A Business Policy is a Directive that is not directly enforceable whose purpose is to govern or guide the enterprise. Business Policies provide the basis for Business Rules. Business Policies also govern Business Processes.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="business_policy.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Means+Concepts">Means Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Mean+Concept+Relationships">Mean Concept Relationships</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030620 space=CBMP2024xR2 version=1 -->
## PAGE 00036: Business Process Model and Notation (BPMN) standard

- page_id: `290030620`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030620/Business+Process+Model+and+Notation+BPMN+standard
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030627 space=CBMP2024xR2 version=1 -->
## PAGE 00037: Business Process Model and Notation Concepts

- page_id: `290030627`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030627/Business+Process+Model+and+Notation+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030912 space=CBMP2024xR2 version=2 -->
## PAGE 00038: Business Rule

- page_id: `290030912`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030912/Business+Rule
- version_number: 2
- version_date: `2026-02-23T14:20:23.652+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Means Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Business Rule is a Directive, intended to govern, guide, or influence business behavior, in support of Business Policy that has been formulated in response to an Opportunity, Threat, Strength, or Weakness. It is a single Directive that does not require additional interpretation to undertake Strategies or Tactics. Often, a Business Rule is derived from Business Policy. Business Rules guide Business Processes.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="business_rule.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Means+Concepts">Means Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Mean+Concept+Relationships">Mean Concept Relationships</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030668 space=CBMP2024xR2 version=1 -->
## PAGE 00039: Business Rule Task

- page_id: `290030668`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030668/Business+Rule+Task
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030873 space=CBMP2024xR2 version=2 -->
## PAGE 00041: Call Choreography

- page_id: `290030873`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030873/Call+Choreography
- version_number: 2
- version_date: `2026-02-23T14:20:21.129+01:00`
...
````html
<p><strong>Description</strong></p><p>A Call Choreography identifies the point in a process where a global choreography is used. It acts as a place holder to include a choreography element it is calling.</p><p>A Call Choreography is with a thick border.</p><p><strong>Notation</strong></p><ul><li>Call Choreography<br /><ac:image><ri:attachment ri:filename="call_choreography.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Call Choreography" /></ri:attachment></ac:image></li><li>A Call Choreography referencing another Choreography is marked with a plus (+) sign<br /><ac:image><ri:attachment ri:filename="call_choreography_ref.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Call Choreography" /></ri:attachment></ac:image></li></ul><p><br /></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Choreography</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+Call+Choreography+Activity">Creating Call Choreography Activity</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030850 space=CBMP2024xR2 version=2 -->
## PAGE 00042: Call Conversation

- page_id: `290030850`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030850/Call+Conversation
- version_number: 2
- version_date: `2026-02-23T14:20:19.957+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Call Conversation identifies a place in a conversation where a Conversation is used.</p><p><strong>Notation</strong></p><ul><li>Call Conversation that does not call any conversation<br /><ac:image><ri:attachment ri:filename="call_conversation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Call Conversation" /></ri:attachment></ac:image></li><li>Call Conversation calling Global Conversation<br /><ac:image><ri:attachment ri:filename="call_conversation_global.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Call Conversation" /></ri:attachment></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Collaboration">Collaboration</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Conversation+Link">Conversation Link</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Conversation+Nodes">Creating and Using Conversation Nodes</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030613 space=CBMP2024xR2 version=1 -->
## PAGE 00043: Cameo Business Modeler Plugin Documentation

- page_id: `290030613`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030613/Cameo+Business+Modeler+Plugin+Documentation
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030764 space=CBMP2024xR2 version=2 -->
## PAGE 00044: Cancel Boundary Event

- page_id: `290030764`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030764/Cancel+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.096+01:00`
...
````html
<p><strong>Description</strong></p><p>A Cancel Boundary Event is used within a Transaction SubProcess.</p><p>This type of Event must be attached to the boundary of a SubProcess and will be triggered if the following conditions are satisfied:</p><ul><li>A Cancel End Event is reached within the Transaction SubProcess.</li><li>A Transaction Protocol Cancel message is received while a transaction is being performed.</li></ul><p>A Cancel Boundary Event always interrupts the Activity to which it is attached. The boundary of the event is always solid.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="boundary_event_cancel.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Cancel Boundary Event" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030789 space=CBMP2024xR2 version=1 -->
## PAGE 00045: Cancel End Event

- page_id: `290030789`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030789/Cancel+End+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Choreography is a container for a BPMN Choreography diagram and its elements.</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030859 space=CBMP2024xR2 version=2 -->
## PAGE 00047: Choreography Activities

- page_id: `290030859`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030859/Choreography+Activities
- version_number: 2
- version_date: `2026-02-23T14:20:20.690+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Choreography Diagram
- labels: []
...
````html
<p style="margin-top: 10.0px;"><strong>Description</strong></p><p>A Choreography Task is an atomic Activity in a choreography process. It represents one or more messages exchanged between two Participants.A Choreography Task can display messages that are defined by the referenced Message Flows. The messages connected to an Initiating Participant compartment are white and those connected to a Non-Initiating Participant compartment are gray.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="choreography_task.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Choreography Task" /></ri:attachment></ac:image><br /><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="choreography_example_I.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Choreography Task" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Choreography task corresponding to BPMN Collaboration diagram.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Choreography+Task" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using Choreography Task</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Choreography+Activity" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using Choreography Activity</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030950 space=CBMP2024xR2 version=2 -->
## PAGE 00049: Class

- page_id: `290030950`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030950/Class
- version_number: 2
- version_date: `2026-02-23T14:20:25.757+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Data Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Class element represents data or a concept that is related to problem area and is used by business processes. To define more information about a class, you can add class properties for the class.</p><p><strong>Notation</strong></p><ul><li>Class<br /><ac:image><ri:attachment ri:filename="class.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Class" /></ri:attachment></ac:image></li><li>Class with properties<br /><ac:image><ri:attachment ri:filename="class_with_properties.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Class" /></ri:attachment></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Association">BPMN Association</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Generalization">Generalization</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Data+Object" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Data Object</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Data+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Data Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Business+Data+Description+Table">BPMN Business Data Description Table</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Data+Usage+Matrices">BPMN Data Usage Matrices</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030834 space=CBMP2024xR2 version=2 -->
## PAGE 00050: Collaboration

- page_id: `290030834`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030834/Collaboration
- version_number: 2
- version_date: `2026-02-23T14:20:18.885+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Collaboration element provides a description of collaborations between pools. This element is a container for a BPMN Collaboration diagram and its elements.</p><p><br /></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Participant">Participant</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030628 space=CBMP2024xR2 version=1 -->
## PAGE 00051: Common BPMN Elements

- page_id: `290030628`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030628/Common+BPMN+Elements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030827 space=CBMP2024xR2 version=2 -->
## PAGE 00052: Compensation

- page_id: `290030827`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030827/Compensation
- version_number: 2
- version_date: `2026-02-23T14:20:18.639+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Compensation in business process modeling is concerned with undoing steps that have already been successfully completed because their results and possible side effects are no longer desired and need to be reversed. If an Activity is still active, it cannot be compensated and needs to be canceled. The cancellation of a SubProcess can produce a compensation of the already successfully completed portions of an active Activity.</p><p>A Compensation is performed by a compensation handler. A compensation handler performs the steps necessary to reverse the effects of an Activity. For a SubProcess, the compensation handler will have access to the SubProcess data once they have been completed (“snapshot data”).</p><p>A compensation handler is a set of Activities that is not connected to other portions of the BPMN model. The compensation handler starts with either of the Compensation Events:</p><ul><li>Compensation Boundary Event </li><li>The handler’s Start Event (in case of a Compensation Event SubProcess)</li></ul><p>A compensation handler connected through a boundary event can only perform a “black-box” compensation of the original Activity. This compensation is modeled with a specialized Compensation Activity, which is connected to the boundary event through an association. The Compensation Activity, which can be either a Task or a SubProcess, is marked to show that it is used for compensation only and is located outside the normal flow of the Process.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="compensation_handler_I.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Compensation" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Compensation handler connected through Compensation Boundary Event.</h6><p>Another way to model a compensation is using a compensation handler, which starts with a Start Event of an Event SubProcess that is contained within a Process or SubProcess. Just like any other Compensation Activities, a Compensation Event SubProcess is located outside the normal flow of a process. The Event SubProcess, which is marked with a dotted line boundary, has access to data that are part of the parent, which is a snapshot at the point in time when the parent has been completed. A Compensation Event SubProcess can recursively trigger a compensation for activities contained in its parent.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="compensation_handler_II.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Compensation" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Compensation defined by Event SubProcess.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/SubProcesses">SubProcesses</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Compensation+Start+Event">Compensation Start Event</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Escalation+Throwing+Intermediate+Event">Escalation Throwing Intermediate Event</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Compensation+Boundary+Event">Compensation Boundary Event</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Association">Association</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Activities">Using Activities</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030766 space=CBMP2024xR2 version=2 -->
## PAGE 00053: Compensation Boundary Event

- page_id: `290030766`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030766/Compensation+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.192+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030745 space=CBMP2024xR2 version=2 -->
## PAGE 00056: Compensation Throwing Intermediate Event

- page_id: `290030745`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030745/Compensation+Throwing+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:15.452+01:00`
...
````html
<p><strong>Description</strong></p><p>A Compensation Throwing Intermediate Event indicates that a compensation is necessary.</p><p>If an Activity, which has been successfully completed, is identified, then it will be compensated.</p><p>If no Activity is identified, all successfully completed Activities visible from a Compensation Throwing Intermediate Event will be compensated in reverse order of their sequence flows. To be compensated, the Activity must have a Boundary Compensation Event or contain a Compensation Event SubProcess.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_throwing_event_compensation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Compensation Throwing Intermediate Event" /></ri:attachment></ac:image></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Compensation" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Compensation</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030813 space=CBMP2024xR2 version=2 -->
## PAGE 00057: Complex Gateway

- page_id: `290030813`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030813/Complex+Gateway
- version_number: 2
- version_date: `2026-02-23T14:20:18.058+01:00`
...
````html
<p><strong>Description</strong></p><p>A Complex Gateway can be used to model complex synchronization behavior. An Activation Condition is the Complex Gateway’s property, which is used to describe precise behavior.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="gateway_complex.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Complex Gateway" /></ri:attachment></ac:image></p><p><strong>Example</strong></p><p>The activation condition specifies that tokens on three out of five incoming sequence flows are needed to activate the gateway. Which token the Gateway will produce is determined by the conditions on the outgoing sequence flow as in the split behavior of an Inclusive Gateway</p><p><ac:image ac:align="center"><ri:attachment ri:filename="complex_gateway.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Complex Gateway" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Complex Gateway.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Gateways">Gateways</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030968 space=CBMP2024xR2 version=2 -->
## PAGE 00058: Composition

- page_id: `290030968`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030968/Composition
- version_number: 2
- version_date: `2026-02-23T14:20:27.247+01:00`
...
````html
<p><strong>Description</strong></p><p>A Composition is a key relationship that shows how organization structure is composed. For example, one organization unit can be a part of a parent organization.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="composition.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Composition" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Information+system">Information system</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Structure+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Organization Structure Diagram</a></li></ul><p><strong>Related Procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Organization+Structure+Diagram">Using Organization Structure Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030768 space=CBMP2024xR2 version=2 -->
## PAGE 00059: Conditional Boundary Event

- page_id: `290030768`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030768/Conditional+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.293+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Conditional Boundary Event is triggered when a specified condition becomes true. When the event is triggered, it will change a normal flow of a Process into an exception flow.</p><p>This event displays either of the following on a diagram:</p><ul><li>A Conditional Catching Intermediate Event name if the name is specified.</li><li>A Conditional property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Conditional Boundary Event" /></ri:attachment></ac:image></li><li>Non-interrupting Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional_false.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Conditional Boundary Event" /></ri:attachment></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030727 space=CBMP2024xR2 version=2 -->
## PAGE 00060: Conditional Catching Intermediate Event

- page_id: `290030727`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030727/Conditional+Catching+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:14.520+01:00`
...
````html
<p><strong>Description</strong></p><p>A Consecutive with Owner Number numbering schema provides non-multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is displayed before the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_I.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Consecutive with Owner Number" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Consecutive Numbering style with element owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030885 space=CBMP2024xR2 version=2 -->
## PAGE 00063: Consecutive without Owner Number

- page_id: `290030885`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030885/Consecutive+without+Owner+Number
- version_number: 2
- version_date: `2026-02-23T14:20:21.823+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > Numbering Elements > Numbering Schemas
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Consecutive without Owner Number numbering schema provides non-multilevel element numbering. An Element Owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_II.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Consecutive without Owner Number" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Consecutive numbering style without owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030846 space=CBMP2024xR2 version=2 -->
## PAGE 00064: Conversation

- page_id: `290030846`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030846/Conversation
- version_number: 2
- version_date: `2026-02-23T14:20:19.646+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Conversation is an atomic element for a BPMN Collaboration diagram. It represents a set of message flows that is grouped together.</p><p>A Conversation can involve two or more Participants. A Conversation Link path will be from a Conversation to the involved Participants (Pools).</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="conversation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Conversation" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Conversation+Link">Conversation Link</a></li></ul><p><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Conversation+Nodes">Creating and Using Conversation Nodes</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030853 space=CBMP2024xR2 version=2 -->
## PAGE 00065: Conversation Link

- page_id: `290030853`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030853/Conversation+Link
- version_number: 2
- version_date: `2026-02-23T14:20:20.096+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Conversation Link is used to connect conversation nodes (Communication, SubConversation, and Call Conversation) to and from Participants (Pools).</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="conversation_link.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Conversation Link" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Conversation Link notation.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Collaboration">Collaboration</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/SubConversation" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">SubConversation</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Call+Conversation">Call Conversation</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Conversation" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Conversation</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031002 space=CBMP2024xR2 version=2 -->
## PAGE 00066: Creating a Diagram

- page_id: `290031002`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031002/Creating+a+Diagram
- version_number: 2
- version_date: `2026-02-23T14:20:30.249+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin
- labels: []

### NORMALIZED CONTENT

true[CONFLUENCE_PAGE title='Creating diagrams' space='MD2024xR2']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="eae4f08c-e6c8-4d47-b6d5-e0142ef9ec86"><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:space-key="MD2024xR2" ri:content-title="Creating diagrams" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=290031008 space=CBMP2024xR2 version=2 -->
## PAGE 00067: Creating and Using a BPMNEvent

- page_id: `290031008`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031008/Creating+and+Using+a+BPMNEvent
- version_number: 2
- version_date: `2026-02-23T14:20:31.572+01:00`
...
- [CONFLUENCE_PAGE title='Data Object' space='CBMP2024xR2']
- [CONFLUENCE_PAGE title='Data Store' space='CBMP2024xR2']
- [CONFLUENCE_PAGE title='Data Input and Data Output' space='CBMP2024xR2']
...
````html
<p><br /></p><p style="margin-top: 0.0px;"><strong>Description</strong></p><p>A Data Association is used to model how data are pushed into or pulled from item-aware elements. Tokens do not flow along a Data Association. Therefore, they have no direct effect on the flow of a process.</p><p>Alternatively, Data Objects can be directly associated with a Sequence Flow to represent the same input or output Data Associations. This is a visual shortcut that is stored in a model as two Data Associations</p><ul><li>from Activity to Data Object</li><li>from Data Object to Activity</li></ul><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="data_association_ flow_data_object.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Data Association" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Data Association showing flow of Data Object.</h6><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Data+Object">Data Object</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Data+Store">Data Store</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Data+Input+and+Data+Output">Data Input and Data Output</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Data+Items">Creating and Using Data Items</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030822 space=CBMP2024xR2 version=2 -->
## PAGE 00081: Data Input and Data Output

- page_id: `290030822`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030822/Data+Input+and+Data+Output
- version_number: 2
- version_date: `2026-02-23T14:20:18.409+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Items and Data
- labels: []
...
````html
<p><strong>Description</strong></p><p>Activities and processes often require data in order to execute. In addition, they may produce data during or as the result of the execution.Data requirements are captured as Data Input. The produced data are captured using a Data Output notation.</p><p><strong>Notation</strong></p><ul><li>Data Input<br /><ac:image><ri:attachment ri:filename="data_imput.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Data Input and Data Output" /></ri:attachment></ac:image></li><li>Data Output<br /><ac:image><ri:attachment ri:filename="data_output.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Data Input and Data Output" /></ri:attachment></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Data+Association">Data Association</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Data+Items" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Creating and Using Data Items</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030817 space=CBMP2024xR2 version=2 -->
## PAGE 00082: Data Object

- page_id: `290030817`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030817/Data+Object
- version_number: 2
- version_date: `2026-02-23T14:20:18.189+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Items and Data
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Dependency indicates a semantic relationship between two model elements (or two sets of model elements). Dependency indicates a situation in which a change to a supplier (target) element may require a change to a client (source) element in the dependency.</p><p>A Dependency is shown as a dashed arrow between model elements. The model element at the start point of the arrow (the client element) depends on the model element at the arrowhead (the supplier element). The arrow can be labeled with an optional individual name.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="dependency.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Dependency" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030887 space=CBMP2024xR2 version=2 -->
## PAGE 00086: Element Types Numbering Sequence

- page_id: `290030887`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030887/Element+Types+Numbering+Sequence
- version_number: 2
- version_date: `2026-02-23T14:20:21.963+01:00`
...
<!--NOMAGIC_PAGE id=290030900 space=CBMP2024xR2 version=2 -->
## PAGE 00087: End Concept Relationships

- page_id: `290030900`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030900/End+Concept+Relationships
- version_number: 2
- version_date: `2026-02-23T14:20:22.901+01:00`
...
<!--NOMAGIC_PAGE id=290030893 space=CBMP2024xR2 version=1 -->
## PAGE 00089: Ends Concepts

- page_id: `290030893`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030893/Ends+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030641 space=CBMP2024xR2 version=1 -->
## PAGE 00090: Error

- page_id: `290030641`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030641/Error
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030762 space=CBMP2024xR2 version=2 -->
## PAGE 00091: Error Boundary Event

- page_id: `290030762`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030762/Error+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:15.965+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030927 space=CBMP2024xR2 version=2 -->
## PAGE 00103: External Influencer

- page_id: `290030927`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030927/External+Influencer
- version_number: 2
- version_date: `2026-02-23T14:20:24.045+01:00`
...
<!--NOMAGIC_PAGE id=290030955 space=CBMP2024xR2 version=2 -->
## PAGE 00105: Generalization

- page_id: `290030955`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030955/Generalization
- version_number: 2
- version_date: `2026-02-23T14:20:26.061+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Data Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Generalization link shows that one class provides grouping criteria for sets of other classes. Generic class may define sets of properties, that are applicable to all the specific classes. The Generalization link can be among classes.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="generalization.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Generalization" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Data+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Data Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030618 space=CBMP2024xR2 version=1 -->
## PAGE 00106: Getting Started

- page_id: `290030618`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030618/Getting+Started
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030896 space=CBMP2024xR2 version=2 -->
## PAGE 00107: Goal

- page_id: `290030896`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030896/Goal
- version_number: 2
- version_date: `2026-02-23T14:20:22.624+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Ends Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>Unlike vision, a goal should generally be attainable and should be more specifically oriented to a single aspect of the business problem. A Goal is a statement about a state or condition of the enterprise to be brought about or sustained through appropriate Means. A Goal amplifies a Vision.It indicates what must be satisfied on a continuing basis to effectively attain the Vision.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="goal.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Goal" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Ends+Concepts" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Ends Concepts</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/End+Concept+Relationships" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030979 space=CBMP2024xR2 version=2 -->
## PAGE 00108: Governs

- page_id: `290030979`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030979/Governs
- version_number: 2
- version_date: `2026-02-23T14:20:28.074+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Process Definition Diagram > BPMNRelationships
- labels: []
...
````html
<p><strong>Description</strong></p><p>Governs shows that a Business Policy governs BPMN Process.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="governs_process.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Governs" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030639 space=CBMP2024xR2 version=1 -->
## PAGE 00109: Group

- page_id: `290030639`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030639/Group
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030981 space=CBMP2024xR2 version=2 -->
## PAGE 00110: Guides

- page_id: `290030981`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030981/Guides
- version_number: 2
- version_date: `2026-02-23T14:20:28.238+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Process Definition Diagram > BPMNRelationships
- labels: []
...
````html
<p><strong>Description</strong></p><p>Guides shows that a Business Rule guides a BPMN Process.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="guides.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Guides" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Strategy">Strategy</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Tactic" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Tactic</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Policy" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Policy</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Rule">Business Rule</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030804 space=CBMP2024xR2 version=2 -->
## PAGE 00111: Inclusive Gateway

- page_id: `290030804`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030804/Inclusive+Gateway
- version_number: 2
- version_date: `2026-02-23T14:20:17.726+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Gateways
- labels: []
...
````html
<p>The following table provides the relationship that exists between element types and the meaning.</p><table class="wrapped"><colgroup><col /><col /><col /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td>Is Source Of </td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Influencing Organization" /></ac:link> to an Influencer (<ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Internal Influencer" /></ac:link>).<br />Meaning that the Influencing Organization is the source of Influencer. An Influencer may have multiple sources, or<br />none.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="is_source_of.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Influence Concepts Relationship" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Influencer+Concepts">Influencer Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030926 space=CBMP2024xR2 version=1 -->
## PAGE 00113: Influencer Concepts

- page_id: `290030926`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030926/Influencer+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030931 space=CBMP2024xR2 version=2 -->
## PAGE 00114: Influencing Organization

- page_id: `290030931`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030931/Influencing+Organization
- version_number: 2
- version_date: `2026-02-23T14:20:24.347+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Influencer Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>An Information System is a type of hardware or a software, e. g., international sales system, ticket reservation system, etc. Information system can be used by Process or Process Activity.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="information_system.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Information system" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Structure+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Organization Structure Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Resources+Usage+Matrices">BPMN Resources Usage Matrices</a></li></ul><p><strong>Related Procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Organization+Structure+Diagram">Using Organization Structure Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030616 space=CBMP2024xR2 version=2 -->
## PAGE 00116: Installation, licensing, and system requirements

- page_id: `290030616`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030616/Installation+licensing+and+system+requirements
- version_number: 2
- version_date: `2026-02-23T14:18:55.004+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation
- labels: []

### NORMALIZED CONTENT

For information regarding installation, licensing, and system requirements, visit the [CONFLUENCE_PAGE title='Installation, Licensing, and System Requirements Documentation' space='IL2024xR2'] page.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>For information regarding installation, licensing, and system requirements, visit the <ac:link><ri:page ri:space-key="IL2024xR2" ri:content-title="Installation, Licensing, and System Requirements Documentation" /><ac:plain-text-link-body><![CDATA[Installation, licensing, and system requirements]]></ac:plain-text-link-body></ac:link> page.</p>
````

<!--NOMAGIC_PAGE id=290030720 space=CBMP2024xR2 version=1 -->
## PAGE 00117: Intermediate Catch Event

- page_id: `290030720`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030720/Intermediate+Catch+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030738 space=CBMP2024xR2 version=1 -->
## PAGE 00118: Intermediate Throwing Event

- page_id: `290030738`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030738/Intermediate+Throwing+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030929 space=CBMP2024xR2 version=2 -->
## PAGE 00119: Internal Influencer

- page_id: `290030929`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030929/Internal+Influencer
- version_number: 2
- version_date: `2026-02-23T14:20:24.194+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Influencer Concepts
- labels: []
...
<!--NOMAGIC_PAGE id=290030816 space=CBMP2024xR2 version=1 -->
## PAGE 00121: Items and Data

- page_id: `290030816`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030816/Items+and+Data
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030729 space=CBMP2024xR2 version=2 -->
## PAGE 00122: Link Catching Intermediate Event

- page_id: `290030729`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030729/Link+Catching+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:14.632+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Intermediate Catch Event
- labels: []
...
````html
<p style="margin-top: 10.0px;">The following table provides the relationships that exist between element types and their meaning.</p><table class="wrapped relative-table" style="width: 1931.61px;"><colgroup><col style="width: 334.094px;" /><col style="width: 1057.38px;" /><col style="width: 539.141px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td><strong>Makes Operative </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mission" /><ac:plain-text-link-body><![CDATA[ Mission ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Vision" /></ac:link>. Meaning that the Mission lists every continuing<br />Activity to ensure the Vision.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="makes_operative.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Component Of </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[ Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mission" /></ac:link>. Meaning that the Strategy is the method or<br />course of action that will be employed to achieve the Mission.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="component_of.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Implements </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /></ac:link>. Meaning that the Tactic realizes Strategies.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="implements.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Enables </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link>. Meaning that a Strategy/<br />Tactic makes another Strategy/Tactic doable. That is to say the latter Strategy/Tactic<br />provides an opportunity for the former Strategy/Tactic to be carried out. Use this link<br />to associate Strategy to another Strategy or Tactic to another Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="enables.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Effects Enforcement Level </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link>. Meaning that the Tactics influences the</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="effects_enforcement_level.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Formulated Based On </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link>. Meaning<br />that the Strategy or Tactic is planned according to what result the Business Policy or<br />Business Rule desires.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="formulated based on.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Channel Efforts Towards </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link> to an <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Objective" /></ac:link>. Meaning that the Strategy is<br />coordinated as activities aimed towards Goals as Tactic towards Objective. For example, the<br />Tactic “Free delivery” channels efforts towards the Objective “5% increase in sales within 3<br />months.”</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="channel_effort_towards.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Governs </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Tactic" /></ac:link>. Meaning that the Business Policy or BusinessRule determines the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="governs.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Basis For </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link>. Meaning that the Business Policy is the key to achieve Business Rule.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="basis_for.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Supports Achievement Of </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Goal" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Objective" /></ac:link>. Meaning that the Business Policy provides an<br />idea or reason to develop the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="supports_achievement_of.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td colspan="1"><strong>Acts As Regulation </strong></td><td colspan="1"><p>This link connects a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Policy" /></ac:link> or a <ac:link><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Business Rule" /></ac:link> to External Influencer.</p></td><td colspan="1"><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="acts_as_regulation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Means+Concepts">Means Concepts</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030903 space=CBMP2024xR2 version=1 -->
## PAGE 00126: Means Concepts

- page_id: `290030903`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030903/Means+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030753 space=CBMP2024xR2 version=1 -->
## PAGE 00127: Message Boundary Event

- page_id: `290030753`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030753/Message+Boundary+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Message End Event indicates that a message will be sent when a process is completed.</p><p>This event displays any of the following on a diagram:</p><ul><li>A Message End Event name if the name is specified.</li><li>A Message Ref property value if the name is unspecified.</li><li>An Operation Ref property if the name and Message Ref are not specified.</li></ul><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event_message.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Message End Event" /></ri:attachment></ac:image></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/End+Events">End Events</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Message">Message</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul><p><br /></p><p />
````

<!--NOMAGIC_PAGE id=290030840 space=CBMP2024xR2 version=2 -->
## PAGE 00130: Message Flow

- page_id: `290030840`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030840/Message+Flow
- version_number: 2
- version_date: `2026-02-23T14:20:19.212+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Message Flow is used to show the flow of messages between two participants who are prepared to send and receive them.</p><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="a22639dc-1888-49e6-b405-3b6ece737c90"><ac:rich-text-body><ul><li>A Message Flow must connect separate Pools. It can be connected to the pool boundary or an element inside the pool.</li><li>A Message Flow cannot connect two elements in the same Pool.</li></ul></ac:rich-text-body></ac:structured-macro><p>Messages that are sent by a Message Flow can be displayed on a diagram in two ways:</p><ul><li>overlapping the Message Flow</li><li>associated with the Message Flow</li></ul><p>However, they can also be hidden.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="collaboration_I.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Message Flow" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Message Flows between two pools.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="message_flow_overlapping.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Message Flow" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Messages overlapping Message Flows.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="collaboration_II.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Message Flow" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Message Flows between Pools Inner elements.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane">Pool and Lane</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030695 space=CBMP2024xR2 version=1 -->
## PAGE 00131: Message Start Event

- page_id: `290030695`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030695/Message+Start+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031035 space=CBMP2024xR2 version=1 -->
## PAGE 00133: Migrating from BPMN 1.1

- page_id: `290031035`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031035/Migrating+from+BPMN+1.1
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031036 space=CBMP2024xR2 version=1 -->
## PAGE 00134: Migrating to UML Profile for BPMN2 v1.0

- page_id: `290031036`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031036/Migrating+to+UML+Profile+for+BPMN2+v1.0
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031034 space=CBMP2024xR2 version=1 -->
## PAGE 00135: Migration

- page_id: `290031034`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031034/Migration
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030904 space=CBMP2024xR2 version=2 -->
## PAGE 00136: Mission

- page_id: `290030904`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030904/Mission
- version_number: 2
- version_date: `2026-02-23T14:20:23.070+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Means Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Mission indicates the ongoing operational Activity of the enterprise. The Mission describes what the business is or will be doing on a day-to-day basis.</p><p>A Mission makes a Vision operative. It indicates the ongoing Activity that makes the Vision a reality. A Mission is planned by means of Strategies.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="mission.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Mission" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Means+Concepts">Means Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Mean+Concept+Relationships">Mean Concept Relationships</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=290031029 space=CBMP2024xR2 version=2 -->
## PAGE 00137: Modifying BPMN Matrices

- page_id: `290031029`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031029/Modifying+BPMN+Matrices
- version_number: 2
- version_date: `2026-02-23T14:20:35.509+01:00`
...
````html
<p><strong>Description</strong></p><p>A Multilevel without Owner Number numbering schema provides multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center" ac:height="250"><ri:attachment ri:filename="element_numbering_multilevel_II.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Multilevel without Owner Number" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Multilevel Numbering style without element owner number.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="47f86cd7-cfac-410d-a52b-3266d8d1fbfe"><ac:rich-text-body><p>When a Multilevel without element number numbering schema is used, the numbers in a project are not unique. Elements with the same number can exist in multiple diagrams.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030774 space=CBMP2024xR2 version=2 -->
## PAGE 00141: Multiple Boundary Event

- page_id: `290030774`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030774/Multiple+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.500+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030797 space=CBMP2024xR2 version=2 -->
## PAGE 00143: Multiple End Event

- page_id: `290030797`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030797/Multiple+End+Event
- version_number: 2
- version_date: `2026-02-23T14:20:17.482+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > End Events
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Multiple Start Event indicates that there are multiple ways to trigger a process. However, only one is required.</p><p><strong>Notation</strong></p><ul><li>Interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_interr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Multiple Start Event" /></ri:attachment></ac:image></li><li>Non-interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_noninterr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Multiple Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030749 space=CBMP2024xR2 version=2 -->
## PAGE 00145: Multiple Throwing Intermediate Event

- page_id: `290030749`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030749/Multiple+Throwing+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:15.661+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Intermediate Throwing Event
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Multiple Throwing Intermediate Event signifies that multiple types of events are thrown. All of the defined triggers will be thrown by this event.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_throwing_event_multiple.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Multiple Throwing Intermediate Event" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031014 space=CBMP2024xR2 version=2 -->
## PAGE 00146: Navigation Between BPMN Diagrams

- page_id: `290031014`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031014/Navigation+Between+BPMN+Diagrams
- version_number: 2
- version_date: `2026-02-23T14:20:32.327+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin > Using BPMN Process Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined result.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="None End Event" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030721 space=CBMP2024xR2 version=2 -->
## PAGE 00148: None Intermediate Event

- page_id: `290030721`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030721/None+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:14.263+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Intermediate Catch Event
- labels: []
...
<!--NOMAGIC_PAGE id=290030693 space=CBMP2024xR2 version=1 -->
## PAGE 00149: None Start Event

- page_id: `290030693`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030693/None+Start+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined trigger that invokes the start of a process.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="start_event.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="None Start Event" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290030876 space=CBMP2024xR2 version=1 -->
## PAGE 00150: Numbering Elements

- page_id: `290030876`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030876/Numbering+Elements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030898 space=CBMP2024xR2 version=2 -->
## PAGE 00152: Objective

- page_id: `290030898`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030898/Objective
- version_number: 2
- version_date: `2026-02-23T14:20:22.761+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Ends Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>An Organization Structure Diagram represents the hierarchical structure of an organization. This diagram allows showing organization departments, roles inside departments, and actual persons inside an organization. The diagram can also represent the reporting structure of an organization.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="organization_structure_diagram.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Organization Structure Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Organization Structure diagram.</h6><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul class="childpages-macro"><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Information+system">Information system</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Composition">Composition</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030960 space=CBMP2024xR2 version=2 -->
## PAGE 00154: Organization Unit

- page_id: `290030960`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030960/Organization+Unit
- version_number: 2
- version_date: `2026-02-23T14:20:26.558+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Organization Structure Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>An organization represents a group of persons, associated for a particular purpose. An Element may denote an organization, a department, or a working group inside an organization. e. g., the company, sale department, etc. This element is combined with the Participant definition.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="organization_unit.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Organization Unit" /></ri:attachment></ac:image></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Information+system">Information system</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Structure+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Organization Structure Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Resources+Usage+Matrices">BPMN Resources Usage Matrices</a></li></ul><p><strong>Related Procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Organization+Structure+Diagram">Using Organization Structure Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030983 space=CBMP2024xR2 version=2 -->
## PAGE 00155: Package

- page_id: `290030983`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030983/Package
- version_number: 2
- version_date: `2026-02-23T14:20:28.447+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Process Definition Diagram
- labels: []
...
<!--NOMAGIC_PAGE id=290030807 space=CBMP2024xR2 version=2 -->
## PAGE 00156: Parallel Gateway

- page_id: `290030807`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030807/Parallel+Gateway
- version_number: 2
- version_date: `2026-02-23T14:20:17.831+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Gateways
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Parallel Gateway is used to synchronize (combine) and create parallel flows.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="gateway_parallel.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Parallel Gateway" /></ri:attachment></ac:image></p><p><strong>Example</strong></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Parallel_gateway.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Parallel Gateway" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Parallel Gateway.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Gateways">Gateways</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030777 space=CBMP2024xR2 version=2 -->
## PAGE 00157: Parallel Multiple Boundary Event

- page_id: `290030777`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030777/Parallel+Multiple+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.601+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Parallel Multiple Start Event indicates that there are multiple triggers required before a process can be initiated.</p><p><strong>Notation</strong></p><ul><li>Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_interr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Parallel Multiple Start Event" /></ri:attachment></ac:image></li><li>Non-Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_noninterr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Parallel Multiple Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030855 space=CBMP2024xR2 version=2 -->
## PAGE 00160: Participant

- page_id: `290030855`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030855/Participant
- version_number: 2
- version_date: `2026-02-23T14:20:20.260+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Participant represents a specific partner entity, such as a company and a more general partner role, for example, a buyer, seller, or manufacturer who is a participant in a collaboration. A Participant is often responsible for the execution of a process enclosed in a pool.</p><p>Participant element can be contained only in Collaboration or Choreography and represent Resource.</p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Conversation" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Conversation</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+BPMN+Collaboration+Diagram">Using BPMN Collaboration Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+and+Using+Pool+and+Lanes">Creating and Using Pool and Lanes</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030964 space=CBMP2024xR2 version=2 -->
## PAGE 00161: Person

- page_id: `290030964`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030964/Person
- version_number: 2
- version_date: `2026-02-23T14:20:26.901+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Organization Structure Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Person is a type of human that is recognized by law as the subject of rights and duties. This element is combined with the Resource Role definition.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="person.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Person" /></ri:attachment></ac:image></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Resource">Resource</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Information+system">Information system</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Pool+and+Lane" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Pool and Lane</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Activities">Activities</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Structure+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Organization Structure Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Resources+Usage+Matrices">BPMN Resources Usage Matrices</a></li></ul><p><strong>Related Procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Organization+Structure+Diagram">Using Organization Structure Diagram</a></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=290030835 space=CBMP2024xR2 version=2 -->
## PAGE 00162: Pool and Lane

- page_id: `290030835`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030835/Pool+and+Lane
- version_number: 2
- version_date: `2026-02-23T14:20:19.049+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Receive Task is a simple task that is designed to wait for a message to arrive from an external participant (relative to the Process). Once the message has been received, the task is completed.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="receive_task.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Receive Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290030959 space=CBMP2024xR2 version=2 -->
## PAGE 00167: Resource

- page_id: `290030959`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030959/Resource
- version_number: 2
- version_date: `2026-02-23T14:20:26.384+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Organization Structure Diagram
- labels: []
...
<!--NOMAGIC_PAGE id=290030938 space=CBMP2024xR2 version=2 -->
## PAGE 00168: Risk

- page_id: `290030938`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030938/Risk
- version_number: 2
- version_date: `2026-02-23T14:20:25.041+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Assessment Concepts
- labels: []
...
<!--NOMAGIC_PAGE id=290030660 space=CBMP2024xR2 version=1 -->
## PAGE 00171: Send Task

- page_id: `290030660`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030660/Send+Task
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Service Task is a task that uses some sort of service, which could be a Web service or an automated application.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="service_task.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Service Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290030771 space=CBMP2024xR2 version=2 -->
## PAGE 00174: Signal Boundary Event

- page_id: `290030771`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030771/Signal+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:16.397+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030793 space=CBMP2024xR2 version=2 -->
## PAGE 00176: Signal End Event

- page_id: `290030793`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030793/Signal+End+Event
- version_number: 2
- version_date: `2026-02-23T14:20:17.259+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > End Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030711 space=CBMP2024xR2 version=1 -->
## PAGE 00177: Signal Start Event

- page_id: `290030711`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030711/Signal+Start+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Signal Start Event means that a signal, which has been broadcast from another process, has arrived and triggered the start of a process.</p><p>A Signal Start Event displays either of the following on a diagram:</p><ul><li>A Signal Start Event name if the name is specified.</li><li>A Signal Ref property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_interr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Signal Start Event" /></ri:attachment></ac:image></li><li>Non-Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_noninterr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Signal Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030743 space=CBMP2024xR2 version=2 -->
## PAGE 00178: Signal Throwing Intermediate Event

- page_id: `290030743`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030743/Signal+Throwing+Intermediate+Event
- version_number: 2
- version_date: `2026-02-23T14:20:15.324+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Intermediate Throwing Event
- labels: []
...
<!--NOMAGIC_PAGE id=290030692 space=CBMP2024xR2 version=1 -->
## PAGE 00179: Start Events

- page_id: `290030692`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030692/Start+Events
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030906 space=CBMP2024xR2 version=2 -->
## PAGE 00180: Strategy

- page_id: `290030906`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030906/Strategy
- version_number: 2
- version_date: `2026-02-23T14:20:23.212+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Means Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>A SubChoreography is a compound Activity that can include choreography activities and define their flows. It can be expanded to show its details within the choreography in which it is contained.</p><p>It can also be displayed in a collapsed view to hide its details. A collapsed SubChoreography is indicated with a plus sign (+) to distinguish itself from a Choreography Task.</p><p><strong>Notation</strong></p><p><strong><ac:image><ri:attachment ri:filename="choreography_subprocess.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="SubChoreography" /></ri:attachment></ac:image><br /></strong></p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="choreography_subprocess_expanded.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="SubChoreography" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Expanded SubChoreography.</h6><p><strong> </strong></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Organization+Unit">Organization Unit</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Role" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Role</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Person">Person</a></li><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Choreography+Activities">Choreography Activities</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedures</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/Creating+SubChoreography">Creating SubChoreography</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR2/Using+Choreography+Activity" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using Choreography Activity</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030848 space=CBMP2024xR2 version=2 -->
## PAGE 00182: SubConversation

- page_id: `290030848`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030848/SubConversation
- version_number: 2
- version_date: `2026-02-23T14:20:19.820+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Collaboration Diagram
- labels: []
...
````html
<p><strong>Description</strong></p><p>A SubProcess is used to create a context for an exception handling that applies to a group of activities.</p><p>A collapsed SubProcess can be used as a mechanism to show a compact and less clutter group of parallel activities.</p><p><strong>Notation</strong></p><ul><li>Expanded SubProcess<br /><ac:image><ri:attachment ri:filename="expanded_subprocess.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="SubProcess" /></ri:attachment></ac:image></li><li>Collapsed SubProcess<br /><ac:image><ri:attachment ri:filename="suppressed_subproces.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="SubProcess" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030672 space=CBMP2024xR2 version=1 -->
## PAGE 00184: SubProcesses

- page_id: `290030672`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030672/SubProcesses
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030622 space=CBMP2024xR2 version=2 -->
## PAGE 00185: Supportive diagrams

- page_id: `290030622`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030622/Supportive+diagrams
- version_number: 2
- version_date: `2026-02-23T14:19:33.010+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Getting Started > Introducing Main Concepts
- labels: []
...
- [CONFLUENCE_PAGE title='Process Definition Diagram' space='']
- [CONFLUENCE_PAGE title='Business Data Diagram' space='']
- [CONFLUENCE_PAGE title='Organization Structure Diagram' space='']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>Cameo Business Modeler also supports diagrams that allow for specifying additional information about business model.</p><p>The following diagrams are supported:</p><ul><li><ac:link><ri:page ri:content-title="Process Definition Diagram" /></ac:link></li><li><ac:link><ri:page ri:content-title="Business Data Diagram" /></ac:link></li><li><ac:link><ri:page ri:content-title="Organization Structure Diagram" /></ac:link></li></ul><p><br /></p>
````

<!--NOMAGIC_PAGE id=290030890 space=CBMP2024xR2 version=1 -->
## PAGE 00186: Supportive Diagrams Concepts

- page_id: `290030890`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030890/Supportive+Diagrams+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030623 space=CBMP2024xR2 version=1 -->
## PAGE 00187: Switching to Business Modeling Perspectives

- page_id: `290030623`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030623/Switching+to+Business+Modeling+Perspectives
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030908 space=CBMP2024xR2 version=2 -->
## PAGE 00188: Tactic

- page_id: `290030908`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030908/Tactic
- version_number: 2
- version_date: `2026-02-23T14:20:23.350+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Business Motivation Diagram > Means Concepts
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Task that has no specified behavior defined.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="task.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290030655 space=CBMP2024xR2 version=1 -->
## PAGE 00190: Tasks

- page_id: `290030655`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030655/Tasks
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030795 space=CBMP2024xR2 version=2 -->
## PAGE 00191: Terminate End Event

- page_id: `290030795`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030795/Terminate+End+Event
- version_number: 2
- version_date: `2026-02-23T14:20:17.359+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > End Events
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Text Annotation allows a modeler to provide additional information about elements for the reader of a BPMN diagram.</p><p><strong>Example</strong></p><p><strong><br /></strong><ac:image><ri:attachment ri:filename="text_annotation.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Text Annotation" /></ri:attachment></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=290030756 space=CBMP2024xR2 version=2 -->
## PAGE 00193: Timer Boundary Event

- page_id: `290030756`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030756/Timer+Boundary+Event
- version_number: 2
- version_date: `2026-02-23T14:20:15.763+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Business Process Model and Notation Concepts > BPMN Process Diagram > Boundary Events
- labels: []
...
<!--NOMAGIC_PAGE id=290030698 space=CBMP2024xR2 version=1 -->
## PAGE 00195: Timer Start Event

- page_id: `290030698`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030698/Timer+Start+Event
- version_number: 1
...
````html
<p>Description</p><p>A Timer Start Event allows a particular time and date or cycle setting, for example, on Mondays at 9 A.M., to trigger the start of a process.</p><p>A Timer Start Event displays any of the following on a diagram:</p><ul><li>A Timer Start Event name if the name is specified.</li><li>A Time Cycle property name if the name is unspecified.</li><li>A Time Date property if the name and Time Cycle are unspecified.</li></ul><p>Notation</p><ul><li>Interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_interr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Timer Start Event" /></ri:attachment></ac:image></li><li>Non-interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_noninterr.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Timer Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030683 space=CBMP2024xR2 version=1 -->
## PAGE 00196: Transaction

- page_id: `290030683`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030683/Transaction
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Transaction is a specialized type of SubProcess whose special behavior is controlled through a transaction protocol (such as WS-Transaction).</p><p><strong>Notation</strong></p><ul><li>Expanded<br /><ac:image><ri:attachment ri:filename="transaction.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Transaction" /></ri:attachment></ac:image></li><li>Collapsed<br /><ac:image><ri:attachment ri:filename="transaction_suppressed.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Transaction" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290030973 space=CBMP2024xR2 version=2 -->
## PAGE 00197: Usage

- page_id: `290030973`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030973/Usage
- version_number: 2
- version_date: `2026-02-23T14:20:27.573+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Supportive Diagrams Concepts > Process Definition Diagram > BPMNRelationships
- labels: []
...
````html
<p><strong>Description</strong></p><p>A Usage is a BPMNRelationship in which one element requires another element (or set of elements) for its full implementation or operation.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="use.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="Usage" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR2/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR2/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290030617 space=CBMP2024xR2 version=1 -->
## PAGE 00198: User Guide

- page_id: `290030617`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030617/User+Guide
- version_number: 1
...
<!--NOMAGIC_PAGE id=290030664 space=CBMP2024xR2 version=1 -->
## PAGE 00199: User Task

- page_id: `290030664`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290030664/User+Task
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A User Task is a typical workflow task where a human performer performs the task with the assistance of software and is scheduled through a task list manager of some sort.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="user_task.png"><ri:page ri:space-key="CBMP2024xR2" ri:content-title="User Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290031007 space=CBMP2024xR2 version=2 -->
## PAGE 00200: Using Activities

- page_id: `290031007`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031007/Using+Activities
- version_number: 2
- version_date: `2026-02-23T14:20:31.239+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin > Using BPMN Process Diagram
- labels: []
...
<!--NOMAGIC_PAGE id=290031017 space=CBMP2024xR2 version=2 -->
## PAGE 00202: Using BPMN Collaboration Diagram

- page_id: `290031017`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031017/Using+BPMN+Collaboration+Diagram
- version_number: 2
- version_date: `2026-02-23T14:20:32.558+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin
- labels: []
...
<!--NOMAGIC_PAGE id=290031031 space=CBMP2024xR2 version=2 -->
## PAGE 00203: Using BPMN Element Numbers

- page_id: `290031031`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031031/Using+BPMN+Element+Numbers
- version_number: 2
- version_date: `2026-02-23T14:20:36.039+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin
- labels: []
...
<!--NOMAGIC_PAGE id=290031027 space=CBMP2024xR2 version=2 -->
## PAGE 00205: Using BPMN Tables and Matrices

- page_id: `290031027`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031027/Using+BPMN+Tables+and+Matrices
- version_number: 2
- version_date: `2026-02-23T14:20:35.014+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin
- labels: []
...
<!--NOMAGIC_PAGE id=290031023 space=CBMP2024xR2 version=2 -->
## PAGE 00207: Using Choreography Activity

- page_id: `290031023`
- space_key: `CBMP2024xR2`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR2/pages/290031023/Using+Choreography+Activity
- version_number: 2
- version_date: `2026-02-23T14:20:33.907+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Using Cameo Business Modeler Plugin > Using BPMN Choreography Diagram
- labels: []
