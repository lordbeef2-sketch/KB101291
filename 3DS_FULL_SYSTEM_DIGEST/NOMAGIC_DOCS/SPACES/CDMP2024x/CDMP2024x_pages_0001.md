# NOMAGIC DOCUMENTATION SPACE: Cameo Data Modeler Plugin 2024x

<!--NOMAGIC_SPACE key=CDMP2024x chunk=1 -->

<!--NOMAGIC_PAGE id=136723754 space=CDMP2024x version=2 -->
## PAGE 00001: 2024x Version News

- page_id: `136723754`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723754/2024x+Version+News
- version_number: 2
- version_date: `2023-09-21T12:53:58.679+02:00`
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-layer" ac:schema-version="1" ac:macro-id="77797f8b-2d07-4d07-b70c-4e570426681c"><ac:parameter ac:name="id">29827136</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-column" ac:schema-version="1" ac:macro-id="40048bea-c115-42c4-9527-177c1f1b6d97"><ac:parameter ac:name="id">29827138</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="bb9bbbe5-ffa6-4af6-9ab6-cb08d5ee5ca0"><ac:parameter ac:name="id">29827135</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><h5 style="text-align: center;">Cameo Data Modeler Plugin</h5><p style="text-align: center;"><span style="color: rgb(128,128,128);">Released on: November 10, 2023</span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="content-block" ac:schema-version="1" ac:macro-id="3fcf1df8-2998-47bf-b5fb-8aabdf7ee585"><ac:parameter ac:name="id">29827137</ac:parameter><ac:parameter ac:name="atlassian-macro-output-type">INLINE</ac:parameter><ac:rich-text-body><p>This version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=136723824 space=CDMP2024x version=1 -->
## PAGE 00002: Access control

- page_id: `136723824`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723824/Access+control
- version_number: 1
- version_date: `2023-09-21T12:46:56.929+02:00`
...
<!--NOMAGIC_PAGE id=136723975 space=CDMP2024x version=1 -->
## PAGE 00003: Annotation

- page_id: `136723975`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723975/Annotation
- version_number: 1
- version_date: `2023-09-21T12:47:03.743+02:00`
...
<!--NOMAGIC_PAGE id=136723904 space=CDMP2024x version=1 -->
## PAGE 00006: AttributeGroup

- page_id: `136723904`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723904/AttributeGroup
- version_number: 1
- version_date: `2023-09-21T12:47:00.009+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
````html
<p>An entity is a thing capable of an existence. An entity usually refers to some aspect of the real world, which can be distinguished from other aspects of the real world (a person, place, customer transaction, order, etc.).</p><p>An entity is represented by a box shape on the diagram. An entity has two compartments where properties (columns) of the entity can be specified. The upper compartment holds the primary key properties of the entity; the lower compartment holds other properties.</p><p>A relationship between entities describes how entities are associated. Relationships are represented by lines, connecting entities. Relationship end adornments indicate multiplicities of these ends. Multiplicity is the number of entity instances that can be associated with a number of another entity instances. Relationship multiplicity is represented by three symbols, the so-called “crow's foot notation” or “Information Engineering notation”.</p><p>The following table shows symbols of the relationship multiplicity.</p><table class="relative-table" style="width: 69.9945%;"><colgroup><col style="width: 42.9451%;" /><col style="width: 24.9216%;" /><col style="width: 32.1333%;" /></colgroup><tbody><tr><th style="text-align: left;">Name</th><th style="text-align: left;">Value</th><th style="text-align: left;">Notation</th></tr><tr><td>Zero</td><td>Zero</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Zero Notation.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr><tr><td>Vertical</td><td>One</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Vertical Notation.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr><tr><td><p>Crow's foot</p></td><td>Many</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Crow's Foot Notation.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p>Multiplicity lower bounds and upper bounds are paired into one adornment, as shown in the following table. Note that any lower bound, which is more that 0 is treated as 1 (this also includes lower bounds greater than 1, such as 2.). Also, any upper bound which is greater than 1 is treated as Many (this also includes upper bounds less than unlimited, such as 7.).</p><table class="relative-table" style="width: 70.1042%;"><colgroup><col style="width: 17.7617%;" /><col style="width: 25.3511%;" /><col style="width: 24.7285%;" /><col style="width: 32.1587%;" /></colgroup><tbody><tr><th>Min</th><th>Max</th><th>Read as</th><th>Figure</th></tr><tr><td>0</td><td>1</td><td>One (optional)</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="One Optional Pairing.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr><tr><td>1</td><td>1</td><td>One (mandatory)</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="One Mandatory Pairing.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr><tr><td>0</td><td>Many</td><td>Many (optional)</td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Many Optional Pairing.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr><tr><td colspan="1">1</td><td colspan="1">Many</td><td colspan="1">Many (mandatory)</td><td colspan="1"><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="Many Mandatory Pairing.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><ac:image ac:align="center"><ri:attachment ri:filename="Basic ER Diagram Example.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Basic concepts" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Basic ER diagram example.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b767ba70-1442-4a55-8ae0-36e002775508"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>Some authors use <strong>Entity Type </strong>term to signify the description of a set of entities and <strong>Entity </strong><strong>Instance </strong>term to signify concrete exemplar from that set. <strong>Entity </strong>term used in this manual corresponds to <strong>Entity Type</strong>.</li><li>Data modeling world frequently uses term Cardinality to denote the allowable numbers of entity instances, which can be associated. But with the rise of the UML, the more correct term <strong>Multiplicity </strong>was introduced and term <strong>Cardinality </strong>is only used to denote concrete numbers of entity instances, which are associated. Hence in the example Person [0..1]------</li><li>-[0..*] Book, the ranges [0..1] and [0..*] are called multiplicities. And if we have person “John Doe” associated with books “Moby Dick” and “Origin of Species”, we have a cardinality of 2 for loaned books role (and 1 on an opposite end - current reader role). Note that cardinality is always concrete number while multiplicity denotes range of possible cardinalities.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=136723776 space=CDMP2024x version=1 -->
## PAGE 00008: Business entity-relationship diagrams

- page_id: `136723776`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723776/Business+entity-relationship+diagrams
- version_number: 1
- version_date: `2023-09-21T12:46:55.414+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Entity-relationship (ER) modeling and diagrams
- labels: []
...
````html
<p>A Business ER diagram is a simplified version of the ER diagram. The Business ER diagram shows entities only as boxes (without structure) and the relationships between them. It is useful for high-level, abstract domain modeling that provides a structure for business data or defines business terminology.</p><p>You can draw these diagrams using the same ER diagram simply by suppressing both the primary key and column compartments on all the entities. A more convenient way to do this is to select all the entities (hold down <strong>ALT</strong> and click all relevant entities) and use the <strong>Suppress All </strong>button on the <strong>Shape Editing</strong> toolbar of the diagram.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 143 Suppress Button (Before).png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Business entity-relationship diagrams" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Multi-selecting all entities by pressing ALT and clicking all relevant entities.</h6><p style="text-align: center;"><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 144 Suppress Button (After).png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Business entity-relationship diagrams" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Using the Suppress All button on the Shape Editing toolbar of the diagram to only show entities as boxes (without structure) and the relationships between them.</h6><p><br /></p>
````

<!--NOMAGIC_PAGE id=136723752 space=CDMP2024x version=1 -->
## PAGE 00009: Cameo Data Modeler Plugin

- page_id: `136723752`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723752/Cameo+Data+Modeler+Plugin
- version_number: 1
- version_date: `2023-09-21T12:46:54.956+02:00`
- ancestors: 
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="e1ed5909-3683-4ecd-bbf4-4c3bd73dcbd3"><ac:parameter ac:name="depth">1</ac:parameter><ac:parameter ac:name="style">h4</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell><p><br /></p></ac:layout-cell><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p> </p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=136723828 space=CDMP2024x version=1 -->
## PAGE 00010: Code engineering set

- page_id: `136723828`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723828/Code+engineering+set
- version_number: 1
- version_date: `2023-09-21T12:46:57.144+02:00`
...
###### [IMAGE alt='' src='']DDL properties in CG Properties Editor dialog.
...
<!--NOMAGIC_PAGE id=136723896 space=CDMP2024x version=1 -->
## PAGE 00012: ComplexType

- page_id: `136723896`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723896/ComplexType
- version_number: 1
- version_date: `2023-09-21T12:46:59.674+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
<!--NOMAGIC_PAGE id=136723827 space=CDMP2024x version=1 -->
## PAGE 00016: Database code engineering

- page_id: `136723827`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723827/Database+code+engineering
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723801 space=CDMP2024x version=1 -->
## PAGE 00017: Database modeling

- page_id: `136723801`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723801/Database+modeling
- version_number: 1
- version_date: `2023-09-21T12:46:56.082+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support
- labels: []
...
````html
<p>This chapter covers modeling various SQL elements in detail and with examples.</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f7632294-bae6-45cf-bbf4-f91f8d69202e"><ac:parameter ac:name="depth">1</ac:parameter><ac:parameter ac:name="style">h4</ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=136723797 space=CDMP2024x version=1 -->
## PAGE 00018: Database support

- page_id: `136723797`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723797/Database+support
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723831 space=CDMP2024x version=1 -->
## PAGE 00019: DDL dialects

- page_id: `136723831`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723831/DDL+dialects
- version_number: 1
- version_date: `2023-09-21T12:46:57.336+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support > Database code engineering
- labels: []
...
For more information about Oracle DDL generation and customization, see [CONFLUENCE_PAGE title='Oracle DDL generation and customization' space='MD2024x'] in the MagicDraw User Guide.
...
<!--NOMAGIC_PAGE id=136723890 space=CDMP2024x version=1 -->
## PAGE 00021: Element

- page_id: `136723890`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723890/Element
- version_number: 1
- version_date: `2023-09-21T12:46:59.295+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
<!--NOMAGIC_PAGE id=136723880 space=CDMP2024x version=1 -->
## PAGE 00023: Entity-relationship and SQL reports

- page_id: `136723880`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723880/Entity-relationship+and+SQL+reports
- version_number: 1
- version_date: `2023-09-21T12:46:58.834+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide
- labels: []
...
<!--NOMAGIC_PAGE id=136723856 space=CDMP2024x version=1 -->
## PAGE 00025: ER to SQL (generic / Oracle) transformations

- page_id: `136723856`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723856/ER+to+SQL+generic+Oracle+transformations
- version_number: 1
- version_date: `2023-09-21T12:46:57.999+02:00`
...
For more information, see [CONFLUENCE_PAGE title='UML to SQL transformation' space='CDMP2024x'].
...
Let's review an example of key modeling, described in [CONFLUENCE_PAGE title='Key modeling' space='CDMP2024x']. After the transformation, the three entities of the ER model are transformed into the three tables of the SQL model, respectively.
...
<!--NOMAGIC_PAGE id=136723782 space=CDMP2024x version=1 -->
## PAGE 00027: Generalization and specialization

- page_id: `136723782`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723782/Generalization+and+specialization
- version_number: 1
- version_date: `2023-09-21T12:46:55.596+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Entity-relationship (ER) modeling and diagrams
- labels: []
...
- [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='CDMP2024x']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>The Cameo Data Modeler plugin is an add-on for MagicDraw Standard, Professional, and Architect Editions. It is purchased separately; however, it is free of charge for MagicDraw Enterprise Edition. The Cameo Data Modeler plugin replaces the previous (free) Data Modeling Notations plugin that supported the business entity-relationship diagram (a simplified version of an entity- relationship diagram), for high level, abstract domain data modeling. This plugin repackages database and XML schema modeling functionality, previously available only in MagicDraw Architect and Enterprise editions.</p><ul><li class="auto-cursor-target"><ac:link><ri:page ri:space-key="CDMP2024x" ri:content-title="Installation, licensing, and system requirements" /><ac:plain-text-link-body><![CDATA[Installing Cameo Data Modeler Plugin]]></ac:plain-text-link-body></ac:link></li></ul>
````

<!--NOMAGIC_PAGE id=136723987 space=CDMP2024x version=1 -->
## PAGE 00029: Group

- page_id: `136723987`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723987/Group
- version_number: 1
- version_date: `2023-09-21T12:47:04.283+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
<!--NOMAGIC_PAGE id=136723779 space=CDMP2024x version=1 -->
## PAGE 00031: Identifying relationships and dependent entities

- page_id: `136723779`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723779/Identifying+relationships+and+dependent+entities
- version_number: 1
- version_date: `2023-09-21T12:46:55.486+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Entity-relationship (ER) modeling and diagrams
- labels: []
...
<!--NOMAGIC_PAGE id=136724016 space=CDMP2024x version=1 -->
## PAGE 00034: Include

- page_id: `136724016`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136724016/Include
- version_number: 1
- version_date: `2023-09-21T12:47:05.432+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
<!--NOMAGIC_PAGE id=136723963 space=CDMP2024x version=1 -->
## PAGE 00036: Key

- page_id: `136723963`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723963/Key
- version_number: 1
- version_date: `2023-09-21T12:47:03.150+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
````html
<p>Entity keys are marked by applying the corresponding stereotype («PrimaryKey», «AlternativeKey») on the necessary column(s). This can be done from the column's shortcut menu.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 10 Key Usage in ER Diagram.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Key modeling" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Example of key usage in an ER diagram.</h6><p><br /></p><p>Primary key columns are grouped into a separate compartment. When the «PrimaryKey» stereotype is applied / unapplied, the column migrates between the two compartments.</p><p>In rare cases, you may need to specify several alternative keys on the same entry. In this case, you will fill the “Id” tag field of the key column with key identifier(s). Columns with the same Id are considered to belong to the same key. Overlapping alternative keys can be specified in the same manner (a column can have several ids specified).</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 11 Multiple Overlapping Alternative Keys in ER Diagram.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Key modeling" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Example of multiple overlapping alternative keys in ER diagram.</h6><p><br /></p><p>Inversion entries are specified analogously. An inversion entry is a non-unique (combination of) column(s), frequently used to search for the entity. Marking columns as IE provides hints to database implementers about which indexes to specify.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 12 Inversion Entry in ER Diagram.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Key modeling" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Example of inversion entry in ER diagram.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="67f2233a-7aab-41d3-9e3e-d75cb289e155"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>Although an ER profile carries the «ForeignKey» stereotype, this stereotype is currently unused. It is reserved for future automatic foreign key derivation functionality. Users should not specify FK columns explicitly on their entities (FKs are implied), unless they are needed for a specific purpose. <strong>Use at your own risk.</strong></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=136723859 space=CDMP2024x version=1 -->
## PAGE 00038: Key transformation

- page_id: `136723859`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723859/Key+transformation
- version_number: 1
- version_date: `2023-09-21T12:46:58.140+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Transformations > ER to SQL (generic / Oracle) transformations
- labels: []
...
Let's review an example of key modeling, which has been described in [CONFLUENCE_PAGE title='Key modeling' space='CDMP2024x']. After the transformation, the three entities of the ER model are transformed into the three tables of the SQL model respectively.
...
````html
<p>Keys in ER models are transformed into constraints in a DDL model. These are the rules for key transformations into DDL constraints as follows.</p><ol><li>The Primary key of the entity in the ER model is transformed into a primary key constraint in the SQL model.</li><li>The Alternative keys of the entities in the ER model are transformed into unique constraints in the SQL model.</li><li>The Inversion entries of the entities in the ER model are transformed into indexes in the SQL model.</li><li>If key or entry in ER model has a name (<strong>identifier </strong>tag), this information is preserved in the SQL model. The corresponding key / index will also have a name in the SQL model.</li></ol><p>Let's review an example of key modeling, which has been described in <ac:link><ri:page ri:space-key="CDMP2024x" ri:content-title="Key modeling" /></ac:link>. After the transformation, the three entities of the ER model are transformed into the three tables of the SQL model respectively.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 41 TBD Screenshot Example of Key Transformation Results.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Key transformation" /></ri:attachment></ac:image></p><h6 style="text-align: center;">TBD screenshot example of key transformation results.</h6>
````

<!--NOMAGIC_PAGE id=136723965 space=CDMP2024x version=1 -->
## PAGE 00039: Keyref

- page_id: `136723965`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723965/Keyref
- version_number: 1
- version_date: `2023-09-21T12:47:03.294+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
<!--NOMAGIC_PAGE id=136723918 space=CDMP2024x version=1 -->
## PAGE 00041: List

- page_id: `136723918`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723918/List
- version_number: 1
- version_date: `2023-09-21T12:47:00.791+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
````html
<ul><li>The UML Class must have the additional stereotype XSDlist.</li><li>Binding between this class and XSD:list must be provided.</li><li>“itemsType” maps to UML TemplateArgument from Binding.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 71 List Example Model.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="List" /></ri:attachment></ac:image></p><h6 style="text-align: center;">List model example.</h6><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="bf178920-bb72-431d-b746-65e3b26b324b"><ac:parameter ac:name="title">List XML code sample</ac:parameter><ac:rich-text-body><pre>&lt;?xml version=1.0, encoding=’UTF-8’?›</pre><pre>&lt;xs:schema xmlns:xs=&quot;<a href="http://www.w3.org/2001/XMLSchema">http://www.w3.org/2001/XMLSchema</a>&quot;&gt;<br />	&lt;xs:simpleType name=&quot;my_number_list2&quot; &gt;</pre><pre>		&lt;xs:list &gt;</pre><pre>			&lt;xs:simpleType&gt;</pre><pre>				&lt;xs:restriction base=&quot;xs:string&quot; /&gt;<br />			&lt;/xs:simpleType›</pre><pre>		&lt;/xs:list&gt;</pre><pre>	&lt;/xs:simpleType&gt;</pre><pre>	&lt;xs:simpleType name=&quot;my_number_list&quot; &gt;<br />		&lt;xs:annotation &gt;</pre><pre>			&lt;xs:documentation &gt;my list documentation&lt;/xs:documentation&gt;<br />		&lt;/xs:annotation&gt;</pre><pre>		&lt;xs:list itemType=&quot;xs:boolean&quot; /&gt;</pre><pre>	&lt;/xs:simpleType&gt;</pre><pre>&lt;/xs:schema&gt;</pre></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=136723928 space=CDMP2024x version=1 -->
## PAGE 00042: MaxExclusive

- page_id: `136723928`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723928/MaxExclusive
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723934 space=CDMP2024x version=1 -->
## PAGE 00043: MaxInclusive

- page_id: `136723934`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723934/MaxInclusive
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723949 space=CDMP2024x version=1 -->
## PAGE 00044: MaxLength

- page_id: `136723949`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723949/MaxLength
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723924 space=CDMP2024x version=1 -->
## PAGE 00045: MinExclusive

- page_id: `136723924`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723924/MinExclusive
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723931 space=CDMP2024x version=1 -->
## PAGE 00046: MinInclusive

- page_id: `136723931`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723931/MinInclusive
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723946 space=CDMP2024x version=1 -->
## PAGE 00047: MinLength

- page_id: `136723946`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723946/MinLength
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723810 space=CDMP2024x version=1 -->
## PAGE 00048: Modeling types

- page_id: `136723810`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723810/Modeling+types
- version_number: 1
- version_date: `2023-09-21T12:46:56.410+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support > Database modeling
- labels: []
...
Besides attributes, Structured UDTs have a collection of methods - operations, performing actions on values of this type. Methods are covered in a separate section with stored procedures and functions (see [CONFLUENCE_PAGE title='Routines' space='CDMP2024x'] section).
...
<!--NOMAGIC_PAGE id=136723955 space=CDMP2024x version=1 -->
## PAGE 00051: Pattern

- page_id: `136723955`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723955/Pattern
- version_number: 1
...
<!--NOMAGIC_PAGE id=136724006 space=CDMP2024x version=1 -->
## PAGE 00052: Redefine

- page_id: `136724006`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136724006/Redefine
- version_number: 1
- version_date: `2023-09-21T12:47:05.030+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
There is an UML limitation, that UML does not allow to place UML operations (which are used to model SQL procedures and functions) directly in the UML packages (which are used to model SQL schemas). For this reason global routines are placed into a special container class - GLOBALS (see [CONFLUENCE_PAGE title='Top level elements' space='CDMP2024x']).
...
Besides the standard properties of SQL routines (see [CONFLUENCE_PAGE title='Routines' space='CDMP2024x']), procedure has the following properties available in the Specification window.
...
Besides the standard properties of SQL routines (see [CONFLUENCE_PAGE title='Routines' space='CDMP2024x']), function has the following properties available in the Specification window.
...
Besides the properties of SQL functions (see [CONFLUENCE_PAGE title='Routines' space='CDMP2024x']), method has the following properties available in the Specification window.
...
Maps to UML TaggedValues named “selector” and “field” of a UML Attribute representing key, keyRef, or unique. The “selector” tag has a value representing the “xpath” and “field," a list of values representing the field “xpath”. ID values shall be skipped and annotation documentation will be applied to the tagged value according to the annotation rule (see [CONFLUENCE_PAGE title='Annotation' space='CDMP2024x']). For the values annotation field, documentation shall be merged into one.
...
<!--NOMAGIC_PAGE id=136723798 space=CDMP2024x version=1 -->
## PAGE 00059: SQL diagrams

- page_id: `136723798`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723798/SQL+diagrams
- version_number: 1
- version_date: `2023-09-21T12:46:56.006+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support
- labels: []
...
There are additional properties to choose for SQL to UML transformation in **Model Transformation Wizard**. For more information about the wizard, see [CONFLUENCE_PAGE title='Model Transformation Wizard' space='MD2024x'] in the MagicDraw User Guide.
...
<!--NOMAGIC_PAGE id=136723807 space=CDMP2024x version=1 -->
## PAGE 00062: Tables, columns, views, and columns

- page_id: `136723807`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723807/Tables+columns+views+and+columns
- version_number: 1
- version_date: `2023-09-21T12:46:56.313+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support > Database modeling
- labels: []
...
See [CONFLUENCE_PAGE title='Constraints' space='CDMP2024x'] and [Triggers](https://docs.nomagic.com/display/CDMP2024x/Constraints#Constraints-Triggers) for triggers. There can be various kinds of tables as follows.
...
Besides the standard SQL element properties and persistent table properties (see [Persistent table](https://docs.nomagic.com/display/CDMP2024x/Tables%2C+columns%2C+views%2C+and+columns#Tables,columns,views,andcolumns-Persistenttable)), view has the following properties available in the Specification window.
...
<!--NOMAGIC_PAGE id=136723803 space=CDMP2024x version=1 -->
## PAGE 00063: Top level elements

- page_id: `136723803`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723803/Top+level+elements
- version_number: 1
- version_date: `2023-09-21T12:46:56.180+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Database support > Database modeling
- labels: []
...
<!--NOMAGIC_PAGE id=136723862 space=CDMP2024x version=1 -->
## PAGE 00065: Tracing between data model layers

- page_id: `136723862`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723862/Tracing+between+data+model+layers
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723843 space=CDMP2024x version=1 -->
## PAGE 00066: Transformation procedure

- page_id: `136723843`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723843/Transformation+procedure
- version_number: 1
- version_date: `2023-09-21T12:46:57.644+02:00`
...
To transform enumerations to **lookup tables**. This strategy can handle the more complex enumerations, for example, enumerations having their own attributes. The lookup table is automatically populated with enumeration literal values, and INSERT statements are generated during the SQL code generation. For each attribute that enumeration source has (including inherited attributes) the column in the target table is created. Attributes are transformed using the normal transformation rules for class attributes (including the type mapping, data type expansion, if requested, and multivalue-attribute expansion). The **name**column is added to the lookup table and the primary key is automatically generated (see [CONFLUENCE_PAGE title='Transformation procedure' space='CDMP2024x']). Every class attribute of the enumeration type in the transformation source is transformed to the foreign key.
...
For more information about selecting elements, see [CONFLUENCE_PAGE title='Selecting elements' space='MD2024x'] in MagicDraw User Guide.

4. Click **OK**when you are done.

You can also create your custom naming rules using structured expressions or various scripts. The naming rule is an executable opaque behavior. For more information about executable opaque behaviors, see [CONFLUENCE_PAGE title='Creating executable opaque behaviors' space='MD2024x'] in MagicDraw User Guide. The following procedure describes one of the possible ways to create a custom naming rule.
...
For more information, see [CONFLUENCE_PAGE title='Creating executable opaque behaviors' space='MD2024x'] in MagicDraw User Guide*.*
...
For more information about the TypeTest operation, see [CONFLUENCE_PAGE title='Calling operations from the model' space='MD2024x'] in MagicDraw User Guide.
...
This is the complete list of properties available in UML to SQL(Generic / Oracle) transformation in the **Model Transformation Wizard**(For more information about this wizard, see [CONFLUENCE_PAGE title='Model Transformation Wizard' space='MD2024x'] in MagicDraw User Guide).
...
For more information about the **Model Transformations W****izard**, see [CONFLUENCE_PAGE title='Model Transformation Wizard' space='MD2024x'] in MagicDraw User Guide.
...
- For more information on creating your own transformation rules or changing mapping behavior, see [CONFLUENCE_PAGE title='Transformation Type Mapping' space='MD2024x'] in MagicDraw User Guide.
- For more information on setting up mapping, watch the “Transformations” online demo at https://www.nomagic.com/support/demos .
...
<!--NOMAGIC_PAGE id=136723875 space=CDMP2024x version=1 -->
## PAGE 00071: UML to XML schema transformation

- page_id: `136723875`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723875/UML+to+XML+schema+transformation
- version_number: 1
- version_date: `2023-09-21T12:46:58.588+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Transformations
- labels: []
...
- There are additional properties to choose for UML to XML Schema transformation in the Model Transformation Wizard. For more information about the wizard, see [CONFLUENCE_PAGE title='Model Transformation Wizard' space='MD2024x'] in MagicDraw User Guide.
...
````html
<ul><li>The UML Class must have the additional stereotype XSDunion.</li><li>“memberTypes” and inner simpleTypes maps to several UML Generalizations between the simple type and members types.</li><li>In order to have an inner simpleType element, the parent of this Generalization must be an inner Class of an outer UML Class.</li></ul><h6><ac:image ac:align="center"><ri:attachment ri:filename="Figure 73 Union Example Model and XML Code2.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Union" /></ri:attachment></ac:image></h6><h6 style="text-align: center;">Union model example.</h6><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="52b0db29-d7c1-4a90-bc63-cf186f5700d7"><ac:parameter ac:name="title">Union model and XML code samples</ac:parameter><ac:rich-text-body><pre>&lt;xs:schema xmlns:nm = &quot;<a href="http://nomagic.com">http://nomagic.com</a>&quot; xmlns:xs = &quot;<a href="http://www.w3.org/2001/XMLSchema">http://www.w3.org/2001/XMLSchema</a>&quot; targetNamespace = &quot;<a href="http://nomagic.com">http://nomagic.com</a>&quot; &gt;<br />	&lt;xs:simpleType name = &quot;my_simple_union&quot; &gt;</pre><pre>		&lt;xs:union id = &quot;unionID&quot; memberTypes = &quot;xs:string xs:number&quot; /&gt;<br />	&lt;/xs:simpleType&gt;</pre><pre>	&lt;xs:simpleType name = &quot;my_simple_union2&quot; &gt;</pre><pre>		&lt;xs:annotation &gt;</pre><pre>			&lt;xs:documentation &gt;very important documentation&lt;/xs:documentation&gt;</pre><pre>		&lt;/xs:annotation&gt;</pre><pre>		&lt;xs:union id = &quot;unionID&quot; memberTypes = &quot;xs:number&quot; &gt; <br /> 			&lt;xs:simpleType &gt; <br />				&lt;xs:restriction base = &quot;xs:number&quot; /&gt;</pre><pre>			&lt;/xs:simpleType&gt; <br />		&lt;/xs:union&gt;</pre><pre>	&lt;/xs:simpleType&gt;</pre><pre>&lt;/xs:schema&gt;</pre></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=136723961 space=CDMP2024x version=1 -->
## PAGE 00073: Unique

- page_id: `136723961`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723961/Unique
- version_number: 1
- version_date: `2023-09-21T12:47:03.019+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
For a unique UML model example, see [CONFLUENCE_PAGE title='Keyref' space='CDMP2024x'].
...
<!--NOMAGIC_PAGE id=136723756 space=CDMP2024x version=1 -->
## PAGE 00074: User guide

- page_id: `136723756`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723756/User+guide
- version_number: 1
...
<!--NOMAGIC_PAGE id=136723794 space=CDMP2024x version=1 -->
## PAGE 00075: Virtual entities

- page_id: `136723794`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723794/Virtual+entities
- version_number: 1
- version_date: `2023-09-21T12:46:55.820+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Entity-relationship (ER) modeling and diagrams
- labels: []
...
````html
<p>Virtual entities can be derived from information in other entities. They are marked with the keyword «virtual» on diagrams. They can be handled in the same manner as other entities.</p><p>Virtual entities roughly correspond to views in databases.</p><p>If you need to specify exactly how virtual entities are derived from other entities, you can use Abstraction relationships from UML. You can specify the derivation expression in the Mapping field.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Figure 13 Virtual Entity Usage in ER Diagram.png"><ri:page ri:space-key="CDMP2024x" ri:content-title="Virtual entities" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Example of virtual entity usage in an ER diagram.</h6>
````

<!--NOMAGIC_PAGE id=136723861 space=CDMP2024x version=1 -->
## PAGE 00076: Virtual entity transformation

- page_id: `136723861`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723861/Virtual+entity+transformation
- version_number: 1
- version_date: `2023-09-21T12:46:58.236+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Transformations > ER to SQL (generic / Oracle) transformations
- labels: []
...
<!--NOMAGIC_PAGE id=136723884 space=CDMP2024x version=1 -->
## PAGE 00078: XML schema mapping to UML elements

- page_id: `136723884`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723884/XML+schema+mapping+to+UML+elements
- version_number: 1
- version_date: `2023-09-21T12:46:59.002+02:00`
...
````html
<p>The following XML schemas are applied to UML elements for a variety of purposes:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="5279bae4-e2cd-4c5a-a6e0-97c6cddaaeb4"><ac:parameter ac:name="depth">1</ac:parameter><ac:parameter ac:name="style">h4</ac:parameter></ac:structured-macro></p>
````

<!--NOMAGIC_PAGE id=136724020 space=CDMP2024x version=1 -->
## PAGE 00079: XML schema namespaces

- page_id: `136724020`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136724020/XML+schema+namespaces
- version_number: 1
- version_date: `2023-09-21T12:47:05.644+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > XML schemas > XML schema mapping to UML elements
- labels: []
...
For an XML schema namespaces UML Model example, see [CONFLUENCE_PAGE title='Schema' space='CDMP2024x'].

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>Maps to a UML Package with the stereotype <em>XSDnamespace</em>. To define the “xmlns” attribute in the schema file, you must add Permission between the XSDnamespace package and XSDschema class into the model.</p><ul><li style="text-align: left;">The Permission name maps to the namespace shortcut.</li></ul><ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="25a3f67b-f948-4360-855f-a52180b34a0c"><ac:parameter ac:name="title">XML representation of the skeleton of a schema</ac:parameter><ac:rich-text-body><pre>&lt;xs:schema</pre><pre>	xmlns:xs=&quot;<a href="http://www.w3.org/2001/XMLSchema">http://www.w3.org/2001/XMLSchema</a>&quot; xmlns=&quot;<a href="http://www.w3.org/2001/XMLSchema">http://www.w3.org/2001/XMLSchema</a>&quot; <br />	targetNamespace=&quot;<a href="http://www.example.com/example">http://www.example.com/example</a>&quot;&gt;<br />	…</pre><pre>&lt;/xs:schema&gt;</pre></ac:rich-text-body></ac:structured-macro><p>To generate these namespaces</p><hr /><ul><li>The UML model must have a Package with the name <a href="https://www.w3.org/2001/XMLSchema"><em>http://www.w3.org/2001/XMLSchema</em></a></li><li>The UML model must have a Package with the name <a href="https://docs.nomagic.com/www.example.com/example"><em>http://www.example.com/example</em></a></li><li>Permission with the name “xs” must be added into the model between the XMLSchema Class and the Package <a href="https://www.w3.org/2001/XMLSchema"><em>http://www.w3.org/2001/XMLSchema</em></a></li><li>Permission without a name must be added into the model between the XMLSchema Class and the Package<a href="https://www.w3.org/2001/XMLSchema"><em> http://www.w3.org/2001/XMLSchema</em></a></li></ul><p>For an XML schema namespaces UML Model example, see <ac:link><ri:page ri:space-key="CDMP2024x" ri:content-title="Schema" /></ac:link>.</p>
````

<!--NOMAGIC_PAGE id=136723879 space=CDMP2024x version=1 -->
## PAGE 00080: XML schema to UML transformation

- page_id: `136723879`
- space_key: `CDMP2024x`
- source_url: https://docs.nomagic.com/spaces/CDMP2024x/pages/136723879/XML+schema+to+UML+transformation
- version_number: 1
- version_date: `2023-09-21T12:46:58.768+02:00`
- ancestors: Cameo Data Modeler Plugin > User guide > Transformations
- labels: []
