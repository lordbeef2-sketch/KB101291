# NOMAGIC DOCUMENTATION SPACE: Cameo DataHub 2024x Refresh3

<!--NOMAGIC_SPACE key=CDH2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227163385 space=CDH2024xR3 version=2 -->
## PAGE 00001: 2024x Refresh1 Version News

- page_id: `227163385`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163385/2024x+Refresh1+Version+News
- version_number: 2
- version_date: `2026-02-11T10:52:46.553+01:00`
...
In version 2024x Refresh1, Cameo DataHub presents a number of new features and enhancements. This release introduces various enhancements, security and technical improvements, as well as bug and minor fixes.

### Jama Connect®

With 2024x Refresh1 version, we introduce a new connector to support integration. The new driver JAMA Connect has been added to the list of available drivers in the Add Data Source dialog. To learn more about the new connector, refer to [CONFLUENCE_PAGE title='Adding Data Sources for JAMA Connect' space=''].

[IMAGE alt='' src='']

###### The new JAMA Connect connector is available in the Add Data Source dialog.

### Environment Options

The **Save HTML images from the data source in the project as attached files**option in the Environment Options dialog is updated now. The option is now set to *true*by default. 
 
[IMAGE alt='' src='']

###### Save HTML images from the data source in the project as the attached files option set to *true*in the Environment dialog.

### ENOVIA Requirements

ENOVIA Requirements driver now supports the two-way synchronization for the images found on mapped attribute values.

### Other Improvements

- OSLC selection dialog of the OSLC drivers V2 and V3 is enhanced with an additional view mode parameter. This enhancement presents the OSLC API provider‘s response in compact view on the OSLC delegated UIs.
- The VBS mode argument needed to launch IBM Doors is set to be used by default.
- Cameo DataHub now supports the 3DEXPERIENCE Platform version 2024x FD03 for both cloud and on-premise.
- Cameo DataHub migrated to the 3DS platform Relations API V2 to resolve the issue related to moving synchronized items from one specification to another.
- The listing of specifications on Spec selecting UI is migrated from DB queries to Indexed API to improve performance.
- Cameo DataHub now supports the 7.37.2 version of the jxBrowser.

### Security improvements

- Third-party software libraries used in the Cameo DataHub plugin codebase are updated to their most recent available versions.

### Bug Fixes

- The Maximize/Restore button presentation is fixed to display the button‘s label correctly.
- The Minimize/Restore button functionality is fixed to restore the affected panel to its original size correctly.
- The Regression introduced in the previous version of the Cameo DataHub, impacting the customization of IBM Doors data types to support more flexible mapping scenarios, is now fixed. To learn more, refer to [CONFLUENCE_PAGE title='Customizing new node type for DOORS' space=''].

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:image ac:align="center"><ri:attachment ri:filename="Cameo DataHub logo.png" /></ac:image></p><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: <span style="color:var(--ds-text,#707070);">July 5, 2024</span></span></p><p><span style="color:var(--ds-text,#172b4d);"><span style="color:var(--ds-text,#333333);">In version 2024x Refresh1, Cameo DataHub</span> presents a number of new features and enhancements. This release introduces various enhancements, security and technical improvements, as well as bug and minor fixes.</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="three_equal"><ac:layout-cell><p><ac:link ac:anchor="Jama Connect®" /></p><p><ac:link ac:anchor="Environment Options" /></p></ac:layout-cell><ac:layout-cell><p><ac:link ac:anchor="ENOVIA Requirements" /></p><p><ac:link ac:anchor="Other Improvements" /></p></ac:layout-cell><ac:layout-cell><p><ac:link ac:anchor="Security improvements" /></p><p><ac:link ac:anchor="Bug Fixes" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1>Jama Connect®</h1><p>With 2024x Refresh1 version, we introduce a new connector to support integration. The new driver JAMA Connect has been added to the list of available drivers in the Add Data Source dialog. To learn more about the new connector, refer to <ac:link><ri:page ri:content-title="Adding Data Sources for JAMA Connect" /></ac:link>.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="JAMA Connect.png" /></ac:image></p><h6 style="text-align: center;">The new JAMA Connect connector is available in the Add Data Source dialog.<br /><br /></h6><h1>Environment Options</h1><p>The <strong style="font-size: 14.0px;letter-spacing: 0.0px;">Save HTML images from the data source in the project as attached files</strong><span style="font-size: 14.0px;font-weight: 400;letter-spacing: 0.0px;"> option in the Environment Options dialog is updated now. The option is now set to <em>true </em>by default. <br /><br /><ac:image ac:align="center"><ri:attachment ri:filename="Environment dialog.png" /></ac:image></span></p><h6 style="text-align: center;">Save HTML images from the data source in the project as the attached files option set to <em>true </em>in the Environment dialog.</h6><h1>ENOVIA Requirements</h1><p><span>ENOVIA Requirements driver now supports the two-way synchronization for the images found on mapped attribute values.</span></p><h1>Other Improvements</h1><ul><li><span>OSLC selection dialog of the OSLC drivers V2 and V3 is enhanced with an additional view mode parameter. This enhancement presents the OSLC API provider‘s response in compact view on the OSLC delegated UIs.</span></li><li><span>The VBS mode argument needed to launch IBM Doors is set to be used by default.</span></li><li><span>Cameo DataHub now supports the 3DEXPERIENCE Platform version 2024x FD03 for both cloud and on-premise.</span></li><li><span>Cameo DataHub migrated to the 3DS platform Relations API V2 to resolve the issue related to moving synchronized items from one specification to another. </span></li><li><span>The listing of specifications on Spec selecting UI is migrated from DB queries to Indexed API to improve performance. </span></li><li><span>Cameo DataHub now supports the 7.37.2 version of the jxBrowser.</span></li></ul><h1>Security improvements</h1><ul><li><span>Third-party software libraries used in the Cameo DataHub plugin codebase are updated to their most recent available versions.</span></li></ul><h1>Bug Fixes</h1><ul><li><span>The Maximize/Restore button presentation is fixed to display the button‘s label correctly.</span></li><li><span>The Minimize/Restore button functionality is fixed to restore the affected panel to its original size correctly.</span></li><li><span>The Regression introduced in the previous version of the Cameo DataHub, impacting the customization of IBM Doors data types to support more flexible mapping scenarios, is now fixed. To learn more, refer to <ac:link><ri:page ri:content-title="Customizing new node type for DOORS" /></ac:link>.</span></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163383 space=CDH2024xR3 version=4 -->
## PAGE 00002: 2024x Refresh2 Version News

- page_id: `227163383`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163383/2024x+Refresh2+Version+News
- version_number: 4
- version_date: `2026-02-11T10:52:40.149+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
In version 2024x Refresh2, Cameo DataHubintroduces numerous connector specific enhancements. Also, the release introduces various bug fixes and general enhancements.
...
##### IBM Doors Next Generation connector

**Enhanced Backlink Support**: DataHub now fully supports the backlink between IBM DOORS NG and TWC. The OSLC resource link is now automatically retrieved from the TWC OSLC API. When the model is committed to TWC and data is synchronized between DOORS NG and the model, the **Satisfy By**link hover now provides a preview of the Collaborator resource. For more information, refer to [CONFLUENCE_PAGE title='Business Use Case flow with DNG' space='CDH2022xR2'].

##### JAMA Connect connector

The JAMA Connect requirements management application connector introduces several new features:

- Related Element Selection : Users can now select related elements from either the modeling application or JAMA Connect. When a synchronized item is selected in a model or on the DataHub Explorer panel, initiating the Select the related item command will highlight the corresponding element on the opposite side. This enhancement simplifies navigation between synchronized parts of the model and JAMA Connect project.
- Diagram Synchronization : You can now synchronize diagrams from JAMA Connect to the model. Diagrams are converted into images and embedded into the Text property of the selected model element. Note that synchronization is currently only supported from JAMA Connect to the model. For more information, refer to [CONFLUENCE_PAGE title='Diagram Synchronization' space=''] .
- Streamlined GUI : The DataHub GUI has been now enhanced to disable unsupported commands when using the JAMA Connect connector, resulting in a clearer and more user-friendly interface.

### Bug Fixes

##### JAMA Connect

- UTF-8 Synchronization Error : Fixed an issue where a UTF-8 related error occurred during data synchronization from the model to JAMA Connect in specific cases.
- Custom Item Synchronization : Resolved issues with the synchronization of custom JAMA Connect items not functioning correctly in certain scenarios.
- Link Display Issues : Fixed an issue where links between items synchronized from the model to JAMA Connect project were not displayed correctly until the project was reloaded.
- Authentication Panel : Resolved an issue that disabled the JAMA Connect data source login panel inputs when switching between available authentication methods.

##### ENOVIA Requirements

- Data Loss Prevention : Fixed an issue causing partial data loss during synchronization from the ENOVIA Requirements application to the model due to complex HTML-formatted data.
- Empty Requirement Specification : Resolved an issue preventing the creation of empty Requirement Specifications on the ENOVIA Requirements application side based on an empty package from a model. You can now synchronize an empty package and add necessary items later, either in the model or the ENOVIA Requirements application.
- 3DS Platform Support : This release now supports the 3DS 2025x platform, deployed both on the cloud and on-premise.

### Other Enhancements

- **Improved GUI for Non-UML Projects**: The DataHub GUI now automatically disables its menus when a non-UML project is open.
- Various small GUI enhancements and bug fixes have been implemented to improve overall user experience and application stability.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:image ac:align="center"><ri:attachment ri:filename="Cameo DataHub logo.png" /></ac:image></p><p style="text-align: center;"><span style="color:var(--ds-chart-gray-bold,#8590a2);">Released on: November 8, 2024</span></p><p><span style="color:var(--ds-text,#172b4d);"><span style="color:var(--ds-text,#333333);">In version 2024x Refresh2, Cameo DataHub</span><span> </span>introduces numerous connector specific enhancements. Also, the release introduces various bug fixes and general enhancements.</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="three_equal"><ac:layout-cell><ac:link ac:anchor="Enhancements" /><ul><li><ac:link ac:anchor="IBM Doors Next Generation connector" /></li><li><ac:link ac:anchor="JAMA Connect connector" /></li></ul></ac:layout-cell><ac:layout-cell><ac:link ac:anchor="Bug Fixes" /><ul><li><ac:link ac:anchor="JAMA Connect" /></li><li><ac:link ac:anchor="ENOVIA Requirements" /></li></ul></ac:layout-cell><ac:layout-cell><ac:link ac:anchor="Other Enhancements" /><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1>Enhancements</h1><h3><span style="letter-spacing: 0.0px;">IBM Doors Next Generation connector</span></h3><p><strong>Enhanced Backlink Support</strong>: DataHub now fully supports the backlink between IBM DOORS NG and TWC. The OSLC resource link is now automatically retrieved from the TWC OSLC API. When the model is committed to TWC and data is synchronized between DOORS NG and the model, the <strong>Satisfy By </strong>link hover now provides a preview of the Collaborator resource. For more information, refer to <ac:link><ri:page ri:space-key="CDH2022xR2" ri:content-title="Business Use Case flow with DNG" /></ac:link>.</p><h3><span style="letter-spacing: 0.0px;">JAMA Connect connector</span></h3><p>The JAMA Connect requirements management application connector introduces several new features:</p><ul><li><strong>Related Element Selection</strong>: Users can now select related elements from either the modeling application or JAMA Connect. When a synchronized item is selected in a model or on the DataHub Explorer panel, initiating the <strong>Select the related item </strong>command will highlight the corresponding element on the opposite side. This enhancement simplifies navigation between synchronized parts of the model and JAMA Connect project.</li><li><strong>Diagram Synchronization</strong>: You can now synchronize diagrams from JAMA Connect to the model. Diagrams are converted into images and embedded into the <strong>Text </strong>property of the selected model element. Note that synchronization is currently only supported from JAMA Connect to the model. For more information, refer to <ac:link><ri:page ri:content-title="Diagram Synchronization" /></ac:link>.</li><li><strong>Streamlined GUI</strong>: The DataHub GUI has been now enhanced to disable unsupported commands when using the JAMA Connect connector, resulting in a clearer and more user-friendly interface.</li></ul><h1>Bug Fixes</h1><h3>JAMA Connect</h3><ul><li><strong>UTF-8 Synchronization Error</strong>: Fixed an issue where a UTF-8 related error occurred during data synchronization from the model to JAMA Connect in specific cases.</li><li><strong>Custom Item Synchronization</strong>: Resolved issues with the synchronization of custom JAMA Connect items not functioning correctly in certain scenarios.</li><li><strong>Link Display Issues</strong>: Fixed an issue where links between items synchronized from the model to JAMA Connect project were not displayed correctly until the project was reloaded.</li><li><strong>Authentication Panel</strong>: Resolved an issue that disabled the JAMA Connect data source login panel inputs when switching between available authentication methods.</li></ul><h3>ENOVIA Requirements</h3><ul><li><strong>Data Loss Prevention</strong>: Fixed an issue causing partial data loss during synchronization from the ENOVIA Requirements application to the model due to complex HTML-formatted data.</li><li><strong>Empty Requirement Specification</strong>: Resolved an issue preventing the creation of empty Requirement Specifications on the ENOVIA Requirements application side based on an empty package from a model. You can now synchronize an empty package and add necessary items later, either in the model or the ENOVIA Requirements application.</li><li><strong>3DS Platform Support</strong>: This release now supports the 3DS 2025x platform, deployed both on the cloud and on-premise.</li></ul><h1>Other Enhancements</h1><ul><li><span style="letter-spacing: 0.0px;"><strong>Improved GUI for Non-UML Projects</strong>: The DataHub GUI now automatically disables its menus when a non-UML project is open.</span></li><li>Various small GUI enhancements and bug fixes have been implemented to improve overall user experience and application stability.</li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163381 space=CDH2024xR3 version=8 -->
## PAGE 00003: 2024x Refresh3 Version News

- page_id: `227163381`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163381/2024x+Refresh3+Version+News
- version_number: 8
- version_date: `2026-02-11T10:52:35.183+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
In version 2024x Refresh3, Cameo DataHubpresents a two major enhancements. This release introduces enhancements related to the ENOVIA Requirements and DOORS NG data sources.

### ENOVIA Requirements

You can now access all requirements you own immediately after logging into the **ENOVIA Requirements**data source. All the Folders, Specifications, and Requirements owned by you are displayed in the Cameo DataHub Explorer Panel. You can also view all the requirements accessible to you on the server. To learn more, refer to the [CONFLUENCE_PAGE title='Adding Data Sources for ENOVIA Requirements' space=''] page.

[IMAGE alt='' src='']

###### All the Folders, Specification and Requirements owned by you displayed in CDH Explorer Panel.

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:image ac:align="center"><ri:attachment ri:filename="Cameo DataHub logo.png" /></ac:image></p><p style="text-align: center;"><span style="color:var(--ds-chart-gray-bold,#8590a2);">Released on: July 11, 2025</span></p><p style="text-align: center;"><br /></p><p style="text-align: left;"><span style="color:var(--ds-chart-gray-bold,#8590a2);"><span style="color:var(--ds-text,#172b4d);"><span style="color:var(--ds-text-accent-magenta-bolder,#50253f);">In version 2024x Refresh3, Cameo DataHub</span><span> </span>presents a two major enhancements. This release introduces enhancements related to the ENOVIA Requirements and DOORS NG data sources.</span></span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1>ENOVIA Requirements</h1><p>You can now access all requirements you own immediately after logging into the <strong>ENOVIA Requirements </strong>data source. All the Folders, Specifications, and Requirements owned by you are displayed in the Cameo DataHub Explorer Panel. You can also view all the requirements accessible to you on the server. To learn more, refer to the <ac:link><ri:page ri:content-title="Adding Data Sources for ENOVIA Requirements" /></ac:link> page.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Requirements.png" /></ac:image></p><h6 style="text-align: center;">All the Folders, Specification and Requirements owned by you displayed in CDH Explorer Panel.</h6></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163390 space=CDH2024xR3 version=3 -->
## PAGE 00004: 2024x Version News

- page_id: `227163390`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163390/2024x+Version+News
- version_number: 3
- version_date: `2026-02-11T10:52:51.432+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
- The default behavior of the ENOVIA Requirements connector is changed to display all objects, instead of only Owned ones. To see only owned items, select the command**Show only Owned elements**on thedata source contextual menu.
- The default behavior of the ENOVIA Requirements connector is changed to show revision names on the CDH Explorer panel. To hide revision names, select**Hide revision**on thedata source contextual menu.
- The ownership information (**Collab Space** name and **Company name**) for requirement domain-related objects is now displayed on the ENOVIA Requirements data source tree. To see the ownership information, select the**Show Ownership**command on thedata source contextual menu.
- Support for customized **Chapters**objects is enabled. All ENOVIA Requirements custom data types are now available.
- Synchronization links rerouting to a new revision is enabled. When therevised object is replacedon the platform side,synchronization linksare rerouted to thereplaced objectautomatically whensynchronizationis initiated for therevised objectfor the first time.When therevised object is not replaced,link reroutingis initiated manually by selecting the command on thecontextual menu.
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:image ac:align="center"><ri:attachment ri:filename="Cameo DataHub logo.png" /></ac:image></p><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: November 28, 2025</span></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><h1><span style="letter-spacing: -0.01em;">ENOVIA Requirements Improvements</span></h1><ul><li data-uuid="1a63c276-c116-4568-8c15-9a57f90340b0"><p>All requirement domain-related objects are now available on the CDH Explorer panel for you.</p></li><li data-uuid="8d25aed4-5d8d-45af-8a95-2a1b70a7d96f"><p>The default behavior of the ENOVIA Requirements connector is changed to display all objects, instead of only Owned ones. <span>To see only owned items, select the command </span><strong>Show only Owned elements</strong><span> on the </span><span>data source contextual menu</span><span>.</span></p></li><li data-uuid="ac2f1fc3-631c-4bf2-895c-2fb0901d3fae"><p>The default behavior of the ENOVIA Requirements connector is changed to show revision names on the CDH Explorer panel. <span>To hide revision names, select </span><strong>Hide revision</strong><span> on the </span><span>data source contextual menu</span><span>.</span></p></li><li data-uuid="b797b7a1-8677-4193-8175-2e193cb3939d"><p>The ownership information (<strong>Collab Space</strong> name and <strong>Company name</strong>) for requirement domain-related objects is now displayed on the ENOVIA Requirements data source tree. <span>To see the ownership information, select the </span><strong>Show Ownership</strong><span> command on the </span><span>data source contextual menu</span><span>.</span></p></li><li data-uuid="c471cc96-2c69-4d8f-b582-f5d7f91750eb"><p>Support for customized <strong>Chapters </strong>objects is enabled. All ENOVIA Requirements custom data types are now available.</p></li><li data-uuid="a85839e0-ed6f-4715-bb68-d8c1b2b360d1"><p>Synchronization links rerouting to a new revision is enabled. <span>When the </span><span>revised object is replaced</span><span> on the platform side, </span><span>synchronization links</span><span> are rerouted to the </span><span>replaced object</span><span> automatically when </span><span>synchronization</span><span> is initiated for the </span><span>revised object</span><span> for the first time. </span><span>When the </span><span>revised object is not replaced</span><span>, </span><span>link rerouting</span><span> is initiated manually by selecting the command on the </span><span>contextual menu</span><span>.</span></p></li><li data-uuid="c142c8d4-bafe-4d23-abf8-7658cde68a50"><p>Significant data synchronization performance improvements delivered.</p></li></ul><h1>JAMA Improvements</h1><ul><li data-uuid="2466d41c-ff75-46f5-9eba-48d8c08c7925"><p>The possibility to synchronize Comments objects from JAMA Connect to CATIA models is enabled. Comments could only be synchronized from JAMA Connect to CATIA models only.</p></li></ul><h1>Performance Improvements</h1><p><span style="color:var(--ds-text,#172b4d);">Operations related to opening a local MSOSA project, logging and launching the ENOVIA Requirements, Using Show all elements command and Expanding the ENOVIA node has been improved</span><span style="letter-spacing: 0.0px;">. The following table presents a performance comparison of the time taken to perform various activities on a set of 1000 requirements organized in a flat hierarchy:</span></p><p><br /></p><table class="fixed-width wrapped" style="width: 711.0px;float: left;"><colgroup><col style="width: 68.0px;" /><col style="width: 258.0px;" /><col style="width: 195.0px;" /><col style="width: 190.0px;" /></colgroup><tbody class=""><tr class=""><td class="highlight-#f4f5f7" style="text-align: center;vertical-align: middle;" data-highlight-colour="#f4f5f7"><p title=""><strong>Sr. No.</strong></p></td><td class="highlight-#f4f5f7" style="vertical-align: middle;" data-highlight-colour="#f4f5f7"><p style="text-align: center;" title=""><strong>Action</strong></p></td><td class="highlight-#f4f5f7" style="vertical-align: middle;text-align: center;" data-highlight-colour="#f4f5f7"><p title=""><strong>2024xR2</strong></p></td><td class="highlight-#f4f5f7" style="vertical-align: middle;text-align: center;" data-highlight-colour="#f4f5f7"><p title=""><strong>2026x</strong></p></td></tr><tr class=""><td style="text-align: center;vertical-align: middle;"><p><strong>1</strong></p></td><td style="vertical-align: middle;"><p>Opening a local <strong>MSOSA </strong>project</p></td><td style="text-align: center;vertical-align: middle;"><p>17 Seconds</p></td><td class="highlight-#e3fcef" style="text-align: center;vertical-align: middle;" data-highlight-colour="#e3fcef"><p title="">11 Seconds</p></td></tr><tr class=""><td style="text-align: center;vertical-align: middle;"><p><strong>2</strong></p></td><td style="vertical-align: middle;"><p>Logging into <strong>ENOVIA Requirements</strong></p></td><td style="text-align: center;vertical-align: middle;"><p>10 Seconds</p></td><td class="highlight-#e3fcef" style="text-align: center;vertical-align: middle;" data-highlight-colour="#e3fcef"><p title="">9 Seconds</p></td></tr><tr class=""><td style="text-align: center;vertical-align: middle;"><p><strong>3</strong></p></td><td style="vertical-align: middle;"><p>Launching <strong>ENOVIA Requirements</strong></p></td><td style="text-align: center;vertical-align: middle;"><p>349 Seconds</p></td><td class="highlight-#e3fcef" style="text-align: center;vertical-align: middle;" data-highlight-colour="#e3fcef"><p title="">39 Seconds</p></td></tr><tr class=""><td style="text-align: center;vertical-align: middle;"><p><strong>4</strong></p></td><td style="vertical-align: middle;"><p>Using <strong>Show all elements</strong> command</p></td><td style="text-align: center;vertical-align: middle;"><p>220 Seconds</p></td><td class="highlight-#e3fcef" style="text-align: center;vertical-align: middle;" data-highlight-colour="#e3fcef"><p title="">45 Seconds</p></td></tr><tr class=""><td style="vertical-align: middle;text-align: center;"><p><strong>5</strong></p></td><td style="vertical-align: middle;text-align: center;"><p style="text-align: left;">Expanding the <strong>ENOVIA node</strong></p></td><td style="vertical-align: middle;text-align: center;"><p style="text-align: center;">200 Seconds</p></td><td class="highlight-#e3fcef" style="vertical-align: middle;text-align: center;" data-highlight-colour="#e3fcef"><p title="">52 Seconds</p></td></tr></tbody></table></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163515 space=CDH2024xR3 version=3 -->
## PAGE 00006: Add-on features

- page_id: `227163515`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163515/Add-on+features
- version_number: 3
- version_date: `2026-02-10T11:13:07.373+01:00`
...
<!--NOMAGIC_PAGE id=227163757 space=CDH2024xR3 version=1 -->
## PAGE 00007: Adding a new node to a Data Source

- page_id: `227163757`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163757/Adding+a+new+node+to+a+Data+Source
- version_number: 1
- version_date: `2023-07-14T06:08:39.468+02:00`
...
````html
<p>You can use DataHub Explorer to add a new node to a particular application without switching to that application. In addition, the new node you have added in DataHub Explorer also appears in the application itself. You can add a new node to any connected Data Sources by using the <strong>New Node</strong> command in the DataHub shortcut menu. Types of nodes vary, depending on the driver and the parent of the new node.</p><p><br /></p><p>To add a new node to a specific Data Source</p><hr /><ol><li>Right-click a node and select<strong> New Node</strong>.<br /><br /><ac:image><ri:attachment ri:filename="New_Node.png"><ri:page ri:content-title="Adding a new node to a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>The <strong>New Node</strong> dialog opens. Select a new node type from the tree view and click <strong>Next</strong>.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="Available Node Types under Data Node" ac:alt="Available Node Types under Data Node"><ri:attachment ri:filename="new-node-a.png"><ri:page ri:content-title="Adding a new node to a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p>     3.   Specify the new node’s properties details and click <strong>Finish</strong>.</p><p style="margin-left: 30.0px;"><ac:image ac:title="New Node wizard interface - step two - mapping node attributes" ac:alt="New Node wizard interface - step two - mapping node attributes"><ri:attachment ri:filename="new-node-b.png"><ri:page ri:content-title="Adding a new node to a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p>
````

<!--NOMAGIC_PAGE id=227164289 space=CDH2024xR3 version=2 -->
## PAGE 00008: Adding another attribute into the report template

- page_id: `227164289`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164289/Adding+another+attribute+into+the+report+template
- version_number: 2
- version_date: `2025-05-05T08:12:57.094+02:00`
...
4. Open the [DHLink Summary](https://docs.nomagic.com/display/CDH2024xR3/DHLink+summary) dialog in MagicDraw to [CONFLUENCE_PAGE title='Working with DHLink Summary reports' space='CDH2024xR3']
...
````html
<p>DataHub uses report template code from its report template to create the layout and detail of a <strong>DHLink Summary</strong> report. You can find the report template file in <em style="text-align: left;">&lt;install_root&gt;\</em><em>plugins\com.nomagic.datahub.magicdraw\data\templates\relation.html</em>. You can edit the report template file with any text editors to add more information to the report template. In this scenario, you want to add another attribute to the report template.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="The Inside of a Report Template" ac:alt="The Inside of a Report Template"><ri:attachment ri:filename="datahub-folder-relation-template.png"><ri:page ri:content-title="Adding another attribute into the report template" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The report template code inside the report template file and the construction of the report layout and data script.</h6><p>To add another attribute to the report template and generate a DHLink Summary report</p><hr /><ol><li>Open the template file located in <em style="text-align: left;">&lt;install_root&gt;\</em><em>plugins\com.nomagic.datahub.magicdraw\data\templates\relation.html</em>. with any text editors.</li><li><p class="auto-cursor-target">Type the following code in the highlighted area of the report template code fragment to add more attributes to the report template file. For example, if you want to add the <strong>Created Thru</strong> attributes into the report template file to include them in the DHLink Summary report, you must replace <em>&lt;Attribute name&gt;</em> with <strong>Created Thru</strong>.<br /><br /></p><ac:structured-macro ac:name="code" ac:schema-version="1" ac:macro-id="0d0a735e-5a93-4102-8d64-7f424a1bf17b"><ac:parameter ac:name="language">text</ac:parameter><ac:parameter ac:name="title">The code for adding another attribute in the report template file</ac:parameter><ac:plain-text-body><![CDATA[<br/>$DataHubReportEngine.decorateHTMLTag($row.sourceElement.entity.getAttributeValue("<Attribute name>"))]]></ac:plain-text-body></ac:structured-macro><h6 style="text-align: center;"><ac:image ac:align="left"><ri:attachment ri:filename="Report Template File.png"><ri:page ri:content-title="Adding another attribute into the report template" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="8c810da1-595f-4a5c-b948-268d17398be8"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>The name of the attribute you want to add in the report template file must be the same as the one that appears in the <strong>Cameo DataHub Properties</strong> tab.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Attribute Name in Property Tab.png"><ri:page ri:content-title="Adding another attribute into the report template" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The attribute name, e.g., Created Thru, in the DataHub Properties tab must match the &lt;Attribute name&gt; in the report template code.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li><p><span class="confluence-link">Save the template file.</span></p></li><li><p>Open the <a href="https://docs.nomagic.com/display/CDH2024xR3/DHLink+summary">DHLink Summary</a> dialog in MagicDraw to <ac:link><ri:page ri:content-title="Working with DHLink Summary reports" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[generate the DHLink Summary report.]]></ac:plain-text-link-body></ac:link></p></li></ol><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Summary Report (Before).png"><ri:page ri:content-title="Adding another attribute into the report template" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">A DHLink Summary report generated from the report template before adding another attribute.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Summary Report (After).png"><ri:page ri:content-title="Adding another attribute into the report template" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">A DHLink Summary report generated from the report template after adding another attribute.</h6>
````

<!--NOMAGIC_PAGE id=227164086 space=CDH2024xR3 version=1 -->
## PAGE 00009: Adding Data Sources for an OSLC Provider

- page_id: `227164086`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164086/Adding+Data+Sources+for+an+OSLC+Provider
- version_number: 1
- version_date: `2018-01-24T08:07:20.705+01:00`
...
````html
<p>To add a Data Source for an OSLC Provider</p><hr /><ol><li>Click <span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="dh-add-ds-btn.png"><ri:page ri:content-title="Adding Data Sources for an OSLC Provider" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> </span>on the <strong>DataHub Explorer</strong> toolbar. The <strong>Add Data Source</strong> dialog opens.</li><li>From the <strong>Driver</strong> drop-down list, select <strong>OSLC Provider</strong>.<br /><br /><ac:image><ri:attachment ri:filename="add_provider.png"><ri:page ri:content-title="Adding Data Sources for an OSLC Provider" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Enter the <strong>Root Services URI</strong>, <strong>Consumer key</strong>, and <strong>Consumer secret</strong> (provided by your administrator).</li><li>Click <strong>Create</strong>.</li></ol><p> The new OSLC Provider is added to the <strong>DataHub Explorer</strong> tree.</p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227163930 space=CDH2024xR3 version=1 -->
## PAGE 00010: Adding Data Sources for CSV

- page_id: `227163930`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163930/Adding+Data+Sources+for+CSV
- version_number: 1
- version_date: `2018-02-02T04:12:43.291+01:00`
...
````html
<p>To add a new CSV Data Source</p><hr /><ol><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Add Data Source</strong> <ac:image><ri:attachment ri:filename="dh-add-ds-btn.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>button .</li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="The Add Data Source button on the DataHub explorer toolbar" ac:alt="The Add Data Source button on the DataHub explorer toolbar"><ri:attachment ri:filename="dh-explorer-toolbar-add-ds.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br />The <strong>Add Data Source </strong>dialog opens.<br /><br /></p><p style="margin-left: 30.0px;"><ac:image ac:title="Adding a CSV Data Source to DataHub explorer" ac:alt="Adding a CSV Data Source to DataHub explorer"><ri:attachment ri:filename="add-ds-csv-a.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p>      2.  From the <strong>Driver</strong> drop-down list, select <strong>CSV</strong>.</p><p>      3.  Enter the <strong>CSV</strong> information in the following boxes explained in the table below</p><table><colgroup><col /><col /></colgroup><tbody><tr><th style="margin-left: 30.0px;">Field</th><th>Function</th></tr><tr><td colspan="1">File</td><td colspan="1">The CSV file to be added.</td></tr><tr><td>Key</td><td><div class="content-wrapper"><p>The name of the column header used as the ID of the node.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="cee5f392-7206-4894-abdb-9ec6669d76cc"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>The <strong>Key</strong> field is mandatory if you have selected the <strong>Copy Data with Sync</strong> operation from the<strong> Operation</strong> drop-down list in DataHub Explorer.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></div></td></tr><tr><td>Label</td><td><div class="content-wrapper"><p class="auto-cursor-target">The name of the column header created as the name of the node.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="654c9b53-7144-4cad-be2d-6fb9e8eb67bb"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If you leave the <strong>Label</strong> field blank, a running number will be assigned for the name.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></div></td></tr><tr><td>Separator</td><td>Select a delimiter for the CSV file. The available delimiters are comma, semi-colon, space, and slash.</td></tr><tr><td>Save option</td><td><div class="content-wrapper"><p>If you select the <ac:image><ri:attachment ri:filename="dh-save-auto.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> check box, DataHub makes changes to the CSV file when the CSV item is saved.</p></div></td></tr></tbody></table><p style="margin-left: 30.0px;">4. Click <strong>Create</strong>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="08fcfd8c-d8f4-4be6-b196-96780a0cfe01"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>A CSV file must contain the names of attributes in the first row and data in the other rows.</li><li>Once the CSV Data Source has been created, make sure the following conditions<br /><ul><li>The order of the data in the tree view in DataHub Explorer is the same as that of data in the CSV file.</li><li>If you edit the data in the tree view in DataHub Explorer, you must click <strong>Save <ac:image><ri:attachment ri:filename="save-btn.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong> to save the new data to the CSV file.</li><li>If the data in the CSV file has been updated, you must click <strong>Reload</strong> <strong><ac:image><ri:attachment ri:filename="reload.png"><ri:page ri:content-title="Adding Data Sources for CSV" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> </strong>to update the tree view in DataHub Explorer.</li><li>If a column name has been edited, or a new column has been added into the CSV file, the CSV Data Source will be corrupted. You have to remove and add the CSV Data Source again.</li></ul></li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="5955fe1e-3b4f-4616-b5bd-9525a7a01765"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>Nodes under a particular driver in DataHub Explorer represent nodes in the application that the driver represents.</li><li>If a driver is correctly started, the name of the driver appears in the tree view in DataHub Explorer. The driver connects to the data in each respective application.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164050 space=CDH2024xR3 version=4 -->
## PAGE 00011: Adding Data Sources for ENOVIA Requirements

- page_id: `227164050`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164050/Adding+Data+Sources+for+ENOVIA+Requirements
- version_number: 4
- version_date: `2025-07-01T14:20:22.909+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources
- labels: []
...
1. [CONFLUENCE_PAGE title='Authentication with 3DEXPERIENCE platform' space='MD2024xR3']
2. In the main menu, select 3DEXPERIENCE > ENOVIA Requirements. 
 
[IMAGE alt='' src='']

All the requirement owned by you are displayed in the CDH Explorer Panel. 
 
[IMAGE alt='' src='']

You can also view all the requirements accessible to you on the server.

To view all the requirements

- Right-click the ENOVIA REQS data source and select Show all elements . [ATTACHMENT filename='Show all element.png']

**Related page**

- Mapping source and target types to copy data to and from a modelling tool
- [CONFLUENCE_PAGE title='Authentication with 3DEXPERIENCE platform' space='MD2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>The ENOVIA Requirements connector, based on the Cameo DataHub framework, provides the data copy and synchronization functionality between your model and the requirement management application on the 3DEXPERIENCE platform. SAML is also supported for passing authorization credentials to the platform. Furthermore, Cameo DataHub enhances the ENOVIA requirements connection by applying a login with an embedded browser in place of a simple login form. As this is the new authentication technique, this login method allows you to connect to both requirement data sources deployed on Premises and Cloud.</p><p><br /></p><p>To add an ENOVIA <span>Requirements </span>Data Source</p><hr /><ol><li data-uuid="3b2a8ed3-de00-4765-b3fa-881a288283e0"><ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Authentication with 3DEXPERIENCE platform" /><ac:plain-text-link-body><![CDATA[Log in to the 3DEXPERIENCE platform.]]></ac:plain-text-link-body></ac:link></li><li data-uuid="4fd27ded-d14d-4d21-9666-75f5b5f8d598"><p class="auto-cursor-target">In the main menu, select 3DEXPERIENCE &gt; ENOVIA Requirements.<br /><br /><ac:image><ri:attachment ri:filename="ENOVIA Requirements option.png" /></ac:image></p></li></ol><p>All the requirement owned by you are displayed in the CDH Explorer Panel.<br /><br /><ac:image><ri:attachment ri:filename="Requirements.png" /></ac:image></p><p><br /></p><p>You can also view all the requirements accessible to you on the server.</p><p>To view all the requirements </p><hr /><ul><li data-uuid="038cb164-1ac6-4a9d-b882-8d274964088a">Right-click the <strong>ENOVIA REQS </strong>data source and select <strong>Show all elements</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Show all element.png" /></ac:image></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="aa53e7d4-98be-4ae1-8296-923ed11499de"><a href="https://docs.nomagic.com/display/CDH2024xR3/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool">Mapping source and target types to copy data to and from a modelling tool</a></li><li data-uuid="aa929ab1-e6b6-4a4e-b5f6-16ef82624fa5"><ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Authentication with 3DEXPERIENCE platform" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163940 space=CDH2024xR3 version=1 -->
## PAGE 00012: Adding Data Sources for IBM Rational DOORS

- page_id: `227163940`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163940/Adding+Data+Sources+for+IBM+Rational+DOORS
- version_number: 1
- version_date: `2024-05-14T12:41:53.241+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources
- labels: []
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="502fe4d1-2367-487b-bfbd-123aa3244f65"><ac:parameter ac:name="title">Prerequisite</ac:parameter><ac:rich-text-body><p>To add the <span style="color: rgb(51,51,51);">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>® </sup></span>data source, the properties file must be updated for JAVA version 17 and above.</p><p>To update the properties file</p><hr /><ol><li>Close the modeling tool.</li><li>Go to <em>&lt;install_root&gt;\bin</em> folder.</li><li>Open <em>&lt;modeling_tool_name&gt;</em>. properties file using any text editor.</li><li>At the end of the “JAVA_ARGS=” line, add any one of these three arguments:<ul><li>-Ddatahub.com_library\=VBS</li><li>-Ddatahub.com_library\=VBS-DXL</li><li>-Ddatahub.com_library\=COM4J</li></ul></li><li>Save and close the file.</li><li>Relaunch the modeling tool after saving the file.</li></ol></ac:rich-text-body></ac:structured-macro><p><br /></p><p><span style="color: rgb(51,51,51);">To add an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Data Source</span></p><hr /><ol><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Add Data Source</strong> button.<br /><br /><ac:image><ri:attachment ri:filename="Add data source.png"><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li><li> From the <strong style="letter-spacing: 0.0px;">Driver</strong><span style="letter-spacing: 0.0px;"> drop-down list, choose </span><strong style="letter-spacing: 0.0px;">IBM</strong><sup style="letter-spacing: 0.0px;">®</sup><span style="letter-spacing: 0.0px;"> </span><strong style="letter-spacing: 0.0px;">Rational<sup>®</sup> DOORS<sup>®</sup></strong><span style="letter-spacing: 0.0px;">.<br /><br /><ac:image><ri:attachment ri:filename="Select IBM DOORS.png"><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></span></li><li><span style="letter-spacing: 0.0px;">Click <strong style="letter-spacing: 0.0px;">Create<br /><br /><ac:image><ri:attachment ri:filename="Click Create.PNG"><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></strong></span></li></ol><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="508d1b7d-494d-427a-82ac-617e046a895d"><ac:parameter ac:name="title">Warning</ac:parameter><ac:rich-text-body><p><span>Before adding an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Data Source, you must start the DOORS client on your machine; otherwise, MagicDraw<sup>®</sup> generates an error dialog box.</span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163989 space=CDH2024xR3 version=1 -->
## PAGE 00013: Adding Data Sources for IBM Rational DOORS Next Generation

- page_id: `227163989`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163989/Adding+Data+Sources+for+IBM+Rational+DOORS+Next+Generation
- version_number: 1
- version_date: `2023-08-29T11:59:36.828+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources
- labels: []
...
<!--NOMAGIC_PAGE id=227163550 space=CDH2024xR3 version=3 -->
## PAGE 00018: Basic features of DataHub

- page_id: `227163550`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163550/Basic+features+of+DataHub
- version_number: 3
- version_date: `2026-02-10T11:14:42.574+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You will be guided through DataHub basic copying operations from the <strong>Operation</strong> drop-down list in Cameo DataHub Explorer including creating OSLC links and DHTraces. There is also more explanation about creating OSLC queries and copying their results, optionally as SysML requirements.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="6f2d6385-48e0-4de2-8a92-4805fe86c206" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164134 space=CDH2024xR3 version=2 -->
## PAGE 00019: Business Use Case flow with DNG

- page_id: `227164134`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164134/Business+Use+Case+flow+with+DNG
- version_number: 2
- version_date: `2025-05-05T08:12:56.805+02:00`
...
OSLC root services document URI can be found using the following pattern - http(s)://TWC_IP:PORT/oslc/rootservices. For more information, see [OSLC API](https://docs.nomagic.com/display/TWCloud2024xR3/OSLC+API).

You must also [publish the project as an OSLC resource in Cameo Collaborator for Teamwork Cloud](https://docs.nomagic.com/display/CC4TWC2024xR3/Publishing+an+OSLC+resource).

After establishing server and project-level relationships, open your modeling tool ([MagicDraw](https://docs.nomagic.com/display/MD2024xR3), [Cameo Systems Modeler](https://docs.nomagic.com/display/CSM2024xR3), or [Cameo Enterprise Architecture](https://docs.nomagic.com/display/CEA2024xR3)), and perform the following steps:

1. Add requirements (import or sync) from DNG through DataHub as described at [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space='CDH2024xR3'].
2. Copy requirements from DataHub to your model as described at [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR3']. The adding of requirements has been enhanced during OSLC consumer implementation in version 19.0. Users are able to see the DNG requirement’s OSLC Previews in the [OSLC Preview](https://docs.nomagic.com/display/CDH2024xR3/OSLC+Preview) tab of a modeling tool.
...
````html
<p>When used for a period of time, DataHub may contain DHLinks left over in the database where the referencing objects are no longer available. This can happen when nodes were manually removed without using the synchronization mechanism. Therefore, DataHub has another capability to detect unused DHLinks and remove them. You can also use this function when you want to split part of a synchronized model as a used project.</p><p><br /></p><p>To remove all unused DHLink</p><hr /><ul><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Remove non-use DHLink</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Command to Cleanup DHLink.png"><ri:page ri:content-title="Cleanup for unused DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ul><p>DataHub will detect the DHLinks that are not being used by any elements in the project, and the summary will be shown before you are confirmed to delete them.</p>
````

<!--NOMAGIC_PAGE id=227163741 space=CDH2024xR3 version=1 -->
## PAGE 00023: Closing and opening Data Sources

- page_id: `227163741`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163741/Closing+and+opening+Data+Sources
- version_number: 1
- version_date: `2018-02-02T05:15:35.124+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To close an open Data Source</p><hr /><ul><li>Right-click a Data Source in the <strong>DataHub Explorer</strong> tree and choose <strong><ac:image><ri:attachment ri:filename="close-ds.png"><ri:page ri:content-title="Closing and opening Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>.</li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="227ab3ef-e0d9-4259-9d5e-ca03f5e98b8c"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>Closing a Data Source doesn’t remove it from the <strong>DataHub Explorer</strong> tree. This action is only for deactivation.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To open or activate an inactive Data Source</p><hr /><ul><li>Right-click an inactive Data Source and choose <strong><ac:image><ri:attachment ri:filename="connect.png"><ri:page ri:content-title="Closing and opening Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>. The Data Source shows as connected.</li></ul>
````

<!--NOMAGIC_PAGE id=227164038 space=CDH2024xR3 version=1 -->
## PAGE 00024: Collection nodes in DOORS Next Generation

- page_id: `227164038`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164038/Collection+nodes+in+DOORS+Next+Generation
- version_number: 1
- version_date: `2023-07-27T10:29:39.092+02:00`
...
````html
<p>You can work with an artifact in a Collection via a new Collection tab that displays items of the Collection artifact by using the <strong>Open collection in new window</strong> command.</p><p><br /></p><p>To open a Collection artifact in a new tab</p><hr /><ul><li>Right-click a Collection element in DataHub Explorer and select <strong>Open collection in new window</strong>.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Open collection.png"><ri:page ri:content-title="Collection nodes in DOORS Next Generation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Open collection in new window command.</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="An Open DOORS Next Generation Collection Artifact Tab in DataHub Explorer.png"><ri:page ri:content-title="Collection nodes in DOORS Next Generation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">An open DOORS Next Generation Collection artifact tab in DataHub Explorer.</h6><p>The new Collection artifact tab that shows items of the Collection artifact will open in DataHub Explorer.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="61a4d8b4-c545-434f-b429-4312515ad7c4"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>DataHub records the open Collection artifact tab as a new Alias tree, thus allowing you to directly open the DOORS Next Generation Collection artifact tab by clicking <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Alias Manager</strong> and selecting the Collection from the list at the next time you connect the DOORS Next Generation Data Source.</li><li>All associated DHLinks created will be available only within the Collection artifact tab.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164007 space=CDH2024xR3 version=1 -->
## PAGE 00025: Comment elements under Requirements of DOORS Next Generation Data Source

- page_id: `227164007`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164007/Comment+elements+under+Requirements+of+DOORS+Next+Generation+Data+Source
- version_number: 1
- version_date: `2023-07-27T07:23:46.913+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>In DOORS Next Generation, comments are together with Requirements as attributes. DataHub captures comments by reading them as comment elements under Requirements. Therefore, you can import and create mappings with any element types, including comment elements, under SysML Requirements.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DNG Comment.png"><ri:page ri:content-title="Comment elements under Requirements of DOORS Next Generation Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Comment elements in DOORS Next Generation under a Requirement.</h6><p>To display a DOORS Next Generation comment element under a Requirement</p><hr /><ul><li>Right-click a DOORS Next Generation Data Source and select <strong>Show comments</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Show_comments.png"><ri:page ri:content-title="Comment elements under Requirements of DOORS Next Generation Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ul><p>The comment element(s) will be displayed under the Requirement(s) of the selected Data Source.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Show Comments for DOORS NG.png"><ri:page ri:content-title="Comment elements under Requirements of DOORS Next Generation Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Comment elements are shown under the Requirement of the selected DOORS Next Generation Data Source.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a3bae2f8-d19b-4a19-a426-92db3406d4a5"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>DataHub does not show the Requirements’ comment elements by default.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163485 space=CDH2024xR3 version=2 -->
## PAGE 00026: Compatible data sources

- page_id: `227163485`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163485/Compatible+data+sources
- version_number: 2
- version_date: `2026-02-10T11:10:45.932+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=227164044 space=CDH2024xR3 version=2 -->
## PAGE 00027: Configuration Management

- page_id: `227164044`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164044/Configuration+Management
- version_number: 2
- version_date: `2025-11-20T13:04:47.688+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
- [CONFLUENCE_PAGE title='Installing modeling tools' space='NMDOC']
- [CONFLUENCE_PAGE title='Installing plugins in earlier versions' space='NMDOC']
- [CONFLUENCE_PAGE title='Installing Teamwork Cloud on Windows' space='TWCloud2024xR3']
- [CONFLUENCE_PAGE title='Cameo Collaborator for Teamwork Cloud Documentation' space='CC4TWC2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Software requirements</h3><p>To link and share data using Open Services for Lifecycle Collaboration (OSLC) integration, ensure that the following software requirements are met:</p><ul><li data-uuid="3c3f1782-2e24-4746-8225-74bcbc212c00">The following software is installed on your machine:<ol><li>Modeling tool with the Requirements plugin (e.g., MagicDraw + Requirements plugin, Cameo Systems Modeler, Cameo Enterprise Architecture)</li><li>Cameo DataHub</li></ol></li></ul><ul><li class="auto-cursor-target" data-uuid="a4e16158-fca3-4a53-a9fc-b3a17eb87d4d">You have access to the following software on a server:<br /><ol><li>Teamwork Cloud</li><li>Cameo Collaborator for Teamwork Cloud</li><li>Doors Next Generation v6.0.3+ (DNG)<br /><br /></li></ol></li></ul><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="4d23ba4a-401c-4b82-8cc0-3dd47bf95b75"><ac:parameter ac:name="title">Software versions</ac:parameter><ac:rich-text-body><p>You must use the same version of a modeling tool and Cameo DataHub, and the same version of Teamwork Cloud and Cameo Collaborator for Teamwork Cloud. For more information, see the <a href="https://www.nomagic.com/support/compatibility">product compatibility page</a>.</p></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="fecbe8e1-d0b4-44f9-8a78-8656548e1fb1"><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Installing modeling tools" /><ac:plain-text-link-body><![CDATA[Installing modeling tools]]></ac:plain-text-link-body></ac:link></li><li data-uuid="34d4cb64-29c9-49f1-8515-059c683ef975"><ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Installing plugins in earlier versions" /><ac:plain-text-link-body><![CDATA[Installing plugins]]></ac:plain-text-link-body></ac:link></li><li data-uuid="bdabf8e5-e8b4-47ec-9e07-ab48e8c2697d"><ac:link><ri:page ri:space-key="TWCloud2024xR3" ri:content-title="Installing Teamwork Cloud on Windows" /><ac:plain-text-link-body><![CDATA[Installing and configuring Teamwork Cloud]]></ac:plain-text-link-body></ac:link></li><li data-uuid="31ce03de-8e62-4b29-8016-1240262bdd83"><ac:link><ri:page ri:space-key="CC4TWC2024xR3" ri:content-title="Cameo Collaborator for Teamwork Cloud Documentation" /><ac:plain-text-link-body><![CDATA[Installing Cameo Collaborator for Teamwork Cloud]]></ac:plain-text-link-body></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163691 space=CDH2024xR3 version=2 -->
## PAGE 00029: Confirmation

- page_id: `227163691`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163691/Confirmation
- version_number: 2
- version_date: `2025-05-05T08:12:55.481+02:00`
...
````html
<p>This DataHub operation is similar to <strong>Copy Data with Sync</strong>, but whereas synchronization relations are either source to target, or target to source, or bidirectional, the direction of DHTrace is not important. There is only a link relationship between the source and target nodes. When either of the nodes changes, the DHTrace relationship is marked with a <strong>Suspect</strong> status and allows you to clear the DHTrace and validate the Requirement.</p><p><br /></p><p>To Copy Data with DHTrace</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>, select <strong>Copy Data with DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy_Data_With_DHTrace_Operation.png"><ri:page ri:content-title="Copy Data with DHTrace operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p>Drag some selected nodes from the Cameo DataHub Explorer panel to the Containment tree.<br /><br /></p><ac:image><ri:attachment ri:filename="MD Tree for CopyandCreateDHTrace.png"><ri:page ri:content-title="Copy Data with DHTrace operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br />The <strong>Create DHTrace</strong> <strong>Summary</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Create DHTrace Summary Dialog.png"><ri:page ri:content-title="Copy Data with DHTrace operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p class="auto-cursor-target">Make some changes to the nodes on any side, e.g., modifying a node or deleting a node.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="487c5573-94a9-4169-8f36-cb8976a1adc8"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>DHTrace can detect a modified or deleted node.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li>Right-click the changed node on either side and select <strong>Check DHTrace Changes Recursively</strong>. The <strong>DHTrace Summary</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="DHTrace Summary.png"><ri:page ri:content-title="Copy Data with DHTrace operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Select the checkboxes to the left of any Suspect relationships and click <strong>OK</strong> to clear the <strong>Suspect</strong> DHTrace links.</li></ol><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="98256673-0b0e-43e8-95e7-0a1eb0b0cc7c"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>If you do not clear the suspect DHTrace links, they will have the <strong>Suspect</strong> status.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="384ab95b-61b7-4bcc-aa67-1d5b069042f5"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><p><strong>Copy Data</strong>, <strong>Copy Data with Sync</strong>, and<strong> Copy Data</strong> <strong>with DHTrace</strong> all copy data along with links. To skip copying links, hold <strong>CTRL</strong> while dragging the nodes. This operation ignores the links in the application, e.g., DOORS 9.X Link, DOORS Next Generation Link, and MagicDraw Link.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163817 space=CDH2024xR3 version=1 -->
## PAGE 00032: Copy Data with Sync operation

- page_id: `227163817`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163817/Copy+Data+with+Sync+operation
- version_number: 1
- version_date: `2023-02-02T07:08:08.176+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer
- labels: []
...
<!--NOMAGIC_PAGE id=227164023 space=CDH2024xR3 version=1 -->
## PAGE 00034: Copying DHLinks across Stream or Baseline Data Sources

- page_id: `227164023`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164023/Copying+DHLinks+across+Stream+or+Baseline+Data+Sources
- version_number: 1
- version_date: `2023-07-28T07:19:22.894+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>When you have synchronization with any existing Stream or Baseline, you can continue it with a new stream or baseline. DataHub enables you to copy DHLinks from one Stream or Baseline Data Source to another.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_Selection.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Selecting an existing DHLink in an Initial Stream or Baseline.</h6><p>To copy an existing DHLink to another Stream or Baseline Data Source</p><hr /><ol><li style="text-align: left;">Right-click an element in the target Stream or Baseline that DHLink(s) will be copied to and select <strong>Copy DHLink from other data sources</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy_DHLinks from other data source.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li style="text-align: left;">The <strong style="letter-spacing: 0.0px;">Copy DHLink from other data sources</strong><span style="letter-spacing: 0.0px;"> dialog box opens. From the </span><strong style="letter-spacing: 0.0px;">Select root element of the DHLink</strong><span style="letter-spacing: 0.0px;"> list, select a Stream or baseline to copy DHLink(s) from. Click </span><strong style="letter-spacing: 0.0px;">OK</strong><span style="letter-spacing: 0.0px;">.</span><br /><br /><ac:image><ri:attachment ri:filename="Dailog_box.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol><p><br /><span style="letter-spacing: 0.0px;">After links are copied from one data source to the other, both data sources will not contain synchronized links. Data sources </span><span style="letter-spacing: 0.0px;">those links are copied from will be displayed with an <em><strong>x</strong></em> icon on the components, <span>indicating that it is not in </span>synchronization<span> with the model</span>. The other data source the links are copied to will be displayed with an <em><strong>s</strong></em> icon on the components, indicating that it is in </span>synchronization<span style="letter-spacing: 0.0px;"> with the model.</span></p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_copy.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The duplicated DHLink copied from the Initial Stream</h6><p>It is possible to have both sources in synchronization by selecting the <strong>Include Link Recursively</strong> command.</p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Inlcude DHLinks.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Inlcude DHLinks Recursively command</h6><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DHlink_copy_both_sync.png"><ri:page ri:content-title="Copying DHLinks across Stream or Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Both data sources in synchronization</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="cbe65665-f9b5-4667-be69-52cba4a780f5"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The selected element in the target Stream must be the root element of DHLink(s) in the other Stream Data Source to perform the copying DHLink operation across Stream Data Sources.</li><li>When the Check for change command is initiated, you need to select which target stream to check the model against.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164120 space=CDH2024xR3 version=1 -->
## PAGE 00035: Copying OSLC query results to a modeling tool as SysML Requirements

- page_id: `227164120`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164120/Copying+OSLC+query+results+to+a+modeling+tool+as+SysML+Requirements
- version_number: 1
- version_date: `2018-02-08T05:01:41.157+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []

### NORMALIZED CONTENT

To copy OSLC query results to a modeling tool as SysML Requirements, you must set up [CONFLUENCE_PAGE title='Adding IBM Rational DOORS Next Generation Data Sources' space='CDH2024xR3']an IBM® Rational® DOORS® Next Generation Data Source and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.

To copy OSLC query results to a modeling tool as SysML Requirements

1. Complete the steps of [CONFLUENCE_PAGE title='Creating OSLC queries' space='CDH2024xR3'] .
...
````html
<p>To copy OSLC query results to a modeling tool as SysML Requirements, you must set up <ac:link><ri:page ri:content-title="Adding IBM Rational DOORS Next Generation Data Sources" ri:space-key="CDH2024xR3" /><ac:link-body>an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</ac:link-body></ac:link> and query the Data Source using OSLC query syntax. When you have the query results, you can copy them into your modeling tool as SysML Requirements.</p><p>To copy OSLC query results to a modeling tool as SysML Requirements</p><hr /><ol><li>Complete the steps of <ac:link><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[creating OSLC queries]]></ac:plain-text-link-body></ac:link>.</li><li>From the OSLC query results, drag the matching query tree to the Containment tree of the modeling tool.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="export-from-oslc-qe.png"><ri:page ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p><p style="margin-left: 30.0px;">2. The <strong>Copy Data</strong> dialog opens. From the target type list in the <strong>MagicDraw Side</strong> group, choose <strong>Extended Requirement</strong>. Click <strong>OK</strong>.<br /><br /></p><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Copy Data for OSLC Query User Guide.png"><ri:page ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p><br /></p><p>The result of the copy is shown in the MagicDraw Containment tree.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="export-doors-ng-node-2.png"><ri:page ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="margin-left: 30.0px;text-align: center;">The result of the copied OSLC query in the MagicDraw Containment tree.</h6><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="c9cbee8c-4d2b-4f4b-8733-bc9cbfe86342"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p style="margin-left: 30.0px;"><strong>OSLC Query Editor</strong><span> supports the </span><strong>Copy Data</strong>,<strong> Copy Data with DHTrace</strong>, and<strong> Create DHTrace</strong><strong> </strong>operations<span>.</span></p><p style="margin-left: 30.0px;"><span><br /></span></p><p><ac:image ac:align="center"><ri:attachment ri:filename="OSLC Query Editor.png"><ri:page ri:content-title="Copying OSLC query results to a modeling tool as SysML Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Copy Data, Copy Data with DHTrace, and Create DHTrace operations are supported in the OSLC Query Editor dialog.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163895 space=CDH2024xR3 version=3 -->
## PAGE 00036: Copying Requirements into a modeling tool

- page_id: `227163895`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163895/Copying+Requirements+into+a+modeling+tool
- version_number: 3
- version_date: `2026-02-10T11:18:47.701+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub allows you to copy Requirements from DOORS into UML diagrams, from DOORS Data Source to the Containment area as Use Case diagrams, from DOORS or DOORS Next Generation to a modeling tool with DHLinks, and copy Requirements using OSLC links.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="96c19c2f-7366-41b0-ad7b-00ce7fa929ff" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163896 space=CDH2024xR3 version=1 -->
## PAGE 00037: Copying Requirements to a modeling tool as the SysML Requirement diagram

- page_id: `227163896`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163896/Copying+Requirements+to+a+modeling+tool+as+the+SysML+Requirement+diagram
- version_number: 1
- version_date: `2018-08-06T09:34:28.860+02:00`
...
1. [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS' space='CDH2024xR3'] or [CONFLUENCE_PAGE title='Adding Data Sources for IBM Rational DOORS Next Generation' space='CDH2024xR3'] in DataHub Explorer.
...
````html
<p>You can copy text-based Requirements and their associated Use Cases from DOORS or DOORS Next Generation Data Sources by simply dragging the node from the DOORS Data Source to your modeling tool's Containment tree.</p><p>This section deals with how to copy text-based Requirements from IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> into a UML diagram.</p><p>To copy Requirements from DOORS Data Source to a modeling tool as the SysML Requirement diagram</p><hr /><ol><li class="confluence-link"><ac:link><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[Add a DOORS Data Source ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:content-title="Adding Data Sources for IBM Rational DOORS Next Generation" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[DOORS Next Generation Data Source ]]></ac:plain-text-link-body></ac:link>in DataHub Explorer.</li><li>Select a node and drag it from DataHub Explorer to your modeling tool's Containment area.</li><li><p>Map the Formal Module to a package and the object to a base stereotype of the Requirement. Click <strong>OK</strong>. <br /><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Copy Data with Object.png"><ri:page ri:content-title="Copying Requirements to a modeling tool as the SysML Requirement diagram" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p></li></ol><h6 style="margin-left: 30.0px;text-align: center;">The Copy Data dialog in Group Type Mapping mode when copying Requirements from DOORS to the modeling tool's Containment tree.</h6><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Result of copying SysML requirements diagram to MagicDraw" ac:alt="Result of copying SysML requirements diagram to MagicDraw"><ri:attachment ri:filename="result-of-import-req-diag.png"><ri:page ri:content-title="Copying Requirements to a modeling tool as the SysML Requirement diagram" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p><br /></p><h6 style="text-align: center;"> The dragged Requirement elements in the Requirement diagram as the result of copying.</h6>
````

<!--NOMAGIC_PAGE id=227163904 space=CDH2024xR3 version=2 -->
## PAGE 00038: Copying Requirements to a modeling tool as the Use Case diagram

- page_id: `227163904`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163904/Copying+Requirements+to+a+modeling+tool+as+the+Use+Case+diagram
- version_number: 2
- version_date: `2025-05-05T08:12:56.036+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
````html
<p>This section deals with copying a Use Case diagram from a DOORS Data Source into your modeling tool's Containment area.</p><p>To copy a Use Case from a DOORS Data Source to a modeling tool as the Use Case diagram</p><hr /><ol><li><a href="https://docs.nomagic.com/display/CDH2024xR3/Adding+Data+Sources+for+IBM+Rational+DOORS">Add a DOORS Data Source </a>or <a href="https://docs.nomagic.com/display/CDH2024xR3/Adding+Data+Sources+for+IBM+Rational+DOORS+Next+Generation">DOORS Next Generation Data Source </a>in DataHub Explorer.</li><li><p style="text-align: left;">Drag the selected node from DOORS Data Source to your modeling tool's Containment tree.<br /><br /><ac:image ac:title="Drag and drop to copy requirements from DOORS data source to MagicDraw" ac:alt="Drag and drop to copy requirements from DOORS data source to MagicDraw"><ri:attachment ri:filename="importing-reqs-from-doors-ds.png"><ri:page ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p></li><li><p style="text-align: left;">Map the Formal Module to a Use Case diagram type and the object to a Use Case type. Click <strong>OK</strong>.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="Copy Data with Object.png"><ri:page ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p></li></ol><h6 style="text-align: center;margin-left: 30.0px;">The Copy Data dialog in Group Type Mapping mode when copying Use Case elements from DOORS to the modeling tool's Containment area.</h6><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="Result of copying Use Case Diagram to MagicDraw" ac:alt="Result of copying Use Case Diagram to MagicDraw"><ri:attachment ri:filename="result-of-import-use-case.png"><ri:page ri:content-title="Copying Requirements to a modeling tool as the Use Case diagram" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Use Case diagram after copying Requirements from DOORS to a modeling tool.</h6>
````

<!--NOMAGIC_PAGE id=227163912 space=CDH2024xR3 version=1 -->
## PAGE 00039: Copying Requirements to a modeling tool with DHLinks

- page_id: `227163912`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163912/Copying+Requirements+to+a+modeling+tool+with+DHLinks
- version_number: 1
- version_date: `2018-02-06T09:15:39.483+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
````html
<p>To copy Requirements from DOORS or DOORS Next Generation Data Source to a modeling tool</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Copy Data with Sync</strong>.</li><li>Drag a data node in a DOORS or DOORS Next Generation Data Source from DataHub Explorer to the modeling tool's Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="Copy Requirement with DHLinks.png"><ri:page ri:content-title="Copying Requirements to a modeling tool with DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>The <strong>Copy Data with Sync</strong> dialog appears. From the <strong>Mapping Mode</strong> drop-down list, choose <strong>Individual Type Mapping</strong> or <strong>Group Type Mapping</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy Data with Sync Dialog with Mapping Dropdown List (Group Mapping).png"><ri:page ri:content-title="Copying Requirements to a modeling tool with DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>After you finish all attribute mappings, click <strong>OK</strong>. The copying result is shown in the modeling tool's Containment tree.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="Result of copying SysML requirement with DHLink" ac:alt="Result of copying SysML requirement with DHLink"><ri:attachment ri:filename="result-of-import-req-as-dh-link.png"><ri:page ri:content-title="Copying Requirements to a modeling tool with DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p>
````

<!--NOMAGIC_PAGE id=227163922 space=CDH2024xR3 version=1 -->
## PAGE 00040: Copying Requirements to a modeling tool with OSLC links

- page_id: `227163922`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163922/Copying+Requirements+to+a+modeling+tool+with+OSLC+links
- version_number: 1
- version_date: `2023-07-14T07:03:39.918+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer > Copying Requirements into a modeling tool
- labels: []
...
This version of DataHub now supports OSLC queries and links that you can [CONFLUENCE_PAGE title='Create DHTrace operation with OSLC links' space='CDH2024xR3'].
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ad0ec783-712d-491a-8709-a013333b8cc6"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p>This version of DataHub now supports OSLC queries and links that you can <ac:link><ri:page ri:content-title="Create DHTrace operation with OSLC links" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[create OSLC links through the Create DHTrace operation]]></ac:plain-text-link-body></ac:link>.</p><p><br /></p><p>To copy Requirements using OSLC links</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create_DHTrace.png"><ri:page ri:content-title="Copying Requirements to a modeling tool with OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>From an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source, drag a node into the modeling tool's Containment area. A shortcut menu appears, prompting you to select the type of link. Select one from the shortcut menu.<br /><br /><ac:image><ri:attachment ri:filename="Create OSLC Link by Create DHTrace.png"><ri:page ri:content-title="Copying Requirements to a modeling tool with OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li></ol><p><ac:image ac:align="center"><ri:attachment ri:filename="result-of-create-oslc-link.png"><ri:page ri:content-title="Copying Requirements to a modeling tool with OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The newly created OSLC hyperlink from copying the Requirement in the modeling tool's Containment tree.</h6>
````

<!--NOMAGIC_PAGE id=227163867 space=CDH2024xR3 version=3 -->
## PAGE 00041: Create DHTrace operation with OSLC links

- page_id: `227163867`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163867/Create+DHTrace+operation+with+OSLC+links
- version_number: 3
- version_date: `2026-02-10T11:19:15.385+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="eb70b979-0fa0-474c-8101-94279fb2a98e"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In addition to creating DHTrace, the <strong>Create DHTrace</strong> operation enables you to create OSLC links instead of using the <strong>Create OSLC link</strong> operation in earlier versions of Cameo DataHub 19.0.</p></ac:rich-text-body></ac:structured-macro><h3>Create DHTrace operation</h3><p>This DataHub operation does not copy data. It only creates a DHTrace link from a source to a target. When the source has any changes, the DHTrace link becomes <strong>Suspect</strong>.</p><p><br /></p><p>To create DHTrace</p><hr /><ol><li data-uuid="7ceb0ec2-b06e-4fd3-87da-f2b68225909e">From the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create_DHTrace.png" /></ac:image><br /><br /></li><li data-uuid="0e0874b0-c11a-4127-8106-4abb163fd425">Drag any nodes from <strong>DataHub Explorer</strong> to the MagicDraw Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="MD Tree for CreateDHTrace.png" /></ac:image><br /><br />The <strong>Create DHTrace Summary</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Create DHTrace Summary Dialog.png" /></ac:image><br /><br /></li><li data-uuid="7c05a3e0-1a73-4150-8b0d-a52dd111af96">When you modify the source nodes, right-click one of them and select <strong>Check Changes</strong> &gt; <strong>Check DHTrace Changes</strong> or <strong>Check DHTrace Changes recursively</strong>. The <strong>DHTrace Summary</strong> dialog appears showing the <strong>Suspect</strong> status of the DHTrace links.<br /><br /><ac:image><ri:attachment ri:filename="DHTrace Summary.png" /></ac:image><br /><br /></li><li data-uuid="4909ed8f-c161-4f6e-8424-00773f88d452">Select the checkboxes of the data nodes you want to clear the <strong>Suspect</strong> status in the <strong>DHTrace Summary</strong> dialog and click <strong>OK</strong>.</li></ol><h3>Creating OSLC links through the Create DHTrace operation</h3><p><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="ad0ec783-712d-491a-8709-a013333b8cc6"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p>OSLC links can be created when you open an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source in DataHub.</p><p><br /></p><p>To create an OSLC link</p><hr /><ol><li data-uuid="42040ce6-ca1e-4130-89b6-ec689408bd69">From the <strong>Operation</strong> drop-down list in <strong>DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.</li><li data-uuid="bea56522-862e-45f4-83a2-5e265a247001"><p class="_mce_tagged_br" style="text-align: left;">From an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source, drag a node into the MagicDraw<sup>®</sup> Containment area.</p></li><li data-uuid="22a0e9fa-716f-45a6-b1ad-d8448f819014"><p class="_mce_tagged_br" style="text-align: left;">A shortcut menu prompts you to choose the type of link. Select one from the shortcut menu. The link of the selected type will be created.<br /><br /></p><ac:image ac:align="left" ac:title="Figure OSLC Link types" ac:alt="Figure OSLC Link types"><ri:attachment ri:filename="worddav5a3754b972c5e28584dc28a2a6a5178a.png" /></ac:image></li></ol><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="worddav940b362d2a8553e7320fdc5b60af115c.png" /></ac:image></p><h6 style="text-align: center;">The newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree.</h6><p style="margin-left: 30.0px;text-align: center;"><ac:image ac:title="Properties of OSLC Link " ac:alt="Properties of OSLC Link "><ri:attachment ri:filename="worddavae7ad7197fdcea58505c68e4c441a7fb.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink's Properties.</h6><p style="margin-left: 30.0px;text-align: center;"><ac:image><ri:attachment ri:filename="OSLC Hyperlink.png" /></ac:image></p><h6 style="text-align: center;margin-left: 30.0px;">The OSLC hyperlink is in the DH Links panel.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="5e84bade-c62f-4d03-83d0-e32975745c6b"><ac:link><ri:page ri:content-title="Creating OSLC links" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163858 space=CDH2024xR3 version=1 -->
## PAGE 00042: Create Sync operation

- page_id: `227163858`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163858/Create+Sync+operation
- version_number: 1
- version_date: `2023-07-14T06:35:10.076+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Operations in DataHub Explorer
- labels: []
...
3. The Create Sync Wizard will appear. Perform the Type/Attribute mapping as you would while using the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR3'] . [ATTACHMENT filename='CreateSync_Wizard.png']
...
````html
<p style="text-align: left;">The Create Sync operation is an addition to the list of Cameo DataHub operations. The Create Sync operation will recreate synchronization (DHLinks) if you lose or delete the DHLinks. Before, in order to recreate synchronization (DHLinks), if you lost or deleted the DHLinks you were required to copy the data from the Cameo DataHub to the modeling tool(Cameo) using the Copy Data with Sync operation. This new operation allows you to recreate synchronization(DHLinks) without replicating the data.<br /><br /></p><h6 style="text-align: center;"><ac:image><ri:attachment ri:filename="Same Data.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br />The same data source exists in the Cameo DataHub Explorer panel and the Modelling tool without DHLinks</h6><p>To create sync between existing data</p><hr /><ol><li><span style="color: rgb(62,63,64);">From the<span> </span></span><strong>Operation</strong><span style="color: rgb(62,63,64);"> list in<span> the </span></span><strong>Cameo DataHub Explorer </strong>panel<span style="color: rgb(62,63,64);">, select<span> </span></span><strong>Create Sync</strong><span style="color: rgb(62,63,64);">.<br /><br /><ac:image><ri:attachment ri:filename="Create_Sync.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></span></li><li>Drag the parent data set from the Cameo DataHub Explorer panel and drop it over the identical data set in the Containment tree.<br /><br /><ac:image><ri:attachment ri:filename="Create Sync_Drag and Drop.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>The Create Sync Wizard will appear. Perform the Type/Attribute mapping as you would while using the <ac:link><ri:page ri:content-title="Copy Data with Sync operation" ri:space-key="CDH2024xR3" /></ac:link>. <br /><br /><ac:image><ri:attachment ri:filename="CreateSync_Wizard.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Select the mapped type, then choose the <strong>Key attribute </strong>between them. The key attribute will be used to match the values. <br /><br /><ac:image ac:border="true"><ri:attachment ri:filename="CreateSync_Wizard_2.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p class="auto-cursor-target">Once matching results are displayed, do one or several of the following:</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="84e8ec61-84a7-462f-bb96-86b3924bc0e6"><ac:rich-text-body><p>The matching result displays the matched attributes in green(Sync relation created) and unmatched attributes in red(Sync relation not created).</p></ac:rich-text-body></ac:structured-macro><ul><li>If there are key attributes that do not match (highlighted in red) and you want them to be included, select the checkbox for the particular value and click <strong>Add Sync</strong>.</li><li>If there are key attributes that match and you do not want them to be included, select the checkbox for the particular value and click <strong>Remove Sync.</strong></li><li>If there are key attributes that do not match (highlighted in red)and you want them to be excluded, select the checkbox for the particular value and click <strong>Exclude</strong>.</li><li>Select <strong>Ignore</strong> <strong>all no sync source entities</strong> checkbox, if you want all nodes that did not match to be ignored. The synchronization will discover them later.</li><li>Select <strong>Exclude all no sync source entities </strong>checkbox, if you want all the nodes that did not match to be marked as Excluded. The synchronization will no longer include them in the operation.<br /><br /><ac:image><ri:attachment ri:filename="CreateSync_Wizard_3.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li></ul></li><li><p class="auto-cursor-target">Click <strong>Finish</strong>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="343eb2e6-cf3f-4c62-a8dd-4e2382a57e94"><ac:rich-text-body><p>Until every node is marked as synced or excluded, you cannot click <strong>Finish.</strong></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="CreateSync_Wizard_4.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p class="auto-cursor-target">Once the procedure is finished, the newly created synchronization will be visible as shown in the image below, denoted with the <strong>S </strong>icon.<br /><br /><ac:image><ri:attachment ri:filename="Sync_Done.png"><ri:page ri:content-title="Create Sync operation" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p></li></ol>
````

<!--NOMAGIC_PAGE id=227164012 space=CDH2024xR3 version=1 -->
## PAGE 00043: Creating a Stream and Baseline as a Data Source

- page_id: `227164012`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164012/Creating+a+Stream+and+Baseline+as+a+Data+Source
- version_number: 1
- version_date: `2023-07-27T07:56:50.770+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
````html
<p>A Component is a container in a project that you can use to organize artifacts. When connected with a DOORS Next Generation Data Source, DataHub lists Components under each project.  The main Data Source tree still displays artifacts from default Components. You can also open additional Components as another Data Source. Additionally, you can perform all DataHub operations, such as the main Data Source, from the Component Data Source.</p><p><span class="confluence-embedded-file-wrapper image-center-wrapper"><ac:image ac:align="center"><ri:attachment ri:filename="Components Supported in Cameo DataHub.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></span></p><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="Components in DOORS NG.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></span></p><h6 style="text-align: center;">Components in DOORS Next Generation.</h6><p style="text-align: center;"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="Components in DOORS Next Generation.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></span></p><h6 style="text-align: center;">Components in DOORS Next Generation in Cameo DataHub Explorer.</h6><p>You can now work with a Stream and Baseline by creating a new Data Source from components; thus, DOORS Next Generation projects can be connected to a specific Stream and Baseline.</p><p><br /></p><p>To create a Stream as a Data Source</p><hr /><ul><li>Right-click a Component element in DataHub Explorer and select <strong>Create Stream as Data Source</strong>.<br /><br /></li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Create Component or Stream as Data Source Command.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Create Component/Stream as Data Source command.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="eb78f629-4d38-4d98-8a1d-deb7a74288e4"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>An Initial Stream is used when creating a Data Source for a Component without an additional Stream.</li><li>If the Component with Stream(s) other than the Initial Stream is selected, the <strong>Select stream</strong> list in the <strong>Create Stream as Data Source</strong> dialog box will appear.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="Select_component or stream.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Select stream list in the Create Stream as Data Source dialog.</h6></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Created Component Stream Data Source.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The created Stream Data Source.</h6><p class="auto-cursor-target"><br /></p><p class="auto-cursor-target">To create a Baseline as a Data Source</p><hr /><ul><li>Right-click a Component element in DataHub Explorer and select <strong>Create Baseline as Data Source</strong>.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_creation.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Create Baseline as Data Source command.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a2390e6c-6994-4b2b-8206-16616f4c6f4d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>An Initial Baseline is used when creating a Data Source for a Component without an additional Stream.</li><li>If the Component with Baseline(s) other than the Initial Stream is selected, the <strong>Select baseline </strong>list in the <strong>Create Baseline as Data Source</strong> dialog box will appear.</li></ul><p style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_selection.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Select baseline list in the Create Baseline as Data Source dialog box.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target" style="text-align: center;"><br /></p><p class="auto-cursor-target" style="text-align: center;"><ac:image><ri:attachment ri:filename="Baseline_created.png"><ri:page ri:content-title="Creating a Stream and Baseline as a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The created Baseline Data Source.</h6><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="0e94662f-8e68-4617-9160-846140545311"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>Components on the CDH Explorer panel and DNG side are only visible and available to use when the Configuration Management for selected projects is enabled.</li><li>The Stream and Baseline Data Source name is represented in the format of<em> &lt;Project Area name&gt;</em> | <em>&lt;Component name&gt;</em> | <em>&lt;Stream/Baseline name&gt;</em>.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163768 space=CDH2024xR3 version=3 -->
## PAGE 00044: Creating Alias

- page_id: `227163768`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163768/Creating+Alias
- version_number: 3
- version_date: `2026-02-10T11:17:39.410+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>To create <strong>Alias Explorer</strong></p><hr /><ul><li data-uuid="157d94ce-a4d4-43a8-bcc6-c202b81474aa">Right-click a node that you want to create the selected scope and click <strong>Create Alias</strong>. The <strong>Alias Explorer</strong> tab opens, showing only the nodes in the scope that you have selected.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Create_Alias.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="74f047fe-3bfc-4474-9669-a2e0ba24dbcb"><strong><ac:link><ri:page ri:content-title="DataHub Alias Manager" /></ac:link></strong></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164146 space=CDH2024xR3 version=3 -->
## PAGE 00045: Creating DHTrace links

- page_id: `227164146`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164146/Creating+DHTrace+links
- version_number: 3
- version_date: `2026-02-10T11:23:18.037+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Creating links between elements
- labels: []
...
````html
<p>DataHub links can create relationships between elements. The relationship determines how the elements react when one of the elements changes. You can use the MagicDraw shortcut menu to navigate to DHLinks.</p><p><br /></p><p>To navigate to DHLinks from the MagicDraw shortcut menu</p><hr /><ul><li>Right-click a node in the MagicDraw Containment tree. Select <strong>Go To</strong> &gt;<strong> DHLinks</strong>.</li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="MagicDraw Containment Tree context menu to navigate to DHLinks" ac:alt="MagicDraw Containment Tree context menu to navigate to DHLinks"><ri:attachment ri:filename="dh-go-to-dh-links.png"><ri:page ri:content-title="Creating links between elements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227164101 space=CDH2024xR3 version=1 -->
## PAGE 00048: Creating OSLC links

- page_id: `227164101`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164101/Creating+OSLC+links
- version_number: 1
- version_date: `2023-07-27T11:49:54.124+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
You can create OSLC links and queries from an [CONFLUENCE_PAGE title='Adding IBM Rational DOORS Next Generation Data Sources' space='CDH2024xR3']IBM® Rational® DOORS® Next Generation Data Source in DataHub by using the **Create DHTrace** operation from the **Operation** drop-down list in **Cameo DataHub Explorer**.
...
When you copy the Doors Next Generation (DNG) datasource's requirements from the DataHub Explorer to the MagicDraw containment tree, the URI link is created automatically for those requirements with the type “self”. This "self" type link is needed for [CONFLUENCE_PAGE title='OSLC Preview' space='CDH2024xR3'], navigation, or other purposes.
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a56a9bc2-1c75-4b2d-8fde-0b7f76c04bea"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>In the 19.0 and later versions, the <strong>Create OSLC link</strong> operation is not displayed and is used through the <strong>Create DHTrace</strong> operation instead from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong> (for IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source).</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p class="confluence-link">You can create OSLC links and queries from an <ac:link><ri:page ri:content-title="Adding IBM Rational DOORS Next Generation Data Sources" ri:space-key="CDH2024xR3" /><ac:link-body>IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</ac:link-body></ac:link> in DataHub by using the <strong>Create DHTrace</strong> operation from the <strong>Operation</strong> drop-down list in <strong>Cameo DataHub Explorer</strong>.</p><p><br /></p><p>To create an OSLC Link</p><hr /><ol><li class="confluence-link">Open an <span class="confluence-link">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source</span>.</li><li>From the <strong>Operation</strong> drop-down list in <strong>DataHub Explorer</strong>, select <strong>Create DHTrace</strong>.<br /><br /><ac:image><ri:attachment ri:filename="CDH_Panel_Create_DHTrace.png"><ri:page ri:content-title="Creating OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>From the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation data source, drag a node into the MagicDraw<sup>®</sup> Containment area.</li><li>There is a popup menu after dragging the node to the MagicDraw Containment area. Choose one type of link from the list that you want to create.<br /><br /><ac:image ac:title="Figure OSLC Link types" ac:alt="Figure OSLC Link types"><ri:attachment ri:filename="dh-link-types.png"><ri:page ri:content-title="Creating OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d127d1d5-cbff-4b8c-a7e7-c48f3fdfa28d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>When you copy the Doors Next Generation (DNG) datasource's requirements from the DataHub Explorer to the MagicDraw containment tree, the URI link is created automatically for those requirements with the type “self”. This &quot;self&quot; type link is needed for <ac:link><ri:page ri:content-title="OSLC Preview" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[previewing]]></ac:plain-text-link-body></ac:link>, navigation, or other purposes.</p></ac:rich-text-body></ac:structured-macro><p><span style="line-height: 1.4285715;"><br /></span></p><p><span style="line-height: 1.4285715;">The figures below show the newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree, OSLC hyperlinks' properties, and an OSLC hyperlink in the</span> <strong>DH Links</strong> panel respectively.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="OSLC hyperlinks in MagicDraw containment area" ac:alt="OSLC hyperlinks in MagicDraw containment area"><ri:attachment ri:filename="oslc-hyperlinks.png"><ri:page ri:content-title="Creating OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;"> The newly created OSLC hyperlinks in the MagicDraw<sup>®</sup> Containment tree.</h6><p style="text-align: center;margin-left: 30.0px;"><ac:image ac:title="Properties of OSLC Link " ac:alt="Properties of OSLC Link "><ri:attachment ri:filename="worddavae7ad7197fdcea58505c68e4c441a7fb.png"><ri:page ri:content-title="Creating OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The OSLC hyperlink's properties.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="OSLC Hyperlink.png"><ri:page ri:content-title="Creating OSLC links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">An OSLC hyperlink in the DH Links panel.</h6>
````

<!--NOMAGIC_PAGE id=227164110 space=CDH2024xR3 version=1 -->
## PAGE 00049: Creating OSLC queries

- page_id: `227164110`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164110/Creating+OSLC+queries
- version_number: 1
- version_date: `2018-02-02T07:57:00.865+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
````html
<p>There are two types of OSLC queries you can construct to query the DOORS<sup>®</sup> Next Generation artifacts repository - simple or basic query and advanced query based on SQL or SPARQL<em>. </em>You can find the details of OSLC queries and more examples of queries and their syntax on the <a class="external-link" href="http://open-services.net/" style="line-height: 1.4285715;" rel="nofollow">OSLC Specification website</a>.</p><p><br /></p><p>To create and run a simple or basic OSLC query</p><hr /><ol><li>Do one of the following</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Create OSLC Query</strong> from MagicDraw®.</li><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Create OSLC Query</strong> <ac:image><ri:attachment ri:filename="oslc-query-icon.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> button.</li></ul></li></ul><p style="margin-left: 30.0px;">The <strong>OSLC Query Editor</strong> dialog opens.</p><p style="margin-left: 30.0px;"><ac:image ac:title="OSLC Query editor window" ac:alt="OSLC Query editor window"><ri:attachment ri:filename="oslc-query-editor-a.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p style="margin-left: 30.0px;">2. Fill out the information that you want to create the query to search for.</p><p style="margin-left: 30.0px;">3. Click <strong><ac:image><ri:attachment ri:filename="run-btn.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>. The results of the query, if any, appears below the <em>Type text to search</em> box.</p><p style="margin-left: 30.0px;"><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="d156c760-b22b-45db-a9e8-5fd0c8057a3f"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li>You can filter the search results of the query by using the <em>Type text to search</em> box.</li><li>You can click <ac:image><ri:attachment ri:filename="oslc-btn1.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to save the results in <strong>Alias Manager</strong>.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To create and run an advanced query</p><hr /><ol><li>Do one of the following</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Create OSLC Query</strong> from MagicDraw®.</li><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Create OSLC Query</strong> <ac:image><ri:attachment ri:filename="oslc-query-icon.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> button.</li></ul></li></ul><p style="margin-left: 30.0px;">The <strong>OSLC Query Editor</strong> dialog opens.</p><p style="margin-left: 30.0px;"><ac:image ac:title="The OSLC advanced Query Editor tab" ac:alt="The OSLC advanced Query Editor tab"><ri:attachment ri:filename="datahub-oslc-query-editor.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p style="margin-left: 30.0px;">2. Click the <strong><ac:image><ri:attachment ri:filename="query-editor.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong> tab. In the <strong>Query String</strong> box, type your query using the simple or basic query language, e.g., <em><span class="nolink">https://10.1.1.70:9443/rm/views?oslc.query=true</span></em> or using the SPARQL query language, e.g., <em><span class="external-link">https://host:port/bugs?oslc.select=dcterms:created,dcterms:creator{foaf:familyName}&amp;oslc.where=cm:severity=&quot;high<em><span class="external-link">&quot;</span></em></span></em>.</p><p style="margin-left: 30.0px;">3. Click <strong><ac:image><ri:attachment ri:filename="run-btn.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>. The results of the query, if any, appears below the <em>Type text to search</em> box.</p><p style="margin-left: 30.0px;"><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="af0338e8-0d8f-4cb1-b445-df64678c4cf5"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><ul><li>You can filter the search results of the query by using the <em>Type text to search</em> box.</li><li>You can click <ac:image><ri:attachment ri:filename="oslc-btn1.png"><ri:page ri:content-title="Creating OSLC queries" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to save the results in <strong>Alias Manager</strong>.</li></ul></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163578 space=CDH2024xR3 version=3 -->
## PAGE 00050: Creating OSLC Query operation

- page_id: `227163578`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163578/Creating+OSLC+Query+operation
- version_number: 3
- version_date: `2026-02-10T11:15:23.936+01:00`
...
````html
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="79c5d464-e846-47f5-9784-96f13e36978d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>This customization applies for the entire DOORS Data Source. You cannot customize the node’s label for only some modules.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To customize the node’s label</p><hr /><ol><li>Right-click a DOORS Data Source and select <strong>Customize Module/Object label</strong>.<br /><br /><ac:image><ri:attachment ri:filename="6.png"><ri:page ri:content-title="Customizing module and object label in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p class="auto-cursor-target">The <strong>Customize label</strong> dialog opens. Enter the name of property that you want to display for the module and object by placing the property name inside quotation marks. You can append more properties or add some text, e.g., <em>“Object Identifier”::”Object Heading</em>”. Click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="customlabel02.png"><ri:page ri:content-title="Customizing module and object label in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="customlabel03.png"><ri:page ri:content-title="Customizing module and object label in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="14daf86b-d10f-46f0-b683-8de8bbfeab9d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>When you edit the node’s label, you must reload the tree in <strong>DataHub Explorer</strong>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=227163983 space=CDH2024xR3 version=1 -->
## PAGE 00053: Customizing module and object labels in DataHub Explorer

- page_id: `227163983`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163983/Customizing+module+and+object+labels+in+DataHub+Explorer
- version_number: 1
- version_date: `2023-07-27T11:38:05.665+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS
- labels: []
...
````html
<p>Another capability of Cameo DataHub is designing labels of modules and objects for Rational DOORS Data Sources that allows you to create labels from appending one or more property values and additional text.</p><p>Instead of displaying the module names and object headings or object text in the tree, you can now design the labels of modules and objects by using one or more properties’ values or adding some text.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="79c5d464-e846-47f5-9784-96f13e36978d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>This customization applies to the entire DOORS Data Source. You cannot customize the node’s label for only some modules.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p>To customize the node’s label</p><hr /><ol><li>Right-click a DOORS Data Source and select <strong>Customize Module/Object label</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Customize module label.PNG"><ri:page ri:content-title="Customizing module and object labels in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p class="auto-cursor-target">The <strong>Customize label</strong> dialog opens. Enter the name of the property that you want to display for the module and object by placing the property name inside quotation marks. You can append more properties or add some text, e.g., <em>“Object Identifier”::”Object Heading</em>”. Click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="customlabel02.png"><ri:page ri:content-title="Customizing module and object labels in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="customlabel03.png"><ri:page ri:content-title="Customizing module and object labels in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="14daf86b-d10f-46f0-b683-8de8bbfeab9d"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>When you edit the node’s label, you must reload the tree in <strong>DataHub Explorer</strong>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=227163976 space=CDH2024xR3 version=1 -->
## PAGE 00054: Customizing new node type for DOORS

- page_id: `227163976`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163976/Customizing+new+node+type+for+DOORS
- version_number: 1
- version_date: `2023-02-20T11:57:36.350+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS
- labels: []
...
<!--NOMAGIC_PAGE id=227163526 space=CDH2024xR3 version=1 -->
## PAGE 00055: Data copying progress bar

- page_id: `227163526`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163526/Data+copying+progress+bar
- version_number: 1
- version_date: `2018-02-01T06:06:30.438+01:00`
...
````html
<p>When copying data, DataHub shows the progress through its progress bar.</p><p><br /></p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Copy progress bar" ac:alt="DataHub Copy progress bar"><ri:attachment ri:filename="data-copy-progress-bar.png"><ri:page ri:content-title="Data copying progress bar" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;"> The progress bar when DataHub copies data.</h6>
````

<!--NOMAGIC_PAGE id=227164329 space=CDH2024xR3 version=1 -->
## PAGE 00056: Data Source synchronization

- page_id: `227164329`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164329/Data+Source+synchronization
- version_number: 1
- version_date: `2018-02-06T12:00:25.389+01:00`
...
````html
<p>You can synchronize a Data Source by selecting it and clicking either the <strong>Synchronize</strong> button on the <strong>DataHub Explorer</strong> toolbar or by choosing the <strong>Synchronize</strong> menu item from the shortcut menu.</p><p><br /></p><p>To synchronize an entire Data Source, do one of the following</p><hr /><ul><li>Select a Data Source in the <strong>DataHub Explorer</strong> tab and click the <strong>Synchronize</strong> button on the <strong>DataHub Explorer</strong> toolbar.<br /><br /><ac:image ac:title="Data Source Synchronization Button in the DataHub Explorer of MagicDraw" ac:alt="Data Source Synchronization Button in the DataHub Explorer of MagicDraw"><ri:attachment ri:filename="data-sync-btn-on-explorer-tab.png"><ri:page ri:content-title="Data Source synchronization" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Right-click a Data Source and select <strong>Synchronize &gt; Synchronize Node </strong>or<strong> Synchronize Node Recursively</strong> to synchronize all items that have<strong> </strong>DHLinks within the selected Data Source.<br /><br /><ac:image><ri:attachment ri:filename="Node Sync Shortcut Menu DataHub Explorer.png"><ri:page ri:content-title="Data Source synchronization" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ul><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="766ea1b3-44c5-4274-b4ae-1b740e3330a0"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p><span>The </span><strong>Synchronize</strong><span> button in DataHub Explorer is enabled only when you select a node or a Data Source.</span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164302 space=CDH2024xR3 version=3 -->
## PAGE 00057: Data Sources on Teamwork Cloud

- page_id: `227164302`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164302/Data+Sources+on+Teamwork+Cloud
- version_number: 3
- version_date: `2026-02-10T11:24:20.001+01:00`
...
<!--NOMAGIC_PAGE id=227163587 space=CDH2024xR3 version=3 -->
## PAGE 00058: Data Synchronization

- page_id: `227163587`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163587/Data+Synchronization
- version_number: 3
- version_date: `2026-02-10T11:15:31.326+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>An alias can be created from any nodes or Data Source. DataHub <ac:link><ri:page ri:content-title="Alias Manager" /><ac:link-body><strong>Alias Manager</strong></ac:link-body></ac:link> stores all available aliases, and they can be either accessed or removed from there.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><p><strong><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="dc640d2e-5976-4968-95e1-db163f3bbc3e"><ac:parameter ac:name="excerptType">simple</ac:parameter></ac:structured-macro></strong></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163772 space=CDH2024xR3 version=1 -->
## PAGE 00060: DataHub Alias Manager

- page_id: `227163772`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163772/DataHub+Alias+Manager
- version_number: 1
- version_date: `2018-02-07T09:09:36.258+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>When an Alias is created, it is saved in <strong style="line-height: 1.4285715;">Alias Manager</strong>. You can reopen or remove an Alias you have created through the<strong style="line-height: 1.4285715;"> Alias Manager</strong> dialog.</p><p><br /></p><p>To manage an existing Alias</p><hr /><ol><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Alias Manager</strong>.</li><li>The <strong>Alias Manager</strong> dialog opens. Expand each driver to see all of the Aliases under each driver.</li></ol><p><br /></p><p>To open or remove an Alias</p><hr /><ul><li>Select an Alias. Click <ac:image><ri:attachment ri:filename="open-btn2.png"><ri:page ri:content-title="DataHub Alias Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to open the selected Alias or <ac:image><ri:attachment ri:filename="remove-btn.png"><ri:page ri:content-title="DataHub Alias Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to delete it.<br /><br /> <ac:image ac:title="Deleting an Existing Schema Map in the Schema Map Manager" ac:alt="Deleting an Existing Schema Map in the Schema Map Manager"><ri:attachment ri:filename="alias-manager.png"><ri:page ri:content-title="DataHub Alias Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ul><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="63a4e2e9-057d-4145-9b7a-5012a14ade3b"><ac:parameter ac:name="title">Warning</ac:parameter><ac:rich-text-body><p><span>The created Alias is displayed in </span><strong>Alias Manager</strong><span> only when the related Data Source is connected.</span></p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163531 space=CDH2024xR3 version=3 -->
## PAGE 00061: DataHub basic operations

- page_id: `227163531`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163531/DataHub+basic+operations
- version_number: 3
- version_date: `2026-02-10T11:14:11.487+01:00`
- ancestors: Cameo DataHub Documentation > Getting started
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>After installing Cameo DataHub, you can begin to add Data Sources. Data Sources can be added for the following requirements management systems</p><ul><li data-uuid="4bb88887-6eea-466a-aa1e-226b8efe7379">IBM DOORS</li><li data-uuid="d145f4b9-bcc0-48bf-89db-2ffb59e2546e">IBM DOORS Next Generation</li><li data-uuid="5b01cb62-6f5a-4430-ac6a-6637dbf2c3dd">CSV Files</li></ul><p>Once you have the Data Sources in DataHub open, you can start using more advanced DataHub features, e.g., copying data and DHLink relations between Data Sources. The synchronization features of DataHub are also illustrated in this chapter.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="d3d3c6cd-463e-4172-89e0-623c37fcd0a3" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163419 space=CDH2024xR3 version=2 -->
## PAGE 00062: DataHub Explorer buttons and icons

- page_id: `227163419`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163419/DataHub+Explorer+buttons+and+icons
- version_number: 2
- version_date: `2026-02-10T11:10:05.071+01:00`
...
````html
<p><span style="color:var(--ds-text,#333333);">The following table lists the icons in the <strong>DataHub Explorer</strong> tab.<br /> </span></p><table class="relative-table wrapped" style="width: 99.9434%;"><colgroup><col style="width: 4.86219%;" /><col style="width: 17.9848%;" /><col style="width: 77.2406%;" /></colgroup><tbody><tr><th>Icon</th><th>Name</th><th>Description</th></tr><tr><td><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="datahub.gif" /></ac:image></div></td><td><ac:inline-comment-marker ac:ref="e01ff494-dd00-4c24-8631-ba510086a80f">Cameo DataHub</ac:inline-comment-marker></td><td>The DataHub root.</td></tr><tr><td><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="magicdraw_driver.gif" /></ac:image></div></td><td>MagicDraw® Driver</td><td>The MagicDraw<sup>®</sup> driver to connect to a MagicDraw<sup>®</sup> project.</td></tr><tr><td><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="driver.png" /></ac:image></div></td><td>Drivers</td><td><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">The drivers to connect to the other tools </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">(</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">CSV</ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="5aaf4904-6f2d-44bf-960e-e28fc7b06a66">IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation).</ac:inline-comment-marker></td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-toggle-btn.png" /></ac:image></div></td><td colspan="1">Toggle showing only <br />connected Data Sources</td><td colspan="1">Hides all disconnected Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="toggle-data-sources-icon.png" /></ac:image></div></td><td colspan="1">Toggle showing all Data Sources</td><td colspan="1">Displays all Data Sources in the <strong>DataHub Explorer</strong> tab.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-add-ds-btn.png" /></ac:image></div></td><td colspan="1">Add Data Source button</td><td colspan="1">Opens the <strong>Add Data Source</strong> dialog.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-explorer-btn-4.png" /></ac:image></div></td><td colspan="1">Synchronize button</td><td colspan="1">Starts the synchronization process.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-disconnected-ds-btn.png" /></ac:image></div></td><td colspan="1">Disconnected Data Source</td><td colspan="1"><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">The Data Source (of MagicDraw<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, or a CSV file) disconnected from </ac:inline-comment-marker><ac:inline-comment-marker ac:ref="f7f1691c-9fae-4102-a0b8-8635a3c8265b">its source.</ac:inline-comment-marker></td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="folder.gif" /></ac:image></div></td><td colspan="1">Folder, Package</td><td colspan="1">A folder or a Package.</td></tr><tr><td rowspan="2"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="link.png" /></ac:image></div></td><td colspan="1">DOORS Link</td><td colspan="1">A link in the IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> application.</td></tr><tr><td colspan="1">MagicDraw<sup>®</sup> relationship</td><td colspan="1">A link in the MagicDraw<sup>®</sup> application.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="ex.gif" /></ac:image></div></td><td colspan="1">Item</td><td colspan="1">Any items, e.g., an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> object, MagicDraw<sup>®</sup> element, or CSV item.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-oslc-query-icon.png" /></ac:image></div></td><td colspan="1">Create OSLC Query <br />button</td><td colspan="1">Opens the <strong>OSLC Query Editor</strong> dialog, allowing you to perform basic and advanced queries to an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source. This becomes enabled when you add an IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Data Source.</td></tr><tr><td colspan="1"><div class="content-wrapper"><ac:image ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="dh-trash-icon.png" /></ac:image></div></td><td colspan="1">DataHub explorer Trash <br />Icon</td><td colspan="1">Deletes an item when the item is dragged onto the icon. A confirmation dialog appears before deleting the item.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227163409 space=CDH2024xR3 version=4 -->
## PAGE 00063: DataHub Explorer tab

- page_id: `227163409`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163409/DataHub+Explorer+tab
- version_number: 4
- version_date: `2026-02-10T11:08:59.447+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<p>The <strong>DataHub Explorer</strong> tab has toolbar options for the following actions</p><ul><li data-uuid="c4ceb76f-4ba9-47be-b985-9c7531f1218d">Add a new Data Source</li><li data-uuid="6806031f-5448-473f-b245-c13dccd2c972">Close a Data Source</li><li data-uuid="b63c16bb-4d21-4eb0-b8b7-7eebd37e70d1">Open a Data Source</li><li data-uuid="ffe5c807-7934-43ed-8fee-b3d15463f318">Filter inactive Data Source</li><li data-uuid="f7fded9f-60d6-4eeb-b230-8df780cc859c">Create OSLC query</li><li data-uuid="f21e81d3-ae6e-4dba-b79b-09f26ee51ad2">Work with data in the tree</li><li data-uuid="4a573511-0f20-4688-9982-41f4947274ee">Search for items</li></ul><p>You can use <strong>DataHub Explorer toolbar</strong> buttons and shortcut menu items to connect, add, or remove Data Sources. You can also use it to view drivers, Data Sources, and items of the connected Data Sources in the DataHub tree. You can also apply a filter to display only the connected Data Sources in DataHub Explorer.</p><p><br />To open DataHub Explorer</p><hr /><ol><li data-uuid="78d48c70-a8cc-452c-a538-17c70d6f9c3d">Start MagicDraw® and open an existing project or start a new one.</li><li data-uuid="aee0dd2d-aaf8-4b0a-93dd-8c191017e9d1">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /><br /><ac:image ac:title="The DataHub Explorer Tab" ac:alt="The DataHub Explorer Tab"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></li></ol><p><br /></p><p>The <strong>DataHub Explorer</strong> tab contains the following</p><ul><li style="list-style-type: none;background-image: none;" data-uuid="78a2787f-a509-4044-8691-bf8be4fe4524"><ul><li><strong>Operation</strong> drop-down list</li><li>Tree of Data Sources</li><li>Explorer buttons and icons</li><li>Text search box</li></ul></li></ul><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="7340f42d-dbd3-4040-97d4-dab2d6e6ebbe" /></p>
````

<!--NOMAGIC_PAGE id=227163397 space=CDH2024xR3 version=4 -->
## PAGE 00064: DataHub menu

- page_id: `227163397`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163397/DataHub+menu
- version_number: 4
- version_date: `2026-02-10T11:07:39.723+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="b3fae4ab-4342-4d4e-abf5-0656390a1ebd"><ac:parameter ac:name="page">Operations in DataHub Explorer</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name="retain-block-width">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:content-title="Operations in DataHub Explorer" /></ac:link></ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163435 space=CDH2024xR3 version=2 -->
## PAGE 00066: DataHub Properties tab

- page_id: `227163435`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163435/DataHub+Properties+tab
- version_number: 2
- version_date: `2026-02-10T11:10:10.339+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
````html
<p>The <strong style="line-height: 1.4285715;">DataHub Properties</strong> tab shows the properties (names and values) and associations of a selected node in DataHub Explorer that you can edit and save their value. You can also open, update, or delete the following items in the <strong style="line-height: 1.4285715;">DataHub Properties </strong>tab. </p><ul><li>MagicDraw<sup>®</sup> elements</li><li>DOORS objects and modules</li><li>CSV items</li><li>IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation Artifacts</li></ul><p><br /></p><p>To open the <strong>DataHub Properties</strong> tab in MagicDraw®, do one of the following</p><hr /><ul><li>Right-click a node in DataHub Explorer and click <strong>Properties</strong>.</li><li>Double-click a node in DataHub Explorer.<br /><br />The <strong>DataHub Properties</strong> tab opens in MagicDraw<sup>®</sup>, and the properties of the selected item are displayed.</li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="dh-properties-tab.png" /></ac:image><br /><span style="color:var(--ds-background-accent-gray-bolder,#626f86);"> </span></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="d31614a8-1844-44ae-b9a2-5da7206f8cb8"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li>The <strong>DH Links </strong>panel opens when the <strong>DataHub Properties</strong> tab is open.</li><li>Read-only and multi-valued properties cannot be edited. However, you can edit multi-valued properties through the Specifications window.</li></ul></ac:rich-text-body></ac:structured-macro><p><br /></p><p>The table below explains the function of each icon in the <strong>DataHub Properties</strong> tab in MagicDraw<sup>®</sup>.</p><table class="relative-table" style="margin-left: 30.0px;width: 96.4116%;"><colgroup><col style="width: 4.71616%;" /><col style="width: 16.6754%;" /><col style="width: 78.6376%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Icon</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Name</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color:var(--ds-text,#000000);">Function</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - categorized view.png" /></ac:image></td><td style="margin-left: 30.0px;"><strong>Categorized View</strong></td><td style="margin-left: 30.0px;">Shows all property names by category.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center" ac:thumbnail="true" ac:width="29"><ri:attachment ri:filename="Properties - alphabetical view.png" /></ac:image></td><td style="margin-left: 30.0px;"><strong>Alphabetical View</strong></td><td style="margin-left: 30.0px;">Shows all property names in an alphabetical order.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - show description.png" /></ac:image></td><td style="margin-left: 30.0px;"><strong>Show Description</strong></td><td style="margin-left: 30.0px;">Shows description of each property.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - expand.png" /></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Expand</strong></td><td style="margin-left: 30.0px;" colspan="1"><p>Shows all property names and values.</p></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center"><ri:attachment ri:filename="Properties - collapse.png" /></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Collapse</strong></td><td style="margin-left: 30.0px;" colspan="1">Hides all property names and values.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image ac:align="center" ac:thumbnail="true" ac:width="25"><ri:attachment ri:filename="Properties - save.png" /></ac:image></td><td style="margin-left: 30.0px;" colspan="1"><strong>Save</strong></td><td style="margin-left: 30.0px;" colspan="1">Saves changes made to a property name or value. The button is enabled when the value of the property changes.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163417 space=CDH2024xR3 version=3 -->
## PAGE 00067: DataHub tree

- page_id: `227163417`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163417/DataHub+tree
- version_number: 3
- version_date: `2026-02-10T11:09:51.593+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > DataHub Explorer tab
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub tree is composed of nodes, each of which represents either a node or a connected Data Source. Data in the DataHub tree are arranged hierarchically in a tree structure. It represents all the data that DataHub contains at that time.</p><p><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="DataHub Tree.png" /></ac:image></p><h6 style="text-align: center;">The DataHub tree.</h6></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><ul><li data-uuid="afa53ef7-6a34-4d4b-b5d8-3212264344fe"><ac:link><ri:page ri:content-title="Data Source synchronization" /></ac:link></li><li data-uuid="7865ba3b-9e5e-4ce1-a31e-7b9a363c609b"><ac:link><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" /><ac:plain-text-link-body><![CDATA[Displaying MagicDraw Data Sources]]></ac:plain-text-link-body></ac:link></li><li data-uuid="8f2cb0a6-1e03-4a9e-89dd-200643c02e28"><ac:link><ri:page ri:content-title="Removing a Data Source" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164215 space=CDH2024xR3 version=5 -->
## PAGE 00068: Define Target Type from Attribute Value dialog and mapping

- page_id: `227164215`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164215/Define+Target+Type+from+Attribute+Value+dialog+and+mapping
- version_number: 5
- version_date: `2025-10-08T12:23:41.091+02:00`
...
<!--NOMAGIC_PAGE id=227164425 space=CDH2024xR3 version=4 -->
## PAGE 00070: Defining a target type from an attribute value

- page_id: `227164425`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164425/Defining+a+target+type+from+an+attribute+value
- version_number: 4
- version_date: `2026-02-10T11:25:47.048+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<p>The functionality of synchronization has been additionally simplified with the use of the <strong>Define Target Type from Attribute Value</strong> option. The synchronization does not limit only to a simple type-to type-mapping and attribute-to-attribute mapping but also a target node type can be defined dynamically according to a specified attribute value.</p><p><br /></p><p>To copy data and define a target node type from an attribute value</p><hr /><ol><li data-uuid="3ec3b818-db3a-41d6-8d2b-9bc4b5487153">From the Operation drop-down list in DataHub Explorer, select one of the DataHub operations to copy data. The Copy Data with Sync dialog (depending on the operation you have selected) opens.</li><li data-uuid="e8ffc116-ff40-4ac7-a041-83d9b0e86da6">From the <strong>Mapping Mode</strong> option, select <strong>Group Type Mapping</strong>.<br /><br /><ac:image ac:title="Copy Data with Sync in Group Type Mapping " ac:alt="Copy Data with Sync in Group Type Mapping "><ri:attachment ri:filename="set-as-default-target-type.png" /></ac:image><br /><br /></li><li data-uuid="9f145749-e8a4-49eb-9ca2-ffc115d1c255">Select a source node type to start mapping.</li><li data-uuid="a035f441-e9f7-43d9-a5c2-e91511ea4eab">Select the <strong>Define Target Type from Attribute Value</strong> check box.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping.png" /></ac:image><br /><br /></li><li data-uuid="2bb6eb96-382c-4824-b212-fea42e288afd">From the <strong>Attribute</strong> drop-down list, choose an attribute to define a target node type.</li><li data-uuid="b373cfd9-e59e-4dc2-975e-121fa900e04c"><p class="auto-cursor-target">Specify the attribute value to do the mapping.</p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="307eb3bc-f78b-4130-9353-ece0cc9e69b0"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><ul><li>If the attribute is <strong>Enumeration</strong>, you can select a value from the <strong>Value</strong> drop-down list for each attribute.<br /><br /><ac:image><ri:attachment ri:filename="Selecting Value from Name Attribute.png" /></ac:image><br /><br /></li><li>If the attribute is a simple data type, you can type any expected value in the <strong>Value</strong> box.</li></ul></ac:rich-text-body></ac:structured-macro></li><li data-uuid="452de857-4ad1-442e-a606-0477747d37a5">From the target type box on the right-hand side of the source type box, choose a target node type for that value.</li><li data-uuid="f3f56ffa-f07b-42c7-9980-d4cbfcf604c4">Continue mapping the attributes.</li><li data-uuid="ecca305d-cb2c-4df0-b992-6eabb80238cd">If you have more values for mapping, click <ac:image><ri:attachment ri:filename="add-btn2.png" /></ac:image> to enter more values for mapping.<br /><br /><ac:image><ri:attachment ri:filename="Define Target Type for Group Mapping End - Edited.png" /></ac:image><br /><br /></li><li data-uuid="e32ecbb6-095e-45f3-9119-95e8e25ea9e0">Repeat Steps 5 to 9 to map each attribute value.</li><li data-uuid="2351e656-2f28-4aba-b6e9-8ee97791f4ba">When you finish mapping each attribute value, click <strong>OK</strong> to start copying.<br /><br /></li></ol><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="661cd26c-c59e-4110-b077-6b60922bbe9b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="8653c42b-1979-478e-bb9e-38e5129709d8">The functionality to map between<strong> </strong>Attribute value and Target type is available only in Group Type Mapping.</li><li data-uuid="69b5e00a-5801-44d6-927b-a249b6d87a14">At least 2 values must be identified for mapping.</li><li data-uuid="69936ca4-fe68-4149-9877-8aa465cb9e07">You can edit or deactivate the mapping in the <a href="https://docs.nomagic.com/display/CDH2024xR3/Mapping+with+Schema+Map+Manager">Schema Map Manager</a> dialog.</li></ul></ac:rich-text-body></ac:structured-macro><p><strong>Related page</strong></p><ul><li data-uuid="824e1054-7d29-487f-a2b2-cc82183180df"><a href="https://docs.nomagic.com/display/CDH2024xR3/Mapping+with+Schema+Map+Manager">Mapping with Schema Map Manager</a></li></ul>
````

<!--NOMAGIC_PAGE id=227164240 space=CDH2024xR3 version=1 -->
## PAGE 00071: Deleting a schema map

- page_id: `227164240`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164240/Deleting+a+schema+map
- version_number: 1
- version_date: `2024-09-03T07:56:07.132+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []

### NORMALIZED CONTENT

If a schema map is referenced by a DHLink, it cannot be deleted. You can delete only schema maps that are not referenced by any DHLinks. Deleting aDefine Target Type from the Attribute Value mapped schema deletes all defined target types. If you want to delete only some values of the schema, you can delete them in the[CONFLUENCE_PAGE title='Define Target Type from Attribute Value dialog and mapping' space='CDH2024xR3'] dialog.

To delete an existing schema map

1. Open the Cameo DataHub [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR3'] dialog.
...
````html
<p><span style="color: rgb(51,51,51);">If a schema map is referenced by a DHLink, it cannot be deleted. You can delete only schema maps that are not referenced by any DHLinks. Deleting a </span><span style="color: rgb(51,51,51);"> Define Target Type from the Attribute Value mapped schema deletes all defined target types. If you want to delete only some values of the schema, you can delete them in the </span><span><ac:link><ri:page ri:content-title="Define Target Type from Attribute Value dialog and mapping" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[Define Target Type from Attribute Value]]></ac:plain-text-link-body></ac:link> dialog.<br /></span></p><p><span style="color: rgb(51,51,51);"> </span></p><p>To delete an existing schema map</p><hr /><ol><li>Open the Cameo DataHub <ac:link><ri:page ri:content-title="Mapping with Schema Map Manager" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[Schema Map Manager]]></ac:plain-text-link-body></ac:link> dialog. </li><li>Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.</li><li>Click <strong>Delete</strong>. A confirmation dialog box to confirm the deletion opens. Click <strong>Yes</strong>.</li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Schema_Map_Manager_Delete.png"><ri:page ri:content-title="Deleting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="bc7e74f4-3315-4de8-91fe-e9a9dde36a79"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If you delete a schema map that is currently in use, an error message opens, showing that one or more relations are using the deleted schema map. Therefore, you must delete the relations first, and then delete the schema map.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163748 space=CDH2024xR3 version=1 -->
## PAGE 00072: Deleting Requirements

- page_id: `227163748`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163748/Deleting+Requirements
- version_number: 1
- version_date: `2018-02-02T05:52:57.404+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To delete a Requirement from the <strong>DataHub Explorer</strong> tree, do one of the following</p><hr /><ul><li>Right-click the node you want to delete and select <strong><ac:image><ri:attachment ri:filename="delete-node.png"><ri:page ri:content-title="Deleting Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>.</li><li>Drag the node onto the <strong>DataHub Explorer</strong><ac:image><ri:attachment ri:filename="dh-trash-icon.png"><ri:page ri:content-title="Deleting Requirements" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><strong>Trash</strong> icon.</li></ul><p>A confirmation dialog asking you to confirm the deletion opens. Click <strong>OK</strong>.</p>
````

<!--NOMAGIC_PAGE id=227163443 space=CDH2024xR3 version=2 -->
## PAGE 00073: DH Links panel

- page_id: `227163443`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163443/DH+Links+panel
- version_number: 2
- version_date: `2026-02-10T11:10:15.197+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
2. In the [CONFLUENCE_PAGE title='Copy Data with Sync operation' space='CDH2024xR3'] dialog, map the **Diagram**on the modeling tool side to the **Text**on the JAMA Connect side. 
...
- [CONFLUENCE_PAGE title='Adding Data Sources for JAMA Connect' space='CDH2024xR3']

### EXACT CONFLUENCE STORAGE SOURCE

````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h3>Diagram Synchronization</h3><p>You can synchronize a single diagram or an entire package of diagrams from the modeling tool into the JAMA Connect project.  All types of diagrams available in the modeling tool are supported. The synchronized diagram is converted to an image and is embedded in the description property of the corresponding JAMA Connect project item. When you synchronize, the image on the JAMA Connect side is updated if the related diagram is modified in the modeling tool.</p><p><br /></p><p><span style="color: rgb(62,63,64);">To synchronize the diagram</span></p><hr /><ol><li>Drag and drop a diagram or a diagram package onto the project, component, or set node.<br /><br /><ac:image><ri:attachment ri:filename="Drag and Drop.png"><ri:page ri:content-title="Diagram Synchronization" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">In the <ac:link><ri:page ri:content-title="Copy Data with Sync operation" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[Copy Data with Sync]]></ac:plain-text-link-body></ac:link> dialog, map the <strong>Diagram </strong>on the modeling tool side to the <strong>Text </strong>on the JAMA Connect side.<br /><br /><ac:image><ri:attachment ri:filename="Diagram to the Text mapping.png"><ri:page ri:content-title="Diagram Synchronization" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></span></li><li><span style="color: rgb(62,63,64);">In Select Attribute to Sync section, map the <strong>Documentation </strong>attribute against the <strong>Description </strong>and the <strong>Name </strong>attribute against the <strong>Name</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Select Attribute to Sync section.png"><ri:page ri:content-title="Diagram Synchronization" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></span></li><li><span style="color: rgb(62,63,64);">Click <strong>OK</strong>.</span></li></ol><p><span style="color: rgb(62,63,64);">The following video shows the </span><span>SysML Diagrams Synchronization from JAMA Connect to the modeling tool:</span></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="1ab36aa0-2087-4dcf-a5a3-47b3e110d432"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=d_oXKu9730I" /></ac:parameter><ac:parameter ac:name="height">400</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages:</strong></p><ul><li><ac:link><ri:page ri:content-title="Adding Data Sources for JAMA Connect" ri:space-key="CDH2024xR3" /></ac:link></li></ul></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164263 space=CDH2024xR3 version=1 -->
## PAGE 00078: Directions of DHLinks

- page_id: `227164263`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164263/Directions+of+DHLinks
- version_number: 1
- version_date: `2018-02-07T11:04:49.463+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DHLink summary and generating reports
- labels: []

### NORMALIZED CONTENT

Besides showing types of DHLinks and the source and type elements that have DHLinks, the **[CONFLUENCE_PAGE title='DHLink Summary' space='CDH2024xR3']** dialog displays the direction of the **DHLink** with an arrow. The arrow describes the direction of synchronization graphically, either unidirectional or bidirectional.
...
````html
<p>Besides showing types of DHLinks and the source and type elements that have DHLinks, the <strong><ac:link><ri:page ri:content-title="DHLink Summary" ri:space-key="CDH2024xR3" /><ac:plain-text-link-body><![CDATA[DHLink Summary]]></ac:plain-text-link-body></ac:link></strong> dialog displays the direction of the <strong>DHLink</strong> with an arrow. The arrow describes the direction of synchronization graphically, either unidirectional or bidirectional.</p><p><br /></p><table class="relative-table" style="margin-left: 30.0px;width: 97.3794%;"><colgroup><col style="width: 6.01758%;" /><col style="width: 16.4233%;" /><col style="width: 16.4909%;" /><col style="width: 61.0908%;" /></colgroup><thead style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Symbol</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Type</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Sync status</span></strong></td><td class="highlight-grey" colspan="1" data-highlight-colour="grey"><strong><span style="color: rgb(0,0,0);">Description</span></strong></td></tr></thead><tbody style="margin-left: 30.0px;"><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><span class="confluence-embedded-file-wrapper"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-151732.png"><ri:page ri:content-title="Working with DataHub and modeling tools" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></span></span></td><td style="margin-left: 30.0px;"><strong>Two-way sync</strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;">Data synchronization can be performed on both sides, which are source or target with the <strong>Synchronized</strong> status.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><span class="confluence-embedded-file-wrapper"> </span><ac:image><ri:attachment ri:filename="capture-20120810-150304.png"><ri:page ri:content-title="Working with DataHub and modeling tools" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;"><strong>One-way Sync from MagicDraw </strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;"><span>Selecting this synchronization mode allows the Data Source from the node with a DHLink in the other driver picks up changes from the MagicDraw Data Source.</span></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;"><span class="confluence-embedded-file-wrapper"><span class="confluence-embedded-file-wrapper"><ac:image><ri:attachment ri:filename="capture-20120810-150426.png"><ri:page ri:content-title="Working with DataHub and modeling tools" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></span></span></td><td style="margin-left: 30.0px;"><strong>One-way Sync to MagicDraw</strong></td><td style="margin-left: 30.0px;"><strong>Synchronized</strong></td><td style="margin-left: 30.0px;"><span>Selecting this synchronization mode allows the MagicDraw Data Source to pick up changes from the node <span>with a DHLink in the other driver</span>.</span></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image><ri:attachment ri:filename="capture-20120810-150304.png"><ri:page ri:content-title="Working with DataHub and modeling tools" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Pending Update/ Pending Delete</strong></td><td style="margin-left: 30.0px;" colspan="1">The relation status is <strong>PendingUpdate</strong>, <strong>PendingDelete, </strong>or<strong> Orphan</strong>, and the data are updated from the source to the target.</td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1"><ac:image><ri:attachment ri:filename="capture-20120810-150426.png"><ri:page ri:content-title="Working with DataHub and modeling tools" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Pending Update/ Pending Delete</strong> </td><td style="margin-left: 30.0px;" colspan="1"><p>The relation status is <strong style="line-height: 1.42857;">PendingUpdate,</strong> <strong style="line-height: 1.42857;">PendingDelete<strong>, </strong><span>or</span></strong> <strong>Orphan</strong>, and the data will be updated from the target to the source.</p></td></tr><tr style="margin-left: 30.0px;"><td style="margin-left: 30.0px;" colspan="1">- - - - -</td><td style="margin-left: 30.0px;" colspan="1">All</td><td style="margin-left: 30.0px;" colspan="1"><strong>Excluded</strong></td><td style="margin-left: 30.0px;" colspan="1">This symbol is used for a <strong>DHLink</strong> relation that has been excluded and has a virtual relation.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164361 space=CDH2024xR3 version=4 -->
## PAGE 00079: Directions of synchronization

- page_id: `227164361`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164361/Directions+of+synchronization
- version_number: 4
- version_date: `2026-02-10T11:26:09.667+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
````html
<p>The synchronization direction allows you to choose the direction from which the changes are sent. There are three directions of data synchronization in the dialog of the selected DataHub Explorer operation as follows</p><ul><li data-uuid="7d959922-4ab2-4dca-98a4-4d7cdca6ac30"><ac:image><ri:attachment ri:filename="two-way-sync.png" /></ac:image><br />Synchronizations are in both directions.</li><li data-uuid="e7cf03f3-d234-4275-bc7d-250e98fc6ce1"><strong><ac:image><ri:attachment ri:filename="one-way-sync-to-md.png" /></ac:image></strong><br />The third-party Data Source is always synchronized to the MagicDraw Data Source.</li><li data-uuid="65dec1ca-6108-42f7-a754-48246cbaddd0"><ac:image><ri:attachment ri:filename="one-way-sync-from-md.png" /></ac:image><br />The MagicDraw Data Source is always synchronized to the third-party Data Source.</li></ul>
````

<!--NOMAGIC_PAGE id=227163532 space=CDH2024xR3 version=1 -->
## PAGE 00080: Displaying MagicDraw Data Sources in DataHub Explorer

- page_id: `227163532`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163532/Displaying+MagicDraw+Data+Sources+in+DataHub+Explorer
- version_number: 1
- version_date: `2023-07-12T11:29:27.152+02:00`
- ancestors: Cameo DataHub Documentation > Getting started > DataHub basic operations
- labels: []

### NORMALIZED CONTENT

By default, MagicDraw® Data Sources are not shown in the [CONFLUENCE_PAGE title='DataHub Explorer tab' space='CDH2024xR3']. However, you can display MagicDraw® Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.
...
````html
<p>By default, MagicDraw<sup>®</sup> Data Sources are not shown in the <ac:link><ri:page ri:content-title="DataHub Explorer tab" ri:space-key="CDH2024xR3" /></ac:link>. However, you can display MagicDraw<sup>®</sup> Data Sources in the DataHub Explorer tree through the Cameo DataHub Environment options.</p><p><br /></p><p>To display a MagicDraw<sup>®</sup> Data Source in the DataHub Explorer tree</p><hr /><ol><li>From the MagicDraw main menu, click <strong>Options</strong> &gt; <strong>Environment</strong>. The Environment Options dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_General.png"><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>On the left-hand side of the dialog, select <strong>Cameo DataHub</strong> in the list.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH.png"><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>In the<strong> General</strong> group of options, clear the Filter a Magic Systems of Systems Architect data source from the DataHub Explorer checkbox.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_Clear_Checkbox.png"><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>OK</strong>. A MagicDraw<sup>®</sup> Data Source now appears in the DataHub Explorer panel.<br /><br /><ac:image><ri:attachment ri:filename="MD_Data_Source.png"><ri:page ri:content-title="Displaying MagicDraw Data Sources in DataHub Explorer" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol><p><br /></p>
````

<!--NOMAGIC_PAGE id=227163957 space=CDH2024xR3 version=1 -->
## PAGE 00081: DOORS Baseline Data Sources

- page_id: `227163957`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163957/DOORS+Baseline+Data+Sources
- version_number: 1
- version_date: `2023-07-31T12:00:42.377+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS
- labels: []
...
````html
<p>You can access DOORS Baseline by adding a new Baseline Data Source.</p><p>To create the Baseline Data Source</p><hr /><ol><li>Right-click any folder, project, or module you want to create the Baseline Data Source and select <strong>Create data source from Baseline</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Create data source fom baseline.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>The <strong>Create data source from Baseline</strong> dialog opens and lists all Baseline versions grouped by the Baseline set. Do one of the following:<br /><br /><ul><li><p>To create a Data Source with only the selected module, select a particular module version.</p></li><li><p>To create a Data Source with all modules in the Baseline set, select a Baseline set version.</p></li></ul><br /><ac:image><ri:attachment ri:filename="Dialog Box.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Select the Baseline that you want and click <strong>OK</strong>.  You will get a new Data Source that contains the modules with the specific version you have selected.<br /><br /><ac:image><ri:attachment ri:filename="Data Source with module and specific versions.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol><p>It is possible that your data in DataHub (DHLink to MagicDraw) work with original DOORS Data Sources or other Data Sources with different Baseline versions. If you also want the newly created Baseline Data Sources to synchronize with those data, you can use the copying function to copy the DHLinks from other DOORS Data Sources to the new Baseline Data Sources.</p><p>To copy the DHLink to a Baseline Data Source</p><hr /><ol><li>Right-click any module in the Baseline Data Source and select <strong>Copy DHLink from other data sources</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Copy DHlinks from other data sources.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>The <strong>Copy DHLink from other data source</strong> dialog opens. From the drop-down list, choose the Data Source you want to copy the DHLink from.<br /><br /><ac:image><ri:attachment ri:filename="Copi DHLinks Dialog box.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>OK</strong>. The DHLink will be copied to the new Baseline Data Source.<br /><br /><ac:image><ri:attachment ri:filename="DHLinks_Copied.PNG"><ri:page ri:content-title="DOORS Baseline Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=227163509 space=CDH2024xR3 version=2 -->
## PAGE 00082: Driver deployment

- page_id: `227163509`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163509/Driver+deployment
- version_number: 2
- version_date: `2026-02-10T11:12:38.500+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=227163724 space=CDH2024xR3 version=2 -->
## PAGE 00083: ENOVIA Requirements

- page_id: `227163724`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163724/ENOVIA+Requirements
- version_number: 2
- version_date: `2025-05-05T08:12:55.775+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Customizing DataHub options
- labels: []
...
````html
<p>The <strong>Copy Data with Sync</strong> operation has been enhanced. It no longer requires you to map the whole set of data before copying data. With the <strong>Copy Data with Sync</strong> operation, DataHub can exclude data types that you do not map when you select <ac:image ac:thumbnail="true" ac:height="18"><ri:attachment ri:filename="Non-mapping.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> as the target type and select the <strong>Exclude all unmapped nodes from DHLinks</strong> check box, and these nodes will not be copied. Alternatively, DataHub allows you to create the schema mapping for the selected nodes as <strong>Exclude</strong> by selecting the <ac:image ac:thumbnail="true" ac:height="17"><ri:attachment ri:filename="Excluded.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> target type. You can also include the portion of data that has been excluded later.</p><p><br /></p><p>To exclude a portion of data while copying with DHLink</p><hr /><ol><li>From the <strong>Operation</strong> drop-down list in DataHub Explorer, select <strong>Copy Data with Sync</strong>. The <strong>Copy Data with Sync</strong> dialog opens.</li><li><a href="https://docs.nomagic.com/display/CDH2024xR3/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modeling+tool">Map the data types that you need to copy</a>.</li><li>Exclude nodes from being copied by doing one of the following<br /><br /><ul><li class="auto-cursor-target">Selecting the <ac:image ac:thumbnail="true" ac:height="18"><ri:attachment ri:filename="Non-mapping.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> target type and the <strong>Exclude all unmapped nodes from DHLinks</strong> check box.</li><li class="auto-cursor-target">Selecting the <ac:image ac:thumbnail="true" ac:height="17"><ri:attachment ri:filename="Excluded.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>target type.</li></ul><br /><ac:image><ri:attachment ri:filename="Exclude in Copy Data with Sync Dialog (highlighted).png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>OK </strong>to start copying the data. The copied data are indicated with the <ac:image><ri:attachment ri:filename="s-node.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> symbols, and the data which is not copied are indicated with the <ac:image><ri:attachment ri:filename="x-clude.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> symbols.<br /><br /></li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Exclude in DH Explorer Tree (Highlighted).png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /><br /></p><p>To include previously excluded data into a scope set</p><hr /><ol><li>Double-click a node marked with a <ac:image><ri:attachment ri:filename="x-clude.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> symbol. The <strong>DH Links </strong>panel appears.</li><li>Right-click the relation table and select <strong>Include Node</strong>.</li></ol><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="worddavf35042654464548804c64111c9aebecf.png"><ri:page ri:content-title="Excluding some nodes when copying data" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="19aadcfd-b40c-4815-aa50-24d490721a9f"><ac:parameter ac:name="title">Information</ac:parameter><ac:rich-text-body><p>When you synchronize data next time, DataHub will recognize it as a newly added node to the target side.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164229 space=CDH2024xR3 version=1 -->
## PAGE 00085: Exporting a schema map

- page_id: `227164229`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164229/Exporting+a+schema+map
- version_number: 1
- version_date: `2024-09-03T07:54:06.434+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []
...
````html
<p>To export a schema map as a new template</p><hr /><ol><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The Schema Map Manager dialog opens. There are some properties with pre-mappings.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:content-title="Exporting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Click <strong>Export</strong>. The Export Schema Map Wizard appears.<br /><br /><ac:image><ri:attachment ri:filename="Export Schema Map Wizard.png"><ri:page ri:content-title="Exporting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Select the source and target driver of the map and click <strong>Next</strong>.</li><li>Do one of the following:<br /><br /><ul><li>If any maps are not attribute-defined, select the box(es) in front of the maps and click the selected map to choose the type object, e.g., DOORS, to change it to a generic type. Click <strong>Next</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Non-attribute Map.png"><ri:page ri:content-title="Exporting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>If any maps are attribute-defined, select all the box(es) in front of the maps that contain defined attributes and click the selected map to choose the type object, e.g., DOORS, to change it to a generic type. Click <strong>Next</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Attribute-defined Map.png"><ri:page ri:content-title="Exporting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li></ul></li><li>Name the schema and the exported file. Click <strong>Finish</strong>.<br /><br /><ac:image><ri:attachment ri:filename="Naming Schema.png"><ri:page ri:content-title="Exporting a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=227163501 space=CDH2024xR3 version=2 -->
## PAGE 00086: Exporting schema maps as new templates

- page_id: `227163501`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163501/Exporting+schema+maps+as+new+templates
- version_number: 2
- version_date: `2026-02-10T11:12:33.297+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []
...
<!--NOMAGIC_PAGE id=227163744 space=CDH2024xR3 version=1 -->
## PAGE 00087: Filtering inactive Data Sources

- page_id: `227163744`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163744/Filtering+inactive+Data+Sources
- version_number: 1
- version_date: `2018-02-02T05:17:21.375+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To filter out an inactive Data Source</p><hr /><ul><li>On the <strong>DataHub Explorer</strong> toolbar, click the <strong>Filter inactive data sources</strong> <ac:image><ri:attachment ri:filename="dh-inactive-ds-filter.png"><ri:page ri:content-title="Filtering inactive Data Sources" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>button.</li></ul>
````

<!--NOMAGIC_PAGE id=227163701 space=CDH2024xR3 version=2 -->
## PAGE 00088: General

- page_id: `227163701`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163701/General
- version_number: 2
- version_date: `2025-05-05T08:12:55.568+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Customizing DataHub options
- labels: []
...
<!--NOMAGIC_PAGE id=227163404 space=CDH2024xR3 version=2 -->
## PAGE 00092: Hot keys

- page_id: `227163404`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163404/Hot+keys
- version_number: 2
- version_date: `2026-02-10T11:07:11.853+01:00`
...
<!--NOMAGIC_PAGE id=227164316 space=CDH2024xR3 version=5 -->
## PAGE 00093: How synchronization works

- page_id: `227164316`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164316/How+synchronization+works
- version_number: 5
- version_date: `2026-02-10T13:25:52.241+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub synchronization capability is a core feature of the DataHub. Synchronization is primarily used for keeping track of changes. This synchronization feature allows you to track different types of node changes, to update or remove DHLinks from the <strong>Synchronize</strong> button on either side of the MagicDraw Containment area or DataHub Explorer, to synchronize Data Sources with other collaboration tools, and to choose to synchronize single, grouped, or entire Data Source.</p><p>The following videos show the data synchronization and the data links in action:</p><p><br /></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="8a6f2cc2-f7a8-4d80-9956-4cd8a6fea605"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=O3LijuCItEM" /></ac:parameter><ac:parameter ac:name="height">450</ac:parameter></ac:structured-macro></p><p style="text-align: center;"><ac:structured-macro ac:name="widget" ac:schema-version="1" ac:macro-id="3122e301-6e43-4c8d-8ba8-738e3a23db4c"><ac:parameter ac:name="width">800</ac:parameter><ac:parameter ac:name="url"><ri:url ri:value="https://www.youtube.com/watch?v=gKiXaQK7Wf8" /></ac:parameter><ac:parameter ac:name="height">450</ac:parameter></ac:structured-macro></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="25bb0086-a93b-4a5c-8c33-65a6c954e6fb" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164491 space=CDH2024xR3 version=1 -->
## PAGE 00094: HTML images, RTF, and OLE support

- page_id: `227164491`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164491/HTML+images+RTF+and+OLE+support
- version_number: 1
- version_date: `2024-01-24T10:17:53.825+01:00`
...
````html
<p>To import a schema map</p><hr /><ol><li>On the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The <strong>Schema Map Manager</strong> dialog opens.</li><li>Click <strong>Import</strong> and choose the schema map file. The template will be updated with the new mapping.</li></ol><p><br /><ac:image ac:align="center"><ri:attachment ri:filename="maptemplate05.png"><ri:page ri:content-title="Importing a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The updated template with the new mapping and without defined attributes.</h6><p><ac:image ac:align="center"><ri:attachment ri:filename="Attribute-defined Template.png"><ri:page ri:content-title="Importing a schema map" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The updated template with the new attribute-defined mapping.</h6>
````

<!--NOMAGIC_PAGE id=227163523 space=CDH2024xR3 version=1 -->
## PAGE 00098: Inactive Data Source filter

- page_id: `227163523`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163523/Inactive+Data+Source+filter
- version_number: 1
- version_date: `2018-02-01T06:03:38.327+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Add-on features
- labels: []
...
````html
<p>The<strong> Inactive Data Source Filter</strong> button <ac:image><ri:attachment ri:filename="dh-inactive-ds-filter.png"><ri:page ri:content-title="Inactive Data Source filter" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>is available on the <strong>DataHub Explorer</strong> toolbar. You can use this filter to filter out all inactive Data Sources from the <strong>DataHub Explorer</strong> tree.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer toolbar - Filtering inactive sources button" ac:alt="DataHub Explorer toolbar - Filtering inactive sources button"><ri:attachment ri:filename="dh-toggle-connected-data-sources.png"><ri:page ri:content-title="Inactive Data Source filter" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;"> Inactive Data Source Filter button on the DataHub Explorer toolbar.</h6>
````

<!--NOMAGIC_PAGE id=227164227 space=CDH2024xR3 version=1 -->
## PAGE 00099: Individual and Group Type Mapping

- page_id: `227164227`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164227/Individual+and+Group+Type+Mapping
- version_number: 1
- version_date: `2024-09-03T07:45:10.385+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping > Schema mapping modes
- labels: []
...
DataHub also provides a default Schema Map template for mapping data. In the **[CONFLUENCE_PAGE title='Schema Map Manager' space='CDH2024xR3']**dialog, you can find the default Schema Map template under the IBM® Rational® DOORS® driver side.
...
<!--NOMAGIC_PAGE id=227163394 space=CDH2024xR3 version=3 -->
## PAGE 00101: Installation, licensing, and system requirements

- page_id: `227163394`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163394/Installation+licensing+and+system+requirements
- version_number: 3
- version_date: `2025-11-20T12:52:32.215+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
````html
<p class="with-breadcrumbs">For information regarding installation, licensing, and system requirements, visit the <ac:link><ri:page ri:space-key="IL2024xR3" ri:content-title="Installation, licensing, and system requirements" /></ac:link> page.</p>
````

<!--NOMAGIC_PAGE id=227163393 space=CDH2024xR3 version=2 -->
## PAGE 00102: Introduction to Cameo DataHub

- page_id: `227163393`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163393/Introduction+to+Cameo+DataHub
- version_number: 2
- version_date: `2025-11-20T12:52:31.833+01:00`
- ancestors: Cameo DataHub Documentation
- labels: []
...
````html
<p><ac:structured-macro ac:name="excerpt-include" ac:schema-version="1" ac:macro-id="885f5512-3e04-41a2-925a-7d2fb0d0f728"><ac:parameter ac:name="page">Cameo DataHub Documentation</ac:parameter><ac:parameter ac:name="nopanel">true</ac:parameter><ac:parameter ac:name=""><ac:link><ri:page ri:content-title="Cameo DataHub Documentation" /></ac:link></ac:parameter></ac:structured-macro></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=227164097 space=CDH2024xR3 version=4 -->
## PAGE 00103: Linking model elements to OSLC resources

- page_id: `227164097`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164097/Linking+model+elements+to+OSLC+resources
- version_number: 4
- version_date: `2026-02-10T11:21:17.390+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
1. Do one of the following:
  - In the Model Browser, select an element, open its [CONFLUENCE_PAGE title='Specification window' space='MD2024xR3']**Specification** window and go to Documentation / Hyperlinks property group. Click Add .
...
````html
<p>You can link your model elements to the OSLC resources through the hyperlinks.</p><p>There are two ways you can link a model element to an OSLC resource:</p><ul><li data-uuid="171fb7e4-ffb1-44bb-a215-e2fbd150af47">Selecting an existing resource</li><li data-uuid="ddc15f6f-f329-4f33-8434-3e86e6cbb67d">Creating a new resource</li></ul><h3>Selecting an existing OSLC resource</h3><p><br /></p><p>To link an element to an OSLC resource</p><hr /><ol><li data-uuid="6f3568f7-6cfa-4722-84ad-c6dfc492cd5a">Do one of the following:<ul><li>In the Model Browser, select an element, open its <ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Specification window" /><ac:link-body><strong>Specification</strong> window</ac:link-body></ac:link> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the <strong>Hyperlinks / Go To</strong> button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="fa8f8163-515f-48ac-93d5-cbefad8476e1">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="230ffc4b-c7a3-4bfc-a375-1301e9024a26">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="23c2ae6a-49b3-446f-96b0-5d940fb0e7d3">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="6d3973d5-d02e-479f-804b-8770580fd1dc">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Choose Existing</strong> option.</li><li data-uuid="1951ca8a-9815-4030-9675-b544ca1e1a14">Select an artifact and click <strong>OK</strong>.<br /><br /><ac:image><ri:attachment ri:filename="select.png" /></ac:image><br /><br /></li><li data-uuid="91a32724-dc9c-4be3-8daa-c56696674a90">Click <strong>Close</strong>.</li><li data-uuid="60a9d216-649a-4663-9e17-eae26676b53a">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><h3>Creating a new OSLC resource</h3><p><br /></p><p>To create a new OSLC resource</p><hr /><ol><li data-uuid="e40bec69-44a4-4438-89f1-309a9669db1d">Do one of the following:<ul><li>In the Model Browser, select an element, open its <ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Specification window" /><ac:link-body><strong>Specification</strong> window</ac:link-body></ac:link> and go to <strong>Documentation / Hyperlinks</strong> property group. Click <strong>Add</strong>.</li><li>On the diagram pane, select an element, click the Hyperlinks / Go To button at the bottom left corner of the element shape. Select <strong>Add Hyperlink</strong>.</li></ul></li><li data-uuid="9f212e4d-fe81-479b-85ef-881a3d7623db">In the <strong>Edit Hyperlink</strong> dialog, open the <strong>OSLC Link</strong> tab.</li><li data-uuid="4d3829f2-51a9-4d5b-bd89-a7c3ffd03242">From the <strong>OSLC link type</strong> drop-down list, select a link type.</li><li data-uuid="b22e44e8-9a9a-4f6c-99e1-42baa554268f">Click the <strong>...</strong> button. The <strong>Select OSLC Resource</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="add_link.png" /></ac:image><br /><br /></li><li data-uuid="0cfb5908-f12e-4ca5-bea7-a7bda8656e8b">In the <strong>Select OSLC Resource</strong> dialog, select the <strong>Create New</strong> option.</li><li data-uuid="c75f96b3-71c6-464d-a0fe-5b30a538461a">Fill out the data for the new element.<br /><br /><ac:image><ri:attachment ri:filename="create.png" /></ac:image><br /><br /></li><li data-uuid="da0619b0-b50b-4c6f-8ed1-009c6fd8a564">Click <strong>OK</strong>.</li><li data-uuid="af277c67-c206-4a87-8477-f10b0105bc8f">Close the <strong>Edit Hyperlink</strong> dialog.</li></ol><p>The created element is now linked to your selected model element.</p>
````

<!--NOMAGIC_PAGE id=227163554 space=CDH2024xR3 version=3 -->
## PAGE 00104: Mapping source and target types to copy data to and from a modelling tool

- page_id: `227163554`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163554/Mapping+source+and+target+types+to+copy+data+to+and+from+a+modelling+tool
- version_number: 3
- version_date: `2026-02-10T11:15:06.182+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Basic features of DataHub
- labels: []
...
````html
<p>The <strong>Schema Map Manager</strong> dialog allows you to see all attributes of both sources and targets. It automates data matching and mapping so that you can integrate data on both sides and make them identical.</p><p>To open the <strong>Schema Map Manager</strong> dialog in MagicDraw<sup>®</sup></p><hr /><ol><li>From the main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>Schema Map Manager</strong>. The Cameo DataHub <strong>Schema Map Manager</strong> dialog opens.<br /><br /><ac:image><ri:attachment ri:filename="Schema_Map_Manager.png"><ri:page ri:content-title="Mapping with Schema Map Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Expand the nodes to see the types that have already been mapped.<br /><br /></li></ol><p>You can also select a schema map template in the<strong> Schema Map Manager</strong> dialog by expanding each Data Source. DataHub also allows you to view schema maps used by particular relations. You can right-click an item in the table and select <strong>View Schema Map</strong> to open the<strong> View Schema Map</strong> dialog from that schema map.<br /><br /></p><p style="text-align: center;"><ac:image><ri:attachment ri:filename="View Schema Map dialog.png"><ri:page ri:content-title="Mapping with Schema Map Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The View Schema Map dialog showing schema maps used by particular relations.</h6>
````

<!--NOMAGIC_PAGE id=227164003 space=CDH2024xR3 version=1 -->
## PAGE 00106: Module artifacts of DOORS Next Generation

- page_id: `227164003`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164003/Module+artifacts+of+DOORS+Next+Generation
- version_number: 1
- version_date: `2023-07-27T07:21:51.009+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with Data Sources > Adding Data Sources for IBM Rational DOORS Next Generation
- labels: []
...
<!--NOMAGIC_PAGE id=227163529 space=CDH2024xR3 version=3 -->
## PAGE 00109: Opening DataHub Explorer

- page_id: `227163529`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163529/Opening+DataHub+Explorer
- version_number: 3
- version_date: `2026-02-10T11:13:47.366+01:00`
- ancestors: Cameo DataHub Documentation > Getting started
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p><span style="color:var(--ds-text,#333333);">To open <strong>DataHub Explorer</strong></span></p><hr /><ol><li data-uuid="2bced86d-24c3-46bb-9bef-83de1ec54856">Create a new MagicDraw<sup>®</sup> project or open an existing project.</li><li data-uuid="25f38597-ca2f-4652-981a-0542f99ded3a">From the MagicDraw main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link> opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="worddavff8df49b8dd564525b509af5bc3f682e.png" /></ac:image></p><p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="59442eae-22b5-4d89-902c-278cc7ff4145"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="d47a72ab-0070-41c2-b4be-045a0129ddf6">Nodes under particular drivers in <strong>DataHub Explorer</strong> also represent nodes in the applications belonging to the drivers.</li><li data-uuid="7c387e8b-9084-4f31-9bd6-f2cb0ae7a92b">If a driver is correctly started, the name of the driver will appear in the <strong>DataHub Explorer</strong> tree. The driver will then connect to data in each of its respective application.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related page</strong></p><ul><li data-uuid="3c8a5ff6-06dc-4dfb-8321-1f10eeca0394"><ac:link><ri:page ri:content-title="DataHub Explorer tab" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164166 space=CDH2024xR3 version=1 -->
## PAGE 00110: Opening selected Requirements in DataHub Explorer or other applications

- page_id: `227164166`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164166/Opening+selected+Requirements+in+DataHub+Explorer+or+other+applications
- version_number: 1
- version_date: `2018-02-02T11:38:24.735+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Creating links between elements
- labels: []
...
The **OSLC Preview** tab in the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2024xR3'] allows you to view the details of the OSLC resource. The OSLC resource can be selected from **DataHub Explorer**, in the MagicDraw Containment tree, and an OSLC link to the other node from the connected OSLC Data Source that links to an element selected in the Model Browser**.**
...
````html
<p>This section explains the Generic OSLC Service Provider preference in the Cameo DataHub Options dialog.</p><p><br /></p><p>To specify the number of maximum concurrent connections for the OSLC Provider</p><hr /><ol><li>Open the <a href="https://docs.nomagic.com/display/CDH2024xR3/Customizing+DataHub+options">Cameo DataHub Options</a> dialog.<br /><br /><ac:image><ri:attachment ri:filename="Environment_Options_CDH_OSLC.png"><ri:page ri:content-title="OSLC Provider" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li>Go to the <strong>Generic OSLC Service Provider</strong> option<span> </span><span style="color: rgb(62,63,64);">group and<span> </span></span><span style="color: rgb(62,63,64);">update the option.<br /></span></li></ol><p style="">The following table explains the Generic OSLC Service Provider<strong> </strong>options in the Cameo DataHub Options dialog.</p><table class="relative-table" style="width: 87.8548%;"><colgroup><col style="width: 30.4639%;" /><col style="width: 69.5294%;" /></colgroup><tbody><tr><th>Option</th><th>Function</th></tr><tr><td>Maximum concurrent connection</td><td>Takes a numerical value for the maximum number of concurrent connections.</td></tr></tbody></table><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163514 space=CDH2024xR3 version=2 -->
## PAGE 00115: OSLC support

- page_id: `227163514`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163514/OSLC+support
- version_number: 2
- version_date: `2026-02-10T11:12:45.460+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=227164131 space=CDH2024xR3 version=1 -->
## PAGE 00116: OSLC tutorial

- page_id: `227164131`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164131/OSLC+tutorial
- version_number: 1
- version_date: `2023-08-29T11:16:03.004+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with OSLC features
- labels: []
...
````html
<p>To remove a Data Source</p><hr /><ol><li>Right-click the Data Source to remove and select <strong><ac:image><ri:attachment ri:filename="remove-ds.png"><ri:page ri:content-title="Removing a Data Source" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>.</li><li>You are prompted to confirm the removal action. Click <strong>OK</strong>.</li></ol><p>This option removes the Data Source from the <strong>DataHub Explorer</strong> tree. It also removes all related DHLinks and Schema Map information from DataHub.</p>
````

<!--NOMAGIC_PAGE id=227164153 space=CDH2024xR3 version=1 -->
## PAGE 00119: Removing DHLinks

- page_id: `227164153`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164153/Removing+DHLinks
- version_number: 1
- version_date: `2023-07-27T12:07:08.755+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Creating links between elements
- labels: []
...
````html
<p>DataHub provides two options to remove the DHLink of a node as follows</p><ul><li>Remove only a DHLink or DHTrace of the selected node.</li><li>Remove all DHLinks or DHTraces recursively in the node hierarchy.</li></ul><p><br />To remove a DHLink or DHTrace (recursively), do one of the following</p><hr /><ul><li>Right-click an item in <strong>DataHub Explorer</strong> and select <strong>Remove DHLinks</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Remove DHLinks.png"><ri:page ri:content-title="Removing DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p><ul><li>Right-click a DHLink in the <strong>DH Links</strong> panel and select <strong>Remove DHLink</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="Removing DHLink in the Cameo DataHub DHLink Panel" ac:alt="Removing DHLink in the Cameo DataHub DHLink Panel"><ri:attachment ri:filename="dh-links-tab-sync-tasks.png"><ri:page ri:content-title="Removing DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p><ul><li>Right-click a Traced or Suspect link in the <strong>DH Links </strong>panel and click <strong>Remove DHTrace</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image ac:title="Remove DHTrace option from DHLinks Panel" ac:alt="Remove DHTrace option from DHLinks Panel"><ri:attachment ri:filename="remove-dh-trace.png"><ri:page ri:content-title="Removing DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></p><ul><li>Right-click a node in the MagicDraw Containment tree and select <strong>DataHub Actions</strong> &gt; <strong>Remove DHLinks</strong>.<br /><br /></li></ul><p style="margin-left: 30.0px;"><ac:image><ri:attachment ri:filename="Right-click to Remove DHLink.png"><ri:page ri:content-title="Removing DHLinks" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p>
````

<!--NOMAGIC_PAGE id=227164170 space=CDH2024xR3 version=4 -->
## PAGE 00120: Requirement Mapping

- page_id: `227164170`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164170/Requirement+Mapping
- version_number: 4
- version_date: `2026-02-10T11:23:00.246+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>You can do simple schema mappings or define<span class="current"> target types from attribute value mapping</span>s between sources and targets in Cameo DataHub by using Schema Map Manager. This section also describes exporting, importing, and deleting schema mappings by using the <strong>Schema Map Manager</strong> dialog.</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="a3d1720d-ba69-440a-acdb-61ac8accc19c" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164285 space=CDH2024xR3 version=1 -->
## PAGE 00121: Saving the DHLink summary as reports

- page_id: `227164285`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164285/Saving+the+DHLink+summary+as+reports
- version_number: 1
- version_date: `2018-02-07T11:26:42.760+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DHLink summary and generating reports
- labels: []
...
1. In the Filter Options pane on the left-hand side of the [CONFLUENCE_PAGE title='DHLink Summary' space='CDH2024xR3'] dialog, choose type of relations you want to see in the DHLink summary.
...
````html
<p>After you view a DHLink summary, you can click <ac:image><ri:attachment ri:filename="save-btn-2.png"><ri:page ri:content-title="Saving the DHLink summary as reports" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to save the summary view. The report is saved in the HTML format so that you can open it in a web browser, e.g., Chrome or Firefox.</p><p><br /></p><p>To save a DHLink summary as a report</p><hr /><ol><li>In the<strong> Filter Options</strong> pane on the left-hand side of the <strong><ac:link><ri:page ri:content-title="DHLink Summary" ri:space-key="CDH2024xR3" /></ac:link></strong> dialog, choose type of relations you want to see in the DHLink summary.</li><li>Do one of the following to save the report</li></ol><ul><li style="list-style-type: none;background-image: none;"><ul><li>Click<strong> <ac:image><ri:attachment ri:filename="view-btn.png"><ri:page ri:content-title="Saving the DHLink summary as reports" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong> to view the DHLink summary and click <ac:image><ri:attachment ri:filename="save-btn-2.png"><ri:page ri:content-title="Saving the DHLink summary as reports" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image> to save the DHLink summary as a report.</li><li>Click<strong> <ac:image><ri:attachment ri:filename="generate-btn.png"><ri:page ri:content-title="Saving the DHLink summary as reports" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong> to save the DHLink summary as a report without viewing the items in the DHLink summary.</li></ul></li></ul><p><br /></p><ac:structured-macro ac:name="tip" ac:schema-version="1" ac:macro-id="e10c92a1-e958-4bae-a124-7b7341b2fb1c"><ac:parameter ac:name="title">Tip</ac:parameter><ac:rich-text-body><p>If you want to save a large amount of data in the report more quickly, click <strong><ac:image><ri:attachment ri:filename="generate-btn.png"><ri:page ri:content-title="Saving the DHLink summary as reports" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></strong>.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227163486 space=CDH2024xR3 version=5 -->
## PAGE 00122: Schema map and mapping options

- page_id: `227163486`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163486/Schema+map+and+mapping+options
- version_number: 5
- version_date: `2026-02-10T11:11:52.137+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface
- labels: []
...
<!--NOMAGIC_PAGE id=227163500 space=CDH2024xR3 version=2 -->
## PAGE 00124: Schema map templates

- page_id: `227163500`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163500/Schema+map+templates
- version_number: 2
- version_date: `2026-02-10T11:12:27.047+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Schema map and mapping options
- labels: []
...
<!--NOMAGIC_PAGE id=227164194 space=CDH2024xR3 version=1 -->
## PAGE 00125: Schema mapping modes

- page_id: `227164194`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164194/Schema+mapping+modes
- version_number: 1
- version_date: `2024-09-03T07:50:55.891+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=227163751 space=CDH2024xR3 version=1 -->
## PAGE 00126: Searching for a text string

- page_id: `227163751`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163751/Searching+for+a+text+string
- version_number: 1
- version_date: `2022-12-07T08:41:14.960+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Working with the DataHub Explorer tree
- labels: []
...
````html
<p>To search for text</p><hr /><ol><li><span style="color: rgb(62,63,64);">Type the text you want to search into the search box </span> <ac:image><ri:attachment ri:filename="text-search-box.png"><ri:page ri:content-title="Searching for a text string" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>.<br /><br /><ac:image ac:title="Text Search from DataHub Explorer" ac:alt="Text Search from DataHub Explorer"><ri:attachment ri:filename="dh-explorer-toolbar.png"><ri:page ri:content-title="Searching for a text string" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">The search results are shown in the<span> </span></span><strong style="text-align: left;">DataHub Explorer</strong><span style="color: rgb(62,63,64);"><span> </span>tree with highlighted texts in accordance with the used search word.</span><br /><br /><ac:image ac:title="Results of text search - the search item will be highlighted" ac:alt="Results of text search - the search item will be highlighted"><ri:attachment ri:filename="results-of-text-search.png"><ri:page ri:content-title="Searching for a text string" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><span style="color: rgb(62,63,64);">To navigate to the</span><span style="color: rgb(62,63,64);"> </span><strong style="text-align: left;">Next Result<span> </span></strong><span style="color: rgb(62,63,64);">or</span><span style="color: rgb(62,63,64);"> </span><strong style="text-align: left;">Previous Result<span> </span></strong><span style="color: rgb(62,63,64);">in the highlighted texts, use the navigation buttons next to the search box.<br /></span><br /><ac:image><ri:attachment ri:filename="Navigation Button.png"><ri:page ri:content-title="Searching for a text string" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ol>
````

<!--NOMAGIC_PAGE id=227164195 space=CDH2024xR3 version=1 -->
## PAGE 00127: Simple schema mapping

- page_id: `227164195`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164195/Simple+schema+mapping
- version_number: 1
- version_date: `2024-09-03T07:57:51.031+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping > Schema mapping modes
- labels: []
...
1. Open the [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR3'] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog. [ATTACHMENT filename='Schema_Map_Manager.png']
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
1. Open the [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH2024xR3'] [CONFLUENCE_PAGE title='Mapping with Schema Map Manager' space='CDH190'] dialog.
2. Select a source type that you want to edit its mapping. The default target type appears in the Target Type section.
...
<!--NOMAGIC_PAGE id=227164394 space=CDH2024xR3 version=2 -->
## PAGE 00130: Synchronize buttons and commands

- page_id: `227164394`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164394/Synchronize+buttons+and+commands
- version_number: 2
- version_date: `2025-11-20T12:59:13.426+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=227164442 space=CDH2024xR3 version=1 -->
## PAGE 00131: Synchronizing changes in data hierarchy

- page_id: `227164442`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164442/Synchronizing+changes+in+data+hierarchy
- version_number: 1
- version_date: `2018-01-22T03:52:10.306+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<p>The functionality of DHLink has been enhanced. The DHLink map is now stored along with the project so you can avoid conflicts in multi-user scenarios. The synchronization does not only limit for updating attribute values but also updating data hierarchy. When nodes are moved within the scope, synchronization also affects the changes in the data hierarchy next time you synchronize the data.</p><p><br /></p><p><ac:image><ri:attachment ri:filename="Sync Changes Hierarchy.png"><ri:page ri:content-title="Synchronizing changes in data hierarchy" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p>
````

<!--NOMAGIC_PAGE id=227164474 space=CDH2024xR3 version=1 -->
## PAGE 00132: Synchronizing changes in schema mapping

- page_id: `227164474`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164474/Synchronizing+changes+in+schema+mapping
- version_number: 1
- version_date: `2018-01-22T03:56:47.836+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<p>You can also synchronize updates on a schema map when you perform the data synchronization. If you change a schema map, synchronization applies the changes in the schema map to the affected nodes.</p><p><br /></p><p><ac:image ac:align="center"><ri:attachment ri:filename="Schema Map Changes Synchronize.png"><ri:page ri:content-title="Synchronizing changes in schema mapping" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The Schema Map Manager for synchronizing schema mapping.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="c5b2c6d2-eaef-4588-89d2-a718b527e510"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>After you update the schema map, the <strong>Edit Schema Map Confirmation</strong> dialog opens to notify that you must synchronize the data again to synchronize the changes to the affected nodes.</p><h6 style="text-align: center;"><ac:image ac:align="center" ac:title="Confirmation to Synchronize when a Schema Map is Changed" ac:alt="Confirmation to Synchronize when a Schema Map is Changed"><ri:attachment ri:filename="confirm-schema-edit.png"><ri:page ri:content-title="Synchronizing changes in schema mapping" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image>The Edit Schema Map Confirmation dialog.</h6></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227164365 space=CDH2024xR3 version=1 -->
## PAGE 00133: Synchronizing DOORS External Links

- page_id: `227164365`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164365/Synchronizing+DOORS+External+Links
- version_number: 1
- version_date: `2023-07-31T10:18:29.530+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
````html
<p>After Requirements are synchronized from DOORS, they can have Relationships, e.g., <strong>Satisfy</strong> or <strong>Derive</strong>, with other elements in the model. In this version, DataHub can synchronize these Relationships back to DOORS and create External Links that help display and navigate to those relationships with related model elements.<br /><br /></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="DataHub Synchronizes Relationships back to DOORS with External Links.png"><ri:page ri:content-title="Synchronizing DOORS External Links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">DataHub synchronizes Relationships back to DOORS and creates External Links to display and navigate to those relationships.</h6><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="External Link2.png"><ri:page ri:content-title="Synchronizing DOORS External Links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The External Link in DOORS displaying the Relationship and navigating to the related model element.</h6><p><br /></p><p>To synchronize a related element in the model with Requirements in DOORS as an External Link</p><hr /><ol><li><p class="auto-cursor-target">Right-click the module or parent node of Requirements and select <strong>Create/Update External Links to the Satisfying elements</strong>. The External Link will be created in the Requirements that contain Relationships in DOORS.<br /><br /><ac:image><ri:attachment ri:filename="Create External Link.PNG"><ri:page ri:content-title="Synchronizing DOORS External Links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="17e2ff65-e4a7-4132-907a-1d60c2449eeb"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>If you have selected the root node of the Sync Scope, the <strong>Create/Update External Links to the Satisfying elements</strong> operation will recursively detect the changes. Otherwise, only the selected node will be checked.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li><li>The <strong>Updating External Links</strong> dialog opens to show the synchronizing actions of the selected module or parent node of Requirements. Click <strong>Synchronize</strong> to proceed with the actions.<br /><br /><ac:image><ri:attachment ri:filename="Updating External Links Dialog.png"><ri:page ri:content-title="Synchronizing DOORS External Links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /></li><li><p class="auto-cursor-target">The <strong>Create/Update External Links Summary</strong> dialog opens to show the summary of External Links that have been created or updated. Click <strong>Close</strong> to complete the External Link synchronization.<br /><br /></p><p class="auto-cursor-target"><ac:image><ri:attachment ri:filename="Create or Update External Links Summary Dialog.png"><ri:page ri:content-title="Synchronizing DOORS External Links" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="a3b8b291-3600-4c53-8fe9-630159ccdae9"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>External Links will be created with or deleted from Requirements in DOORS according to the Relationships in the model.</p></ac:rich-text-body></ac:structured-macro><p class="auto-cursor-target"><br /></p></li></ol>
````

<!--NOMAGIC_PAGE id=227164468 space=CDH2024xR3 version=3 -->
## PAGE 00134: Synchronizing nodes

- page_id: `227164468`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164468/Synchronizing+nodes
- version_number: 3
- version_date: `2026-02-10T11:25:29.549+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>To synchronize any nodes in the <strong>Conflict Dashboard</strong> dialog</p><hr /><ol><li data-uuid="fcf9ef6c-8747-4fdc-a62f-dbce21a03cab"><p class="auto-cursor-target">Select any check boxes of Data Sources on either of the sides. The selected side will be the master Data Source, and the other side will pick up the changes from the selected side.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="57776fbc-c1d7-4a13-9494-dcc9a7c64609"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><p>A single node can be only synchronized from either the source to the target or the target to the source. However, multiple nodes can have different synchronization directions, e.g., one node can be synchronized from the source to the target, and another node can be synchronized from the target to the source.</p></ac:rich-text-body></ac:structured-macro></li><li data-uuid="de8340ec-420d-4d96-bb19-6987982a61d8">Click <strong>Synchronize</strong>.</li></ol></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related Pages</strong></p><ul><li data-uuid="78b34ec8-c428-4793-99fa-3c589b2e401f"><ac:link><ri:page ri:content-title="Tracking changes on Conflict Dashboard" /></ac:link></li></ul></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164317 space=CDH2024xR3 version=3 -->
## PAGE 00135: Synchronizing Requirements

- page_id: `227164317`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164317/Synchronizing+Requirements
- version_number: 3
- version_date: `2026-02-10T11:26:25.178+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization
- labels: []
...
<!--NOMAGIC_PAGE id=227163521 space=CDH2024xR3 version=1 -->
## PAGE 00137: Text search in DataHub Explorer and Alias Manager

- page_id: `227163521`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163521/Text+search+in+DataHub+Explorer+and+Alias+Manager
- version_number: 1
- version_date: `2018-02-01T06:00:28.729+01:00`
- ancestors: Cameo DataHub Documentation > Getting started > Understanding DataHub user interface > Add-on features
- labels: []
...
````html
<p>The text search capability in DataHub Explorer allows you to search for data and items in DataHub.</p><p style="margin-left: 30.0px;"><ac:image ac:align="center" ac:title="DataHub Explorer Text Search box" ac:alt="DataHub Explorer Text Search box"><ri:attachment ri:filename="dh-text-search.png"><ri:page ri:content-title="Text search in DataHub Explorer and Alias Manager" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Text search capability in DataHub Explorer.</h6>
````

<!--NOMAGIC_PAGE id=227164346 space=CDH2024xR3 version=1 -->
## PAGE 00138: Tracking changes on Conflict Dashboard

- page_id: `227164346`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164346/Tracking+changes+on+Conflict+Dashboard
- version_number: 1
- version_date: `2023-07-28T06:00:25.619+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Synchronization > Synchronizing Requirements
- labels: []
...
Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to [CONFLUENCE_PAGE title='Server Certificates' space='MD2024xR3']. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to [CONFLUENCE_PAGE title='3DEXPERIENCE platform troubleshooting' space='MD2024xR3'].

### EXACT CONFLUENCE STORAGE SOURCE

````html
<h3>Server Certificate tool</h3><p>Generally, all the certificates are managed automatically by the Server Certificate tool. To learn more about the Server Certificate tool, refer to <ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Server Certificates" /></ac:link>. The certificate is manually installed only when it is not trusted. To learn more about installing certificates manually, refer to  <ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="3DEXPERIENCE platform troubleshooting" /></ac:link>.</p>
````

<!--NOMAGIC_PAGE id=227164183 space=CDH2024xR3 version=1 -->
## PAGE 00140: UI components of Schema Map Manager

- page_id: `227164183`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164183/UI+components+of+Schema+Map+Manager
- version_number: 1
- version_date: `2024-09-03T07:56:46.724+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools > Requirement Mapping
- labels: []
...
<!--NOMAGIC_PAGE id=227164306 space=CDH2024xR3 version=3 -->
## PAGE 00142: Updating Teamwork Cloud projects

- page_id: `227164306`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164306/Updating+Teamwork+Cloud+projects
- version_number: 3
- version_date: `2025-12-03T10:32:46.514+01:00`
...
<!--NOMAGIC_PAGE id=227163588 space=CDH2024xR3 version=1 -->
## PAGE 00143: User Guide

- page_id: `227163588`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163588/User+Guide
- version_number: 1
- version_date: `2024-01-30T08:26:23.403+01:00`
- ancestors: Cameo DataHub Documentation
...
<!--NOMAGIC_PAGE id=227164299 space=CDH2024xR3 version=4 -->
## PAGE 00144: Using DataHub in Teamwork Cloud environment

- page_id: `227164299`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164299/Using+DataHub+in+Teamwork+Cloud+environment
- version_number: 4
- version_date: `2025-11-06T09:55:08.740+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
<!--NOMAGIC_PAGE id=227164503 space=CDH2024xR3 version=1 -->
## PAGE 00145: Working with custom IP Classification attributes

- page_id: `227164503`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164503/Working+with+custom+IP+Classification+attributes
- version_number: 1
- version_date: `2023-07-28T07:09:14.718+02:00`
- ancestors: Cameo DataHub Documentation > User Guide > Additional DataHub features
- labels: []
...
````html
<p><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02"><span style="color: rgb(62,63,64);">If you use</span> </ac:inline-comment-marker><a href="https://dsua.dsone.3ds.com/R2023x/English/?show=Lbc3DDashUserMap/lbc3ddash-c-ov.htm"><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02">IP Classification Editor</ac:inline-comment-marker></a><ac:inline-comment-marker ac:ref="dafeae39-9b84-4efb-8cdb-024dabcd4f02"> <span style="color: rgb(62,63,64);">on the 3DEXPERIENCE platform to manage libraries and classes, you can view and work with these custom IP classification attributes in the modeling tool as well. Cameo DataHub allows you to choose whether the attributes are displayed or hidden and use them for mapping and synchronization.</span></ac:inline-comment-marker></p><p>To view custom added attributes through IP classification</p><hr /><ul><li>Right-click on the <strong>ENVOIA REQS</strong> data source and select <strong>Show IP classification attribute<br /><br /></strong></li></ul><p><ac:image ac:align="left"><ri:attachment ri:filename="Custom IP Classfication command.png"><ri:page ri:content-title="Working with custom IP Classification attributes" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /><br /><br /><br /><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p><br /></p><p>After you click on the <strong>Show IP Classification attribute</strong> command, the data source will be reloaded and the list of custom added attributes will be visible in the properties tab.</p><p><br /></p><p>To view the properties tab</p><hr /><ul><li>Right click on the data source and select <strong>Properties<br /></strong><br /><ac:image><ri:attachment ri:filename="IP Classification Properties.png"><ri:page ri:content-title="Working with custom IP Classification attributes" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li><li>A new tab will display the properties of the selected data source.<br /><br /><ac:image><ri:attachment ri:filename="IP_Classification Comparison.png"><ri:page ri:content-title="Working with custom IP Classification attributes" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image></li></ul><p>To hide the custom added attributes through IP classification</p><hr /><ul><li>Right-click on the <strong>ENVOIA REQS</strong> data source and select <strong>Hide IP classification attribute<br /><br /><ac:image><ri:attachment ri:filename="IP Classification Hide Command.png"><ri:page ri:content-title="Working with custom IP Classification attributes" ri:space-key="CDH2024xR3" /></ri:attachment></ac:image><br /></strong></li></ul><hr />
````

<!--NOMAGIC_PAGE id=227163928 space=CDH2024xR3 version=3 -->
## PAGE 00146: Working with Data Sources

- page_id: `227163928`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163928/Working+with+Data+Sources
- version_number: 3
- version_date: `2026-02-10T11:20:14.109+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>Before connecting a Data Source to a driver, you need to have the<strong> DataHub Explorer</strong> tab open in MagicDraw<sup>®</sup>.</p><p>To open <strong>DataHub Explorer</strong></p><hr /><ol><li data-uuid="9f5b4b86-7c1f-4a65-ba02-9fa551c02f84">Start MagicDraw<sup>®</sup> and create a new project or open an existing one.</li><li data-uuid="61d0a2fa-9035-4f66-91e1-2737afb448a9">From the MagicDraw<sup>®</sup> main menu, click <strong>Tools</strong> &gt; <strong>DataHub</strong> &gt; <strong>DataHub Explorer</strong>. The <strong>DataHub Explorer</strong> tab opens.<br /> </li></ol><p style="margin-left: 30.0px;"><ac:image ac:title="DataHub Explorer" ac:alt="DataHub Explorer"><ri:attachment ri:filename="dh-explorer.png" /></ac:image></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="4a3bfa82-0bb1-4b85-9474-03162e9e93dc" /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227163589 space=CDH2024xR3 version=4 -->
## PAGE 00147: Working with DataHub and modeling tools

- page_id: `227163589`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163589/Working+with+DataHub+and+modeling+tools
- version_number: 4
- version_date: `2026-02-10T11:16:50.400+01:00`
- ancestors: Cameo DataHub Documentation > User Guide
- labels: []
...
To use Cameo DataHub, make sure you have [deployed it in your application](https://docs.nomagic.com/display/CDH2024xR3/Driver+deployment). The DataHub plugin works with both local and [CONFLUENCE_PAGE title='Using Teamwork Cloud' space='MD2024xR3'].
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><p>DataHub is a fully functional plugin for MagicDraw<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup>, IBM<sup>®</sup> Rational<sup>®</sup> DOORS<sup>®</sup> Next Generation, and CSV files. It allows you to work with the Requirement management tools mentioned above and provides three following main functions</p><ul><li data-uuid="faa2e882-935d-4c60-8541-93376313340b">Copy</li><li data-uuid="897505c8-75d1-483d-83b1-3980fc22a874">Link</li><li data-uuid="6177864d-71f2-4bff-9372-022c8275003a">Synchronize</li></ul><p>You can copy Requirement objects, and link them to one another as well as system models, for example, Use Cases and Diagram elements. You can create OSLC links and synchronize the repositories. This chapter also explains OSLC support and how to use it with Cameo DataHub.</p><p>To use Cameo DataHub, make sure you have <a href="https://docs.nomagic.com/display/CDH2024xR3/Driver+deployment">deployed it in your application</a>. The DataHub plugin works with both local and <ac:link><ri:page ri:space-key="MD2024xR3" ri:content-title="Using Teamwork Cloud" /><ac:plain-text-link-body><![CDATA[Teamwork Cloud projects]]></ac:plain-text-link-body></ac:link>.</p><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="b195c968-f56f-4ea2-844a-9d41925ec19b"><ac:parameter ac:name="title">Note</ac:parameter><ac:rich-text-body><ul><li data-uuid="8a21501e-f613-4a0b-b120-025ad31c186a">To load a MagicDraw<sup>®</sup> Teamwork Cloud project as a Data Source in DataHub, you must first log on to MagicDraw<sup>®</sup> Teamwork Cloud.</li><li data-uuid="cfb8e1e8-ce90-4e18-8bfe-c115c2f7fc49">Only the <strong>Locked For Edit</strong> Teamwork Cloud project elements can perform DataHub functions, e.g., copying and creating OSLC links and queries or synchronizing data.</li></ul></ac:rich-text-body></ac:structured-macro></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><strong>Related pages</strong></p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="061fb9c2-d35d-44fe-9eba-f215aff9675d" /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=227164084 space=CDH2024xR3 version=3 -->
## PAGE 00148: Working with OSLC features

- page_id: `227164084`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164084/Working+with+OSLC+features
- version_number: 3
- version_date: `2026-02-10T11:21:25.824+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
````html
<p>The modeling tool can link and share data using Open Services for Lifecycle Collaboration (OSLC) integration that allows the following</p><ul><li data-uuid="91d1d238-a828-4b90-9687-9dc6e38010bf">The modeling environment to work smoothly in the IBM Jazz ecosystem.</li><li data-uuid="c7441fad-66d5-42c9-aa03-d0ecb36a9461">Linking different project lifecycle artifacts in different tools without additional plugins needed.</li><li data-uuid="dd67760d-a096-4ed3-9325-27e56ad0bb8e">Seeing information details of linked artifacts without switching between different tools. </li></ul><p>The following chapters describe how the modeling tool works with OSLC:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f1b328bc-fea4-4637-8557-0d096f85deb0" /></p>
````

<!--NOMAGIC_PAGE id=227163733 space=CDH2024xR3 version=3 -->
## PAGE 00149: Working with the DataHub Explorer tree

- page_id: `227163733`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227163733/Working+with+the+DataHub+Explorer+tree
- version_number: 3
- version_date: `2026-02-10T11:17:52.890+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
...
<!--NOMAGIC_PAGE id=227164248 space=CDH2024xR3 version=5 -->
## PAGE 00150: Working with the DHLink summary and generating reports

- page_id: `227164248`
- space_key: `CDH2024xR3`
- source_url: https://docs.nomagic.com/spaces/CDH2024xR3/pages/227164248/Working+with+the+DHLink+summary+and+generating+reports
- version_number: 5
- version_date: `2026-02-10T11:23:51.861+01:00`
- ancestors: Cameo DataHub Documentation > User Guide > Working with DataHub and modeling tools
- labels: []
