# NOMAGIC DOCUMENTATION SPACE: Magic Real-Time Communication Designer 2024x Refresh3

<!--NOMAGIC_SPACE key=MRTCD2024xR3 chunk=1 -->

<!--NOMAGIC_PAGE id=227178990 space=MRTCD2024xR3 version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `227178990`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178990/Applying+DDS+Sterotypes
- version_number: 1
...
First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='MRTCD2024xR3']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='MRTCD2024xR3']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024xR3']>]]>
...
````html
<p>The Domain can be created by using the <span style="color: rgb(62,63,64);">DDS Domain Table. As shown in the following table, the Smart Home DDS Domain is created with specified its id, topics, participants and participant instances. <a href="https://docs.nomagic.com/display/MRTCD2024xR3/Defining+Domains+and+Domain+Participants#DefiningDomainsandDomainParticipants-CreatingDomainandDomainParticipantsbyusingtheDDSDomainTable">How to create DDS Domain Table&gt;&gt;</a></span></p><p><span style="color: rgb(62,63,64);"><ac:image ac:align="center"><ri:attachment ri:filename="domain_table.png"><ri:page ri:content-title="Creating the domain" ri:space-key="MRTCD2024xR3" /></ri:attachment></ac:image></span></p><h6 style="text-align: center;"><span style="color: rgb(62,63,64);">The example of DDS Domain Table.</span></h6><p class="auto-cursor-target"><span><span><span style="color: rgb(62,63,64);">The Participant Instances derived column displays all the instances that will be in the the DDS XML. </span>Now we are ready to export the model if we desire, but first we need to assign quality of service requirements on the DDS elements.</span><br /></span></p><p class="auto-cursor-target"><span><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=227178960 space=MRTCD2024xR3 version=1 -->
## PAGE 00004: Defining Domain Participant communication

- page_id: `227178960`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178960/Defining+Domain+Participant+communication
- version_number: 1
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024xR3'] 
[IMAGE alt='' src='']
...
<!--NOMAGIC_PAGE id=227179000 space=MRTCD2024xR3 version=1 -->
## PAGE 00008: Domain Participant without Instance

- page_id: `227179000`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179000/Domain+Participant+without+Instance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179001 space=MRTCD2024xR3 version=1 -->
## PAGE 00009: Duplicate Domain ID

- page_id: `227179001`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179001/Duplicate+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179002 space=MRTCD2024xR3 version=1 -->
## PAGE 00010: Endpoint not Referenced

- page_id: `227179002`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179002/Endpoint+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178982 space=MRTCD2024xR3 version=1 -->
## PAGE 00011: Environment setup

- page_id: `227178982`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178982/Environment+setup
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178988 space=MRTCD2024xR3 version=1 -->
## PAGE 00012: Example Model

- page_id: `227178988`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178988/Example+Model
- version_number: 1
...
````html
<p class="FirstParagraph">HomeControler.mdzip contains a model that describes a system that consists of an air conditioner unit, a dehumidifiers, shutters and a light sensor. The air conditioner and the dehumidifier both contain a controller and a sensor component. The system is supervised by the Home Controller whose main responsibility is to monitor data received from the components and to control them.</p><p class="FirstParagraph"><ac:image ac:align="center"><ri:attachment ri:filename="ibd_homeControlerSystem.png"><ri:page ri:content-title="Example Model" ri:space-key="MRTCD2024xR3" /></ri:attachment></ac:image></p><h6 class="FirstParagraph" style="text-align: center;">The SysmL Internal Block Diagram of Home Controller environment.</h6>
````

<!--NOMAGIC_PAGE id=227178997 space=MRTCD2024xR3 version=2 -->
## PAGE 00013: Exporting DDS Control Example to XML

- page_id: `227178997`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178997/Exporting+DDS+Control+Example+to+XML
- version_number: 2
- version_date: `2025-05-06T15:12:10.579+02:00`
- ancestors: Magic Real-Time Communication Designer > Home Control Example
- labels: []

### NORMALIZED CONTENT

You can export the DDS examples to XML. For this, follow the procedures provided in the page [Exporting DDS XML](https://docs.nomagic.com/display/MRTCD2024xR3/Exporting+DDS+XML).

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can export the DDS examples to XML. For this, follow the procedures provided in the page <a class="current" style="letter-spacing: 0.0px;" href="https://docs.nomagic.com/display/MRTCD2024xR3/Exporting+DDS+XML">Exporting DDS XML</a>.</p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=227178968 space=MRTCD2024xR3 version=2 -->
## PAGE 00014: Exporting DDS XML

- page_id: `227178968`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178968/Exporting+DDS+XML
- version_number: 2
- version_date: `2025-05-06T15:12:52.054+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
...
<!--NOMAGIC_PAGE id=227178987 space=MRTCD2024xR3 version=1 -->
## PAGE 00017: Home Control Example

- page_id: `227178987`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178987/Home+Control+Example
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179003 space=MRTCD2024xR3 version=1 -->
## PAGE 00018: Illegal Inheritance

- page_id: `227179003`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179003/Illegal+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178944 space=MRTCD2024xR3 version=1 -->
## PAGE 00019: Importing DDS Profile and DDS Style in Other Projects

- page_id: `227178944`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178944/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='MRTCD2024xR3'] to import them.
...
<!--NOMAGIC_PAGE id=227178981 space=MRTCD2024xR3 version=1 -->
## PAGE 00023: Install for simulation

- page_id: `227178981`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178981/Install+for+simulation
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178939 space=MRTCD2024xR3 version=2 -->
## PAGE 00024: Installation

- page_id: `227178939`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178939/Installation
- version_number: 2
- version_date: `2025-05-06T15:12:51.764+02:00`
- ancestors: Magic Real-Time Communication Designer
...
<!--NOMAGIC_PAGE id=227179005 space=MRTCD2024xR3 version=1 -->
## PAGE 00025: Instance not Participant

- page_id: `227179005`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179005/Instance+not+Participant
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179006 space=MRTCD2024xR3 version=1 -->
## PAGE 00026: Invalid Member Multiplicity

- page_id: `227179006`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179006/Invalid+Member+Multiplicity
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179007 space=MRTCD2024xR3 version=1 -->
## PAGE 00027: Invalid Member Type

- page_id: `227179007`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179007/Invalid+Member+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179008 space=MRTCD2024xR3 version=1 -->
## PAGE 00028: Invalid Port Type

- page_id: `227179008`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179008/Invalid+Port+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179009 space=MRTCD2024xR3 version=1 -->
## PAGE 00029: Invalid Repository

- page_id: `227179009`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179009/Invalid+Repository
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179010 space=MRTCD2024xR3 version=1 -->
## PAGE 00030: Invalid Topic Type Property Direction

- page_id: `227179010`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179010/Invalid+Topic+Type+Property+Direction
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178938 space=MRTCD2024xR3 version=3 -->
## PAGE 00031: Magic Real-Time Communication Designer

- page_id: `227178938`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178938/Magic+Real-Time+Communication+Designer
- version_number: 3
- version_date: `2025-05-06T15:14:26.338+02:00`
- ancestors: 
...
<!--NOMAGIC_PAGE id=227179011 space=MRTCD2024xR3 version=1 -->
## PAGE 00032: Missing Domain Attribute

- page_id: `227179011`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179011/Missing+Domain+Attribute
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179012 space=MRTCD2024xR3 version=1 -->
## PAGE 00033: Missing Domain ID

- page_id: `227179012`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179012/Missing+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179013 space=MRTCD2024xR3 version=1 -->
## PAGE 00034: Missing Element Name

- page_id: `227179013`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179013/Missing+Element+Name
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179014 space=MRTCD2024xR3 version=1 -->
## PAGE 00035: Multiple Struct Inheritance

- page_id: `227179014`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179014/Multiple+Struct+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179015 space=MRTCD2024xR3 version=1 -->
## PAGE 00036: Multitype Topic

- page_id: `227179015`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179015/Multitype+Topic
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179016 space=MRTCD2024xR3 version=1 -->
## PAGE 00037: Non-Nmeric Domain ID

- page_id: `227179016`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179016/Non-Nmeric+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179017 space=MRTCD2024xR3 version=1 -->
## PAGE 00038: Participant Type not Referenced

- page_id: `227179017`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179017/Participant+Type+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178995 space=MRTCD2024xR3 version=1 -->
## PAGE 00039: Qos Assignments

- page_id: `227178995`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178995/Qos+Assignments
- version_number: 1
...
The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='MRTCD2024xR3']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:content-title="QoS profile assignments" ri:space-key="MRTCD2024xR3" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:content-title="Qos Assignments" ri:space-key="MRTCD2024xR3" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=227178962 space=MRTCD2024xR3 version=2 -->
## PAGE 00040: QoS profile assignments

- page_id: `227178962`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178962/QoS+profile+assignments
- version_number: 2
- version_date: `2025-05-06T15:12:51.989+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
...
<!--NOMAGIC_PAGE id=227178980 space=MRTCD2024xR3 version=1 -->
## PAGE 00042: Simulation with Simulink

- page_id: `227178980`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178980/Simulation+with+Simulink
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179018 space=MRTCD2024xR3 version=1 -->
## PAGE 00043: Struct Member Visibility

- page_id: `227179018`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179018/Struct+Member+Visibility
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179019 space=MRTCD2024xR3 version=1 -->
## PAGE 00044: Topic Missing from Domain

- page_id: `227179019`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179019/Topic+Missing+from+Domain
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178986 space=MRTCD2024xR3 version=1 -->
## PAGE 00045: Type mapping

- page_id: `227178986`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178986/Type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179020 space=MRTCD2024xR3 version=1 -->
## PAGE 00046: Unspecified String Bounds

- page_id: `227179020`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179020/Unspecified+String+Bounds
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179021 space=MRTCD2024xR3 version=1 -->
## PAGE 00047: Unspecified String Bounds of Map Key

- page_id: `227179021`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179021/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
...
<!--NOMAGIC_PAGE id=227179022 space=MRTCD2024xR3 version=1 -->
## PAGE 00048: Unsupported Discriminator Type

- page_id: `227179022`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227179022/Unsupported+Discriminator+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=227178978 space=MRTCD2024xR3 version=2 -->
## PAGE 00049: Validation

- page_id: `227178978`
- space_key: `MRTCD2024xR3`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024xR3/pages/227178978/Validation
- version_number: 2
- version_date: `2025-05-06T15:12:52.236+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
- labels: []
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='MRTCD2024xR3'].
