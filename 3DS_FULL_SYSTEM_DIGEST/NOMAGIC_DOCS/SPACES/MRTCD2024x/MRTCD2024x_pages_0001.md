# NOMAGIC DOCUMENTATION SPACE: Magic Real-Time Communication Designer 2024x

<!--NOMAGIC_SPACE key=MRTCD2024x chunk=1 -->

<!--NOMAGIC_PAGE id=137990305 space=MRTCD2024x version=1 -->
## PAGE 00001: Applying DDS Sterotypes

- page_id: `137990305`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990305/Applying+DDS+Sterotypes
- version_number: 1
...
First and for most we need do define the data structures and the topics which will be used in the communication. This can easily be done with a Topic Definition diagram. [CONFLUENCE_PAGE title='Defining topics and types' space='MRTCD2024x']>]]>
...
Now that we have the data structures for the communication we can assign them to ports turning them into data writers and data readers in the DDS sense. [CONFLUENCE_PAGE title='Defining Domain Participant communication' space='MRTCD2024x']>]]>

First we need to apply the DomainParticipant stereotypes on Blocks whose instances will be used as the individual applications in the communication. [CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024x']>]]>
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2021xR2'] , right-click a Package wherein you want to create Domain Participants or Domain.
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2021xR2'] , right-click a predefined Domain Package.
...
2. In the table, specify the following: 
 ...
 - The **Participant Instances** column fill in automatically when instances are created in the model. >]]>[CONFLUENCE_PAGE title='Defining Domains and Domain Participants' space='MRTCD2024x'] 
[IMAGE alt='' src='']
...
1. In the [CONFLUENCE_PAGE title='Containment tab' space='MD2021xR2'] , right-click a Block which will be the owner of the instances.
2. From the shortcut menu, select Create Diagram and from the opened dialog, select SysML Internal Block Diagram.
3. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] select a property (e.g. Part Property) and click on the diagram pane.
...
1. Double-click the Part Property to open it's [CONFLUENCE_PAGE title='Specification window' space='MD2021xR2'] .
...
1. In the [CONFLUENCE_PAGE title='Model Browser' space='MD2021xR2'] , select the owner for the new diagram.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] , select a type you need and click on DDS Module element.
2. Type its name.
3. Click the Create Member [CONFLUENCE_PAGE title='Smart manipulators' space='MD2021xR2'] to create a Members for the type.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] , select a Topic and click on the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] .
2. Type its name.
3. Click the Create Element [CONFLUENCE_PAGE title='Smart manipulators' space='MD2021xR2'] to create a Topic Type Property or Reception for the Topic.
...
<!--NOMAGIC_PAGE id=137990315 space=MRTCD2024x version=1 -->
## PAGE 00008: Domain Participant without Instance

- page_id: `137990315`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990315/Domain+Participant+without+Instance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990316 space=MRTCD2024x version=1 -->
## PAGE 00009: Duplicate Domain ID

- page_id: `137990316`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990316/Duplicate+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990317 space=MRTCD2024x version=1 -->
## PAGE 00010: Endpoint not Referenced

- page_id: `137990317`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990317/Endpoint+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990297 space=MRTCD2024x version=1 -->
## PAGE 00011: Environment setup

- page_id: `137990297`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990297/Environment+setup
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990303 space=MRTCD2024x version=1 -->
## PAGE 00012: Example Model

- page_id: `137990303`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990303/Example+Model
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990312 space=MRTCD2024x version=1 -->
## PAGE 00013: Exporting DDS Control Example to XML

- page_id: `137990312`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990312/Exporting+DDS+Control+Example+to+XML
- version_number: 1
- version_date: `2023-09-22T14:02:25.173+02:00`
- ancestors: Magic Real-Time Communication Designer > Home Control Example
- labels: []

### NORMALIZED CONTENT

You can export the DDS examples to XML. For this, follow the procedures provided in the page [Exporting DDS XML](https://docs.nomagic.com/display/DRCP2021xR2/Exporting+DDS+XML).

### EXACT CONFLUENCE STORAGE SOURCE

````html
<p>You can export the DDS examples to XML. For this, follow the procedures provided in the page <a class="current" style="letter-spacing: 0.0px;" href="https://docs.nomagic.com/display/DRCP2021xR2/Exporting+DDS+XML">Exporting DDS XML</a>.</p><p><br /></p><p class="auto-cursor-target"><br /></p>
````

<!--NOMAGIC_PAGE id=137990283 space=MRTCD2024x version=1 -->
## PAGE 00014: Exporting DDS XML

- page_id: `137990283`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990283/Exporting+DDS+XML
- version_number: 1
- version_date: `2023-09-22T14:02:24.353+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] , select Tools > DDS > Generate DDS XML .
...
<!--NOMAGIC_PAGE id=137990302 space=MRTCD2024x version=1 -->
## PAGE 00017: Home Control Example

- page_id: `137990302`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990302/Home+Control+Example
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990318 space=MRTCD2024x version=1 -->
## PAGE 00018: Illegal Inheritance

- page_id: `137990318`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990318/Illegal+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990259 space=MRTCD2024x version=1 -->
## PAGE 00019: Importing DDS Profile and DDS Style in Other Projects

- page_id: `137990259`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990259/Importing+DDS+Profile+and+DDS+Style+in+Other+Projects
- version_number: 1
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] , select Tools > DDS > Import DDS XML.
...
The model defined in the XML is imported. As example see the figure below. QoS Profilescontained by the same file will not be imported. For this, you have to use the [CONFLUENCE_PAGE title='Importing QoS Profile' space='MRTCD2024x'] to import them.
...
1. From the [CONFLUENCE_PAGE title='Understanding the user interface' space='MD2021xR2'] , select Tools > DDS > Import QoS Profile .
...
<!--NOMAGIC_PAGE id=137990296 space=MRTCD2024x version=1 -->
## PAGE 00023: Install for simulation

- page_id: `137990296`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990296/Install+for+simulation
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990254 space=MRTCD2024x version=1 -->
## PAGE 00024: Installation

- page_id: `137990254`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990254/Installation
- version_number: 1
- version_date: `2023-09-22T14:02:23.791+02:00`
- ancestors: Magic Real-Time Communication Designer
...
1. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='MD2021xR2'] .
2. Install [CONFLUENCE_PAGE title='Installation, licensing, and system requirements' space='SYSMLP2021xR2'] .
3. Start MagicDraw.
...
<!--NOMAGIC_PAGE id=137990253 space=MRTCD2024x version=1 -->
## PAGE 00026: Introduction

- page_id: `137990253`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990253/Introduction
- version_number: 1
- version_date: `2023-09-22T14:02:23.753+02:00`
- ancestors: Magic Real-Time Communication Designer
- labels: []
...
<!--NOMAGIC_PAGE id=137990321 space=MRTCD2024x version=1 -->
## PAGE 00027: Invalid Member Multiplicity

- page_id: `137990321`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990321/Invalid+Member+Multiplicity
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990322 space=MRTCD2024x version=1 -->
## PAGE 00028: Invalid Member Type

- page_id: `137990322`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990322/Invalid+Member+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990323 space=MRTCD2024x version=1 -->
## PAGE 00029: Invalid Port Type

- page_id: `137990323`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990323/Invalid+Port+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990324 space=MRTCD2024x version=1 -->
## PAGE 00030: Invalid Repository

- page_id: `137990324`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990324/Invalid+Repository
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990325 space=MRTCD2024x version=1 -->
## PAGE 00031: Invalid Topic Type Property Direction

- page_id: `137990325`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990325/Invalid+Topic+Type+Property+Direction
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990252 space=MRTCD2024x version=2 -->
## PAGE 00032: Magic Real-Time Communication Designer

- page_id: `137990252`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990252/Magic+Real-Time+Communication+Designer
- version_number: 2
- version_date: `2025-05-06T15:02:58.567+02:00`
- ancestors: 
...
<!--NOMAGIC_PAGE id=137990326 space=MRTCD2024x version=1 -->
## PAGE 00033: Missing Domain Attribute

- page_id: `137990326`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990326/Missing+Domain+Attribute
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990327 space=MRTCD2024x version=1 -->
## PAGE 00034: Missing Domain ID

- page_id: `137990327`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990327/Missing+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990328 space=MRTCD2024x version=1 -->
## PAGE 00035: Missing Element Name

- page_id: `137990328`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990328/Missing+Element+Name
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990329 space=MRTCD2024x version=1 -->
## PAGE 00036: Multiple Struct Inheritance

- page_id: `137990329`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990329/Multiple+Struct+Inheritance
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990330 space=MRTCD2024x version=1 -->
## PAGE 00037: Multitype Topic

- page_id: `137990330`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990330/Multitype+Topic
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990331 space=MRTCD2024x version=1 -->
## PAGE 00038: Non-Nmeric Domain ID

- page_id: `137990331`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990331/Non-Nmeric+Domain+ID
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990332 space=MRTCD2024x version=1 -->
## PAGE 00039: Participant Type not Referenced

- page_id: `137990332`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990332/Participant+Type+not+Referenced
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990310 space=MRTCD2024x version=1 -->
## PAGE 00040: Qos Assignments

- page_id: `137990310`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990310/Qos+Assignments
- version_number: 1
...
The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. [CONFLUENCE_PAGE title='QoS profile assignments' space='MRTCD2024x']>]]>
...
````html
<p>The currents version allows three kind of QoS assignment each of which can be swiftly created with specific generic tables. Since they were already covered in previous sections we only assign one for demonstration purposes. <ac:link><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /><ac:plain-text-link-body><![CDATA[Learn how to create Endpoint QoS Assignment Table >>]]></ac:plain-text-link-body></ac:link></p><p>As shown in the figure below, the case is a kind of a special one because the port readLight is not actually on the HomeController block but on its light port’s type called NestedLightPort. There is a validation rule which checks if the port has no connection with the given instance.</p><p><ac:image ac:align="center"><ri:attachment ri:filename="QoS_Assignment_table.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="Qos Assignments" /></ri:attachment></ac:image></p><h6 style="text-align: center;">The example of Endpoint QoS Assignment Table.</h6>
````

<!--NOMAGIC_PAGE id=137990277 space=MRTCD2024x version=1 -->
## PAGE 00041: QoS profile assignments

- page_id: `137990277`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990277/QoS+profile+assignments
- version_number: 1
- version_date: `2023-09-22T14:02:24.257+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
...
````html
<p class="FirstParagraph">There are three elements that QoS Profiles can be assigned to in the model:</p><ul><li class="FirstParagraph">Endpoints typed by Topic.</li><li class="FirstParagraph">DomainParticipants.</li><li class="FirstParagraph">Topics.</li></ul><p><br /></p><p>To create an empty Endpoint QoS Assignment Table</p><hr /><ol><li>In the <a href="https://docs.nomagic.com/display/MD2021xR2/Containment+tab">Containment tree</a>, right-click a predefined <em>Endpoint QoS </em>Package.</li><li>From the shortcut menu, select <strong>Create Diagram </strong>and from the opened dialog, select Endpoint QoS Assignment Table.</li><li>The unnamed table is created. Type its name and press enter.</li></ol><p><br /></p><p>To fill in the Endpoint QoS Assignment Table</p><hr /><ol><li>From the table toolbar, click the <strong>Add New</strong> button. The new row appears and Endpoint QoS Assignment element is created in the model.</li><li><p class="auto-cursor-target">In the table, specify the following:<br /> - Double-click the <strong>Name</strong> cell and type Endpoint QoS Assignment name.<br /> - Double-click the <strong>QoS Profile</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Elements</strong> dialog choose QoS Profile.<br /> - Double-click the <strong>Endpoint</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Port </strong>dialog choose already created ports or use the <strong>Creation Mode</strong> to create new port.<br /> - Double-click the <strong>Domain Participant Instance</strong> cell, select <span class="confluence-embedded-file-wrapper confluence-embedded-manual-size"><ac:image ac:thumbnail="true" ac:alt="Edit" ac:height="11"><ri:attachment ri:filename="edit_button.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></span> and in the <strong>Select Property </strong>dialog choose already created Part Properties or use the <strong>Creation Mode</strong> to create new Part Property.</p></li></ol><p class="FirstParagraph"><span><br /></span></p><p class="FirstParagraph"><span>Assigning QoS on subscribers/publishers is not possible since they are derived from the model and not explicitly marked.</span></p><ul><li>To assign QoS Profiles on Topics create a Topic QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="topic_qos_assignemnt_table_example.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Domain Participants create a Participant QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="participant_qos_assignment.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li><li>To assign QoS Profiles on Endpoints create a Endpoint QoS Assignment Table.<br /><ac:image><ri:attachment ri:filename="endpoint_Qos_assignment_table.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="QoS profile assignments" /></ri:attachment></ac:image></li></ul>
````

<!--NOMAGIC_PAGE id=137990300 space=MRTCD2024x version=1 -->
## PAGE 00042: Setting up the Simulink model

- page_id: `137990300`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990300/Setting+up+the+Simulink+model
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990295 space=MRTCD2024x version=1 -->
## PAGE 00043: Simulation with Simulink

- page_id: `137990295`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990295/Simulation+with+Simulink
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990333 space=MRTCD2024x version=1 -->
## PAGE 00044: Struct Member Visibility

- page_id: `137990333`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990333/Struct+Member+Visibility
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990334 space=MRTCD2024x version=1 -->
## PAGE 00045: Topic Missing from Domain

- page_id: `137990334`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990334/Topic+Missing+from+Domain
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990301 space=MRTCD2024x version=1 -->
## PAGE 00046: Type mapping

- page_id: `137990301`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990301/Type+mapping
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990335 space=MRTCD2024x version=1 -->
## PAGE 00047: Unspecified String Bounds

- page_id: `137990335`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990335/Unspecified+String+Bounds
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990336 space=MRTCD2024x version=1 -->
## PAGE 00048: Unspecified String Bounds of Map Key

- page_id: `137990336`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990336/Unspecified+String+Bounds+of+Map+Key
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990337 space=MRTCD2024x version=1 -->
## PAGE 00049: Unsupported Discriminator Type

- page_id: `137990337`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990337/Unsupported+Discriminator+Type
- version_number: 1
...
<!--NOMAGIC_PAGE id=137990293 space=MRTCD2024x version=1 -->
## PAGE 00050: Validation

- page_id: `137990293`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990293/Validation
- version_number: 1
- version_date: `2023-09-22T14:02:24.545+02:00`
- ancestors: Magic Real-Time Communication Designer > Getting started
- labels: []
...
The detailed descriptions of the validation rules are available in [CONFLUENCE_PAGE title='Validation Suite' space='MRTCD2024x'].

[CONFLUENCE_PAGE title='Validation' space='MD2021xR2']>]]>
...
````html
<p class="FirstParagraph"><span lang="EN">The validity of the DDS model is continuously checked by active validation rules contained in the DDS Validation Suite. For example, if you accidentally add multiple attributes to a Topic, an error is displayed. You can fix some of these DDS modeling problems by right-clicking on them and selecting the appropriate solver.</span></p><p class="FirstParagraph"><span lang="EN"><ac:image><ri:attachment ri:filename="image2020-11-12_15-7-35.png"><ri:page ri:space-key="MRTCD2024x" ri:content-title="Validation" /></ri:attachment></ac:image></span></p><p class="FirstParagraph"><br /></p><p class="FirstParagraph"><span lang="EN"><span><span>There is a separate validation suite for Simulink named DDS Simulink Validation Suite. It contains validation rules for data types that are not supported by Simulink. It can be activated independently from the rest of the rules.</span></span></span></p><p>The detailed descriptions of the validation rules are available in <ac:link><ri:page ri:space-key="MRTCD2024x" ri:content-title="Validation Suite" /></ac:link>.</p><p><br /></p><p><ac:link><ri:page ri:space-key="MD2021xR2" ri:content-title="Validation" /><ac:plain-text-link-body><![CDATA[Learn more about Validation >>]]></ac:plain-text-link-body></ac:link></p><p>.</p><p class="FirstParagraph"><span lang="EN"><br /></span></p><div><span style="white-space: pre-wrap;"><br /></span></div><div><span style="white-space: pre-wrap;"><br /></span></div>
````

<!--NOMAGIC_PAGE id=137990313 space=MRTCD2024x version=1 -->
## PAGE 00051: Validation Suite

- page_id: `137990313`
- space_key: `MRTCD2024x`
- source_url: https://docs.nomagic.com/spaces/MRTCD2024x/pages/137990313/Validation+Suite
- version_number: 1
- version_date: `2023-09-22T14:02:25.224+02:00`
- ancestors: Magic Real-Time Communication Designer
- labels: []
...
The severity is either error or warning. Warning means that the state is not necessarily incorrect, but probably is. The implementation, qualified name, and abbreviation are given because those are the identifiers modeling tool provides for a validation rule, so this document is searchable by either. [CONFLUENCE_PAGE title='Validation' space='MD2021xR2']>]]>
