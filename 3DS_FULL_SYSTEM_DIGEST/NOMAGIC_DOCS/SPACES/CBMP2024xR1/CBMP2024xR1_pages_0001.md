# NOMAGIC DOCUMENTATION SPACE: Cameo Business Modeler Plugin 2024x Refresh1

<!--NOMAGIC_SPACE key=CBMP2024xR1 chunk=1 -->

<!--NOMAGIC_PAGE id=290031244 space=CBMP2024xR1 version=2 -->
## PAGE 00001: 2024x Refresh1 Version News

- page_id: `290031244`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031244/2024x+Refresh1+Version+News
- version_number: 2
- version_date: `2026-02-11T11:48:24.666+01:00`
...
````html
<ac:layout><ac:layout-section ac:type="single"><ac:layout-cell><h1 style="line-height: 1.66667;letter-spacing: normal;text-align: center;">Cameo Business Modeler Plugin</h1><p style="text-align: center;"><span style="color:var(--ds-text,#707070);">Released on: July 5</span><span style="color:var(--ds-text,#707070);">, 2024</span></p><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p><br /></p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="single"><ac:layout-cell><p>The version was released for compatibility purposes only. It does not contain new capabilities only minor bug fixes.</p><p>Check the product compatibility <ac:link><ri:page ri:space-key="NMDOC" ri:content-title="Product compatibility" /><ac:plain-text-link-body><![CDATA[here]]></ac:plain-text-link-body></ac:link>.</p></ac:layout-cell></ac:layout-section></ac:layout>
````

<!--NOMAGIC_PAGE id=290031275 space=CBMP2024xR1 version=1 -->
## PAGE 00002: Activities

- page_id: `290031275`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031275/Activities
- version_number: 1
...
````html
<p>An Activity is a work that is performed within a business process. An Activity can be atomic or non-atomic (compound). There are three types of Activities that are part of a Process:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="f66051d6-e804-413f-8aea-802e12fc6c57" /></p><p>If the Activity property Is For Compensation is set to true, the Activity will be used for compensation, which means that this Activity will be activated only when a Compensation Event is detected and initiated under the Compensation Event visibility scope. The Compensation indicator (marker) is displayed for all activities that are used for the compensation.</p><ul><li>Compensation Task with Compensation indicator<br /><ac:image><ri:attachment ri:filename="task_compensation.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></li><li>Compensation SubProcess with Compensation indicator<br /><ac:image><ri:attachment ri:filename="subprocess_compensation.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul><p>Activities can be repeated sequentially, essentially behaving like a loop. The presence of loop characteristics signifies that an Activity has the looping behavior. There are two types of looping characteristics defined in BPMN:</p><ul><li>Standard Loop. A Standard Loop indicator (marker) displayed in an Activity shape shows that the looping behavior based on a boolean condition is defined for this Activity. Additional looping characteristics can be defined, and the Activity will loop as long as the boolean condition is true. The condition is evaluated for every loop iteration and can be evaluated at the beginning or end of the iteration. In addition, a numeric cap can be optionally specified, but the number of iterations cannot exceed this cap.<ul><li>Task with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="task_standard_loop.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></li><li>SubProcess with Standard Loop marker<br /><ac:image><ri:attachment ri:filename="subprocess_standard_loop.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul></li><li><p>MultiInstance Loop. A MultiInstance Loop indicator shows that a desired number of Activity instances can be created. The instances can be executed in parallel or sequentially. Either expression is used to specify the desired number of instances or a data driven setup that can be used.</p><ul><li><p>Task with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="task_multi_par.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li><p>SubProcess with MultiInstance Loop marker for parallel instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li><p>Task with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="task_multi_par_seq.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></p></li><li>SubProcess with MultiInstance Loop marker for sequential instances<br /><ac:image><ri:attachment ri:filename="sun_multi_par_seq.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Activities" /></ri:attachment></ac:image></li></ul></li></ul><ac:structured-macro ac:name="warning" ac:schema-version="1" ac:macro-id="78303b38-7a07-479f-9c99-d0b24fc412d5"><ac:rich-text-body><p>The Compensation, Multi-instance Loop, and Standard Loop indicators can be added to all types of Activities.</p></ac:rich-text-body></ac:structured-macro>
````

<!--NOMAGIC_PAGE id=290031305 space=CBMP2024xR1 version=1 -->
## PAGE 00003: AdHoc SubProcess

- page_id: `290031305`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031305/AdHoc+SubProcess
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>An AdHoc SubProcess is a specialized type of SubProcess, which is a group of activities that have no required sequence relationships. A set of activities can be defined for the process, but the sequence and number of performances for the activities are determined by the performers of the activities.</p><p><strong>Notation</strong></p><ul><li>Expanded<br /><ac:image><ri:attachment ri:filename="expanded_adhoc.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="AdHoc SubProcess" /></ri:attachment></ac:image></li><li>Collapsed<br /><ac:image><ri:attachment ri:filename="suppressed_adhoc.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="AdHoc SubProcess" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031261 space=CBMP2024xR1 version=1 -->
## PAGE 00004: Anchor

- page_id: `290031261`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031261/Anchor
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031565 space=CBMP2024xR1 version=1 -->
## PAGE 00006: Assessment

- page_id: `290031565`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031565/Assessment
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031571 space=CBMP2024xR1 version=1 -->
## PAGE 00007: Assessment Concept Relationships

- page_id: `290031571`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031571/Assessment+Concept+Relationships
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>The following table provides the relationships that exist between element types and their meaning.</p><table class="relative-table wrapped" style="width: 2059.95px;"><colgroup><col style="width: 210.594px;" /><col style="width: 1303.06px;" /><col style="width: 545.297px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td style="">Identifies</td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Potential Reward" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Risk" /></ac:link>. Meaning that the Assessment points out some possible Potential Reward or Risk that is/are significant to that Assessment. Each possible consequence serves as an appraisal of the worth, value, or quality of some aspect of the Assessment in specific terms, types, or dimensions.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="identifies.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Provides<br />Impetus</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment is the driving force for the Business Policy or Business Rule.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="provides_impetus.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Achievements</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Vision" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Objective" /></ac:link>. Meaning that the Assessment has an impact on the End outcomes.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_achievements.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Affects<br />Employment</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mission" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link>, <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link>. Meaning that the Assessment has an impact on the use of Means.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="affects_employment.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td style=""><p>Judgement<br />For</p></td><td style=""><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment" /></ac:link> to a Influencer (<ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Internal Influencer" /></ac:link>). Meaning that the Assessment is the Influencer’s judgment that influences the organization’s ability to carry out its Means or achieve its Ends.</p></td><td style=""><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="judgement_for.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Assessment Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Assessment+Concepts">Assessment Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031564 space=CBMP2024xR1 version=1 -->
## PAGE 00008: Assessment Concepts

- page_id: `290031564`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031564/Assessment+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031265 space=CBMP2024xR1 version=1 -->
## PAGE 00009: Association

- page_id: `290031265`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031265/Association
- version_number: 1
...
````html
<p>A Boundary Event is an Intermediate event which can be placed on the boundary of any of the following activities:</p><ul><li>SubProcess, Task, or Call Activity</li><li>SubChoreography, Choreography Task, or Call Choreography</li></ul><p>Boundary Event indicates that while attached-to Activity is running, event is listening for the trigger signal.</p><p>Boundary Event types:</p><ul><li>Interrupting Boundary Event aborts Activity and Process is continued of exceptional flow. This event is drawn with a solid border.</li><li>Non-Interrupting Boundary Event splits process to parallel flows. This event is drawn with a dashed border.</li></ul><p><ac:image ac:align="center"><ri:attachment ri:filename="boundary_error.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Boundary Events" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Error Boundary Event attached to SubProcess.</h6><p>Types of Boundary Events are as follows:</p><p><ac:structured-macro ac:name="children" ac:schema-version="2" ac:macro-id="dd5528d2-89f7-4470-8751-3f740afa86c7" /></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=290031621 space=CBMP2024xR1 version=1 -->
## PAGE 00011: BPMN Activities Description Table

- page_id: `290031621`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031621/BPMN+Activities+Description+Table
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031485 space=CBMP2024xR1 version=1 -->
## PAGE 00014: BPMN Choreography Diagram

- page_id: `290031485`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031485/BPMN+Choreography+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031623 space=CBMP2024xR1 version=1 -->
## PAGE 00017: BPMN Matrices

- page_id: `290031623`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031623/BPMN+Matrices
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031273 space=CBMP2024xR1 version=1 -->
## PAGE 00018: BPMN Process

- page_id: `290031273`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031273/BPMN+Process
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A BPMN Process Diagram describes a sequence or flow of activities in an organization that shows how the business works. The diagram shows activities, events, and data that trigger or feed business activities. A BPMN Process Diagram is similar to the UML Activity diagram with a much richer set of default message types and business process styles of notations.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="process_diagram.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="BPMN Process Diagram" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">BPMN Process diagram</h6><p><br /></p>
````

<!--NOMAGIC_PAGE id=290031615 space=CBMP2024xR1 version=1 -->
## PAGE 00020: BPMN Processes Description Table

- page_id: `290031615`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031615/BPMN+Processes+Description+Table
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031628 space=CBMP2024xR1 version=1 -->
## PAGE 00021: BPMN Processes Structure Map

- page_id: `290031628`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031628/BPMN+Processes+Structure+Map
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031669 space=CBMP2024xR1 version=1 -->
## PAGE 00025: BPMN2 Completeness Validation Rules

- page_id: `290031669`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031669/BPMN2+Completeness+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031667 space=CBMP2024xR1 version=1 -->
## PAGE 00026: BPMN2 Correctness (Active) Validation Rules

- page_id: `290031667`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031667/BPMN2+Correctness+Active+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031668 space=CBMP2024xR1 version=1 -->
## PAGE 00027: BPMN2 Correctness Validation Rules

- page_id: `290031668`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031668/BPMN2+Correctness+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031670 space=CBMP2024xR1 version=1 -->
## PAGE 00028: BPMN2 Export Completeness Validation Rules

- page_id: `290031670`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031670/BPMN2+Export+Completeness+Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031518 space=CBMP2024xR1 version=1 -->
## PAGE 00029: BPMN2 XML support

- page_id: `290031518`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031518/BPMN2+XML+support
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031473 space=CBMP2024xR1 version=1 -->
## PAGE 00030: BPMNMessage

- page_id: `290031473`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031473/BPMNMessage
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031577 space=CBMP2024xR1 version=1 -->
## PAGE 00032: Business Data Diagram

- page_id: `290031577`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031577/Business+Data+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031539 space=CBMP2024xR1 version=1 -->
## PAGE 00035: Business Policy

- page_id: `290031539`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031539/Business+Policy
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031256 space=CBMP2024xR1 version=1 -->
## PAGE 00037: Business Process Model and Notation Concepts

- page_id: `290031256`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031256/Business+Process+Model+and+Notation+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031541 space=CBMP2024xR1 version=1 -->
## PAGE 00038: Business Rule

- page_id: `290031541`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031541/Business+Rule
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Business Rule is a Directive, intended to govern, guide, or influence business behavior, in support of Business Policy that has been formulated in response to an Opportunity, Threat, Strength, or Weakness. It is a single Directive that does not require additional interpretation to undertake Strategies or Tactics. Often, a Business Rule is derived from Business Policy. Business Rules guide Business Processes.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="business_rule.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Means+Concepts">Means Concepts</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Mean+Concept+Relationships">Mean Concept Relationships</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031297 space=CBMP2024xR1 version=1 -->
## PAGE 00039: Business Rule Task

- page_id: `290031297`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031297/Business+Rule+Task
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031502 space=CBMP2024xR1 version=1 -->
## PAGE 00041: Call Choreography

- page_id: `290031502`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031502/Call+Choreography
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031393 space=CBMP2024xR1 version=1 -->
## PAGE 00044: Cancel Boundary Event

- page_id: `290031393`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031393/Cancel+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031488 space=CBMP2024xR1 version=1 -->
## PAGE 00047: Choreography Activities

- page_id: `290031488`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031488/Choreography+Activities
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031257 space=CBMP2024xR1 version=1 -->
## PAGE 00051: Common BPMN Elements

- page_id: `290031257`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031257/Common+BPMN+Elements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031456 space=CBMP2024xR1 version=1 -->
## PAGE 00052: Compensation

- page_id: `290031456`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031456/Compensation
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031420 space=CBMP2024xR1 version=1 -->
## PAGE 00054: Compensation End Event

- page_id: `290031420`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031420/Compensation+End+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031374 space=CBMP2024xR1 version=1 -->
## PAGE 00056: Compensation Throwing Intermediate Event

- page_id: `290031374`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031374/Compensation+Throwing+Intermediate+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Conditional Boundary Event is triggered when a specified condition becomes true. When the event is triggered, it will change a normal flow of a Process into an exception flow.</p><p>This event displays either of the following on a diagram:</p><ul><li>A Conditional Catching Intermediate Event name if the name is specified.</li><li>A Conditional property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Conditional Boundary Event" /></ri:attachment></ac:image></li><li>Non-interrupting Conditional Boundary Event (Cancel Activity - True)<br /><ac:image><ri:attachment ri:filename="boundary_event_conditional_false.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Conditional Boundary Event" /></ri:attachment></ac:image></li></ul><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031356 space=CBMP2024xR1 version=1 -->
## PAGE 00060: Conditional Catching Intermediate Event

- page_id: `290031356`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031356/Conditional+Catching+Intermediate+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031332 space=CBMP2024xR1 version=1 -->
## PAGE 00061: Conditional Start Event

- page_id: `290031332`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031332/Conditional+Start+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Consecutive with Owner Number numbering schema provides non-multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is displayed before the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_I.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Consecutive with Owner Number" /></ri:attachment></ac:image></p><h6 style="text-align: center;">Consecutive Numbering style with element owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031514 space=CBMP2024xR1 version=1 -->
## PAGE 00063: Consecutive without Owner Number

- page_id: `290031514`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031514/Consecutive+without+Owner+Number
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Consecutive without Owner Number numbering schema provides non-multilevel element numbering. An Element Owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="element_numbering_consecutive_II.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Consecutive without Owner Number" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Consecutive numbering style without owner number.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031475 space=CBMP2024xR1 version=1 -->
## PAGE 00064: Conversation

- page_id: `290031475`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031475/Conversation
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031637 space=CBMP2024xR1 version=1 -->
## PAGE 00067: Creating and Using a BPMNEvent

- page_id: `290031637`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031637/Creating+and+Using+a+BPMNEvent
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031649 space=CBMP2024xR1 version=1 -->
## PAGE 00070: Creating and Using Conversation Nodes

- page_id: `290031649`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031649/Creating+and+Using+Conversation+Nodes
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031642 space=CBMP2024xR1 version=1 -->
## PAGE 00071: Creating and Using Data Items

- page_id: `290031642`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031642/Creating+and+Using+Data+Items
- version_number: 1
...
- [CONFLUENCE_PAGE title='Data Object' space='CBMP2024xR1']
- [CONFLUENCE_PAGE title='Data Store' space='CBMP2024xR1']
- [CONFLUENCE_PAGE title='Data Input and Data Output' space='CBMP2024xR1']
...
<!--NOMAGIC_PAGE id=290031650 space=CBMP2024xR1 version=1 -->
## PAGE 00073: Creating and Using Participant

- page_id: `290031650`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031650/Creating+and+Using+Participant
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031647 space=CBMP2024xR1 version=1 -->
## PAGE 00074: Creating and Using Pool and Lanes

- page_id: `290031647`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031647/Creating+and+Using+Pool+and+Lanes
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031635 space=CBMP2024xR1 version=1 -->
## PAGE 00075: Creating and Using SubProcesses

- page_id: `290031635`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031635/Creating+and+Using+SubProcesses
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031634 space=CBMP2024xR1 version=1 -->
## PAGE 00076: Creating and Using Tasks

- page_id: `290031634`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031634/Creating+and+Using+Tasks
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031253 space=CBMP2024xR1 version=1 -->
## PAGE 00077: Creating BPMN Projects

- page_id: `290031253`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031253/Creating+BPMN+Projects
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031654 space=CBMP2024xR1 version=1 -->
## PAGE 00079: Creating SubChoreography

- page_id: `290031654`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031654/Creating+SubChoreography
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031454 space=CBMP2024xR1 version=1 -->
## PAGE 00080: Data Association

- page_id: `290031454`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031454/Data+Association
- version_number: 1
...
````html
<p><br /></p><p style="margin-top: 0.0px;"><strong>Description</strong></p><p>A Data Association is used to model how data are pushed into or pulled from item-aware elements. Tokens do not flow along a Data Association. Therefore, they have no direct effect on the flow of a process.</p><p>Alternatively, Data Objects can be directly associated with a Sequence Flow to represent the same input or output Data Associations. This is a visual shortcut that is stored in a model as two Data Associations</p><ul><li>from Activity to Data Object</li><li>from Data Object to Activity</li></ul><p><strong>Example</strong></p><p><ac:image ac:align="center"><ri:attachment ri:filename="data_association_ flow_data_object.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Data Association" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Data Association showing flow of Data Object.</h6><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Object">Data Object</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Store">Data Store</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Data+Input+and+Data+Output">Data Input and Data Output</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+Data+Items">Creating and Using Data Items</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031451 space=CBMP2024xR1 version=1 -->
## PAGE 00081: Data Input and Data Output

- page_id: `290031451`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031451/Data+Input+and+Data+Output
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Dependency indicates a semantic relationship between two model elements (or two sets of model elements). Dependency indicates a situation in which a change to a supplier (target) element may require a change to a client (source) element in the dependency.</p><p>A Dependency is shown as a dashed arrow between model elements. The model element at the start point of the arrow (the client element) depends on the model element at the arrowhead (the supplier element). The arrow can be labeled with an optional individual name.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="dependency.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Dependency" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031516 space=CBMP2024xR1 version=1 -->
## PAGE 00086: Element Types Numbering Sequence

- page_id: `290031516`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031516/Element+Types+Numbering+Sequence
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031529 space=CBMP2024xR1 version=1 -->
## PAGE 00087: End Concept Relationships

- page_id: `290031529`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031529/End+Concept+Relationships
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031522 space=CBMP2024xR1 version=1 -->
## PAGE 00089: Ends Concepts

- page_id: `290031522`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031522/Ends+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031270 space=CBMP2024xR1 version=1 -->
## PAGE 00090: Error

- page_id: `290031270`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031270/Error
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031391 space=CBMP2024xR1 version=1 -->
## PAGE 00091: Error Boundary Event

- page_id: `290031391`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031391/Error+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031661 space=CBMP2024xR1 version=1 -->
## PAGE 00102: Exporting Models to XPDL

- page_id: `290031661`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031661/Exporting+Models+to+XPDL
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031556 space=CBMP2024xR1 version=1 -->
## PAGE 00103: External Influencer

- page_id: `290031556`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031556/External+Influencer
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031428 space=CBMP2024xR1 version=1 -->
## PAGE 00104: Gateways

- page_id: `290031428`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031428/Gateways
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031584 space=CBMP2024xR1 version=1 -->
## PAGE 00105: Generalization

- page_id: `290031584`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031584/Generalization
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Generalization link shows that one class provides grouping criteria for sets of other classes. Generic class may define sets of properties, that are applicable to all the specific classes. The Generalization link can be among classes.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="generalization.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Generalization" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Class" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Class</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Data+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Business Data Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031247 space=CBMP2024xR1 version=1 -->
## PAGE 00106: Getting Started

- page_id: `290031247`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031247/Getting+Started
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031525 space=CBMP2024xR1 version=1 -->
## PAGE 00107: Goal

- page_id: `290031525`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031525/Goal
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>Governs shows that a Business Policy governs BPMN Process.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="governs_process.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Governs" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031268 space=CBMP2024xR1 version=1 -->
## PAGE 00109: Group

- page_id: `290031268`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031268/Group
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031610 space=CBMP2024xR1 version=1 -->
## PAGE 00110: Guides

- page_id: `290031610`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031610/Guides
- version_number: 1
...
````html
<p>The following table provides the relationship that exists between element types and the meaning.</p><table class="wrapped"><colgroup><col /><col /><col /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td>Is Source Of </td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Influencing Organization" /></ac:link> to an Influencer (<ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="External Influencer" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Internal Influencer" /></ac:link>).<br />Meaning that the Influencing Organization is the source of Influencer. An Influencer may have multiple sources, or<br />none.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="is_source_of.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Influence Concepts Relationship" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Influencer+Concepts">Influencer Concepts</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031555 space=CBMP2024xR1 version=1 -->
## PAGE 00113: Influencer Concepts

- page_id: `290031555`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031555/Influencer+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031560 space=CBMP2024xR1 version=1 -->
## PAGE 00114: Influencing Organization

- page_id: `290031560`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031560/Influencing+Organization
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031245 space=CBMP2024xR1 version=1 -->
## PAGE 00116: Installation, licensing, and system requirements

- page_id: `290031245`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031245/Installation+licensing+and+system+requirements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031349 space=CBMP2024xR1 version=1 -->
## PAGE 00117: Intermediate Catch Event

- page_id: `290031349`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031349/Intermediate+Catch+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031367 space=CBMP2024xR1 version=1 -->
## PAGE 00118: Intermediate Throwing Event

- page_id: `290031367`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031367/Intermediate+Throwing+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031558 space=CBMP2024xR1 version=1 -->
## PAGE 00119: Internal Influencer

- page_id: `290031558`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031558/Internal+Influencer
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031445 space=CBMP2024xR1 version=1 -->
## PAGE 00121: Items and Data

- page_id: `290031445`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031445/Items+and+Data
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031358 space=CBMP2024xR1 version=1 -->
## PAGE 00122: Link Catching Intermediate Event

- page_id: `290031358`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031358/Link+Catching+Intermediate+Event
- version_number: 1
...
````html
<p style="margin-top: 10.0px;">The following table provides the relationships that exist between element types and their meaning.</p><table class="wrapped relative-table" style="width: 1931.61px;"><colgroup><col style="width: 334.094px;" /><col style="width: 1057.38px;" /><col style="width: 539.141px;" /></colgroup><tbody><tr><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Relationship </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);">Description </th><th style="background-color: rgb(241,242,244);color:var(--ds-text,#172b4d);"><p style="color:var(--ds-text,#172b4d);">Example</p></th></tr><tr><td><strong>Makes Operative </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mission" /><ac:plain-text-link-body><![CDATA[ Mission ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Vision" /></ac:link>. Meaning that the Mission lists every continuing<br />Activity to ensure the Vision.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="makes_operative.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Component Of </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[ Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mission" /></ac:link>. Meaning that the Strategy is the method or<br />course of action that will be employed to achieve the Mission.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="component_of.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Implements </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /></ac:link>. Meaning that the Tactic realizes Strategies.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="implements.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Enables </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link>. Meaning that a Strategy/<br />Tactic makes another Strategy/Tactic doable. That is to say the latter Strategy/Tactic<br />provides an opportunity for the former Strategy/Tactic to be carried out. Use this link<br />to associate Strategy to another Strategy or Tactic to another Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="enables.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Effects Enforcement Level </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link>. Meaning that the Tactics influences the</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="effects_enforcement_level.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Formulated Based On </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link>. Meaning<br />that the Strategy or Tactic is planned according to what result the Business Policy or<br />Business Rule desires.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="formulated based on.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Channel Efforts Towards </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Goal" /></ac:link>, or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link> to an <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Objective" /></ac:link>. Meaning that the Strategy is<br />coordinated as activities aimed towards Goals as Tactic towards Objective. For example, the<br />Tactic “Free delivery” channels efforts towards the Objective “5% increase in sales within 3<br />months.”</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="channel_effort_towards.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Governs </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Strategy" /><ac:plain-text-link-body><![CDATA[Strategy ]]></ac:plain-text-link-body></ac:link>or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Tactic" /></ac:link>. Meaning that the Business Policy or BusinessRule determines the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="governs.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Basis For </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link>. Meaning that the Business Policy is the key to achieve Business Rule.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="basis_for.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td><strong>Supports Achievement Of </strong></td><td><p>This link connects <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link> to a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Goal" /></ac:link> or <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Objective" /></ac:link>. Meaning that the Business Policy provides an<br />idea or reason to develop the Strategy or Tactic.</p></td><td><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="supports_achievement_of.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr><tr><td colspan="1"><strong>Acts As Regulation </strong></td><td colspan="1"><p>This link connects a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Policy" /></ac:link> or a <ac:link><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Business Rule" /></ac:link> to External Influencer.</p></td><td colspan="1"><div class="content-wrapper"><p><ac:image><ri:attachment ri:filename="acts_as_regulation.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Mean Concept Relationships" /></ri:attachment></ac:image></p></div></td></tr></tbody></table><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Means+Concepts">Means Concepts</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Business+Motivation+Diagram">Business Motivation Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031532 space=CBMP2024xR1 version=1 -->
## PAGE 00126: Means Concepts

- page_id: `290031532`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031532/Means+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031382 space=CBMP2024xR1 version=1 -->
## PAGE 00127: Message Boundary Event

- page_id: `290031382`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031382/Message+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031664 space=CBMP2024xR1 version=1 -->
## PAGE 00133: Migrating from BPMN 1.1

- page_id: `290031664`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031664/Migrating+from+BPMN+1.1
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031665 space=CBMP2024xR1 version=1 -->
## PAGE 00134: Migrating to UML Profile for BPMN2 v1.0

- page_id: `290031665`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031665/Migrating+to+UML+Profile+for+BPMN2+v1.0
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031663 space=CBMP2024xR1 version=1 -->
## PAGE 00135: Migration

- page_id: `290031663`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031663/Migration
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031533 space=CBMP2024xR1 version=1 -->
## PAGE 00136: Mission

- page_id: `290031533`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031533/Mission
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031657 space=CBMP2024xR1 version=1 -->
## PAGE 00138: Modifying BPMN Table

- page_id: `290031657`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031657/Modifying+BPMN+Table
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031508 space=CBMP2024xR1 version=1 -->
## PAGE 00139: Multilevel with Owner Number

- page_id: `290031508`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031508/Multilevel+with+Owner+Number
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Multilevel without Owner Number numbering schema provides multilevel element numbering. An Element owner (BPMN Process, BPMN Collaboration, or Choreography) number is not included in the element number.</p><p><strong>Example</strong></p><p><ac:image ac:align="center" ac:height="250"><ri:attachment ri:filename="element_numbering_multilevel_II.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Multilevel without Owner Number" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172B4D);">Multilevel Numbering style without element owner number.</h6><ac:structured-macro ac:name="note" ac:schema-version="1" ac:macro-id="47f86cd7-cfac-410d-a52b-3266d8d1fbfe"><ac:rich-text-body><p>When a Multilevel without element number numbering schema is used, the numbers in a project are not unique. Elements with the same number can exist in multiple diagrams.</p></ac:rich-text-body></ac:structured-macro><p><br /></p><p style="margin-top: 0.0px;"><strong>Related diagrams</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Using+BPMN+Element+Numbers" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Using BPMN Element Numbers</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031403 space=CBMP2024xR1 version=1 -->
## PAGE 00141: Multiple Boundary Event

- page_id: `290031403`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031403/Multiple+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031426 space=CBMP2024xR1 version=1 -->
## PAGE 00143: Multiple End Event

- page_id: `290031426`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031426/Multiple+End+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Multiple Start Event indicates that there are multiple ways to trigger a process. However, only one is required.</p><p><strong>Notation</strong></p><ul><li>Interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_interr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Multiple Start Event" /></ri:attachment></ac:image></li><li>Non-interrupting Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_noninterr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Multiple Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031378 space=CBMP2024xR1 version=1 -->
## PAGE 00145: Multiple Throwing Intermediate Event

- page_id: `290031378`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031378/Multiple+Throwing+Intermediate+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Multiple Throwing Intermediate Event signifies that multiple types of events are thrown. All of the defined triggers will be thrown by this event.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="intermediate_throwing_event_multiple.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Multiple Throwing Intermediate Event" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li class="ancestor-link parent-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Intermediate+Throwing+Event">Intermediate Throwing Event</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031643 space=CBMP2024xR1 version=1 -->
## PAGE 00146: Navigation Between BPMN Diagrams

- page_id: `290031643`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031643/Navigation+Between+BPMN+Diagrams
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined result.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="end_event.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="None End Event" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Boundary+Events">Boundary Events</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Activities">Activities</a></li><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/End+Events" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">End Events</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+an+Event">Creating and Using an Event</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031350 space=CBMP2024xR1 version=1 -->
## PAGE 00148: None Intermediate Event

- page_id: `290031350`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031350/None+Intermediate+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031322 space=CBMP2024xR1 version=1 -->
## PAGE 00149: None Start Event

- page_id: `290031322`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031322/None+Start+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A None Start Event does not have a defined trigger that invokes the start of a process.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="start_event.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="None Start Event" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290031505 space=CBMP2024xR1 version=1 -->
## PAGE 00150: Numbering Elements

- page_id: `290031505`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031505/Numbering+Elements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031527 space=CBMP2024xR1 version=1 -->
## PAGE 00152: Objective

- page_id: `290031527`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031527/Objective
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031436 space=CBMP2024xR1 version=1 -->
## PAGE 00156: Parallel Gateway

- page_id: `290031436`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031436/Parallel+Gateway
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Parallel Gateway is used to synchronize (combine) and create parallel flows.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="gateway_parallel.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Parallel Gateway" /></ri:attachment></ac:image></p><p><strong>Example</strong></p><p style="text-align: center;"><ac:image ac:align="center"><ri:attachment ri:filename="Parallel_gateway.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Parallel Gateway" /></ri:attachment></ac:image></p><h6 style="letter-spacing: normal;line-height: 1.66667;text-align: center;color:var(--ds-text,#172b4d);">Parallel Gateway.</h6><p><br /></p><p style="margin-top: 0.0px;"><strong>Related elements</strong></p><ul><li class="ancestor-link parent-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Gateways">Gateways</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Sequence+Flow">Sequence Flow</a></li></ul><p><strong>Related diagrams</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process+Diagram">BPMN Process Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Collaboration+Diagram">BPMN Collaboration Diagram</a></li><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Choreography+Diagram">BPMN Choreography Diagram</a></li></ul><p><strong>Related procedure</strong></p><ul><li><a href="https://docs.nomagic.com/display/CBMP2024xR1/Creating+and+Using+a+Sequence+Flow">Creating and Using a Sequence Flow</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031406 space=CBMP2024xR1 version=1 -->
## PAGE 00157: Parallel Multiple Boundary Event

- page_id: `290031406`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031406/Parallel+Multiple+Boundary+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Parallel Multiple Start Event indicates that there are multiple triggers required before a process can be initiated.</p><p><strong>Notation</strong></p><ul><li>Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_interr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Parallel Multiple Start Event" /></ri:attachment></ac:image></li><li>Non-Interrupting Parallel Multiple Start Event<br /><ac:image><ri:attachment ri:filename="start_event_multiple_parallel_noninterr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Parallel Multiple Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031484 space=CBMP2024xR1 version=1 -->
## PAGE 00160: Participant

- page_id: `290031484`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031484/Participant
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031593 space=CBMP2024xR1 version=1 -->
## PAGE 00161: Person

- page_id: `290031593`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031593/Person
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031606 space=CBMP2024xR1 version=1 -->
## PAGE 00165: Realizes

- page_id: `290031606`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031606/Realizes
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031567 space=CBMP2024xR1 version=1 -->
## PAGE 00168: Risk

- page_id: `290031567`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031567/Risk
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031299 space=CBMP2024xR1 version=1 -->
## PAGE 00170: Script Task

- page_id: `290031299`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031299/Script+Task
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031289 space=CBMP2024xR1 version=1 -->
## PAGE 00171: Send Task

- page_id: `290031289`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031289/Send+Task
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Service Task is a task that uses some sort of service, which could be a Web service or an automated application.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="service_task.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Service Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290031400 space=CBMP2024xR1 version=1 -->
## PAGE 00174: Signal Boundary Event

- page_id: `290031400`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031400/Signal+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031422 space=CBMP2024xR1 version=1 -->
## PAGE 00176: Signal End Event

- page_id: `290031422`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031422/Signal+End+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031340 space=CBMP2024xR1 version=1 -->
## PAGE 00177: Signal Start Event

- page_id: `290031340`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031340/Signal+Start+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Signal Start Event means that a signal, which has been broadcast from another process, has arrived and triggered the start of a process.</p><p>A Signal Start Event displays either of the following on a diagram:</p><ul><li>A Signal Start Event name if the name is specified.</li><li>A Signal Ref property value if the name is unspecified.</li></ul><p><strong>Notation</strong></p><ul><li>Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_interr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Signal Start Event" /></ri:attachment></ac:image></li><li>Non-Interrupting Signal Start Event<br /><ac:image><ri:attachment ri:filename="start_event_signal_noninterr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Signal Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031372 space=CBMP2024xR1 version=1 -->
## PAGE 00178: Signal Throwing Intermediate Event

- page_id: `290031372`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031372/Signal+Throwing+Intermediate+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031321 space=CBMP2024xR1 version=1 -->
## PAGE 00179: Start Events

- page_id: `290031321`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031321/Start+Events
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031535 space=CBMP2024xR1 version=1 -->
## PAGE 00180: Strategy

- page_id: `290031535`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031535/Strategy
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A SubProcess is used to create a context for an exception handling that applies to a group of activities.</p><p>A collapsed SubProcess can be used as a mechanism to show a compact and less clutter group of parallel activities.</p><p><strong>Notation</strong></p><ul><li>Expanded SubProcess<br /><ac:image><ri:attachment ri:filename="expanded_subprocess.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="SubProcess" /></ri:attachment></ac:image></li><li>Collapsed SubProcess<br /><ac:image><ri:attachment ri:filename="suppressed_subproces.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="SubProcess" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031301 space=CBMP2024xR1 version=1 -->
## PAGE 00184: SubProcesses

- page_id: `290031301`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031301/SubProcesses
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031251 space=CBMP2024xR1 version=2 -->
## PAGE 00185: Supportive diagrams

- page_id: `290031251`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031251/Supportive+diagrams
- version_number: 2
- version_date: `2026-02-23T14:33:40.069+01:00`
- ancestors: Cameo Business Modeler Plugin Documentation > User Guide > Getting Started > Introducing Main Concepts
- labels: []
...
<!--NOMAGIC_PAGE id=290031519 space=CBMP2024xR1 version=1 -->
## PAGE 00186: Supportive Diagrams Concepts

- page_id: `290031519`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031519/Supportive+Diagrams+Concepts
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031252 space=CBMP2024xR1 version=1 -->
## PAGE 00187: Switching to Business Modeling Perspectives

- page_id: `290031252`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031252/Switching+to+Business+Modeling+Perspectives
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031537 space=CBMP2024xR1 version=1 -->
## PAGE 00188: Tactic

- page_id: `290031537`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031537/Tactic
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Task that has no specified behavior defined.</p><p><strong>Notation</strong></p><p><ac:image><ri:attachment ri:filename="task.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Task" /></ri:attachment></ac:image></p><p />
````

<!--NOMAGIC_PAGE id=290031284 space=CBMP2024xR1 version=1 -->
## PAGE 00190: Tasks

- page_id: `290031284`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031284/Tasks
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031424 space=CBMP2024xR1 version=1 -->
## PAGE 00191: Terminate End Event

- page_id: `290031424`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031424/Terminate+End+Event
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Text Annotation allows a modeler to provide additional information about elements for the reader of a BPMN diagram.</p><p><strong>Example</strong></p><p><strong><br /></strong><ac:image><ri:attachment ri:filename="text_annotation.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Text Annotation" /></ri:attachment></ac:image></p><p><br /></p>
````

<!--NOMAGIC_PAGE id=290031385 space=CBMP2024xR1 version=1 -->
## PAGE 00193: Timer Boundary Event

- page_id: `290031385`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031385/Timer+Boundary+Event
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031327 space=CBMP2024xR1 version=1 -->
## PAGE 00195: Timer Start Event

- page_id: `290031327`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031327/Timer+Start+Event
- version_number: 1
...
````html
<p>Description</p><p>A Timer Start Event allows a particular time and date or cycle setting, for example, on Mondays at 9 A.M., to trigger the start of a process.</p><p>A Timer Start Event displays any of the following on a diagram:</p><ul><li>A Timer Start Event name if the name is specified.</li><li>A Time Cycle property name if the name is unspecified.</li><li>A Time Date property if the name and Time Cycle are unspecified.</li></ul><p>Notation</p><ul><li>Interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_interr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Timer Start Event" /></ri:attachment></ac:image></li><li>Non-interrupting Timer Start Event<br /><ac:image><ri:attachment ri:filename="start_event_timer_noninterr.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Timer Start Event" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031312 space=CBMP2024xR1 version=1 -->
## PAGE 00196: Transaction

- page_id: `290031312`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031312/Transaction
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Transaction is a specialized type of SubProcess whose special behavior is controlled through a transaction protocol (such as WS-Transaction).</p><p><strong>Notation</strong></p><ul><li>Expanded<br /><ac:image><ri:attachment ri:filename="transaction.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Transaction" /></ri:attachment></ac:image></li><li>Collapsed<br /><ac:image><ri:attachment ri:filename="transaction_suppressed.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Transaction" /></ri:attachment></ac:image></li></ul><p />
````

<!--NOMAGIC_PAGE id=290031602 space=CBMP2024xR1 version=1 -->
## PAGE 00197: Usage

- page_id: `290031602`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031602/Usage
- version_number: 1
...
````html
<p><strong>Description</strong></p><p>A Usage is a BPMNRelationship in which one element requires another element (or set of elements) for its full implementation or operation.</p><p><strong>Example</strong></p><p><ac:image><ri:attachment ri:filename="use.png"><ri:page ri:space-key="CBMP2024xR1" ri:content-title="Usage" /></ri:attachment></ac:image></p><p><br /></p><p style="margin-top: 0.0px;"><strong>Related element</strong></p><ul><li><a style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);" href="https://docs.nomagic.com/display/CBMP2024xR1/BPMN+Process">BPMN Process</a></li></ul><p><strong>Related diagram</strong></p><ul><li class="ancestor-link"><a href="https://docs.nomagic.com/display/CBMP2024xR1/Process+Definition+Diagram" style=";color:var(--ds-background-accent-blue-bolder,#0c66e4);">Process Definition Diagram</a></li></ul>
````

<!--NOMAGIC_PAGE id=290031246 space=CBMP2024xR1 version=1 -->
## PAGE 00198: User Guide

- page_id: `290031246`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031246/User+Guide
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031293 space=CBMP2024xR1 version=1 -->
## PAGE 00199: User Task

- page_id: `290031293`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031293/User+Task
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031651 space=CBMP2024xR1 version=1 -->
## PAGE 00201: Using BPMN Choreography Diagram

- page_id: `290031651`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031651/Using+BPMN+Choreography+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031646 space=CBMP2024xR1 version=1 -->
## PAGE 00202: Using BPMN Collaboration Diagram

- page_id: `290031646`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031646/Using+BPMN+Collaboration+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031660 space=CBMP2024xR1 version=1 -->
## PAGE 00203: Using BPMN Element Numbers

- page_id: `290031660`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031660/Using+BPMN+Element+Numbers
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031633 space=CBMP2024xR1 version=1 -->
## PAGE 00204: Using BPMN Process Diagram

- page_id: `290031633`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031633/Using+BPMN+Process+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031656 space=CBMP2024xR1 version=1 -->
## PAGE 00205: Using BPMN Tables and Matrices

- page_id: `290031656`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031656/Using+BPMN+Tables+and+Matrices
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031630 space=CBMP2024xR1 version=1 -->
## PAGE 00206: Using Cameo Business Modeler Plugin

- page_id: `290031630`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031630/Using+Cameo+Business+Modeler+Plugin
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031652 space=CBMP2024xR1 version=1 -->
## PAGE 00207: Using Choreography Activity

- page_id: `290031652`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031652/Using+Choreography+Activity
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031632 space=CBMP2024xR1 version=1 -->
## PAGE 00208: Using Common BPMN Elements

- page_id: `290031632`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031632/Using+Common+BPMN+Elements
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031659 space=CBMP2024xR1 version=1 -->
## PAGE 00209: Using Organization Structure Diagram

- page_id: `290031659`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031659/Using+Organization+Structure+Diagram
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031666 space=CBMP2024xR1 version=1 -->
## PAGE 00210: Validation Rules

- page_id: `290031666`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031666/Validation+Rules
- version_number: 1
...
<!--NOMAGIC_PAGE id=290031523 space=CBMP2024xR1 version=1 -->
## PAGE 00211: Vision

- page_id: `290031523`
- space_key: `CBMP2024xR1`
- source_url: https://docs.nomagic.com/spaces/CBMP2024xR1/pages/290031523/Vision
- version_number: 1
