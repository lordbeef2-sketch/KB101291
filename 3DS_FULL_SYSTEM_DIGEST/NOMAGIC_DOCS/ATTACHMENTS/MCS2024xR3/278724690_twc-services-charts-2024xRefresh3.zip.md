# NOMAGIC ATTACHMENT: twc-services-charts-2024xRefresh3.zip

- attachment_id: `278724690`
...
- reported_bytes: 62161
- download_url: https://docs.nomagic.com/download/attachments/227173188/twc-services-charts-2024xRefresh3.zip?version=1&modificationDate=1765893913941&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `b44cbbd5c6ba853bbd6d20169a43cc1ae836b6bd6328b43ec9bbadd577af2ba6`
...
Changes:
    ...
    New properties was added to authentication service:
        -Dmessaging.server.ip=
        -Dmessaging.server.port=
        -Dmessaging.server.security.enabled=
        -Dmessaging.user.name=
        -Dmessaging.user.password=
        -Dmessage.server.persistence.enabled=
    
    From Simulation and Collaboratro charts properties removed:
        -Dlicense.server=
        -Dlicense.framework=
        
    Added ingress-nginx default properties to increase proxy stream timeout
        proxy-stream-next-upstream-timeout: '3600'
        proxy-stream-timeout: '3600'

Ingress-nginx Chart was updated to 4.12.1 (nginx 1.12.1).
Zookeeper Chart was updated to 13.0.8 (Zookeeper 3.9.3)

Twcloud java updated to 17.0.14_7
Tomcat version updated to 10.1.40
Tomcat java version updated to 21.0.6+7
Apache ActiveMQ Artemis updatet to 2.40

Fixed:
	Sysml2-api and sgi-crawler filenames in Dockerfile
...
````json
{
  ...
  "type": "attachment",
  "status": "current",
  "title": "twc-services-charts-2024xRefresh3.zip",
  "version": {
    "by": {
      "type": "known",
      "username": "ingabe",
    ...
    "when": "2025-12-16T15:05:13.941+01:00",
    "message": "",
    "number": 1,
    "minorEdit": false,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/278724690/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/278724690"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/227173188/twc-services-charts-2024xRefresh3.zip?version=1&modificationDate=1765893913941&api=v2",
    "webui": "/spaces/MCS2024xR3/pages/227173188/Deployment+example+for+Teamwork+Cloud+with+services+on+Kubernetes?preview=%2F227173188%2F278724690%2Ftwc-services-charts-2024xRefresh3.zip",
    "self": "https://docs.nomagic.com/rest/api/content/278724690"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/278724690/child",
    "restrictions": "/rest/api/content/278724690/restriction/byOperation",
    "history": "/rest/api/content/278724690/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/278724690/descendant",
    "space": "/rest/api/space/MCS2024xR3",
    "relevantViewRestrictions": "/rest/api/content/278724690/restriction/relevantViewRestrictions"
  }
}
````
