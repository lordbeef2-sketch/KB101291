# NOMAGIC ATTACHMENT: utilities_2024xRefresh3.zip

- attachment_id: `278724648`
- space_key: `TWCloud2024xR3`
- parent_page_id: `227172937`
- parent_page_title: Admin Tools
- media_type: `application/zip`
- reported_bytes: 12745
- download_url: https://docs.nomagic.com/download/attachments/227172937/utilities_2024xRefresh3.zip?version=1&modificationDate=1765812482978&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `e80a67a01319b120b8a7745410b47503bdb7ae3fafc427c2745f5abb0d5ed6ea`
...
#Find TWC environment settings and make backup path from the installation root
if [ -f $TWC_ENV_PATH ]; then 
	source $TWC_ENV_PATH
	if [[ $# -eq 0 ]]; then TWC_BACKUP_PATH=${TWCLOUD_HOME%/*}/TWC_Backup; fi
fi
if [ -f $WAP_SVC_PATH ]; then WAP_PATH=$(cat $WAP_SVC_PATH | grep CATALINA_HOME_WEBAPP | cut -f3 -d\=); fi

#Copy relevant files to back up into a temporary staging folder
...
if [ -f $TWC_ENV_PATH ]; then 
	...
	if [ -d ${TWCLOUD_HOME%/*}/TWC_Backup ]; then DEFAULT_SRC_PATH=${TWCLOUD_HOME%/*}/TWC_Backup; fi
fi
echo
...
if [ -f $DIFF_SRC_PATH ] || [ -d $DIFF_SRC_PATH ]; then
	...
	if [[ $1 =~ "/" ]]; then echo "Invalid path: $DIFF_SRC_PATH"; fi
	echo
	printhelp
fi
...
````json
{
  ...
  "type": "attachment",
  "status": "current",
  "title": "utilities_2024xRefresh3.zip",
  "version": {
    "by": {
      "type": "known",
      "username": "jse21",
    ...
    "when": "2025-12-15T16:28:02.978+01:00",
    "message": "",
    "number": 1,
    "minorEdit": true,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/278724648/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/278724648"
    }
  },
  "position": -1,
  "container": {
    ...
    "_links": {
      "webui": "/spaces/TWCloud2024xR3/pages/227172937/Admin+Tools",
      "edit": "/pages/resumedraft.action?draftId=227172937",
      "tinyui": "/x/SWKKDQ",
      "self": "https://docs.nomagic.com/rest/api/content/227172937"
    },
    "_expandable": {
      "container": "/rest/api/space/TWCloud2024xR3",
      "metadata": "",
      "operations": "",
      "children": "/rest/api/content/227172937/child",
      "restrictions": "/rest/api/content/227172937/restriction/byOperation",
      "history": "/rest/api/content/227172937/history",
      "ancestors": "",
      "body": "",
      "version": "",
      "descendants": "/rest/api/content/227172937/descendant",
      "space": "/rest/api/space/TWCloud2024xR3",
      "relevantViewRestrictions": "/rest/api/content/227172937/restriction/relevantViewRestrictions"
    }
  },
  "metadata": {
  ...
  "_links": {
    "download": "/download/attachments/227172937/utilities_2024xRefresh3.zip?version=1&modificationDate=1765812482978&api=v2",
    "webui": "/spaces/TWCloud2024xR3/pages/227172937/Admin+Tools?preview=%2F227172937%2F278724648%2Futilities_2024xRefresh3.zip",
    "self": "https://docs.nomagic.com/rest/api/content/278724648"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/278724648/child",
    "restrictions": "/rest/api/content/278724648/restriction/byOperation",
    "history": "/rest/api/content/278724648/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/278724648/descendant",
    "space": "/rest/api/space/TWCloud2024xR3",
    "relevantViewRestrictions": "/rest/api/content/278724648/restriction/relevantViewRestrictions"
  }
}
````
