# NOMAGIC ATTACHMENT: CustomTWC_Cassandra5_DockerImg.zip

- attachment_id: `304001847`
- space_key: `MCS`
- parent_page_id: `304001845`
- parent_page_title: (2026x Refresh1) Installing Cassandra on Windows
- media_type: `application/zip`
- reported_bytes: 36807
- download_url: https://docs.nomagic.com/download/attachments/304001845/CustomTWC_Cassandra5_DockerImg.zip?version=1&modificationDate=1777452419961&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `9cfa01271edda0f286a60f3e0589e6e585d4779187ef3d6a47f2c4268e1f0329`

## ARCHIVE CONTENTS

### ENTRY: CustomTWC_Cassandra5_DockerImg/cassandra.twc.yaml
...
### ENTRY: CustomTWC_Cassandra5_DockerImg/Dockerfile
...
### ENTRY: CustomTWC_Cassandra5_DockerImg/jvm-server.twc.options
...
### ENTRY: CustomTWC_Cassandra5_DockerImg/jvm17-server.twc.options
...
# Enable metrics reporting to InfluxDB using the javaagent library
#-javaagent:/usr/share/cassandra/lib//jolokia-agent-jvm-2.3.0-javaagent.jar=port=8778,host=127.0.0.1,protocol=http


````

### ENTRY: CustomTWC_Cassandra5_DockerImg/logback.twc.xml
...
### ENTRY: CustomTWC_Cassandra5_DockerImg/README.md
...
````json
{
  ...
  "type": "attachment",
  "status": "current",
  "title": "CustomTWC_Cassandra5_DockerImg.zip",
  "version": {
    "by": {
      "type": "known",
      "username": "jse21",
    ...
    "when": "2026-04-29T10:46:59.961+02:00",
    "message": "",
    "number": 1,
    "minorEdit": true,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/304001847/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/304001847"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/304001845/CustomTWC_Cassandra5_DockerImg.zip?version=1&modificationDate=1777452419961&api=v2",
    "webui": "/spaces/MCS/pages/304001845/2026x+Refresh1+Installing+Cassandra+on+Windows?preview=%2F304001845%2F304001847%2FCustomTWC_Cassandra5_DockerImg.zip",
    "self": "https://docs.nomagic.com/rest/api/content/304001847"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/304001847/child",
    "restrictions": "/rest/api/content/304001847/restriction/byOperation",
    "history": "/rest/api/content/304001847/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/304001847/descendant",
    "space": "/rest/api/space/MCS",
    "relevantViewRestrictions": "/rest/api/content/304001847/restriction/relevantViewRestrictions"
  }
}
````
