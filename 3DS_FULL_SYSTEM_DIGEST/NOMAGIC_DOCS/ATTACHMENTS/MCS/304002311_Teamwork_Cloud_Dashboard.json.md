...
- attachment_id: `304002311`
- space_key: `MCS`
- parent_page_id: `304002285`
- parent_page_title: (2026x Refresh1) Telemetry Node
- media_type: `application/octet-stream`
- reported_bytes: 205215
- download_url: https://docs.nomagic.com/download/attachments/304002285/Teamwork%20Cloud%20Dashboard.json?version=1&modificationDate=1777452446930&api=v2
- payload_kind: `text-exact`
- downloaded_sha256: `30ac30509d9cc80a363841fbddbc15681b6fe48ef4c7394ca459403a38be4835`
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(max(bytes_recv),1s)*8 as \"in\"  FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), * fill(none)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
            ...
            },
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(max(bytes_sent),1s)*8 as \"out\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), * fill(none)",
              "rawQuery": true,
              "refId": "B",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(max(packets_recv), 1s) as \"in\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), * fill(none)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
            ...
            },
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative( max(packets_sent) ,1s) as \"out\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), * fill(none)",
              "rawQuery": true,
              "refId": "B",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(drop_in), 1s) as \"in\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), host,interface fill(none)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
            ...
            },
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(drop_out), 1s) as \"out\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), host,interface fill(none)",
              "rawQuery": true,
              "refId": "B",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(err_in), 1s) as \"in\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), host,interface fill(none)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
            ...
            },
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(err_out), 1s) as \"out\" FROM \"net\" WHERE host =~ /$server/ AND interface =~ /(vlan|eth|bond|en).*/ AND $timeFilter GROUP BY time($interval), host,interface fill(none)",
              "rawQuery": true,
              "refId": "B",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(reads),1s) as \"read\" FROM \"diskio\" WHERE \"host\" =~ /$server$/ AND \"name\" =~ /(v|s)d(a|b|c|d)$/ AND $timeFilter GROUP BY time($interval), *",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
            ...
            },
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT non_negative_derivative(mean(writes),1s) as \"write\" FROM \"diskio\" WHERE \"host\" =~ /$server$/ AND \"name\" =~ /(v|s)d(a|b|c|d)$/ AND $timeFilter GROUP BY time($interval), *",
              "rawQuery": true,
              "refId": "B",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT mean(iops_in_progress) as \"iops\" FROM \"diskio\" WHERE \"host\" =~ /$server$/ AND \"name\" =~ /(v|s)d(a|b|c|d)$/ AND $timeFilter GROUP BY time($interval), *",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT mean(\"Value\") FROM \"twc\" WHERE \"host\" =~ /^$server$/ AND \"objDomain\" = 'TWCloud' AND \"typeName\" =~ /ThreadPools*/ AND \"typeName\" =~ /Persistence*/ AND  \"typeName\" =~ /(ActiveTasks|PendingTasks|Blocked)/ AND $timeFilter GROUP BY time($__interval), \"host\", \"typeName\" fill(null)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT mean(\"Count\") as cumulative, non_negative_derivative(max(Count),1s) as derivative FROM \"twc\" WHERE \"host\" =~ /^$server$/ AND \"objDomain\" = 'TWCloud' AND \"typeName\" =~ /Operation*/ AND  \"typeName\" =~ /Astyanax/ AND $timeFilter GROUP BY time($__interval), \"host\", \"typeName\" fill(null)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
          ...
          "targets": [
            {
              ...
              "orderByTime": "ASC",
              "policy": "default",
              "query": "SELECT mean(\"50thPercentile\") as p50,  mean(\"99thPercentile\") as p99 FROM \"twc\" WHERE \"host\" =~ /^$server$/ AND \"objDomain\" = 'TWCloud' AND \"typeName\" =~ /Operation/ AND  \"typeName\" =~ /Astyanax/ AND $timeFilter GROUP BY time($__interval), \"host\", \"typeName\" fill(null)",
              "rawQuery": true,
              "refId": "A",
              "resultFormat": "time_series",
              "select": [
...
````json
{
  ...
  "version": {
    ...
    "when": "2026-04-29T10:47:26.930+02:00",
    "message": "",
    "number": 1,
    "minorEdit": false,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/304002311/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/304002311"
    }
  },
  "position": -1,
  "container": {
    ...
    "type": "page",
    "status": "current",
    "title": "(2026x Refresh1) Telemetry Node",
    "position": 1,
    "extensions": {
      "position": 1
    },
    "_links": {
      "webui": "/spaces/MCS/pages/304002285/2026x+Refresh1+Telemetry+Node",
      "edit": "/pages/resumedraft.action?draftId=304002285",
      "tinyui": "/x/7bQeEg",
      "self": "https://docs.nomagic.com/rest/api/content/304002285"
    },
    "_expandable": {
      "container": "/rest/api/space/MCS",
      "metadata": "",
      "operations": "",
      "children": "/rest/api/content/304002285/child",
      "restrictions": "/rest/api/content/304002285/restriction/byOperation",
      "history": "/rest/api/content/304002285/history",
      "ancestors": "",
      "body": "",
      "version": "",
      "descendants": "/rest/api/content/304002285/descendant",
      "space": "/rest/api/space/MCS",
      "relevantViewRestrictions": "/rest/api/content/304002285/restriction/relevantViewRestrictions"
    }
  },
  "metadata": {
  ...
  "_links": {
    "download": "/download/attachments/304002285/Teamwork%20Cloud%20Dashboard.json?version=1&modificationDate=1777452446930&api=v2",
    "webui": "/spaces/MCS/pages/304002285/2026x+Refresh1+Telemetry+Node?preview=%2F304002285%2F304002311%2FTeamwork+Cloud+Dashboard.json",
    "self": "https://docs.nomagic.com/rest/api/content/304002311"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/304002311/child",
    "restrictions": "/rest/api/content/304002311/restriction/byOperation",
    "history": "/rest/api/content/304002311/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/304002311/descendant",
    "space": "/rest/api/space/MCS",
    "relevantViewRestrictions": "/rest/api/content/304002311/restriction/relevantViewRestrictions"
  }
}
````
