# NOMAGIC ATTACHMENT: nginx-SAMPLE.zip

- attachment_id: `304002675`
- space_key: `MCS`
- parent_page_id: `304002672`
- parent_page_title: (2026x Refresh1) Downloadable scripts
- media_type: `application/zip`
- reported_bytes: 7412
- download_url: https://docs.nomagic.com/download/attachments/304002672/nginx-SAMPLE.zip?version=2&modificationDate=1782458184781&api=v2
- payload_kind: `archive-expanded`
- downloaded_sha256: `fe6ff0b18680e312f5871c14020a30609954734a239b1bf2f79ca76751e40390`

## ARCHIVE CONTENTS

### ENTRY: nginx-SAMPLE/configure_nginx_layer4_tcp.sh
...
### ENTRY: nginx-SAMPLE/configure_nginx_layer7_https.sh
...
### ENTRY: nginx-SAMPLE/example_install_nginx.sh
...
# Only allow RHEL 
if [[ "$OS_ID" != "rhel" ]]; then
    echo "Error: $NAME is not supported. This script supports only RHEL or Oracle Linux."
    exit 1
fi
...
# Check if nginx is available in default repos
if yum list available nginx >/dev/null 2>&1; then
    echo "nginx found in default repo — installing"
    yum -y install nginx
else
    echo "nginx not found in default repo — adding nginx.org repository"
...
### ENTRY: nginx-SAMPLE/https.conf.layer7.https.tmpl
...
### ENTRY: nginx-SAMPLE/nginx.conf.layer4.tcp.tmpl
...
### ENTRY: nginx-SAMPLE/nginx.conf.layer7.https.tmpl
...
### ENTRY: nginx-SAMPLE/stream.conf.layer4.tcp.tmpl
...
### ENTRY: nginx-SAMPLE/stream.conf.layer7.https.tmpl
...
````json
{
  ...
  "version": {
    ...
    "when": "2026-06-26T09:16:24.781+02:00",
    "message": "",
    "number": 2,
    "minorEdit": true,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/304002675/version/2"
    },
    "_expandable": {
      "content": "/rest/api/content/304002675"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/304002672/nginx-SAMPLE.zip?version=2&modificationDate=1782458184781&api=v2",
    "webui": "/spaces/MCS/pages/304002672/2026x+Refresh1+Downloadable+scripts?preview=%2F304002672%2F304002675%2Fnginx-SAMPLE.zip",
    "self": "https://docs.nomagic.com/rest/api/content/304002675"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/304002675/child",
    "restrictions": "/rest/api/content/304002675/restriction/byOperation",
    "history": "/rest/api/content/304002675/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/304002675/descendant",
    "space": "/rest/api/space/MCS",
    "relevantViewRestrictions": "/rest/api/content/304002675/restriction/relevantViewRestrictions"
  }
}
````
