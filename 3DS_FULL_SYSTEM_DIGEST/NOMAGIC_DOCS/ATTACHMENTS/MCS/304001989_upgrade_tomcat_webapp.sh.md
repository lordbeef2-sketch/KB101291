...
- attachment_id: `304001989`
- space_key: `MCS`
- parent_page_id: `304001985`
- parent_page_title: (2026x Refresh1) Hardening the deployment and its services
- media_type: `text/x-sh`
- reported_bytes: 2430
- download_url: https://docs.nomagic.com/download/attachments/304001985/upgrade_tomcat_webapp.sh?version=1&modificationDate=1777452435386&api=v2
...
````json
{
  ...
  "version": {
    ...
    "when": "2026-04-29T10:47:15.386+02:00",
    "message": "",
    "number": 1,
    "minorEdit": false,
    "hidden": false,
    "_links": {
      "self": "https://docs.nomagic.com/rest/experimental/content/304001989/version/1"
    },
    "_expandable": {
      "content": "/rest/api/content/304001989"
    }
  },
  "position": -1,
  "container": {
  ...
  "_links": {
    "download": "/download/attachments/304001985/upgrade_tomcat_webapp.sh?version=1&modificationDate=1777452435386&api=v2",
    "webui": "/spaces/MCS/pages/304001985/2026x+Refresh1+Hardening+the+deployment+and+its+services?preview=%2F304001985%2F304001989%2Fupgrade_tomcat_webapp.sh",
    "self": "https://docs.nomagic.com/rest/api/content/304001989"
  },
  "_expandable": {
    "operations": "",
    "children": "/rest/api/content/304001989/child",
    "restrictions": "/rest/api/content/304001989/restriction/byOperation",
    "history": "/rest/api/content/304001989/history",
    "ancestors": "",
    "body": "",
    "descendants": "/rest/api/content/304001989/descendant",
    "space": "/rest/api/space/MCS",
    "relevantViewRestrictions": "/rest/api/content/304001989/restriction/relevantViewRestrictions"
  }
}
````
