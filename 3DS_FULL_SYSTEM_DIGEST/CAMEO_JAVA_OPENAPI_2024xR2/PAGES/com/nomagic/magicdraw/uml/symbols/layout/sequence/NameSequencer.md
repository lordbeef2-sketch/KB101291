# JAVA OPENAPI: NameSequencer (2024x API)

- source_url: https://jdocs.nomagic.com/2024xRefresh2/com/nomagic/magicdraw/uml/symbols/layout/sequence/NameSequencer.html
- source_path: `com/nomagic/magicdraw/uml/symbols/layout/sequence/NameSequencer.html`
- source_sha256: `211a16a7b7f8b954fe57051d7489870169e1ba587e8ee7a039101e6ebdd949b0`
- captured_utc: `2026-07-14T16:55:55.335458+00:00`
...
`[NumberingSequencer](NumberingSequencer.html)`

@OpenApiAllpublic classNameSequencer
...
Description
`int`
`[compare](#compare(com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement))([ShapeElement](../../shapes/ShapeElement.html) shape1,
 [ShapeElement](../../shapes/ShapeElement.html) shape2)`

`protected int`
`[compareStrings](#compareStrings(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string1,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string2)`
...
sequencer name
compare
public int compare([ShapeElement](../../shapes/ShapeElement.html) shape1,
 [ShapeElement](../../shapes/ShapeElement.html) shape2)
Specified by:
...
protected int compareStrings(@CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string1,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) string2)
Compares two strings alphanumerically. Empty strings are placed at the end.
...
<h1 class="title" title="Class NameSequencer">Class NameSequencer</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.layout.sequence.NameSequencer</div>
</div>
...
<dd><code><a href="NumberingSequencer.html" title="class in com.nomagic.magicdraw.uml.symbols.layout.sequence">NumberingSequencer</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public class </span><span class="element-name type-name-label">NameSequencer</span>
...
<div class="block">Alphanumeric sequencer. Sorts alphabetically (uses the same sorting comparator as containment tree)</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">NameSequencer</a>()</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#compare(com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement)">compare</a><wbr/>(<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> shape1,
 <a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> shape2)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#compareStrings(java.lang.String,java.lang.String)">compareStrings</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> string1,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> string2)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Compares two strings alphanumerically.</div>
</div>
...
<h3>NameSequencer</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">NameSequencer</span>()</div>
</section>
</li>
</ul>
</section>
...
<h3>compare</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">int</span> <span class="element-name">compare</span><wbr/><span class="parameters">(<a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> shape1,
 <a href="../../shapes/ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a> shape2)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
...
<li>
<section class="detail" id="compareStrings(java.lang.String,java.lang.String)">
<h3>compareStrings</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">int</span> <span class="element-name">compareStrings</span><wbr/><span class="parameters">(@CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> string1,
 @CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> string2)</span></div>
<div class="block">Compares two strings alphanumerically. Empty strings are placed at the end.
 Null values are translated into empty strings.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>string1</code> - first string</dd>
<dd><code>string2</code> - second string</dd>
<dt>Returns:</dt>
<dd>compare result</dd>
</dl>
</section>
</li>
</ul>
