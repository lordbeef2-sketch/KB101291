...
| Python integration | `SYSTEMS_MODELING_OFFICIAL_REPOSITORIES/SysML-v2-API-Cookbook` | API Services repo; TWC/Simulation schemas; legacy Python | endpoint path, notebook cell, `requests`, JSON schema |
