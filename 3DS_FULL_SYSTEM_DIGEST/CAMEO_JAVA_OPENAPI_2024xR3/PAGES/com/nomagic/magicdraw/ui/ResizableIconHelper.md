# JAVA OPENAPI: ResizableIconHelper (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/ui/ResizableIconHelper.html
- source_path: `com/nomagic/magicdraw/ui/ResizableIconHelper.html`
- source_sha256: `b4da2ed1b92f2e6efda89865a6150c57e4163faea7512c041e0b9fa929838677`
- captured_utc: `2026-07-14T16:55:50.714404+00:00`
...
@OpenApiAll
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public classResizableIconHelper
...
`[createSVGIcon](#createSVGIcon(java.net.URL))([URL](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/net/URL.html) url)`
Deprecated.
...
createSVGIcon
@CheckForNull
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public static [ResizableIcon](../../ui/ResizableIcon.html) createSVGIcon([URL](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/net/URL.html) url)
Deprecated.
use [`IconsFactory.getNotScaledIcon(java.net.URL)`](../icons/IconsFactory.html#getNotScaledIcon(java.net.URL))
