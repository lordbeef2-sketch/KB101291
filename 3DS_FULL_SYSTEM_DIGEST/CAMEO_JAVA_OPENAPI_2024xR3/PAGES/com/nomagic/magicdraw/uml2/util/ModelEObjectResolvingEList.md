# JAVA OPENAPI: ModelEObjectResolvingEList (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml2/util/ModelEObjectResolvingEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/ModelEObjectResolvingEList.html`
- source_sha256: `a958f6fc6f08f882175f1b5cfeaf481a2d165beb9378c27ba263deafe1c19607`
- captured_utc: `2026-07-14T16:56:06.754584+00:00`
...
## Class ModelEObjectResolvingEList<E>
...
com.nomagic.magicdraw.uml2.util.ModelEObjectResolvingEList<E>
...
public classModelEObjectResolvingEList<E>
...
1.0
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.ModelEObjectResolvingEList)
...
Constructor
Description
`[ModelEObjectResolvingEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int))([Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`protected [E](ModelEObjectResolvingEList.html)`
`[resolve](#resolve(int,E))(int index,
 [E](ModelEObjectResolvingEList.html) object)`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, isSet, newData, resolve, resolve, resolveProxy, set, toArray, toArray, unset`
...
Overrides:
`hasProxies` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](ModelEObjectResolvingEList.html)>`
resolve
protected [E](ModelEObjectResolvingEList.html) resolve(int index,
 [E](ModelEObjectResolvingEList.html) object)
Overrides:
`resolve` in class `org.eclipse.emf.ecore.util.EObjectEList<[E](ModelEObjectResolvingEList.html)>`
...
<h1 class="title" title="Class ModelEObjectResolvingEList">Class ModelEObjectResolvingEList&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.ModelEObjectResolvingEList&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">ModelEObjectResolvingEList&lt;E&gt;</span>
...
<div class="block">Supports resolving of proxies.</div>
<dl class="notes">
<dt>Version:</dt>
<dd>1.0</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.ModelEObjectResolvingEList">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int)">ModelEObjectResolvingEList</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resolve(int,E)">resolve</a><wbr/>(int index,
 <a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a> object)</code></div>
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, isSet, newData, resolve, resolve, resolveProxy, set, toArray, toArray, unset</code></div>
<div class="inherited-list">
...
<h3>ModelEObjectResolvingEList</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ModelEObjectResolvingEList</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasProxies</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a></span> <span class="element-name">resolve</span><wbr/><span class="parameters">(int index,
 <a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a> object)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>resolve</code> in class <code>org.eclipse.emf.ecore.util.EObjectEList&lt;<a href="ModelEObjectResolvingEList.html" title="type parameter in ModelEObjectResolvingEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
