# JAVA OPENAPI: Behaviors (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml2/Behaviors.html
- source_path: `com/nomagic/magicdraw/uml2/Behaviors.html`
- source_sha256: `d0e5fe6f0cafea5860e026e3b02153e31631acd023ee4b88c04ffbc3bdb3803e`
- captured_utc: `2026-07-14T16:56:06.250580+00:00`
...
com.nomagic.magicdraw.uml2.Behaviors

public classBehaviors
...
Method
Description
`static [Behavior](../../uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/Behavior.html)`
`[findBehaviorFor](#findBehaviorFor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`
Finds a defining behavior for a given element.
`static boolean`
`[isReturnParameter](#isReturnParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter))([Parameter](../../uml2/ext/magicdraw/classes/mdkernel/Parameter.html) parameter)`
...
Method Details
findBehaviorFor
@CheckForNullpublic static [Behavior](../../uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/Behavior.html) findBehaviorFor([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
...
behavior
isReturnParameter
public static boolean isReturnParameter([Parameter](../../uml2/ext/magicdraw/classes/mdkernel/Parameter.html) parameter)
Parameters:
`parameter` - parameter
Returns:
...
<div class="inheritance">com.nomagic.magicdraw.uml2.Behaviors</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">Behaviors</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block">Convenience utility methods that operate on Behavior elements</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="../../uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#findBehaviorFor(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">findBehaviorFor</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Finds a defining behavior for a given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isReturnParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter)">isReturnParameter</a><wbr/>(<a href="../../uml2/ext/magicdraw/classes/mdkernel/Parameter.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Parameter</a> parameter)</code></div>
