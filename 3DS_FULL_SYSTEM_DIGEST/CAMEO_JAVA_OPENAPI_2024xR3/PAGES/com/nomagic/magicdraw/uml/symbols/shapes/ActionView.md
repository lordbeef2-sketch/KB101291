# JAVA OPENAPI: ActionView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/ActionView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/ActionView.html`
- source_sha256: `3cfd3a1b118583876c1ff18906a413c8ac87e9ec80f3d780141293b252df967b`
- captured_utc: `2026-07-14T16:56:01.847528+00:00`
...
`[CallBehaviorActionView](CallBehaviorActionView.html)`, `[CallOperationActionView](CallOperationActionView.html)`, `[OpaqueActionView](OpaqueActionView.html)`, `[SignalActionView](SignalActionView.html)`, `[StructuredActivityNodeView](StructuredActivityNodeView.html)`

@OpenApipublic classActionView
...
Constructor
Description
`[ActionView](#%3Cinit%3E())()`

`[ActionView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`protected void`
`[createAnyActionConfig](#createAnyActionConfig(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[SmartListenerConfig](../../../../uml2/ext/jmi/smartlistener/SmartListenerConfig.html)> configurations)`
...
`[Action](../../../../uml2/ext/magicdraw/actions/mdbasicactions/Action.html)`
`[getElement](#getElement())()`
Returns model element of this presentation element.
`com.nomagic.magicdraw.uml.symbols.shapes.ActionHeaderView`
`[getHeaderView](#getHeaderView())()`

`[PinView](PinView.html)`
`[getPinSymbol](#getPinSymbol(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Pin))([Pin](../../../../uml2/ext/magicdraw/actions/mdbasicactions/Pin.html) pin)`
Find owned symbol for a given pin
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[PinView](PinView.html)>`
`[getPinViews](#getPinViews())()`
...
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActionView.ARC_WIDTH)
ARC_HEIGHT
public static final int ARC_HEIGHT
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActionView.ARC_HEIGHT)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ActionView
public ActionView()
ActionView
public ActionView(@CheckForNull
...
protected void createAnyActionConfig([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[SmartListenerConfig](../../../../uml2/ext/jmi/smartlistener/SmartListenerConfig.html)> configurations)
getPinSymbol
@CheckForNullpublic [PinView](PinView.html) getPinSymbol([Pin](../../../../uml2/ext/magicdraw/actions/mdbasicactions/Pin.html) pin)
Find owned symbol for a given pin
Parameters:
...
getPinViews
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[PinView](PinView.html)> getPinViews()
Gets pin symbols lying on this action.
Returns:
...
getElement
public [Action](../../../../uml2/ext/magicdraw/actions/mdbasicactions/Action.html) getElement()
...
<h1 class="title" title="Class ActionView">Class ActionView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.ActionView</div>
</div>
</div>
</div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ActionView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ActionView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.ActionHeaderView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#constructHeaderView()">constructHeaderView</a>()</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/actions/mdbasicactions/Action.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Action</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.ActionHeaderView</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="PinView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PinView</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPinSymbol(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Pin)">getPinSymbol</a><wbr/>(<a href="../../../../uml2/ext/magicdraw/actions/mdbasicactions/Pin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Pin</a> pin)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Find owned symbol for a given pin</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="PinView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PinView</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPinViews()">getPinViews</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets pin symbols lying on this action.</div>
</div>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActionView.ARC_WIDTH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActionView.ARC_HEIGHT">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ActionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ActionView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ActionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ActionView</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.ActionHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<li>
<section class="detail" id="getPinSymbol(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Pin)">
<h3>getPinSymbol</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="PinView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PinView</a></span> <span class="element-name">getPinSymbol</span><wbr/><span class="parameters">(<a href="../../../../uml2/ext/magicdraw/actions/mdbasicactions/Pin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Pin</a> pin)</span></div>
<div class="block">Find owned symbol for a given pin</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>pin</code> - pin for which symbol existence should be checked.</dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="getPinViews()">
<h3>getPinViews</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="PinView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PinView</a>&gt;</span> <span class="element-name">getPinViews</span>()</div>
<div class="block">Gets pin symbols lying on this action.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>pin symbols lying on this action.</dd>
</dl>
</section>
</li>
<li>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/actions/mdbasicactions/Action.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Action</a></span> <span class="element-name">getElement</span>()</div>
