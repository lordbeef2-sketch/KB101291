# JAVA OPENAPI: AssociationClassView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/AssociationClassView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/AssociationClassView.html`
- source_sha256: `96677b9cd0b48bd4cd0f66554bbfb6b09a35ff46bb51cfffebfe523bcf045523`
- captured_utc: `2026-07-14T16:55:59.805509+00:00`
...
[com.nomagic.magicdraw.uml.symbols.paths.AssociationView](AssociationView.html)
com.nomagic.magicdraw.uml.symbols.paths.AssociationClassView

All Implemented Interfaces:
`[BaseElement](../../BaseElement.html)`, `com.nomagic.magicdraw.uml.CompartmentSupport`, `[MDElement](../../MDElement.html)`, `[ModelElementProvider](../../ModelElementProvider.html)`, `com.nomagic.magicdraw.uml.symbols.LabelOwner`, `com.nomagic.magicdraw.uml.symbols.LineJumpDrawer`, `com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>`, `com.nomagic.magicdraw.uml.symbols.paths.PathWithEnds<com.nomagic.magicdraw.uml.symbols.shapes.LinkEndView>`, `com.nomagic.magicdraw.uml.symbols.PropertyBasedPresentationElement`, `[StereotypesDisplayModeOwner](../shapes/StereotypesDisplayModeOwner.html)`, `com.nomagic.magicdraw.uml.symbols.SuspendShapeAutoResizeModeProvider`, `[NameOwner](../../../utils/NameOwner.html)`, `[PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[EventListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/EventListener.html)`

@OpenApipublic classAssociationClassView
extends [AssociationView](AssociationView.html)
implements com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>
...
Constructor
Description
`[AssociationClassView](#%3Cinit%3E())()`

`[AssociationClassView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[AssociationClassView](AssociationClassView.html)`
`[clone](#clone())()`

`protected void`
`[disposeChildren](#disposeChildren())()`
Removes all children from itself.
`[ClassView](../shapes/ClassView.html)`
`[getAnchoredShape](#getAnchoredShape())()`

`[LinkAttributeView](LinkAttributeView.html)`
`[getAnchorPath](#getAnchorPath())()`
...
`[ClassView](../shapes/ClassView.html)`
`[getClassView](#getClassView())()`

`[AssociationClass](../../../../uml2/ext/magicdraw/classes/mdassociationclasses/AssociationClass.html)`
`[getElement](#getElement())()`
Returns model element of this presentation element.
`[LinkAttributeView](LinkAttributeView.html)`
`[getLinkAttributeView](#getLinkAttributeView())()`
...
`boolean`
`[isAnchoredShapeMandatory](#isAnchoredShapeMandatory())()`

`boolean`
`[isSubElement](#isSubElement(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) element)`

`void`
`[layoutAnchoredShape](#layoutAnchoredShape())()`

`protected void`
`[notifyBreakPointsChangedForElement](#notifyBreakPointsChangedForElement(com.nomagic.magicdraw.uml.symbols.PresentationElement,java.awt.Point))([PresentationElement](../PresentationElement.html) view,
...
Removes given child
`void`
`[setClassView](#setClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView))([ClassView](../shapes/ClassView.html) classView)`
...
`void`
`[setLinkAttributeView](#setLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView))([LinkAttributeView](LinkAttributeView.html) linkAttributeView)`

`void`
`[simpleSetBounds](#simpleSetBounds(java.awt.Rectangle))([Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) rct)`
calls break point vector changed method.
`void`
`[sSetClassView](#sSetClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView))([ClassView](../shapes/ClassView.html) classView)`
...
`void`
`[sSetLinkAttributeView](#sSetLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView))([LinkAttributeView](LinkAttributeView.html) linkAttributeView)`
Methods inherited from class com.nomagic.magicdraw.uml.symbols.paths.[AssociationView](AssociationView.html)
`[canAddInstance](AssociationView.html#canAddInstance(com.nomagic.magicdraw.uml.symbols.PresentationElement)), [canHavePaths](AssociationView.html#canHavePaths()), [constructNameTextToDisplay](AssociationView.html#constructNameTextToDisplay()), [createNameLabelWrapper](AssociationView.html#createNameLabelWrapper()), [createSmartListenerConfig](AssociationView.html#createSmartListenerConfig(java.util.List)), [getAssociationNameBox](AssociationView.html#getAssociationNameBox()), [getModelElementForClientEndShape](AssociationView.html#getModelElementForClientEndShape()), [getModelElementForSupplierEndShape](AssociationView.html#getModelElementForSupplierEndShape()), [getNameLabelWrapper](AssociationView.html#getNameLabelWrapper()), [internalApplyProperties](AssociationView.html#internalApplyProperties(com.dassault_systemes.modeler.magic.diagram.styledelegates.PresentationElementStyleChanger)), [propertyChange](AssociationView.html#propertyChange(java.beans.PropertyChangeEvent)), [updateNameBox](AssociationView.html#updateNameBox())`
...
`calculateAlternativePoints, calculateAltPointsFromEndShapes, getAltPoint1, getAltPoint2, getChildPresentationElementForContextMenu, getChildrenWithSymbolProperties, getClientEndShape, getSupplierConnectionType, getSupplierEndShape, internalUpdatePresentationElement, layoutLabelOnNotifyBreakPointsChanged, notifyBreakPointsChanged, setAltPoint1, setAltPoint2, setLocationForChild, sSetClientEndShape, sSetModelElementsForPathEndShapes, sSetSupplierEndShape`
...
Methods inherited from interface com.nomagic.magicdraw.uml.symbols.paths.PathWithEnds
`asContainerLinkView`
...
Method Details
setClassView
public void setClassView([ClassView](../shapes/ClassView.html) classView)
sSetLinkAttributeView
public void sSetLinkAttributeView(@CheckForNull
 [LinkAttributeView](LinkAttributeView.html) linkAttributeView)
sSetClassView
public void sSetClassView([ClassView](../shapes/ClassView.html) classView)
setLinkAttributeView
public void setLinkAttributeView([LinkAttributeView](LinkAttributeView.html) linkAttributeView)
clone
public [AssociationClassView](AssociationClassView.html) clone()
Specified by:
...
getClassView
public [ClassView](../shapes/ClassView.html) getClassView()
getLinkAttributeView
public [LinkAttributeView](LinkAttributeView.html) getLinkAttributeView()
isAnchoredShapeMandatory
public boolean isAnchoredShapeMandatory()
Specified by:
`isAnchoredShapeMandatory` in interface `com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>`
getAnchorPath
public [LinkAttributeView](LinkAttributeView.html) getAnchorPath()
Specified by:
`getAnchorPath` in interface `com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>`
getAnchoredShape
public [ClassView](../shapes/ClassView.html) getAnchoredShape()
Specified by:
`getAnchoredShape` in interface `com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>`
removePresentationElement
public void removePresentationElement([PresentationElement](../PresentationElement.html) element)
Description copied from class: `[PresentationElement](../PresentationElement.html#removePresentationElement(com.nomagic.magicdraw.uml.symbols.PresentationElement))`
Removes given child
Overrides:
...
`element` - child
isSubElement
public boolean isSubElement([PresentationElement](../PresentationElement.html) element)
setElement
...
Description copied from class: `[PathElement](PathElement.html#simpleSetBounds(java.awt.Rectangle))`
calls break point vector changed method.
Overrides:
...
public void internalMovedAsToSelf(int dx,
 int dy)
Description copied from class: `[PathElement](PathElement.html#internalMovedAsToSelf(int,int))`
This is an internal method to notify a path that it was moved by connecting shape as the path "to self"
Overrides:
`[internalMovedAsToSelf](PathElement.html#internalMovedAsToSelf(int,int))` in class `[PathElement](PathElement.html)`
Parameters:
`dx` - delta x
`dy` - delta y
notifyBreakPointsChangedForElement
protected void notifyBreakPointsChangedForElement([PresentationElement](../PresentationElement.html) view,
 [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) location)
...
Overrides:
`[accept](AssociationView.html#accept(com.nomagic.magicdraw.uml.Visitor))` in class `[AssociationView](AssociationView.html)`
Parameters:
...
Description copied from class: `[PresentationElement](../PresentationElement.html#disposeChildren())`
...
Specified by:
`layoutAnchoredShape` in interface `com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner<[ClassView](../shapes/ClassView.html),[LinkAttributeView](LinkAttributeView.html)>`
getElement
public [AssociationClass](../../../../uml2/ext/magicdraw/classes/mdassociationclasses/AssociationClass.html) getElement()
...
Overrides:
`[getElement](AssociationView.html#getElement())` in class `[AssociationView](AssociationView.html)`
Returns:
...
<h1 class="title" title="Class AssociationClassView">Class AssociationClassView</h1>
</div>
...
<div class="inheritance"><a href="AssociationView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">com.nomagic.magicdraw.uml.symbols.paths.AssociationView</a>
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.AssociationClassView</div>
</div>
</div>
</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">AssociationClassView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">AssociationClassView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="AssociationClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">AssociationClassView</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#disposeChildren()">disposeChildren</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Removes all children from itself.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getAnchoredShape()">getAnchoredShape</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getAnchorPath()">getAnchorPath</a>()</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getClassView()">getClassView</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdassociationclasses/AssociationClass.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdassociationclasses">AssociationClass</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLinkAttributeView()">getLinkAttributeView</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isAnchoredShapeMandatory()">isAnchoredShapeMandatory</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isSubElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">isSubElement</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#layoutAnchoredShape()">layoutAnchoredShape</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#notifyBreakPointsChangedForElement(com.nomagic.magicdraw.uml.symbols.PresentationElement,java.awt.Point)">notifyBreakPointsChangedForElement</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view,
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Notify about changed break points</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView)">setClassView</a><wbr/>(<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a> classView)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setElement</a><wbr/>(<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView)">setLinkAttributeView</a><wbr/>(<a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a> linkAttributeView)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#simpleSetBounds(java.awt.Rectangle)">simpleSetBounds</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> rct)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">calls break point vector changed method.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView)">sSetClassView</a><wbr/>(<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a> classView)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView)">sSetLinkAttributeView</a><wbr/>(<a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a> linkAttributeView)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml.symbols.paths.AssociationView">Methods inherited from class com.nomagic.magicdraw.uml.symbols.paths.<a href="AssociationView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">AssociationView</a></h3>
<code><a href="AssociationView.html#canAddInstance(com.nomagic.magicdraw.uml.symbols.PresentationElement)">canAddInstance</a>, <a href="AssociationView.html#canHavePaths()">canHavePaths</a>, <a href="AssociationView.html#constructNameTextToDisplay()">constructNameTextToDisplay</a>, <a href="AssociationView.html#createNameLabelWrapper()">createNameLabelWrapper</a>, <a href="AssociationView.html#createSmartListenerConfig(java.util.List)">createSmartListenerConfig</a>, <a href="AssociationView.html#getAssociationNameBox()">getAssociationNameBox</a>, <a href="AssociationView.html#getModelElementForClientEndShape()">getModelElementForClientEndShape</a>, <a href="AssociationView.html#getModelElementForSupplierEndShape()">getModelElementForSupplierEndShape</a>, <a href="AssociationView.html#getNameLabelWrapper()">getNameLabelWrapper</a>, <a href="AssociationView.html#internalApplyProperties(com.dassault_systemes.modeler.magic.diagram.styledelegates.PresentationElementStyleChanger)">internalApplyProperties</a>, <a href="AssociationView.html#propertyChange(java.beans.PropertyChangeEvent)">propertyChange</a>, <a href="AssociationView.html#updateNameBox()">updateNameBox</a></code></div>
<div class="inherited-list">
...
<code>calculateAlternativePoints, calculateAltPointsFromEndShapes, getAltPoint1, getAltPoint2, getChildPresentationElementForContextMenu, getChildrenWithSymbolProperties, getClientEndShape, getSupplierConnectionType, getSupplierEndShape, internalUpdatePresentationElement, layoutLabelOnNotifyBreakPointsChanged, notifyBreakPointsChanged, setAltPoint1, setAltPoint2, setLocationForChild, sSetClientEndShape, sSetModelElementsForPathEndShapes, sSetSupplierEndShape</code></div>
<div class="inherited-list">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml.symbols.paths.PathWithEnds">Methods inherited from interface com.nomagic.magicdraw.uml.symbols.paths.PathWithEnds</h3>
...
<h3>AssociationClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AssociationClassView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>AssociationClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AssociationClassView</span><wbr/><span class="parameters">(@CheckForNull
...
<ul class="member-list">
<li>
<section class="detail" id="setClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView)">
<h3>setClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setClassView</span><wbr/><span class="parameters">(<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a> classView)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView)">
<h3>sSetLinkAttributeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetLinkAttributeView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a> linkAttributeView)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetClassView(com.nomagic.magicdraw.uml.symbols.shapes.ClassView)">
<h3>sSetClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetClassView</span><wbr/><span class="parameters">(<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a> classView)</span></div>
</section>
</li>
<li>
<section class="detail" id="setLinkAttributeView(com.nomagic.magicdraw.uml.symbols.paths.LinkAttributeView)">
<h3>setLinkAttributeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setLinkAttributeView</span><wbr/><span class="parameters">(<a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a> linkAttributeView)</span></div>
</section>
</li>
<li>
<section class="detail" id="clone()">
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="AssociationClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">AssociationClassView</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<dt>Overrides:</dt>
<dd><code>clone</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getClassView()">
<h3>getClassView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></span> <span class="element-name">getClassView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getLinkAttributeView()">
<h3>getLinkAttributeView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a></span> <span class="element-name">getLinkAttributeView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isAnchoredShapeMandatory()">
<h3>isAnchoredShapeMandatory</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isAnchoredShapeMandatory</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>isAnchoredShapeMandatory</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner&lt;<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a>,<wbr/><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getAnchorPath()">
<h3>getAnchorPath</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a></span> <span class="element-name">getAnchorPath</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getAnchorPath</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner&lt;<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a>,<wbr/><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a></span> <span class="element-name">getAnchoredShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getAnchoredShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner&lt;<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a>,<wbr/><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#removePresentationElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PresentationElement</a></code></span></div>
<div class="block">Removes given child</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>removePresentationElement</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="isSubElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>isSubElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isSubElement</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> element)</span></div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>setElement</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>sSetElement</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">simpleSetBounds</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> rct)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#simpleSetBounds(java.awt.Rectangle)">PathElement</a></code></span></div>
<div class="block">calls break point vector changed method.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>simpleSetBounds</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
<dt>Parameters:</dt>
<dd><code>rct</code> - new bounding rectangle.</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">internalMovedAsToSelf</span><wbr/><span class="parameters">(int dx,
 int dy)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#internalMovedAsToSelf(int,int)">PathElement</a></code></span></div>
<div class="block">This is an internal method to notify a path that it was moved by connecting shape as the path "to self"</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#internalMovedAsToSelf(int,int)">internalMovedAsToSelf</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="notifyBreakPointsChangedForElement(com.nomagic.magicdraw.uml.symbols.PresentationElement,java.awt.Point)">
<h3>notifyBreakPointsChangedForElement</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">notifyBreakPointsChangedForElement</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>notifyBreakPointsChangedForElement</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
<dt>Parameters:</dt>
<dd><code>view</code> - symbol</dd>
...
<dt>Overrides:</dt>
<dd><code><a href="AssociationView.html#accept(com.nomagic.magicdraw.uml.Visitor)">accept</a></code> in class <code><a href="AssociationView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">AssociationView</a></code></dd>
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#disposeChildren()">PresentationElement</a></code></span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>getBoundsToRepaint</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="layoutAnchoredShape()">
<h3>layoutAnchoredShape</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">layoutAnchoredShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>layoutAnchoredShape</code> in interface <code>com.nomagic.magicdraw.uml.symbols.paths.AnchoredShapeOwner&lt;<a href="../shapes/ClassView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassView</a>,<wbr/><a href="LinkAttributeView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">LinkAttributeView</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code><a href="AssociationView.html#getElement()">getElement</a></code> in class <code><a href="AssociationView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">AssociationView</a></code></dd>
<dt>Returns:</dt>
