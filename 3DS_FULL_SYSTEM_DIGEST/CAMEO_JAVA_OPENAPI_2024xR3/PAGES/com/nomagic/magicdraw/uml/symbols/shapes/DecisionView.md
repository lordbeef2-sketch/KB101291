# JAVA OPENAPI: DecisionView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/DecisionView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/DecisionView.html`
- source_sha256: `54d05d6b0635b65794f100b17b51b650a1c093eac28344e28de65bd6a59b846a`
- captured_utc: `2026-07-14T16:56:02.822539+00:00`
...
@OpenApipublic classDecisionView
...
Description
`static final int`
`[INNER_POLYGON_GAP](#INNER_POLYGON_GAP)`
...
Constructor
Description
`[DecisionView](#%3Cinit%3E())()`
Creates a new decision view.
`[DecisionView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
...
`boolean`
`[isDecisionOrMergeNode](#isDecisionOrMergeNode())()`
...
Distance from outer to inner polygon
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.DecisionView.INNER_POLYGON_GAP)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DecisionView
public DecisionView()
...
<h1 class="title" title="Class DecisionView">Class DecisionView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.DecisionView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DecisionView</span>
<span class="extends-implements">extends com.nomagic.magicdraw.uml.symbols.shapes.ShapeWithLabels</span></div>
<div class="block">Creates decision view object in activity or state diagram.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#INNER_POLYGON_GAP">INNER_POLYGON_GAP</a></code></div>
<div class="col-last even-row-color">
<div class="block">Distance from outer to inner polygon</div>
</div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">DecisionView</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a new decision view.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">DecisionView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates and initializes a new decision view from specified parameter.</div>
</div>
</div>
</section>
</li>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isChoice()">isChoice</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isDecisionOrMergeNode()">isDecisionOrMergeNode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isJunction()">isJunction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<li>
<section class="detail" id="INNER_POLYGON_GAP">
<h3>INNER_POLYGON_GAP</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">INNER_POLYGON_GAP</span></div>
<div class="block">Distance from outer to inner polygon</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.DecisionView.INNER_POLYGON_GAP">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>DecisionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DecisionView</span>()</div>
<div class="block">Creates a new decision view.</div>
</section>
</li>
<li>
...
<h3>DecisionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DecisionView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</span></div>
<div class="block">Creates and initializes a new decision view from specified parameter.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>parent</code> - this decision view parent object.</dd>
</dl>
</section>
</li>
</ul>
...
<li>
<section class="detail" id="isDecisionOrMergeNode()">
<h3>isDecisionOrMergeNode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isDecisionOrMergeNode</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isJunction()">
<h3>isJunction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isJunction</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isChoice()">
<h3>isChoice</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isChoice</span>()</div>
</section>
</li>
<li>
