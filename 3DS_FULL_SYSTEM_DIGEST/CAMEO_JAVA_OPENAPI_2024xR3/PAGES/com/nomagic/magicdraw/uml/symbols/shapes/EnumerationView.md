# JAVA OPENAPI: EnumerationView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/EnumerationView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/EnumerationView.html`
- source_sha256: `8a8aab2daf10f864bcb4849ce536d53f424643f6773e932ad27ae17f798143f0`
- captured_utc: `2026-07-14T16:56:02.621537+00:00`
...
@OpenApipublic classEnumerationView
extends [ClassifierView](ClassifierView.html)
...
Constructor
Description
`[EnumerationView](#%3Cinit%3E())()`

`[EnumerationView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[getEnumerationLiteralsConstraintsTextMode](#getEnumerationLiteralsConstraintsTextMode())()`
...
`[getLiteralsColor](#getLiteralsColor())()`

`[Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html)`
`[getLiteralsFont](#getLiteralsFont())()`

`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)`
`[getLiteralsSortMode](#getLiteralsSortMode())()`
...
`boolean`
`[isShowEnumerationLiteralsConstraints](#isShowEnumerationLiteralsConstraints())()`

`boolean`
`[isShowEnumerationLiteralsStereotype](#isShowEnumerationLiteralsStereotype())()`

`boolean`
`[isShowEnumerationLiteralsTaggedValues](#isShowEnumerationLiteralsTaggedValues())()`

`boolean`
`[isShowInheritedLiteralsSign](#isShowInheritedLiteralsSign())()`

`boolean`
`[isShowLiteralsMoreSign](#isShowLiteralsMoreSign())()`

`void`
`[setEnumerationLiteralsConstraintsTextMode](#setEnumerationLiteralsConstraintsTextMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`

`void`
`[setLiteralsColor](#setLiteralsColor(java.awt.Color))([Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) color)`

`void`
`[setLiteralsFont](#setLiteralsFont(java.awt.Font))([Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html) font)`

`protected void`
`[setLiteralsSortMode](#setLiteralsSortMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) sm)`

`void`
`[setShowEnumerationLiteralsConstraints](#setShowEnumerationLiteralsConstraints(boolean))(boolean show)`

`void`
`[setShowEnumerationLiteralsStereotype](#setShowEnumerationLiteralsStereotype(boolean))(boolean show)`

`void`
`[setShowEnumerationLiteralsTaggedValues](#setShowEnumerationLiteralsTaggedValues(boolean))(boolean show)`

`void`
`[setShowInheritedLiteralsSign](#setShowInheritedLiteralsSign(boolean))(boolean showInheritedSign)`
Show inherited literals sign
`void`
`[setShowLiteralsMoreSign](#setShowLiteralsMoreSign(boolean))(boolean showMoreSign)`
Show literals more sign.
`void`
`[sSetEnumerationLiteralsConstraintsTextMode](#sSetEnumerationLiteralsConstraintsTextMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`

`void`
`[sSetLiteralsColor](#sSetLiteralsColor(java.awt.Color))([Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) color)`

`void`
`[sSetLiteralsFont](#sSetLiteralsFont(java.awt.Font))([Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html) font)`

`void`
`[sSetLiteralsSortMode](#sSetLiteralsSortMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) sm)`

`void`
`[sSetShowEnumerationLiteralsConstraints](#sSetShowEnumerationLiteralsConstraints(boolean))(boolean show)`

`void`
`[sSetShowEnumerationLiteralsStereotype](#sSetShowEnumerationLiteralsStereotype(boolean))(boolean show)`

`void`
`[sSetShowEnumerationLiteralsTaggedValues](#sSetShowEnumerationLiteralsTaggedValues(boolean))(boolean show)`

`void`
`[sSetShowInheritedLiteralsSign](#sSetShowInheritedLiteralsSign(boolean))(boolean showInheritedSign)`
Show inherited sign for literals
`void`
`[sSetShowLiteralsMoreSign](#sSetShowLiteralsMoreSign(boolean))(boolean showMoreSign)`
...
EnumerationView
public EnumerationView(@CheckForNull
...
Overrides:
`[accept](ClassifierView.html#accept(com.nomagic.magicdraw.uml.Visitor))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
`visitor` - which visits this element.
Throws:
`[Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)`
getLiteralsColor
public [Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) getLiteralsColor()
getLiteralsFont
public [Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html) getLiteralsFont()
sSetLiteralsColor
public void sSetLiteralsColor([Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) color)
setLiteralsColor
public void setLiteralsColor([Color](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html) color)
sSetLiteralsFont
public void sSetLiteralsFont([Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html) font)
setLiteralsFont
public void setLiteralsFont([Font](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html) font)
internalSilentApply
public void internalSilentApply()
Description copied from class: `[PresentationElement](../PresentationElement.html#internalSilentApply())`
Silently applies all properties after initialization
Overrides:
`[internalSilentApply](ClassifierView.html#internalSilentApply())` in class `[ClassifierView](ClassifierView.html)`
...
Applies properties from given property manager
Overrides:
`[internalApplyProperties](ClassifierView.html#internalApplyProperties(com.dassault_systemes.modeler.magic.diagram.styledelegates.PresentationElementStyleChanger))` in class `[ClassifierView](ClassifierView.html)`
Parameters:
...
public void sSetEnumerationLiteralsConstraintsTextMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
setEnumerationLiteralsConstraintsTextMode
public void setEnumerationLiteralsConstraintsTextMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
getEnumerationLiteralsConstraintsTextMode
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getEnumerationLiteralsConstraintsTextMode()
...
Overrides:
`[createSmartListenerConfig](ClassifierView.html#createSmartListenerConfig(java.util.List))` in class `[ClassifierView](ClassifierView.html)`
sSetLiteralsSortMode
public void sSetLiteralsSortMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) sm)
setLiteralsSortMode
protected void setLiteralsSortMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) sm)
getLiteralsSortMode
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getLiteralsSortMode()
...
`showMoreSign` - show.
getElement
public [Enumeration](../../../../uml2/ext/magicdraw/classes/mdkernel/Enumeration.html) getElement()
...
Overrides:
`[getElement](ClassifierView.html#getElement())` in class `[ClassifierView](ClassifierView.html)`
Returns:
model element of this presentation element.
getHeaderView
public com.nomagic.magicdraw.uml.symbols.shapes.EnumerationHeaderView getHeaderView()
Overrides:
`[getHeaderView](ClassifierView.html#getHeaderView())` in class `[ClassifierView](ClassifierView.html)`
...
<h1 class="title" title="Class EnumerationView">Class EnumerationView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.EnumerationView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">EnumerationView</span>
<span class="extends-implements">extends <a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></span></div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">EnumerationView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">EnumerationView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEnumerationLiteralsConstraintsTextMode()">getEnumerationLiteralsConstraintsTextMode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.EnumerationHeaderView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getHeaderView()">getHeaderView</a>()</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLiteralsColor()">getLiteralsColor</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLiteralsFont()">getLiteralsFont</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLiteralsSortMode()">getLiteralsSortMode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowEnumerationLiteralsConstraints()">isShowEnumerationLiteralsConstraints</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowEnumerationLiteralsStereotype()">isShowEnumerationLiteralsStereotype</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowEnumerationLiteralsTaggedValues()">isShowEnumerationLiteralsTaggedValues</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowInheritedLiteralsSign()">isShowInheritedLiteralsSign</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowLiteralsMoreSign()">isShowLiteralsMoreSign</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setEnumerationLiteralsConstraintsTextMode(java.lang.String)">setEnumerationLiteralsConstraintsTextMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setLiteralsColor(java.awt.Color)">setLiteralsColor</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> color)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setLiteralsFont(java.awt.Font)">setLiteralsFont</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a> font)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setLiteralsSortMode(java.lang.String)">setLiteralsSortMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> sm)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowEnumerationLiteralsConstraints(boolean)">setShowEnumerationLiteralsConstraints</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowEnumerationLiteralsStereotype(boolean)">setShowEnumerationLiteralsStereotype</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowEnumerationLiteralsTaggedValues(boolean)">setShowEnumerationLiteralsTaggedValues</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowInheritedLiteralsSign(boolean)">setShowInheritedLiteralsSign</a><wbr/>(boolean showInheritedSign)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited literals sign</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowLiteralsMoreSign(boolean)">setShowLiteralsMoreSign</a><wbr/>(boolean showMoreSign)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show literals more sign.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetEnumerationLiteralsConstraintsTextMode(java.lang.String)">sSetEnumerationLiteralsConstraintsTextMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetLiteralsColor(java.awt.Color)">sSetLiteralsColor</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> color)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetLiteralsFont(java.awt.Font)">sSetLiteralsFont</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a> font)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetLiteralsSortMode(java.lang.String)">sSetLiteralsSortMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> sm)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowEnumerationLiteralsConstraints(boolean)">sSetShowEnumerationLiteralsConstraints</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowEnumerationLiteralsStereotype(boolean)">sSetShowEnumerationLiteralsStereotype</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowEnumerationLiteralsTaggedValues(boolean)">sSetShowEnumerationLiteralsTaggedValues</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowInheritedLiteralsSign(boolean)">sSetShowInheritedLiteralsSign</a><wbr/>(boolean showInheritedSign)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited sign for literals</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowLiteralsMoreSign(boolean)">sSetShowLiteralsMoreSign</a><wbr/>(boolean showMoreSign)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show more sign for literals.</div>
</div>
</div>
</div>
</div>
...
<h3>EnumerationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">EnumerationView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>EnumerationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">EnumerationView</span><wbr/><span class="parameters">(@CheckForNull
...
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#accept(com.nomagic.magicdraw.uml.Visitor)">accept</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="getLiteralsColor()">
<h3>getLiteralsColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a></span> <span class="element-name">getLiteralsColor</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getLiteralsFont()">
<h3>getLiteralsFont</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a></span> <span class="element-name">getLiteralsFont</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetLiteralsColor(java.awt.Color)">
<h3>sSetLiteralsColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetLiteralsColor</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> color)</span></div>
</section>
</li>
<li>
<section class="detail" id="setLiteralsColor(java.awt.Color)">
<h3>setLiteralsColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setLiteralsColor</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a> color)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetLiteralsFont(java.awt.Font)">
<h3>sSetLiteralsFont</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetLiteralsFont</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a> font)</span></div>
</section>
</li>
<li>
<section class="detail" id="setLiteralsFont(java.awt.Font)">
<h3>setLiteralsFont</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setLiteralsFont</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Font.html" title="class or interface in java.awt">Font</a> font)</span></div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#internalSilentApply()">internalSilentApply</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#internalApplyProperties(com.dassault_systemes.modeler.magic.diagram.styledelegates.PresentationElementStyleChanger)">internalApplyProperties</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="sSetShowEnumerationLiteralsStereotype(boolean)">
<h3>sSetShowEnumerationLiteralsStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowEnumerationLiteralsStereotype</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowEnumerationLiteralsStereotype(boolean)">
<h3>setShowEnumerationLiteralsStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowEnumerationLiteralsStereotype</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="isShowEnumerationLiteralsStereotype()">
<h3>isShowEnumerationLiteralsStereotype</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowEnumerationLiteralsStereotype</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowEnumerationLiteralsTaggedValues()">
<h3>isShowEnumerationLiteralsTaggedValues</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowEnumerationLiteralsTaggedValues</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowEnumerationLiteralsTaggedValues(boolean)">
<h3>sSetShowEnumerationLiteralsTaggedValues</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowEnumerationLiteralsTaggedValues</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowEnumerationLiteralsTaggedValues(boolean)">
<h3>setShowEnumerationLiteralsTaggedValues</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowEnumerationLiteralsTaggedValues</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowEnumerationLiteralsConstraints(boolean)">
<h3>sSetShowEnumerationLiteralsConstraints</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowEnumerationLiteralsConstraints</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowEnumerationLiteralsConstraints(boolean)">
<h3>setShowEnumerationLiteralsConstraints</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowEnumerationLiteralsConstraints</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="isShowEnumerationLiteralsConstraints()">
<h3>isShowEnumerationLiteralsConstraints</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowEnumerationLiteralsConstraints</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetEnumerationLiteralsConstraintsTextMode(java.lang.String)">
<h3>sSetEnumerationLiteralsConstraintsTextMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetEnumerationLiteralsConstraintsTextMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
</section>
</li>
<li>
<section class="detail" id="setEnumerationLiteralsConstraintsTextMode(java.lang.String)">
<h3>setEnumerationLiteralsConstraintsTextMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setEnumerationLiteralsConstraintsTextMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
</section>
</li>
<li>
<section class="detail" id="getEnumerationLiteralsConstraintsTextMode()">
<h3>getEnumerationLiteralsConstraintsTextMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getEnumerationLiteralsConstraintsTextMode</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#createSmartListenerConfig(java.util.List)">createSmartListenerConfig</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetLiteralsSortMode(java.lang.String)">
<h3>sSetLiteralsSortMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetLiteralsSortMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> sm)</span></div>
</section>
</li>
<li>
<section class="detail" id="setLiteralsSortMode(java.lang.String)">
<h3>setLiteralsSortMode</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">setLiteralsSortMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> sm)</span></div>
</section>
</li>
<li>
<section class="detail" id="getLiteralsSortMode()">
<h3>getLiteralsSortMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getLiteralsSortMode</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowInheritedLiteralsSign()">
<h3>isShowInheritedLiteralsSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowInheritedLiteralsSign</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if inherited sign is shown for literals</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowInheritedLiteralsSign(boolean)">
<h3>sSetShowInheritedLiteralsSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowInheritedLiteralsSign</span><wbr/><span class="parameters">(boolean showInheritedSign)</span></div>
<div class="block">Show inherited sign for literals</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="setShowInheritedLiteralsSign(boolean)">
<h3>setShowInheritedLiteralsSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowInheritedLiteralsSign</span><wbr/><span class="parameters">(boolean showInheritedSign)</span></div>
<div class="block">Show inherited literals sign</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showInheritedSign</code> - show</dd>
...
<li>
<section class="detail" id="isShowLiteralsMoreSign()">
<h3>isShowLiteralsMoreSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowLiteralsMoreSign</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if more sign is shown for literals.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowLiteralsMoreSign(boolean)">
<h3>sSetShowLiteralsMoreSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowLiteralsMoreSign</span><wbr/><span class="parameters">(boolean showMoreSign)</span></div>
<div class="block">Show more sign for literals.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showMoreSign</code> - show.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setShowLiteralsMoreSign(boolean)">
<h3>setShowLiteralsMoreSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowLiteralsMoreSign</span><wbr/><span class="parameters">(boolean showMoreSign)</span></div>
<div class="block">Show literals more sign.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showMoreSign</code> - show.</dd>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a></span> <span class="element-name">getElement</span>()</div>
...
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#getElement()">getElement</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
<dt>Returns:</dt>
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.EnumerationHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ClassifierView.html#getHeaderView()">getHeaderView</a></code> in class <code><a href="ClassifierView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ClassifierView</a></code></dd>
</dl>
</section>
</li>
</ul>
