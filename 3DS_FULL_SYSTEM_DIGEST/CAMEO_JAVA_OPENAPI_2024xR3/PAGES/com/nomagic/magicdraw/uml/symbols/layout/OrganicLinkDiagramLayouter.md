# JAVA OPENAPI: OrganicLinkDiagramLayouter (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/layout/OrganicLinkDiagramLayouter.html
- source_path: `com/nomagic/magicdraw/uml/symbols/layout/OrganicLinkDiagramLayouter.html`
- source_sha256: `8b230fa3879b87c1b2b677fa9242fadcbdd684b7243e579933449bdc15b80fe6`
- captured_utc: `2026-07-14T16:55:58.113491+00:00`
...
## Class OrganicLinkDiagramLayouter
...
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public classOrganicLinkDiagramLayouter
...
Constructor
Description
`[OrganicLinkDiagramLayouter](#%3Cinit%3E())()`
Deprecated.
...
`static void`
`[removeBends](#removeBends(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,int))([BaseGraph](BaseGraph.html) graph,
 int max)`
Deprecated.
...
@OpenApipublic OrganicLinkDiagramLayouter()
Deprecated.
Construct OrganicLinkDiagramLayouter
 ============ METHOD DETAIL ========== 
Method Details
...
removeBends
public static void removeBends([BaseGraph](BaseGraph.html) graph,
 int max)
Deprecated.
Remove bends from graph.
Parameters:
...
<h1 class="title" title="Class OrganicLinkDiagramLayouter">Class OrganicLinkDiagramLayouter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.layout.OrganicLinkDiagramLayouter</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">OrganicLinkDiagramLayouter</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">OrganicLinkDiagramLayouter</a>()</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block">Construct OrganicLinkDiagramLayouter</div>
</div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#removeBends(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,int)">removeBends</a><wbr/>(<a href="BaseGraph.html" title="class in com.nomagic.magicdraw.uml.symbols.layout">BaseGraph</a> graph,
 int max)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4 method-summary-table-tab6">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block">Remove bends from graph.</div>
</div>
</div>
</div>
</div>
...
<code><a href="AbstractLinkDiagramLayouter.html#clearOldRectangles(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph)">clearOldRectangles</a>, <a href="AbstractLinkDiagramLayouter.html#containsSelectedFromTheSameParent(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement)">containsSelectedFromTheSameParent</a>, <a href="AbstractLinkDiagramLayouter.html#createGraph(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup)">createGraph</a>, <a href="AbstractLinkDiagramLayouter.html#getConnectedPaths(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement)">getConnectedPaths</a>, <a href="AbstractLinkDiagramLayouter.html#getSelected(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement)">getSelected</a>, <a href="AbstractLinkDiagramLayouter.html#placeLegendAndInfo(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.nomagic.magicdraw.uml.symbols.layout.BaseGraph)">placeLegendAndInfo</a>, <a href="AbstractLinkDiagramLayouter.html#postprocessing(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.dassault_systemes.modeler.foundation.editing.CompositeCommand)">postprocessing</a>, <a href="AbstractLinkDiagramLayouter.html#resizeOuterBoundaryIfNecessary(com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.dassault_systemes.modeler.foundation.editing.CompositeCommand)">resizeOuterBoundaryIfNecessary</a></code></div>
<div class="inherited-list">
...
<h3>OrganicLinkDiagramLayouter</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">OrganicLinkDiagramLayouter</span>()</div>
...
<li>
<section class="detail" id="removeBends(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,int)">
<h3>removeBends</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">void</span> <span class="element-name">removeBends</span><wbr/><span class="parameters">(<a href="BaseGraph.html" title="class in com.nomagic.magicdraw.uml.symbols.layout">BaseGraph</a> graph,
 int max)</span></div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
<div class="block">Remove bends from graph.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>graph</code> - The given graph.</dd>
