# JAVA OPENAPI: DurationConstraintView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/DurationConstraintView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/DurationConstraintView.html`
- source_sha256: `c702bf41a7b132abbc85f47e818f1ef63533817212a881b89d2e87374aaaaabc`
- captured_utc: `2026-07-14T16:56:00.372513+00:00`
...
@OpenApipublic classDurationConstraintView
...
Constructor
Description
`[DurationConstraintView](#%3Cinit%3E())()`

`[DurationConstraintView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[draw](#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List))([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) pt1,
 [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) pt2,
...
`[DurationConstraint](../../../../uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationConstraint.html)`
...
`[getEndPoint](#getEndPoint(boolean))(boolean forSupplier)`
Returns client or supplier point of the end element
`[Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html)`
`[getMessageIntersectionPoint](#getMessageIntersectionPoint(com.nomagic.magicdraw.uml.symbols.PresentationElement,int))([PresentationElement](../PresentationElement.html) end,
 int x)`
...
`static boolean`
`[isNoStateSet](#isNoStateSet(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) pe)`

`void`
`[pathMovedBy](#pathMovedBy(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) end)`
...
Description copied from class: `[PathElement](PathElement.html#getDefaultParentForData())`
Presentation element could suggest parent, which would be more acceptable, than adding to the client
 If returning null, general mechanism will work
Overrides:
`[getDefaultParentForData](PathElement.html#getDefaultParentForData())` in class `[PathElement](PathElement.html)`
Returns:
parent for data
canBeDeleted
...
isNoStateSet
public static boolean isNoStateSet([PresentationElement](../PresentationElement.html) pe)
draw
public void draw([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) pt1,
 [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) pt2,
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html)> breakPoints)
Description copied from class: `[PathElement](PathElement.html#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List))`
Draws link from given point pt1 through break points
 to given point pt2.
Overrides:
`[draw](PathElement.html#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List))` in class `[PathElement](PathElement.html)`
Parameters:
`g` - graphics
`pt1` - first point
`pt2` - second point
...
pathMovedBy
public void pathMovedBy([PresentationElement](../PresentationElement.html) end)
getEndPoint
public [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) getEndPoint(boolean forSupplier)
Returns client or supplier point of the end element
Parameters:
...
public [Point](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html) getMessageIntersectionPoint([PresentationElement](../PresentationElement.html) end,
 int x)
Returns point, where message link intersects straight line described by x
Parameters:
`end` - end
...
Description copied from class: `[PathElement](PathElement.html#getMiddlePoint())`
Calculates and returns middle point of link.
 For this link it is average between supplier's and client's points.
Overrides:
`[getMiddlePoint](PathElement.html#getMiddlePoint())` in class `[PathElement](PathElement.html)`
Returns:
middle point.
getElement
public [DurationConstraint](../../../../uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationConstraint.html) getElement()
...
Overrides:
`[canChangeLineStyle](PathElement.html#canChangeLineStyle())` in class `[PathElement](PathElement.html)`
Returns:
true if this link can change line style.
canClearBreakPoints
public boolean canClearBreakPoints()
Overrides:
`[canClearBreakPoints](PathElement.html#canClearBreakPoints())` in class `[PathElement](PathElement.html)`
Returns:
...
<h1 class="title" title="Class DurationConstraintView">Class DurationConstraintView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.DurationConstraintView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DurationConstraintView</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">DurationConstraintView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">DurationConstraintView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#canChangeLineStyle()">canChangeLineStyle</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List)">draw</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a> pt1,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a> pt2,
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultParentForData()">getDefaultParentForData</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationConstraint</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEndPoint(boolean)">getEndPoint</a><wbr/>(boolean forSupplier)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns client or supplier point of the end element</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getMessageIntersectionPoint(com.nomagic.magicdraw.uml.symbols.PresentationElement,int)">getMessageIntersectionPoint</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> end,
 int x)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns point, where message link intersects straight line described by x</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isNoStateSet(com.nomagic.magicdraw.uml.symbols.PresentationElement)">isNoStateSet</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> pe)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#pathMovedBy(com.nomagic.magicdraw.uml.symbols.PresentationElement)">pathMovedBy</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> end)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resetToDefaultPosition()">resetToDefaultPosition</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Reset constraint view to the default position</div>
</div>
</div>
</div>
</div>
...
<h3>DurationConstraintView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DurationConstraintView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>DurationConstraintView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DurationConstraintView</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#getDefaultParentForData()">PathElement</a></code></span></div>
<div class="block">Presentation element could suggest parent, which would be more acceptable, than adding to the client
 If returning null, general mechanism will work</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#getDefaultParentForData()">getDefaultParentForData</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="isNoStateSet(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>isNoStateSet</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">boolean</span> <span class="element-name">isNoStateSet</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> pe)</span></div>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List)">PathElement</a></code></span></div>
<div class="block">Draws link from given point pt1 through break points
 to given point pt2.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#draw(java.awt.Graphics2D,java.awt.Point,java.awt.Point,java.util.List)">draw</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Parameters:</dt>
<dd><code>g</code> - graphics</dd>
<dd><code>pt1</code> - first point</dd>
<dd><code>pt2</code> - second point</dd>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>internalUpdatePresentationElement</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
...
<li>
<section class="detail" id="pathMovedBy(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>pathMovedBy</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">pathMovedBy</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> end)</span></div>
</section>
</li>
<li>
<section class="detail" id="getEndPoint(boolean)">
<h3>getEndPoint</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></span> <span class="element-name">getEndPoint</span><wbr/><span class="parameters">(boolean forSupplier)</span></div>
<div class="block">Returns client or supplier point of the end element</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>forSupplier</code> - true if point is calculated for supplier end of this link</dd>
<dt>Returns:</dt>
<dd>nearest end</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getMessageIntersectionPoint(com.nomagic.magicdraw.uml.symbols.PresentationElement,int)">
<h3>getMessageIntersectionPoint</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></span> <span class="element-name">getMessageIntersectionPoint</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> end,
 int x)</span></div>
<div class="block">Returns point, where message link intersects straight line described by x</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>end</code> - end</dd>
<dd><code>x</code> - coordinate</dd>
<dt>Returns:</dt>
<dd>point</dd>
</dl>
</section>
...
<li>
<section class="detail" id="resetToDefaultPosition()">
<h3>resetToDefaultPosition</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">resetToDefaultPosition</span>()</div>
<div class="block">Reset constraint view to the default position</div>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#getMiddlePoint()">PathElement</a></code></span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#getMiddlePoint()">getMiddlePoint</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
<dd>middle point.</dd>
</dl>
</section>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#canChangeLineStyle()">canChangeLineStyle</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#canClearBreakPoints()">canClearBreakPoints</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
