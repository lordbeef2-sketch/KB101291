# JAVA OPENAPI: ConnectorView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/ConnectorView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/ConnectorView.html`
- source_sha256: `95580f655c81e2115404620bed8cfc80f47bc0bc0c2d298c57372b5cedcf4240`
- captured_utc: `2026-07-14T16:55:59.589508+00:00`
...
`[BaseElement](../../BaseElement.html)`, `com.nomagic.magicdraw.uml.CompartmentSupport`, `[MDElement](../../MDElement.html)`, `[ModelElementProvider](../../ModelElementProvider.html)`, `com.nomagic.magicdraw.uml.symbols.LabelOwner`, `com.nomagic.magicdraw.uml.symbols.LineJumpDrawer`, `com.nomagic.magicdraw.uml.symbols.paths.PathWithEnds<com.nomagic.magicdraw.uml.symbols.shapes.LinkEndView>`, `com.nomagic.magicdraw.uml.symbols.PropertyBasedPresentationElement`, `[StereotypesDisplayModeOwner](../shapes/StereotypesDisplayModeOwner.html)`, `com.nomagic.magicdraw.uml.symbols.SuspendShapeAutoResizeModeProvider`, `[NameOwner](../../../utils/NameOwner.html)`, `[PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[EventListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/EventListener.html)`

Direct Known Subclasses:
`[ConnectorToSelfView](ConnectorToSelfView.html)`

@OpenApipublic classConnectorView
...
Constructor
Description
`[ConnectorView](#%3Cinit%3E())()`

`[ConnectorView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[Connector](../../../../uml2/ext/magicdraw/compositestructures/mdinternalstructures/Connector.html)`
`[getElement](#getElement())()`
Returns model element of this presentation element.
`protected [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getModelElementForClientEndShape](#getModelElementForClientEndShape())()`

`protected [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getModelElementForSupplierEndShape](#getModelElementForSupplierEndShape())()`

`static [Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)`
`[getPartWithPortForView](#getPartWithPortForView(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.paths.ConnectorView))([PresentationElement](../PresentationElement.html) view,
 [ConnectorView](ConnectorView.html) connectorView)`
...
`boolean`
`[isShowConnectorEndA](#isShowConnectorEndA())()`

`boolean`
`[isShowConnectorEndB](#isShowConnectorEndB())()`
...
`void`
`[setShowConnectorEndA](#setShowConnectorEndA(boolean))(boolean show)`

`void`
`[setShowConnectorEndB](#setShowConnectorEndB(boolean))(boolean show)`
...
`void`
`[setSupplier](#setSupplier(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) obj)`
Sets supplier end for link.
`void`
`[sSetShowConnectorEndA](#sSetShowConnectorEndA(boolean))(boolean show)`

`void`
`[sSetShowConnectorEndB](#sSetShowConnectorEndB(boolean))(boolean show)`

`void`
`[sSetShowInheritedSign](#sSetShowInheritedSign(boolean))(boolean showInheritedSign)`
Show inherited sign
`void`
`[sSetShowType](#sSetShowType(boolean))(boolean showType)`

`void`
`[updateNameBox](#updateNameBox())()`

`void`
`[updatePartWithPortForConnectorEnds](#updatePartWithPortForConnectorEnds())()`
...
ConnectorView
public ConnectorView(@CheckForNull
...
getElement
public [Connector](../../../../uml2/ext/magicdraw/compositestructures/mdinternalstructures/Connector.html) getElement()
...
protected [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getModelElementForSupplierEndShape()
Specified by:
...
protected [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getModelElementForClientEndShape()
Specified by:
`getModelElementForClientEndShape` in class `com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView`
getType
public [Association](../../../../uml2/ext/magicdraw/classes/mdkernel/Association.html) getType()
setClient
...
`obj` - shape to check
setSupplier
public void setSupplier([PresentationElement](../PresentationElement.html) obj)
...
@CheckForNullpublic static [Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getPartWithPortForView([PresentationElement](../PresentationElement.html) view,
 [ConnectorView](ConnectorView.html) connectorView)
Calculate partWithPort property value
Parameters:
...
<h1 class="title" title="Class ConnectorView">Class ConnectorView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.ConnectorView</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="ConnectorToSelfView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">ConnectorToSelfView</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ConnectorView</span>
<span class="extends-implements">extends com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</span></div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ConnectorView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ConnectorView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#constructNameTextToDisplay()">constructNameTextToDisplay</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createEndBoxes()">createEndBoxes</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getModelElementForClientEndShape()">getModelElementForClientEndShape</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getModelElementForSupplierEndShape()">getModelElementForSupplierEndShape</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getPartWithPortForView(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.paths.ConnectorView)">getPartWithPortForView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view,
 <a href="ConnectorView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">ConnectorView</a> connectorView)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Calculate partWithPort property value</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Association.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Association</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowConnectorEndA()">isShowConnectorEndA</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowConnectorEndB()">isShowConnectorEndB</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowConnectorEndA(boolean)">setShowConnectorEndA</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowConnectorEndB(boolean)">setShowConnectorEndB</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowConnectorEndA(boolean)">sSetShowConnectorEndA</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowConnectorEndB(boolean)">sSetShowConnectorEndB</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowType(boolean)">sSetShowType</a><wbr/>(boolean showType)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updateNameBox()">updateNameBox</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#updatePartWithPortForConnectorEnds()">updatePartWithPortForConnectorEnds</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Updates partWithPort property for both connector ends.</div>
</div>
</div>
</div>
</div>
...
<h3>ConnectorView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ConnectorView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ConnectorView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ConnectorView</span><wbr/><span class="parameters">(@CheckForNull
...
<dt>Overrides:</dt>
<dd><code>accept</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
<dt>Parameters:</dt>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/compositestructures/mdinternalstructures/Connector.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdinternalstructures">Connector</a></span> <span class="element-name">getElement</span>()</div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>canAddInstance</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>updateNameBox</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.ContainerLinkView</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>setShowType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowType</span><wbr/><span class="parameters">(boolean showType)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowType(boolean)">
<h3>sSetShowType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowType</span><wbr/><span class="parameters">(boolean showType)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="createEndBoxes()">
<h3>createEndBoxes</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">createEndBoxes</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowConnectorEndA()">
<h3>isShowConnectorEndA</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowConnectorEndA</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowConnectorEndB()">
<h3>isShowConnectorEndB</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowConnectorEndB</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setShowConnectorEndA(boolean)">
<h3>setShowConnectorEndA</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowConnectorEndA</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowConnectorEndB(boolean)">
<h3>setShowConnectorEndB</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowConnectorEndB</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowConnectorEndA(boolean)">
<h3>sSetShowConnectorEndA</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowConnectorEndA</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowConnectorEndB(boolean)">
<h3>sSetShowConnectorEndB</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowConnectorEndB</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getModelElementForSupplierEndShape()">
<h3>getModelElementForSupplierEndShape</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getModelElementForSupplierEndShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getModelElementForSupplierEndShape</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getModelElementForClientEndShape()">
<h3>getModelElementForClientEndShape</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getModelElementForClientEndShape</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getModelElementForClientEndShape</code> in class <code>com.nomagic.magicdraw.uml.symbols.paths.LinkWithEndsView</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>getType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Association.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Association</a></span> <span class="element-name">getType</span>()</div>
</section>
</li>
<li>
...
<h3>setSupplier</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setSupplier</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</span></div>
...
<dt>Parameters:</dt>
<dd><code>obj</code> - new supplier.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="updatePartWithPortForConnectorEnds()">
<h3>updatePartWithPortForConnectorEnds</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">updatePartWithPortForConnectorEnds</span>()</div>
<div class="block">Updates partWithPort property for both connector ends.</div>
</section>
</li>
<li>
<section class="detail" id="getPartWithPortForView(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.paths.ConnectorView)">
<h3>getPartWithPortForView</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getPartWithPortForView</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> view,
 <a href="ConnectorView.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">ConnectorView</a> connectorView)</span></div>
<div class="block">Calculate partWithPort property value</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>view</code> - symbol for which to calculate property value</dd>
<dd><code>connectorView</code> - connector view</dd>
<dt>Returns:</dt>
<dd>Property or null</dd>
</dl>
</section>
</li>
</ul>
