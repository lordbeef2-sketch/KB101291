# JAVA OPENAPI: PartView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/PartView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/PartView.html`
- source_sha256: `9af891af8047a11356d3ade98e55142803d00500c0085dcf7d60f603c41db6a7`
- captured_utc: `2026-07-14T16:56:04.523558+00:00`
...
`[PartView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Description
`void`
`[accept](#accept(com.nomagic.magicdraw.uml.Visitor))([Visitor](../../Visitor.html) o)`
...
`[findPresentationElement](#findPresentationElement(java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.util.List))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[PresentationElement](../PresentationElement.html)> elements,
...
`[getCompartmentElementID](#getCompartmentElementID())()`

`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)`
`[getCompartmentText](#getCompartmentText())()`
...
`[getElementFromParentSymbol](#getElementFromParentSymbol())()`

`[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getElementFromParentSymbol](#getElementFromParentSymbol(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
...
`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)`
`[getMetaClassifiersQPropertyName](#getMetaClassifiersQPropertyName())()`

`com.dassault_systemes.modeler.foundation.model.ModelElement`
`[getModelElementToMove](#getModelElementToMove())()`
Returns element that should be used for during "move" operation.
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)>`
...
`protected boolean`
`[isDrawSeparator](#isDrawSeparator())()`

`boolean`
`[isInOtherPart](#isInOtherPart())()`

`static boolean`
`[isPart](#isPart(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) obj)`

`boolean`
`[isPartPort](#isPartPort())()`

`static boolean`
`[isPartPort](#isPartPort(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) obj)`

`boolean`
`[isShowDefaultValue](#isShowDefaultValue())()`
Returns show default value flag.
`boolean`
`[isShowDefaultValueCompartmentName](#isShowDefaultValueCompartmentName())()`
Indicates if default value compartment name should be displayed.
`boolean`
`[isShowInheritedSign](#isShowInheritedSign())()`
...
`boolean`
`[isShowRakeIcon](#isShowRakeIcon())()`
Indicated if an element should show Rake Icon
`boolean`
`[isShowTaggedValuesStereotypes](#isShowTaggedValuesStereotypes())()`

`boolean`
`[isSuppressStructureCompartment](#isSuppressStructureCompartment())()`

`boolean`
`[isValid](#isValid(com.nomagic.magicdraw.uml.symbols.PresentationElement,boolean))([PresentationElement](../PresentationElement.html) parent,
 boolean changeElementParent)`
...
In dummy resize mode symbol may not resize according it children or move children on bounds
 changed and etc.
`void`
`[setNestedPath](#setNestedPath(java.util.List))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> nestedPath)`
...
`void`
`[setShowDefaultValue](#setShowDefaultValue(boolean))(boolean show)`
Set show default value flag.
`void`
`[setShowDefaultValueCompartmentName](#setShowDefaultValueCompartmentName(boolean))(boolean show)`
...
`void`
`[setShowSlotTypeMode](#setShowSlotTypeMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`
...
Removes given child
`void`
`[sSetClassifiers](#sSetClassifiers(java.util.List))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> type)`
Sets one classifier.
`void`
`[sSetNestedPath](#sSetNestedPath(java.util.List,boolean))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> nestedPart,
 boolean disposeOldListeners)`

`void`
`[sSetShowDefaultValue](#sSetShowDefaultValue(boolean))(boolean show)`
Set show default value flag.
`void`
`[sSetShowDefaultValueCompartmentName](#sSetShowDefaultValueCompartmentName(boolean))(boolean show)`
Simple sets show default value compartment name flag value.
`void`
`[sSetShowInheritedSign](#sSetShowInheritedSign(boolean))(boolean showInheritedSign)`
Show inherited sign
`void`
`[sSetShowMultiplicity](#sSetShowMultiplicity(boolean))(boolean showMultiplicity)`

`void`
`[sSetShowQualifiedNameInTaggedValues](#sSetShowQualifiedNameInTaggedValues(boolean))(boolean show)`

`void`
`[sSetShowSlotTypeMode](#sSetShowSlotTypeMode(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)`
Sets value of slot showing property.
`void`
...
getClassifier
public [Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html) getClassifier()
Specified by:
`getClassifier` in class `com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView`
sSetClassifiers
public void sSetClassifiers([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> type)
...
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getMetaClassifiersQPropertyName()
Specified by:
...
getElement
public [Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getElement()
...
getProperty
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public [Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getProperty()
Deprecated.
use #getElement
accept
public void accept([Visitor](../../Visitor.html) o)
...
Description copied from class: `[PresentationElement](../PresentationElement.html#getModelElementToMove())`
...
Overrides:
`[getModelElementToMove](../PresentationElement.html#getModelElementToMove())` in class `[PresentationElement](../PresentationElement.html)`
Returns:
element to move
See Also:
[`PresentationElement.getElement()`](../PresentationElement.html#getElement())
getCompartmentElementID
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getCompartmentElementID()
Specified by:
`[getCompartmentElementID](../../CompartmentElement.html#getCompartmentElementID())` in interface `[CompartmentElement](../../CompartmentElement.html)`
getCompartmentText
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getCompartmentText()
Specified by:
`[getCompartmentText](../../CompartmentElement.html#getCompartmentText())` in interface `[CompartmentElement](../../CompartmentElement.html)`
...
isValid
public boolean isValid([PresentationElement](../PresentationElement.html) parent,
 boolean changeElementParent)
Checks if part is valid by symbol ownership in it's current context.
Parameters:
...
@CheckForNullpublic [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getElementFromParentSymbol()
getElementFromParentSymbol
@CheckForNullpublic [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getElementFromParentSymbol([PresentationElement](../PresentationElement.html) parent)
isDrawSeparator
...
getShowSlotTypeMode
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getShowSlotTypeMode()
...
public void sSetShowSlotTypeMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
Sets value of slot showing property. Just changes property,
...
`SlotView.SHOW_TYPE_MODE_QUALIFIED_NAME`
setShowSlotTypeMode
public void setShowSlotTypeMode([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mode)
...
Returns show default value flag. Default value can be shown in separate compartment if it is InstanceValue or
 after = sign in signature.
Returns:
flag value
sSetShowDefaultValue
public void sSetShowDefaultValue(boolean show)
Set show default value flag. Default value can be shown in separate compartment if it is InstanceValue or
 after = sign in signature.
Parameters:
`show` - new value
setShowDefaultValue
...
getNestedPath
@CheckForNullpublic [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> getNestedPath()
setNestedPath
public void setNestedPath(@CheckForNull
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> nestedPath)
sSetNestedPath
public void sSetNestedPath(@CheckForNull
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> nestedPart,
 boolean disposeOldListeners)
propertyChange
...
clone
public [PartView](PartView.html) clone()
Specified by:
...
Description copied from class: `[PresentationElement](../PresentationElement.html#setDummyResizeMode(boolean))`
In dummy resize mode symbol may not resize according it children or move children on bounds
...
Description copied from class: `[PresentationElement](../PresentationElement.html#findOwnerForChildElement(com.nomagic.magicdraw.uml.symbols.PresentationElement))`
Returns element owner for given child.
Overrides:
`[findOwnerForChildElement](../PresentationElement.html#findOwnerForChildElement(com.nomagic.magicdraw.uml.symbols.PresentationElement))` in class `[PresentationElement](../PresentationElement.html)`
Returns:
most suitable owner for given child's element
findPresentationElement
@CheckForNullpublic static [PresentationElement](../PresentationElement.html) findPresentationElement([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[PresentationElement](../PresentationElement.html)> elements,
 [Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> nestedPath)
Finds existing symbol among the given ones with a given Element and given nestedPath
...
public static boolean isPart(@CheckForNull
 [PresentationElement](../PresentationElement.html) obj)
Parameters:
`obj` - symbol
Returns:
true if given symbol is pure Part, does not represent Port
isPartPort
public static boolean isPartPort([PresentationElement](../PresentationElement.html) obj)
Parameters:
`obj` - symbol
Returns:
...
protected int getHeaderInsetReduce(int edge,
 com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds bounds)
Overrides:
`[getHeaderInsetReduce](ShapeElement.html#getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds))` in class `[ShapeElement](ShapeElement.html)`
getHeaderView
...
<h1 class="title" title="Class PartView">Class PartView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.PartView</div>
</div>
</div>
</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PartView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PartView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#accept(com.nomagic.magicdraw.uml.Visitor)">accept</a><wbr/>(<a href="../../Visitor.html" title="class in com.nomagic.magicdraw.uml">Visitor</a> o)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="PartView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PartView</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#findPresentationElement(java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.util.List)">findPresentationElement</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a>&gt; elements,
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; nestedPath)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Finds existing symbol among the given ones with a given Element and given nestedPath</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getClassifier()">getClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCompartmentElementID()">getCompartmentElementID</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCompartmentText()">getCompartmentText</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getElementFromParentSymbol()">getElementFromParentSymbol</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getElementFromParentSymbol(com.nomagic.magicdraw.uml.symbols.PresentationElement)">getElementFromParentSymbol</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEncapsulatedClassifier()">getEncapsulatedClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/TypedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">TypedElement</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEncapsulatedClassifierProvider()">getEncapsulatedClassifierProvider</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.PartHeaderView</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getMetaClassifiersQPropertyName()">getMetaClassifiersQPropertyName</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.dassault_systemes.modeler.foundation.model.ModelElement</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getModelElementToMove()">getModelElementToMove</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getNestedPath()">getNestedPath</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#getProperty()">getProperty</a>()</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getShowSlotTypeMode()">getShowSlotTypeMode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets value of slot showing property.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getStructureCompartment()">getStructureCompartment</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#internalGetHeaderInsets()">internalGetHeaderInsets</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isDrawSeparator()">isDrawSeparator</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isInOtherPart()">isInOtherPart</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isPart(com.nomagic.magicdraw.uml.symbols.PresentationElement)">isPart</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isPartPort()">isPartPort</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isPartPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">isPartPort</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowDefaultValue()">isShowDefaultValue</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns show default value flag.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowDefaultValueCompartmentName()">isShowDefaultValueCompartmentName</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if default value compartment name should be displayed.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowInheritedSign()">isShowInheritedSign</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowQualifiedNameInTaggedValues()">isShowQualifiedNameInTaggedValues</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowRakeIcon()">isShowRakeIcon</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicated if an element should show Rake Icon</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isSuppressStructureCompartment()">isSuppressStructureCompartment</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isValid(com.nomagic.magicdraw.uml.symbols.PresentationElement,boolean)">isValid</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 boolean changeElementParent)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Checks if part is valid by symbol ownership in it's current context.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setNestedPath(java.util.List)">setNestedPath</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; nestedPath)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowDefaultValue(boolean)">setShowDefaultValue</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Set show default value flag.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowDefaultValueCompartmentName(boolean)">setShowDefaultValueCompartmentName</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets show default value compartment name flag value.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited members sign in compartment</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowMultiplicity(boolean)">setShowMultiplicity</a><wbr/>(boolean showMultiplicity)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowSlotTypeMode(java.lang.String)">setShowSlotTypeMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of slot showing property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowTaggedValuesStereotypes(boolean)">setShowTaggedValuesStereotypes</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetClassifiers(java.util.List)">sSetClassifiers</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt; type)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets one classifier.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetNestedPath(java.util.List,boolean)">sSetNestedPath</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; nestedPart,
 boolean disposeOldListeners)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowDefaultValue(boolean)">sSetShowDefaultValue</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Set show default value flag.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowDefaultValueCompartmentName(boolean)">sSetShowDefaultValueCompartmentName</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Simple sets show default value compartment name flag value.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowInheritedSign(boolean)">sSetShowInheritedSign</a><wbr/>(boolean showInheritedSign)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited sign</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowMultiplicity(boolean)">sSetShowMultiplicity</a><wbr/>(boolean showMultiplicity)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowQualifiedNameInTaggedValues(boolean)">sSetShowQualifiedNameInTaggedValues</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowSlotTypeMode(java.lang.String)">sSetShowSlotTypeMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of slot showing property.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetTaggedValuesDisplayMode(java.lang.String)">sSetTaggedValuesDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<code>addBreakPoints, checkShowsProxy, doActualShapeDrawing, getClassifiers, getDefaultDimension, getSeparatorDistanceFromRightSide, getStereotypesToDisplay, getTypeClass, isActive, isDrawUnderLine, isShowClass, isShowFullType, movePathElement, selfSpecificHeaderShapeDraw, setDrawUnderLine, setShowClass, setShowFullType, sSetShowClass, sSetShowFullType</code></div>
<div class="inherited-list">
...
<h3>PartView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PartView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>PartView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PartView</span><wbr/><span class="parameters">(@CheckForNull
...
<ul class="member-list">
<li>
<section class="detail" id="getStructureCompartment()">
<h3>getStructureCompartment</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.StructureCompartmentView</span> <span class="element-name">getStructureCompartment</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getClassifier()">
<h3>getClassifier</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a></span> <span class="element-name">getClassifier</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getClassifier</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetClassifiers(java.util.List)">
<h3>sSetClassifiers</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetClassifiers</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt; type)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></span></div>
<div class="block">Sets one classifier.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>sSetClassifiers</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
<dt>Parameters:</dt>
<dd><code>type</code> - a collection of classifiers to set as type of this typed element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getMetaClassifiersQPropertyName()">
<h3>getMetaClassifiersQPropertyName</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getMetaClassifiersQPropertyName</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>getMetaClassifiersQPropertyName</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getElement</span>()</div>
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getProperty</span>()</div>
...
<h3>accept</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">accept</span><wbr/><span class="parameters">(<a href="../../Visitor.html" title="class in com.nomagic.magicdraw.uml">Visitor</a> o)</span>
...
<dt>Overrides:</dt>
<dd><code>accept</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
<dt>Parameters:</dt>
<dd><code>o</code> - which visits this element.</dd>
<dt>Throws:</dt>
...
<li>
<section class="detail" id="isShowRakeIcon()">
<h3>isShowRakeIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowRakeIcon</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></span></div>
<div class="block">Indicated if an element should show Rake Icon</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>isShowRakeIcon</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
<dt>Returns:</dt>
<dd>true in case should show, else false</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#getModelElementToMove()">PresentationElement</a></code></span></div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../PresentationElement.html#getModelElementToMove()">getModelElementToMove</a></code> in class <code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></dd>
<dt>Returns:</dt>
<dd>element to move</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../PresentationElement.html#getElement()"><code>PresentationElement.getElement()</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getCompartmentElementID()">
<h3>getCompartmentElementID</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getCompartmentElementID</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="../../CompartmentElement.html#getCompartmentElementID()">getCompartmentElementID</a></code> in interface <code><a href="../../CompartmentElement.html" title="interface in com.nomagic.magicdraw.uml">CompartmentElement</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getCompartmentText()">
<h3>getCompartmentText</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getCompartmentText</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="../../CompartmentElement.html#getCompartmentText()">getCompartmentText</a></code> in interface <code><a href="../../CompartmentElement.html" title="interface in com.nomagic.magicdraw.uml">CompartmentElement</a></code></dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isValid(com.nomagic.magicdraw.uml.symbols.PresentationElement,boolean)">
<h3>isValid</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isValid</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 boolean changeElementParent)</span></div>
<div class="block">Checks if part is valid by symbol ownership in it's current context.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>parent</code> - the owner of part</dd>
<dd><code>changeElementParent</code> - check if valid for a move operation</dd>
<dt>Returns:</dt>
<dd>true if part ownership is valid</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getElementFromParentSymbol()">
<h3>getElementFromParentSymbol</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getElementFromParentSymbol</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getElementFromParentSymbol(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>getElementFromParentSymbol</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getElementFromParentSymbol</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</span></div>
</section>
</li>
<li>
<section class="detail" id="isDrawSeparator()">
<h3>isDrawSeparator</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">boolean</span> <span class="element-name">isDrawSeparator</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>isDrawSeparator</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getShowSlotTypeMode()">
<h3>getShowSlotTypeMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getShowSlotTypeMode</span>()</div>
<div class="block">Gets value of slot showing property. Default is NONE</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>mode</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><code>SlotView.SHOW_TYPE_MODE_NONE</code></li>
<li><code>SlotView.SHOW_TYPE_MODE_NAME</code></li>
<li><code>SlotView.SHOW_TYPE_MODE_QUALIFIED_NAME</code></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="sSetShowSlotTypeMode(java.lang.String)">
<h3>sSetShowSlotTypeMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowSlotTypeMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
<div class="block">Sets value of slot showing property. Just changes property,
 but no update is done</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>mode</code> - mode</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><code>SlotView.SHOW_TYPE_MODE_NONE</code></li>
...
<li>
<section class="detail" id="setShowSlotTypeMode(java.lang.String)">
<h3>setShowSlotTypeMode</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowSlotTypeMode</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</span></div>
<div class="block">Sets value of slot showing property. Calls view update</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>mode</code> - mode</dd>
<dt>See Also:</dt>
...
<li>
<section class="detail" id="isShowInheritedSign()">
<h3>isShowInheritedSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowInheritedSign</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if inherited sign is shown</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowInheritedSign(boolean)">
<h3>sSetShowInheritedSign</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowInheritedSign</span><wbr/><span class="parameters">(boolean showInheritedSign)</span></div>
<div class="block">Show inherited sign</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showInheritedSign</code> - show</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowInheritedSign</span><wbr/><span class="parameters">(boolean showInheritedSign)</span></div>
<div class="block">Show inherited members sign in compartment</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showInheritedSign</code> - show</dd>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowMultiplicity</span><wbr/><span class="parameters">(boolean showMultiplicity)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowMultiplicity(boolean)">
<h3>sSetShowMultiplicity</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowMultiplicity</span><wbr/><span class="parameters">(boolean showMultiplicity)</span></div>
</section>
</li>
<li>
<section class="detail" id="isShowDefaultValueCompartmentName()">
<h3>isShowDefaultValueCompartmentName</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowDefaultValueCompartmentName</span>()</div>
<div class="block">Indicates if default value compartment name should be displayed.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if default value compartment name should be displayed, false otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowDefaultValueCompartmentName(boolean)">
<h3>sSetShowDefaultValueCompartmentName</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowDefaultValueCompartmentName</span><wbr/><span class="parameters">(boolean show)</span></div>
<div class="block">Simple sets show default value compartment name flag value.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>show</code> - value to set.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setShowDefaultValueCompartmentName(boolean)">
<h3>setShowDefaultValueCompartmentName</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowDefaultValueCompartmentName</span><wbr/><span class="parameters">(boolean show)</span></div>
<div class="block">Sets show default value compartment name flag value.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>show</code> - value to set.</dd>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>internalApplyProperties</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
<dt>Parameters:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>internalSilentApply</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isSuppressStructureCompartment()">
<h3>isSuppressStructureCompartment</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isSuppressStructureCompartment</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isShowDefaultValue()">
<h3>isShowDefaultValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowDefaultValue</span>()</div>
<div class="block">Returns show default value flag. Default value can be shown in separate compartment if it is InstanceValue or
 after = sign in signature.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>flag value</dd>
</dl>
...
<li>
<section class="detail" id="sSetShowDefaultValue(boolean)">
<h3>sSetShowDefaultValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowDefaultValue</span><wbr/><span class="parameters">(boolean show)</span></div>
<div class="block">Set show default value flag. Default value can be shown in separate compartment if it is InstanceValue or
 after = sign in signature.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>show</code> - new value</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setShowDefaultValue(boolean)">
<h3>setShowDefaultValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowDefaultValue</span><wbr/><span class="parameters">(boolean show)</span></div>
<div class="block">Set show default value flag. Default value can be shown in separate compartment if it is InstanceValue or
 after = sign in signature.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="isInOtherPart()">
<h3>isInOtherPart</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isInOtherPart</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getNestedPath()">
<h3>getNestedPath</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt;</span> <span class="element-name">getNestedPath</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setNestedPath(java.util.List)">
<h3>setNestedPath</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setNestedPath</span><wbr/><span class="parameters">(@CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; nestedPath)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetNestedPath(java.util.List,boolean)">
<h3>sSetNestedPath</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetNestedPath</span><wbr/><span class="parameters">(@CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; nestedPart,
 boolean disposeOldListeners)</span></div>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code>propertyChange</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.HeaderShapeView</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="PartView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">PartView</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#setDummyResizeMode(boolean)">PresentationElement</a></code></span></div>
<div class="block">In dummy resize mode symbol may not resize according it children or move children on bounds
 changed and etc. This is more as hack for resize problems during load or diagram layout</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>setDummyResizeMode</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.ContainerShapeView</code></dd>
<dt>Parameters:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>canChangeParent</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.BaseHeaderShapeView</code></dd>
<dt>Parameters:</dt>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#findOwnerForChildElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PresentationElement</a></code></span></div>
<div class="block">Returns element owner for given child.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../PresentationElement.html#findOwnerForChildElement(com.nomagic.magicdraw.uml.symbols.PresentationElement)">findOwnerForChildElement</a></code> in class <code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="findPresentationElement(java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.util.List)">
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>elements</code> - symbols</dd>
<dd><code>element</code> - element</dd>
<dd><code>nestedPath</code> - nested path of the Part</dd>
<dt>Returns:</dt>
<dd>found presentation element or null</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isPartPort()">
<h3>isPartPort</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isPartPort</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if PartView represents Port.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isPart(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>isPart</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">boolean</span> <span class="element-name">isPart</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>obj</code> - symbol</dd>
<dt>Returns:</dt>
<dd>true if given symbol is pure Part, does not represent Port</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isPartPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>isPartPort</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">boolean</span> <span class="element-name">isPartPort</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> obj)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>obj</code> - symbol</dd>
<dt>Returns:</dt>
<dd>true if given symbol is Part, but it represents Port</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ShapeElement.html#getHeaderInsetReduce(int,com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement.OnEdgeBounds)">getHeaderInsetReduce</a></code> in class <code><a href="ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a></code></dd>
</dl>
</section>
</li>
<li>
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.PartHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>getHeaderView</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
</ul>
