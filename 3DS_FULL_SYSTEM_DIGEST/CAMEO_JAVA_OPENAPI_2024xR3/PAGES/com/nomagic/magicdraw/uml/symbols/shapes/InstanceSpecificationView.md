# JAVA OPENAPI: InstanceSpecificationView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/InstanceSpecificationView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/InstanceSpecificationView.html`
- source_sha256: `cd64a1bc5c347aed62c2e39f1f9c8b6d6409229f97e2d2b0ede6440d4af5dff1`
- captured_utc: `2026-07-14T16:56:03.272548+00:00`
...
`[NodeInstanceSpecificationView](NodeInstanceSpecificationView.html)`

@OpenApipublic classInstanceSpecificationView
...
Constructor
Description
`[InstanceSpecificationView](#%3Cinit%3E())()`

`[InstanceSpecificationView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
Creates and initializes a new CollaborationObjectView object
 from specified parameter.
`[InstanceSpecificationView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.HeaderView))([PresentationElement](../PresentationElement.html) parent,
...
`com.nomagic.magicdraw.uml.symbols.shapes.InstanceSpecificationHeaderView`
`[getHeaderView](#getHeaderView())()`

`com.nomagic.magicdraw.uml.symbols.shapes.InstanceSlotsCompartmentView`
`[getInstanceSlotsCompartmentView](#getInstanceSlotsCompartmentView())()`
...
`boolean`
`[getShowValueTypeUnits](#getShowValueTypeUnits())()`
Gets value of slot stereotype tag showing property.
`void`
...
`boolean`
`[isShowSpecificationValue](#isShowSpecificationValue())()`

`boolean`
`[isSuppressSlotsCompartment](#isSuppressSlotsCompartment())()`
...
`void`
`[setShowSpecificationValue](#setShowSpecificationValue(boolean))(boolean showSpecificationValue)`

`void`
`[setShowValueTypeUnits](#setShowValueTypeUnits(boolean))(boolean value)`
Sets value of showing value type units property..
`void`
`[sSetClassifiers](#sSetClassifiers(java.util.List))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> classifiers)`
Sets one classifier.
`void`
...
Sets value of slot showing property.
`void`
`[sSetShowSpecificationValue](#sSetShowSpecificationValue(boolean))(boolean showSpecificationValue)`

`void`
`[sSetShowValueTypeUnits](#sSetShowValueTypeUnits(boolean))(boolean value)`
Sets value of showing value type units property.
`void`
...
getClassifiers
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> getClassifiers()
Overrides:
...
sSetClassifiers
public void sSetClassifiers([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> classifiers)
...
Returns:
true if this container can add this object
...
Sets value of showing value type units property. Just changes property,
...
<h1 class="title" title="Class InstanceSpecificationView">Class InstanceSpecificationView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.InstanceSpecificationView</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="NodeInstanceSpecificationView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">NodeInstanceSpecificationView</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public class </span><span class="element-name type-name-label">InstanceSpecificationView</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">InstanceSpecificationView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">InstanceSpecificationView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates and initializes a new CollaborationObjectView object
 from specified parameter.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.HeaderView)">InstanceSpecificationView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderView headerView)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="block">Checks can this container contain or not.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.InstanceSpecificationHeaderView</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.InstanceSlotsCompartmentView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getInstanceSlotsCompartmentView()">getInstanceSlotsCompartmentView</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getShowSlotTypeMode()">getShowSlotTypeMode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets value of slot showing property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getShowValueTypeUnits()">getShowValueTypeUnits</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets value of slot stereotype tag showing property.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowSpecificationValue()">isShowSpecificationValue</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isSuppressSlotsCompartment()">isSuppressSlotsCompartment</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Is suppress compartment</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowSpecificationValue(boolean)">setShowSpecificationValue</a><wbr/>(boolean showSpecificationValue)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowValueTypeUnits(boolean)">setShowValueTypeUnits</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of showing value type units property..</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowSlotTypeMode(java.lang.String)">sSetShowSlotTypeMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of slot showing property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowSpecificationValue(boolean)">sSetShowSpecificationValue</a><wbr/>(boolean showSpecificationValue)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowValueTypeUnits(boolean)">sSetShowValueTypeUnits</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of showing value type units property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<code>addBreakPoints, checkShowsProxy, doActualShapeDrawing, getDefaultDimension, getSeparatorDistanceFromRightSide, getStereotypesToDisplay, getTypeClass, isActive, isDrawSeparator, isDrawUnderLine, isShowClass, isShowFullType, movePathElement, selfSpecificHeaderShapeDraw, setDrawUnderLine, setShowClass, setShowFullType, sSetShowClass, sSetShowFullType</code></div>
<div class="inherited-list">
...
<h3>InstanceSpecificationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">InstanceSpecificationView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>InstanceSpecificationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">InstanceSpecificationView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</span></div>
<div class="block">Creates and initializes a new CollaborationObjectView object
 from specified parameter.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>parent</code> - this object keeps reference to parent object</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement,com.nomagic.magicdraw.uml.symbols.shapes.HeaderView)">
<h3>InstanceSpecificationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">InstanceSpecificationView</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent,
 com.nomagic.magicdraw.uml.symbols.shapes.HeaderView headerView)</span></div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>getClassifiers</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.TypedElementView</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Parameters:</dt>
<dd><code>classifiers</code> - a collection of classifiers to set as type of this typed element</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>true if this container can add this object
 otherwise return false.</dd>
</dl>
</section>
</li>
<li>
...
<dt>Parameters:</dt>
<dd><code>visitor</code> - - the Visitor
                **</dd>
<dt>Throws:</dt>
...
<li>
<section class="detail" id="isSuppressSlotsCompartment()">
<h3>isSuppressSlotsCompartment</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isSuppressSlotsCompartment</span>()</div>
<div class="block">Is suppress compartment</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>suppress value</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getShowValueTypeUnits()">
<h3>getShowValueTypeUnits</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">getShowValueTypeUnits</span>()</div>
<div class="block">Gets value of slot stereotype tag showing property. Default is True</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true to show, else false</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowValueTypeUnits(boolean)">
<h3>sSetShowValueTypeUnits</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowValueTypeUnits</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets value of showing value type units property. Just changes property,
...
<li>
<section class="detail" id="setShowValueTypeUnits(boolean)">
<h3>setShowValueTypeUnits</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowValueTypeUnits</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets value of showing value type units property.. Calls view update</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - value</dd>
</dl>
...
<li>
<section class="detail" id="isShowSpecificationValue()">
<h3>isShowSpecificationValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowSpecificationValue</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if symbol should display specification value of Instance Specification</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setShowSpecificationValue(boolean)">
<h3>setShowSpecificationValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowSpecificationValue</span><wbr/><span class="parameters">(boolean showSpecificationValue)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showSpecificationValue</code> - true if symbol should display specification value of Instance Specification</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="sSetShowSpecificationValue(boolean)">
<h3>sSetShowSpecificationValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowSpecificationValue</span><wbr/><span class="parameters">(boolean showSpecificationValue)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>showSpecificationValue</code> - true if symbol should display specification value of Instance Specification</dd>
</dl>
...
<li>
<section class="detail" id="getInstanceSlotsCompartmentView()">
<h3>getInstanceSlotsCompartmentView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.InstanceSlotsCompartmentView</span> <span class="element-name">getInstanceSlotsCompartmentView</span>()</div>
</section>
</li>
<li>
...
<h3>getHeaderView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.InstanceSpecificationHeaderView</span> <span class="element-name">getHeaderView</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
