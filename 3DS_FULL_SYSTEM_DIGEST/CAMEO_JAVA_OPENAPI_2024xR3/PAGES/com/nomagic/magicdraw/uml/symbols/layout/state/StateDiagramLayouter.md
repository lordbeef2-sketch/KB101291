# JAVA OPENAPI: StateDiagramLayouter (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/layout/state/StateDiagramLayouter.html
- source_path: `com/nomagic/magicdraw/uml/symbols/layout/state/StateDiagramLayouter.html`
- source_sha256: `7f5d436284bd15e8453e58dcbd4fb920aed72b7078bf0f18b71039434265a1c4`
- captured_utc: `2026-07-14T16:55:58.974497+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.magicdraw.uml.symbols.layout.state](package-summary.html)
...
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public classStateDiagramLayouter
...
A specialized layouter for state and protocol state diagrams. It is also used as a default
 layouter for diagrams that are based on them.
...
Constructor
Description
`[StateDiagramLayouter](#%3Cinit%3E())()`
Deprecated.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Deprecated.
`boolean`
`[canLayoutAsHierarchic](#canLayoutAsHierarchic(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup))([BaseGraph](../BaseGraph.html) graph,
 [AbstractDiagramLayouterOptionsGroup](../../../../core/options/AbstractDiagramLayouterOptionsGroup.html) options)`
Deprecated.
`com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type`
`[getPredefinedLayouterType](#getPredefinedLayouterType())()`
Deprecated.
`protected boolean`
...
Deprecated.
`void`
`[setPredefinedLayouterType](#setPredefinedLayouterType(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type))(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type type)`
Deprecated.
...
`[canSetLocationForOnEdgeShape](../HierarchicDiagramLayouter.html#canSetLocationForOnEdgeShape(com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement)), [collectOnEdgeToResize](../HierarchicDiagramLayouter.html#collectOnEdgeToResize(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup)), [createPathRerouteCollectors](../HierarchicDiagramLayouter.html#createPathRerouteCollectors()), [isTypeSupported](../HierarchicDiagramLayouter.html#isTypeSupported(com.nomagic.magicdraw.uml.AbstractDiagramType))`
...
@OpenApipublic StateDiagramLayouter()
Deprecated.
 ============ METHOD DETAIL ========== 
Method Details
layout
...
public boolean canLayoutAsHierarchic([BaseGraph](../BaseGraph.html) graph,
 [AbstractDiagramLayouterOptionsGroup](../../../../core/options/AbstractDiagramLayouterOptionsGroup.html) options)
Deprecated.
preProcessing
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span> <a href="package-summary.html">com.nomagic.magicdraw.uml.symbols.layout.state</a></div>
<h1 class="title" title="Class StateDiagramLayouter">Class StateDiagramLayouter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">StateDiagramLayouter</span>
...
<div class="block">A specialized layouter for state and protocol state diagrams. It is also used as a default
 layouter for diagrams that are based on them.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">StateDiagramLayouter</a>()</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#canLayoutAsHierarchic(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup)">canLayoutAsHierarchic</a><wbr/>(<a href="../BaseGraph.html" title="class in com.nomagic.magicdraw.uml.symbols.layout">BaseGraph</a> graph,
...
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
 </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code>com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#getPredefinedLayouterType()">getPredefinedLayouterType</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
 </div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code>protected void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#preProcessing(com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup,com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.dassault_systemes.modeler.foundation.editing.CompositeCommand)">preProcessing</a><wbr/>(<a href="../../../../core/options/AbstractDiagramLayouterOptionsGroup.html" title="class in com.nomagic.magicdraw.core.options">AbstractDiagramLayouterOptionsGroup</a> options,
 <a href="../../AbstractDiagramPresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">AbstractDiagramPresentationElement</a> dpe,
 com.dassault_systemes.modeler.foundation.editing.CompositeCommand mc)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#setPredefinedLayouterType(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type)">setPredefinedLayouterType</a><wbr/>(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type type)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
 </div>
</div>
...
<code><a href="../HierarchicDiagramLayouter.html#canSetLocationForOnEdgeShape(com.nomagic.magicdraw.uml.symbols.shapes.ShapeElement)">canSetLocationForOnEdgeShape</a>, <a href="../HierarchicDiagramLayouter.html#collectOnEdgeToResize(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup)">collectOnEdgeToResize</a>, <a href="../HierarchicDiagramLayouter.html#createPathRerouteCollectors()">createPathRerouteCollectors</a>, <a href="../HierarchicDiagramLayouter.html#isTypeSupported(com.nomagic.magicdraw.uml.AbstractDiagramType)">isTypeSupported</a></code></div>
<div class="inherited-list">
...
<h3>StateDiagramLayouter</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">StateDiagramLayouter</span>()</div>
...
<li>
<section class="detail" id="canLayoutAsHierarchic(com.nomagic.magicdraw.uml.symbols.layout.BaseGraph,com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup)">
<h3>canLayoutAsHierarchic</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">canLayoutAsHierarchic</span><wbr/><span class="parameters">(<a href="../BaseGraph.html" title="class in com.nomagic.magicdraw.uml.symbols.layout">BaseGraph</a> graph,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../AbstractHierarchicDiagramLayouter.html#preProcessing(com.nomagic.magicdraw.core.options.AbstractDiagramLayouterOptionsGroup,com.nomagic.magicdraw.uml.symbols.AbstractDiagramPresentationElement,com.dassault_systemes.modeler.foundation.editing.CompositeCommand)">preProcessing</a></code> in class <code><a href="../AbstractHierarchicDiagramLayouter.html" title="class in com.nomagic.magicdraw.uml.symbols.layout">AbstractHierarchicDiagramLayouter</a></code></dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getPredefinedLayouterType()">
<h3>getPredefinedLayouterType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type</span> <span class="element-name">getPredefinedLayouterType</span>()</div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
</section>
</li>
<li>
<section class="detail" id="setPredefinedLayouterType(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type)">
<h3>setPredefinedLayouterType</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setPredefinedLayouterType</span><wbr/><span class="parameters">(com.nomagic.magicdraw.uml.symbols.layout.state.StateDiagramLayouter.Type type)</span></div>
<div class="deprecation-block"><span class="deprecated-label">Deprecated.</span></div>
</section>
</li>
</ul>
