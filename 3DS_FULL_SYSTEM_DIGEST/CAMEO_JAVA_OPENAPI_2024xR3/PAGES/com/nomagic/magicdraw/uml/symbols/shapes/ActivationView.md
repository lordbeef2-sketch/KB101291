# JAVA OPENAPI: ActivationView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/ActivationView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/ActivationView.html`
- source_sha256: `60a53325f863cf975bf04fdae341c99d41a74636a8f4b9b3b961ca4990287740`
- captured_utc: `2026-07-14T16:56:04.031556+00:00`
...
@OpenApipublic classActivationView
...
`static final int`
`[DISTANCE_FROM_NESTED](#DISTANCE_FROM_NESTED)`
...
Constructor
Description
`[ActivationView](#%3Cinit%3E())()`

`[ActivationView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[adjustBoundsBeforeChange](#adjustBoundsBeforeChange(java.awt.Rectangle,boolean,java.util.Collection))([Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) rect,
...
`[findLowerMessage](#findLowerMessage())()`

`com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView`
`[findParentMessage](#findParentMessage())()`

`com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView`
`[findUpperMessage](#findUpperMessage())()`
...
`[getLifelineView](#getLifelineView())()`
...
`[getNestedActivations](#getNestedActivations())()`
...
`[getParentActivation](#getParentActivation())()`
...
`boolean`
`[hasNestedActivations](#hasNestedActivations())()`
Indicates if this activation has nested activations.
`boolean`
`[hasSameNestingLevel](#hasSameNestingLevel(com.nomagic.magicdraw.uml.symbols.shapes.ActivationView))([ActivationView](ActivationView.html) activation)`
...
`boolean`
`[isMovable](#isMovable(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html) msg)`
...
`boolean`
`[isResizedByUser](#isResizedByUser())()`
...
`boolean`
`[representsExecutionSpecification](#representsExecutionSpecification())()`
...
`void`
`[setResizedByUser](#setResizedByUser(boolean))(boolean resizedByUser)`
...
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.BOTTOM_LENGTH)
DEFAULT_HEIGHT
public static final int DEFAULT_HEIGHT
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DEFAULT_HEIGHT)
DEFAULT_WIDTH
public static final int DEFAULT_WIDTH
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DEFAULT_WIDTH)
DISTANCE_FROM_NESTED
public static final int DISTANCE_FROM_NESTED
Distance by which parent activations extend inner activations.
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DISTANCE_FROM_NESTED)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ActivationView
public ActivationView()
ActivationView
public ActivationView(@CheckForNull
 [PresentationElement](../PresentationElement.html) parent)
 ============ METHOD DETAIL ========== 
Method Details
moveLinksToSelf
public void moveLinksToSelf()
Description copied from class: `[ShapeElement](ShapeElement.html#moveLinksToSelf())`
Move links to self.
Overrides:
`[moveLinksToSelf](ShapeElement.html#moveLinksToSelf())` in class `[ShapeElement](ShapeElement.html)`
sSetElement
...
Description copied from class: `[PresentationElement](../PresentationElement.html#isUseGradientForFill())`
Do we need to use gradient for fill color? Checks diagram property.
Overrides:
...
public [Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) adjustBoundsBeforeChange([Rectangle](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Rectangle.html) rect,
 boolean autosizeOperation,
 [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PresentationElement](../PresentationElement.html)> movedTogether)
...
findUpperMessage
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView findUpperMessage()
Returns:
finds the top message. If there is incoming and outgoing message and the same y coordinate, then the incoming one will
 be selected as the upper, in order for [`findParentMessage()`](#findParentMessage()) method to work correctly in such case
findLowerMessage
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView findLowerMessage()
Returns:
finds the lower message
findParentMessage
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView findParentMessage()
Returns:
first incoming non asynchronous message from top
isMovable
public boolean isMovable([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html) msg)
Parameters:
`msg` - message
Returns:
...
Overrides:
`[disposeConnectedPaths](../paths/PathConnector.html#disposeConnectedPaths())` in class `[PathConnector](../paths/PathConnector.html)`
getLine
public [LifeLineLineView](LifeLineLineView.html) getLine()
getVisibility
public com.nomagic.magicdraw.uml.symbols.PresentationElementVisibility getVisibility()
Overrides:
`[getVisibility](../PresentationElement.html#getVisibility())` in class `[PresentationElement](../PresentationElement.html)`
Returns:
element visibility
useParentStyle
...
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[ActivationView](ActivationView.html)> getNestedActivations()
Retrieves a list of nested activations placed on this activation.
Returns:
...
hasSameNestingLevel
public boolean hasSameNestingLevel([ActivationView](ActivationView.html) activation)
Indicates if this activation has same nesting level as a given one.
Parameters:
...
getParentActivation
@CheckForNullpublic [ActivationView](ActivationView.html) getParentActivation()
Returns parent activation if this activation is nested.
Returns:
parent activation if nested, null otherwise.
getLifelineView
@CheckForNullpublic [SequenceLifelineView](SequenceLifelineView.html) getLifelineView()
Returns SequenceLifelineView to which this activation belongs.
Returns:
...
Description copied from class: `[ShapeElement](ShapeElement.html#adjustBounds(java.awt.Rectangle))`
Validates bounds
Overrides:
...
Returns preferable dimension of the element for autosize.This implementation simple returns
 preferred size.
Overrides:
`[getPreferredDimensionForAutosize](ShapeElement.html#getPreferredDimensionForAutosize())` in class `[ShapeElement](ShapeElement.html)`
Returns:
preferred dimension
canBeAutosized
protected boolean canBeAutosized()
Overrides:
`[canBeAutosized](ShapeElement.html#canBeAutosized())` in class `[ShapeElement](ShapeElement.html)`
supportsVisibleConnectedPathElementsIfSelfInvisible
protected boolean supportsVisibleConnectedPathElementsIfSelfInvisible()
Overrides:
`[supportsVisibleConnectedPathElementsIfSelfInvisible](../paths/PathConnector.html#supportsVisibleConnectedPathElementsIfSelfInvisible())` in class `[PathConnector](../paths/PathConnector.html)`
...
<h1 class="title" title="Class ActivationView">Class ActivationView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.shapes.ActivationView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ActivationView</span>
<span class="extends-implements">extends com.nomagic.magicdraw.uml.symbols.shapes.ContainerShapeView</span></div>
<div class="block">Creates activation object in sequence diagram.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#BOTTOM_LENGTH">BOTTOM_LENGTH</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#DEFAULT_HEIGHT">DEFAULT_HEIGHT</a></code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-first even-row-color"><code>static final int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#DEFAULT_WIDTH">DEFAULT_WIDTH</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#DISTANCE_FROM_NESTED">DISTANCE_FROM_NESTED</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Distance by which parent activations extend inner activations.</div>
</div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ActivationView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ActivationView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#autoResize()">autoResize</a>()</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#findLowerMessage()">findLowerMessage</a>()</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#findParentMessage()">findParentMessage</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#findUpperMessage()">findUpperMessage</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLifelineView()">getLifelineView</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns SequenceLifelineView to which this activation belongs.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getLine()">getLine</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getNestedActivations()">getNestedActivations</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Retrieves a list of nested activations placed on this activation.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getNestingLevel()">getNestingLevel</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns nesting level of this activation (counted from 0).</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getParentActivation()">getParentActivation</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns parent activation if this activation is nested.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.SequenceObjectViewContainer</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getSeqContainer()">getSeqContainer</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#hasNestedActivations()">hasNestedActivations</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this activation has nested activations.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#hasSameNestingLevel(com.nomagic.magicdraw.uml.symbols.shapes.ActivationView)">hasSameNestingLevel</a><wbr/>(<a href="ActivationView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ActivationView</a> activation)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this activation has same nesting level as a given one.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isMovable(java.util.Collection)">isMovable</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a> msg)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Indicates if this activation is nested.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isResizedByUser()">isResizedByUser</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#movePathElement(com.nomagic.magicdraw.uml.symbols.paths.PathElement,com.nomagic.magicdraw.uml.symbols.paths.PathConnector)">movePathElement</a><wbr/>(<a href="../paths/PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a> link,
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#representsExecutionSpecification()">representsExecutionSpecification</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sDispose()">sDispose</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">dispose without adding container for re-layout.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setResizedByUser(boolean)">setResizedByUser</a><wbr/>(boolean resizedByUser)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#supportsVisibleConnectedPathElementsIfSelfInvisible()">supportsVisibleConnectedPathElementsIfSelfInvisible</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
...
<code>addPresentationElement, addPresentationElement, addPresentationElementWithoutResize, adjustChildBoundsForMoving, autosize, autosizeByChildren, calculateAutosizeDimension, calculateAutosizeDimension, canAddChild, canMoveChildOutside, checkShowsProxy, childrenBoundsForReshape, clearShowsProxy, clone, constructLayoutHelper, correctChildrenVector, getChildrenBounds, getChildrenInsets, getChildrenOnBorderBounds, getContainerBounds, getDefaultChildrenInsets, getLayoutHelper, getLayoutHelperClone, getManipulatedElementAt, getManipulationPreferredDimension, getPresentationElementAt, getPresentationElementIndex, getPresentationElements, getProxyPresentationElementsStream, getRemovableChildren, hasManipulatedChildrenIncludingIndirect, hasManipulatedShapesNotOnEdge, hasManipulatedShapesOnEdge, hasManipulatedShapesOnEdge, internalAddIndirectManipulatedChildrenRect, internalAppendChildRect, internalGetChildAt, internalGetIndirectManipulatedChildrenRect, internalGetManipulatedChildrenRect, internalGetSelfManipulationPreferredSize, internalSetChildren, internalUpdatePresentationElement, isCanChildrenChangeEdge, isCanMoveChildren, isChildMovable, layoutChildren, moveChild, moveChildren, needAdjustToPreferred, paintChildren, paintChildrenBackground, prefDimensionByManipulatedChildren, preferredDimension, recursiveAutosize, removePresentationElement, removePresentationElement, sAddPresentationElement, setBounds, setCanMoveChildren, setDummyResizeMode, setFillColor, setFillColorForChildren, setLayoutHelper, setPresentationElements, showPathElements, simpleSetBounds, simpleSetBounds, sRemovePresentationElement, sSetPresentationElements</code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="BOTTOM_LENGTH">
<h3>BOTTOM_LENGTH</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">BOTTOM_LENGTH</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.BOTTOM_LENGTH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="DEFAULT_HEIGHT">
<h3>DEFAULT_HEIGHT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">DEFAULT_HEIGHT</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DEFAULT_HEIGHT">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="DEFAULT_WIDTH">
<h3>DEFAULT_WIDTH</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">DEFAULT_WIDTH</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DEFAULT_WIDTH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="DISTANCE_FROM_NESTED">
<h3>DISTANCE_FROM_NESTED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">DISTANCE_FROM_NESTED</span></div>
<div class="block">Distance by which parent activations extend inner activations.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.ActivationView.DISTANCE_FROM_NESTED">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ActivationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ActivationView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ActivationView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ActivationView</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">moveLinksToSelf</span>()</div>
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="ShapeElement.html#moveLinksToSelf()">ShapeElement</a></code></span></div>
<div class="block">Move links to self.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ShapeElement.html#moveLinksToSelf()">moveLinksToSelf</a></code> in class <code><a href="ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a></code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="../PresentationElement.html#isUseGradientForFill()">PresentationElement</a></code></span></div>
<div class="block">Do we need to use gradient for fill color? Checks diagram property.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>setBounds</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.ContainerShapeView</code></dd>
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="findUpperMessage()">
<h3>findUpperMessage</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView</span> <span class="element-name">findUpperMessage</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>finds the top message. If there is incoming and outgoing message and the same y coordinate, then the incoming one will
 be selected as the upper, in order for <a href="#findParentMessage()"><code>findParentMessage()</code></a> method to work correctly in such case</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="findLowerMessage()">
<h3>findLowerMessage</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView</span> <span class="element-name">findLowerMessage</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>finds the lower message</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="findParentMessage()">
<h3>findParentMessage</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.paths.SeqBaseMessageView</span> <span class="element-name">findParentMessage</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>first incoming non asynchronous message from top</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isMovable(java.util.Collection)">
<h3>isMovable</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isMovable</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a> msg)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>msg</code> - message</dd>
<dt>Returns:</dt>
<dd>true if activation must be moved together with given messages</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="autoResize()">
<h3>autoResize</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">autoResize</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="sDispose()">
<h3>sDispose</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sDispose</span>()</div>
<div class="block">dispose without adding container for re-layout. Used to dispose symbols during container re-layout</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../paths/PathConnector.html#disposeConnectedPaths()">disposeConnectedPaths</a></code> in class <code><a href="../paths/PathConnector.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathConnector</a></code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getLine()">
<h3>getLine</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="LifeLineLineView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">LifeLineLineView</a></span> <span class="element-name">getLine</span>()</div>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../PresentationElement.html#getVisibility()">getVisibility</a></code> in class <code><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="representsExecutionSpecification()">
<h3>representsExecutionSpecification</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">representsExecutionSpecification</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setResizedByUser(boolean)">
<h3>setResizedByUser</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setResizedByUser</span><wbr/><span class="parameters">(boolean resizedByUser)</span></div>
</section>
</li>
<li>
<section class="detail" id="isResizedByUser()">
<h3>isResizedByUser</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isResizedByUser</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getNestingLevel()">
<h3>getNestingLevel</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">int</span> <span class="element-name">getNestingLevel</span>()</div>
<div class="block">Returns nesting level of this activation (counted from 0).</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>nesting level.</dd>
...
<li>
<section class="detail" id="getNestedActivations()">
<h3>getNestedActivations</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ActivationView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ActivationView</a>&gt;</span> <span class="element-name">getNestedActivations</span>()</div>
<div class="block">Retrieves a list of nested activations placed on this activation.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>a list of nested activations.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>true if activation is nested, false otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasSameNestingLevel(com.nomagic.magicdraw.uml.symbols.shapes.ActivationView)">
<h3>hasSameNestingLevel</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">hasSameNestingLevel</span><wbr/><span class="parameters">(<a href="ActivationView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ActivationView</a> activation)</span></div>
<div class="block">Indicates if this activation has same nesting level as a given one.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>activation</code> - - activation to which nesting level is compared.</dd>
<dt>Returns:</dt>
<dd>true if nesting levels of activations are the same.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasNestedActivations()">
<h3>hasNestedActivations</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">hasNestedActivations</span>()</div>
<div class="block">Indicates if this activation has nested activations.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>true if this activation has nested activations, false otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getParentActivation()">
<h3>getParentActivation</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ActivationView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ActivationView</a></span> <span class="element-name">getParentActivation</span>()</div>
<div class="block">Returns parent activation if this activation is nested.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>parent activation if nested, null otherwise.</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getLifelineView()">
<h3>getLifelineView</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="SequenceLifelineView.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">SequenceLifelineView</a></span> <span class="element-name">getLifelineView</span>()</div>
<div class="block">Returns SequenceLifelineView to which this activation belongs.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>SequenceLifelineView to which this activation belongs.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="ShapeElement.html#adjustBounds(java.awt.Rectangle)">ShapeElement</a></code></span></div>
<div class="block">Validates bounds</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ShapeElement.html#getPreferredDimensionForAutosize()">getPreferredDimensionForAutosize</a></code> in class <code><a href="ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a></code></dd>
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="ShapeElement.html#canBeAutosized()">canBeAutosized</a></code> in class <code><a href="ShapeElement.html" title="class in com.nomagic.magicdraw.uml.symbols.shapes">ShapeElement</a></code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="../paths/PathConnector.html#supportsVisibleConnectedPathElementsIfSelfInvisible()">supportsVisibleConnectedPathElementsIfSelfInvisible</a></code> in class <code><a href="../paths/PathConnector.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathConnector</a></code></dd>
</dl>
</section>
</li>
</ul>
