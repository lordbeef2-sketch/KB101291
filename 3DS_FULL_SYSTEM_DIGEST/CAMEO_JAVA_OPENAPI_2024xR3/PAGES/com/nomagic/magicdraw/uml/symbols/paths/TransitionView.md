# JAVA OPENAPI: TransitionView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/paths/TransitionView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/TransitionView.html`
- source_sha256: `3a32a93aef049f59c4ba35256ec17c07d7705cc182efb80db04bbb40b5dd3031`
- captured_utc: `2026-07-14T16:56:01.959531+00:00`
...
@OpenApipublic classTransitionView
...
`[OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY](#OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY)`

`static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)`
`[OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME](#OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME)`
...
`[OPAQUE_BEHAVIOR_DISPLAY_MODES](#OPAQUE_BEHAVIOR_DISPLAY_MODES)`
...
Constructor
Description
`[TransitionView](#%3Cinit%3E())()`

`[TransitionView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.paths.TransitionView.OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME)
OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.paths.TransitionView.OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY)
OPAQUE_BEHAVIOR_DISPLAY_MODES
public static final [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> OPAQUE_BEHAVIOR_DISPLAY_MODES
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
TransitionView
public TransitionView()
TransitionView
public TransitionView(@CheckForNull
...
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) constructNameTextToDisplay()
Overrides:
...
Overrides:
`[checkShowsProxy](PathConnector.html#checkShowsProxy())` in class `[PathConnector](PathConnector.html)`
isShowPort
...
Description copied from class: `[PathElement](PathElement.html#askDeleteDataConfirmation())`
Return true, because while deleting link view user must be prompt about deleting data
Overrides:
`[askDeleteDataConfirmation](PathElement.html#askDeleteDataConfirmation())` in class `[PathElement](PathElement.html)`
Returns:
...
<h1 class="title" title="Class TransitionView">Class TransitionView</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml.symbols.paths.TransitionView</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TransitionView</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY">OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME">OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#OPAQUE_BEHAVIOR_DISPLAY_MODES">OPAQUE_BEHAVIOR_DISPLAY_MODES</a></code></div>
<div class="col-last even-row-color"> </div>
</div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">TransitionView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">TransitionView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowOperationsSignature()">isShowOperationsSignature</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowPort()">isShowPort</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setOpaqueBehaviorDisplayMode(java.lang.String)">setOpaqueBehaviorDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowOperationsSignature(boolean)">setShowOperationsSignature</a><wbr/>(boolean showSignature)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets if trigger event operation signature should be shown</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowPort(boolean)">setShowPort</a><wbr/>(boolean showPort)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetOpaqueBehaviorDisplayMode(java.lang.String)">sSetOpaqueBehaviorDisplayMode</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mode)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowOperationsSignature(boolean)">sSetShowOperationsSignature</a><wbr/>(boolean showSignature)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets if trigger event operation signature should be shown</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowPort(boolean)">sSetShowPort</a><wbr/>(boolean showPort)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets value of the "Show Port" symbol property.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<li>
<section class="detail" id="OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME">
<h3>OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.paths.TransitionView.OPAQUE_BEHAVIOR_DISPLAY_MODE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY">
<h3>OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.paths.TransitionView.OPAQUE_BEHAVIOR_DISPLAY_MODE_BODY">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="OPAQUE_BEHAVIOR_DISPLAY_MODES">
<h3>OPAQUE_BEHAVIOR_DISPLAY_MODES</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">OPAQUE_BEHAVIOR_DISPLAY_MODES</span></div>
</section>
</li>
</ul>
</section>
...
<h3>TransitionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TransitionView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>TransitionView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TransitionView</span><wbr/><span class="parameters">(@CheckForNull
...
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">constructNameTextToDisplay</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathConnector.html#checkShowsProxy()">checkShowsProxy</a></code> in class <code><a href="PathConnector.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathConnector</a></code></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="PathElement.html#askDeleteDataConfirmation()">PathElement</a></code></span></div>
<div class="block">Return true, because while deleting link view user must be prompt about deleting data</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="PathElement.html#askDeleteDataConfirmation()">askDeleteDataConfirmation</a></code> in class <code><a href="PathElement.html" title="class in com.nomagic.magicdraw.uml.symbols.paths">PathElement</a></code></dd>
<dt>Returns:</dt>
