# JAVA OPENAPI: PortView (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uml/symbols/shapes/PortView.html
- source_path: `com/nomagic/magicdraw/uml/symbols/shapes/PortView.html`
- source_sha256: `1ab0d499445146e7a55f814d081c1d59af06b528e0d7919f9c447337c1e65f17`
- captured_utc: `2026-07-14T16:56:05.507569+00:00`
...
`[PortView](#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[adjustPositionForProvidedInterfacesLabel](#adjustPositionForProvidedInterfacesLabel())()`

`void`
`[adjustPositionForRequiredInterfacesLabel](#adjustPositionForRequiredInterfacesLabel())()`
...
`boolean`
`[canLabelBeInside](#canLabelBeInside(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper))(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper labelWrapper)`
...
`void`
`[drawLinesToInterfacesLabels](#drawLinesToInterfacesLabels(java.awt.Graphics2D))([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g)`
Draw lines to interface labels.
`void`
`[drawLineToLabel](#drawLineToLabel(java.awt.Graphics,com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView,com.nomagic.magicdraw.uml.symbols.shapes.Alignment,com.nomagic.magicdraw.uml.symbols.shapes.Alignment))([Graphics](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics.html) g,
...
`[getBorderOwnerExcludingPort](#getBorderOwnerExcludingPort())()`
Gets owner of the border on which this port lies.
`protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getDefaultHorizontalPositionForProvidedLabel](#getDefaultHorizontalPositionForProvidedLabel())()`

`protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getDefaultHorizontalPositionForRequiredLabel](#getDefaultHorizontalPositionForRequiredLabel())()`
Default position required lollipop.
`protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getDefaultVerticalPositionForProvidedLabel](#getDefaultVerticalPositionForProvidedLabel())()`

`protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getDefaultVerticalPositionForRequiredLabel](#getDefaultVerticalPositionForRequiredLabel())()`
Default position required lollipop.
...
`[getIconPositionForProvidedHorizontal](#getIconPositionForProvidedHorizontal())()`

`com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getIconPositionForProvidedVertical](#getIconPositionForProvidedVertical())()`

`com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getIconPositionForRequiredHorizontal](#getIconPositionForRequiredHorizontal())()`

`com.nomagic.magicdraw.uml.symbols.shapes.Alignment`
`[getIconPositionForRequiredVertical](#getIconPositionForRequiredVertical())()`
...
`[getPort](#getPort(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) symbol)`

`static [EncapsulatedClassifier](../../../../uml2/ext/magicdraw/compositestructures/mdports/EncapsulatedClassifier.html)`
`[getPortClassifier](#getPortClassifier(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) parent)`

`com.nomagic.magicdraw.uml.symbols.shapes.ProvidedInterfaceLabelWrapper`
`[getProvidedInterfaceLabelWrapper](#getProvidedInterfaceLabelWrapper())()`

`final com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView`
`[getProvidedInterfacesLabelBox](#getProvidedInterfacesLabelBox())()`
...
`[getRequiredInterfaceLabelWrapper](#getRequiredInterfaceLabelWrapper())()`

`com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView`
`[getRequiredInterfacesLabelBox](#getRequiredInterfacesLabelBox())()`
...
`static boolean`
`[isPort](#isPort(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) element)`
Check if given symbol represents Port
`boolean`
`[isShowInheritedSign](#isShowInheritedSign())()`

`boolean`
`[isShowProvidedInterfaces](#isShowProvidedInterfaces())()`

`boolean`
`[isShowRequiredInterfaces](#isShowRequiredInterfaces())()`

`protected boolean`
`[isSnapToGrid](#isSnapToGrid())()`

`static boolean`
`[ownerValid](#ownerValid(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) symbol)`
...
`void`
`[setShowProvidedInterfaces](#setShowProvidedInterfaces(boolean))(boolean show)`

`void`
`[setShowRequiredInterfaces](#setShowRequiredInterfaces(boolean))(boolean show)`

`void`
`[sSetShowInheritedSign](#sSetShowInheritedSign(boolean))(boolean showInheritedSign)`
Show inherited sign
`void`
`[sSetShowProvidedInterfaces](#sSetShowProvidedInterfaces(boolean))(boolean show)`

`void`
`[sSetShowRequiredInterfaces](#sSetShowRequiredInterfaces(boolean))(boolean show)`
...
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PortView.MIN_SIZE_HEIGHT)
MIN_SIZE_WIDTH
public static final int MIN_SIZE_WIDTH
See Also:
[Constant Field Values](../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PortView.MIN_SIZE_WIDTH)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
PortView
public PortView()
PortView
public PortView(@CheckForNull
 [PresentationElement](../PresentationElement.html) parent)
 ============ METHOD DETAIL ========== 
Method Details
getElement
public [Port](../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html) getElement()
...
getPort
public static [Port](../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html) getPort([PresentationElement](../PresentationElement.html) symbol)
Parameters:
`symbol` - symbol
Returns:
return element of given symbol as Port
isPort
public static boolean isPort([PresentationElement](../PresentationElement.html) element)
Check if given symbol represents Port
Parameters:
`element` - symbol
Returns:
...
@CheckForNullpublic com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView getRequiredInterfacesLabelBox()
getProvidedInterfacesLabelBox
@CheckForNullpublic final com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView getProvidedInterfacesLabelBox()
ownerValid
public static boolean ownerValid([PresentationElement](../PresentationElement.html) symbol)
getPortClassifier
@CheckForNullpublic static [EncapsulatedClassifier](../../../../uml2/ext/magicdraw/compositestructures/mdports/EncapsulatedClassifier.html) getPortClassifier([PresentationElement](../PresentationElement.html) parent)
getBorderOwnerExcludingPort
public [PresentationElement](../PresentationElement.html) getBorderOwnerExcludingPort()
Gets owner of the border on which this port lies. Does not take
 into consideration nested ports.
Returns:
...
Default position required lollipop. Gives if it is on the right or left according port view or,
 if lollipop are at the top or bottom regarding the portView, then gives right or left according PROVIDED lollipop
Returns:
position
See Also:
`Alignment.RIGHT`
...
Default position required lollipop. Gives if it is on the top or bottom according port view or,
 if lollipop are at the left or right regarding the portView, then gives right or left according PROVIDED lollipop
Returns:
position
See Also:
`Alignment.TOP`
...
public void drawLinesToInterfacesLabels([Graphics2D](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html) g)
Draw lines to interface labels.
Parameters:
`g` - graphics
drawLineToLabel
public void drawLineToLabel([Graphics](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics.html) g,
 com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView label,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionHorizontal,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionVertical)
propertyChange
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#MIN_SIZE_HEIGHT">MIN_SIZE_HEIGHT</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#MIN_SIZE_WIDTH">MIN_SIZE_WIDTH</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PortView</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.symbols.PresentationElement)">PortView</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#adjustPositionForProvidedInterfacesLabel()">adjustPositionForProvidedInterfacesLabel</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#adjustPositionForRequiredInterfacesLabel()">adjustPositionForRequiredInterfacesLabel</a>()</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#canLabelBeInside(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper)">canLabelBeInside</a><wbr/>(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper labelWrapper)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#drawLinesToInterfacesLabels(java.awt.Graphics2D)">drawLinesToInterfacesLabels</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Draw lines to interface labels.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#drawLineToLabel(java.awt.Graphics,com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView,com.nomagic.magicdraw.uml.symbols.shapes.Alignment,com.nomagic.magicdraw.uml.symbols.shapes.Alignment)">drawLineToLabel</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics.html" title="class or interface in java.awt">Graphics</a> g,
 com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView label,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionHorizontal,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionVertical)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getBorderOwnerExcludingPort()">getBorderOwnerExcludingPort</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets owner of the border on which this port lies.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultHorizontalPositionForProvidedLabel()">getDefaultHorizontalPositionForProvidedLabel</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultHorizontalPositionForRequiredLabel()">getDefaultHorizontalPositionForRequiredLabel</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Default position required lollipop.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultVerticalPositionForProvidedLabel()">getDefaultVerticalPositionForProvidedLabel</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefaultVerticalPositionForRequiredLabel()">getDefaultVerticalPositionForRequiredLabel</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Default position required lollipop.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdports">Port</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getIconPositionForProvidedHorizontal()">getIconPositionForProvidedHorizontal</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getIconPositionForProvidedVertical()">getIconPositionForProvidedVertical</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getIconPositionForRequiredHorizontal()">getIconPositionForRequiredHorizontal</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.Alignment</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getIconPositionForRequiredVertical()">getIconPositionForRequiredVertical</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a href="../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdports">Port</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#getPort()">getPort</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">getPort</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> symbol)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getPortClassifier(com.nomagic.magicdraw.uml.symbols.PresentationElement)">getPortClassifier</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.ProvidedInterfaceLabelWrapper</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getProvidedInterfaceLabelWrapper()">getProvidedInterfaceLabelWrapper</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>final com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getProvidedInterfacesLabelBox()">getProvidedInterfacesLabelBox</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.RequiredInterfaceLabelWrapper</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getRequiredInterfaceLabelWrapper()">getRequiredInterfaceLabelWrapper</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getRequiredInterfacesLabelBox()">getRequiredInterfacesLabelBox</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#internalGetModelElementsForRelationshipConnecting()">internalGetModelElementsForRelationshipConnecting</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isDrawRectangle()">isDrawRectangle</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">isPort</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Check if given symbol represents Port</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowInheritedSign()">isShowInheritedSign</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowProvidedInterfaces()">isShowProvidedInterfaces</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isShowRequiredInterfaces()">isShowRequiredInterfaces</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#ownerValid(com.nomagic.magicdraw.uml.symbols.PresentationElement)">ownerValid</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> symbol)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowInheritedSign(boolean)">setShowInheritedSign</a><wbr/>(boolean showInheritedSign)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited members sign in compartment</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowProvidedInterfaces(boolean)">setShowProvidedInterfaces</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setShowRequiredInterfaces(boolean)">setShowRequiredInterfaces</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowInheritedSign(boolean)">sSetShowInheritedSign</a><wbr/>(boolean showInheritedSign)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Show inherited sign</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowProvidedInterfaces(boolean)">sSetShowProvidedInterfaces</a><wbr/>(boolean show)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#sSetShowRequiredInterfaces(boolean)">sSetShowRequiredInterfaces</a><wbr/>(boolean show)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="MIN_SIZE_HEIGHT">
<h3>MIN_SIZE_HEIGHT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">MIN_SIZE_HEIGHT</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PortView.MIN_SIZE_HEIGHT">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="MIN_SIZE_WIDTH">
<h3>MIN_SIZE_WIDTH</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">int</span> <span class="element-name">MIN_SIZE_WIDTH</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../../constant-values.html#com.nomagic.magicdraw.uml.symbols.shapes.PortView.MIN_SIZE_WIDTH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>PortView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PortView</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>PortView</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PortView</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdports">Port</a></span> <span class="element-name">getElement</span>()</div>
...
<li>
<section class="detail" id="getPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>getPort</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/compositestructures/mdports/Port.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdports">Port</a></span> <span class="element-name">getPort</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> symbol)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>symbol</code> - symbol</dd>
<dt>Returns:</dt>
<dd>return element of given symbol as Port</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isPort(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>isPort</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">boolean</span> <span class="element-name">isPort</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> element)</span></div>
<div class="block">Check if given symbol represents Port</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>element</code> - symbol</dd>
<dt>Returns:</dt>
<dd>true if symbol is PortView or PartView which represents Port</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getRequiredInterfaceLabelWrapper()">
<h3>getRequiredInterfaceLabelWrapper</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.RequiredInterfaceLabelWrapper</span> <span class="element-name">getRequiredInterfaceLabelWrapper</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getProvidedInterfaceLabelWrapper()">
<h3>getProvidedInterfaceLabelWrapper</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.ProvidedInterfaceLabelWrapper</span> <span class="element-name">getProvidedInterfaceLabelWrapper</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getRequiredInterfacesLabelBox()">
<h3>getRequiredInterfacesLabelBox</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView</span> <span class="element-name">getRequiredInterfacesLabelBox</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getProvidedInterfacesLabelBox()">
<h3>getProvidedInterfacesLabelBox</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public final</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView</span> <span class="element-name">getProvidedInterfacesLabelBox</span>()</div>
</section>
</li>
<li>
<section class="detail" id="ownerValid(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>ownerValid</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type">boolean</span> <span class="element-name">ownerValid</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> symbol)</span></div>
</section>
</li>
<li>
<section class="detail" id="getPortClassifier(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>getPortClassifier</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="../../../../uml2/ext/magicdraw/compositestructures/mdports/EncapsulatedClassifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.compositestructures.mdports">EncapsulatedClassifier</a></span> <span class="element-name">getPortClassifier</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> parent)</span></div>
</section>
</li>
<li>
<section class="detail" id="getBorderOwnerExcludingPort()">
<h3>getBorderOwnerExcludingPort</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">getBorderOwnerExcludingPort</span>()</div>
<div class="block">Gets owner of the border on which this port lies. Does not take
 into consideration nested ports.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>symbol on which this port lies, excluding nested ports.</dd>
</dl>
</section>
</li>
<li>
...
<li>
<section class="detail" id="adjustPositionForProvidedInterfacesLabel()">
<h3>adjustPositionForProvidedInterfacesLabel</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">adjustPositionForProvidedInterfacesLabel</span>()</div>
</section>
</li>
<li>
<section class="detail" id="adjustPositionForRequiredInterfacesLabel()">
<h3>adjustPositionForRequiredInterfacesLabel</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">adjustPositionForRequiredInterfacesLabel</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="isShowRequiredInterfaces()">
<h3>isShowRequiredInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowRequiredInterfaces</span>()</div>
</section>
</li>
<li>
<section class="detail" id="isShowProvidedInterfaces()">
<h3>isShowProvidedInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isShowProvidedInterfaces</span>()</div>
</section>
</li>
<li>
<section class="detail" id="sSetShowProvidedInterfaces(boolean)">
<h3>sSetShowProvidedInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowProvidedInterfaces</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowProvidedInterfaces(boolean)">
<h3>setShowProvidedInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowProvidedInterfaces</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="sSetShowRequiredInterfaces(boolean)">
<h3>sSetShowRequiredInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">sSetShowRequiredInterfaces</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
<section class="detail" id="setShowRequiredInterfaces(boolean)">
<h3>setShowRequiredInterfaces</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setShowRequiredInterfaces</span><wbr/><span class="parameters">(boolean show)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getIconPositionForProvidedHorizontal()">
<h3>getIconPositionForProvidedHorizontal</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getIconPositionForProvidedHorizontal</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getIconPositionForProvidedVertical()">
<h3>getIconPositionForProvidedVertical</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getIconPositionForProvidedVertical</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getDefaultHorizontalPositionForProvidedLabel()">
<h3>getDefaultHorizontalPositionForProvidedLabel</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getDefaultHorizontalPositionForProvidedLabel</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getDefaultVerticalPositionForProvidedLabel()">
<h3>getDefaultVerticalPositionForProvidedLabel</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getDefaultVerticalPositionForProvidedLabel</span>()</div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="getIconPositionForRequiredHorizontal()">
<h3>getIconPositionForRequiredHorizontal</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getIconPositionForRequiredHorizontal</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getIconPositionForRequiredVertical()">
<h3>getIconPositionForRequiredVertical</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getIconPositionForRequiredVertical</span>()</div>
</section>
</li>
<li>
<section class="detail" id="getDefaultHorizontalPositionForRequiredLabel()">
<h3>getDefaultHorizontalPositionForRequiredLabel</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getDefaultHorizontalPositionForRequiredLabel</span>()</div>
<div class="block">Default position required lollipop. Gives if it is on the right or left according port view or,
 if lollipop are at the top or bottom regarding the portView, then gives right or left according PROVIDED lollipop</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>position</dd>
<dt>See Also:</dt>
...
<li><code>Alignment.LEFT</code></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="getDefaultVerticalPositionForRequiredLabel()">
<h3>getDefaultVerticalPositionForRequiredLabel</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">com.nomagic.magicdraw.uml.symbols.shapes.Alignment</span> <span class="element-name">getDefaultVerticalPositionForRequiredLabel</span>()</div>
<div class="block">Default position required lollipop. Gives if it is on the top or bottom according port view or,
 if lollipop are at the left or right regarding the portView, then gives right or left according PROVIDED lollipop</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>position</dd>
<dt>See Also:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>paintSelf</code> in class <code>com.nomagic.magicdraw.uml.symbols.shapes.AbstractShapeWithLabelsInside</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="drawLinesToInterfacesLabels(java.awt.Graphics2D)">
<h3>drawLinesToInterfacesLabels</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">drawLinesToInterfacesLabels</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g)</span></div>
<div class="block">Draw lines to interface labels.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="drawLineToLabel(java.awt.Graphics,com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView,com.nomagic.magicdraw.uml.symbols.shapes.Alignment,com.nomagic.magicdraw.uml.symbols.shapes.Alignment)">
<h3>drawLineToLabel</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">drawLineToLabel</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics.html" title="class or interface in java.awt">Graphics</a> g,
 com.nomagic.magicdraw.uml.symbols.shapes.TextBoxWithIconView label,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionHorizontal,
 com.nomagic.magicdraw.uml.symbols.shapes.Alignment labelPositionVertical)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="canLabelBeInside(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper)">
<h3>canLabelBeInside</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">canLabelBeInside</span><wbr/><span class="parameters">(com.nomagic.magicdraw.uml.symbols.shapes.LabelWrapper labelWrapper)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>canLabelBeInside</code> in interface <code>com.nomagic.magicdraw.uml.symbols.shapes.LabelsDisplayModeSupporter</code></dd>
</dl>
</section>
</li>
</ul>
