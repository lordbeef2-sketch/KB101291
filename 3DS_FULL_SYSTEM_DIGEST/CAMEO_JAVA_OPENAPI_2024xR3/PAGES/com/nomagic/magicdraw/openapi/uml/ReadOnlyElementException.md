# JAVA OPENAPI: ReadOnlyElementException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/openapi/uml/ReadOnlyElementException.html
- source_path: `com/nomagic/magicdraw/openapi/uml/ReadOnlyElementException.html`
- source_sha256: `435f7c24a06a19663a44f977a9fa58cf92eec829ef4c4943750c6c7707ab2412`
- captured_utc: `2026-07-14T16:55:26.662136+00:00`
...
@OpenApiAllpublic classReadOnlyElementException
...
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.openapi.uml.ReadOnlyElementException)
...
Constructor
Description
`[ReadOnlyElementException](#%3Cinit%3E(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../uml/BaseElement.html) element)`
...
Method Details
getElement
public [BaseElement](../../uml/BaseElement.html) getElement()
Returns a read only(not editable) element of this exception.
Returns:
read only element.
...
<h1 class="title" title="Class ReadOnlyElementException">Class ReadOnlyElementException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.openapi.uml.ReadOnlyElementException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ReadOnlyElementException</span>
...
<div class="block">The exception is thrown if user wants to edit not editable(readonly) ModelElement.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.openapi.uml.ReadOnlyElementException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.uml.BaseElement)">ReadOnlyElementException</a><wbr/>(<a href="../../uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs new exception for given read only(not editable) Element.</div>
</div>
</div>
</section>
</li>
...
<div class="block">Returns a read only(not editable) element of this exception.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.uml.BaseElement)">
<h3>ReadOnlyElementException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ReadOnlyElementException</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Constructs new exception for given read only(not editable) Element.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>element</code> - the read only Element.</dd>
</dl>
</section>
</li>
</ul>
...
<h3>getElement</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../../uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a></span> <span class="element-name">getElement</span>()</div>
<div class="block">Returns a read only(not editable) element of this exception.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>read only element.</dd>
</dl>
</section>
</li>
</ul>
