# JAVA OPENAPI: Job (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/job/Job.html
- source_path: `com/nomagic/magicdraw/job/Job.html`
- source_sha256: `776f9bfee494bd57191f4ff4e83b701f66fd0ba803cbffafb80b7ebc9dbb3376`
- captured_utc: `2026-07-14T16:55:23.288098+00:00`
...
Throws:
`[Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)` - if any error occurs
finished
void finished()
Cleanup should be done here after the job is finished.
getName
...
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html" title="class or interface in java.lang">Exception</a></code> - if any error occurs</dd>
</dl>
</section>
</li>
<li>
