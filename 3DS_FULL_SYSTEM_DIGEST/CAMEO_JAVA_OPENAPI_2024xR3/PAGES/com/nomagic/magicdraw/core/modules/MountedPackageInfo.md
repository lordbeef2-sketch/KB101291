# JAVA OPENAPI: MountedPackageInfo (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/core/modules/MountedPackageInfo.html
- source_path: `com/nomagic/magicdraw/core/modules/MountedPackageInfo.html`
- source_sha256: `26a1d028e121a0816294e890ee3a126bf279870733375f3e82518bc677d5cfe8`
- captured_utc: `2026-07-14T16:55:11.734969+00:00`
...
`[MountedPackageInfo](#%3Cinit%3E(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package,java.lang.String))([Package](../../../uml2/ext/magicdraw/classes/mdkernel/Package.html) aPackage,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mountedOn)`
Constructor,
 ========== METHOD SUMMARY =========== 
Method Summary
...
Get mounted package.
`void`
`[setMountedOn](#setMountedOn(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mountedOn)`
...
package.
getMountedOn
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getMountedOn()
Get mounted on element qualified name.
Returns:
qualified name.
setPackage
...
`aPackage` - package.
setMountedOn
public void setMountedOn([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) mountedOn)
Set mounted on element qualified name.
Parameters:
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package,java.lang.String)">MountedPackageInfo</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Package.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Package</a> aPackage,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mountedOn)</code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MountedPackageInfo</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Package.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Package</a> aPackage,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> mountedOn)</span></div>
<div class="block">Constructor,</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getMountedOn</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getMountedOn</span>()</div>
<div class="block">Get mounted on element qualified name.</div>
<dl class="notes">
<dt>Returns:</dt>
