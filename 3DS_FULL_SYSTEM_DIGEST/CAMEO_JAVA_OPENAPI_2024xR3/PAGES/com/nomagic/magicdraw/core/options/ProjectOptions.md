# JAVA OPENAPI: ProjectOptions (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/core/options/ProjectOptions.html
- source_path: `com/nomagic/magicdraw/core/options/ProjectOptions.html`
- source_sha256: `b69a5fc5e7e0e33abfa9a0d913c641280e5a393695c03ef54bbb41afd0b75c28`
- captured_utc: `2026-07-14T16:55:13.187984+00:00`
...
`[BaseElement](../../uml/BaseElement.html)`, `[MDElement](../../uml/MDElement.html)`, `[ProjectProvider](../../uml/ProjectProvider.html)`, `[PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html)`, `[Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[EventListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/EventListener.html)`

@OpenApiAllpublic final classProjectOptions
extends com.nomagic.magicdraw.uml.MDElementImpl
implements [Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html), [PropertyChangeListener](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/beans/PropertyChangeListener.html), [ProjectProvider](../../uml/ProjectProvider.html)
...
`static final [Predicate](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html)<[Project](../Project.html)>`
...
Creates project options with initialized defaults.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[addPersonalVisibleProperty](#addPersonalVisibleProperty(com.nomagic.magicdraw.properties.Property,java.util.function.Predicate))([Property](../../properties/Property.html) property,
 [Predicate](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html)<[Project](../Project.html)> projectPredicate)`
...
`[getCommonProjectOptions](#getCommonProjectOptions())()`
...
`[Property](../../properties/Property.html)`
`[getPersonalInvisibleProperty](#getPersonalInvisibleProperty(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)`
...
`[getUserProjectOptions](#getUserProjectOptions())()`
...
`boolean`
`[isPropertyAvailableInProject](#isPropertyAvailableInProject(java.lang.String,com.nomagic.magicdraw.properties.Property,com.nomagic.magicdraw.core.Project))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) manager,
 [Property](../../properties/Property.html) property,
...
`void`
`[readEditorWindowOptions](#readEditorWindowOptions(com.nomagic.magicdraw.properties.PropertyManager))([PropertyManager](../../properties/PropertyManager.html) manager)`
Applies corresponding persisted PropertyManager to the given manager.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PropertyManager](../../properties/PropertyManager.html)>`
`[readEditorWindowOptions](#readEditorWindowOptions(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) category)`
Returns saved editor window options property managers from category, if category null - returns all.
`static void`
...
`void`
`[removeDiagramViewOptions](#removeDiagramViewOptions(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions))(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions options)`
...
`void`
`[setCommonProjectOptions](#setCommonProjectOptions(com.nomagic.magicdraw.core.project.options.CommonProjectOptions))(com.nomagic.magicdraw.core.project.options.CommonProjectOptions commonProjectOptions)`
...
`void`
`[setRecentTypes](#setRecentTypes(java.util.List))([List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> types)`
...
`void`
`[setUserProjectOptions](#setUserProjectOptions(com.nomagic.magicdraw.core.project.options.UserProjectOptions))(com.nomagic.magicdraw.core.project.options.UserProjectOptions userProjectOptions)`
...
`void`
`[storeEditorWindowOptions](#storeEditorWindowOptions(java.util.Collection,java.lang.String))([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PropertyManager](../../properties/PropertyManager.html)> managers,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) category)`
Remember not empty property managers of given editor window options.
`static void`
...
public static final [Predicate](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html)<[Project](../Project.html)> UML_PROJECT_PREDICATE
A predicate to check if Project is UML-based.
OPTIONS_LOCK
...
`property` - property
getProperty
@CheckForNullpublic [Property](../../properties/Property.html) getProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)
Returns property from [`PROJECT_GENERAL_PROPERTIES`](#PROJECT_GENERAL_PROPERTIES) manager.
Returns:
found property
...
`property` - property
See Also:
[`Project.isUMLProject()`](../Project.html#isUMLProject())
addProperty
public void addProperty([Property](../../properties/Property.html) property,
 [Predicate](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html)<[Project](../Project.html)> projectPredicate)
Adds property into [`PROJECT_GENERAL_PROPERTIES`](#PROJECT_GENERAL_PROPERTIES) manager.
...
public boolean isPropertyAvailableInProject([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) manager,
 [Property](../../properties/Property.html) property,
 [Project](../Project.html) project)
Check if given property is available in the given project by its kind.
Parameters:
...
@CheckForNullpublic [Property](../../properties/Property.html) getPersonalInvisibleProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id)
Gets personal invisible property that affects one user in the teamwork environment.
Parameters:
`id` - property identifier
Returns:
...
public void setRecentTypes(@CheckForNull
 [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Classifier](../../../uml2/ext/magicdraw/classes/mdkernel/Classifier.html)> types)
Sets last selected metaclass for type creation
Parameters:
`types` - recent types
getRecentTypes
...
Description copied from interface: `[MDElement](../../uml/MDElement.html#getProject())`
This method is deprecated and will be removed soon.
Specified by:
`[getProject](../../uml/MDElement.html#getProject())` in interface `[MDElement](../../uml/MDElement.html)`
Specified by:
...
@NotApipublic void readEditorWindowOptions([PropertyManager](../../properties/PropertyManager.html) manager)
Applies corresponding persisted PropertyManager to the given manager.
readEditorWindowOptions
@NotApipublic [Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PropertyManager](../../properties/PropertyManager.html)> readEditorWindowOptions(@CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) category)
Returns saved editor window options property managers from category, if category null - returns all.
storeEditorWindowOptions
@NotApipublic void storeEditorWindowOptions([Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PropertyManager](../../properties/PropertyManager.html)> managers,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) category)
Remember not empty property managers of given editor window options.
removeDiagramViewOptions
@NotApipublic void removeDiagramViewOptions(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions options)
Removes corresponding PropertyManager from project options.
Parameters:
`options` - options
getCommonProjectOptions
@NotApipublic com.nomagic.magicdraw.core.project.options.CommonProjectOptions getCommonProjectOptions()
setCommonProjectOptions
@NotApipublic void setCommonProjectOptions(com.nomagic.magicdraw.core.project.options.CommonProjectOptions commonProjectOptions)
getUserProjectOptions
@NotApipublic com.nomagic.magicdraw.core.project.options.UserProjectOptions getUserProjectOptions()
setUserProjectOptions
@NotApipublic void setUserProjectOptions(com.nomagic.magicdraw.core.project.options.UserProjectOptions userProjectOptions)
setAutoNumbering
...
<div class="col-last even-row-color">
<div class="block">Creates project options with initialized defaults.</div>
</div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#addPersonalVisibleProperty(com.nomagic.magicdraw.properties.Property,java.util.function.Predicate)">addPersonalVisibleProperty</a><wbr/>(<a href="../../properties/Property.html" title="class in com.nomagic.magicdraw.properties">Property</a> property,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html" title="class or interface in java.util.function">Predicate</a>&lt;<a href="../Project.html" title="class in com.nomagic.magicdraw.core">Project</a>&gt; projectPredicate)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.core.project.options.CommonProjectOptions</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getCommonProjectOptions()">getCommonProjectOptions</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getModifiedModelElementsStyle()">getModifiedModelElementsStyle</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns default model element values.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getModulesDirectories(boolean)">getModulesDirectories</a><wbr/>(boolean resolvePathVariables)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns modules paths.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPassiveValidationSeverity()">getPassiveValidationSeverity</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../../properties/Property.html" title="class in com.nomagic.magicdraw.properties">Property</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPersonalInvisibleProperty(java.lang.String)">getPersonalInvisibleProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>com.nomagic.magicdraw.core.project.options.UserProjectOptions</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getUserProjectOptions()">getUserProjectOptions</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#readEditorWindowOptions(com.nomagic.magicdraw.properties.PropertyManager)">readEditorWindowOptions</a><wbr/>(<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a> manager)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Applies corresponding persisted PropertyManager to the given manager.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#readEditorWindowOptions(java.lang.String)">readEditorWindowOptions</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> category)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns saved editor window options property managers from category, if category null - returns all.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#removeDiagramViewOptions(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions)">removeDiagramViewOptions</a><wbr/>(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions options)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Removes corresponding PropertyManager from project options.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setBooleanProperty(boolean,java.lang.String,java.lang.String,java.lang.String,java.util.function.Predicate)">setBooleanProperty</a><wbr/>(boolean value,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> manager,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setBooleanPropertyForUMLProject(boolean,java.lang.String,java.lang.String,java.lang.String)">setBooleanPropertyForUMLProject</a><wbr/>(boolean value,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> manager,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> group)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setCommonProjectOptions(com.nomagic.magicdraw.core.project.options.CommonProjectOptions)">setCommonProjectOptions</a><wbr/>(com.nomagic.magicdraw.core.project.options.CommonProjectOptions commonProjectOptions)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setUserProjectOptions(com.nomagic.magicdraw.core.project.options.UserProjectOptions)">setUserProjectOptions</a><wbr/>(com.nomagic.magicdraw.core.project.options.UserProjectOptions userProjectOptions)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setValidateOnlyActiveDiagrams(boolean)">setValidateOnlyActiveDiagrams</a><wbr/>(boolean validateOnlyActiveDiagrams)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setValidateOnlyLocallyChangedElementsPreCommit(boolean)">setValidateOnlyLocallyChangedElementsPreCommit</a><wbr/>(boolean validateOnlyLocallyChangedElements)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setValidationIgnoredOption(java.lang.String)">setValidationIgnoredOption</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setXpdlImportLocation(java.lang.String)">setXpdlImportLocation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> importLocation)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#showDotNotationForAssociations()">showDotNotationForAssociations</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets the SHOW_DOT_NOTATION_FOR_ASSOCIATIONS property value</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#storeEditorWindowOptions(java.util.Collection,java.lang.String)">storeEditorWindowOptions</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a>&gt; managers,
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Remember not empty property managers of given editor window options.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static void</code></div>
...
<code>accept, addPropertyChangeListener, atInsert, canAdd, canAddChild, canAddChild, canAddInstance, canBeDeleted, canChangeParent, canDeleteChild, clone, compareTo, createSortKeys, dispose, firePropertyChange, generateID, getClassType, getHumanName, getHumanType, getID, getName, getObjectParent, getProjectProvider, getResourceID, getSortKeys, hasListeners, isEditable, isParentOf, removeAllParents, removeAllPropertyChangeListeners, removePropertyChangeListener, setID, setProjectProvider, setResourceIDProvider, sGetID, toString</code></div>
<div class="inherited-list">
...
<dd>
<ul class="see-list">
<li><a href="../Project.html#isUMLProject()"><code>Project.isUMLProject()</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">addProperty</span><wbr/><span class="parameters">(<a href="../../properties/Property.html" title="class in com.nomagic.magicdraw.properties">Property</a> property,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/Predicate.html" title="class or interface in java.util.function">Predicate</a>&lt;<a href="../Project.html" title="class in com.nomagic.magicdraw.core">Project</a>&gt; projectPredicate)</span></div>
<div class="block">Adds property into <a href="#PROJECT_GENERAL_PROPERTIES"><code>PROJECT_GENERAL_PROPERTIES</code></a> manager.
...
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code><a href="../../uml/MDElement.html#getProject()">MDElement</a></code></span></div>
<div class="block">This method is deprecated and will be removed soon.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="../../uml/MDElement.html#getProject()">getProject</a></code> in interface <code><a href="../../uml/MDElement.html" title="interface in com.nomagic.magicdraw.uml">MDElement</a></code></dd>
<dt>Specified by:</dt>
...
<li>
<section class="detail" id="readEditorWindowOptions(com.nomagic.magicdraw.properties.PropertyManager)">
<h3>readEditorWindowOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">readEditorWindowOptions</span><wbr/><span class="parameters">(<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a> manager)</span></div>
<div class="block">Applies corresponding persisted PropertyManager to the given manager.</div>
</section>
</li>
<li>
<section class="detail" id="readEditorWindowOptions(java.lang.String)">
<h3>readEditorWindowOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a>&gt;</span> <span class="element-name">readEditorWindowOptions</span><wbr/><span class="parameters">(@CheckForNull
...
<li>
<section class="detail" id="storeEditorWindowOptions(java.util.Collection,java.lang.String)">
<h3>storeEditorWindowOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">storeEditorWindowOptions</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../properties/PropertyManager.html" title="class in com.nomagic.magicdraw.properties">PropertyManager</a>&gt; managers,
 @CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> category)</span></div>
<div class="block">Remember not empty property managers of given editor window options.</div>
</section>
...
<li>
<section class="detail" id="removeDiagramViewOptions(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions)">
<h3>removeDiagramViewOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">removeDiagramViewOptions</span><wbr/><span class="parameters">(com.dassault_systemes.modeler.magic.ui.diagrams.editor.EditorOptions options)</span></div>
<div class="block">Removes corresponding PropertyManager from project options.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="getCommonProjectOptions()">
<h3>getCommonProjectOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.core.project.options.CommonProjectOptions</span> <span class="element-name">getCommonProjectOptions</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setCommonProjectOptions(com.nomagic.magicdraw.core.project.options.CommonProjectOptions)">
<h3>setCommonProjectOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setCommonProjectOptions</span><wbr/><span class="parameters">(com.nomagic.magicdraw.core.project.options.CommonProjectOptions commonProjectOptions)</span></div>
</section>
</li>
<li>
<section class="detail" id="getUserProjectOptions()">
<h3>getUserProjectOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">com.nomagic.magicdraw.core.project.options.UserProjectOptions</span> <span class="element-name">getUserProjectOptions</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setUserProjectOptions(com.nomagic.magicdraw.core.project.options.UserProjectOptions)">
<h3>setUserProjectOptions</h3>
<div class="member-signature"><span class="annotations">@NotApi
</span><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setUserProjectOptions</span><wbr/><span class="parameters">(com.nomagic.magicdraw.core.project.options.UserProjectOptions userProjectOptions)</span></div>
</section>
</li>
<li>
