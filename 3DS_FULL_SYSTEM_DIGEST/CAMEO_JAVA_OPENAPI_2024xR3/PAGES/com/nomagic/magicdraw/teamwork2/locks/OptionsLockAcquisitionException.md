# JAVA OPENAPI: OptionsLockAcquisitionException (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/teamwork2/locks/OptionsLockAcquisitionException.html
- source_path: `com/nomagic/magicdraw/teamwork2/locks/OptionsLockAcquisitionException.html`
- source_sha256: `bd2408d0599e4ca07c1f719b8b8fe255f15eb55f775d0c291f7057771949345f`
- captured_utc: `2026-07-14T16:55:39.269281+00:00`
...
Constructor
Description
`[OptionsLockAcquisitionException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) options)`
...
public OptionsLockAcquisitionException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) options)
Creates new instance of [`OptionsLockAcquisitionException`](OptionsLockAcquisitionException.html)
Parameters:
...
Method Details
getOptions
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getOptions()
Gets the options that could not be locked
Returns:
the options
...
<h3>getOptions</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getOptions</span>()</div>
<div class="block">Gets the options that could not be locked</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the options</dd>
