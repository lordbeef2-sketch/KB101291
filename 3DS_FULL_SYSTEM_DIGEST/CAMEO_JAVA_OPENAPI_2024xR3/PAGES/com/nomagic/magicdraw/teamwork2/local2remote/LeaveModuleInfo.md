# JAVA OPENAPI: LeaveModuleInfo (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/teamwork2/local2remote/LeaveModuleInfo.html
- source_path: `com/nomagic/magicdraw/teamwork2/local2remote/LeaveModuleInfo.html`
- source_sha256: `2dbb3676e273ffd74311e2f517d3450138c6d82e028ab4d5deed186ac04f1e0b`
- captured_utc: `2026-07-14T16:55:38.841270+00:00`
...
@OpenApipublic final classLeaveModuleInfo
...
Constructor
Description
`[LeaveModuleInfo](#%3Cinit%3E(com.nomagic.ci.persistence.IAttachedProject))(com.nomagic.ci.persistence.IAttachedProject attachedProject)`
Constructor.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Constructor Details
LeaveModuleInfo
@OpenApipublic LeaveModuleInfo(com.nomagic.ci.persistence.IAttachedProject attachedProject)
Constructor.
Parameters:
`attachedProject` - module to leave local.
...
<h1 class="title" title="Class LeaveModuleInfo">Class LeaveModuleInfo</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.teamwork2.local2remote.LeaveModuleInfo</div>
</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public final class </span><span class="element-name type-name-label">LeaveModuleInfo</span>
...
<div class="block">Leave local module resolution info. Local module will be unchanged when local project is added to teamwork.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.ci.persistence.IAttachedProject)">LeaveModuleInfo</a><wbr/>(com.nomagic.ci.persistence.IAttachedProject attachedProject)</code></div>
...
<h3>LeaveModuleInfo</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="modifiers">public</span> <span class="element-name">LeaveModuleInfo</span><wbr/><span class="parameters">(com.nomagic.ci.persistence.IAttachedProject attachedProject)</span></div>
<div class="block">Constructor.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>attachedProject</code> - module to leave local.</dd>
</dl>
</section>
</li>
</ul>
