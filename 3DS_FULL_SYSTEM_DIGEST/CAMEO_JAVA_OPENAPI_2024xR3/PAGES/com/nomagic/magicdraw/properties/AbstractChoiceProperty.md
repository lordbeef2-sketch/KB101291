# JAVA OPENAPI: AbstractChoiceProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/AbstractChoiceProperty.html
- source_path: `com/nomagic/magicdraw/properties/AbstractChoiceProperty.html`
- source_sha256: `f07a246785a5369663d5f6fbc0055663308afe48ffb68e71d2f21b640cae3f6b`
- captured_utc: `2026-07-14T16:55:27.710149+00:00`
...
`[AbstractChoiceProperty](#%3Cinit%3E(java.lang.String,java.lang.Object))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
...
AbstractChoiceProperty
public AbstractChoiceProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) value)
 ============ METHOD DETAIL ========== 
Method Details
...
the editable flag.
getChoice
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html) getChoice()
Returns list of possible values.
Returns:
...
<h3>AbstractChoiceProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AbstractChoiceProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<h3>getChoice</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a></span> <span class="element-name">getChoice</span>()</div>
<div class="block">Returns list of possible values.</div>
<dl class="notes">
<dt>Returns:</dt>
