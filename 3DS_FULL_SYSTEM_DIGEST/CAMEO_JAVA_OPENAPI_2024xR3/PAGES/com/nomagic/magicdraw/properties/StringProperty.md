# JAVA OPENAPI: StringProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/StringProperty.html
- source_path: `com/nomagic/magicdraw/properties/StringProperty.html`
- source_sha256: `f33fea70a2f1f818238c0cd9fabbec165bc0aad4e041c090595bbf5ba0488c91`
- captured_utc: `2026-07-14T16:55:29.671169+00:00`
...
`[DateTimeProperty](DateTimeProperty.html)`, `[JarEntryProperty](JarEntryProperty.html)`, `[PasswordProperty](PasswordProperty.html)`

@OpenApiAllpublic classStringProperty
...
Constructor
Description
`[StringProperty](#%3Cinit%3E())()`
Default constructor.
`[StringProperty](#%3Cinit%3E(java.lang.String,java.lang.Object))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) value)`
Deprecated.
use [`StringProperty(String, String)`](#%3Cinit%3E(java.lang.String,java.lang.String))
`[StringProperty](#%3Cinit%3E(java.lang.String,java.lang.Object,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) value,
 boolean multiline)`
Deprecated.
use [`StringProperty(String, String, boolean)`](#%3Cinit%3E(java.lang.String,java.lang.String,boolean))
`[StringProperty](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)`
The property constructor.
`[StringProperty](#%3Cinit%3E(java.lang.String,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value,
 boolean multiline)`
The property constructor.
 ========== METHOD SUMMARY =========== 
...
`[StringProperty](StringProperty.html)`
`[clone](#clone())()`
Clones the property.
...
`void`
`[setMultiline](#setMultiline(boolean))(boolean multiline)`
...
StringProperty
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public StringProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) value)
Deprecated.
use [`StringProperty(String, String)`](#%3Cinit%3E(java.lang.String,java.lang.String))
StringProperty
public StringProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)
The property constructor.
 Property is editable, and not multi lined.
Parameters:
...
clone
public [StringProperty](StringProperty.html) clone()
...
<h1 class="title" title="Class StringProperty">Class StringProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.StringProperty</div>
</div>
</div>
...
<div class="block">The property for storing and editing some String value.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">StringProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Object)">StringProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="deprecation-comment">use <a href="#%3Cinit%3E(java.lang.String,java.lang.String)"><code>StringProperty(String, String)</code></a></div>
</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Object,boolean)">StringProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 ...
 boolean multiline)</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span>
<div class="deprecation-comment">use <a href="#%3Cinit%3E(java.lang.String,java.lang.String,boolean)"><code>StringProperty(String, String, boolean)</code></a></div>
</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">StringProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,boolean)">StringProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value,
 boolean multiline)</code></div>
<div class="col-last even-row-color">
<div class="block">The property constructor.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="StringProperty.html" title="class in com.nomagic.magicdraw.properties">StringProperty</a></code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns value as String object.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isMultiline()">isMultiline</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns multiline flag.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setMultiline(boolean)">setMultiline</a><wbr/>(boolean multiline)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets the multiline flag</div>
</div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StringProperty</span>()</div>
...
</span><span class="modifiers">public</span> <span class="element-name">StringProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<h3>StringProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StringProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<div class="block">The property constructor.
 Property is editable, and not multi lined.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StringProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 ...
 boolean multiline)</span></div>
<div class="block">The property constructor.
 Property is editable.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of property.</dd>
<dd><code>value</code> - value of the property.</dd>
<dd><code>multiline</code> - the multiline flag value.</dd>
</dl>
</section>
</li>
</ul>
...
<li>
<section class="detail" id="isMultiline()">
<h3>isMultiline</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isMultiline</span>()</div>
<div class="block">Returns multiline flag.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the multiline flag.</dd>
</dl>
</section>
</li>
<li>
...
<h3>setMultiline</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setMultiline</span><wbr/><span class="parameters">(boolean multiline)</span></div>
<div class="block">Sets the multiline flag</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>multiline</code> - the multiline flag value.</dd>
...
<h3>getString</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getString</span>()</div>
<div class="block">Returns value as String object.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>String object.</dd>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="StringProperty.html" title="class in com.nomagic.magicdraw.properties">StringProperty</a></span> <span class="element-name">clone</span>()</div>
