# JAVA OPENAPI: PasswordProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/PasswordProperty.html
- source_path: `com/nomagic/magicdraw/properties/PasswordProperty.html`
- source_sha256: `d2d95b8ff3cfef1e7293925c99220a3d6e00396d2316c52168f11b73cad2197b`
- captured_utc: `2026-07-14T16:55:28.687158+00:00`
...
com.nomagic.magicdraw.properties.PasswordProperty
...
@OpenApiAllpublic classPasswordProperty
...
Constructor
Description
`[PasswordProperty](#%3Cinit%3E())()`
Default constructor.
`[PasswordProperty](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
...
`[PasswordProperty](PasswordProperty.html)`
`[clone](#clone())()`
Clones the property.
...
Default constructor. Value of the property will be null.
 Property will be editable.
 ID will be empty string.
PasswordProperty
public PasswordProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)
The property constructor.
 Property will be editable.
...
Returns:
PropertyID.PASSWORD_PROPERTY
See Also:
[`PropertyID.PASSWORD_PROPERTY`](PropertyID.html#PASSWORD_PROPERTY)
clone
public [PasswordProperty](PasswordProperty.html) clone()
...
<h1 class="title" title="Class PasswordProperty">Class PasswordProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.PasswordProperty</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PasswordProperty</span>
...
<div class="block">The property for storing and editing some password(as string).</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PasswordProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">PasswordProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="PasswordProperty.html" title="class in com.nomagic.magicdraw.properties">PasswordProperty</a></code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PasswordProperty</span>()</div>
...
<h3>PasswordProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PasswordProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 @CheckForNull
...
<div class="block">The property constructor.
 Property will be editable.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of property.</dd>
<dd><code>value</code> - the string value of the property.</dd>
</dl>
</section>
</li>
</ul>
...
<div class="block"><span class="descfrm-type-label">Description copied from class: <code><a href="StringProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor)">StringProperty</a></code></span></div>
<div class="block">Accepts the given visitor.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<dt>Returns:</dt>
<dd>PropertyID.PASSWORD_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="PropertyID.html#PASSWORD_PROPERTY"><code>PropertyID.PASSWORD_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="PasswordProperty.html" title="class in com.nomagic.magicdraw.properties">PasswordProperty</a></span> <span class="element-name">clone</span>()</div>
