# JAVA OPENAPI: ListProperty (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/properties/ListProperty.html
- source_path: `com/nomagic/magicdraw/properties/ListProperty.html`
- source_sha256: `b81451732f4df944a6caf0d0962af480d3ca4aadf701d7b113237972a1b3d71a`
- captured_utc: `2026-07-14T16:55:28.260153+00:00`
...
`[ListProperty](#%3Cinit%3E(java.lang.String,java.lang.Object%5B%5D))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
...
ListProperty
public ListProperty([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) id,
 [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html)[] value)
Creates and initializes a new `ListProperty` object from
 specified parameters.
Parameters:
...
`value` - a value.
Throws:
`[IllegalArgumentException](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/IllegalArgumentException.html)` - if specified value is not
...
<h3>ListProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ListProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang">IllegalArgumentException</a></code> - if specified value is not
