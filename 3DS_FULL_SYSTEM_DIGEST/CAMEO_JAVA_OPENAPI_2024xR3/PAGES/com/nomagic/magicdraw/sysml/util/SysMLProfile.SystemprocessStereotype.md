# JAVA OPENAPI: SysMLProfile.SystemprocessStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/sysml/util/SysMLProfile.SystemprocessStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.SystemprocessStereotype.html`
- source_sha256: `606b46ca3c1c03224887cf4b6a9bbd7c9b53c63e63a744a6c7f5834a8855c6b6`
- captured_utc: `2026-07-14T16:55:37.830263+00:00`
...
## Class SysMLProfile.SystemprocessStereotype
...
com.nomagic.magicdraw.sysml.util.SysMLProfile.SystemprocessStereotype

Enclosing class:
[SysMLProfile](SysMLProfile.html)

public static classSysMLProfile.SystemprocessStereotype
...
Description
`protected`
`[SystemprocessStereotype](#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile))([SysMLProfile](SysMLProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.SystemprocessStereotype.STEREOTYPE_NAME)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
SystemprocessStereotype
protected SystemprocessStereotype([SysMLProfile](SysMLProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
<h1 class="title" title="Class SysMLProfile.SystemprocessStereotype">Class SysMLProfile.SystemprocessStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.SystemprocessStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SysMLProfile.SystemprocessStereotype</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile)">SystemprocessStereotype</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.SystemprocessStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>SystemprocessStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">SystemprocessStereotype</span><wbr/><span class="parameters">(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
