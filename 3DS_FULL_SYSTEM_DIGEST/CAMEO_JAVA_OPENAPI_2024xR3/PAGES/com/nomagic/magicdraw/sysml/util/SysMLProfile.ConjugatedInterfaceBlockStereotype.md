# JAVA OPENAPI: SysMLProfile.ConjugatedInterfaceBlockStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/sysml/util/SysMLProfile.ConjugatedInterfaceBlockStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.ConjugatedInterfaceBlockStereotype.html`
- source_sha256: `5bc6950e76f3e00fc6e513e967b1d76005b9c1754f66587e254c94ee85691af3`
- captured_utc: `2026-07-14T16:55:36.185242+00:00`
...
ORIGINAL
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ORIGINAL
The original Interface Block of the conjugated Interface Block that has the same features as the original, except its Directed Features and Flow Properties are reversed.
See Also:
...
<h3>ORIGINAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ORIGINAL</span></div>
<div class="block">The original Interface Block of the conjugated Interface Block that has the same features as the original, except its Directed Features and Flow Properties are reversed.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
