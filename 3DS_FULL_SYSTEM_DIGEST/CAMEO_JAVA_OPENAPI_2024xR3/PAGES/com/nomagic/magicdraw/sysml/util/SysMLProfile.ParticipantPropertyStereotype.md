# JAVA OPENAPI: SysMLProfile.ParticipantPropertyStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/sysml/util/SysMLProfile.ParticipantPropertyStereotype.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.ParticipantPropertyStereotype.html`
- source_sha256: `b8cbdf5fff098ec1650144bd6fdae69dc2dbff1429c87507b6e9707e84c12a69`
- captured_utc: `2026-07-14T16:55:37.445256+00:00`
...
com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype

Enclosing class:
[SysMLProfile](SysMLProfile.html)

public static classSysMLProfile.ParticipantPropertyStereotype
...
Description
`protected`
`[ParticipantPropertyStereotype](#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile))([SysMLProfile](SysMLProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearEnd](#clearEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)`
`[getEnd](#getEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)`

`[Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html)`
`[getEndProperty](#getEndProperty())()`
...
`void`
`[setEnd](#setEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype.STEREOTYPE_NAME)
END
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) END
A member end of the association block owning the property on which the stereotype is applied.
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype.END)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
ParticipantPropertyStereotype
protected ParticipantPropertyStereotype([SysMLProfile](SysMLProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
stereotype
getEndProperty
@CheckForNullpublic [Property](../../../uml2/ext/magicdraw/classes/mdkernel/Property.html) getEndProperty()
setEnd
public void setEnd([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) value)
clearEnd
public void clearEnd([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
getEnd
@CheckForNullpublic [Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getEnd([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class SysMLProfile.ParticipantPropertyStereotype">Class SysMLProfile.ParticipantPropertyStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SysMLProfile.ParticipantPropertyStereotype</span>
...
<div class="block">A member end of the association block owning the property on which the stereotype is applied.</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.sysml.util.SysMLProfile)">ParticipantPropertyStereotype</a><wbr/>(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearEnd</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getEnd</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getEndProperty()">getEndProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setEnd</a><wbr/>(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="see-list">
<li><a href="../../../../../constant-values.html#com.nomagic.magicdraw.sysml.util.SysMLProfile.ParticipantPropertyStereotype.END">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>ParticipantPropertyStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">ParticipantPropertyStereotype</span><wbr/><span class="parameters">(<a href="SysMLProfile.html" title="class in com.nomagic.magicdraw.sysml.util">SysMLProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getEndProperty()">
<h3>getEndProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getEndProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setEnd</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setEnd</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearEnd</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearEnd</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getEnd(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getEnd</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getEnd</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
