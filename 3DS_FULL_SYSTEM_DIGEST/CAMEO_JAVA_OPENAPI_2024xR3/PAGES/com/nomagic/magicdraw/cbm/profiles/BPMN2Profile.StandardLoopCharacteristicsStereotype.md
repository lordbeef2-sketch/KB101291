# JAVA OPENAPI: BPMN2Profile.StandardLoopCharacteristicsStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.StandardLoopCharacteristicsStereotype.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.StandardLoopCharacteristicsStereotype.html`
- source_sha256: `174e50383cfc4f16cc9cb4b22c239f2d3f9afeb066e220b15db63c6750220125`
- captured_utc: `2026-07-14T16:55:09.866951+00:00`
...
LOOPCONDITION
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) LOOPCONDITION
...
LOOPMAXIMUM
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) LOOPMAXIMUM
Serves as a cap on the number of iterations.
See Also:
...
TESTBEFORE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) TESTBEFORE
Flag that controls whether the loop condition is evaluated at the beginning (testBefore = true) or at the end (testBefore = false) of the loop iteration.
See Also:
...
getLoopCondition
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getLoopCondition([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setLoopCounter
...
getLoopMaximum
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getLoopMaximum([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setTestBefore
...
isTestBefore
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isTestBefore([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h3>LOOPMAXIMUM</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">LOOPMAXIMUM</span></div>
<div class="block">Serves as a cap on the number of iterations.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>TESTBEFORE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">TESTBEFORE</span></div>
<div class="block">Flag that controls whether the loop condition is evaluated at the beginning (testBefore = true) or at the end (testBefore = false) of the loop iteration.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
