# JAVA OPENAPI: BPMN2Profile.DataStoreStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.DataStoreStereotype.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.DataStoreStereotype.html`
- source_sha256: `5fd57c48461edc2fd238071475d98d2615d24d09cdde0845faf679cfab759fc5`
- captured_utc: `2026-07-14T16:55:06.115906+00:00`
...
CAPACITY
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) CAPACITY
...
ISUNLIMITED
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ISUNLIMITED
If isUnlimited is set to true, then the capacity of a Data Store is set as unlimited and will override any value of the capacity attribute.
See Also:
...
getCapacity
@CheckForNullpublic [Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html) getCapacity([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setIsUnlimited
...
isIsUnlimited
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isIsUnlimited([Element](../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setId
...
<h3>CAPACITY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">CAPACITY</span></div>
...
<h3>ISUNLIMITED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ISUNLIMITED</span></div>
<div class="block">If isUnlimited is set to true, then the capacity of a Data Store is set as unlimited and will override any value of the capacity attribute.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
