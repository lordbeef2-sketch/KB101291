# JAVA OPENAPI: CodeEngineeringManager (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/ce/CodeEngineeringManager.html
- source_path: `com/nomagic/magicdraw/ce/CodeEngineeringManager.html`
- source_sha256: `b339d381ead9b24b03899897307ff6ee01b67cc88dbf3270f58e1dc914e3a2d9`
- captured_utc: `2026-07-14T16:55:11.155961+00:00`
...
public static [CodeEngineeringSet](CodeEngineeringSet.html) createCodeEngineeringSet([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) language,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) dialect,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name,
 [Project](../core/Project.html) project,
...
public static [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[CodeEngineeringSet](CodeEngineeringSet.html)> getAllCodeEngineeringSets([Project](../core/Project.html) project)
Given a project, returns list of all available code engineering sets.
Parameters:
...
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html)public static void setClassFieldCreationType([Project](../core/Project.html) project,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) language,
 boolean asAttribute)
 throws [IllegalStateException](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/IllegalStateException.html)
Deprecated.
