# JAVA OPENAPI: UAF.ActualRiskStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uaf/UAF.ActualRiskStereotype.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ActualRiskStereotype.html`
- source_sha256: `c390cd1a5ae6dbc9e7bb957cf9e52f0ca367fe20225a7c9f9d0f4a9d8f9739d7`
- captured_utc: `2026-07-14T16:55:40.980294+00:00`
...
ACTUALRISKOWNER
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) ACTUALRISKOWNER
Enables association of an ActualRisk to an actual organizational role that is responsible for executing the actual mitigation.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) AFFECTEDACTUALRESOURCE
Asserts that an ActualRisk is applicable to an ActualResource.
See Also:
