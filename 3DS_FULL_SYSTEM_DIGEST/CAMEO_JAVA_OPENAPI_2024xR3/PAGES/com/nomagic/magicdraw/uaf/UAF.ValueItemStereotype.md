# JAVA OPENAPI: UAF.ValueItemStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/uaf/UAF.ValueItemStereotype.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ValueItemStereotype.html`
- source_sha256: `7c3b5b6041d8e510e36a9e230551b8d7af4def798744bd392486a44ed33e8b86`
- captured_utc: `2026-07-14T16:55:50.012399+00:00`
...
APPLIESFOR
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) APPLIESFOR
Relates the MeasurementSet to the MeasurableElement that it is applicable to.
See Also:
...
QUANTITYKIND
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) QUANTITYKIND
...
UNIT
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) UNIT
A quantity in terms of which the magnitudes of other quantities that have the same dimension can be stated, as identified by an instance of the Unit stereotype.
See Also:
...
public void removeAppliesFor([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) value)
getAppliesFor
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getAppliesFor([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setURI
...
<h3>APPLIESFOR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">APPLIESFOR</span></div>
<div class="block">Relates the MeasurementSet to the MeasurableElement that it is applicable to.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>UNIT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">UNIT</span></div>
<div class="block">A quantity in terms of which the magnitudes of other quantities that have the same dimension can be stated, as identified by an instance of the Unit stereotype.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
