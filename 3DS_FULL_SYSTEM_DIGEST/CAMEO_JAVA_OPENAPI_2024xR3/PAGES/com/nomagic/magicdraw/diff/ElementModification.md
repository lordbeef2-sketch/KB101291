# JAVA OPENAPI: ElementModification (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/magicdraw/diff/ElementModification.html
- source_path: `com/nomagic/magicdraw/diff/ElementModification.html`
- source_sha256: `ddc57af1cc54646db755f2e8100ec31ed2250f30447f7db3292efbe641431859`
- captured_utc: `2026-07-14T16:55:15.905015+00:00`
...
Description
`void`
`[accept](#accept(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor))(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor visitor)`
...
@OpenApi[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getChangedPropertyName()
Get modified property/feature name.
Returns:
changed property name.
accept
void accept(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor visitor)
Parameters:
`visitor` - visitor.
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#accept(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor)">accept</a><wbr/>(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor visitor)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getChangedPropertyName()">getChangedPropertyName</a>()</code></div>
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getChangedPropertyName</span>()</div>
<div class="block">Get modified property/feature name.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="accept(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor)">
<h3>accept</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">accept</span><wbr/><span class="parameters">(com.nomagic.magicdraw.merge.impl.ui.ExtendedDifferenceVisitor visitor)</span></div>
<dl class="notes">
<dt>Parameters:</dt>
