# JAVA OPENAPI: UPDMProfile.ActualOrganizationStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/updm/utils/UPDMProfile.ActualOrganizationStereotype.html
- source_path: `com/nomagic/updm/utils/UPDMProfile.ActualOrganizationStereotype.html`
- source_sha256: `784bc7602b27e5a56115172ea08608bad142c20ca662990536ee66bb71cc4b8b`
- captured_utc: `2026-07-14T16:56:30.577852+00:00`
...
CODE_SYMBOL
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) CODE_SYMBOL
Army, Navy, Air Force, Marine Corps, Joint
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.updm.utils.UPDMProfile.ActualOrganizationStereotype.CODE_SYMBOL)
RATIFIEDSTANDARDS
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) RATIFIEDSTANDARDS
Standards that were ratified by this ActualOrganization
See Also:
...
SERVICETYPE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SERVICETYPE
Service office code or symbol
See Also:
...
getCodesymbol
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getCodesymbol([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
...
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getRatifiedStandards([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setServiceType
...
getServiceType
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getServiceType([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setPhysicalLocation
...
<h3>CODE_SYMBOL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">CODE_SYMBOL</span></div>
<div class="block">Army, Navy, Air Force, Marine Corps, Joint</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>SERVICETYPE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SERVICETYPE</span></div>
<div class="block">Service office code or symbol</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
