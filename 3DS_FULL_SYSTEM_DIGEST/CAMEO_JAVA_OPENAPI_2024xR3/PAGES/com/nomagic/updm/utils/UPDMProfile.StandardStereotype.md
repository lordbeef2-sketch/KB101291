# JAVA OPENAPI: UPDMProfile.StandardStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/updm/utils/UPDMProfile.StandardStereotype.html
- source_path: `com/nomagic/updm/utils/UPDMProfile.StandardStereotype.html`
- source_sha256: `df0585cd620ea556c7b07bfefb6feb8abfa907324ebde2b12a3a05b14bacff75`
- captured_utc: `2026-07-14T16:56:39.959957+00:00`
...
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) INFORMATIONTECHNOLOGYSTANDARDCATEGORY
The information technology standard category which the <> belongs to.
See Also:
...
CURRENTSTATUS
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) CURRENTSTATUS
Current status of the Standard.
See Also:
...
SHORTNAME
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) SHORTNAME
Short name of the Standard.
See Also:
...
public [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)> getInformationTechnologyStandardCategory([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setCurrentStatus
...
getCurrentStatus
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getCurrentStatus([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setMandatedDate
...
getShortName
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getShortName([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setVersion
...
<div class="col-last even-row-color">
<div class="block">The information technology standard category which the &lt;<standard>&gt; belongs to.</standard></div>
</div>
<div class="col-first odd-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></code></div>
...
<h3>SHORTNAME</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SHORTNAME</span></div>
<div class="block">Short name of the Standard.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
