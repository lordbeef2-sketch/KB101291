# JAVA OPENAPI: SetFontFaceAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/actions/SetFontFaceAction.html
- source_path: `com/nomagic/actions/SetFontFaceAction.html`
- source_sha256: `959548fc3a8b95db249fb43f0264cae17af4f95bb7ebdfc263aa1c30a9c0ac22`
- captured_utc: `2026-07-14T16:55:01.610856+00:00`
...
`void`
`[setFontFace](#setFontFace(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) newFontFace)`
...
Field Details
FONT_FACE
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) FONT_FACE
The value of font face property key.
See Also:
...
Method Details
getFontFace
public [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getFontFace()
Returns selected font face value.
Returns:
selected font face name.
setFontFace
public void setFontFace([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) newFontFace)
Sets new font face value.
Parameters:
`newFontFace` - value.
...
<h3>FONT_FACE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">FONT_FACE</span></div>
<div class="block">The value of font face property key.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<h3>getFontFace</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getFontFace</span>()</div>
<div class="block">Returns selected font face value.</div>
<dl class="notes">
<dt>Returns:</dt>
