# JAVA OPENAPI: AlphaCompositeIcon (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/ui/AlphaCompositeIcon.html
- source_path: `com/nomagic/ui/AlphaCompositeIcon.html`
- source_sha256: `e9fbc64b58c8b6f559ae9febe27f0ec9b39517d14a1c374653eb1aaa1f32387d`
- captured_utc: `2026-07-14T16:56:09.627616+00:00`
...
`[ResizableIcon](ResizableIcon.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html)`
...
Constructor
Description
`[AlphaCompositeIcon](#%3Cinit%3E(javax.swing.Icon))([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon)`

`[AlphaCompositeIcon](#%3Cinit%3E(javax.swing.Icon,java.awt.Composite))([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [Composite](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Composite.html) composite)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
Constructor Details
AlphaCompositeIcon
public AlphaCompositeIcon([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon)
AlphaCompositeIcon
public AlphaCompositeIcon([Icon](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [Composite](https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Composite.html) composite)
 ============ METHOD DETAIL ========== 
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(javax.swing.Icon,java.awt.Composite)">AlphaCompositeIcon</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a> icon,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Composite.html" title="class or interface in java.awt">Composite</a> composite)</code></div>
...
<h3>AlphaCompositeIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">AlphaCompositeIcon</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a> icon,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Composite.html" title="class or interface in java.awt">Composite</a> composite)</span></div>
</section>
</li>
</ul>
</section>
