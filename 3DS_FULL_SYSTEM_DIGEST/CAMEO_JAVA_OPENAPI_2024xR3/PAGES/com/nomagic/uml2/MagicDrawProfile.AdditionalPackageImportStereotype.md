# JAVA OPENAPI: MagicDrawProfile.AdditionalPackageImportStereotype (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/MagicDrawProfile.AdditionalPackageImportStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.AdditionalPackageImportStereotype.html`
- source_sha256: `689d112aca8fd21cfb33809286b385c4b030828ca69624ca15f4152c44b70772`
- captured_utc: `2026-07-14T16:56:10.375626+00:00`
...
## Class MagicDrawProfile.AdditionalPackageImportStereotype
...
com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype

Enclosing class:
[MagicDrawProfile](MagicDrawProfile.html)

public static classMagicDrawProfile.AdditionalPackageImportStereotype
...
`static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)`
`[TREATASAUXILIARYINOWNINGPROJECT](#TREATASAUXILIARYINOWNINGPROJECT)`
 ======== CONSTRUCTOR SUMMARY ======== 
Constructor Summary
Constructors
Modifier
...
Description
`protected`
`[AdditionalPackageImportStereotype](#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile))([MagicDrawProfile](MagicDrawProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearTreatAsAuxiliaryInOwningProject](#clearTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`[getTreatAsAuxiliaryInOwningProjectProperty](#getTreatAsAuxiliaryInOwningProjectProperty())()`
...
`[isTreatAsAuxiliaryInOwningProject](#isTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`void`
`[setTreatAsAuxiliaryInOwningProject](#setTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype.STEREOTYPE_NAME)
TREATASAUXILIARYINOWNINGPROJECT
public static final [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) TREATASAUXILIARYINOWNINGPROJECT
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype.TREATASAUXILIARYINOWNINGPROJECT)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
AdditionalPackageImportStereotype
protected AdditionalPackageImportStereotype([MagicDrawProfile](MagicDrawProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getTreatAsAuxiliaryInOwningProjectProperty()
setTreatAsAuxiliaryInOwningProject
public void setTreatAsAuxiliaryInOwningProject([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) value)
clearTreatAsAuxiliaryInOwningProject
public void clearTreatAsAuxiliaryInOwningProject([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
isTreatAsAuxiliaryInOwningProject
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html) isTreatAsAuxiliaryInOwningProject([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class MagicDrawProfile.AdditionalPackageImportStereotype">Class MagicDrawProfile.AdditionalPackageImportStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">MagicDrawProfile.AdditionalPackageImportStereotype</span>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#TREATASAUXILIARYINOWNINGPROJECT">TREATASAUXILIARYINOWNINGPROJECT</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile)">AdditionalPackageImportStereotype</a><wbr/>(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearTreatAsAuxiliaryInOwningProject</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getTreatAsAuxiliaryInOwningProjectProperty()">getTreatAsAuxiliaryInOwningProjectProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">isTreatAsAuxiliaryInOwningProject</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean)">setTreatAsAuxiliaryInOwningProject</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
...
<dd>
<ul class="see-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="TREATASAUXILIARYINOWNINGPROJECT">
<h3>TREATASAUXILIARYINOWNINGPROJECT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">TREATASAUXILIARYINOWNINGPROJECT</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.AdditionalPackageImportStereotype.TREATASAUXILIARYINOWNINGPROJECT">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>AdditionalPackageImportStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">AdditionalPackageImportStereotype</span><wbr/><span class="parameters">(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getTreatAsAuxiliaryInOwningProjectProperty()">
<h3>getTreatAsAuxiliaryInOwningProjectProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getTreatAsAuxiliaryInOwningProjectProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.lang.Boolean)">
<h3>setTreatAsAuxiliaryInOwningProject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setTreatAsAuxiliaryInOwningProject</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
...
<li>
<section class="detail" id="clearTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearTreatAsAuxiliaryInOwningProject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearTreatAsAuxiliaryInOwningProject</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="isTreatAsAuxiliaryInOwningProject(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>isTreatAsAuxiliaryInOwningProject</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a></span> <span class="element-name">isTreatAsAuxiliaryInOwningProject</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
