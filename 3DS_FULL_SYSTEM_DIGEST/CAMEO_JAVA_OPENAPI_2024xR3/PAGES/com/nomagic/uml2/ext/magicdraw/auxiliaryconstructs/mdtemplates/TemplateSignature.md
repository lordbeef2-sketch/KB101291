# JAVA OPENAPI: TemplateSignature (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdtemplates/TemplateSignature.html
- source_path: `com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdtemplates/TemplateSignature.html`
- source_sha256: `4acab9874f8ddf658aa97314de51d89a6ab5a7f9c083b8167531fb30c3693456`
- captured_utc: `2026-07-14T16:56:20.531739+00:00`
...
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[TemplateParameter](TemplateParameter.html)>`
...
Method Details
getParameter
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[TemplateParameter](TemplateParameter.html)> getParameter()
Returns the value of the '***Parameter***' reference list.
...
Generated:
getOwnedParameter
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[TemplateParameter](TemplateParameter.html)> getOwnedParameter()
Returns the value of the '***Owned Parameter***' containment reference list.
 The list contents are of type [`TemplateParameter`](TemplateParameter.html).
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[TemplateBinding](TemplateBinding.html)> get_templateBindingOfSignature()
Returns the value of the '***template Binding Of Signature***' reference list.
