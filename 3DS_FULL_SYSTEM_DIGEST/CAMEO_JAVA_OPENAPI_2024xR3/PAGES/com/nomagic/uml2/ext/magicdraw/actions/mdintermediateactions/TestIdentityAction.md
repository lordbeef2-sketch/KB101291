# JAVA OPENAPI: TestIdentityAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/TestIdentityAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/TestIdentityAction.html`
- source_sha256: `44f08f466f510820e3a392017ca0c389858e2adaa1a0d19f39f8ec984bb70aaa`
- captured_utc: `2026-07-14T16:56:18.851719+00:00`
...
public interfaceTestIdentityActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getTestIdentityAction()`](../../metadata/UMLPackage.html#getTestIdentityAction())
Model:
...
`void`
`[setFirst](#setFirst(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*First*`](#getFirst())' containment reference.
`void`
...
`void`
`[setSecond](#setSecond(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*Second*`](#getSecond())' containment reference.
...
Method Details
getFirst
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getFirst()
Returns the value of the '***First***' containment reference.
 It is bidirectional and its opposite is
 '[`*test Identity Action Of First*`](../mdbasicactions/InputPin.html#get_testIdentityActionOfFirst())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setFirst(InputPin)`](#setFirst(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getTestIdentityAction_First()`](../../metadata/UMLPackage.html#getTestIdentityAction_First())
[`InputPin.get_testIdentityActionOfFirst()`](../mdbasicactions/InputPin.html#get_testIdentityActionOfFirst())
Model:
opposite="_testIdentityActionOfFirst" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setFirst
void setFirst(@CheckForNull
...
Generated:
getSecond
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getSecond()
Returns the value of the '***Second***' containment reference.
 It is bidirectional and its opposite is
 '[`*test Identity Action Of Second*`](../mdbasicactions/InputPin.html#get_testIdentityActionOfSecond())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setSecond(InputPin)`](#setSecond(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getTestIdentityAction_Second()`](../../metadata/UMLPackage.html#getTestIdentityAction_Second())
[`InputPin.get_testIdentityActionOfSecond()`](../mdbasicactions/InputPin.html#get_testIdentityActionOfSecond())
Model:
opposite="_testIdentityActionOfSecond" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setSecond
void setSecond(@CheckForNull
 [InputPin](../mdbasicactions/InputPin.html) value)
Sets the value of the '[`*Second*`](#getSecond())' containment reference.
 begin-user-doc 
 end-user-doc
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is
 '[`*test Identity Action Of Result*`](../mdbasicactions/OutputPin.html#get_testIdentityActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getTestIdentityAction_Result()`](../../metadata/UMLPackage.html#getTestIdentityAction_Result())
[`OutputPin.get_testIdentityActionOfResult()`](../mdbasicactions/OutputPin.html#get_testIdentityActionOfResult())
Model:
...
<h1 class="title" title="Interface TestIdentityAction">Interface TestIdentityAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">TestIdentityAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getFirst()"><code><em>First</em></code></a></li>
<li><a href="#getSecond()"><code><em>Second</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getTestIdentityAction()"><code>UMLPackage.getTestIdentityAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getFirst()">getFirst</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>First</b></em>' containment reference.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSecond()">getSecond</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Second</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setFirst(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setFirst</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getFirst()"><code><em>First</em></code></a>' containment reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setResult(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)">setResult</a><wbr/>(<a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getResult()"><code><em>Result</em></code></a>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setSecond(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setSecond</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getSecond()"><code><em>Second</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getFirst</span>()</div>
<div class="block">Returns the value of the '<em><b>First</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_testIdentityActionOfFirst()"><code><em>test Identity Action Of First</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin on which the first input object is placed.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>First</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setFirst(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setFirst(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTestIdentityAction_First()"><code>UMLPackage.getTestIdentityAction_First()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_testIdentityActionOfFirst()"><code>InputPin.get_testIdentityActionOfFirst()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_testIdentityActionOfFirst" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setFirst(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setFirst</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setFirst</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getFirst()"><code><em>First</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>First</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getFirst()"><code>getFirst()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getSecond()">
<h3>getSecond</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getSecond</span>()</div>
<div class="block">Returns the value of the '<em><b>Second</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_testIdentityActionOfSecond()"><code><em>test Identity Action Of Second</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the second input object is placed.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Second</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setSecond(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setSecond(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTestIdentityAction_Second()"><code>UMLPackage.getTestIdentityAction_Second()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_testIdentityActionOfSecond()"><code>InputPin.get_testIdentityActionOfSecond()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_testIdentityActionOfSecond" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setSecond(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setSecond</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSecond</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getSecond()"><code><em>Second</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Second</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getSecond()"><code>getSecond()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_testIdentityActionOfResult()"><code><em>test Identity Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin whose Boolean value indicates whether the two input objects are identical.
...
<li><a href="../../metadata/UMLPackage.html#getTestIdentityAction_Result()"><code>UMLPackage.getTestIdentityAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_testIdentityActionOfResult()"><code>OutputPin.get_testIdentityActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_testIdentityActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
