# JAVA OPENAPI: ExpansionRegion (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionRegion.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionRegion.html`
- source_sha256: `8cdefe6addb80738fe132c1e9c6860f4cc7de0514e62d07fabe7f5eb24800786`
- captured_utc: `2026-07-14T16:56:19.841730+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)>`
...
Generated:
getOutputElement
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)> getOutputElement()
Returns the value of the '***Output Element***' reference list.
...
Generated:
getInputElement
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)> getInputElement()
Returns the value of the '***Input Element***' reference list.
 The list contents are of type [`ExpansionNode`](ExpansionNode.html).
 It is bidirectional and its opposite is
