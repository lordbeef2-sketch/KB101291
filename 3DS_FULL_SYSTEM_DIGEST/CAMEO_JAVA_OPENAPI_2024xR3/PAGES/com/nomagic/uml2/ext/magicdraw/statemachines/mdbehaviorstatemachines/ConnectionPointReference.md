# JAVA OPENAPI: ConnectionPointReference (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/ConnectionPointReference.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/ConnectionPointReference.html`
- source_sha256: `9d5ebaddb74ebbd63ac4240666a030da439e3e5436ef9a1627d5b97b00b9da75`
- captured_utc: `2026-07-14T16:56:25.735798+00:00`
...
Method Details
getEntry
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)> getEntry()
Returns the value of the '***Entry***' reference list.
...
Generated:
getExit
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)> getExit()
Returns the value of the '***Exit***' reference list.
 The list contents are of type [`Pseudostate`](Pseudostate.html).
...
<div class="block">Returns the value of the '<em><b>Entry</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<code>.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfEntry <em>connection Point Reference Of Entry</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The entryPoint Pseudostates corresponding to this connection point.
...
<div class="block">Returns the value of the '<em><b>Exit</b></em>' reference list.
 The list contents are of type <a href="Pseudostate.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>Pseudostate</code></a>.
 It is bidirectional and its opposite is '<code>.mdbehaviorstatemachines.Pseudostate#get_connectionPointReferenceOfExit <em>connection Point Reference Of Exit</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The exitPoints kind Pseudostates corresponding to this connection point.
