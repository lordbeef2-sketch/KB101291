# JAVA OPENAPI: Interaction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/Interaction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/Interaction.html`
- source_sha256: `03d90d27ec9709c869c50c792eecd5045a40315b14ec60e0197d84a2ad7a48fe`
- captured_utc: `2026-07-14T16:56:24.807788+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InteractionUse](../mdfragments/InteractionUse.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Action](../../actions/mdbasicactions/Action.html)>`
`[getAction](#getAction())()`
Returns the value of the '***Action***' containment reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Gate](../mdfragments/Gate.html)>`
`[getFormalGate](#getFormalGate())()`
Returns the value of the '***Formal Gate***' containment reference list.
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[InteractionFragment](InteractionFragment.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Message](Message.html)>`
...
Method Details
getMessage
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Message](Message.html)> getMessage()
Returns the value of the '***Message***' containment reference list.
...
Generated:
getFragment
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[InteractionFragment](InteractionFragment.html)> getFragment()
Returns the value of the '***Fragment***' containment reference list.
...
Generated:
getAction
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Action](../../actions/mdbasicactions/Action.html)> getAction()
Returns the value of the '***Action***' containment reference list.
...
Generated:
getFormalGate
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Gate](../mdfragments/Gate.html)> getFormalGate()
Returns the value of the '***Formal Gate***' containment reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InteractionUse](../mdfragments/InteractionUse.html)> get_interactionUseOfRefersTo()
Returns the value of the '***interaction Use Of Refers To***' reference list.
...
Generated:
getLifeline
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Lifeline](Lifeline.html)> getLifeline()
Returns the value of the '***Lifeline***' containment reference list.
