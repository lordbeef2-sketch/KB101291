# JAVA OPENAPI: InteractionConstraint (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/interactions/mdfragments/InteractionConstraint.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdfragments/InteractionConstraint.html`
- source_sha256: `ab7379be143379910614345a3ffdedb6afbcac1a72ea7ddde9df376412e6c4a5`
- captured_utc: `2026-07-14T16:56:25.158791+00:00`
...
The following features are supported:
 [`*Maxint*`](#getMaxint())
[`*Minint*`](#getMinint())
[`*interaction Operand Of Guard*`](#get_interactionOperandOfGuard())

See Also:
[`UMLPackage.getInteractionConstraint()`](../../metadata/UMLPackage.html#getInteractionConstraint())
Model:
...
Method
Description
`[InteractionOperand](InteractionOperand.html)`
`[get_interactionOperandOfGuard](#get_interactionOperandOfGuard())()`
...
`void`
`[set_interactionOperandOfGuard](#set_interactionOperandOfGuard(com.nomagic.uml2.ext.magicdraw.interactions.mdfragments.InteractionOperand))([InteractionOperand](InteractionOperand.html) value)`
Sets the value of the '[`*interaction Operand
 Of Guard*`](#get_interactionOperandOfGuard())' container reference.
`void`
`[setMaxint](#setMaxint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
Sets the value of the '[`*Maxint*`](#getMaxint())' containment reference.
`void`
`[setMinint](#setMinint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
Sets the value of the '[`*Minint*`](#getMinint())' containment reference.
...
Method Details
getMinint
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getMinint()
Returns the value of the '***Minint***' containment reference.
 It is bidirectional and its opposite is
 '[`*interaction Constraint Of Minint*`](../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMinint())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMinint(ValueSpecification)`](#setMinint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getInteractionConstraint_Minint()`](../../metadata/UMLPackage.html#getInteractionConstraint_Minint())
[`ValueSpecification.get_interactionConstraintOfMinint()`](../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMinint())
Model:
opposite="_interactionConstraintOfMinint" containment="true" resolveProxies="true" ordered="false"
Generated:
setMinint
void setMinint(@CheckForNull
...
Generated:
getMaxint
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getMaxint()
Returns the value of the '***Maxint***' containment reference.
 It is bidirectional and its opposite is
 '[`*interaction Constraint Of Maxint*`](../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMaxint())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMaxint(ValueSpecification)`](#setMaxint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getInteractionConstraint_Maxint()`](../../metadata/UMLPackage.html#getInteractionConstraint_Maxint())
[`ValueSpecification.get_interactionConstraintOfMaxint()`](../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMaxint())
Model:
opposite="_interactionConstraintOfMaxint" containment="true" resolveProxies="true" ordered="false"
Generated:
setMaxint
void setMaxint(@CheckForNull
 [ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)
Sets the value of the '[`*Maxint*`](#getMaxint())' containment reference.
 begin-user-doc 
 end-user-doc
...
@CheckForNull[InteractionOperand](InteractionOperand.html) get_interactionOperandOfGuard()
Returns the value of the '***interaction Operand Of Guard***' container reference.
 It is bidirectional and its opposite is '[`*Guard*`](InteractionOperand.html#getGuard())'.
 begin-user-doc 
If the meaning of the '*interaction Operand Of Guard*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*interaction Operand Of Guard*' container reference.
See Also:
[`set_interactionOperandOfGuard(InteractionOperand)`](#set_interactionOperandOfGuard(com.nomagic.uml2.ext.magicdraw.interactions.mdfragments.InteractionOperand))
[`UMLPackage.getInteractionConstraint__interactionOperandOfGuard()`](../../metadata/UMLPackage.html#getInteractionConstraint__interactionOperandOfGuard())
[`InteractionOperand.getGuard()`](InteractionOperand.html#getGuard())
Model:
opposite="guard" required="true" transient="false" ordered="false"
Generated:
set_interactionOperandOfGuard
void set_interactionOperandOfGuard(@CheckForNull
 [InteractionOperand](InteractionOperand.html) value)
Sets the value of the '[`*interaction Operand
 Of Guard*`](#get_interactionOperandOfGuard())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*interaction Operand Of Guard*' container reference.
See Also:
[`get_interactionOperandOfGuard()`](#get_interactionOperandOfGuard())
Generated:
...
<h1 class="title" title="Interface InteractionConstraint">Interface InteractionConstraint</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">InteractionConstraint</span><span class="extends-implements">
extends <a href="../../classes/mdkernel/Constraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Constraint</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getMaxint()"><code><em>Maxint</em></code></a></li>
<li><a href="#getMinint()"><code><em>Minint</em></code></a></li>
<li><a href="#get_interactionOperandOfGuard()"><code><em>interaction Operand Of Guard</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getInteractionConstraint()"><code>UMLPackage.getInteractionConstraint()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="InteractionOperand.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdfragments">InteractionOperand</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_interactionOperandOfGuard()">get_interactionOperandOfGuard</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>interaction Operand Of Guard</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getMaxint()">getMaxint</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Maxint</b></em>' containment reference.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getMinint()">getMinint</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Minint</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_interactionOperandOfGuard(com.nomagic.uml2.ext.magicdraw.interactions.mdfragments.InteractionOperand)">set_interactionOperandOfGuard</a><wbr/>(<a href="InteractionOperand.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdfragments">InteractionOperand</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_interactionOperandOfGuard()"><code><em>interaction Operand
 Of Guard</em></code></a>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMaxint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setMaxint</a><wbr/>(<a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getMaxint()"><code><em>Maxint</em></code></a>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMinint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setMinint</a><wbr/>(<a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getMinint()"><code><em>Minint</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getMinint()">
<h3>getMinint</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getMinint</span>()</div>
<div class="block">Returns the value of the '<em><b>Minint</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMinint()"><code><em>interaction Constraint Of Minint</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The minimum number of iterations of a loop
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Minint</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setMinint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setMinint(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInteractionConstraint_Minint()"><code>UMLPackage.getInteractionConstraint_Minint()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMinint()"><code>ValueSpecification.get_interactionConstraintOfMinint()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_interactionConstraintOfMinint" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMinint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setMinint</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setMinint</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getMinint()"><code><em>Minint</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Minint</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getMinint()"><code>getMinint()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getMaxint()">
<h3>getMaxint</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getMaxint</span>()</div>
<div class="block">Returns the value of the '<em><b>Maxint</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMaxint()"><code><em>interaction Constraint Of Maxint</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The maximum number of iterations of a loop
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Maxint</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setMaxint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setMaxint(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInteractionConstraint_Maxint()"><code>UMLPackage.getInteractionConstraint_Maxint()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_interactionConstraintOfMaxint()"><code>ValueSpecification.get_interactionConstraintOfMaxint()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_interactionConstraintOfMaxint" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMaxint(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setMaxint</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setMaxint</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getMaxint()"><code><em>Maxint</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Maxint</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getMaxint()"><code>getMaxint()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="get_interactionOperandOfGuard()">
<h3>get_interactionOperandOfGuard</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="InteractionOperand.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdfragments">InteractionOperand</a></span> <span class="element-name">get_interactionOperandOfGuard</span>()</div>
<div class="block">Returns the value of the '<em><b>interaction Operand Of Guard</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="InteractionOperand.html#getGuard()"><code><em>Guard</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>interaction Operand Of Guard</em>' container reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>interaction Operand Of Guard</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#set_interactionOperandOfGuard(com.nomagic.uml2.ext.magicdraw.interactions.mdfragments.InteractionOperand)"><code>set_interactionOperandOfGuard(InteractionOperand)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInteractionConstraint__interactionOperandOfGuard()"><code>UMLPackage.getInteractionConstraint__interactionOperandOfGuard()</code></a></li>
<li><a href="InteractionOperand.html#getGuard()"><code>InteractionOperand.getGuard()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="guard" required="true" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_interactionOperandOfGuard(com.nomagic.uml2.ext.magicdraw.interactions.mdfragments.InteractionOperand)">
<h3>set_interactionOperandOfGuard</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_interactionOperandOfGuard</span><wbr/><span class="parameters">(@CheckForNull
 <a href="InteractionOperand.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdfragments">InteractionOperand</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#get_interactionOperandOfGuard()"><code><em>interaction Operand
 Of Guard</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>interaction Operand Of Guard</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#get_interactionOperandOfGuard()"><code>get_interactionOperandOfGuard()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
