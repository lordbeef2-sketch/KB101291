# JAVA OPENAPI: AcceptCallAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/AcceptCallAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/AcceptCallAction.html`
- source_sha256: `9ecafe0c917ed815969e80fcc2113cbf3c19ee0df21e98dac449d139026a7efb`
- captured_utc: `2026-07-14T16:56:17.511706+00:00`
...
All Superinterfaces:
`[AcceptEventAction](AcceptEventAction.html)`, `[Action](../mdbasicactions/Action.html)`, `[ActivityNode](../../activities/mdfundamentalactivities/ActivityNode.html)`, `[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[ExecutableNode](../../activities/mdstructuredactivities/ExecutableNode.html)`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `com.dassault_systemes.modeler.foundation.model.ModelElement`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[RedefinableElement](../../classes/mdkernel/RedefinableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`

public interfaceAcceptCallActionextends [AcceptEventAction](AcceptEventAction.html)

begin-user-doc 
 A representation of the model object '***Accept Call Action***'.
 end-user-doc 
begin-model-doc 
 An AcceptCallAction is an AcceptEventAction that handles the receipt of a synchronous call request. In addition to the values from the Operation input parameters,
 the Action produces an output that is needed later to supply the information to the ReplyAction necessary to return control to the caller. An AcceptCallAction is
 for synchronous calls. If it is used to handle an asynchronous call, execution of the subsequent ReplyAction will complete immediately with no effect.
 end-model-doc 
The following features are supported:
 [`*Return Information*`](#getReturnInformation())

See Also:
[`UMLPackage.getAcceptCallAction()`](../../metadata/UMLPackage.html#getAcceptCallAction())
Model:
...
`void`
`[setReturnInformation](#setReturnInformation(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin))([OutputPin](../mdbasicactions/OutputPin.html) value)`
Sets the value of the '[`*Return Information*`](#getReturnInformation())'
 containment reference.
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions.[AcceptEventAction](AcceptEventAction.html)
`[getResult](AcceptEventAction.html#getResult()), [getTrigger](AcceptEventAction.html#getTrigger()), [hasResult](AcceptEventAction.html#hasResult()), [hasTrigger](AcceptEventAction.html#hasTrigger()), [isUnmarshall](AcceptEventAction.html#isUnmarshall()), [setUnmarshall](AcceptEventAction.html#setUnmarshall(boolean))`
...
@CheckForNull[OutputPin](../mdbasicactions/OutputPin.html) getReturnInformation()
Returns the value of the '***Return Information***' containment reference.
 It is bidirectional and its opposite is '[`*accept Call Action Of Return Information*`](../mdbasicactions/OutputPin.html#get_acceptCallActionOfReturnInformation())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 An OutputPin where a value is placed containing sufficient information to perform a subsequent ReplyAction and return control to the caller. The contents of this
 value are opaque. It can be passed and copied but it cannot be manipulated by the model.
 end-model-doc
Returns:
the value of the '*Return Information*' containment reference.
See Also:
[`setReturnInformation(OutputPin)`](#setReturnInformation(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin))
[`UMLPackage.getAcceptCallAction_ReturnInformation()`](../../metadata/UMLPackage.html#getAcceptCallAction_ReturnInformation())
[`OutputPin.get_acceptCallActionOfReturnInformation()`](../mdbasicactions/OutputPin.html#get_acceptCallActionOfReturnInformation())
Model:
opposite="_acceptCallActionOfReturnInformation" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
...
<li><a href="../../metadata/UMLPackage.html#getAcceptCallAction()"><code>UMLPackage.getAcceptCallAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions.AcceptEventAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions.<a href="AcceptEventAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions">AcceptEventAction</a></h3>
<code><a href="AcceptEventAction.html#getResult()">getResult</a>, <a href="AcceptEventAction.html#getTrigger()">getTrigger</a>, <a href="AcceptEventAction.html#hasResult()">hasResult</a>, <a href="AcceptEventAction.html#hasTrigger()">hasTrigger</a>, <a href="AcceptEventAction.html#isUnmarshall()">isUnmarshall</a>, <a href="AcceptEventAction.html#setUnmarshall(boolean)">setUnmarshall</a></code></div>
<div class="inherited-list">
...
</span><span class="return-type"><a href="../mdbasicactions/OutputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">OutputPin</a></span> <span class="element-name">getReturnInformation</span>()</div>
<div class="block">Returns the value of the '<em><b>Return Information</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/OutputPin.html#get_acceptCallActionOfReturnInformation()"><code><em>accept Call Action Of Return Information</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An OutputPin where a value is placed containing sufficient information to perform a subsequent ReplyAction and return control to the caller. The contents of this
...
<dd>
<ul class="see-list-long">
<li><a href="#setReturnInformation(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)"><code>setReturnInformation(OutputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getAcceptCallAction_ReturnInformation()"><code>UMLPackage.getAcceptCallAction_ReturnInformation()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_acceptCallActionOfReturnInformation()"><code>OutputPin.get_acceptCallActionOfReturnInformation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_acceptCallActionOfReturnInformation" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setReturnInformation(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)">
