# JAVA OPENAPI: ReadLinkObjectEndQualifierAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReadLinkObjectEndQualifierAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReadLinkObjectEndQualifierAction.html`
- source_sha256: `bc5ff76b4ba4895d976ee56dcb8019ed8bc199a9ffcf98459282aa7ecebe44c9`
- captured_utc: `2026-07-14T16:56:17.959709+00:00`
...
public interfaceReadLinkObjectEndQualifierActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getReadLinkObjectEndQualifierAction()`](../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction())
Model:
...
Sets the value of the '[`*Qualifier*`](#getQualifier())'
 reference.
`void`
...
Sets the value of the '[`*Result*`](#getResult())' containment
 reference.
...
Returns the value of the '***Object***' containment reference.
 It is bidirectional and its opposite is '[`*read Link Object End Qualifier Action Of Object*`](../mdbasicactions/InputPin.html#get_readLinkObjectEndQualifierActionOfObject())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadLinkObjectEndQualifierAction_Object()`](../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Object())
[`InputPin.get_readLinkObjectEndQualifierActionOfObject()`](../mdbasicactions/InputPin.html#get_readLinkObjectEndQualifierActionOfObject())
Model:
opposite="_readLinkObjectEndQualifierActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setObject
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is '[`*read Link Object End Qualifier Action Of Result*`](../mdbasicactions/OutputPin.html#get_readLinkObjectEndQualifierActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadLinkObjectEndQualifierAction_Result()`](../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Result())
[`OutputPin.get_readLinkObjectEndQualifierActionOfResult()`](../mdbasicactions/OutputPin.html#get_readLinkObjectEndQualifierActionOfResult())
Model:
opposite="_readLinkObjectEndQualifierActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
Returns the value of the '***Qualifier***' reference.
 It is bidirectional and its opposite is '[`*read
 Link Object End Qualifier Action Of Qualifier*`](../../classes/mdkernel/Property.html#get_readLinkObjectEndQualifierActionOfQualifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadLinkObjectEndQualifierAction_Qualifier()`](../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Qualifier())
[`Property.get_readLinkObjectEndQualifierActionOfQualifier()`](../../classes/mdkernel/Property.html#get_readLinkObjectEndQualifierActionOfQualifier())
Model:
opposite="_readLinkObjectEndQualifierActionOfQualifier" required="true" ordered="false"
Generated:
setQualifier
...
<h1 class="title" title="Interface ReadLinkObjectEndQualifierAction">Interface ReadLinkObjectEndQualifierAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReadLinkObjectEndQualifierAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction()"><code>UMLPackage.getReadLinkObjectEndQualifierAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getQualifier()"><code><em>Qualifier</em></code></a>'
 reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getResult()"><code><em>Result</em></code></a>' containment
 reference.</div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_readLinkObjectEndQualifierActionOfObject()"><code><em>read Link Object End Qualifier Action Of Object</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin from which the link object is obtained.
...
<li><a href="../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Object()"><code>UMLPackage.getReadLinkObjectEndQualifierAction_Object()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_readLinkObjectEndQualifierActionOfObject()"><code>InputPin.get_readLinkObjectEndQualifierActionOfObject()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readLinkObjectEndQualifierActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/OutputPin.html#get_readLinkObjectEndQualifierActionOfResult()"><code><em>read Link Object End Qualifier Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin where the result value is placed.
...
<li><a href="../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Result()"><code>UMLPackage.getReadLinkObjectEndQualifierAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_readLinkObjectEndQualifierActionOfResult()"><code>OutputPin.get_readLinkObjectEndQualifierActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readLinkObjectEndQualifierActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Qualifier</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/Property.html#get_readLinkObjectEndQualifierActionOfQualifier()"><code><em>read
 Link Object End Qualifier Action Of Qualifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The qualifier Property to be read.
...
<li><a href="../../metadata/UMLPackage.html#getReadLinkObjectEndQualifierAction_Qualifier()"><code>UMLPackage.getReadLinkObjectEndQualifierAction_Qualifier()</code></a></li>
<li><a href="../../classes/mdkernel/Property.html#get_readLinkObjectEndQualifierActionOfQualifier()"><code>Property.get_readLinkObjectEndQualifierActionOfQualifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readLinkObjectEndQualifierActionOfQualifier" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
