# JAVA OPENAPI: Observation (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Observation.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Observation.html`
- source_sha256: `b28bf22f6a36bb968c611f8ed5cf36732b913eba0d49732fd0904f708bedfee0`
- captured_utc: `2026-07-14T16:56:23.783774+00:00`
...
`[DurationObservation](DurationObservation.html)`, `[TimeObservation](TimeObservation.html)`

public interfaceObservationextends [PackageableElement](../../classes/mdkernel/PackageableElement.html)
...
The following features are supported:
 [`*time Expression Of Observation*`](#get_timeExpressionOfObservation())
[`*Behavior*`](#getBehavior())
[`*duration Of Observation*`](#get_durationOfObservation())

See Also:
[`UMLPackage.getObservation()`](../../metadata/UMLPackage.html#getObservation())
Model:
abstract="true"
...
`[get_durationOfObservation](#get_durationOfObservation())()`
Returns the value of the '***duration Of Observation***' reference.
`[TimeExpression](TimeExpression.html)`
`[get_timeExpressionOfObservation](#get_timeExpressionOfObservation())()`
Returns the value of the '***time Expression Of Observation***' reference.
`[Behavior](../mdbasicbehaviors/Behavior.html)`
`[getBehavior](#getBehavior())()`
Returns the value of the '***Behavior***' container reference.
`void`
`[set_durationOfObservation](#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))([Duration](Duration.html) value)`
Sets the value of the
 '[`*duration Of Observation*`](#get_durationOfObservation())' reference.
`void`
`[set_timeExpressionOfObservation](#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression))([TimeExpression](TimeExpression.html) value)`
Sets the value of the
 '[`*time Expression Of Observation*`](#get_timeExpressionOfObservation())'
 reference.
`void`
`[setBehavior](#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))([Behavior](../mdbasicbehaviors/Behavior.html) value)`
Sets the value of the '[`*Behavior*`](#getBehavior())' container reference.
...
@CheckForNull[TimeExpression](TimeExpression.html) get_timeExpressionOfObservation()
Returns the value of the '***time Expression Of Observation***' reference.
 It is bidirectional and its opposite is '[`*Observation*`](TimeExpression.html#getObservation())'.
 begin-user-doc 
If the meaning of the '*time Expression Of Observation*' reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*time Expression Of Observation*' reference.
See Also:
[`set_timeExpressionOfObservation(TimeExpression)`](#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression))
[`UMLPackage.getObservation__timeExpressionOfObservation()`](../../metadata/UMLPackage.html#getObservation__timeExpressionOfObservation())
[`TimeExpression.getObservation()`](TimeExpression.html#getObservation())
Model:
opposite="observation" ordered="false"
Generated:
set_timeExpressionOfObservation
void set_timeExpressionOfObservation(@CheckForNull
...
Parameters:
`value` - the new value of the '*time Expression Of Observation*' reference.
See Also:
[`get_timeExpressionOfObservation()`](#get_timeExpressionOfObservation())
Generated:
getBehavior
@CheckForNull[Behavior](../mdbasicbehaviors/Behavior.html) getBehavior()
Returns the value of the '***Behavior***' container reference.
 It is bidirectional and its opposite is '[`*Observation*`](../mdbasicbehaviors/Behavior.html#getObservation())'.
 begin-user-doc 
If the meaning of the '*Behavior*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*Behavior*' container reference.
See Also:
[`setBehavior(Behavior)`](#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))
[`UMLPackage.getObservation_Behavior()`](../../metadata/UMLPackage.html#getObservation_Behavior())
[`Behavior.getObservation()`](../mdbasicbehaviors/Behavior.html#getObservation())
Model:
opposite="observation" transient="false" ordered="false"
Generated:
setBehavior
void setBehavior(@CheckForNull
 [Behavior](../mdbasicbehaviors/Behavior.html) value)
Sets the value of the '[`*Behavior*`](#getBehavior())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
@CheckForNull[Duration](Duration.html) get_durationOfObservation()
Returns the value of the '***duration Of Observation***' reference.
 It is bidirectional and its opposite is '[`*Observation*`](Duration.html#getObservation())'.
 begin-user-doc 
If the meaning of the '*duration Of Observation*' reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*duration Of Observation*' reference.
See Also:
[`set_durationOfObservation(Duration)`](#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration))
[`UMLPackage.getObservation__durationOfObservation()`](../../metadata/UMLPackage.html#getObservation__durationOfObservation())
[`Duration.getObservation()`](Duration.html#getObservation())
Model:
opposite="observation" ordered="false"
Generated:
set_durationOfObservation
void set_durationOfObservation(@CheckForNull
 [Duration](Duration.html) value)
Sets the value of the
 '[`*duration Of Observation*`](#get_durationOfObservation())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*duration Of Observation*' reference.
See Also:
[`get_durationOfObservation()`](#get_durationOfObservation())
Generated:
...
<h1 class="title" title="Interface Observation">Interface Observation</h1>
</div>
...
<dd><code><a href="DurationObservation.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationObservation</a></code>, <code><a href="TimeObservation.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeObservation</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Observation</span><span class="extends-implements">
extends <a href="../../classes/mdkernel/PackageableElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">PackageableElement</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#get_timeExpressionOfObservation()"><code><em>time Expression Of Observation</em></code></a></li>
<li><a href="#getBehavior()"><code><em>Behavior</em></code></a></li>
<li><a href="#get_durationOfObservation()"><code><em>duration Of Observation</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getObservation()"><code>UMLPackage.getObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
 annotation="MOF package='commonbehaviors.mdsimpletime'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_durationOfObservation()">get_durationOfObservation</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>duration Of Observation</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_timeExpressionOfObservation()">get_timeExpressionOfObservation</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>time Expression Of Observation</b></em>' reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Behavior</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">set_durationOfObservation</a><wbr/>(<a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#get_durationOfObservation()"><code><em>duration Of Observation</em></code></a>' reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)">set_timeExpressionOfObservation</a><wbr/>(<a href="TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#get_timeExpressionOfObservation()"><code><em>time Expression Of Observation</em></code></a>'
 reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setBehavior</a><wbr/>(<a href="../mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getBehavior()"><code><em>Behavior</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="get_timeExpressionOfObservation()">
<h3>get_timeExpressionOfObservation</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a></span> <span class="element-name">get_timeExpressionOfObservation</span>()</div>
<div class="block">Returns the value of the '<em><b>time Expression Of Observation</b></em>' reference.
 It is bidirectional and its opposite is '<a href="TimeExpression.html#getObservation()"><code><em>Observation</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>time Expression Of Observation</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>time Expression Of Observation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)"><code>set_timeExpressionOfObservation(TimeExpression)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getObservation__timeExpressionOfObservation()"><code>UMLPackage.getObservation__timeExpressionOfObservation()</code></a></li>
<li><a href="TimeExpression.html#getObservation()"><code>TimeExpression.getObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="observation" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_timeExpressionOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)">
<h3>set_timeExpressionOfObservation</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_timeExpressionOfObservation</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>time Expression Of Observation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#get_timeExpressionOfObservation()"><code>get_timeExpressionOfObservation()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<h3>getBehavior</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></span> <span class="element-name">getBehavior</span>()</div>
<div class="block">Returns the value of the '<em><b>Behavior</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="../mdbasicbehaviors/Behavior.html#getObservation()"><code><em>Observation</em></code></a>'.
 <!-- begin-user-doc -->
<p>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Behavior</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)"><code>setBehavior(Behavior)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getObservation_Behavior()"><code>UMLPackage.getObservation_Behavior()</code></a></li>
<li><a href="../mdbasicbehaviors/Behavior.html#getObservation()"><code>Behavior.getObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="observation" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setBehavior(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">
<h3>setBehavior</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setBehavior</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getBehavior()"><code><em>Behavior</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Behavior</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getBehavior()"><code>getBehavior()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="get_durationOfObservation()">
<h3>get_durationOfObservation</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a></span> <span class="element-name">get_durationOfObservation</span>()</div>
<div class="block">Returns the value of the '<em><b>duration Of Observation</b></em>' reference.
 It is bidirectional and its opposite is '<a href="Duration.html#getObservation()"><code><em>Observation</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>duration Of Observation</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>duration Of Observation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)"><code>set_durationOfObservation(Duration)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getObservation__durationOfObservation()"><code>UMLPackage.getObservation__durationOfObservation()</code></a></li>
<li><a href="Duration.html#getObservation()"><code>Duration.getObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="observation" ordered="false"</dd>
...
<li>
<section class="detail" id="set_durationOfObservation(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.Duration)">
<h3>set_durationOfObservation</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_durationOfObservation</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Duration.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Duration</a> value)</span></div>
<div class="block">Sets the value of the
 '<a href="#get_durationOfObservation()"><code><em>duration Of Observation</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>duration Of Observation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#get_durationOfObservation()"><code>get_durationOfObservation()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
