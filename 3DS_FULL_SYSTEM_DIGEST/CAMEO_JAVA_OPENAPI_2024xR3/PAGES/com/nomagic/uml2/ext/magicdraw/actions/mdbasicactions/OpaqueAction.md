# JAVA OPENAPI: OpaqueAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/OpaqueAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/OpaqueAction.html`
- source_sha256: `4079633a53d32ae69fc38636321e8017c0a78cd30f8f9ddd348a5be13475c85d`
- captured_utc: `2026-07-14T16:56:16.756697+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InputPin](InputPin.html)>`
`[getInputValue](#getInputValue())()`
Returns the value of the '***Input Value***' containment reference list.
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)>`
`[getLanguage](#getLanguage())()`
Returns the value of the '***Language***' attribute list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[OutputPin](OutputPin.html)>`
...
Generated:
getInputValue
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InputPin](InputPin.html)> getInputValue()
Returns the value of the '***Input Value***' containment reference list.
...
Generated:
getOutputValue
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[OutputPin](OutputPin.html)> getOutputValue()
Returns the value of the '***Output Value***' containment reference list.
