# JAVA OPENAPI: ReadSelfAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ReadSelfAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/ReadSelfAction.html`
- source_sha256: `92ae6c50a5983505bddb0bf89e3c2b8948aed0c6c20f9ed55c08c4c2c2f4b082`
- captured_utc: `2026-07-14T16:56:18.493716+00:00`
...
public interfaceReadSelfActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getReadSelfAction()`](../../metadata/UMLPackage.html#getReadSelfAction())
Model:
...
Returns the value of the '***Result***' containment reference.
 ...
 '[`*read Self Action Of Result*`](../mdbasicactions/OutputPin.html#get_readSelfActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadSelfAction_Result()`](../../metadata/UMLPackage.html#getReadSelfAction_Result())
[`OutputPin.get_readSelfActionOfResult()`](../mdbasicactions/OutputPin.html#get_readSelfActionOfResult())
Model:
opposite="_readSelfActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
<h1 class="title" title="Interface ReadSelfAction">Interface ReadSelfAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReadSelfAction</span><span class="extends-implements">
...
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getReadSelfAction()"><code>UMLPackage.getReadSelfAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_readSelfActionOfResult()"><code><em>read Self Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the context object is placed.
...
<li><a href="../../metadata/UMLPackage.html#getReadSelfAction_Result()"><code>UMLPackage.getReadSelfAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_readSelfActionOfResult()"><code>OutputPin.get_readSelfActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readSelfActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
