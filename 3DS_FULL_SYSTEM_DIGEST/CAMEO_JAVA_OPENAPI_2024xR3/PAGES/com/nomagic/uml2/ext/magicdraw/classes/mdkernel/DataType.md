# JAVA OPENAPI: DataType (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/DataType.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/DataType.html`
- source_sha256: `3eb0ec2a83221487103eabc937c11fe547db52f451ad93eec1461f4300603215`
- captured_utc: `2026-07-14T16:56:21.638750+00:00`
...
`[Enumeration](Enumeration.html)`, `[PrimitiveType](PrimitiveType.html)`

public interfaceDataTypeextends [Classifier](Classifier.html)
...
See Also:
[`UMLPackage.getDataType()`](../../metadata/UMLPackage.html#getDataType())
Model:
...
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Operation](Operation.html)>`
...
Method Details
getOwnedAttribute
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Property](Property.html)> getOwnedAttribute()
Returns the value of the '***Owned Attribute***' containment reference list.
 The list contents are of type [`Property`](Property.html).
 It is bidirectional and its opposite is '[`*Datatype*`](Property.html#getDatatype())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDataType_OwnedAttribute()`](../../metadata/UMLPackage.html#getDataType_OwnedAttribute())
[`Property.getDatatype()`](Property.html#getDatatype())
Model:
opposite="datatype" containment="true" resolveProxies="true"
Generated:
getOwnedOperation
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Operation](Operation.html)> getOwnedOperation()
Returns the value of the '***Owned Operation***' containment reference list.
 The list contents are of type [`Operation`](Operation.html).
 It is bidirectional and its opposite is '[`*Datatype*`](Operation.html#getDatatype())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDataType_OwnedOperation()`](../../metadata/UMLPackage.html#getDataType_OwnedOperation())
[`Operation.getDatatype()`](Operation.html#getDatatype())
Model:
opposite="datatype" containment="true" resolveProxies="true"
Generated:
hasOwnedAttribute
...
<dd><code><a href="Enumeration.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Enumeration</a></code>, <code><a href="PrimitiveType.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">PrimitiveType</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DataType</span><span class="extends-implements">
extends <a href="Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a></span></div>
...
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getDataType()"><code>UMLPackage.getDataType()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Owned Attribute</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is '<a href="Property.html#getDatatype()"><code><em>Datatype</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The attributes owned by the DataType.
...
<li><a href="../../metadata/UMLPackage.html#getDataType_OwnedAttribute()"><code>UMLPackage.getDataType_OwnedAttribute()</code></a></li>
<li><a href="Property.html#getDatatype()"><code>Property.getDatatype()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="datatype" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Owned Operation</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is '<a href="Operation.html#getDatatype()"><code><em>Datatype</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Operations owned by the DataType.
...
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getDataType_OwnedOperation()"><code>UMLPackage.getDataType_OwnedOperation()</code></a></li>
<li><a href="Operation.html#getDatatype()"><code>Operation.getDatatype()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="datatype" containment="true" resolveProxies="true"</dd>
