# JAVA OPENAPI: InstanceValue (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/InstanceValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/InstanceValue.html`
- source_sha256: `eaeb632b5934f09bef441e1a5c76260488baf50fe05ca3634ec14f00ee0c66bf`
- captured_utc: `2026-07-14T16:56:21.978754+00:00`
...
public interfaceInstanceValueextends [ValueSpecification](ValueSpecification.html)
...
See Also:
[`UMLPackage.getInstanceValue()`](../../metadata/UMLPackage.html#getInstanceValue())
Model:
...
`void`
`[setInstance](#setInstance(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification))([InstanceSpecification](InstanceSpecification.html) value)`
Sets the value of the '[`*Instance*`](#getInstance())' reference.
...
Method Details
getInstance
@CheckForNull[InstanceSpecification](InstanceSpecification.html) getInstance()
Returns the value of the '***Instance***' reference.
 It is bidirectional and its opposite is
 '[`*instance Value Of Instance*`](InstanceSpecification.html#get_instanceValueOfInstance())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setInstance(InstanceSpecification)`](#setInstance(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification))
[`UMLPackage.getInstanceValue_Instance()`](../../metadata/UMLPackage.html#getInstanceValue_Instance())
[`InstanceSpecification.get_instanceValueOfInstance()`](InstanceSpecification.html#get_instanceValueOfInstance())
Model:
opposite="_instanceValueOfInstance" required="true" ordered="false"
Generated:
setInstance
void setInstance(@CheckForNull
...
<h1 class="title" title="Interface InstanceValue">Interface InstanceValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">InstanceValue</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getInstance()"><code><em>Instance</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getInstanceValue()"><code>UMLPackage.getInstanceValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInstance()">getInstance</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Instance</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setInstance(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification)">setInstance</a><wbr/>(<a href="InstanceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">InstanceSpecification</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getInstance()"><code><em>Instance</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="InstanceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">InstanceSpecification</a></span> <span class="element-name">getInstance</span>()</div>
<div class="block">Returns the value of the '<em><b>Instance</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="InstanceSpecification.html#get_instanceValueOfInstance()"><code><em>instance Value Of Instance</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InstanceSpecification that represents the specified value.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Instance</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setInstance(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification)"><code>setInstance(InstanceSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInstanceValue_Instance()"><code>UMLPackage.getInstanceValue_Instance()</code></a></li>
<li><a href="InstanceSpecification.html#get_instanceValueOfInstance()"><code>InstanceSpecification.get_instanceValueOfInstance()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_instanceValueOfInstance" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setInstance(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification)">
<h3>setInstance</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setInstance</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getInstance()"><code><em>Instance</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Instance</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getInstance()"><code>getInstance()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
