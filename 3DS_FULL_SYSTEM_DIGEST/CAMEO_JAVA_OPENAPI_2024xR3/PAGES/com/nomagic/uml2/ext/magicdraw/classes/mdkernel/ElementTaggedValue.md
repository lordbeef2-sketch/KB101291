# JAVA OPENAPI: ElementTaggedValue (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/ElementTaggedValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/ElementTaggedValue.html`
- source_sha256: `19a1300b3682975fd5039cbd3ce31e431b17e3d247dff1ff58b3fdb6c4c5f4e3`
- captured_utc: `2026-07-14T16:56:21.674751+00:00`
...
public interfaceElementTaggedValueextends [TaggedValue](TaggedValue.html)
...
`[getValue](#getValue())()`
Returns the value of the '***Value***' reference list.
...
Method Details
getValue
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Element](Element.html)> getValue()
Returns the value of the '***Value***' reference list.
 The list contents are of type [`Element`](Element.html).
 It is bidirectional and its opposite is '[`*Element Tagged Value*`](Element.html#get_elementTaggedValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The values held by the ElementTaggedValue.
 end-model-doc
Specified by:
...
See Also:
[`Element.get_elementTaggedValue()`](Element.html#get_elementTaggedValue())
Model:
...
<h1 class="title" title="Interface ElementTaggedValue">Interface ElementTaggedValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ElementTaggedValue</span><span class="extends-implements">
...
<div class="block"><!-- begin-user-doc -->
 A representation of the model object '<em><b>Element Tagged Value</b></em>'.
 <!-- end-user-doc -->
<p>
<!-- begin-model-doc -->
 An ElementTaggedValue designates that an entity modeled by an Element has an Element tagged value or values.
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' reference list.</div>
</div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="Element.html#get_elementTaggedValue()"><code><em>Element Tagged Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The values held by the ElementTaggedValue.
...
<dt>Returns:</dt>
<dd>the value of the '<em>Value</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="Element.html#get_elementTaggedValue()"><code>Element.get_elementTaggedValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_elementTaggedValue"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
