# JAVA OPENAPI: RealTaggedValue (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/RealTaggedValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/RealTaggedValue.html`
- source_sha256: `d72a4247ea77c8bbcf0b8959f8b30afb2993fcc2334c1daee45f1450d869536e`
- captured_utc: `2026-07-14T16:56:22.672761+00:00`
...
## Interface RealTaggedValue

All Superinterfaces:
`[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html)`, `[Element](Element.html)`, `org.eclipse.emf.ecore.EObject`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `com.dassault_systemes.modeler.foundation.model.ModelElement`, `[ModelObject](../../base/ModelObject.html)`, `org.eclipse.emf.common.notify.Notifier`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`, `[TaggedValue](TaggedValue.html)`

public interfaceRealTaggedValueextends [TaggedValue](TaggedValue.html)

begin-user-doc 
 A representation of the model object '***Real Tagged Value***'.
 end-user-doc 
begin-model-doc 
 A RealTaggedValue designates that an entity modeled by an Element has a real tagged value or values.
 end-model-doc 
...
Method Details
getValue
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Double](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Double.html)> getValue()
Returns the value of the '***Value***' attribute list.
 The list contents are of type [`Double`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Double.html).
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The values held by the RealTaggedValue.
 end-model-doc
Specified by:
...
Model:
unique="false" dataType="uml.Real"
Generated:
...
<h1 class="title" title="Interface RealTaggedValue">Interface RealTaggedValue</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">RealTaggedValue</span><span class="extends-implements">
...
<div class="block"><!-- begin-user-doc -->
 A representation of the model object '<em><b>Real Tagged Value</b></em>'.
 <!-- end-user-doc -->
<p>
<!-- begin-model-doc -->
 A RealTaggedValue designates that an entity modeled by an Element has a real tagged value or values.
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' attribute list.
 The list contents are of type <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Double.html" title="class or interface in java.lang"><code>Double</code></a>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The values held by the RealTaggedValue.
...
<dt>Model:</dt>
<dd>unique="false" dataType="uml.Real"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
