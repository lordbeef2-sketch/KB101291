# JAVA OPENAPI: VariableAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/VariableAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/VariableAction.html`
- source_sha256: `3f78065dbc2e66573b0f43eae3a5f0ad4a3bb2b10f08772c3612d70dfd62f15c`
- captured_utc: `2026-07-14T16:56:18.991723+00:00`
...
`[AddVariableValueAction](AddVariableValueAction.html)`, `[ClearVariableAction](ClearVariableAction.html)`, `[ReadVariableAction](ReadVariableAction.html)`, `[RemoveVariableValueAction](RemoveVariableValueAction.html)`, `[WriteVariableAction](WriteVariableAction.html)`

public interfaceVariableActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getVariableAction()`](../../metadata/UMLPackage.html#getVariableAction())
Model:
abstract="true"
...
`void`
`[setVariable](#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable))([Variable](../../activities/mdstructuredactivities/Variable.html) value)`
Sets the value of the '[`*Variable*`](#getVariable())' reference.
...
Method Details
getVariable
@CheckForNull[Variable](../../activities/mdstructuredactivities/Variable.html) getVariable()
Returns the value of the '***Variable***' reference.
 It is bidirectional and its opposite is
 '[`*variable Action Of Variable*`](../../activities/mdstructuredactivities/Variable.html#get_variableActionOfVariable())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setVariable(Variable)`](#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable))
[`UMLPackage.getVariableAction_Variable()`](../../metadata/UMLPackage.html#getVariableAction_Variable())
[`Variable.get_variableActionOfVariable()`](../../activities/mdstructuredactivities/Variable.html#get_variableActionOfVariable())
Model:
opposite="_variableActionOfVariable" required="true" ordered="false"
Generated:
setVariable
void setVariable(@CheckForNull
 [Variable](../../activities/mdstructuredactivities/Variable.html) value)
Sets the value of the '[`*Variable*`](#getVariable())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
<h1 class="title" title="Interface VariableAction">Interface VariableAction</h1>
</div>
...
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getVariableAction()"><code>UMLPackage.getVariableAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
 annotation="MOF package='actions.mdstructuredactions'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../activities/mdstructuredactivities/Variable.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">Variable</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getVariable()">getVariable</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Variable</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable)">setVariable</a><wbr/>(<a href="../../activities/mdstructuredactivities/Variable.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">Variable</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getVariable()"><code><em>Variable</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../../activities/mdstructuredactivities/Variable.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">Variable</a></span> <span class="element-name">getVariable</span>()</div>
<div class="block">Returns the value of the '<em><b>Variable</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../activities/mdstructuredactivities/Variable.html#get_variableActionOfVariable()"><code><em>variable Action Of Variable</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Variable to be read or written.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Variable</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable)"><code>setVariable(Variable)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getVariableAction_Variable()"><code>UMLPackage.getVariableAction_Variable()</code></a></li>
<li><a href="../../activities/mdstructuredactivities/Variable.html#get_variableActionOfVariable()"><code>Variable.get_variableActionOfVariable()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_variableActionOfVariable" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable)">
<h3>setVariable</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setVariable</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../activities/mdstructuredactivities/Variable.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">Variable</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getVariable()"><code><em>Variable</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Variable</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getVariable()"><code>getVariable()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
