# JAVA OPENAPI: LinkAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/LinkAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/LinkAction.html`
- source_sha256: `a4f6ffc37faa7e540dd2eef182bdd47ade11d68832d352cbc68680f129accef3`
- captured_utc: `2026-07-14T16:56:18.432717+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[LinkEndData](LinkEndData.html)>`
`[getEndData](#getEndData())()`
Returns the value of the '***End Data***' containment reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InputPin](../mdbasicactions/InputPin.html)>`
...
Method Details
getInputValue
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[InputPin](../mdbasicactions/InputPin.html)> getInputValue()
Returns the value of the '***Input Value***' containment reference list.
...
Generated:
getEndData
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[LinkEndData](LinkEndData.html)> getEndData()
Returns the value of the '***End Data***' containment reference list.
