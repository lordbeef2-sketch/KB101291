# JAVA OPENAPI: DurationObservation (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationObservation.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/DurationObservation.html`
- source_sha256: `47088ad04629fc5049cebbdf4b007341cdc1e105db35d7d7b63f7ca303cf878b`
- captured_utc: `2026-07-14T16:56:23.936776+00:00`
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)>`
`[getEvent](#getEvent())()`
...
Method Details
isFirstEvent
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[Boolean](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html)> isFirstEvent()
Returns the value of the '***First Event***' attribute list.
 The list contents are of type [`Boolean`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html).
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Generated:
getEvent
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)> getEvent()
Returns the value of the '***Event***' reference list.
...
<div class="block">Returns the value of the '<em><b>First Event</b></em>' attribute list.
 The list contents are of type <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang"><code>Boolean</code></a>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The value of firstEvent[i] is related to event[i] (where i is 1 or 2). If firstEvent[i] is true, then the corresponding observation event is the first time
