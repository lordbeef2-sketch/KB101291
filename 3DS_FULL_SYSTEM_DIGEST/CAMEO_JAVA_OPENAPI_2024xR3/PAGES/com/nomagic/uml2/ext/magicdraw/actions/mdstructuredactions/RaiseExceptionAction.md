# JAVA OPENAPI: RaiseExceptionAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/RaiseExceptionAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/RaiseExceptionAction.html`
- source_sha256: `d26627e8798165f6ab7f870638812b2151575947611bcf0d7945685f065b8f14`
- captured_utc: `2026-07-14T16:56:19.063723+00:00`
...
public interfaceRaiseExceptionActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getRaiseExceptionAction()`](../../metadata/UMLPackage.html#getRaiseExceptionAction())
Model:
...
`void`
`[setException](#setException(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*Exception*`](#getException())' containment
 reference.
...
Method Details
getException
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getException()
Returns the value of the '***Exception***' containment reference.
 It is bidirectional and its opposite is
 '[`*raise Exception Action Of Exception*`](../mdbasicactions/InputPin.html#get_raiseExceptionActionOfException())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setException(InputPin)`](#setException(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getRaiseExceptionAction_Exception()`](../../metadata/UMLPackage.html#getRaiseExceptionAction_Exception())
[`InputPin.get_raiseExceptionActionOfException()`](../mdbasicactions/InputPin.html#get_raiseExceptionActionOfException())
Model:
opposite="_raiseExceptionActionOfException" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setException
void setException(@CheckForNull
...
<h1 class="title" title="Interface RaiseExceptionAction">Interface RaiseExceptionAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">RaiseExceptionAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getException()"><code><em>Exception</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getRaiseExceptionAction()"><code>UMLPackage.getRaiseExceptionAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getException()">getException</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Exception</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setException(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setException</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getException()"><code><em>Exception</em></code></a>' containment
 reference.</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getException</span>()</div>
<div class="block">Returns the value of the '<em><b>Exception</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_raiseExceptionActionOfException()"><code><em>raise Exception Action Of Exception</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An InputPin whose value becomes the exception object.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Exception</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setException(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setException(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getRaiseExceptionAction_Exception()"><code>UMLPackage.getRaiseExceptionAction_Exception()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_raiseExceptionActionOfException()"><code>InputPin.get_raiseExceptionActionOfException()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_raiseExceptionActionOfException" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setException(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setException</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setException</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Exception</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getException()"><code>getException()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
