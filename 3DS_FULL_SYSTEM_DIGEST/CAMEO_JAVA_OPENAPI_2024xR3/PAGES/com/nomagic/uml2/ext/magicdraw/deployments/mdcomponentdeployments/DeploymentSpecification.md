# JAVA OPENAPI: DeploymentSpecification (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/deployments/mdcomponentdeployments/DeploymentSpecification.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdcomponentdeployments/DeploymentSpecification.html`
- source_sha256: `c00109361f8d6af3e7b19dab3d89ce0292a3639ec51e27159bfe5e4de7170980`
- captured_utc: `2026-07-14T16:56:24.635786+00:00`
...
Sets the value of the '[`*Deployment*`](#getDeployment())'
 container reference.
`void`
`[setDeploymentLocation](#setDeploymentLocation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the
 '[`*Deployment Location*`](#getDeploymentLocation())' attribute.
`void`
`[setExecutionLocation](#setExecutionLocation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the
...
@CheckForNull[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getDeploymentLocation()
Returns the value of the '***Deployment Location***' attribute.
...
@CheckForNull[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getExecutionLocation()
Returns the value of the '***Execution Location***' attribute.
 The default value is `""`.
 begin-user-doc 
 end-user-doc 
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getDeploymentLocation</span>()</div>
...
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getExecutionLocation</span>()</div>
