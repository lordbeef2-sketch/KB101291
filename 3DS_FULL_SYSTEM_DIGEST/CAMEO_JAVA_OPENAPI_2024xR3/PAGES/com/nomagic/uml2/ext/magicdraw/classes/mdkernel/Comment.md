# JAVA OPENAPI: Comment (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Comment.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Comment.html`
- source_sha256: `92918bd47119ac62db5337cb0fc9e4d89eab15feb23c8a3a1e9a7f926f5bb5a1`
- captured_utc: `2026-07-14T16:56:21.276749+00:00`
...
public interfaceCommentextends [Element](Element.html)
...
The following features are supported:
 [`*Annotated Element*`](#getAnnotatedElement())
[`*Body*`](#getBody())
[`*Owning Element*`](#getOwningElement())

See Also:
[`UMLPackage.getComment()`](../../metadata/UMLPackage.html#getComment())
Model:
...
`[getOwningElement](#getOwningElement())()`
Returns the value of the '***Owning Element***' container reference.
`boolean`
`[hasAnnotatedElement](#hasAnnotatedElement())()`

`void`
`[setBody](#setBody(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the '[`*Body*`](#getBody())' attribute.
`void`
`[setOwningElement](#setOwningElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](Element.html) value)`
Sets the value of the '[`*Owning Element*`](#getOwningElement())' container reference.
...
Method Details
getAnnotatedElement
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Element](Element.html)> getAnnotatedElement()
Returns the value of the '***Annotated Element***' reference list.
 The list contents are of type [`Element`](Element.html).
 It is bidirectional and its opposite is
 '[`*comment Of Annotated Element*`](Element.html#get_commentOfAnnotatedElement())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getComment_AnnotatedElement()`](../../metadata/UMLPackage.html#getComment_AnnotatedElement())
[`Element.get_commentOfAnnotatedElement()`](Element.html#get_commentOfAnnotatedElement())
Model:
opposite="_commentOfAnnotatedElement" ordered="false"
Generated:
getBody
@CheckForNull[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getBody()
Returns the value of the '***Body***' attribute.
...
[`UMLPackage.getComment_Body()`](../../metadata/UMLPackage.html#getComment_Body())
Model:
...
Generated:
getOwningElement
@CheckForNull[Element](Element.html) getOwningElement()
Returns the value of the '***Owning Element***' container reference.
 It is bidirectional and its opposite is '[`*Owned Comment*`](Element.html#getOwnedComment())'.
 begin-user-doc 
If the meaning of the '*Owning Element*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*Owning Element*' container reference.
See Also:
[`setOwningElement(Element)`](#setOwningElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))
[`UMLPackage.getComment_OwningElement()`](../../metadata/UMLPackage.html#getComment_OwningElement())
[`Element.getOwnedComment()`](Element.html#getOwnedComment())
Model:
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Comment</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getAnnotatedElement()"><code><em>Annotated Element</em></code></a></li>
<li><a href="#getBody()"><code><em>Body</em></code></a></li>
<li><a href="#getOwningElement()"><code><em>Owning Element</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getComment()"><code>UMLPackage.getComment()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Annotated Element</b></em>' reference list.</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Body</b></em>' attribute.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwningElement()">getOwningElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Owning Element</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasAnnotatedElement()">hasAnnotatedElement</a>()</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getBody()"><code><em>Body</em></code></a>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwningElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setOwningElement</a><wbr/>(<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getOwningElement()"><code><em>Owning Element</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt;</span> <span class="element-name">getAnnotatedElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Annotated Element</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Element.html#get_commentOfAnnotatedElement()"><code><em>comment Of Annotated Element</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the Element(s) being commented.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Annotated Element</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getComment_AnnotatedElement()"><code>UMLPackage.getComment_AnnotatedElement()</code></a></li>
<li><a href="Element.html#get_commentOfAnnotatedElement()"><code>Element.get_commentOfAnnotatedElement()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_commentOfAnnotatedElement" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getBody</span>()</div>
<div class="block">Returns the value of the '<em><b>Body</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Body</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#setBody(java.lang.String)"><code>setBody(String)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getComment_Body()"><code>UMLPackage.getComment_Body()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Sets the value of the '<a href="#getBody()"><code><em>Body</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Body</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getBody()"><code>getBody()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getOwningElement()">
<h3>getOwningElement</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getOwningElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Owning Element</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Element.html#getOwnedComment()"><code><em>Owned Comment</em></code></a>'.
 <!-- begin-user-doc -->
<p>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Owning Element</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setOwningElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)"><code>setOwningElement(Element)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getComment_OwningElement()"><code>UMLPackage.getComment_OwningElement()</code></a></li>
<li><a href="Element.html#getOwnedComment()"><code>Element.getOwnedComment()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="ownedComment" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwningElement(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setOwningElement</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwningElement</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getOwningElement()"><code><em>Owning Element</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Owning Element</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getOwningElement()"><code>getOwningElement()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="hasAnnotatedElement()">
<h3>hasAnnotatedElement</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasAnnotatedElement</span>()
