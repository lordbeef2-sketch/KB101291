# JAVA OPENAPI: Duration (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Duration.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Duration.html`
- source_sha256: `6d57d1a1d917df2a3d238773844bca296ee7baa2c0c411d6011e5b72909eeac1`
- captured_utc: `2026-07-14T16:56:23.691775+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)>`
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)> get_durationIntervalOfMax()
Returns the value of the '***duration Interval Of Max***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)> get_durationIntervalOfMin()
Returns the value of the '***duration Interval Of Min***' reference list.
 The list contents are of type [`DurationInterval`](DurationInterval.html).
