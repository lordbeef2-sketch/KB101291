# JAVA OPENAPI: InformationFlow (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdinformationflows/InformationFlow.html
- source_path: `com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdinformationflows/InformationFlow.html`
- source_sha256: `bde973dd75dda762f76a91491e4b796a0b148a7d971065fb5aa9dc1484ccedff`
- captured_utc: `2026-07-14T16:56:20.325736+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Relationship](../../classes/mdkernel/Relationship.html)>`
`[getRealization](#getRealization())()`
Returns the value of the '***Realization***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityEdge](../../activities/mdbasicactivities/ActivityEdge.html)>`
...
Method Details
getRealization
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Relationship](../../classes/mdkernel/Relationship.html)> getRealization()
Returns the value of the '***Realization***' reference list.
...
Generated:
getConveyed
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)> getConveyed()
Returns the value of the '***Conveyed***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)> getInformationSource()
Returns the value of the '***Information Source***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[NamedElement](../../classes/mdkernel/NamedElement.html)> getInformationTarget()
Returns the value of the '***Information Target***' reference list.
 The list contents are of type [`NamedElement`](../../classes/mdkernel/NamedElement.html).
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityEdge](../../activities/mdbasicactivities/ActivityEdge.html)> getRealizingActivityEdge()
Returns the value of the '***Realizing Activity Edge***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Connector](../../compositestructures/mdinternalstructures/Connector.html)> getRealizingConnector()
Returns the value of the '***Realizing Connector***' reference list.
...
Generated:
getRealizingMessage
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Message](../../interactions/mdbasicinteractions/Message.html)> getRealizingMessage()
Returns the value of the '***Realizing Message***' reference list.
...
<div class="block">Returns the value of the '<em><b>Realizing Connector</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<code>.mdinternalstructures.Connector#get_informationFlowOfRealizingConnector <em>information Flow Of Realizing Connector</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Determines which Connectors will realize the specified flow.
