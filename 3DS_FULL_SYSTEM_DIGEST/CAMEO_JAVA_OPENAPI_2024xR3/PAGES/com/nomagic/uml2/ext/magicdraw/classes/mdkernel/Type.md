# JAVA OPENAPI: Type (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Type.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/Type.html`
- source_sha256: `4ccf5eb09a14e4aa689eb31481ea92160f7abfb36aaa3d2032cfdf552d9022ba`
- captured_utc: `2026-07-14T16:56:22.838765+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Association](Association.html)>`
`[get_associationOfEndType](#get_associationOfEndType())()`
Returns the value of the '***association Of End Type***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[BehavioralFeature](BehavioralFeature.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[TypedElement](TypedElement.html)>`
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[BehavioralFeature](BehavioralFeature.html)> get_behavioralFeatureOfRaisedException()
Returns the value of the '***behavioral Feature Of Raised Exception***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Operation](Operation.html)> get_operationOfRaisedException()
Returns the value of the '***operation Of Raised Exception***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Association](Association.html)> get_associationOfEndType()
Returns the value of the '***association Of End Type***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[TypedElement](TypedElement.html)> get_typedElementOfType()
Returns the value of the '***typed Element Of Type***' reference list.
