# JAVA OPENAPI: CombinedFragment (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/interactions/mdfragments/CombinedFragment.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdfragments/CombinedFragment.html`
- source_sha256: `fbe809032f95ba431eeba673e825f5bee28e87a967d6a0a5bcb06088ed0512dd`
- captured_utc: `2026-07-14T16:56:25.132793+00:00`
...
`[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[InteractionOperand](InteractionOperand.html)>`
...
Method Details
getCfragmentGate
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Gate](Gate.html)> getCfragmentGate()
Returns the value of the '***Cfragment Gate***' containment reference list.
...
Generated:
getOperand
[List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html)<[InteractionOperand](InteractionOperand.html)> getOperand()
Returns the value of the '***Operand***' containment reference list.
