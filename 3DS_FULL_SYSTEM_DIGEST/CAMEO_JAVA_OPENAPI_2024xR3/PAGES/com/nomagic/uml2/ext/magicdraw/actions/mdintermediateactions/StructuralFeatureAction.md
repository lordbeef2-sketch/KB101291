# JAVA OPENAPI: StructuralFeatureAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/StructuralFeatureAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/StructuralFeatureAction.html`
- source_sha256: `ead2be80dffb6fdcca115e3bb4d5338e323fae7c9c0fd9e576f42d5b14669a18`
- captured_utc: `2026-07-14T16:56:18.868720+00:00`
...
`[AddStructuralFeatureValueAction](AddStructuralFeatureValueAction.html)`, `[ClearStructuralFeatureAction](ClearStructuralFeatureAction.html)`, `[ReadStructuralFeatureAction](ReadStructuralFeatureAction.html)`, `[RemoveStructuralFeatureValueAction](RemoveStructuralFeatureValueAction.html)`, `[WriteStructuralFeatureAction](WriteStructuralFeatureAction.html)`

public interfaceStructuralFeatureActionextends [Action](../mdbasicactions/Action.html)
...
The following features are supported:
 [`*Object*`](#getObject())
[`*Structural Feature*`](#getStructuralFeature())

See Also:
[`UMLPackage.getStructuralFeatureAction()`](../../metadata/UMLPackage.html#getStructuralFeatureAction())
Model:
abstract="true"
...
Sets the value of the '[`*Object*`](#getObject())' containment
 reference.
`void`
`[setStructuralFeature](#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature))([StructuralFeature](../../classes/mdkernel/StructuralFeature.html) value)`
Sets the value of the
 '[`*Structural Feature*`](#getStructuralFeature())' reference.
...
@CheckForNull[StructuralFeature](../../classes/mdkernel/StructuralFeature.html) getStructuralFeature()
Returns the value of the '***Structural Feature***' reference.
 It is bidirectional and its opposite is '[`*structural Feature Action Of Structural Feature*`](../../classes/mdkernel/StructuralFeature.html#get_structuralFeatureActionOfStructuralFeature())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setStructuralFeature(StructuralFeature)`](#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature))
[`UMLPackage.getStructuralFeatureAction_StructuralFeature()`](../../metadata/UMLPackage.html#getStructuralFeatureAction_StructuralFeature())
[`StructuralFeature.get_structuralFeatureActionOfStructuralFeature()`](../../classes/mdkernel/StructuralFeature.html#get_structuralFeatureActionOfStructuralFeature())
Model:
opposite="_structuralFeatureActionOfStructuralFeature" required="true" ordered="false"
Generated:
setStructuralFeature
void setStructuralFeature(@CheckForNull
 [StructuralFeature](../../classes/mdkernel/StructuralFeature.html) value)
Sets the value of the
 '[`*Structural Feature*`](#getStructuralFeature())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*Structural Feature*' reference.
See Also:
[`getStructuralFeature()`](#getStructuralFeature())
Generated:
getObject
...
Returns the value of the '***Object***' containment reference.
 ...
 '[`*structural Feature Action Of Object*`](../mdbasicactions/InputPin.html#get_structuralFeatureActionOfObject())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getStructuralFeatureAction_Object()`](../../metadata/UMLPackage.html#getStructuralFeatureAction_Object())
[`InputPin.get_structuralFeatureActionOfObject()`](../mdbasicactions/InputPin.html#get_structuralFeatureActionOfObject())
Model:
opposite="_structuralFeatureActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setObject
...
<h1 class="title" title="Interface StructuralFeatureAction">Interface StructuralFeatureAction</h1>
</div>
...
<dd><code><a href="AddStructuralFeatureValueAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">AddStructuralFeatureValueAction</a></code>, <code><a href="ClearStructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">ClearStructuralFeatureAction</a></code>, <code><a href="ReadStructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">ReadStructuralFeatureAction</a></code>, <code><a href="RemoveStructuralFeatureValueAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">RemoveStructuralFeatureValueAction</a></code>, <code><a href="WriteStructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">WriteStructuralFeatureAction</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">StructuralFeatureAction</span><span class="extends-implements">
...
<li><a href="#getStructuralFeature()"><code><em>Structural Feature</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getStructuralFeatureAction()"><code>UMLPackage.getStructuralFeatureAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
 annotation="MOF package='actions.mdintermediateactions'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../classes/mdkernel/StructuralFeature.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">StructuralFeature</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getStructuralFeature()">getStructuralFeature</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Structural Feature</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature)">setStructuralFeature</a><wbr/>(<a href="../../classes/mdkernel/StructuralFeature.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">StructuralFeature</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#getStructuralFeature()"><code><em>Structural Feature</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getStructuralFeature()">
<h3>getStructuralFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/StructuralFeature.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">StructuralFeature</a></span> <span class="element-name">getStructuralFeature</span>()</div>
<div class="block">Returns the value of the '<em><b>Structural Feature</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/StructuralFeature.html#get_structuralFeatureActionOfStructuralFeature()"><code><em>structural Feature Action Of Structural Feature</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The StructuralFeature to be read or written.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Structural Feature</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature)"><code>setStructuralFeature(StructuralFeature)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getStructuralFeatureAction_StructuralFeature()"><code>UMLPackage.getStructuralFeatureAction_StructuralFeature()</code></a></li>
<li><a href="../../classes/mdkernel/StructuralFeature.html#get_structuralFeatureActionOfStructuralFeature()"><code>StructuralFeature.get_structuralFeatureActionOfStructuralFeature()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_structuralFeatureActionOfStructuralFeature" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature)">
<h3>setStructuralFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setStructuralFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../classes/mdkernel/StructuralFeature.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">StructuralFeature</a> value)</span></div>
<div class="block">Sets the value of the
 '<a href="#getStructuralFeature()"><code><em>Structural Feature</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Structural Feature</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getStructuralFeature()"><code>getStructuralFeature()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_structuralFeatureActionOfObject()"><code><em>structural Feature Action Of Object</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin from which the object whose StructuralFeature is to be read or written is obtained.
...
<li><a href="../../metadata/UMLPackage.html#getStructuralFeatureAction_Object()"><code>UMLPackage.getStructuralFeatureAction_Object()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_structuralFeatureActionOfObject()"><code>InputPin.get_structuralFeatureActionOfObject()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_structuralFeatureActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
