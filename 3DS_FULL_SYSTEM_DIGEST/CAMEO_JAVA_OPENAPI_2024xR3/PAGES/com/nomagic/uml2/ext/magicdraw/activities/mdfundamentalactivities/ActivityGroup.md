# JAVA OPENAPI: ActivityGroup (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/activities/mdfundamentalactivities/ActivityGroup.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdfundamentalactivities/ActivityGroup.html`
- source_sha256: `9171f682f065e37262b3b757a8093bc942fb3e78a069c09768b911993d4bf544`
- captured_utc: `2026-07-14T16:56:19.876731+00:00`
...
`[ActivityPartition](../mdintermediateactivities/ActivityPartition.html)`, `[ConditionalNode](../mdstructuredactivities/ConditionalNode.html)`, `[ExpansionRegion](../mdextrastructuredactivities/ExpansionRegion.html)`, `[InterruptibleActivityRegion](../mdcompleteactivities/InterruptibleActivityRegion.html)`, `[LoopNode](../mdstructuredactivities/LoopNode.html)`, `[SequenceNode](../mdstructuredactivities/SequenceNode.html)`, `[StructuredActivityNode](../mdstructuredactivities/StructuredActivityNode.html)`

public interfaceActivityGroupextends [NamedElement](../../classes/mdkernel/NamedElement.html)
...
The following features are supported:
 [`*Contained Node*`](#getContainedNode())
[`*In Activity*`](#getInActivity())
[`*Subgroup*`](#getSubgroup())
[`*Super Group*`](#getSuperGroup())
[`*Contained Edge*`](#getContainedEdge())

See Also:
[`UMLPackage.getActivityGroup()`](../../metadata/UMLPackage.html#getActivityGroup())
Model:
abstract="true"
...
`[getContainedEdge](#getContainedEdge())()`
...
`[getContainedNode](#getContainedNode())()`
Returns the value of the '***Contained Node***' reference list.
`[Activity](Activity.html)`
`[getInActivity](#getInActivity())()`
...
`[ActivityGroup](ActivityGroup.html)`
`[getSuperGroup](#getSuperGroup())()`
Returns the value of the '***Super Group***' reference.
`boolean`
`[hasContainedEdge](#hasContainedEdge())()`

`boolean`
`[hasContainedNode](#hasContainedNode())()`

`boolean`
`[hasSubgroup](#hasSubgroup())()`

`void`
`[setInActivity](#setInActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity))([Activity](Activity.html) value)`
Sets the value of the '[`*In Activity*`](#getInActivity())' container
 reference.
`void`
`[setSuperGroup](#setSuperGroup(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.ActivityGroup))([ActivityGroup](ActivityGroup.html) value)`
Sets the value of the '[`*Super Group*`](#getSuperGroup())' reference.
...
Method Details
getContainedNode
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityNode](ActivityNode.html)> getContainedNode()
Returns the value of the '***Contained Node***' reference list.
 The list contents are of type [`ActivityNode`](ActivityNode.html).
 It is bidirectional and its opposite is '[`*In Group*`](ActivityNode.html#getInGroup())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getActivityGroup_ContainedNode()`](../../metadata/UMLPackage.html#getActivityGroup_ContainedNode())
[`ActivityNode.getInGroup()`](ActivityNode.html#getInGroup())
Model:
opposite="inGroup" transient="true" volatile="true" derived="true" ordered="false"
Generated:
getInActivity
@CheckForNull[Activity](Activity.html) getInActivity()
Returns the value of the '***In Activity***' container reference.
 It is bidirectional and its opposite is '[`*Group*`](Activity.html#getGroup())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setInActivity(Activity)`](#setInActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity))
[`UMLPackage.getActivityGroup_InActivity()`](../../metadata/UMLPackage.html#getActivityGroup_InActivity())
[`Activity.getGroup()`](Activity.html#getGroup())
Model:
...
Generated:
getSubgroup
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityGroup](ActivityGroup.html)> getSubgroup()
Returns the value of the '***Subgroup***' reference list.
...
See Also:
[`UMLPackage.getActivityGroup_Subgroup()`](../../metadata/UMLPackage.html#getActivityGroup_Subgroup())
[`getSuperGroup()`](#getSuperGroup())
Model:
opposite="superGroup" transient="true" volatile="true" derived="true" ordered="false"
Generated:
getSuperGroup
@CheckForNull[ActivityGroup](ActivityGroup.html) getSuperGroup()
Returns the value of the '***Super Group***' reference.
 It is bidirectional and its opposite is '[`*Subgroup*`](#getSubgroup())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setSuperGroup(ActivityGroup)`](#setSuperGroup(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.ActivityGroup))
[`UMLPackage.getActivityGroup_SuperGroup()`](../../metadata/UMLPackage.html#getActivityGroup_SuperGroup())
[`getSubgroup()`](#getSubgroup())
Model:
...
void setSuperGroup(@CheckForNull
 [ActivityGroup](ActivityGroup.html) value)
Sets the value of the '[`*Super Group*`](#getSuperGroup())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
Generated:
getContainedEdge
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ActivityEdge](../mdbasicactivities/ActivityEdge.html)> getContainedEdge()
Returns the value of the '***Contained Edge***' reference list.
 The list contents are of type [`ActivityEdge`](../mdbasicactivities/ActivityEdge.html).
 It is bidirectional and its opposite is '[`*In Group*`](../mdbasicactivities/ActivityEdge.html#getInGroup())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getActivityGroup_ContainedEdge()`](../../metadata/UMLPackage.html#getActivityGroup_ContainedEdge())
[`ActivityEdge.getInGroup()`](../mdbasicactivities/ActivityEdge.html#getInGroup())
Model:
opposite="inGroup" transient="true" volatile="true" derived="true" ordered="false"
Generated:
hasContainedNode
...
<h1 class="title" title="Interface ActivityGroup">Interface ActivityGroup</h1>
</div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getContainedNode()"><code><em>Contained Node</em></code></a></li>
<li><a href="#getInActivity()"><code><em>In Activity</em></code></a></li>
<li><a href="#getSubgroup()"><code><em>Subgroup</em></code></a></li>
<li><a href="#getSuperGroup()"><code><em>Super Group</em></code></a></li>
<li><a href="#getContainedEdge()"><code><em>Contained Edge</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getActivityGroup()"><code>UMLPackage.getActivityGroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getContainedEdge()">getContainedEdge</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Contained Edge</b></em>' reference list.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getContainedNode()">getContainedNode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Contained Node</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Activity.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">Activity</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInActivity()">getInActivity</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>In Activity</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSubgroup()">getSubgroup</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Subgroup</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActivityGroup.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityGroup</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSuperGroup()">getSuperGroup</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Super Group</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasContainedEdge()">hasContainedEdge</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasContainedNode()">hasContainedNode</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasSubgroup()">hasSubgroup</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setInActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity)">setInActivity</a><wbr/>(<a href="Activity.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">Activity</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getInActivity()"><code><em>In Activity</em></code></a>' container
 reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setSuperGroup(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.ActivityGroup)">setSuperGroup</a><wbr/>(<a href="ActivityGroup.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityGroup</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getSuperGroup()"><code><em>Super Group</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getContainedNode()">
<h3>getContainedNode</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ActivityNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityNode</a>&gt;</span> <span class="element-name">getContainedNode</span>()</div>
<div class="block">Returns the value of the '<em><b>Contained Node</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="ActivityNode.html#getInGroup()"><code><em>In Group</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 ActivityNodes immediately contained in the ActivityGroup.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Contained Node</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getActivityGroup_ContainedNode()"><code>UMLPackage.getActivityGroup_ContainedNode()</code></a></li>
<li><a href="ActivityNode.html#getInGroup()"><code>ActivityNode.getInGroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="inGroup" transient="true" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getInActivity()">
<h3>getInActivity</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Activity.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">Activity</a></span> <span class="element-name">getInActivity</span>()</div>
<div class="block">Returns the value of the '<em><b>In Activity</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Activity.html#getGroup()"><code><em>Group</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Activity containing the ActivityGroup, if it is directly owned by an Activity.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>In Activity</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setInActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity)"><code>setInActivity(Activity)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getActivityGroup_InActivity()"><code>UMLPackage.getActivityGroup_InActivity()</code></a></li>
<li><a href="Activity.html#getGroup()"><code>Activity.getGroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="group" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setInActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity)">
<h3>setInActivity</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setInActivity</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>In Activity</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getInActivity()"><code>getInActivity()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getSubgroup()">
<h3>getSubgroup</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ActivityGroup.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityGroup</a>&gt;</span> <span class="element-name">getSubgroup</span>()</div>
<div class="block">Returns the value of the '<em><b>Subgroup</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="#getSuperGroup()"><code><em>Super Group</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Other ActivityGroups immediately contained in this ActivityGroup.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Subgroup</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getActivityGroup_Subgroup()"><code>UMLPackage.getActivityGroup_Subgroup()</code></a></li>
<li><a href="#getSuperGroup()"><code>getSuperGroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="superGroup" transient="true" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSuperGroup()">
<h3>getSuperGroup</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActivityGroup.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityGroup</a></span> <span class="element-name">getSuperGroup</span>()</div>
<div class="block">Returns the value of the '<em><b>Super Group</b></em>' reference.
 It is bidirectional and its opposite is '<a href="#getSubgroup()"><code><em>Subgroup</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The ActivityGroup immediately containing this ActivityGroup, if it is directly owned by another ActivityGroup.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Super Group</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setSuperGroup(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.ActivityGroup)"><code>setSuperGroup(ActivityGroup)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getActivityGroup_SuperGroup()"><code>UMLPackage.getActivityGroup_SuperGroup()</code></a></li>
<li><a href="#getSubgroup()"><code>getSubgroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="subgroup" transient="true" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setSuperGroup(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.ActivityGroup)">
<h3>setSuperGroup</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setSuperGroup</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ActivityGroup.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities">ActivityGroup</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getSuperGroup()"><code><em>Super Group</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Super Group</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
<li><a href="#getSuperGroup()"><code>getSuperGroup()</code></a></li>
...
<li>
<section class="detail" id="getContainedEdge()">
<h3>getContainedEdge</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../mdbasicactivities/ActivityEdge.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ActivityEdge</a>&gt;</span> <span class="element-name">getContainedEdge</span>()</div>
<div class="block">Returns the value of the '<em><b>Contained Edge</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="../mdbasicactivities/ActivityEdge.html#getInGroup()"><code><em>In Group</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 ActivityEdges immediately contained in the ActivityGroup.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Contained Edge</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getActivityGroup_ContainedEdge()"><code>UMLPackage.getActivityGroup_ContainedEdge()</code></a></li>
<li><a href="../mdbasicactivities/ActivityEdge.html#getInGroup()"><code>ActivityEdge.getInGroup()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="inGroup" transient="true" volatile="true" derived="true" ordered="false"</dd>
...
<li>
<section class="detail" id="hasContainedNode()">
<h3>hasContainedNode</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasContainedNode</span>()
...
<li>
<section class="detail" id="hasSubgroup()">
<h3>hasSubgroup</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasSubgroup</span>()
             throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="hasContainedEdge()">
<h3>hasContainedEdge</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasContainedEdge</span>()
                  throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
