# JAVA OPENAPI: WriteStructuralFeatureAction (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/WriteStructuralFeatureAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/WriteStructuralFeatureAction.html`
- source_sha256: `cd05c5ece732204fdb8f1fab7598b8975f4e3797d103268fdca3f41ee150b545`
- captured_utc: `2026-07-14T16:56:18.722718+00:00`
...
See Also:
[`UMLPackage.getWriteStructuralFeatureAction()`](../../metadata/UMLPackage.html#getWriteStructuralFeatureAction())
Model:
abstract="true"
...
Sets the value of the '[`*Value*`](#getValue())' containment
 reference.
...
Returns the value of the '***Value***' containment reference.
 It is bidirectional and its opposite is '[`*write
 Structural Feature Action Of Value*`](../mdbasicactions/InputPin.html#get_writeStructuralFeatureActionOfValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getWriteStructuralFeatureAction_Value()`](../../metadata/UMLPackage.html#getWriteStructuralFeatureAction_Value())
[`InputPin.get_writeStructuralFeatureActionOfValue()`](../mdbasicactions/InputPin.html#get_writeStructuralFeatureActionOfValue())
Model:
opposite="_writeStructuralFeatureActionOfValue" containment="true" resolveProxies="true" ordered="false"
Generated:
setValue
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is '[`*write Structural Feature Action Of Result*`](../mdbasicactions/OutputPin.html#get_writeStructuralFeatureActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getWriteStructuralFeatureAction_Result()`](../../metadata/UMLPackage.html#getWriteStructuralFeatureAction_Result())
[`OutputPin.get_writeStructuralFeatureActionOfResult()`](../mdbasicactions/OutputPin.html#get_writeStructuralFeatureActionOfResult())
Model:
opposite="_writeStructuralFeatureActionOfResult" containment="true" resolveProxies="true" ordered="false"
Generated:
setResult
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">WriteStructuralFeatureAction</span><span class="extends-implements">
extends <a href="StructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">StructuralFeatureAction</a></span></div>
...
<li><a href="../../metadata/UMLPackage.html#getWriteStructuralFeatureAction()"><code>UMLPackage.getWriteStructuralFeatureAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' containment reference.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getValue()"><code><em>Value</em></code></a>' containment
 reference.</div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Value</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_writeStructuralFeatureActionOfValue()"><code><em>write
 Structural Feature Action Of Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that provides the value to be added or removed from the StructuralFeature.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Value</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="#setValue(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setValue(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getWriteStructuralFeatureAction_Value()"><code>UMLPackage.getWriteStructuralFeatureAction_Value()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_writeStructuralFeatureActionOfValue()"><code>InputPin.get_writeStructuralFeatureActionOfValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_writeStructuralFeatureActionOfValue" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Value</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list">
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/OutputPin.html#get_writeStructuralFeatureActionOfResult()"><code><em>write Structural Feature Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which is put the input object as modified by the WriteStructuralFeatureAction.
...
<li><a href="../../metadata/UMLPackage.html#getWriteStructuralFeatureAction_Result()"><code>UMLPackage.getWriteStructuralFeatureAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_writeStructuralFeatureActionOfResult()"><code>OutputPin.get_writeStructuralFeatureActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_writeStructuralFeatureActionOfResult" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
