# JAVA OPENAPI: StateMachine (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/StateMachine.html
- source_path: `com/nomagic/uml2/ext/magicdraw/statemachines/mdbehaviorstatemachines/StateMachine.html`
- source_sha256: `61c5be2501bef3c3b85c34b24926a644d102b302e7f95d6718135fee093bb947`
- captured_utc: `2026-07-14T16:56:26.019801+00:00`
...
`[ProtocolStateMachine](../mdprotocolstatemachines/ProtocolStateMachine.html)`

public interfaceStateMachineextends [Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html)

begin-user-doc 
 A representation of the model object '***State Machine***'.
 end-user-doc 
begin-model-doc 
 StateMachines can be used to express event-driven behaviors of parts of a system. Behavior is modeled as a traversal of a graph of Vertices interconnected by one or
 more joined Transition arcs that are triggered by the dispatching of successive Event occurrences. During this traversal, the StateMachine may execute a sequence of
 Behaviors associated with various elements of the StateMachine.
 end-model-doc 
The following features are supported:
 [`*Connection Point*`](#getConnectionPoint())
[`*Extended State Machine*`](#getExtendedStateMachine())
[`*state Machine Of Extended State Machine*`](#get_stateMachineOfExtendedStateMachine())
[`*Submachine State*`](#getSubmachineState())
[`*Region*`](#getRegion())

See Also:
[`UMLPackage.getStateMachine()`](../../metadata/UMLPackage.html#getStateMachine())
Model:
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)>`
`[get_stateMachineOfExtendedStateMachine](#get_stateMachineOfExtendedStateMachine())()`
Returns the value of the '***state Machine Of Extended State Machine***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[State](State.html)>`
`[getSubmachineState](#getSubmachineState())()`
...
`boolean`
`[hasExtendedStateMachine](#hasExtendedStateMachine())()`

`boolean`
`[hasRegion](#hasRegion())()`

`boolean`
`[hasSubmachineState](#hasSubmachineState())()`
...
Method Details
getConnectionPoint
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Pseudostate](Pseudostate.html)> getConnectionPoint()
Returns the value of the '***Connection Point***' containment reference list.
 The list contents are of type [`Pseudostate`](Pseudostate.html).
 It is bidirectional and its opposite is
 '[`*State Machine*`](Pseudostate.html#getStateMachine())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getStateMachine_ConnectionPoint()`](../../metadata/UMLPackage.html#getStateMachine_ConnectionPoint())
[`Pseudostate.getStateMachine()`](Pseudostate.html#getStateMachine())
Model:
opposite="stateMachine" containment="true" resolveProxies="true" ordered="false"
Generated:
getSubmachineState
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[State](State.html)> getSubmachineState()
Returns the value of the '***Submachine State***' reference list.
 The list contents are of type [`State`](State.html).
 It is bidirectional and its opposite is '[`*Submachine*`](State.html#getSubmachine())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getStateMachine_SubmachineState()`](../../metadata/UMLPackage.html#getStateMachine_SubmachineState())
[`State.getSubmachine()`](State.html#getSubmachine())
Model:
opposite="submachine" ordered="false"
Generated:
getExtendedStateMachine
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)> getExtendedStateMachine()
Returns the value of the '***Extended State Machine***' reference list.
 The list contents are of type [`StateMachine`](StateMachine.html).
 It is bidirectional and its opposite is '[`.StateMachine#get_stateMachineOfExtendedStateMachine *state Machine Of Extended State Machine*`](package-summary.html)'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getStateMachine_ExtendedStateMachine()`](../../metadata/UMLPackage.html#getStateMachine_ExtendedStateMachine())
[`get_stateMachineOfExtendedStateMachine()`](#get_stateMachineOfExtendedStateMachine())
Model:
opposite="_stateMachineOfExtendedStateMachine" ordered="false"
Generated:
get_stateMachineOfExtendedStateMachine
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[StateMachine](StateMachine.html)> get_stateMachineOfExtendedStateMachine()
Returns the value of the '***state Machine Of Extended State Machine***' reference list.
 The list contents are of type [`StateMachine`](StateMachine.html).
 It is bidirectional and its opposite is
 '[`*Extended State Machine*`](#getExtendedStateMachine())'.
 begin-user-doc 
If the meaning of the '*state Machine Of Extended State Machine*' reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*state Machine Of Extended State Machine*' reference list.
See Also:
[`UMLPackage.getStateMachine__stateMachineOfExtendedStateMachine()`](../../metadata/UMLPackage.html#getStateMachine__stateMachineOfExtendedStateMachine())
[`getExtendedStateMachine()`](#getExtendedStateMachine())
Model:
opposite="extendedStateMachine" ordered="false"
Generated:
getRegion
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[Region](Region.html)> getRegion()
Returns the value of the '***Region***' containment reference list.
 The list contents are of type [`Region`](Region.html).
 It is bidirectional and its opposite is
 '[`*State Machine*`](Region.html#getStateMachine())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getStateMachine_Region()`](../../metadata/UMLPackage.html#getStateMachine_Region())
[`Region.getStateMachine()`](Region.html#getStateMachine())
Model:
...
<h1 class="title" title="Interface StateMachine">Interface StateMachine</h1>
</div>
...
<dd><code><a href="../mdprotocolstatemachines/ProtocolStateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdprotocolstatemachines">ProtocolStateMachine</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">StateMachine</span><span class="extends-implements">
...
<li><a href="#getExtendedStateMachine()"><code><em>Extended State Machine</em></code></a></li>
<li><a href="#get_stateMachineOfExtendedStateMachine()"><code><em>state Machine Of Extended State Machine</em></code></a></li>
<li><a href="#getSubmachineState()"><code><em>Submachine State</em></code></a></li>
...
<dd>
<ul class="see-list">
<li><a href="../../metadata/UMLPackage.html#getStateMachine()"><code>UMLPackage.getStateMachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">StateMachine</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_stateMachineOfExtendedStateMachine()">get_stateMachineOfExtendedStateMachine</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>state Machine Of Extended State Machine</b></em>' reference list.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getConnectionPoint()">getConnectionPoint</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Connection Point</b></em>' containment reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">StateMachine</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExtendedStateMachine()">getExtendedStateMachine</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Extended State Machine</b></em>' reference list.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="State.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">State</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSubmachineState()">getSubmachineState</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Submachine State</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_stateMachineOfExtendedStateMachine()">has_stateMachineOfExtendedStateMachine</a>()</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasExtendedStateMachine()">hasExtendedStateMachine</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasSubmachineState()">hasSubmachineState</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Connection Point</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Pseudostate.html#getStateMachine()"><code><em>State Machine</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The connection points defined for this StateMachine. They represent the interface of the StateMachine when used as part of submachine State
...
<li><a href="../../metadata/UMLPackage.html#getStateMachine_ConnectionPoint()"><code>UMLPackage.getStateMachine_ConnectionPoint()</code></a></li>
<li><a href="Pseudostate.html#getStateMachine()"><code>Pseudostate.getStateMachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="stateMachine" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSubmachineState()">
<h3>getSubmachineState</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="State.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">State</a>&gt;</span> <span class="element-name">getSubmachineState</span>()</div>
<div class="block">Returns the value of the '<em><b>Submachine State</b></em>' reference list.
 The list contents are of type <a href="State.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>State</code></a>.
 It is bidirectional and its opposite is '<a href="State.html#getSubmachine()"><code><em>Submachine</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the submachine(s) in case of a submachine State. Multiple machines are referenced in case of a concurrent State.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Submachine State</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getStateMachine_SubmachineState()"><code>UMLPackage.getStateMachine_SubmachineState()</code></a></li>
<li><a href="State.html#getSubmachine()"><code>State.getSubmachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="submachine" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getExtendedStateMachine()">
<h3>getExtendedStateMachine</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">StateMachine</a>&gt;</span> <span class="element-name">getExtendedStateMachine</span>()</div>
<div class="block">Returns the value of the '<em><b>Extended State Machine</b></em>' reference list.
 The list contents are of type <a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>StateMachine</code></a>.
 It is bidirectional and its opposite is '<a href="package-summary.html"><code>.StateMachine#get_stateMachineOfExtendedStateMachine <em>state Machine Of Extended State Machine</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The StateMachines of which this is an extension.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Extended State Machine</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getStateMachine_ExtendedStateMachine()"><code>UMLPackage.getStateMachine_ExtendedStateMachine()</code></a></li>
<li><a href="#get_stateMachineOfExtendedStateMachine()"><code>get_stateMachineOfExtendedStateMachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_stateMachineOfExtendedStateMachine" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_stateMachineOfExtendedStateMachine()">
<h3>get_stateMachineOfExtendedStateMachine</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines">StateMachine</a>&gt;</span> <span class="element-name">get_stateMachineOfExtendedStateMachine</span>()</div>
<div class="block">Returns the value of the '<em><b>state Machine Of Extended State Machine</b></em>' reference list.
 The list contents are of type <a href="StateMachine.html" title="interface in com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines"><code>StateMachine</code></a>.
 It is bidirectional and its opposite is
 '<a href="#getExtendedStateMachine()"><code><em>Extended State Machine</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>state Machine Of Extended State Machine</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>state Machine Of Extended State Machine</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getStateMachine__stateMachineOfExtendedStateMachine()"><code>UMLPackage.getStateMachine__stateMachineOfExtendedStateMachine()</code></a></li>
<li><a href="#getExtendedStateMachine()"><code>getExtendedStateMachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="extendedStateMachine" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Region</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Region.html#getStateMachine()"><code><em>State Machine</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Regions owned directly by the StateMachine.
...
<dd>
<ul class="see-list-long">
<li><a href="../../metadata/UMLPackage.html#getStateMachine_Region()"><code>UMLPackage.getStateMachine_Region()</code></a></li>
<li><a href="Region.html#getStateMachine()"><code>Region.getStateMachine()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="stateMachine" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasSubmachineState()">
<h3>hasSubmachineState</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasSubmachineState</span>()
                    throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="hasExtendedStateMachine()">
<h3>hasExtendedStateMachine</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasExtendedStateMachine</span>()
                         throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="has_stateMachineOfExtendedStateMachine()">
<h3>has_stateMachineOfExtendedStateMachine</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_stateMachineOfExtendedStateMachine</span>()
                                        throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
