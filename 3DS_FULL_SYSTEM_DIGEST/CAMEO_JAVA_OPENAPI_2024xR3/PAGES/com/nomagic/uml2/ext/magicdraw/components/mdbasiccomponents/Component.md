# JAVA OPENAPI: Component (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/Component.html
- source_path: `com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/Component.html`
- source_sha256: `549d61fed321de331b958be9805a4ee54e2f5f6da998f1eb9453470316acf13a`
- captured_utc: `2026-07-14T16:56:24.051778+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ComponentRealization](ComponentRealization.html)>`
...
Generated:
getRealization
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[ComponentRealization](ComponentRealization.html)> getRealization()
Returns the value of the '***Realization***' containment reference list.
...
Generated:
getPackagedElement
[Collection](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Collection.html)<[PackageableElement](../../classes/mdkernel/PackageableElement.html)> getPackagedElement()
Returns the value of the '***Packaged Element***' containment reference list.
...
<li><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getComponent_IndirectlyInstantiated()</code></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Provided</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<code><em>component Of Provided</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Interfaces that the Component exposes to its environment. These Interfaces may be Realized by the Component or any of its realizingClassifiers, or they may
...
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces.Interface#get_componentOfProvided</code></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Required</b></em>' reference list.
 The list contents are of type <a href="../../classes/mdinterfaces/Interface.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces"><code>Interface</code></a>.
 It is bidirectional and its opposite is
 '<code><em>component Of Required</em></code>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Interfaces that the Component requires from other Components in its environment in order to be able to offer its full set of provided functionality. These
...
<li><code>com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces.Interface#get_componentOfRequired</code></li>
</ul>
</dd>
<dt>Model:</dt>
