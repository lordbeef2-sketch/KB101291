# JAVA OPENAPI: ElementImageHelper.ImageInformation (2024x Refresh3 API)

- source_url: https://jdocs.nomagic.com/2024xRefresh3/com/nomagic/uml2/ext/jmi/helpers/ElementImageHelper.ImageInformation.html
- source_path: `com/nomagic/uml2/ext/jmi/helpers/ElementImageHelper.ImageInformation.html`
- source_sha256: `b5c929b68ceb97d4d5697df6ec8ed2d481ee7ff4fafb3f9b25fdaecc58e29770`
- captured_utc: `2026-07-14T16:56:15.810688+00:00`
...
`com.nomagic.magicdraw.icons.ElementImages.ElementImageInformation`, `[Cloneable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html)`
...
`[ImageInformation](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) content,
...
`[ImageInformation](#%3Cinit%3E(java.lang.String,java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) content,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) format,
...
`void`
`[setContent](#setContent(java.lang.String))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) content)`
...
public ImageInformation(@CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) content,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) format,
 @CheckForNull
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) location)
...
ImageInformation
public ImageInformation([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) content,
 [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) format)
Initializes content, format of image.
Parameters:
`content` - content of image. Use [`Utilities.toString(byte[])`](../../../../utils/Utilities.html#toString(byte%5B%5D)) to convert bytes to a string.
...
getContent
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) getContent()
Returns:
...
clone
protected [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html) clone()
Overrides:
...
<div class="inheritance">com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation
...
<dd><code>com.nomagic.magicdraw.icons.ElementImages.ElementImageInformation</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Cloneable.html" title="class or interface in java.lang">Cloneable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><a href="ElementImageHelper.html" title="class in com.nomagic.uml2.ext.jmi.helpers">ElementImageHelper</a></dd>
</dl>
<hr/>
...
<span class="extends-implements">extends com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation</span></div>
...
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation">Methods inherited from class com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation</h3>
...
<h3>ImageInformation</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ImageInformation</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> content,
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setContent</span><wbr/><span class="parameters">(@CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> content)</span></div>
<div class="block"><span class="descfrm-type-label">Description copied from interface: <code>com.nomagic.magicdraw.icons.ElementImages.ElementImageInformation</code></span></div>
...
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getContent</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>equals</code> in class <code>com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hashCode</code> in class <code>com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span> <span class="element-name">clone</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>clone</code> in class <code>com.nomagic.magicdraw.icons.ElementImages.AbstractElementImageInformation</code></dd>
</dl>
</section>
</li>
</ul>
