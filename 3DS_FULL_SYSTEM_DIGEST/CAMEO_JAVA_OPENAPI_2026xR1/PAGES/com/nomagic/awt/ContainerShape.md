# JAVA OPENAPI: ContainerShape (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/awt/ContainerShape.html
- source_path: `com/nomagic/awt/ContainerShape.html`
- source_sha256: `4f261af5bd249211c282a1bc7bcbfc228fd61b7d5daad9193f088649447a04e4`
- captured_utc: `2026-07-14T16:45:07.774106+00:00`
...
Description
`void`
`[addEllipse](#addEllipse(java.awt.Rectangle))([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) el)`
Add ellipse.
`void`
`[addShape](#addShape(com.nomagic.awt.Line))([Line](Line.html) line)`
Add line.
`void`
`[addShape](#addShape(java.awt.geom.RoundRectangle2D))([RoundRectangle2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/geom/RoundRectangle2D.html) rect)`
Add rectangle shape.
`void`
`[addShape](#addShape(java.awt.Polygon))([Polygon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Polygon.html) polygon)`
Add Polygon.
`void`
`[addShape](#addShape(java.awt.Rectangle))([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) rect)`
Add rectangle shape.
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Line](Line.html)>`
`[getLines](#getLines())()`
Returns contained lines.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Polygon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Polygon.html)>`
`[getPolygons](#getPolygons())()`
Returns polygons
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html)>`
`[getRectangles](#getRectangles())()`
Returns contained rectangles.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[RoundRectangle2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/geom/RoundRectangle2D.html)>`
...
`[Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html)`
`[intersection](#intersection(java.awt.Point,java.awt.Point))([Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) a,
 [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) b)`

`boolean`
`[intersects](#intersects(java.awt.Rectangle))([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) bounds)`
...
Method Details
intersection
@CheckForNullpublic [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) intersection([Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) a,
 [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) b)
intersection
@CheckForNullpublic [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) intersection(int ax,
 int ay,
 int bx,
 int by)
Computes the intersection of this shape (intersection with any of contained shapes) with the specified line.
...
addShape
public void addShape([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) rect)
Add rectangle shape.
addShape
public void addShape([RoundRectangle2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/geom/RoundRectangle2D.html) rect)
Add rectangle shape.
addShape
public void addShape([Line](Line.html) line)
Add line.
addEllipse
public void addEllipse([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) el)
Add ellipse.
addShape
public void addShape([Polygon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Polygon.html) polygon)
Add Polygon.
getEllipses
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html)> getEllipses()
Returns contained ellipses
Returns:
ellipses
getRectangles
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html)> getRectangles()
Returns contained rectangles.
Returns:
rectangle
getLines
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Line](Line.html)> getLines()
Returns contained lines.
Returns:
lines
getRoundRectangles
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[RoundRectangle2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/geom/RoundRectangle2D.html)> getRoundRectangles()
Returns round rectangles
Returns:
round rectangles
getPolygons
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Polygon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Polygon.html)> getPolygons()
Returns polygons
Returns:
polygons
...
created container shape.
intersects
public boolean intersects([Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) bounds)
Indicates if container shape intersects with specified bounds.
Parameters:
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="Line.html" title="class in com.nomagic.awt">Line</a>&gt;</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#intersection(java.awt.Point,java.awt.Point)">intersection</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a> a,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a> b)</code></div>
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a> b)</span></div>
</section>
</li>
<li>
...
<h3>intersection</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></span> <span class="element-name">intersection</span><wbr/><span class="parameters">(int ax,
 int ay,
 int bx,
 int by)</span></div>
