# JAVA OPENAPI: ColoredRichTextBuilder (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/text/builders/ColoredRichTextBuilder.html
- source_path: `com/nomagic/text/builders/ColoredRichTextBuilder.html`
- source_sha256: `c1cb504c0e6aa332dddfe1722b9a5789d008170d6a4fe5841f6828fdde25bf74`
- captured_utc: `2026-07-14T16:46:16.582021+00:00`
...
[com.nomagic.text.builders.RichTextBuilder](RichTextBuilder.html)<T>
com.nomagic.text.builders.ColoredRichTextBuilder<T>

All Implemented Interfaces:
`[TextBuilder](TextBuilder.html)<T>`

@OpenApiAllpublic classColoredRichTextBuilder<T extends ColoredRichTextBuilder>
extends [RichTextBuilder](RichTextBuilder.html)<T>
...
Constructor
Description
`[ColoredRichTextBuilder](#%3Cinit%3E())()`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[toString](#toString())()`
Methods inherited from class com.nomagic.text.builders.[RichTextBuilder](RichTextBuilder.html)
`[toAppendableText](RichTextBuilder.html#toAppendableText(java.lang.String)), [toPlainText](RichTextBuilder.html#toPlainText())`
...
Method Details
setColor
public [T](ColoredRichTextBuilder.html) setColor(@CheckForNull
...
Specified by:
`[compress](TextBuilder.html#compress(int))` in interface `[TextBuilder](TextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Overrides:
`[compress](RichTextBuilder.html#compress(int))` in class `[RichTextBuilder](RichTextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Parameters:
...
Overrides:
`[appendColor](AbstractTextBuilder.html#appendColor(java.lang.String))` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
prependColor
...
Overrides:
`[prependColor](AbstractTextBuilder.html#prependColor(java.lang.String))` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
setText
...
Replace current text with the given one
Specified by:
`[setText](TextBuilder.html#setText(java.lang.CharSequence))` in interface `[TextBuilder](TextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Overrides:
`[setText](AbstractTextBuilder.html#setText(java.lang.CharSequence))` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Parameters:
`text` - text
toString
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) toString()
Specified by:
`[toString](TextBuilder.html#toString())` in interface `[TextBuilder](TextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Overrides:
`[toString](AbstractTextBuilder.html#toString())` in class `[AbstractTextBuilder](AbstractTextBuilder.html)<[T](ColoredRichTextBuilder.html) extends [ColoredRichTextBuilder](ColoredRichTextBuilder.html)>`
Returns:
result string
isColorSupported
...
<h1 class="title" title="Class ColoredRichTextBuilder">Class ColoredRichTextBuilder&lt;T extends ColoredRichTextBuilder&gt;</h1>
</div>
...
<div class="inheritance"><a href="RichTextBuilder.html" title="class in com.nomagic.text.builders">com.nomagic.text.builders.RichTextBuilder</a>&lt;T&gt;
<div class="inheritance">com.nomagic.text.builders.ColoredRichTextBuilder&lt;T&gt;</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ColoredRichTextBuilder&lt;T extends ColoredRichTextBuilder&gt;</span>
<span class="extends-implements">extends <a href="RichTextBuilder.html" title="class in com.nomagic.text.builders">RichTextBuilder</a>&lt;T&gt;</span></div>
<div class="block">A builder used for rich text building. Colored fragments are supported.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ColoredRichTextBuilder</a>()</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#compress(int)">compress</a><wbr/>(int textLength)</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ColoredRichTextBuilder.html" title="type parameter in ColoredRichTextBuilder">T</a></code></div>
...
<h3 id="methods-inherited-from-class-com.nomagic.text.builders.RichTextBuilder">Methods inherited from class com.nomagic.text.builders.<a href="RichTextBuilder.html" title="class in com.nomagic.text.builders">RichTextBuilder</a></h3>
<code><a href="RichTextBuilder.html#toAppendableText(java.lang.String)">toAppendableText</a>, <a href="RichTextBuilder.html#toPlainText()">toPlainText</a></code></div>
<div class="inherited-list">
...
<h3>ColoredRichTextBuilder</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ColoredRichTextBuilder</span>()</div>
</section>
</li>
</ul>
</section>
...
<h3>setColor</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ColoredRichTextBuilder.html" title="type parameter in ColoredRichTextBuilder">T</a></span> <span class="element-name">setColor</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="TextBuilder.html#compress(int)">TextBuilder</a></code></span></div>
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="TextBuilder.html#compress(int)">compress</a></code> in interface <code><a href="TextBuilder.html" title="interface in com.nomagic.text.builders">TextBuilder</a>&lt;<a href="ColoredRichTextBuilder.html" title="type parameter in ColoredRichTextBuilder">T</a> extends <a href="ColoredRichTextBuilder.html" title="class in com.nomagic.text.builders">ColoredRichTextBuilder</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code><a href="RichTextBuilder.html#compress(int)">compress</a></code> in class <code><a href="RichTextBuilder.html" title="class in com.nomagic.text.builders">RichTextBuilder</a>&lt;<a href="ColoredRichTextBuilder.html" title="type parameter in ColoredRichTextBuilder">T</a> extends <a href="ColoredRichTextBuilder.html" title="class in com.nomagic.text.builders">ColoredRichTextBuilder</a>&gt;</code></dd>
<dt>Parameters:</dt>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="AbstractTextBuilder.html#appendColor(java.lang.String)">appendColor</a></code> in class <code><a href="AbstractTextBuilder.html" title="class in com.nomagic.text.builders">AbstractTextBuilder</a>&lt;<a href="ColoredRichTextBuilder.html" title="type parameter in ColoredRichTextBuilder">T</a> extends <a href="ColoredRichTextBuilder.html" title="class in com.nomagic.text.builders">ColoredRichTextBuilder</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
