# JAVA OPENAPI: RichTextStringUtils (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/text/rich/RichTextStringUtils.html
- source_path: `com/nomagic/text/rich/RichTextStringUtils.html`
- source_sha256: `d88c5b1b057b8a59d7cb2b03e5e5ea14e02cb0bed65fbf61ccebee188b19ad9e`
- captured_utc: `2026-07-14T16:46:16.868025+00:00`
...
Color tag prefix
`static final [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html)`
...
`[closeColor](#closeColor(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)`
Close color tag.
`static void`
`[closeColor](#closeColor(java.lang.StringBuffer))([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text)`
Close color tag.
`static void`
`[closeColor](#closeColor(java.lang.StringBuilder))([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text)`
Close color tag.
`static void`
`[startColor](#startColor(java.lang.StringBuffer,java.awt.Color))([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text,
...
`static void`
`[startColor](#startColor(java.lang.StringBuilder,java.awt.Color))([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`
Set given color to the given text.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[startColor](#startColor(java.lang.String,java.awt.Color))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`
Set given color to the given text.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[toString](#toString(java.awt.Color))([Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`

`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[trimText](#trimText(java.lang.String,int))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 int endIndex)`
Trim text up to the given index.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[trimText](#trimText(java.lang.String,int,int))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 int startIndex,
 int endIndex)`
Trim text from-to the given index.
`static void`
`[wrapInColor](#wrapInColor(java.lang.StringBuffer,java.awt.Color))([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`
Set given color to the given text.
`static void`
`[wrapInColor](#wrapInColor(java.lang.StringBuilder,java.awt.Color))([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`
Set given color to the given text.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[wrapInColor](#wrapInColor(java.lang.String,java.awt.Color))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)`
Set given color to the given text.
...
Field Details
GRAY_COLOR
public static final [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) GRAY_COLOR
Gray color
COLOR_PREFIX
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) COLOR_PREFIX
Color tag prefix
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.text.rich.RichTextStringUtils.COLOR_PREFIX)
COLOR_POSTFIX
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) COLOR_POSTFIX
Color tag postfix
See Also:
...
Method Details
closeColor
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) closeColor([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)
Close color tag.
Parameters:
`text` - text
closeColor
public static void closeColor([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text)
Close color tag.
Parameters:
`text` - text
closeColor
public static void closeColor([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text)
Close color tag.
Parameters:
`text` - text
startColor
public static void startColor([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Set given color to the given text.
Parameters:
`text` - text
`color` - color
startColor
public static void startColor([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Set given color to the given text.
Parameters:
`text` - text
`color` - color
startColor
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) startColor([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Set given color to the given text.
Parameters:
`text` - text
...
wrapInColor
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) wrapInColor(@CheckForNull
...
text with given color
wrapInColor
public static void wrapInColor([StringBuilder](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuilder.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Set given color to the given text.
Parameters:
`text` - text
`color` - color
wrapInColor
public static void wrapInColor([StringBuffer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/StringBuffer.html) text,
 [Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Set given color to the given text.
Parameters:
`text` - text
`color` - color
trimText
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) trimText([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text,
 int endIndex)
...
cut text
toString
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) toString([Color](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html) color)
Parameters:
`color` - color
Returns:
...
<div class="col-first even-row-color"><code>static final <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a></code></div>
...
<h3>GRAY_COLOR</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Color.html" title="class or interface in java.awt">Color</a></span> <span class="element-name">GRAY_COLOR</span></div>
<div class="block">Gray color</div>
</section>
</li>
<li>
