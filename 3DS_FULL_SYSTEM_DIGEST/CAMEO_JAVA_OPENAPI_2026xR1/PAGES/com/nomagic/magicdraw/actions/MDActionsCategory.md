# JAVA OPENAPI: MDActionsCategory (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/actions/MDActionsCategory.html
- source_path: `com/nomagic/magicdraw/actions/MDActionsCategory.html`
- source_sha256: `9d5f10cefd0f2cff9fc0b143580945c93ec3ba87360befba7667d6be759ceefc`
- captured_utc: `2026-07-14T16:45:07.757106+00:00`
...
@OpenApiAllpublic classMDActionsCategory
extends [ActionsCategory](../../actions/ActionsCategory.html)
implements com.nomagic.magicdraw.actions.ShortcutSchemaAction

The class describes the actions' category used in MagicDraw.
 This category uses `ActionsGroupController` for checking enabled/disable state of assigned relative actions group(if it has some group).

See Also:
[Serialized Form](../../../../serialized-form.html#com.nomagic.magicdraw.actions.MDActionsCategory)
...
Constructor
Description
`[MDActionsCategory](#%3Cinit%3E())()`
Creates actions category with no name
`[MDActionsCategory](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`[MDActionsCategory](#%3Cinit%3E(java.lang.String,java.lang.String,int))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 int mnemonic)`
Constructs the action with given id, name, mnemonic key and group.
`[MDActionsCategory](#%3Cinit%3E(java.lang.String,java.lang.String,int,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 int mnemonic,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) group)`
Constructs the action with given id, name, mnemonic key and group.
`[MDActionsCategory](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
...
`[MDActionsCategory](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 [KeyStroke](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/KeyStroke.html) stroke,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) group,
...
<h1 class="title" title="Class MDActionsCategory">Class MDActionsCategory</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.actions.MDActionsCategory</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="DiagramInnerToolbarConfiguration.html" title="class in com.nomagic.magicdraw.actions">DiagramInnerToolbarConfiguration</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public class </span><span class="element-name type-name-label">MDActionsCategory</span>
<span class="extends-implements">extends <a href="../../actions/ActionsCategory.html" title="class in com.nomagic.actions">ActionsCategory</a>
implements com.nomagic.magicdraw.actions.ShortcutSchemaAction</span></div>
<div class="block">The class describes the actions' category used in MagicDraw.
 This category uses <code>ActionsGroupController</code> for checking enabled/disable state of assigned relative actions group(if it has some group).</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../serialized-form.html#com.nomagic.magicdraw.actions.MDActionsCategory">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">MDActionsCategory</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Creates actions category with no name</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">MDActionsCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,int)">MDActionsCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,int,java.lang.String)">MDActionsCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 int mnemonic,
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String)">MDActionsCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String,boolean)">MDActionsCategory</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/KeyStroke.html" title="class or interface in javax.swing">KeyStroke</a> stroke,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isUseShortcutSchema()">isUseShortcutSchema</a>()</code></div>
...
<h3>MDActionsCategory</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MDActionsCategory</span>()</div>
<div class="block">Creates actions category with no name</div>
</section>
</li>
<li>
...
<h3>MDActionsCategory</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MDActionsCategory</span><wbr/><span class="parameters">(@CheckForNull
...
<dd><code>id</code> - the id of the action</dd>
<dd><code>name</code> - the name of the action</dd>
<dd><code>mnemonic</code> - mnemonic char</dd>
</dl>
</section>
</li>
<li>
