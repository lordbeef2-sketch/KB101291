# JAVA OPENAPI: DiagramsActionsManager (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/actions/DiagramsActionsManager.html
- source_path: `com/nomagic/magicdraw/actions/DiagramsActionsManager.html`
- source_sha256: `568f1aba0a9c082fdac139b453daf66f004f2b52bf8e1e101b8ac77a7f7ca454`
- captured_utc: `2026-07-14T16:45:07.724105+00:00`
...
Description
`void`
`[addManager](#addManager(java.lang.String,java.util.function.Supplier))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type,
 [Supplier](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Supplier.html)<[ActionsManager](../../actions/ActionsManager.html)> manager)`
...
`[getManager](#getManager(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)`
Returns the manager for the given diagram type.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ActionsManager](../../actions/ActionsManager.html)>`
`[getManagers](#getManagers())()`
Returns the list of all managers.
`void`
`[removeManager](#removeManager(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)`
...
Method Details
getManager
@CheckForNullpublic [ActionsManager](../../actions/ActionsManager.html) getManager([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)
Returns the manager for the given diagram type.
Returns:
the manager for the given diagram type.
addManager
public void addManager([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type,
 [Supplier](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Supplier.html)<[ActionsManager](../../actions/ActionsManager.html)> manager)
Adds the given manager of the given diagram type.
Parameters:
...
removeManager
public void removeManager([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)
Removes the added manager of the given diagram type.
Parameters:
`type` - the type of the diagram.
getManagers
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ActionsManager](../../actions/ActionsManager.html)> getManagers()
Returns the list of all managers.
Returns:
the list of all managers.
getActionFor
@CheckForNullpublic [NMAction](../../actions/NMAction.html) getActionFor([KeyStroke](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/KeyStroke.html) stroke)
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#addManager(java.lang.String,java.util.function.Supplier)">addManager</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> type,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Supplier.html" title="class or interface in java.util.function">Supplier</a>&lt;<a href="../../actions/ActionsManager.html" title="class in com.nomagic.actions">ActionsManager</a>&gt; manager)</code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">addManager</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> type,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Supplier.html" title="class or interface in java.util.function">Supplier</a>&lt;<a href="../../actions/ActionsManager.html" title="class in com.nomagic.actions">ActionsManager</a>&gt; manager)</span></div>
<div class="block">Adds the given manager of the given diagram type.</div>
<dl class="notes">
<dt>Parameters:</dt>
