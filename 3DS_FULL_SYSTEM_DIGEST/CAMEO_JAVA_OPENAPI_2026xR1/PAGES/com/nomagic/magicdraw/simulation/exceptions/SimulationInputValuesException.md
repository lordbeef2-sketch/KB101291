# JAVA OPENAPI: SimulationInputValuesException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/exceptions/SimulationInputValuesException.html
- source_path: `com/nomagic/magicdraw/simulation/exceptions/SimulationInputValuesException.html`
- source_sha256: `f616dc9dcdf49eca84d77f20aaac9b3ad24293fdbdac3cf43ba0c648e74fcd5f`
- captured_utc: `2026-07-14T16:45:42.396565+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.magicdraw.simulation.exceptions](package-summary.html)

## Class SimulationInputValuesException
...
@OpenApiAllpublic classSimulationInputValuesException
extends [RuntimeException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/RuntimeException.html)

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.simulation.exceptions.SimulationInputValuesException)
...
Constructor
Description
`[SimulationInputValuesException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
SimulationInputValuesException
public SimulationInputValuesException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span> <a href="package-summary.html">com.nomagic.magicdraw.simulation.exceptions</a></div>
<h1 class="title" title="Class SimulationInputValuesException">Class SimulationInputValuesException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.simulation.exceptions.SimulationInputValuesException</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">SimulationInputValuesException</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.simulation.exceptions.SimulationInputValuesException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">SimulationInputValuesException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
...
<h3>SimulationInputValuesException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SimulationInputValuesException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</span></div>
</section>
</li>
</ul>
</section>
