# JAVA OPENAPI: SimulationProfile (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/SimulationProfile.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationProfile.html`
- source_sha256: `cc0ef1d9196e9e42f6f0d6c3b33658dd43dcaae77f28a409fb0c0f0cb76d4365`
- captured_utc: `2026-07-14T16:45:42.708571+00:00`
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) ACTIVESTATEIMAGES_DATATYPE
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) DATARECORDTYPE_DATATYPE
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) DURATIONSIMULATIONMODE_DATATYPE
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) TIMEUNITKIND_DATATYPE
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) TIMELINEMODE_DATATYPE
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) CALLBEHAVIORACTION_CUSTOMIZATION_BODY_PROPERTY
If Behavior is an OpaqueBehavior, represents it's body.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) STATE_CUSTOMIZATION_BODY_PROPERTY
If Behavior is an OpaqueBehavior, represents it's body.
See Also:
