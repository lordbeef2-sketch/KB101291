# JAVA OPENAPI: SimulationHelper (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/SimulationHelper.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationHelper.html`
- source_sha256: `7ffa3d03635f8e9c5c694ec764c294c4b014887fa3cf6fba4c6069fa62cd9ddd`
- captured_utc: `2026-07-14T16:45:40.672542+00:00`
...
Method
Description
`static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[FeatureValue](fuml/classes/FeatureValue.html)>`
`[findFeatureValue](#findFeatureValue(com.nomagic.magicdraw.simulation.fuml.classes.CompoundValue,java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))([CompoundValue](fuml/classes/CompoundValue.html) runtimeContext,
...
Deprecated.
moved to [`fUMLHelper.findFeatureValue(CompoundValue, List, Property)`](fuml/fUMLHelper.html#findFeatureValue(com.nomagic.magicdraw.simulation.fuml.classes.CompoundValue,java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))
`static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Signal](../../uml2/ext/magicdraw/commonbehaviors/mdcommunications/Signal.html)>`
`[getAvailableSignals](#getAvailableSignals(com.nomagic.magicdraw.simulation.fuml.classes.StructuredValue,com.nomagic.magicdraw.simulation.engine.ExecutionEngine))([StructuredValue](fuml/classes/StructuredValue.html) target,
...
`[getConfigElement](#getConfigElement(com.nomagic.magicdraw.simulation.execution.SimulationExecution))([SimulationExecution](execution/SimulationExecution.html) simulationExecution)`
Gets simulation config element from simulation execution.
`static [SimulationExecution](execution/SimulationExecution.html)`
`[getExecution](#getExecution(com.nomagic.magicdraw.core.Project))([Project](../core/Project.html) project)`
...
`[getSimulationOptionValue](#getSimulationOptionValue(java.lang.String,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
...
`[isFeatureValueInvalid](#isFeatureValueInvalid(com.nomagic.magicdraw.simulation.fuml.classes.FeatureValue,int))([FeatureValue](fuml/classes/FeatureValue.html) featureValue,
 int index)`
...
Method Details
findFeatureValue
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[FeatureValue](fuml/classes/FeatureValue.html)> findFeatureValue([CompoundValue](fuml/classes/CompoundValue.html) runtimeContext,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Property](../../uml2/ext/magicdraw/classes/mdkernel/Property.html)> propertyPath,
 [Property](../../uml2/ext/magicdraw/classes/mdkernel/Property.html) target)
Deprecated.
moved to [`fUMLHelper.findFeatureValue(CompoundValue, List, Property)`](fuml/fUMLHelper.html#findFeatureValue(com.nomagic.magicdraw.simulation.fuml.classes.CompoundValue,java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))
...
@CheckForNullpublic static [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getConfigElement(@CheckForNull
 [SimulationExecution](execution/SimulationExecution.html) simulationExecution)
Gets simulation config element from simulation execution.
Parameters:
...
getExecution
@CheckForNullpublic static [SimulationExecution](execution/SimulationExecution.html) getExecution([Project](../core/Project.html) project)
Retrieves object representing ongoing SimulationExecution, if any
isFeatureValueInvalid
@CheckForNullpublic static [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isFeatureValueInvalid([FeatureValue](fuml/classes/FeatureValue.html) featureValue,
 int index)
Check the specified FeatureValue is invalid value or not.
Parameters:
...
getAvailableSignals
public static [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Signal](../../uml2/ext/magicdraw/commonbehaviors/mdcommunications/Signal.html)> getAvailableSignals(@CheckForNull
 [StructuredValue](fuml/classes/StructuredValue.html) target,
 @CheckForNull
 [ExecutionEngine](engine/ExecutionEngine.html) engine)
Get availableSignals from the specified StructuredValue.
Parameters:
...
@CheckForNullpublic static [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) getSimulationOptionValue([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 @CheckForNull
 [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) context)
Get the simulation option value
 In case there is no execution, will try to return the option value from project or environment options of the tool
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4 method-summary-table-tab6"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="fuml/classes/FeatureValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">FeatureValue</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4 method-summary-table-tab6"><code><a class="member-name-link" href="#findFeatureValue(com.nomagic.magicdraw.simulation.fuml.classes.CompoundValue,java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)">findFeatureValue</a><wbr/>(<a href="fuml/classes/CompoundValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">CompoundValue</a> runtimeContext,
...
<div class="deprecation-comment">moved to <a href="fuml/fUMLHelper.html#findFeatureValue(com.nomagic.magicdraw.simulation.fuml.classes.CompoundValue,java.util.List,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)"><code>fUMLHelper.findFeatureValue(CompoundValue, List, Property)</code></a></div>
</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getAvailableSignals(com.nomagic.magicdraw.simulation.fuml.classes.StructuredValue,com.nomagic.magicdraw.simulation.engine.ExecutionEngine)">getAvailableSignals</a><wbr/>(<a href="fuml/classes/StructuredValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">StructuredValue</a> target,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="execution/SimulationExecution.html" title="class in com.nomagic.magicdraw.simulation.execution">SimulationExecution</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getExecution(com.nomagic.magicdraw.core.Project)">getExecution</a><wbr/>(<a href="../core/Project.html" title="class in com.nomagic.magicdraw.core">Project</a> project)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Retrieves object representing ongoing SimulationExecution, if any</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getSimulationOptionValue(java.lang.String,com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getSimulationOptionValue</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#isFeatureValueInvalid(com.nomagic.magicdraw.simulation.fuml.classes.FeatureValue,int)">isFeatureValueInvalid</a><wbr/>(<a href="fuml/classes/FeatureValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">FeatureValue</a> featureValue,
 int index)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Check the specified FeatureValue is invalid value or not.</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="fuml/classes/FeatureValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">FeatureValue</a>&gt;</span> <span class="element-name">findFeatureValue</span><wbr/><span class="parameters">(<a href="fuml/classes/CompoundValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">CompoundValue</a> runtimeContext,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../uml2/ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt; propertyPath,
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="execution/SimulationExecution.html" title="class in com.nomagic.magicdraw.simulation.execution">SimulationExecution</a> simulationExecution)</span></div>
<div class="block">Gets simulation config element from simulation execution.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>simulationExecution</code> - SimulationExecution</dd>
<dt>Returns:</dt>
...
<li>
<section class="detail" id="getExecution(com.nomagic.magicdraw.core.Project)">
<h3>getExecution</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="execution/SimulationExecution.html" title="class in com.nomagic.magicdraw.simulation.execution">SimulationExecution</a></span> <span class="element-name">getExecution</span><wbr/><span class="parameters">(<a href="../core/Project.html" title="class in com.nomagic.magicdraw.core">Project</a> project)</span></div>
<div class="block">Retrieves object representing ongoing SimulationExecution, if any</div>
</section>
</li>
<li>
<section class="detail" id="isFeatureValueInvalid(com.nomagic.magicdraw.simulation.fuml.classes.FeatureValue,int)">
<h3>isFeatureValueInvalid</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html" title="class or interface in java.lang">Boolean</a></span> <span class="element-name">isFeatureValueInvalid</span><wbr/><span class="parameters">(<a href="fuml/classes/FeatureValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">FeatureValue</a> featureValue,
 int index)</span></div>
<div class="block">Check the specified FeatureValue is invalid value or not.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>featureValue</code> - the specified FeatureValue</dd>
...
<li>
<section class="detail" id="getAvailableSignals(com.nomagic.magicdraw.simulation.fuml.classes.StructuredValue,com.nomagic.magicdraw.simulation.engine.ExecutionEngine)">
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html" title="class or interface in java.util">Set</a>&lt;<a href="../../uml2/ext/magicdraw/commonbehaviors/mdcommunications/Signal.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdcommunications">Signal</a>&gt;</span> <span class="element-name">getAvailableSignals</span><wbr/><span class="parameters">(@CheckForNull
 <a href="fuml/classes/StructuredValue.html" title="class in com.nomagic.magicdraw.simulation.fuml.classes">StructuredValue</a> target,
 @CheckForNull
