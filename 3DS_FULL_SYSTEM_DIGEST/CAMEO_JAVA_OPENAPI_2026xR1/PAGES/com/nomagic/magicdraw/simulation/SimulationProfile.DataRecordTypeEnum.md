# JAVA OPENAPI: SimulationProfile.DataRecordTypeEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/simulation/SimulationProfile.DataRecordTypeEnum.html
- source_path: `com/nomagic/magicdraw/simulation/SimulationProfile.DataRecordTypeEnum.html`
- source_sha256: `01a4bf9a407f4d867b5f8ed60abe790d365ee3006306ca629a7b2ec44c114ba8`
- captured_utc: `2026-07-14T16:45:40.775545+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SimulationProfile.DataRecordTypeEnum](SimulationProfile.DataRecordTypeEnum.html)>
com.nomagic.magicdraw.simulation.SimulationProfile.DataRecordTypeEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SimulationProfile.DataRecordTypeEnum](SimulationProfile.DataRecordTypeEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[SimulationProfile](SimulationProfile.html)`

public static enumSimulationProfile.DataRecordTypeEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SimulationProfile.DataRecordTypeEnum](SimulationProfile.DataRecordTypeEnum.html)>
...
valueOf
public static [SimulationProfile.DataRecordTypeEnum](SimulationProfile.DataRecordTypeEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
