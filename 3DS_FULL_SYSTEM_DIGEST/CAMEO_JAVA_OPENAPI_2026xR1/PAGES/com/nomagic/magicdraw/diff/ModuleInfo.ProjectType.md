# JAVA OPENAPI: ModuleInfo.ProjectType (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/diff/ModuleInfo.ProjectType.html
- source_path: `com/nomagic/magicdraw/diff/ModuleInfo.ProjectType.html`
- source_sha256: `1be095758ebcbc3a853d02474528937f512c823cc56c8ec42edea75593f8129a`
- captured_utc: `2026-07-14T16:45:33.164443+00:00`
...
## Enum Class ModuleInfo.ProjectType

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ModuleInfo.ProjectType](ModuleInfo.ProjectType.html)>
com.nomagic.magicdraw.diff.ModuleInfo.ProjectType

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[ModuleInfo.ProjectType](ModuleInfo.ProjectType.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing interface:
`[ModuleInfo](ModuleInfo.html)`

public static enumModuleInfo.ProjectType
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[ModuleInfo.ProjectType](ModuleInfo.ProjectType.html)>
...
`static [ModuleInfo.ProjectType](ModuleInfo.ProjectType.html)`
...
ESI
public static final [ModuleInfo.ProjectType](ModuleInfo.ProjectType.html) ESI
LOCAL
public static final [ModuleInfo.ProjectType](ModuleInfo.ProjectType.html) LOCAL
 ============ METHOD DETAIL ========== 
Method Details
values
public static [ModuleInfo.ProjectType](ModuleInfo.ProjectType.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [ModuleInfo.ProjectType](ModuleInfo.ProjectType.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class ModuleInfo.ProjectType">Enum Class ModuleInfo.ProjectType</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.diff.ModuleInfo.ProjectType</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing interface:</dt>
<dd><code><a href="ModuleInfo.html" title="interface in com.nomagic.magicdraw.diff">ModuleInfo</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">ModuleInfo.ProjectType</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a>&gt;</span></div>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ESI">ESI</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#LOCAL">LOCAL</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isEsi()">isEsi</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isLocal()">isLocal</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a>[]</code></div>
...
<li>
<section class="detail" id="ESI">
<h3>ESI</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a></span> <span class="element-name">ESI</span></div>
</section>
</li>
<li>
<section class="detail" id="LOCAL">
<h3>LOCAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a></span> <span class="element-name">LOCAL</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ModuleInfo.ProjectType.html" title="enum class in com.nomagic.magicdraw.diff">ModuleInfo.ProjectType</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
<li>
<section class="detail" id="isEsi()">
<h3>isEsi</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isEsi</span>()</div>
</section>
</li>
<li>
