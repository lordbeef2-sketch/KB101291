# JAVA OPENAPI: Modification (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/diff/Modification.html
- source_path: `com/nomagic/magicdraw/diff/Modification.html`
- source_sha256: `f4a8a825d7ee011e58c904cc55a1e4a2f90f91e4aa1c6eea90f92f4c524029b8`
- captured_utc: `2026-07-14T16:45:32.867440+00:00`
...
`[ElementModification](ElementModification.html)`, `[StereotypeModification](StereotypeModification.html)`, `[TagValueModification](TagValueModification.html)`

@OpenApiAllpublic interfaceModificationextends [ElementDifference](ElementDifference.html)

Difference with some kind of element modification. Detail information about changed value can be
 get using [`getModificationInfo()`](#getModificationInfo())
...
Method Details
getModificationInfo
[ModificationInfo](ModificationInfo.html) getModificationInfo()
Get modification info.
Returns:
...
<h1 class="title" title="Interface Modification">Interface Modification</h1>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ModificationInfo.html" title="interface in com.nomagic.magicdraw.diff">ModificationInfo</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getModificationInfo()">getModificationInfo</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Get modification info.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getModificationInfo()">
<h3>getModificationInfo</h3>
<div class="member-signature"><span class="return-type"><a href="ModificationInfo.html" title="interface in com.nomagic.magicdraw.diff">ModificationInfo</a></span> <span class="element-name">getModificationInfo</span>()</div>
<div class="block">Get modification info.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>Detailed information about modification.</dd>
</dl>
</section>
</li>
</ul>
