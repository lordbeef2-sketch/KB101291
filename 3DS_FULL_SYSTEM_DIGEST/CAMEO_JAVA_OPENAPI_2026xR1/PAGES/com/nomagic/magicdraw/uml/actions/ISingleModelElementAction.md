# JAVA OPENAPI: ISingleModelElementAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/actions/ISingleModelElementAction.html
- source_path: `com/nomagic/magicdraw/uml/actions/ISingleModelElementAction.html`
- source_sha256: `98f94f0cd7fb488d22d6f3a5053f164f51b9689434bdae98538ca5f8b38729fc`
- captured_utc: `2026-07-14T16:46:05.520872+00:00`
...
Method Details
getProvider
@CheckForNull[ModelElementProvider](../core/ModelElementProvider.html) getProvider()
Gets the provider.
Returns:
Returns a ModelElementProvider
setProvider
void setProvider(@CheckForNull
 [ModelElementProvider](../core/ModelElementProvider.html) provider)
Sets the provider.
Parameters:
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider)">setProvider</a><wbr/>(<a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a> provider)</code></div>
...
</span><span class="return-type"><a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a></span> <span class="element-name">getProvider</span>()</div>
<div class="block">Gets the provider.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setProvider</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a> provider)</span></div>
<div class="block">Sets the provider.</div>
<dl class="notes">
<dt>Parameters:</dt>
