# JAVA OPENAPI: SingleModelElementAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/actions/SingleModelElementAction.html
- source_path: `com/nomagic/magicdraw/uml/actions/SingleModelElementAction.html`
- source_sha256: `74e0e6b3bb9075b84241f92f1231dcc1b1198a7684acd2bf4f4f93588f5db7ce`
- captured_utc: `2026-07-14T16:46:05.648874+00:00`
...
Constructor
Description
`[SingleModelElementAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) actionID,
...
`[SingleModelElementAction](#%3Cinit%3E(java.lang.String,java.lang.String,javax.swing.KeyStroke,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) actionID,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) actionName,
 [KeyStroke](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/KeyStroke.html) stroke,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) group,
 boolean useSchema)`
...
`[ModelElementProvider](../core/ModelElementProvider.html)`
`[getProvider](#getProvider())()`
Gets the provider.
`void`
`[setProvider](#setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider))([ModelElementProvider](../core/ModelElementProvider.html) provider)`
Sets the provider.
...
element or null
getProvider
public [ModelElementProvider](../core/ModelElementProvider.html) getProvider()
Gets the provider.
Specified by:
...
setProvider
public void setProvider([ModelElementProvider](../core/ModelElementProvider.html) provider)
Sets the provider.
Specified by:
`[setProvider](ISingleModelElementAction.html#setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider))` in interface `[ISingleModelElementAction](ISingleModelElementAction.html)`
Parameters:
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider)">setProvider</a><wbr/>(<a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a> provider)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<h3>getProvider</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a></span> <span class="element-name">getProvider</span>()</div>
<div class="block">Gets the provider.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<li>
<section class="detail" id="setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider)">
<h3>setProvider</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setProvider</span><wbr/><span class="parameters">(<a href="../core/ModelElementProvider.html" title="interface in com.nomagic.magicdraw.uml.core">ModelElementProvider</a> provider)</span></div>
<div class="block">Sets the provider.</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="ISingleModelElementAction.html#setProvider(com.nomagic.magicdraw.uml.core.ModelElementProvider)">setProvider</a></code> in interface <code><a href="ISingleModelElementAction.html" title="interface in com.nomagic.magicdraw.uml.actions">ISingleModelElementAction</a></code></dd>
<dt>Parameters:</dt>
