# JAVA OPENAPI: PathConnector (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/symbols/paths/PathConnector.html
- source_path: `com/nomagic/magicdraw/uml/symbols/paths/PathConnector.html`
- source_sha256: `b5a108cf2a21242a8a0087e60e49e874383fb118009d68d7bebcaa1e67cd9ee9`
- captured_utc: `2026-07-14T16:46:06.848892+00:00`
...
`final [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PathElement](PathElement.html)>`
`[getConnectedPathElements](#getConnectedPathElements())()`
Returns connected path elements.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PathElement](PathElement.html)>`
...
@OpenApipublic final [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PathElement](PathElement.html)> getConnectedPathElements()
...
getConnectedPathElements
@OpenApipublic [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[PathElement](PathElement.html)> getConnectedPathElements(boolean incoming)
Returns connected path elements by direction.
Parameters:
