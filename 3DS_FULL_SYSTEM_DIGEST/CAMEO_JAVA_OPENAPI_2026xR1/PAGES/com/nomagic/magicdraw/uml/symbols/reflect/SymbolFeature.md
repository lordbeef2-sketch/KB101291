# JAVA OPENAPI: SymbolFeature (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml/symbols/reflect/SymbolFeature.html
- source_path: `com/nomagic/magicdraw/uml/symbols/reflect/SymbolFeature.html`
- source_sha256: `12124c07bb0aa29e8207a5229c2ca3c65da3e9b026fc6a12fd1a09d8397fb6f7`
- captured_utc: `2026-07-14T16:46:07.159895+00:00`
...
Method
Description
`default [PresentationElement](../PresentationElement.html)`
`[getContainerForInnerSymbols](#getContainerForInnerSymbols(com.nomagic.magicdraw.uml.symbols.PresentationElement))([PresentationElement](../PresentationElement.html) o)`
...
Returns:
default value.
getContainerForInnerSymbols
default [PresentationElement](../PresentationElement.html) getContainerForInnerSymbols([PresentationElement](../PresentationElement.html) o)
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code>default <a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code><a class="member-name-link" href="#getContainerForInnerSymbols(com.nomagic.magicdraw.uml.symbols.PresentationElement)">getContainerForInnerSymbols</a><wbr/>(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> o)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code>default <a href="SymbolFeature.html" title="type parameter in SymbolFeature">T</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code><a class="member-name-link" href="#getDefaultValue()">getDefaultValue</a>()</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="SymbolFeatureTypes.html" title="enum class in com.nomagic.magicdraw.uml.symbols.reflect">SymbolFeatureTypes</a></code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code><a class="member-name-link" href="#isMultiple()">isMultiple</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab5"><code><a class="member-name-link" href="#isOrdered()">isOrdered</a>()</code></div>
...
<li>
<section class="detail" id="getContainerForInnerSymbols(com.nomagic.magicdraw.uml.symbols.PresentationElement)">
<h3>getContainerForInnerSymbols</h3>
<div class="member-signature"><span class="modifiers">default</span> <span class="return-type"><a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a></span> <span class="element-name">getContainerForInnerSymbols</span><wbr/><span class="parameters">(<a href="../PresentationElement.html" title="class in com.nomagic.magicdraw.uml.symbols">PresentationElement</a> o)</span></div>
</section>
</li>
</ul>
</section>
