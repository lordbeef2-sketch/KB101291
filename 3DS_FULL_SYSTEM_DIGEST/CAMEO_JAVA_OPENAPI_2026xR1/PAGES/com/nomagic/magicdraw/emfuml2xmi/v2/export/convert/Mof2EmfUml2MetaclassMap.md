# JAVA OPENAPI: Mof2EmfUml2MetaclassMap (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/emfuml2xmi/v2/export/convert/Mof2EmfUml2MetaclassMap.html
- source_path: `com/nomagic/magicdraw/emfuml2xmi/v2/export/convert/Mof2EmfUml2MetaclassMap.html`
- source_sha256: `ed8b997cf3361bc2d7b14785fe5fd07f396eef78c11d9e3235e2ba7ec8b63a9d`
- captured_utc: `2026-07-14T16:45:34.580462+00:00`
...
get
@CheckForNull
@OpenApipublic static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) get([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) mdUml2Metaclass)
Returns corresponding Eclipse UML2 model metaclass.
Parameters:
...
put
@OpenApipublic static void put([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) mdClassName,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) eClassName)
Maps MagicDraw UML2 model metaclass to Eclipse UML2 model metaclass.
Parameters:
...
remove
@OpenApipublic static void remove([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) mdClassName)
Removes mapping between MagicDraw UML2 model metaclass and Eclipse UML2 model metaclass.
Parameters:
`mdClassName` - MagicDraw UML2 model metaclass name
