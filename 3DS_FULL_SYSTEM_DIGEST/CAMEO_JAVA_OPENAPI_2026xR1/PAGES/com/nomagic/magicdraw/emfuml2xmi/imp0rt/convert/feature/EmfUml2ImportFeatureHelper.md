...
- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/emfuml2xmi/imp0rt/convert/feature/EmfUml2ImportFeatureHelper.html
- source_path: `com/nomagic/magicdraw/emfuml2xmi/imp0rt/convert/feature/EmfUml2ImportFeatureHelper.html`
- source_sha256: `9d774883d89193c005e1c8572c04fc76f3201d3d639713c9ebe69cdab4c920d4`
- captured_utc: `2026-07-14T16:45:34.373460+00:00`
...
`[getElement](#getElement(org.eclipse.uml2.uml.Element))(org.eclipse.uml2.uml.Element eElement)`
...
Method Details
getElement
@OpenApi[Element](../../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) getElement(org.eclipse.uml2.uml.Element eElement)
Returns Eclipse UML2 model element corresponding to MagicDraw UML2 model element.
Parameters:
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getElement(org.eclipse.uml2.uml.Element)">getElement</a><wbr/>(org.eclipse.uml2.uml.Element eElement)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../EmfUml2ImportHelper.html" title="interface in com.nomagic.magicdraw.emfuml2xmi.imp0rt">EmfUml2ImportHelper</a></code></div>
...
<li>
<section class="detail" id="getElement(org.eclipse.uml2.uml.Element)">
<h3>getElement</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="return-type"><a href="../../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getElement</span><wbr/><span class="parameters">(org.eclipse.uml2.uml.Element eElement)</span></div>
<div class="block">Returns Eclipse UML2 model element corresponding to MagicDraw UML2 model element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getMofHelper</h3>
<div class="member-signature"><span class="annotations">@OpenApi
</span><span class="return-type"><a href="../../EmfUml2ImportHelper.html" title="interface in com.nomagic.magicdraw.emfuml2xmi.imp0rt">EmfUml2ImportHelper</a></span> <span class="element-name">getMofHelper</span>()</div>
<div class="block">Return MagicDraw UML2 model conversion to Eclipse UML2 XMI helper.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>helper</dd>
