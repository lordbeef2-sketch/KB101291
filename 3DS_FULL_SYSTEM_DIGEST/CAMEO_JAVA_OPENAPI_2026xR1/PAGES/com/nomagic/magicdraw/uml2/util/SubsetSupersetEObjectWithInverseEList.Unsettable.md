# JAVA OPENAPI: SubsetSupersetEObjectWithInverseEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectWithInverseEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectWithInverseEList.Unsettable.html`
- source_sha256: `eb20a6044edc5ea1a9564f4c2b8d7f3a97d34d1bfeaf63e54186cf7fe01aac5f`
- captured_utc: `2026-07-14T16:46:10.139934+00:00`
...
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList.Unsettable<E>
...
`[SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse](SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html)`

Enclosing class:
`[SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)<[E](SubsetSupersetEObjectWithInverseEList.html)>`

public static classSubsetSupersetEObjectWithInverseEList.Unsettable<E>
extends [SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse](SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html)<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)
...
Overrides:
`didChange` in class `org.eclipse.emf.common.util.AbstractEList<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectWithInverseEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectWithInverseEList.Unsettable">Class SubsetSupersetEObjectWithInverseEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList</a>&lt;<a href="SubsetSupersetEObjectWithInverseEList.html" title="type parameter in SubsetSupersetEObjectWithInverseEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectWithInverseEList.Unsettable&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse</a>&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable.ManyInverse">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList</a></h2>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.common.util.AbstractEList&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
