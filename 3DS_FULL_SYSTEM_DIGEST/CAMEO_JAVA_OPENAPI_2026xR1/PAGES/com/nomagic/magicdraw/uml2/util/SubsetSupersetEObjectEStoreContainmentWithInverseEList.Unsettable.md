# JAVA OPENAPI: SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html`
- source_sha256: `75c24fcadfa594ccf261d3d9d6e030e75b328d29d7318c599025a8bd7aaadedc`
- captured_utc: `2026-07-14T16:46:09.893931+00:00`
...
## Class SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable<E>
...
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)<E>
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)<E>
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable<E>
...
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html)`

Enclosing class:
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)>`

public static classSubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable<E>
extends [SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html)<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)
`[SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
Fields
Modifier and Type
...
`protected boolean`
`[isSet](#isSet)`
Fields inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)
`[inverseFeatureID](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#inverseFeatureID)`
...
Constructor
Description
`[Unsettable](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D,int))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`void`
`[unset](#unset())()`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreContainmentWithInverseEList](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html)
`[getInverseFeatureClass](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#getInverseFeatureClass()), [getInverseFeatureID](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#getInverseFeatureID()), [hasNavigableInverse](SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#hasNavigableInverse())`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)
`[addAll](SubsetSupersetEObjectEStoreContainmentEList.html#addAll(int,java.util.Collection)), [addAll](SubsetSupersetEObjectEStoreContainmentEList.html#addAll(java.util.Collection)), [hasInverse](SubsetSupersetEObjectEStoreContainmentEList.html#hasInverse()), [isContainment](SubsetSupersetEObjectEStoreContainmentEList.html#isContainment())`
...
`canContainNull, hasInstanceClass, hasManyInverse, isContainer, isEObject, isUnique, isUnsettable, kind, useEquals`
...
Constructor Details
Unsettable
public Unsettable([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs,
...
Overrides:
`didChange` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">Class SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance"><a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList</a>&lt;E&gt;
<div class="inheritance"><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList</a>&lt;E&gt;
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.Resolving">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a></h2>
<code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#isSet">isSet</a></code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h3 id="fields-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentWithInverseEList">Fields inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentWithInverseEList</a></h3>
<code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#inverseFeatureID">inverseFeatureID</a></code></div>
<div class="inherited-list">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D,int)">Unsettable</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#didChange()">didChange</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isSet()">isSet</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#unset()">unset</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<code><a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#getInverseFeatureClass()">getInverseFeatureClass</a>, <a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#getInverseFeatureID()">getInverseFeatureID</a>, <a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.html#hasNavigableInverse()">hasNavigableInverse</a></code></div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList">Methods inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList</a></h3>
<code><a href="SubsetSupersetEObjectEStoreContainmentEList.html#addAll(int,java.util.Collection)">addAll</a>, <a href="SubsetSupersetEObjectEStoreContainmentEList.html#addAll(java.util.Collection)">addAll</a>, <a href="SubsetSupersetEObjectEStoreContainmentEList.html#hasInverse()">hasInverse</a>, <a href="SubsetSupersetEObjectEStoreContainmentEList.html#isContainment()">isContainment</a></code></div>
<div class="inherited-list">
...
<code>canContainNull, hasInstanceClass, hasManyInverse, isContainer, isEObject, isUnique, isUnsettable, kind, useEquals</code></div>
<div class="inherited-list">
...
<code>contains, containsAll, createNotification, createNotification, dispatchNotification, get, getEObject, getFeature, getFeatureID, getFeatureType, getInverseEReference, getNotifier, inverseAdd, inverseRemove, isInstance, isNotificationRequired, resolve, resolve, resolveProxy, set, toArray, toArray</code></div>
<div class="inherited-list">
...
<h3>isSet</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">boolean</span> <span class="element-name">isSet</span></div>
</section>
</li>
</ul>
</section>
...
<h3>Unsettable</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">Unsettable</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs,
...
<ul class="member-list">
<li>
<section class="detail" id="didChange()">
<h3>didChange</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">didChange</span>()</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isSet()">
<h3>isSet</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">isSet</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.EStructuralFeature.Setting</code></dd>
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>unset</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">unset</span>()</div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.EStructuralFeature.Setting</code></dd>
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentWithInverseEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
