# JAVA OPENAPI: SubsetSupersetEObjectEStoreContainmentEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html`
- source_sha256: `36b2fb729324fd04a1c25281ed6356016ace94ed2e0a33409629dcd4f7ac9c22`
- captured_utc: `2026-07-14T16:46:09.845930+00:00`
...
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList.Unsettable<E>
...
`[SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html)`

Enclosing class:
`[SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.html)>`

public static classSubsetSupersetEObjectEStoreContainmentEList.Unsettable<E>
extends [SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectEStoreContainmentEList](SubsetSupersetEObjectEStoreContainmentEList.html)
`[SubsetSupersetEObjectEStoreContainmentEList.Unsettable](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
Fields
Modifier and Type
...
`[addAll](SubsetSupersetEObjectEStoreContainmentEList.html#addAll(int,java.util.Collection)), [addAll](SubsetSupersetEObjectEStoreContainmentEList.html#addAll(java.util.Collection)), [hasInverse](SubsetSupersetEObjectEStoreContainmentEList.html#hasInverse()), [hasNavigableInverse](SubsetSupersetEObjectEStoreContainmentEList.html#hasNavigableInverse()), [isContainment](SubsetSupersetEObjectEStoreContainmentEList.html#isContainment())`
...
Overrides:
`didChange` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic<[E](SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectEStoreContainmentEList.Unsettable">Class SubsetSupersetEObjectEStoreContainmentEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectEStoreContainmentEList.Unsettable&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectEStoreContainmentEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectEStoreContainmentEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable.Resolving">E</a>&gt;</code></div>
...
<code><a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEStoreContainmentEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.DelegatingEcoreEList.Generic&lt;<a href="SubsetSupersetEObjectEStoreContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectEStoreContainmentEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
