# JAVA OPENAPI: SubsetSupersetEObjectContainmentEList (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.html`
- source_sha256: `b044a8fcebe9eeca35f396c5edbef1da979cb0d6e7b5a542c3310010939c786f`
- captured_utc: `2026-07-14T16:46:09.656928+00:00`
...
`[SubsetSupersetEObjectContainmentEList.Resolving](SubsetSupersetEObjectContainmentEList.Resolving.html)`, `[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)`, `[SubsetSupersetEObjectContainmentWithInverseEList](SubsetSupersetEObjectContainmentWithInverseEList.html)`

public classSubsetSupersetEObjectContainmentEList<E>
extends [SubsetSupersetEObjectEList](SubsetSupersetEObjectEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList)
...
Description
`static class`
`[SubsetSupersetEObjectContainmentEList.Resolving](SubsetSupersetEObjectContainmentEList.Resolving.html)<[E](SubsetSupersetEObjectContainmentEList.Resolving.html)>`
...
Constructor
Description
`[SubsetSupersetEObjectContainmentEList](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`[addAll](#addAll(int,java.util.Collection))(int index,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)`

`boolean`
`[addAll](#addAll(java.util.Collection))([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)`
...
public SubsetSupersetEObjectContainmentEList([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs)
...
Overrides:
`hasInverse` in class `com.dassault_systemes.modeler.foundation.util.AbstractModelEObjectEList<[E](SubsetSupersetEObjectContainmentEList.html)>`
hasNavigableInverse
protected boolean hasNavigableInverse()
Overrides:
`hasNavigableInverse` in class `com.dassault_systemes.modeler.foundation.util.AbstractModelEObjectEList<[E](SubsetSupersetEObjectContainmentEList.html)>`
isContainment
protected boolean isContainment()
Overrides:
`isContainment` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectContainmentEList.html)>`
addAll
public boolean addAll([Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html#addAll(java.util.Collection))` in interface `[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Overrides:
`[addAll](SubsetSupersetEObjectEList.html#addAll(java.util.Collection))` in class `[SubsetSupersetEObjectEList](SubsetSupersetEObjectEList.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
addAll
public boolean addAll(int index,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [E](SubsetSupersetEObjectContainmentEList.html)> collection)
Specified by:
`[addAll](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(int,java.util.Collection))` in interface `[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
Overrides:
`[addAll](SubsetSupersetEObjectEList.html#addAll(int,java.util.Collection))` in class `[SubsetSupersetEObjectEList](SubsetSupersetEObjectEList.html)<[E](SubsetSupersetEObjectContainmentEList.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectContainmentEList">Class SubsetSupersetEObjectContainmentEList&lt;E&gt;</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Resolving</a></code>, <code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a></code>, <code><a href="SubsetSupersetEObjectContainmentWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentWithInverseEList</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">SubsetSupersetEObjectContainmentEList&lt;E&gt;</span>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Resolving</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Resolving">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable">E</a>&gt;</code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D)">SubsetSupersetEObjectContainmentEList</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
 int[] subsetFeatureIDs)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates and initializes a new <code>SubsetSupersetEObjectContainmentEList</code> instance.</div>
</div>
</div>
</section>
</li>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#addAll(int,java.util.Collection)">addAll</a><wbr/>(int index,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends <a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt; collection)</code></div>
...
<h3>SubsetSupersetEObjectContainmentEList</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">SubsetSupersetEObjectContainmentEList</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasInverse</code> in class <code>com.dassault_systemes.modeler.foundation.util.AbstractModelEObjectEList&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasNavigableInverse</code> in class <code>com.dassault_systemes.modeler.foundation.util.AbstractModelEObjectEList&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>isContainment</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<h3>addAll</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">boolean</span> <span class="element-name">addAll</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;? extends <a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt; collection)</span></div>
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html#addAll(java.util.Collection)" title="class or interface in java.util">addAll</a></code> in interface <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
<dt>Specified by:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html#addAll(java.util.Collection)" title="class or interface in java.util">addAll</a></code> in interface <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code><a href="SubsetSupersetEObjectEList.html#addAll(java.util.Collection)">addAll</a></code> in class <code><a href="SubsetSupersetEObjectEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEList</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Overrides:</dt>
<dd><code><a href="SubsetSupersetEObjectEList.html#addAll(int,java.util.Collection)">addAll</a></code> in class <code><a href="SubsetSupersetEObjectEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectEList</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.html" title="type parameter in SubsetSupersetEObjectContainmentEList">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
