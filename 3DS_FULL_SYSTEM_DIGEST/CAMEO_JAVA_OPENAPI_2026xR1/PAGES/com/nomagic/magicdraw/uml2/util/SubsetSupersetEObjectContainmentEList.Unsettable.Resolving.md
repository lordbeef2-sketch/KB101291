# JAVA OPENAPI: SubsetSupersetEObjectContainmentEList.Unsettable.Resolving (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html`
- source_sha256: `f0f761def3521ccd888fcc9895475016dadfb3149a0c4d4c0308dc81d240f7f4`
- captured_utc: `2026-07-14T16:46:09.609928+00:00`
...
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)<E>
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable.Resolving<E>
...
Enclosing class:
`[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)<[E](SubsetSupersetEObjectContainmentEList.Unsettable.html)>`

public static classSubsetSupersetEObjectContainmentEList.Unsettable.Resolving<E>
extends [SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable.Resolving)

======== NESTED CLASS SUMMARY ======== 
Nested Class Summary
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)
`[SubsetSupersetEObjectContainmentEList.Unsettable.Resolving](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html)<[E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectContainmentEList](SubsetSupersetEObjectContainmentEList.html)
`[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)<[E](SubsetSupersetEObjectContainmentEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
Fields inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)
`[isSet](SubsetSupersetEObjectContainmentEList.Unsettable.html#isSet)`
...
Constructor
Description
`[Resolving](#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D))([Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<?> dataClass,
...
`protected [E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html)`
`[resolve](#resolve(int,E))(int index,
 [E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html) object)`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectContainmentEList.Unsettable](SubsetSupersetEObjectContainmentEList.Unsettable.html)
`[didChange](SubsetSupersetEObjectContainmentEList.Unsettable.html#didChange()), [isSet](SubsetSupersetEObjectContainmentEList.Unsettable.html#isSet()), [unset](SubsetSupersetEObjectContainmentEList.Unsettable.html#unset())`
...
`[addAll](SubsetSupersetEObjectContainmentEList.html#addAll(int,java.util.Collection)), [addAll](SubsetSupersetEObjectContainmentEList.html#addAll(java.util.Collection)), [hasInverse](SubsetSupersetEObjectContainmentEList.html#hasInverse()), [hasNavigableInverse](SubsetSupersetEObjectContainmentEList.html#hasNavigableInverse()), [isContainment](SubsetSupersetEObjectContainmentEList.html#isContainment())`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, newData, resolve, resolveProxy, set, toArray, toArray`
...
Overrides:
`hasProxies` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html)>`
resolve
protected [E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html) resolve(int index,
 [E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html) object)
Overrides:
`resolve` in class `org.eclipse.emf.ecore.util.EObjectEList<[E](SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">Class SubsetSupersetEObjectContainmentEList.Unsettable.Resolving&lt;E&gt;</h1>
</div>
...
<div class="inheritance"><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;E&gt;
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable.Resolving&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectContainmentEList.Unsettable.Resolving&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a></h2>
<code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable.Resolving</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a>&gt;</code></div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectContainmentEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList</a></h2>
<code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<h2>Field Summary</h2>
<div class="inherited-list">
<h3 id="fields-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable">Fields inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a></h3>
<code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html#isSet">isSet</a></code></div>
<div class="inherited-list">
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Class,org.eclipse.emf.ecore.InternalEObject,int,int%5B%5D,int%5B%5D)">Resolving</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html" title="class or interface in java.lang">Class</a>&lt;?&gt; dataClass,
 org.eclipse.emf.ecore.InternalEObject owner,
 int featureID,
 int[] supersetFeatureIDs,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#resolve(int,E)">resolve</a><wbr/>(int index,
 <a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a> object)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectContainmentEList.Unsettable">Methods inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectContainmentEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectContainmentEList.Unsettable</a></h3>
<code><a href="SubsetSupersetEObjectContainmentEList.Unsettable.html#didChange()">didChange</a>, <a href="SubsetSupersetEObjectContainmentEList.Unsettable.html#isSet()">isSet</a>, <a href="SubsetSupersetEObjectContainmentEList.Unsettable.html#unset()">unset</a></code></div>
<div class="inherited-list">
...
<code><a href="SubsetSupersetEObjectContainmentEList.html#addAll(int,java.util.Collection)">addAll</a>, <a href="SubsetSupersetEObjectContainmentEList.html#addAll(java.util.Collection)">addAll</a>, <a href="SubsetSupersetEObjectContainmentEList.html#hasInverse()">hasInverse</a>, <a href="SubsetSupersetEObjectContainmentEList.html#hasNavigableInverse()">hasNavigableInverse</a>, <a href="SubsetSupersetEObjectContainmentEList.html#isContainment()">isContainment</a></code></div>
<div class="inherited-list">
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getInverseFeatureClass, getInverseFeatureID, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isInstance, isNotificationRequired, newData, resolve, resolveProxy, set, toArray, toArray</code></div>
<div class="inherited-list">
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>hasProxies</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a></span> <span class="element-name">resolve</span><wbr/><span class="parameters">(int index,
 <a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a> object)</span></div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>resolve</code> in class <code>org.eclipse.emf.ecore.util.EObjectEList&lt;<a href="SubsetSupersetEObjectContainmentEList.Unsettable.Resolving.html" title="type parameter in SubsetSupersetEObjectContainmentEList.Unsettable.Resolving">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
