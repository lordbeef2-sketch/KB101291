# JAVA OPENAPI: SubsetSupersetEObjectWithInverseResolvingEList.Unsettable (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html
- source_path: `com/nomagic/magicdraw/uml2/util/SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html`
- source_sha256: `541560c20b49bbfb6f0ddefc4d5f2d2907f5e92a8323dc0c855f8b971d683e0f`
- captured_utc: `2026-07-14T16:46:10.238936+00:00`
...
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)<E>
[com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList](SubsetSupersetEObjectWithInverseResolvingEList.html)<E>
com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList.Unsettable<E>
...
`[SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html)`

Enclosing class:
`[SubsetSupersetEObjectWithInverseResolvingEList](SubsetSupersetEObjectWithInverseResolvingEList.html)<[E](SubsetSupersetEObjectWithInverseResolvingEList.html)>`

public static classSubsetSupersetEObjectWithInverseResolvingEList.Unsettable<E>
extends [SubsetSupersetEObjectWithInverseResolvingEList](SubsetSupersetEObjectWithInverseResolvingEList.html)<E>

See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList.Unsettable)
...
Description
`static class`
`[SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html)<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html)>`
Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectWithInverseResolvingEList](SubsetSupersetEObjectWithInverseResolvingEList.html)
`[SubsetSupersetEObjectWithInverseResolvingEList.Unsettable](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
 =========== FIELD SUMMARY =========== 
Field Summary
Fields
Modifier and Type
...
`protected boolean`
`[isSet](#isSet)`
Fields inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)
`[inverseFeatureID](SubsetSupersetEObjectWithInverseEList.html#inverseFeatureID)`
...
`void`
`[unset](#unset())()`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectWithInverseResolvingEList](SubsetSupersetEObjectWithInverseResolvingEList.html)
`[hasProxies](SubsetSupersetEObjectWithInverseResolvingEList.html#hasProxies()), [resolve](SubsetSupersetEObjectWithInverseResolvingEList.html#resolve(int,E))`
Methods inherited from class com.nomagic.magicdraw.uml2.util.[SubsetSupersetEObjectWithInverseEList](SubsetSupersetEObjectWithInverseEList.html)
`[getInverseFeatureClass](SubsetSupersetEObjectWithInverseEList.html#getInverseFeatureClass()), [getInverseFeatureID](SubsetSupersetEObjectWithInverseEList.html#getInverseFeatureID()), [hasInverse](SubsetSupersetEObjectWithInverseEList.html#hasInverse()), [hasNavigableInverse](SubsetSupersetEObjectWithInverseEList.html#hasNavigableInverse())`
...
`createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, newData, resolve, resolveProxy, set, toArray, toArray`
...
Overrides:
`didChange` in class `org.eclipse.emf.common.util.AbstractEList<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
isSet
public boolean isSet()
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`isSet` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
Overrides:
`isSet` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
unset
public void unset()
Specified by:
`unset` in interface `org.eclipse.emf.ecore.EStructuralFeature.Setting`
Specified by:
`unset` in interface `org.eclipse.emf.ecore.util.InternalEList.Unsettable<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
Overrides:
`unset` in class `org.eclipse.emf.ecore.util.EcoreEList<[E](SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html)>`
...
<h1 class="title" title="Class SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">Class SubsetSupersetEObjectWithInverseResolvingEList.Unsettable&lt;E&gt;</h1>
</div>
...
<div class="inheritance"><a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList</a>&lt;E&gt;
<div class="inheritance"><a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList</a>&lt;E&gt;
<div class="inheritance">com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList.Unsettable&lt;E&gt;</div>
</div>
</div>
</div>
</div>
...
<dd><code><a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList</a>&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList">E</a>&gt;</code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">SubsetSupersetEObjectWithInverseResolvingEList.Unsettable&lt;E&gt;</span>
<span class="extends-implements">extends <a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList</a>&lt;E&gt;</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse</a>&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.ManyInverse">E</a>&gt;</code></div>
<div class="col-last even-row-color"> </div>
</div>
<div class="inherited-list">
<h2 id="nested-classes-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList">Nested classes/interfaces inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList</a></h2>
<code><a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList.Unsettable</a>&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></div>
</section>
</li>
<!-- =========== FIELD SUMMARY =========== -->
<li>
...
<div class="inherited-list">
<h3 id="fields-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList">Fields inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList</a></h3>
<code><a href="SubsetSupersetEObjectWithInverseEList.html#inverseFeatureID">inverseFeatureID</a></code></div>
<div class="inherited-list">
...
<div class="block">Creates and initializes a new <code>SubsetSupersetEObjectWithInverseResolvingEList$Unsettable</code> instance.</div>
</div>
</div>
</section>
</li>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseResolvingEList">Methods inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectWithInverseResolvingEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseResolvingEList</a></h3>
<code><a href="SubsetSupersetEObjectWithInverseResolvingEList.html#hasProxies()">hasProxies</a>, <a href="SubsetSupersetEObjectWithInverseResolvingEList.html#resolve(int,E)">resolve</a></code></div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.uml2.util.SubsetSupersetEObjectWithInverseEList">Methods inherited from class com.nomagic.magicdraw.uml2.util.<a href="SubsetSupersetEObjectWithInverseEList.html" title="class in com.nomagic.magicdraw.uml2.util">SubsetSupersetEObjectWithInverseEList</a></h3>
<code><a href="SubsetSupersetEObjectWithInverseEList.html#getInverseFeatureClass()">getInverseFeatureClass</a>, <a href="SubsetSupersetEObjectWithInverseEList.html#getInverseFeatureID()">getInverseFeatureID</a>, <a href="SubsetSupersetEObjectWithInverseEList.html#hasInverse()">hasInverse</a>, <a href="SubsetSupersetEObjectWithInverseEList.html#hasNavigableInverse()">hasNavigableInverse</a></code></div>
<div class="inherited-list">
...
<code>createNotification, createNotification, dispatchNotification, get, getEObject, getEStructuralFeature, getFeature, getFeatureType, getInverseEReference, getNotifier, hasInstanceClass, inverseAdd, inverseRemove, isContainment, isInstance, isNotificationRequired, newData, resolve, resolveProxy, set, toArray, toArray</code></div>
<div class="inherited-list">
...
<dd><code>inverseFeatureID</code> - id of inverse feature.</dd>
</dl>
</section>
</li>
</ul>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code>didChange</code> in class <code>org.eclipse.emf.common.util.AbstractEList&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>isSet</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>isSet</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
<li>
...
<dt>Specified by:</dt>
<dd><code>unset</code> in interface <code>org.eclipse.emf.ecore.util.InternalEList.Unsettable&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
<dt>Overrides:</dt>
<dd><code>unset</code> in class <code>org.eclipse.emf.ecore.util.EcoreEList&lt;<a href="SubsetSupersetEObjectWithInverseResolvingEList.Unsettable.html" title="type parameter in SubsetSupersetEObjectWithInverseResolvingEList.Unsettable">E</a>&gt;</code></dd>
</dl>
</section>
</li>
</ul>
