# JAVA OPENAPI: Connection (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/pathicon/Connection.html
- source_path: `com/nomagic/magicdraw/ui/pathicon/Connection.html`
- source_sha256: `5b93b99dba77445b817ace4a5e475fbe5302f5e959e50fc128eff69210532f6b`
- captured_utc: `2026-07-14T16:46:03.636849+00:00`
...
Basic generalization (closed).
`static final int`
`[GENERALIZATION2](#GENERALIZATION2)`
Basic generalization (filled).
`static final int`
...
Method
Description
`static [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html)`
`[drawConnection](#drawConnection(java.awt.Graphics2D,int,int,int,int,int,int,java.awt.Rectangle))([Graphics2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 int type,
 int x,
 int y,
 int x2,
 int y2,
 int preferredSize,
 [Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) shapeBounds)`
Method for Path end shape drawing.
`static [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html)`
`[drawConnection](#drawConnection(java.awt.Graphics2D,int,int,int,int,int,int,java.awt.Shape,boolean))([Graphics2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 int type,
 int x,
 int y,
 int x2,
 int y2,
 int preferredSize,
 [Shape](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Shape.html) boundingShape,
 boolean useCorrecting)`
Method for Path end shape drawing.
`static [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html)`
`[drawConnection](#drawConnection(java.awt.Graphics2D,com.nomagic.ui.ResizableIcon,int,int,int,int,int,java.awt.Rectangle,java.util.function.Function))([Graphics2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 ...
 int size,
 [Rectangle](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html) shapeBounds,
 [Function](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Function.html)<[ResizableIcon](../../../ui/ResizableIcon.html),[ResizableIcon](../../../ui/ResizableIcon.html)> iconTransformer)`
...
Equilateral triangle.
 Can be used with [`CLOSED`](#CLOSED), [`FILLED`](#FILLED)
See Also:
...
Square. Connected to line at the corner.
 Can be used with [`FILLED`](#FILLED)
See Also:
[`SQUARE`](#SQUARE)
...
Arrow.
 Can be used with [`FILLED`](#FILLED), [`CLOSED`](#CLOSED)
See Also:
...
Slash on the line.
 Can not be used with [`FILLED`](#FILLED), [`CLOSED`](#CLOSED)
See Also:
...
Method Details
drawConnection
public static [Point](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html) drawConnection([Graphics2D](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html) g,
 int type,
 int x,
 int y,
 int x2,
...
<div class="block">Equilateral triangle.</div>
</div>
...
<div class="col-last odd-row-color">
<div class="block">Should a figure be closed (none is the same as opened)?
...
<div class="col-last even-row-color">
<div class="block">Closed arrow and colon like line.</div>
</div>
<div class="col-first odd-row-color"><code>static final int</code></div>
...
<div class="col-last odd-row-color">
<div class="block">Closed arrow and double colon like line.</div>
</div>
<div class="col-first even-row-color"><code>static final int</code></div>
...
<div class="col-last even-row-color">
<div class="block">Circle with diagonal cross.</div>
</div>
<div class="col-first odd-row-color"><code>static final int</code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#drawConnection(java.awt.Graphics2D,int,int,int,int,int,int,java.awt.Rectangle)">drawConnection</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 int type,
 int x,
 int y,
 int x2,
 int y2,
 int preferredSize,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> shapeBounds)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Method for Path end shape drawing.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#drawConnection(java.awt.Graphics2D,int,int,int,int,int,int,java.awt.Shape,boolean)">drawConnection</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 ...
 int y2,
 int preferredSize,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Shape.html" title="class or interface in java.awt">Shape</a> boundingShape,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#drawConnection(java.awt.Graphics2D,com.nomagic.ui.ResizableIcon,int,int,int,int,int,java.awt.Rectangle,java.util.function.Function)">drawConnection</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 ...
 int y2,
 int size,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> shapeBounds,
...
<div class="block">Equilateral triangle.
 Can be used with <a href="#CLOSED"><code>CLOSED</code></a>, <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Circle.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Square. Connected to the line at border.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#DIAMOND_SQUARE"><code>DIAMOND_SQUARE</code></a></li>
...
<div class="block">Square. Connected to line at the corner.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<div class="block">Arrow.
 Can be used with <a href="#FILLED"><code>FILLED</code></a>, <a href="#CLOSED"><code>CLOSED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Circle with cross.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<div class="block">Circle with diagonal cross.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<div class="block">Slash on the line.
 Can not be used with <a href="#FILLED"><code>FILLED</code></a>, <a href="#CLOSED"><code>CLOSED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Half of circle.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<div class="block">"Pacman" like shape.
 Can be used with <a href="#FILLED"><code>FILLED</code></a></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Point.html" title="class or interface in java.awt">Point</a></span> <span class="element-name">drawConnection</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Graphics2D.html" title="class or interface in java.awt">Graphics2D</a> g,
 ...
 int preferredSize,
 @CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Rectangle.html" title="class or interface in java.awt">Rectangle</a> shapeBounds)</span></div>
<div class="block">Method for Path end shape drawing.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>g</code> - graphics context</dd>
