# JAVA OPENAPI: SelectElementInfo (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/ui/dialogs/SelectElementInfo.html
- source_path: `com/nomagic/magicdraw/ui/dialogs/SelectElementInfo.html`
- source_sha256: `753e6ac08439add612c358c64849d952a6b4a29e5fdb463d4401a26541898409`
- captured_utc: `2026-07-14T16:46:01.160817+00:00`
...
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public static final int SUGGESTION_LIST_NEVER
Deprecated.
not used anymore
...
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public static final int SUGGESTION_LIST_ALWAYS
Deprecated.
not used anymore
...
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public static final int SUGGESTION_LIST_ON_DEMAND
Deprecated.
not used anymore
...
showRelationships
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public boolean showRelationships
Deprecated.
not used anymore. Now relationships are shown on demand
Show model relationships in selection UI
allowLoad
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public boolean allowLoad
Deprecated.
not used anymore. Now modules are allowed to load if needed
Allow to load not loaded modules in UI
suggestionList
@OpenApi
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public int suggestionList
Deprecated.
