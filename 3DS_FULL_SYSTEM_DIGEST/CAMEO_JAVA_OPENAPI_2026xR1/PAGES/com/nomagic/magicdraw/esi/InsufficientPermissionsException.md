# JAVA OPENAPI: InsufficientPermissionsException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/esi/InsufficientPermissionsException.html
- source_path: `com/nomagic/magicdraw/esi/InsufficientPermissionsException.html`
- source_sha256: `381c65ea12843d6548a46b1c1624c1fbf9d8156302fed88747b3dcd6ceaabad4`
- captured_utc: `2026-07-14T16:45:35.977480+00:00`
...
@OpenApiAllpublic classInsufficientPermissionsException
extends [RuntimeException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/RuntimeException.html)

This particular extension of [`RuntimeException`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/RuntimeException.html) identifies that the *Teamwork
 Cloud* related operation has failed due to insufficient permissions that the
 currently logged in user has.

See Also:
[Serialized Form](../../../../serialized-form.html#com.nomagic.magicdraw.esi.InsufficientPermissionsException)
...
Constructor
Description
`[InsufficientPermissionsException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
public InsufficientPermissionsException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
...
<h1 class="title" title="Class InsufficientPermissionsException">Class InsufficientPermissionsException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.esi.InsufficientPermissionsException</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">InsufficientPermissionsException</span>
...
<div class="block">This particular extension of <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/RuntimeException.html" title="class or interface in java.lang"><code>RuntimeException</code></a> identifies that the <em>Teamwork
 Cloud</em> related operation has failed due to insufficient permissions that the
 currently logged in user has.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../serialized-form.html#com.nomagic.magicdraw.esi.InsufficientPermissionsException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">InsufficientPermissionsException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
...
<h3>InsufficientPermissionsException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">InsufficientPermissionsException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</span></div>
</section>
</li>
</ul>
</section>
