# JAVA OPENAPI: ProxyManager (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/proxy/ProxyManager.html
- source_path: `com/nomagic/magicdraw/core/proxy/ProxyManager.html`
- source_sha256: `ca81e20dfc9083c754e714cd3fedf11945d5cc423d85a969a2188bef724b5fd7`
- captured_utc: `2026-07-14T16:45:31.703425+00:00`
...
`[getModuleWithMissingShare](#getModuleWithMissingShare(com.dassault_systemes.modeler.foundation.model.ModelElement))([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) proxy)`
...
`boolean`
`[isElementProxy](#isElementProxy(com.dassault_systemes.modeler.foundation.model.ModelElement))([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) el)`
Return true if element is proxy.
`boolean`
`[isGhostProxy](#isGhostProxy(com.dassault_systemes.modeler.foundation.model.ModelElement))([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) el)`
returns true if proxy was not resolved by loading module.
`void`
`[makeNotProxy](#makeNotProxy(com.dassault_systemes.modeler.foundation.model.ModelElement))([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) element)`
Marks element as normal.
`void`
`[markProxy](#markProxy(com.dassault_systemes.modeler.foundation.model.ModelElement))([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) element)`
Just marks this element as proxy.

============ METHOD DETAIL ========== 
Method Details
isElementProxy
boolean isElementProxy([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) el)
...
isGhostProxy
boolean isGhostProxy([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) el)
returns true if proxy was not resolved by loading module.
...
@CheckForNullcom.nomagic.ci.persistence.IAttachedProject getModuleWithMissingShare([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) proxy)
Return module in which element exists is not shared, and used by module shared part.
Parameters:
...
markProxy
void markProxy([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) element)
Just marks this element as proxy.
Parameters:
`element` - element to mark as proxy
makeNotProxy
void makeNotProxy([ModelElement](../../../../dassault_systemes/modeler/foundation/model/ModelElement.html) element)
Marks element as normal.
Parameters:
...
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isElementProxy</span><wbr/><span class="parameters">(<a href="../../../../dassault_systemes/modeler/foundation/model/ModelElement.html" title="interface in com.dassault_systemes.modeler.foundation.model">ModelElement</a> el)</span></div>
...
<h3>isGhostProxy</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isGhostProxy</span><wbr/><span class="parameters">(<a href="../../../../dassault_systemes/modeler/foundation/model/ModelElement.html" title="interface in com.dassault_systemes.modeler.foundation.model">ModelElement</a> el)</span></div>
...
</span><span class="return-type">com.nomagic.ci.persistence.IAttachedProject</span> <span class="element-name">getModuleWithMissingShare</span><wbr/><span class="parameters">(<a href="../../../../dassault_systemes/modeler/foundation/model/ModelElement.html" title="interface in com.dassault_systemes.modeler.foundation.model">ModelElement</a> proxy)</span></div>
<div class="block">Return module in which element exists is not shared, and used by module shared part.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>markProxy</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">markProxy</span><wbr/><span class="parameters">(<a href="../../../../dassault_systemes/modeler/foundation/model/ModelElement.html" title="interface in com.dassault_systemes.modeler.foundation.model">ModelElement</a> element)</span></div>
<div class="block">Just marks this element as proxy.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>makeNotProxy</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">makeNotProxy</span><wbr/><span class="parameters">(<a href="../../../../dassault_systemes/modeler/foundation/model/ModelElement.html" title="interface in com.dassault_systemes.modeler.foundation.model">ModelElement</a> element)</span></div>
<div class="block">Marks element as normal.</div>
<dl class="notes">
<dt>Parameters:</dt>
