# JAVA OPENAPI: SyncMode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/options/SyncMode.html
- source_path: `com/nomagic/magicdraw/core/options/SyncMode.html`
- source_sha256: `2d880492e040be1345431c3bb16b80b2442d90776f687f59d75655ed83ce4609`
- captured_utc: `2026-07-14T16:45:31.287423+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SyncMode](SyncMode.html)>
com.nomagic.magicdraw.core.options.SyncMode

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SyncMode](SyncMode.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

@OpenApiAllpublic enumSyncMode
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SyncMode](SyncMode.html)>
...
AUTO
public static final [SyncMode](SyncMode.html) AUTO
MANUAL
public static final [SyncMode](SyncMode.html) MANUAL
NONE
public static final [SyncMode](SyncMode.html) NONE
 ============ METHOD DETAIL ========== 
Method Details
values
public static [SyncMode](SyncMode.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [SyncMode](SyncMode.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
Overrides:
`[toString](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html#toString())` in class `[Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SyncMode](SyncMode.html)>`
getDefault
public static [SyncMode](SyncMode.html) getDefault()
Get default SyncMode
Returns:
SyncMode - Manual
getValues
public static [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getValues()
Returns values of choices
Returns:
list of values
...
<h1 class="title" title="Enum Class SyncMode">Enum Class SyncMode</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.core.options.SyncMode</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public enum </span><span class="element-name type-name-label">SyncMode</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a>&gt;</span></div>
<div class="block">Enumeration for element hiding public branch sync feature
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#MANUAL">MANUAL</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getDefault()">getDefault</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Get default SyncMode</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#getValues()">getValues</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4">
<div class="block">Returns values of choices</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></code></div>
...
<h3>AUTO</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></span> <span class="element-name">AUTO</span></div>
</section>
</li>
<li>
<section class="detail" id="MANUAL">
<h3>MANUAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></span> <span class="element-name">MANUAL</span></div>
</section>
</li>
<li>
<section class="detail" id="NONE">
<h3>NONE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></span> <span class="element-name">NONE</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
<h3>getDefault</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="SyncMode.html" title="enum class in com.nomagic.magicdraw.core.options">SyncMode</a></span> <span class="element-name">getDefault</span>()</div>
<div class="block">Get default SyncMode</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>SyncMode - Manual</dd>
</dl>
</section>
</li>
<li>
...
<h3>getValues</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a>&gt;</span> <span class="element-name">getValues</span>()</div>
<div class="block">Returns values of choices</div>
<dl class="notes">
<dt>Returns:</dt>
