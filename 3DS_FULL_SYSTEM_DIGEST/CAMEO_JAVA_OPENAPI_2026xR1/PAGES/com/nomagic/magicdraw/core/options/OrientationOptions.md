# JAVA OPENAPI: OrientationOptions (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/options/OrientationOptions.html
- source_path: `com/nomagic/magicdraw/core/options/OrientationOptions.html`
- source_sha256: `ffa43a70e0d1d55ef4ab68a08f721a28a707a6f8752181927caac2f87a60f0cc`
- captured_utc: `2026-07-14T16:45:31.322419+00:00`
...
`[getClockwiseOrientation](#getClockwiseOrientation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`

`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getCounterClockwiseOrientation](#getCounterClockwiseOrientation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`

`static byte`
`[getOrientation](#getOrientation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`
Translates layouter option group orientation to core layouter byte orientation representation.
`static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getReversed](#getReversed(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`

`static boolean`
`[isHorizontal](#isHorizontal(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`

`static boolean`
`[isVertical](#isVertical(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)`
...
Field Details
TOP_TO_BOTTOM
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) TOP_TO_BOTTOM
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.core.options.OrientationOptions.TOP_TO_BOTTOM)
BOTTOM_TO_TOP
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) BOTTOM_TO_TOP
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.core.options.OrientationOptions.BOTTOM_TO_TOP)
LEFT_TO_RIGHT
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) LEFT_TO_RIGHT
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.core.options.OrientationOptions.LEFT_TO_RIGHT)
RIGHT_TO_LEFT
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) RIGHT_TO_LEFT
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SPECIFIED_BY_DIAGRAM
See Also:
[Constant Field Values](../../../../../constant-values.html#com.nomagic.magicdraw.core.options.OrientationOptions.SPECIFIED_BY_DIAGRAM)
ORIENTATIONS
public static final [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html) ORIENTATIONS
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
OrientationOptions
...
Method Details
getOrientation
public static byte getOrientation([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
Translates layouter option group orientation to core layouter byte orientation representation.
...
isVertical
public static boolean isVertical([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
isHorizontal
public static boolean isHorizontal([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
getReversed
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getReversed([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
getClockwiseOrientation
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getClockwiseOrientation([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
Parameters:
`orientation` - orientation
Returns:
clockwise orientation of given one, throws an exception if argument is not valid
getCounterClockwiseOrientation
public static [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getCounterClockwiseOrientation([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) orientation)
Parameters:
`orientation` - orientation
Returns:
clockwise orientation of given one, throws an exception if argument is not valid
...
<h3>ORIENTATIONS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a></span> <span class="element-name">ORIENTATIONS</span></div>
</section>
</li>
</ul>
</section>
