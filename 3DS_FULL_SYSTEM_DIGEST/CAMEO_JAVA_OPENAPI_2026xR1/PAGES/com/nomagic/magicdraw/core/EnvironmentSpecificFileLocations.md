# JAVA OPENAPI: EnvironmentSpecificFileLocations (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/core/EnvironmentSpecificFileLocations.html
- source_path: `com/nomagic/magicdraw/core/EnvironmentSpecificFileLocations.html`
- source_sha256: `cd935a152786cb123451afa682efdb2c4cb4b09030892b377eb7140d84965959`
- captured_utc: `2026-07-14T16:45:28.912388+00:00`
...
setFileLocation
@OpenApipublic void setFileLocation([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) locationNameID,
 [File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) file)
Before saving file locations file is checked if it still exists.
