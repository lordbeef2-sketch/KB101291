# JAVA OPENAPI: MacroChange (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/merge/macro/MacroChange.html
- source_path: `com/nomagic/magicdraw/merge/macro/MacroChange.html`
- source_sha256: `fdf151b7d0f6d99d20fa284b8e9b5d372dccf51af31ebd3dc8b37a340d6043d1`
- captured_utc: `2026-07-14T16:45:38.163511+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Change](../Change.html)>`
`[getChanges](#getChanges())()`
Get grouped changes.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [RelatedMacroChange](RelatedMacroChange.html)>`
...
Method Details
getChanges
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Change](../Change.html)> getChanges()
Get grouped changes.
Returns:
grouped changes.
getDifference
...
getConflicts
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [RelatedMacroChange](RelatedMacroChange.html)> getConflicts()
...
conflicting changes
getDependent
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [RelatedMacroChange](RelatedMacroChange.html)> getDependent()
...
dependent changes.
getRequired
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [RelatedMacroChange](RelatedMacroChange.html)> getRequired()
...
required changes.
getProjectElementId
[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getProjectElementId()
Returns:
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../Change.html#getDifference()">Change</a></code></span></div>
<div class="block">Returns the difference that caused current change.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../Change.html#getConflicts()">Change</a></code></span></div>
<div class="block">Returns the current change conflicting changes.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../Change.html#getDependent()">Change</a></code></span></div>
<div class="block">Returns the current change dependent changes - changes that requires current change.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from interface: <code><a href="../Change.html#getRequired()">Change</a></code></span></div>
<div class="block">Returns the current change required changes.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getProjectElementId</span>()</div>
<dl class="notes">
<dt>Returns:</dt>
