# JAVA OPENAPI: BinaryEvaluator (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/evaluation/BinaryEvaluator.html
- source_path: `com/nomagic/magicdraw/evaluation/BinaryEvaluator.html`
- source_sha256: `4bec62ccf9bf2588f0c1e4d113440393ca36e2cfd8874808022914917073947c`
- captured_utc: `2026-07-14T16:45:36.076482+00:00`
...
Description
`void`
`[registerAdditionalImplementers](#registerAdditionalImplementers(java.lang.ClassLoader))([ClassLoader](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/ClassLoader.html) implementorClasses)`
...
@OpenApivoid registerAdditionalImplementers([ClassLoader](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/ClassLoader.html) implementorClasses)
Method allows registering additional classloaders, to load classes,
