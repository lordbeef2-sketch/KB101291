# JAVA OPENAPI: PropertyManagerByStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/PropertyManagerByStereotype.html
- source_path: `com/nomagic/magicdraw/properties/PropertyManagerByStereotype.html`
- source_sha256: `b8a101f0331745cb29a4fc2eb872b62a95e563a8ad90169d8983707c1b7eef29`
- captured_utc: `2026-07-14T16:45:39.652531+00:00`
...
`[PropertyManagerByStereotype](#%3Cinit%3E(java.lang.String,java.util.List))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[setStereoType](#setStereoType(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)`
...
public PropertyManagerByStereotype([PropertyManager](PropertyManager.html) parentPropertyManager,
 ...
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)
PropertyManagerByStereotype
public PropertyManagerByStereotype([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Property](Property.html)> properties)
 ============ METHOD DETAIL ========== 
Method Details
accept
...
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getAssignedStereotypeID()
Gets represented stereotype identifier.
...
setStereoType
public void setStereoType([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id)
customize
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getAssignedStereotypeID</span>()</div>
...
<div class="block"><span class="description-from-type-label">Description copied from class: <code><a href="PropertyManager.html#getName()">PropertyManager</a></code></span></div>
<div class="block">Returns name of the property manager.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<div class="block"><span class="description-from-type-label">Description copied from class: <code><a href="PropertyManager.html#clone()">PropertyManager</a></code></span></div>
