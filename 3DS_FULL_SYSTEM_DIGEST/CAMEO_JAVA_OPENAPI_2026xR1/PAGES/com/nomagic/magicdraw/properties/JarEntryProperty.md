# JAVA OPENAPI: JarEntryProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/JarEntryProperty.html
- source_path: `com/nomagic/magicdraw/properties/JarEntryProperty.html`
- source_sha256: `4be256051bf1e0954cbc64b535d291cde9c444ba350d7284e61b969092bc3bd6`
- captured_utc: `2026-07-14T16:45:39.480528+00:00`
...
@OpenApiAllpublic classJarEntryProperty
...
Constructor
Description
`[JarEntryProperty](#%3Cinit%3E())()`
Default constructor.
`[JarEntryProperty](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) jarEntryName)`
...
`[JarEntryProperty](JarEntryProperty.html)`
`[clone](#clone())()`
Clones the property.
...
Get Path Property.
`void`
`[setPathProperty](#setPathProperty(com.nomagic.magicdraw.properties.ClassPathEntriesListProperty))([ClassPathEntriesListProperty](ClassPathEntriesListProperty.html) pathProperty)`
Set path property
...
JarEntryProperty
public JarEntryProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) jarEntryName)
The property constructor.
Parameters:
...
See Also:
[`PropertyID.JARENTRY_PROPERTY`](PropertyID.html#JARENTRY_PROPERTY)
getPathProperty
public [ClassPathEntriesListProperty](ClassPathEntriesListProperty.html) getPathProperty()
Get Path Property.
Returns:
ClassPathEntriesListProperty
setPathProperty
public void setPathProperty([ClassPathEntriesListProperty](ClassPathEntriesListProperty.html) pathProperty)
Set path property
Parameters:
`pathProperty` - Set Path Property.
clone
public [JarEntryProperty](JarEntryProperty.html) clone()
...
<h1 class="title" title="Class JarEntryProperty">Class JarEntryProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.JarEntryProperty</div>
</div>
</div>
</div>
...
<dd><code><a href="JDBCDriverClassNameProperty.html" title="class in com.nomagic.magicdraw.properties">JDBCDriverClassNameProperty</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public class </span><span class="element-name type-name-label">JarEntryProperty</span>
...
<div class="block">The property for storing and editing some entry of jar files.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">JarEntryProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">JarEntryProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> jarEntryName)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ClassPathEntriesListProperty.html" title="class in com.nomagic.magicdraw.properties">ClassPathEntriesListProperty</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPathProperty()">getPathProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Get Path Property.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setPathProperty(com.nomagic.magicdraw.properties.ClassPathEntriesListProperty)">setPathProperty</a><wbr/>(<a href="ClassPathEntriesListProperty.html" title="class in com.nomagic.magicdraw.properties">ClassPathEntriesListProperty</a> pathProperty)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Set path property</div>
</div>
</div>
</div>
</div>
...
<h3>JarEntryProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">JarEntryProperty</span>()</div>
...
<h3>JarEntryProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">JarEntryProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> jarEntryName)</span></div>
<div class="block">The property constructor.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of property.</dd>
<dd><code>jarEntryName</code> - the name of jar entry in the jar file.</dd>
</dl>
</section>
</li>
</ul>
...
<dt>Returns:</dt>
<dd>PropertyID.JARENTRY_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#JARENTRY_PROPERTY"><code>PropertyID.JARENTRY_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ClassPathEntriesListProperty.html" title="class in com.nomagic.magicdraw.properties">ClassPathEntriesListProperty</a></span> <span class="element-name">getPathProperty</span>()</div>
<div class="block">Get Path Property.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>ClassPathEntriesListProperty</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setPathProperty(com.nomagic.magicdraw.properties.ClassPathEntriesListProperty)">
<h3>setPathProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setPathProperty</span><wbr/><span class="parameters">(<a href="ClassPathEntriesListProperty.html" title="class in com.nomagic.magicdraw.properties">ClassPathEntriesListProperty</a> pathProperty)</span></div>
<div class="block">Set path property</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>pathProperty</code> - Set Path Property.</dd>
</dl>
</section>
</li>
<li>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></span> <span class="element-name">clone</span>()</div>
