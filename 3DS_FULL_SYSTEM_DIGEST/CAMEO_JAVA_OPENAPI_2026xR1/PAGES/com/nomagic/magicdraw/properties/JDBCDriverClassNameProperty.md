# JAVA OPENAPI: JDBCDriverClassNameProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/JDBCDriverClassNameProperty.html
- source_path: `com/nomagic/magicdraw/properties/JDBCDriverClassNameProperty.html`
- source_sha256: `03f3996318f975ed880c0987fb53c1d4ae74ad8e286a174556a8e885da549fba`
- captured_utc: `2026-07-14T16:45:39.451527+00:00`
...
[com.nomagic.magicdraw.properties.JarEntryProperty](JarEntryProperty.html)
...
@OpenApiAllpublic classJDBCDriverClassNameProperty
extends [JarEntryProperty](JarEntryProperty.html)
...
Constructor
Description
`[JDBCDriverClassNameProperty](#%3Cinit%3E())()`
Default constructor.
`[JDBCDriverClassNameProperty](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) driverClassName)`
Creates and initializes a new instance of `JDBCDriverClassNameProperty`
 class.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[JDBCDriverClassNameProperty](JDBCDriverClassNameProperty.html)`
`[clone](#clone())()`
Clones the property.
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getClassType](#getClassType())()`
Returns property class type.
Methods inherited from class com.nomagic.magicdraw.properties.[JarEntryProperty](JarEntryProperty.html)
`[getPathProperty](JarEntryProperty.html#getPathProperty()), [setPathProperty](JarEntryProperty.html#setPathProperty(com.nomagic.magicdraw.properties.ClassPathEntriesListProperty))`
...
JDBCDriverClassNameProperty
public JDBCDriverClassNameProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) driverClassName)
Creates and initializes a new instance of `JDBCDriverClassNameProperty`
 class.
Parameters:
...
Overrides:
`[getClassType](JarEntryProperty.html#getClassType())` in class `[JarEntryProperty](JarEntryProperty.html)`
Returns:
PropertyID.JDBC_DRIVER_CLASS_NAME_PROPERTY
See Also:
[`PropertyID.JDBC_DRIVER_CLASS_NAME_PROPERTY`](PropertyID.html#JDBC_DRIVER_CLASS_NAME_PROPERTY)
accept
...
Description copied from class: `[JarEntryProperty](JarEntryProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor))`
Accepts the given visitor.
Specified by:
...
Overrides:
`[accept](JarEntryProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor))` in class `[JarEntryProperty](JarEntryProperty.html)`
Parameters:
`v` - the PropertyVisitor.
Throws:
`[Exception](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Exception.html)`
clone
public [JDBCDriverClassNameProperty](JDBCDriverClassNameProperty.html) clone()
...
Overrides:
`[clone](JarEntryProperty.html#clone())` in class `[JarEntryProperty](JarEntryProperty.html)`
Returns:
the cloned property.
...
<h1 class="title" title="Class JDBCDriverClassNameProperty">Class JDBCDriverClassNameProperty</h1>
</div>
...
<div class="inheritance"><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">com.nomagic.magicdraw.properties.JarEntryProperty</a>
<div class="inheritance">com.nomagic.magicdraw.properties.JDBCDriverClassNameProperty</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">JDBCDriverClassNameProperty</span>
<span class="extends-implements">extends <a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></span></div>
<div class="block">The property for storing and editing a class name of a JDBC driver.</div>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">JDBCDriverClassNameProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">JDBCDriverClassNameProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> driverClassName)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates and initializes a new instance of <code>JDBCDriverClassNameProperty</code>
 class.</div>
</div>
</div>
</section>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="JDBCDriverClassNameProperty.html" title="class in com.nomagic.magicdraw.properties">JDBCDriverClassNameProperty</a></code></div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.magicdraw.properties.JarEntryProperty">Methods inherited from class com.nomagic.magicdraw.properties.<a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></h3>
<code><a href="JarEntryProperty.html#getPathProperty()">getPathProperty</a>, <a href="JarEntryProperty.html#setPathProperty(com.nomagic.magicdraw.properties.ClassPathEntriesListProperty)">setPathProperty</a></code></div>
<div class="inherited-list">
...
<h3>JDBCDriverClassNameProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">JDBCDriverClassNameProperty</span>()</div>
...
<h3>JDBCDriverClassNameProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">JDBCDriverClassNameProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> driverClassName)</span></div>
<div class="block">Creates and initializes a new instance of <code>JDBCDriverClassNameProperty</code>
 class.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of property.</dd>
<dd><code>driverClassName</code> - the name of class of JDBC driver.</dd>
</dl>
</section>
</li>
</ul>
...
<dt>Overrides:</dt>
<dd><code><a href="JarEntryProperty.html#getClassType()">getClassType</a></code> in class <code><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></code></dd>
<dt>Returns:</dt>
<dd>PropertyID.JDBC_DRIVER_CLASS_NAME_PROPERTY</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="PropertyID.html#JDBC_DRIVER_CLASS_NAME_PROPERTY"><code>PropertyID.JDBC_DRIVER_CLASS_NAME_PROPERTY</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="block"><span class="description-from-type-label">Description copied from class: <code><a href="JarEntryProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor)">JarEntryProperty</a></code></span></div>
<div class="block">Accepts the given visitor.</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<dt>Overrides:</dt>
<dd><code><a href="JarEntryProperty.html#accept(com.nomagic.magicdraw.properties.PropertyVisitor)">accept</a></code> in class <code><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></code></dd>
<dt>Parameters:</dt>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="JDBCDriverClassNameProperty.html" title="class in com.nomagic.magicdraw.properties">JDBCDriverClassNameProperty</a></span> <span class="element-name">clone</span>()</div>
...
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="JarEntryProperty.html#clone()">clone</a></code> in class <code><a href="JarEntryProperty.html" title="class in com.nomagic.magicdraw.properties">JarEntryProperty</a></code></dd>
<dt>Returns:</dt>
