# JAVA OPENAPI: PageFormatProperty (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/properties/PageFormatProperty.html
- source_path: `com/nomagic/magicdraw/properties/PageFormatProperty.html`
- source_sha256: `6968076f11d81e210d58e5098271339850a12d044e5532a1d402021b53ccda75`
- captured_utc: `2026-07-14T16:45:39.424525+00:00`
...
@OpenApiAllpublic classPageFormatProperty
extends [Property](Property.html)

The property for storing `java.awt.print.PageFormat` value.
 Current implementation does not provide some editor for this value.

See Also:
[`PageFormat`](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html)
...
Constructor
Description
`[PageFormatProperty](#%3Cinit%3E())()`
Default constructor.
`[PageFormatProperty](#%3Cinit%3E(java.lang.String,java.awt.print.PageFormat))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [PageFormat](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html) value)`
...
`[PageFormatProperty](PageFormatProperty.html)`
`[clone](#clone())()`
Clones the property.
...
PageFormatProperty
public PageFormatProperty([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [PageFormat](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html) value)
The property constructor.
Parameters:
...
getPageFormat
public [PageFormat](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html) getPageFormat()
Returns value as `PageFormat`.
Returns:
value as `PageFormat`.
getClassType
...
See Also:
[`PropertyID.PAGE_FORMAT`](PropertyID.html#PAGE_FORMAT)
clone
public [PageFormatProperty](PageFormatProperty.html) clone()
...
<h1 class="title" title="Class PageFormatProperty">Class PageFormatProperty</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.properties.PageFormatProperty</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">PageFormatProperty</span>
...
<div class="block">The property for storing <code>java.awt.print.PageFormat</code> value.
 Current implementation does not provide some editor for this value.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print"><code>PageFormat</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">PageFormatProperty</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Default constructor.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.awt.print.PageFormat)">PageFormatProperty</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a> value)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="PageFormatProperty.html" title="class in com.nomagic.magicdraw.properties">PageFormatProperty</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getPageFormat()">getPageFormat</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns value as <code>PageFormat</code>.</div>
</div>
</div>
</div>
</div>
...
<h3>PageFormatProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PageFormatProperty</span>()</div>
<div class="block">Default constructor. Value of the property will be null.
 ID will be empty string.</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.awt.print.PageFormat)">
<h3>PageFormatProperty</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">PageFormatProperty</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a> value)</span></div>
<div class="block">The property constructor.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>id</code> - the ID of property.</dd>
<dd><code>value</code> - the PageFormat value of the property.</dd>
</dl>
</section>
</li>
</ul>
...
<li>
<section class="detail" id="getPageFormat()">
<h3>getPageFormat</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/print/PageFormat.html" title="class or interface in java.awt.print">PageFormat</a></span> <span class="element-name">getPageFormat</span>()</div>
<div class="block">Returns value as <code>PageFormat</code>.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>value as <code>PageFormat</code>.</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>PropertyID.PAGE_FORMAT</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="PropertyID.html#PAGE_FORMAT"><code>PropertyID.PAGE_FORMAT</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>clone</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="PageFormatProperty.html" title="class in com.nomagic.magicdraw.properties">PageFormatProperty</a></span> <span class="element-name">clone</span>()</div>
