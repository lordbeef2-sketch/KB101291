# JAVA OPENAPI: AnalysisPatternsProfile.relationEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/sysml/util/AnalysisPatternsProfile.relationEnum.html
- source_path: `com/nomagic/magicdraw/sysml/util/AnalysisPatternsProfile.relationEnum.html`
- source_sha256: `60889b3fd878d69990d3643fd7919a2ba5fb204c77c8c02d8a86cbb552e0cbe8`
- captured_utc: `2026-07-14T16:45:44.087590+00:00`
...
## Enum Class AnalysisPatternsProfile.relationEnum

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html)>
com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile.relationEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[AnalysisPatternsProfile](AnalysisPatternsProfile.html)`

public static enumAnalysisPatternsProfile.relationEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html)>
...
Method
Description
`static [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile,com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile.relationEnum))([AnalysisPatternsProfile](AnalysisPatternsProfile.html) profile,
 [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) anEnum)`
...
PERCENT
public static final [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) PERCENT
VALUES
public static final [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) VALUES
 ============ METHOD DETAIL ========== 
Method Details
values
public static [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [AnalysisPatternsProfile.relationEnum](AnalysisPatternsProfile.relationEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class AnalysisPatternsProfile.relationEnum">Enum Class AnalysisPatternsProfile.relationEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile.relationEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">AnalysisPatternsProfile.relationEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a>&gt;</span></div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#PERCENT">PERCENT</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#VALUES">VALUES</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile,com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile.relationEnum)">toEnumerationLiteral</a><wbr/>(<a href="AnalysisPatternsProfile.html" title="class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile</a> profile,
 <a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a>[]</code></div>
...
<h3>PERCENT</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></span> <span class="element-name">PERCENT</span></div>
</section>
</li>
<li>
<section class="detail" id="VALUES">
<h3>VALUES</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></span> <span class="element-name">VALUES</span></div>
</section>
</li>
</ul>
</section>
...
<section class="detail" id="values()">
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile,com.nomagic.magicdraw.sysml.util.AnalysisPatternsProfile.relationEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="AnalysisPatternsProfile.relationEnum.html" title="enum class in com.nomagic.magicdraw.sysml.util">AnalysisPatternsProfile.relationEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
