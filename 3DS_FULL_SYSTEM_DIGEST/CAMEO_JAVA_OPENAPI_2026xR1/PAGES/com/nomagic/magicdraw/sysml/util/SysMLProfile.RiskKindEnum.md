# JAVA OPENAPI: SysMLProfile.RiskKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/sysml/util/SysMLProfile.RiskKindEnum.html
- source_path: `com/nomagic/magicdraw/sysml/util/SysMLProfile.RiskKindEnum.html`
- source_sha256: `97938948019d235ff618830f10674aeb4510271528b50bffa4dbc438b08078dd`
- captured_utc: `2026-07-14T16:45:47.461635+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.RiskKindEnum](SysMLProfile.RiskKindEnum.html)>
com.nomagic.magicdraw.sysml.util.SysMLProfile.RiskKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[SysMLProfile.RiskKindEnum](SysMLProfile.RiskKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[SysMLProfile](SysMLProfile.html)`

public static enumSysMLProfile.RiskKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[SysMLProfile.RiskKindEnum](SysMLProfile.RiskKindEnum.html)>
...
valueOf
public static [SysMLProfile.RiskKindEnum](SysMLProfile.RiskKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
