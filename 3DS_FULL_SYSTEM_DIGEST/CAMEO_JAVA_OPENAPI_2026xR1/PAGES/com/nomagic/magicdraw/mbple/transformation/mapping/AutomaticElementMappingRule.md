# JAVA OPENAPI: AutomaticElementMappingRule (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/mbple/transformation/mapping/AutomaticElementMappingRule.html
- source_path: `com/nomagic/magicdraw/mbple/transformation/mapping/AutomaticElementMappingRule.html`
- source_sha256: `8d42b60d16bc27c3a27da5cc30d69fc781d03cd5bc9a4686cfefa0130c5b66f0`
- captured_utc: `2026-07-14T16:45:37.978509+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.magicdraw.mbple.transformation.mapping](package-summary.html)
...
`[getElementToMap](#getElementToMap(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.util.List))([Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html) sourceElement,
 [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> targetElements)`
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span> <a href="package-summary.html">com.nomagic.magicdraw.mbple.transformation.mapping</a></div>
...
<div class="block">Copied from md core and modified.

 Rule for describing when source element can be mapped to target element without user input</div>
</section>
