# JAVA OPENAPI: DefaultValidationRuleImpl (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/validation/DefaultValidationRuleImpl.html
- source_path: `com/nomagic/magicdraw/validation/DefaultValidationRuleImpl.html`
- source_sha256: `0e20c6f3d3838a3b2ee373e9e9bd45cd4852f112cdd88afb07bb84cb9fb9445a`
- captured_utc: `2026-07-14T16:46:10.665945+00:00`
...
`protected [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)>`
...
`[Map](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html)<[Class](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Class.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)>,[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[SmartListenerConfig](../../uml2/ext/jmi/smartlistener/SmartListenerConfig.html)>>`
...
run
@CheckForNullpublic final [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[Annotation](../annotation/Annotation.html)> run([Project](../core/Project.html) project,
 [Constraint](../../uml2/ext/magicdraw/classes/mdkernel/Constraint.html) constraint,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> elements)
Performs validation on the specified model elements by using specified constraint.
Specified by:
...
`Annotation` object.
getInvalidElements
protected [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getInvalidElements([Constraint](../../uml2/ext/magicdraw/classes/mdkernel/Constraint.html) constraint,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<? extends [Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> elements)
Returns invalid elements from the specified collection of elements.
Parameters:
