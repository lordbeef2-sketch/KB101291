# JAVA OPENAPI: ModuleUsageLockAcquisitionException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/teamwork2/locks/ModuleUsageLockAcquisitionException.html
- source_path: `com/nomagic/magicdraw/teamwork2/locks/ModuleUsageLockAcquisitionException.html`
- source_sha256: `103a01cdc29744a5a41fcf15c64218a924ca882598466d83dab79c8cd0ed28aa`
- captured_utc: `2026-07-14T16:45:47.911640+00:00`
...
@OpenApiAllpublic classModuleUsageLockAcquisitionException
...
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.locks.ModuleUsageLockAcquisitionException)
...
Constructor
Description
`[ModuleUsageLockAcquisitionException](#%3Cinit%3E(com.nomagic.magicdraw.core.modules.ModuleUsage))([ModuleUsage](../../core/modules/ModuleUsage.html) moduleUsage)`
Creates new instance of [`ModuleUsageLockAcquisitionException`](ModuleUsageLockAcquisitionException.html)
 ========== METHOD SUMMARY =========== 
Method Summary
...
public ModuleUsageLockAcquisitionException([ModuleUsage](../../core/modules/ModuleUsage.html) moduleUsage)
Creates new instance of [`ModuleUsageLockAcquisitionException`](ModuleUsageLockAcquisitionException.html)
Parameters:
...
<h1 class="title" title="Class ModuleUsageLockAcquisitionException">Class ModuleUsageLockAcquisitionException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.teamwork2.locks.ModuleUsageLockAcquisitionException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ModuleUsageLockAcquisitionException</span>
...
<div class="block">An exception that is thrown to signal that a required module usage could not be locked</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.locks.ModuleUsageLockAcquisitionException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicdraw.core.modules.ModuleUsage)">ModuleUsageLockAcquisitionException</a><wbr/>(<a href="../../core/modules/ModuleUsage.html" title="class in com.nomagic.magicdraw.core.modules">ModuleUsage</a> moduleUsage)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates new instance of <a href="ModuleUsageLockAcquisitionException.html" title="class in com.nomagic.magicdraw.teamwork2.locks"><code>ModuleUsageLockAcquisitionException</code></a></div>
</div>
</div>
</section>
</li>
...
<li>
<section class="detail" id="&lt;init&gt;(com.nomagic.magicdraw.core.modules.ModuleUsage)">
<h3>ModuleUsageLockAcquisitionException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ModuleUsageLockAcquisitionException</span><wbr/><span class="parameters">(<a href="../../core/modules/ModuleUsage.html" title="class in com.nomagic.magicdraw.core.modules">ModuleUsage</a> moduleUsage)</span></div>
<div class="block">Creates new instance of <a href="ModuleUsageLockAcquisitionException.html" title="class in com.nomagic.magicdraw.teamwork2.locks"><code>ModuleUsageLockAcquisitionException</code></a></div>
<dl class="notes">
<dt>Parameters:</dt>
