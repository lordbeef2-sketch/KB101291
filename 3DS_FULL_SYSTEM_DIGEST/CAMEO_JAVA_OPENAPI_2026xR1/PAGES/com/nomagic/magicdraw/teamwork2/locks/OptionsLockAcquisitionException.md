# JAVA OPENAPI: OptionsLockAcquisitionException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/teamwork2/locks/OptionsLockAcquisitionException.html
- source_path: `com/nomagic/magicdraw/teamwork2/locks/OptionsLockAcquisitionException.html`
- source_sha256: `5bd11bd43a633dbd85f843ba3e720c4c58593251fff90e00238c5a4fc54ae357`
- captured_utc: `2026-07-14T16:45:47.861639+00:00`
...
@OpenApiAllpublic classOptionsLockAcquisitionException
...
See Also:
[Serialized Form](../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.locks.OptionsLockAcquisitionException)
...
Constructor
Description
`[OptionsLockAcquisitionException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) options)`
Creates new instance of [`OptionsLockAcquisitionException`](OptionsLockAcquisitionException.html)
 ========== METHOD SUMMARY =========== 
Method Summary
...
public OptionsLockAcquisitionException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) options)
Creates new instance of [`OptionsLockAcquisitionException`](OptionsLockAcquisitionException.html)
Parameters:
...
Method Details
getOptions
public [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getOptions()
Gets the options that could not be locked
Returns:
the options
...
<h1 class="title" title="Class OptionsLockAcquisitionException">Class OptionsLockAcquisitionException</h1>
</div>
...
<div class="inheritance">com.nomagic.magicdraw.teamwork2.locks.OptionsLockAcquisitionException</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">OptionsLockAcquisitionException</span>
...
<div class="block">An exception that is thrown to signal that a required options could not be locked</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../../serialized-form.html#com.nomagic.magicdraw.teamwork2.locks.OptionsLockAcquisitionException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">OptionsLockAcquisitionException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> options)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates new instance of <a href="OptionsLockAcquisitionException.html" title="class in com.nomagic.magicdraw.teamwork2.locks"><code>OptionsLockAcquisitionException</code></a></div>
</div>
</div>
</section>
</li>
...
<div class="block">Gets the options that could not be locked</div>
</div>
</div>
</div>
</div>
...
<h3>OptionsLockAcquisitionException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">OptionsLockAcquisitionException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> options)</span></div>
<div class="block">Creates new instance of <a href="OptionsLockAcquisitionException.html" title="class in com.nomagic.magicdraw.teamwork2.locks"><code>OptionsLockAcquisitionException</code></a></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>options</code> - the options that could not be locked</dd>
</dl>
</section>
</li>
</ul>
...
<h3>getOptions</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getOptions</span>()</div>
<div class="block">Gets the options that could not be locked</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the options</dd>
