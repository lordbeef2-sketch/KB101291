# JAVA OPENAPI: PasswordProtectException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/teamwork2/esi/protect/PasswordProtectException.html
- source_path: `com/nomagic/magicdraw/teamwork2/esi/protect/PasswordProtectException.html`
- source_sha256: `a990e25c77b211f63cb9004a169dfd7eb83e33e30ea1659111e4bb613cf68889`
- captured_utc: `2026-07-14T16:45:47.585636+00:00`
...
`[PasswordProtectException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`
Creates and initializes a new `PasswordProtectException` from specified parameter.
`[PasswordProtectException](#%3Cinit%3E(java.lang.String,java.lang.Throwable))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
...
`[PasswordProtectException](#%3Cinit%3E(java.lang.Throwable))([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)`
Creates and initializes a new `PasswordProtectException` from specified parameter.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Creates and initializes a new `PasswordProtectException`.
PasswordProtectException
public PasswordProtectException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
Creates and initializes a new `PasswordProtectException` from specified parameter.
Parameters:
`message` - error message.
PasswordProtectException
public PasswordProtectException([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)
Creates and initializes a new `PasswordProtectException` from specified parameter.
Parameters:
