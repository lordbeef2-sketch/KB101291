# JAVA OPENAPI: CategoryInfo (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/teamwork2/esi/CategoryInfo.html
- source_path: `com/nomagic/magicdraw/teamwork2/esi/CategoryInfo.html`
- source_sha256: `25048f376833e03ac9131b7dd44fa8ef1f4a4bf8ca39b4f74c2719a43d823e1c`
- captured_utc: `2026-07-14T16:45:47.551635+00:00`
...
`[getName](#getName())()`
Gets category name
`[Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[UUID](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html)>`
`[getNested](#getNested())()`
...
getParentID
@OpenApi
@CheckForNullpublic [UUID](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html) getParentID()
Get category parent id
Returns:
parent category id
getNested
@OpenApipublic [Set](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Set.html)<[UUID](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html)> getNested()
Get nested category id
Returns:
nested category ids
getID
@CheckForNull
@OpenApipublic [UUID](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html) getID()
Gets category identifier
Returns:
...
@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html" title="class or interface in java.util">UUID</a></span> <span class="element-name">getParentID</span>()</div>
<div class="block">Get category parent id</div>
<dl class="notes">
<dt>Returns:</dt>
...
@OpenApi
</span><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/UUID.html" title="class or interface in java.util">UUID</a></span> <span class="element-name">getID</span>()</div>
<div class="block">Gets category identifier</div>
<dl class="notes">
<dt>Returns:</dt>
