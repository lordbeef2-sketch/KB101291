# JAVA OPENAPI: MatrixSettings.LegendLocation (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.LegendLocation.html
- source_path: `com/nomagic/magicdraw/dependencymatrix/persistence/MatrixSettings.LegendLocation.html`
- source_sha256: `22587803515772d031b13fd040d0847b58e60bb7254a035303f2b8711e2f07b6`
- captured_utc: `2026-07-14T16:45:32.301437+00:00`
...
## Enum Class MatrixSettings.LegendLocation

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html)>
com.nomagic.magicdraw.dependencymatrix.persistence.MatrixSettings.LegendLocation

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[MatrixSettings](MatrixSettings.html)`

public static enumMatrixSettings.LegendLocation
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html)>
...
Method
Description
`static [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html)`
...
ABOVE_COLUMN_HEADER
public static final [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html) ABOVE_COLUMN_HEADER
TOP_LEFT_CORNER
public static final [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html) TOP_LEFT_CORNER
DO_NOT_DISPLAY
public static final [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html) DO_NOT_DISPLAY
 ============ METHOD DETAIL ========== 
Method Details
values
public static [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
type string
getEnum
public static [MatrixSettings.LegendLocation](MatrixSettings.LegendLocation.html) getEnum([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) type)
Finds enum by its type
Parameters:
`type` - type to find
Returns:
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">MatrixSettings.LegendLocation</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a>&gt;</span></div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a>[]</code></div>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></span> <span class="element-name">ABOVE_COLUMN_HEADER</span></div>
</section>
</li>
<li>
<section class="detail" id="TOP_LEFT_CORNER">
<h3>TOP_LEFT_CORNER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></span> <span class="element-name">TOP_LEFT_CORNER</span></div>
</section>
</li>
<li>
<section class="detail" id="DO_NOT_DISPLAY">
<h3>DO_NOT_DISPLAY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></span> <span class="element-name">DO_NOT_DISPLAY</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
<h3>getEnum</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="MatrixSettings.LegendLocation.html" title="enum class in com.nomagic.magicdraw.dependencymatrix.persistence">MatrixSettings.LegendLocation</a></span> <span class="element-name">getEnum</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> type)</span></div>
<div class="block">Finds enum by its type</div>
<dl class="notes">
<dt>Parameters:</dt>
