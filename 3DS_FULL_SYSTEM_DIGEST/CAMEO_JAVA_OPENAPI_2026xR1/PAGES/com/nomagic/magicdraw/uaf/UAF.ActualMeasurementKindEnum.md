# JAVA OPENAPI: UAF.ActualMeasurementKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.ActualMeasurementKindEnum.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ActualMeasurementKindEnum.html`
- source_sha256: `ca5870532a6c2f805932f8ff279c3bab39f5e3636a7465b018b981fe0fd49faf`
- captured_utc: `2026-07-14T16:45:48.426647+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html)>
com.nomagic.magicdraw.uaf.UAF.ActualMeasurementKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UAF](UAF.html)`

public static enumUAF.ActualMeasurementKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html)>
...
Method
Description
`static [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ActualMeasurementKindEnum))([UAF](UAF.html) profile,
 [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) anEnum)`
...
ACTUAL
public static final [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) ACTUAL
Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a realworld value.
REQUIRED
public static final [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) REQUIRED
Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a value that is expected to be achieved.
ESTIMATE
public static final [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) ESTIMATE
Indicates that the ActualMeasurement associated with the ActualMeasurementKind is an estimate of a realworld value.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [UAF.ActualMeasurementKindEnum](UAF.ActualMeasurementKindEnum.html) toEnum([EnumerationLiteral](../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class UAF.ActualMeasurementKindEnum">Enum Class UAF.ActualMeasurementKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.uaf.UAF.ActualMeasurementKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">UAF.ActualMeasurementKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a>&gt;</span></div>
<div class="block">Enumeration of the possible kinds of ActualMeasurement.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ACTUAL">ACTUAL</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a realworld value.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#ESTIMATE">ESTIMATE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is an estimate of a realworld value.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#REQUIRED">REQUIRED</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a value that is expected to be achieved.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ActualMeasurementKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile,
 <a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a>[]</code></div>
...
<h3>ACTUAL</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">ACTUAL</span></div>
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a realworld value.</div>
</section>
</li>
<li>
...
<h3>REQUIRED</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">REQUIRED</span></div>
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is a value that is expected to be achieved.</div>
</section>
</li>
<li>
<section class="detail" id="ESTIMATE">
<h3>ESTIMATE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">ESTIMATE</span></div>
<div class="block">Indicates that the ActualMeasurement associated with the ActualMeasurementKind is an estimate of a realworld value.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ActualMeasurementKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="UAF.ActualMeasurementKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ActualMeasurementKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
