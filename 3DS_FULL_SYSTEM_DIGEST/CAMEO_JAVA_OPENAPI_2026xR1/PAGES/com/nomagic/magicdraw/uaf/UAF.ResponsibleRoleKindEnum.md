# JAVA OPENAPI: UAF.ResponsibleRoleKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.ResponsibleRoleKindEnum.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.ResponsibleRoleKindEnum.html`
- source_sha256: `12e3a154d2641a70820c58482e61c88811708208ebccbe8dc44a32bd69f2d945`
- captured_utc: `2026-07-14T16:45:57.943773+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html)>
com.nomagic.magicdraw.uaf.UAF.ResponsibleRoleKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UAF](UAF.html)`

public static enumUAF.ResponsibleRoleKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html)>
...
Method
Description
`static [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ResponsibleRoleKindEnum))([UAF](UAF.html) profile,
 [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) anEnum)`
...
MANAGER
public static final [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) MANAGER
Indicates that the ResourceInteraction associated with the ResourceInteractionKind is a an implementation of logical flow.
RESPONSIBLEOWNER
public static final [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) RESPONSIBLEOWNER
Indicates that the ResourceInteraction associated with the ResourceInteractionKind is a an implementation of logical flow.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [UAF.ResponsibleRoleKindEnum](UAF.ResponsibleRoleKindEnum.html) toEnum([EnumerationLiteral](../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class UAF.ResponsibleRoleKindEnum">Enum Class UAF.ResponsibleRoleKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.uaf.UAF.ResponsibleRoleKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">UAF.ResponsibleRoleKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a>&gt;</span></div>
<div class="block">Enumeration of the possible kinds of ResponsibleFor relationship.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#MANAGER">MANAGER</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the ResourceInteraction associated with the ResourceInteractionKind is a an implementation of logical flow.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#RESPONSIBLEOWNER">RESPONSIBLEOWNER</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ResponsibleRoleKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile,
 <a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a>[]</code></div>
...
<li>
<section class="detail" id="MANAGER">
<h3>MANAGER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></span> <span class="element-name">MANAGER</span></div>
<div class="block">Indicates that the ResourceInteraction associated with the ResourceInteractionKind is a an implementation of logical flow.</div>
</section>
</li>
<li>
<section class="detail" id="RESPONSIBLEOWNER">
<h3>RESPONSIBLEOWNER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></span> <span class="element-name">RESPONSIBLEOWNER</span></div>
<div class="block">Indicates that the ResourceInteraction associated with the ResourceInteractionKind is a an implementation of logical flow.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.ResponsibleRoleKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="UAF.ResponsibleRoleKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.ResponsibleRoleKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
