# JAVA OPENAPI: UAF.WholeLifeConfigurationKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/uaf/UAF.WholeLifeConfigurationKindEnum.html
- source_path: `com/nomagic/magicdraw/uaf/UAF.WholeLifeConfigurationKindEnum.html`
- source_sha256: `40db130168af03435063e9716562459a5de281934c57793f5ed79bac92b6700d`
- captured_utc: `2026-07-14T16:45:59.386793+00:00`
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html)>
com.nomagic.magicdraw.uaf.UAF.WholeLifeConfigurationKindEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[UAF](UAF.html)`

public static enumUAF.WholeLifeConfigurationKindEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html)>
...
Method
Description
`static [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.WholeLifeConfigurationKindEnum))([UAF](UAF.html) profile,
 [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) anEnum)`
...
SERVICE
public static final [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) SERVICE
Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which Services are versioned.
RESOURCEPERFORMER
public static final [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) RESOURCEPERFORMER
Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which ResourcePerformers are versioned.
ORGANIZATIONALRESOURCE
public static final [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) ORGANIZATIONALRESOURCE
Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which OrganizationalResources are versioned.
 ============ METHOD DETAIL ========== 
Method Details
values
public static [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [UAF.WholeLifeConfigurationKindEnum](UAF.WholeLifeConfigurationKindEnum.html) toEnum([EnumerationLiteral](../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class UAF.WholeLifeConfigurationKindEnum">Enum Class UAF.WholeLifeConfigurationKindEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.uaf.UAF.WholeLifeConfigurationKindEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">UAF.WholeLifeConfigurationKindEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a>&gt;</span></div>
<div class="block">Enumeration of the possible kinds of WholeLifeConfiguration.</div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ORGANIZATIONALRESOURCE">ORGANIZATIONALRESOURCE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which OrganizationalResources are versioned.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#RESOURCEPERFORMER">RESOURCEPERFORMER</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which ResourcePerformers are versioned.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#SERVICE">SERVICE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which Services are versioned.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.WholeLifeConfigurationKindEnum)">toEnumerationLiteral</a><wbr/>(<a href="UAF.html" title="class in com.nomagic.magicdraw.uaf">UAF</a> profile,
 <a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a>[]</code></div>
...
<h3>SERVICE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">SERVICE</span></div>
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which Services are versioned.</div>
</section>
</li>
<li>
<section class="detail" id="RESOURCEPERFORMER">
<h3>RESOURCEPERFORMER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">RESOURCEPERFORMER</span></div>
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which ResourcePerformers are versioned.</div>
</section>
</li>
<li>
<section class="detail" id="ORGANIZATIONALRESOURCE">
<h3>ORGANIZATIONALRESOURCE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">ORGANIZATIONALRESOURCE</span></div>
<div class="block">Indicates that the WholeLifeConfiguration associated with the WholeLifeConfigurationKind is the master specification from which OrganizationalResources are versioned.</div>
</section>
</li>
</ul>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.uaf.UAF,com.nomagic.magicdraw.uaf.UAF.WholeLifeConfigurationKindEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="UAF.WholeLifeConfigurationKindEnum.html" title="enum class in com.nomagic.magicdraw.uaf">UAF.WholeLifeConfigurationKindEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
