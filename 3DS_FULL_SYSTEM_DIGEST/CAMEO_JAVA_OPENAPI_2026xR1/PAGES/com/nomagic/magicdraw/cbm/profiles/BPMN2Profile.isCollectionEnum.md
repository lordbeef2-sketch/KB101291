# JAVA OPENAPI: BPMN2Profile.isCollectionEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.isCollectionEnum.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.isCollectionEnum.html`
- source_sha256: `51d98e6384de547607eed641e4923a0840d891c4cb57adaa1e46d5e5eb24a8e9`
- captured_utc: `2026-07-14T16:45:28.021375+00:00`
...
## Enum Class BPMN2Profile.isCollectionEnum

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html)>
com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.isCollectionEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[BPMN2Profile](BPMN2Profile.html)`

public static enumBPMN2Profile.isCollectionEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html)>
...
Method
Description
`static [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.isCollectionEnum))([BPMN2Profile](BPMN2Profile.html) profile,
 [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) anEnum)`
...
TRUE
public static final [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) TRUE
FALSE
public static final [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) FALSE
 ============ METHOD DETAIL ========== 
Method Details
values
public static [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [BPMN2Profile.isCollectionEnum](BPMN2Profile.isCollectionEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<h1 class="title" title="Enum Class BPMN2Profile.isCollectionEnum">Enum Class BPMN2Profile.isCollectionEnum</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a>&gt;
<div class="inheritance">com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.isCollectionEnum</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">BPMN2Profile.isCollectionEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a>&gt;</span></div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.isCollectionEnum)">toEnumerationLiteral</a><wbr/>(<a href="BPMN2Profile.html" title="class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile</a> profile,
 <a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a>[]</code></div>
...
<h3>TRUE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></span> <span class="element-name">TRUE</span></div>
</section>
</li>
<li>
<section class="detail" id="FALSE">
<h3>FALSE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></span> <span class="element-name">FALSE</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.isCollectionEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="BPMN2Profile.isCollectionEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.isCollectionEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
