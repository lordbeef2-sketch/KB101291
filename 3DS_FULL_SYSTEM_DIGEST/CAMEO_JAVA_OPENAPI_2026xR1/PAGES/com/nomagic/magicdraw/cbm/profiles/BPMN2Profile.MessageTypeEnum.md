# JAVA OPENAPI: BPMN2Profile.MessageTypeEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.MessageTypeEnum.html
- source_path: `com/nomagic/magicdraw/cbm/profiles/BPMN2Profile.MessageTypeEnum.html`
- source_sha256: `2603628f8461ec9b837063a87b24b4f4c21b88183f05edefc05b0d0cc67b9f5f`
- captured_utc: `2026-07-14T16:45:24.170324+00:00`
...
## Enum Class BPMN2Profile.MessageTypeEnum

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html)>
com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.MessageTypeEnum

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[BPMN2Profile](BPMN2Profile.html)`

public static enumBPMN2Profile.MessageTypeEnum
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html)>
...
Method
Description
`static [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html)`
...
`[toEnumerationLiteral](#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.MessageTypeEnum))([BPMN2Profile](BPMN2Profile.html) profile,
 [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) anEnum)`
...
INITIATING
public static final [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) INITIATING
REPLY
public static final [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) REPLY
 ============ METHOD DETAIL ========== 
Method Details
values
public static [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
from
@CheckForNullpublic static [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) from(@CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) o)
toEnum
@CheckForNullpublic static [BPMN2Profile.MessageTypeEnum](BPMN2Profile.MessageTypeEnum.html) toEnum([EnumerationLiteral](../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html) literal)
...
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">BPMN2Profile.MessageTypeEnum</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a>&gt;</span></div>
</section>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#INITIATING">INITIATING</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#REPLY">REPLY</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="#toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.MessageTypeEnum)">toEnumerationLiteral</a><wbr/>(<a href="BPMN2Profile.html" title="class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile</a> profile,
 <a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a> anEnum)</code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a>[]</code></div>
...
<li>
<section class="detail" id="INITIATING">
<h3>INITIATING</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></span> <span class="element-name">INITIATING</span></div>
</section>
</li>
<li>
<section class="detail" id="REPLY">
<h3>REPLY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></span> <span class="element-name">REPLY</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
...
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></span> <span class="element-name">from</span><wbr/><span class="parameters">(@CheckForNull
...
<h3>toEnum</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public static</span> <span class="return-type"><a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a></span> <span class="element-name">toEnum</span><wbr/><span class="parameters">(<a href="../../../uml2/ext/magicdraw/classes/mdkernel/EnumerationLiteral.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">EnumerationLiteral</a> literal)</span></div>
</section>
</li>
<li>
<section class="detail" id="toEnumerationLiteral(com.nomagic.magicdraw.cbm.profiles.BPMN2Profile,com.nomagic.magicdraw.cbm.profiles.BPMN2Profile.MessageTypeEnum)">
...
<div class="member-signature"><span class="annotations">@CheckForNull
 ...
 <a href="BPMN2Profile.MessageTypeEnum.html" title="enum class in com.nomagic.magicdraw.cbm.profiles">BPMN2Profile.MessageTypeEnum</a> anEnum)</span></div>
</section>
</li>
</ul>
</section>
