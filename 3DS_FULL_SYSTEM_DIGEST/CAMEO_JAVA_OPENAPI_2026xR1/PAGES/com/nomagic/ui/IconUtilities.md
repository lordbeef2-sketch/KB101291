# JAVA OPENAPI: IconUtilities (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/ui/IconUtilities.html
- source_path: `com/nomagic/ui/IconUtilities.html`
- source_sha256: `24b90e7b7c3af391e7b0d68bbbf4ad9d713c8fc8695326cf7e552507508b620e`
- captured_utc: `2026-07-14T16:46:17.039028+00:00`
...
`static boolean`
`[isExistingIconImage](#isExistingIconImage(javax.swing.Icon))([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)`
Used to check if icon really contains a valid image
`static boolean`
`[isImageFile](#isImageFile(java.io.File))([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) file)`

`static [BufferedImage](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/BufferedImage.html)`
`[toImage](#toImage(javax.swing.Icon))([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)`
Create an image from a given icon
`static byte[]`
`[toPng](#toPng(java.awt.image.RenderedImage))([RenderedImage](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/RenderedImage.html) img)`
Export given image to PNG.
`static byte[]`
`[toPng](#toPng(javax.swing.Icon))([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)`
Export given icon to PNG.
`static byte[]`
`[toSvg](#toSvg(javax.swing.Icon))([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)`
...
public static final [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> IMAGE_SHAPE_IMAGE_TYPES
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
IconUtilities
...
Method Details
toSvg
public static byte[] toSvg([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)
Export given icon to SVG.
Parameters:
`icon` - icon
Returns:
svg bytes
toPng
public static byte[] toPng([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)
Export given icon to PNG.
Parameters:
`icon` - icon
Returns:
png bytes
toPng
public static byte[] toPng([RenderedImage](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/RenderedImage.html) img)
Export given image to PNG.
Parameters:
`img` - image
Returns:
...
gray(disabled) icon
toImage
public static [BufferedImage](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/BufferedImage.html) toImage([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)
Create an image from a given icon
Parameters:
`icon` - icon
Returns:
image
isImageFile
public static boolean isImageFile([File](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/File.html) file)
isExistingIconImage
public static boolean isExistingIconImage([Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon)
Used to check if icon really contains a valid image
Parameters:
`icon` - icon
Returns:
