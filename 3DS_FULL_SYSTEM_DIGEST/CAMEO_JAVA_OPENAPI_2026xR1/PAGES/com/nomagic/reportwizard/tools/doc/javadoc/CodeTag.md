# JAVA OPENAPI: CodeTag (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/reportwizard/tools/doc/javadoc/CodeTag.html
- source_path: `com/nomagic/reportwizard/tools/doc/javadoc/CodeTag.html`
- source_sha256: `77b12e332b17424adeda52eb81640275d878612612eb3f0464fcb07b46c35f6e`
- captured_utc: `2026-07-14T16:46:15.432006+00:00`
...
com.nomagic.reportwizard.tools.doc.javadoc.CodeTag

All Implemented Interfaces:
`[Tag](../Tag.html)`

@OpenApiAllpublic classCodeTag
...
Constructor
Description
`[CodeTag](#%3Cinit%3E(java.lang.String,java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
...
Constructor Details
CodeTag
public CodeTag([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) kind,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) text)
Create a code tag.
Parameters:
...
<h1 class="title" title="Class CodeTag">Class CodeTag</h1>
</div>
...
<div class="inheritance">com.nomagic.reportwizard.tools.doc.javadoc.CodeTag</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CodeTag</span>
...
<div class="block">Represents a @code documentation tag.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Sep 3, 2008</dd>
</dl>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.String)">CodeTag</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
...
<div class="block">Create a code tag.</div>
</div>
</div>
</section>
</li>
...
<h3>CodeTag</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CodeTag</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> kind,
