# JAVA OPENAPI: MDCustomizationForRequirements.RequirementTableStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/requirements/util/MDCustomizationForRequirements.RequirementTableStereotype.html
- source_path: `com/nomagic/requirements/util/MDCustomizationForRequirements.RequirementTableStereotype.html`
- source_sha256: `f1c5044ea9b00660eb4ae3420d28383a3809468c4be9344225c256c8bc97bb94`
- captured_utc: `2026-07-14T16:46:16.232017+00:00`
...
`[setShowColumns](#setShowColumns(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,java.util.Collection))([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html)> value)`
...
COLUMNSWIDTH
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) COLUMNSWIDTH
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) CUSTOMCOLUMNELEMENTS
See Also:
...
SHOWCOLUMNS
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWCOLUMNS
See Also:
...
SHOWCUSTOMCOLUMNS
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWCUSTOMCOLUMNS
See Also:
...
public void removeColumnsWidth([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html) value)
getColumnsWidth
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Integer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Integer.html)> getColumnsWidth([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setContext
...
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html)> getCustomColumnElements([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setShowColumns
...
public void removeShowColumns([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element,
 [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) value)
getShowColumns
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html)> getShowColumns([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
setShowContext
...
isShowContext
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowContext([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
...
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html)> getShowCustomColumns([Element](../../uml2/ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h3>SHOWCOLUMNS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">SHOWCOLUMNS</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
