# JAVA OPENAPI: XLSXLimitedBufferedWriter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/ooxml/XLSXLimitedBufferedWriter.html
- source_path: `com/nomagic/magicreport/engine/ooxml/XLSXLimitedBufferedWriter.html`
- source_sha256: `782ee7fdd178f2eceaa0acced0b89f394ecbe2aa5b9e8509da3bd0f08ba29a1e`
- captured_utc: `2026-07-14T16:46:12.310965+00:00`
...
## Class XLSXLimitedBufferedWriter
...
com.nomagic.magicreport.engine.ooxml.XLSXLimitedBufferedWriter
...
@OpenApiAllpublic classXLSXLimitedBufferedWriter
...
Constructor
Description
`[XLSXLimitedBufferedWriter](#%3Cinit%3E(java.io.Writer,com.nomagic.magicreport.engine.velocity.XLSXEngine))([Writer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html) out,
 [XLSXEngine](../velocity/XLSXEngine.html) engine)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
XLSXLimitedBufferedWriter
public XLSXLimitedBufferedWriter([Writer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html) out,
 [XLSXEngine](../velocity/XLSXEngine.html) engine)
 ============ METHOD DETAIL ========== 
Method Details
write
...
<h1 class="title" title="Class XLSXLimitedBufferedWriter">Class XLSXLimitedBufferedWriter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.engine.ooxml.XLSXLimitedBufferedWriter</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">XLSXLimitedBufferedWriter</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.io.Writer,com.nomagic.magicreport.engine.velocity.XLSXEngine)">XLSXLimitedBufferedWriter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html" title="class or interface in java.io">Writer</a> out,
 <a href="../velocity/XLSXEngine.html" title="class in com.nomagic.magicreport.engine.velocity">XLSXEngine</a> engine)</code></div>
...
<li>
<section class="detail" id="&lt;init&gt;(java.io.Writer,com.nomagic.magicreport.engine.velocity.XLSXEngine)">
<h3>XLSXLimitedBufferedWriter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">XLSXLimitedBufferedWriter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html" title="class or interface in java.io">Writer</a> out,
 <a href="../velocity/XLSXEngine.html" title="class in com.nomagic.magicreport.engine.velocity">XLSXEngine</a> engine)</span></div>
</section>
</li>
</ul>
</section>
