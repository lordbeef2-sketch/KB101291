# JAVA OPENAPI: DOCXEngine.NumberingUpdateProcess (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/velocity/DOCXEngine.NumberingUpdateProcess.html
- source_path: `com/nomagic/magicreport/engine/velocity/DOCXEngine.NumberingUpdateProcess.html`
- source_sha256: `f1c2f6535ed1893477e2aa7a85cd2491b1b8645e15d3a34b1f4de7167c33527b`
- captured_utc: `2026-07-14T16:46:13.070976+00:00`
...
## Class DOCXEngine.NumberingUpdateProcess
...
com.nomagic.magicreport.engine.velocity.DOCXEngine.NumberingUpdateProcess
...
public static classDOCXEngine.NumberingUpdateProcess
...
Constructor
Description
`[NumberingUpdateProcess](#%3Cinit%3E(com.nomagic.magicreport.engine.ooxml.child.docx.DocumentInfo,com.nomagic.magicreport.engine.velocity.DOCXEngine))([DocumentInfo](../ooxml/child/docx/DocumentInfo.html) documentInfo,
...
`int`
`[getAbstractNumId](#getAbstractNumId())()`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
NumberingUpdateProcess
public NumberingUpdateProcess([DocumentInfo](../ooxml/child/docx/DocumentInfo.html) documentInfo,
 [DOCXEngine](DOCXEngine.html) engine)
 ============ METHOD DETAIL ========== 
Method Details
startElement
...
<h1 class="title" title="Class DOCXEngine.NumberingUpdateProcess">Class DOCXEngine.NumberingUpdateProcess</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.engine.velocity.DOCXEngine.NumberingUpdateProcess</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">DOCXEngine.NumberingUpdateProcess</span>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.magicreport.engine.ooxml.child.docx.DocumentInfo,com.nomagic.magicreport.engine.velocity.DOCXEngine)">NumberingUpdateProcess</a><wbr/>(<a href="../ooxml/child/docx/DocumentInfo.html" title="class in com.nomagic.magicreport.engine.ooxml.child.docx">DocumentInfo</a> documentInfo,
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getAbstractNumId()">getAbstractNumId</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Return abstractNumId.</div>
</div>
...
<div class="block">Get content of numbering</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getNumId()">getNumId</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Return numId.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<h3>NumberingUpdateProcess</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">NumberingUpdateProcess</span><wbr/><span class="parameters">(<a href="../ooxml/child/docx/DocumentInfo.html" title="class in com.nomagic.magicreport.engine.ooxml.child.docx">DocumentInfo</a> documentInfo,
...
<li>
<section class="detail" id="getAbstractNumId()">
<h3>getAbstractNumId</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">int</span> <span class="element-name">getAbstractNumId</span>()</div>
<div class="block">Return abstractNumId.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>int abstractNum id</dd>
</dl>
</section>
</li>
<li>
