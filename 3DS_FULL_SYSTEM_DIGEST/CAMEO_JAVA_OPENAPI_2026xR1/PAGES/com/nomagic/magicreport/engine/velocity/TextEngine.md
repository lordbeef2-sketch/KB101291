# JAVA OPENAPI: TextEngine (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/velocity/TextEngine.html
- source_path: `com/nomagic/magicreport/engine/velocity/TextEngine.html`
- source_sha256: `a4991b84913e5c645c146676f38415da35cd535356b19471f67cd60d4ab4872c`
- captured_utc: `2026-07-14T16:46:13.431979+00:00`
...
@OpenApiAllpublic classTextEngine
...
Perform a pre-processing before evaluate template. This method do nothing. The process will be pass directly
 to Velocity.
Overrides:
...
public void evaluate([Template](../../Template.html) template)
 throws [TemplateException](../../TemplateException.html)
Merge a template with current context and rendered stream into the writer. Overwrite default process so this
 engine is pure velocity processing.
Specified by:
...
<h1 class="title" title="Class TextEngine">Class TextEngine</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.engine.velocity.TextEngine</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TextEngine</span>
<span class="extends-implements">extends <a href="DefaultTemplateEngine.html" title="class in com.nomagic.magicreport.engine.velocity">DefaultTemplateEngine</a></span></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">TextEngine</a>()</code></div>
...
<h3>TextEngine</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TextEngine</span>()</div>
<div class="block">Create instance of engine.</div>
</section>
</li>
</ul>
...
<div class="block">Perform a pre-processing before evaluate template. This method do nothing. The process will be pass directly
 to Velocity.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">evaluate</span><wbr/><span class="parameters">(<a href="../../Template.html" title="class in com.nomagic.magicreport">Template</a> template)</span>
              throws <span class="exceptions"><a href="../../TemplateException.html" title="class in com.nomagic.magicreport">TemplateException</a></span></div>
<div class="block">Merge a template with current context and rendered stream into the writer. Overwrite default process so this
 engine is pure velocity processing.</div>
<dl class="notes">
<dt>Specified by:</dt>
