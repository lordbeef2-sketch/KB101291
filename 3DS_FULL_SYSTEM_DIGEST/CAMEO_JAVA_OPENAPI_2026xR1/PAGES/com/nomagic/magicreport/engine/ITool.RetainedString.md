# JAVA OPENAPI: ITool.RetainedString (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/engine/ITool.RetainedString.html
- source_path: `com/nomagic/magicreport/engine/ITool.RetainedString.html`
- source_sha256: `475ef595b7377d207f00a0adc54ba8b19fa751a5360652effb6c9293fb8c2311`
- captured_utc: `2026-07-14T16:46:11.972961+00:00`
...
@OpenApiAllpublic static classITool.RetainedString
...
Direct command [`IFormatter`](../format/IFormatter.html) to keep the referenced String format. The
 [`IFormatter`](../format/IFormatter.html) and other
 [`IReferenceInsertionHandler`](IReferenceInsertionHandler.html) should maintain String directed by this
 class.

Since:
Feb 18, 2008
See Also:
[Serialized Form](../../../../serialized-form.html#com.nomagic.magicreport.engine.ITool.RetainedString)
...
Constructor
Description
`[RetainedString](#%3Cinit%3E(java.lang.CharSequence))([CharSequence](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/CharSequence.html) charSequence)`
...
Constructor Details
RetainedString
public RetainedString([CharSequence](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/CharSequence.html) charSequence)
Constructs a retained string that contains the same characters as the specified CharSequence.
Parameters:
...
Compares this RetainedString to the specified object. The result is `true` if and only if the
 argument is not `null` and is a `RetainedString` object that represents the same sequence of
...
Returns:
`true` if the given object represents a `RetainedString` equivalent to this
 RetainedString, `false` otherwise
hashCode
public int hashCode()
Returns a hash code for this RetainedString.
Overrides:
...
<h1 class="title" title="Class ITool.RetainedString">Class ITool.RetainedString</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance">com.nomagic.magicreport.engine.ITool.RetainedString</div>
</div>
...
<dd><code><a href="ITool.html" title="interface in com.nomagic.magicreport.engine">ITool</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public static class </span><span class="element-name type-name-label">ITool.RetainedString</span>
...
<div class="block">Direct command <a href="../format/IFormatter.html" title="interface in com.nomagic.magicreport.format"><code>IFormatter</code></a> to keep the referenced String format. The
 <a href="../format/IFormatter.html" title="interface in com.nomagic.magicreport.format"><code>IFormatter</code></a> and other
 <a href="IReferenceInsertionHandler.html" title="interface in com.nomagic.magicreport.engine"><code>IReferenceInsertionHandler</code></a> should maintain String directed by this
 class.</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Feb 18, 2008</dd>
...
<dd>
<ul class="tag-list">
<li><a href="../../../../serialized-form.html#com.nomagic.magicreport.engine.ITool.RetainedString">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.CharSequence)">RetainedString</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/CharSequence.html" title="class or interface in java.lang">CharSequence</a> charSequence)</code></div>
...
<div class="block">Compares this RetainedString to the specified object.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns a hash code for this RetainedString.</div>
</div>
...
<h3>RetainedString</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RetainedString</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/CharSequence.html" title="class or interface in java.lang">CharSequence</a> charSequence)</span></div>
<div class="block">Constructs a retained string that contains the same characters as the specified CharSequence.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="block">Compares this RetainedString to the specified object. The result is <code>true</code> if and only if the
 argument is not <code>null</code> and is a <code>RetainedString</code> object that represents the same sequence of
 characters as this object.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html#equals(java.lang.Object)" title="class or interface in java.lang">equals</a></code> in class <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></code></dd>
<dt>Parameters:</dt>
<dd><code>anObject</code> - The object to compare this <code>RetainedString</code> against</dd>
<dt>Returns:</dt>
<dd><code>true</code> if the given object represents a <code>RetainedString</code> equivalent to this
         RetainedString, <code>false</code> otherwise</dd>
</dl>
</section>
</li>
<li>
