# JAVA OPENAPI: RTFFormatter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/RTFFormatter.html
- source_path: `com/nomagic/magicreport/format/RTFFormatter.html`
- source_sha256: `ba0112f6e0373bf8044aa5f4457701126dd894fca0d1e8a9455aa0c1d203a772`
- captured_utc: `2026-07-14T16:46:13.858985+00:00`
...
@OpenApiAllpublic classRTFFormatter
...
`static final float`
`[MAX_HEIGHT_IN_PIXELS](#MAX_HEIGHT_IN_PIXELS)`
...
Constructor
Description
`[RTFFormatter](#%3Cinit%3E(java.util.Properties))([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)`
...
Create a RTF bookmark string from given [`Bookmark`](../Bookmark.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImage](#createImage(com.nomagic.magicreport.Image))([Image](../Image.html) image)`
Create a RTF image string from given [`Image`](../Image.html) object.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImage](#createImage(com.nomagic.magicreport.Image,int,int,int))([Image](../Image.html) image,
 int width,
 int height,
 int flag)`
Create a RTF image string from given [`Image`](../Image.html) object.
`long`
`[createImageBody](#createImageBody(com.nomagic.magicreport.Image,java.io.Writer))([Image](../Image.html) image,
 [Writer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html) writer)`
Create image body to writer.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImageFooter](#createImageFooter(com.nomagic.magicreport.Image,int,int,int))([Image](../Image.html) image,
 int width,
 int height,
 int flag)`
Create an image footer.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImageHeader](#createImageHeader(com.nomagic.magicreport.Image,int,int,int))([Image](../Image.html) image,
 int width,
 int height,
 int flag)`
Create an image header.
`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImageProperty](#createImageProperty(float,float,int))(float w,
 float h,
 int flag)`

`protected [ITool.RetainedString](../engine/ITool.RetainedString.html)`
`[createImageProperty](#createImageProperty(com.nomagic.magicreport.Image,float,float,int))([Image](../Image.html) image,
 float w,
 float h,
 int flag)`
...
Create a RTF link string from given [`Link`](../Link.html) object.
...
`[getImageFormat](#getImageFormat(com.nomagic.magicreport.Image))([Image](../Image.html) image)`
Return the image format.
`float[]`
`[getPageSize](#getPageSize())()`
Calculation for total paper width and total paper height after minus margin of page in twips.
`protected boolean`
`[isLargeImage](#isLargeImage(com.nomagic.magicreport.Image))([Image](../Image.html) image)`
...
The number of hundredths of millimeters (0.01 mm) in an inch.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.HMM_PER_INCH)
TWIPS_PER_INCH
public static final float TWIPS_PER_INCH
The number of twips in an inch.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.TWIPS_PER_INCH)
MAX_WIDTH_IN_PIXELS
public static final float MAX_WIDTH_IN_PIXELS
The number of appropriate max image width in pixels.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.MAX_WIDTH_IN_PIXELS)
MAX_HEIGHT_IN_PIXELS
public static final float MAX_HEIGHT_IN_PIXELS
The number of appropriate max image height in pixels.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.MAX_HEIGHT_IN_PIXELS)
LINKED_PICTURE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) LINKED_PICTURE
The image property indicates that image will be temporary stored as a link during *process* and it
 will be replaced with binary data in *post-process*.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.LINKED_PICTURE)
WMF_PLACEABLE_HEADER_SIZE
protected static final int WMF_PLACEABLE_HEADER_SIZE
The number of WMF header length.
See Also:
[Constant Field Values](../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.WMF_PLACEABLE_HEADER_SIZE)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
RTFFormatter
public RTFFormatter([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)
Create a RTF formatter with with specific properties.
Parameters:
...
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)` - when IO error occurs
createImageHeader
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createImageHeader([Image](../Image.html) image,
 int width,
 int height,
 int flag)
Create an image header.
...
image header
See Also:
[`createImageProperty(float, float, int)`](#createImageProperty(float,float,int))
createImageBody
public long createImageBody([Image](../Image.html) image,
 [Writer](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Writer.html) writer)
 throws [IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)
Create image body to writer.
Parameters:
...
Throws:
`[IOException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html)` - if exception occurs
createImageFooter
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createImageFooter([Image](../Image.html) image,
 int width,
 int height,
 int flag)
Create an image footer.
...
[`createImageProperty(float, float, int)`](#createImageProperty(float,float,int))
createImageProperty
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createImageProperty(float w,
 float h,
 int flag)
createImageProperty
protected [ITool.RetainedString](../engine/ITool.RetainedString.html) createImageProperty([Image](../Image.html) image,
 float w,
 float h,
 int flag)
Calculate Property of image. `picscalex - scale in x
 picscaley - scale in y
 picw - Width of image(0.01 mm)
 pich - Height of image(0.01 mm)
 picwgoal - Width of image(twips)
 pichgoal - Height of image(twips)` `Units Used
 ----------
 1 Twip = 1/20 Point
 1 Point = 1/72 Inch
 1 Twip = 1/1440 Inch
...
getImageFormat
protected [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getImageFormat([Image](../Image.html) image)
Return the image format.
Parameters:
`image` - the Image
Returns:
...
isLargeImage
protected boolean isLargeImage([Image](../Image.html) image)
Compare the width and height of the image and paper if the image is greater than paper, it's considered as
 large image.
Parameters:
...
<h1 class="title" title="Class RTFFormatter">Class RTFFormatter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.RTFFormatter</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">RTFFormatter</span>
...
<div class="block">This class provides implementation for RTF format output. Extend from DefaultFormatter, this class provide
 additional support for BufferedImage, and RTF escaped characters.</div>
<dl class="notes">
<dt>Since:</dt>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#HMM_PER_INCH">HMM_PER_INCH</a></code></div>
<div class="col-last even-row-color">
<div class="block">The number of hundredths of millimeters (0.01 mm) in an inch.</div>
</div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#LINKED_PICTURE">LINKED_PICTURE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">The image property indicates that image will be temporary stored as a link during <em>process</em> and it
 will be replaced with binary data in <em>post-process</em>.</div>
</div>
<div class="col-first even-row-color"><code>static final float</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#MAX_HEIGHT_IN_PIXELS">MAX_HEIGHT_IN_PIXELS</a></code></div>
<div class="col-last even-row-color">
<div class="block">The number of appropriate max image height in pixels.</div>
</div>
<div class="col-first odd-row-color"><code>static final float</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#MAX_WIDTH_IN_PIXELS">MAX_WIDTH_IN_PIXELS</a></code></div>
<div class="col-last odd-row-color">
<div class="block">The number of appropriate max image width in pixels.</div>
</div>
<div class="col-first even-row-color"><code>static final float</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#TWIPS_PER_INCH">TWIPS_PER_INCH</a></code></div>
<div class="col-last even-row-color">
<div class="block">The number of twips in an inch.</div>
</div>
<div class="col-first odd-row-color"><code>protected static final int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#WMF_PLACEABLE_HEADER_SIZE">WMF_PLACEABLE_HEADER_SIZE</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.Properties)">RTFFormatter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</code></div>
<div class="col-last even-row-color">
<div class="block">Create a RTF formatter with with specific properties.</div>
</div>
</div>
</section>
</li>
...
<div class="block">Create a RTF bookmark string from given <a href="../Bookmark.html" title="class in com.nomagic.magicreport"><code>Bookmark</code></a> object.</div>
</div>
...
<div class="block">Create a RTF image string from given <a href="../Image.html" title="class in com.nomagic.magicreport"><code>Image</code></a> object.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImage(com.nomagic.magicreport.Image,int,int,int)">createImage</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 int width,
 int height,
 int flag)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImageBody(com.nomagic.magicreport.Image,java.io.Writer)">createImageBody</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create image body to writer.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImageFooter(com.nomagic.magicreport.Image,int,int,int)">createImageFooter</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 int width,
 int height,
 int flag)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create an image footer.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImageHeader(com.nomagic.magicreport.Image,int,int,int)">createImageHeader</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 int width,
 int height,
 int flag)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create an image header.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImageProperty(float,float,int)">createImageProperty</a><wbr/>(float w,
 float h,
 int flag)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createImageProperty(com.nomagic.magicreport.Image,float,float,int)">createImageProperty</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 float w,
 float h,
 int flag)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Calculate Property of image.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected <a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create a RTF link string from given <a href="../Link.html" title="class in com.nomagic.magicreport"><code>Link</code></a> object.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Convert an Object value into RTF format.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getImageFormat(com.nomagic.magicreport.Image)">getImageFormat</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Return the image format.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Calculation for total paper width and total paper height after minus margin of page in twips.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isLargeImage(com.nomagic.magicreport.Image)">isLargeImage</a><wbr/>(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Compare the width and height of the image and paper if the image is greater than paper, it's considered as
 large image.</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="HMM_PER_INCH">
<h3>HMM_PER_INCH</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">float</span> <span class="element-name">HMM_PER_INCH</span></div>
<div class="block">The number of hundredths of millimeters (0.01 mm) in an inch.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.HMM_PER_INCH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="TWIPS_PER_INCH">
<h3>TWIPS_PER_INCH</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">float</span> <span class="element-name">TWIPS_PER_INCH</span></div>
<div class="block">The number of twips in an inch.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.TWIPS_PER_INCH">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="MAX_WIDTH_IN_PIXELS">
<h3>MAX_WIDTH_IN_PIXELS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">float</span> <span class="element-name">MAX_WIDTH_IN_PIXELS</span></div>
<div class="block">The number of appropriate max image width in pixels.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.MAX_WIDTH_IN_PIXELS">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="MAX_HEIGHT_IN_PIXELS">
<h3>MAX_HEIGHT_IN_PIXELS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type">float</span> <span class="element-name">MAX_HEIGHT_IN_PIXELS</span></div>
<div class="block">The number of appropriate max image height in pixels.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.MAX_HEIGHT_IN_PIXELS">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="LINKED_PICTURE">
<h3>LINKED_PICTURE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">LINKED_PICTURE</span></div>
<div class="block">The image property indicates that image will be temporary stored as a link during <em>process</em> and it
 will be replaced with binary data in <em>post-process</em>.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.LINKED_PICTURE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="member-signature"><span class="modifiers">protected static final</span> <span class="return-type">int</span> <span class="element-name">WMF_PLACEABLE_HEADER_SIZE</span></div>
<div class="block">The number of WMF header length.</div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../../constant-values.html#com.nomagic.magicreport.format.RTFFormatter.WMF_PLACEABLE_HEADER_SIZE">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>RTFFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RTFFormatter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</span></div>
<div class="block">Create a RTF formatter with with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<dt>Returns:</dt>
<dd>The String in RTF image format.</dd>
<dt>Throws:</dt>
...
<li>
<section class="detail" id="createImage(com.nomagic.magicreport.Image,int,int,int)">
<h3>createImage</h3>
...
<li>
<section class="detail" id="createImageHeader(com.nomagic.magicreport.Image,int,int,int)">
<h3>createImageHeader</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createImageHeader</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 int width,
 int height,
 int flag)</span></div>
<div class="block">Create an image header.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>image</code> - Image object</dd>
<dd><code>width</code> - target image width</dd>
<dd><code>height</code> - target image height</dd>
<dd><code>flag</code> - target image flag</dd>
<dt>Returns:</dt>
<dd>image header</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#createImageProperty(float,float,int)"><code>createImageProperty(float, float, int)</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<li>
<section class="detail" id="createImageBody(com.nomagic.magicreport.Image,java.io.Writer)">
<h3>createImageBody</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">long</span> <span class="element-name">createImageBody</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>image</code> - an Image object</dd>
<dd><code>writer</code> - the writer</dd>
<dt>Returns:</dt>
<dd>total written characters</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - if exception occurs</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="createImageFooter(com.nomagic.magicreport.Image,int,int,int)">
<h3>createImageFooter</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createImageFooter</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 int width,
 int height,
 int flag)</span></div>
<div class="block">Create an image footer.</div>
...
<li>
<section class="detail" id="createImageProperty(float,float,int)">
<h3>createImageProperty</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createImageProperty</span><wbr/><span class="parameters">(float w,
 float h,
 int flag)</span></div>
</section>
</li>
<li>
<section class="detail" id="createImageProperty(com.nomagic.magicreport.Image,float,float,int)">
<h3>createImageProperty</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a href="../engine/ITool.RetainedString.html" title="class in com.nomagic.magicreport.engine">ITool.RetainedString</a></span> <span class="element-name">createImageProperty</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image,
 float w,
 float h,
 int flag)</span></div>
<div class="block">Calculate Property of image. <pre><code>
...
<dd><code>flag</code> - scaling image flag</dd>
<dt>Returns:</dt>
<dd>String property of image in rtf tag</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getImageFormat(com.nomagic.magicreport.Image)">
<h3>getImageFormat</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getImageFormat</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image)</span></div>
<div class="block">Return the image format.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="isLargeImage(com.nomagic.magicreport.Image)">
<h3>isLargeImage</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">boolean</span> <span class="element-name">isLargeImage</span><wbr/><span class="parameters">(<a href="../Image.html" title="class in com.nomagic.magicreport">Image</a> image)</span></div>
<div class="block">Compare the width and height of the image and paper if the image is greater than paper, it's considered as
 large image.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>image</code> - image want to compare with paper</dd>
<dt>Returns:</dt>
<dd>true if image is larger than paper size</dd>
</dl>
</section>
</li>
<li>
...
<dt>Returns:</dt>
<dd>The String in RTF bookmark format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
...
<dt>Returns:</dt>
<dd>The String in RTF link format.</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/IOException.html" title="class or interface in java.io">IOException</a></code> - when IO error occurs</dd>
</dl>
</section>
