# JAVA OPENAPI: TextFormatter (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/format/TextFormatter.html
- source_path: `com/nomagic/magicreport/format/TextFormatter.html`
- source_sha256: `faff3c17c0a9716017fd088185265c4311a0f2eb194966e73f5d4f058382b52d`
- captured_utc: `2026-07-14T16:46:13.979987+00:00`
...
com.nomagic.magicreport.format.TextFormatter

All Implemented Interfaces:
`[IFormatter](IFormatter.html)`

@OpenApiAllpublic classTextFormatter
extends [DefaultFormatter](DefaultFormatter.html)

This class provides implementation for text format output. Extend from DefaultFormatter, this class provide
...
Constructor
Description
`[TextFormatter](#%3Cinit%3E(java.util.Properties))([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)`
...
Constructor Details
TextFormatter
public TextFormatter([Properties](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html) properties)
Create a Text formatter with specific properties.
Parameters:
...
<h1 class="title" title="Class TextFormatter">Class TextFormatter</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.format.TextFormatter</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TextFormatter</span>
...
<div class="block">This class provides implementation for text format output. Extend from DefaultFormatter, this class provide
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.Properties)">TextFormatter</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</code></div>
<div class="col-last even-row-color">
<div class="block">Create a Text formatter with specific properties.</div>
</div>
</div>
</section>
</li>
...
<h3>TextFormatter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TextFormatter</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Properties.html" title="class or interface in java.util">Properties</a> properties)</span></div>
<div class="block">Create a Text formatter with specific properties.</div>
<dl class="notes">
<dt>Parameters:</dt>
