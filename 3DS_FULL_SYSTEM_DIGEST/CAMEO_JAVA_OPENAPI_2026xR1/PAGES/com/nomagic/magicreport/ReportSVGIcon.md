# JAVA OPENAPI: ReportSVGIcon (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/ReportSVGIcon.html
- source_path: `com/nomagic/magicreport/ReportSVGIcon.html`
- source_sha256: `c39558c0bdba5e365d292f5b825826874b4bb194a3525eea7ceeb39c11616893`
- captured_utc: `2026-07-14T16:46:11.493953+00:00`
...
@OpenApiAllpublic classReportSVGIcon
...
Sep 02, 2021
See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.magicreport.ReportSVGIcon)
...
Constructor
Description
`[ReportSVGIcon](#%3Cinit%3E(java.lang.String,javax.swing.Icon,java.lang.String,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
...
`[createSVGGraphics2D](#createSVGGraphics2D())()`
...
`[getSVGGraphics2D](#getSVGGraphics2D())()`
...
Constructor Details
ReportSVGIcon
public ReportSVGIcon([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) id,
 [Icon](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html) icon,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) imageFormat,
 boolean disposeAfterUse)
 ============ METHOD DETAIL ========== 
...
Returns:
getBufferedImage
public [BufferedImage](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/BufferedImage.html) getBufferedImage()
Create buffered image from icon.
Returns:
BufferedImage
clone
public [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) clone()
Description copied from class: `[Image](Image.html#clone())`
Creates and returns a copy of this object.
Overrides:
`[clone](Image.html#clone())` in class `[Image](Image.html)`
Returns:
...
<h1 class="title" title="Class ReportSVGIcon">Class ReportSVGIcon</h1>
</div>
...
<div class="inheritance">com.nomagic.magicreport.ReportSVGIcon</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ReportSVGIcon</span>
<span class="extends-implements">extends <a href="Image.html" title="class in com.nomagic.magicreport">Image</a></span></div>
<div class="block">A bean represent SVG icon.
 This class store original icon and SVGGraphics2D to create as svg</div>
<dl class="notes">
<dt>Since:</dt>
<dd>Sep 02, 2021</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.magicreport.ReportSVGIcon">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,javax.swing.Icon,java.lang.String,boolean)">ReportSVGIcon</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>protected org.apache.batik.svggen.SVGGraphics2D</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#createSVGGraphics2D()">createSVGGraphics2D</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create SVGGraphics2D</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getBufferedImage()">getBufferedImage</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Create buffered image from icon.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getSVGGraphics2D()">getSVGGraphics2D</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setSVGGraphics2D(org.apache.batik.svggen.SVGGraphics2D)">setSVGGraphics2D</a><wbr/>(org.apache.batik.svggen.SVGGraphics2D svgGraphics2D)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<h3>ReportSVGIcon</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ReportSVGIcon</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> id,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/javax/swing/Icon.html" title="class or interface in javax.swing">Icon</a> icon,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> imageFormat,
...
<ul class="member-list">
<li>
<section class="detail" id="getSVGGraphics2D()">
<h3>getSVGGraphics2D</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">org.apache.batik.svggen.SVGGraphics2D</span> <span class="element-name">getSVGGraphics2D</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setSVGGraphics2D(org.apache.batik.svggen.SVGGraphics2D)">
<h3>setSVGGraphics2D</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">void</span> <span class="element-name">setSVGGraphics2D</span><wbr/><span class="parameters">(org.apache.batik.svggen.SVGGraphics2D svgGraphics2D)</span></div>
</section>
</li>
<li>
...
<li>
<section class="detail" id="createSVGGraphics2D()">
<h3>createSVGGraphics2D</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="return-type">org.apache.batik.svggen.SVGGraphics2D</span> <span class="element-name">createSVGGraphics2D</span>()</div>
<div class="block">Create SVGGraphics2D</div>
<dl class="notes">
<dt>Returns:</dt>
</dl>
...
<li>
<section class="detail" id="getBufferedImage()">
<h3>getBufferedImage</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/image/BufferedImage.html" title="class or interface in java.awt.image">BufferedImage</a></span> <span class="element-name">getBufferedImage</span>()</div>
<div class="block">Create buffered image from icon.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>BufferedImage</dd>
...
<div class="block"><span class="description-from-type-label">Description copied from class: <code><a href="Image.html#clone()">Image</a></code></span></div>
<div class="block">Creates and returns a copy of this object.</div>
<dl class="notes">
<dt>Overrides:</dt>
<dd><code><a href="Image.html#clone()">clone</a></code> in class <code><a href="Image.html" title="class in com.nomagic.magicreport">Image</a></code></dd>
<dt>Returns:</dt>
