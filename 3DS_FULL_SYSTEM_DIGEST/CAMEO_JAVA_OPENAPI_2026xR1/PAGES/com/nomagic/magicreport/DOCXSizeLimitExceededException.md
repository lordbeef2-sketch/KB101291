# JAVA OPENAPI: DOCXSizeLimitExceededException (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/magicreport/DOCXSizeLimitExceededException.html
- source_path: `com/nomagic/magicreport/DOCXSizeLimitExceededException.html`
- source_sha256: `fa0bbfc0e7a22321869e9132acbe5cad6776d5904450bad95da619a80e79f3e6`
- captured_utc: `2026-07-14T16:46:11.316952+00:00`
...
## Class DOCXSizeLimitExceededException
...
[com.nomagic.magicreport.ReportSizeLimitExceededException](ReportSizeLimitExceededException.html)
com.nomagic.magicreport.DOCXSizeLimitExceededException

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`

@OpenApiAllpublic classDOCXSizeLimitExceededException
extends [ReportSizeLimitExceededException](ReportSizeLimitExceededException.html)

See Also:
[Serialized Form](../../../serialized-form.html#com.nomagic.magicreport.DOCXSizeLimitExceededException)
...
Constructor
Description
`[DOCXSizeLimitExceededException](#%3Cinit%3E())()`

`[DOCXSizeLimitExceededException](#%3Cinit%3E(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)`

`[DOCXSizeLimitExceededException](#%3Cinit%3E(java.lang.String,java.lang.Throwable))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)`

`[DOCXSizeLimitExceededException](#%3Cinit%3E(java.lang.String,java.lang.Throwable,boolean,boolean))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause,
 boolean enableSuppression,
 boolean writableStackTrace)`

`[DOCXSizeLimitExceededException](#%3Cinit%3E(java.lang.Throwable))([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
DOCXSizeLimitExceededException
public DOCXSizeLimitExceededException()
DOCXSizeLimitExceededException
public DOCXSizeLimitExceededException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message,
 [Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause,
 boolean enableSuppression,
 boolean writableStackTrace)
DOCXSizeLimitExceededException
...
public DOCXSizeLimitExceededException([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) message)
DOCXSizeLimitExceededException
public DOCXSizeLimitExceededException([Throwable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html) cause)
...
<h1 class="title" title="Class DOCXSizeLimitExceededException">Class DOCXSizeLimitExceededException</h1>
</div>
...
<div class="inheritance"><a href="ReportSizeLimitExceededException.html" title="class in com.nomagic.magicreport">com.nomagic.magicreport.ReportSizeLimitExceededException</a>
<div class="inheritance">com.nomagic.magicreport.DOCXSizeLimitExceededException</div>
</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">DOCXSizeLimitExceededException</span>
<span class="extends-implements">extends <a href="ReportSizeLimitExceededException.html" title="class in com.nomagic.magicreport">ReportSizeLimitExceededException</a></span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../../serialized-form.html#com.nomagic.magicreport.DOCXSizeLimitExceededException">Serialized Form</a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">DOCXSizeLimitExceededException</a>()</code></div>
<div class="col-last even-row-color"> </div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String)">DOCXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message)</code></div>
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.String,java.lang.Throwable)">DOCXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
...
<div class="col-last odd-row-color"> </div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.lang.Throwable)">DOCXSizeLimitExceededException</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html" title="class or interface in java.lang">Throwable</a> cause)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<h3>DOCXSizeLimitExceededException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DOCXSizeLimitExceededException</span>()</div>
</section>
</li>
<li>
<section class="detail" id="&lt;init&gt;(java.lang.String,java.lang.Throwable,boolean,boolean)">
<h3>DOCXSizeLimitExceededException</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">DOCXSizeLimitExceededException</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> message,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Throwable.html" title="class or interface in java.lang">Throwable</a> cause,
 boolean enableSuppression,
