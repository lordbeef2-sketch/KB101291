# JAVA OPENAPI: MagicDrawProfile.GroupedStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.GroupedStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.GroupedStereotype.html`
- source_sha256: `951ffa5aa1739ce0010df91fa06288e1f027af919b239a4d37be61935eb40f6d`
- captured_utc: `2026-07-14T16:46:18.077042+00:00`
...
public static classMagicDrawProfile.GroupedStereotype
...
Description
`protected`
`[GroupedStereotype](#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile))([MagicDrawProfile](MagicDrawProfile.html) profile)`
 ========== METHOD SUMMARY =========== 
Method Summary
...
`void`
`[clearGroup](#clearGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`

`[MagicDrawProfile.CustomizationGroupNamesEnum](MagicDrawProfile.CustomizationGroupNamesEnum.html)`
`[getGroup](#getGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](ext/magicdraw/classes/mdkernel/Element.html) element)`
...
`void`
`[setGroup](#setGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.CustomizationGroupNamesEnum))([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [MagicDrawProfile.CustomizationGroupNamesEnum](MagicDrawProfile.CustomizationGroupNamesEnum.html) value)`
...
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.GroupedStereotype.STEREOTYPE_NAME)
GROUP
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) GROUP
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.GroupedStereotype.GROUP)
 ========= CONSTRUCTOR DETAIL ======== 
Constructor Details
GroupedStereotype
protected GroupedStereotype([MagicDrawProfile](MagicDrawProfile.html) profile)
 ============ METHOD DETAIL ========== 
Method Details
getStereotype
...
stereotype
getGroupProperty
@CheckForNullpublic [Property](ext/magicdraw/classes/mdkernel/Property.html) getGroupProperty()
setGroup
public void setGroup([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 @CheckForNull
 [MagicDrawProfile.CustomizationGroupNamesEnum](MagicDrawProfile.CustomizationGroupNamesEnum.html) value)
clearGroup
public void clearGroup([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
getGroup
@CheckForNullpublic [MagicDrawProfile.CustomizationGroupNamesEnum](MagicDrawProfile.CustomizationGroupNamesEnum.html) getGroup([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h1 class="title" title="Class MagicDrawProfile.GroupedStereotype">Class MagicDrawProfile.GroupedStereotype</h1>
</div>
...
<div class="inheritance">com.nomagic.uml2.MagicDrawProfile.GroupedStereotype</div>
</div>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public static class </span><span class="element-name type-name-label">MagicDrawProfile.GroupedStereotype</span>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#GROUP">GROUP</a></code></div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.nomagic.uml2.MagicDrawProfile)">GroupedStereotype</a><wbr/>(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</code></div>
<div class="col-last even-row-color"> </div>
</div>
</section>
</li>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#clearGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">clearGroup</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MagicDrawProfile.CustomizationGroupNamesEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.CustomizationGroupNamesEnum</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">getGroup</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#getGroupProperty()">getGroupProperty</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.CustomizationGroupNamesEnum)">setGroup</a><wbr/>(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 <a href="MagicDrawProfile.CustomizationGroupNamesEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.CustomizationGroupNamesEnum</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"> </div>
</div>
</div>
</div>
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.GroupedStereotype.STEREOTYPE_NAME">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<dd>
<ul class="tag-list">
<li><a href="../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.GroupedStereotype.GROUP">Constant Field Values</a></li>
</ul>
</dd>
</dl>
</section>
...
<h3>GroupedStereotype</h3>
<div class="member-signature"><span class="modifiers">protected</span> <span class="element-name">GroupedStereotype</span><wbr/><span class="parameters">(<a href="MagicDrawProfile.html" title="class in com.nomagic.uml2">MagicDrawProfile</a> profile)</span></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="getGroupProperty()">
<h3>getGroupProperty</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="ext/magicdraw/classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getGroupProperty</span>()</div>
</section>
</li>
<li>
<section class="detail" id="setGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element,com.nomagic.uml2.MagicDrawProfile.CustomizationGroupNamesEnum)">
<h3>setGroup</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setGroup</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element,
 @CheckForNull
 <a href="MagicDrawProfile.CustomizationGroupNamesEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.CustomizationGroupNamesEnum</a> value)</span></div>
</section>
</li>
<li>
<section class="detail" id="clearGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>clearGroup</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">clearGroup</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
<section class="detail" id="getGroup(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>getGroup</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="MagicDrawProfile.CustomizationGroupNamesEnum.html" title="enum class in com.nomagic.uml2">MagicDrawProfile.CustomizationGroupNamesEnum</a></span> <span class="element-name">getGroup</span><wbr/><span class="parameters">(<a href="ext/magicdraw/classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> element)</span></div>
</section>
</li>
<li>
