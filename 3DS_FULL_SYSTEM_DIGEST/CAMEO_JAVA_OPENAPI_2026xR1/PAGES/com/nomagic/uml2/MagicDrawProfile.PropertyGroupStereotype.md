# JAVA OPENAPI: MagicDrawProfile.PropertyGroupStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.PropertyGroupStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.PropertyGroupStereotype.html`
- source_sha256: `ce86a8e320f93c9ab4c5071f8a58dfaeb176f2a5b002e705625469918aff0452`
- captured_utc: `2026-07-14T16:46:19.628060+00:00`
...
COLUMNS
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) COLUMNS
p {padding:0px; margin:0px;}
Stores the specified table columns for showing the values of a multivalued property in the element’s Specification window, for example, **ownedOperation** in Class.
...
FILTER
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) FILTER
p {padding:0px; margin:0px;}
Stores the element types (UML metaclasses and custom stereotypes) that will be displayed as property values.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINCOMPARTMENTEDIT
p {padding:0px; margin:0px;}
This property allows for displaying the element properties in the **Compartment Edit** dialog > the **Element Properties** tab and in a note on a diagram either within the property group/subgroup or without it. If the value is *true*, the property name will be displayed as follows: *<property_group_name>::<property_name>*. If the value is *false*, the property name will be displayed as follows: *<property_name>*.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINDEPENDENCYMATRIX
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINELEMENTSPECIFICATION
p {padding:0px; margin:0px;}
If the value is *true*, the property group/ subgroup will be visible in the element’s Specification window.
See Also:
...
SHOWGROUPINGOTO
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINGOTO
p {padding:0px; margin:0px;}
If the value is *true*, the property group/ subgroup will be visible in element’s shortcut menu as a submenu under the **Go To** menu.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINQUICKPROPERTIES
p {padding:0px; margin:0px;}
If the value is *true*, the property group/ subgroup will be visible in the element’s **Properties** panel.
See Also:
...
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) SHOWGROUPINRELATIONMAP
p {padding:0px; margin:0px;}
If the value is *true* , the property group/ subgroup will be visible in the **Criterion Editor** dialog, when you create or edit a Relation Map diagram.
See Also:
...
TITLEBARDESCRIPTION
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) TITLEBARDESCRIPTION
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.PropertyGroupStereotype.TITLEBARDESCRIPTION)
TITLEBARNAME
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) TITLEBARNAME
See Also:
[Constant Field Values](../../../constant-values.html#com.nomagic.uml2.MagicDrawProfile.PropertyGroupStereotype.TITLEBARNAME)
USEASNODE
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) USEASNODE
p {padding:0px; margin:0px;}
If the value is *true*, the property group will be displayed in a separate tab in the element’s Specification window and/ or **Properties** panel.
...
public void removeColumns([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)
getColumns
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getColumns([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setFilter
...
public void removeFilter([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [Element](ext/magicdraw/classes/mdkernel/Element.html) value)
getFilter
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](ext/magicdraw/classes/mdkernel/Element.html)> getFilter([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setProperties
...
public void removeProperties([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)
getProperties
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)> getProperties([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInCompartmentEdit([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInDependencyMatrix([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInElementSpecification([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setShowGroupInGoTo
...
isShowGroupInGoTo
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInGoTo([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInQuickProperties([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isShowGroupInRelationMap([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
...
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getTitleBarDescription([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setTitleBarName
...
getTitleBarName
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getTitleBarName([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setUseAsNode
...
isUseAsNode
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isUseAsNode([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h3>COLUMNS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">COLUMNS</span></div>
...
<h3>FILTER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">FILTER</span></div>
<div class="block"><html>
<head>
<style>
 p {padding:0px; margin:0px;}
...
<h3>USEASNODE</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">USEASNODE</span></div>
<div class="block"><html>
<head>
<style>
 p {padding:0px; margin:0px;}
