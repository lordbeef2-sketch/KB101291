# JAVA OPENAPI: Interval (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Interval.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Interval.html`
- source_sha256: `492a838f564d4659089a6d5754921e09bf20e955cd758111fd6db91f794be4da`
- captured_utc: `2026-07-14T16:46:31.382218+00:00`
...
`[DurationInterval](DurationInterval.html)`, `[TimeInterval](TimeInterval.html)`

public interfaceIntervalextends [ValueSpecification](../../classes/mdkernel/ValueSpecification.html)
...
The following features are supported:
 [`*Min*`](#getMin())
[`*interval Constraint Of Specification*`](#get_intervalConstraintOfSpecification())
[`*Max*`](#getMax())

See Also:
[`UMLPackage.getInterval()`](../../metadata/UMLPackage.html#getInterval())
Model:
...
Method
Description
`[IntervalConstraint](IntervalConstraint.html)`
`[get_intervalConstraintOfSpecification](#get_intervalConstraintOfSpecification())()`
Returns the value of the '***interval Constraint Of Specification***' container reference.
...
`void`
`[set_intervalConstraintOfSpecification](#set_intervalConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.IntervalConstraint))([IntervalConstraint](IntervalConstraint.html) value)`
Sets the value of the '[`*interval Constraint
 Of Specification*`](#get_intervalConstraintOfSpecification())' container reference.
`void`
`[setMax](#setMax(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
Sets the value of the '[`*Max*`](#getMax())' reference.
`void`
`[setMin](#setMin(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
...
Method Details
getMin
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getMin()
Returns the value of the '***Min***' reference.
 It is bidirectional and its opposite is '[`*interval Of Min*`](../../classes/mdkernel/ValueSpecification.html#get_intervalOfMin())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMin(ValueSpecification)`](#setMin(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getInterval_Min()`](../../metadata/UMLPackage.html#getInterval_Min())
[`ValueSpecification.get_intervalOfMin()`](../../classes/mdkernel/ValueSpecification.html#get_intervalOfMin())
Model:
opposite="_intervalOfMin" required="true" ordered="false"
Generated:
setMin
...
Generated:
getMax
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getMax()
Returns the value of the '***Max***' reference.
 It is bidirectional and its opposite is '[`*interval Of Max*`](../../classes/mdkernel/ValueSpecification.html#get_intervalOfMax())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setMax(ValueSpecification)`](#setMax(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getInterval_Max()`](../../metadata/UMLPackage.html#getInterval_Max())
[`ValueSpecification.get_intervalOfMax()`](../../classes/mdkernel/ValueSpecification.html#get_intervalOfMax())
Model:
opposite="_intervalOfMax" required="true" ordered="false"
Generated:
setMax
...
[`getMax()`](#getMax())
Generated:
get_intervalConstraintOfSpecification
@CheckForNull[IntervalConstraint](IntervalConstraint.html) get_intervalConstraintOfSpecification()
Returns the value of the '***interval Constraint Of Specification***' container reference.
 It is bidirectional and its opposite is
 '[`*Specification*`](IntervalConstraint.html#getSpecification())'.
 begin-user-doc 
If the meaning of the '*interval Constraint Of Specification*' reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*interval Constraint Of Specification*' container reference.
See Also:
[`set_intervalConstraintOfSpecification(IntervalConstraint)`](#set_intervalConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.IntervalConstraint))
[`UMLPackage.getInterval__intervalConstraintOfSpecification()`](../../metadata/UMLPackage.html#getInterval__intervalConstraintOfSpecification())
[`IntervalConstraint.getSpecification()`](IntervalConstraint.html#getSpecification())
Model:
opposite="specification" volatile="true" ordered="false"
Generated:
set_intervalConstraintOfSpecification
void set_intervalConstraintOfSpecification(@CheckForNull
 [IntervalConstraint](IntervalConstraint.html) value)
Sets the value of the '[`*interval Constraint
 Of Specification*`](#get_intervalConstraintOfSpecification())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*interval Constraint Of Specification*' container reference.
See Also:
[`get_intervalConstraintOfSpecification()`](#get_intervalConstraintOfSpecification())
Generated:
...
<h1 class="title" title="Interface Interval">Interface Interval</h1>
</div>
...
<dd><code><a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a></code>, <code><a href="TimeInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeInterval</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Interval</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getMin()"><code><em>Min</em></code></a></li>
<li><a href="#get_intervalConstraintOfSpecification()"><code><em>interval Constraint Of Specification</em></code></a></li>
<li><a href="#getMax()"><code><em>Max</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getInterval()"><code>UMLPackage.getInterval()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="IntervalConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">IntervalConstraint</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_intervalConstraintOfSpecification()">get_intervalConstraintOfSpecification</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>interval Constraint Of Specification</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_intervalConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.IntervalConstraint)">set_intervalConstraintOfSpecification</a><wbr/>(<a href="IntervalConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">IntervalConstraint</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_intervalConstraintOfSpecification()"><code><em>interval Constraint
 Of Specification</em></code></a>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMax(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setMax</a><wbr/>(<a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getMin</span>()</div>
<div class="block">Returns the value of the '<em><b>Min</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/ValueSpecification.html#get_intervalOfMin()"><code><em>interval Of Min</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Refers to the ValueSpecification denoting the minimum value of the range.
...
<li><a href="#setMin(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setMin(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInterval_Min()"><code>UMLPackage.getInterval_Min()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_intervalOfMin()"><code>ValueSpecification.get_intervalOfMin()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_intervalOfMin" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMin(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setMin</h3>
...
<h3>getMax</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getMax</span>()</div>
<div class="block">Returns the value of the '<em><b>Max</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/ValueSpecification.html#get_intervalOfMax()"><code><em>interval Of Max</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Refers to the ValueSpecification denoting the maximum value of the range.
...
<dd>
<ul class="tag-list-long">
<li><a href="#setMax(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setMax(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInterval_Max()"><code>UMLPackage.getInterval_Max()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_intervalOfMax()"><code>ValueSpecification.get_intervalOfMax()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_intervalOfMax" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMax(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setMax</h3>
...
<li>
<section class="detail" id="get_intervalConstraintOfSpecification()">
<h3>get_intervalConstraintOfSpecification</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="IntervalConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">IntervalConstraint</a></span> <span class="element-name">get_intervalConstraintOfSpecification</span>()</div>
<div class="block">Returns the value of the '<em><b>interval Constraint Of Specification</b></em>' container reference.
 It is bidirectional and its opposite is
 '<a href="IntervalConstraint.html#getSpecification()"><code><em>Specification</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>interval Constraint Of Specification</em>' reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>interval Constraint Of Specification</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#set_intervalConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.IntervalConstraint)"><code>set_intervalConstraintOfSpecification(IntervalConstraint)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getInterval__intervalConstraintOfSpecification()"><code>UMLPackage.getInterval__intervalConstraintOfSpecification()</code></a></li>
<li><a href="IntervalConstraint.html#getSpecification()"><code>IntervalConstraint.getSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="set_intervalConstraintOfSpecification(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.IntervalConstraint)">
<h3>set_intervalConstraintOfSpecification</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_intervalConstraintOfSpecification</span><wbr/><span class="parameters">(@CheckForNull
 <a href="IntervalConstraint.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">IntervalConstraint</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#get_intervalConstraintOfSpecification()"><code><em>interval Constraint
 Of Specification</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>interval Constraint Of Specification</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#get_intervalConstraintOfSpecification()"><code>get_intervalConstraintOfSpecification()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
