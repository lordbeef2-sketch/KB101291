# JAVA OPENAPI: Extension (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/mdprofiles/Extension.html
- source_path: `com/nomagic/uml2/ext/magicdraw/mdprofiles/Extension.html`
- source_sha256: `411c19b2f924f9ece07e71c308cf3cc0a62ce4fa88fa122aff1f581bad5e2765`
- captured_utc: `2026-07-14T16:46:33.296244+00:00`
...
See Also:
[`UMLPackage.getExtension()`](../metadata/UMLPackage.html#getExtension())
Model:
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.[Association](../classes/mdkernel/Association.html)
`[get_clearAssociationActionOfAssociation](../classes/mdkernel/Association.html#get_clearAssociationActionOfAssociation()), [get_connectorOfType](../classes/mdkernel/Association.html#get_connectorOfType()), [getEndType](../classes/mdkernel/Association.html#getEndType()), [getMemberEnd](../classes/mdkernel/Association.html#getMemberEnd()), [getNavigableOwnedEnd](../classes/mdkernel/Association.html#getNavigableOwnedEnd()), [has_clearAssociationActionOfAssociation](../classes/mdkernel/Association.html#has_clearAssociationActionOfAssociation()), [has_connectorOfType](../classes/mdkernel/Association.html#has_connectorOfType()), [hasEndType](../classes/mdkernel/Association.html#hasEndType()), [hasMemberEnd](../classes/mdkernel/Association.html#hasMemberEnd()), [hasNavigableOwnedEnd](../classes/mdkernel/Association.html#hasNavigableOwnedEnd()), [hasOwnedEnd](../classes/mdkernel/Association.html#hasOwnedEnd()), [isDerived](../classes/mdkernel/Association.html#isDerived()), [setDerived](../classes/mdkernel/Association.html#setDerived(boolean))`
...
Returns the value of the '***Required***' attribute.
 ...
 begin-model-doc 
 Indicates whether an instance of the extending stereotype must be created when an instance of the extended class is created. The attribute value is derived from
 the value of the lower property of the ExtensionEnd referenced by Extension::ownedEnd; a lower value of 1 means that isRequired is true, but otherwise it is
 false. Since the default value of ExtensionEnd::lower is 0, the default value of isRequired is false.
 end-model-doc
Returns:
...
Generated:
getMetaclass
@CheckForNull[Class](../classes/mdkernel/Class.html) getMetaclass()
Returns the value of the '***Metaclass***' reference.
 It is bidirectional and its opposite is '[`*Extension*`](../classes/mdkernel/Class.html#getExtension())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getExtension_Metaclass()`](../metadata/UMLPackage.html#getExtension_Metaclass())
[`Class.getExtension()`](../classes/mdkernel/Class.html#getExtension())
Model:
opposite="extension" required="true" transient="true" changeable="false" volatile="true" derived="true" ordered="false"
Generated:
getOwnedEnd
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Property](../classes/mdkernel/Property.html)> getOwnedEnd()
Returns the value of the '***Owned End***' containment reference list.
 The list contents are of type [`ExtensionEnd`](ExtensionEnd.html).
 It is bidirectional and its opposite is '[`*extension Of Owned End*`](ExtensionEnd.html#get_extensionOfOwnedEnd())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Specified by:
`[getOwnedEnd](../classes/mdkernel/Association.html#getOwnedEnd())` in interface `[Association](../classes/mdkernel/Association.html)`
Returns:
the value of the '*Owned End*' containment reference list.
See Also:
[`UMLPackage.getExtension_OwnedEnd()`](../metadata/UMLPackage.html#getExtension_OwnedEnd())
[`ExtensionEnd.get_extensionOfOwnedEnd()`](ExtensionEnd.html#get_extensionOfOwnedEnd())
Model:
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isRequired()"><code><em>Required</em></code></a></li>
<li><a href="#getMetaclass()"><code><em>Metaclass</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../metadata/UMLPackage.html#getExtension()"><code>UMLPackage.getExtension()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getMetaclass()">getMetaclass</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Metaclass</b></em>' reference.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isRequired()">isRequired</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Required</b></em>' attribute.</div>
</div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Association">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.<a href="../classes/mdkernel/Association.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Association</a></h3>
<code><a href="../classes/mdkernel/Association.html#get_clearAssociationActionOfAssociation()">get_clearAssociationActionOfAssociation</a>, <a href="../classes/mdkernel/Association.html#get_connectorOfType()">get_connectorOfType</a>, <a href="../classes/mdkernel/Association.html#getEndType()">getEndType</a>, <a href="../classes/mdkernel/Association.html#getMemberEnd()">getMemberEnd</a>, <a href="../classes/mdkernel/Association.html#getNavigableOwnedEnd()">getNavigableOwnedEnd</a>, <a href="../classes/mdkernel/Association.html#has_clearAssociationActionOfAssociation()">has_clearAssociationActionOfAssociation</a>, <a href="../classes/mdkernel/Association.html#has_connectorOfType()">has_connectorOfType</a>, <a href="../classes/mdkernel/Association.html#hasEndType()">hasEndType</a>, <a href="../classes/mdkernel/Association.html#hasMemberEnd()">hasMemberEnd</a>, <a href="../classes/mdkernel/Association.html#hasNavigableOwnedEnd()">hasNavigableOwnedEnd</a>, <a href="../classes/mdkernel/Association.html#hasOwnedEnd()">hasOwnedEnd</a>, <a href="../classes/mdkernel/Association.html#isDerived()">isDerived</a>, <a href="../classes/mdkernel/Association.html#setDerived(boolean)">setDerived</a></code></div>
<div class="inherited-list">
...
<div class="block">Returns the value of the '<em><b>Required</b></em>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Indicates whether an instance of the extending stereotype must be created when an instance of the extended class is created. The attribute value is derived from
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Required</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getExtension_Required()</code></pre>
</details>
</li>
</ul>
</dd>
...
</span><span class="return-type"><a href="../classes/mdkernel/Class.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Class</a></span> <span class="element-name">getMetaclass</span>()</div>
<div class="block">Returns the value of the '<em><b>Metaclass</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../classes/mdkernel/Class.html#getExtension()"><code><em>Extension</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the Class that is extended through an Extension. The property is derived from the type of the memberEnd that is not the ownedEnd.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Metaclass</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../metadata/UMLPackage.html#getExtension_Metaclass()"><code>UMLPackage.getExtension_Metaclass()</code></a></li>
<li><a href="../classes/mdkernel/Class.html#getExtension()"><code>Class.getExtension()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="extension" required="true" transient="true" changeable="false" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Owned End</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is '<a href="ExtensionEnd.html#get_extensionOfOwnedEnd()"><code><em>extension Of Owned End</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the end of the extension that is typed by a Stereotype.
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="../classes/mdkernel/Association.html#getOwnedEnd()">getOwnedEnd</a></code> in interface <code><a href="../classes/mdkernel/Association.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Association</a></code></dd>
<dt>Returns:</dt>
<dd>the value of the '<em>Owned End</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../metadata/UMLPackage.html#getExtension_OwnedEnd()"><code>UMLPackage.getExtension_OwnedEnd()</code></a></li>
<li><a href="ExtensionEnd.html#get_extensionOfOwnedEnd()"><code>ExtensionEnd.get_extensionOfOwnedEnd()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_extensionOfOwnedEnd" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
