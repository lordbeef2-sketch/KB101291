# JAVA OPENAPI: LinkAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/LinkAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/LinkAction.html`
- source_sha256: `c187374868b9d4ea1ece222975d12e28cf232324efac0e4ce4def2bf10e8e7d0`
- captured_utc: `2026-07-14T16:46:24.739132+00:00`
...
`[CreateLinkAction](CreateLinkAction.html)`, `[CreateLinkObjectAction](../mdcompleteactions/CreateLinkObjectAction.html)`, `[DestroyLinkAction](DestroyLinkAction.html)`, `[ReadLinkAction](ReadLinkAction.html)`, `[WriteLinkAction](WriteLinkAction.html)`

public interfaceLinkActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getLinkAction()`](../../metadata/UMLPackage.html#getLinkAction())
Model:
abstract="true"
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[LinkEndData](LinkEndData.html)>`
`[getEndData](#getEndData())()`
Returns the value of the '***End Data***' containment reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[InputPin](../mdbasicactions/InputPin.html)>`
`[getInputValue](#getInputValue())()`
Returns the value of the '***Input Value***' containment reference list.
`boolean`
`[hasEndData](#hasEndData())()`
...
Method Details
getInputValue
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[InputPin](../mdbasicactions/InputPin.html)> getInputValue()
Returns the value of the '***Input Value***' containment reference list.
 The list contents are of type [`InputPin`](../mdbasicactions/InputPin.html).
 It is bidirectional and its opposite is
 '[`*link Action Of Input Value*`](../mdbasicactions/InputPin.html#get_linkActionOfInputValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLinkAction_InputValue()`](../../metadata/UMLPackage.html#getLinkAction_InputValue())
[`InputPin.get_linkActionOfInputValue()`](../mdbasicactions/InputPin.html#get_linkActionOfInputValue())
Model:
opposite="_linkActionOfInputValue" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
getEndData
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[LinkEndData](LinkEndData.html)> getEndData()
Returns the value of the '***End Data***' containment reference list.
 The list contents are of type [`LinkEndData`](LinkEndData.html).
 It is bidirectional and its opposite is
 '[`*link Action Of End Data*`](LinkEndData.html#get_linkActionOfEndData())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getLinkAction_EndData()`](../../metadata/UMLPackage.html#getLinkAction_EndData())
[`LinkEndData.get_linkActionOfEndData()`](LinkEndData.html#get_linkActionOfEndData())
Model:
...
<h1 class="title" title="Interface LinkAction">Interface LinkAction</h1>
</div>
...
<dd><code><a href="CreateLinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">CreateLinkAction</a></code>, <code><a href="../mdcompleteactions/CreateLinkObjectAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions">CreateLinkObjectAction</a></code>, <code><a href="DestroyLinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">DestroyLinkAction</a></code>, <code><a href="ReadLinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">ReadLinkAction</a></code>, <code><a href="WriteLinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">WriteLinkAction</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">LinkAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getEndData()"><code><em>End Data</em></code></a></li>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getLinkAction()"><code>UMLPackage.getLinkAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>abstract="true"
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkEndData</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getEndData()">getEndData</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>End Data</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a>&gt;</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasEndData()">hasEndData</a>()</code></div>
...
<div class="block">Returns the value of the '<em><b>Input Value</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/InputPin.html#get_linkActionOfInputValue()"><code><em>link Action Of Input Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 InputPins used by the LinkEndData of the LinkAction.
...
<li><a href="../../metadata/UMLPackage.html#getLinkAction_InputValue()"><code>UMLPackage.getLinkAction_InputValue()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_linkActionOfInputValue()"><code>InputPin.get_linkActionOfInputValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_linkActionOfInputValue" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getEndData()">
<h3>getEndData</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkEndData</a>&gt;</span> <span class="element-name">getEndData</span>()</div>
<div class="block">Returns the value of the '<em><b>End Data</b></em>' containment reference list.
 The list contents are of type <a href="LinkEndData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions"><code>LinkEndData</code></a>.
 It is bidirectional and its opposite is
 '<a href="LinkEndData.html#get_linkActionOfEndData()"><code><em>link Action Of End Data</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The LinkEndData identifying the values on the ends of the links acting on by this LinkAction.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>End Data</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getLinkAction_EndData()"><code>UMLPackage.getLinkAction_EndData()</code></a></li>
<li><a href="LinkEndData.html#get_linkActionOfEndData()"><code>LinkEndData.get_linkActionOfEndData()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_linkActionOfEndData" containment="true" resolveProxies="true" lower="2" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<li>
<section class="detail" id="hasEndData()">
<h3>hasEndData</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasEndData</span>()
            throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
