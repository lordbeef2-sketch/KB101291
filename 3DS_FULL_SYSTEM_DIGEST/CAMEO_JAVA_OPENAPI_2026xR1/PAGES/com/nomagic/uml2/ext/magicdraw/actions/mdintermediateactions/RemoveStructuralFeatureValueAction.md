# JAVA OPENAPI: RemoveStructuralFeatureValueAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/RemoveStructuralFeatureValueAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/RemoveStructuralFeatureValueAction.html`
- source_sha256: `e7bb0111bb03b47c15b7d41be267129f8b19ad650d503d24d214cbf139cd630a`
- captured_utc: `2026-07-14T16:46:25.199135+00:00`
...
The following features are supported:
 [`*Remove Duplicates*`](#isRemoveDuplicates())
[`*Remove At*`](#getRemoveAt())

See Also:
[`UMLPackage.getRemoveStructuralFeatureValueAction()`](../../metadata/UMLPackage.html#getRemoveStructuralFeatureValueAction())
Model:
...
`void`
`[setRemoveAt](#setRemoveAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))([InputPin](../mdbasicactions/InputPin.html) value)`
Sets the value of the '[`*Remove At*`](#getRemoveAt())'
 containment reference.
`void`
`[setRemoveDuplicates](#setRemoveDuplicates(boolean))(boolean value)`
Sets the value of the
 '[`*Remove Duplicates*`](#isRemoveDuplicates())' attribute.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.[StructuralFeatureAction](StructuralFeatureAction.html)
`[getObject](StructuralFeatureAction.html#getObject()), [getStructuralFeature](StructuralFeatureAction.html#getStructuralFeature()), [setObject](StructuralFeatureAction.html#setObject(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)), [setStructuralFeature](StructuralFeatureAction.html#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature))`
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.[WriteStructuralFeatureAction](WriteStructuralFeatureAction.html)
`[getResult](WriteStructuralFeatureAction.html#getResult()), [getValue](WriteStructuralFeatureAction.html#getValue()), [setResult](WriteStructuralFeatureAction.html#setResult(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)), [setValue](WriteStructuralFeatureAction.html#setValue(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))`
...
See Also:
[`setRemoveDuplicates(boolean)`](#setRemoveDuplicates(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getRemoveStructuralFeatureValueAction_RemoveDuplicates()`
Model:
...
Generated:
getRemoveAt
@CheckForNull[InputPin](../mdbasicactions/InputPin.html) getRemoveAt()
Returns the value of the '***Remove At***' containment reference.
 It is bidirectional and its opposite is '[`*remove Structural Feature Value Action Of Remove At*`](../mdbasicactions/InputPin.html#get_removeStructuralFeatureValueActionOfRemoveAt())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setRemoveAt(InputPin)`](#setRemoveAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))
[`UMLPackage.getRemoveStructuralFeatureValueAction_RemoveAt()`](../../metadata/UMLPackage.html#getRemoveStructuralFeatureValueAction_RemoveAt())
[`InputPin.get_removeStructuralFeatureValueActionOfRemoveAt()`](../mdbasicactions/InputPin.html#get_removeStructuralFeatureValueActionOfRemoveAt())
Model:
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isRemoveDuplicates()"><code><em>Remove Duplicates</em></code></a></li>
<li><a href="#getRemoveAt()"><code><em>Remove At</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getRemoveStructuralFeatureValueAction()"><code>UMLPackage.getRemoveStructuralFeatureValueAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRemoveAt()">getRemoveAt</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Remove At</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isRemoveDuplicates()">isRemoveDuplicates</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Remove Duplicates</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setRemoveAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setRemoveAt</a><wbr/>(<a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getRemoveAt()"><code><em>Remove At</em></code></a>'
 containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setRemoveDuplicates(boolean)">setRemoveDuplicates</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#isRemoveDuplicates()"><code><em>Remove Duplicates</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.StructuralFeatureAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.<a href="StructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">StructuralFeatureAction</a></h3>
<code><a href="StructuralFeatureAction.html#getObject()">getObject</a>, <a href="StructuralFeatureAction.html#getStructuralFeature()">getStructuralFeature</a>, <a href="StructuralFeatureAction.html#setObject(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setObject</a>, <a href="StructuralFeatureAction.html#setStructuralFeature(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.StructuralFeature)">setStructuralFeature</a></code></div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.WriteStructuralFeatureAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.<a href="WriteStructuralFeatureAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">WriteStructuralFeatureAction</a></h3>
<code><a href="WriteStructuralFeatureAction.html#getResult()">getResult</a>, <a href="WriteStructuralFeatureAction.html#getValue()">getValue</a>, <a href="WriteStructuralFeatureAction.html#setResult(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.OutputPin)">setResult</a>, <a href="WriteStructuralFeatureAction.html#setValue(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setValue</a></code></div>
</section>
</li>
</ul>
</section>
...
<li>
<section class="detail" id="isRemoveDuplicates()">
<h3>isRemoveDuplicates</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isRemoveDuplicates</span>()</div>
<div class="block">Returns the value of the '<em><b>Remove Duplicates</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Remove Duplicates</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setRemoveDuplicates(boolean)"><code>setRemoveDuplicates(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getRemoveStructuralFeatureValueAction_RemoveDuplicates()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setRemoveDuplicates(boolean)">
<h3>setRemoveDuplicates</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setRemoveDuplicates</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the
 '<a href="#isRemoveDuplicates()"><code><em>Remove Duplicates</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Remove Duplicates</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isRemoveDuplicates()"><code>isRemoveDuplicates()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getRemoveAt()">
<h3>getRemoveAt</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicactions/InputPin.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">InputPin</a></span> <span class="element-name">getRemoveAt</span>()</div>
<div class="block">Returns the value of the '<em><b>Remove At</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_removeStructuralFeatureValueActionOfRemoveAt()"><code><em>remove Structural Feature Value Action Of Remove At</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An InputPin that provides the position of an existing value to remove in ordered, nonunique structural features. The type of the removeAt InputPin is
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Remove At</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setRemoveAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setRemoveAt(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getRemoveStructuralFeatureValueAction_RemoveAt()"><code>UMLPackage.getRemoveStructuralFeatureValueAction_RemoveAt()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_removeStructuralFeatureValueActionOfRemoveAt()"><code>InputPin.get_removeStructuralFeatureValueActionOfRemoveAt()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_removeStructuralFeatureValueActionOfRemoveAt" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setRemoveAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">
<h3>setRemoveAt</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setRemoveAt</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Remove At</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getRemoveAt()"><code>getRemoveAt()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
