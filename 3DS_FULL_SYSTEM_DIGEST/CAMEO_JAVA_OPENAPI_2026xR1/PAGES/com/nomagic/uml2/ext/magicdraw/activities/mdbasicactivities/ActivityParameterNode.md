# JAVA OPENAPI: ActivityParameterNode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdbasicactivities/ActivityParameterNode.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdbasicactivities/ActivityParameterNode.html`
- source_sha256: `c1b283460f1dc557c3f562bee6ce2e45d9a45a657a3da1b7de95b3583f67474f`
- captured_utc: `2026-07-14T16:46:25.974146+00:00`
...
See Also:
[`UMLPackage.getActivityParameterNode()`](../../metadata/UMLPackage.html#getActivityParameterNode())
Model:
...
`void`
`[setParameter](#setParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter))([Parameter](../../classes/mdkernel/Parameter.html) value)`
Sets the value of the '[`*Parameter*`](#getParameter())' reference.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.[ObjectNode](ObjectNode.html)
`[get_exceptionHandlerOfExceptionInput](ObjectNode.html#get_exceptionHandlerOfExceptionInput()), [getInState](ObjectNode.html#getInState()), [getOrdering](ObjectNode.html#getOrdering()), [getSelection](ObjectNode.html#getSelection()), [getUpperBound](ObjectNode.html#getUpperBound()), [has_exceptionHandlerOfExceptionInput](ObjectNode.html#has_exceptionHandlerOfExceptionInput()), [hasInState](ObjectNode.html#hasInState()), [isControlType](ObjectNode.html#isControlType()), [setControlType](ObjectNode.html#setControlType(boolean)), [setOrdering](ObjectNode.html#setOrdering(com.nomagic.uml2.ext.magicdraw.activities.mdcompleteactivities.ObjectNodeOrderingKind)), [setSelection](ObjectNode.html#setSelection(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)), [setUpperBound](ObjectNode.html#setUpperBound(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))`
...
Method Details
getParameter
@CheckForNull[Parameter](../../classes/mdkernel/Parameter.html) getParameter()
Returns the value of the '***Parameter***' reference.
 It is bidirectional and its opposite is
 '[`*activity Parameter Node Of Parameter*`](../../classes/mdkernel/Parameter.html#get_activityParameterNodeOfParameter())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setParameter(Parameter)`](#setParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter))
[`UMLPackage.getActivityParameterNode_Parameter()`](../../metadata/UMLPackage.html#getActivityParameterNode_Parameter())
[`Parameter.get_activityParameterNodeOfParameter()`](../../classes/mdkernel/Parameter.html#get_activityParameterNodeOfParameter())
Model:
opposite="_activityParameterNodeOfParameter" required="true" ordered="false"
Generated:
setParameter
void setParameter(@CheckForNull
 [Parameter](../../classes/mdkernel/Parameter.html) value)
Sets the value of the '[`*Parameter*`](#getParameter())' reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
<li><a href="../../metadata/UMLPackage.html#getActivityParameterNode()"><code>UMLPackage.getActivityParameterNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Parameter</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter)">setParameter</a><wbr/>(<a href="../../classes/mdkernel/Parameter.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Parameter</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getParameter()"><code><em>Parameter</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectNode">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.<a href="ObjectNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ObjectNode</a></h3>
<code><a href="ObjectNode.html#get_exceptionHandlerOfExceptionInput()">get_exceptionHandlerOfExceptionInput</a>, <a href="ObjectNode.html#getInState()">getInState</a>, <a href="ObjectNode.html#getOrdering()">getOrdering</a>, <a href="ObjectNode.html#getSelection()">getSelection</a>, <a href="ObjectNode.html#getUpperBound()">getUpperBound</a>, <a href="ObjectNode.html#has_exceptionHandlerOfExceptionInput()">has_exceptionHandlerOfExceptionInput</a>, <a href="ObjectNode.html#hasInState()">hasInState</a>, <a href="ObjectNode.html#isControlType()">isControlType</a>, <a href="ObjectNode.html#setControlType(boolean)">setControlType</a>, <a href="ObjectNode.html#setOrdering(com.nomagic.uml2.ext.magicdraw.activities.mdcompleteactivities.ObjectNodeOrderingKind)">setOrdering</a>, <a href="ObjectNode.html#setSelection(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setSelection</a>, <a href="ObjectNode.html#setUpperBound(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setUpperBound</a></code></div>
<div class="inherited-list">
...
</span><span class="return-type"><a href="../../classes/mdkernel/Parameter.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Parameter</a></span> <span class="element-name">getParameter</span>()</div>
<div class="block">Returns the value of the '<em><b>Parameter</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Parameter.html#get_activityParameterNodeOfParameter()"><code><em>activity Parameter Node Of Parameter</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Parameter for which the ActivityParameterNode will be accepting or providing values.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Parameter</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter)"><code>setParameter(Parameter)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getActivityParameterNode_Parameter()"><code>UMLPackage.getActivityParameterNode_Parameter()</code></a></li>
<li><a href="../../classes/mdkernel/Parameter.html#get_activityParameterNodeOfParameter()"><code>Parameter.get_activityParameterNodeOfParameter()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_activityParameterNodeOfParameter" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setParameter(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter)">
<h3>setParameter</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setParameter</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../../classes/mdkernel/Parameter.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Parameter</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getParameter()"><code><em>Parameter</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Parameter</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getParameter()"><code>getParameter()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
