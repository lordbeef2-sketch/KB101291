# JAVA OPENAPI: ComponentRealization (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/ComponentRealization.html
- source_path: `com/nomagic/uml2/ext/magicdraw/components/mdbasiccomponents/ComponentRealization.html`
- source_sha256: `424e6a871753deeb6f751146124588d8f1b07ad3b175160da3c46ed81b742200`
- captured_utc: `2026-07-14T16:46:31.624221+00:00`
...
begin-model-doc 
 ...
 The Component forms an abstraction from these various Classifiers.
 end-model-doc 
The following features are supported:
 [`*Realizing Classifier*`](#getRealizingClassifier())
[`*Abstraction*`](#getAbstraction())

See Also:
[`UMLPackage.getComponentRealization()`](../../metadata/UMLPackage.html#getComponentRealization())
Model:
...
`[getRealizingClassifier](#getRealizingClassifier())()`
Returns the value of the '***Realizing Classifier***' reference list.
`boolean`
`[hasRealizingClassifier](#hasRealizingClassifier())()`

`void`
`[setAbstraction](#setAbstraction(com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents.Component))([Component](Component.html) value)`
Sets the value of the '[`*Abstraction*`](#getAbstraction())' container
 reference.
...
Method Details
getAbstraction
@CheckForNull[Component](Component.html) getAbstraction()
Returns the value of the '***Abstraction***' container reference.
 It is bidirectional and its opposite is '[`*Realization*`](Component.html#getRealization())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setAbstraction(Component)`](#setAbstraction(com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents.Component))
[`UMLPackage.getComponentRealization_Abstraction()`](../../metadata/UMLPackage.html#getComponentRealization_Abstraction())
[`Component.getRealization()`](Component.html#getRealization())
Model:
opposite="realization" transient="false" ordered="false"
Generated:
setAbstraction
void setAbstraction(@CheckForNull
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Classifier](../../classes/mdkernel/Classifier.html)> getRealizingClassifier()
Returns the value of the '***Realizing Classifier***' reference list.
 The list contents are of type [`Classifier`](../../classes/mdkernel/Classifier.html).
 It is bidirectional and its opposite is '[`*component Realization Of Realizing Classifier*`](../../classes/mdkernel/Classifier.html#get_componentRealizationOfRealizingClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Returns:
the value of the '*Realizing Classifier*' reference list.
See Also:
[`UMLPackage.getComponentRealization_RealizingClassifier()`](../../metadata/UMLPackage.html#getComponentRealization_RealizingClassifier())
[`Classifier.get_componentRealizationOfRealizingClassifier()`](../../classes/mdkernel/Classifier.html#get_componentRealizationOfRealizingClassifier())
Model:
opposite="_componentRealizationOfRealizingClassifier" required="true" ordered="false"
Generated:
hasRealizingClassifier
boolean hasRealizingClassifier()
...
<h1 class="title" title="Interface ComponentRealization">Interface ComponentRealization</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ComponentRealization</span><span class="extends-implements">
extends <a href="../../classes/mddependencies/Realization.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Realization</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getRealizingClassifier()"><code><em>Realizing Classifier</em></code></a></li>
<li><a href="#getAbstraction()"><code><em>Abstraction</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getComponentRealization()"><code>UMLPackage.getComponentRealization()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Component.html" title="interface in com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents">Component</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getAbstraction()">getAbstraction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Abstraction</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getRealizingClassifier()">getRealizingClassifier</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Realizing Classifier</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasRealizingClassifier()">hasRealizingClassifier</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setAbstraction(com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents.Component)">setAbstraction</a><wbr/>(<a href="Component.html" title="interface in com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents">Component</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getAbstraction()"><code><em>Abstraction</em></code></a>' container
 reference.</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getAbstraction()">
<h3>getAbstraction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Component.html" title="interface in com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents">Component</a></span> <span class="element-name">getAbstraction</span>()</div>
<div class="block">Returns the value of the '<em><b>Abstraction</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Component.html#getRealization()"><code><em>Realization</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Component that owns this ComponentRealization and which is implemented by its realizing Classifiers.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Abstraction</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setAbstraction(com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents.Component)"><code>setAbstraction(Component)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getComponentRealization_Abstraction()"><code>UMLPackage.getComponentRealization_Abstraction()</code></a></li>
<li><a href="Component.html#getRealization()"><code>Component.getRealization()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="realization" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setAbstraction(com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents.Component)">
<h3>setAbstraction</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setAbstraction</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Component.html" title="interface in com.nomagic.uml2.ext.magicdraw.components.mdbasiccomponents">Component</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getAbstraction()"><code><em>Abstraction</em></code></a>' container
 reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Abstraction</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getAbstraction()"><code>getAbstraction()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getRealizingClassifier()">
<h3>getRealizingClassifier</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../../classes/mdkernel/Classifier.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Classifier</a>&gt;</span> <span class="element-name">getRealizingClassifier</span>()</div>
<div class="block">Returns the value of the '<em><b>Realizing Classifier</b></em>' reference list.
 ...
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/Classifier.html#get_componentRealizationOfRealizingClassifier()"><code><em>component Realization Of Realizing Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Classifiers that are involved in the implementation of the Component that owns this Realization.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Realizing Classifier</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getComponentRealization_RealizingClassifier()"><code>UMLPackage.getComponentRealization_RealizingClassifier()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_componentRealizationOfRealizingClassifier()"><code>Classifier.get_componentRealizationOfRealizingClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_componentRealizationOfRealizingClassifier" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasRealizingClassifier()">
<h3>hasRealizingClassifier</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasRealizingClassifier</span>()
