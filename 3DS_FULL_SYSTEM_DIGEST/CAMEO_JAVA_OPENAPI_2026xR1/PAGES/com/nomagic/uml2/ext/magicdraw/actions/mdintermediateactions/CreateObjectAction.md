# JAVA OPENAPI: CreateObjectAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/CreateObjectAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/CreateObjectAction.html`
- source_sha256: `77d082c9acef5da07f1897f77cc26a2c98c77f9859dbea27fa7e2d2658f071ae`
- captured_utc: `2026-07-14T16:46:24.385125+00:00`
...
public interfaceCreateObjectActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getCreateObjectAction()`](../../metadata/UMLPackage.html#getCreateObjectAction())
Model:
...
Returns the value of the '***Classifier***' reference.
 ...
 '[`*create Object Action Of Classifier*`](../../classes/mdkernel/Classifier.html#get_createObjectActionOfClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getCreateObjectAction_Classifier()`](../../metadata/UMLPackage.html#getCreateObjectAction_Classifier())
[`Classifier.get_createObjectActionOfClassifier()`](../../classes/mdkernel/Classifier.html#get_createObjectActionOfClassifier())
Model:
opposite="_createObjectActionOfClassifier" required="true" ordered="false"
Generated:
setClassifier
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is
 '[`*create Object Action Of Result*`](../mdbasicactions/OutputPin.html#get_createObjectActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getCreateObjectAction_Result()`](../../metadata/UMLPackage.html#getCreateObjectAction_Result())
[`OutputPin.get_createObjectActionOfResult()`](../mdbasicactions/OutputPin.html#get_createObjectActionOfResult())
Model:
opposite="_createObjectActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
<h1 class="title" title="Interface CreateObjectAction">Interface CreateObjectAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">CreateObjectAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getCreateObjectAction()"><code>UMLPackage.getCreateObjectAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Classifier</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Classifier.html#get_createObjectActionOfClassifier()"><code><em>create Object Action Of Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Classifier to be instantiated.
...
<li><a href="../../metadata/UMLPackage.html#getCreateObjectAction_Classifier()"><code>UMLPackage.getCreateObjectAction_Classifier()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_createObjectActionOfClassifier()"><code>Classifier.get_createObjectActionOfClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_createObjectActionOfClassifier" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_createObjectActionOfResult()"><code><em>create Object Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the newly created object is placed.
...
<li><a href="../../metadata/UMLPackage.html#getCreateObjectAction_Result()"><code>UMLPackage.getCreateObjectAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_createObjectActionOfResult()"><code>OutputPin.get_createObjectActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_createObjectActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
