# JAVA OPENAPI: JoinNode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdintermediateactivities/JoinNode.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdintermediateactivities/JoinNode.html`
- source_sha256: `2743d1db8a57d069afcbeffc48788944bde9b21494203fec5fab91506f8b8b3e`
- captured_utc: `2026-07-14T16:46:26.940159+00:00`
...
public interfaceJoinNodeextends [ControlNode](../mdbasicactivities/ControlNode.html)
...
The following features are supported:
 [`*Combine Duplicate*`](#isCombineDuplicate())
[`*Join Spec*`](#getJoinSpec())

See Also:
[`UMLPackage.getJoinNode()`](../../metadata/UMLPackage.html#getJoinNode())
Model:
...
`void`
`[setCombineDuplicate](#setCombineDuplicate(boolean))(boolean value)`
Sets the value of the '[`*Combine Duplicate*`](#isCombineDuplicate())'
 attribute.
`void`
`[setJoinSpec](#setJoinSpec(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))([ValueSpecification](../../classes/mdkernel/ValueSpecification.html) value)`
Sets the value of the '[`*Join Spec*`](#getJoinSpec())' containment reference.
...
See Also:
[`setCombineDuplicate(boolean)`](#setCombineDuplicate(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getJoinNode_CombineDuplicate()`
Model:
...
Generated:
getJoinSpec
@CheckForNull[ValueSpecification](../../classes/mdkernel/ValueSpecification.html) getJoinSpec()
Returns the value of the '***Join Spec***' containment reference.
 It is bidirectional and its opposite is
 '[`*join Node Of Join Spec*`](../../classes/mdkernel/ValueSpecification.html#get_joinNodeOfJoinSpec())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setJoinSpec(ValueSpecification)`](#setJoinSpec(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification))
[`UMLPackage.getJoinNode_JoinSpec()`](../../metadata/UMLPackage.html#getJoinNode_JoinSpec())
[`ValueSpecification.get_joinNodeOfJoinSpec()`](../../classes/mdkernel/ValueSpecification.html#get_joinNodeOfJoinSpec())
Model:
...
<h1 class="title" title="Interface JoinNode">Interface JoinNode</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">JoinNode</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isCombineDuplicate()"><code><em>Combine Duplicate</em></code></a></li>
<li><a href="#getJoinSpec()"><code><em>Join Spec</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getJoinNode()"><code>UMLPackage.getJoinNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getJoinSpec()">getJoinSpec</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Join Spec</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isCombineDuplicate()">isCombineDuplicate</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Combine Duplicate</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setCombineDuplicate(boolean)">setCombineDuplicate</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isCombineDuplicate()"><code><em>Combine Duplicate</em></code></a>'
 attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setJoinSpec(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">setJoinSpec</a><wbr/>(<a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getJoinSpec()"><code><em>Join Spec</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="isCombineDuplicate()">
<h3>isCombineDuplicate</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isCombineDuplicate</span>()</div>
<div class="block">Returns the value of the '<em><b>Combine Duplicate</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Combine Duplicate</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setCombineDuplicate(boolean)"><code>setCombineDuplicate(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getJoinNode_CombineDuplicate()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setCombineDuplicate(boolean)">
<h3>setCombineDuplicate</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setCombineDuplicate</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isCombineDuplicate()"><code><em>Combine Duplicate</em></code></a>'
 attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Combine Duplicate</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isCombineDuplicate()"><code>isCombineDuplicate()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getJoinSpec()">
<h3>getJoinSpec</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/ValueSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">ValueSpecification</a></span> <span class="element-name">getJoinSpec</span>()</div>
<div class="block">Returns the value of the '<em><b>Join Spec</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/ValueSpecification.html#get_joinNodeOfJoinSpec()"><code><em>join Node Of Join Spec</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A ValueSpecification giving the condition under which the JoinNode will offer a token on its outgoing ActivityEdge. If no joinSpec is specified, then the
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Join Spec</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setJoinSpec(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)"><code>setJoinSpec(ValueSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getJoinNode_JoinSpec()"><code>UMLPackage.getJoinNode_JoinSpec()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_joinNodeOfJoinSpec()"><code>ValueSpecification.get_joinNodeOfJoinSpec()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_joinNodeOfJoinSpec" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setJoinSpec(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.ValueSpecification)">
<h3>setJoinSpec</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setJoinSpec</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getJoinSpec()"><code><em>Join Spec</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Join Spec</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getJoinSpec()"><code>getJoinSpec()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
