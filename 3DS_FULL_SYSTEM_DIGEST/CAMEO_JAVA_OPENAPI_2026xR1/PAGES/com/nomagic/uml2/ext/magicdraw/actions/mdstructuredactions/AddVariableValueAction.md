# JAVA OPENAPI: AddVariableValueAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/AddVariableValueAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/AddVariableValueAction.html`
- source_sha256: `f672776a6f38cda1f97b29098d8f6038c59d9e168458abb083696d0af68c88c3`
- captured_utc: `2026-07-14T16:46:25.504139+00:00`
...
public interfaceAddVariableValueActionextends [WriteVariableAction](WriteVariableAction.html)
...
See Also:
[`UMLPackage.getAddVariableValueAction()`](../../metadata/UMLPackage.html#getAddVariableValueAction())
Model:
...
Sets the value of the '[`*Insert At*`](#getInsertAt())' containment
 reference.
`void`
...
Returns the value of the '***Insert At***' containment reference.
 It is bidirectional and its opposite is '[`*add
 Variable Value Action Of Insert At*`](../mdbasicactions/InputPin.html#get_addVariableValueActionOfInsertAt())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The InputPin that gives the position at which to insert a new value or move an existing value in ordered Variables. The type of the insertAt InputPin is
 UnlimitedNatural, but the value cannot be zero. It is omitted for unordered Variables.
 end-model-doc
Returns:
...
[`UMLPackage.getAddVariableValueAction_InsertAt()`](../../metadata/UMLPackage.html#getAddVariableValueAction_InsertAt())
[`InputPin.get_addVariableValueActionOfInsertAt()`](../mdbasicactions/InputPin.html#get_addVariableValueActionOfInsertAt())
Model:
...
<h1 class="title" title="Interface AddVariableValueAction">Interface AddVariableValueAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">AddVariableValueAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getAddVariableValueAction()"><code>UMLPackage.getAddVariableValueAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getInsertAt()"><code><em>Insert At</em></code></a>' containment
 reference.</div>
</div>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getAddVariableValueAction_ReplaceAll()</code></pre>
</details>
</li>
</ul>
</dd>
...
<div class="block">Returns the value of the '<em><b>Insert At</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_addVariableValueActionOfInsertAt()"><code><em>add
 Variable Value Action Of Insert At</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that gives the position at which to insert a new value or move an existing value in ordered Variables. The type of the insertAt InputPin is
...
<li><a href="../../metadata/UMLPackage.html#getAddVariableValueAction_InsertAt()"><code>UMLPackage.getAddVariableValueAction_InsertAt()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_addVariableValueActionOfInsertAt()"><code>InputPin.get_addVariableValueActionOfInsertAt()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_addVariableValueActionOfInsertAt" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
