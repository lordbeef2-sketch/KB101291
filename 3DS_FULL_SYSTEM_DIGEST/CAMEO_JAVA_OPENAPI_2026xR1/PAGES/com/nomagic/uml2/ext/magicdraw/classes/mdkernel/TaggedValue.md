# JAVA OPENAPI: TaggedValue (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/classes/mdkernel/TaggedValue.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mdkernel/TaggedValue.html`
- source_sha256: `bce06d27374a4f51aea030f587b0ff9764ab351410171772968bf6e289ab4da2`
- captured_utc: `2026-07-14T16:46:30.184203+00:00`
...
`[BooleanTaggedValue](BooleanTaggedValue.html)`, `[ElementTaggedValue](ElementTaggedValue.html)`, `[IntegerTaggedValue](IntegerTaggedValue.html)`, `[RealTaggedValue](RealTaggedValue.html)`, `[StringTaggedValue](StringTaggedValue.html)`

public interfaceTaggedValueextends [Element](Element.html)
...
[`*Tag Definition*`](#getTagDefinition())
[`*Tagged Value Owner*`](#getTaggedValueOwner())

See Also:
[`UMLPackage.getTaggedValue()`](../../metadata/UMLPackage.html#getTaggedValue())
Model:
Generated:
...
`[addConvertedValue](#addConvertedValue(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)`
Converts and adds given value to value suitable for this TaggedValue.
`[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)`
`[convertValue](#convertValue(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)`
Converts given value to value suitable for this TaggedValue.
`[Property](Property.html)`
`[getTagDefinition](#getTagDefinition())()`
Returns the value of the '***Tag Definition***' reference.
`[Element](Element.html)`
`[getTaggedValueOwner](#getTaggedValueOwner())()`
Returns the value of the '***Tagged Value Owner***' container reference.
...
`void`
`[setTagDefinition](#setTagDefinition(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))([Property](Property.html) value)`
Sets the value of the '[`*Tag Definition*`](#getTagDefinition())' reference.
`void`
`[setTaggedValueOwner](#setTaggedValueOwner(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))([Element](Element.html) value)`
Sets the value of the '[`*Tagged Value Owner*`](#getTaggedValueOwner())' container reference.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<?>`
`[value](#value())()`
Returns value of the tag.
...
Method Details
getTagDefinition
@CheckForNull[Property](Property.html) getTagDefinition()
Returns the value of the '***Tag Definition***' reference.
 It is bidirectional and its opposite is '[`*Defined Tagged Value*`](Property.html#get_definedTaggedValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The Property that specifies the values that may be held by the TaggedValue.
 end-model-doc
Returns:
the value of the '*Tag Definition*' reference.
See Also:
[`setTagDefinition(Property)`](#setTagDefinition(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property))
[`UMLPackage.getTaggedValue_TagDefinition()`](../../metadata/UMLPackage.html#getTaggedValue_TagDefinition())
[`Property.get_definedTaggedValue()`](Property.html#get_definedTaggedValue())
Model:
...
Generated:
getTaggedValueOwner
[Element](Element.html) getTaggedValueOwner()
Returns the value of the '***Tagged Value Owner***' container reference.
 It is bidirectional and its opposite is '[`*Tagged Value*`](Element.html#getTaggedValue())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The Element that owns this TaggedValue.
 end-model-doc
Returns:
the value of the '*Tagged Value Owner*' container reference.
See Also:
[`setTaggedValueOwner(Element)`](#setTaggedValueOwner(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element))
[`UMLPackage.getTaggedValue_TaggedValueOwner()`](../../metadata/UMLPackage.html#getTaggedValue_TaggedValueOwner())
[`Element.getTaggedValue()`](Element.html#getTaggedValue())
Model:
opposite="taggedValue" transient="false"
Generated:
setTaggedValueOwner
void setTaggedValueOwner([Element](Element.html) value)
Sets the value of the '[`*Tagged Value Owner*`](#getTaggedValueOwner())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
Generated:
value
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<?> value()
Returns value of the tag.
 begin-user-doc 
 end-user-doc
Model:
...
Generated:
getValue
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<?> getValue()
Returns value of the tag.
Returns:
tag value.
addConvertedValue
[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) addConvertedValue([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)
...
Throws:
`[IllegalArgumentException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html)` - in case value cannot be converted to suitable
See Also:
[`convertValue(Object)`](#convertValue(java.lang.Object))
[`getValue()`](#getValue())
convertValue
[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) convertValue([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)
 throws [IllegalArgumentException](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html)
...
<h1 class="title" title="Interface TaggedValue">Interface TaggedValue</h1>
</div>
...
<ul>
<li><a href="#getTagDefinition()"><code><em>Tag Definition</em></code></a></li>
<li><a href="#getTaggedValueOwner()"><code><em>Tagged Value Owner</em></code></a></li>
</ul></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getTaggedValue()"><code>UMLPackage.getTaggedValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dt>Generated:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#addConvertedValue(java.lang.Object)">addConvertedValue</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Converts and adds given value to value suitable for this TaggedValue.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#convertValue(java.lang.Object)">convertValue</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Converts given value to value suitable for this TaggedValue.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTagDefinition()">getTagDefinition</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Tag Definition</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTaggedValueOwner()">getTaggedValueOwner</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Tagged Value Owner</b></em>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;?&gt;</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns value of the tag.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Checks if TaggedValue has any value</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTagDefinition(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)">setTagDefinition</a><wbr/>(<a href="Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getTagDefinition()"><code><em>Tag Definition</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTaggedValueOwner(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">setTaggedValueOwner</a><wbr/>(<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getTaggedValueOwner()"><code><em>Tagged Value Owner</em></code></a>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;?&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#value()">value</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns value of the tag.</div>
</div>
</div>
...
<li>
<section class="detail" id="getTagDefinition()">
<h3>getTagDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a></span> <span class="element-name">getTagDefinition</span>()</div>
<div class="block">Returns the value of the '<em><b>Tag Definition</b></em>' reference.
 It is bidirectional and its opposite is '<a href="Property.html#get_definedTaggedValue()"><code><em>Defined Tagged Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Property that specifies the values that may be held by the TaggedValue.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Tag Definition</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setTagDefinition(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)"><code>setTagDefinition(Property)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTaggedValue_TagDefinition()"><code>UMLPackage.getTaggedValue_TagDefinition()</code></a></li>
<li><a href="Property.html#get_definedTaggedValue()"><code>Property.get_definedTaggedValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="definedTaggedValue"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setTagDefinition(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property)">
<h3>setTagDefinition</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTagDefinition</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getTagDefinition()"><code><em>Tag Definition</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Tag Definition</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getTagDefinition()"><code>getTagDefinition()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getTaggedValueOwner()">
<h3>getTaggedValueOwner</h3>
<div class="member-signature"><span class="return-type"><a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a></span> <span class="element-name">getTaggedValueOwner</span>()</div>
<div class="block">Returns the value of the '<em><b>Tagged Value Owner</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="Element.html#getTaggedValue()"><code><em>Tagged Value</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Element that owns this TaggedValue.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Tagged Value Owner</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setTaggedValueOwner(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)"><code>setTaggedValueOwner(Element)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTaggedValue_TaggedValueOwner()"><code>UMLPackage.getTaggedValue_TaggedValueOwner()</code></a></li>
<li><a href="Element.html#getTaggedValue()"><code>Element.getTaggedValue()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="taggedValue" transient="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setTaggedValueOwner(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element)">
<h3>setTaggedValueOwner</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTaggedValueOwner</span><wbr/><span class="parameters">(<a href="Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getTaggedValueOwner()"><code><em>Tagged Value Owner</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Tagged Value Owner</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getTaggedValueOwner()"><code>getTaggedValueOwner()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<h3>value</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;?&gt;</span> <span class="element-name">value</span>()</div>
<div class="block">Returns value of the tag.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Model:</dt>
<dd>kind="operation" dataType="uml.EList&lt;? extends org.eclipse.emf.ecore.EJavaObject&gt;" unique="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<h3>getValue</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;?&gt;</span> <span class="element-name">getValue</span>()</div>
<div class="block">Returns value of the tag.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>tag value.</dd>
...
<li>
<section class="detail" id="addConvertedValue(java.lang.Object)">
<h3>addConvertedValue</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span> <span class="element-name">addConvertedValue</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value)</span>
...
<div class="block">Converts and adds given value to value suitable for this TaggedValue. For example Object to String.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - value to add</dd>
<dt>Returns:</dt>
<dd>added value (converted one)</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang">IllegalArgumentException</a></code> - in case value cannot be converted to suitable</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#convertValue(java.lang.Object)"><code>convertValue(Object)</code></a></li>
...
<li>
<section class="detail" id="convertValue(java.lang.Object)">
<h3>convertValue</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span> <span class="element-name">convertValue</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> value)</span>
             throws <span class="exceptions"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang">IllegalArgumentException</a></span></div>
<div class="block">Converts given value to value suitable for this TaggedValue. For example Object to String.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - value to convert</dd>
<dt>Returns:</dt>
<dd>converter value or same value if it is suitable</dd>
<dt>Throws:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang">IllegalArgumentException</a></code> - in case value cannot be converted to suitable</dd>
</dl>
</section>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>true if value is not empty</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getValue()"><code>getValue()</code></a></li>
