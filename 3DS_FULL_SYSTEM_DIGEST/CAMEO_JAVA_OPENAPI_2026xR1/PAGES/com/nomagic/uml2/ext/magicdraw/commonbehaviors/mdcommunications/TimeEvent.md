# JAVA OPENAPI: TimeEvent (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/TimeEvent.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/TimeEvent.html`
- source_sha256: `bcc8cc2d2b3e4adb9a47bb362f7ee809a4f62eee5025be95616d6689689e371a`
- captured_utc: `2026-07-14T16:46:31.004213+00:00`
...
See Also:
[`UMLPackage.getTimeEvent()`](../../metadata/UMLPackage.html#getTimeEvent())
Model:
...
Method
Description
`[TimeExpression](../mdsimpletime/TimeExpression.html)`
`[getWhen](#getWhen())()`
...
`void`
`[setRelative](#setRelative(boolean))(boolean value)`
Sets the value of the '[`*Relative*`](#isRelative())' attribute.
`void`
`[setWhen](#setWhen(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression))([TimeExpression](../mdsimpletime/TimeExpression.html) value)`
Sets the value of the '[`*When*`](#getWhen())' containment reference.
...
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getTimeEvent_Relative()`
Model:
...
Generated:
getWhen
@CheckForNull[TimeExpression](../mdsimpletime/TimeExpression.html) getWhen()
Returns the value of the '***When***' containment reference.
 It is bidirectional and its opposite is
 '[`*time Event Of When*`](../mdsimpletime/TimeExpression.html#get_timeEventOfWhen())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setWhen(TimeExpression)`](#setWhen(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression))
[`UMLPackage.getTimeEvent_When()`](../../metadata/UMLPackage.html#getTimeEvent_When())
[`TimeExpression.get_timeEventOfWhen()`](../mdsimpletime/TimeExpression.html#get_timeEventOfWhen())
Model:
opposite="_timeEventOfWhen" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setWhen
void setWhen(@CheckForNull
 [TimeExpression](../mdsimpletime/TimeExpression.html) value)
Sets the value of the '[`*When*`](#getWhen())' containment reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
<h1 class="title" title="Interface TimeEvent">Interface TimeEvent</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">TimeEvent</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isRelative()"><code><em>Relative</em></code></a></li>
<li><a href="#getWhen()"><code><em>When</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getTimeEvent()"><code>UMLPackage.getTimeEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdsimpletime/TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getWhen()">getWhen</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>When</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isRelative()">isRelative</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Relative</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setRelative(boolean)">setRelative</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isRelative()"><code><em>Relative</em></code></a>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setWhen(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)">setWhen</a><wbr/>(<a href="../mdsimpletime/TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getWhen()"><code><em>When</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
<div class="block">Returns the value of the '<em><b>Relative</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Relative</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setRelative(boolean)"><code>setRelative(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getTimeEvent_Relative()</code></pre>
</details>
</li>
</ul>
</dd>
...
<h3>setRelative</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setRelative</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isRelative()"><code><em>Relative</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Relative</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isRelative()"><code>isRelative()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
</span><span class="return-type"><a href="../mdsimpletime/TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a></span> <span class="element-name">getWhen</span>()</div>
<div class="block">Returns the value of the '<em><b>When</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdsimpletime/TimeExpression.html#get_timeEventOfWhen()"><code><em>time Event Of When</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Specifies the time of the TimeEvent.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>When</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setWhen(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)"><code>setWhen(TimeExpression)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getTimeEvent_When()"><code>UMLPackage.getTimeEvent_When()</code></a></li>
<li><a href="../mdsimpletime/TimeExpression.html#get_timeEventOfWhen()"><code>TimeExpression.get_timeEventOfWhen()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_timeEventOfWhen" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setWhen(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime.TimeExpression)">
<h3>setWhen</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setWhen</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdsimpletime/TimeExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">TimeExpression</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getWhen()"><code><em>When</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>When</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getWhen()"><code>getWhen()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
