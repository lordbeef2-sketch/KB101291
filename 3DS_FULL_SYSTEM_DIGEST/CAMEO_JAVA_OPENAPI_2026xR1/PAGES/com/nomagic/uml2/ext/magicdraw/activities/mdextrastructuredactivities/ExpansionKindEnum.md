# JAVA OPENAPI: ExpansionKindEnum (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionKindEnum.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionKindEnum.html`
- source_sha256: `bb437ae2208af30248ffef0d562d7458102b77be61725a0eb703b69bf11a0b83`
- captured_utc: `2026-07-14T16:46:26.427152+00:00`
...
`[ExpansionKind](ExpansionKind.html)`, `[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `javax.jmi.reflect.RefEnum`, `org.eclipse.emf.common.util.Enumerator`
...
get
public static [ExpansionKindEnum](ExpansionKindEnum.html) get([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) literal)
Returns the '***Expansion Kind***' literal with the specified literal value.
 begin-user-doc 
 end-user-doc
Generated:
getByName
public static [ExpansionKindEnum](ExpansionKindEnum.html) getByName([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the '***Expansion Kind***' literal with the specified name.
 begin-user-doc 
 end-user-doc
Generated:
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getExpansionKindEnum()</code></pre>
</details>
</li>
