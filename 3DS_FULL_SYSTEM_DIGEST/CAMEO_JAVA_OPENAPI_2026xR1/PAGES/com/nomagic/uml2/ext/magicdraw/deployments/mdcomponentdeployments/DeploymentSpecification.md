# JAVA OPENAPI: DeploymentSpecification (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/deployments/mdcomponentdeployments/DeploymentSpecification.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdcomponentdeployments/DeploymentSpecification.html`
- source_sha256: `1246de9954a240a319deee6420199e480805468f72867ec13680277db42a7006`
- captured_utc: `2026-07-14T16:46:32.064227+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.uml2.ext.magicdraw.deployments.mdcomponentdeployments](package-summary.html)

## Interface DeploymentSpecification

All Superinterfaces:
`[Artifact](../mdartifacts/Artifact.html)`, `[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Classifier](../../classes/mdkernel/Classifier.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[DeployedArtifact](../mdnodes/DeployedArtifact.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `[Namespace](../../classes/mdkernel/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[PackageableElement](../../classes/mdkernel/PackageableElement.html)`, `[ParameterableElement](../../auxiliaryconstructs/mdtemplates/ParameterableElement.html)`, `[RedefinableElement](../../classes/mdkernel/RedefinableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`, `[TemplateableElement](../../auxiliaryconstructs/mdtemplates/TemplateableElement.html)`, `[Type](../../classes/mdkernel/Type.html)`

public interfaceDeploymentSpecificationextends [Artifact](../mdartifacts/Artifact.html)

begin-user-doc 
 A representation of the model object '***Deployment Specification***'.
 end-user-doc 
begin-model-doc 
 A deployment specification specifies a set of properties that determine execution parameters of a component artifact that is deployed on a node. A deployment
 specification can be aimed at a specific type of container. An artifact that reifies or implements deployment specification properties is a deployment descriptor.
 end-model-doc 
The following features are supported:
 [`*Deployment Location*`](#getDeploymentLocation())
[`*Execution Location*`](#getExecutionLocation())
[`*Deployment*`](#getDeployment())

See Also:
[`UMLPackage.getDeploymentSpecification()`](../../metadata/UMLPackage.html#getDeploymentSpecification())
Model:
...
Method
Description
`[Deployment](../mdnodes/Deployment.html)`
`[getDeployment](#getDeployment())()`
Returns the value of the '***Deployment***' container reference.
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getDeploymentLocation](#getDeploymentLocation())()`
Returns the value of the '***Deployment Location***' attribute.
`[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html)`
`[getExecutionLocation](#getExecutionLocation())()`
Returns the value of the '***Execution Location***' attribute.
`void`
`[setDeployment](#setDeployment(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Deployment))([Deployment](../mdnodes/Deployment.html) value)`
Sets the value of the '[`*Deployment*`](#getDeployment())'
 container reference.
`void`
`[setDeploymentLocation](#setDeploymentLocation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the
 '[`*Deployment Location*`](#getDeploymentLocation())' attribute.
`void`
`[setExecutionLocation](#setExecutionLocation(java.lang.String))([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) value)`
Sets the value of the
 '[`*Execution Location*`](#getExecutionLocation())' attribute.
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts.[Artifact](../mdartifacts/Artifact.html)
`[get_artifactOfNestedArtifact](../mdartifacts/Artifact.html#get_artifactOfNestedArtifact()), [getFileName](../mdartifacts/Artifact.html#getFileName()), [getManifestation](../mdartifacts/Artifact.html#getManifestation()), [getNestedArtifact](../mdartifacts/Artifact.html#getNestedArtifact()), [getOwnedAttribute](../mdartifacts/Artifact.html#getOwnedAttribute()), [getOwnedOperation](../mdartifacts/Artifact.html#getOwnedOperation()), [hasManifestation](../mdartifacts/Artifact.html#hasManifestation()), [hasNestedArtifact](../mdartifacts/Artifact.html#hasNestedArtifact()), [hasOwnedAttribute](../mdartifacts/Artifact.html#hasOwnedAttribute()), [hasOwnedOperation](../mdartifacts/Artifact.html#hasOwnedOperation()), [set_artifactOfNestedArtifact](../mdartifacts/Artifact.html#set_artifactOfNestedArtifact(com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts.Artifact)), [setFileName](../mdartifacts/Artifact.html#setFileName(java.lang.String))`
...
@CheckForNull[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getDeploymentLocation()
Returns the value of the '***Deployment Location***' attribute.
...
See Also:
[`setDeploymentLocation(String)`](#setDeploymentLocation(java.lang.String))
[`UMLPackage.getDeploymentSpecification_DeploymentLocation()`](../../metadata/UMLPackage.html#getDeploymentSpecification_DeploymentLocation())
Model:
...
@CheckForNull[String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getExecutionLocation()
Returns the value of the '***Execution Location***' attribute.
 The default value is `""`.
 begin-user-doc 
 end-user-doc 
...
See Also:
[`setExecutionLocation(String)`](#setExecutionLocation(java.lang.String))
[`UMLPackage.getDeploymentSpecification_ExecutionLocation()`](../../metadata/UMLPackage.html#getDeploymentSpecification_ExecutionLocation())
Model:
default="" dataType="com.nomagic.uml2.ext.magicdraw.String" ordered="false"
Generated:
...
Generated:
getDeployment
@CheckForNull[Deployment](../mdnodes/Deployment.html) getDeployment()
Returns the value of the '***Deployment***' container reference.
 It is bidirectional and its opposite is '[`*Configuration*`](../mdnodes/Deployment.html#getConfiguration())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setDeployment(Deployment)`](#setDeployment(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Deployment))
[`UMLPackage.getDeploymentSpecification_Deployment()`](../../metadata/UMLPackage.html#getDeploymentSpecification_Deployment())
[`Deployment.getConfiguration()`](../mdnodes/Deployment.html#getConfiguration())
Model:
opposite="configuration" transient="false" ordered="false"
Generated:
setDeployment
void setDeployment(@CheckForNull
 [Deployment](../mdnodes/Deployment.html) value)
Sets the value of the '[`*Deployment*`](#getDeployment())'
 container reference.
 begin-user-doc 
 end-user-doc
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getDeploymentLocation()"><code><em>Deployment Location</em></code></a></li>
<li><a href="#getExecutionLocation()"><code><em>Execution Location</em></code></a></li>
<li><a href="#getDeployment()"><code><em>Deployment</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getDeploymentSpecification()"><code>UMLPackage.getDeploymentSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>annotation="MOF package='deployments.mdcomponentdeployments'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdnodes/Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDeployment()">getDeployment</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Deployment</b></em>' container reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDeploymentLocation()">getDeploymentLocation</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Deployment Location</b></em>' attribute.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExecutionLocation()">getExecutionLocation</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Execution Location</b></em>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDeployment(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Deployment)">setDeployment</a><wbr/>(<a href="../mdnodes/Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getDeployment()"><code><em>Deployment</em></code></a>'
 container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDeploymentLocation(java.lang.String)">setDeploymentLocation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#getDeploymentLocation()"><code><em>Deployment Location</em></code></a>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setExecutionLocation(java.lang.String)">setExecutionLocation</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the
 '<a href="#getExecutionLocation()"><code><em>Execution Location</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts.Artifact">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts.<a href="../mdartifacts/Artifact.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts">Artifact</a></h3>
<code><a href="../mdartifacts/Artifact.html#get_artifactOfNestedArtifact()">get_artifactOfNestedArtifact</a>, <a href="../mdartifacts/Artifact.html#getFileName()">getFileName</a>, <a href="../mdartifacts/Artifact.html#getManifestation()">getManifestation</a>, <a href="../mdartifacts/Artifact.html#getNestedArtifact()">getNestedArtifact</a>, <a href="../mdartifacts/Artifact.html#getOwnedAttribute()">getOwnedAttribute</a>, <a href="../mdartifacts/Artifact.html#getOwnedOperation()">getOwnedOperation</a>, <a href="../mdartifacts/Artifact.html#hasManifestation()">hasManifestation</a>, <a href="../mdartifacts/Artifact.html#hasNestedArtifact()">hasNestedArtifact</a>, <a href="../mdartifacts/Artifact.html#hasOwnedAttribute()">hasOwnedAttribute</a>, <a href="../mdartifacts/Artifact.html#hasOwnedOperation()">hasOwnedOperation</a>, <a href="../mdartifacts/Artifact.html#set_artifactOfNestedArtifact(com.nomagic.uml2.ext.magicdraw.deployments.mdartifacts.Artifact)">set_artifactOfNestedArtifact</a>, <a href="../mdartifacts/Artifact.html#setFileName(java.lang.String)">setFileName</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getDeploymentLocation()">
<h3>getDeploymentLocation</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getDeploymentLocation</span>()</div>
<div class="block">Returns the value of the '<em><b>Deployment Location</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Deployment Location</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDeploymentLocation(java.lang.String)"><code>setDeploymentLocation(String)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDeploymentSpecification_DeploymentLocation()"><code>UMLPackage.getDeploymentSpecification_DeploymentLocation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="setDeploymentLocation(java.lang.String)">
<h3>setDeploymentLocation</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDeploymentLocation</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the
 '<a href="#getDeploymentLocation()"><code><em>Deployment Location</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Deployment Location</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getDeploymentLocation()"><code>getDeploymentLocation()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getExecutionLocation()">
<h3>getExecutionLocation</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">getExecutionLocation</span>()</div>
<div class="block">Returns the value of the '<em><b>Execution Location</b></em>' attribute.
 The default value is <code>""</code>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Execution Location</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setExecutionLocation(java.lang.String)"><code>setExecutionLocation(String)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDeploymentSpecification_ExecutionLocation()"><code>UMLPackage.getDeploymentSpecification_ExecutionLocation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>default="" dataType="com.nomagic.uml2.ext.magicdraw.String" ordered="false"</dd>
...
<li>
<section class="detail" id="setExecutionLocation(java.lang.String)">
<h3>setExecutionLocation</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setExecutionLocation</span><wbr/><span class="parameters">(@CheckForNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> value)</span></div>
<div class="block">Sets the value of the
 '<a href="#getExecutionLocation()"><code><em>Execution Location</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Execution Location</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getExecutionLocation()"><code>getExecutionLocation()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getDeployment()">
<h3>getDeployment</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdnodes/Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a></span> <span class="element-name">getDeployment</span>()</div>
<div class="block">Returns the value of the '<em><b>Deployment</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="../mdnodes/Deployment.html#getConfiguration()"><code><em>Configuration</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The deployment with which the DeploymentSpecification is associated.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Deployment</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDeployment(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Deployment)"><code>setDeployment(Deployment)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDeploymentSpecification_Deployment()"><code>UMLPackage.getDeploymentSpecification_Deployment()</code></a></li>
<li><a href="../mdnodes/Deployment.html#getConfiguration()"><code>Deployment.getConfiguration()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="configuration" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setDeployment(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.Deployment)">
<h3>setDeployment</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDeployment</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdnodes/Deployment.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">Deployment</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getDeployment()"><code><em>Deployment</em></code></a>'
 container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Deployment</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getDeployment()"><code>getDeployment()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
