# JAVA OPENAPI: SignalEvent (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/SignalEvent.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdcommunications/SignalEvent.html`
- source_sha256: `2e7281a5ff8eab363ee39ff841db551f3b12ddce9fc421ca0fff04df5c41f408`
- captured_utc: `2026-07-14T16:46:30.975213+00:00`
...
public interfaceSignalEventextends [MessageEvent](MessageEvent.html)
...
See Also:
[`UMLPackage.getSignalEvent()`](../../metadata/UMLPackage.html#getSignalEvent())
Model:
...
Returns the value of the '***Signal***' reference.
 ...
 '[`*signal Event Of Signal*`](Signal.html#get_signalEventOfSignal())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getSignalEvent_Signal()`](../../metadata/UMLPackage.html#getSignalEvent_Signal())
[`Signal.get_signalEventOfSignal()`](Signal.html#get_signalEventOfSignal())
Model:
opposite="_signalEventOfSignal" required="true" ordered="false"
Generated:
setSignal
...
<h1 class="title" title="Interface SignalEvent">Interface SignalEvent</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">SignalEvent</span><span class="extends-implements">
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getSignalEvent()"><code>UMLPackage.getSignalEvent()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Signal</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="Signal.html#get_signalEventOfSignal()"><code><em>signal Event Of Signal</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The specific Signal that is associated with this SignalEvent.
...
<li><a href="../../metadata/UMLPackage.html#getSignalEvent_Signal()"><code>UMLPackage.getSignalEvent_Signal()</code></a></li>
<li><a href="Signal.html#get_signalEventOfSignal()"><code>Signal.get_signalEventOfSignal()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_signalEventOfSignal" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
