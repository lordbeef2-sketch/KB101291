# JAVA OPENAPI: AddStructuralFeatureValueAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/AddStructuralFeatureValueAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/AddStructuralFeatureValueAction.html`
- source_sha256: `3bd852ec674eb53895c1ac767fd6b35989c7686bd326b2091f5834c3b583351c`
- captured_utc: `2026-07-14T16:46:24.330124+00:00`
...
public interfaceAddStructuralFeatureValueActionextends [WriteStructuralFeatureAction](WriteStructuralFeatureAction.html)
...
See Also:
[`UMLPackage.getAddStructuralFeatureValueAction()`](../../metadata/UMLPackage.html#getAddStructuralFeatureValueAction())
Model:
...
Sets the value of the '[`*Insert At*`](#getInsertAt())'
 containment reference.
`void`
`[setReplaceAll](#setReplaceAll(boolean))(boolean value)`
Sets the value of the '[`*Replace All*`](#isReplaceAll())'
 attribute.
...
Returns the value of the '***Insert At***' containment reference.
 It is bidirectional and its opposite is '[`*add Structural Feature Value Action Of Insert At*`](../mdbasicactions/InputPin.html#get_addStructuralFeatureValueActionOfInsertAt())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 The InputPin that gives the position at which to insert the value in an ordered StructuralFeature. The type of the insertAt InputPin is UnlimitedNatural, but the
 value cannot be zero. It is omitted for unordered StructuralFeatures.
 end-model-doc
Returns:
...
[`UMLPackage.getAddStructuralFeatureValueAction_InsertAt()`](../../metadata/UMLPackage.html#getAddStructuralFeatureValueAction_InsertAt())
[`InputPin.get_addStructuralFeatureValueActionOfInsertAt()`](../mdbasicactions/InputPin.html#get_addStructuralFeatureValueActionOfInsertAt())
Model:
...
<h1 class="title" title="Interface AddStructuralFeatureValueAction">Interface AddStructuralFeatureValueAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">AddStructuralFeatureValueAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getAddStructuralFeatureValueAction()"><code>UMLPackage.getAddStructuralFeatureValueAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInsertAt()">getInsertAt</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Insert At</b></em>' containment reference.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getInsertAt()"><code><em>Insert At</em></code></a>'
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isReplaceAll()"><code><em>Replace All</em></code></a>'
 attribute.</div>
</div>
</div>
</div>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getAddStructuralFeatureValueAction_ReplaceAll()</code></pre>
</details>
</li>
</ul>
</dd>
...
<div class="block">Returns the value of the '<em><b>Insert At</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_addStructuralFeatureValueActionOfInsertAt()"><code><em>add Structural Feature Value Action Of Insert At</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that gives the position at which to insert the value in an ordered StructuralFeature. The type of the insertAt InputPin is UnlimitedNatural, but the
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Insert At</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setInsertAt(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)"><code>setInsertAt(InputPin)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getAddStructuralFeatureValueAction_InsertAt()"><code>UMLPackage.getAddStructuralFeatureValueAction_InsertAt()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_addStructuralFeatureValueActionOfInsertAt()"><code>InputPin.get_addStructuralFeatureValueActionOfInsertAt()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_addStructuralFeatureValueActionOfInsertAt" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Insert At</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
