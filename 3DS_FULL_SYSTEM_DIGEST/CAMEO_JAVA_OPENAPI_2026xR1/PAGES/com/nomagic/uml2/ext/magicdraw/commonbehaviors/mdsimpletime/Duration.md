# JAVA OPENAPI: Duration (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Duration.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdsimpletime/Duration.html`
- source_sha256: `f0743e7dca1bb8c5588e78966d11671b74ea64150d7e1994f243ee2f88349461`
- captured_utc: `2026-07-14T16:46:31.259216+00:00`
...
public interfaceDurationextends [ValueSpecification](../../classes/mdkernel/ValueSpecification.html)
...
[`*duration Interval Of Min*`](#get_durationIntervalOfMin())
[`*duration Interval Of Max*`](#get_durationIntervalOfMax())
[`*Expr*`](#getExpr())

See Also:
[`UMLPackage.getDuration()`](../../metadata/UMLPackage.html#getDuration())
Model:
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)>`
`[get_durationIntervalOfMax](#get_durationIntervalOfMax())()`
Returns the value of the '***duration Interval Of Max***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)>`
`[get_durationIntervalOfMin](#get_durationIntervalOfMin())()`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Observation](Observation.html)>`
`[getObservation](#getObservation())()`
Returns the value of the '***Observation***' reference list.
`boolean`
`[has_durationIntervalOfMax](#has_durationIntervalOfMax())()`

`boolean`
`[has_durationIntervalOfMin](#has_durationIntervalOfMin())()`
...
Returns the value of the '***Expr***' containment reference.
 It is bidirectional and its opposite is '[`*duration Of Expr*`](../../classes/mdkernel/ValueSpecification.html#get_durationOfExpr())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getDuration_Expr()`](../../metadata/UMLPackage.html#getDuration_Expr())
[`ValueSpecification.get_durationOfExpr()`](../../classes/mdkernel/ValueSpecification.html#get_durationOfExpr())
Model:
...
Generated:
getObservation
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Observation](Observation.html)> getObservation()
Returns the value of the '***Observation***' reference list.
 The list contents are of type [`Observation`](Observation.html).
 It is bidirectional and its opposite is
 '[`*duration Of Observation*`](Observation.html#get_durationOfObservation())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDuration_Observation()`](../../metadata/UMLPackage.html#getDuration_Observation())
[`Observation.get_durationOfObservation()`](Observation.html#get_durationOfObservation())
Model:
opposite="_durationOfObservation" ordered="false"
Generated:
get_durationIntervalOfMax
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)> get_durationIntervalOfMax()
Returns the value of the '***duration Interval Of Max***' reference list.
 The list contents are of type [`DurationInterval`](DurationInterval.html).
 It is bidirectional and its opposite is '[`*Max*`](DurationInterval.html#getMax())'.
 begin-user-doc 
If the meaning of the '*duration Interval Of Max*' reference list isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*duration Interval Of Max*' reference list.
See Also:
[`UMLPackage.getDuration__durationIntervalOfMax()`](../../metadata/UMLPackage.html#getDuration__durationIntervalOfMax())
[`DurationInterval.getMax()`](DurationInterval.html#getMax())
Model:
opposite="max" volatile="true" ordered="false"
Generated:
get_durationIntervalOfMin
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DurationInterval](DurationInterval.html)> get_durationIntervalOfMin()
Returns the value of the '***duration Interval Of Min***' reference list.
 The list contents are of type [`DurationInterval`](DurationInterval.html).
 It is bidirectional and its opposite is '[`*Min*`](DurationInterval.html#getMin())'.
 begin-user-doc 
If the meaning of the '*duration Interval Of Min*' reference list isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*duration Interval Of Min*' reference list.
See Also:
[`UMLPackage.getDuration__durationIntervalOfMin()`](../../metadata/UMLPackage.html#getDuration__durationIntervalOfMin())
[`DurationInterval.getMin()`](DurationInterval.html#getMin())
Model:
...
<h1 class="title" title="Interface Duration">Interface Duration</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Duration</span><span class="extends-implements">
...
<li><a href="#get_durationIntervalOfMin()"><code><em>duration Interval Of Min</em></code></a></li>
<li><a href="#get_durationIntervalOfMax()"><code><em>duration Interval Of Max</em></code></a></li>
...
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getDuration()"><code>UMLPackage.getDuration()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_durationIntervalOfMax()">get_durationIntervalOfMax</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>duration Interval Of Max</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_durationIntervalOfMin()">get_durationIntervalOfMin</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>duration Interval Of Min</b></em>' reference list.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExpr()">getExpr</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Expr</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="Observation.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">Observation</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getObservation()">getObservation</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Observation</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_durationIntervalOfMax()">has_durationIntervalOfMax</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_durationIntervalOfMin()">has_durationIntervalOfMin</a>()</code></div>
...
<div class="block">Returns the value of the '<em><b>Expr</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/ValueSpecification.html#get_durationOfExpr()"><code><em>duration Of Expr</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A ValueSpecification that evaluates to the value of the Duration.
...
<li><a href="../../metadata/UMLPackage.html#getDuration_Expr()"><code>UMLPackage.getDuration_Expr()</code></a></li>
<li><a href="../../classes/mdkernel/ValueSpecification.html#get_durationOfExpr()"><code>ValueSpecification.get_durationOfExpr()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationOfExpr" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Observation</b></em>' reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="Observation.html#get_durationOfObservation()"><code><em>duration Of Observation</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Refers to the Observations that are involved in the computation of the Duration value
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDuration_Observation()"><code>UMLPackage.getDuration_Observation()</code></a></li>
<li><a href="Observation.html#get_durationOfObservation()"><code>Observation.get_durationOfObservation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_durationOfObservation" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_durationIntervalOfMax()">
<h3>get_durationIntervalOfMax</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a>&gt;</span> <span class="element-name">get_durationIntervalOfMax</span>()</div>
<div class="block">Returns the value of the '<em><b>duration Interval Of Max</b></em>' reference list.
 The list contents are of type <a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime"><code>DurationInterval</code></a>.
 It is bidirectional and its opposite is '<a href="DurationInterval.html#getMax()"><code><em>Max</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>duration Interval Of Max</em>' reference list isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>duration Interval Of Max</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDuration__durationIntervalOfMax()"><code>UMLPackage.getDuration__durationIntervalOfMax()</code></a></li>
<li><a href="DurationInterval.html#getMax()"><code>DurationInterval.getMax()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="get_durationIntervalOfMin()">
<h3>get_durationIntervalOfMin</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime">DurationInterval</a>&gt;</span> <span class="element-name">get_durationIntervalOfMin</span>()</div>
<div class="block">Returns the value of the '<em><b>duration Interval Of Min</b></em>' reference list.
 The list contents are of type <a href="DurationInterval.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdsimpletime"><code>DurationInterval</code></a>.
 It is bidirectional and its opposite is '<a href="DurationInterval.html#getMin()"><code><em>Min</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>duration Interval Of Min</em>' reference list isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>duration Interval Of Min</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDuration__durationIntervalOfMin()"><code>UMLPackage.getDuration__durationIntervalOfMin()</code></a></li>
<li><a href="DurationInterval.html#getMin()"><code>DurationInterval.getMin()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<li>
<section class="detail" id="has_durationIntervalOfMax()">
<h3>has_durationIntervalOfMax</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_durationIntervalOfMax</span>()
                           throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
...
<li>
<section class="detail" id="has_durationIntervalOfMin()">
<h3>has_durationIntervalOfMin</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_durationIntervalOfMin</span>()
                           throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
