# JAVA OPENAPI: DecisionNode (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdintermediateactivities/DecisionNode.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdintermediateactivities/DecisionNode.html`
- source_sha256: `45cef944591027e333e1e76c4d0f070368f53066451ada39fad5e39fe124f76d`
- captured_utc: `2026-07-14T16:46:26.852157+00:00`
...
All Superinterfaces:
`[ActivityNode](../mdfundamentalactivities/ActivityNode.html)`, `[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[ControlNode](../mdbasicactivities/ControlNode.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[RedefinableElement](../../classes/mdkernel/RedefinableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`

public interfaceDecisionNodeextends [ControlNode](../mdbasicactivities/ControlNode.html)
...
The following features are supported:
 [`*Decision Input*`](#getDecisionInput())
[`*Decision Input Flow*`](#getDecisionInputFlow())

See Also:
[`UMLPackage.getDecisionNode()`](../../metadata/UMLPackage.html#getDecisionNode())
Model:
...
`[getDecisionInput](#getDecisionInput())()`
Returns the value of the '***Decision Input***' reference.
`[ObjectFlow](../mdbasicactivities/ObjectFlow.html)`
`[getDecisionInputFlow](#getDecisionInputFlow())()`
Returns the value of the '***Decision Input Flow***' reference.
`void`
`[setDecisionInput](#setDecisionInput(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))([Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) value)`
Sets the value of the '[`*Decision Input*`](#getDecisionInput())'
 reference.
`void`
`[setDecisionInputFlow](#setDecisionInputFlow(com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectFlow))([ObjectFlow](../mdbasicactivities/ObjectFlow.html) value)`
Sets the value of the '[`*Decision Input Flow*`](#getDecisionInputFlow())'
 reference.
...
Method Details
getDecisionInput
@CheckForNull[Behavior](../../commonbehaviors/mdbasicbehaviors/Behavior.html) getDecisionInput()
Returns the value of the '***Decision Input***' reference.
 It is bidirectional and its opposite is
 '[`*decision Node Of Decision Input*`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_decisionNodeOfDecisionInput())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setDecisionInput(Behavior)`](#setDecisionInput(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior))
[`UMLPackage.getDecisionNode_DecisionInput()`](../../metadata/UMLPackage.html#getDecisionNode_DecisionInput())
[`Behavior.get_decisionNodeOfDecisionInput()`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_decisionNodeOfDecisionInput())
Model:
opposite="_decisionNodeOfDecisionInput" ordered="false"
Generated:
setDecisionInput
void setDecisionInput(@CheckForNull
...
@CheckForNull[ObjectFlow](../mdbasicactivities/ObjectFlow.html) getDecisionInputFlow()
Returns the value of the '***Decision Input Flow***' reference.
 It is bidirectional and its opposite is '[`*decision Node Of Decision Input Flow*`](../mdbasicactivities/ObjectFlow.html#get_decisionNodeOfDecisionInputFlow())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 An additional ActivityEdge incoming to the DecisionNode that provides a decision input value for the guards ValueSpecifications on ActivityEdges outgoing from
 the DecisionNode.
 end-model-doc
Returns:
the value of the '*Decision Input Flow*' reference.
See Also:
[`setDecisionInputFlow(ObjectFlow)`](#setDecisionInputFlow(com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectFlow))
[`UMLPackage.getDecisionNode_DecisionInputFlow()`](../../metadata/UMLPackage.html#getDecisionNode_DecisionInputFlow())
[`ObjectFlow.get_decisionNodeOfDecisionInputFlow()`](../mdbasicactivities/ObjectFlow.html#get_decisionNodeOfDecisionInputFlow())
Model:
opposite="_decisionNodeOfDecisionInputFlow" ordered="false"
Generated:
setDecisionInputFlow
void setDecisionInputFlow(@CheckForNull
 [ObjectFlow](../mdbasicactivities/ObjectFlow.html) value)
Sets the value of the '[`*Decision Input Flow*`](#getDecisionInputFlow())'
 reference.
 begin-user-doc 
 end-user-doc
Parameters:
`value` - the new value of the '*Decision Input Flow*' reference.
See Also:
[`getDecisionInputFlow()`](#getDecisionInputFlow())
Generated:
...
<h1 class="title" title="Interface DecisionNode">Interface DecisionNode</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">DecisionNode</span><span class="extends-implements">
extends <a href="../mdbasicactivities/ControlNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ControlNode</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getDecisionInput()"><code><em>Decision Input</em></code></a></li>
<li><a href="#getDecisionInputFlow()"><code><em>Decision Input Flow</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getDecisionNode()"><code>UMLPackage.getDecisionNode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDecisionInput()">getDecisionInput</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Decision Input</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdbasicactivities/ObjectFlow.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ObjectFlow</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDecisionInputFlow()">getDecisionInputFlow</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Decision Input Flow</b></em>' reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDecisionInput(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">setDecisionInput</a><wbr/>(<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getDecisionInput()"><code><em>Decision Input</em></code></a>'
 reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDecisionInputFlow(com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectFlow)">setDecisionInputFlow</a><wbr/>(<a href="../mdbasicactivities/ObjectFlow.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ObjectFlow</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getDecisionInputFlow()"><code><em>Decision Input Flow</em></code></a>'
 reference.</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getDecisionInput()">
<h3>getDecisionInput</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html" title="interface in com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors">Behavior</a></span> <span class="element-name">getDecisionInput</span>()</div>
<div class="block">Returns the value of the '<em><b>Decision Input</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_decisionNodeOfDecisionInput()"><code><em>decision Node Of Decision Input</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 A Behavior that is executed to provide an input to guard ValueSpecifications on ActivityEdges outgoing from the DecisionNode.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Decision Input</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDecisionInput(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)"><code>setDecisionInput(Behavior)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDecisionNode_DecisionInput()"><code>UMLPackage.getDecisionNode_DecisionInput()</code></a></li>
<li><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_decisionNodeOfDecisionInput()"><code>Behavior.get_decisionNodeOfDecisionInput()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_decisionNodeOfDecisionInput" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setDecisionInput(com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdbasicbehaviors.Behavior)">
<h3>setDecisionInput</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDecisionInput</span><wbr/><span class="parameters">(@CheckForNull
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Decision Input</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getDecisionInput()"><code>getDecisionInput()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getDecisionInputFlow()">
<h3>getDecisionInputFlow</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../mdbasicactivities/ObjectFlow.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ObjectFlow</a></span> <span class="element-name">getDecisionInputFlow</span>()</div>
<div class="block">Returns the value of the '<em><b>Decision Input Flow</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactivities/ObjectFlow.html#get_decisionNodeOfDecisionInputFlow()"><code><em>decision Node Of Decision Input Flow</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An additional ActivityEdge incoming to the DecisionNode that provides a decision input value for the guards ValueSpecifications on ActivityEdges outgoing from
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Decision Input Flow</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDecisionInputFlow(com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectFlow)"><code>setDecisionInputFlow(ObjectFlow)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDecisionNode_DecisionInputFlow()"><code>UMLPackage.getDecisionNode_DecisionInputFlow()</code></a></li>
<li><a href="../mdbasicactivities/ObjectFlow.html#get_decisionNodeOfDecisionInputFlow()"><code>ObjectFlow.get_decisionNodeOfDecisionInputFlow()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_decisionNodeOfDecisionInputFlow" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setDecisionInputFlow(com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectFlow)">
<h3>setDecisionInputFlow</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDecisionInputFlow</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdbasicactivities/ObjectFlow.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities">ObjectFlow</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getDecisionInputFlow()"><code><em>Decision Input Flow</em></code></a>'
 reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Decision Input Flow</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getDecisionInputFlow()"><code>getDecisionInputFlow()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
