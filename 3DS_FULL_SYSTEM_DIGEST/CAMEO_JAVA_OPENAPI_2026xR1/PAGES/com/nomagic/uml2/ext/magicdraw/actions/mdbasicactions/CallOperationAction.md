# JAVA OPENAPI: CallOperationAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallOperationAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallOperationAction.html`
- source_sha256: `705df861c4b1ffbf8715f6703c1c60c0cc0337b3750be88cc9eabcab8fc3a3a6`
- captured_utc: `2026-07-14T16:46:23.575114+00:00`
...
public interfaceCallOperationActionextends [CallAction](CallAction.html)

begin-user-doc 
 A representation of the model object '***Call Operation Action***'.
 end-user-doc 
begin-model-doc 
 A CallOperationAction is a CallAction that transmits an Operation call request to the target object, where it may cause the invocation of associated Behavior. The
 argument values of the CallOperationAction are passed on the input Parameters of the Operation. If call is synchronous, the execution of the CallOperationAction
 waits until the execution of the invoked Operation completes and the values of output Parameters of the Operation are placed on the result OutputPins. If the call
 is asynchronous, the CallOperationAction completes immediately and no results values can be provided.
 end-model-doc 
...
See Also:
[`UMLPackage.getCallOperationAction()`](../../metadata/UMLPackage.html#getCallOperationAction())
Model:
...
`void`
`[setOperation](#setOperation(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Operation))([Operation](../../classes/mdkernel/Operation.html) value)`
Sets the value of the '[`*Operation*`](#getOperation())' reference.
`void`
...
Method Details
getOperation
@CheckForNull[Operation](../../classes/mdkernel/Operation.html) getOperation()
Returns the value of the '***Operation***' reference.
 It is bidirectional and its opposite is
 '[`*call Operation Action Of Operation*`](../../classes/mdkernel/Operation.html#get_callOperationActionOfOperation())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getCallOperationAction_Operation()`](../../metadata/UMLPackage.html#getCallOperationAction_Operation())
[`Operation.get_callOperationActionOfOperation()`](../../classes/mdkernel/Operation.html#get_callOperationActionOfOperation())
Model:
opposite="_callOperationActionOfOperation" required="true" ordered="false"
Generated:
setOperation
...
Returns the value of the '***Target***' containment reference.
 It is bidirectional and its opposite is
 '[`*call Operation Action Of Target*`](InputPin.html#get_callOperationActionOfTarget())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getCallOperationAction_Target()`](../../metadata/UMLPackage.html#getCallOperationAction_Target())
[`InputPin.get_callOperationActionOfTarget()`](InputPin.html#get_callOperationActionOfTarget())
Model:
opposite="_callOperationActionOfTarget" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setTarget
...
<h1 class="title" title="Interface CallOperationAction">Interface CallOperationAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">CallOperationAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getCallOperationAction()"><code>UMLPackage.getCallOperationAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Operation</b></em>' reference.</div>
</div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getOperation()"><code><em>Operation</em></code></a>' reference.</div>
</div>
...
</span><span class="return-type"><a href="../../classes/mdkernel/Operation.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Operation</a></span> <span class="element-name">getOperation</span>()</div>
<div class="block">Returns the value of the '<em><b>Operation</b></em>' reference.
 It is bidirectional and its opposite is
 '<a href="../../classes/mdkernel/Operation.html#get_callOperationActionOfOperation()"><code><em>call Operation Action Of Operation</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Operation being invoked.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Operation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setOperation(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Operation)"><code>setOperation(Operation)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getCallOperationAction_Operation()"><code>UMLPackage.getCallOperationAction_Operation()</code></a></li>
<li><a href="../../classes/mdkernel/Operation.html#get_callOperationActionOfOperation()"><code>Operation.get_callOperationActionOfOperation()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_callOperationActionOfOperation" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Sets the value of the '<a href="#getOperation()"><code><em>Operation</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Operation</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="block">Returns the value of the '<em><b>Target</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="InputPin.html#get_callOperationActionOfTarget()"><code><em>call Operation Action Of Target</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that provides the target object to which the Operation call request is sent.
...
<li><a href="../../metadata/UMLPackage.html#getCallOperationAction_Target()"><code>UMLPackage.getCallOperationAction_Target()</code></a></li>
<li><a href="InputPin.html#get_callOperationActionOfTarget()"><code>InputPin.get_callOperationActionOfTarget()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_callOperationActionOfTarget" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
