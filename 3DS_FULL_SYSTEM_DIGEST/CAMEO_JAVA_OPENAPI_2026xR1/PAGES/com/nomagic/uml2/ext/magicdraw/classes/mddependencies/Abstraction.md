# JAVA OPENAPI: Abstraction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/classes/mddependencies/Abstraction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/classes/mddependencies/Abstraction.html`
- source_sha256: `139c962c6adab67bc5c75020b9aa129a0a2272bbcd495141206f6baaff5ece6a`
- captured_utc: `2026-07-14T16:46:27.830170+00:00`
...
`[ComponentRealization](../../components/mdbasiccomponents/ComponentRealization.html)`, `[InterfaceRealization](../mdinterfaces/InterfaceRealization.html)`, `[Manifestation](../../deployments/mdartifacts/Manifestation.html)`, `[Realization](Realization.html)`, `[Substitution](Substitution.html)`

public interfaceAbstractionextends [Dependency](Dependency.html)

begin-user-doc 
 A representation of the model object '***Abstraction***'.
 end-user-doc 
begin-model-doc 
 An Abstraction is a Relationship that relates two Elements or sets of Elements that represent the same concept at different levels of abstraction or from different
 viewpoints.
 end-model-doc 
...
See Also:
[`UMLPackage.getAbstraction()`](../../metadata/UMLPackage.html#getAbstraction())
Model:
...
Method
Description
`[OpaqueExpression](../mdkernel/OpaqueExpression.html)`
`[getMapping](#getMapping())()`
Returns the value of the '***Mapping***' containment reference.
`void`
`[setMapping](#setMapping(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.OpaqueExpression))([OpaqueExpression](../mdkernel/OpaqueExpression.html) value)`
Sets the value of the '[`*Mapping*`](#getMapping())' containment reference.
...
Method Details
getMapping
@CheckForNull[OpaqueExpression](../mdkernel/OpaqueExpression.html) getMapping()
Returns the value of the '***Mapping***' containment reference.
 It is bidirectional and its opposite is
 '[`*abstraction Of Mapping*`](../mdkernel/OpaqueExpression.html#get_abstractionOfMapping())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 An OpaqueExpression that states the abstraction relationship between the supplier(s) and the client(s). In some cases, such as derivation, it is usually formal
 and unidirectional; in other cases, such as trace, it is usually informal and bidirectional. The mapping expression is optional and may be omitted if the precise
 relationship between the Elements is not specified.
 end-model-doc
Returns:
the value of the '*Mapping*' containment reference.
See Also:
[`setMapping(OpaqueExpression)`](#setMapping(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.OpaqueExpression))
[`UMLPackage.getAbstraction_Mapping()`](../../metadata/UMLPackage.html#getAbstraction_Mapping())
[`OpaqueExpression.get_abstractionOfMapping()`](../mdkernel/OpaqueExpression.html#get_abstractionOfMapping())
Model:
opposite="_abstractionOfMapping" containment="true" resolveProxies="true" ordered="false"
Generated:
setMapping
void setMapping(@CheckForNull
 [OpaqueExpression](../mdkernel/OpaqueExpression.html) value)
Sets the value of the '[`*Mapping*`](#getMapping())' containment reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
<h1 class="title" title="Interface Abstraction">Interface Abstraction</h1>
</div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getMapping()"><code><em>Mapping</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getAbstraction()"><code>UMLPackage.getAbstraction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../mdkernel/OpaqueExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">OpaqueExpression</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getMapping()">getMapping</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Mapping</b></em>' containment reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMapping(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.OpaqueExpression)">setMapping</a><wbr/>(<a href="../mdkernel/OpaqueExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">OpaqueExpression</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getMapping()"><code><em>Mapping</em></code></a>' containment reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../mdkernel/OpaqueExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">OpaqueExpression</a></span> <span class="element-name">getMapping</span>()</div>
<div class="block">Returns the value of the '<em><b>Mapping</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdkernel/OpaqueExpression.html#get_abstractionOfMapping()"><code><em>abstraction Of Mapping</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An OpaqueExpression that states the abstraction relationship between the supplier(s) and the client(s). In some cases, such as derivation, it is usually formal
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Mapping</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setMapping(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.OpaqueExpression)"><code>setMapping(OpaqueExpression)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getAbstraction_Mapping()"><code>UMLPackage.getAbstraction_Mapping()</code></a></li>
<li><a href="../mdkernel/OpaqueExpression.html#get_abstractionOfMapping()"><code>OpaqueExpression.get_abstractionOfMapping()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_abstractionOfMapping" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMapping(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.OpaqueExpression)">
<h3>setMapping</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setMapping</span><wbr/><span class="parameters">(@CheckForNull
 <a href="../mdkernel/OpaqueExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">OpaqueExpression</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getMapping()"><code><em>Mapping</em></code></a>' containment reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Mapping</em>' containment reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getMapping()"><code>getMapping()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
