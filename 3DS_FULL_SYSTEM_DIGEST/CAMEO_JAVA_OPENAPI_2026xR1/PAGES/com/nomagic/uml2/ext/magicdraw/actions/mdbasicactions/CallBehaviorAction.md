# JAVA OPENAPI: CallBehaviorAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallBehaviorAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdbasicactions/CallBehaviorAction.html`
- source_sha256: `c7fa66a3faa6110de5e2a5c09af7a576c0a4ce1c5e54343724667e9a229ea7a7`
- captured_utc: `2026-07-14T16:46:23.558112+00:00`
...
All Superinterfaces:
`[Action](Action.html)`, `[ActivityNode](../../activities/mdfundamentalactivities/ActivityNode.html)`, `[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[CallAction](CallAction.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[ExecutableNode](../../activities/mdstructuredactivities/ExecutableNode.html)`, `[InvocationAction](InvocationAction.html)`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[RedefinableElement](../../classes/mdkernel/RedefinableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`

public interfaceCallBehaviorActionextends [CallAction](CallAction.html)

begin-user-doc 
 A representation of the model object '***Call Behavior Action***'.
 end-user-doc 
begin-model-doc 
 A CallBehaviorAction is a CallAction that invokes a Behavior directly. The argument values of the CallBehaviorAction are passed on the input Parameters of the
 invoked Behavior. If the call is synchronous, the execution of the CallBehaviorAction waits until the execution of the invoked Behavior completes and the values of
 output Parameters of the Behavior are placed on the result OutputPins. If the call is asynchronous, the CallBehaviorAction completes immediately and no results
...
See Also:
[`UMLPackage.getCallBehaviorAction()`](../../metadata/UMLPackage.html#getCallBehaviorAction())
Model:
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.[CallAction](CallAction.html)
`[getResult](CallAction.html#getResult()), [hasResult](CallAction.html#hasResult()), [isSynchronous](CallAction.html#isSynchronous()), [setSynchronous](CallAction.html#setSynchronous(boolean))`
...
Returns the value of the '***Behavior***' reference.
 It is bidirectional and its opposite is '[`*call Behavior Action Of Behavior*`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_callBehaviorActionOfBehavior())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getCallBehaviorAction_Behavior()`](../../metadata/UMLPackage.html#getCallBehaviorAction_Behavior())
[`Behavior.get_callBehaviorActionOfBehavior()`](../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_callBehaviorActionOfBehavior())
Model:
opposite="_callBehaviorActionOfBehavior" required="true" ordered="false"
Generated:
setBehavior
...
<h1 class="title" title="Interface CallBehaviorAction">Interface CallBehaviorAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">CallBehaviorAction</span><span class="extends-implements">
extends <a href="CallAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">CallAction</a></span></div>
...
<li><a href="../../metadata/UMLPackage.html#getCallBehaviorAction()"><code>UMLPackage.getCallBehaviorAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.CallAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.<a href="CallAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">CallAction</a></h3>
<code><a href="CallAction.html#getResult()">getResult</a>, <a href="CallAction.html#hasResult()">hasResult</a>, <a href="CallAction.html#isSynchronous()">isSynchronous</a>, <a href="CallAction.html#setSynchronous(boolean)">setSynchronous</a></code></div>
<div class="inherited-list">
...
<div class="block">Returns the value of the '<em><b>Behavior</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_callBehaviorActionOfBehavior()"><code><em>call Behavior Action Of Behavior</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Behavior being invoked.
...
<li><a href="../../metadata/UMLPackage.html#getCallBehaviorAction_Behavior()"><code>UMLPackage.getCallBehaviorAction_Behavior()</code></a></li>
<li><a href="../../commonbehaviors/mdbasicbehaviors/Behavior.html#get_callBehaviorActionOfBehavior()"><code>Behavior.get_callBehaviorActionOfBehavior()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_callBehaviorActionOfBehavior" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
