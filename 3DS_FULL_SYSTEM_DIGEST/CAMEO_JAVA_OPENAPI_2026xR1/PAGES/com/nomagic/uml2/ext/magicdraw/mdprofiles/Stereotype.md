# JAVA OPENAPI: Stereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/mdprofiles/Stereotype.html
- source_path: `com/nomagic/uml2/ext/magicdraw/mdprofiles/Stereotype.html`
- source_sha256: `a8aae61f48887505202f9eab779eaa02f42ecf53ae517486ad0a0186adb94b7b`
- captured_utc: `2026-07-14T16:46:33.419244+00:00`
...
public interfaceStereotypeextends [Class](../classes/mdkernel/Class.html)
...
The following features are supported:
 [`*extension End Of Type*`](#get_extensionEndOfType())
[`*Icon*`](#getIcon())
[`*Profile*`](#getProfile())

See Also:
[`UMLPackage.getStereotype()`](../metadata/UMLPackage.html#getStereotype())
Model:
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExtensionEnd](ExtensionEnd.html)>`
`[get_extensionEndOfType](#get_extensionEndOfType())()`
Returns the value of the '***extension End Of Type***' reference list.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../classes/mdkernel/Element.html)>`
`[get_stereotypedElement](#get_stereotypedElement())()`
Returns the value of the '***Stereotyped Element***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Image](Image.html)>`
`[getIcon](#getIcon())()`
...
`boolean`
`[has_extensionEndOfType](#has_extensionEndOfType())()`

`boolean`
`[has_stereotypedElement](#has_stereotypedElement())()`
...
Method Details
getIcon
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Image](Image.html)> getIcon()
Returns the value of the '***Icon***' containment reference list.
 The list contents are of type [`Image`](Image.html).
 It is bidirectional and its opposite is '[`*stereotype Of Icon*`](Image.html#get_stereotypeOfIcon())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 Stereotype can change the graphical appearance of the extended model element by using attached icons. When this association is not null, it references the
 location of the icon content to be displayed within diagrams presenting the extended model elements.
 end-model-doc
Returns:
the value of the '*Icon*' containment reference list.
See Also:
[`UMLPackage.getStereotype_Icon()`](../metadata/UMLPackage.html#getStereotype_Icon())
[`Image.get_stereotypeOfIcon()`](Image.html#get_stereotypeOfIcon())
Model:
opposite="_stereotypeOfIcon" containment="true" resolveProxies="true" ordered="false"
Generated:
getProfile
@CheckForNull[Profile](Profile.html) getProfile()
Returns the value of the '***Profile***' reference.
 It is bidirectional and its opposite is '
invalid reference
`*stereotype Of Profile*`
'.
 begin-user-doc 
If the meaning of the '*Profile*' reference isn't clear,
...
See Also:
[`UMLPackage.getStereotype_Profile()`](../metadata/UMLPackage.html#getStereotype_Profile())
invalid reference
`com.nomagic.uml2.ext.magicdraw.mdprofiles.Profile#get_stereotypeOfProfile`
Model:
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExtensionEnd](ExtensionEnd.html)> get_extensionEndOfType()
Returns the value of the '***extension End Of Type***' reference list.
 The list contents are of type [`ExtensionEnd`](ExtensionEnd.html).
 It is bidirectional and its opposite is '[`*Type*`](ExtensionEnd.html#getType())'.
 begin-user-doc 
If the meaning of the '*extension End Of Type*' reference list isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*extension End Of Type*' reference list.
See Also:
[`UMLPackage.getStereotype__extensionEndOfType()`](../metadata/UMLPackage.html#getStereotype__extensionEndOfType())
[`ExtensionEnd.getType()`](ExtensionEnd.html#getType())
Model:
opposite="type" volatile="true" ordered="false"
Generated:
get_stereotypedElement
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../classes/mdkernel/Element.html)> get_stereotypedElement()
Returns the value of the '***Stereotyped Element***' reference list.
 The list contents are of type [`Element`](../classes/mdkernel/Element.html).
 It is bidirectional and its opposite is '[`*Applied Stereotype*`](../classes/mdkernel/Element.html#getAppliedStereotype())'.
 begin-user-doc 
 end-user-doc
Returns:
...
See Also:
invalid reference
`UMLPackage#getStereotype__stereotypedElement()`
[`Element.getAppliedStereotype()`](../classes/mdkernel/Element.html#getAppliedStereotype())
Model:
...
<h1 class="title" title="Interface Stereotype">Interface Stereotype</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Stereotype</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#get_extensionEndOfType()"><code><em>extension End Of Type</em></code></a></li>
<li><a href="#getIcon()"><code><em>Icon</em></code></a></li>
<li><a href="#getProfile()"><code><em>Profile</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../metadata/UMLPackage.html#getStereotype()"><code>UMLPackage.getStereotype()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExtensionEnd.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">ExtensionEnd</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_extensionEndOfType()">get_extensionEndOfType</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>extension End Of Type</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_stereotypedElement()">get_stereotypedElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Stereotyped Element</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="Image.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">Image</a>&gt;</code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Icon</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Profile.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">Profile</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getProfile()">getProfile</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Profile</b></em>' reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_extensionEndOfType()">has_extensionEndOfType</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#has_stereotypedElement()">has_stereotypedElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasIcon()">hasIcon</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
</div>
</div>
</div>
...
<h3>getIcon</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="Image.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">Image</a>&gt;</span> <span class="element-name">getIcon</span>()</div>
<div class="block">Returns the value of the '<em><b>Icon</b></em>' containment reference list.
 The list contents are of type <a href="Image.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles"><code>Image</code></a>.
 It is bidirectional and its opposite is '<a href="Image.html#get_stereotypeOfIcon()"><code><em>stereotype Of Icon</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Stereotype can change the graphical appearance of the extended model element by using attached icons. When this association is not null, it references the
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Icon</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../metadata/UMLPackage.html#getStereotype_Icon()"><code>UMLPackage.getStereotype_Icon()</code></a></li>
<li><a href="Image.html#get_stereotypeOfIcon()"><code>Image.get_stereotypeOfIcon()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_stereotypeOfIcon" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
</span><span class="return-type"><a href="Profile.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">Profile</a></span> <span class="element-name">getProfile</span>()</div>
<div class="block">Returns the value of the '<em><b>Profile</b></em>' reference.
 It is bidirectional and its opposite is '
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code><em>stereotype Of Profile</em></code></pre>
</details>
'.
 <!-- begin-user-doc -->
<p>
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Profile</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../metadata/UMLPackage.html#getStereotype_Profile()"><code>UMLPackage.getStereotype_Profile()</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.mdprofiles.Profile#get_stereotypeOfProfile</code></pre>
</details>
</li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_stereotypeOfProfile" required="true" transient="true" changeable="false" volatile="true" derived="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_extensionEndOfType()">
<h3>get_extensionEndOfType</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ExtensionEnd.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles">ExtensionEnd</a>&gt;</span> <span class="element-name">get_extensionEndOfType</span>()</div>
<div class="block">Returns the value of the '<em><b>extension End Of Type</b></em>' reference list.
 The list contents are of type <a href="ExtensionEnd.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdprofiles"><code>ExtensionEnd</code></a>.
 It is bidirectional and its opposite is '<a href="ExtensionEnd.html#getType()"><code><em>Type</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>extension End Of Type</em>' reference list isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>extension End Of Type</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../metadata/UMLPackage.html#getStereotype__extensionEndOfType()"><code>UMLPackage.getStereotype__extensionEndOfType()</code></a></li>
<li><a href="ExtensionEnd.html#getType()"><code>ExtensionEnd.getType()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="type" volatile="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="get_stereotypedElement()">
<h3>get_stereotypedElement</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Element</a>&gt;</span> <span class="element-name">get_stereotypedElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Stereotyped Element</b></em>' reference list.
 The list contents are of type <a href="../classes/mdkernel/Element.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel"><code>Element</code></a>.
 It is bidirectional and its opposite is '<a href="../classes/mdkernel/Element.html#getAppliedStereotype()"><code><em>Applied Stereotype</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Stereotyped Element</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>UMLPackage#getStereotype__stereotypedElement()</code></pre>
</details>
</li>
<li><a href="../classes/mdkernel/Element.html#getAppliedStereotype()"><code>Element.getAppliedStereotype()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="appliedStereotype" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="has_stereotypedElement()">
<h3>has_stereotypedElement</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_stereotypedElement</span>()</div>
</section>
</li>
<li>
<section class="detail" id="hasIcon()">
<h3>hasIcon</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasIcon</span>()
...
<li>
<section class="detail" id="has_extensionEndOfType()">
<h3>has_extensionEndOfType</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">has_extensionEndOfType</span>()
                        throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
