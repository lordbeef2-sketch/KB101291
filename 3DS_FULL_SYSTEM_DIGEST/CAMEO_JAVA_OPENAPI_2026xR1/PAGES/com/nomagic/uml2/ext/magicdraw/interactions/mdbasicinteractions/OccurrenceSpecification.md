# JAVA OPENAPI: OccurrenceSpecification (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/OccurrenceSpecification.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/OccurrenceSpecification.html`
- source_sha256: `0556c2bf3509565e57cc2750189b47ff03e10429b67426d57d7b11582531eae2`
- captured_utc: `2026-07-14T16:46:32.800235+00:00`
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutionSpecification](ExecutionSpecification.html)>`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[GeneralOrdering](GeneralOrdering.html)>`
...
Method Details
getToBefore
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[GeneralOrdering](GeneralOrdering.html)> getToBefore()
Returns the value of the '***To Before***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutionSpecification](ExecutionSpecification.html)> get_executionSpecificationOfFinish()
Returns the value of the '***execution Specification Of Finish***' reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutionSpecification](ExecutionSpecification.html)> get_executionSpecificationOfStart()
Returns the value of the '***execution Specification Of Start***' reference list.
 The list contents are of type [`ExecutionSpecification`](ExecutionSpecification.html).
...
Generated:
getToAfter
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[GeneralOrdering](GeneralOrdering.html)> getToAfter()
Returns the value of the '***To After***' reference list.
 The list contents are of type [`GeneralOrdering`](GeneralOrdering.html).
