# JAVA OPENAPI: Clause (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdstructuredactivities/Clause.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdstructuredactivities/Clause.html`
- source_sha256: `4807ca40eaaebc06484d82642d2bc9f4c0cc57d927f044429839e4c8221eb372`
- captured_utc: `2026-07-14T16:46:27.068161+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Clause](Clause.html)>`
...
Generated:
getBody
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExecutableNode](ExecutableNode.html)> getBody()
Returns the value of the '***Body***' reference list.
 The list contents are of type [`ExecutableNode`](ExecutableNode.html).
 It is bidirectional and its opposite is
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Clause](Clause.html)> getPredecessorClause()
Returns the value of the '***Predecessor Clause***' reference list.
...
Generated:
getSuccessorClause
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Clause](Clause.html)> getSuccessorClause()
Returns the value of the '***Successor Clause***' reference list.
 The list contents are of type [`Clause`](Clause.html).
 It is bidirectional and its opposite is
 '[`*Predecessor Clause*`](#getPredecessorClause())'.
