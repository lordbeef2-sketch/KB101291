# JAVA OPENAPI: ActionExecutionSpecification (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/ActionExecutionSpecification.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/ActionExecutionSpecification.html`
- source_sha256: `e1aca67c7add3869e23180acd1d71a436938d5777b2598b79db8f194083560b5`
- captured_utc: `2026-07-14T16:46:32.281230+00:00`
...
public interfaceActionExecutionSpecificationextends [ExecutionSpecification](ExecutionSpecification.html)
...
See Also:
[`UMLPackage.getActionExecutionSpecification()`](../../metadata/UMLPackage.html#getActionExecutionSpecification())
Model:
...
`void`
`[setAction](#setAction(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Action))([Action](../../actions/mdbasicactions/Action.html) value)`
Sets the value of the '[`*Action*`](#getAction())' reference.
...
Method Details
getAction
@CheckForNull[Action](../../actions/mdbasicactions/Action.html) getAction()
Returns the value of the '***Action***' reference.
 It is bidirectional and its opposite is '[`*action
 Execution Specification Of Action*`](../../actions/mdbasicactions/Action.html#get_actionExecutionSpecificationOfAction())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setAction(Action)`](#setAction(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Action))
[`UMLPackage.getActionExecutionSpecification_Action()`](../../metadata/UMLPackage.html#getActionExecutionSpecification_Action())
[`Action.get_actionExecutionSpecificationOfAction()`](../../actions/mdbasicactions/Action.html#get_actionExecutionSpecificationOfAction())
Model:
opposite="_actionExecutionSpecificationOfAction" required="true" ordered="false"
Generated:
setAction
void setAction(@CheckForNull
...
<h1 class="title" title="Interface ActionExecutionSpecification">Interface ActionExecutionSpecification</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ActionExecutionSpecification</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getActionExecutionSpecification()"><code>UMLPackage.getActionExecutionSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Action</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setAction(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Action)">setAction</a><wbr/>(<a href="../../actions/mdbasicactions/Action.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Action</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getAction()"><code><em>Action</em></code></a>' reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="../../actions/mdbasicactions/Action.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions">Action</a></span> <span class="element-name">getAction</span>()</div>
<div class="block">Returns the value of the '<em><b>Action</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../actions/mdbasicactions/Action.html#get_actionExecutionSpecificationOfAction()"><code><em>action
 Execution Specification Of Action</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 Action whose execution is occurring.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Action</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setAction(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Action)"><code>setAction(Action)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getActionExecutionSpecification_Action()"><code>UMLPackage.getActionExecutionSpecification_Action()</code></a></li>
<li><a href="../../actions/mdbasicactions/Action.html#get_actionExecutionSpecificationOfAction()"><code>Action.get_actionExecutionSpecificationOfAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_actionExecutionSpecificationOfAction" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setAction(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.Action)">
<h3>setAction</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setAction</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#getAction()"><code><em>Action</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Action</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
