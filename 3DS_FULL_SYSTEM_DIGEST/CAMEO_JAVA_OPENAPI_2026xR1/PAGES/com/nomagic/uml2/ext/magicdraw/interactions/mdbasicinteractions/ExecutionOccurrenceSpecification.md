# JAVA OPENAPI: ExecutionOccurrenceSpecification (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/ExecutionOccurrenceSpecification.html
- source_path: `com/nomagic/uml2/ext/magicdraw/interactions/mdbasicinteractions/ExecutionOccurrenceSpecification.html`
- source_sha256: `99f084b26f3d48b848e29bf3b7597b5494cfcadb8423f4d8b4428c0ee3ffcfa0`
- captured_utc: `2026-07-14T16:46:32.497233+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[InteractionFragment](InteractionFragment.html)`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[OccurrenceSpecification](OccurrenceSpecification.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`

public interfaceExecutionOccurrenceSpecificationextends [OccurrenceSpecification](OccurrenceSpecification.html)
...
See Also:
[`UMLPackage.getExecutionOccurrenceSpecification()`](../../metadata/UMLPackage.html#getExecutionOccurrenceSpecification())
Model:
...
Method
Description
`[ExecutionSpecification](ExecutionSpecification.html)`
`[getExecution](#getExecution())()`
Returns the value of the '***Execution***' reference.
`void`
`[setExecution](#setExecution(com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.ExecutionSpecification))([ExecutionSpecification](ExecutionSpecification.html) value)`
Sets the value of the '[`*Execution*`](#getExecution())'
 reference.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.[OccurrenceSpecification](OccurrenceSpecification.html)
`[get_executionSpecificationOfFinish](OccurrenceSpecification.html#get_executionSpecificationOfFinish()), [get_executionSpecificationOfStart](OccurrenceSpecification.html#get_executionSpecificationOfStart()), [getCovered](OccurrenceSpecification.html#getCovered()), [getToAfter](OccurrenceSpecification.html#getToAfter()), [getToBefore](OccurrenceSpecification.html#getToBefore()), [has_executionSpecificationOfFinish](OccurrenceSpecification.html#has_executionSpecificationOfFinish()), [has_executionSpecificationOfStart](OccurrenceSpecification.html#has_executionSpecificationOfStart()), [hasToAfter](OccurrenceSpecification.html#hasToAfter()), [hasToBefore](OccurrenceSpecification.html#hasToBefore())`
...
Method Details
getExecution
@CheckForNull[ExecutionSpecification](ExecutionSpecification.html) getExecution()
Returns the value of the '***Execution***' reference.
 It is bidirectional and its opposite is '[`.ExecutionSpecification#get_executionOccurrenceSpecificationOfExecution *execution Occurrence Specification Of Execution*`](package-summary.html)'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setExecution(ExecutionSpecification)`](#setExecution(com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.ExecutionSpecification))
[`UMLPackage.getExecutionOccurrenceSpecification_Execution()`](../../metadata/UMLPackage.html#getExecutionOccurrenceSpecification_Execution())
[`ExecutionSpecification.get_executionOccurrenceSpecificationOfExecution()`](ExecutionSpecification.html#get_executionOccurrenceSpecificationOfExecution())
Model:
opposite="_executionOccurrenceSpecificationOfExecution" required="true" ordered="false"
Generated:
setExecution
void setExecution(@CheckForNull
 [ExecutionSpecification](ExecutionSpecification.html) value)
Sets the value of the '[`*Execution*`](#getExecution())'
 reference.
 begin-user-doc 
 end-user-doc
...
<h1 class="title" title="Interface ExecutionOccurrenceSpecification">Interface ExecutionOccurrenceSpecification</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ExecutionOccurrenceSpecification</span><span class="extends-implements">
extends <a href="OccurrenceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">OccurrenceSpecification</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getExecution()"><code><em>Execution</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getExecutionOccurrenceSpecification()"><code>UMLPackage.getExecutionOccurrenceSpecification()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ExecutionSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">ExecutionSpecification</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExecution()">getExecution</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Execution</b></em>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setExecution(com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.ExecutionSpecification)">setExecution</a><wbr/>(<a href="ExecutionSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">ExecutionSpecification</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getExecution()"><code><em>Execution</em></code></a>'
 reference.</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.OccurrenceSpecification">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.<a href="OccurrenceSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">OccurrenceSpecification</a></h3>
<code><a href="OccurrenceSpecification.html#get_executionSpecificationOfFinish()">get_executionSpecificationOfFinish</a>, <a href="OccurrenceSpecification.html#get_executionSpecificationOfStart()">get_executionSpecificationOfStart</a>, <a href="OccurrenceSpecification.html#getCovered()">getCovered</a>, <a href="OccurrenceSpecification.html#getToAfter()">getToAfter</a>, <a href="OccurrenceSpecification.html#getToBefore()">getToBefore</a>, <a href="OccurrenceSpecification.html#has_executionSpecificationOfFinish()">has_executionSpecificationOfFinish</a>, <a href="OccurrenceSpecification.html#has_executionSpecificationOfStart()">has_executionSpecificationOfStart</a>, <a href="OccurrenceSpecification.html#hasToAfter()">hasToAfter</a>, <a href="OccurrenceSpecification.html#hasToBefore()">hasToBefore</a></code></div>
<div class="inherited-list">
...
</span><span class="return-type"><a href="ExecutionSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">ExecutionSpecification</a></span> <span class="element-name">getExecution</span>()</div>
<div class="block">Returns the value of the '<em><b>Execution</b></em>' reference.
 It is bidirectional and its opposite is '<a href="package-summary.html"><code>.ExecutionSpecification#get_executionOccurrenceSpecificationOfExecution <em>execution Occurrence Specification Of Execution</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 References the execution specification describing the execution that is started or finished at this execution event.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Execution</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setExecution(com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.ExecutionSpecification)"><code>setExecution(ExecutionSpecification)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getExecutionOccurrenceSpecification_Execution()"><code>UMLPackage.getExecutionOccurrenceSpecification_Execution()</code></a></li>
<li><a href="ExecutionSpecification.html#get_executionOccurrenceSpecificationOfExecution()"><code>ExecutionSpecification.get_executionOccurrenceSpecificationOfExecution()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_executionOccurrenceSpecificationOfExecution" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setExecution(com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.ExecutionSpecification)">
<h3>setExecution</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setExecution</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ExecutionSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions">ExecutionSpecification</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getExecution()"><code><em>Execution</em></code></a>'
 reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Execution</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getExecution()"><code>getExecution()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
