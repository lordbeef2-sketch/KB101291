# JAVA OPENAPI: ReadVariableAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/ReadVariableAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/ReadVariableAction.html`
- source_sha256: `0f6c36d099f46361a91dbfc37f20ac0d0626ebc2a3a833e32133950b55b130e3`
- captured_utc: `2026-07-14T16:46:25.659143+00:00`
...
public interfaceReadVariableActionextends [VariableAction](VariableAction.html)
...
See Also:
[`UMLPackage.getReadVariableAction()`](../../metadata/UMLPackage.html#getReadVariableAction())
Model:
...
Returns the value of the '***Result***' containment reference.
 ...
 '[`*read Variable Action Of Result*`](../mdbasicactions/OutputPin.html#get_readVariableActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadVariableAction_Result()`](../../metadata/UMLPackage.html#getReadVariableAction_Result())
[`OutputPin.get_readVariableActionOfResult()`](../mdbasicactions/OutputPin.html#get_readVariableActionOfResult())
Model:
opposite="_readVariableActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
<h1 class="title" title="Interface ReadVariableAction">Interface ReadVariableAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReadVariableAction</span><span class="extends-implements">
...
<li><a href="../../metadata/UMLPackage.html#getReadVariableAction()"><code>UMLPackage.getReadVariableAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_readVariableActionOfResult()"><code><em>read Variable Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin on which the result values are placed.
...
<li><a href="../../metadata/UMLPackage.html#getReadVariableAction_Result()"><code>UMLPackage.getReadVariableAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_readVariableActionOfResult()"><code>OutputPin.get_readVariableActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readVariableActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
