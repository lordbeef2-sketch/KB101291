# JAVA OPENAPI: StructuredClassifier (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/compositestructures/mdinternalstructures/StructuredClassifier.html
- source_path: `com/nomagic/uml2/ext/magicdraw/compositestructures/mdinternalstructures/StructuredClassifier.html`
- source_sha256: `cdc17c7e85bbd0f0729a8f9a9ff2c140d70417bd610108c00766ee969b49db96`
- captured_utc: `2026-07-14T16:46:31.785223+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Property](../../classes/mdkernel/Property.html)>`
`[getPart](#getPart())()`
Returns the value of the '***Part***' reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ConnectableElement](ConnectableElement.html)>`
`[getRole](#getRole())()`
...
Generated:
getPart
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Property](../../classes/mdkernel/Property.html)> getPart()
Returns the value of the '***Part***' reference list.
 The list contents are of type [`Property`](../../classes/mdkernel/Property.html).
...
Generated:
getRole
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ConnectableElement](ConnectableElement.html)> getRole()
Returns the value of the '***Role***' reference list.
 The list contents are of type [`ConnectableElement`](ConnectableElement.html).
 It is bidirectional and its opposite is '
invalid reference
`.mdinternalstructures.ConnectableElement#get_structuredClassifierOfRole *structured Classifier Of Role*`
'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Generated:
getOwnedConnector
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Connector](Connector.html)> getOwnedConnector()
Returns the value of the '***Owned Connector***' containment reference list.
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../../classes/mdkernel/Property.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Property</a>&gt;</code></div>
...
<pre><code><em>structured Classifier Of Part</em></code></pre>
</details>
'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
...
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property#get_structuredClassifierOfPart</code></pre>
</details>
</li>
</ul>
</dd>
...
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>.mdinternalstructures.ConnectableElement#get_structuredClassifierOfRole <em>structured Classifier Of Role</em></code></pre>
</details>
'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
