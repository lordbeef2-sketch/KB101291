# JAVA OPENAPI: Include (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/mdusecases/Include.html
- source_path: `com/nomagic/uml2/ext/magicdraw/mdusecases/Include.html`
- source_sha256: `a30d5d353cf831ccd15a2fa8f44ab74444f97d4a90b4337f3ead87814f24349d`
- captured_utc: `2026-07-14T16:46:34.069252+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[DirectedRelationship](../classes/mdkernel/DirectedRelationship.html)`, `[Element](../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[MDObject](../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../base/ModelObject.html)`, `[NamedElement](../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`, `[Relationship](../classes/mdkernel/Relationship.html)`

public interfaceIncludeextends [NamedElement](../classes/mdkernel/NamedElement.html), [DirectedRelationship](../classes/mdkernel/DirectedRelationship.html)
...
[`*Including Case*`](#getIncludingCase())

See Also:
[`UMLPackage.getInclude()`](../metadata/UMLPackage.html#getInclude())
Model:
...
`[UseCase](UseCase.html)`
`[getIncludingCase](#getIncludingCase())()`
Returns the value of the '***Including Case***' container reference.
`void`
`[setAddition](#setAddition(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase))([UseCase](UseCase.html) value)`
Sets the value of the '[`*Addition*`](#getAddition())' reference.
`void`
`[setIncludingCase](#setIncludingCase(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase))([UseCase](UseCase.html) value)`
Sets the value of the '[`*Including Case*`](#getIncludingCase())' container reference.
...
Method Details
getIncludingCase
@CheckForNull[UseCase](UseCase.html) getIncludingCase()
Returns the value of the '***Including Case***' container reference.
 It is bidirectional and its opposite is '[`*Include*`](UseCase.html#getInclude())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setIncludingCase(UseCase)`](#setIncludingCase(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase))
[`UMLPackage.getInclude_IncludingCase()`](../metadata/UMLPackage.html#getInclude_IncludingCase())
[`UseCase.getInclude()`](UseCase.html#getInclude())
Model:
...
Generated:
getAddition
@CheckForNull[UseCase](UseCase.html) getAddition()
Returns the value of the '***Addition***' reference.
 It is bidirectional and its opposite is '[`*include Of Addition*`](UseCase.html#get_includeOfAddition())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setAddition(UseCase)`](#setAddition(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase))
[`UMLPackage.getInclude_Addition()`](../metadata/UMLPackage.html#getInclude_Addition())
[`UseCase.get_includeOfAddition()`](UseCase.html#get_includeOfAddition())
Model:
...
<h1 class="title" title="Interface Include">Interface Include</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Include</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getAddition()"><code><em>Addition</em></code></a></li>
<li><a href="#getIncludingCase()"><code><em>Including Case</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../metadata/UMLPackage.html#getInclude()"><code>UMLPackage.getInclude()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getAddition()">getAddition</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Addition</b></em>' reference.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getIncludingCase()">getIncludingCase</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Including Case</b></em>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setAddition(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)">setAddition</a><wbr/>(<a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getAddition()"><code><em>Addition</em></code></a>' reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setIncludingCase(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)">setIncludingCase</a><wbr/>(<a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getIncludingCase()"><code><em>Including Case</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getIncludingCase()">
<h3>getIncludingCase</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a></span> <span class="element-name">getIncludingCase</span>()</div>
<div class="block">Returns the value of the '<em><b>Including Case</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="UseCase.html#getInclude()"><code><em>Include</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The UseCase which includes the addition and owns the Include relationship.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Including Case</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setIncludingCase(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)"><code>setIncludingCase(UseCase)</code></a></li>
<li><a href="../metadata/UMLPackage.html#getInclude_IncludingCase()"><code>UMLPackage.getInclude_IncludingCase()</code></a></li>
<li><a href="UseCase.html#getInclude()"><code>UseCase.getInclude()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="include" required="true" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setIncludingCase(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)">
<h3>setIncludingCase</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setIncludingCase</span><wbr/><span class="parameters">(@CheckForNull
 <a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getIncludingCase()"><code><em>Including Case</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Including Case</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getIncludingCase()"><code>getIncludingCase()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getAddition()">
<h3>getAddition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a></span> <span class="element-name">getAddition</span>()</div>
<div class="block">Returns the value of the '<em><b>Addition</b></em>' reference.
 It is bidirectional and its opposite is '<a href="UseCase.html#get_includeOfAddition()"><code><em>include Of Addition</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The UseCase that is to be included.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Addition</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setAddition(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)"><code>setAddition(UseCase)</code></a></li>
<li><a href="../metadata/UMLPackage.html#getInclude_Addition()"><code>UMLPackage.getInclude_Addition()</code></a></li>
<li><a href="UseCase.html#get_includeOfAddition()"><code>UseCase.get_includeOfAddition()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_includeOfAddition" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setAddition(com.nomagic.uml2.ext.magicdraw.mdusecases.UseCase)">
<h3>setAddition</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setAddition</span><wbr/><span class="parameters">(@CheckForNull
 <a href="UseCase.html" title="interface in com.nomagic.uml2.ext.magicdraw.mdusecases">UseCase</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getAddition()"><code><em>Addition</em></code></a>' reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Addition</em>' reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getAddition()"><code>getAddition()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
