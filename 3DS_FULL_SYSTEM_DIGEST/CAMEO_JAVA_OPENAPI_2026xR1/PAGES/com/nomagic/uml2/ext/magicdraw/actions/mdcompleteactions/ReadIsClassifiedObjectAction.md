# JAVA OPENAPI: ReadIsClassifiedObjectAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReadIsClassifiedObjectAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/ReadIsClassifiedObjectAction.html`
- source_sha256: `ab178b6c59dd17caf367c688a645b585414c1627a059f28bad7a4d1fb63da6f9`
- captured_utc: `2026-07-14T16:46:23.858117+00:00`
...
public interfaceReadIsClassifiedObjectActionextends [Action](../mdbasicactions/Action.html)
...
See Also:
[`UMLPackage.getReadIsClassifiedObjectAction()`](../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction())
Model:
...
`boolean`
`[isDirect](#isDirect())()`
Returns the value of the '***Direct***' attribute.
`void`
...
`void`
`[setDirect](#setDirect(boolean))(boolean value)`
Sets the value of the '[`*Direct*`](#isDirect())' attribute.
`void`
...
Returns the value of the '***Classifier***' reference.
 ...
 Is Classified Object Action Of Classifier*`](../../classes/mdkernel/Classifier.html#get_readIsClassifiedObjectActionOfClassifier())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadIsClassifiedObjectAction_Classifier()`](../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Classifier())
[`Classifier.get_readIsClassifiedObjectActionOfClassifier()`](../../classes/mdkernel/Classifier.html#get_readIsClassifiedObjectActionOfClassifier())
Model:
opposite="_readIsClassifiedObjectActionOfClassifier" required="true" ordered="false"
Generated:
setClassifier
...
Returns the value of the '***Direct***' attribute.
 ...
 begin-model-doc 
 Indicates whether the input object must be directly classified by the given Classifier or whether it may also be an instance of a specialization of the given
 Classifier.
 end-model-doc
Returns:
the value of the '*Direct*' attribute.
See Also:
[`setDirect(boolean)`](#setDirect(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getReadIsClassifiedObjectAction_Direct()`
Model:
...
Parameters:
`value` - the new value of the '*Direct*' attribute.
See Also:
[`isDirect()`](#isDirect())
Generated:
getResult
...
Returns the value of the '***Result***' containment reference.
 It is bidirectional and its opposite is '[`*read
 Is Classified Object Action Of Result*`](../mdbasicactions/OutputPin.html#get_readIsClassifiedObjectActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadIsClassifiedObjectAction_Result()`](../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Result())
[`OutputPin.get_readIsClassifiedObjectActionOfResult()`](../mdbasicactions/OutputPin.html#get_readIsClassifiedObjectActionOfResult())
Model:
opposite="_readIsClassifiedObjectActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setResult
...
Returns the value of the '***Object***' containment reference.
 It is bidirectional and its opposite is '[`*read
 Is Classified Object Action Of Object*`](../mdbasicactions/InputPin.html#get_readIsClassifiedObjectActionOfObject())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
[`UMLPackage.getReadIsClassifiedObjectAction_Object()`](../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Object())
[`InputPin.get_readIsClassifiedObjectActionOfObject()`](../mdbasicactions/InputPin.html#get_readIsClassifiedObjectActionOfObject())
Model:
opposite="_readIsClassifiedObjectActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"
Generated:
setObject
...
<h1 class="title" title="Interface ReadIsClassifiedObjectAction">Interface ReadIsClassifiedObjectAction</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ReadIsClassifiedObjectAction</span><span class="extends-implements">
...
<li><a href="#isDirect()"><code><em>Direct</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction()"><code>UMLPackage.getReadIsClassifiedObjectAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isDirect()">isDirect</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Direct</b></em>' attribute.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setDirect(boolean)">setDirect</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isDirect()"><code><em>Direct</em></code></a>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
...
<div class="block">Returns the value of the '<em><b>Classifier</b></em>' reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/Classifier.html#get_readIsClassifiedObjectActionOfClassifier()"><code><em>read
 Is Classified Object Action Of Classifier</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Classifier against which the classification of the input object is tested.
...
<li><a href="../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Classifier()"><code>UMLPackage.getReadIsClassifiedObjectAction_Classifier()</code></a></li>
<li><a href="../../classes/mdkernel/Classifier.html#get_readIsClassifiedObjectActionOfClassifier()"><code>Classifier.get_readIsClassifiedObjectActionOfClassifier()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readIsClassifiedObjectActionOfClassifier" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Direct</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Direct</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setDirect(boolean)"><code>setDirect(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getReadIsClassifiedObjectAction_Direct()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setDirect(boolean)">
<h3>setDirect</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setDirect</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isDirect()"><code><em>Direct</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Direct</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isDirect()"><code>isDirect()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/OutputPin.html#get_readIsClassifiedObjectActionOfResult()"><code><em>read
 Is Classified Object Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The OutputPin that holds the Boolean result of the test.
...
<li><a href="../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Result()"><code>UMLPackage.getReadIsClassifiedObjectAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_readIsClassifiedObjectActionOfResult()"><code>OutputPin.get_readIsClassifiedObjectActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readIsClassifiedObjectActionOfResult" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Object</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_readIsClassifiedObjectActionOfObject()"><code><em>read
 Is Classified Object Action Of Object</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The InputPin that holds the object whose classification is to be tested.
...
<li><a href="../../metadata/UMLPackage.html#getReadIsClassifiedObjectAction_Object()"><code>UMLPackage.getReadIsClassifiedObjectAction_Object()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_readIsClassifiedObjectActionOfObject()"><code>InputPin.get_readIsClassifiedObjectActionOfObject()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_readIsClassifiedObjectActionOfObject" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
