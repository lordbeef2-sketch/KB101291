# JAVA OPENAPI: StringExpression (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdtemplates/StringExpression.html
- source_path: `com/nomagic/uml2/ext/magicdraw/auxiliaryconstructs/mdtemplates/StringExpression.html`
- source_sha256: `7c5d46d56284d374f94518680082705d0dabecf10d69b6328d6885d8365cfd90`
- captured_utc: `2026-07-14T16:46:27.571167+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../classes/mdkernel/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[Expression](../../classes/mdkernel/Expression.html)`, `[MDObject](../../../../../magicdraw/foundation/MDObject.html)`, `[ModelElement](../../../../../../dassault_systemes/modeler/foundation/model/ModelElement.html)`, `[ModelObject](../../base/ModelObject.html)`, `[NamedElement](../../classes/mdkernel/NamedElement.html)`, `org.eclipse.emf.common.notify.Notifier`, `[PackageableElement](../../classes/mdkernel/PackageableElement.html)`, `[ParameterableElement](ParameterableElement.html)`, `javax.jmi.reflect.RefBaseObject`, `javax.jmi.reflect.RefFeatured`, `javax.jmi.reflect.RefObject`, `[TemplateableElement](TemplateableElement.html)`, `[TypedElement](../../classes/mdkernel/TypedElement.html)`, `[ValueSpecification](../../classes/mdkernel/ValueSpecification.html)`

public interfaceStringExpressionextends [Expression](../../classes/mdkernel/Expression.html), [TemplateableElement](TemplateableElement.html)

begin-user-doc 
 A representation of the model object '***String Expression***'.
 end-user-doc 
begin-model-doc 
 A StringExpression is an Expression that specifies a String value that is derived by concatenating a sequence of operands with String values or a sequence of
 subExpressions, some of which might be template parameters.
 end-model-doc 
The following features are supported:
 [`*Owning Expression*`](#getOwningExpression())
[`*Sub Expression*`](#getSubExpression())
[`*named Element Of Name Expression*`](#get_namedElementOfNameExpression())

See Also:
[`UMLPackage.getStringExpression()`](../../metadata/UMLPackage.html#getStringExpression())
Model:
...
`[get_namedElementOfNameExpression](#get_namedElementOfNameExpression())()`
Returns the value of the '***named Element Of Name Expression***' container reference.
`[StringExpression](StringExpression.html)`
`[getOwningExpression](#getOwningExpression())()`
Returns the value of the '***Owning Expression***' container reference.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[StringExpression](StringExpression.html)>`
`[getSubExpression](#getSubExpression())()`
Returns the value of the '***Sub Expression***' containment reference list.
`boolean`
`[hasSubExpression](#hasSubExpression())()`

`void`
`[set_namedElementOfNameExpression](#set_namedElementOfNameExpression(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement))([NamedElement](../../classes/mdkernel/NamedElement.html) value)`
Sets the value of the '[`*named Element
 Of Name Expression*`](#get_namedElementOfNameExpression())' container reference.
`void`
`[setOwningExpression](#setOwningExpression(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.StringExpression))([StringExpression](StringExpression.html) value)`
Sets the value of the '[`*Owning Expression*`](#getOwningExpression())'
 container reference.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.[Expression](../../classes/mdkernel/Expression.html)
`[getOperand](../../classes/mdkernel/Expression.html#getOperand()), [getSymbol](../../classes/mdkernel/Expression.html#getSymbol()), [hasOperand](../../classes/mdkernel/Expression.html#hasOperand()), [setSymbol](../../classes/mdkernel/Expression.html#setSymbol(java.lang.String))`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.[ParameterableElement](ParameterableElement.html)
`[get_templateParameterOfDefault](ParameterableElement.html#get_templateParameterOfDefault()), [get_templateParameterOfOwnedDefault](ParameterableElement.html#get_templateParameterOfOwnedDefault()), [get_templateParameterSubstitutionOfActual](ParameterableElement.html#get_templateParameterSubstitutionOfActual()), [get_templateParameterSubstitutionOfOwnedActual](ParameterableElement.html#get_templateParameterSubstitutionOfOwnedActual()), [getOwningTemplateParameter](ParameterableElement.html#getOwningTemplateParameter()), [getTemplateParameter](ParameterableElement.html#getTemplateParameter()), [has_templateParameterOfDefault](ParameterableElement.html#has_templateParameterOfDefault()), [has_templateParameterSubstitutionOfActual](ParameterableElement.html#has_templateParameterSubstitutionOfActual()), [set_templateParameterOfOwnedDefault](ParameterableElement.html#set_templateParameterOfOwnedDefault(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter)), [set_templateParameterSubstitutionOfOwnedActual](ParameterableElement.html#set_templateParameterSubstitutionOfOwnedActual(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameterSubstitution)), [setOwningTemplateParameter](ParameterableElement.html#setOwningTemplateParameter(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter)), [setTemplateParameter](ParameterableElement.html#setTemplateParameter(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter))`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.[TemplateableElement](TemplateableElement.html)
`[getOwnedTemplateSignature](TemplateableElement.html#getOwnedTemplateSignature()), [getTemplateBinding](TemplateableElement.html#getTemplateBinding()), [hasTemplateBinding](TemplateableElement.html#hasTemplateBinding()), [setOwnedTemplateSignature](TemplateableElement.html#setOwnedTemplateSignature(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateSignature))`
...
Method Details
getSubExpression
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[StringExpression](StringExpression.html)> getSubExpression()
Returns the value of the '***Sub Expression***' containment reference list.
 The list contents are of type [`StringExpression`](StringExpression.html).
...
See Also:
[`UMLPackage.getStringExpression_SubExpression()`](../../metadata/UMLPackage.html#getStringExpression_SubExpression())
[`getOwningExpression()`](#getOwningExpression())
Model:
opposite="owningExpression" containment="true" resolveProxies="true"
Generated:
getOwningExpression
@CheckForNull[StringExpression](StringExpression.html) getOwningExpression()
Returns the value of the '***Owning Expression***' container reference.
 It is bidirectional and its opposite is
 '[`*Sub Expression*`](#getSubExpression())'.
 begin-user-doc 
...
See Also:
[`setOwningExpression(StringExpression)`](#setOwningExpression(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.StringExpression))
[`UMLPackage.getStringExpression_OwningExpression()`](../../metadata/UMLPackage.html#getStringExpression_OwningExpression())
[`getSubExpression()`](#getSubExpression())
Model:
opposite="subExpression" transient="false" ordered="false"
Generated:
setOwningExpression
void setOwningExpression(@CheckForNull
 [StringExpression](StringExpression.html) value)
Sets the value of the '[`*Owning Expression*`](#getOwningExpression())'
 container reference.
 begin-user-doc 
 end-user-doc
...
[`getOwningExpression()`](#getOwningExpression())
Generated:
get_namedElementOfNameExpression
@CheckForNull[NamedElement](../../classes/mdkernel/NamedElement.html) get_namedElementOfNameExpression()
Returns the value of the '***named Element Of Name Expression***' container reference.
 It is bidirectional and its opposite is '[`*Name Expression*`](../../classes/mdkernel/NamedElement.html#getNameExpression())'.
 begin-user-doc 
If the meaning of the '*named Element Of Name Expression*' container reference isn't clear,
 there really should be more of a description here...
 end-user-doc
Returns:
the value of the '*named Element Of Name Expression*' container reference.
See Also:
[`set_namedElementOfNameExpression(NamedElement)`](#set_namedElementOfNameExpression(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement))
[`UMLPackage.getStringExpression__namedElementOfNameExpression()`](../../metadata/UMLPackage.html#getStringExpression__namedElementOfNameExpression())
[`NamedElement.getNameExpression()`](../../classes/mdkernel/NamedElement.html#getNameExpression())
Model:
opposite="nameExpression" transient="false" ordered="false"
Generated:
set_namedElementOfNameExpression
void set_namedElementOfNameExpression(@CheckForNull
...
Parameters:
`value` - the new value of the '*named Element Of Name Expression*' container reference.
See Also:
[`get_namedElementOfNameExpression()`](#get_namedElementOfNameExpression())
Generated:
hasSubExpression
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getOwningExpression()"><code><em>Owning Expression</em></code></a></li>
<li><a href="#getSubExpression()"><code><em>Sub Expression</em></code></a></li>
<li><a href="#get_namedElementOfNameExpression()"><code><em>named Element Of Name Expression</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getStringExpression()"><code>UMLPackage.getStringExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#get_namedElementOfNameExpression()">get_namedElementOfNameExpression</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>named Element Of Name Expression</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwningExpression()">getOwningExpression</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Owning Expression</b></em>' container reference.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSubExpression()">getSubExpression</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Sub Expression</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasSubExpression()">hasSubExpression</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#set_namedElementOfNameExpression(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">set_namedElementOfNameExpression</a><wbr/>(<a href="../../classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#get_namedElementOfNameExpression()"><code><em>named Element
 Of Name Expression</em></code></a>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwningExpression(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.StringExpression)">setOwningExpression</a><wbr/>(<a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getOwningExpression()"><code><em>Owning Expression</em></code></a>'
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Expression">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.classes.mdkernel.<a href="../../classes/mdkernel/Expression.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">Expression</a></h3>
<code><a href="../../classes/mdkernel/Expression.html#getOperand()">getOperand</a>, <a href="../../classes/mdkernel/Expression.html#getSymbol()">getSymbol</a>, <a href="../../classes/mdkernel/Expression.html#hasOperand()">hasOperand</a>, <a href="../../classes/mdkernel/Expression.html#setSymbol(java.lang.String)">setSymbol</a></code></div>
<div class="inherited-list">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.ParameterableElement">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.<a href="ParameterableElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">ParameterableElement</a></h3>
<code><a href="ParameterableElement.html#get_templateParameterOfDefault()">get_templateParameterOfDefault</a>, <a href="ParameterableElement.html#get_templateParameterOfOwnedDefault()">get_templateParameterOfOwnedDefault</a>, <a href="ParameterableElement.html#get_templateParameterSubstitutionOfActual()">get_templateParameterSubstitutionOfActual</a>, <a href="ParameterableElement.html#get_templateParameterSubstitutionOfOwnedActual()">get_templateParameterSubstitutionOfOwnedActual</a>, <a href="ParameterableElement.html#getOwningTemplateParameter()">getOwningTemplateParameter</a>, <a href="ParameterableElement.html#getTemplateParameter()">getTemplateParameter</a>, <a href="ParameterableElement.html#has_templateParameterOfDefault()">has_templateParameterOfDefault</a>, <a href="ParameterableElement.html#has_templateParameterSubstitutionOfActual()">has_templateParameterSubstitutionOfActual</a>, <a href="ParameterableElement.html#set_templateParameterOfOwnedDefault(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter)">set_templateParameterOfOwnedDefault</a>, <a href="ParameterableElement.html#set_templateParameterSubstitutionOfOwnedActual(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameterSubstitution)">set_templateParameterSubstitutionOfOwnedActual</a>, <a href="ParameterableElement.html#setOwningTemplateParameter(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter)">setOwningTemplateParameter</a>, <a href="ParameterableElement.html#setTemplateParameter(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateParameter)">setTemplateParameter</a></code></div>
<div class="inherited-list">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateableElement">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.<a href="TemplateableElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">TemplateableElement</a></h3>
<code><a href="TemplateableElement.html#getOwnedTemplateSignature()">getOwnedTemplateSignature</a>, <a href="TemplateableElement.html#getTemplateBinding()">getTemplateBinding</a>, <a href="TemplateableElement.html#hasTemplateBinding()">hasTemplateBinding</a>, <a href="TemplateableElement.html#setOwnedTemplateSignature(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.TemplateSignature)">setOwnedTemplateSignature</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getSubExpression()">
<h3>getSubExpression</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a>&gt;</span> <span class="element-name">getSubExpression</span>()</div>
<div class="block">Returns the value of the '<em><b>Sub Expression</b></em>' containment reference list.
 The list contents are of type <a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates"><code>StringExpression</code></a>.
 It is bidirectional and its opposite is
 '<a href="#getOwningExpression()"><code><em>Owning Expression</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The StringExpressions that constitute this StringExpression.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Sub Expression</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getStringExpression_SubExpression()"><code>UMLPackage.getStringExpression_SubExpression()</code></a></li>
<li><a href="#getOwningExpression()"><code>getOwningExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="owningExpression" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getOwningExpression()">
<h3>getOwningExpression</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a></span> <span class="element-name">getOwningExpression</span>()</div>
<div class="block">Returns the value of the '<em><b>Owning Expression</b></em>' container reference.
 It is bidirectional and its opposite is
 '<a href="#getSubExpression()"><code><em>Sub Expression</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The StringExpression of which this StringExpression is a subExpression.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Owning Expression</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setOwningExpression(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.StringExpression)"><code>setOwningExpression(StringExpression)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getStringExpression_OwningExpression()"><code>UMLPackage.getStringExpression_OwningExpression()</code></a></li>
<li><a href="#getSubExpression()"><code>getSubExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="subExpression" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setOwningExpression(com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.StringExpression)">
<h3>setOwningExpression</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwningExpression</span><wbr/><span class="parameters">(@CheckForNull
 <a href="StringExpression.html" title="interface in com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates">StringExpression</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getOwningExpression()"><code><em>Owning Expression</em></code></a>'
 container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Owning Expression</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#getOwningExpression()"><code>getOwningExpression()</code></a></li>
...
<li>
<section class="detail" id="get_namedElementOfNameExpression()">
<h3>get_namedElementOfNameExpression</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../classes/mdkernel/NamedElement.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mdkernel">NamedElement</a></span> <span class="element-name">get_namedElementOfNameExpression</span>()</div>
<div class="block">Returns the value of the '<em><b>named Element Of Name Expression</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="../../classes/mdkernel/NamedElement.html#getNameExpression()"><code><em>Name Expression</em></code></a>'.
 <!-- begin-user-doc -->
<p>
 If the meaning of the '<em>named Element Of Name Expression</em>' container reference isn't clear,
 there really should be more of a description here...
 </p>
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>named Element Of Name Expression</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#set_namedElementOfNameExpression(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)"><code>set_namedElementOfNameExpression(NamedElement)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getStringExpression__namedElementOfNameExpression()"><code>UMLPackage.getStringExpression__namedElementOfNameExpression()</code></a></li>
<li><a href="../../classes/mdkernel/NamedElement.html#getNameExpression()"><code>NamedElement.getNameExpression()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="nameExpression" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="set_namedElementOfNameExpression(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement)">
<h3>set_namedElementOfNameExpression</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">set_namedElementOfNameExpression</span><wbr/><span class="parameters">(@CheckForNull
...
<div class="block">Sets the value of the '<a href="#get_namedElementOfNameExpression()"><code><em>named Element
 Of Name Expression</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>named Element Of Name Expression</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#get_namedElementOfNameExpression()"><code>get_namedElementOfNameExpression()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="hasSubExpression()">
<h3>hasSubExpression</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasSubExpression</span>()
