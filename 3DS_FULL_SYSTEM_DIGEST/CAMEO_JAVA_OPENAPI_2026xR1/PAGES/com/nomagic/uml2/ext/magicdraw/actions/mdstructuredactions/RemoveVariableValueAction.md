# JAVA OPENAPI: RemoveVariableValueAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/RemoveVariableValueAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdstructuredactions/RemoveVariableValueAction.html`
- source_sha256: `42ec30ce43231aa78edf1f327339116fe0fb6be127080380e59bc3eb908480dd`
- captured_utc: `2026-07-14T16:46:25.677141+00:00`
...
See Also:
[`UMLPackage.getRemoveVariableValueAction()`](../../metadata/UMLPackage.html#getRemoveVariableValueAction())
Model:
...
Sets the value of the '[`*Remove At*`](#getRemoveAt())' containment
 reference.
`void`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.[VariableAction](VariableAction.html)
`[getVariable](VariableAction.html#getVariable()), [setVariable](VariableAction.html#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable))`
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.[WriteVariableAction](WriteVariableAction.html)
`[getValue](WriteVariableAction.html#getValue()), [setValue](WriteVariableAction.html#setValue(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin))`
...
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getRemoveVariableValueAction_RemoveDuplicates()`
Model:
...
Returns the value of the '***Remove At***' containment reference.
 It is bidirectional and its opposite is '[`*remove
 Variable Value Action Of Remove At*`](../mdbasicactions/InputPin.html#get_removeVariableValueActionOfRemoveAt())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
 An InputPin that provides the position of an existing value to remove in ordered, nonunique Variables. The type of the removeAt InputPin is UnlimitedNatural, but
 the value cannot be zero or unlimited.
 end-model-doc
Returns:
...
[`UMLPackage.getRemoveVariableValueAction_RemoveAt()`](../../metadata/UMLPackage.html#getRemoveVariableValueAction_RemoveAt())
[`InputPin.get_removeVariableValueActionOfRemoveAt()`](../mdbasicactions/InputPin.html#get_removeVariableValueActionOfRemoveAt())
Model:
...
<li><a href="../../metadata/UMLPackage.html#getRemoveVariableValueAction()"><code>UMLPackage.getRemoveVariableValueAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getRemoveAt()"><code><em>Remove At</em></code></a>' containment
 reference.</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.VariableAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.<a href="VariableAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions">VariableAction</a></h3>
<code><a href="VariableAction.html#getVariable()">getVariable</a>, <a href="VariableAction.html#setVariable(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Variable)">setVariable</a></code></div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.WriteVariableAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions.<a href="WriteVariableAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdstructuredactions">WriteVariableAction</a></h3>
<code><a href="WriteVariableAction.html#getValue()">getValue</a>, <a href="WriteVariableAction.html#setValue(com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.InputPin)">setValue</a></code></div>
</section>
</li>
</ul>
</section>
...
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getRemoveVariableValueAction_RemoveDuplicates()</code></pre>
</details>
</li>
</ul>
</dd>
...
<div class="block">Returns the value of the '<em><b>Remove At</b></em>' containment reference.
 It is bidirectional and its opposite is '<a href="../mdbasicactions/InputPin.html#get_removeVariableValueActionOfRemoveAt()"><code><em>remove
 Variable Value Action Of Remove At</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 An InputPin that provides the position of an existing value to remove in ordered, nonunique Variables. The type of the removeAt InputPin is UnlimitedNatural, but
...
<li><a href="../../metadata/UMLPackage.html#getRemoveVariableValueAction_RemoveAt()"><code>UMLPackage.getRemoveVariableValueAction_RemoveAt()</code></a></li>
<li><a href="../mdbasicactions/InputPin.html#get_removeVariableValueActionOfRemoveAt()"><code>InputPin.get_removeVariableValueActionOfRemoveAt()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_removeVariableValueActionOfRemoveAt" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
