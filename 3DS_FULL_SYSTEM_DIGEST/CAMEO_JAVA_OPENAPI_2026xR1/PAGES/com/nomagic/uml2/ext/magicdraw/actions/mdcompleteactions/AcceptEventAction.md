# JAVA OPENAPI: AcceptEventAction (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/AcceptEventAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdcompleteactions/AcceptEventAction.html`
- source_sha256: `41f1e21be9c426dbcb9c1defb840fe1adb2aa9459929a7f1b4d8f474ec62307c`
- captured_utc: `2026-07-14T16:46:24.038120+00:00`
...
`[AcceptCallAction](AcceptCallAction.html)`

public interfaceAcceptEventActionextends [Action](../mdbasicactions/Action.html)
...
The following features are supported:
 [`*Unmarshall*`](#isUnmarshall())
[`*Result*`](#getResult())
[`*Trigger*`](#getTrigger())

See Also:
[`UMLPackage.getAcceptEventAction()`](../../metadata/UMLPackage.html#getAcceptEventAction())
Model:
...
Returns the value of the '***Unmarshall***' attribute.
`void`
`[setUnmarshall](#setUnmarshall(boolean))(boolean value)`
Sets the value of the '[`*Unmarshall*`](#isUnmarshall())' attribute.
...
Returns the value of the '***Unmarshall***' attribute.
 ...
 begin-model-doc 
 Indicates whether there is a single OutputPin for a SignalEvent occurrence, or multiple OutputPins for attribute values of the instance of the Signal associated
 with a SignalEvent occurrence.
 end-model-doc
Returns:
the value of the '*Unmarshall*' attribute.
See Also:
[`setUnmarshall(boolean)`](#setUnmarshall(boolean))
invalid reference
`com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getAcceptEventAction_Unmarshall()`
Model:
...
Returns the value of the '***Result***' containment reference list.
 ...
 '[`*accept Event Action Of Result*`](../mdbasicactions/OutputPin.html#get_acceptEventActionOfResult())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getAcceptEventAction_Result()`](../../metadata/UMLPackage.html#getAcceptEventAction_Result())
[`OutputPin.get_acceptEventActionOfResult()`](../mdbasicactions/OutputPin.html#get_acceptEventActionOfResult())
Model:
opposite="_acceptEventActionOfResult" containment="true" resolveProxies="true"
Generated:
getTrigger
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Trigger](../../commonbehaviors/mdcommunications/Trigger.html)> getTrigger()
Returns the value of the '***Trigger***' containment reference list.
 The list contents are of type [`Trigger`](../../commonbehaviors/mdcommunications/Trigger.html).
 It is bidirectional and its opposite is
 '[`*accept Event Action Of Trigger*`](../../commonbehaviors/mdcommunications/Trigger.html#get_acceptEventActionOfTrigger())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getAcceptEventAction_Trigger()`](../../metadata/UMLPackage.html#getAcceptEventAction_Trigger())
[`Trigger.get_acceptEventActionOfTrigger()`](../../commonbehaviors/mdcommunications/Trigger.html#get_acceptEventActionOfTrigger())
Model:
...
<h1 class="title" title="Interface AcceptEventAction">Interface AcceptEventAction</h1>
</div>
...
<dd><code><a href="AcceptCallAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions">AcceptCallAction</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">AcceptEventAction</span><span class="extends-implements">
...
<p>
 The following features are supported:
 <ul>
<li><a href="#isUnmarshall()"><code><em>Unmarshall</em></code></a></li>
...
<li><a href="../../metadata/UMLPackage.html#getAcceptEventAction()"><code>UMLPackage.getAcceptEventAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isUnmarshall()">isUnmarshall</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Unmarshall</b></em>' attribute.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setUnmarshall(boolean)">setUnmarshall</a><wbr/>(boolean value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#isUnmarshall()"><code><em>Unmarshall</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="isUnmarshall()">
<h3>isUnmarshall</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isUnmarshall</span>()</div>
<div class="block">Returns the value of the '<em><b>Unmarshall</b></em>' attribute.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Unmarshall</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setUnmarshall(boolean)"><code>setUnmarshall(boolean)</code></a></li>
<li>
<details class="invalid-tag">
<summary>invalid reference</summary>
<pre><code>com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage#getAcceptEventAction_Unmarshall()</code></pre>
</details>
</li>
</ul>
</dd>
...
<li>
<section class="detail" id="setUnmarshall(boolean)">
<h3>setUnmarshall</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setUnmarshall</span><wbr/><span class="parameters">(boolean value)</span></div>
<div class="block">Sets the value of the '<a href="#isUnmarshall()"><code><em>Unmarshall</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Unmarshall</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="#isUnmarshall()"><code>isUnmarshall()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<div class="block">Returns the value of the '<em><b>Result</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../mdbasicactions/OutputPin.html#get_acceptEventActionOfResult()"><code><em>accept Event Action Of Result</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 OutputPins holding the values received from an Event occurrence.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getAcceptEventAction_Result()"><code>UMLPackage.getAcceptEventAction_Result()</code></a></li>
<li><a href="../mdbasicactions/OutputPin.html#get_acceptEventActionOfResult()"><code>OutputPin.get_acceptEventActionOfResult()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_acceptEventActionOfResult" containment="true" resolveProxies="true"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
...
<div class="block">Returns the value of the '<em><b>Trigger</b></em>' containment reference list.
 ...
 It is bidirectional and its opposite is
 '<a href="../../commonbehaviors/mdcommunications/Trigger.html#get_acceptEventActionOfTrigger()"><code><em>accept Event Action Of Trigger</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Triggers specifying the Events of which the AcceptEventAction waits for occurrences.
...
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getAcceptEventAction_Trigger()"><code>UMLPackage.getAcceptEventAction_Trigger()</code></a></li>
<li><a href="../../commonbehaviors/mdcommunications/Trigger.html#get_acceptEventActionOfTrigger()"><code>Trigger.get_acceptEventActionOfTrigger()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_acceptEventActionOfTrigger" containment="true" resolveProxies="true" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
