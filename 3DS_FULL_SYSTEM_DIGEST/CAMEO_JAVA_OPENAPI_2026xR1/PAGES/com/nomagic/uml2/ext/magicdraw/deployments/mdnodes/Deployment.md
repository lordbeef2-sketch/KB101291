# JAVA OPENAPI: Deployment (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/Deployment.html
- source_path: `com/nomagic/uml2/ext/magicdraw/deployments/mdnodes/Deployment.html`
- source_sha256: `2a8a1dccbc415bae3c689d7ab770e3320f2643c9f031424f58a4da8ab364c410`
- captured_utc: `2026-07-14T16:46:32.136229+00:00`

## NORMALIZED JAVADOC CONTENT

======== START OF CLASS DATA ========

Package [com.nomagic.uml2.ext.magicdraw.deployments.mdnodes](package-summary.html)
...
public interfaceDeploymentextends [Dependency](../../classes/mddependencies/Dependency.html)
...
begin-model-doc 
 ...
 A component deployment is the deployment of one or more artifacts or artifact instances to a deployment target, optionally parameterized by a deployment
 specification. Examples are executables and configuration files.
 end-model-doc 
The following features are supported:
 [`*Configuration*`](#getConfiguration())
[`*Location*`](#getLocation())
[`*Deployed Artifact*`](#getDeployedArtifact())

See Also:
[`UMLPackage.getDeployment()`](../../metadata/UMLPackage.html#getDeployment())
Model:
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DeploymentSpecification](../mdcomponentdeployments/DeploymentSpecification.html)>`
`[getConfiguration](#getConfiguration())()`
Returns the value of the '***Configuration***' containment reference list.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DeployedArtifact](DeployedArtifact.html)>`
`[getDeployedArtifact](#getDeployedArtifact())()`
Returns the value of the '***Deployed Artifact***' reference list.
`[DeploymentTarget](DeploymentTarget.html)`
...
`boolean`
`[hasDeployedArtifact](#hasDeployedArtifact())()`

`void`
`[setLocation](#setLocation(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget))([DeploymentTarget](DeploymentTarget.html) value)`
Sets the value of the '[`*Location*`](#getLocation())' container reference.
...
Method Details
getLocation
@CheckForNull[DeploymentTarget](DeploymentTarget.html) getLocation()
Returns the value of the '***Location***' container reference.
 It is bidirectional and its opposite is '[`*Deployment*`](DeploymentTarget.html#getDeployment())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`setLocation(DeploymentTarget)`](#setLocation(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget))
[`UMLPackage.getDeployment_Location()`](../../metadata/UMLPackage.html#getDeployment_Location())
[`DeploymentTarget.getDeployment()`](DeploymentTarget.html#getDeployment())
Model:
opposite="deployment" required="true" transient="false" ordered="false"
Generated:
setLocation
void setLocation(@CheckForNull
 [DeploymentTarget](DeploymentTarget.html) value)
Sets the value of the '[`*Location*`](#getLocation())' container reference.
 begin-user-doc 
 end-user-doc
Parameters:
...
Generated:
getConfiguration
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DeploymentSpecification](../mdcomponentdeployments/DeploymentSpecification.html)> getConfiguration()
Returns the value of the '***Configuration***' containment reference list.
 The list contents are of type [`DeploymentSpecification`](../mdcomponentdeployments/DeploymentSpecification.html).
 It is bidirectional and its opposite is
 '[`*Deployment*`](../mdcomponentdeployments/DeploymentSpecification.html#getDeployment())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDeployment_Configuration()`](../../metadata/UMLPackage.html#getDeployment_Configuration())
[`DeploymentSpecification.getDeployment()`](../mdcomponentdeployments/DeploymentSpecification.html#getDeployment())
Model:
opposite="deployment" containment="true" resolveProxies="true" ordered="false"
Generated:
getDeployedArtifact
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[DeployedArtifact](DeployedArtifact.html)> getDeployedArtifact()
Returns the value of the '***Deployed Artifact***' reference list.
 The list contents are of type [`DeployedArtifact`](DeployedArtifact.html).
 It is bidirectional and its opposite is
 '[`*deployment Of Deployed Artifact*`](DeployedArtifact.html#get_deploymentOfDeployedArtifact())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getDeployment_DeployedArtifact()`](../../metadata/UMLPackage.html#getDeployment_DeployedArtifact())
[`DeployedArtifact.get_deploymentOfDeployedArtifact()`](DeployedArtifact.html#get_deploymentOfDeployedArtifact())
Model:
opposite="_deploymentOfDeployedArtifact" ordered="false"
Generated:
hasConfiguration
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span> <a href="package-summary.html">com.nomagic.uml2.ext.magicdraw.deployments.mdnodes</a></div>
<h1 class="title" title="Interface Deployment">Interface Deployment</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">Deployment</span><span class="extends-implements">
extends <a href="../../classes/mddependencies/Dependency.html" title="interface in com.nomagic.uml2.ext.magicdraw.classes.mddependencies">Dependency</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getConfiguration()"><code><em>Configuration</em></code></a></li>
<li><a href="#getLocation()"><code><em>Location</em></code></a></li>
<li><a href="#getDeployedArtifact()"><code><em>Deployed Artifact</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="../../metadata/UMLPackage.html#getDeployment()"><code>UMLPackage.getDeployment()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>annotation="MOF package='deployments.mdnodes'"</dd>
<dt>Generated:</dt>
</dl>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="../mdcomponentdeployments/DeploymentSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdcomponentdeployments">DeploymentSpecification</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getConfiguration()">getConfiguration</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Configuration</b></em>' containment reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="DeployedArtifact.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeployedArtifact</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getDeployedArtifact()">getDeployedArtifact</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Deployed Artifact</b></em>' reference list.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="DeploymentTarget.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeploymentTarget</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getLocation()">getLocation</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Location</b></em>' container reference.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasConfiguration()">hasConfiguration</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasDeployedArtifact()">hasDeployedArtifact</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setLocation(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget)">setLocation</a><wbr/>(<a href="DeploymentTarget.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeploymentTarget</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getLocation()"><code><em>Location</em></code></a>' container reference.</div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="DeploymentTarget.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeploymentTarget</a></span> <span class="element-name">getLocation</span>()</div>
<div class="block">Returns the value of the '<em><b>Location</b></em>' container reference.
 It is bidirectional and its opposite is '<a href="DeploymentTarget.html#getDeployment()"><code><em>Deployment</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The DeployedTarget which is the target of a Deployment.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Location</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="#setLocation(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget)"><code>setLocation(DeploymentTarget)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getDeployment_Location()"><code>UMLPackage.getDeployment_Location()</code></a></li>
<li><a href="DeploymentTarget.html#getDeployment()"><code>DeploymentTarget.getDeployment()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="deployment" required="true" transient="false" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setLocation(com.nomagic.uml2.ext.magicdraw.deployments.mdnodes.DeploymentTarget)">
<h3>setLocation</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setLocation</span><wbr/><span class="parameters">(@CheckForNull
 <a href="DeploymentTarget.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeploymentTarget</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getLocation()"><code><em>Location</em></code></a>' container reference.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Location</em>' container reference.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
...
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="../mdcomponentdeployments/DeploymentSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdcomponentdeployments">DeploymentSpecification</a>&gt;</span> <span class="element-name">getConfiguration</span>()</div>
<div class="block">Returns the value of the '<em><b>Configuration</b></em>' containment reference list.
 The list contents are of type <a href="../mdcomponentdeployments/DeploymentSpecification.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdcomponentdeployments"><code>DeploymentSpecification</code></a>.
 It is bidirectional and its opposite is
 '<a href="../mdcomponentdeployments/DeploymentSpecification.html#getDeployment()"><code><em>Deployment</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The specification of properties that parameterize the deployment and execution of one or more Artifacts.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Configuration</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDeployment_Configuration()"><code>UMLPackage.getDeployment_Configuration()</code></a></li>
<li><a href="../mdcomponentdeployments/DeploymentSpecification.html#getDeployment()"><code>DeploymentSpecification.getDeployment()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="deployment" containment="true" resolveProxies="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getDeployedArtifact()">
<h3>getDeployedArtifact</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="DeployedArtifact.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes">DeployedArtifact</a>&gt;</span> <span class="element-name">getDeployedArtifact</span>()</div>
<div class="block">Returns the value of the '<em><b>Deployed Artifact</b></em>' reference list.
 The list contents are of type <a href="DeployedArtifact.html" title="interface in com.nomagic.uml2.ext.magicdraw.deployments.mdnodes"><code>DeployedArtifact</code></a>.
 It is bidirectional and its opposite is
 '<a href="DeployedArtifact.html#get_deploymentOfDeployedArtifact()"><code><em>deployment Of Deployed Artifact</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The Artifacts that are deployed onto a Node. This association specializes the supplier association.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Deployed Artifact</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getDeployment_DeployedArtifact()"><code>UMLPackage.getDeployment_DeployedArtifact()</code></a></li>
<li><a href="DeployedArtifact.html#get_deploymentOfDeployedArtifact()"><code>DeployedArtifact.get_deploymentOfDeployedArtifact()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_deploymentOfDeployedArtifact" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasConfiguration()">
<h3>hasConfiguration</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasConfiguration</span>()
...
<li>
<section class="detail" id="hasDeployedArtifact()">
<h3>hasDeployedArtifact</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasDeployedArtifact</span>()
                     throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
