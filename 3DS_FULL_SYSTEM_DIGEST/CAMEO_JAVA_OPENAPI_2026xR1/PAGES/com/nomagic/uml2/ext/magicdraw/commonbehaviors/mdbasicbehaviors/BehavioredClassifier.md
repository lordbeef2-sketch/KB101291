# JAVA OPENAPI: BehavioredClassifier (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/BehavioredClassifier.html
- source_path: `com/nomagic/uml2/ext/magicdraw/commonbehaviors/mdbasicbehaviors/BehavioredClassifier.html`
- source_sha256: `c114f86f4b4d2b1747c418354e1c349e0408aed0309faeb915a073f99d49d33a`
- captured_utc: `2026-07-14T16:46:30.485207+00:00`
...
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[InterfaceRealization](../../classes/mdinterfaces/InterfaceRealization.html)>`
...
Method Details
getOwnedBehavior
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[Behavior](Behavior.html)> getOwnedBehavior()
Returns the value of the '***Owned Behavior***' containment reference list.
...
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[InterfaceRealization](../../classes/mdinterfaces/InterfaceRealization.html)> getInterfaceRealization()
Returns the value of the '***Interface Realization***' containment reference list.
