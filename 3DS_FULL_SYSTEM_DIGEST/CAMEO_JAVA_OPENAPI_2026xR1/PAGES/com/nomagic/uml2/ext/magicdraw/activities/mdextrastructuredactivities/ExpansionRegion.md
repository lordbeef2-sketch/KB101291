# JAVA OPENAPI: ExpansionRegion (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionRegion.html
- source_path: `com/nomagic/uml2/ext/magicdraw/activities/mdextrastructuredactivities/ExpansionRegion.html`
- source_sha256: `e2b4a5f2810be7b94399f8b9f57c4c6642875d114f8b82cc41695a48dd0ac815`
- captured_utc: `2026-07-14T16:46:26.668155+00:00`
...
The following features are supported:
 [`*Mode*`](#getMode())
[`*Output Element*`](#getOutputElement())
[`*Input Element*`](#getInputElement())

See Also:
[`UMLPackage.getExpansionRegion()`](../../metadata/UMLPackage.html#getExpansionRegion())
Model:
...
Method
Description
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)>`
`[getInputElement](#getInputElement())()`
Returns the value of the '***Input Element***' reference list.
`[ExpansionKind](ExpansionKind.html)`
`[getMode](#getMode())()`
Returns the value of the '***Mode***' attribute.
`[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)>`
`[getOutputElement](#getOutputElement())()`
Returns the value of the '***Output Element***' reference list.
`boolean`
`[hasInputElement](#hasInputElement())()`

`boolean`
`[hasOutputElement](#hasOutputElement())()`

`void`
`[setMode](#setMode(com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities.ExpansionKind))([ExpansionKind](ExpansionKind.html) value)`
Sets the value of the '[`*Mode*`](#getMode())' attribute.
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.[ExecutableNode](../mdstructuredactivities/ExecutableNode.html)
`[get_clauseOfBody](../mdstructuredactivities/ExecutableNode.html#get_clauseOfBody()), [get_clauseOfTest](../mdstructuredactivities/ExecutableNode.html#get_clauseOfTest()), [get_exceptionHandlerOfHandlerBody](../mdstructuredactivities/ExecutableNode.html#get_exceptionHandlerOfHandlerBody()), [get_loopNodeOfBodyPart](../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfBodyPart()), [get_loopNodeOfSetupPart](../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfSetupPart()), [get_loopNodeOfTest](../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfTest()), [get_sequenceNodeOfExecutableNode](../mdstructuredactivities/ExecutableNode.html#get_sequenceNodeOfExecutableNode()), [getHandler](../mdstructuredactivities/ExecutableNode.html#getHandler()), [has_exceptionHandlerOfHandlerBody](../mdstructuredactivities/ExecutableNode.html#has_exceptionHandlerOfHandlerBody()), [hasHandler](../mdstructuredactivities/ExecutableNode.html#hasHandler()), [set_clauseOfBody](../mdstructuredactivities/ExecutableNode.html#set_clauseOfBody(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Clause)), [set_clauseOfTest](../mdstructuredactivities/ExecutableNode.html#set_clauseOfTest(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Clause)), [set_loopNodeOfBodyPart](../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfBodyPart(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)), [set_loopNodeOfSetupPart](../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfSetupPart(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)), [set_loopNodeOfTest](../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfTest(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)), [set_sequenceNodeOfExecutableNode](../mdstructuredactivities/ExecutableNode.html#set_sequenceNodeOfExecutableNode(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.SequenceNode))`
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.[StructuredActivityNode](../mdstructuredactivities/StructuredActivityNode.html)
`[getActivity](../mdstructuredactivities/StructuredActivityNode.html#getActivity()), [getEdge](../mdstructuredactivities/StructuredActivityNode.html#getEdge()), [getNode](../mdstructuredactivities/StructuredActivityNode.html#getNode()), [getStructuredNodeInput](../mdstructuredactivities/StructuredActivityNode.html#getStructuredNodeInput()), [getStructuredNodeOutput](../mdstructuredactivities/StructuredActivityNode.html#getStructuredNodeOutput()), [getVariable](../mdstructuredactivities/StructuredActivityNode.html#getVariable()), [hasEdge](../mdstructuredactivities/StructuredActivityNode.html#hasEdge()), [hasNode](../mdstructuredactivities/StructuredActivityNode.html#hasNode()), [hasStructuredNodeInput](../mdstructuredactivities/StructuredActivityNode.html#hasStructuredNodeInput()), [hasStructuredNodeOutput](../mdstructuredactivities/StructuredActivityNode.html#hasStructuredNodeOutput()), [hasVariable](../mdstructuredactivities/StructuredActivityNode.html#hasVariable()), [isMustIsolate](../mdstructuredactivities/StructuredActivityNode.html#isMustIsolate()), [setActivity](../mdstructuredactivities/StructuredActivityNode.html#setActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity)), [setMustIsolate](../mdstructuredactivities/StructuredActivityNode.html#setMustIsolate(boolean))`

============ METHOD DETAIL ========== 
Method Details
getMode
@CheckForNull[ExpansionKind](ExpansionKind.html) getMode()
Returns the value of the '***Mode***' attribute.
 The default value is `"iterative"`.
 The literals are from the enumeration [`ExpansionKind`](ExpansionKind.html).
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`ExpansionKind`](ExpansionKind.html)
[`setMode(ExpansionKind)`](#setMode(com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities.ExpansionKind))
[`UMLPackage.getExpansionRegion_Mode()`](../../metadata/UMLPackage.html#getExpansionRegion_Mode())
Model:
default="iterative" required="true" ordered="false"
Generated:
setMode
void setMode(@CheckForNull
 [ExpansionKind](ExpansionKind.html) value)
Sets the value of the '[`*Mode*`](#getMode())' attribute.
 begin-user-doc 
 end-user-doc
Parameters:
...
Generated:
getOutputElement
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)> getOutputElement()
Returns the value of the '***Output Element***' reference list.
 The list contents are of type [`ExpansionNode`](ExpansionNode.html).
 It is bidirectional and its opposite is
 '[`*Region As Output*`](ExpansionNode.html#getRegionAsOutput())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getExpansionRegion_OutputElement()`](../../metadata/UMLPackage.html#getExpansionRegion_OutputElement())
[`ExpansionNode.getRegionAsOutput()`](ExpansionNode.html#getRegionAsOutput())
Model:
opposite="regionAsOutput" ordered="false"
Generated:
getInputElement
[Collection](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html)<[ExpansionNode](ExpansionNode.html)> getInputElement()
Returns the value of the '***Input Element***' reference list.
 The list contents are of type [`ExpansionNode`](ExpansionNode.html).
 It is bidirectional and its opposite is
 '[`*Region As Input*`](ExpansionNode.html#getRegionAsInput())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
See Also:
[`UMLPackage.getExpansionRegion_InputElement()`](../../metadata/UMLPackage.html#getExpansionRegion_InputElement())
[`ExpansionNode.getRegionAsInput()`](ExpansionNode.html#getRegionAsInput())
Model:
...
<h1 class="title" title="Interface ExpansionRegion">Interface ExpansionRegion</h1>
</div>
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">ExpansionRegion</span><span class="extends-implements">
extends <a href="../mdstructuredactivities/StructuredActivityNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">StructuredActivityNode</a></span></div>
...
<p>
 The following features are supported:
 <ul>
<li><a href="#getMode()"><code><em>Mode</em></code></a></li>
<li><a href="#getOutputElement()"><code><em>Output Element</em></code></a></li>
<li><a href="#getInputElement()"><code><em>Input Element</em></code></a></li>
</ul>
</p></p></p></div>
<dl class="notes">
<dt>See Also:</dt>
...
<li><a href="../../metadata/UMLPackage.html#getExpansionRegion()"><code>UMLPackage.getExpansionRegion()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionNode</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getInputElement()">getInputElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Input Element</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionKind</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getMode()">getMode</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Mode</b></em>' attribute.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a><wbr/>&lt;<a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionNode</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOutputElement()">getOutputElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Returns the value of the '<em><b>Output Element</b></em>' reference list.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasInputElement()">hasInputElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#hasOutputElement()">hasOutputElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"> </div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setMode(com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities.ExpansionKind)">setMode</a><wbr/>(<a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionKind</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Sets the value of the '<a href="#getMode()"><code><em>Mode</em></code></a>' attribute.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.ExecutableNode">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.<a href="../mdstructuredactivities/ExecutableNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">ExecutableNode</a></h3>
<code><a href="../mdstructuredactivities/ExecutableNode.html#get_clauseOfBody()">get_clauseOfBody</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_clauseOfTest()">get_clauseOfTest</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_exceptionHandlerOfHandlerBody()">get_exceptionHandlerOfHandlerBody</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfBodyPart()">get_loopNodeOfBodyPart</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfSetupPart()">get_loopNodeOfSetupPart</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_loopNodeOfTest()">get_loopNodeOfTest</a>, <a href="../mdstructuredactivities/ExecutableNode.html#get_sequenceNodeOfExecutableNode()">get_sequenceNodeOfExecutableNode</a>, <a href="../mdstructuredactivities/ExecutableNode.html#getHandler()">getHandler</a>, <a href="../mdstructuredactivities/ExecutableNode.html#has_exceptionHandlerOfHandlerBody()">has_exceptionHandlerOfHandlerBody</a>, <a href="../mdstructuredactivities/ExecutableNode.html#hasHandler()">hasHandler</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_clauseOfBody(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Clause)">set_clauseOfBody</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_clauseOfTest(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.Clause)">set_clauseOfTest</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfBodyPart(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)">set_loopNodeOfBodyPart</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfSetupPart(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)">set_loopNodeOfSetupPart</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_loopNodeOfTest(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.LoopNode)">set_loopNodeOfTest</a>, <a href="../mdstructuredactivities/ExecutableNode.html#set_sequenceNodeOfExecutableNode(com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.SequenceNode)">set_sequenceNodeOfExecutableNode</a></code></div>
<div class="inherited-list">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.StructuredActivityNode">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities.<a href="../mdstructuredactivities/StructuredActivityNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdstructuredactivities">StructuredActivityNode</a></h3>
<code><a href="../mdstructuredactivities/StructuredActivityNode.html#getActivity()">getActivity</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#getEdge()">getEdge</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#getNode()">getNode</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#getStructuredNodeInput()">getStructuredNodeInput</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#getStructuredNodeOutput()">getStructuredNodeOutput</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#getVariable()">getVariable</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#hasEdge()">hasEdge</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#hasNode()">hasNode</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#hasStructuredNodeInput()">hasStructuredNodeInput</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#hasStructuredNodeOutput()">hasStructuredNodeOutput</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#hasVariable()">hasVariable</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#isMustIsolate()">isMustIsolate</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#setActivity(com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity)">setActivity</a>, <a href="../mdstructuredactivities/StructuredActivityNode.html#setMustIsolate(boolean)">setMustIsolate</a></code></div>
</section>
</li>
</ul>
</section>
...
</span><span class="return-type"><a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionKind</a></span> <span class="element-name">getMode</span>()</div>
<div class="block">Returns the value of the '<em><b>Mode</b></em>' attribute.
 The default value is <code>"iterative"</code>.
 The literals are from the enumeration <a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities"><code>ExpansionKind</code></a>.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The mode in which the ExpansionRegion executes its contents. If parallel, executions are concurrent. If iterative, executions are sequential. If stream, a stream
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Mode</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities"><code>ExpansionKind</code></a></li>
<li><a href="#setMode(com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities.ExpansionKind)"><code>setMode(ExpansionKind)</code></a></li>
<li><a href="../../metadata/UMLPackage.html#getExpansionRegion_Mode()"><code>UMLPackage.getExpansionRegion_Mode()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>default="iterative" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="setMode(com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities.ExpansionKind)">
<h3>setMode</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setMode</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionKind</a> value)</span></div>
<div class="block">Sets the value of the '<a href="#getMode()"><code><em>Mode</em></code></a>' attribute.
 <!-- begin-user-doc -->
<!-- end-user-doc --></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the new value of the '<em>Mode</em>' attribute.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
<li><a href="ExpansionKind.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities"><code>ExpansionKind</code></a></li>
<li><a href="#getMode()"><code>getMode()</code></a></li>
</ul>
</dd>
<dt>Generated:</dt>
</dl>
...
<li>
<section class="detail" id="getOutputElement()">
<h3>getOutputElement</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionNode</a>&gt;</span> <span class="element-name">getOutputElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Output Element</b></em>' reference list.
 The list contents are of type <a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities"><code>ExpansionNode</code></a>.
 It is bidirectional and its opposite is
 '<a href="ExpansionNode.html#getRegionAsOutput()"><code><em>Region As Output</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The ExpansionNodes that form the output collections of the ExpansionRegion.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Output Element</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getExpansionRegion_OutputElement()"><code>UMLPackage.getExpansionRegion_OutputElement()</code></a></li>
<li><a href="ExpansionNode.html#getRegionAsOutput()"><code>ExpansionNode.getRegionAsOutput()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="regionAsOutput" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="getInputElement()">
<h3>getInputElement</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Collection.html" title="class or interface in java.util">Collection</a>&lt;<a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities">ExpansionNode</a>&gt;</span> <span class="element-name">getInputElement</span>()</div>
<div class="block">Returns the value of the '<em><b>Input Element</b></em>' reference list.
 The list contents are of type <a href="ExpansionNode.html" title="interface in com.nomagic.uml2.ext.magicdraw.activities.mdextrastructuredactivities"><code>ExpansionNode</code></a>.
 It is bidirectional and its opposite is
 '<a href="ExpansionNode.html#getRegionAsInput()"><code><em>Region As Input</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The ExpansionNodes that hold the input collections for the ExpansionRegion.
...
<dl class="notes">
<dt>Returns:</dt>
<dd>the value of the '<em>Input Element</em>' reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getExpansionRegion_InputElement()"><code>UMLPackage.getExpansionRegion_InputElement()</code></a></li>
<li><a href="ExpansionNode.html#getRegionAsInput()"><code>ExpansionNode.getRegionAsInput()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="regionAsInput" required="true" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
<li>
<section class="detail" id="hasOutputElement()">
<h3>hasOutputElement</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasOutputElement</span>()
...
<li>
<section class="detail" id="hasInputElement()">
<h3>hasInputElement</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">hasInputElement</span>()
                 throws <span class="exceptions">javax.jmi.reflect.JmiException</span></div>
<dl class="notes">
<dt>Throws:</dt>
<dd><code>javax.jmi.reflect.JmiException</code></dd>
