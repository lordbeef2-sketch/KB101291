# JAVA OPENAPI: EventSupport (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/ext/jmi/EventSupport.html
- source_path: `com/nomagic/uml2/ext/jmi/EventSupport.html`
- source_sha256: `f0652978c0e228079b5cc284079c0f78624aabb46297de3ce6d84193cab1efd5`
- captured_utc: `2026-07-14T16:46:21.231084+00:00`
...
`[createIndexedPropertyChangeEvent](#createIndexedPropertyChangeEvent(java.lang.Object,java.lang.String,java.lang.Object,java.lang.Object,int))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) source,
...
`void`
`[fireInstanceDeletedEvent](#fireInstanceDeletedEvent(javax.jmi.reflect.RefBaseObject,java.lang.Object,com.dassault_systemes.modeler.foundation.events.DirectContainerContents))(javax.jmi.reflect.RefBaseObject source,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) deleted,
 com.dassault_systemes.modeler.foundation.events.DirectContainerContents oldDirectContainerContents)`
Fires event about an instance delete.
`void`
`[fireModelElementDisposeEvent](#fireModelElementDisposeEvent(javax.jmi.reflect.RefObject,com.dassault_systemes.modeler.foundation.events.DirectContainerContents))(javax.jmi.reflect.RefObject disposed,
 com.dassault_systemes.modeler.foundation.events.DirectContainerContents oldDirectContainerContents)`
...
`protected boolean`
`[isNotDeliveredEventElement](#isNotDeliveredEventElement(java.lang.Object))([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) object)`
...
`addPropertyChangeListener, addPropertyChangeListener, addPropertyChangeListener, addPropertyChangeListener, addRepositoryListener, callModelListener, callWithStoppedEvents, fireCountedPropertyChange, fireModelElementDisposeEvent, firePropertyChange, firePropertyChange, fireRepositoryPropertyChange, getEventsCount, internalFireUncountedPropertyChange, invokeAfterTransaction, isEnableEventFiring, isModelCleanAfterEventsStopped, removeAllPropertyChangeListeners, removeListener, removePropertyChangeListener, removePropertyChangeListener, removePropertyChangeListener, removePropertyChangeListener, removeRepositoryListener, restoreEventDelivery, runWithStoppedEvents, setEnableEventFiring, setModelListener, startLogEvents, stopEventDelivery, stopLogEvents`
...
protected boolean isNotDeliveredEventElement([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) object)
Specified by:
...
protected com.nomagic.uml2.ext.jmi.IndexedPropertyChangeEvent createIndexedPropertyChangeEvent([Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) source,
 [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) propertyName,
 @CheckForNull
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) oldValue,
 @CheckForNull
...
`oldDirectContainerContents` - old direct container (feature data set or resource).
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#fireInstanceDeletedEvent(javax.jmi.reflect.RefBaseObject,java.lang.Object,com.dassault_systemes.modeler.foundation.events.DirectContainerContents)">fireInstanceDeletedEvent</a><wbr/>(javax.jmi.reflect.RefBaseObject source,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> deleted,
 com.dassault_systemes.modeler.foundation.events.DirectContainerContents oldDirectContainerContents)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Fires event about an instance delete.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#fireModelElementDisposeEvent(javax.jmi.reflect.RefObject,com.dassault_systemes.modeler.foundation.events.DirectContainerContents)">fireModelElementDisposeEvent</a><wbr/>(javax.jmi.reflect.RefObject disposed,
 com.dassault_systemes.modeler.foundation.events.DirectContainerContents oldDirectContainerContents)</code></div>
...
<code>addPropertyChangeListener, addPropertyChangeListener, addPropertyChangeListener, addPropertyChangeListener, addRepositoryListener, callModelListener, callWithStoppedEvents, fireCountedPropertyChange, fireModelElementDisposeEvent, firePropertyChange, firePropertyChange, fireRepositoryPropertyChange, getEventsCount, internalFireUncountedPropertyChange, invokeAfterTransaction, isEnableEventFiring, isModelCleanAfterEventsStopped, removeAllPropertyChangeListeners, removeListener, removePropertyChangeListener, removePropertyChangeListener, removePropertyChangeListener, removePropertyChangeListener, removeRepositoryListener, restoreEventDelivery, runWithStoppedEvents, setEnableEventFiring, setModelListener, startLogEvents, stopEventDelivery, stopLogEvents</code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="fireModelElementDisposeEvent(javax.jmi.reflect.RefObject,com.dassault_systemes.modeler.foundation.events.DirectContainerContents)">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">fireModelElementDisposeEvent</span><wbr/><span class="parameters">(javax.jmi.reflect.RefObject disposed,
 @CheckForNull
 com.dassault_systemes.modeler.foundation.events.DirectContainerContents oldDirectContainerContents)</span></div>
<div class="block"><span class="description-from-type-label">Description copied from class: <code>com.dassault_systemes.modeler.foundation.events.EventSupport</code></span></div>
<div class="block">Fires event about an instance disposal.</div>
<dl class="notes">
<dt>Overrides:</dt>
...
<dd><code>oldDirectContainerContents</code> - old direct container (feature data set or resource).</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="fireInstanceDeletedEvent(javax.jmi.reflect.RefBaseObject,java.lang.Object,com.dassault_systemes.modeler.foundation.events.DirectContainerContents)">
