# JAVA OPENAPI: MagicDrawProfile.DerivedPropertySpecificationStereotype (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/nomagic/uml2/MagicDrawProfile.DerivedPropertySpecificationStereotype.html
- source_path: `com/nomagic/uml2/MagicDrawProfile.DerivedPropertySpecificationStereotype.html`
- source_sha256: `2c0e57c42316a903e152ea4a21d7676c7f81287bbc1310cc63419a731ae73151`
- captured_utc: `2026-07-14T16:46:17.869038+00:00`
...
ISREADONLY
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) ISREADONLY
...
VALUESETTER
public static final [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) VALUESETTER
See Also:
...
public void removeExpression([Element](ext/magicdraw/classes/mdkernel/Element.html) element,
 [Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html) value)
getExpression
public [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)> getExpression([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setIsReadOnly
...
isIsReadOnly
@CheckForNullpublic [Boolean](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Boolean.html) isIsReadOnly([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
setValueSetter
...
getValueSetter
@CheckForNullpublic [String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) getValueSetter([Element](ext/magicdraw/classes/mdkernel/Element.html) element)
clear
...
<h3>ISREADONLY</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">ISREADONLY</span></div>
...
<h3>VALUESETTER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a></span> <span class="element-name">VALUESETTER</span></div>
<dl class="notes">
<dt>See Also:</dt>
<dd>
<ul class="tag-list">
