# JAVA OPENAPI: TimeLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/TimeLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/TimeLibrary.html`
- source_sha256: `ccc9552cb4cb6582960bf37a15c9dd2b25ca616b00b7e15528892c6531523d7e`
- captured_utc: `2026-07-14T16:45:02.155030+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.TimeLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classTimeLibrary
...
Description
`static class`
`[TimeLibrary.TimeInstantValueAttributeDefinition](TimeLibrary.TimeInstantValueAttributeDefinition.html)`
...
Constructor
Description
`[TimeLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new time library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [TimeLibrary](TimeLibrary.html)`
...
`[TimeLibrary.TimeInstantValueAttributeDefinition](TimeLibrary.TimeInstantValueAttributeDefinition.html)`
`[TimeInstantValue](#TimeInstantValue())()`
Returns time instant value.
...
Constructor Details
TimeLibrary
public TimeLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new time library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [TimeLibrary](TimeLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [TimeLibrary](TimeLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
TimeInstantValue
public [TimeLibrary.TimeInstantValueAttributeDefinition](TimeLibrary.TimeInstantValueAttributeDefinition.html) TimeInstantValue()
Returns time instant value.
Returns:
time instant value
getTypeWrappers
...
<h1 class="title" title="Class TimeLibrary">Class TimeLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.TimeLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TimeLibrary</span>
...
<div class="block">Access helper for the time standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="TimeLibrary.TimeInstantValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary.TimeInstantValueAttributeDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the time instant value attribute definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TimeLibrary.TimeInstantValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary.TimeInstantValueAttributeDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TimeInstantValue()">TimeInstantValue</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns time instant value.</div>
</div>
</div>
</div>
</div>
...
<h3>TimeLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TimeLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new time library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TimeLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="TimeInstantValue()">
<h3>TimeInstantValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TimeLibrary.TimeInstantValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">TimeLibrary.TimeInstantValueAttributeDefinition</a></span> <span class="element-name">TimeInstantValue</span>()</div>
<div class="block">Returns time instant value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>time instant value</dd>
</dl>
</section>
</li>
<li>
