# JAVA OPENAPI: CauseAndEffectLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/CauseAndEffectLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/CauseAndEffectLibrary.html`
- source_sha256: `01a6f6458b24a151f7f2a974ccc439abac69cf02295427a74ab740ae5b0050b3`
- captured_utc: `2026-07-14T16:44:53.076910+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.CauseAndEffectLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classCauseAndEffectLibrary
...
Constructor
Description
`[CauseAndEffectLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new cause and effect library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [CauseAndEffectLibrary](CauseAndEffectLibrary.html)`
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
CauseAndEffectLibrary
public CauseAndEffectLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new cause and effect library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [CauseAndEffectLibrary](CauseAndEffectLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [CauseAndEffectLibrary](CauseAndEffectLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
<h1 class="title" title="Class CauseAndEffectLibrary">Class CauseAndEffectLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.CauseAndEffectLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CauseAndEffectLibrary</span>
...
<div class="block">Access helper for the cause and effect standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CauseAndEffectLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CauseAndEffectLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CauseAndEffectLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CauseAndEffectLibrary</a></code></div>
...
<h3>CauseAndEffectLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CauseAndEffectLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new cause and effect library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="CauseAndEffectLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CauseAndEffectLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="CauseAndEffectLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CauseAndEffectLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
