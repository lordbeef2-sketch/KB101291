# JAVA OPENAPI: StatesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/StatesLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/StatesLibrary.html`
- source_sha256: `1e08bf5745cdc7d8639049bbf7848673e558b998a4ad0f72440a52d4fc67354b`
- captured_utc: `2026-07-14T16:45:01.005016+00:00`
...
@OpenApiAllpublic classStatesLibrary
...
Description
`static class`
`[StatesLibrary.StateActionsStateUsage](StatesLibrary.StateActionsStateUsage.html)`
Wrapper for the state actions state usage library element.
`static class`
`[StatesLibrary.StateActionStateDefinition](StatesLibrary.StateActionStateDefinition.html)`
Wrapper for the state action state definition library element.
`static class`
`[StatesLibrary.StateTransitionActionActionDefinition](StatesLibrary.StateTransitionActionActionDefinition.html)`
...
Constructor
Description
`[StatesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
...
Method
Description
`static [StatesLibrary](StatesLibrary.html)`
...
Constructor Details
StatesLibrary
public StatesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new states library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [StatesLibrary](StatesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [StatesLibrary](StatesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
StateAction
public [StatesLibrary.StateActionStateDefinition](StatesLibrary.StateActionStateDefinition.html) StateAction()
Returns state action.
Returns:
state action
StateTransitionAction
public [StatesLibrary.StateTransitionActionActionDefinition](StatesLibrary.StateTransitionActionActionDefinition.html) StateTransitionAction()
Returns state transition action.
Returns:
state transition action
stateActions
public [StatesLibrary.StateActionsStateUsage](StatesLibrary.StateActionsStateUsage.html) stateActions()
Returns state actions.
Returns:
state actions
getTypeWrappers
...
<h1 class="title" title="Class StatesLibrary">Class StatesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.StatesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">StatesLibrary</span>
...
<div class="block">Access helper for the states standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="StatesLibrary.StateActionsStateUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionsStateUsage</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the state actions state usage library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="StatesLibrary.StateActionStateDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionStateDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the state action state definition library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="StatesLibrary.StateTransitionActionActionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateTransitionActionActionDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the state transition action action definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StatesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StatesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="StatesLibrary.StateActionStateDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionStateDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#StateAction()">StateAction</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns state action.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="StatesLibrary.StateActionsStateUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionsStateUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#stateActions()">stateActions</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns state actions.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="StatesLibrary.StateTransitionActionActionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateTransitionActionActionDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#StateTransitionAction()">StateTransitionAction</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns state transition action.</div>
</div>
</div>
</div>
</div>
...
<h3>StatesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StatesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new states library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StatesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StatesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="StateAction()">
<h3>StateAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="StatesLibrary.StateActionStateDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionStateDefinition</a></span> <span class="element-name">StateAction</span>()</div>
<div class="block">Returns state action.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>state action</dd>
...
<li>
<section class="detail" id="StateTransitionAction()">
<h3>StateTransitionAction</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="StatesLibrary.StateTransitionActionActionDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateTransitionActionActionDefinition</a></span> <span class="element-name">StateTransitionAction</span>()</div>
<div class="block">Returns state transition action.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>state transition action</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="stateActions()">
<h3>stateActions</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="StatesLibrary.StateActionsStateUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">StatesLibrary.StateActionsStateUsage</a></span> <span class="element-name">stateActions</span>()</div>
<div class="block">Returns state actions.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>state actions</dd>
