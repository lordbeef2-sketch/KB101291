# JAVA OPENAPI: RequirementDerivationLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/RequirementDerivationLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/RequirementDerivationLibrary.html`
- source_sha256: `5008c8d11513fd2e35c2fe42a7ca3344d0e8ebfca9fea9ead16f638bd7049c07`
- captured_utc: `2026-07-14T16:44:54.485929+00:00`
...
## Class RequirementDerivationLibrary
...
com.dassault_systemes.modeler.sysml.libraries.standard.RequirementDerivationLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classRequirementDerivationLibrary
...
Description
`static class`
`[RequirementDerivationLibrary.DerivationMetadataMetadataDefinition](RequirementDerivationLibrary.DerivationMetadataMetadataDefinition.html)`
Wrapper for the derivation metadata metadata definition library element.
`static class`
`[RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition](RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html)`
Wrapper for the derived requirement metadata metadata definition library element.
`static class`
`[RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition](RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition.html)`
...
Constructor
Description
`[RequirementDerivationLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new requirement derivation library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Returns derivation metadata.
`[RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition](RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html)`
`[DerivedRequirementMetadata](#DerivedRequirementMetadata())()`
Returns derived requirement metadata.
`static [RequirementDerivationLibrary](RequirementDerivationLibrary.html)`
...
Returns original requirement metadata.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
RequirementDerivationLibrary
public RequirementDerivationLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new requirement derivation library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [RequirementDerivationLibrary](RequirementDerivationLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [RequirementDerivationLibrary](RequirementDerivationLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
public [RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition](RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition.html) OriginalRequirementMetadata()
Returns original requirement metadata.
Returns:
original requirement metadata
DerivedRequirementMetadata
public [RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition](RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html) DerivedRequirementMetadata()
Returns derived requirement metadata.
Returns:
derived requirement metadata
DerivationMetadata
public [RequirementDerivationLibrary.DerivationMetadataMetadataDefinition](RequirementDerivationLibrary.DerivationMetadataMetadataDefinition.html) DerivationMetadata()
Returns derivation metadata.
Returns:
derivation metadata
getTypeWrappers
...
<h1 class="title" title="Class RequirementDerivationLibrary">Class RequirementDerivationLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.RequirementDerivationLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">RequirementDerivationLibrary</span>
...
<div class="block">Access helper for the requirement derivation standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="RequirementDerivationLibrary.DerivationMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivationMetadataMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the derivation metadata metadata definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the derived requirement metadata metadata definition library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the original requirement metadata metadata definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="RequirementDerivationLibrary.DerivationMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivationMetadataMetadataDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#DerivationMetadata()">DerivationMetadata</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns derivation metadata.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#DerivedRequirementMetadata()">DerivedRequirementMetadata</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns derived requirement metadata.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="RequirementDerivationLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="RequirementDerivationLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#OriginalRequirementMetadata()">OriginalRequirementMetadata</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns original requirement metadata.</div>
</div>
...
<h3>RequirementDerivationLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RequirementDerivationLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new requirement derivation library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="RequirementDerivationLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="RequirementDerivationLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="OriginalRequirementMetadata()">
<h3>OriginalRequirementMetadata</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.OriginalRequirementMetadataMetadataDefinition</a></span> <span class="element-name">OriginalRequirementMetadata</span>()</div>
<div class="block">Returns original requirement metadata.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>original requirement metadata</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="DerivedRequirementMetadata()">
<h3>DerivedRequirementMetadata</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivedRequirementMetadataMetadataDefinition</a></span> <span class="element-name">DerivedRequirementMetadata</span>()</div>
<div class="block">Returns derived requirement metadata.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>derived requirement metadata</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="DerivationMetadata()">
<h3>DerivationMetadata</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="RequirementDerivationLibrary.DerivationMetadataMetadataDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">RequirementDerivationLibrary.DerivationMetadataMetadataDefinition</a></span> <span class="element-name">DerivationMetadata</span>()</div>
<div class="block">Returns derivation metadata.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>derivation metadata</dd>
</dl>
</section>
</li>
<li>
