# JAVA OPENAPI: CalculationsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/CalculationsLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/CalculationsLibrary.html`
- source_sha256: `d04598ee64bc2f56669c7afb6b42fa6ab32cd2024ff0f5af879aef024b762d1f`
- captured_utc: `2026-07-14T16:44:52.583904+00:00`
...
@OpenApiAllpublic classCalculationsLibrary
...
Description
`static class`
`[CalculationsLibrary.CalculationCalculationDefinition](CalculationsLibrary.CalculationCalculationDefinition.html)`
Wrapper for the calculation calculation definition library element.
`static class`
`[CalculationsLibrary.CalculationsCalculationUsage](CalculationsLibrary.CalculationsCalculationUsage.html)`
...
Constructor
Description
`[CalculationsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
...
`static [CalculationsLibrary](CalculationsLibrary.html)`
...
Constructor Details
CalculationsLibrary
public CalculationsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new calculations library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [CalculationsLibrary](CalculationsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [CalculationsLibrary](CalculationsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
Calculation
public [CalculationsLibrary.CalculationCalculationDefinition](CalculationsLibrary.CalculationCalculationDefinition.html) Calculation()
Returns calculation.
Returns:
calculation
calculations
public [CalculationsLibrary.CalculationsCalculationUsage](CalculationsLibrary.CalculationsCalculationUsage.html) calculations()
Returns calculations.
Returns:
calculations
getTypeWrappers
...
<h1 class="title" title="Class CalculationsLibrary">Class CalculationsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.CalculationsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CalculationsLibrary</span>
...
<div class="block">Access helper for the calculations standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="CalculationsLibrary.CalculationCalculationDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationCalculationDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the calculation calculation definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="CalculationsLibrary.CalculationsCalculationUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationsCalculationUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the calculations calculation usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="CalculationsLibrary.CalculationCalculationDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationCalculationDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Calculation()">Calculation</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns calculation.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="CalculationsLibrary.CalculationsCalculationUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationsCalculationUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#calculations()">calculations</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns calculations.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CalculationsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CalculationsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary</a></code></div>
...
<h3>CalculationsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CalculationsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new calculations library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="CalculationsLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<li>
<section class="detail" id="Calculation()">
<h3>Calculation</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="CalculationsLibrary.CalculationCalculationDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationCalculationDefinition</a></span> <span class="element-name">Calculation</span>()</div>
<div class="block">Returns calculation.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>calculation</dd>
...
<li>
<section class="detail" id="calculations()">
<h3>calculations</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="CalculationsLibrary.CalculationsCalculationUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">CalculationsLibrary.CalculationsCalculationUsage</a></span> <span class="element-name">calculations</span>()</div>
<div class="block">Returns calculations.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>calculations</dd>
