# JAVA OPENAPI: ISQBaseLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/ISQBaseLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/ISQBaseLibrary.html`
- source_sha256: `28a7e7adfac05a2172a707b633653d3f4956d90f5eba6443671255e7e89049fa`
- captured_utc: `2026-07-14T16:44:53.415915+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.ISQBaseLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classISQBaseLibrary
...
Description
`static class`
`[ISQBaseLibrary.DurationUnitAttributeDefinition](ISQBaseLibrary.DurationUnitAttributeDefinition.html)`
Wrapper for the duration unit attribute definition library element.
`static class`
`[ISQBaseLibrary.MassAttributeUsage](ISQBaseLibrary.MassAttributeUsage.html)`
...
Constructor
Description
`[ISQBaseLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new isqbase library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`static [ISQBaseLibrary](ISQBaseLibrary.html)`
...
Constructor Details
ISQBaseLibrary
public ISQBaseLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new isqbase library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [ISQBaseLibrary](ISQBaseLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [ISQBaseLibrary](ISQBaseLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
DurationUnit
public [ISQBaseLibrary.DurationUnitAttributeDefinition](ISQBaseLibrary.DurationUnitAttributeDefinition.html) DurationUnit()
Returns duration unit.
Returns:
duration unit
mass
public [ISQBaseLibrary.MassAttributeUsage](ISQBaseLibrary.MassAttributeUsage.html) mass()
Returns mass.
Returns:
mass
getTypeWrappers
...
<h1 class="title" title="Class ISQBaseLibrary">Class ISQBaseLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.ISQBaseLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ISQBaseLibrary</span>
...
<div class="block">Access helper for the isqbase standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ISQBaseLibrary.DurationUnitAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.DurationUnitAttributeDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the duration unit attribute definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ISQBaseLibrary.MassAttributeUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.MassAttributeUsage</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the mass attribute usage library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ISQBaseLibrary.DurationUnitAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.DurationUnitAttributeDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#DurationUnit()">DurationUnit</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns duration unit.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQBaseLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ISQBaseLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ISQBaseLibrary.MassAttributeUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.MassAttributeUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#mass()">mass</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns mass.</div>
</div>
...
<h3>ISQBaseLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ISQBaseLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new isqbase library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ISQBaseLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ISQBaseLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="DurationUnit()">
<h3>DurationUnit</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ISQBaseLibrary.DurationUnitAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.DurationUnitAttributeDefinition</a></span> <span class="element-name">DurationUnit</span>()</div>
<div class="block">Returns duration unit.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>duration unit</dd>
...
<li>
<section class="detail" id="mass()">
<h3>mass</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ISQBaseLibrary.MassAttributeUsage.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">ISQBaseLibrary.MassAttributeUsage</a></span> <span class="element-name">mass</span>()</div>
<div class="block">Returns mass.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>mass</dd>
