# JAVA OPENAPI: QuantitiesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/libraries/standard/QuantitiesLibrary.html
- source_path: `com/dassault_systemes/modeler/sysml/libraries/standard/QuantitiesLibrary.html`
- source_sha256: `a0ea43e6eac56f45227c12bbe009bc1fd4121c9a1c9e98bdb46dbc65bf1e8d81`
- captured_utc: `2026-07-14T16:44:54.439929+00:00`
...
com.dassault_systemes.modeler.sysml.libraries.standard.QuantitiesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classQuantitiesLibrary
...
Description
`static class`
`[QuantitiesLibrary.ScalarQuantityValueAttributeDefinition](QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html)`
Wrapper for the scalar quantity value attribute definition library element.
`static class`
`[QuantitiesLibrary.TensorQuantityValueAttributeDefinition](QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html)`
...
Constructor
Description
`[QuantitiesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a new quantities library instance.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [QuantitiesLibrary](QuantitiesLibrary.html)`
...
`[QuantitiesLibrary.ScalarQuantityValueAttributeDefinition](QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html)`
`[ScalarQuantityValue](#ScalarQuantityValue())()`
Returns scalar quantity value.
`[QuantitiesLibrary.TensorQuantityValueAttributeDefinition](QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html)`
`[TensorQuantityValue](#TensorQuantityValue())()`
Returns tensor quantity value.
...
Constructor Details
QuantitiesLibrary
public QuantitiesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a new quantities library instance.
Parameters:
`project` - the project
 ============ METHOD DETAIL ========== 
...
public static [QuantitiesLibrary](QuantitiesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the library instance for the given project.
Parameters:
`project` - the project
Returns:
...
getInstance
public static [QuantitiesLibrary](QuantitiesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the library instance for the project that owns the given element.
Parameters:
`element` - the element
Returns:
...
packages names
TensorQuantityValue
public [QuantitiesLibrary.TensorQuantityValueAttributeDefinition](QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html) TensorQuantityValue()
Returns tensor quantity value.
Returns:
tensor quantity value
ScalarQuantityValue
public [QuantitiesLibrary.ScalarQuantityValueAttributeDefinition](QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html) ScalarQuantityValue()
Returns scalar quantity value.
Returns:
...
<h1 class="title" title="Class QuantitiesLibrary">Class QuantitiesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.sysml.libraries.standard.QuantitiesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">QuantitiesLibrary</span>
...
<div class="block">Access helper for the quantities standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.ScalarQuantityValueAttributeDefinition</a></code></div>
<div class="col-last even-row-color">
<div class="block">Wrapper for the scalar quantity value attribute definition library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.TensorQuantityValueAttributeDefinition</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Wrapper for the tensor quantity value attribute definition library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="QuantitiesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="QuantitiesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.ScalarQuantityValueAttributeDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#ScalarQuantityValue()">ScalarQuantityValue</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns scalar quantity value.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.TensorQuantityValueAttributeDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TensorQuantityValue()">TensorQuantityValue</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns tensor quantity value.</div>
</div>
</div>
</div>
</div>
...
<h3>QuantitiesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">QuantitiesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a new quantities library instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="QuantitiesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the library instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>project</code> - the project</dd>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="QuantitiesLibrary.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the library instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="TensorQuantityValue()">
<h3>TensorQuantityValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="QuantitiesLibrary.TensorQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.TensorQuantityValueAttributeDefinition</a></span> <span class="element-name">TensorQuantityValue</span>()</div>
<div class="block">Returns tensor quantity value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>tensor quantity value</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="ScalarQuantityValue()">
<h3>ScalarQuantityValue</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="QuantitiesLibrary.ScalarQuantityValueAttributeDefinition.html" title="class in com.dassault_systemes.modeler.sysml.libraries.standard">QuantitiesLibrary.ScalarQuantityValueAttributeDefinition</a></span> <span class="element-name">ScalarQuantityValue</span>()</div>
<div class="block">Returns scalar quantity value.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>scalar quantity value</dd>
</dl>
</section>
</li>
<li>
