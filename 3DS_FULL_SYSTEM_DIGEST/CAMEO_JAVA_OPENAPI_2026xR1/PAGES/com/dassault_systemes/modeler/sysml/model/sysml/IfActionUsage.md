# JAVA OPENAPI: IfActionUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/IfActionUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/IfActionUsage.html`
- source_sha256: `00fff4b7e5a5de1b92bdab83c5066d706b5bd8bbea774fababc8ae869f185d97`
- captured_utc: `2026-07-14T16:45:03.864057+00:00`
...
@OpenApiAllpublic interfaceIfActionUsageextends [ActionUsage](ActionUsage.html)
...
`[getElseAction](#getElseAction())()`
The `ActionUsage` that is to be performed if the result of the `ifArgument` is false.
`[Expression](../../../kerml/model/kerml/Expression.html)`
`[getIfArgument](#getIfArgument())()`
The `Expression` whose result determines whether the `thenAction` or (optionally) the `elseAction` is performed.
`[ActionUsage](ActionUsage.html)`
`[getThenAction](#getThenAction())()`
The `ActionUsage` that is to be performed if the result of the `ifArgument` is true.
...
Method Details
getElseAction
@CheckForNull[ActionUsage](ActionUsage.html) getElseAction()
...
Returns:
the elseAction value
Model:
derived="true"
 transient="true"
 oppositeRoleName="ifElseAction"
getThenAction
@CheckForNull[ActionUsage](ActionUsage.html) getThenAction()
The `ActionUsage` that is to be performed if the result of the `ifArgument` is true. It is the second `parameterof the IfActionUsage.`
Returns:
the thenAction value
Model:
derived="true"
 transient="true"
 oppositeRoleName="ifThenAction"
getIfArgument
@CheckForNull[Expression](../../../kerml/model/kerml/Expression.html) getIfArgument()
The `Expression` whose result determines whether the `thenAction` or (optionally) the `elseAction` is performed. It is the first `parameterof the IfActionUsage.`
Returns:
the ifArgument value
Model:
derived="true"
 transient="true"
 oppositeRoleName="ifAction"
...
<h1 class="title" title="Interface IfActionUsage">Interface IfActionUsage</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">IfActionUsage</span><span class="extends-implements">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getElseAction()">getElseAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> that is to be performed if the result of the <code>ifArgument</code> is false.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getIfArgument()">getIfArgument</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expression</code> whose result determines whether the <code>thenAction</code> or (optionally) the <code>elseAction</code> is performed.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getThenAction()">getThenAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsage</code> that is to be performed if the result of the <code>ifArgument</code> is true.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getElseAction()">
<h3>getElseAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getElseAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> that is to be performed if the result of the <code>ifArgument</code> is false. It is the (optional) third <code>parameter</code> of the <code>IfActionUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the elseAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="ifElseAction"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getThenAction()">
<h3>getThenAction</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getThenAction</span>()</div>
<div class="block"><p>The <code>ActionUsage</code> that is to be performed if the result of the <code>ifArgument</code> is true. It is the second <code>parameter<code> of the <code>IfActionUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the thenAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="ifThenAction"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getIfArgument()">
<h3>getIfArgument</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getIfArgument</span>()</div>
<div class="block"><p>The <code>Expression</code> whose result determines whether the <code>thenAction</code> or (optionally) the <code>elseAction</code> is performed. It is the first <code>parameter<code> of the <code>IfActionUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the ifArgument value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="ifAction"</dd>
</dl>
</section>
</li>
</ul>
