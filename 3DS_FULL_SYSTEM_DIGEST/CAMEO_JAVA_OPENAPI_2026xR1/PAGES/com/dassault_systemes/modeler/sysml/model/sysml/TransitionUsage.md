# JAVA OPENAPI: TransitionUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/TransitionUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/TransitionUsage.html`
- source_sha256: `834b59c7cb17a9ff2de222bebcf8403b4bfe29944681a3a32ca1360ca15718e6`
- captured_utc: `2026-07-14T16:45:05.022069+00:00`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Expression](../../../kerml/model/kerml/Expression.html)>`
`[getGuardExpression](#getGuardExpression())()`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[AcceptActionUsage](AcceptActionUsage.html)>`
`[getTriggerAction](#getTriggerAction())()`
...
`[ReferenceUsage](ReferenceUsage.html)`
`[triggerPayloadParameter](#triggerPayloadParameter())()`
Return the `payloadParameter` of the `triggerAction` of this `TransitionUsage`, if it has one.
Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.[ActionUsage](ActionUsage.html)
`[argument](ActionUsage.html#argument(int)), [getActionDefinition](ActionUsage.html#getActionDefinition()), [inputParameter](ActionUsage.html#inputParameter(int)), [inputParameters](ActionUsage.html#inputParameters()), [isSubactionUsage](ActionUsage.html#isSubactionUsage())`
...
Method Details
getSource
@CheckForNull[ActionUsage](ActionUsage.html) getSource()
The source `ActionUsage` of this `TransitionUsage`, which becomes the `source` of the `succession` for the `TransitionUsage`.
Returns:
the source value
Model:
derived="true"
 transient="true"
 oppositeRoleName="outgoingTransition"
getTarget
@CheckForNull[ActionUsage](ActionUsage.html) getTarget()
The target `ActionUsage` of this `TransitionUsage, which is the targetFeature of the succession for the TransitionUsage.`
Returns:
the target value
Model:
derived="true"
 transient="true"
 oppositeRoleName="incomingTransition"
getTriggerAction
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[AcceptActionUsage](AcceptActionUsage.html)> getTriggerAction()
The `AcceptActionUsages` that define the triggers of this `TransitionUsage`, which are the `ownedFeatures` of the `TransitionUsage` related to it by `TransitionFeatureMemberships` with `kind = trigger`, which must all be `AcceptActionUsages`.
Returns:
the triggerAction value
Model:
derived="true"
 transient="true"
 oppositeRoleName="triggeredTransition"
getGuardExpression
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Expression](../../../kerml/model/kerml/Expression.html)> getGuardExpression()
The `Expressions` that define the guards of this `TransitionUsage`, which are the `ownedFeatures` of the `TransitionUsage` related to it by `TransitionFeatureMemberships` with `kind = guard`, which must all be `Expressions`.
Returns:
the guardExpression value
Model:
derived="true"
 transient="true"
 oppositeRoleName="guardedTransition"
getEffectAction
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ActionUsage](ActionUsage.html)> getEffectAction()
The `ActionUsages` that define the effects of this `TransitionUsage`, which are the `ownedFeatures` of the `TransitionUsage` related to it by `TransitionFeatureMemberships` with `kind = effect`, which must all be `ActionUsages`.
Returns:
the effectAction value
Model:
derived="true"
 transient="true"
 oppositeRoleName="activeTransition"
getSuccession
@CheckForNull[Succession](../../../kerml/model/kerml/Succession.html) getSuccession()
The `Succession` that is the `ownedFeature` of this `TransitionUsage`, which, if the `TransitionUsage` is triggered, asserts the temporal ordering of the `source` and `target`.
Returns:
the succession value
Model:
derived="true"
 transient="true"
 oppositeRoleName="linkedTransition"
triggerPayloadParameter
[ReferenceUsage](ReferenceUsage.html) triggerPayloadParameter()
Return the `payloadParameter` of the `triggerAction` of this `TransitionUsage`, if it has one.
 if triggerAction->isEmpty() then null
 else triggerAction->first().payloadParameter
 endif
sourceFeature
[Feature](../../../kerml/model/kerml/Feature.html) sourceFeature()
Return the `Feature` to be used as the `source` of the `succession` of this `TransitionUsage`, which is the first `member` of the `TransitionUsage` that is a `Feature`, that is owned by the `TransitionUsage` via a `Membership` that is *not* a `FeatureMembership`, and whose `featureTarget` is an `ActionUsage`.
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getEffectAction()">getEffectAction</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ActionUsages</code> that define the effects of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = effect</code>, which must all be <code>ActionUsages</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getGuardExpression()">getGuardExpression</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expressions</code> that define the guards of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = guard</code>, which must all be <code>Expressions</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The source <code>ActionUsage</code> of this <code>TransitionUsage</code>, which becomes the <code>source</code> of the <code>succession</code> for the <code>TransitionUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../../kerml/model/kerml/Succession.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Succession</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSuccession()">getSuccession</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Succession</code> that is the <code>ownedFeature</code> of this <code>TransitionUsage</code>, which, if the <code>TransitionUsage</code> is triggered, asserts the temporal ordering of the <code>source</code> and <code>target</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The target <code>ActionUsage</code> of this <code>TransitionUsage<code>, which is the <code>targetFeature</code> of the <code>succession</code> for the <code>TransitionUsage</code>.</code></code></div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="AcceptActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">AcceptActionUsage</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTriggerAction()">getTriggerAction</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>AcceptActionUsages</code> that define the triggers of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = trigger</code>, which must all be <code>AcceptActionUsages</code>.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#sourceFeature()">sourceFeature</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Return the <code>Feature</code> to be used as the <code>source</code> of the <code>succession</code> of this <code>TransitionUsage</code>, which is the first <code>member</code> of the <code>TransitionUsage</code> that is a <code>Feature</code>, that is owned by the <code>TransitionUsage</code> via a <code>Membership</code> that is <em>not</em> a <code>FeatureMembership</code>, and whose <code>featureTarget</code> is an <code>ActionUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ReferenceUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ReferenceUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#triggerPayloadParameter()">triggerPayloadParameter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Return the <code>payloadParameter</code> of the <code>triggerAction</code> of this <code>TransitionUsage</code>, if it has one.</div>
</div>
</div>
</div>
</div>
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.sysml.model.sysml.ActionUsage">Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.<a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></h3>
<code><a href="ActionUsage.html#argument(int)">argument</a>, <a href="ActionUsage.html#getActionDefinition()">getActionDefinition</a>, <a href="ActionUsage.html#inputParameter(int)">inputParameter</a>, <a href="ActionUsage.html#inputParameters()">inputParameters</a>, <a href="ActionUsage.html#isSubactionUsage()">isSubactionUsage</a></code></div>
<div class="inherited-list">
...
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getSource</span>()</div>
<div class="block"><p>The source <code>ActionUsage</code> of this <code>TransitionUsage</code>, which becomes the <code>source</code> of the <code>succession</code> for the <code>TransitionUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="outgoingTransition"</dd>
</dl>
</section>
</li>
<li>
...
<h3>getTarget</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a></span> <span class="element-name">getTarget</span>()</div>
<div class="block"><p>The target <code>ActionUsage</code> of this <code>TransitionUsage<code>, which is the <code>targetFeature</code> of the <code>succession</code> for the <code>TransitionUsage</code>.</code></code></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="incomingTransition"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getTriggerAction()">
<h3>getTriggerAction</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="AcceptActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">AcceptActionUsage</a>&gt;</span> <span class="element-name">getTriggerAction</span>()</div>
<div class="block"><p>The <code>AcceptActionUsages</code> that define the triggers of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = trigger</code>, which must all be <code>AcceptActionUsages</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the triggerAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="triggeredTransition"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getGuardExpression()">
<h3>getGuardExpression</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</span> <span class="element-name">getGuardExpression</span>()</div>
<div class="block"><p>The <code>Expressions</code> that define the guards of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = guard</code>, which must all be <code>Expressions</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the guardExpression value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="guardedTransition"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getEffectAction()">
<h3>getEffectAction</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ActionUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ActionUsage</a>&gt;</span> <span class="element-name">getEffectAction</span>()</div>
<div class="block"><p>The <code>ActionUsages</code> that define the effects of this <code>TransitionUsage</code>, which are the <code>ownedFeatures</code> of the <code>TransitionUsage</code> related to it by <code>TransitionFeatureMemberships</code> with <code>kind = effect</code>, which must all be <code>ActionUsages</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the effectAction value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="activeTransition"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSuccession()">
<h3>getSuccession</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Succession.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Succession</a></span> <span class="element-name">getSuccession</span>()</div>
<div class="block"><p>The <code>Succession</code> that is the <code>ownedFeature</code> of this <code>TransitionUsage</code>, which, if the <code>TransitionUsage</code> is triggered, asserts the temporal ordering of the <code>source</code> and <code>target</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the succession value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="linkedTransition"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="triggerPayloadParameter()">
<h3>triggerPayloadParameter</h3>
<div class="member-signature"><span class="return-type"><a href="ReferenceUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ReferenceUsage</a></span> <span class="element-name">triggerPayloadParameter</span>()</div>
<div class="block"><p>Return the <code>payloadParameter</code> of the <code>triggerAction</code> of this <code>TransitionUsage</code>, if it has one.</p>
 if triggerAction-&gt;isEmpty() then null
 else triggerAction-&gt;first().payloadParameter
 endif</div>
</section>
...
<li>
<section class="detail" id="sourceFeature()">
<h3>sourceFeature</h3>
<div class="member-signature"><span class="return-type"><a href="../../../kerml/model/kerml/Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">sourceFeature</span>()</div>
<div class="block"><p>Return the <code>Feature</code> to be used as the <code>source</code> of the <code>succession</code> of this <code>TransitionUsage</code>, which is the first <code>member</code> of the <code>TransitionUsage</code> that is a <code>Feature</code>, that is owned by the <code>TransitionUsage</code> via a <code>Membership</code> that is <em>not</em> a <code>FeatureMembership</code>, and whose <code>featureTarget</code> is an <code>ActionUsage</code>.</p>
 let features : Sequence(Feature) = ownedMembership-&gt;
     reject(oclIsKindOf(FeatureMembership)).memberElement-&gt;
     selectByKind(Feature)-&gt;
     select(featureTarget.oclIsKindOf(ActionUsage)) in
