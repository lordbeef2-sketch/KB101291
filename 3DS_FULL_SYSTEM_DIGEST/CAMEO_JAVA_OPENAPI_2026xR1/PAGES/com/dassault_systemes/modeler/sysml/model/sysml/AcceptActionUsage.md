# JAVA OPENAPI: AcceptActionUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/AcceptActionUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/AcceptActionUsage.html`
- source_sha256: `7a5a068b2eb9443b994f72c5cc072689722db5c8305e134874645572f4d073e1`
- captured_utc: `2026-07-14T16:45:02.793038+00:00`
...
@OpenApiAllpublic interfaceAcceptActionUsageextends [ActionUsage](ActionUsage.html)
...
Method
Description
`[Expression](../../../kerml/model/kerml/Expression.html)`
`[getPayloadArgument](#getPayloadArgument())()`
An `Expression` whose `result` is bound to the `*payload*` `parameter` of this `AcceptActionUsage`.
`[ReferenceUsage](ReferenceUsage.html)`
`[getPayloadParameter](#getPayloadParameter())()`
...
`[Expression](../../../kerml/model/kerml/Expression.html)`
`[getReceiverArgument](#getReceiverArgument())()`
...
Method Details
getReceiverArgument
@CheckForNull[Expression](../../../kerml/model/kerml/Expression.html) getReceiverArgument()
An `Expression` whose `result` is bound to the *`receiver`* input `parameter` of this `AcceptActionUsage`.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="acceptActionUsage"
getPayloadParameter
@CheckForNull[ReferenceUsage](ReferenceUsage.html) getPayloadParameter()
The `nestedReference` of this `AcceptActionUsage` that redefines the `payload` output `parameter` of the base `AcceptActionUsage` *`AcceptAction`* from the Systems Model Library.
Returns:
the payloadParameter value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningAcceptActionUsage"
 subsets=[`Usage.getNestedReference()`](Usage.html#getNestedReference())
getPayloadArgument
@CheckForNull[Expression](../../../kerml/model/kerml/Expression.html) getPayloadArgument()
...
derived="true"
 transient="true"
 oppositeRoleName="acceptingActionUsage"
isTriggerAction
...
<h1 class="title" title="Interface AcceptActionUsage">Interface AcceptActionUsage</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">AcceptActionUsage</span><span class="extends-implements">
...
<div class="block"><p>An <code>AcceptActionUsage</code> is an <code>ActionUsage</code> that specifies the acceptance of an <em><code>incomingTransfer</code></em> from the <code><em>Occurrence</em></code> given by the result of its <code>receiverArgument</code> Expression. (If no <code>receiverArgument</code> is provided, the default is the <em><code>this</code></em> context of the AcceptActionUsage.) The payload of the accepted <em><code>Transfer</code></em> is output on its <code>payloadParameter</code>. Which <em><code>Transfers</code></em> may be accepted is determined by conformance to the typing and (potentially) binding of the <code>payloadParameter</code>.</p>
 ...
 payloadArgument.oclIsKindOf(TriggerInvocationExpression) implies
     ...
     ownedFeature-&gt;selectByKind(BindingConnector)-&gt;exists(b |
         b.relatedFeatures-&gt;includes(parameter-&gt;at(2)) and
         b.relatedFeatures-&gt;includes(invocation.parameter-&gt;at(2)))</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getPayloadArgument()">getPayloadArgument</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An <code>Expression</code> whose <code>result</code> is bound to the <code><em>payload</em></code> <code>parameter</code> of this <code>AcceptActionUsage</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getPayloadParameter()">getPayloadParameter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>nestedReference</code> of this <code>AcceptActionUsage</code> that redefines the <code>payload</code> output <code>parameter</code> of the base <code>AcceptActionUsage</code> <em><code>AcceptAction</code></em> from the Systems Model Library.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReceiverArgument()">getReceiverArgument</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">An <code>Expression</code> whose <code>result</code> is bound to the <em><code>receiver</code></em> input <code>parameter</code> of this <code>AcceptActionUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isTriggerAction()">isTriggerAction</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Check if this <code>AcceptActionUsage</code> is the <code>triggerAction</code> of a <code>TransitionUsage</code>.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getReceiverArgument()">
<h3>getReceiverArgument</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getReceiverArgument</span>()</div>
<div class="block"><p>An <code>Expression</code> whose <code>result</code> is bound to the <em><code>receiver</code></em> input <code>parameter</code> of this <code>AcceptActionUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the receiverArgument value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="acceptActionUsage"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getPayloadParameter()">
<h3>getPayloadParameter</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ReferenceUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ReferenceUsage</a></span> <span class="element-name">getPayloadParameter</span>()</div>
<div class="block"><p>The <code>nestedReference</code> of this <code>AcceptActionUsage</code> that redefines the <code>payload</code> output <code>parameter</code> of the base <code>AcceptActionUsage</code> <em><code>AcceptAction</code></em> from the Systems Model Library.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the payloadParameter value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningAcceptActionUsage"
        subsets=<a href="Usage.html#getNestedReference()"><code>Usage.getNestedReference()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getPayloadArgument()">
<h3>getPayloadArgument</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getPayloadArgument</span>()</div>
<div class="block"><p>An <code>Expression</code> whose <code>result</code> is bound to the <code><em>payload</em></code> <code>parameter</code> of this <code>AcceptActionUsage</code>. If provided, the <code>AcceptActionUsage</code> will only accept a <code><em>Transfer</em></code> with exactly this <code><em>payload</em></code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the payloadArgument value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="acceptingActionUsage"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="isTriggerAction()">
<h3>isTriggerAction</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">isTriggerAction</span>()</div>
<div class="block"><p>Check if this <code>AcceptActionUsage</code> is the <code>triggerAction</code> of a <code>TransitionUsage</code>.</p>
 owningType &lt;&gt; null and 
 owningType.oclIsKindOf(TransitionUsage) and
 owningType.oclAsType(TransitionUsage).triggerAction-&gt;includes(self)</div>
</section>
</li>
</ul>
</section>
