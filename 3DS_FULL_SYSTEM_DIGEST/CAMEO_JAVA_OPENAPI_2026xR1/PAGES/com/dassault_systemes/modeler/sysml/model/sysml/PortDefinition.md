# JAVA OPENAPI: PortDefinition (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/PortDefinition.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/PortDefinition.html`
- source_sha256: `1a64bcd6aabff89555384e6a53361533e65c360d70cee49803902de4fbbd623e`
- captured_utc: `2026-07-14T16:45:04.377061+00:00`
...
The invalid input: '<'codeConjugatedPortDefinition that is conjugate to this `PortDefinition`.
...
derived="true"
 transient="true"
 opposite=[`ConjugatedPortDefinition.getOriginalPortDefinition()`](ConjugatedPortDefinition.html#getOriginalPortDefinition())
...
<h1 class="title" title="Interface PortDefinition">Interface PortDefinition</h1>
</div>
...
<dd><code><a href="ConjugatedPortDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConjugatedPortDefinition</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">PortDefinition</span><span class="extends-implements">
extends <a href="OccurrenceDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">OccurrenceDefinition</a>, <a href="../../../kerml/model/kerml/Structure.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Structure</a></span></div>
<div class="block"><p>A <code>PortDefinition</code> defines a point at which external entities can connect to and interact with a system or part of a system. Any <code>ownedUsages</code> of a <code>PortDefinition</code>, other than <code>PortUsages</code>, must not be composite.</p>
 ...
 not oclIsKindOf(ConjugatedPortDefinition) implies
     ownedMember-&gt;
         selectByKind(ConjugatedPortDefinition)-&gt;
         size() = 1
 specializesFromLibrary('Ports::Port')</div>
</section>
...
<div class="block">The <span class="invalid-tag">invalid input: '&lt;'</span>codeConjugatedPortDefinition that is conjugate to this <code>PortDefinition</code>.</div>
</div>
</div>
</div>
</div>
...
<div class="block"><p>The <span class="invalid-tag">invalid input: '&lt;'</span>codeConjugatedPortDefinition that is conjugate to this <code>PortDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        opposite=<a href="ConjugatedPortDefinition.html#getOriginalPortDefinition()"><code>ConjugatedPortDefinition.getOriginalPortDefinition()</code></a></dd>
</dl>
</section>
</li>
</ul>
