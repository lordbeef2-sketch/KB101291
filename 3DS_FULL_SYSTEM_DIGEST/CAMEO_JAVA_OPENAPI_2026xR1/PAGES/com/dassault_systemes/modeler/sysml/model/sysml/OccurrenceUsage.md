# JAVA OPENAPI: OccurrenceUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/OccurrenceUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/OccurrenceUsage.html`
- source_sha256: `1df71ee456ee4bc0a8a7a8cdf65d6c18ce019e2f09b06ebc00e4b05bb2afb8e9`
- captured_utc: `2026-07-14T16:45:04.308059+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[Feature](../../../kerml/model/kerml/Feature.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `[Namespace](../../../kerml/model/kerml/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[Type](../../../kerml/model/kerml/Type.html)`, `[Usage](Usage.html)`

All Known Subinterfaces:
`[AcceptActionUsage](AcceptActionUsage.html)`, `[ActionUsage](ActionUsage.html)`, `[AllocationUsage](AllocationUsage.html)`, `[AnalysisCaseUsage](AnalysisCaseUsage.html)`, `[AssertConstraintUsage](AssertConstraintUsage.html)`, `[AssignmentActionUsage](AssignmentActionUsage.html)`, `[CalculationUsage](CalculationUsage.html)`, `[CaseUsage](CaseUsage.html)`, `[ConcernUsage](ConcernUsage.html)`, `[ConnectionUsage](ConnectionUsage.html)`, `[ConstraintUsage](ConstraintUsage.html)`, `[ControlNode](ControlNode.html)`, `[DecisionNode](DecisionNode.html)`, `[EventOccurrenceUsage](EventOccurrenceUsage.html)`, `[ExhibitStateUsage](ExhibitStateUsage.html)`, `[FlowUsage](FlowUsage.html)`, `[ForkNode](ForkNode.html)`, `[ForLoopActionUsage](ForLoopActionUsage.html)`, `[IfActionUsage](IfActionUsage.html)`, `[IncludeUseCaseUsage](IncludeUseCaseUsage.html)`, `[InterfaceUsage](InterfaceUsage.html)`, `[ItemUsage](ItemUsage.html)`, `[JoinNode](JoinNode.html)`, `[LoopActionUsage](LoopActionUsage.html)`, `[MergeNode](MergeNode.html)`, `[MetadataUsage](MetadataUsage.html)`, `[PartUsage](PartUsage.html)`, `[PerformActionUsage](PerformActionUsage.html)`, `[PortUsage](PortUsage.html)`, `[RenderingUsage](RenderingUsage.html)`, `[RequirementUsage](RequirementUsage.html)`, `[SatisfyRequirementUsage](SatisfyRequirementUsage.html)`, `[SendActionUsage](SendActionUsage.html)`, `[StateUsage](StateUsage.html)`, `[SuccessionFlowUsage](SuccessionFlowUsage.html)`, `[TerminateActionUsage](TerminateActionUsage.html)`, `[TransitionUsage](TransitionUsage.html)`, `[UseCaseUsage](UseCaseUsage.html)`, `[VerificationCaseUsage](VerificationCaseUsage.html)`, `[ViewpointUsage](ViewpointUsage.html)`, `[ViewUsage](ViewUsage.html)`, `[WhileLoopActionUsage](WhileLoopActionUsage.html)`

@OpenApiAllpublic interfaceOccurrenceUsageextends [Usage](Usage.html)
...
Method
Description
`[OccurrenceDefinition](OccurrenceDefinition.html)`
`[getIndividualDefinition](#getIndividualDefinition())()`
The at most one `occurrenceDefinition` that has `isIndividual = true`.
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](../../../kerml/model/kerml/Class.html)>`
`[getOccurrenceDefinition](#getOccurrenceDefinition())()`
The `Classes` that are the types of this `OccurrenceUsage`.
`[PortionKind](PortionKind.html)`
`[getPortionKind](#getPortionKind())()`
The kind of temporal portion (time slice or snapshot) is represented by this `OccurrenceUsage`.
`boolean`
...
Whether this `OccurrenceUsage` represents the usage of the specific individual represented by its `individualDefinition`.
`void`
`[setPortionKind](#setPortionKind(com.dassault_systemes.modeler.sysml.model.sysml.PortionKind))([PortionKind](PortionKind.html) value)`
The kind of temporal portion (time slice or snapshot) is represented by this `OccurrenceUsage`.
...
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Class](../../../kerml/model/kerml/Class.html)> getOccurrenceDefinition()
...
Returns:
the occurrenceDefinition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="definedOccurrence"
 redefines=[`Usage.getDefinition()`](Usage.html#getDefinition())
getIndividualDefinition
@CheckForNull[OccurrenceDefinition](OccurrenceDefinition.html) getIndividualDefinition()
The at most one `occurrenceDefinition` that has `isIndividual = true`.
Returns:
the individualDefinition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="individualUsage"
 subsets=[`getOccurrenceDefinition()`](#getOccurrenceDefinition())
isIndividual
...
derived="false"
 transient="false"
getPortionKind
@CheckForNull[PortionKind](PortionKind.html) getPortionKind()
...
Returns:
the portionKind value
Model:
derived="false"
 transient="false"
setPortionKind
void setPortionKind(@CheckForNull
 [PortionKind](PortionKind.html) value)
The kind of temporal portion (time slice or snapshot) is represented by this `OccurrenceUsage`. If `portionKind` is not null, then the `owningType` of the `OccurrenceUsage` must be non-null, and the `OccurrenceUsage` represents portions of the featuring instance of the `owningType`.
Parameters:
`value` - the portionKind value
Model:
derived="false"
 transient="false"
...
<h1 class="title" title="Interface OccurrenceUsage">Interface OccurrenceUsage</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">OccurrenceUsage</span><span class="extends-implements">
extends <a href="Usage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">Usage</a></span></div>
<div class="block"><p>An <code>OccurrenceUsage</code> is a <code>Usage</code> whose <code>types</code> are all <code>Classes</code>. Nominally, if a <code>type</code> is an <code>OccurrenceDefinition</code>, an <code>OccurrenceUsage</code> is a <code>Usage</code> of that <code>OccurrenceDefinition</code> within a system. However, other types of Kernel <code>Classes</code> are also allowed, to permit use of <code>Classes</code> from the Kernel Model Libraries.</p>
 ...
 portionKind &lt;&gt; null implies
     ...
     (owningType.oclIsKindOf(OccurrenceDefinition) or
      owningType.oclIsKindOf(OccurrenceUsage))
 portionKind &lt;&gt; null implies isPortion</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="OccurrenceDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">OccurrenceDefinition</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getIndividualDefinition()">getIndividualDefinition</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The at most one <code>occurrenceDefinition</code> that has <code>isIndividual = true</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../../kerml/model/kerml/Class.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Class</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOccurrenceDefinition()">getOccurrenceDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Classes</code> that are the types of this <code>OccurrenceUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="PortionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">PortionKind</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getPortionKind()">getPortionKind</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The kind of temporal portion (time slice or snapshot) is represented by this <code>OccurrenceUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#isIndividual()">isIndividual</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether this <code>OccurrenceUsage</code> represents the usage of the specific individual represented by its <code>individualDefinition</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setIsIndividual(boolean)">setIsIndividual</a><wbr/>(boolean value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Whether this <code>OccurrenceUsage</code> represents the usage of the specific individual represented by its <code>individualDefinition</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setPortionKind(com.dassault_systemes.modeler.sysml.model.sysml.PortionKind)">setPortionKind</a><wbr/>(<a href="PortionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">PortionKind</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The kind of temporal portion (time slice or snapshot) is represented by this <code>OccurrenceUsage</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getOccurrenceDefinition()">
<h3>getOccurrenceDefinition</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../kerml/model/kerml/Class.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Class</a>&gt;</span> <span class="element-name">getOccurrenceDefinition</span>()</div>
<div class="block"><p>The <code>Classes</code> that are the types of this <code>OccurrenceUsage</code>. Nominally, these are <code>OccurrenceDefinitions</code>, but other kinds of kernel <code>Classes</code> are also allowed, to permit use of <code>Classes</code> from the Kernel Model Libraries.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the occurrenceDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="definedOccurrence"
        redefines=<a href="Usage.html#getDefinition()"><code>Usage.getDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getIndividualDefinition()">
<h3>getIndividualDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="OccurrenceDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">OccurrenceDefinition</a></span> <span class="element-name">getIndividualDefinition</span>()</div>
<div class="block"><p>The at most one <code>occurrenceDefinition</code> that has <code>isIndividual = true</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the individualDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="individualUsage"
        subsets=<a href="#getOccurrenceDefinition()"><code>getOccurrenceDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Whether this <code>OccurrenceUsage</code> represents the usage of the specific individual represented by its <code>individualDefinition</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="getPortionKind()">
<h3>getPortionKind</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="PortionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">PortionKind</a></span> <span class="element-name">getPortionKind</span>()</div>
<div class="block"><p>The kind of temporal portion (time slice or snapshot) is represented by this <code>OccurrenceUsage</code>. If <code>portionKind</code> is not null, then the <code>owningType</code> of the <code>OccurrenceUsage</code> must be non-null, and the <code>OccurrenceUsage</code> represents portions of the featuring instance of the <code>owningType</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the portionKind value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
...
<li>
<section class="detail" id="setPortionKind(com.dassault_systemes.modeler.sysml.model.sysml.PortionKind)">
<h3>setPortionKind</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setPortionKind</span><wbr/><span class="parameters">(@CheckForNull
 <a href="PortionKind.html" title="class in com.dassault_systemes.modeler.sysml.model.sysml">PortionKind</a> value)</span></div>
<div class="block"><p>The kind of temporal portion (time slice or snapshot) is represented by this <code>OccurrenceUsage</code>. If <code>portionKind</code> is not null, then the <code>owningType</code> of the <code>OccurrenceUsage</code> must be non-null, and the <code>OccurrenceUsage</code> represents portions of the featuring instance of the <code>owningType</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the portionKind value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"</dd>
</dl>
