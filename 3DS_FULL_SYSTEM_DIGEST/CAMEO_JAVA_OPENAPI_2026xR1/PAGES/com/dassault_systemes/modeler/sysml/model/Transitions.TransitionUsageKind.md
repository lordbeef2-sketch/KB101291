# JAVA OPENAPI: Transitions.TransitionUsageKind (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/Transitions.TransitionUsageKind.html
- source_path: `com/dassault_systemes/modeler/sysml/model/Transitions.TransitionUsageKind.html`
- source_sha256: `3bf8a8b91e6935986669a9bdf2c5fb5f48a4782026b5d6da36c8688784f40d4c`
- captured_utc: `2026-07-14T16:45:02.722039+00:00`
...
## Enum Class Transitions.TransitionUsageKind

[java.lang.Object](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html)
[java.lang.Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html)>
com.dassault_systemes.modeler.sysml.model.Transitions.TransitionUsageKind

All Implemented Interfaces:
`[Serializable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)<[Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html)>`, `[Constable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html)`

Enclosing class:
`[Transitions](Transitions.html)`

public static enumTransitions.TransitionUsageKind
extends [Enum](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html)<[Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html)>
...
STATE_TRANSITION
public static final [Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html) STATE_TRANSITION
DECISION_TRANSITION
public static final [Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html) DECISION_TRANSITION
 ============ METHOD DETAIL ========== 
Method Details
values
public static [Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html)[] values()
Returns an array containing the constants of this enum class, in
the order they are declared.
Returns:
an array containing the constants of this enum class, in the order they are declared
valueOf
public static [Transitions.TransitionUsageKind](Transitions.TransitionUsageKind.html) valueOf([String](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html) name)
Returns the enum constant of this class with the specified name.
...
<h1 class="title" title="Enum Class Transitions.TransitionUsageKind">Enum Class Transitions.TransitionUsageKind</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">java.lang.Object</a>
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a>&gt;
<div class="inheritance">com.dassault_systemes.modeler.sysml.model.Transitions.TransitionUsageKind</div>
</div>
</div>
<section class="class-description" id="class-description">
<dl class="notes">
<dt>All Implemented Interfaces:</dt>
<dd><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io">Serializable</a></code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang">Comparable</a>&lt;<a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a>&gt;</code>, <code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant">Constable</a></code></dd>
</dl>
<dl class="notes">
<dt>Enclosing class:</dt>
<dd><code><a href="Transitions.html" title="class in com.dassault_systemes.modeler.sysml.model">Transitions</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="modifiers">public static enum </span><span class="element-name type-name-label">Transitions.TransitionUsageKind</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a>&gt;</span></div>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#DECISION_TRANSITION">DECISION_TRANSITION</a></code></div>
<div class="col-last even-row-color"> </div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#STATE_TRANSITION">STATE_TRANSITION</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a></code></div>
...
<li>
<section class="detail" id="STATE_TRANSITION">
<h3>STATE_TRANSITION</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a></span> <span class="element-name">STATE_TRANSITION</span></div>
</section>
</li>
<li>
<section class="detail" id="DECISION_TRANSITION">
<h3>DECISION_TRANSITION</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a></span> <span class="element-name">DECISION_TRANSITION</span></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="Transitions.TransitionUsageKind.html" title="enum class in com.dassault_systemes.modeler.sysml.model">Transitions.TransitionUsageKind</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
