# JAVA OPENAPI: FramedConcernMembership (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/FramedConcernMembership.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/FramedConcernMembership.html`
- source_sha256: `9cd7a33d640a30ee078a959886685b67ae02a07a698afc85b78b9b0b29793397`
- captured_utc: `2026-07-14T16:45:03.876055+00:00`
...
@OpenApiAllpublic interfaceFramedConcernMembershipextends [RequirementConstraintMembership](RequirementConstraintMembership.html)
...
Method
Description
`[ConcernUsage](ConcernUsage.html)`
`[getOwnedConcern](#getOwnedConcern())()`
The `ConcernUsage` that is the `ownedConstraint` of this `FramedConcernMembership`.
`[ConcernUsage](ConcernUsage.html)`
`[getReferencedConcern](#getReferencedConcern())()`
The `ConcernUsage` that is referenced through this `FramedConcernMembership`.
`void`
`[setOwnedConcern](#setOwnedConcern(com.dassault_systemes.modeler.sysml.model.sysml.ConcernUsage))([ConcernUsage](ConcernUsage.html) value)`
The `ConcernUsage` that is the `ownedConstraint` of this `FramedConcernMembership`.
...
Method Details
getOwnedConcern
@CheckForNull[ConcernUsage](ConcernUsage.html) getOwnedConcern()
The `ConcernUsage` that is the `ownedConstraint` of this `FramedConcernMembership`.
Returns:
...
derived="true"
 transient="true"
 oppositeRoleName="framedConstraintMembership"
 redefines=[`RequirementConstraintMembership.getOwnedConstraint()`](RequirementConstraintMembership.html#getOwnedConstraint())
setOwnedConcern
void setOwnedConcern(@CheckForNull
 [ConcernUsage](ConcernUsage.html) value)
The `ConcernUsage` that is the `ownedConstraint` of this `FramedConcernMembership`.
Parameters:
`value` - the ownedConcern value
Model:
derived="true"
 transient="true"
 oppositeRoleName="framedConstraintMembership"
 redefines=[`RequirementConstraintMembership.getOwnedConstraint()`](RequirementConstraintMembership.html#getOwnedConstraint())
getReferencedConcern
@CheckForNull[ConcernUsage](ConcernUsage.html) getReferencedConcern()
...
Returns:
the referencedConcern value
Model:
derived="true"
 transient="true"
 oppositeRoleName="referencingConcernMembership"
...
<h1 class="title" title="Interface FramedConcernMembership">Interface FramedConcernMembership</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">FramedConcernMembership</span><span class="extends-implements">
...
<div class="block"><p>A <code>FramedConcernMembership</code> is a <code>RequirementConstraintMembership</code> for a framed <code>ConcernUsage</code> of a <code>RequirementDefinition</code> or <code>RequirementUsage</code>.</p>
 kind = RequirementConstraintKind::requirement</div>
</section>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getOwnedConcern()">getOwnedConcern</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ConcernUsage</code> that is the <code>ownedConstraint</code> of this <code>FramedConcernMembership</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencedConcern()">getReferencedConcern</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block"> The <code>ConcernUsage</code> that is referenced through this <code>FramedConcernMembership</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setOwnedConcern(com.dassault_systemes.modeler.sysml.model.sysml.ConcernUsage)">setOwnedConcern</a><wbr/>(<a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ConcernUsage</code> that is the <code>ownedConstraint</code> of this <code>FramedConcernMembership</code>.</div>
</div>
</div>
...
</span><span class="return-type"><a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a></span> <span class="element-name">getOwnedConcern</span>()</div>
<div class="block"><p>The <code>ConcernUsage</code> that is the <code>ownedConstraint</code> of this <code>FramedConcernMembership</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setOwnedConcern(com.dassault_systemes.modeler.sysml.model.sysml.ConcernUsage)">
<h3>setOwnedConcern</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setOwnedConcern</span><wbr/><span class="parameters">(@CheckForNull
 <a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a> value)</span></div>
<div class="block"><p>The <code>ConcernUsage</code> that is the <code>ownedConstraint</code> of this <code>FramedConcernMembership</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the ownedConcern value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="framedConstraintMembership"
...
<li>
<section class="detail" id="getReferencedConcern()">
<h3>getReferencedConcern</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ConcernUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConcernUsage</a></span> <span class="element-name">getReferencedConcern</span>()</div>
<div class="block"><p> The <code>ConcernUsage</code> that is referenced through this <code>FramedConcernMembership</code>. It is the <code>referencedConstraint</code> of the <code>FramedConcernMembership</code> considered as a <code>RequirementConstraintMembership</code>, which must be a <code>ConcernUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencedConcern value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="referencingConcernMembership"
