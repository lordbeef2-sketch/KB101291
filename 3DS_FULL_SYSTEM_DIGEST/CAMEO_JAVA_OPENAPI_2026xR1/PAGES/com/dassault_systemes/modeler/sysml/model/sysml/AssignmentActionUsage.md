# JAVA OPENAPI: AssignmentActionUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/AssignmentActionUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/AssignmentActionUsage.html`
- source_sha256: `369102096281b626f3f5877c8bae5585b4779f2da422b83187be5b72227f81a9`
- captured_utc: `2026-07-14T16:45:03.189045+00:00`
...
@OpenApiAllpublic interfaceAssignmentActionUsageextends [ActionUsage](ActionUsage.html)
...
`[getTargetArgument](#getTargetArgument())()`
...
Method Details
getTargetArgument
@CheckForNull[Expression](../../../kerml/model/kerml/Expression.html) getTargetArgument()
The `Expression` whose value is an occurrence in the domain of the `referent` `Feature`, for which the value of the `referent` will be set to the result of the `valueExpression` by this `AssignmentActionUsage`.
Returns:
the targetArgument value
Model:
derived="true"
 transient="true"
 oppositeRoleName="assignmentAction"
getValueExpression
@CheckForNull[Expression](../../../kerml/model/kerml/Expression.html) getValueExpression()
The `Expression` whose result is to be assigned to the `referent` `Feature`.
Returns:
the valueExpression value
Model:
derived="true"
 transient="true"
 oppositeRoleName="assigningAction"
getReferent
@CheckForNull[Feature](../../../kerml/model/kerml/Feature.html) getReferent()
The `Feature` whose value is to be set.
Returns:
the referent value
Model:
...
<h1 class="title" title="Interface AssignmentActionUsage">Interface AssignmentActionUsage</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">AssignmentActionUsage</span><span class="extends-implements">
...
<div class="block"><p>An <code>AssignmentActionUsage</code> is an <code>ActionUsage</code> that is defined, directly or indirectly, by the <code>ActionDefinition</code> <em><code>AssignmentAction</code></em> from the Systems Model Library. It specifies that the value of the <code>referent</code> <code>Feature</code>, relative to the target given by the result of the <code>targetArgument</code> <code>Expression</code>, should be set to the result of the <code>valueExpression</code>.</p>
 ...
 ownedMembership-&gt;exists(
     not oclIsKindOf(OwningMembership) and 
     memberElement.oclIsKindOf(Feature))
 referent &lt;&gt; null implies referent.featureTarget.mayTimeVary</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferent()">getReferent</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> whose value is to be set.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTargetArgument()">getTargetArgument</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expression</code> whose value is an occurrence in the domain of the <code>referent</code> <code>Feature</code>, for which the value of the <code>referent</code> will be set to the result of the <code>valueExpression</code> by this <code>AssignmentActionUsage</code>.</div>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getValueExpression()">getValueExpression</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expression</code> whose result is to be assigned to the <code>referent</code> <code>Feature</code>.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getTargetArgument()">
<h3>getTargetArgument</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getTargetArgument</span>()</div>
<div class="block"><p>The <code>Expression</code> whose value is an occurrence in the domain of the <code>referent</code> <code>Feature</code>, for which the value of the <code>referent</code> will be set to the result of the <code>valueExpression</code> by this <code>AssignmentActionUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the targetArgument value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="assignmentAction"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getValueExpression()">
<h3>getValueExpression</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span> <span class="element-name">getValueExpression</span>()</div>
<div class="block"><p>The <code>Expression</code> whose result is to be assigned to the <code>referent</code> <code>Feature</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the valueExpression value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="assigningAction"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getReferent()">
<h3>getReferent</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="../../../kerml/model/kerml/Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getReferent</span>()</div>
<div class="block"><p>The <code>Feature</code> whose value is to be set.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referent value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="assignment"</dd>
</dl>
</section>
</li>
</ul>
