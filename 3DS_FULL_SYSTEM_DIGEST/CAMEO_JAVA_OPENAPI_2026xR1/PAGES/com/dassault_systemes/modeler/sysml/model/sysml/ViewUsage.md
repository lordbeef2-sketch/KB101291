# JAVA OPENAPI: ViewUsage (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/sysml/model/sysml/ViewUsage.html
- source_path: `com/dassault_systemes/modeler/sysml/model/sysml/ViewUsage.html`
- source_sha256: `abc5fd1373ffac3e92075b6bf4119b5bce76accf8846f8d767333e5b4ca0c712`
- captured_utc: `2026-07-14T16:45:05.239071+00:00`
...
All Superinterfaces:
`[BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html)`, `[Cloneable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Cloneable.html)`, `[Comparable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Comparable.html)`, `[Element](../../../kerml/model/kerml/Element.html)`, `org.eclipse.emf.ecore.EObject`, `[Feature](../../../kerml/model/kerml/Feature.html)`, `[ItemUsage](ItemUsage.html)`, `[ModelElement](../../../foundation/model/ModelElement.html)`, `com.dassault_systemes.modeler.modelextension.model.modelextension.ModelExtensionObject`, `[Namespace](../../../kerml/model/kerml/Namespace.html)`, `org.eclipse.emf.common.notify.Notifier`, `[OccurrenceUsage](OccurrenceUsage.html)`, `[PartUsage](PartUsage.html)`, `[Type](../../../kerml/model/kerml/Type.html)`, `[Usage](Usage.html)`

@OpenApiAllpublic interfaceViewUsageextends [PartUsage](PartUsage.html)
...
Method
Description
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../kerml/model/kerml/Element.html)>`
`[getExposedElement](#getExposedElement())()`
...
`[getSatisfiedViewpoint](#getSatisfiedViewpoint())()`
...
`[getViewCondition](#getViewCondition())()`
...
`[ViewDefinition](ViewDefinition.html)`
`[getViewDefinition](#getViewDefinition())()`
The `ViewDefinition` that is the `definition` of this `ViewUsage`.
`[RenderingUsage](RenderingUsage.html)`
`[getViewRendering](#getViewRendering())()`
...
`boolean`
`[includeAsExposed](#includeAsExposed(com.dassault_systemes.modeler.kerml.model.kerml.Element))([Element](../../../kerml/model/kerml/Element.html) element)`
...
Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.[ItemUsage](ItemUsage.html)
`[getItemDefinition](ItemUsage.html#getItemDefinition())`
...
Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.[PartUsage](PartUsage.html)
`[getPartDefinition](PartUsage.html#getPartDefinition())`
...
Method Details
getViewDefinition
@CheckForNull[ViewDefinition](ViewDefinition.html) getViewDefinition()
The `ViewDefinition` that is the `definition` of this `ViewUsage`.
Returns:
the viewDefinition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="definedView"
 redefines=[`PartUsage.getPartDefinition()`](PartUsage.html#getPartDefinition())
getSatisfiedViewpoint
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[ViewpointUsage](ViewpointUsage.html)> getSatisfiedViewpoint()
The `nestedRequirements` of this `ViewUsage` that are `ViewpointUsages` for (additional) viewpoints satisfied by the `ViewUsage`.
Returns:
the satisfiedViewpoint value
Model:
derived="true"
 transient="true"
 oppositeRoleName="viewpointSatisfyingView"
 subsets=[`Usage.getNestedRequirement()`](Usage.html#getNestedRequirement())
getExposedElement
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Element](../../../kerml/model/kerml/Element.html)> getExposedElement()
The `Elements` that are exposed by this `ViewUsage`, which are those `memberElements` of the imported `Memberships` from all the `Expose` `Relationships` that meet all the owned and inherited `viewConditions`.
Returns:
the exposedElement value
Model:
derived="true"
 transient="true"
 oppositeRoleName="exposingView"
getViewRendering
@CheckForNull[RenderingUsage](RenderingUsage.html) getViewRendering()
The `RenderingUsage` to be used to render views defined by this `ViewUsage`, which is the `referencedRendering` of the `ViewRenderingMembership` of the `ViewUsage`.
Returns:
the viewRendering value
Model:
derived="true"
 transient="true"
 oppositeRoleName="renderingOwningView"
getViewCondition
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Expression](../../../kerml/model/kerml/Expression.html)> getViewCondition()
The `Expressions` related to this `ViewUsage` by `ElementFilterMemberships`, which specify conditions on `Elements` to be rendered in a view.
Returns:
the viewCondition value
Model:
derived="true"
 transient="true"
 oppositeRoleName="owningView"
includeAsExposed
boolean includeAsExposed([Element](../../../kerml/model/kerml/Element.html) element)
Determine whether the given `element` meets all the owned and inherited `viewConditions`.
...
<h1 class="title" title="Interface ViewUsage">Interface ViewUsage</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ViewUsage</span><span class="extends-implements">
extends <a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a></span></div>
<div class="block"><p>A <code>ViewUsage</code> is a usage of a <code>ViewDefinition</code> to specify the generation of a view of the <code>members</code> of a collection of <code>exposedNamespaces</code>. The <code>ViewUsage</code> can satisfy more <code>viewpoints</code> than its definition, and it can specialize the <code>viewRendering</code> specified by its definition.<p>
 exposedElement = ownedImport-&gt;selectByKind(Expose).
     importedMemberships(Set{}).memberElement-&gt;
     select(elm | includeAsExposed(elm))-&gt;
     asOrderedSet()
 ...
 (owningType.oclIsKindOf(ViewDefinition) or
  owningType.oclIsKindOf(ViewUsage)) implies
     specializesFromLibrary('Views::View::subviews')</p></p></div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getExposedElement()">getExposedElement</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Elements</code> that are exposed by this <code>ViewUsage</code>, which are those <code>memberElements</code> of the imported <code>Memberships</code> from all the <code>Expose</code> <code>Relationships</code> that meet all the owned and inherited <code>viewConditions</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="ViewpointUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewpointUsage</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getSatisfiedViewpoint()">getSatisfiedViewpoint</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>nestedRequirements</code> of this <code>ViewUsage</code> that are <code>ViewpointUsages</code> for (additional) viewpoints satisfied by the <code>ViewUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getViewCondition()">getViewCondition</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Expressions</code> related to this <code>ViewUsage</code> by <code>ElementFilterMemberships</code>, which specify conditions on <code>Elements</code> to be rendered in a view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="ViewDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewDefinition</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getViewDefinition()">getViewDefinition</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>ViewDefinition</code> that is the <code>definition</code> of this <code>ViewUsage</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getViewRendering()">getViewRendering</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>RenderingUsage</code> to be used to render views defined by this <code>ViewUsage</code>, which is the <code>referencedRendering</code> of the <code>ViewRenderingMembership</code> of the <code>ViewUsage</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#includeAsExposed(com.dassault_systemes.modeler.kerml.model.kerml.Element)">includeAsExposed</a><wbr/>(<a href="../../../kerml/model/kerml/Element.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Element</a> element)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Determine whether the given <code>element</code> meets all the owned and inherited <code>viewConditions</code>.</div>
</div>
</div>
</div>
</div>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.sysml.model.sysml.ItemUsage">Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.<a href="ItemUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ItemUsage</a></h3>
<code><a href="ItemUsage.html#getItemDefinition()">getItemDefinition</a></code></div>
<div class="inherited-list">
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.dassault_systemes.modeler.sysml.model.sysml.PartUsage">Methods inherited from interface com.dassault_systemes.modeler.sysml.model.sysml.<a href="PartUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">PartUsage</a></h3>
<code><a href="PartUsage.html#getPartDefinition()">getPartDefinition</a></code></div>
<div class="inherited-list">
...
<li>
<section class="detail" id="getViewDefinition()">
<h3>getViewDefinition</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="ViewDefinition.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewDefinition</a></span> <span class="element-name">getViewDefinition</span>()</div>
<div class="block"><p>The <code>ViewDefinition</code> that is the <code>definition</code> of this <code>ViewUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the viewDefinition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="definedView"
        redefines=<a href="PartUsage.html#getPartDefinition()"><code>PartUsage.getPartDefinition()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getSatisfiedViewpoint()">
<h3>getSatisfiedViewpoint</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="ViewpointUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ViewpointUsage</a>&gt;</span> <span class="element-name">getSatisfiedViewpoint</span>()</div>
<div class="block"><p>The <code>nestedRequirements</code> of this <code>ViewUsage</code> that are <code>ViewpointUsages</code> for (additional) viewpoints satisfied by the <code>ViewUsage</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the satisfiedViewpoint value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="viewpointSatisfyingView"
        subsets=<a href="Usage.html#getNestedRequirement()"><code>Usage.getNestedRequirement()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getExposedElement()">
<h3>getExposedElement</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../kerml/model/kerml/Element.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Element</a>&gt;</span> <span class="element-name">getExposedElement</span>()</div>
<div class="block"><p>The <code>Elements</code> that are exposed by this <code>ViewUsage</code>, which are those <code>memberElements</code> of the imported <code>Memberships</code> from all the <code>Expose</code> <code>Relationships</code> that meet all the owned and inherited <code>viewConditions</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the exposedElement value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="exposingView"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getViewRendering()">
<h3>getViewRendering</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="RenderingUsage.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">RenderingUsage</a></span> <span class="element-name">getViewRendering</span>()</div>
<div class="block"><p>The <code>RenderingUsage</code> to be used to render views defined by this <code>ViewUsage</code>, which is the <code>referencedRendering</code> of the <code>ViewRenderingMembership</code> of the <code>ViewUsage</code>.<p></p></p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the viewRendering value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="renderingOwningView"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="getViewCondition()">
<h3>getViewCondition</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="../../../kerml/model/kerml/Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a>&gt;</span> <span class="element-name">getViewCondition</span>()</div>
<div class="block"><p>The <code>Expressions</code> related to this <code>ViewUsage</code> by <code>ElementFilterMemberships</code>, which specify conditions on <code>Elements</code> to be rendered in a view.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the viewCondition value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="owningView"</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="includeAsExposed(com.dassault_systemes.modeler.kerml.model.kerml.Element)">
<h3>includeAsExposed</h3>
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">includeAsExposed</span><wbr/><span class="parameters">(<a href="../../../kerml/model/kerml/Element.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Element</a> element)</span></div>
<div class="block"><p>Determine whether the given <code>element</code> meets all the owned and inherited <code>viewConditions</code>.</p>
 let metadataFeatures: Sequence(AnnotatingElement) = 
     element.ownedAnnotation.annotatingElement-&gt;
         select(oclIsKindOf(MetadataFeature)) in
 self.membership-&gt;selectByKind(ElementFilterMembership).
