# JAVA OPENAPI: ConstructorExpression (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/ConstructorExpression.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/ConstructorExpression.html`
- source_sha256: `65fe48a92959302b7e38f30d6f5bf8f7d2f421876436eea77ff0d70e20201583`
- captured_utc: `2026-07-14T16:44:48.678850+00:00`
...
@OpenApiAllpublic interfaceConstructorExpressionextends [InstantiationExpression](InstantiationExpression.html)
...
<h1 class="title" title="Interface ConstructorExpression">Interface ConstructorExpression</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ConstructorExpression</span><span class="extends-implements">
...
<div class="block"><p>A <code>ConstructorExpression</code> is an <code>InstantiationExpression</code> whose <code>result</code> specializes its <code>instantiatedType</code>, binding some or all of the <code>features</code> of the <code>instantiatedType</code> to the <code>results</code> of its <code>argument</code> <code>Expressions</code>.</p>
 ...
 specializes('Performances::constructorEvaluations')
 result.specializes(instantiatedType)
 ownedFeatures-&gt;excluding(result)-&gt;isEmpty()</div>
</section>
...
<div class="block">A <code>ConstructorExpression</code> is model-level evaluable if all its argument <code>Expressions</code> are model-level evaluable.</div>
</div>
</div>
</div>
</div>
...
<code><a href="Expression.html#checkCondition(com.dassault_systemes.modeler.kerml.model.kerml.Element)">checkCondition</a>, <a href="Expression.html#evaluate(com.dassault_systemes.modeler.kerml.model.kerml.Element)">evaluate</a>, <a href="Expression.html#getFunction()">getFunction</a>, <a href="Expression.html#getResult()">getResult</a>, <a href="Expression.html#isModelLevelEvaluable()">isModelLevelEvaluable</a></code></div>
<div class="inherited-list">
...
<div class="block"><p>A <code>ConstructorExpression</code> is model-level evaluable if all its argument <code>Expressions</code> are model-level evaluable.</p>
 
 argument-&gt;forAll(modelLevelEvaluable(visited))</div>
<dl class="notes">
<dt>Specified by:</dt>
