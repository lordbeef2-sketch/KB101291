# JAVA OPENAPI: ReferenceSubsetting (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/ReferenceSubsetting.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/ReferenceSubsetting.html`
- source_sha256: `19ed4ee8d2ea366919b467f8f96000f8d9311decb33cc6db90f4e070e26ff2a0`
- captured_utc: `2026-07-14T16:44:50.245874+00:00`
...
@OpenApiAllpublic interfaceReferenceSubsettingextends [Subsetting](Subsetting.html)
...
`[getReferencedFeature](#getReferencedFeature())()`
The `Feature` that is referenced by the `referencingFeature` of this `ReferenceSubsetting`.
`[Feature](Feature.html)`
`[getReferencingFeature](#getReferencingFeature())()`
The `Feature` that owns this `ReferenceSubsetting` relationship, which is also its `subsettingFeature`.
`void`
`[setReferencedFeature](#setReferencedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` that is referenced by the `referencingFeature` of this `ReferenceSubsetting`.
`void`
`[setReferencingFeature](#setReferencingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` that owns this `ReferenceSubsetting` relationship, which is also its `subsettingFeature`.
...
@CheckForNull[Feature](Feature.html) getReferencedFeature()
The `Feature` that is referenced by the `referencingFeature` of this `ReferenceSubsetting`.
Returns:
the referencedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="referencing"
 redefines=[`Subsetting.getSubsettedFeature()`](Subsetting.html#getSubsettedFeature())
setReferencedFeature
void setReferencedFeature(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` that is referenced by the `referencingFeature` of this `ReferenceSubsetting`.
Parameters:
`value` - the referencedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="referencing"
 redefines=[`Subsetting.getSubsettedFeature()`](Subsetting.html#getSubsettedFeature())
getReferencingFeature
@CheckForNull[Feature](Feature.html) getReferencingFeature()
The `Feature` that owns this `ReferenceSubsetting` relationship, which is also its `subsettingFeature`.
Returns:
the referencingFeature value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedReferenceSubsetting()`](Feature.html#getOwnedReferenceSubsetting())
 redefines=[`Subsetting.getOwningFeature()`](Subsetting.html#getOwningFeature()), [`Subsetting.getSubsettingFeature()`](Subsetting.html#getSubsettingFeature())
setReferencingFeature
void setReferencingFeature(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` that owns this `ReferenceSubsetting` relationship, which is also its `subsettingFeature`.
Parameters:
`value` - the referencingFeature value
Model:
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedReferenceSubsetting()`](Feature.html#getOwnedReferenceSubsetting())
...
<h1 class="title" title="Interface ReferenceSubsetting">Interface ReferenceSubsetting</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">ReferenceSubsetting</span><span class="extends-implements">
extends <a href="Subsetting.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Subsetting</a></span></div>
<div class="block"><p><code>ReferenceSubsetting</code> is a kind of <code>Subsetting</code> in which the <code>referencedFeature</code> is syntactically distinguished from other <code>Features</code> subsetted by the <code>referencingFeature</code>. <code>ReferenceSubsetting</code> has the same semantics as <code>Subsetting</code>, but the <code>referencedFeature</code> may have a special purpose relative to the <code>referencingFeature</code>. For instance, <code>ReferenceSubsetting</code> is used to identify the <code>relatedFeatures</code> of a <code>Connector</code>.</p>
<p><code>ReferenceSubsetting</code> is always an <code>ownedRelationship</code> of its <code>referencingFeature</code>. A <code>Feature</code> can have at most one <code>ownedReferenceSubsetting</code>.</p></div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencedFeature()">getReferencedFeature</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that is referenced by the <code>referencingFeature</code> of this <code>ReferenceSubsetting</code>.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencingFeature()">getReferencingFeature</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that owns this <code>ReferenceSubsetting</code> relationship, which is also its <code>subsettingFeature</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setReferencedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setReferencedFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that is referenced by the <code>referencingFeature</code> of this <code>ReferenceSubsetting</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setReferencingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setReferencingFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that owns this <code>ReferenceSubsetting</code> relationship, which is also its <code>subsettingFeature</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getReferencedFeature()">
<h3>getReferencedFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getReferencedFeature</span>()</div>
<div class="block"><p>The <code>Feature</code> that is referenced by the <code>referencingFeature</code> of this <code>ReferenceSubsetting</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="referencing"
...
<li>
<section class="detail" id="setReferencedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setReferencedFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setReferencedFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> that is referenced by the <code>referencingFeature</code> of this <code>ReferenceSubsetting</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the referencedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="referencing"
...
<li>
<section class="detail" id="getReferencingFeature()">
<h3>getReferencingFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getReferencingFeature</span>()</div>
<div class="block"><p>The <code>Feature</code> that owns this <code>ReferenceSubsetting</code> relationship, which is also its <code>subsettingFeature</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencingFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedReferenceSubsetting()"><code>Feature.getOwnedReferenceSubsetting()</code></a>
        redefines=<a href="Subsetting.html#getOwningFeature()"><code>Subsetting.getOwningFeature()</code></a>, <a href="Subsetting.html#getSubsettingFeature()"><code>Subsetting.getSubsettingFeature()</code></a></dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="setReferencingFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setReferencingFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setReferencingFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> that owns this <code>ReferenceSubsetting</code> relationship, which is also its <code>subsettingFeature</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the referencingFeature value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedReferenceSubsetting()"><code>Feature.getOwnedReferenceSubsetting()</code></a>
