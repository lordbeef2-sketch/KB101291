# JAVA OPENAPI: FeatureReferenceExpression (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/FeatureReferenceExpression.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/FeatureReferenceExpression.html`
- source_sha256: `a82107da93b6a63318db32bf111c74a2f4d81086a9ec34357f7a0757d18037c1`
- captured_utc: `2026-07-14T16:44:49.671864+00:00`
...
@OpenApiAllpublic interfaceFeatureReferenceExpressionextends [Expression](Expression.html)
...
Method Details
getReferent
@CheckForNull[Feature](Feature.html) getReferent()
The `Feature` that is referenced by this `FeatureReferenceExpression`, which is its first non-`parameter` `member`.
Returns:
the referent value
Model:
derived="true"
 transient="true"
 oppositeRoleName="referenceExpression"
...
<h1 class="title" title="Interface FeatureReferenceExpression">Interface FeatureReferenceExpression</h1>
</div>
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">FeatureReferenceExpression</span><span class="extends-implements">
extends <a href="Expression.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Expression</a></span></div>
<div class="block"><p>A <code>FeatureReferenceExpression</code> is an <code>Expression</code> whose <code>result</code> is bound to a <code>referent</code> <code>Feature</code>.</p>
 referent =
     let nonParameterMemberships : Sequence(Membership) = ownedMembership-&gt;
         reject(oclIsKindOf(ParameterMembership)) in
     if nonParameterMemberships-&gt;isEmpty() or
...
<div class="block">First, determine a <code>value</code> <code>Expression</code> for the <code>referent</code>:</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferent()">getReferent</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that is referenced by this <code>FeatureReferenceExpression</code>, which is its first non-<code>parameter</code> <code>member</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#modelLevelEvaluable(java.util.List)">modelLevelEvaluable</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a>&gt; visited)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">A <code>FeatureReferenceExpression</code> is model-level evaluable if it's <code>referent</code></div>
</div>
</div>
</div>
</div>
...
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getReferent</span>()</div>
<div class="block"><p>The <code>Feature</code> that is referenced by this <code>FeatureReferenceExpression</code>, which is its first non-<code>parameter</code> <code>member</code>.<p></p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>A <code>FeatureReferenceExpression</code> is model-level evaluable if it's <code>referent</code></p>
<ul>
...
<li>has no <code>featuringTypes</code> and, if it has a <code>FeatureValue</code>, the <code>value</code> <code>Expression</code> is model-level evaluable.</li>
 ...
 referent.featuringType-&gt;isEmpty() and
     (referent.valuation = null or 
     referent.valuation.modelLevelEvaluable(visited-&gt;including(referent))))</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<div class="block"><p>First, determine a <code>value</code> <code>Expression</code> for the <code>referent</code>:</p>
<ul>
