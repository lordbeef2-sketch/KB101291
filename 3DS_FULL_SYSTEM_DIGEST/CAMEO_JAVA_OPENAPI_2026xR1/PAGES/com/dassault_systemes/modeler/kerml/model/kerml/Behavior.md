# JAVA OPENAPI: Behavior (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/Behavior.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/Behavior.html`
- source_sha256: `bbeb241b188fd6fe9a71032ff24807bcc00b379e09f62daf0ab4ae8960bb9b33`
- captured_utc: `2026-07-14T16:44:48.597850+00:00`
...
`[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Step](Step.html)>`
`[getStep](#getStep())()`
...
Method Details
getStep
[List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)<[Step](Step.html)> getStep()
The `Steps` that make up this `Behavior`.
Returns:
the step value
Model:
derived="true"
 transient="true"
 oppositeRoleName="featuringBehavior"
 subsets=[`Type.getFeature()`](Type.html#getFeature())
getParameter
...
derived="true"
 transient="true"
 oppositeRoleName="parameteredBehavior"
...
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">Behavior</span><span class="extends-implements">
extends <a href="Class.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Class</a></span></div>
<div class="block"><p>A <code>Behavior </code>coordinates occurrences of other <code>Behaviors</code>, as well as changes in objects. <code>Behaviors</code> can be decomposed into <code>Steps</code> and be characterized by <code>parameters</code>.</p>
 
 ownedSpecialization.general-&gt;forAll(not oclIsKindOf(Structure))
 specializesFromLibrary('Performances::Performance')
 step = feature-&gt;selectByKind(Step)</div>
</section>
...
<div class="block">The parameters of this <code>Behavior</code>, which are defined as its <code>directedFeatures</code>, whose values are passed into and/or out of a performance of the <code>Behavior</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a><wbr/>&lt;<a href="Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a>&gt;</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getStep()">getStep</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Steps</code> that make up this <code>Behavior</code>.</div>
</div>
</div>
</div>
</div>
...
<h3>getStep</h3>
<div class="member-signature"><span class="return-type"><a class="external-link" href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="Step.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Step</a>&gt;</span> <span class="element-name">getStep</span>()</div>
<div class="block"><p>The <code>Steps</code> that make up this <code>Behavior</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        oppositeRoleName="featuringBehavior"
        subsets=<a href="Type.html#getFeature()"><code>Type.getFeature()</code></a></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>The parameters of this <code>Behavior</code>, which are defined as its <code>directedFeatures</code>, whose values are passed into and/or out of a performance of the <code>Behavior</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
