# JAVA OPENAPI: FeatureTyping (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/FeatureTyping.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/FeatureTyping.html`
- source_sha256: `feb84eb16ae17174b832f357e1086ac26ab1840d1f7bbaac19f79cf76856d414`
- captured_utc: `2026-07-14T16:44:49.714865+00:00`
...
`[ConjugatedPortTyping](../../../sysml/model/sysml/ConjugatedPortTyping.html)`

@OpenApiAllpublic interfaceFeatureTypingextends [Specialization](Specialization.html)
...
`[Feature](Feature.html)`
`[getTypedFeature](#getTypedFeature())()`
The `Feature` that has a `type` determined by this `FeatureTyping`.
`void`
`[setType](#setType(com.dassault_systemes.modeler.kerml.model.kerml.Type))([Type](Type.html) value)`
The `Type` that is being applied by this `FeatureTyping`.
`void`
`[setTypedFeature](#setTypedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature))([Feature](Feature.html) value)`
The `Feature` that has a `type` determined by this `FeatureTyping`.
...
Method Details
getTypedFeature
@CheckForNull[Feature](Feature.html) getTypedFeature()
The `Feature` that has a `type` determined by this `FeatureTyping`.
Returns:
the typedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="typing"
 redefines=[`Specialization.getSpecific()`](Specialization.html#getSpecific())
setTypedFeature
void setTypedFeature(@CheckForNull
 [Feature](Feature.html) value)
The `Feature` that has a `type` determined by this `FeatureTyping`.
Parameters:
`value` - the typedFeature value
Model:
derived="false"
 transient="false"
 oppositeRoleName="typing"
...
derived="true"
 transient="true"
 opposite=[`Feature.getOwnedTyping()`](Feature.html#getOwnedTyping())
 subsets=[`getTypedFeature()`](#getTypedFeature())
...
<h1 class="title" title="Interface FeatureTyping">Interface FeatureTyping</h1>
</div>
...
<dd><code><a href="../../../sysml/model/sysml/ConjugatedPortTyping.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">ConjugatedPortTyping</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">FeatureTyping</span><span class="extends-implements">
...
<div class="block"><p><code>FeatureTyping</code> is <code>Specialization</code> in which the <code>specific</code> <code>Type</code> is a <code>Feature</code>. This means the set of instances of the (specific) <code>typedFeature</code> is a subset of the set of instances of the (general) <code>type</code>. In the simplest case, the <code>type</code> is a <code>Classifier</code>, whereupon the <code>typedFeature</code> has values that are instances of the <code>Classifier</code>.</p></div>
</section>
...
<div class="block">A <code>typedFeature</code> that is also the <code>owningRelatedElement</code> of this <code>FeatureTyping</code>.</div>
</div>
...
<div class="block">The <code>Type</code> that is being applied by this <code>FeatureTyping</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getTypedFeature()">getTypedFeature</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that has a <code>type</code> determined by this <code>FeatureTyping</code>.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">setType</a><wbr/>(<a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Type</code> that is being applied by this <code>FeatureTyping</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setTypedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">setTypedFeature</a><wbr/>(<a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Feature</code> that has a <code>type</code> determined by this <code>FeatureTyping</code>.</div>
</div>
</div>
...
<li>
<section class="detail" id="getTypedFeature()">
<h3>getTypedFeature</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a></span> <span class="element-name">getTypedFeature</span>()</div>
<div class="block"><p>The <code>Feature</code> that has a <code>type</code> determined by this <code>FeatureTyping</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the typedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="typing"
...
<li>
<section class="detail" id="setTypedFeature(com.dassault_systemes.modeler.kerml.model.kerml.Feature)">
<h3>setTypedFeature</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setTypedFeature</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Feature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Feature</a> value)</span></div>
<div class="block"><p>The <code>Feature</code> that has a <code>type</code> determined by this <code>FeatureTyping</code>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the typedFeature value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="typing"
...
<h3>getType</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Type.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Type</a></span> <span class="element-name">getType</span>()</div>
<div class="block"><p>The <code>Type</code> that is being applied by this <code>FeatureTyping</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setType(com.dassault_systemes.modeler.kerml.model.kerml.Type)">
<h3>setType</h3>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the type value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="typingByType"
...
<div class="block"><p>A <code>typedFeature</code> that is also the <code>owningRelatedElement</code> of this <code>FeatureTyping</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<dd>derived="true"
        transient="true"
        opposite=<a href="Feature.html#getOwnedTyping()"><code>Feature.getOwnedTyping()</code></a>
        subsets=<a href="#getTypedFeature()"><code>getTypedFeature()</code></a>
