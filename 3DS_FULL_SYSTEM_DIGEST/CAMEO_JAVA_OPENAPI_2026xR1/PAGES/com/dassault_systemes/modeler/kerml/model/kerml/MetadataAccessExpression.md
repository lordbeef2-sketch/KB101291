# JAVA OPENAPI: MetadataAccessExpression (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/MetadataAccessExpression.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/MetadataAccessExpression.html`
- source_sha256: `87994509ebee8adf91f44d0213f44e9be93b69d025f322d4300ed975d8d6ac4d`
- captured_utc: `2026-07-14T16:44:49.898868+00:00`
...
@OpenApiAllpublic interfaceMetadataAccessExpressionextends [Expression](Expression.html)
...
`[MetadataFeature](MetadataFeature.html)`
`[metaclassFeature](#metaclassFeature())()`
...
@CheckForNull[Element](Element.html) getReferencedElement()
The `Element` whose metadata is being accessed.
Returns:
the referencedElement value
Model:
derived="true"
 transient="true"
 oppositeRoleName="accessExpression"
...
metaclassFeature
[MetadataFeature](MetadataFeature.html) metaclassFeature()
Return a `MetadataFeature` whose `annotatedElement` is the `referencedElement`, whose `metaclass` is the reflective `Metaclass` corresponding to the MOF class of the `referencedElement` and whose `ownedFeatures` are bound to the MOF properties of the `referencedElement`.
...
<h1 class="title" title="Interface MetadataAccessExpression">Interface MetadataAccessExpression</h1>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#getReferencedElement()">getReferencedElement</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Element</code> whose metadata is being accessed.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="MetadataFeature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">MetadataFeature</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#metaclassFeature()">metaclassFeature</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Return a <code>MetadataFeature</code> whose <code>annotatedElement</code> is the <code>referencedElement</code>, whose <code>metaclass</code> is the reflective <code>Metaclass</code> corresponding to the MOF class of the <code>referencedElement</code> and whose <code>ownedFeatures</code> are bound to the MOF properties of the <code>referencedElement</code>.</div>
</div>
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">A <code>MetadataAccessExpression</code> is always model-level evaluable.</div>
</div>
</div>
</div>
</div>
...
<li>
<section class="detail" id="getReferencedElement()">
<h3>getReferencedElement</h3>
<div class="member-signature"><span class="annotations">@CheckForNull
</span><span class="return-type"><a href="Element.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Element</a></span> <span class="element-name">getReferencedElement</span>()</div>
<div class="block"><p>The <code>Element</code> whose metadata is being accessed.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the referencedElement value</dd>
<dt>Model:</dt>
<dd>derived="true"
        transient="true"
        oppositeRoleName="accessExpression"
...
<div class="block"><p>A <code>MetadataAccessExpression</code> is always model-level evaluable.</p>
 true</div>
<dl class="notes">
<dt>Specified by:</dt>
...
<li>
<section class="detail" id="metaclassFeature()">
<h3>metaclassFeature</h3>
<div class="member-signature"><span class="return-type"><a href="MetadataFeature.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">MetadataFeature</a></span> <span class="element-name">metaclassFeature</span>()</div>
<div class="block"><p>Return a <code>MetadataFeature</code> whose <code>annotatedElement</code> is the <code>referencedElement</code>, whose <code>metaclass</code> is the reflective <code>Metaclass</code> corresponding to the MOF class of the <code>referencedElement</code> and whose <code>ownedFeatures</code> are bound to the MOF properties of the <code>referencedElement</code>.</p></div>
</section>
</li>
</ul>
</section>
