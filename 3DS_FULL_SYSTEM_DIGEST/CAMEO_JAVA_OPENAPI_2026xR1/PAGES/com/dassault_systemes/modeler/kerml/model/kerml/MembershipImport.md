# JAVA OPENAPI: MembershipImport (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/model/kerml/MembershipImport.html
- source_path: `com/dassault_systemes/modeler/kerml/model/kerml/MembershipImport.html`
- source_sha256: `c96f5a210f1c29053ae3a72ebab4e1f4ea5c23c3f7407fef08936795b551c28c`
- captured_utc: `2026-07-14T16:44:49.918871+00:00`
...
`[MembershipExpose](../../../sysml/model/sysml/MembershipExpose.html)`

@OpenApiAllpublic interfaceMembershipImportextends [Import](Import.html)
...
Returns at least the `importedMembership`.
`void`
`[setImportedMembership](#setImportedMembership(com.dassault_systemes.modeler.kerml.model.kerml.Membership))([Membership](Membership.html) value)`
The `Membership` to be imported.
...
@CheckForNull[Membership](Membership.html) getImportedMembership()
The `Membership` to be imported.
Returns:
...
setImportedMembership
void setImportedMembership(@CheckForNull
 [Membership](Membership.html) value)
The `Membership` to be imported.
Parameters:
`value` - the importedMembership value
Model:
derived="false"
 transient="false"
 oppositeRoleName="import"
...
<h1 class="title" title="Interface MembershipImport">Interface MembershipImport</h1>
</div>
...
<dd><code><a href="../../../sysml/model/sysml/MembershipExpose.html" title="interface in com.dassault_systemes.modeler.sysml.model.sysml">MembershipExpose</a></code></dd>
</dl>
<hr/>
<div class="type-signature"><span class="annotations">@OpenApiAll
</span><span class="modifiers">public interface </span><span class="element-name type-name-label">MembershipImport</span><span class="extends-implements">
extends <a href="Import.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Import</a></span></div>
<div class="block"><p>A <code>MembershipImport</code> is an <code>Import</code> that imports its <code>importedMembership</code> into the <code>importOwningNamespace</code>. If <code>isRecursive = true</code> and the <code>memberElement</code> of the <code>importedMembership</code> is a <code>Namespace</code>, then the equivalent of a recursive <code>NamespaceImport</code> is also performed on that <code>Namespace</code>.</p>
 
 importedElement = importedMembership.memberElement</div>
</section>
...
<div class="block">The <code>Membership</code> to be imported.</div>
</div>
...
<div class="block">Returns at least the <code>importedMembership</code>.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#setImportedMembership(com.dassault_systemes.modeler.kerml.model.kerml.Membership)">setImportedMembership</a><wbr/>(<a href="Membership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Membership</a> value)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">The <code>Membership</code> to be imported.</div>
</div>
</div>
...
</span><span class="return-type"><a href="Membership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Membership</a></span> <span class="element-name">getImportedMembership</span>()</div>
<div class="block"><p>The <code>Membership</code> to be imported.</p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<li>
<section class="detail" id="setImportedMembership(com.dassault_systemes.modeler.kerml.model.kerml.Membership)">
<h3>setImportedMembership</h3>
<div class="member-signature"><span class="return-type">void</span> <span class="element-name">setImportedMembership</span><wbr/><span class="parameters">(@CheckForNull
 <a href="Membership.html" title="interface in com.dassault_systemes.modeler.kerml.model.kerml">Membership</a> value)</span></div>
<div class="block"><p>The <code>Membership</code> to be imported.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - the importedMembership value</dd>
<dt>Model:</dt>
<dd>derived="false"
        transient="false"
        oppositeRoleName="import"
...
<div class="block"><p>Returns at least the <code>importedMembership</code>. If <code>isRecursive = true</code> and the <code>memberElement</code> of the <code>importedMembership</code> is a <code>Namespace</code>, then <code>Memberships</code> are also recursively imported from that <code>Namespace</code>.</p>
