# JAVA OPENAPI: MetaobjectsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/MetaobjectsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/MetaobjectsLibrary.html`
- source_sha256: `bad70438172f429cdebc893443cdab1a6cd76fcb952eb240e9fe5662518256f3`
- captured_utc: `2026-07-14T16:44:46.079817+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.MetaobjectsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classMetaobjectsLibrary
...
Description
`static class`
`[MetaobjectsLibrary.MetaobjectMetaclass](MetaobjectsLibrary.MetaobjectMetaclass.html)`
Type wrapper for the MetaobjectMetaclass library element.
`static class`
`[MetaobjectsLibrary.MetaobjectsFeature](MetaobjectsLibrary.MetaobjectsFeature.html)`
Type wrapper for the MetaobjectsFeature library element.
`static class`
`[MetaobjectsLibrary.SemanticMetadataMetaclass](MetaobjectsLibrary.SemanticMetadataMetaclass.html)`
...
Constructor
Description
`[MetaobjectsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a MetaobjectsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [MetaobjectsLibrary](MetaobjectsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the MetaobjectsLibrary instance for the project that owns the given element.
`static [MetaobjectsLibrary](MetaobjectsLibrary.html)`
...
Returns the MetaobjectsLibrary instance for the given project.
...
Returns the wrapper for the Metaobject library element.
`[MetaobjectsLibrary.MetaobjectsFeature](MetaobjectsLibrary.MetaobjectsFeature.html)`
`[metaobjects](#metaobjects())()`
Returns the wrapper for the metaobjects library element.
...
Returns the wrapper for the SemanticMetadata library element.
...
Constructor Details
MetaobjectsLibrary
public MetaobjectsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a MetaobjectsLibrary for the given project.
Parameters:
...
public static [MetaobjectsLibrary](MetaobjectsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the MetaobjectsLibrary instance for the given project.
Parameters:
...
getInstance
public static [MetaobjectsLibrary](MetaobjectsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the MetaobjectsLibrary instance for the project that owns the given element.
Parameters:
...
Metaobject
public [MetaobjectsLibrary.MetaobjectMetaclass](MetaobjectsLibrary.MetaobjectMetaclass.html) Metaobject()
Returns the wrapper for the Metaobject library element.
Returns:
the wrapper for the Metaobject element
SemanticMetadata
public [MetaobjectsLibrary.SemanticMetadataMetaclass](MetaobjectsLibrary.SemanticMetadataMetaclass.html) SemanticMetadata()
Returns the wrapper for the SemanticMetadata library element.
Returns:
the wrapper for the SemanticMetadata element
metaobjects
public [MetaobjectsLibrary.MetaobjectsFeature](MetaobjectsLibrary.MetaobjectsFeature.html) metaobjects()
Returns the wrapper for the metaobjects library element.
Returns:
the wrapper for the metaobjects element
getTypeWrappers
...
<h1 class="title" title="Class MetaobjectsLibrary">Class MetaobjectsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.MetaobjectsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">MetaobjectsLibrary</span>
...
<div class="block">Provides typed access to elements from the Metaobjects standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="MetaobjectsLibrary.MetaobjectMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectMetaclass</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the MetaobjectMetaclass library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="MetaobjectsLibrary.MetaobjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectsFeature</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the MetaobjectsFeature library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="MetaobjectsLibrary.SemanticMetadataMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.SemanticMetadataMetaclass</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the SemanticMetadataMetaclass library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MetaobjectsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary</a></code></div>
...
<div class="block">Returns the MetaobjectsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="MetaobjectsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary</a></code></div>
...
<div class="block">Returns the MetaobjectsLibrary instance for the given project.</div>
</div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MetaobjectsLibrary.MetaobjectMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectMetaclass</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Metaobject()">Metaobject</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Metaobject library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MetaobjectsLibrary.MetaobjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectsFeature</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#metaobjects()">metaobjects</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the metaobjects library element.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="MetaobjectsLibrary.SemanticMetadataMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.SemanticMetadataMetaclass</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#SemanticMetadata()">SemanticMetadata</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the SemanticMetadata library element.</div>
</div>
</div>
</div>
</div>
...
<h3>MetaobjectsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MetaobjectsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a MetaobjectsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="Metaobject()">
<h3>Metaobject</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="MetaobjectsLibrary.MetaobjectMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectMetaclass</a></span> <span class="element-name">Metaobject</span>()</div>
<div class="block">Returns the wrapper for the Metaobject library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Metaobject element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="SemanticMetadata()">
<h3>SemanticMetadata</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="MetaobjectsLibrary.SemanticMetadataMetaclass.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.SemanticMetadataMetaclass</a></span> <span class="element-name">SemanticMetadata</span>()</div>
<div class="block">Returns the wrapper for the SemanticMetadata library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the SemanticMetadata element</dd>
</dl>
</section>
</li>
<li>
...
<h3>metaobjects</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="MetaobjectsLibrary.MetaobjectsFeature.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">MetaobjectsLibrary.MetaobjectsFeature</a></span> <span class="element-name">metaobjects</span>()</div>
<div class="block">Returns the wrapper for the metaobjects library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the metaobjects element</dd>
</dl>
</section>
</li>
<li>
