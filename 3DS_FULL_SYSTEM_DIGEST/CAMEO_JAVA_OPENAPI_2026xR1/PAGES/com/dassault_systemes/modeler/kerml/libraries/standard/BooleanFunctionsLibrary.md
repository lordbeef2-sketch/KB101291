# JAVA OPENAPI: BooleanFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/BooleanFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/BooleanFunctionsLibrary.html`
- source_sha256: `ae3959582a35768a795d9a851cbedc75e812170d3a31077faf45eb7b1685d57d`
- captured_utc: `2026-07-14T16:44:45.307807+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.BooleanFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classBooleanFunctionsLibrary
...
Constructor
Description
`[BooleanFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a BooleanFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [BooleanFunctionsLibrary](BooleanFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the BooleanFunctionsLibrary instance for the project that owns the given element.
`static [BooleanFunctionsLibrary](BooleanFunctionsLibrary.html)`
...
Returns the BooleanFunctionsLibrary instance for the given project.
...
public BooleanFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a BooleanFunctionsLibrary for the given project.
Parameters:
...
public static [BooleanFunctionsLibrary](BooleanFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the BooleanFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [BooleanFunctionsLibrary](BooleanFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the BooleanFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class BooleanFunctionsLibrary">Class BooleanFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.BooleanFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">BooleanFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the BooleanFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BooleanFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BooleanFunctionsLibrary</a></code></div>
...
<div class="block">Returns the BooleanFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="BooleanFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">BooleanFunctionsLibrary</a></code></div>
...
<div class="block">Returns the BooleanFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>BooleanFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">BooleanFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a BooleanFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
