# JAVA OPENAPI: StringFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/StringFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/StringFunctionsLibrary.html`
- source_sha256: `6d0931c778b03631faa72c6294f62b10f9fd3889a919dd295b01116c92764902`
- captured_utc: `2026-07-14T16:44:46.931828+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.StringFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classStringFunctionsLibrary
...
Constructor
Description
`[StringFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a StringFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [StringFunctionsLibrary](StringFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the StringFunctionsLibrary instance for the project that owns the given element.
`static [StringFunctionsLibrary](StringFunctionsLibrary.html)`
...
Returns the StringFunctionsLibrary instance for the given project.
...
public StringFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a StringFunctionsLibrary for the given project.
Parameters:
...
public static [StringFunctionsLibrary](StringFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the StringFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [StringFunctionsLibrary](StringFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the StringFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class StringFunctionsLibrary">Class StringFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.StringFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">StringFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the StringFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StringFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StringFunctionsLibrary</a></code></div>
...
<div class="block">Returns the StringFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StringFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StringFunctionsLibrary</a></code></div>
...
<div class="block">Returns the StringFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>StringFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StringFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a StringFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
