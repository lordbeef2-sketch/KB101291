# JAVA OPENAPI: TransfersLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/TransfersLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/TransfersLibrary.html`
- source_sha256: `c49fb19ed1af8fcd68cc30cf11d990e0cd8ba762d1cb189df66dd192befb825e`
- captured_utc: `2026-07-14T16:44:47.059829+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.TransfersLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classTransfersLibrary
...
Description
`static class`
`[TransfersLibrary.FlowTransfersBeforeFlow](TransfersLibrary.FlowTransfersBeforeFlow.html)`
Type wrapper for the FlowTransfersBeforeFlow library element.
`static class`
`[TransfersLibrary.FlowTransfersFlow](TransfersLibrary.FlowTransfersFlow.html)`
Type wrapper for the FlowTransfersFlow library element.
`static class`
`[TransfersLibrary.TransferInteraction](TransfersLibrary.TransferInteraction.html)`
Type wrapper for the TransferInteraction library element.
`static class`
`[TransfersLibrary.TransfersStep](TransfersLibrary.TransfersStep.html)`
...
Constructor
Description
`[TransfersLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a TransfersLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Returns the wrapper for the flowTransfers library element.
`[TransfersLibrary.FlowTransfersBeforeFlow](TransfersLibrary.FlowTransfersBeforeFlow.html)`
`[flowTransfersBefore](#flowTransfersBefore())()`
Returns the wrapper for the flowTransfersBefore library element.
`static [TransfersLibrary](TransfersLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the TransfersLibrary instance for the project that owns the given element.
`static [TransfersLibrary](TransfersLibrary.html)`
...
Returns the TransfersLibrary instance for the given project.
...
`[TransfersLibrary.TransferInteraction](TransfersLibrary.TransferInteraction.html)`
`[Transfer](#Transfer())()`
Returns the wrapper for the Transfer library element.
`[TransfersLibrary.TransfersStep](TransfersLibrary.TransfersStep.html)`
`[transfers](#transfers())()`
Returns the wrapper for the transfers library element.
...
Constructor Details
TransfersLibrary
public TransfersLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a TransfersLibrary for the given project.
Parameters:
...
public static [TransfersLibrary](TransfersLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the TransfersLibrary instance for the given project.
Parameters:
...
getInstance
public static [TransfersLibrary](TransfersLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the TransfersLibrary instance for the project that owns the given element.
Parameters:
...
Transfer
public [TransfersLibrary.TransferInteraction](TransfersLibrary.TransferInteraction.html) Transfer()
Returns the wrapper for the Transfer library element.
Returns:
the wrapper for the Transfer element
transfers
public [TransfersLibrary.TransfersStep](TransfersLibrary.TransfersStep.html) transfers()
Returns the wrapper for the transfers library element.
Returns:
the wrapper for the transfers element
flowTransfers
public [TransfersLibrary.FlowTransfersFlow](TransfersLibrary.FlowTransfersFlow.html) flowTransfers()
Returns the wrapper for the flowTransfers library element.
Returns:
the wrapper for the flowTransfers element
flowTransfersBefore
public [TransfersLibrary.FlowTransfersBeforeFlow](TransfersLibrary.FlowTransfersBeforeFlow.html) flowTransfersBefore()
Returns the wrapper for the flowTransfersBefore library element.
Returns:
the wrapper for the flowTransfersBefore element
getTypeWrappers
...
<h1 class="title" title="Class TransfersLibrary">Class TransfersLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.TransfersLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TransfersLibrary</span>
...
<div class="block">Provides typed access to elements from the Transfers standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="TransfersLibrary.FlowTransfersBeforeFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersBeforeFlow</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the FlowTransfersBeforeFlow library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="TransfersLibrary.FlowTransfersFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersFlow</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the FlowTransfersFlow library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="TransfersLibrary.TransferInteraction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransferInteraction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the TransferInteraction library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="TransfersLibrary.TransfersStep.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransfersStep</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the TransfersStep library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TransfersLibrary.FlowTransfersFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersFlow</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#flowTransfers()">flowTransfers</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the flowTransfers library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TransfersLibrary.FlowTransfersBeforeFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersBeforeFlow</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#flowTransfersBefore()">flowTransfersBefore</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the flowTransfersBefore library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TransfersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary</a></code></div>
...
<div class="block">Returns the TransfersLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TransfersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary</a></code></div>
...
<div class="block">Returns the TransfersLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TransfersLibrary.TransferInteraction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransferInteraction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Transfer()">Transfer</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Transfer library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TransfersLibrary.TransfersStep.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransfersStep</a></code></div>
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the transfers library element.</div>
</div>
</div>
</div>
</div>
...
<h3>TransfersLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TransfersLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a TransfersLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TransfersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the TransfersLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TransfersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the TransfersLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="Transfer()">
<h3>Transfer</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TransfersLibrary.TransferInteraction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransferInteraction</a></span> <span class="element-name">Transfer</span>()</div>
<div class="block">Returns the wrapper for the Transfer library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Transfer element</dd>
</dl>
</section>
</li>
<li>
...
<h3>transfers</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TransfersLibrary.TransfersStep.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.TransfersStep</a></span> <span class="element-name">transfers</span>()</div>
<div class="block">Returns the wrapper for the transfers library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the transfers element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="flowTransfers()">
<h3>flowTransfers</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TransfersLibrary.FlowTransfersFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersFlow</a></span> <span class="element-name">flowTransfers</span>()</div>
<div class="block">Returns the wrapper for the flowTransfers library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the flowTransfers element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="flowTransfersBefore()">
<h3>flowTransfersBefore</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TransfersLibrary.FlowTransfersBeforeFlow.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TransfersLibrary.FlowTransfersBeforeFlow</a></span> <span class="element-name">flowTransfersBefore</span>()</div>
<div class="block">Returns the wrapper for the flowTransfersBefore library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the flowTransfersBefore element</dd>
</dl>
</section>
</li>
<li>
