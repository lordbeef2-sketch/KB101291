# JAVA OPENAPI: FeatureReferencingPerformancesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/FeatureReferencingPerformancesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/FeatureReferencingPerformancesLibrary.html`
- source_sha256: `159bcffb4d5245ba49094036790087cb1c1680c15f3e6c69c491f47f80fc1804`
- captured_utc: `2026-07-14T16:44:45.616810+00:00`
...
## Class FeatureReferencingPerformancesLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.FeatureReferencingPerformancesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classFeatureReferencingPerformancesLibrary
...
Description
`static class`
`[FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior](FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html)`
...
Constructor
Description
`[FeatureReferencingPerformancesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a FeatureReferencingPerformancesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Description
`[FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior](FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html)`
`[FeatureAccessPerformance](#FeatureAccessPerformance())()`
Returns the wrapper for the FeatureAccessPerformance library element.
`static [FeatureReferencingPerformancesLibrary](FeatureReferencingPerformancesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the FeatureReferencingPerformancesLibrary instance for the project that owns the given element.
`static [FeatureReferencingPerformancesLibrary](FeatureReferencingPerformancesLibrary.html)`
...
Returns the FeatureReferencingPerformancesLibrary instance for the given project.
...
public FeatureReferencingPerformancesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a FeatureReferencingPerformancesLibrary for the given project.
Parameters:
...
public static [FeatureReferencingPerformancesLibrary](FeatureReferencingPerformancesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the FeatureReferencingPerformancesLibrary instance for the given project.
Parameters:
...
getInstance
public static [FeatureReferencingPerformancesLibrary](FeatureReferencingPerformancesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the FeatureReferencingPerformancesLibrary instance for the project that owns the given element.
Parameters:
...
public [FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior](FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html) FeatureAccessPerformance()
Returns the wrapper for the FeatureAccessPerformance library element.
Returns:
the wrapper for the FeatureAccessPerformance element
getTypeWrappers
...
<h1 class="title" title="Class FeatureReferencingPerformancesLibrary">Class FeatureReferencingPerformancesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.FeatureReferencingPerformancesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">FeatureReferencingPerformancesLibrary</span>
...
<div class="block">Provides typed access to elements from the FeatureReferencingPerformances standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the FeatureAccessPerformanceBehavior library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#FeatureAccessPerformance()">FeatureAccessPerformance</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the FeatureAccessPerformance library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="FeatureReferencingPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary</a></code></div>
...
<div class="block">Returns the FeatureReferencingPerformancesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="FeatureReferencingPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary</a></code></div>
...
<div class="block">Returns the FeatureReferencingPerformancesLibrary instance for the given project.</div>
</div>
...
<h3>FeatureReferencingPerformancesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">FeatureReferencingPerformancesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a FeatureReferencingPerformancesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="FeatureReferencingPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the FeatureReferencingPerformancesLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="FeatureReferencingPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the FeatureReferencingPerformancesLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="FeatureAccessPerformance()">
<h3>FeatureAccessPerformance</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">FeatureReferencingPerformancesLibrary.FeatureAccessPerformanceBehavior</a></span> <span class="element-name">FeatureAccessPerformance</span>()</div>
<div class="block">Returns the wrapper for the FeatureAccessPerformance library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the FeatureAccessPerformance element</dd>
</dl>
</section>
</li>
<li>
