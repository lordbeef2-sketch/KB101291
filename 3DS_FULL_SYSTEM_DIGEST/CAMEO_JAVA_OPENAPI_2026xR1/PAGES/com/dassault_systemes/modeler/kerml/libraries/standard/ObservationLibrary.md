# JAVA OPENAPI: ObservationLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ObservationLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ObservationLibrary.html`
- source_sha256: `6875761541b1267364547b7a1a2379b29001709faa393ec9de87b017b76ae845`
- captured_utc: `2026-07-14T16:44:46.243818+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.ObservationLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classObservationLibrary
...
Constructor
Description
`[ObservationLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a ObservationLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [ObservationLibrary](ObservationLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the ObservationLibrary instance for the project that owns the given element.
`static [ObservationLibrary](ObservationLibrary.html)`
...
Returns the ObservationLibrary instance for the given project.
...
Constructor Details
ObservationLibrary
public ObservationLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ObservationLibrary for the given project.
Parameters:
...
public static [ObservationLibrary](ObservationLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ObservationLibrary instance for the given project.
Parameters:
...
getInstance
public static [ObservationLibrary](ObservationLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ObservationLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class ObservationLibrary">Class ObservationLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ObservationLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ObservationLibrary</span>
...
<div class="block">Provides typed access to elements from the Observation standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ObservationLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObservationLibrary</a></code></div>
...
<div class="block">Returns the ObservationLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ObservationLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObservationLibrary</a></code></div>
...
<div class="block">Returns the ObservationLibrary instance for the given project.</div>
</div>
...
<h3>ObservationLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ObservationLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ObservationLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ObservationLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObservationLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the ObservationLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ObservationLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ObservationLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the ObservationLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
