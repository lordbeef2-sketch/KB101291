# JAVA OPENAPI: CollectionFunctionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/CollectionFunctionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/CollectionFunctionsLibrary.html`
- source_sha256: `8fec3949280d68b4a87bbec41502f88b0cbd7cec8d8aacbaaf167a459094543f`
- captured_utc: `2026-07-14T16:44:45.113803+00:00`
...
## Class CollectionFunctionsLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.CollectionFunctionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classCollectionFunctionsLibrary
...
Constructor
Description
`[CollectionFunctionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a CollectionFunctionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [CollectionFunctionsLibrary](CollectionFunctionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the CollectionFunctionsLibrary instance for the project that owns the given element.
`static [CollectionFunctionsLibrary](CollectionFunctionsLibrary.html)`
...
Returns the CollectionFunctionsLibrary instance for the given project.
...
public CollectionFunctionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a CollectionFunctionsLibrary for the given project.
Parameters:
...
public static [CollectionFunctionsLibrary](CollectionFunctionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the CollectionFunctionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [CollectionFunctionsLibrary](CollectionFunctionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the CollectionFunctionsLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class CollectionFunctionsLibrary">Class CollectionFunctionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.CollectionFunctionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CollectionFunctionsLibrary</span>
...
<div class="block">Provides typed access to elements from the CollectionFunctions standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CollectionFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionFunctionsLibrary</a></code></div>
...
<div class="block">Returns the CollectionFunctionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CollectionFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionFunctionsLibrary</a></code></div>
...
<div class="block">Returns the CollectionFunctionsLibrary instance for the given project.</div>
</div>
...
<h3>CollectionFunctionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CollectionFunctionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a CollectionFunctionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="CollectionFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionFunctionsLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the CollectionFunctionsLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="CollectionFunctionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionFunctionsLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the CollectionFunctionsLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
