# JAVA OPENAPI: CollectionsLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/CollectionsLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/CollectionsLibrary.html`
- source_sha256: `1b17245a6a83cbe82b6fd913f8c8f2e43a467b6d25bec4a09e23628d38ffaba0`
- captured_utc: `2026-07-14T16:44:45.129803+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.CollectionsLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classCollectionsLibrary
...
Description
`static class`
`[CollectionsLibrary.ArrayDataType](CollectionsLibrary.ArrayDataType.html)`
...
Constructor
Description
`[CollectionsLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a CollectionsLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
`[CollectionsLibrary.ArrayDataType](CollectionsLibrary.ArrayDataType.html)`
`[Array](#Array())()`
Returns the wrapper for the Array library element.
`static [CollectionsLibrary](CollectionsLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the CollectionsLibrary instance for the project that owns the given element.
`static [CollectionsLibrary](CollectionsLibrary.html)`
...
Returns the CollectionsLibrary instance for the given project.
...
Constructor Details
CollectionsLibrary
public CollectionsLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a CollectionsLibrary for the given project.
Parameters:
...
public static [CollectionsLibrary](CollectionsLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the CollectionsLibrary instance for the given project.
Parameters:
...
getInstance
public static [CollectionsLibrary](CollectionsLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the CollectionsLibrary instance for the project that owns the given element.
Parameters:
...
Array
public [CollectionsLibrary.ArrayDataType](CollectionsLibrary.ArrayDataType.html) Array()
Returns the wrapper for the Array library element.
Returns:
the wrapper for the Array element
getTypeWrappers
...
<h1 class="title" title="Class CollectionsLibrary">Class CollectionsLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.CollectionsLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">CollectionsLibrary</span>
...
<div class="block">Provides typed access to elements from the Collections standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="CollectionsLibrary.ArrayDataType.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionsLibrary.ArrayDataType</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the ArrayDataType library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="CollectionsLibrary.ArrayDataType.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionsLibrary.ArrayDataType</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#Array()">Array</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the Array library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CollectionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionsLibrary</a></code></div>
...
<div class="block">Returns the CollectionsLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="CollectionsLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionsLibrary</a></code></div>
...
<div class="block">Returns the CollectionsLibrary instance for the given project.</div>
</div>
...
<h3>CollectionsLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CollectionsLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a CollectionsLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>Array</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="CollectionsLibrary.ArrayDataType.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">CollectionsLibrary.ArrayDataType</a></span> <span class="element-name">Array</span>()</div>
<div class="block">Returns the wrapper for the Array library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the Array element</dd>
</dl>
</section>
</li>
<li>
