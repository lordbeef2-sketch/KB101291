# JAVA OPENAPI: StatePerformancesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/StatePerformancesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/StatePerformancesLibrary.html`
- source_sha256: `cc0b569696add0891c89b8455d09e1e7a4225215028ab66bbd09dd6a1277c8d7`
- captured_utc: `2026-07-14T16:44:46.964829+00:00`
...
## Class StatePerformancesLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.StatePerformancesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classStatePerformancesLibrary
...
Constructor
Description
`[StatePerformancesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a StatePerformancesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [StatePerformancesLibrary](StatePerformancesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the StatePerformancesLibrary instance for the project that owns the given element.
`static [StatePerformancesLibrary](StatePerformancesLibrary.html)`
...
Returns the StatePerformancesLibrary instance for the given project.
...
========= CONSTRUCTOR DETAIL ======== 
Constructor Details
StatePerformancesLibrary
public StatePerformancesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a StatePerformancesLibrary for the given project.
Parameters:
...
public static [StatePerformancesLibrary](StatePerformancesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the StatePerformancesLibrary instance for the given project.
Parameters:
...
getInstance
public static [StatePerformancesLibrary](StatePerformancesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the StatePerformancesLibrary instance for the project that owns the given element.
Parameters:
...
<h1 class="title" title="Class StatePerformancesLibrary">Class StatePerformancesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.StatePerformancesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">StatePerformancesLibrary</span>
...
<div class="block">Provides typed access to elements from the StatePerformances standard library.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StatePerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StatePerformancesLibrary</a></code></div>
...
<div class="block">Returns the StatePerformancesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="StatePerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StatePerformancesLibrary</a></code></div>
...
<div class="block">Returns the StatePerformancesLibrary instance for the given project.</div>
</div>
...
<h3>StatePerformancesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">StatePerformancesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a StatePerformancesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StatePerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StatePerformancesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the StatePerformancesLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="StatePerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">StatePerformancesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the StatePerformancesLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
