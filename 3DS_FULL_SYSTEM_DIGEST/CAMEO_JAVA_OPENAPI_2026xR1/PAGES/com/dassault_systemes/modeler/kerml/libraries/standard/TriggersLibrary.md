# JAVA OPENAPI: TriggersLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/TriggersLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/TriggersLibrary.html`
- source_sha256: `d4ff27351424b3c306a9bdaad7e6875dcf0b677e6e0f2751e7fc06105d7e1bb7`
- captured_utc: `2026-07-14T16:44:47.232833+00:00`
...
com.dassault_systemes.modeler.kerml.libraries.standard.TriggersLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classTriggersLibrary
...
Description
`static class`
`[TriggersLibrary.TriggerAfterFunction](TriggersLibrary.TriggerAfterFunction.html)`
Type wrapper for the TriggerAfterFunction library element.
`static class`
`[TriggersLibrary.TriggerAtFunction](TriggersLibrary.TriggerAtFunction.html)`
Type wrapper for the TriggerAtFunction library element.
`static class`
`[TriggersLibrary.TriggerWhenFunction](TriggersLibrary.TriggerWhenFunction.html)`
...
Constructor
Description
`[TriggersLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a TriggersLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Method
Description
`static [TriggersLibrary](TriggersLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the TriggersLibrary instance for the project that owns the given element.
`static [TriggersLibrary](TriggersLibrary.html)`
...
Returns the TriggersLibrary instance for the given project.
...
Returns the wrapper for the TriggerAfter library element.
`[TriggersLibrary.TriggerAtFunction](TriggersLibrary.TriggerAtFunction.html)`
`[TriggerAt](#TriggerAt())()`
Returns the wrapper for the TriggerAt library element.
`[TriggersLibrary.TriggerWhenFunction](TriggersLibrary.TriggerWhenFunction.html)`
`[TriggerWhen](#TriggerWhen())()`
Returns the wrapper for the TriggerWhen library element.
...
Constructor Details
TriggersLibrary
public TriggersLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a TriggersLibrary for the given project.
Parameters:
...
public static [TriggersLibrary](TriggersLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the TriggersLibrary instance for the given project.
Parameters:
...
getInstance
public static [TriggersLibrary](TriggersLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the TriggersLibrary instance for the project that owns the given element.
Parameters:
...
TriggerWhen
public [TriggersLibrary.TriggerWhenFunction](TriggersLibrary.TriggerWhenFunction.html) TriggerWhen()
Returns the wrapper for the TriggerWhen library element.
Returns:
the wrapper for the TriggerWhen element
TriggerAt
public [TriggersLibrary.TriggerAtFunction](TriggersLibrary.TriggerAtFunction.html) TriggerAt()
Returns the wrapper for the TriggerAt library element.
Returns:
the wrapper for the TriggerAt element
TriggerAfter
public [TriggersLibrary.TriggerAfterFunction](TriggersLibrary.TriggerAfterFunction.html) TriggerAfter()
Returns the wrapper for the TriggerAfter library element.
Returns:
the wrapper for the TriggerAfter element
getTypeWrappers
...
<h1 class="title" title="Class TriggersLibrary">Class TriggersLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.TriggersLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">TriggersLibrary</span>
...
<div class="block">Provides typed access to elements from the Triggers standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="TriggersLibrary.TriggerAfterFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAfterFunction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the TriggerAfterFunction library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="TriggersLibrary.TriggerAtFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAtFunction</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the TriggerAtFunction library element.</div>
</div>
<div class="col-first even-row-color"><code>static class </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="TriggersLibrary.TriggerWhenFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerWhenFunction</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the TriggerWhenFunction library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TriggersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary</a></code></div>
...
<div class="block">Returns the TriggersLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="TriggersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary</a></code></div>
...
<div class="block">Returns the TriggersLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TriggersLibrary.TriggerAfterFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAfterFunction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TriggerAfter()">TriggerAfter</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the TriggerAfter library element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TriggersLibrary.TriggerAtFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAtFunction</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TriggerAt()">TriggerAt</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the TriggerAt library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="TriggersLibrary.TriggerWhenFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerWhenFunction</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#TriggerWhen()">TriggerWhen</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the TriggerWhen library element.</div>
</div>
</div>
</div>
</div>
...
<h3>TriggersLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TriggersLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a TriggersLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TriggersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the TriggersLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="TriggersLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the TriggersLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="TriggerWhen()">
<h3>TriggerWhen</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TriggersLibrary.TriggerWhenFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerWhenFunction</a></span> <span class="element-name">TriggerWhen</span>()</div>
<div class="block">Returns the wrapper for the TriggerWhen library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the TriggerWhen element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="TriggerAt()">
<h3>TriggerAt</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TriggersLibrary.TriggerAtFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAtFunction</a></span> <span class="element-name">TriggerAt</span>()</div>
<div class="block">Returns the wrapper for the TriggerAt library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the TriggerAt element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="TriggerAfter()">
<h3>TriggerAfter</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="TriggersLibrary.TriggerAfterFunction.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">TriggersLibrary.TriggerAfterFunction</a></span> <span class="element-name">TriggerAfter</span>()</div>
<div class="block">Returns the wrapper for the TriggerAfter library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the TriggerAfter element</dd>
</dl>
</section>
</li>
<li>
