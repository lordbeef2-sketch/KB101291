# JAVA OPENAPI: ControlPerformancesLibrary (2026x Refresh1 API)

- source_url: https://jdocs.nomagic.com/2026xRefresh1/com/dassault_systemes/modeler/kerml/libraries/standard/ControlPerformancesLibrary.html
- source_path: `com/dassault_systemes/modeler/kerml/libraries/standard/ControlPerformancesLibrary.html`
- source_sha256: `bcc28e32bb47ec777533d393ed6b0f93ff8e090aee8f6da19277b75ac5f6c10f`
- captured_utc: `2026-07-14T16:44:45.463809+00:00`
...
## Class ControlPerformancesLibrary
...
com.dassault_systemes.modeler.kerml.libraries.standard.ControlPerformancesLibrary

All Implemented Interfaces:
`com.dassault_systemes.modeler.foundation.project.service.DisposableService`

@OpenApiAllpublic classControlPerformancesLibrary
...
Description
`static class`
`[ControlPerformancesLibrary.DecisionPerformanceBehavior](ControlPerformancesLibrary.DecisionPerformanceBehavior.html)`
Type wrapper for the DecisionPerformanceBehavior library element.
`static class`
`[ControlPerformancesLibrary.MergePerformanceBehavior](ControlPerformancesLibrary.MergePerformanceBehavior.html)`
...
Constructor
Description
`[ControlPerformancesLibrary](#%3Cinit%3E(com.dassault_systemes.modeler.foundation.project.ModelElementProject))([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)`
Creates a ControlPerformancesLibrary for the given project.
 ========== METHOD SUMMARY =========== 
Method Summary
...
Returns the wrapper for the DecisionPerformance library element.
`static [ControlPerformancesLibrary](ControlPerformancesLibrary.html)`
`[getInstance](#getInstance(com.nomagic.magicdraw.uml.BaseElement))([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)`
Returns the ControlPerformancesLibrary instance for the project that owns the given element.
`static [ControlPerformancesLibrary](ControlPerformancesLibrary.html)`
...
Returns the ControlPerformancesLibrary instance for the given project.
...
`[ControlPerformancesLibrary.MergePerformanceBehavior](ControlPerformancesLibrary.MergePerformanceBehavior.html)`
`[MergePerformance](#MergePerformance())()`
Returns the wrapper for the MergePerformance library element.
...
public ControlPerformancesLibrary([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Creates a ControlPerformancesLibrary for the given project.
Parameters:
...
public static [ControlPerformancesLibrary](ControlPerformancesLibrary.html) getInstanceByProject([ModelElementProject](../../../foundation/project/ModelElementProject.html) project)
Returns the ControlPerformancesLibrary instance for the given project.
Parameters:
...
getInstance
public static [ControlPerformancesLibrary](ControlPerformancesLibrary.html) getInstance([BaseElement](../../../../../nomagic/magicdraw/uml/BaseElement.html) element)
Returns the ControlPerformancesLibrary instance for the project that owns the given element.
Parameters:
...
DecisionPerformance
public [ControlPerformancesLibrary.DecisionPerformanceBehavior](ControlPerformancesLibrary.DecisionPerformanceBehavior.html) DecisionPerformance()
Returns the wrapper for the DecisionPerformance library element.
Returns:
the wrapper for the DecisionPerformance element
MergePerformance
public [ControlPerformancesLibrary.MergePerformanceBehavior](ControlPerformancesLibrary.MergePerformanceBehavior.html) MergePerformance()
Returns the wrapper for the MergePerformance library element.
Returns:
the wrapper for the MergePerformance element
getTypeWrappers
...
<h1 class="title" title="Class ControlPerformancesLibrary">Class ControlPerformancesLibrary</h1>
</div>
...
<div class="inheritance">com.dassault_systemes.modeler.kerml.libraries.standard.ControlPerformancesLibrary</div>
</div>
</div>
</div>
...
</span><span class="modifiers">public class </span><span class="element-name type-name-label">ControlPerformancesLibrary</span>
...
<div class="block">Provides typed access to elements from the ControlPerformances standard library.</div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="ControlPerformancesLibrary.DecisionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.DecisionPerformanceBehavior</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type wrapper for the DecisionPerformanceBehavior library element.</div>
</div>
<div class="col-first odd-row-color"><code>static class </code></div>
<div class="col-second odd-row-color"><code><a class="type-name-link" href="ControlPerformancesLibrary.MergePerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.MergePerformanceBehavior</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type wrapper for the MergePerformanceBehavior library element.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ControlPerformancesLibrary.DecisionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.DecisionPerformanceBehavior</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#DecisionPerformance()">DecisionPerformance</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the DecisionPerformance library element.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ControlPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary</a></code></div>
...
<div class="block">Returns the ControlPerformancesLibrary instance for the project that owns the given element.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="ControlPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary</a></code></div>
...
<div class="block">Returns the ControlPerformancesLibrary instance for the given project.</div>
</div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="ControlPerformancesLibrary.MergePerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.MergePerformanceBehavior</a></code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#MergePerformance()">MergePerformance</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Returns the wrapper for the MergePerformance library element.</div>
</div>
...
<h3>ControlPerformancesLibrary</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">ControlPerformancesLibrary</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Creates a ControlPerformancesLibrary for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ControlPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary</a></span> <span class="element-name">getInstanceByProject</span><wbr/><span class="parameters">(<a href="../../../foundation/project/ModelElementProject.html" title="interface in com.dassault_systemes.modeler.foundation.project">ModelElementProject</a> project)</span></div>
<div class="block">Returns the ControlPerformancesLibrary instance for the given project.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<h3>getInstance</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="ControlPerformancesLibrary.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary</a></span> <span class="element-name">getInstance</span><wbr/><span class="parameters">(<a href="../../../../../nomagic/magicdraw/uml/BaseElement.html" title="interface in com.nomagic.magicdraw.uml">BaseElement</a> element)</span></div>
<div class="block">Returns the ControlPerformancesLibrary instance for the project that owns the given element.</div>
<dl class="notes">
<dt>Parameters:</dt>
...
<li>
<section class="detail" id="DecisionPerformance()">
<h3>DecisionPerformance</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ControlPerformancesLibrary.DecisionPerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.DecisionPerformanceBehavior</a></span> <span class="element-name">DecisionPerformance</span>()</div>
<div class="block">Returns the wrapper for the DecisionPerformance library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the DecisionPerformance element</dd>
</dl>
</section>
</li>
<li>
<section class="detail" id="MergePerformance()">
<h3>MergePerformance</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type"><a href="ControlPerformancesLibrary.MergePerformanceBehavior.html" title="class in com.dassault_systemes.modeler.kerml.libraries.standard">ControlPerformancesLibrary.MergePerformanceBehavior</a></span> <span class="element-name">MergePerformance</span>()</div>
<div class="block">Returns the wrapper for the MergePerformance library element.</div>
<dl class="notes">
<dt>Returns:</dt>
<dd>the wrapper for the MergePerformance element</dd>
</dl>
</section>
</li>
<li>
