# JAVA OPENAPI: CreateLinkAction (2026x API)

- source_url: https://jdocs.nomagic.com/2026x/com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/CreateLinkAction.html
- source_path: `com/nomagic/uml2/ext/magicdraw/actions/mdintermediateactions/CreateLinkAction.html`
- source_sha256: `022d1fd9e92316ea6d2b011955d67551ca9aa52447b61cc6002aac5cf9615c9f`
- captured_utc: `2026-07-14T16:58:49.025415+00:00`
...
See Also:
[`UMLPackage.getCreateLinkAction()`](../../metadata/UMLPackage.html#getCreateLinkAction())
Model:
...
Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.[LinkAction](LinkAction.html)
`[getInputValue](LinkAction.html#getInputValue()), [hasEndData](LinkAction.html#hasEndData()), [hasInputValue](LinkAction.html#hasInputValue())`
...
Returns the value of the '***End Data***' containment reference list.
 The list contents are of type [`LinkEndCreationData`](LinkEndCreationData.html).
 It is bidirectional and its opposite is '[`*create Link Action Of End Data*`](LinkEndCreationData.html#get_createLinkActionOfEndData())'.
 begin-user-doc 
 end-user-doc 
 begin-model-doc 
...
Specified by:
`[getEndData](LinkAction.html#getEndData())` in interface `[LinkAction](LinkAction.html)`
Returns:
the value of the '*End Data*' containment reference list.
See Also:
[`UMLPackage.getCreateLinkAction_EndData()`](../../metadata/UMLPackage.html#getCreateLinkAction_EndData())
[`LinkEndCreationData.get_createLinkActionOfEndData()`](LinkEndCreationData.html#get_createLinkActionOfEndData())
Model:
opposite="_createLinkActionOfEndData" containment="true" resolveProxies="true" lower="2" ordered="false"
Generated:
...
<li><a href="../../metadata/UMLPackage.html#getCreateLinkAction()"><code>UMLPackage.getCreateLinkAction()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
...
<div class="inherited-list">
<h3 id="methods-inherited-from-class-com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.LinkAction">Methods inherited from interface com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions.<a href="LinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkAction</a></h3>
<code><a href="LinkAction.html#getInputValue()">getInputValue</a>, <a href="LinkAction.html#hasEndData()">hasEndData</a>, <a href="LinkAction.html#hasInputValue()">hasInputValue</a></code></div>
<div class="inherited-list">
...
<div class="block">Returns the value of the '<em><b>End Data</b></em>' containment reference list.
 The list contents are of type <a href="LinkEndCreationData.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions"><code>LinkEndCreationData</code></a>.
 It is bidirectional and its opposite is '<a href="LinkEndCreationData.html#get_createLinkActionOfEndData()"><code><em>create Link Action Of End Data</em></code></a>'.
 <!-- begin-user-doc -->
<!-- end-user-doc -->
<!-- begin-model-doc -->
 The LinkEndData that specifies the values to be placed on the Association ends for the new link.
...
<dl class="notes">
<dt>Specified by:</dt>
<dd><code><a href="LinkAction.html#getEndData()">getEndData</a></code> in interface <code><a href="LinkAction.html" title="interface in com.nomagic.uml2.ext.magicdraw.actions.mdintermediateactions">LinkAction</a></code></dd>
<dt>Returns:</dt>
<dd>the value of the '<em>End Data</em>' containment reference list.</dd>
<dt>See Also:</dt>
<dd>
<ul class="tag-list-long">
<li><a href="../../metadata/UMLPackage.html#getCreateLinkAction_EndData()"><code>UMLPackage.getCreateLinkAction_EndData()</code></a></li>
<li><a href="LinkEndCreationData.html#get_createLinkActionOfEndData()"><code>LinkEndCreationData.get_createLinkActionOfEndData()</code></a></li>
</ul>
</dd>
<dt>Model:</dt>
<dd>opposite="_createLinkActionOfEndData" containment="true" resolveProxies="true" lower="2" ordered="false"</dd>
<dt>Generated:</dt>
</dl>
</section>
</li>
