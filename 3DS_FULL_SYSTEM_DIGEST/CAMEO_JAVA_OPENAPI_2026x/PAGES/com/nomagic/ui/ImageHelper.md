# JAVA OPENAPI: ImageHelper (2026x API)

- source_url: https://jdocs.nomagic.com/2026x/com/nomagic/ui/ImageHelper.html
- source_path: `com/nomagic/ui/ImageHelper.html`
- source_sha256: `8bced76621aaad9cf94add79fd117a99e3f8909e0f031d1ccfdb9d575ee81334`
- captured_utc: `2026-07-14T16:58:41.759332+00:00`
...
@OpenApiAll
[@Deprecated](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Deprecated.html)public classImageHelper
...
`[createResizableIcon](#createResizableIcon(java.awt.Image))([Image](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Image.html) image)`
Deprecated.
Create resizable icon from given image..
`static [ResizableIcon](ResizableIcon.html)`
`[createResizableIcon](#createResizableIcon(java.net.URL,com.nomagic.ui.ImageFormat))([URL](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/net/URL.html) url,
...
Method Details
createResizableIcon
public static [ResizableIcon](ResizableIcon.html) createResizableIcon([URL](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/net/URL.html) url,
 [ImageFormat](ImageFormat.html) imageFormat)
...
createResizableIcon
public static [ResizableIcon](ResizableIcon.html) createResizableIcon([Image](https://docs.oracle.com/en/java/javase/21/docs/api/java.desktop/java/awt/Image.html) image)
Deprecated.
Create resizable icon from given image..
Parameters:
