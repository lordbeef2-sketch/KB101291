...
This is the only valid starting point for the NI knowledge base. It governs only `NI_KB/`. The sibling `3DS_NI_KB/` is a separate KB and must never be opened, indexed, required, or cited by this protocol.
...
This control file is intentionally outside the evidence manifest and is consumed as the entry document. The evidence corpus contains 1845 Markdown documents. Including this controller, the independent NI KB contains 1846 Markdown documents.

## NI-ONLY MANIFEST ANCHOR

- manifest: `00_MACHINE_MANIFEST.md`
- required manifest SHA-256: `13055c7dba39c18fd23f35b19d61e9498d84cae16b74583cfe2c412a59576f30`
- listed evidence rows: `1844`
...
2. Evidence ordinals 2 through 1845: read every manifest row in its listed order.
...
SHA-256 of the complete 1845-record stream must equal:

```text
2e4da8de969401c24b99a16a027a12ce370aceae1b8e09b36bcbbf95e382fdb7
```
