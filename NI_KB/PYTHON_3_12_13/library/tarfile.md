# PYTHON_3_12_13::library/tarfile.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/tarfile.txt -->
...
TarFile.extractall(path='.', members=None, *, numeric_owner=False, filter=None)
   ...
   is recommended to set this explicitly depending on which *tar*
