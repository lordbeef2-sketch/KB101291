# PYTHON_3_12_13::library/exceptions.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=library/exceptions.txt -->
...
exception OSError(errno, strerror[, filename[, winerror[, filename2]]])
   ...
   encoded to or decoded from the *filesystem encoding and error
   handler*. Also, the *filename2* constructor argument and attribute
   was added.
