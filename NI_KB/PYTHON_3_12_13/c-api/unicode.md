# PYTHON_3_12_13::c-api/unicode.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=c-api/unicode.txt -->
...
PyObject *PyUnicode_InternFromString(const char *str)
   ...
   Python may keep a reference to the result, or prevent it from being
   garbage-collected promptly. For interning an unbounded number of
   different strings, such as ones coming from user input, prefer
   calling "PyUnicode_FromString()" and "PyUnicode_InternInPlace()"
   directly.
