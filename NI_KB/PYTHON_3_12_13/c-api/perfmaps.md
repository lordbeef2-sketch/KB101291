# PYTHON_3_12_13::c-api/perfmaps.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=c-api/perfmaps.txt -->
...
Note that holding the Global Interpreter Lock (GIL) is not required
for these APIs.
