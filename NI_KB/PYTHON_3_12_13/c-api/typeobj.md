# PYTHON_3_12_13::c-api/typeobj.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=c-api/typeobj.txt -->
...
Py_ssize_t PyVarObject.ob_size
   ...
   This field should be accessed using the "Py_SIZE()" and
   "Py_SET_SIZE()" macros.
...
Py_ssize_t PyTypeObject.tp_itemsize
   ...
   should be acessed using "PyLong_Export()".
...
destructor PyTypeObject.tp_dealloc
   ...
   Warning:
     ...
     In a garbage collected Python, "tp_dealloc" may be called from
     any Python thread, not just the thread which created the object
     (if the object becomes part of a refcount cycle, that cycle might
     be collected by a garbage collection on any thread).  This is not
     a problem for Python API calls, since the thread on which
     "tp_dealloc" is called will own the Global Interpreter Lock
...
unsigned long PyTypeObject.tp_flags
   ...
   **Bit Masks:**
   ...
   Py_TPFLAGS_MANAGED_DICT
      ...
      *~object.__dict__* attribute, and that the space for the
   ...
   Py_TPFLAGS_VALID_VERSION_TAG
      ...
      Warning:
        ...
        This flag is present in header files, but is an internal
        feature and should not be used. It will be removed in a future
        version of CPython
