# PYTHON_3_12_13::whatsnew/3.12.md

<!--SYSTEM_CORPUS id=PYTHON_3_12_13 source_path=whatsnew/3.12.txt -->
...
* As of 3.12.4, "os.mkdir()" and "os.makedirs()" on Windows now
  support passing a *mode* value of "0o700" to apply access control to
  the new directory. This implicitly affects "tempfile.mkdtemp()" and
  is a mitigation for **CVE 2024-4030**. Other values for *mode*
  continue to be ignored. (Contributed by Steve Dower in gh-118486.)
...
* Headers with embedded newlines are now quoted on output.
  ...
  The "generator" will now refuse to serialize (write) headers that
  ...
  turn this safety feature off, set "verify_generated_headers".
...
* "email.utils.getaddresses()" and "email.utils.parseaddr()" now
  ...
  An optional *strict* parameter was added to these two functions: use
  ...
  to check if the *strict* paramater is available. (Contributed by
